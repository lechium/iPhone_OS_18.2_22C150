...
- (void).cxx_destruct;	// IMP=0x0020000000006c76
...
- (id)_muteAnnouncementsSpecifierTitleForMuted:(_Bool)arg1 announceEnablementType:(long long)arg2;	// IMP=0x0010000000006baf
- (void)_updateAnnounceMuted:(_Bool)arg1;	// IMP=0x0010000000006ad9
- (_Bool)_isAnnounceMuted;	// IMP=0x0010000000006a06
- (id)_announceEnabledFooterText;	// IMP=0x0000000000006987
- (void)_updateAnnounceEnabled:(_Bool)arg1;	// IMP=0x001000000000658f
- (_Bool)_isAnnounceEnabled;	// IMP=0x0010000000006519
- (void)stateService:(id)arg1 didReceiveDoNotDisturbStateUpdate:(id)arg2;	// IMP=0x00100000000063d8
- (void)preferences:(id)arg1 announceNotificationsInCarPlayTemporarilyDisabledChanged:(_Bool)arg2;	// IMP=0x00100000000062ec
- (void)preferences:(id)arg1 carPlayAnnounceEnablementTypeChanged:(long long)arg2;	// IMP=0x00100000000061c2
- (void)announceCarPlaySettingUpdated:(long long)arg1;	// IMP=0x0010000000006033
...
- (id)specifierSections;	// IMP=0x00100000000056a6
- (id)cellSpecifier;	// IMP=0x00100000000054fb
- (id)initWithPanelController:(id)arg1;	// IMP=0x0010000000005213
