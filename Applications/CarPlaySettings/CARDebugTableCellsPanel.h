...
- (void).cxx_destruct;	// IMP=0x0020000000007b25
...
- (id);	// IMP=0x0010000000007a91
@property(retain, nonatomic) UITableView *tableView; // @synthesize tableView=_tableView;
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x00100000000079e6
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00100000000079db
- (id)tableView:(id)arg1 titleForHeaderInSection:(long long)arg2;	// IMP=0x00100000000079b3
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00100000000079a8
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x001000000000775d
- (void)viewDidLoad;	// IMP=0x001000000000721e
- (id)initWithPanelController:(id)arg1;	// IMP=0x00100000000071ef
- (id)cellSpecifier;	// IMP=0x0010000000007098
