...
- (void).cxx_destruct;	// IMP=0x0020000000004c36
...
- (_Bool)matches:(id)arg1;	// IMP=0x0010000000004b60
- (void)cancelTimeoutTimer;	// IMP=0x0010000000004b2e
- (void)startTimeoutTimerWithTimeout:(double)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000049fc
- (id)initWithToken:(id)arg1 pixelSize:(struct CGSize)arg2 scale:(double)arg3 capabilitiesPath:(id)arg4 maskPath:(id)arg5 successHandler:(CDUnknownBlockType)arg6 failureHandler:(CDUnknownBlockType)arg7;	// IMP=0x0010000000004880
