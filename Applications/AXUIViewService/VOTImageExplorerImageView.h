...
- (void).cxx_destruct;	// IMP=0x002000000000f2d6
...
- (id)_accessibilityCustomContentForFeature:(id)arg1;	// IMP=0x001000000000e6e8
- (id)_axNearbyRelationsForFeature:(id)arg1;	// IMP=0x001000000000de70
- (id)_axNearbyRelationKeyForFeature:(id)arg1 andNeighborFeature:(id)arg2;	// IMP=0x001000000000db24
- (id)_axRelationOfCurrentFrame:(struct CGRect)arg1 withNeighborFrame:(struct CGRect)arg2;	// IMP=0x001000000000d9c9
- (id)sortedElements;	// IMP=0x001000000000d91a
- (id)imageExplorerRotorWithName:(id)arg1;	// IMP=0x001000000000d3d0
- (_Bool)addElement:(id)arg1 toElements:(id)arg2 forFeatureKey:(id)arg3;	// IMP=0x001000000000d2e4
- (id)_findPeopleFeatureThatOverlapsWithFace:(id)arg1;	// IMP=0x001000000000cd9a
- (id)_generateFaceAccessibilityElements;	// IMP=0x001000000000c86e
- (id)_generateObjectClassificationAccessibilityElements;	// IMP=0x001000000000c46e
- (id)_generateOCRTextAccessibilityElementsForFeature:(id)arg1;	// IMP=0x001000000000c004
- (id)_generateOCRDocumentAccessibilityElements;	// IMP=0x001000000000b7bd
- (id)generateAccessibilityElements;	// IMP=0x001000000000b648
- (id)explorableOCRTypes;	// IMP=0x001000000000b63b
- (_Bool)_accessibilityShouldIncludeRegionDescription;	// IMP=0x001000000000b633
- (_Bool)_accessibilityShouldIncludeRemoteParentCustomActions;	// IMP=0x001000000000b62b
- (unsigned int)_accessibilityMediaAnalysisOptions;	// IMP=0x001000000000b623
- (id)accessibilityElements;	// IMP=0x001000000000b611
- (id)accessibilityCustomRotors;	// IMP=0x001000000000b19f
- (_Bool)isAccessibilityElement;	// IMP=0x001000000000b157
- (id)filteredSubfeaturesForFeature:(id)arg1 withOCRType:(long long)arg2;	// IMP=0x001000000000b06d
