...
- (void)startSearchQuery;	// IMP=0x001000000000eed9
- (void)showPseudoContactsListForIPhone;	// IMP=0x001000000000ed18
- (void)showNextContact;	// IMP=0x001000000000e978
- (void)iterateContact;	// IMP=0x001000000000e64c
- (void)navigationController:(id)arg1 didShowViewController:(id)arg2 animated:(_Bool)arg3;	// IMP=0x001000000000e637
- (void)didShow:(id)arg1;	// IMP=0x001000000000e4d2
- (void)resetDelegate;	// IMP=0x001000000000e3cd
- (void)prepareForNextTest;	// IMP=0x001000000000e38f
- (_Bool)prepareForTestWithOptions:(id)arg1;	// IMP=0x001000000000df2b
