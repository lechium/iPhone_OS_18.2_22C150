...
- (void).cxx_destruct;	// IMP=0x002000000000f6c0
...
- (void)startSearchQueryWithOptions:(id)arg1;	// IMP=0x001000000000f32b
- (_Bool)prepareForTestWithOptions:(id)arg1;	// IMP=0x001000000000f19a
