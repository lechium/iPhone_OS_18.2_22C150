...
@interface _TtC16SafetyMonitorApp33LiveActivityElementViewController : UIViewController
{
    ...
    MISSING_TYPE *avatarView;	// 88 = 0x58
...
- (void).cxx_destruct;	// IMP=0x0040000000007b50
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000007b00
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00100000000078a0
- (_Bool)_canShowWhileLocked;	// IMP=0x00100000000047b0
- (void)viewWillLayoutSubviewsWithTransitionCoordinator:(id)arg1;	// IMP=0x0010000000004760
- (void)viewDidLoad;	// IMP=0x0010000000003700
