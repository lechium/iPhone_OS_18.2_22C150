...
@class MISSING_TYPE, UIApplicationShortcutItem, UITraitCollection, UIWindow, UIWindowScene;
...
- (MISSING_TYPE *)windowScene:userDidAcceptCloudKitShareWithMetadata: /* Error: Ran out of types for this method. */;
