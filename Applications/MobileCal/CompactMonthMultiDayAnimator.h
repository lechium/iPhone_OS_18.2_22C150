...
@interface CompactMonthMultiDayAnimator : NSObject
{
...
+ (Class)monthMultiDayTransitionViewClass;	// IMP=0x00200000000dda82
- (void).cxx_destruct;	// IMP=0x00200000000de448
...
- (void)animateTransition:(id)arg1;	// IMP=0x00100000000ddbde
- (double)transitionDuration:(id)arg1;	// IMP=0x00100000000ddb8e
- (id)initWithModel:(id)arg1 paletteView:(id)arg2 reverse:(_Bool)arg3;	// IMP=0x00100000000dda93
