...
@class EKCalendarDate, EKDayOccurrenceView, EKDayViewController, EKEvent, NSArray, NSDate, NSDateComponents, UIView, UIViewController;
...
- (void)dayViewController:(EKDayViewController *)arg1 didSelectEvents:(NSArray *)arg2 animated:(_Bool)arg3 userInitiated:(_Bool)arg4;
...
- (EKEvent *)dayViewController:(EKDayViewController *)arg1 createReminderAtDate:(NSDate *)arg2 allDay:(_Bool)arg3;
