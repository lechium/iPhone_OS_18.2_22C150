...
@optional
- (_Bool)weekGroupViewShouldAnnotateAppEntities:(WeekGroupView *)arg1 onDayStarting:(EKCalendarDate *)arg2;
...
- (void)weekGroup:(WeekGroupView *)arg1 didSelectEvents:(NSArray *)arg2 userInitiated:(_Bool)arg3;
- (void)weekGroup:(WeekGroupView *)arg1 didSelectEvent:(EKEvent *)arg2 userInitiated:(_Bool)arg3 dateSelected:(EKCalendarDate *)arg4;
@end
