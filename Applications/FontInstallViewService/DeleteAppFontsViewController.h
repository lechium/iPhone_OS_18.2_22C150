...
- (void).cxx_destruct;	// IMP=0x0020000000003370
...
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0010000000002f40
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x0010000000002e90
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x0010000000002e40
- (void)dontDelete:(id)arg1;	// IMP=0x0010000000002dd0
- (void)doDelete:(id)arg1;	// IMP=0x0010000000002d50
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0010000000002d00
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000002650
- (void)viewDidLoad;	// IMP=0x0010000000002610
