...
- (void).cxx_destruct;	// IMP=0x002000000001494f
...
- (id)auditCandidates:(id)arg1 autoSubscriptionAddedDateByTagId:(id)arg2 multiplierProvider:(CDUnknownBlockType)arg3;	// IMP=0x00100000000141ef
- (_Bool)shouldRejectTagID:(id)arg1 withAggregate:(id)arg2 baseline:(id)arg3 currentDate:(id)arg4 addedDate:(id)arg5 maxIdleTime:(double)arg6 minEvents:(double)arg7 minRate:(double)arg8 baseRate:(double)arg9 multiplier:(double)arg10;	// IMP=0x0010000000014007
- (_Bool)shouldAcceptAggregate:(id)arg1 withCtr:(double)arg2 minEvents:(double)arg3 minClicks:(double)arg4 minRate:(double)arg5 baseRate:(double)arg6 multiplier:(double)arg7;	// IMP=0x0010000000013f14
- (double)ctrForTagID:(id)arg1 withAggregate:(id)arg2 baselineAggregate:(id)arg3;	// IMP=0x0010000000013dae
- (double)metricMultiplierForTagID:(id)arg1 withPriorFactorExponent:(double)arg2 tagFavorabilityExponent:(double)arg3;	// IMP=0x0010000000013bf1
- (void)_considerExternalSignals:(CDUnknownBlockType)arg1;	// IMP=0x00100000000131ff
- (void)_considerInternalSignals:(CDUnknownBlockType)arg1;	// IMP=0x0010000000012c9c
- (id)processSafariSignals:(id)arg1;	// IMP=0x00100000000128ae
- (id)processExternalAppUsageSignals:(id)arg1;	// IMP=0x0010000000012541
- (void)processAppSignals:(id)arg1 safariSignals:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000111cc
- (void)considerBiome:(CDUnknownBlockType)arg1;	// IMP=0x0010000000010b11
- (id)maybeConsiderPortrait;	// IMP=0x00100000000107d4
- (void)considerLocation:(CDUnknownBlockType)arg1;	// IMP=0x00100000000101d0
- (void)_considerInternalAppUsage:(CDUnknownBlockType)arg1;	// IMP=0x001000000000fc56
- (void)_findValidAutoFavoritesWithCandidates:(id)arg1 channelsAllowedProvider:(CDUnknownBlockType)arg2 topicsAllowedProvider:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x001000000000f345
- (void)_processSignals:(CDUnknownBlockType)arg1;	// IMP=0x001000000000c414
- (void)operationWillFinishWithError:(id)arg1;	// IMP=0x001000000000c340
- (void)performOperation;	// IMP=0x001000000000c09b
- (void)prepareOperation;	// IMP=0x001000000000bfff
- (_Bool)validateOperation;	// IMP=0x001000000000bde6
