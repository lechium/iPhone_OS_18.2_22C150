...
- (void).cxx_destruct;	// IMP=0x002000000004e164
...
- (id)headlineNotification_dictionaryRepresentation;	// IMP=0x001000000004df80
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000004dde8
- (id)initWithHeadline:(id)arg1;	// IMP=0x001000000004d91f
