...
@protocol FCANFHelper, FREditorialConfigurationProvider, FREditorialItemDownloader, FREditorialItemEntryManager, FREditorialItemThumbnailCreator, TSEditorialItemChangeDelegate;
...
@interface FRToCEditorialManager : NSObject
{
    ...
    id <FCANFHelper> _ANFHelper;	// 88 = 0x58
    FCOperationThrottler *_refreshThrottler;	// 96 = 0x60
}

- (void).cxx_destruct;	// IMP=0x0020000000049358
...
// Error: Property attributes should begin with the type ('T') attribute, property name: localStore
...
- (void)operationThrottler:(id)arg1 performAsyncOperationWithCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000048fd5
- (void)_fetchInterestTokenForArticleID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000048dfa
- (void)prewarmWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000489a0
- (void)tappedEditorialItemWithIdentifier:(id)arg1;	// IMP=0x0010000000047c73
- (void)removeBadgeForArticleID:(id)arg1;	// IMP=0x0010000000047a85
- (void)_refreshEditorialItemsOrderedWith:(id)arg1;	// IMP=0x00100000000478e5
- (void)_fetchTagsAndRefreshEditorialItems;	// IMP=0x00100000000466ed
- (id)cachedEditorialItems;	// IMP=0x0010000000045ead
- (_Bool)_editorialItemHasBadge:(id)arg1;	// IMP=0x0010000000045d8e
- (void)processOverrideEditorialItems:(id)arg1;	// IMP=0x0010000000044b6c
- (void)refreshEditorialItems;	// IMP=0x0010000000044b2f
- (void)activityObservingApplicationWindowWillBecomeForeground;	// IMP=0x0010000000044b1d
- (id)initWithCloudContext:(id)arg1 activityMonitor:(id)arg2 editorialItemEntryManager:(id)arg3 articleEditorialItemDownloader:(id)arg4 tagEditorialItemDownloader:(id)arg5 editorialConfigurationProvider:(id)arg6 thumbnailCreator:(id)arg7 ANFHelper:(id)arg8;	// IMP=0x0010000000044817
- (id)init;	// IMP=0x00100000000446c4
