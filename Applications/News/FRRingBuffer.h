...
- (void).cxx_destruct;	// IMP=0x00200000000734b3
...
- (id)description;	// IMP=0x001000000007331c
@property(readonly, nonatomic) NSDictionary *dictionary;
- (void)insertValue:(double)arg1;	// IMP=0x0010000000072dd5
- (id)initWithCapacity:(unsigned long long)arg1 dictionary:(id)arg2;	// IMP=0x00100000000729f7
- (id)initWithCapacity:(unsigned long long)arg1;	// IMP=0x0010000000072980
