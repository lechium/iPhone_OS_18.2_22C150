...
- (void).cxx_destruct;	// IMP=0x00200000007379c6
...
- (void)getCanCallPhoneNumber:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000737680
- (void)presentCustomTipAlert:(id)arg1;	// IMP=0x0010000000737666
- (void)dealloc;	// IMP=0x0010000000737615
- (void)remoteViewController:(id)arg1 desiresConstrainedSize:(struct CGSize)arg2;	// IMP=0x001000000073760f
- (void)remoteViewControllerServiceDidTerminate:(id)arg1;	// IMP=0x001000000073759a
- (struct CGSize)maximumSizeForRemoteViewController:(id)arg1;	// IMP=0x0010000000737515
- (struct CGSize)minimumSizeForRemoteViewController:(id)arg1;	// IMP=0x0010000000737490
- (double)headerAndRouteFromToViewHeight;	// IMP=0x0010000000737417
- (double)heightForLayout:(unsigned long long)arg1;	// IMP=0x0010000000737231
- (id)stackedViews;	// IMP=0x001000000073717b
- (void)didChangeLayout:(unsigned long long)arg1;	// IMP=0x0010000000737103
- (void)waypointListViewDidSelectAddStop:(id)arg1;	// IMP=0x00100000007370fd
- (void)updatedRefinementModel:(id)arg1;	// IMP=0x00100000007370f7
- (void)selectedRefinementModel:(id)arg1;	// IMP=0x00100000007370f1
- (void)pressedRefinementModel:(id)arg1;	// IMP=0x00100000007370eb
- (long long)transportTypeForFieldsView:(id)arg1;	// IMP=0x00100000007370e0
- (id)currentRefinementsForFieldsView:(id)arg1;	// IMP=0x00000000007370d8
- (id)waypointsForFieldsView:(id)arg1;	// IMP=0x00100000007370d0
- (void)didTapTimingInFieldsView:(id)arg1;	// IMP=0x00100000007370ca
- (void)_setBannerViewContainerContentView:(id)arg1;	// IMP=0x001000000073666e
- (void)_updateFromRideStatus:(id)arg1;	// IMP=0x00100000007358ae
- (void)rideStatusMapDidChange:(id)arg1;	// IMP=0x0010000000735818
- (int)_currentAnalyticsTarget;	// IMP=0x00100000007352f6
- (void)headerViewButtonTapped:(id)arg1 buttonType:(unsigned long long)arg2;	// IMP=0x001000000073526c
- (void)contactTapped:(id)arg1;	// IMP=0x0010000000735183
- (void)_completedButtonTapped:(id)arg1;	// IMP=0x001000000073504d
- (id)_cancelConfirmationAlertControllerForApp:(id)arg1 withFee:(id)arg2 threshold:(id)arg3 continueBlock:(CDUnknownBlockType)arg4;	// IMP=0x00100000007347ee
- (void)_cleanupWithRideStatus:(id)arg1;	// IMP=0x00100000007345db
- (void)_cancelTapped:(id)arg1;	// IMP=0x0010000000733e0c
- (void)_openAppTapped;	// IMP=0x0010000000733d07
- (void)_bannerViewTapped:(id)arg1;	// IMP=0x0010000000733c6c
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x0010000000733b52
- (void)getRemoteViewControllerWithDelegate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000733869
- (void)extensionManager:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x0010000000733863
- (void)extensionManager:(id)arg1 didUpdateAvailableExtensions:(id)arg2;	// IMP=0x0010000000733643
- (void)viewDidLoad;	// IMP=0x001000000073278f
- (id)init;	// IMP=0x001000000073275c
- (id)initWithApplicationIdentifier:(id)arg1;	// IMP=0x0010000000732403
