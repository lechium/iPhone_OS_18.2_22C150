...
+ (_Bool)requiresConstraintBasedLayout;	// IMP=0x002000000084b66b
- (void).cxx_destruct;	// IMP=0x0020000000853d67
...
// Original attribute string: T@"UILayoutGuide",?,R,N,V_minimumCompressedContentLayoutGuide

@property(readonly, copy) NSString *description;
- (void)_handleCarScreenSizeChange;	// IMP=0x00100000008537c4
@property(readonly, nonatomic) double dynamicPointScaleValue;
@property(readonly, nonatomic) double availableWidth;
- (void)updateWithGroupAnimation:(id)arg1;	// IMP=0x0010000000851116
- (unsigned long long)_primaryManeuverViewVariant;	// IMP=0x00100000008510f7
- (unsigned long long)_desiredCompressionStage;	// IMP=0x0010000000850b69
- (void)_replaceSecondaryViewManeuver:(id)arg1 initialConstraints:(id)arg2 finalConstraints:(id)arg3;	// IMP=0x001000000085061d
- (void)_replacePrimaryViewManeuver:(id)arg1 initialConstraints:(id)arg2 finalConstraints:(id)arg3 slide:(_Bool)arg4;	// IMP=0x001000000084f571
- (double)complementarySignHeightForManeuverView:(id)arg1;	// IMP=0x001000000084f3d0
- (void)_prepareManeuverView:(id)arg1;	// IMP=0x001000000084eefa
- (void)hideJunctionViewTemporarily;	// IMP=0x001000000084eee3
- (double)maxAvailableHeightForJunctionView:(double)arg1;	// IMP=0x001000000084ed2f
- (void)hideJunctionViewAnimated:(_Bool)arg1;	// IMP=0x001000000084eb59
- (void)showJunctionViewAnimated:(_Bool)arg1;	// IMP=0x001000000084e9b7
- (void)refreshJunctionView;	// IMP=0x001000000084e89c
- (void)_updateCompressionStage;	// IMP=0x001000000084e158
- (void)_resetPrecalculatedCompressionSizes;	// IMP=0x001000000084e089
- (void)setBlurMode:(int)arg1;	// IMP=0x001000000084dfaa
- (_Bool)_shouldForceSecondaryManeuverViewHidden;	// IMP=0x001000000084d242
- (_Bool)isPointInJunctionView:(struct CGPoint)arg1;	// IMP=0x001000000084d128
...
- (void)layoutSubviews;	// IMP=0x001000000084ce2f
- (double)_heightForCompressionStage:(unsigned long long)arg1 isMaximumCompression:(_Bool *)arg2;	// IMP=0x001000000084c931
- (void)dealloc;	// IMP=0x001000000084c898
- (id)initWithDestination:(unsigned long long)arg1;	// IMP=0x001000000084b673
