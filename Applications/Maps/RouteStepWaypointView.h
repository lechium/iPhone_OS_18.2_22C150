...
+ (double)heightForItem:(id)arg1 width:(double)arg2 maximumHeight:(double)arg3;	// IMP=0x00400000006d2070
- (void).cxx_destruct;	// IMP=0x00200000006d2b0f
...
- (_Bool)shouldUseTextToBottomConstraint;	// IMP=0x00100000006d2968
- (void)setItem:(id)arg1;	// IMP=0x00100000006d2394
- (void)setShouldUseTextToBottomConstraint:(_Bool)arg1;	// IMP=0x00100000006d203f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000006d15a1
