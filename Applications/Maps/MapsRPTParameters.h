...
- (void).cxx_destruct;	// IMP=0x002000000063befe
...
- (void)prepareWithComposer:(id)arg1;	// IMP=0x001000000063bcb0
- (CDUnknownBlockType)composerBlock;	// IMP=0x001000000063aaa8
- (id)initWithTestName:(id)arg1 view:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 testActions:(id)arg4 actionDuration:(double)arg5;	// IMP=0x001000000063a92b
