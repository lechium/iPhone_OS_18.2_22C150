...
- (id)description;	// IMP=0x0010000000443963
- (double)valueAtTime:(double)arg1;	// IMP=0x001000000044384b
- (id)initWithMass:(double)arg1 stiffness:(double)arg2 damping:(double)arg3 initialVelocity:(double)arg4;	// IMP=0x0010000000442c93
