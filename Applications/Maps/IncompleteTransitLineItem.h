...
- (void).cxx_destruct;	// IMP=0x00200000002a6bab
...
- (id)initWithTransitLine:(id)arg1;	// IMP=0x00100000002a67c9
- (id)initWithIdentifier:(id)arg1 name:(id)arg2;	// IMP=0x00100000002a671e
- (id)initWithLabelMarker:(id)arg1 system:(id)arg2;	// IMP=0x00100000002a6685
- (id)initWithLabelMarker:(id)arg1;	// IMP=0x00100000002a6671
