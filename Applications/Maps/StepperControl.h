...
- (void).cxx_destruct;	// IMP=0x0020000000d2c250
...
- (void)plusButtonTapped:(id)arg1;	// IMP=0x0010000000d2bf80
- (void)minusButtonTapped:(id)arg1;	// IMP=0x0010000000d2bf4e
- (void)updateLabel;	// IMP=0x0010000000d2be43
- (void)setupConstraints;	// IMP=0x0010000000d2b7fd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000d2b47c
