...
- (void).cxx_destruct;	// IMP=0x0020000000f1eb9a
...
- (id)calculateArtworkViewWidthAndArtworkSizes:(out double *)arg1;	// IMP=0x0010000000f1e5b8
- (id)initWithSizedArtworks:(id)arg1 sizeParameter:(struct ArtworkWidthCalculatorSizeParameter)arg2;	// IMP=0x0010000000f1e4c7
