...
- (void).cxx_destruct;	// IMP=0x0020000000ebb360
...
- (void)restaurantReservationRequestControllerDidComplete:(id)arg1 contentRefresh:(_Bool)arg2;	// IMP=0x0010000000ebb267
- (void)willResignCurrent:(_Bool)arg1;	// IMP=0x0010000000ebb1ef
- (void)viewDidLoad;	// IMP=0x0010000000ebb0a0
- (id)initWithRestaurantReservationRequester:(id)arg1;	// IMP=0x0010000000ebb034
