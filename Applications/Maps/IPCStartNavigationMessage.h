...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x00400000008cb854
- (void).cxx_destruct;	// IMP=0x00200000008cbe90
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x00100000008cbd08
- (id)description;	// IMP=0x00100000008cbc59
- (id)dictionaryValue;	// IMP=0x00100000008cba89
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000008cb8a6
