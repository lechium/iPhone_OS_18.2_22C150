...
- (void).cxx_destruct;	// IMP=0x002000000088a782
...
- (double)minimumDurationForOutput:(unsigned long long)arg1;	// IMP=0x001000000088a72b
- (void)timerFired:(id)arg1;	// IMP=0x001000000088a6fa
- (void)updateOutput;	// IMP=0x001000000088a6c9
