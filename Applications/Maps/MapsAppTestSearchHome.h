...
- (void).cxx_destruct;	// IMP=0x0020000000ccfcbd
...
- (void)runScrollTest;	// IMP=0x0010000000ccf9c9
- (void)continueAfterCollectingDataFromDataFetchers;	// IMP=0x0010000000ccf919
- (void)didUpdateDataFetcher:(id)arg1;	// IMP=0x0010000000ccf78d
- (_Bool)runTest;	// IMP=0x0010000000ccf3fa
- (id)initWithApplication:(id)arg1 testName:(id)arg2 options:(id)arg3;	// IMP=0x0010000000ccf39d
