...
- (void).cxx_destruct;	// IMP=0x0020000000e5a74f
@property(retain, nonatomic) NSUUID *updateIdentifier; // @synthesize updateIdentifier=_updateIdentifier;
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0010000000e5a699
@property(nonatomic) __weak UIImage *image;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000e5a4e1
