...
- (void).cxx_destruct;	// IMP=0x0020000000780c38
...
- (void)recordItemInHistoryWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000007806d0
- (void)recordItemInHistory;	// IMP=0x00100000007806bc
- (id)initWithTicket:(id)arg1 searchResults:(id)arg2 auxiliaryControlsOrigin:(long long)arg3 hasRefinedMapItems:(_Bool)arg4 tracksRAPReportingOnly:(_Bool)arg5 completionTitle:(id)arg6;	// IMP=0x001000000078056c
