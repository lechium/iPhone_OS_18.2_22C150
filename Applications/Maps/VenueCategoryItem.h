...
- (void).cxx_destruct;	// IMP=0x002000000084a5a3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000084a392
- (id)initWithSearchCategory:(id)arg1 venueIdentifier:(id)arg2 displayMode:(int)arg3 isAutoCompleteCategory:(_Bool)arg4 shouldFrameMapViewport:(_Bool)arg5;	// IMP=0x001000000084a2de
