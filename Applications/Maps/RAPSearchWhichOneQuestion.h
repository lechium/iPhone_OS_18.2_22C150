...
- (void).cxx_destruct;	// IMP=0x002000000031354e
...
- (_Bool)_hasSearchRelatedFollowupQuestion;	// IMP=0x00100000003134b4
- (void)_fillSubmissionParameters:(id)arg1;	// IMP=0x0010000000312f2a
- (id)_alternateAuxiliaryControlsRecording;	// IMP=0x0010000000312eda
- (_Bool)_isRecursivelyComplete;	// IMP=0x0010000000312e86
- (_Bool)isComplete;	// IMP=0x0010000000312e71
