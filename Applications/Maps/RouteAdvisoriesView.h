...
- (void).cxx_destruct;	// IMP=0x0020000000cc2ff6
...
- (void)refreshContent;	// IMP=0x0010000000cc26af
- (void)_logAnalyticsIfNeeded;	// IMP=0x0010000000cc244d
- (void)setAdvisories:(id)arg1 coordinator:(id)arg2;	// IMP=0x0010000000cc2363
@property(readonly, nonatomic) _Bool isVisible;
- (void)setOverrideTextColor:(id)arg1 isSelected:(_Bool)arg2;	// IMP=0x0010000000cc20c8
- (void)setupSubViews;	// IMP=0x0010000000cc1c93
- (void)didMoveToWindow;	// IMP=0x0010000000cc1c25
- (id)init;	// IMP=0x0010000000cc1bc2
