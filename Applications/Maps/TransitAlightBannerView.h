...
- (void).cxx_destruct;	// IMP=0x0020000000557274
- (void)wasDismissedByUser;	// IMP=0x001000000055724e
@property(readonly, nonatomic) unsigned long long bannerType;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0010000000557054
- (void)updateFromBannerItem;	// IMP=0x0010000000556bca
- (id)initWithTarget:(id)arg1 item:(id)arg2 aperturePresentation:(_Bool)arg3;	// IMP=0x00100000005565b6
