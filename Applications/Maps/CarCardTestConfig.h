...
@interface CarCardTestConfig : NSObject
{
    ...
    CDStruct_035a826d _layout;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x0020000000e3431c
...
@property(readonly, nonatomic) CDStruct_035a826d layout; // @synthesize layout=_layout;
- (id)description;	// IMP=0x0010000000e33b81
- (id)initWithNotification:(id)arg1;	// IMP=0x0010000000e33723
