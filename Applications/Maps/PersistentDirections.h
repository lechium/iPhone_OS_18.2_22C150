...
- (void).cxx_destruct;	// IMP=0x0020000000c70327
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000c70058
- (unsigned long long)hash;	// IMP=0x0010000000c6ff66
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c6fdaa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000c6fc16
- (void)copyTo:(id)arg1;	// IMP=0x0010000000c6faf3
- (void)writeTo:(id)arg1;	// IMP=0x0010000000c6f9e8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000c6f726
- (id)dictionaryRepresentation;	// IMP=0x0010000000c6f4d3
- (id)description;	// IMP=0x0010000000c6f424
