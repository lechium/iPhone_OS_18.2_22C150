...
- (void).cxx_destruct;	// IMP=0x0020000000bb6a84
...
- (void)_parseComponents;	// IMP=0x0010000000bb6468
@property(readonly, nonatomic) NSString *displayString;
- (void)_parseSubtitutes;	// IMP=0x0010000000bb6051
- (id)initWithResultDisplayHeader:(id)arg1 substitutes:(id)arg2 visibleTime:(double)arg3 showCloseButton:(_Bool)arg4;	// IMP=0x0010000000bb5f68
