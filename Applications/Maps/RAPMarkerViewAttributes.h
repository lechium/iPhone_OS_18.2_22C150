...
- (void).cxx_destruct;	// IMP=0x0020000000d1e943
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000d1e8a5
- (id)initWithTitle:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x0010000000d1e7ec
