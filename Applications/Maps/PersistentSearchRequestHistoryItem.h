...
- (void).cxx_destruct;	// IMP=0x0020000000c9eab9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000c9e7db
- (unsigned long long)hash;	// IMP=0x0010000000c9e162
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c9def2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000c9dd0e
- (void)copyTo:(id)arg1;	// IMP=0x0010000000c9db81
- (void)writeTo:(id)arg1;	// IMP=0x0010000000c9d9f1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000c9d9e4
- (id)dictionaryRepresentation;	// IMP=0x0010000000c9d1b6
- (id)description;	// IMP=0x0010000000c9d107
