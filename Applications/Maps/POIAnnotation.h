...
- (void).cxx_destruct;	// IMP=0x0020000000e35e9d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000e35d62
- (id)debugDictionary;	// IMP=0x0010000000e35be4
@property(readonly, nonatomic) _Bool isMarkedLocation;
...
- (id)feature;	// IMP=0x0010000000e35a34
- (id)initWithItem:(id)arg1 defaultLocale:(id)arg2;	// IMP=0x0010000000e345fe
