...
- (id)initWithWalkingSegment:(id)arg1 stepIndexRange:(struct _NSRange)arg2;	// IMP=0x001000000075ea92
- (id)initWithStep:(id)arg1 stepIndexRange:(struct _NSRange)arg2;	// IMP=0x001000000075e97c
