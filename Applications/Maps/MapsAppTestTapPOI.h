...
- (void).cxx_destruct;	// IMP=0x0020000000aa756e
...
- (void)scrollPlacecardTest;	// IMP=0x0010000000aa7013
- (void)didShowWebModule;	// IMP=0x0010000000aa6e94
- (void)didShowPlaceCard;	// IMP=0x0010000000aa6d45
- (void)tapPOI;	// IMP=0x0010000000aa66b6
- (void)didFinishJumping;	// IMP=0x0010000000aa65a7
- (_Bool)runTest;	// IMP=0x0010000000aa63cf
- (id)initWithApplication:(id)arg1 testName:(id)arg2 options:(id)arg3;	// IMP=0x0010000000aa6146
