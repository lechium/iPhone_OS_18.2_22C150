...
+ (id)title;	// IMP=0x00400000002d2d3c
+ (id)personalizedItemKey;	// IMP=0x00100000002d2767
- (void).cxx_destruct;	// IMP=0x00200000002d3062
...
- (void)updateFromVehicleEvent:(id)arg1 geoMapItem:(id)arg2;	// IMP=0x00100000002d28ea
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1;	// IMP=0x00100000002d2835
- (id)initWithVehicleEvent:(id)arg1 geoMapItem:(id)arg2;	// IMP=0x00100000002d2782
- (id)init;	// IMP=0x00100000002d2774
