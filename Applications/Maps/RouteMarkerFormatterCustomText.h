...
- (void).cxx_destruct;	// IMP=0x0020000000553949
...
- (id)markerInfoForRoute:(id)arg1;	// IMP=0x0010000000553839
- (id)initWithRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2 customSelectedRouteText:(id)arg3;	// IMP=0x0010000000553775
