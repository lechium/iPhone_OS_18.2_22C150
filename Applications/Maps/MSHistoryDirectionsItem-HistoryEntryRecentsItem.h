...
@interface MSHistoryDirectionsItem (HistoryEntryRecentsItem)
- (void)ifSearch:(CDUnknownBlockType)arg1 ifRoute:(CDUnknownBlockType)arg2 ifPlaceDisplay:(CDUnknownBlockType)arg3 ifTransitLineItem:(CDUnknownBlockType)arg4;	// IMP=0x00200000008f5975
@property(readonly, nonatomic) NSData *archivedSharedTripData;
@property(readonly, nonatomic) _Bool navigationWasInterrupted;
- (id)routeInformationSource;	// IMP=0x00100000008f591b
