...
+ (MISSING_TYPE *)identifier;	// IMP=0x0040000000c9fdce
- (void).cxx_destruct;	// IMP=0x0020000000ca0bbf
...
- (void)setTitle:(id)arg1;	// IMP=0x0010000000ca09f8
- (void)setImage:(id)arg1;	// IMP=0x0010000000ca098f
- (void)prepareForReuse;	// IMP=0x0010000000ca08ea
- (_Bool)canBecomeFirstResponder;	// IMP=0x0010000000ca05b2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000c9fde0
