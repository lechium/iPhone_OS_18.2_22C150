...
- (void).cxx_destruct;	// IMP=0x00200000008b526e
...
- (id)description;	// IMP=0x00100000008b518e
- (id)initWithApplication:(id)arg1 optionName:(id)arg2 paymentMethods:(id)arg3 estimatedPickupDate:(id)arg4 passengersChoice:(id)arg5;	// IMP=0x00100000008b5016
