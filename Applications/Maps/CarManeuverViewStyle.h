...
@interface CarManeuverViewStyle : NSObject
{
    ...
    long long _alignmentStyle;	// 40 = 0x28
    unsigned long long _compressionStage;	// 48 = 0x30
}

+ (id)styleWithVariant:(unsigned long long)arg1 destination:(unsigned long long)arg2 layoutType:(unsigned long long)arg3;	// IMP=0x0020000000d104bb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000d10b94
...
- (_Bool)_isDisplayedInWidget;	// IMP=0x0010000000d10514
@property(readonly, nonatomic) _Bool displaysShield;
- (id)initWithVariant:(unsigned long long)arg1 destination:(unsigned long long)arg2 layoutType:(unsigned long long)arg3;	// IMP=0x0010000000d10461
