...
- (void).cxx_destruct;	// IMP=0x0020000000be1cef
...
- (id)markerInfoForRoute:(id)arg1;	// IMP=0x0010000000be1b90
- (id)initWithRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2;	// IMP=0x0010000000be1b12
