...
- (void).cxx_destruct;	// IMP=0x0020000000809099
@property(readonly, nonatomic) RideBookingPlanningSession *session; // @synthesize session=_session;
- (void)_addOriginDestinationToPlan:(id)arg1;	// IMP=0x0010000000808e1c
- (id)buildDirectionsPlan;	// IMP=0x0010000000808a79
- (id)initWithRideBookingPlanningSession:(id)arg1;	// IMP=0x0010000000808a0e
