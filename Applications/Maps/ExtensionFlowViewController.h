...
- (void).cxx_destruct;	// IMP=0x0020000000855a26
...
- (void)setupHeaderView;	// IMP=0x00100000008557a9
- (void)_setMaskOnNavigationBar:(id)arg1;	// IMP=0x0010000000855597
- (void)setupContainerViewWithRootViewController:(id)arg1;	// IMP=0x001000000085508c
- (void)setScrollContentOffset:(struct CGPoint)arg1;	// IMP=0x001000000085502e
- (void)popViewController;	// IMP=0x0010000000854fe4
- (_Bool)viewControllerUseExtensionFlowHeader:(id)arg1;	// IMP=0x0010000000854f7b
- (void)pushViewController:(id)arg1;	// IMP=0x0010000000854c84
- (void)handleDismissAction:(id)arg1;	// IMP=0x0010000000854aeb
- (void)viewDidLoad;	// IMP=0x0010000000854a13
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000854904
- (id)init;	// IMP=0x00100000008548ee
