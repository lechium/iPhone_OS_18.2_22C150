...
@class CyclePreferences, DirectionItem, DrivePreferences, GEOAdvisoriesInfo, GEOComposedRoute, GEORouteDisplayHints, NSArray, NSString, NSUUID, RideBookingRideOptionStateObserverProxy, RouteCollection, RoutePlanningError, RoutePlanningTiming, RoutePlanningWaypointRequest, TransitPreferences, VGVirtualGarage, WalkPreferences, WaypointSet;
...
- (void)updateCurrentRoute:(GEOComposedRoute *)arg1;
@end
