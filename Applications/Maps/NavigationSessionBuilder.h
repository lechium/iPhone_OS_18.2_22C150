...
- (void).cxx_destruct;	// IMP=0x0020000000ba318b
...
- (id)build;	// IMP=0x0010000000ba2eb4
- (id)initWithRouteCollection:(id)arg1 navigationDetailsOptions:(struct NavigationDetailsOptions)arg2 mapServiceTraits:(id)arg3 sessionInitiator:(unsigned long long)arg4 isResumingMultipointRoute:(_Bool)arg5 tracePlaybackPath:(id)arg6;	// IMP=0x0010000000ba2da0
