...
- (void).cxx_destruct;	// IMP=0x0020000000ca1626
@property(readonly, nonatomic) NavManeuverSignView *navSignView; // @synthesize navSignView=_navSignView;
- (void)prepareForReuse;	// IMP=0x0010000000ca15cc
- (void)_configureConstraints;	// IMP=0x0010000000ca12dd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000ca117b
