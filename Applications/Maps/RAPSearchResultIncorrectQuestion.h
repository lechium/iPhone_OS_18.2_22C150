...
+ (id)localizedTitleForResultCount:(unsigned long long)arg1;	// IMP=0x0020000000313cdb
- (void).cxx_destruct;	// IMP=0x0020000000313e93
- (id)localizedPhotosPickerExplanation;	// IMP=0x0010000000313e82
...
- (id)initWithReport:(id)arg1 parentQuestion:(id)arg2 searchResultsCount:(unsigned long long)arg3;	// IMP=0x0010000000313d5e
