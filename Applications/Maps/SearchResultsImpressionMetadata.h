...
- (void).cxx_destruct;	// IMP=0x0020000000b24fed
...
- (id)initWithResultIndex:(unsigned long long)arg1 businessId:(unsigned long long)arg2 localSearchProviderId:(unsigned int)arg3 query:(id)arg4;	// IMP=0x0010000000b24eef
