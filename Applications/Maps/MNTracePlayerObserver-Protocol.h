...
@class CLHeading, GEOComposedRoute, GEOComposedWaypoint, GEODirectionsRequest, GEODirectionsResponse, MISSING_TYPE, MNLocation, MNTraceNetworkEvent, MNTracePlayer, NSArray, NSDate, NSError, VGVehicle;
...
- (MISSING_TYPE *)tracePlayerDidStop: /* Error: Ran out of types for this method. */;
