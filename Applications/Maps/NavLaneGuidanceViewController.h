...
- (void).cxx_destruct;	// IMP=0x0020000000670de7
...
- (void)_insertBackgroundView;	// IMP=0x0010000000670bda
- (void)_updateLaneGuidanceAnimated:(_Bool)arg1;	// IMP=0x00100000006709c0
- (void)navigationService:(id)arg1 hideLaneDirectionsForId:(id)arg2;	// IMP=0x001000000067098b
- (void)navigationService:(id)arg1 showLaneDirections:(id)arg2;	// IMP=0x001000000067086b
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0010000000670664
@property(readonly, nonatomic) _Bool hasLaneGuidance;
- (void)pressedLaneGuidance;	// IMP=0x00100000006703e6
- (void)viewDidLoad;	// IMP=0x001000000066ff96
- (id)initWithDelegate:(id)arg1 blurGroup:(id)arg2;	// IMP=0x001000000066fe71
- (_Bool)_canShowWhileLocked;	// IMP=0x001000000066fe69
