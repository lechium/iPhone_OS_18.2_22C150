...
- (void).cxx_destruct;	// IMP=0x0020000000bb8b49
...
- (void);	// IMP=0x0010000000bb87c6
- (void)addFullyDrawnCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000bb8667
- (void)stepZoomCompleted;	// IMP=0x0010000000bb8655
- (void)stepLoadCompleted:(id)arg1;	// IMP=0x0010000000bb83b3
- (void)runStepZoomTest:(double)arg1;	// IMP=0x0010000000bb7eae
- (_Bool)runTest;	// IMP=0x0010000000bb7c19
- (long long)_zoomAmount;	// IMP=0x0010000000bb7bf0
- (double)_regionSizeForZoom:(double)arg1;	// IMP=0x0010000000bb7bcd
- (id)initWithApplication:(id)arg1 testName:(id)arg2 options:(id)arg3;	// IMP=0x0010000000bb7a53
