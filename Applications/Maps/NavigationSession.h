...
- (void).cxx_destruct;	// IMP=0x0020000000547330
...
- (void)routeCollectionUpdateProvider:(id)arg1 didUpdateRouteCollection:(id)arg2;	// IMP=0x0010000000547146
- (void)navigationService:(id)arg1 didSwitchToNewTransportType:(int)arg2 newRoute:(id)arg3 traffic:(id)arg4;	// IMP=0x00100000005470dc
- (void)navigationService:(id)arg1 didFinishLoadingTrace:(id)arg2;	// IMP=0x00100000005470c7
- (void)navigationStateProvider:(id)arg1 didChangeNavigationState:(unsigned long long)arg2;	// IMP=0x0010000000546ddb
- (void)_retryAutomaticSharing:(id)arg1;	// IMP=0x0010000000546ca2
- (void)_scheduleAutomaticSharingRetry:(unsigned long long)arg1;	// IMP=0x0010000000546b13
- (void)_startAutomaticETASharingIfNeeded:(unsigned long long)arg1;	// IMP=0x001000000054637d
- (void)cleanupStateReplay;	// IMP=0x0010000000546340
- (void)replayCurrentState;	// IMP=0x0010000000546285
- (void)prepareToReplayCurrentState;	// IMP=0x0010000000546248
- (void)suspendWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000545f88
- (void)resume;	// IMP=0x0010000000545c5b
- (void)removeObserver:(id)arg1;	// IMP=0x0010000000545b69
- (void)addObserver:(id)arg1;	// IMP=0x0010000000545a77
...
- (void)dealloc;	// IMP=0x00100000005453e6
- (id)initWithInitiator:(unsigned long long)arg1 configuration:(id)arg2 navigationService:(id)arg3;	// IMP=0x0010000000544f81
- (id)initWithInitiator:(unsigned long long)arg1 configuration:(id)arg2;	// IMP=0x0010000000544efd
- (void)selectRoute:(id)arg1;	// IMP=0x001000000039866c
