...
+ (void)loadAllSearchesFromStorage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0020000000b1e3ec
- (void).cxx_destruct;	// IMP=0x0020000000b1ebbd
...
- (id)geoMapItemForSearchResultAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000b1ead2
@property(readonly, nonatomic) unsigned long long searchResultsCount;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000b1ea7a
@property(readonly, nonatomic) id <RAPAuxiliaryControlsRecording> auxiliaryControlsRecording;
- (void)applyToCorrectedSearch:(id)arg1;	// IMP=0x0010000000b1ea5b
- (id)initWithHistoryItem:(id)arg1 correctedSearchTemplate:(id)arg2 auxiliaryControls:(id)arg3 originatingIndex:(unsigned long long)arg4;	// IMP=0x0010000000b1e8a4
