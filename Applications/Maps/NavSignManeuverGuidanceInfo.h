...
+ (id)updatedGuidanceWithPreviousGuidance:(id)arg1 currentGuidance:(id)arg2;	// IMP=0x0040000000292df4
- (void).cxx_destruct;	// IMP=0x002000000029402f
...
- (void)_setNeedsChangeNotification;	// IMP=0x0010000000293d5f
- (void)_notifyObserversWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000293c28
- (id)description;	// IMP=0x00100000002935c9
- (void)removeGuidanceObserver:(id)arg1;	// IMP=0x00100000002935b3
- (void)addGuidanceObserver:(id)arg1;	// IMP=0x001000000029359d
- (_Bool)matchesManeuver:(int)arg1 minorTextAlternatives:(id)arg2;	// IMP=0x001000000029349b
- (_Bool)matchesManeuver:(int)arg1 minorTextAlternatives:(id)arg2 shieldInfo:(id)arg3;	// IMP=0x0010000000293308
@property(retain, nonatomic) MKServerFormattedString *minorText;
@property(retain, nonatomic) MKServerFormattedString *majorText;
- (id)initWithSignID:(id)arg1 maneuverArtwork:(id)arg2 majorTextAlternatives:(id)arg3 minorTextAlternatives:(id)arg4 shieldInfo:(id)arg5;	// IMP=0x0010000000292f74
