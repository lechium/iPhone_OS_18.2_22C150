...
+ (id)keyForVenue:(id)arg1 building:(id)arg2 floorOrdinal:(id)arg3;	// IMP=0x0020000000750ef1
- (void).cxx_destruct;	// IMP=0x0020000000751367
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000751124
- (unsigned long long)hash;	// IMP=0x001000000075101e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000751013
- (id)initWithVenueID:(unsigned long long)arg1 buildingID:(id)arg2 levelID:(id)arg3 floorOrdinal:(id)arg4;	// IMP=0x0010000000750e06
