...
+ (id)edgeConstraintsWithTop:(id)arg1 left:(id)arg2 bottom:(id)arg3 right:(id)arg4;	// IMP=0x00400000003074a6
+ (id)edgeConstraintsWithTop:(id)arg1 leading:(id)arg2 bottom:(id)arg3 trailing:(id)arg4;	// IMP=0x00100000003073c9
- (void).cxx_destruct;	// IMP=0x0020000000307849
