...
- (void).cxx_destruct;	// IMP=0x002000000069e4df
...
- (void)_setupResultWithRAPInfos:(id)arg1;	// IMP=0x001000000069e244
- (id)initWithRAPInfos:(id)arg1;	// IMP=0x001000000069e1c6
