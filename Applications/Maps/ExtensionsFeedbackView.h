...
- (void).cxx_destruct;	// IMP=0x00200000008d78e9
...
- (void)configureTippingViewWithDelegate:(id)arg1;	// IMP=0x00100000008d7761
- (void)configureSubmitButtonTitle:(id)arg1;	// IMP=0x00100000008d75e1
- (void)configureHeaderImage:(id)arg1;	// IMP=0x00100000008d7594
- (void)_submitTapped:(id)arg1;	// IMP=0x00100000008d755e
- (void)_updateSubmitButton;	// IMP=0x00100000008d74dd
- (void)_updateConstraints;	// IMP=0x00100000008d70a2
- (void)updateTheme;	// IMP=0x00100000008d7034
- (void)_commonInit;	// IMP=0x00100000008d6cb7
- (id)initWithSubmitHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000008d6c11
