...
- (void).cxx_destruct;	// IMP=0x0020000000e75606
...
- (void)didChangeProtectionStatusForBundleId:(id)arg1;	// IMP=0x0010000000e7546e
- (void)updateSessionAsInstallCompletedIfNeeded:(id)arg1;	// IMP=0x0010000000e75468
- (id)reservationExtensionFlowViewController;	// IMP=0x0010000000e75383
- (id)alertControllerForExtensionPermission;	// IMP=0x0010000000e74e8a
- (id)alertControllerForLockedExtension;	// IMP=0x0010000000e74aa5
- (void)requester:(id)arg1 userCurrentBookingRequestDidFailWithError:(id)arg2;	// IMP=0x0010000000e74991
- (void)requesterUserCurrentBookingRequestDidComplete:(id)arg1;	// IMP=0x0010000000e746ed
- (void)discoverActiveReservationEvents;	// IMP=0x0010000000e74677
- (void)discoverGuest;	// IMP=0x0010000000e7463a
- (void)discoverAvailableBookings;	// IMP=0x0010000000e74418
- (void)requesterReservationDefaultsRequestDidComplete:(id)arg1;	// IMP=0x0010000000e74358
- (void)discoverDefaults;	// IMP=0x0010000000e7431b
- (void)resolve;	// IMP=0x0010000000e74138
- (id)initWithExtension:(id)arg1 appStoreApp:(id)arg2 mapItem:(id)arg3 presenter:(id)arg4;	// IMP=0x0010000000e74016
