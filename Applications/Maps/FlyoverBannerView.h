...
- (void).cxx_destruct;	// IMP=0x0020000000e567d7
...
- (void)stopButtonPressed;	// IMP=0x0010000000e566de
- (struct CGSize)intrinsicContentSize;	// IMP=0x0010000000e56480
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000e55bdf
