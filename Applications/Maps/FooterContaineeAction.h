...
@interface FooterContaineeAction
{
    ...
    long long _cellStyle;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x00200000008394ef
...
- (id)accessibilityIdentifierForAction;	// IMP=0x0010000000839460
- (void)loadSubtitleWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000839445
