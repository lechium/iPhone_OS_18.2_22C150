...
- (void).cxx_destruct;	// IMP=0x0020000000e7d6c2
...
- (id)description;	// IMP=0x0010000000e7d4af
- (id)dictionaryValue;	// IMP=0x0010000000e7d27f
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000e7d0f0
