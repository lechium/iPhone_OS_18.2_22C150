...
- (void).cxx_destruct;	// IMP=0x0020000000a9f769
...
- (void)_didTapActionButton:(id)arg1;	// IMP=0x0010000000a9f670
- (void)_didTapCancelButton:(id)arg1;	// IMP=0x0010000000a9f624
@property(nonatomic) _Bool progressBarHidden;
@property(nonatomic) double completionProgress;
- (void)confirmButtonTitlesetCompletionProgress:(double)arg1;	// IMP=0x0010000000a9f4a8
...
- (id)_initialConstraints;	// IMP=0x0010000000a9ebc8
- (void)_customInit;	// IMP=0x0010000000a9e6fe
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000a9e6a0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000a9e631
