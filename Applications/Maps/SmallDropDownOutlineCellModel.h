...
- (void).cxx_destruct;	// IMP=0x0020000000dc7b82
...
- (_Bool)needsReloadFromPreviousViewModel:(id)arg1;	// IMP=0x0010000000dc7b2f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000dc796e
@property(readonly) unsigned long long hash;
- (id)initWithButtonTitle:(id)arg1 dropDownTitles:(id)arg2 selectedIndex:(long long)arg3 delegate:(id)arg4 backgroundModel:(id)arg5;	// IMP=0x0010000000dc782c
