...
- (void).cxx_destruct;	// IMP=0x002000000092e6f9
...
- (id)sourceWithType:(int)arg1;	// IMP=0x001000000092e608
- (void)addSource:(id)arg1;	// IMP=0x001000000092e44a
- (_Bool)hasObjectWithType:(int)arg1;	// IMP=0x001000000092e3fb
- (id)initWithCurrentLocation:(_Bool)arg1 parkedCar:(_Bool)arg2 personalizedItems:(_Bool)arg3;	// IMP=0x001000000092e205
- (id)init;	// IMP=0x001000000092e1e3
