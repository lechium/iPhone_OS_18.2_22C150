...
- (void).cxx_destruct;	// IMP=0x0020000000eb5e50
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0010000000eb5dfd
- (void)updateFromBannerItem;	// IMP=0x0010000000eb5a53
- (id)initWithTarget:(id)arg1 item:(id)arg2 aperturePresentation:(_Bool)arg3;	// IMP=0x0010000000eb4f5a
