...
- (void).cxx_destruct;	// IMP=0x002000000086f980
...
- (void)_incrementPriority;	// IMP=0x001000000086f612
- (void);	// IMP=0x001000000086f59f
- (void)_dismiss;	// IMP=0x001000000086f553
- (void)_decreaseHeight;	// IMP=0x001000000086f51d
- (void)_increaseHeight;	// IMP=0x001000000086f4e7
- (void)viewDidLayoutSubviews;	// IMP=0x001000000086f254
- (void)_updateLabel;	// IMP=0x001000000086f108
- (id)_buttonWithTitle:(id)arg1;	// IMP=0x001000000086f001
- (void)viewDidLoad;	// IMP=0x001000000086d6d4
- (id)init;	// IMP=0x001000000086d683
