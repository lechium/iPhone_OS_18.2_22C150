...
@class AddressBookAddress, AutocompleteMatchInfo, GEOEnhancedPlacement, GEOLabelGeometry, GEOServerResultScoreMetadata, MKMapItem, MapsLocationOfInterest, NSArray, NSDate, NSSet, NSString, ParkedCar, PersonalizedItemClientFeatureIDAdornment, PersonalizedItemPrioritizedStringAdornment, PersonalizedItemSource, PersonalizedItemStyleAttributesAdornment, SearchResult, TrafficIncidentReport, VKLabelMarker;
...
+ (id)keysForServerCompletion:(id)arg1;	// IMP=0x0020000000396821
- (void).cxx_destruct;	// IMP=0x0020000000397084
...
- (id)leafPersonalizedAutocompleteItems;	// IMP=0x0010000000396f94
...
- (id)_searchItemForString:(id)arg1;	// IMP=0x0010000000396d53
- (id)initWithPersonalizedItem:(id)arg1 matchInfo:(id)arg2;	// IMP=0x00100000003965c0
- (id)initWithLocalCompletion:(id)arg1 sourceType:(long long)arg2 sourceSubtype:(long long)arg3 matchInfo:(id)arg4;	// IMP=0x00100000003965a0
- (id)initWithLocalCompletion:(id)arg1 sourceType:(long long)arg2 sourceSubtype:(long long)arg3 hasPriorityOverride:(_Bool)arg4 priorityOverride:(long long)arg5 matchInfo:(id)arg6;	// IMP=0x001000000039583d
- (id)initWithServerCompletion:(id)arg1 hasPriorityOverride:(_Bool)arg2 priorityOverride:(long long)arg3 serverResultScoreMetadata:(id)arg4;	// IMP=0x0010000000395696
- (id)init;	// IMP=0x0010000000395688
