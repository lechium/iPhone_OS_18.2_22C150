...
- (void).cxx_destruct;	// IMP=0x0020000000767a3a
...
- (id)initWithNumberOfPages:(long long)arg1 routeStepCells:(id)arg2 routeStepCalloutCells:(id)arg3;	// IMP=0x001000000076793c
