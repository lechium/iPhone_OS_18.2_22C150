...
+ (id)libraryCenteredConfiguration;	// IMP=0x0040000000ba8ec2
+ (id)routePlanningTimingPickerConfiguration;	// IMP=0x0010000000ba8e4e
+ (id)leadingInsetConfiguration;	// IMP=0x0010000000ba8e26
+ (id)popoverCardHeaderConfiguration;	// IMP=0x0010000000ba8b41
+ (id)leadingNavigationModalCardHeaderCompactConfiguration;	// IMP=0x0010000000ba8a3d
+ (id)navigationModalCardHeaderCompactConfiguration;	// IMP=0x0010000000ba88ff
+ (id)navigationModalCardHeaderConfiguration;	// IMP=0x0010000000ba87c1
+ (id)leadingAlignedTitleModalCardHeaderConfiguration;	// IMP=0x0010000000ba87a3
+ (id)defaultModalCardHeaderConfiguration;	// IMP=0x0010000000ba84c2
- (void).cxx_destruct;	// IMP=0x0020000000ba8fae
