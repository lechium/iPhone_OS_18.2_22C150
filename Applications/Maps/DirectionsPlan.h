...
+ (Class)handlesForSharingETAType;	// IMP=0x0020000000886860
+ (Class)planningWaypointType;	// IMP=0x001000000088678e
+ (id)_maps_expiryDateForRoute:(id)arg1;	// IMP=0x0010000000398382
- (void).cxx_destruct;	// IMP=0x002000000088a058
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000889942
- (unsigned long long)hash;	// IMP=0x0010000000889328
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000888e36
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000008887f0
- (void)copyTo:(id)arg1;	// IMP=0x00100000008883fa
- (void)writeTo:(id)arg1;	// IMP=0x0010000000887f05
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000887ef8
- (id)dictionaryRepresentation;	// IMP=0x0010000000886935
- (id)description;	// IMP=0x0010000000886886
@property(readonly, nonatomic) _Bool hasCompanionRouteContextData;
- (id)handlesForSharingETAAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000886843
- (unsigned long long)handlesForSharingETAsCount;	// IMP=0x0010000000886826
- (void)addHandlesForSharingETA:(id)arg1;	// IMP=0x00100000008867bc
- (void)clearHandlesForSharingETAs;	// IMP=0x001000000088679f
- (id)planningWaypointAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000886771
- (unsigned long long)planningWaypointsCount;	// IMP=0x0010000000886754
- (void)addPlanningWaypoint:(id)arg1;	// IMP=0x00100000008866ea
- (void)clearPlanningWaypoints;	// IMP=0x00100000008866cd
...
- (int)StringAsTransitPrioritization:(id)arg1;	// IMP=0x0010000000886446
- (id)transitPrioritizationAsString:(int)arg1;	// IMP=0x00100000008863fd
...
- (int)StringAsDisplayMethod:(id)arg1;	// IMP=0x0010000000886163
- (id)displayMethodAsString:(int)arg1;	// IMP=0x001000000088611a
