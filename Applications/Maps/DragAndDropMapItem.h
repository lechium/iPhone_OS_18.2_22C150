...
+ (long long)itemProviderVisibilityForRepresentationWithTypeIdentifier:(id)arg1;	// IMP=0x0020000000258510
+ (id)writableTypeIdentifiersForItemProvider;	// IMP=0x00100000002583db
+ (id)dragAndDropItemWithObject:(id)arg1;	// IMP=0x00100000002571fc
- (void).cxx_destruct;	// IMP=0x0020000000258c4a
...
- (id)traitsForMapItemResolver:(id)arg1;	// IMP=0x0010000000258b66
- (id)loadDataWithTypeIdentifier:(id)arg1 forItemProviderCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000258518
@property(readonly, nonatomic) NSItemProvider *itemProvider;
@property(readonly, nonatomic) id <NSItemProviderWriting> itemProviderWriting;
- (void)_resolveMapItem;	// IMP=0x0010000000257f4d
- (void)_didResolveMapItem:(id)arg1;	// IMP=0x0010000000257ed4
- (id)initWithPersonalizedItem:(id)arg1;	// IMP=0x0010000000257cb2
- (id)initWithRecentContact:(id)arg1;	// IMP=0x0010000000257bfa
- (id)initWithAddress:(id)arg1;	// IMP=0x0010000000257aec
- (id)initWithMapItem:(id)arg1;	// IMP=0x0010000000257a10
- (id)initWithLabelMarker:(id)arg1;	// IMP=0x001000000025783d
- (id)init;	// IMP=0x0010000000257812
