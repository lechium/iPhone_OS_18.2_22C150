...
- (void).cxx_destruct;	// IMP=0x0020000000072dc3
...
- (void)completeTransition:(_Bool)arg1;	// IMP=0x0010000000072b76
@property(readonly, nonatomic) long long semanticContentAttribute;
- (id)init;	// IMP=0x0010000000072adb
- (id)initWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000072a68
