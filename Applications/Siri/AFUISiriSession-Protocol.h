...
@class AFMetrics, AFSpeechSynthesisRecord, AFUserUtteranceSelectionResults, AceObject, MISSING_TYPE, NSDictionary, NSString, NSUUID, SABaseClientBoundCommand, SASRequestOptions;
...
- (MISSING_TYPE *)forceAudioSessionActiveWithCompletion: /* Error: Ran out of types for this method. */;
