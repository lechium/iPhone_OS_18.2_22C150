...
- (void).cxx_destruct;	// IMP=0x0020000000042694
@property(readonly, copy, nonatomic) SRCompactKeyboardAnimation *animation; // @synthesize animation=_animation;
@property(readonly, nonatomic) struct CGRect frame; // @synthesize frame=_frame;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000042667
@property(readonly, nonatomic) struct CGRect frameForAnimation;
- (id)initWithKeyboardNotification:(id)arg1;	// IMP=0x0010000000042259
- (id)initWithFrame:(struct CGRect)arg1 animation:(id)arg2;	// IMP=0x00100000000421d9
