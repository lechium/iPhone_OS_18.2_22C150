...
@class AFConversation, AFDialogPhase, AceObject, MISSING_TYPE, NSArray, NSIndexPath, NSString, NSURL, NSUUID, SAUIListItem, SRUIFSiriSessionInfo;
...
- (MISSING_TYPE *)domainObjectStoreForSiriPresentation: /* Error: Ran out of types for this method. */;
