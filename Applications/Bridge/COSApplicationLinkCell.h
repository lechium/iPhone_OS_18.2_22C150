...
- (void).cxx_destruct;	// IMP=0x0020000000028ff2
...
- (void)updateProgress:(id)arg1;	// IMP=0x0010000000028d7b
- (id)cachedInstalledProgressByAppID;	// IMP=0x0010000000028d26
- (void)refreshCellContentsWithSpecifier:(id)arg1;	// IMP=0x0010000000028899
- (void)layoutSubviews;	// IMP=0x0010000000027d45
- (void)stopInstallation;	// IMP=0x0010000000027ad1
- (void)installApp;	// IMP=0x00100000000271d8
- (void)installNanoBundle:(id)arg1 forDevice:(id)arg2;	// IMP=0x0010000000026de9
- (id)device;	// IMP=0x0010000000026ddf
- (void)dealloc;	// IMP=0x0010000000026d6a
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x0010000000026763
