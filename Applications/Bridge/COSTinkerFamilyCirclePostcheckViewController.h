...
+ (_Bool)controllerNeedsToRun;	// IMP=0x00200000000df534
- (void).cxx_destruct;	// IMP=0x00200000000e0717
...
- (id)holdActivityIdentifier;	// IMP=0x00100000000e0685
- (_Bool)controllerAllowsNavigatingBackTo;	// IMP=0x00100000000e067d
- (void)startPostCheck;	// IMP=0x00100000000dfb98
- (void)presentAlertAndFallbackToSignInForError:(id)arg1;	// IMP=0x00100000000df8d5
- (void)didEstablishHold;	// IMP=0x00100000000df5c1
- (id)localizedWaitScreenDescription;	// IMP=0x00100000000df555
- (double)waitScreenPushGracePeriod;	// IMP=0x00100000000df54c
- (_Bool)holdWithWaitScreen;	// IMP=0x00100000000df544
- (_Bool)holdBeforeDisplaying;	// IMP=0x00100000000df53c
