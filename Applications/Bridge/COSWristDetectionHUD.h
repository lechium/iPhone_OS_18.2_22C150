...
- (void).cxx_destruct;	// IMP=0x00200000000920da
...
- (void)updateWithSummary:(id)arg1;	// IMP=0x0010000000091e5b
- (void)updateWithConfidences:(id)arg1;	// IMP=0x00100000000918f2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000090f42
