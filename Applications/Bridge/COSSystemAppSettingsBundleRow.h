...
- (void).cxx_destruct;	// IMP=0x002000000013d33a
...
- (id)description;	// IMP=0x001000000013d181
- (_Bool)_requiredAppsInstalled:(id)arg1;	// IMP=0x001000000013ce85
- (_Bool)_removeRowForSpecialCriteriaOverride:(id)arg1;	// IMP=0x001000000013cdd5
- (void)setAreRequiredWatchAppsInstalled:(id)arg1;	// IMP=0x001000000013cce2
- (id)settingsBundleDict;	// IMP=0x001000000013c96a
- (void)_setRequiredInstalledWatchAppsForLegacy:(id)arg1;	// IMP=0x001000000013c8df
- (id)initWithBundle:(id)arg1 name:(id)arg2;	// IMP=0x001000000013c59e
