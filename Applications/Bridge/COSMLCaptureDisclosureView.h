...
- (void).cxx_destruct;	// IMP=0x00200000000aa039
...
- (void)tappedLearnMore:(id)arg1;	// IMP=0x00100000000a9d4d
- (void)layoutSubviews;	// IMP=0x00100000000a9b48
- (void)userToggledSwitch:(id)arg1;	// IMP=0x00100000000a9b13
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000a9659
