...
- (void).cxx_destruct;	// IMP=0x0020000000067b79
...
- (id)_gzipCompressData:(id)arg1;	// IMP=0x00100000000679a1
@property(readonly, nonatomic) NSData *gzipContent;
@property(readonly, nonatomic) NSString *mimeType;
- (id)initWithContent:(id)arg1 filename:(id)arg2 bucket:(id)arg3 gzip:(_Bool)arg4;	// IMP=0x0010000000067826
