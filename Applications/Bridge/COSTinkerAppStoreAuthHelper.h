...
+ (id)storeAccountWithDSID:(id)arg1 altDSID:(id)arg2 username:(id)arg3;	// IMP=0x0040000000145aa5
+ (id)satelliteStoreAccountForFamilyMember:(id)arg1;	// IMP=0x0010000000145980
- (void).cxx_destruct;	// IMP=0x00200000001462bd
...
- (void)authenticateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000145cab
- (id)initWithContext:(id)arg1;	// IMP=0x00100000001458b5
