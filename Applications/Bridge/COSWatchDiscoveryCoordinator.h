...
- (void).cxx_destruct;	// IMP=0x002000000003805a
...
- (id)_discoveredNetworkRelayWatch;	// IMP=0x0010000000037fa5
- (_Bool)_shouldAllowBailoutForDetectingNetworkRelayWatches;	// IMP=0x0010000000037da7
- (_Bool)_foundNearbyAdvertisingWatches;	// IMP=0x0010000000037b5c
- (void)_checkForDiscoveredUnpairedWatches:(id)arg1;	// IMP=0x0010000000037abe
- (void)_refreshWatchDiscoveryTimer;	// IMP=0x0010000000037a11
- (void)stopDiscoveringWatchNearby;	// IMP=0x00100000000379df
- (void)startDiscoveringWatchNearby;	// IMP=0x0010000000037980
