...
- (id)description;	// IMP=0x00100000000aac71
- (void)divideConfidencesBy:(long long)arg1;	// IMP=0x00100000000aac25
- (void)addConfidences:(id)arg1;	// IMP=0x00100000000aab2a
- (id)initWithObservationTime:(double)arg1;	// IMP=0x00100000000aaae7
- (id)initWithObservationTime:(double)arg1 none:(double)arg2 invalid:(double)arg3 lr:(double)arg4 ll:(double)arg5 rr:(double)arg6 rl:(double)arg7 palm:(double)arg8 dock:(double)arg9;	// IMP=0x00000000000aaa31
