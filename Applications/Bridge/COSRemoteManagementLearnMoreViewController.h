...
+ (id)defaultParagraphTextAttributes;	// IMP=0x0040000000134a00
- (void).cxx_destruct;	// IMP=0x0020000000135f2f
...
- (id)_descriptionText;	// IMP=0x001000000013550e
- (void)controllerDone:(id)arg1;	// IMP=0x00100000001354f5
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000013536e
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000134b3f
