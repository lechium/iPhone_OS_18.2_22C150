...
- (void).cxx_destruct;	// IMP=0x002000000006f02a
...
- (void)updateProgress:(unsigned long long)arg1;	// IMP=0x001000000006eec1
- (void)checkForFileTransferProgress;	// IMP=0x001000000006ea53
- (void)listenForLogTransferProgress;	// IMP=0x001000000006ea08
- (void)layoutSubviews;	// IMP=0x001000000006e28d
- (void)dealloc;	// IMP=0x001000000006e222
- (void)notifyDownload:(id)arg1;	// IMP=0x001000000006e13c
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x001000000006de9e
