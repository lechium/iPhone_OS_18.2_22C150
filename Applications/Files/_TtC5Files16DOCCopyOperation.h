...
- (void).cxx_destruct;	// IMP=0x0020000000267850
- (id)initWithSourceURLsAndNames:(id)arg1 destinationFolder:(id)arg2;	// IMP=0x00100000002677a0
- (id)initWithSourceURLs:(id)arg1 destinationFolder:(id)arg2;	// IMP=0x00100000002676b0
- (id)initWithItems:(id)arg1 destinationURL:(id)arg2;	// IMP=0x0010000000267610
- (id)initWithURLs:(id)arg1 destinationFolder:(id)arg2;	// IMP=0x0010000000267510
- (id)initWithItems:(id)arg1 destinationFolder:(id)arg2;	// IMP=0x0010000000267430
- (void)registerUndo;	// IMP=0x0010000000266c70
- (id)operationForUndoing;	// IMP=0x0010000000266c20
- (id)operationForRedoing;	// IMP=0x0010000000266ac0
@property(nonatomic, readonly) NSString *actionNameForUndoing;
- (void)actionMain;	// IMP=0x0010000000266900
- (void)presendNotifications;	// IMP=0x00100000002668c0
