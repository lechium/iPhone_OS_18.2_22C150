...
- (void)revealWithItems:(NSArray *)arg1 selectEvenIfVisible:(_Bool)arg2 completionBlock:(void (^)(_Bool))arg3;
- (void)getCellFor:(FPItem *)arg1:(void (^)(_TtC5Files21DOCItemCollectionCell *))arg2;
- (void)getViewFor:(FPItem *)arg1 waitForNewThumbnail:(_Bool)arg2:(void (^)(UIView *, UIBezierPath *))arg3;
