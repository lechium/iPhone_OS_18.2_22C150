...
- (void).cxx_destruct;	// IMP=0x0040000000460ae0
- (id)init;	// IMP=0x0010000000460a80
- (CDUnknownBlockType)composerBlock;	// IMP=0x0010000000460910
- (void)prepareWithComposer:(id)arg1;	// IMP=0x0010000000460900
