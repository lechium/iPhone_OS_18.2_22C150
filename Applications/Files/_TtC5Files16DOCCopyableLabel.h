...
- (void).cxx_destruct;	// IMP=0x0040000000179b40
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000179ae0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000001799b0
- (void)tintColorDidChange;	// IMP=0x0010000000179850
- (void)copyDetail;	// IMP=0x0010000000179590
@property(nonatomic, readonly) _Bool canBecomeFirstResponder;
- (void)handleTapWithSender:(id)arg1;	// IMP=0x00100000001793d0
