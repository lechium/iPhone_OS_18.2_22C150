...
+ (Class)layerClass;	// IMP=0x00200000003f79d0
- (void).cxx_destruct;	// IMP=0x00400000003fa2d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000003fa210
- (void)didMoveToWindow;	// IMP=0x00100000003f80f0
- (id)init;	// IMP=0x00100000003f7bf0
