...
@class MISSING_TYPE, NSArray, NSString, NSTextAttachment, NSURL, UIAction, UIMenu, UITextFormattingViewController, UITextItem, UITextItemMenuConfiguration, UITextView;
...
- (MISSING_TYPE *)textView:willEndFormattingWithViewController: /* Error: Ran out of types for this method. */;
