...
@class MISSING_TYPE, NSError, NSProgress, WFContentCollection, WFWorkflowRunnerClient;
...
- (MISSING_TYPE *)workflowRunnerClient:didFinishRunningWorkflowWithAllResults:error:cancelled: /* Error: Ran out of types for this method. */;
