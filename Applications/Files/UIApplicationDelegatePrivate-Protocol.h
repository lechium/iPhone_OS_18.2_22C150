...
@class AFSiriTask, CKShareMetadata, MISSING_TYPE, NSDictionary, NSSet, NSString, UIApplication, UIEvent, _UICanvasDefinition;
...
- (MISSING_TYPE *)_application:willConnectCanvas: /* Error: Ran out of types for this method. */;
