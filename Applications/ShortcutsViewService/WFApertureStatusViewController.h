...
+ (id)requestIdentifierForContext:(id)arg1;	// IMP=0x00200000000066ea
- (void).cxx_destruct;	// IMP=0x0020000000006474
...
- (void)presentableDidAppearAsBanner:(id)arg1;	// IMP=0x0010000000006283
@property(readonly, nonatomic) UIViewController *viewController;
@property(readonly, nonatomic) _Bool providesHostedContent;
- (void)systemDismissedBanner;	// IMP=0x001000000000626c
...
- (id)systemApertureElementProvider;	// IMP=0x0010000000005d03
@property(readonly, copy, nonatomic) NSString *elementIdentifier;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C,N

- (long long)preferredLayoutModeForRunningContext:(id)arg1;	// IMP=0x0010000000005cb1
- (void)startCollapseTimerIfNecessary;	// IMP=0x0010000000005a7f
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000005a2b
- (void)viewWillLayoutSubviews;	// IMP=0x0010000000005318
...
- (id)titleFont;	// IMP=0x00100000000050d4
- (void)setCompletingSuccessfully:(_Bool)arg1;	// IMP=0x0010000000005086
- (_Bool)_canShowWhileLocked;	// IMP=0x001000000000507e
- (void)dealloc;	// IMP=0x0010000000005024
- (id)initWithRunningContext:(id)arg1 attribution:(id)arg2 progress:(id)arg3;	// IMP=0x0010000000004c6d
- (id)initWithRunningContext:(id)arg1 attribution:(id)arg2;	// IMP=0x0010000000004c58
