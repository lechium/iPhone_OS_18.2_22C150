...
@class ASCLockupView, ASCMetricsActivity, MISSING_TYPE, NSError, UIViewController;
@protocol ASCOffer;
...
- (MISSING_TYPE *)lockupView:appStateDidChange: /* Error: Ran out of types for this method. */;
