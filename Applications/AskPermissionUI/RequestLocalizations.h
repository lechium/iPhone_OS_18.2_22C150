...
- (void).cxx_destruct;	// IMP=0x002000000000d93b
...
- (id)description;	// IMP=0x001000000000d8b4
- (id)compile;	// IMP=0x001000000000d76c
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000d591
- (id)initWithApprove:(id)arg1 body:(id)arg2 decline:(id)arg3 title:(id)arg4;	// IMP=0x001000000000d406
