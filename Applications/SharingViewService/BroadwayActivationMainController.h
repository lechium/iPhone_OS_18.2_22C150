...
+ (_Bool)_isSecureForRemoteViewService;	// IMP=0x0040000000119437
- (void).cxx_destruct;	// IMP=0x0020000000119164
...
- (void)retryActivation;	// IMP=0x0010000000119014
- (void)showCompletedUI:(long long)arg1;	// IMP=0x0010000000118ded
- (void)handleButtonActions:(id)arg1;	// IMP=0x0010000000118c49
- (void)dismissAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000118b2b
- (void)dismiss:(int)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000118b0f
- (void)dismiss:(int)arg1;	// IMP=0x0010000000118afb
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000118937
- (void)presentAppropriateViewControllerIfReady;	// IMP=0x0010000000118543
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00100000001184a4
- (unsigned long long)supportedInterfaceOrientations;	// IMP=0x0010000000118422
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000001181c2
- (_Bool)_canShowWhileLocked;	// IMP=0x00100000001181ba
