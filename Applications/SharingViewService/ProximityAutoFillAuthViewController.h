...
- (void).cxx_destruct;	// IMP=0x0020000000109334
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x0010000000109153
- (void)_handlePINEntered:(id)arg1;	// IMP=0x0010000000109004
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x0010000000108c40
- (void)handleDismissButton:(id)arg1;	// IMP=0x0010000000108b8c
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000108abb
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000010884d
