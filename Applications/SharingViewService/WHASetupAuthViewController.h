...
- (void).cxx_destruct;	// IMP=0x0020000000127bc9
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x00100000001279e9
- (void)_handlePINEntered:(id)arg1;	// IMP=0x001000000012789b
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x0010000000127515
- (void)handleDismissButton:(id)arg1;	// IMP=0x0010000000127466
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000127395
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001270b4
