...
- (void).cxx_destruct;	// IMP=0x0020000000113cb9
...
- (void)updateProductID:(unsigned int)arg1;	// IMP=0x001000000011389e
- (void)handleCancelButton:(id)arg1;	// IMP=0x00100000001137dd
- (void)handleJoinButton:(id)arg1;	// IMP=0x001000000011371c
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x001000000011369a
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000001133e4
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x0010000000113353
