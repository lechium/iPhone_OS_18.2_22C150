...
- (void).cxx_destruct;	// IMP=0x0020000000031bcf
...
- (void)scheduleDeletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000031995
- (id)pdfDocument;	// IMP=0x00100000000318ac
- (void)processImageIdentifier:(id)arg1;	// IMP=0x0010000000031770
- (void)_loadUneditedImageIfNecessaryWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000031491
- (id)requestCGImageBackedUneditedImageForUIBlocking;	// IMP=0x0010000000031336
- (void)requestCGImageBackedUneditedImageForUI:(CDUnknownBlockType)arg1;	// IMP=0x001000000003102d
- (id)requestUneditedImageForUIBlocking;	// IMP=0x0010000000030ed2
- (void)requestUneditedImageForUI:(CDUnknownBlockType)arg1;	// IMP=0x0010000000030d8f
- (id)requestOutputImageForUIBlocking;	// IMP=0x0010000000030c34
- (id)requestOutputImageForSavingBlocking;	// IMP=0x0010000000030ab4
- (void)requestOutputImageForUI:(CDUnknownBlockType)arg1;	// IMP=0x001000000003090c
- (void)requestOutputImageInTransition:(_Bool)arg1 forSaving:(CDUnknownBlockType)arg2;	// IMP=0x0010000000030636
- (void)requestOutputImageForSaving:(CDUnknownBlockType)arg1;	// IMP=0x001000000003061f
- (id)_outputImageOnCurrentUneditedImage;	// IMP=0x0010000000030470
- (void)_resumeHighQualityQueueIfNecessary;	// IMP=0x001000000003040a
- (void)dealloc;	// IMP=0x001000000003033c
- (id)initWithScreenshot:(id)arg1;	// IMP=0x00100000000301b5
