...
- (void).cxx_destruct;	// IMP=0x0020000000025be2
...
- (id)generateImageForScreenshot:(id)arg1;	// IMP=0x0010000000025b89
@property(retain, nonatomic) UIImage *image;
- (void)layoutSubviews;	// IMP=0x001000000002599b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000025907
