...
- (void).cxx_destruct;	// IMP=0x00200000000359fe
...
- (_Bool)rulerHostWantsSharedRuler;	// IMP=0x001000000003592f
- (id)rulerHostingView;	// IMP=0x001000000003591d
...
- (void)logDidEndEditingWithOverlay;	// IMP=0x0010000000035779
- (void)logDidEnterEditingWithOverlay;	// IMP=0x0010000000035773
- (void)updateUndoState;	// IMP=0x001000000003576d
