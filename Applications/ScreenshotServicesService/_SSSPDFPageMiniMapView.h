...
+ (struct CGAffineTransform)_transformToConvertToRect:(struct CGRect)arg1 fromRect:(struct CGRect)arg2;	// IMP=0x0040000000034fda
+ (struct CGPoint)adjustedTranslationForProposedRect:(struct CGRect)arg1 originalRect:(struct CGRect)arg2 scaledContentViewBounds:(struct CGRect)arg3;	// IMP=0x0010000000034580
- (void).cxx_destruct;	// IMP=0x00200000000353c6
...
- (struct CGRect)convertRectToPageViewSpace:(struct CGRect)arg1 fromView:(id)arg2;	// IMP=0x0010000000034e39
- (struct CGRect)convertRectFromPageViewSpace:(struct CGRect)arg1 toView:(id)arg2;	// IMP=0x0010000000034c9f
- (struct CGRect)visibleRectInPageViewSpace;	// IMP=0x0010000000034b15
- (void)userDidPanSelectionRect:(id)arg1;	// IMP=0x0010000000034755
- (_Bool)isDraggingVisibleRect;	// IMP=0x0010000000034530
- (void)updatePDFViewFromVisibleRegionView;	// IMP=0x001000000003430c
- (void)updateVisibleRegionViewFromPDFView;	// IMP=0x0010000000033e3f
- (void)annotationsDidChange;	// IMP=0x0010000000033b8f
- (void)visibleRegionRectDidChange;	// IMP=0x0010000000033b58
- (id)pageImageForSize:(struct CGSize)arg1;	// IMP=0x0010000000033919
- (id)pageView;	// IMP=0x00100000000338b2
- (id)pdfPage;	// IMP=0x0010000000033840
- (void)setNeedsPageImageUpdate;	// IMP=0x0000000000033808
- (void)_removePDFNotifications;	// IMP=0x0010000000033662
- (void)_setupPDFNotificationsIfPossible;	// IMP=0x00100000000334ea
- (void)layoutSubviews;	// IMP=0x0010000000033244
- (void)dealloc;	// IMP=0x00100000000331d8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000003307a
