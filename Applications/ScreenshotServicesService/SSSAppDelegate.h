...
- (void).cxx_destruct;	// IMP=0x00200000000274cf
@property(nonatomic) _Bool didLaunchSuspended; // @synthesize didLaunchSuspended=_didLaunchSuspended;
@property(retain, nonatomic) UIWindow *window; // @synthesize window=_window;
- (void)application:(id)arg1 didFinishLaunchingSuspendedWithOptions:(id)arg2;	// IMP=0x0000000000027386
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x0010000000027353
@property(readonly, nonatomic) SSSViewControllerManager *viewControllerManager;
- (void)_setUpDevelopmentUI;	// IMP=0x001000000002729d
- (_Bool)_shouldSetUpDevelopmentUI;	// IMP=0x0010000000027274
