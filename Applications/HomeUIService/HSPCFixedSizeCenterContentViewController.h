...
- (void).cxx_destruct;	// IMP=0x0020000000061dfa
...
- (void)viewDidLoad;	// IMP=0x00100000000615d0
- (id)initWithCenterContentView:(id)arg1 size:(struct CGSize)arg2 pinSides:(_Bool)arg3;	// IMP=0x0010000000061529
- (id)initWithCenterContentView:(id)arg1 size:(struct CGSize)arg2;	// IMP=0x0010000000061515
- (id)initWithCenterContentView:(id)arg1;	// IMP=0x00100000000614f8
