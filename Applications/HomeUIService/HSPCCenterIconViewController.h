...
- (void).cxx_destruct;	// IMP=0x00200000000023ac
...
- (id)commitConfiguration;	// IMP=0x0010000000002319
@property(readonly, nonatomic) id <HFIconDescriptor> iconDescriptor;
- (void)viewDidLoad;	// IMP=0x00100000000021be
- (id)initWithCoordinator:(id)arg1 config:(id)arg2 iconView:(id)arg3;	// IMP=0x00100000000020f4
- (id)initWithCoordinator:(id)arg1 config:(id)arg2;	// IMP=0x001000000000202c
