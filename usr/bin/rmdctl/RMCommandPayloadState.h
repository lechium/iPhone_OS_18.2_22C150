...
- (void)markPending;	// IMP=0x0020000000006725
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x00100000000063dc
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x001000000000606e
- (void)markQueued;	// IMP=0x001000000000600b
