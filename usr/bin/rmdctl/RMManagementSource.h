...
+ (id)fetchRequestWithAccountIdentifier:(id)arg1;	// IMP=0x0020000000011ed2
+ (id)fetchRequestWithIdentifier:(id)arg1;	// IMP=0x0010000000011e2b
+ (id)fetchRequestWithEnrollmentTypes:(id)arg1;	// IMP=0x0010000000011d84
+ (id)fetchRequestWithEnrollmentType:(long long)arg1;	// IMP=0x0010000000011d01
+ (id)fetchRequestWithDeviceChannel;	// IMP=0x0010000000011c73
+ (id)fetchRequestWithBootstrapURI:(id)arg1 enrollmentType:(long long)arg2;	// IMP=0x0010000000011bbe
+ (id)fetchRequestWithBootstrapURI:(id)arg1;	// IMP=0x0010000000011b17
- (id)reportDetails;	// IMP=0x0020000000011f79
- (void)awakeFromInsert;	// IMP=0x0010000000011a84
