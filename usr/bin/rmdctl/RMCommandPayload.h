...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x0020000000005683
- (id)reportDetails;	// IMP=0x0020000000005eda
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x001000000000595f
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x00100000000056f3
