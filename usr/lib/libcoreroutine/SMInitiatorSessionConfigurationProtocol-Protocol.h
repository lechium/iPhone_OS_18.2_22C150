...
@class NSUUID, SMConversation, SMSessionConfiguration, SMSessionMonitorContext;
...
- (void)promptWorkoutAnomalyVerificationWithContext:(SMSessionMonitorContext *)arg1 handler:(void (^)(NSError *))arg2;
...
- (void)fetchSOSReceiversWithCompletion:(void (^)(NSArray *, NSError *))arg1;
...
- (void)handoffSessionForSessionID:(NSUUID *)arg1 handler:(void (^)(NSError *))arg2;
...
- (void)initializeSessionWithConversation:(SMConversation *)arg1 handler:(void (^)(NSDictionary *, long long, long long, NSError *))arg2;

@optional
- (void)initializeAndStartSessionWithConfiguration:(SMSessionConfiguration *)arg1 handler:(void (^)(NSError *))arg2;
