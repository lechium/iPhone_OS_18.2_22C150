...
@class NSArray, NSDate, NSDateInterval, NSDictionary, NSNumber, NSSet, NSString, NSURL, NSUUID, RTCoordinate, RTFetchFingerprintsOptions, RTFingerprint, RTLocation, RTLocationOfInterest, RTLocationOfInterestVisit, RTPlaceInferenceOptions, RTScenarioTrigger, RTSignalGeneratorOptions, RTVisit;

@protocol RTDaemonInternalProtocol <NSObject>
- (void)periodicPurgeWithReply:(void (^)(NSError *))arg1;
- (void)fetchPointOfInterestAttributesWithIdentifier:(unsigned long long)arg1 reply:(void (^)(RTPointOfInterestAttributes *, NSError *))arg2;
- (void)fetchPointOfInterestsAroundCoordinate:(RTCoordinate *)arg1 radius:(double)arg2 reply:(void (^)(NSArray *, NSError *))arg3;
- (void)stopSamplingPointOfInterest:(void (^)(NSError *))arg1;
- (void)startSamplingPointOfInterestWithInterval:(double)arg1 handler:(void (^)(NSError *))arg2;
- (void)fetchPlaceInferenceQueriesWithDateInterval:(NSDateInterval *)arg1 ascending:(_Bool)arg2 reply:(void (^)(NSArray *, NSError *))arg3;
- (void)fetchVisitLogsWithDateInterval:(NSDateInterval *)arg1 reply:(void (^)(NSArray *, NSError *))arg2;
- (void)eraseVisitLogDatabase:(void (^)(NSError *))arg1;
- (void)forceAuthorizedLocationEraseInstallInitialization:(void (^)(_Bool, NSError *))arg1;
- (void)fetchAuthorizedLocationExtendedStatus:(void (^)(RTAuthorizedLocationStatus *, long long, NSError *))arg1;
- (void)fetchAuthorizedLocations:(void (^)(NSArray *, NSError *))arg1;
...
- (void)fetchCurrentLocationWithReply:(void (^)(CLLocation *, NSError *))arg1;
