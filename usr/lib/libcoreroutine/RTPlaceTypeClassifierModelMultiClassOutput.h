...
- (void).cxx_destruct;	// IMP=0x0000000000172656
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000017252d
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithTarget:(long long)arg1 classProbability:(id)arg2;	// IMP=0x0000000000172496
