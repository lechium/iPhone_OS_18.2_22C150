...
+ (id)notifyRegistrationName:(id)arg1 forAssetSetIdentifier:(id)arg2;	// IMP=0x00100000000c8449
+ (id)notifyRegistrationName:(id)arg1;	// IMP=0x00100000000c8412
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000c8164
...
- (id)summary;	// IMP=0x00000000000c82b4
- (id)description;	// IMP=0x00000000000c82a2
- (id)copy;	// IMP=0x00000000000c816c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c8008
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c7ee5
- (id)init;	// IMP=0x00000000000c7ea5
