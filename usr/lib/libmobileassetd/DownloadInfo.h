...
- (void).cxx_destruct;	// IMP=0x00000000000c74bf
...
- (id)description;	// IMP=0x00000000000c6e63
- (id)_taskState;	// IMP=0x00000000000c6dd8
- (void)clearCacheServerUrl;	// IMP=0x00000000000c6db8
- (void)addNewDownloadInfo:(id)arg1;	// IMP=0x00000000000c6d98
- (double)currentEstimate;	// IMP=0x00000000000c6b4c
- (void)updateDownloadData:(long long)arg1;	// IMP=0x00000000000c69c5
- (_Bool)addNewRateDataPoint:(double)arg1;	// IMP=0x00000000000c6767
- (void)determineDownloadUrl:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c648e
- (id)initWithUrl:(id)arg1 forAssetType:(id)arg2 withPurpose:(id)arg3 clientName:(id)arg4 options:(id)arg5;	// IMP=0x00000000000c6172
- (id)initForAssetType:(id)arg1 withPurpose:(id)arg2 clientName:(id)arg3 options:(id)arg4;	// IMP=0x00000000000c6145
- (id)initWithUrl:(id)arg1 clientName:(id)arg2 options:(id)arg3;	// IMP=0x00000000000c611e
