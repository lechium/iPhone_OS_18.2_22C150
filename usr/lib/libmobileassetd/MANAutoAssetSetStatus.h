...
+ (id)_shortTermLockFilenameNormalizedComponent:(id)arg1;	// IMP=0x00100000000cc7e6
+ (id)shortTermLockFilename:(id)arg1 forAssetSetIdentifier:(id)arg2 forSetAtomicInstance:(id)arg3;	// IMP=0x00100000000cc678
+ (id)shortTermLockDirectory:(id)arg1 forAssetSetIdentifier:(id)arg2;	// IMP=0x00100000000cc589
+ (id)newSelectorsForStagingSummary:(id)arg1;	// IMP=0x00100000000cc294
+ (id)newCurrentLockUsageDetailed:(id)arg1;	// IMP=0x00100000000cc1ba
+ (id)newCurrentLockUsageSummary:(id)arg1;	// IMP=0x00100000000cbdd4
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000ca6a1
- (void).cxx_destruct;	// IMP=0x00000000000ccc03
