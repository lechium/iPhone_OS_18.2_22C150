...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000930ea9
...
- (void)dealloc;	// IMP=0x0000000000931129
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000930fa6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000930eb1
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000930d49
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000930cdc
