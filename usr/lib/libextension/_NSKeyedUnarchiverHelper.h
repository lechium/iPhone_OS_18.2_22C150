...
- (_Bool)classNameAllowed:(Class)arg1;	// IMP=0x00000000007c42e4
- (void)setAllowedClassNames:(id)arg1;	// IMP=0x00000000007c42af
- (id)allowedClassNames;	// IMP=0x00000000007c4298
- (void)dealloc;	// IMP=0x00000000007c4224
- (id)init;	// IMP=0x00000000007c41fb
