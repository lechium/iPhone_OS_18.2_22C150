...
+ (id)_replacementsFromMetadataArray:(id)arg1;	// IMP=0x00600000007b03d4
...
- (void)dealloc;	// IMP=0x00000000007b0376
- (id)initWithIndex:(long long)arg1 specifierRangeInFormatString:(struct _NSRange)arg2 replacementRangeInResult:(struct _NSRange)arg3 replacementKind:(long long)arg4 argument:(id)arg5;	// IMP=0x00000000007b02c9
- (id)_initWithMetadata:(id)arg1;	// IMP=0x00000000007affc4
