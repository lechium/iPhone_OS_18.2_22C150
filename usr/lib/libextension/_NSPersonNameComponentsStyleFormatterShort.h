...
- (void)dealloc;	// IMP=0x000000000093328e
- (_Bool)isEnabled;	// IMP=0x000000000093316f
- (id)fallbackStyleFormatter;	// IMP=0x00000000009330ca
- (id)orderedKeysOfInterest;	// IMP=0x000000000093301e
- (id)keysOfInterest;	// IMP=0x0000000000932fdb
- (id)abbreviatedKeys;	// IMP=0x0000000000932fb1
- (id)_formattedStringFromOrderedKeys:(id)arg1 components:(id)arg2 attributesByRange:(id)arg3;	// IMP=0x0000000000932dd1
...
- (id)initWithMasterFormatter:(id)arg1;	// IMP=0x0000000000932bc1
