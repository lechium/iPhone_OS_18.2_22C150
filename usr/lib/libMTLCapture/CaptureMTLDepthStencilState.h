...
- (void).cxx_destruct;	// IMP=0x000000000003c262
- (void)dealloc;	// IMP=0x000000000003c15e
...
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000000003c08b
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000003c07a
@property(readonly, copy) NSString *description;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000003bfb9
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x000000000003bf59
- (id)originalObject;	// IMP=0x000000000003bf4b
@property(readonly) id <MTLDepthStencilState> baseObject;
- (id)initWithBaseObject:(id)arg1 captureDevice:(id)arg2;	// IMP=0x000000000003be5f
