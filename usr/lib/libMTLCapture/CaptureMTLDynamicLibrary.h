...
- (void).cxx_destruct;	// IMP=0x00000000000ba233
@property(retain, nonatomic) id <MTLLibrary> parentLibrary; // @synthesize parentLibrary;
- (_Bool)serializeToURL:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000000ba1b1
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000ba19b
- (void)dealloc;	// IMP=0x00000000000ba097
...
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000000000b9df1
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x00000000000b9de0
@property(readonly, copy) NSString *description;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000b9d1f
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x00000000000b9cbf
- (id)originalObject;	// IMP=0x00000000000b9cb1
- (_Bool)serializeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000b9ae6
@property(readonly) id <MTLDynamicLibrary> baseObject;
- (id)initWithBaseObject:(id)arg1 captureDevice:(id)arg2;	// IMP=0x00000000000b99fa
