...
- (void).cxx_destruct;	// IMP=0x0020000000008ee3
...
- (void)load;	// IMP=0x0010000000008eb5
- (id)initWithCommand:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000008d1a
