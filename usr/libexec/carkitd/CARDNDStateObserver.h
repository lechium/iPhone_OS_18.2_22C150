...
+ (_Bool)observesVehicularReports;	// IMP=0x002000000001213e
- (void).cxx_destruct;	// IMP=0x0020000000012a5d
...
- (void)_checkVehicleState;	// IMP=0x001000000001262d
- (void)airplaneModeChanged;	// IMP=0x00100000000124f7
- (void)scheduleVehicleStateCheckWithDelay:(double)arg1;	// IMP=0x0010000000012328
...
- (void)dealloc;	// IMP=0x00100000000120a0
- (id)initWithRadiosPreferences:(id)arg1 vehicleStateClass:(Class)arg2;	// IMP=0x0010000000011ce8
