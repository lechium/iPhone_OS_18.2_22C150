...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000018c09
- (void).cxx_destruct;	// IMP=0x0020000000018f2d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000018df4
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000018c11
