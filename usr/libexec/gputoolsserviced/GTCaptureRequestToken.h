...
- (void).cxx_destruct;	// IMP=0x0020000000003e33
@property(readonly, nonatomic) unsigned long long tokenId; // @synthesize tokenId=_tokenId;
- (void)waitUntilCompleted;	// IMP=0x0010000000003e14
- (void)completed;	// IMP=0x0010000000003e06
- (id)description;	// IMP=0x0010000000003d88
- (id)initWithCaptureService:(id)arg1 andTokenId:(unsigned long long)arg2;	// IMP=0x0010000000003cea
