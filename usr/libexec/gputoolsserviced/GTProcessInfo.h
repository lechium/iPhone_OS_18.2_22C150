...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001b8be
- (void).cxx_destruct;	// IMP=0x002000000001c22b
...
- (id)description;	// IMP=0x001000000001c114
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001c01a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001bf56
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001ba00
- (id)init;	// IMP=0x001000000001b8c6
