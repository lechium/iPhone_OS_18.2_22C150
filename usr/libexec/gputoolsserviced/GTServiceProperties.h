...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001b190
+ (id)protocolMethods:(id)arg1;	// IMP=0x001000000001b0b0
- (void).cxx_destruct;	// IMP=0x002000000001b88b
...
- (id)description;	// IMP=0x001000000001b77d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001b6ba
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001b5f6
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001b28d
- (id)initWithProtocol:(id)arg1;	// IMP=0x001000000001b198
