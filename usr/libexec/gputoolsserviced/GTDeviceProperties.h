...
+ (id)uniqueDeviceID;	// IMP=0x0020000000017aa5
+ (id)hardwareUUID;	// IMP=0x0010000000017a2f
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000017a27
- (void).cxx_destruct;	// IMP=0x0020000000018ab5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000018739
- (id)initForEmbeddedSystem;	// IMP=0x0010000000018287
- (id)description;	// IMP=0x001000000001825a
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000017f0b
- (id)initWithXPCObject:(id)arg1;	// IMP=0x0010000000017aeb
