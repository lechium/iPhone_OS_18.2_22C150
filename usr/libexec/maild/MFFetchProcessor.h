...
+ (id)mailboxes:(id)arg1 sortedByDate:(CDUnknownBlockType)arg2;	// IMP=0x0040000000082c6d
+ (id)mailboxesSortedByLastFetchDate:(id)arg1;	// IMP=0x0010000000082af4
+ (id)sortedMailboxesInArrayWithMailboxes:(id)arg1 ranking:(id)arg2;	// IMP=0x00100000000826fc
+ (id)intelligentSkeletonFetchProcessor;	// IMP=0x001000000007fb5c
+ (id)powernapProcessor;	// IMP=0x001000000007f9a5
+ (id)processorWithName:(id)arg1 condition:(id)arg2;	// IMP=0x001000000007f918
+ (void)initialize;	// IMP=0x001000000007f637
- (void).cxx_destruct;	// IMP=0x002000000008312e
...
- (id)_mailboxesToFetch;	// IMP=0x0010000000081d8f
- (void)_fetchCompleted:(id)arg1;	// IMP=0x00100000000816df
- (void)_finishRequest;	// IMP=0x0010000000081611
- (void)_cancelCurrentInvocations;	// IMP=0x0010000000081192
- (id)_observeChangesInConditions;	// IMP=0x0010000000080fe0
- (_Bool)_processEligibleMailboxesAndWait;	// IMP=0x001000000008006e
- (_Bool)_runSynchronously:(long long)arg1;	// IMP=0x001000000007fca4
- (void)runSynchronouslyWithDuration:(double)arg1;	// IMP=0x001000000007fc67
- (void)_setRequestLimiterLimit:(unsigned long long)arg1;	// IMP=0x001000000007fc5d
- (void)dealloc;	// IMP=0x001000000007f8a4
- (id)initWithName:(id)arg1 condition:(id)arg2;	// IMP=0x001000000007f6db
