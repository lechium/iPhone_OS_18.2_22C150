...
@class EFPair, MFAttachment, MFComposeWebView, MFMailAccountProxy, MFMailComposeView, MFMailPopoverManager, MSInputContextHistory, NSArray, NSDictionary, NSString, UIViewController, _MFMailCompositionContext;
