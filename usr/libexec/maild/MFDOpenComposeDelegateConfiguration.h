...
- (void).cxx_destruct;	// IMP=0x002000000007b0c9
...
- (id)description;	// IMP=0x001000000007afa5
- (id)initWithIdentifier:(id)arg1 delegateEndpoint:(id)arg2 isEntitledDelegate:(_Bool)arg3;	// IMP=0x001000000007aee3
