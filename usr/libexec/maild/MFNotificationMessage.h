...
@interface MFNotificationMessage : NSObject
{
    ...
    long long _mailboxType;	// 96 = 0x60
    NSDate *_remindMeDate;	// 104 = 0x68
    id <MFFavoritesReader> _favoritesReader;	// 112 = 0x70
    id <EMVIPReader> _vipReader;	// 120 = 0x78
    MFMailboxUid *_mailbox;	// 128 = 0x80
    NSString *_subject;	// 136 = 0x88
    NSString *_senderCommentedAddress;	// 144 = 0x90
    CNContactStore *_contactStore;	// 152 = 0x98
    NSString *_senderFullAddress;	// 160 = 0xa0
}

- (void).cxx_destruct;	// IMP=0x00200000000a9efd
...
- (_Bool)_isInFavoriteMailbox;	// IMP=0x00100000000a9636
- (id)_displaySubject;	// IMP=0x00100000000a94fe
- (id)_displaySender;	// IMP=0x00100000000a9094
- (id)_summaryForRemindMe;	// IMP=0x00100000000a8f7b
- (id)initWithNotificationMessage:(id)arg1 summary:(id)arg2;	// IMP=0x00100000000a8db4
- (id)initWithFavoritesReader:(id)arg1 vipReader:(id)arg2 libraryMessage:(id)arg3 contactStore:(id)arg4 remindMeDate:(id)arg5;	// IMP=0x00100000000a8854
- (id)initWithFavoritesReader:(id)arg1 vipReader:(id)arg2 libraryMessage:(id)arg3 contactStore:(id)arg4 suppressionContexts:(id)arg5 summary:(id)arg6;	// IMP=0x00100000000a8304
