...
- (void).cxx_destruct;	// IMP=0x002000000006250b
...
- (void)cancel;	// IMP=0x001000000006247a
- (void)countDidChange:(long long)arg1 acknowledgementToken:(id)arg2;	// IMP=0x00100000000623aa
- (id)initWithFavoriteItem:(id)arg1 messagePersistence:(id)arg2 hookRegistry:(id)arg3 countDidChange:(CDUnknownBlockType)arg4;	// IMP=0x0010000000061e67
