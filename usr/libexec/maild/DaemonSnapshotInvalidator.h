...
+ (id)log;	// IMP=0x0020000000014075
- (void).cxx_destruct;	// IMP=0x0020000000014a6d
...
- (void)currentFocusChanged:(id)arg1;	// IMP=0x0010000000014955
- (void)accountsChanged:(id)arg1;	// IMP=0x00100000000148a1
- (void)accountsRemoved:(id)arg1;	// IMP=0x00100000000147ed
- (void)deleteSnapshotsForBundleIdentifier:(id)arg1;	// IMP=0x00100000000143fd
- (id)initWithApplicationBundleIdentifier:(id)arg1 hookRegistry:(id)arg2 remoteClientsProvider:(id)arg3 focusController:(id)arg4 invalidationHandler:(id)arg5;	// IMP=0x0010000000014171
- (id)initWithApplicationBundleIdentifier:(id)arg1 hookRegistry:(id)arg2 remoteClientsProvider:(id)arg3 focusController:(id)arg4;	// IMP=0x0010000000014152
