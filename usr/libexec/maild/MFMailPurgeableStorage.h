...
- (void).cxx_destruct;	// IMP=0x002000000008a86c
...
- (long long)nonPurgeableSpace;	// IMP=0x0010000000089ec5
- (id)library;	// IMP=0x0010000000089eac
- (id)initWithAccountsProvider:(id)arg1;	// IMP=0x0010000000089e25
