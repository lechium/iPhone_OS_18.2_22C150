...
- (void).cxx_destruct;	// IMP=0x002000000002f4c4
...
- (id)gestureNamesWaitForTimeInterval:(double *)arg1;	// IMP=0x001000000002eaad
- (id)eventTypeNameWaitForTimeInterval:(double *)arg1;	// IMP=0x001000000002e9e5
@property(readonly, getter=isHandEvent) _Bool handEvent;
- (id)init;	// IMP=0x001000000002e8dd
