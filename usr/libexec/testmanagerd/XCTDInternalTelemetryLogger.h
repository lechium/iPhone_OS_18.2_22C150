...
+ (id)loggerFromConfigurationFile;	// IMP=0x002000000004d000
- (id)init;	// IMP=0x0040000000051540
- (void)postEventData:(NSData *)arg1 completion:(void (^)(NSError *))arg2;	// IMP=0x00100000000510d0
