...
- (void)launchApplicationWithBundleID:(NSString *)arg1 path:(NSString *)arg2 arguments:(NSArray *)arg3 environment:(NSDictionary *)arg4 launchBackgrounded:(_Bool)arg5 timeout:(double)arg6 completion:(void (^)(int, NSError *))arg7;
- (void)invalidate;
@end
