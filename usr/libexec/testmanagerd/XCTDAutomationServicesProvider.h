...
- (void).cxx_destruct;	// IMP=0x0020000000020254
...
- (void)orientationManagerDidUpdateInterfaceOrientation:(long long)arg1;	// IMP=0x001000000002012f
- (void)orientationManagerDidUpdateDeviceOrientation:(long long)arg1;	// IMP=0x00100000000200e3
- (id)initWithAccessibilitySystem:(id)arg1 timeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000001ff71
- (id)initWithApplicationLauncher:(id)arg1 orientationManager:(id)arg2 siriInterface:(id)arg3 systemConfiguration:(id)arg4 axManager:(id)arg5 touchGesturePerformer:(id)arg6;	// IMP=0x001000000001fdf6
- (_Bool)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001fbc8
- (void)unloadAccessibility;	// IMP=0x001000000001fa71
- (void)invalidate;	// IMP=0x001000000001f8b1
- (void)dealloc;	// IMP=0x001000000001f785
