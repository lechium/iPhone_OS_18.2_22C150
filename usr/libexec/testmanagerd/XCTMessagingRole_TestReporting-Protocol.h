...
@class NSData, NSError, NSNumber, NSString, XCTCapabilities, XCTExpectedFailure, XCTIssue, XCTSourceCodeContext, XCTTestIdentifier, XCTTraits, XCTestCaseRunConfiguration;
...
- (id)_XCT_testCaseDidStartWithIdentifier:(XCTTestIdentifier *)arg1 testCaseRunConfiguration:(XCTestCaseRunConfiguration *)arg2 traits:(XCTTraits *)arg3;
...
- (id)_XCT_testSuiteWithIdentifier:(XCTTestIdentifier *)arg1 wasSkippedWithMessage:(NSString *)arg2 sourceCodeContext:(XCTSourceCodeContext *)arg3;
...
- (id)_XCT_testSuiteWithIdentifier:(XCTTestIdentifier *)arg1 didStartAt:(NSString *)arg2 traits:(XCTTraits *)arg3;
- (id)_XCT_didFormPlanWithData:(NSData *)arg1;
