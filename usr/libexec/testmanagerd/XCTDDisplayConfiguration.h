...
+ (id)configurationForDisplayID:(unsigned int)arg1 error:(id *)arg2;	// IMP=0x0020000000020311
+ (id)sharedDisplayMonitor;	// IMP=0x00100000000202bc
- (void).cxx_destruct;	// IMP=0x0020000000020b91
...
- (id)initWithDisplayID:(unsigned int)arg1;	// IMP=0x001000000002033e
