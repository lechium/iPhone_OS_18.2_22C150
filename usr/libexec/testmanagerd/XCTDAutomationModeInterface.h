...
+ (id)sharedInterface;	// IMP=0x0020000000011ee5
+ (void)provideCapabilitiesToBuilder:(id)arg1;	// IMP=0x0010000000011c9c
- (void).cxx_destruct;	// IMP=0x0020000000012b26
...
- (void)unregisterAutomationModeChangeHandlerWithToken:(id)arg1;	// IMP=0x0010000000012a4e
- (id)registerAutomationModeChangeHandlerOnQueue:(id)arg1 withBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000000129c5
- (void)disableAutomationModeForClient:(id)arg1;	// IMP=0x001000000001261e
- (_Bool)enableAutomationModeForClient:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001233e
@property(readonly) _Bool isAutomationModeEnabled;
- (void)dealloc;	// IMP=0x0010000000012294
- (id)initForUnsupportedSystems;	// IMP=0x001000000001224b
- (id)initWithAutomationModeFunctions:(CDStruct_6bdebbfa)arg1;	// IMP=0x0010000000011fda
