...
@class MISSING_TYPE, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSXPCListener, XCTestManagerIDEServer;
...
+ (id)dataContainerRelativePathForURL:(id)arg1;	// IMP=0x0020000000041ebf
+ (id)userName;	// IMP=0x0010000000041e76
+ (id)dataContainerURLPrefix;	// IMP=0x0010000000041d46
+ (id)attachmentsDirectory;	// IMP=0x0010000000041ce3
+ (void)setDataContainerRootURL:(id)arg1;	// IMP=0x0010000000041ccf
+ (id)dataContainerRootURL;	// IMP=0x0010000000041cbe
+ (_Bool)hasAppleInternalSecurityPolicies;	// IMP=0x0010000000041cad
- (void).cxx_destruct;	// IMP=0x0020000000046591
...
- (void)_queue_logStatus;	// IMP=0x0010000000045e08
- (void)_queue_closeTestSession:(id)arg1;	// IMP=0x0010000000045c99
- (void)closeTestSession:(id)arg1;	// IMP=0x0010000000045bc3
- (void)closeIDESession:(id)arg1;	// IMP=0x00100000000456df
- (void)closeTargetBootstrapSession:(id)arg1;	// IMP=0x0010000000045485
- (void)_queue_fulfillTestConnectionRequest:(CDUnknownBlockType)arg1 usingIDESession:(id)arg2;	// IMP=0x0010000000045341
- (void)_queue_handleRequestForSessionWithIdentifier:(id)arg1;	// IMP=0x00100000000451e6
- (void)_queue_advertiseAvailabilityToTargetWithPID:(int)arg1;	// IMP=0x0010000000044f36
- (void)_queue_processTargetSessionRequests;	// IMP=0x0010000000044ae3
- (void)_queue_requestTargetBootstrapSessionForPID:(int)arg1 timeout:(double)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00100000000446c8
- (void)requestTargetBootstrapSessionForPID:(int)arg1 timeout:(double)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00100000000445db
- (void)_queue_processPendingTransferObservationBlocks;	// IMP=0x0010000000044222
- (void)setObserverForConnectionTransferToTargetWithPID:(int)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000004405f
- (void)connectionTransferToTargetWithPID:(int)arg1 completedWithSuccess:(_Bool)arg2 error:(id)arg3;	// IMP=0x0010000000043e4b
- (void)requestSerializedTransportForSessionIdentifier:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000043c54
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000438e1
- (void)addTargetBootstrapSession:(id)arg1;	// IMP=0x00100000000435be
- (void)setIDESession:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0010000000043190
- (void)controlSession:(id)arg1 didAuthorizeProcessID:(int)arg2;	// IMP=0x0010000000043108
- (void)addControlSession:(id)arg1;	// IMP=0x0010000000042f1b
- (void)remoteAutomationSessionDidClose:(id)arg1;	// IMP=0x0010000000042d8f
- (void)serverDidHandleDisconnectForSocket:(int)arg1;	// IMP=0x0010000000042d89
- (MISSING_TYPE *)serverReceivedConnectionForServiceType:overSocket:effectiveUserIdentifier:clientPrivilege:disconnectionHandler: /* Error: Ran out of types for this method. */;	// IMP=0x00100000000429ad
- (void)reportSelfDiagnosisIssue:(id)arg1 description:(id)arg2;	// IMP=0x00100000000428d6
- (void)setupSignalHandlers;	// IMP=0x00100000000425c2
- (void)run;	// IMP=0x00100000000423d9
- (void)startAcceptingTargetConnectionsFromListener:(id)arg1;	// IMP=0x00100000000422bb
- (void)startAcceptingTestConnectionsFromListener:(id)arg1;	// IMP=0x001000000004219d
- (id)init;	// IMP=0x0010000000041fbb
