...
- (void).cxx_destruct;	// IMP=0x002000000002416d
...
- (void)applicationDidUpdateState:(id)arg1;	// IMP=0x00100000000240a1
- (id)init;	// IMP=0x0010000000024029
- (id)initWithProcessMonitor:(id)arg1 processAssertionManager:(id)arg2;	// IMP=0x0010000000023f92
- (void)invalidate;	// IMP=0x0010000000023e4f
- (void)dealloc;	// IMP=0x0010000000023d9d
