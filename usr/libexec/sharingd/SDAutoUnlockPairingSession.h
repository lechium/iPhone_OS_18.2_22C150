...
- (void).cxx_destruct;	// IMP=0x00200000000139d0
...
- (void)idsController:(id)arg1 didReceiveProtoData:(id)arg2 forType:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x00100000000134f8
- (void)handleTimerFired;	// IMP=0x00100000000133c8
- (void)invalidateResponseTimer;	// IMP=0x00100000000132f2
- (void)restartResponseTimer:(unsigned long long)arg1;	// IMP=0x00100000000130f4
- (id)dataFromUUID:(id)arg1;	// IMP=0x001000000001306b
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2 useProxy:(_Bool)arg3 senderID:(id)arg4;	// IMP=0x0010000000012e8d
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2;	// IMP=0x0010000000012e75
- (void)handleMessage:(id)arg1 fromDeviceID:(id)arg2 type:(unsigned short)arg3;	// IMP=0x0010000000012e6f
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000012e69
- (void)start;	// IMP=0x0010000000012e63
@property(readonly, nonatomic) SDUnlockTransport *transport;
- (void)invalidate;	// IMP=0x0010000000012c67
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x0010000000012b3d
- (id)init;	// IMP=0x0010000000012ae5
