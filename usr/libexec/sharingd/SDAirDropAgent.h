...
- (void).cxx_destruct;	// IMP=0x00200000001a44bc
...
- (void)handleEndpointsChanged:(id)arg1;	// IMP=0x00100000001a3e9c
- (id)_agentClientTokenForClient:(id)arg1;	// IMP=0x00100000001a3cab
- (void)_setupAssertHandlers;	// IMP=0x00100000001a3ca5
- (void)_setupFlowHandlers;	// IMP=0x00100000001a3c9f
- (void)_setupBrowseHandlers;	// IMP=0x00100000001a3729
- (void)_createBrowseAgent;	// IMP=0x00100000001a3444
- (void)_setupPolicy;	// IMP=0x00100000001a2fb0
- (id)initWithEndpointService:(id)arg1;	// IMP=0x00100000001a2da9
