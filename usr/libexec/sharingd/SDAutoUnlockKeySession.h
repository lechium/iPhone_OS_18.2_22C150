...
@interface SDAutoUnlockKeySession
{
    ...
    MISSING_TYPE *_needsImageData;	// 20 = 0x14
...
- (void).cxx_destruct;	// IMP=0x002000000001db45
...
- (void)logAutoUnlockEnd;	// IMP=0x001000000001d683
- (void)logAutoUnlockStart;	// IMP=0x001000000001d67d
- (void)invalidateAssertionTimer;	// IMP=0x001000000001d5a7
- (void)restartAssertionTimer;	// IMP=0x001000000001d396
- (void)releaseIdleSleepAssertion;	// IMP=0x001000000001d2f7
- (void)declareSystemActivityAssertion;	// IMP=0x001000000001d063
- (void)sendConfirmationACK;	// IMP=0x001000000001ce4c
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x001000000001c983
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x001000000001c695
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x001000000001c3a9
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x001000000001bd9b
- (void)handleCleanUpAWDL;	// IMP=0x001000000001bd0d
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x001000000001b8c0
- (void)createAuthTokenIfReady;	// IMP=0x001000000001b04d
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x001000000001ae2f
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x001000000001ab6a
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x001000000001a66b
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x001000000001a084
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00100000000198b8
- (void)nq_handleWiFiRequestInvalidated;	// IMP=0x0010000000019819
- (void)nq_handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000019761
- (void)nq_awdlNetworkStarted;	// IMP=0x0010000000019581
- (void)createWiFiRequest;	// IMP=0x0010000000018dc9
- (void)alertOfUnlock;	// IMP=0x0010000000018cad
- (void)promptForApproval;	// IMP=0x0010000000018ca7
- (void)systemIsActive:(id)arg1;	// IMP=0x0010000000018af3
- (void)deviceDisconnected:(id)arg1;	// IMP=0x00100000000188a9
- (void)removeObservers;	// IMP=0x0010000000018856
- (void)addObservers;	// IMP=0x0010000000018758
- (void)postBeganUnlockingNotification;	// IMP=0x00100000000186c5
- (void)beginAKSSession;	// IMP=0x00100000000186bf
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00100000000184f9
- (void)keyCanUnlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000184f3
- (_Bool)keyInState;	// IMP=0x001000000001835d
- (void)_invalidate;	// IMP=0x00100000000180c9
- (void)invalidateOnQueue;	// IMP=0x001000000001808a
- (void)invalidate;	// IMP=0x0010000000018009
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x0010000000017d5c
