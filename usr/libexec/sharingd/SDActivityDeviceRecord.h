...
- (void).cxx_destruct;	// IMP=0x00200000000273dc
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000262ed
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000262d5
- (id)description;	// IMP=0x00100000000261f0
- (id)initWithDevice:(id)arg1;	// IMP=0x001000000002615e
