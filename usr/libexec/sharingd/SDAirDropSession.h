...
- (void).cxx_destruct;	// IMP=0x002000000000eeef
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000000eb1b
- (void)handleConversionProgress:(id)arg1;	// IMP=0x001000000000ea43
- (void)startProgress;	// IMP=0x001000000000e79c
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x001000000000e55c
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x001000000000dd54
- (void)removeClientAlerts;	// IMP=0x001000000000dc1f
- (void)dealloc;	// IMP=0x001000000000db9e
- (void)stop;	// IMP=0x001000000000d993
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x001000000000d623
- (void)serversChanged:(id)arg1;	// IMP=0x001000000000d2ab
- (_Bool)send;	// IMP=0x001000000000d162
- (void)start;	// IMP=0x001000000000ce5c
- (void)releaseSandboxExtensions;	// IMP=0x001000000000cd25
- (void)consumeSandboxExtensions;	// IMP=0x001000000000ca4d
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000000ca21
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x001000000000c7f4
