...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000148c6
- (unsigned long long)hash;	// IMP=0x0010000000014825
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000146e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000014612
- (void)copyTo:(id)arg1;	// IMP=0x0010000000014567
- (MISSING_TYPE *)writeTo: /* Error: Ran out of types for this method. */;	// IMP=0x0010000000014491
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000014484
- (id)dictionaryRepresentation;	// IMP=0x0010000000013e7e
- (id)description;	// IMP=0x0010000000013dcf
