...
- (void).cxx_destruct;	// IMP=0x002000000018ce48
...
- (id)createContextDictionary;	// IMP=0x001000000018c716
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000018c1fe
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x001000000018c18b
