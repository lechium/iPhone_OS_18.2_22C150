...
- (void).cxx_destruct;	// IMP=0x002000000018a1f9
...
- (id)trimHeader:(id)arg1;	// IMP=0x0010000000189e8e
- (unsigned int)parseHeader:(id)arg1;	// IMP=0x0010000000189df3
- (void)handleMessageWritten:(id)arg1;	// IMP=0x0010000000189d0c
- (void)handleSpaceForMessage;	// IMP=0x0010000000189844
- (void)resetReadState;	// IMP=0x0010000000189800
- (void)handleMessageRead;	// IMP=0x001000000018978b
- (void)handleHeaderRead;	// IMP=0x001000000018966b
- (void)handleBytesForMessage;	// IMP=0x0010000000189389
- (id)headerWithLength:(unsigned int)arg1;	// IMP=0x0010000000189322
- (id)messageWithData:(id)arg1;	// IMP=0x00100000001892ae
- (void)sendMessage:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000188f9d
- (void)sendMessage:(id)arg1 withErrorHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000188f5c
- (void)handleSpaceForStream;	// IMP=0x0010000000188c6e
- (void)handleBytesForStream;	// IMP=0x001000000018899c
- (void)writeToStreamWithData:(id)arg1;	// IMP=0x0010000000188819
- (void)handleSpaceAvailable;	// IMP=0x0010000000188706
- (void)handleBytesAvailable;	// IMP=0x00100000001885f3
- (void)handleOpenedStream:(id)arg1;	// IMP=0x00100000001883e1
- (void)setTCPProperties:(id)arg1;	// IMP=0x00100000001882ec
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000018816f
- (_Bool)evaluateCert;	// IMP=0x0010000000187e78
- (void)applySSLSettings:(id)arg1;	// IMP=0x0010000000187b23
- (void)invalidateOpenTimer;	// IMP=0x0010000000187a91
- (void)openTimerFired:(id)arg1;	// IMP=0x00100000001878c9
- (void)startOpenTimer;	// IMP=0x00100000001877f2
- (void)logTransfer;	// IMP=0x0010000000187628
@property _Bool shouldReadNetwork; // @synthesize shouldReadNetwork=_shouldReadNetwork;
- (void)_stop;	// IMP=0x0010000000187300
- (void)stopIfReady;	// IMP=0x00100000001872be
- (void)stop;	// IMP=0x001000000018727e
- (void)start;	// IMP=0x0010000000186fa3
- (void)dealloc;	// IMP=0x0010000000186ee7
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 isClient:(_Bool)arg3;	// IMP=0x0010000000186d3c
