...
- (void).cxx_destruct;	// IMP=0x00200000001837e4
...
- (unsigned long long)hash;	// IMP=0x00100000001835f2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000183528
- (id)description;	// IMP=0x0010000000183430
- (void)dealloc;	// IMP=0x0010000000183379
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x001000000018319a
