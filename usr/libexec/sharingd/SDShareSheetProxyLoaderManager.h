...
- (void).cxx_destruct;	// IMP=0x002000000018eb97
...
- (void)proxyLoader:(id)arg1 didLoadProxiesWithResult:(id)arg2;	// IMP=0x001000000018e841
- (void)_didFinishLoadingLoader:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x001000000018e606
- (void)_scheduleLoadingBlock:(CDUnknownBlockType)arg1 synchronously:(_Bool)arg2;	// IMP=0x001000000018e5eb
- (id)_existingLoaderForSectionType:(long long)arg1;	// IMP=0x001000000018e439
- (void)loadProxySection:(id)arg1;	// IMP=0x001000000018e194
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x001000000018e07b
