...
+ (long long)setupRequestVersion;	// IMP=0x004000000002c3be
- (void).cxx_destruct;	// IMP=0x0020000000031e68
...
// Error: Property attributes should begin with the type ('T') attribute, property name: ltkTimer
...
- (id)userInfoForNewProtocol;	// IMP=0x001000000003190e
- (id)userInfoForOldProtocol;	// IMP=0x0010000000031826
- (id)userInfoForNoCommunincation;	// IMP=0x001000000003173e
- (id)userInfoForNoPasscode;	// IMP=0x0010000000031656
- (id)userInfoForNoWristDetection;	// IMP=0x001000000003156e
- (id)userInfoForNoWristDetectionNoPasscode;	// IMP=0x0010000000031486
- (id)userInfoCompanionViewNotSyncing;	// IMP=0x001000000003139e
- (id)userInfoForWatchLocked;	// IMP=0x00100000000312b6
- (id)userInfoForNotCloudPaired;	// IMP=0x0010000000031212
- (id)userInfoForMacNotSignedIn;	// IMP=0x001000000003112a
- (id)userInfoForWatchNotSignedIn;	// IMP=0x0010000000031042
- (id)userInfoForMissingLTK;	// IMP=0x0010000000030f5a
- (id)userInfoForInternetSharing;	// IMP=0x0010000000030e72
- (id)userInfoForKeychainMismatch;	// IMP=0x0010000000030d8a
- (id)userInfoForiPhoneNeedsUnlock;	// IMP=0x0010000000030ca2
- (void)transport:(id)arg1 didReceiveMessageACKForIdentifier:(id)arg2;	// IMP=0x0010000000030aa5
- (void)transport:(id)arg1 didReceivePayload:(id)arg2 type:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x0010000000030996
- (void)sendCreateSecretWithStepData:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x00100000000305e0
- (void)sendSetupRequest;	// IMP=0x00100000000300e1
- (void)handleSuccessfulPairing;	// IMP=0x001000000002f9b5
- (void)handleSetupCreateRecord:(id)arg1;	// IMP=0x001000000002f278
- (void)handleDeviceAuthenticationSetupRequest;	// IMP=0x001000000002ebdd
- (void)handleEscrowSessionRequest;	// IMP=0x001000000002e1ac
- (void)handleSetupSessionCreated:(id)arg1 fromDeviceID:(id)arg2;	// IMP=0x001000000002d685
- (void)handleKeyDeviceLocked;	// IMP=0x001000000002d589
- (void)handleMessage:(id)arg1 fromDeviceID:(id)arg2 type:(unsigned short)arg3;	// IMP=0x001000000002d28f
- (_Bool)ltkHashMatches;	// IMP=0x001000000002d176
- (void)handleLTKTimerFired;	// IMP=0x001000000002cef5
- (void)invalidateLTKTimer;	// IMP=0x001000000002ce1f
- (void)restartLTKTimer;	// IMP=0x001000000002cc10
- (void)notifyDelegateKeyDeviceIsLocked;	// IMP=0x001000000002cb73
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x001000000002c3d6
- (_Bool)useAttestedProtocol;	// IMP=0x001000000002c3ce
- (_Bool)validatePasscode:(id)arg1;	// IMP=0x001000000002c3b6
- (void)handleTimerFired;	// IMP=0x001000000002c1ed
- (id)generatedError;	// IMP=0x001000000002c0d8
- (void)invalidate;	// IMP=0x001000000002bfdf
- (void)onqueue_updateForCloudPairing;	// IMP=0x001000000002bf80
- (void)updateForCloudPairing;	// IMP=0x001000000002bef9
- (void)onqueue_cancel;	// IMP=0x001000000002bde2
- (void)cancel;	// IMP=0x001000000002bd5b
- (void)onqueue_start;	// IMP=0x001000000002b5ba
- (void)start;	// IMP=0x001000000002b533
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x001000000002b15d
