...
- (void).cxx_destruct;	// IMP=0x00200000000d0948
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000d06ea
- (unsigned long long)hash;	// IMP=0x00100000000d047f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000d01e9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d0029
- (void)copyTo:(id)arg1;	// IMP=0x00100000000cfebc
- (void)writeTo:(id)arg1;	// IMP=0x00100000000cfd2d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000cfd20
- (id)dictionaryRepresentation;	// IMP=0x00100000000cf3b2
- (id)description;	// IMP=0x00100000000cf303
