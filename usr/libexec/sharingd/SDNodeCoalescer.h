...
- (void).cxx_destruct;	// IMP=0x0020000000126fc2
...
- (id)mappedContactIdentifierForContactIdentifier:(id)arg1;	// IMP=0x0010000000126f3f
- (id)setMappedContactIdentifier:(id)arg1 relatedContactIdentifiers:(id)arg2;	// IMP=0x0010000000126bff
- (id)coalescedNodesForNewAvailableNodes:(id)arg1;	// IMP=0x0010000000125ba1
- (id)init;	// IMP=0x0010000000125b2c
