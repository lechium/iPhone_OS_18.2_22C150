...
- (void).cxx_destruct;	// IMP=0x00200000001d4954
...
// Error: Property attributes should begin with the type ('T') attribute, property name: shouldUnlock
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x00100000001d4171
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000001d3bb9
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001d3ba1
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x00100000001d346a
- (void)sendAWDLInfo;	// IMP=0x00100000001d3456
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001d33b9
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001d32c8
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001d32b6
- (void)_start;	// IMP=0x00100000001d32a4
- (void)start;	// IMP=0x00100000001d321d
- (id)getAppName;	// IMP=0x00100000001d3215
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00100000001d320f
- (void)connectionActivated;	// IMP=0x00100000001d3209
- (void)invalidate;	// IMP=0x00100000001d3110
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00100000001d3073
