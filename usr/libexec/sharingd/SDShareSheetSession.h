...
@interface SDShareSheetSession : NSObject
{
    ...
    NSArray *_recipients;	// 512 = 0x200
    NSString *_performActivityType;	// 520 = 0x208
    CDUnknownBlockType _performActivityCompletionHandler;	// 528 = 0x210
    CDUnknownBlockType _findSupportedActivitiesCompletionHandler;	// 536 = 0x218
}

+ (id)secondaryLabelColorWithHostConfiguration:(id)arg1;	// IMP=0x0020000000162017
+ (id)labelColorWithHostConfiguration:(id)arg1;	// IMP=0x0010000000161e9a
- (void).cxx_destruct;	// IMP=0x0020000000163b53
@property(copy, nonatomic) CDUnknownBlockType findSupportedActivitiesCompletionHandler; // @synthesize findSupportedActivitiesCompletionHandler=_findSupportedActivitiesCompletionHandler;
@property(copy, nonatomic) CDUnknownBlockType performActivityCompletionHandler; // @synthesize performActivityCompletionHandler=_performActivityCompletionHandler;
@property(retain, nonatomic) NSString *performActivityType; // @synthesize performActivityType=_performActivityType;
...
- (void)didConnectNearbySharingInteractionWithEndpointUUID:(id)arg1;	// IMP=0x00100000001632cd
- (void)proxyLoaderManagerDidFinishLoadingProxySection:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x00100000001631f3
- (void)proxyLoaderManager:(id)arg1 didLoadProxiesWithChangeDetails:(id)arg2;	// IMP=0x0010000000163197
- (void)_updateProxiesWithChangeDetails:(id)arg1;	// IMP=0x0010000000162fb1
- (void)_removeFailedIndexes:(id)arg1 forProxySection:(id)arg2;	// IMP=0x0010000000162d61
- (void)reportCurrentInvocationForDuration:(long long)arg1;	// IMP=0x001000000016292d
- (void)_loadProxySectionWithType:(long long)arg1;	// IMP=0x0010000000162862
- (id)_proxySectionForType:(long long)arg1;	// IMP=0x0010000000162773
- (id)minimumVisibleShareActivities;	// IMP=0x00100000001621af
- (void)generateSpecialPreviewPhotoForRequestID:(long long)arg1;	// IMP=0x00100000001618e6
- (_Bool)addAttributedString:(id)arg1 withAttachmentName:(id)arg2 description:(id)arg3 previewImage:(id)arg4 itemIndex:(int)arg5;	// IMP=0x00100000001615d4
- (_Bool)addString:(id)arg1 withAttachmentName:(id)arg2 description:(id)arg3 previewImage:(id)arg4 itemIndex:(int)arg5;	// IMP=0x001000000016135d
- (_Bool)createURLPayloadForData:(id)arg1 ofType:(id)arg2 withAttachmentName:(id)arg3 description:(id)arg4 previewImage:(id)arg5 itemIndex:(int)arg6 completion:(CDUnknownBlockType)arg7;	// IMP=0x0010000000160dbe
- (_Bool)addData:(id)arg1 ofType:(id)arg2 withAttachmentName:(id)arg3 description:(id)arg4 previewImage:(id)arg5 itemIndex:(int)arg6;	// IMP=0x0010000000160ac8
- (_Bool)addImage:(id)arg1 withAttachmentName:(id)arg2 description:(id)arg3 previewImage:(id)arg4 itemIndex:(int)arg5;	// IMP=0x001000000016057b
- (_Bool)addURL:(id)arg1 withAttachmentName:(id)arg2 description:(id)arg3 previewImage:(id)arg4 itemIndex:(int)arg5;	// IMP=0x001000000015ff8e
- (_Bool)isValidPayload:(id)arg1 toPerson:(id)arg2 invalidMessage:(id *)arg3;	// IMP=0x001000000015f33a
- (void)resetAfterAirDropTransferWithItemData:(id)arg1;	// IMP=0x001000000015f106
- (void)cancelAirDropForNode:(id)arg1;	// IMP=0x001000000015f078
- (void)sendItems:(id)arg1 itemData:(id)arg2 toEndpointUUID:(id)arg3 withNode:(id)arg4;	// IMP=0x001000000015dfb5
@property(readonly, nonatomic) NSString *hostAppProcessName;
@property(readonly, nonatomic) NSString *hostAppBundleID;
- (id)_orderedActivitiesIncludingUserDisabledExtensionsForAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x001000000015dee5
- (void)_loadPresentableActivitiesForAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x001000000015ddd9
- (id)_orderedAvailableActivitiesForAuditToken:(CDStruct_4c969caf)arg1 WithMatchingContextCustomizationBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000015d9b7
- (void)checkPolicyForAirDropPeople;	// IMP=0x001000000015d38d
- (void)checkPolicyForSuggestedPeople;	// IMP=0x001000000015cbd0
- (void)updateRestrictedActivityTypes:(id)arg1;	// IMP=0x001000000015c32a
- (void)nodesPotentiallyUpdated;	// IMP=0x001000000015c276
- (void)systemRestrictionsChanged:(id)arg1;	// IMP=0x001000000015bacd
- (void)removeStatusMonitorObservers;	// IMP=0x001000000015ba7a
- (void)addStatusMonitorObservers;	// IMP=0x001000000015b9e9
- (id)airdropNodeForIdentifier:(id)arg1;	// IMP=0x001000000015b788
- (void)_deactivateSecurityContext:(id)arg1;	// IMP=0x001000000015b6cc
- (void)_activateSecurityContext:(id)arg1;	// IMP=0x001000000015b610
- (void)setUiServiceConnection:(id)arg1;	// IMP=0x001000000015b5a5
- (id)uiServiceConnection;	// IMP=0x001000000015b54a
- (id)connection;	// IMP=0x001000000015b4ef
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) _Bool skipSlotsRendering;
- (void)invalidate;	// IMP=0x001000000015af09
- (void)activate;	// IMP=0x001000000015ad2c
- (id)initWithSessionID:(id)arg1 xpcConnection:(id)arg2 instantShareSheet:(_Bool)arg3 remoteShareSheet:(_Bool)arg4 xrRenderingMode:(unsigned long long)arg5;	// IMP=0x001000000015a4b6
