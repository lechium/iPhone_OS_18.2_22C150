...
@interface SFCombinedDevice : NSObject
{
    ...
    MISSING_TYPE *_transferPendingDurationSecs;	// 152 = 0x98
}

- (void).cxx_destruct;	// IMP=0x002000000009a3ee
...
- (_Bool)stateIsNearby;	// IMP=0x001000000009a008
- (_Bool)stateIsMedium;	// IMP=0x0010000000099fd7
- (_Bool)stateIsClose;	// IMP=0x0010000000099fc5
- (void)resetTicks;	// IMP=0x0010000000099e2e
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x0010000000099638
- (_Bool)canTransition:(int)arg1;	// IMP=0x0010000000099543
- (id)description;	// IMP=0x0010000000099228
