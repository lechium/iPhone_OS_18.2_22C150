...
- (void).cxx_destruct;	// IMP=0x002000000010a402
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000010a15c
- (unsigned long long)hash;	// IMP=0x0010000000109fcc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000109d67
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000109b79
- (void)copyTo:(id)arg1;	// IMP=0x0010000000109a01
- (void)writeTo:(id)arg1;	// IMP=0x0010000000109881
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000109874
- (id)dictionaryRepresentation;	// IMP=0x00100000001090c8
- (id)description;	// IMP=0x0010000000109019
