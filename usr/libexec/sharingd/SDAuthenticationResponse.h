...
- (void).cxx_destruct;	// IMP=0x002000000001ee3c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000001ece6
- (unsigned long long)hash;	// IMP=0x001000000001ec26
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001eae6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001e9d8
- (void)copyTo:(id)arg1;	// IMP=0x001000000001e911
- (void)writeTo:(id)arg1;	// IMP=0x001000000001e849
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000001e83c
- (id)dictionaryRepresentation;	// IMP=0x001000000001e40c
- (id)description;	// IMP=0x001000000001e35d
