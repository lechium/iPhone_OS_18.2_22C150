...
- (void).cxx_destruct;	// IMP=0x00200000001f293c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001f282b
- (unsigned long long)hash;	// IMP=0x00100000001f2784
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001f2669
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001f2588
- (void)copyTo:(id)arg1;	// IMP=0x00100000001f24e1
- (void)writeTo:(id)arg1;	// IMP=0x00100000001f2435
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001f2428
- (id)dictionaryRepresentation;	// IMP=0x00100000001f2037
- (id)description;	// IMP=0x00100000001f1f88
