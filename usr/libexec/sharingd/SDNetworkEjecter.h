...
- (void).cxx_destruct;	// IMP=0x0020000000137409
...
- (void)stop;	// IMP=0x001000000013735b
- (int)start;	// IMP=0x00100000001372bf
- (void)eject;	// IMP=0x00100000001370aa
- (void)ejectMountPoints:(id)arg1 useAssistant:(_Bool)arg2;	// IMP=0x00100000001370a4
- (void)notifyClientAboutEject:(int)arg1;	// IMP=0x0010000000136f39
- (void)dealloc;	// IMP=0x0010000000136eff
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x0010000000136e84
