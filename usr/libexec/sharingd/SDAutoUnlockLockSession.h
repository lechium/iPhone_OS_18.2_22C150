...
- (void).cxx_destruct;	// IMP=0x002000000025cf38
...
// Error: Property attributes should begin with the type ('T') attribute, property name: iconTransferStore
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2 suppressNotification:(_Bool)arg3;	// IMP=0x001000000025be84
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x001000000025be6f
- (void)completeAttemptPostNotification:(_Bool)arg1;	// IMP=0x001000000025bdcd
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x001000000025bb23
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x001000000025b2af
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x001000000025ae72
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000025aae1
- (void)consumeAuthTokenIfReady;	// IMP=0x001000000025a3bb
- (void)startAWDL;	// IMP=0x00100000002599a1
- (void)handleConfirmationACK;	// IMP=0x0010000000259723
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x001000000025924d
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x00100000002588da
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x0010000000258595
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x0010000000257e90
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000257a46
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00100000002577ff
- (void)handleWiFiRequestInvalidated;	// IMP=0x00100000002577a3
- (void)handleRangingStarted;	// IMP=0x001000000025769f
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x00100000002575e0
- (void)handleAWDLUp;	// IMP=0x001000000025742b
- (void)handlePeerOutOfRange;	// IMP=0x00100000002571f2
- (void)handlePeerInRange;	// IMP=0x0010000000256f0a
- (_Bool)peerInRange:(id)arg1;	// IMP=0x0010000000256d79
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x0010000000256846
- (void)invalidateConfirmationTimer;	// IMP=0x0010000000256770
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00100000002564e9
- (void)handleTimerFired;	// IMP=0x001000000025600c
- (void)invalidateTimerIfReady;	// IMP=0x0010000000255fc1
- (id)aksPeerAvailable;	// IMP=0x0010000000255ddc
- (void)deviceConnected:(id)arg1;	// IMP=0x0010000000255a07
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x0010000000255731
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x00100000002556d2
- (void)connectionActivated;	// IMP=0x0010000000255523
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x0010000000254e32
- (id)getAppName;	// IMP=0x0010000000254e2a
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x0010000000254cf9
- (_Bool)isAcceptor;	// IMP=0x0010000000254cf1
- (id)attemptResults;	// IMP=0x001000000025409c
- (void)logResults;	// IMP=0x001000000025323a
- (void)displayConfigChanged:(id)arg1;	// IMP=0x001000000025319e
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x0010000000253102
- (void)removeObservers;	// IMP=0x00100000002530af
- (void)addObservers;	// IMP=0x0010000000252fb1
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x0010000000252e60
- (void)_handleCanceledAfterSuccess;	// IMP=0x0010000000252d59
- (void)handleCanceledAfterSuccess;	// IMP=0x0010000000252cd2
- (void)lockKeyBagIfNeeded;	// IMP=0x0010000000252bf5
- (void)cancelWiFiRequest;	// IMP=0x0010000000252a0e
- (void)_cancel;	// IMP=0x00100000002526c3
- (void)cancel;	// IMP=0x001000000025263c
- (void)tearDownAWDLIfNecessary;	// IMP=0x0010000000252468
- (void)completeAttemptIfNecessary;	// IMP=0x00100000002522a6
- (void)invalidateNoDisconnect;	// IMP=0x0010000000252277
- (void)invalidate;	// IMP=0x001000000025205c
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000251c60
