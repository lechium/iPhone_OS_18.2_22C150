...
+ (id)sharedManager;	// IMP=0x0020000000105c14
- (void).cxx_destruct;	// IMP=0x0020000000106ec4
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x0010000000106ce5
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x0010000000106ccf
- (void)appleAccountSignedOut;	// IMP=0x0010000000106c57
- (void)appleAccountSignedIn;	// IMP=0x0010000000106bdf
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0010000000106afd
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x001000000010684f
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000106508
- (void)cleanUpConnections;	// IMP=0x00100000001061cc
- (void)start;	// IMP=0x0010000000105db6
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x0010000000105c69
