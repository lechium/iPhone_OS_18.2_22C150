...
- (void).cxx_destruct;	// IMP=0x00200000001d6116
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001d5ee7
- (unsigned long long)hash;	// IMP=0x00100000001d5d92
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d5b78
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001d59d0
- (void)copyTo:(id)arg1;	// IMP=0x00100000001d5880
- (void)writeTo:(id)arg1;	// IMP=0x00100000001d5715
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001d5708
- (id)dictionaryRepresentation;	// IMP=0x00100000001d4e5b
- (id)description;	// IMP=0x00100000001d4dac
