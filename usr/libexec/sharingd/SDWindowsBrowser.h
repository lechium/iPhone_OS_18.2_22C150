...
- (void).cxx_destruct;	// IMP=0x0020000000197792
...
- (void)stop;	// IMP=0x0010000000197708
- (void)start;	// IMP=0x0010000000197621
- (void)bonjourNodesDidChange:(id)arg1;	// IMP=0x00100000001975eb
@property(readonly, copy) NSArray *nodes;
- (void)dealloc;	// IMP=0x0010000000197597
- (id)initWithWorkgroup:(id)arg1;	// IMP=0x001000000019751a
