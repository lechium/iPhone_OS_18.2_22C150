...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001df443
- (void).cxx_destruct;	// IMP=0x00200000001df783
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001df63c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001df576
- (id)description;	// IMP=0x00100000001df56e
- (id)initWithPerspectiveData:(id)arg1 perspectiveDataSize:(struct CGSize)arg2 CGImageData:(id)arg3;	// IMP=0x00100000001df4b5
- (id)init;	// IMP=0x00100000001df44b
