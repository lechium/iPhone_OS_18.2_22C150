...
- (void)onScenarioTrigger:(id)arg1;	// IMP=0x0010000000a1777c
- (void)onVisit:(id)arg1;	// IMP=0x0010000000a17555
- (id)initWithFenceMonitor:(void *)arg1;	// IMP=0x0010000000a17508
