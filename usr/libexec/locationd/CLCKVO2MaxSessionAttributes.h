...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000ddcdfa
- (unsigned long long)hash;	// IMP=0x0010000000ddcabf
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000ddc974
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000ddc885
- (void)copyTo:(id)arg1;	// IMP=0x0010000000ddc7d4
- (void)writeTo:(id)arg1;	// IMP=0x0010000000ddc6e1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000ddc6d4
- (id)dictionaryRepresentation;	// IMP=0x0010000000ddc117
- (id)description;	// IMP=0x0010000000ddc0a0
