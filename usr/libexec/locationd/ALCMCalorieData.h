...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000050a587
- (unsigned long long)hash;	// IMP=0x001000000050a074
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000509ef9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000509de9
- (void)copyTo:(id)arg1;	// IMP=0x0010000000509d17
- (void)writeTo:(id)arg1;	// IMP=0x0010000000509be1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000509bd4
- (id)dictionaryRepresentation;	// IMP=0x00100000005090a2
- (id)description;	// IMP=0x001000000050902b
@property(nonatomic) _Bool hasMetsFM;
- (void);	// IMP=0x0010000000509001
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
- (int)StringAsTruthMetsSource:(id)arg1;	// IMP=0x0010000000508ea8
- (id)truthMetsSourceAsString:(int)arg1;	// IMP=0x0010000000508e6f
...
- (int)StringAsUserMetsSource:(id)arg1;	// IMP=0x0010000000508d61
- (id)userMetsSourceAsString:(int)arg1;	// IMP=0x0010000000508d28
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x0010000000508790
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000005083c4
