...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000087dbe6
- (unsigned long long)hash;	// IMP=0x001000000087d5e9
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000087d447
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000087d325
- (void)copyTo:(id)arg1;	// IMP=0x001000000087d241
- (void)writeTo:(id)arg1;	// IMP=0x001000000087d0e1
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000087d0d4
- (id)dictionaryRepresentation;	// IMP=0x001000000087c497
- (id)description;	// IMP=0x001000000087c420
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
@property(nonatomic) _Bool hasTimestamp;
- (int)StringAsMetSource:(id)arg1;	// IMP=0x001000000087c2bb
- (id)metSourceAsString:(int)arg1;	// IMP=0x001000000087c282
- (int)StringAsActivityType:(id)arg1;	// IMP=0x001000000087bd54
- (id)activityTypeAsString:(int)arg1;	// IMP=0x001000000087b987
