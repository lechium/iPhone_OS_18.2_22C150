...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000da5439
- (unsigned long long)hash;	// IMP=0x0010000000da4fc6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000da4e1f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000da4cf6
- (void)copyTo:(id)arg1;	// IMP=0x0010000000da4c0b
- (void)writeTo:(id)arg1;	// IMP=0x0010000000da4ac1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000da4ab4
- (id)dictionaryRepresentation;	// IMP=0x0010000000da3ea1
- (id)description;	// IMP=0x0010000000da3e2a
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x0010000000da3784
- (id)activityTypeAsString:(int)arg1;	// IMP=0x0010000000da33b7
