...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000031b15a
- (unsigned long long)hash;	// IMP=0x001000000031ad4b
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000031ac33
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000031ab59
- (void)copyTo:(id)arg1;	// IMP=0x001000000031aabd
- (void)writeTo:(id)arg1;	// IMP=0x001000000031a9c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000031a9bc
- (id)dictionaryRepresentation;	// IMP=0x001000000031a3e2
- (id)description;	// IMP=0x001000000031a36b
