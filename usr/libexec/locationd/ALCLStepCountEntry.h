...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000022eccf
- (unsigned long long)hash;	// IMP=0x001000000022e977
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000022e854
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000022e773
- (void)copyTo:(id)arg1;	// IMP=0x001000000022e6d0
- (void)writeTo:(id)arg1;	// IMP=0x001000000022e5d1
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000022e5c4
- (id)dictionaryRepresentation;	// IMP=0x001000000022def8
- (id)description;	// IMP=0x001000000022de81
