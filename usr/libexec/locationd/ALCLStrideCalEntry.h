...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000022aa6b
- (unsigned long long)hash;	// IMP=0x001000000022a2c1
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000022a0f2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000229fb0
- (void)copyTo:(id)arg1;	// IMP=0x0010000000229eac
- (void)writeTo:(id)arg1;	// IMP=0x0010000000229d19
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000229d0c
- (id)dictionaryRepresentation;	// IMP=0x00100000002293cd
- (id)description;	// IMP=0x0010000000229356
