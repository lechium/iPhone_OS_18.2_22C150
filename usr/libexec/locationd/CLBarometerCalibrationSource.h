...
- (void)disableSource;	// IMP=0x00200000003d85bd
- (void)enableSource;	// IMP=0x00100000003d85b7
- (void)dealloc;	// IMP=0x00100000003d8581
- (id)initWithUniverse:(id)arg1 delegate:(id)arg2;	// IMP=0x00100000003d84ce
