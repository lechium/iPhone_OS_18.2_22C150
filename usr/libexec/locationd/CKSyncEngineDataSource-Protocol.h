...
@class CKRecord, CKRecordID, CKRecordZone, CKRecordZoneID, CKSyncEngine, CKSyncEngineBatch, MISSING_TYPE, NSArray, NSData, NSError, NSSet, NSString;
...
- (MISSING_TYPE *)syncEngine:zoneWithIDWasPurged: /* Error: Ran out of types for this method. */;
