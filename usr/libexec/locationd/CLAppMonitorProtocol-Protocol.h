...
@class NSArray, NSDictionary, NSString, RBSProcessHandle, RBSProcessMonitor, RBSProcessStateUpdate;

@protocol CLAppMonitorProtocol <CLNotifierServiceProtocol>
- (void)checkApplications:(NSArray *)arg1 withReply:(void (^)(NSArray *, NSArray *, NSArray *))arg2;
- (int)syncgetAppType:(NSString *)arg1;
- (void)onApplicationsProtectionStatusChanged:(NSArray *)arg1;
- (void)onApplicationsUninstalled:(NSArray *)arg1;
- (void)onApplicationsInstalled:(NSArray *)arg1;
- (void)onApplicationStateMonitor:(RBSProcessMonitor *)arg1 didUpdate:(RBSProcessStateUpdate *)arg2 forProcess:(RBSProcessHandle *)arg3;
