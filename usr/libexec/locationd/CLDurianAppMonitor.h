...
- (void)processMonitor:(id)arg1 didProvideUpdate:(id)arg2 forProcessHandle:(id)arg3;	// IMP=0x00100000011b6c79
- (void)dealloc;	// IMP=0x00100000011b6c2f
- (id)initWithQueue:(id)arg1;	// IMP=0x00100000011b69fb
