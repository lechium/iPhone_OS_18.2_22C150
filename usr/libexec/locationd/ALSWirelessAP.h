...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000c70160
- (unsigned long long)hash;	// IMP=0x0010000000c700c3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c6ffee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000c6ff0e
- (void)copyTo:(id)arg1;	// IMP=0x0010000000c6fe84
- (void)writeTo:(id)arg1;	// IMP=0x0010000000c6fdd3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000c6fdc6
- (id)dictionaryRepresentation;	// IMP=0x0010000000c6f991
- (id)description;	// IMP=0x0010000000c6f91a
@property(nonatomic) _Bool hasNumZaxisHarvestTraces;
@property(nonatomic) _Bool hasChannel;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x0010000000c6f820
