...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000027d34e
- (unsigned long long)hash;	// IMP=0x001000000027d2b1
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000027d1bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000027d0f0
- (void)copyTo:(id)arg1;	// IMP=0x001000000027d062
- (void)writeTo:(id)arg1;	// IMP=0x001000000027cf95
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000027cf88
- (id)dictionaryRepresentation;	// IMP=0x001000000027c9f8
- (id)description;	// IMP=0x001000000027c981
