...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000bf3d0a
- (unsigned long long)hash;	// IMP=0x0010000000bf3c55
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000bf3b60
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000bf3a61
- (void)copyTo:(id)arg1;	// IMP=0x0010000000bf39b3
- (void)writeTo:(id)arg1;	// IMP=0x0010000000bf38ed
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000bf38e0
- (id)dictionaryRepresentation;	// IMP=0x0010000000bf33d5
- (id)description;	// IMP=0x0010000000bf335e
...
- (void)dealloc;	// IMP=0x0010000000bf3204
