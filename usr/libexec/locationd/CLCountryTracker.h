...
+ (_Bool)isSupported;	// IMP=0x0020000000513230
+ (id)getSilo;	// IMP=0x0010000000510ef6
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000510edd
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000510e80
- (id).cxx_construct;	// IMP=0x002000000051546e
- (void).cxx_destruct;	// IMP=0x0010000000515446
...
- (double)calculateDistance:(id)arg1 b:(id)arg2;	// IMP=0x0010000000514d9f
- (void)onManagerNotification:(const int *)arg1 data:(const void *)arg2;	// IMP=0x0010000000514b37
- (void)checkLocationServicesStatus;	// IMP=0x00100000005149e5
- (void)requestLocationWithDesiredAccuracy:(double)arg1;	// IMP=0x0010000000514878
- (void)onLocationUnknownTimer;	// IMP=0x0010000000514756
- (void)updateLocationUnknown;	// IMP=0x0010000000514698
- (void)handleNewLocation:(id)arg1;	// IMP=0x00100000005133fe
- (_Bool)countriesAreUnchanged:(id)arg1;	// IMP=0x0010000000513323
- (void)sendUpdateToRDIfAllowed:(id)arg1;	// IMP=0x0010000000513238
- (void)locationManager:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x001000000051310a
- (void)locationManagerDidChangeAuthorization:(id)arg1;	// IMP=0x0010000000512fee
- (void)locationManager:(id)arg1 didUpdateLocations:(id)arg2;	// IMP=0x00100000005125a8
- (_Bool)locationIsUsable:(id)arg1;	// IMP=0x0010000000511fdb
- (void)refreshSettings;	// IMP=0x0010000000511b39
- (void)endService;	// IMP=0x001000000051194f
- (void)beginService;	// IMP=0x0010000000510f8f
- (id)init;	// IMP=0x0010000000510f52
