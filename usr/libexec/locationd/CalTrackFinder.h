...
- (void)_clearBuffers;	// IMP=0x0010000000da300a
- (unsigned long long)_removeAdditionalInconsistentSpeedPedometerEntries;	// IMP=0x0010000000da2de0
- (void)_closeCurrentTrack;	// IMP=0x0010000000da2158
- (void)_closeTrackCheckPedometer;	// IMP=0x0010000000da1561
- (void)_closeTrackCheckGpsOdometer;	// IMP=0x0010000000da0b0f
- (void)_closeTrackCheckGpsLocationFiltered;	// IMP=0x0010000000da05d5
- (void)_closeTrackCheckGpsLocation;	// IMP=0x0010000000da033a
- (void)_calculateTimeStartEndDistanceGpsPed;	// IMP=0x0010000000d9f835
- (double)_extremaRemovedMean:(double [5])arg1;	// IMP=0x0010000000d9f7d1
- (id)_filterGpsLocationBuffer;	// IMP=0x0010000000d9f166
- (void)updatePedometerBuffer:(struct CLExtendedStepCountEntry)arg1;	// IMP=0x0010000000d9f018
- (void)updateGpsOdometerBuffer:(struct CLOdometerEntry)arg1;	// IMP=0x0010000000d9ed05
- (void)_updateGpsLocationBufferFiltered:(id)arg1;	// IMP=0x0010000000d9ec23
- (void)updateGpsLocationBuffer:(id)arg1 gpsSource:(int)arg2;	// IMP=0x0010000000d9e404
- (void)stop;	// IMP=0x0010000000d9e260
- (void)dealloc;	// IMP=0x0010000000d9e1e5
- (id)init;	// IMP=0x0010000000d9df7a
