...
- (void)fire:(double)arg1 withError:(id)arg2;	// IMP=0x0010000000d4e13c
- (void)invalidate;	// IMP=0x0010000000d4e0d3
- (void)dealloc;	// IMP=0x0010000000d4e07c
- (id)initWithDistance:(double)arg1 inUniverse:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000d4df79
- (id)init;	// IMP=0x0010000000d4df4a
