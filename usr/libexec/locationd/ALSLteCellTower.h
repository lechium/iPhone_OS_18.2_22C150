...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000c1da79
- (unsigned long long)hash;	// IMP=0x0010000000c1d979
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c1d816
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000c1d6f2
- (void)copyTo:(id)arg1;	// IMP=0x0010000000c1d60e
- (void)writeTo:(id)arg1;	// IMP=0x0010000000c1d505
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000c1d4f8
- (id)dictionaryRepresentation;	// IMP=0x0000000000c1cdf6
- (id)description;	// IMP=0x0010000000c1cd7f
...
- (void)dealloc;	// IMP=0x0010000000c1cb70
