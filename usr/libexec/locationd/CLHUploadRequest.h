...
- (id)description;	// IMP=0x0010000000fb5c93
- (id)jsonObject;	// IMP=0x0010000000fb5c2f
@property(readonly) NSURLRequest *URLRequest;
- (id)initWithPayload:(id)arg1;	// IMP=0x0010000000fb5939
- (id)initWithArchive:(id)arg1;	// IMP=0x0010000000fb58e9
- (id)initWithRequest:(id)arg1 endpoint:(id)arg2 headers:(id)arg3;	// IMP=0x0010000000fb584f
- (void)dealloc;	// IMP=0x0010000000fb57f7
- (id)initWithPayload:(id)arg1 requestTypeCode:(unsigned int)arg2 endpoint:(id)arg3 headers:(id)arg4;	// IMP=0x0010000000fb5774
