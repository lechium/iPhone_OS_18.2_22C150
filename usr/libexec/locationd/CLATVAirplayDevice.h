...
- (id).cxx_construct;	// IMP=0x00200000005f9392
...
- (void)dealloc;	// IMP=0x00100000005f9329
- (id)initWithTimestamp:(time_point_60143bad)arg1 RSSI:(int)arg2 uuid:(id)arg3 ipv4:(unsigned int)arg4 channel:(int)arg5;	// IMP=0x00100000005f92ac
- (struct CLATVAirplayDeviceInternal)cppObject;	// IMP=0x00100000005f93a0
