...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000394768
...
- (id)description;	// IMP=0x0010000000394ca9
- (id)jsonObject;	// IMP=0x0010000000394abc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000003949db
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000003948c3
- (void)dealloc;	// IMP=0x0010000000394888
- (id)initWithAccessPoint:(struct AccessPoint)arg1;	// IMP=0x0010000000394770
