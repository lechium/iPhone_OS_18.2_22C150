...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000001156ce4
- (unsigned long long)hash;	// IMP=0x0010000001156bfb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000001156ac3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000011569ba
- (void)copyTo:(id)arg1;	// IMP=0x00100000011568f1
- (void)writeTo:(id)arg1;	// IMP=0x0010000001156809
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000011567fc
- (id)dictionaryRepresentation;	// IMP=0x00100000011561c0
- (id)description;	// IMP=0x0010000001156149
...
- (void)dealloc;	// IMP=0x0010000001155f84
