...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000c10a8c
- (unsigned long long)hash;	// IMP=0x0010000000c109be
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c108c5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000c107d8
- (void)copyTo:(id)arg1;	// IMP=0x0010000000c10735
- (void)writeTo:(id)arg1;	// IMP=0x0010000000c1064d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000c10640
- (id)dictionaryRepresentation;	// IMP=0x0010000000c0ffb6
- (id)description;	// IMP=0x0010000000c0ff3f
@property(nonatomic) _Bool hasPsc;
@property(nonatomic) _Bool hasArfcn;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x0010000000c0fe5c
