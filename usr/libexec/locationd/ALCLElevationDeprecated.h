...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000097c862
- (unsigned long long)hash;	// IMP=0x000000000097c715
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000097c65a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000097c5b3
- (void)copyTo:(id)arg1;	// IMP=0x001000000097c54a
- (void)writeTo:(id)arg1;	// IMP=0x001000000097c4a5
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000097c498
- (id)dictionaryRepresentation;	// IMP=0x001000000097c020
- (id)description;	// IMP=0x001000000097bfa9
@property(nonatomic) _Bool hasVerticalSpeed;
- (int)StringAsGradeType:(id)arg1;	// IMP=0x001000000097bed6
- (id)gradeTypeAsString:(int)arg1;	// IMP=0x001000000097be9d
