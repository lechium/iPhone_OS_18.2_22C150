...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000be7741
- (unsigned long long)hash;	// IMP=0x0010000000be7604
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000be745a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000be7300
- (void)copyTo:(id)arg1;	// IMP=0x0010000000be71e6
- (void)writeTo:(id)arg1;	// IMP=0x0010000000be709d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000be7090
- (id)dictionaryRepresentation;	// IMP=0x0010000000be67ea
- (id)description;	// IMP=0x0010000000be6773
...
- (void)dealloc;	// IMP=0x0010000000be64d0
