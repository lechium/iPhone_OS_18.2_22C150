...
- (id)cellWifiEndpoint;	// IMP=0x0010000001066ef5
...
- (id)description;	// IMP=0x0010000001066e7a
- (id)jsonObject;	// IMP=0x0010000001066d00
- (void)updateEndpoint:(id *)arg1 withKey:(id)arg2;	// IMP=0x0010000001066b8f
- (void)refresh;	// IMP=0x0010000001066aa3
- (void)dealloc;	// IMP=0x0010000001066a21
- (id)init;	// IMP=0x001000000106687e
