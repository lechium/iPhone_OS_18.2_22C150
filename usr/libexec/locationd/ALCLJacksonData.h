...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000002ba434
- (unsigned long long)hash;	// IMP=0x00100000002ba218
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002ba158
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002ba0ad
- (void)copyTo:(id)arg1;	// IMP=0x00100000002ba040
- (void)writeTo:(id)arg1;	// IMP=0x00100000002b9f99
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002b9f8c
- (id)dictionaryRepresentation;	// IMP=0x00100000002b9b6c
- (id)description;	// IMP=0x00100000002b9af5
