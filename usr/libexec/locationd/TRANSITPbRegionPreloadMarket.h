...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000005cc9cc
- (unsigned long long)hash;	// IMP=0x00100000005cc5d7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000005cc4c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000005cc27c
- (void)copyTo:(id)arg1;	// IMP=0x00100000005cc16d
- (void)writeTo:(id)arg1;	// IMP=0x00100000005cbfd5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000005cbfc8
- (id)dictionaryRepresentation;	// IMP=0x00100000005cb983
- (id)description;	// IMP=0x00100000005cb90c
- (id)tilesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000005cb8ef
- (unsigned long long)tilesCount;	// IMP=0x00100000005cb8d2
- (void)addTiles:(id)arg1;	// IMP=0x00100000005cb885
- (void)clearTiles;	// IMP=0x00100000005cb868
...
- (void)dealloc;	// IMP=0x00100000005cb6fc
