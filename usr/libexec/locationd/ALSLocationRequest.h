...
+ (Class)nr5GCellTowerType;	// IMP=0x0020000000c14f14
+ (Class)scdmaCellTowerType;	// IMP=0x0010000000c14e14
+ (Class)lteCellTowerType;	// IMP=0x0010000000c14d14
+ (Class)cdmaEvdoTowerType;	// IMP=0x0010000000c14bd1
+ (Class)cdmaCellTowerType;	// IMP=0x0010000000c14b1c
+ (Class)wirelessAPType;	// IMP=0x0010000000c149bc
+ (Class)cellTowerType;	// IMP=0x0010000000c14907
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000c187ed
- (unsigned long long)hash;	// IMP=0x0010000000c18574
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c1821e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000c1787a
- (void)copyTo:(id)arg1;	// IMP=0x0010000000c1739e
- (Class)responseClass;	// IMP=0x0010000000c1738d
- (unsigned int)requestTypeCode;	// IMP=0x0010000000c17382
- (void)writeTo:(id)arg1;	// IMP=0x0010000000c16c49
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000c16c3c
- (id)dictionaryRepresentation;	// IMP=0x0010000000c15275
- (id)description;	// IMP=0x0010000000c151fe
@property(readonly, nonatomic) _Bool hasMeta;
- (int)StringAsWifiAltitudeScale:(id)arg1;	// IMP=0x0010000000c1519d
- (id)wifiAltitudeScaleAsString:(int)arg1;	// IMP=0x0010000000c1515d
...
- (int)StringAsSurroundingWifiBands:(id)arg1;	// IMP=0x0010000000c150a6
- (id)surroundingWifiBandsAsString:(int)arg1;	// IMP=0x0010000000c15066
- (void)setSurroundingWifiBands:(int *)arg1 count:(unsigned long long)arg2;	// IMP=0x0010000000c1504f
- (int)surroundingWifiBandsAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000c14fb7
- (void)addSurroundingWifiBands:(int)arg1;	// IMP=0x0010000000c14fa4
- (void)clearSurroundingWifiBands;	// IMP=0x0010000000c14f93
...
- (id)nr5GCellTowerAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000c14ef7
- (unsigned long long)nr5GCellTowersCount;	// IMP=0x0010000000c14eda
- (void)addNr5GCellTower:(id)arg1;	// IMP=0x0010000000c14e8d
- (void)clearNr5GCellTowers;	// IMP=0x0010000000c14e70
@property(nonatomic) _Bool hasNumberOfSurroundingScdmaCells;
- (id)scdmaCellTowerAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000c14df7
- (unsigned long long)scdmaCellTowersCount;	// IMP=0x0010000000c14dda
- (void)addScdmaCellTower:(id)arg1;	// IMP=0x0010000000c14d8d
- (void)clearScdmaCellTowers;	// IMP=0x0010000000c14d70
@property(nonatomic) _Bool hasNumberOfSurroundingLteCells;
- (id)lteCellTowerAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000c14cf7
- (unsigned long long)lteCellTowersCount;	// IMP=0x0010000000c14cda
- (void)addLteCellTower:(id)arg1;	// IMP=0x0010000000c14c8d
- (void)clearLteCellTowers;	// IMP=0x0010000000c14c70
@property(nonatomic) _Bool hasNumberOfSurroundingCdmaEvdoCells;
@property(nonatomic) _Bool hasNumberOfSurroundingCdmaCells;
- (id)cdmaEvdoTowerAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000c14bb4
- (unsigned long long)cdmaEvdoTowersCount;	// IMP=0x0010000000c14b97
- (void)addCdmaEvdoTower:(id)arg1;	// IMP=0x0010000000c14b4a
- (void)clearCdmaEvdoTowers;	// IMP=0x0010000000c14b2d
- (id)cdmaCellTowerAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000c14aff
- (unsigned long long)cdmaCellTowersCount;	// IMP=0x0010000000c14ae2
- (void)addCdmaCellTower:(id)arg1;	// IMP=0x0010000000c14a95
- (void)clearCdmaCellTowers;	// IMP=0x0010000000c14a78
...
- (id)wirelessAPAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000c1499f
- (unsigned long long)wirelessAPsCount;	// IMP=0x0010000000c14982
- (void)addWirelessAP:(id)arg1;	// IMP=0x0010000000c14935
- (void)clearWirelessAPs;	// IMP=0x0010000000c14918
- (id)cellTowerAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000c148ea
- (unsigned long long)cellTowersCount;	// IMP=0x0010000000c148cd
- (void)addCellTower:(id)arg1;	// IMP=0x0010000000c14880
- (void)clearCellTowers;	// IMP=0x0010000000c14863
- (void)dealloc;	// IMP=0x0010000000c14794
