...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000582cf6
...
- (id)description;	// IMP=0x0010000000582ee1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000582e39
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000582cfe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000582c60
- (void)dealloc;	// IMP=0x0010000000582c08
- (id)initWithTimestamp:(id)arg1 state:(unsigned long long)arg2 hints:(unsigned long long)arg3;	// IMP=0x0010000000582b35
- (id)initWithTimeRange:(id)arg1 vehicleName:(id)arg2 vehicleModelName:(id)arg3 vehicleBluetoothAddress:(id)arg4;	// IMP=0x0010000000582a9d
