...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000c13bdc
- (unsigned long long)hash;	// IMP=0x0010000000c13abe
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c13935
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000c13810
- (void)copyTo:(id)arg1;	// IMP=0x0010000000c13729
- (void)writeTo:(id)arg1;	// IMP=0x0010000000c135d5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000c135c8
- (id)dictionaryRepresentation;	// IMP=0x0010000000c12ce0
- (id)description;	// IMP=0x0010000000c12c69
