...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000004fd080
- (unsigned long long)hash;	// IMP=0x00100000004fc370
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000004fbef1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004fbc29
- (void)copyTo:(id)arg1;	// IMP=0x00100000004fb99f
- (void)writeTo:(id)arg1;	// IMP=0x00100000004fb669
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000004fb65c
- (id)dictionaryRepresentation;	// IMP=0x00100000004fa0e0
- (id)description;	// IMP=0x00100000004fa069
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x00100000004f9ed1
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x00100000004f9e96
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000004f938c
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000004f8fc0
