...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000023d87e
- (unsigned long long)hash;	// IMP=0x001000000023d190
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000023d089
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000023cfb0
- (void)copyTo:(id)arg1;	// IMP=0x001000000023cf15
- (void)writeTo:(id)arg1;	// IMP=0x001000000023ce1d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000023ce10
- (id)dictionaryRepresentation;	// IMP=0x001000000023c7e1
- (id)description;	// IMP=0x001000000023c76a
- (int)StringAsGender:(id)arg1;	// IMP=0x001000000023c723
- (id)genderAsString:(int)arg1;	// IMP=0x001000000023c6e4
