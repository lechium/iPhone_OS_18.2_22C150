...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000020bfd
- (void).cxx_destruct;	// IMP=0x0020000000020e48
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000020da9
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000020c05
- (id)initResponseForHostname:(id)arg1 ipv4Address:(id)arg2 ipv6Address:(id)arg3;	// IMP=0x0010000000020aea
