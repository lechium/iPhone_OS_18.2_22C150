...
+ (void)invalidateConfigurationForEnvironment:(id)arg1 connectionType:(long long)arg2;	// IMP=0x004000000007b1f2
+ (void)loadConfigurationForEnvironment:(id)arg1 connectionType:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000007aeb7
+ (id)configurationForEnvironment:(id)arg1 connectionType:(long long)arg2;	// IMP=0x001000000007aca8
+ (id)_onQueue_configurationForEnvironment:(id)arg1 connectionType:(long long)arg2;	// IMP=0x001000000007a9fe
+ (void)initialize;	// IMP=0x001000000007a9a7
- (void).cxx_destruct;	// IMP=0x002000000007ccd3
...
- (void)setHasValidSignature:(_Bool)arg1;	// IMP=0x001000000007ccb6
- (_Bool)hasValidSignature;	// IMP=0x001000000007ccad
...
- (void)setExpiryInterval:(double)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000007ca8a
- (_Bool)_isExpired;	// IMP=0x001000000007ca2c
- (_Bool)_isLoaded;	// IMP=0x001000000007ca23
...
- (id)bagExpiryInterval;	// IMP=0x001000000007c901
...
- (id)ExpensiveConditionsBackOffInterval;	// IMP=0x001000000007c7a5
...
- (void)_finishLoadWithResponse:(id)arg1 urlHost:(id)arg2 data:(id)arg3;	// IMP=0x001000000007c014
- (void)_failWithError:(id)arg1;	// IMP=0x001000000007beee
- (void)_callCompletionBlocksWithError:(id)arg1;	// IMP=0x001000000007bc88
- (void)addCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000007bb2d
- (id)pendingCompletionBocks;	// IMP=0x001000000007bb1f
- (void)dealloc;	// IMP=0x001000000007bae0
- (id)initWithEnvironment:(id)arg1 connectionType:(long long)arg2;	// IMP=0x001000000007b4b1
