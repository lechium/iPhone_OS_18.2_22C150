...
- (id)description;	// IMP=0x0010000000043267
- (_Bool)isUnset;	// IMP=0x001000000004324a
- (void)clear;	// IMP=0x001000000004322e
- (_Bool)isUnderLimit;	// IMP=0x0010000000043204
- (void)note;	// IMP=0x00100000000431b5
- (_Bool)_checkIsExpired;	// IMP=0x0010000000043147
- (id)initWithLimit:(long long)arg1 timeLimit:(double)arg2;	// IMP=0x00100000000430fb
