...
@class APSDProtoHostCertificateInfo, APSOutgoingMessage, NSArray, NSData, NSDictionary, NSError, NSNumber, NSString;
...
- (NSError *)sendMessage:(APSOutgoingMessage *)arg1 topicHash:(NSData *)arg2 lastRTT:(NSNumber *)arg3 token:(NSData *)arg4 ultraConstrainedAllowed:(_Bool)arg5 withCompletion:(void (^)(NSDictionary *, NSError *))arg6;
- (void)sendMessageTransportAcknowledgeMessage;
- (void)sendConnectMessageWithToken:(NSData *)arg1 state:(int)arg2 presenceFlags:(unsigned int)arg3 certificates:(NSArray *)arg4 nonce:(NSData *)arg5 signature:(NSData *)arg6 hostCertificateInfo:(APSDProtoHostCertificateInfo *)arg7 withCompletion:(void (^)(NSDictionary *, NSError *))arg8;
- (void)sendConnectMessageWithToken:(NSData *)arg1 presenceFlags:(unsigned int)arg2 certificates:(NSArray *)arg3 nonce:(NSData *)arg4 signature:(NSData *)arg5 hostCertificateInfo:(APSDProtoHostCertificateInfo *)arg6 withCompletion:(void (^)(NSDictionary *, NSError *))arg7;
