...
+ (id)topicAttributesWithFilter:(long long)arg1 darkWakeEnabled:(_Bool)arg2 pushWakeEnabled:(_Bool)arg3 criticalWakeEnabled:(_Bool)arg4 ultraConstrainedEnabled:(_Bool)arg5;	// IMP=0x0040000000075cdb
...
- (id)description;	// IMP=0x0010000000075d3e
- (id)initWithFilter:(long long)arg1 darkWakeEnabled:(_Bool)arg2 pushWakeEnabled:(_Bool)arg3 criticalWakeEnabled:(_Bool)arg4 ultraConstrainedEnabled:(_Bool)arg5;	// IMP=0x0010000000075c6a
