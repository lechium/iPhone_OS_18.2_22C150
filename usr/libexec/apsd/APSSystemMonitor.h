...
+ (id)sharedInstance;	// IMP=0x00400000000c31c5
- (void).cxx_destruct;	// IMP=0x00200000000c3a93
...
- (void)removeListener:(id)arg1;	// IMP=0x00100000000c39bb
- (void)addListener:(id)arg1;	// IMP=0x00100000000c3927
- (void)_setSystemLockState:(_Bool)arg1;	// IMP=0x00100000000c37e1
- (void)_setSystemScreenState:(_Bool)arg1;	// IMP=0x00100000000c369b
- (void)_systemWillSleep;	// IMP=0x00100000000c35fe
- (void)_systemDidWake;	// IMP=0x00100000000c35e1
- (void)_deliverNotificationSelector:(SEL)arg1;	// IMP=0x00100000000c3530
- (void)dealloc;	// IMP=0x00100000000c3284
- (id)init;	// IMP=0x00100000000c321a
