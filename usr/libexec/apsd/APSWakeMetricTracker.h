...
- (void)_clearState;	// IMP=0x0010000000043880
- (void)_fireMetricIfNeeded;	// IMP=0x0010000000043756
- (void)_timerFired:(id)arg1;	// IMP=0x0010000000043725
- (void)noteReceivedLiveMessage;	// IMP=0x0010000000043713
- (void)noteSystemWillSleep;	// IMP=0x0010000000043701
- (void)noteReceivedStoredMessage;	// IMP=0x00100000000436b1
- (void)noteDidConnect;	// IMP=0x0010000000043641
- (void)noteSystemDidFullWakeWhileConnected:(_Bool)arg1;	// IMP=0x0010000000043592
- (id)initWithOnConnectedInterval:(double)arg1 onDisconnectedInterval:(double)arg2 metricSubmissionBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000004348a
- (id)init;	// IMP=0x001000000004334b
