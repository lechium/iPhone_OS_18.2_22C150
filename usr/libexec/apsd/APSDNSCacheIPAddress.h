...
- (void).cxx_destruct;	// IMP=0x0020000000075c23
...
- (void)updateExpirationTime:(double)arg1;	// IMP=0x0010000000075bae
- (id)initWithIPAddress:(id)arg1 addressFamily:(unsigned long long)arg2 timeToLive:(double)arg3;	// IMP=0x0010000000075b1d
