...
- (void).cxx_destruct;	// IMP=0x002000000007d68d
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000007d215
- (void)_cleanupConnection:(id)arg1;	// IMP=0x001000000007d076
- (void)dealloc;	// IMP=0x001000000007cfe4
- (id)initWithQueue:(id)arg1 apsDaemon:(id)arg2;	// IMP=0x001000000007ce3a
