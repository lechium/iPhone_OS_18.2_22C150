...
- (void).cxx_destruct;	// IMP=0x0020000000214935
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000002146de
- (_Bool)wantsHTTPGet;	// IMP=0x00100000002146d6
- (id)additionalQueryStringParameters;	// IMP=0x0010000000214571
- (id)additionalMessageHeaders;	// IMP=0x00100000002143d6
- (id)bagKey;	// IMP=0x00100000002143c9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000021420c
