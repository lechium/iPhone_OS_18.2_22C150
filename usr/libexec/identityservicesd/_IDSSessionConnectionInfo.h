...
- (void).cxx_destruct;	// IMP=0x00200000002f06bf
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x00100000002f023d
- (void)_addRemotePacketOutage;	// IMP=0x00100000002f01af
- (id)description;	// IMP=0x00100000002f00c1
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x00100000002efd84
