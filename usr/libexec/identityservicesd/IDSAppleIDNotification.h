...
- (void).cxx_destruct;	// IMP=0x00200000001ee150
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forSession:(id)arg2;	// IMP=0x00100000001edfbc
- (void)addSession:(id)arg1;	// IMP=0x00100000001edf70
- (void);	// IMP=0x00100000001edf5a
- (void)addAlias:(id)arg1;	// IMP=0x00100000001edf3d
- (id)init;	// IMP=0x00100000001ede9a
