...
- (void).cxx_destruct;	// IMP=0x0020000000340b56
...
- (id)decryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x001000000034039c
- (id)encryptData:(id)arg1 onQueue:(id)arg2 error:(long long *)arg3;	// IMP=0x001000000033fbd1
- (id);	// IMP=0x001000000033fb38
