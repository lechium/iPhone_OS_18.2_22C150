...
- (void).cxx_destruct;	// IMP=0x0020000000126783
...
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x0010000000126448
- (void)_didReceiveData:(id)arg1;	// IMP=0x0010000000125d39
- (void)didReceiveData:(id)arg1;	// IMP=0x0010000000125c9a
- (void)setHasSpaceAvailable:(_Bool)arg1;	// IMP=0x0010000000125a49
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x0010000000125a3e
- (unsigned long long)sendPacketBuffer:(CDStruct_90727270 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x00100000001257f1
- (id)copyLinkStatsDict;	// IMP=0x00100000001256d6
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)start;	// IMP=0x0010000000125664
- (void)triggerBTCorruptionRecovery;	// IMP=0x0010000000125652
- (void)_localDetectedCorruption;	// IMP=0x001000000012564c
- (void)dealloc;	// IMP=0x0010000000125601
- (id)initWithWPLinkManager:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x00100000001254bf
