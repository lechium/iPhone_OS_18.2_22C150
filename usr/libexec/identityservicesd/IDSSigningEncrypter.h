...
- (void).cxx_destruct;	// IMP=0x00200000000e6318
...
- (id)_signData:(id)arg1 withType:(long long)arg2 error:(id *)arg3;	// IMP=0x00100000000e6147
- (unsigned short)_retrieveKeyIndex;	// IMP=0x00100000000e608e
- (id)signData:(id)arg1 withType:(long long)arg2 onQueue:(id)arg3 error:(id *)arg4;	// IMP=0x00100000000e5e52
- (id)batchSignDatas:(id)arg1 withType:(long long)arg2 onQueue:(id)arg3 error:(id *)arg4;	// IMP=0x00100000000e5c64
- (void)signData:(id)arg1 withType:(long long)arg2 onQueue:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000e5a83
- (void)batchSignDatas:(id)arg1 withType:(long long)arg2 onQueue:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000e587d
- (id)initWithKeyType:(unsigned int)arg1 keyDiversifier:(id)arg2 service:(id)arg3 serviceController:(id)arg4 fullDeviceIdentitySigner:(id)arg5;	// IMP=0x00100000000e5783
