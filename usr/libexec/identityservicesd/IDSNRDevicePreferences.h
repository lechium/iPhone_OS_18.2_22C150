...
- (void).cxx_destruct;	// IMP=0x0020000000005fdf
...
- (void)deviceSetupCompleted;	// IMP=0x0010000000005f90
- (void)deviceSetupStarted;	// IMP=0x0010000000005f8a
- (void)cancel;	// IMP=0x0010000000005f84
- (void)removeAllQuickRelayRequests;	// IMP=0x0010000000005f7e
- (void)removeQuickRelayRequest;	// IMP=0x0010000000005f78
- (void)addQuickRelayRequest;	// IMP=0x0010000000005f72
- (void)removePreferWiFiRequest;	// IMP=0x0010000000005f6c
- (void)addPreferWiFiRequest;	// IMP=0x0010000000005f66
- (id)init;	// IMP=0x0010000000005f58
- (id)initWithDeviceIdentifier:(id)arg1;	// IMP=0x0010000000005f4a
