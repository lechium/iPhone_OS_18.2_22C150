...
- (void).cxx_destruct;	// IMP=0x002000000012ae84
...
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2 loggingPrefixString:(id)arg3;	// IMP=0x0010000000129544
- (id)data;	// IMP=0x0010000000128fd2
- (id)init;	// IMP=0x0010000000128fa3
- (_Bool)_isTinkerFlagSet;	// IMP=0x0010000000128f7d
- (_Bool)_isSupportIPsecLinkFlagSet;	// IMP=0x0010000000128f57
- (id)description;	// IMP=0x0010000000128e04
