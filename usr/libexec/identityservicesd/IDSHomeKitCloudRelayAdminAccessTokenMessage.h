...
- (void).cxx_destruct;	// IMP=0x002000000034739f
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000003471bb
- (id)bagKey;	// IMP=0x00100000003471ae
- (id)messageBody;	// IMP=0x00100000003470ce
- (id)additionalMessageHeaders;	// IMP=0x0010000000346f96
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000346df9
