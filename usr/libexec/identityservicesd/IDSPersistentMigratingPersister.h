...
- (void).cxx_destruct;	// IMP=0x00200000003bc9c8
...
- (void)purgeData;	// IMP=0x00100000003bc804
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000003bc754
- (id)data;	// IMP=0x00100000003bc703
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x00100000003bc4e0
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x00100000003bc449
