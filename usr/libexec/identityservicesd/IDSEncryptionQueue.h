...
- (void).cxx_destruct;	// IMP=0x002000000015af48
...
- (void)performSyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000015aecf
- (void)performAsyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000015aeb8
- (id)initWithName:(char *)arg1 qosClass:(unsigned int)arg2 specific:(char *)arg3;	// IMP=0x001000000015adef
