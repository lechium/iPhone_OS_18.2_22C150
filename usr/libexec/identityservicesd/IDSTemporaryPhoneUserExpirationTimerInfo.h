...
+ (long long)phaseForExpirationDate:(id)arg1;	// IMP=0x004000000011285b
- (void).cxx_destruct;	// IMP=0x002000000011289c
...
- (id)initWithUser:(id)arg1 expirationPhase:(long long)arg2;	// IMP=0x0010000000112705
- (id)initWithUser:(id)arg1;	// IMP=0x0010000000112674
