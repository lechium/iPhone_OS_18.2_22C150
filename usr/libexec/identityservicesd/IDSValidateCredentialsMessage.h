...
- (void).cxx_destruct;	// IMP=0x0020000000126e69
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000126c3c
- (id)bagKey;	// IMP=0x0010000000126c2f
- (id)requiredKeys;	// IMP=0x0010000000126c16
- (id)messageBody;	// IMP=0x0010000000126ada
- (id)additionalMessageHeaders;	// IMP=0x00100000001269d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000012683b
