...
- (void).cxx_destruct;	// IMP=0x002000000015b5bc
...
- (id)_legacyIdentity;	// IMP=0x001000000015b50e
- (_Bool)allowMessageData:(id)arg1 withDelayedCommitBlock:(CDUnknownBlockType *)arg2;	// IMP=0x001000000015b361
- (_Bool)allowMessageData:(id)arg1;	// IMP=0x001000000015b250
- (id)initWithRegistrationKeyManager:(id)arg1 messageHashStore:(id)arg2 usePairingKey:(_Bool)arg3;	// IMP=0x001000000015b1ad
- (id)initWithRegistrationKeyManager:(id)arg1;	// IMP=0x001000000015b129
