...
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000000558e4
- (void)setNotifyWhenConnectionReceivesBytes:(_Bool)arg1;	// IMP=0x00100000000558b0
- (void)_endSession;	// IMP=0x0010000000055679
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x001000000005533d
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x0010000000055329
- (void)_sendToConnectedSocket;	// IMP=0x0010000000054ab2
- (_Bool)_queueNextOutgoingData;	// IMP=0x0010000000053fb2
- (void)_processBytesAvailable;	// IMP=0x0010000000053497
- (_Bool)_processIncomingMessage:(id)arg1;	// IMP=0x0010000000052bb9
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0010000000052963
- (void)removePendingMessagesForProtectionClass:(unsigned int)arg1;	// IMP=0x0010000000052462
- (long long)_read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x00100000000521dd
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000520ed
...
- (void)endSession;	// IMP=0x0010000000051aa1
- (void)dealloc;	// IMP=0x0010000000051a18
- (void)start;	// IMP=0x00100000000518d0
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 connectionID:(id)arg5 linkType:(unsigned long long)arg6;	// IMP=0x0010000000051578
