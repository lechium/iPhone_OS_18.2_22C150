...
- (void).cxx_destruct;	// IMP=0x00200000003b0185
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x00100000003af8a7
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x00100000003af7fc
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x00100000003af7ae
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x00100000003af4ab
- (_Bool)supportsReinitiate;	// IMP=0x00100000003af410
- (void)_endSessionTimedOut;	// IMP=0x00100000003af30a
- (void)_endSessionTimerFiredOnMain;	// IMP=0x00100000003af28b
- (void)setEndSessionTimeoutTimer;	// IMP=0x00100000003af0c3
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x00100000003aef64
- (void)_clearPacketLossTimer;	// IMP=0x00100000003aee66
- (void)_connectionTimedOut;	// IMP=0x00100000003aed6d
- (void)_connectionTimerFiredOnMain;	// IMP=0x00100000003aecee
- (void)setConnectionTimer;	// IMP=0x00100000003aea3b
- (void)_clearConnectionTimer;	// IMP=0x00100000003ae8dc
- (void)_clearInvitationTimer;	// IMP=0x00100000003ae77d
- (void)_inviteTimedOut;	// IMP=0x00100000003ae632
- (void)_inviteTimerFiredOnMain;	// IMP=0x00100000003ae5b3
- (void)setInvitationTimer;	// IMP=0x00100000003ae3e0
- (void)clearAllTimers;	// IMP=0x00100000003ae398
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x00100000003acaac
