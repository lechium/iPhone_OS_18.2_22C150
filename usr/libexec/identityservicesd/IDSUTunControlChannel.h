...
@interface IDSUTunControlChannel : NSObject
{
    ...
    MISSING_TYPE *_disableEncryption;	// 112 = 0x70
...
- (void).cxx_destruct;	// IMP=0x002000000016918d
...
- (void)resumeOTRNegotiation;	// IMP=0x001000000016905e
- (void)suspendOTRNegotiation:(id)arg1;	// IMP=0x0010000000169058
- (_Bool)processSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x0010000000169050
- (void)sendSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x001000000016904a
- (_Bool)processOTRNegotiationMessage:(id)arg1;	// IMP=0x0010000000168b58
- (void)sendOTRNegotiationMessage:(id)arg1 negotiationCount:(unsigned int)arg2 negotiationData:(id)arg3;	// IMP=0x0010000000168b52
- (void)_destroyFairplayDeviceSession;	// IMP=0x0010000000168b4c
- (void)_destroyFairplayHostSession;	// IMP=0x0010000000168b46
- (void)_handleFairplayAuthenticationFailure;	// IMP=0x0010000000168ab1
- (_Bool)processFairplayDeviceSessionInfo:(id)arg1;	// IMP=0x0010000000168aa9
- (_Bool)processFairplayDeviceInfo:(id)arg1;	// IMP=0x0010000000168aa1
- (_Bool)processFairplayHostSessionInfo:(id)arg1;	// IMP=0x0010000000168a99
- (id)_utunControlMessageFairplayDeviceSessionInfo:(char *)arg1 grappaDeviceSessionInfoSize:(unsigned int)arg2;	// IMP=0x0010000000168a91
- (id)_utunControlMessageFairplayHostSessionInfo:(unsigned char)arg1 deviceType:(unsigned char)arg2 protocolVersion:(unsigned int)arg3;	// IMP=0x0010000000168a89
- (id)_utunControlMessageFairplayDeviceInfo;	// IMP=0x0010000000168a81
- (void)dealloc;	// IMP=0x0010000000168a43
- (void)invalidate;	// IMP=0x00100000001689ee
- (void)sendPriorityMessage:(id)arg1;	// IMP=0x0010000000168989
- (void)sendMessage:(id)arg1;	// IMP=0x0010000000168924
- (void)_checkSendNewMessage;	// IMP=0x0010000000167c57
- (void)_clearChannel;	// IMP=0x0010000000167b29
@property(readonly, nonatomic) _Bool connected;
- (void)cancelConnection;	// IMP=0x0010000000167afd
- (void)_cancelConnectionAndResetDataConnections:(_Bool)arg1 shouldObliterate:(_Bool)arg2 encryptionFailure:(_Bool)arg3 shouldTriggerCorruptionRecovery:(_Bool)arg4;	// IMP=0x001000000016798b
- (void)_callHandlerWithMessage:(id)arg1 resetDataConnections:(_Bool)arg2 shouldObliterate:(_Bool)arg3 decryptionFailed:(_Bool)arg4 shouldTriggerCorruptionRecovery:(_Bool)arg5;	// IMP=0x001000000016795f
- (void)useConnection:(id)arg1 withFirstMessage:(id)arg2;	// IMP=0x0010000000166e15
- (void)writeToConnection;	// IMP=0x0010000000166762
- (void)readFromConnection;	// IMP=0x0010000000165565
@property(readonly, nonatomic) _Bool isDefaultPairedDeviceStartingToEncrypt;
- (void)encryptControlChannelForStoredIdentities;	// IMP=0x0010000000165557
- (void)simulateDecryptionFailure;	// IMP=0x00100000001654c2
- (void)_cleanupConnection;	// IMP=0x0010000000165451
- (id)initWithDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 receiveHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000165233
- (id)description;	// IMP=0x0010000000165174
