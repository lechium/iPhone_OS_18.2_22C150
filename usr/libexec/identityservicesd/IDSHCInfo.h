...
- (void *)remoteContext;	// IMP=0x00100000002169a7
- (void *)localContext;	// IMP=0x001000000021699d
- (void)setRemoteContext:(void *)arg1;	// IMP=0x0010000000216881
- (void)setLocalContext:(void *)arg1;	// IMP=0x0010000000216765
- (void)invalidate;	// IMP=0x0010000000216606
