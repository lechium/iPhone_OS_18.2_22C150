...
- (void).cxx_destruct;	// IMP=0x00200000004ade46
...
- (id)description;	// IMP=0x00100000004adc11
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004adc06
- (unsigned long long)hash;	// IMP=0x00100000004adb50
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000004adaf7
- (_Bool)isEqualToKeyTransparencyEntry:(id)arg1;	// IMP=0x00100000004ad817
- (id)initWithPushToken:(id)arg1 loggableData:(id)arg2 signedData:(id)arg3;	// IMP=0x00100000004ad75f
