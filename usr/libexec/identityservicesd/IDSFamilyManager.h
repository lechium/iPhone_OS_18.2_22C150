...
+ (id)sharedInstance;	// IMP=0x0040000000163ae9
- (void).cxx_destruct;	// IMP=0x002000000016513f
...
- (void)_notifyFamilyServicesOfUpdate;	// IMP=0x0010000000164b7e
- (void)_familyDidUpdate:(id)arg1;	// IMP=0x0010000000164a5e
- (void)forceFamilyFetch;	// IMP=0x0010000000164870
- (_Bool)canForceFamilyFetch;	// IMP=0x001000000016485a
- (id)initWithFamilyRequest:(id)arg1;	// IMP=0x0010000000164769
- (id)init;	// IMP=0x0010000000164667
- (void)fetchFamilyWithFamilyRequest:(id)arg1;	// IMP=0x0010000000163d1e
- (id)handlesFromFamilyMember:(id)arg1;	// IMP=0x0010000000163b3e
