...
- (void).cxx_destruct;	// IMP=0x002000000011a8fe
...
- (void)handleResponseHeaders:(id)arg1;	// IMP=0x001000000011a67d
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000011a5c3
- (id)messageBody;	// IMP=0x001000000011a114
- (id)additionalMessageHeadersForOutgoingPush;	// IMP=0x001000000011a0b1
- (id)topic;	// IMP=0x001000000011a0a4
- (_Bool)wantsIntegerUniqueIDs;	// IMP=0x001000000011a09c
- (_Bool)wantsResponse;	// IMP=0x001000000011a094
- (_Bool)isIDSMessage;	// IMP=0x001000000011a08c
- (_Bool)highPriority;	// IMP=0x001000000011a084
- (_Bool)wantsAPSRetries;	// IMP=0x001000000011a07c
- (_Bool)wantsIDSProtocolVersion;	// IMP=0x001000000011a074
- (_Bool)isWebTunnelMessage;	// IMP=0x001000000011a06c
- (_Bool)wantsCompressedBody;	// IMP=0x001000000011a064
- (_Bool)wantsBinaryPush;	// IMP=0x001000000011a05c
- (long long)responseCommand;	// IMP=0x001000000011a051
- (long long)command;	// IMP=0x001000000011a046
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000119e98
