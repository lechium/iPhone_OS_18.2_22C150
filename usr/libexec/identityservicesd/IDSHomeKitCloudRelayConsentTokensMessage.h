...
- (void).cxx_destruct;	// IMP=0x002000000038e93e
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000038e827
- (id)bagKey;	// IMP=0x001000000038e81a
- (id)messageBody;	// IMP=0x001000000038e6f8
- (id)additionalMessageHeaders;	// IMP=0x001000000038e5c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000038e457
