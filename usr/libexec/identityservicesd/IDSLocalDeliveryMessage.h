...
@interface IDSLocalDeliveryMessage : NSObject
{
    ...
    MISSING_TYPE *_shouldEnforceRemoteTimeout;	// 234 = 0xea
...
- (id)socketPairMessage;	// IMP=0x0010000000215649
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x0010000000215631
- (void)kickProgressBlock;	// IMP=0x00100000002154de
- (id)init;	// IMP=0x001000000021538c
