...
+ (id)sharedInstance;	// IMP=0x0040000000376220
- (void).cxx_destruct;	// IMP=0x00200000003765d9
- (void)regenerateDeviceIdentifier;	// IMP=0x00100000003764b8
@property(readonly, retain, nonatomic) NSString *deviceIdentifier;
- (id)_deviceIdentifierKeychainID;	// IMP=0x00100000003762e9
...
- (id)init;	// IMP=0x0010000000376275
