...
- (void).cxx_destruct;	// IMP=0x00200000002690dd
...
- (void)didUpdatePairedDevice:(id)arg1;	// IMP=0x0010000000268e6e
- (void)_checkRegistrationStatus;	// IMP=0x00100000002686c8
- (void)_setupForCurrentSubscriptionState;	// IMP=0x0010000000268694
- (void)SIMInformationDidChange;	// IMP=0x00100000002685bf
- (void)userStore:(id)arg1 didUpdateUser:(id)arg2;	// IMP=0x00100000002685b9
- (void)userStore:(id)arg1 didRemoveAuthenticationCertificateForUser:(id)arg2;	// IMP=0x00100000002685b3
- (void)userStore:(id)arg1 didAddAuthenticationCertificate:(id)arg2 forUser:(id)arg3;	// IMP=0x00100000002685ad
- (void)userStore:(id)arg1 didAddUser:(id)arg2;	// IMP=0x00100000002685a7
- (void)userStore:(id)arg1 didRemoveUser:(id)arg2 withAuthenticationCertificate:(id)arg3;	// IMP=0x001000000026852d
- (void)selectedSubscriptionLabelDidChange:(id)arg1;	// IMP=0x0010000000268458
- (id)updatedUserSetForRealm:(long long)arg1 currentUsers:(id)arg2;	// IMP=0x0010000000266fb5
- (void)forceRemoveUser:(id)arg1 silently:(_Bool)arg2;	// IMP=0x0010000000266f44
- (_Bool)_isInDualPhoneIdentityModeForSims:(id)arg1;	// IMP=0x0010000000266c1a
- (void)verifyState;	// IMP=0x0010000000266b95
- (void)dealloc;	// IMP=0x0010000000266b50
- (id)initWithUserStore:(id)arg1 queue:(id)arg2 lockdownManager:(id)arg3 systemMonitor:(id)arg4 CTAdapter:(id)arg5 userConfiguration:(id)arg6 registrationController:(id)arg7 pairingManager:(id)arg8;	// IMP=0x0010000000266963
