...
- (void).cxx_destruct;	// IMP=0x0020000000474a07
...
- (id)debugDescription;	// IMP=0x00100000004723c7
- (id)description;	// IMP=0x0010000000472008
- (id)_userStore;	// IMP=0x0010000000471f87
- (id)_user;	// IMP=0x0010000000471f24
- (void)voidPassword;	// IMP=0x0010000000471cea
- (void)voidAuthenticationTokenAllowingGracePeriod;	// IMP=0x0010000000471b49
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000470a4b
...
- (id)_userID;	// IMP=0x001000000046f9d6
@property(readonly, nonatomic) NSArray *confirmedEmails;
- (void)removeCandidateEmail:(id)arg1;	// IMP=0x001000000046f8b8
- (void)addCandidateEmail:(id)arg1;	// IMP=0x001000000046f7da
// Error: Property attributes should begin with the type ('T') attribute, property name: candidateEmails
// Property attributes: (null)

- (_Bool)saveToKeychain;	// IMP=0x001000000046f771
- (_Bool)removeFromKeychain;	// IMP=0x001000000046f719
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000046d13e
- (id)init;	// IMP=0x001000000046d0e4
- (id)initWithPasswordManager:(id)arg1;	// IMP=0x001000000046d046
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000046d03b
- (id)_keychain_comparisonValue;	// IMP=0x0010000000277483
- (_Bool)_keychain_isEqual:(id)arg1;	// IMP=0x00100000002772dc
