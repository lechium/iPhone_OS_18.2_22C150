...
- (void).cxx_destruct;	// IMP=0x00200000003cef71
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x00100000003ce453
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x00100000003ce012
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x00100000003cde79
- (void)invalidate;	// IMP=0x00100000003cd83e
- (void)dealloc;	// IMP=0x00100000003cd7b5
- (void)_closeSockets;	// IMP=0x00100000003cd39e
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x00100000003cd0c9
- (id)flagsString;	// IMP=0x00100000003cd019
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x00100000003cd00c
- (id)description;	// IMP=0x00100000003ccbfc
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x00100000003cc8cf
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x00100000003cc5b1
