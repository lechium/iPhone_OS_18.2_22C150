...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000005ffd1
- (void).cxx_destruct;	// IMP=0x00200000000601ff
...
- (id)description;	// IMP=0x0010000000060160
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000060068
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000005ffd9
