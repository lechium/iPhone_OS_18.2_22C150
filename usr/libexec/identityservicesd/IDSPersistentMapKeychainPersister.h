...
- (void).cxx_destruct;	// IMP=0x00200000003bae69
...
- (void)purgeData;	// IMP=0x00100000003bad09
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000003baacb
- (id)data;	// IMP=0x00100000003ba8c2
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 keychainWrapper:(id)arg2 systemMonitor:(id)arg3;	// IMP=0x00100000003ba7c2
