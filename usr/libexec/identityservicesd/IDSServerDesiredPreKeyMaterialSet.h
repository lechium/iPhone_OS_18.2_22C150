...
- (void).cxx_destruct;	// IMP=0x002000000049fd98
...
- (id)materialDataByID;	// IMP=0x001000000049fb3a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000049fad6
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long forParticipantID;
- (id)initWithUUID:(id)arg1 publicPreKeyData:(id)arg2 wrapMode:(long long)arg3 creationDate:(id)arg4;	// IMP=0x001000000049f998
- (id)initWithPublicPreKeyData:(id)arg1 wrapMode:(long long)arg2 creationDate:(id)arg3;	// IMP=0x001000000049f8fd
