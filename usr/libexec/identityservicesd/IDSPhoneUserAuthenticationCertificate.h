...
- (void).cxx_destruct;	// IMP=0x002000000048e76d
...
- (id)description;	// IMP=0x001000000048e6a3
- (id)initWithPhoneUser:(id)arg1 authenticationCertificate:(id)arg2;	// IMP=0x001000000048e60a
