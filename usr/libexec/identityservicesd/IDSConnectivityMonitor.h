...
- (void).cxx_destruct;	// IMP=0x00200000001632fe
...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x00100000001631c3
- (void)sendMonitorMessage;	// IMP=0x0010000000162af3
- (void)checkConnectivityState:(id)arg1;	// IMP=0x0010000000162855
- (id)init;	// IMP=0x0010000000162826
