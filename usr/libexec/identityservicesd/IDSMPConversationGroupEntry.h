...
+ (id)entryFromPublicDataRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x0040000000135061
- (void).cxx_destruct;	// IMP=0x0020000000135680
...
- (id)description;	// IMP=0x001000000013547f
- (id)publicDataRepresentationWithError:(id *)arg1;	// IMP=0x0010000000135276
- (id)initWithStableGroupID:(id)arg1 groupServerEntry:(id)arg2;	// IMP=0x0010000000134ed1
