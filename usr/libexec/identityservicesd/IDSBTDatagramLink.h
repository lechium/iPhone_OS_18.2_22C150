...
- (void).cxx_destruct;	// IMP=0x002000000000a976
...
- (id)copyLinkStatsDict;	// IMP=0x001000000000a7bd
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x001000000000a546
- (void)_processIncomingPacket;	// IMP=0x001000000000a540
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x001000000000a535
- (unsigned long long)sendPacketBuffer:(CDStruct_90727270 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x001000000000a52d
- (void)start;	// IMP=0x001000000000a527
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)invalidate;	// IMP=0x001000000000a507
- (void)dealloc;	// IMP=0x001000000000a4c9
- (id)initWithPipe:(id)arg1 withDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x001000000000a4c0
