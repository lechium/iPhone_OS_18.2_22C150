...
- (void).cxx_destruct;	// IMP=0x002000000047ef76
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000047ed34
- (id)bagKey;	// IMP=0x001000000047ed27
- (id)requiredKeys;	// IMP=0x001000000047ed0e
- (id)messageBody;	// IMP=0x001000000047ea71
- (id)additionalMessageHeaders;	// IMP=0x001000000047e870
- (id);	// IMP=0x001000000047e67d
