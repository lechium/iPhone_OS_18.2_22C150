...
@class IDSMPFullDeviceIdentityContainer, IDSMPFullLegacyIdentity, IDSNGMKeyRollingTicket, MISSING_TYPE, NSString;
...
@interface IDSRegistrationKeyConfig : NSObject
{
    ...
    MISSING_TYPE *_isMigratedSignature;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x0020000000040ff3
...
- (void)dealloc;	// IMP=0x0010000000040d8f
