...
@class CBCharacteristic, CBDescriptor, CBL2CAPChannel, CBPeripheral, CBService, MISSING_TYPE, NSArray, NSError, NSNumber;
...
- (MISSING_TYPE *)peripheralDidUpdateRSSI:error: /* Error: Ran out of types for this method. */;
