...
- (void).cxx_destruct;	// IMP=0x00200000001e82f8
...
- (unsigned long long)count;	// IMP=0x00100000001e8263
- (_Bool)isEmpty;	// IMP=0x00100000001e821b
- (id)initWithTopic:(id)arg1 sendMode:(id)arg2;	// IMP=0x00100000001e8182
