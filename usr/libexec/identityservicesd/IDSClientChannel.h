...
- (void)osChannelInfoLog;	// IMP=0x00100000000513c9
- (void)invalidate;	// IMP=0x00100000000513c3
- (_Bool)writeBuffer:(char *)arg1 bufferSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4 moreComing:(_Bool)arg5;	// IMP=0x00100000000513bb
- (_Bool)writePacketBuffer:(CDStruct_90727270 *)arg1 metaData:(const void *)arg2 metadataSize:(unsigned int)arg3 moreComing:(_Bool)arg4;	// IMP=0x00100000000513b3
- (_Bool)writeDatagram:(const void *)arg1 datagramSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4;	// IMP=0x00100000000513ab
- (void)connectWithProtocoHandler;	// IMP=0x00100000000513a5
- (_Bool)connectWithTransportThread;	// IMP=0x001000000005139d
- (id)initWithDestination:(id)arg1;	// IMP=0x001000000005132a
