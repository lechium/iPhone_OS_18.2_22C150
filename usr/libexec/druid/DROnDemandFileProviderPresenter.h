...
+ (id)presenterPresentingURLWrapper:(id)arg1 type:(id)arg2 outURLWrapper:(id *)arg3;	// IMP=0x002000000000d009
+ (double)presenterValiditySeconds;	// IMP=0x001000000000c76b
+ (void)setPresenterValiditySeconds:(double)arg1;	// IMP=0x001000000000c75d
- (void).cxx_destruct;	// IMP=0x002000000000da6d
...
- (void)relinquishPresentedItemToReader:(CDUnknownBlockType)arg1;	// IMP=0x001000000000d114
@property(readonly, retain) NSOperationQueue *presentedItemOperationQueue;
@property(readonly, copy) NSURL *presentedItemURL;
- (void)_operationQueue_invalidate;	// IMP=0x001000000000ce92
- (void)beginPresenting;	// IMP=0x001000000000cb2a
- (id)initWithURLWrapper:(id)arg1 type:(id)arg2;	// IMP=0x001000000000c779
