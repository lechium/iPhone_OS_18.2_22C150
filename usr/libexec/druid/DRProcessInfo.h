...
- (void).cxx_destruct;	// IMP=0x0020000000004bd2
...
- (_Bool)isSameProcessAsSource:(id)arg1;	// IMP=0x0010000000004a7d
- (_Bool)isSameTeamAsSource:(id)arg1;	// IMP=0x001000000000498a
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0010000000004868
