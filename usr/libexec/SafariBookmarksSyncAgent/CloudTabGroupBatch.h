...
- (void).cxx_destruct;	// IMP=0x00200000000be66b
- (void)_filterUpdatedRecordsIfNeeded;	// IMP=0x00100000000be1d8
- (void)addItem:(id)arg1;	// IMP=0x00100000000bddb0
...
- (unsigned long long)_sizeOfRecordUpdateBatch:(id)arg1;	// IMP=0x00100000000bd7ae
@property(readonly, nonatomic) _Bool isFull;
@property(readonly, nonatomic) _Bool isEmpty;
- (id)init;	// IMP=0x00100000000bd3ee
