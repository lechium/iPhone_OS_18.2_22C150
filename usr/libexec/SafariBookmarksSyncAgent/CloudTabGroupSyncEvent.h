...
- (void).cxx_destruct;	// IMP=0x002000000008242e
...
- (id)extraAttributes;	// IMP=0x001000000008218a
- (id)_defaultSubtitle;	// IMP=0x0010000000082059
- (void)addChildEvent:(id)arg1;	// IMP=0x0010000000082043
@property(readonly, copy, nonatomic) NSArray *childEvents;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000081dad
- (id)init;	// IMP=0x0010000000081d94
