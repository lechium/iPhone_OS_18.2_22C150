...
@class CKOperationGroup, CKRecord, CKRecordID, CloudSettingSyncCoordinator, NSData, NSString;

@protocol CloudSettingSyncCoordinatorDelegate <NSObject>
- (void)cloudSettingSyncCoordinator:(CloudSettingSyncCoordinator *)arg1 performInitialSyncDownInOperationGroup:(CKOperationGroup *)arg2;
