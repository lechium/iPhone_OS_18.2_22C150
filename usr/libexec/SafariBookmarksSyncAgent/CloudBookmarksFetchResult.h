...
- (void).cxx_destruct;	// IMP=0x00200000000519a6
...
- (void)addDeletedRecordID:(id)arg1;	// IMP=0x0010000000051925
- (void)addRecord:(id)arg1;	// IMP=0x0010000000051790
...
- (id)init;	// IMP=0x0010000000051391
