...
+ (id)sharedManager;	// IMP=0x0020000000009824
- (void).cxx_destruct;	// IMP=0x002000000000a4f4
...
- (void)setCursorFrameForElement:(id)arg1;	// IMP=0x001000000000a01a
- (void)hideVisualsSynchronously;	// IMP=0x0010000000009e99
- (void)setCursorFrame:(struct CGRect)arg1 withPath:(struct CGPath *)arg2 withContextId:(unsigned int)arg3 element:(id)arg4 forceRefresh:(_Bool)arg5;	// IMP=0x0010000000009a9d
- (void)setCursorStyle:(unsigned long long)arg1;	// IMP=0x001000000000999c
- (struct CGRect)_adjustFrameToFitScreen:(struct CGRect)arg1;	// IMP=0x0010000000009984
- (void)dealloc;	// IMP=0x0010000000009955
- (id)init;	// IMP=0x00100000000098a9
