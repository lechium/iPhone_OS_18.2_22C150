...
+ (id)idsDestinationIDForNRDevice:(id)arg1 withIdsService:(id)arg2;	// IMP=0x0040000000029ead
+ (id)createDirectoryIfNeeded:(id)arg1;	// IMP=0x0010000000029d30
+ (id)nrDeviceForIDSDevice:(id)arg1;	// IMP=0x0010000000029cb2
- (void).cxx_destruct;	// IMP=0x002000000002a05e
...
- (void)checkForActiveDeviceChange;	// IMP=0x00100000000299bc
- (void)_registryChanged:(id)arg1;	// IMP=0x00100000000298a5
- (id)pairingDevice;	// IMP=0x001000000002926b
- (id)pairingID;	// IMP=0x000000000002924f
...
- (void)startMonitoringPairingEventsWithQueue:(id)arg1;	// IMP=0x0010000000028f97
