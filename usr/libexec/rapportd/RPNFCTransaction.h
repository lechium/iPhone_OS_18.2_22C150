...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000022d6
- (void)setState:(long long)arg1;	// IMP=0x00100000000020ce
- (void)setError:(id)arg1;	// IMP=0x0010000000001ab5
- (id)initWithRole:(long long)arg1;	// IMP=0x0010000000001a08
