...
- (void).cxx_destruct;	// IMP=0x00200000000946d8
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000094552
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000094442
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000094345
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000094235
- (void)xpcConnectionInvalidated;	// IMP=0x00100000000940b2
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x0010000000093f8c
