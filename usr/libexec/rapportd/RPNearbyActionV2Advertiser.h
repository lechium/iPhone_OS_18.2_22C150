...
- (void).cxx_destruct;	// IMP=0x002000000008028d
...
- (id)description;	// IMP=0x0010000000080166
- (void)invalidate;	// IMP=0x001000000007fece
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000007fccd
