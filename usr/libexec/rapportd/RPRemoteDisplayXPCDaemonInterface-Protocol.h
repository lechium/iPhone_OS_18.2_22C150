...
@class NSDictionary, NSNumber, NSString, RPRemoteDisplayDevice, RPRemoteDisplayDiscovery, RPRemoteDisplayPerson, RPRemoteDisplayServer, RPRemoteDisplaySession;

@protocol RPRemoteDisplayXPCDaemonInterface
- (void)remoteDisplayChangeDedicatedDevice:(RPRemoteDisplayDevice *)arg1;
- (void)remoteDisplayChangeDiscoverySessionStateForDevice:(NSString *)arg1 reason:(NSString *)arg2;
- (void)remoteDisplayDedicatedDeviceConfirmationWithCompletion:(void (^)(NSError *))arg1;
- (void)remoteDisplayPersonSelected:(RPRemoteDisplayPerson *)arg1 forDedicatedPairing:(_Bool)arg2;
