...
- (void).cxx_destruct;	// IMP=0x0020000000017a35
...
- (void)updateCurrentProgress:(double)arg1;	// IMP=0x001000000001792e
- (id)initWithThresholdTimeInterval:(double)arg1;	// IMP=0x0010000000017867
