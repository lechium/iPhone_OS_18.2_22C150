...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x0020000000018a31
+ (_Bool)supportsDeduplication;	// IMP=0x0010000000018a29
- (void).cxx_destruct;	// IMP=0x0020000000018979
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x00100000000186d4
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x001000000001865f
- (_Bool)isPassthroughConversion;	// IMP=0x00100000000185ea
- (void)startProgressUpdateTimerAndMarkStartTime;	// IMP=0x00100000000185e4
- (void)cancel;	// IMP=0x00100000000185de
- (void)performConversion;	// IMP=0x0010000000018560
- (void)didEnqueue;	// IMP=0x00100000000184fe
- (_Bool)wantsResultAsData;	// IMP=0x0010000000018489
- (void)updateResultTracker;	// IMP=0x0010000000018335
- (void)callCompletionHandler;	// IMP=0x001000000001801b
- (void)loadAsset;	// IMP=0x0010000000017e8e
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x0010000000017b95
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x0010000000017a45
