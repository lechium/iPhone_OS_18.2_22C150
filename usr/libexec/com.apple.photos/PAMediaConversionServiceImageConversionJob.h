...
- (void).cxx_destruct;	// IMP=0x002000000001002b
...
- (void)dealloc;	// IMP=0x001000000000fcb9
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x001000000000f0a1
- (_Bool)_validateOutputSize;	// IMP=0x001000000000ef3a
- (_Bool)_validateOrientation;	// IMP=0x001000000000ee11
- (_Bool)_validateMetadata;	// IMP=0x001000000000ec8d
- (_Bool)_validateSource;	// IMP=0x001000000000ea5e
- (void)_validate;	// IMP=0x001000000000e8f6
- (_Bool)validateSourceAndOptions;	// IMP=0x001000000000e8bd
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x001000000000e766
