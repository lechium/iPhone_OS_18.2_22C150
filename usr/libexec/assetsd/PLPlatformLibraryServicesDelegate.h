...
+ (Class)platformLibraryServicesDelegateClass;	// IMP=0x00200000000163f6
- (void).cxx_destruct;	// IMP=0x00200000000177c0
...
- (id)logPrefix;	// IMP=0x0010000000017734
- (void)handleCompletedAllOperationsForLibraryState:(long long)arg1;	// IMP=0x001000000001754d
- (void)operationCompletionActivities;	// IMP=0x0010000000017312
- (id)commonBuiltInOperations;	// IMP=0x0010000000016957
- (id)operationForGreenTeaContactsAuthorizationCheck;	// IMP=0x00100000000168e0
- (id)operationForLocaleChangeCheck;	// IMP=0x0010000000016869
- (id)systemLibraryBuiltInOperations;	// IMP=0x0010000000016613
- (id)operationsForLibraryStateTransition:(long long)arg1;	// IMP=0x0010000000016460
@property(readonly, nonatomic) long long requiredStateForFileSystemImportOperation;
- (id)initWithLibraryServicesManager:(id)arg1;	// IMP=0x0010000000016407
