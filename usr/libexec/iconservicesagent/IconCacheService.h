...
- (void).cxx_destruct;	// IMP=0x00100000000036a3
...
- (void)clearCache;	// IMP=0x0010000000003582
- (void)scheduleCacheOperation:(unsigned long long)arg1;	// IMP=0x0010000000003462
- (void)start;	// IMP=0x001000000000334e
- (id)initWithServiceName:(id)arg1;	// IMP=0x0010000000003044
- (id)generateStoreUnitWithRequest:(id)arg1 validationToken:(id *)arg2;	// IMP=0x00100000000042d3
- (void)clearCachedItemsForBundeID:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000004279
- (void)generateImageWithRequest:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003af6
- (void)fetchCacheConfigurationWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00100000000038d7
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003718
