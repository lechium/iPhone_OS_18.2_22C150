...
- (void).cxx_destruct;	// IMP=0x002000000000faee
...
- (id)description;	// IMP=0x001000000000f9d9
- (id)dictionaryValue;	// IMP=0x001000000000f839
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000f6b4
