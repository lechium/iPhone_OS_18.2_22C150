...
- (void).cxx_destruct;	// IMP=0x00200000000039bb
...
- (void)_setupResultWithRAPInfos:(id)arg1;	// IMP=0x0010000000003720
- (id)initWithRAPInfos:(id)arg1;	// IMP=0x00100000000036a2
