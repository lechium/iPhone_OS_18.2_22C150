...
- (void).cxx_destruct;	// IMP=0x002000000002694b
...
- (id)description;	// IMP=0x00100000000267d5
- (id)dictionaryValue;	// IMP=0x0010000000026656
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000026533
