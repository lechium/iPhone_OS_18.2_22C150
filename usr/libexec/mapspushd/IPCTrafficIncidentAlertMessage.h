...
- (void).cxx_destruct;	// IMP=0x002000000001da4f
...
- (id)description;	// IMP=0x001000000001d83c
- (id)dictionaryValue;	// IMP=0x001000000001d60c
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001d47d
