...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x004000000001f0b6
- (void).cxx_destruct;	// IMP=0x002000000001f6f2
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x001000000001f56a
- (id)description;	// IMP=0x001000000001f4bb
- (id)dictionaryValue;	// IMP=0x001000000001f2eb
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001f108
