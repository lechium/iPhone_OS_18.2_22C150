...
+ (Class)placesType;	// IMP=0x00200000000161f6
- (void).cxx_destruct;	// IMP=0x00200000000186f6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000182cd
- (unsigned long long)hash;	// IMP=0x0010000000017bd9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000178ea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000017547
- (void)copyTo:(id)arg1;	// IMP=0x00100000000172f1
- (void)writeTo:(id)arg1;	// IMP=0x0010000000017011
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000017004
- (id)dictionaryRepresentation;	// IMP=0x00100000000162b6
- (id)description;	// IMP=0x0010000000016207
- (id)placesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000161d9
- (unsigned long long)placesCount;	// IMP=0x00100000000161bc
- (void)addPlaces:(id)arg1;	// IMP=0x0010000000016152
- (void)clearPlaces;	// IMP=0x0010000000016135
- (int)StringAsDirectionsMode:(id)arg1;	// IMP=0x0010000000016063
- (id)directionsModeAsString:(int)arg1;	// IMP=0x001000000001601a
...
- (int)StringAsType:(id)arg1;	// IMP=0x0010000000015c1d
- (id)typeAsString:(int)arg1;	// IMP=0x0010000000015bd4
