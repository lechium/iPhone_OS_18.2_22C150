...
+ (id)sharedManager;	// IMP=0x004000000012920c
- (void).cxx_destruct;	// IMP=0x002000000012978f
...
- (CDUnknownBlockType)getJobScheduler;	// IMP=0x0010000000129693
- (void)registerQueueGroupWithName:(id)arg1 andNumberOfQueues:(unsigned long long)arg2;	// IMP=0x0010000000129261
- (id)init;	// IMP=0x0010000000129189
