...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x00400000000c24d3
- (void);	// IMP=0x00200000000c3c4f
- (int)persist;	// IMP=0x00100000000c344c
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x00100000000c30b0
- (int)loadMetrics;	// IMP=0x00100000000c26ce
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000c2451
