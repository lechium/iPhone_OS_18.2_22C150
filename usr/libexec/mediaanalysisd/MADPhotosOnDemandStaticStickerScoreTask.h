...
+ (id)taskWithPhotoLibrary:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00400000001540ed
- (void).cxx_destruct;	// IMP=0x0020000000155e72
- (_Bool)run:(id *)arg1;	// IMP=0x0010000000154863
- (void)publishResults:(id)arg1;	// IMP=0x00100000001541a5
- (id)initWithPhotoLibrary:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000153dde
