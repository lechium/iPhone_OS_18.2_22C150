...
+ (id)entryWithTaskID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 task:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x004000000001900b
- (void).cxx_destruct;	// IMP=0x00200000000190fc
...
- (id)initWithTaskID:(unsigned long long)arg1 qos:(unsigned int)arg2 background:(_Bool)arg3 task:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000018f1c
