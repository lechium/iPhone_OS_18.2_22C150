...
- (unsigned long long)analyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005d4de
- (void)addAnalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005d4d0
- (unsigned long long)analyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005d4c2
- (void)addAnalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005d4b4
- (unsigned long long)unanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005d4a9
- (void)addUnanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005d49e
- (unsigned long long)unanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005d493
- (void)addUnanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005d488
- (id)init;	// IMP=0x001000000005d427
