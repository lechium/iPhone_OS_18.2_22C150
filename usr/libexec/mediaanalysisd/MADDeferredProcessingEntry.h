...
+ (id)entryWithLocalIdentifier:(id)arg1 requestDate:(id)arg2;	// IMP=0x004000000005f194
- (void).cxx_destruct;	// IMP=0x002000000005f240
...
- (id)initWithLocalIdentifier:(id)arg1 requestDate:(id)arg2;	// IMP=0x001000000005f0fb
