...
- (void).cxx_destruct;	// IMP=0x0020000000193037
...
- (void)main;	// IMP=0x0010000000192f9a
- (int)mainInternal;	// IMP=0x0010000000192f8f
- (_Bool)isCancelled;	// IMP=0x0010000000192f3f
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000192e8a
- (id)init;	// IMP=0x0010000000192e7c
