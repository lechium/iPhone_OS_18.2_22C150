...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000002b183
- (unsigned long long)hash;	// IMP=0x001000000002af33
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002adfa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002ad24
- (void)copyTo:(id)arg1;	// IMP=0x001000000002ac71
- (void)writeTo:(id)arg1;	// IMP=0x001000000002ab99
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000002ab8c
- (id)dictionaryRepresentation;	// IMP=0x001000000002a5e4
- (id)description;	// IMP=0x001000000002a535
