...
+ (_Bool)validationEnabled;	// IMP=0x0020000000015350
+ (id)validationWrapperForPb:(id)arg1;	// IMP=0x0010000000015218
+ (id)validationWrapperForSameSpan:(id)arg1;	// IMP=0x0010000000015159
+ (id)validationWrapperForRightNow;	// IMP=0x0010000000015085
- (void).cxx_destruct;	// IMP=0x0020000000015ef3
...
- (void)validate;	// IMP=0x0010000000015cb7
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000015931
@property(readonly, nonatomic) NSString *sequencer;
@property(readonly, nonatomic) NSString *objectIdentifier;
@property(readonly, nonatomic) long long changeType;
- (void)_countEvents;	// IMP=0x0010000000015358
