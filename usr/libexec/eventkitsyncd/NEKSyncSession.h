...
@class MISSING_TYPE, NDTPerf, NEKEnvironment, NEKProgressLiar, NEKResultsFetcher, NEKResultsPipe, NEKStatTracker, NEKValidationWrapper, NSMutableArray, NSString;
...
- (void)syncSession:(id)arg1 didEndWithError:(id)arg2;	// IMP=0x001000000005b563
- (_Bool)syncSession:(id)arg1 resetDataStoreWithError:(id *)arg2;	// IMP=0x001000000005b476
- (void)syncSession:(id)arg1 applyChanges:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000005a7ce
- (unsigned int)syncSession:(id)arg1 enqueueChanges:(CDUnknownBlockType)arg2 error:(id *)arg3;	// IMP=0x001000000005a193
- (MISSING_TYPE *)dealloc;	// IMP=0x001000000005a159
- (id)init;	// IMP=0x001000000005a067
