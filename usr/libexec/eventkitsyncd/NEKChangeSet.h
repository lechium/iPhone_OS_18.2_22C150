...
@interface NEKChangeSet : NSObject
{
    ...
    _Bool _hasChangesInNext24hrs;	// 9 = 0x9
...
+ (id)changeSetForReminder;	// IMP=0x0040000000050852
+ (id)changeSetForEvent;	// IMP=0x0010000000050839
- (void).cxx_destruct;	// IMP=0x0020000000050b00
@property(nonatomic) _Bool hasChangesInNext24hrs; // @synthesize hasChangesInNext24hrs=_hasChangesInNext24hrs;
...
- (void)enumerateForChangeType:(int)arg1 forEntitiesOfClass:(Class)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000050a28
- (id)description;	// IMP=0x001000000005092a
