...
@interface NEKPBCalendarAttributes : PBCodable
{
    ...
    MISSING_TYPE *_supportedEntityTypes;	// 32 = 0x20
...
- (void).cxx_destruct;	// IMP=0x00200000000117c8
...
- (unsigned long long)hash;	// IMP=0x00100000000105d3
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000fbd1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000f477
- (void)copyTo:(id)arg1;	// IMP=0x001000000000ee66
- (void)writeTo:(id)arg1;	// IMP=0x001000000000e839
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000e82c
