...
- (void).cxx_destruct;	// IMP=0x0020000000003034
...
- (void)run;	// IMP=0x00100000000028ee
- (void)ensureSlotWatcherIsRunning;	// IMP=0x0010000000002868
- (id)initWithArgc:(int)arg1 argv:(const char **)arg2;	// IMP=0x0010000000002654
...
- (void)initializeSandBox;	// IMP=0x001000000000253a
