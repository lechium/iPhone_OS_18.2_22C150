...
+ (id)allowedBundlesFromEntitlements:(id)arg1;	// IMP=0x0020000000003ab3
+ (id)bundleIdentifierFromAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x001000000000370c
- (void).cxx_destruct;	// IMP=0x0020000000007275
...
- (void)registerClassIDs:(id)arg1;	// IMP=0x0010000000006c64
- (id)reloadTokenClassesFromStore;	// IMP=0x0010000000005fb8
- (void)loadTokensFromStore:(id)arg1;	// IMP=0x00100000000050e2
- (id)createTokenWithTokenID:(id)arg1 persistent:(_Bool)arg2;	// IMP=0x0010000000004d50
- (void)notifyTokenReinsertion:(id)arg1;	// IMP=0x0010000000004c49
- (void)removeTokenWithTokenID:(id)arg1;	// IMP=0x001000000000495c
- (id)tokenWithTokenID:(id)arg1;	// IMP=0x0010000000004893
- (void)commitTransaction;	// IMP=0x0010000000004205
- (void)keychainItemsModified:(id)arg1;	// IMP=0x0010000000004171
- (void)markModified;	// IMP=0x001000000000413f
@property(readonly, nonatomic) NSDictionary *tokenExtensions;
- (id)beginTransaction:(id)arg1;	// IMP=0x0010000000003ff0
@property(readonly, nonatomic) NSArray *tokens;
- (void)dealloc;	// IMP=0x0010000000003f4a
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003ccd
- (id)initWithDriverCache:(id)arg1 listener:(id)arg2 keychain:(id)arg3;	// IMP=0x0010000000003547
