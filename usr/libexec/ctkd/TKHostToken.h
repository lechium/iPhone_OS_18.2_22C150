...
+ (id)keychainItemClasses;	// IMP=0x0020000000002074
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000017f2
- (void).cxx_destruct;	// IMP=0x00200000000024d2
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000022ed
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000021a8
- (id)connectionWithError:(id *)arg1;	// IMP=0x00100000000019eb
- (id)description;	// IMP=0x0010000000001914
- (id)initWithTokenID:(id)arg1 persistent:(_Bool)arg2;	// IMP=0x00100000000017fa
