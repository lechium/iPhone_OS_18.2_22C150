...
+ (id)dispatchScheduler:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x004000000002c787
- (void).cxx_destruct;	// IMP=0x002000000002d783
...
- (id)nextRunTimeString;	// IMP=0x001000000002d6cc
- (void)waitUntilComplete;	// IMP=0x001000000002d648
- (void)suspend;	// IMP=0x001000000002d5d2
- (void)resume;	// IMP=0x001000000002d59d
- (void)reset;	// IMP=0x001000000002d3d6
- (void)updateFrequency:(double)arg1;	// IMP=0x001000000002d1eb
- (void)_doIt;	// IMP=0x001000000002cf03
- (void)doIt;	// IMP=0x001000000002ce7c
- (_Bool)scheduleAt:(id)arg1;	// IMP=0x001000000002ce14
- (_Bool)scheduleNext:(double)arg1;	// IMP=0x001000000002c842
- (id)init:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x001000000002c46a
