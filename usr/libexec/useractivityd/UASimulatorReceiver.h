...
- (id)statusString;	// IMP=0x00100000000067d3
- (_Bool)active;	// IMP=0x001000000000677b
- (_Bool)fetchAdvertisedItems:(_Bool)arg1;	// IMP=0x0010000000005559
- (_Bool)doSetReceivedItems:(id)arg1;	// IMP=0x0010000000004fa3
- (_Bool)receiving;	// IMP=0x0010000000004f1c
- (id)initWithSimulator:(id)arg1;	// IMP=0x0010000000004e14
