...
- (void).cxx_destruct;	// IMP=0x002000000003ff55
...
- (void)extractArchiveWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000003fee1
- (id)initWithDestinationURL:(id)arg1 forArchiveUUID:(id)arg2;	// IMP=0x001000000003fdb0
