...
@class BKSApplicationStateMonitor, FBSDisplayLayoutMonitor, MISSING_TYPE, NSArray, NSDate, NSMutableDictionary, NSMutableSet, NSSet, NSString, NSXPCListener, UADispatchScheduler, UALocalItemReceiver;
...
@interface UAUserActivityClientProcessesController
{
    ...
    MISSING_TYPE *_mainScreenBundleIdentifiersInOrder;	// 112 = 0x70
...
- (void).cxx_destruct;	// IMP=0x0020000000055a28
...
- (id)statusString;	// IMP=0x0010000000054d08
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000054b99
- (id)recentEligibleItemsInOrder:(double)arg1;	// IMP=0x00100000000547b1
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x00100000000534ba
- (id)items;	// IMP=0x0010000000053206
- (_Bool)registerAsProxyApplication:(id)arg1 forPid:(int)arg2;	// IMP=0x0010000000052efc
- (id)advertiseableItemForBundleIdentifier:(id)arg1;	// IMP=0x0010000000052e99
- (void)handleAppStateMonitorUpdate:(id)arg1;	// IMP=0x0010000000052420
- (void)removeClientActivityClient:(id)arg1;	// IMP=0x0010000000051c8d
- (id)userActivityClientForBundleIdentifier:(id)arg1;	// IMP=0x0010000000051bf1
- (_Bool)removeAdditionalUserActivityAdvertisableItems:(id)arg1;	// IMP=0x0010000000051b44
- (_Bool)addAdditionalUserActivityAdvertisableItems:(id)arg1;	// IMP=0x0010000000051a93
@property(readonly, copy) NSSet *additionalUserActivityAdvertisableItems;
- (id)userActivityClientForPID:(int)arg1;	// IMP=0x001000000005196e
- (id)userActivityClientForUUID:(id)arg1;	// IMP=0x001000000005170f
...
- (id)userActivityInfoForUUID:(id)arg1;	// IMP=0x001000000005103b
- (_Bool)clientIsActive:(id)arg1;	// IMP=0x0010000000050de7
- (void)addUserActivityClient:(id)arg1;	// IMP=0x0010000000050a84
- (_Bool)ifLockScreenIsActive:(id)arg1 visibleBundleIdentifiers:(id)arg2;	// IMP=0x0010000000050321
- (id)determineVisibleOrderingForProcessesWithUserActivities:(id)arg1 previousBundleIDOrdering:(id)arg2;	// IMP=0x001000000004f907
- (double)intervalToDelaySuspensionOfAdvertisingForItem:(id)arg1;	// IMP=0x001000000004f7e0
- (_Bool)updateCarPlayScreenLayout:(id)arg1;	// IMP=0x001000000004f601
- (_Bool)updateMainScreenLayout:(id)arg1;	// IMP=0x001000000004f2e5
- (_Bool)resume;	// IMP=0x001000000004ef8f
- (_Bool)suspend;	// IMP=0x001000000004ef05
- (void)dealloc;	// IMP=0x001000000004eda1
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000004e758
