...
- (void).cxx_destruct;	// IMP=0x0020000000004e01
@property(copy) CDUnknownBlockType wasContinuedBlock; // @synthesize wasContinuedBlock=_wasContinuedBlock;
- (id)statusString;	// IMP=0x0010000000004d09
- (id)initFromPing:(id)arg1;	// IMP=0x0010000000004c76
- (id)initWithPayloadSize:(unsigned long long)arg1;	// IMP=0x0010000000004b65
