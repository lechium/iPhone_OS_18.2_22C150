...
- (void).cxx_destruct;	// IMP=0x00200000000461bd
...
- (_Bool)terminate;	// IMP=0x0010000000045b03
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000045997
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000045991
- (_Bool)processCommands:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000456bd
- (_Bool)sendResponse:(id)arg1;	// IMP=0x00100000000456b5
- (_Bool)processCommand:(id)arg1;	// IMP=0x0010000000043085
- (id)scanMockAdvertisement:(id)arg1;	// IMP=0x0010000000042748
- (void)doAdvertiseAdvertisementPayload:(id)arg1 options:(id)arg2;	// IMP=0x00100000000424bd
- (id)sharingAdvertiser;	// IMP=0x00100000000422c1
- (id)sharingReceiver;	// IMP=0x00100000000420c5
- (void)dealloc;	// IMP=0x0010000000041e5a
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x00100000000418b8
