...
- (void).cxx_destruct;	// IMP=0x002000000003db5a
...
- (id)trimFirstBytes:(unsigned long long)arg1 ofData:(id)arg2;	// IMP=0x001000000003d84c
- (long long)tryWriteMessage;	// IMP=0x001000000003d1a6
- (long long)tryWriteRawData;	// IMP=0x001000000003ce97
- (long long)handleSpaceAvailable;	// IMP=0x001000000003ce3e
- (void)handleMessageRead;	// IMP=0x001000000003cd03
- (_Bool)dataHasMessage:(id)arg1;	// IMP=0x001000000003cc90
- (void)processHeader;	// IMP=0x001000000003cb80
- (void)handleBytesAvailable;	// IMP=0x001000000003c78d
- (void)handleOpenCompleted;	// IMP=0x001000000003c690
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000003c444
- (_Bool)writeMessage:(id)arg1 tag:(long long)arg2;	// IMP=0x001000000003c120
- (_Bool)writeRawData:(id)arg1;	// IMP=0x001000000003bf1e
- (void)_stop;	// IMP=0x001000000003bcee
- (void)tryStop;	// IMP=0x001000000003bb9b
- (void)stop;	// IMP=0x001000000003ba83
- (void)start;	// IMP=0x001000000003b65f
- (long long)queueCount;	// IMP=0x001000000003b5dd
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 delegate:(id)arg3;	// IMP=0x001000000003b3f8
