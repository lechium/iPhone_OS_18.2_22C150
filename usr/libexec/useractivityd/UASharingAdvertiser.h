...
- (void).cxx_destruct;	// IMP=0x0020000000094700
...
- (id)statusString;	// IMP=0x00100000000931aa
- (_Bool)pasteboardBitValue;	// IMP=0x0010000000092fc9
- (_Bool)pasteboardAvailible;	// IMP=0x0010000000092dca
- (void)removeIOPowerManagerUserIdleNotifications;	// IMP=0x0010000000092d77
- (void)scheduleIOPowerManagerUserIdleNotifications;	// IMP=0x0010000000092d21
@property _Bool userIsCurrent; // @synthesize userIsCurrent=_userIsCurrent;
- (_Bool)resume;	// IMP=0x0010000000092abf
- (_Bool)suspend;	// IMP=0x00100000000929e6
- (_Bool)active;	// IMP=0x0010000000092955
- (_Bool)okToSuspendAdvertising;	// IMP=0x0010000000092881
- (_Bool)scheduleAdvertisementUpdate;	// IMP=0x001000000009286c
- (_Bool)scheduleAdvertisementUpdate:(double)arg1;	// IMP=0x0010000000092802
- (void)activityAdvertiser:(id)arg1 pairedDevicesChangedNotification:(id)arg2;	// IMP=0x0010000000092432
- (void)activityAdvertiser:(id)arg1 didSendPayloadForActivityIdentifier:(id)arg2 toDevice:(id)arg3 error:(id)arg4;	// IMP=0x00100000000920c1
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 handoffCommand:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000008ecde
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000008dbff
- (id)dataForMoreAppSuggestions;	// IMP=0x001000000008d115
- (void)setShouldAdvertiseAutoPullActivityList:(_Bool)arg1;	// IMP=0x001000000008d042
@property(copy) NSSet *pairedDevices; // @synthesize pairedDevices=_pairedDevices;
- (void)_updatePairedDeviceCapabilities;	// IMP=0x001000000008c371
- (void)_refreshPairedSFPeerDevices;	// IMP=0x001000000008bf8c
...
- (id)sfActivityAdvertiser;	// IMP=0x001000000008bc42
- (_Bool)removeSFActivityAdvertiser:(id)arg1;	// IMP=0x001000000008bb7e
- (_Bool)addSFActivityAdvertiser:(id)arg1;	// IMP=0x001000000008baad
@property(readonly, copy) NSSet *sfActivityAdvertisers;
- (_Bool)peerDeviceCanAcceptNewerPayload:(id)arg1;	// IMP=0x001000000008b586
- (void)_periodicIdleUpdate;	// IMP=0x001000000008b07a
- (void)removeAdvertisement;	// IMP=0x001000000008ab1a
- (void)moveAdvertisementToNonActive;	// IMP=0x001000000008aa5b
- (_Bool)_updateAdvertisement;	// IMP=0x00100000000896ca
- (_Bool)advertiseItem:(id)arg1 force:(_Bool)arg2;	// IMP=0x0010000000086e50
- (_Bool)_advertisePayload:(id)arg1 force:(_Bool)arg2 name:(id)arg3;	// IMP=0x0010000000086377
- (_Bool)_advertisePayload:(id)arg1 force:(_Bool)arg2 name:(id)arg3 sfAdvertiser:(id)arg4;	// IMP=0x0010000000086083
- (_Bool)_advertisePayload:(id)arg1;	// IMP=0x001000000008606c
- (void)advertisePayload:(id)arg1 force:(_Bool)arg2;	// IMP=0x0010000000085f7d
- (void)updateAdvertisingPowerAssertion:(double)arg1;	// IMP=0x0010000000085cf0
- (id)mostRecentAdvertisedBytesTime;	// IMP=0x0010000000085cde
- (id)currentAdvertisedBytes;	// IMP=0x0010000000085bd7
- (void)setAdvertisableItems:(id)arg1;	// IMP=0x0010000000085544
- (id)advertisingItems;	// IMP=0x0010000000085491
- (_Bool)advertising;	// IMP=0x001000000008545e
- (id)advertisableItems;	// IMP=0x00100000000853f2
- (id)initWithManager:(id)arg1 advertiser:(id)arg2;	// IMP=0x0010000000084e5d
