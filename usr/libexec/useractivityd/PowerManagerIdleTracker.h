...
+ (unsigned long long)setup:(id)arg1 interval:(double)arg2;	// IMP=0x00400000000041f1
+ (id)idleTracker:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000003e16
- (void).cxx_destruct;	// IMP=0x0020000000004b27
...
- (void)invalidate;	// IMP=0x0010000000004747
- (void)dealloc;	// IMP=0x0010000000004105
- (id)init:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000003eb0
