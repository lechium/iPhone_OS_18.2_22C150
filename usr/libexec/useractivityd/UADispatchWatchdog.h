...
- (void)_triggerWatchdog;	// IMP=0x001000000001bd18
- (void)cancel;	// IMP=0x001000000001bc24
- (void)poke;	// IMP=0x001000000001bb97
- (void)start;	// IMP=0x001000000001b981
- (void)dealloc;	// IMP=0x001000000001b91e
- (id)initWithName:(id)arg1 timeout:(double)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000001b85a
