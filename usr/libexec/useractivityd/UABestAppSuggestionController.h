...
- (void).cxx_destruct;	// IMP=0x0020000000003799
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000003314
- (_Bool)terminate;	// IMP=0x0010000000003229
- (_Bool)resume;	// IMP=0x0010000000003150
- (_Bool)suspend;	// IMP=0x0010000000003077
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000002f68
