...
- (void).cxx_destruct;	// IMP=0x002000000001447b
...
- (id)statusString;	// IMP=0x0010000000014323
- (_Bool)terminate;	// IMP=0x00100000000141b9
- (_Bool)resume;	// IMP=0x001000000001408e
- (_Bool)suspend;	// IMP=0x0010000000013f63
@property _Bool suspended;
@property(readonly) _Bool active;
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000013cd4
