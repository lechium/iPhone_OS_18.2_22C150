...
- (void).cxx_destruct;	// IMP=0x002000000002f097
...
- (void)requestRemotePasteboardData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002eb7a
- (void)requestRemoteTypeInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000002dcb5
- (void)dealloc;	// IMP=0x001000000002db70
- (void)updateState:(unsigned long long)arg1;	// IMP=0x001000000002d9ff
- (id)stateAsString;	// IMP=0x001000000002d9cd
- (id)initWithRequester:(id)arg1;	// IMP=0x001000000002d813
