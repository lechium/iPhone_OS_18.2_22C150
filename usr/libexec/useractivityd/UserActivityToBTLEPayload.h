...
- (void).cxx_destruct;	// IMP=0x0020000000059ac8
...
- (id)description;	// IMP=0x001000000005961e
- (id)encodeAsData;	// IMP=0x0010000000058d86
- (id)initWithData:(id)arg1;	// IMP=0x0010000000058390
- (void)addAdditionalItem:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000058285
@property(readonly, copy) NSDictionary *additionalItems;
- (id)initWithNSError:(id)arg1;	// IMP=0x00100000000581ff
- (id)init:(id)arg1 title:(id)arg2 date:(id)arg3 userInfoPayload:(id)arg4 teamID:(id)arg5 activityType:(id)arg6;	// IMP=0x0010000000058028
