...
- (void).cxx_destruct;	// IMP=0x002000000003b23e
...
- (id)localPBStatus;	// IMP=0x001000000003a7dd
- (id)statusString;	// IMP=0x001000000003a7d0
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x001000000003a33c
- (void)showProgressUI:(id)arg1;	// IMP=0x001000000003977b
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000038abc
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x0010000000037f82
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000361b1
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x001000000003605a
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x0010000000036048
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000033627
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000003146f
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000003116d
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x0010000000031079
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x0010000000030e07
- (void)clearLocalPasteboardInformation;	// IMP=0x0010000000030d41
- (void);	// IMP=0x0010000000030692
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x00100000000305c0
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x001000000003055a
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000030445
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x00100000000300a9
- (id)currentPasteboardActivityInfo;	// IMP=0x001000000002fd93
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x001000000002fc4f
- (id)items;	// IMP=0x001000000002fc3d
- (void)startConnection:(int)arg1;	// IMP=0x001000000002fba8
...
- (id)uuid;	// IMP=0x001000000002f92f
- (void)dealloc;	// IMP=0x001000000002f867
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000002f1bd
