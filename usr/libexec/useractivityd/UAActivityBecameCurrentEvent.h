...
- (void).cxx_destruct;	// IMP=0x0020000000014727
...
- (id)reportedActivityType;	// IMP=0x001000000001467a
- (id)eventPayload;	// IMP=0x001000000001457e
- (id)eventName;	// IMP=0x0010000000014571
