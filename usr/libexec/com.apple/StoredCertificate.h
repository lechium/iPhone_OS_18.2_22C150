...
- (void).cxx_destruct;	// IMP=0x002000000000d49b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000d31f
- (unsigned long long)hash;	// IMP=0x001000000000d280
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000d148
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000d030
- (void)copyTo:(id)arg1;	// IMP=0x001000000000cf6d
- (void)writeTo:(id)arg1;	// IMP=0x001000000000ceb9
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000ceac
- (id)dictionaryRepresentation;	// IMP=0x001000000000cbd4
- (id)description;	// IMP=0x001000000000cb25
