...
- (void).cxx_destruct;	// IMP=0x002000000003b72a
...
- (void)performRequestWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000003af2e
- (id)sessionConfig;	// IMP=0x001000000003adfb
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000003aa9b
@property(readonly, nonatomic) NSMutableURLRequest *urlRequest;
- (id)protectionSpace;	// IMP=0x001000000003a9df
- (id)credential;	// IMP=0x001000000003a9d7
- (id)validateInput;	// IMP=0x001000000003a887
- (id)additionalHeaders;	// IMP=0x001000000003a87a
- (id)authorizationHeader;	// IMP=0x001000000003a872
- (id)bodyDictionary;	// IMP=0x001000000003a86a
