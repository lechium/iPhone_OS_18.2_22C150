...
+ (id)personaAwareAccountWithDSID:(id)arg1;	// IMP=0x004000000004dc8a
- (void).cxx_destruct;	// IMP=0x002000000004e77c
...
- (id)initWithACAccount:(id)arg1;	// IMP=0x001000000004dee7
