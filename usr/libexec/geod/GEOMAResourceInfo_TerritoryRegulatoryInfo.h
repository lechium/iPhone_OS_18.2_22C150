...
+ (id)_defaultQueryParameters;	// IMP=0x0020000000036152
+ (id)_defaultQueryType;	// IMP=0x0010000000036145
+ (id)allExisitngInfos;	// IMP=0x0010000000035f13
- (_Bool)isEqual:(id)arg1;	// IMP=0x002000000003622e
@property(readonly) unsigned long long hash;
- (_Bool)shouldPrefetchResource:(id)arg1;	// IMP=0x001000000003621c
...
- (id)init;	// IMP=0x0010000000035e6b
