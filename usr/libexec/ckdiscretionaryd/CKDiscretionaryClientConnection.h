...
- (void).cxx_destruct;	// IMP=0x002000000000783a
...
- (void)handleCompletedTask:(id)arg1 operationID:(id)arg2;	// IMP=0x00100000000074b3
- (void)cleanup;	// IMP=0x001000000000705e
- (void)finishOperationID:(id)arg1;	// IMP=0x0010000000006cc1
- (void)queueOperationID:(id)arg1 options:(id)arg2 clientOperationCallbackProxyEndpoint:(id)arg3 withBlock:(CDUnknownBlockType)arg4;	// IMP=0x0010000000005fb8
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x0010000000005a52
- (id)initWithDaemon:(id)arg1 group:(id)arg2 bundleID:(id)arg3 isSpringBoardApp:(_Bool)arg4 requiresPastBuddy:(_Bool)arg5 scheduleSendBarrierBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000000058b9
