...
- (void).cxx_destruct;	// IMP=0x002000000000b802
...
- (id)urlRequest;	// IMP=0x001000000000b527
- (id)urlString;	// IMP=0x001000000000b4d0
- (id)initWithAccount:(id)arg1 store:(id)arg2;	// IMP=0x001000000000b42e
