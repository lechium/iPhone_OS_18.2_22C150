...
- (void).cxx_destruct;	// IMP=0x002000000000c226
- (id)_parseURLFromAlertParameterWithName:(id)arg1;	// IMP=0x001000000000c163
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x001000000000bdc3
