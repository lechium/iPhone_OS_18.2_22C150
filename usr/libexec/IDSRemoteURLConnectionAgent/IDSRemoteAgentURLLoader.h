...
+ (_Bool)shouldAssertWiFi;	// IMP=0x0020000000001dd9
- (void).cxx_destruct;	// IMP=0x0020000000002466
...
- (void)cancel;	// IMP=0x0010000000002251
- (void)load;	// IMP=0x001000000000201f
- (void)dealloc;	// IMP=0x0010000000001ff0
- (id)initWithURLRequest:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000001de1
