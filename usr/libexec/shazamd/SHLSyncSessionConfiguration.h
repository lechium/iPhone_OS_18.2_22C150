...
- (void).cxx_destruct;	// IMP=0x002000000001d190
...
- (id)initWithType:(long long)arg1 scope:(long long)arg2 callingProcessIdentifier:(id)arg3 sessionIdentifier:(id)arg4;	// IMP=0x001000000001d0ba
