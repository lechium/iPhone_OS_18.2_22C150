...
+ (_Bool)hasAudioQueueFailedWithStatus:(int)arg1 annotateError:(id *)arg2;	// IMP=0x0020000000030221
+ (_Bool)isAudioQueueRunning:(struct OpaqueAudioQueue *)arg1;	// IMP=0x001000000002ff97
- (void).cxx_destruct;	// IMP=0x002000000003056d
...
- (void)startAudioQueueAfterRetrySecondsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000030277
- (_Bool)stopAudioQueueAndClearBuffersWithError:(id *)arg1;	// IMP=0x001000000002fffb
- (_Bool)stopRecordingWithError:(id *)arg1;	// IMP=0x001000000002ff85
- (void)startRecordingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f80c
@property(readonly, nonatomic) _Bool isRunning;
- (id)initWithRecordingSource:(long long)arg1;	// IMP=0x001000000002f781
- (void)dealloc;	// IMP=0x001000000002f6e5
