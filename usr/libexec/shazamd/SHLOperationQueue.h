...
+ (id)defaultQueue;	// IMP=0x004000000002d779
...
- (void)cancelAllOperations;	// IMP=0x001000000002da18
- (void)addOperation:(id)arg1 waitUntilFinished:(_Bool)arg2;	// IMP=0x001000000002d87b
- (void)addOperation:(id)arg1;	// IMP=0x001000000002d867
- (id)initOperationQueue;	// IMP=0x001000000002d7de
