...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000055265
- (void).cxx_destruct;	// IMP=0x0020000000055430
...
- (void)updateProgress;	// IMP=0x001000000005526d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000055193
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000054fa4
@property(readonly, nonatomic) NSArray *allItemIdentifiers;
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)subdivideTaskIntoBatchesOfSize:(long long)arg1;	// IMP=0x0010000000054563
- (id)_init;	// IMP=0x001000000005443d
- (id)initWithTracksToModify:(id)arg1 groupsToModify:(id)arg2;	// IMP=0x00100000000542bf
