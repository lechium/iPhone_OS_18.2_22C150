...
- (void).cxx_destruct;	// IMP=0x002000000001f809
@property(retain, nonatomic) NSDictionary *lyricsDictionary; // @synthesize lyricsDictionary=_lyricsDictionary;
- (id)itemForIdentifiers:(id)arg1;	// IMP=0x001000000001f5aa
- (id)initWithLyricsDictionary:(id)arg1;	// IMP=0x001000000001f53f
