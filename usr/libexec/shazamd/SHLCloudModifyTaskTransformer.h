...
- (void).cxx_destruct;	// IMP=0x0020000000038cff
...
- (id)recordIDsToDeleteFromModifyTask:(id)arg1;	// IMP=0x001000000003882e
- (id)recordsToSaveFromModifyTask:(id)arg1 container:(id)arg2;	// IMP=0x001000000003832a
- (id)cloudBackedOperationFromModifyTask:(id)arg1 container:(id)arg2;	// IMP=0x0010000000036ef8
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000036e5d
