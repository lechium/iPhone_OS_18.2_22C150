...
- (void).cxx_destruct;	// IMP=0x0020000000042fd4
...
- (void)recorder:(id)arg1 failedToStartWithError:(id)arg2;	// IMP=0x0010000000042eb0
- (void)recorder:(id)arg1 producedAudioBuffer:(id)arg2 atTime:(id)arg3;	// IMP=0x0010000000042a12
- (id)recorderForSource:(long long)arg1;	// IMP=0x00100000000428b2
- (_Bool)isAudioSourceSupported:(long long)arg1;	// IMP=0x001000000004287f
@property(readonly, nonatomic) long long suggestedAudioRecordingSource;
- (_Bool)hasActiveTapsForRecordingSource:(long long)arg1;	// IMP=0x0010000000042301
@property(readonly, nonatomic) _Bool hasActiveTaps;
- (void)detachTap:(id)arg1;	// IMP=0x001000000004206b
- (void)attachTap:(id)arg1;	// IMP=0x0010000000041e9b
- (void)stopRecordingForReason:(long long)arg1;	// IMP=0x0010000000041835
- (void)startRecording;	// IMP=0x001000000004126d
- (_Bool)shouldStartRecorder:(id)arg1;	// IMP=0x00100000000411fd
- (id)initWithRecorders:(id)arg1;	// IMP=0x00100000000410f3
- (void)dealloc;	// IMP=0x0010000000041054
