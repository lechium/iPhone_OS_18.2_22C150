...
- (void).cxx_destruct;	// IMP=0x002000000004de10
...
- (id)configurationsByRecordZoneIDUsingCache:(id)arg1;	// IMP=0x001000000004da1c
- (id)recordIDsFromCloudBackedZones:(id)arg1;	// IMP=0x001000000004d7f0
- (id)cloudBackedZoneChangesOperationFromFetchTask:(id)arg1 forChangedZones:(id)arg2 container:(id)arg3;	// IMP=0x001000000004c6cb
- (id)cloudBackedDatabaseChangesOperationFromFetchTask:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000004b4b3
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000004b3df
