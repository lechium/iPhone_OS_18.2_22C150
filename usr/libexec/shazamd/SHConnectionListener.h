...
- (void).cxx_destruct;	// IMP=0x00200000000079d8
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000007249
- (void)stopListening;	// IMP=0x001000000000720c
- (void)listen;	// IMP=0x00100000000071cf
- (id)initWithServiceProvider:(id)arg1 listener:(id)arg2;	// IMP=0x00100000000070ef
