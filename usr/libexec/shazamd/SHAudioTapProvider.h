...
- (void).cxx_destruct;	// IMP=0x002000000001927b
...
- (id)tapForSource:(long long)arg1;	// IMP=0x0010000000018f08
- (id)tapsForAvailableSources;	// IMP=0x0010000000018ccf
- (id)initWithAudioRecordingManager:(id)arg1 clientCredentials:(id)arg2 recorderConfiguration:(id)arg3;	// IMP=0x0010000000018c17
- (id)initWithAudioRecordingManager:(id)arg1 clientCredentials:(id)arg2;	// IMP=0x0010000000018b59
