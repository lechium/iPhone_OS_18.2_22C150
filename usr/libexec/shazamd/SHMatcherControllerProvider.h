...
- (void).cxx_destruct;	// IMP=0x002000000004a784
...
- (id)associatedMatcherControllerForRequest:(id)arg1;	// IMP=0x001000000004a687
- (id)catalogForRequest:(id)arg1;	// IMP=0x001000000004a567
- (id)matcherControllerForRequest:(id)arg1;	// IMP=0x0010000000049e94
- (id)initWithAudioTapProvider:(id)arg1 attribution:(id)arg2 clientType:(long long)arg3;	// IMP=0x0010000000049dc6
