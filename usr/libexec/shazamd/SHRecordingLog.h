...
+ (void)powerlogCallingProcessBundleID:(id)arg1 startDate:(id)arg2 endDate:(id)arg3;	// IMP=0x0040000000033a03
- (void).cxx_destruct;	// IMP=0x0020000000033a3b
...
- (void)detachedTapForClient:(long long)arg1;	// IMP=0x00100000000338e6
- (void)attachedTapForClient:(long long)arg1;	// IMP=0x001000000003385d
- (id)initWithBundleID:(id)arg1;	// IMP=0x00100000000337f2
