...
- (void).cxx_destruct;	// IMP=0x0020000000051949
...
- (id)recordZonesFromCloudBackedZones:(id)arg1;	// IMP=0x001000000005173a
- (id)cloudBackedOperationForZonesToSave:(id)arg1 container:(id)arg2;	// IMP=0x0010000000051128
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000510a3
