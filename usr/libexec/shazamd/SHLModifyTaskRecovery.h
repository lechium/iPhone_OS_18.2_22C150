...
- (void).cxx_destruct;	// IMP=0x0020000000032403
...
- (id)recoverTaskFromLimitExceededError;	// IMP=0x0010000000032325
- (id)recoverTaskFromPartialError;	// IMP=0x0010000000031f27
@property(readonly, nonatomic) NSArray *recoverableTasks;
- (id)initWithOriginalTask:(id)arg1 savedGroups:(id)arg2 savedTracks:(id)arg3 deletedIDs:(id)arg4 error:(id)arg5;	// IMP=0x0010000000031c73
