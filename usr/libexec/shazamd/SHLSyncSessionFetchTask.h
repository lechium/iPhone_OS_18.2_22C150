...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002d699
- (void).cxx_destruct;	// IMP=0x002000000002d73f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002d614
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002d52d
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)init;	// IMP=0x001000000002d44a
