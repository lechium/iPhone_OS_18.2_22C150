...
+ (id)bundleWithIdentifier:(id)arg1;	// IMP=0x004000000003b00d
+ (id)bundleWithURL:(id)arg1;	// IMP=0x001000000003afc0
- (_Bool)isPathContainedWithin:(id)arg1;	// IMP=0x002000000003b8c3
- (_Bool)isPathTheMainExecutable:(id)arg1;	// IMP=0x001000000003b7c7
...
- (id)localizedUsageDescriptionForKey:(id)arg1;	// IMP=0x001000000003b54b
...
- (id)description;	// IMP=0x001000000003b0ce
@property(readonly) NSURL *bundleURL;
@property(readonly) NSString *bundlePath;
@property(readonly) NSString *bundleIdentifier;
- (void)dealloc;	// IMP=0x001000000003af81
- (id)initWithIdentifier:(id)arg1;	// IMP=0x001000000003ae67
- (id)initWithURL:(id)arg1;	// IMP=0x001000000003ad9d
