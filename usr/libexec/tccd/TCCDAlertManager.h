...
- (void).cxx_destruct;	// IMP=0x002000000006a015
...
- (void)displayAlertForCondition:(long long)arg1 withCustomUserInfo:(id)arg2;	// IMP=0x0010000000069d71
- (id)initWithAlerts:(id)arg1;	// IMP=0x0010000000069cdd
