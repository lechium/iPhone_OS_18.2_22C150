...
- (void).cxx_destruct;	// IMP=0x0020000000067d16
...
- (id)attributedBundleUsingOutermostBundle:(_Bool)arg1 computedStaticCodeRef:(const void **)arg2 computedNonIdentifiableBundleURL:(id *)arg3;	// IMP=0x00100000000679b6
...
- (id)description;	// IMP=0x00100000000677bd
- (id)initWithMessage:(id)arg1 evaluateResponsibility:(_Bool)arg2 processInfo:(id)arg3;	// IMP=0x001000000006718e
- (id)createProcessFromAuditToken:(CDStruct_4c969caf)arg1 processInfo:(id)arg2;	// IMP=0x001000000006714a
- (void)getAuditToken:(CDStruct_4c969caf *)arg1 fromMessage:(id)arg2;	// IMP=0x001000000006713a
- (id)initWithMessage:(id)arg1 evaluateResponsibility:(_Bool)arg2;	// IMP=0x0010000000067125
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000006710e
