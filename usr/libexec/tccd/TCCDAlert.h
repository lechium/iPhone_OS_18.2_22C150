...
- (void).cxx_destruct;	// IMP=0x002000000006a64c
...
- (void)display;	// IMP=0x001000000006a23f
- (_Bool)isDisplayableForCondition:(long long)arg1;	// IMP=0x001000000006a14a
- (id)initWithCondition:(long long)arg1 platformName:(id)arg2 service:(id)arg3 displayPolicy:(long long)arg4 persistentStateType:(unsigned long long)arg5 displayCountlimit:(int)arg6 configuration:(id)arg7;	// IMP=0x001000000006a03d
