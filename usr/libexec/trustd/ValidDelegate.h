...
- (void).cxx_destruct;	// IMP=0x00200000000246de
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x00100000000243e0
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0010000000024198
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000023c28
- (long long)versionFromTask:(id)arg1;	// IMP=0x0010000000023bcc
- (void)updateDb:(long long)arg1;	// IMP=0x001000000002389d
- (void)reschedule;	// IMP=0x001000000002379f
