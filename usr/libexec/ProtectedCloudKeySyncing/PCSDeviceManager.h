...
+ (id)sharedManager;	// IMP=0x0020000000011500
- (void).cxx_destruct;	// IMP=0x0020000000012244
...
- (void)setSimulatedDevices:(id)arg1;	// IMP=0x0010000000011ec3
@property(readonly) NSArray *allDevices;
- (id)deviceForPairingID:(id)arg1;	// IMP=0x00100000000119a9
- (id)deviceForIDSIdentifier:(id)arg1;	// IMP=0x0010000000011776
- (id)currentActivePairedDevice;	// IMP=0x00100000000115cc
- (id)init;	// IMP=0x0010000000011555
