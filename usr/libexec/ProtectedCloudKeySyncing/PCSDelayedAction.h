...
- (void).cxx_destruct;	// IMP=0x0020000000019871
...
- (void)trigger;	// IMP=0x0010000000019621
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x0010000000019598
- (void)run;	// IMP=0x0010000000019586
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x0010000000019554
- (id)initWithLabel:(id)arg1 delay:(unsigned long long)arg2 operationQueue:(id)arg3;	// IMP=0x0010000000019144
