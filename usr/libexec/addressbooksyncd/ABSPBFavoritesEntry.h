...
- (void).cxx_destruct;	// IMP=0x0020000000003854
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000360b
- (unsigned long long)hash;	// IMP=0x00100000000034ea
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000032fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000003165
- (void)copyTo:(id)arg1;	// IMP=0x001000000000302a
- (void)writeTo:(id)arg1;	// IMP=0x0010000000002ee9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000002edc
- (id)dictionaryRepresentation;	// IMP=0x00100000000028f2
- (id)description;	// IMP=0x0010000000002843
