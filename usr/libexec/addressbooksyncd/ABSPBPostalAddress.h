...
- (void).cxx_destruct;	// IMP=0x0020000000032086
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000031df6
- (unsigned long long)hash;	// IMP=0x0010000000031ced
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000031b05
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000031948
- (void)copyTo:(id)arg1;	// IMP=0x0010000000031805
- (void)writeTo:(id)arg1;	// IMP=0x00100000000316dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000316d0
- (id)dictionaryRepresentation;	// IMP=0x00100000000312dc
- (id)description;	// IMP=0x001000000003122d
