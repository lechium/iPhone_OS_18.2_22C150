...
- (void).cxx_destruct;	// IMP=0x002000000003e26c
...
- (void)resume;	// IMP=0x001000000003e235
- (void)pause;	// IMP=0x001000000003e22f
- (void)doneForRealNotifyingPairedSync:(_Bool)arg1;	// IMP=0x001000000003e0aa
- (id)initWithSession:(id)arg1;	// IMP=0x001000000003e034
