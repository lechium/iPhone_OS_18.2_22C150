...
+ (long long)cpuTime;	// IMP=0x004000000003555a
+ (long long)dirtyMemory;	// IMP=0x00100000000354e3
+ (long long)wallTime;	// IMP=0x001000000003547c
+ (id)nowMinusPrevious:(id)arg1;	// IMP=0x001000000003539d
...
- (id)description;	// IMP=0x00100000000355d4
- (double)cpuTimeMs;	// IMP=0x001000000003534c
- (id)init;	// IMP=0x0010000000035263
