...
- (void).cxx_destruct;	// IMP=0x002000000002c654
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000002c577
- (unsigned long long)hash;	// IMP=0x001000000002c500
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002c40e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002c350
- (void)copyTo:(id)arg1;	// IMP=0x001000000002c2cd
- (void)writeTo:(id)arg1;	// IMP=0x001000000002c249
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000002c23c
- (id)dictionaryRepresentation;	// IMP=0x001000000002bf50
- (id)description;	// IMP=0x001000000002bea1
