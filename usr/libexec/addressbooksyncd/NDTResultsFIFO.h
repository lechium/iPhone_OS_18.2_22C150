...
- (void).cxx_destruct;	// IMP=0x0020000000031131
...
- (id)description;	// IMP=0x0010000000030f70
- (void)terminateIfNotFinished;	// IMP=0x0010000000030e90
- (void)terminate;	// IMP=0x0010000000030dc4
- (id)pop;	// IMP=0x0010000000030cb3
- (void)conditionalPop:(CDUnknownBlockType)arg1;	// IMP=0x0010000000030a13
- (void)finish;	// IMP=0x0010000000030959
- (_Bool)push:(id)arg1;	// IMP=0x001000000003071d
- (id)initWithFIFOLength:(long long)arg1 name:(id)arg2;	// IMP=0x0010000000030649
- (id)init;	// IMP=0x0010000000030630
