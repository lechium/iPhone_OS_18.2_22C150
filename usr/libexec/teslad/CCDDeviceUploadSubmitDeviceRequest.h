...
- (void).cxx_destruct;	// IMP=0x0020000000004576
...
- (id)_deviceDetails;	// IMP=0x0010000000004222
- (id)requestBody;	// IMP=0x0010000000003ebc
- (id)endpointPath;	// IMP=0x0010000000003ea8
- (id)httpMethod;	// IMP=0x0010000000003e9b
- (long long)requestType;	// IMP=0x0010000000003e90
