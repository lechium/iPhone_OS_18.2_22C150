...
- (id)errorForStatusCode:(long long)arg1 responseData:(id)arg2;	// IMP=0x0010000000004e76
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 outError:(id *)arg3;	// IMP=0x0010000000004e6e
- (void)completeOperationWithResponse:(id)arg1 error:(id)arg2;	// IMP=0x0010000000004cf6
- (id)responseWithResponseData:(id)arg1 contentType:(id)arg2 statusCode:(long long)arg3 retryNeeded:(_Bool *)arg4 outError:(id *)arg5;	// IMP=0x0010000000004bc4
