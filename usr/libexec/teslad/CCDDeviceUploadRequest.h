...
- (void).cxx_destruct;	// IMP=0x0020000000003786
...
- (id)requestWithError:(id *)arg1;	// IMP=0x0010000000003415
- (id)_requestBodyData;	// IMP=0x00100000000032e3
- (id)_endpointURL;	// IMP=0x001000000000321a
- (id)_requestHeader;	// IMP=0x00100000000030ac
- (id)_contentType;	// IMP=0x001000000000309f
