...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000153ea
- (void).cxx_destruct;	// IMP=0x00200000000174e8
...
- (id)description;	// IMP=0x00100000000172d9
- (id)infoPlistContent;	// IMP=0x0010000000016f42
- (void)setRequiredDeviceCapabilitiesWithArray:(id)arg1;	// IMP=0x0010000000016d05
- (id)initWithInfoPlistDictionary:(id)arg1;	// IMP=0x0010000000016217
- (id)initWithInfoPlistFromBundle:(struct __CFBundle *)arg1 error:(id *)arg2;	// IMP=0x001000000001617e
- (id)initWithInfoPlistFromBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000160ca
- (id)_plistKeys;	// IMP=0x0010000000016002
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000015d4c
- (unsigned long long)hash;	// IMP=0x0010000000015a4c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000153f2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000150b0
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000014ce2
- (id)init;	// IMP=0x0010000000014cb3
