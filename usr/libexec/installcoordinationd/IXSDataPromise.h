...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000008f8b5
- (void).cxx_destruct;	// IMP=0x00100000000919e5
...
- (id)description;	// IMP=0x001000000009182a
- (void)supersede;	// IMP=0x001000000009176e
- (void)decommission;	// IMP=0x0010000000091638
...
- (void)_setPercentComplete:(double)arg1 saveStateIfNeeded:(_Bool)arg2;	// IMP=0x0010000000090dfa
...
- (void)_removeSavedState;	// IMP=0x00100000000905cf
- (void)saveState;	// IMP=0x001000000009026d
- (_Bool)awakeFromSerializationWithLookupBlock:(CDUnknownBlockType)arg1 error:(id *)arg2;	// IMP=0x0010000000090200
- (_Bool)cancelForReason:(id)arg1 client:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x001000000008fc6d
- (void)reset;	// IMP=0x001000000008f9c0
- (unsigned long long)hash;	// IMP=0x001000000008f97c
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008f8bd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000008f70e
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000008f4c7
@property(readonly, copy, nonatomic) IXDataPromiseSeed *clientSeed; // @dynamic clientSeed;
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008f2cd
- (void)_internalInitWithUniqueIdentifier:(id)arg1;	// IMP=0x001000000008f188
- (oneway void)_remote_preflightWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000009273a
- (oneway void)_remote_getErrorInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000009254b
- (oneway void)_remote_resetWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000921db
- (oneway void)_remote_cancelForReason:(id)arg1 client:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000091fd6
- (oneway void)_remote_setIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000091d9c
- (oneway void)_remote_getIsComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000091c4e
- (oneway void)_remote_setPercentComplete:(double)arg1;	// IMP=0x0010000000091b7a
- (oneway void)_remote_getPercentComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000091a2c
