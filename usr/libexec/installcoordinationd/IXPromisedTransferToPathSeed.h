...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000048035
- (void).cxx_destruct;	// IMP=0x0020000000048157
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004803d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000047f4f
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000047e67
