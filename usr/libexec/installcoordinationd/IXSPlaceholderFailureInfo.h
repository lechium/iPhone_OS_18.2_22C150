...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000048a28
- (void).cxx_destruct;	// IMP=0x0020000000048d5e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000048baa
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000048a30
