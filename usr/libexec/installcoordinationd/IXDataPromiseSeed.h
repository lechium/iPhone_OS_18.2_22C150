...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000048413
- (void).cxx_destruct;	// IMP=0x0020000000048566
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004841b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000482cd
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000004816a
