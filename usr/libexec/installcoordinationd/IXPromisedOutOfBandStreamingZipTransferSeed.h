...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000048876
- (void).cxx_destruct;	// IMP=0x00200000000489f4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004887e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000048707
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000004858e
