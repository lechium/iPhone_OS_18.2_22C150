...
- (unsigned long long)totalBytesForProgress;	// IMP=0x0020000000003110
- (void)reset;	// IMP=0x0010000000003075
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000003046
- (oneway void)_remote_setArchiveBytesConsumed:(unsigned long long)arg1;	// IMP=0x0010000000003189
