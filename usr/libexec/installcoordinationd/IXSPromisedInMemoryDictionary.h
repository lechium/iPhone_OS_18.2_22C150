...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000037cfa
@property(readonly, copy, nonatomic) NSDictionary *dictionary;
- (id)initWithSeed:(id)arg1 dictionary:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000037d02
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000037c75
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000037c46
