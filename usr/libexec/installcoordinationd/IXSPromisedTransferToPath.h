...
- (oneway void)_remote_setTryDeltaCopy:(_Bool)arg1;	// IMP=0x002000000003a988
- (oneway void)_remote_setShouldCopy:(_Bool)arg1;	// IMP=0x001000000003a873
- (oneway void)_remote_setTransferPath:(id)arg1;	// IMP=0x001000000003a72f
