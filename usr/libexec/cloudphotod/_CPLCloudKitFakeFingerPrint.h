...
- (void).cxx_destruct;	// IMP=0x002000000004c2c6
...
- (id)initWithRealResourceType:(unsigned long long)arg1 realFingerPrint:(id)arg2 outputType:(id)arg3 dimensions:(struct CGSize)arg4;	// IMP=0x001000000004bf69
- (id)initWithFakeFingerPrint:(id)arg1;	// IMP=0x001000000004bc50
- (id)initWithFakeIdentity:(id)arg1;	// IMP=0x001000000004bbfa
