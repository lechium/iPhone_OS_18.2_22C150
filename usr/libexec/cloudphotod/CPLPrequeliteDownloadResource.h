...
- (void).cxx_destruct;	// IMP=0x00200000001a50f3
...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x00100000001a4f1f
- (id)initWithResource:(id)arg1;	// IMP=0x00100000001a4d28
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001a4ba0
