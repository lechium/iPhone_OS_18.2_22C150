...
- (void).cxx_destruct;	// IMP=0x0020000000043380
...
- (id)groupNameForGroupName:(id)arg1;	// IMP=0x0010000000042ef9
- (id)initWithMappingInFolderWithURL:(id)arg1;	// IMP=0x0010000000042a84
- (id)initWithMappingAtURL:(id)arg1;	// IMP=0x0010000000042a09
