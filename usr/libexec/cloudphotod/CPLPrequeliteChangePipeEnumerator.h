...
- (void).cxx_destruct;	// IMP=0x002000000018648b
...
- (void)enumerateChangesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001862fa
@property(readonly, nonatomic) _Bool hasChanges;
- (id)initWithStore:(id)arg1 table:(id)arg2;	// IMP=0x00100000001861ba
