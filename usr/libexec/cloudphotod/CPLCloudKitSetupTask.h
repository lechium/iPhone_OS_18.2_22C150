...
- (void).cxx_destruct;	// IMP=0x002000000004540e
...
- (void)runOperations;	// IMP=0x00100000000453ec
- (void)fetchUserRecord;	// IMP=0x001000000004532d
- (void)fetchDerivativesFilter;	// IMP=0x001000000004505f
- (void)fetchDisabledFeatures;	// IMP=0x0010000000044bfc
- (id)initWithController:(id)arg1 updateDisabledFeatures:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000044b67
