...
- (void).cxx_destruct;	// IMP=0x002000000007566b
- (void)runOperations;	// IMP=0x0010000000074f12
- (_Bool)_shouldSkipRampingRequest;	// IMP=0x0010000000074e96
- (double)timeoutIntervalForRequest;	// IMP=0x0010000000074e88
- (id)initWithController:(id)arg1 resourceType:(unsigned long long)arg2 numRequested:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000074dcd
