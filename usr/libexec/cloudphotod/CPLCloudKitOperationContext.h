...
- (void).cxx_destruct;	// IMP=0x002000000003ef6d
...
- (id)startDateDescriptionWithNow:(id)arg1;	// IMP=0x001000000003ebcc
- (id)operationDescription;	// IMP=0x001000000003ebc4
- (id)extendedStatusDescriptionStrings;	// IMP=0x001000000003ebbc
