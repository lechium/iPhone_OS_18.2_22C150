...
+ (id)selfCrashResetReason;	// IMP=0x002000000016a345
- (void).cxx_destruct;	// IMP=0x002000000016a411
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000169627
- (void)acknowledgeChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001684ee
- (void)getChangeBatchWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001672bc
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000166a44
- (id)clientWorkDescription;	// IMP=0x0010000000166a37
