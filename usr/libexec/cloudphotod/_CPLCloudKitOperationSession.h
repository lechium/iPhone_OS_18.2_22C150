...
- (void).cxx_destruct;	// IMP=0x00200000000c96c3
- (_Bool)isOngoing;	// IMP=0x00100000000c96a6
- (id)status;	// IMP=0x00100000000c8da0
- (id)statusObject;	// IMP=0x00100000000c8a7b
- (void)endTask:(id)arg1 withOperationClasses:(id)arg2 operationsAllowingCellular:(id)arg3;	// IMP=0x00100000000c85c6
- (_Bool)beginTask:(id)arg1;	// IMP=0x00100000000c84fd
- (id)init;	// IMP=0x00100000000c842f
