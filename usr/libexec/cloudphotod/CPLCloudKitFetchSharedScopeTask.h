...
- (void).cxx_destruct;	// IMP=0x0020000000088c46
- (id)_scopeChangeFromShareMetadata:(id)arg1 currentUserID:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000885a3
- (void)_fetchSharedScopeWithCurrentUserID:(id)arg1;	// IMP=0x0010000000087ac9
- (void)runOperations;	// IMP=0x0010000000087a48
- (id)initWithController:(id)arg1 shareURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000008798f
