...
- (void).cxx_destruct;	// IMP=0x00200000001afe31
...
- (id)resource;	// IMP=0x00100000001afc24
- (id)initWithResource:(id)arg1;	// IMP=0x00100000001afa3d
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001af8bf
