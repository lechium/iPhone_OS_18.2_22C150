...
- (void).cxx_destruct;	// IMP=0x00200000000c7174
...
- (void)_startDownload;	// IMP=0x00100000000c684d
- (void)_fetchPlaceholderRecordAndStartDownload;	// IMP=0x00100000000c6634
- (void)runOperations;	// IMP=0x00100000000c64da
- (id)_inMemoryDownloadOperationForRecordID:(id)arg1 resource:(id)arg2 record:(id)arg3 keys:(id)arg4 operationType:(long long)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000000c5c01
- (id)initWithController:(id)arg1 resource:(id)arg2 record:(id)arg3 target:(id)arg4 transportScopeMapping:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00100000000c5a59
