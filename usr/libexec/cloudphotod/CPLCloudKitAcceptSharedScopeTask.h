...
- (void).cxx_destruct;	// IMP=0x0020000000056b32
- (void)_acceptShareWithMetadata:(id)arg1 currentUserID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000560c0
- (void)_fetchMetadataForShareURL:(id)arg1 currentUserID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000054e0a
- (void)_acceptShareWithURL:(id)arg1 currentUserID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000054cc5
- (void)_updateScopeParticipantsWithCKShare:(id)arg1 currentUserID:(id)arg2;	// IMP=0x0010000000054bab
- (void)_updateScopeAndFlagsWithCKRecord:(id)arg1 currentUserID:(id)arg2;	// IMP=0x0010000000054a95
- (void)runOperations;	// IMP=0x001000000005429d
- (id)initWithController:(id)arg1 scope:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000541e4
