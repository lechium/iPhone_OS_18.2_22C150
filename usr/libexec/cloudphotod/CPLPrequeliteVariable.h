...
+ (id)variableWithName:(id)arg1 forTable:(id)arg2 type:(id)arg3;	// IMP=0x002000000019fe9b
+ (id)variableWithName:(id)arg1 type:(id)arg2;	// IMP=0x001000000019fe84
+ (id)indexVariableForVariableWithName:(id)arg1 forTable:(id)arg2;	// IMP=0x001000000019f8a8
+ (id)variableWithName:(id)arg1 defaultValue:(id)arg2 forTable:(id)arg3 type:(id)arg4;	// IMP=0x001000000019f803
+ (id);	// IMP=0x001000000019f774
- (void).cxx_destruct;	// IMP=0x00200000001a0198
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a00a5
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a0084
- (id)columnDefinitionWithDefaultValue:(id)arg1;	// IMP=0x001000000019fec9
@property(readonly, nonatomic) id <PQLInjecting> columnDefinition;
- (id)valueFromSet:(id)arg1 atIndex:(int)arg2;	// IMP=0x001000000019fdea
- (id)bindableValueForValue:(id)arg1;	// IMP=0x001000000019fd52
- (void)discardCachedValue;	// IMP=0x001000000019fd19
- (void)setCachedValue:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x001000000019fca4
- (id)cachedValueForIdentifier:(id)arg1;	// IMP=0x001000000019fc43
- (_Bool)hasCachedValueForIdentifier:(id)arg1;	// IMP=0x001000000019fbf4
- (id)redactedDescription;	// IMP=0x001000000019fbab
@property(readonly, copy) NSString *description;
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x001000000019fb31
@property(readonly, nonatomic) NSData *sql;
- (id)initWithName:(id)arg1 defaultValue:(id)arg2 table:(id)arg3 type:(id)arg4;	// IMP=0x001000000019f962
