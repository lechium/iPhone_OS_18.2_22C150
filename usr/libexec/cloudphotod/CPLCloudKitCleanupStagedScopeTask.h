...
- (void).cxx_destruct;	// IMP=0x00200000000cd979
...
- (id)auxiliaryOperationDidFinishWithError:(id)arg1;	// IMP=0x00100000000cd83d
- (void)launchAuxiliaryOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3;	// IMP=0x00100000000cd696
- (id)operationDidFinishWithError:(id)arg1;	// IMP=0x00100000000cd619
- (void)updateProgress:(double)arg1;	// IMP=0x00100000000cd5e4
- (void)updateContextWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000cd57c
- (MISSING_TYPE *)updateOneBatch;	// IMP=0x00100000000cd547
- (id)operationDidFinish:(id)arg1 error:(id)arg2;	// IMP=0x00100000000cd4c0
- (void)launchOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3 sourceBundleIdentifiers:(id)arg4;	// IMP=0x00100000000cd3d7
- (void)dispatchAsync:(CDUnknownBlockType)arg1;	// IMP=0x00100000000cd24c
- (void)runOperations;	// IMP=0x00100000000ccebf
- (void)runAuxiliaryOperation;	// IMP=0x00100000000cca13
- (void)_fetchAndMoveNextBatchWithUserRecordID:(id)arg1;	// IMP=0x00100000000cc458
- (void)_moveBatchRecordWithNames:(id)arg1 userRecordID:(id)arg2 operationID:(id)arg3 moveBatchID:(id)arg4 hasMore:(_Bool)arg5;	// IMP=0x00100000000cbdd3
- (void)_sendExitFeedbackWithSourceRecordIDs:(id)arg1 destinationRecordIDs:(id)arg2 moveError:(id)arg3 operationID:(id)arg4 moveBatchID:(id)arg5;	// IMP=0x00100000000cb994
- (id)initWithController:(id)arg1 stagedScope:(id)arg2 stagingScope:(id)arg3 destinationScope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000cb789
