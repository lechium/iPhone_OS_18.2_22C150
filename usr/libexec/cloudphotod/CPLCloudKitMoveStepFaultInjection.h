...
+ (id)moveStepFaultInjectionWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x004000000003cb35
...
- (id)initWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x001000000003cb6e
