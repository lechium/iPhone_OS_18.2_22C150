...
- (void).cxx_destruct;	// IMP=0x00200000000d00e3
- (void)runOperations;	// IMP=0x00100000000d007a
- (id)initWithController:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000cfff6
