...
- (void).cxx_destruct;	// IMP=0x002000000004df1d
...
- (void)runOperations;	// IMP=0x001000000004d341
- (void)_didFinishDeleteWithError:(id)arg1;	// IMP=0x001000000004d025
- (id)_errorForDeleteError:(id)arg1;	// IMP=0x001000000004cec7
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000004cddf
