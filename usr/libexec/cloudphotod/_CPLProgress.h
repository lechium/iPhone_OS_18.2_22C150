...
- (void).cxx_destruct;	// IMP=0x00200000001860aa
...
- (void)unpublish;	// IMP=0x001000000018602e
- (void)publish;	// IMP=0x0010000000186007
- (void)_publishRealProgressIfNecessary;	// IMP=0x0010000000185ee2
- (void)setUserInfoObject:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000185e51
- (id)initWithIdentifier:(id)arg1 firstSyncOfMainLibrary:(_Bool)arg2;	// IMP=0x0010000000185c90
