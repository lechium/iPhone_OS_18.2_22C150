...
- (void).cxx_destruct;	// IMP=0x00200000000d4152
...
- (void)_determineScopeTypeAndFetchLibraryInfoWithCurrentUserID:(id)arg1;	// IMP=0x00100000000d3ac9
- (void)getScopeInfoWithCurrentUserID:(id)arg1;	// IMP=0x00100000000d3306
- (void)runOperations;	// IMP=0x00100000000d3271
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 previousScopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000d3144
