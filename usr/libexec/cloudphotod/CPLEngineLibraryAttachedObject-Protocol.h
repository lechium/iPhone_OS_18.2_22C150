...
@class CPLEngineLibrary, CPLResource, CPLResourceTransferTask, NSArray, NSError, NSString, NSURL;

@protocol CPLEngineLibraryAttachedObject <NSObject>
- (NSString *)displayableNameForEngineLibrary:(CPLEngineLibrary *)arg1;
- (void)engineLibrary:(CPLEngineLibrary *)arg1 providePayloadForComputeStates:(NSArray *)arg2 inFolderWithURL:(NSURL *)arg3 completionHandler:(void (^)(NSArray *, NSError *))arg4;
