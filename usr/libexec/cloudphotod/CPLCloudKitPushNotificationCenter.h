...
- (void)getStatusDictionaryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000042f9
- (void)getStatusWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003a6d
- (void)_setPushRegistrationStatus:(id)arg1 error:(id)arg2;	// IMP=0x00100000000039f4
- (void)connection:(id)arg1 didReceiveToken:(id)arg2 forTopic:(id)arg3 identifier:(id)arg4;	// IMP=0x00100000000038bc
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x001000000000334f
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x0010000000003267
- (void)unregisterFromPushNotifications;	// IMP=0x00100000000031d0
- (void)stopWaitingForPushNotifications;	// IMP=0x00100000000030cd
- (void)startWaitingForPushNotificationsForContainer:(id)arg1;	// IMP=0x0010000000002a28
- (id)init;	// IMP=0x00100000000027cb
