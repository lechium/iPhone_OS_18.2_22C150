...
+ (id)selfCrashResetReason;	// IMP=0x002000000016d8dc
- (void).cxx_destruct;	// IMP=0x002000000016d9a8
- (void)commitChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000016c44c
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000016bb56
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000016b3c3
- (id)clientWorkDescription;	// IMP=0x001000000016b3b6
