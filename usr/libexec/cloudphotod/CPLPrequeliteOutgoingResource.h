...
- (void).cxx_destruct;	// IMP=0x0020000000194ee8
...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x0010000000194d43
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x0010000000194c38
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x0010000000194956
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000194801
