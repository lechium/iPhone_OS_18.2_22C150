...
- (void).cxx_destruct;	// IMP=0x0020000000087931
@property(readonly, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(readonly, nonatomic) NSArray *tasks; // @synthesize tasks=_tasks;
- (void)runOperations;	// IMP=0x0010000000087746
- (void)_updateSparseRecords:(id)arg1 currentUserRecordID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000086518
- (void)_fetchSparseRecordsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000862ba
- (id)initWithController:(id)arg1 tasks:(id)arg2 transportScopeMapping:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000861da
