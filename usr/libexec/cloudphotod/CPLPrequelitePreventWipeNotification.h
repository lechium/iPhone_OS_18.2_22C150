...
+ (void)resetNotificationForLibraryIdentifier:(id)arg1;	// IMP=0x00400000001ac45c
- (void).cxx_destruct;	// IMP=0x00200000001ad138
...
- (id)createRadarURL;	// IMP=0x00100000001acd09
- (_Bool)shouldPreventWipeOnUpgradeCreateRadar:(_Bool)arg1;	// IMP=0x00100000001acc4a
- (_Bool)_warnUserAndReturnIfShouldPreventWipeOnUpgradeCreateRadar:(_Bool)arg1;	// IMP=0x00100000001ac72a
- (void)_save;	// IMP=0x00100000001ac6a6
- (id)initWithLibraryIdentifier:(id)arg1 reason:(id)arg2;	// IMP=0x00100000001ac548
