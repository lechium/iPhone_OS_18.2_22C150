...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000002122b7
- (void).cxx_destruct;	// IMP=0x0020000000212284
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000002120df
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000211fd7
- (id)description;	// IMP=0x0010000000211eff
- (id)initWithTLK:(id)arg1 classA:(id)arg2 classC:(id)arg3 newUpload:(_Bool)arg4;	// IMP=0x0010000000211e3a
