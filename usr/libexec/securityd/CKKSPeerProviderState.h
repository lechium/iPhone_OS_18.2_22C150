...
+ (id)createFromProvider:(id)arg1;	// IMP=0x004000000015b8fb
+ (id)noPeersState:(id)arg1;	// IMP=0x001000000015b7e5
- (void).cxx_destruct;	// IMP=0x002000000015b791
...
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x001000000015a7ac
- (id)description;	// IMP=0x001000000015a67f
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x001000000015a38f
