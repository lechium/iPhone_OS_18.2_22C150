...
- (void).cxx_destruct;	// IMP=0x00200000000b2df1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000b2b56
- (unsigned long long)hash;	// IMP=0x00100000000b2a1e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b282d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b268c
- (void)copyTo:(id)arg1;	// IMP=0x00100000000b254b
- (void)writeTo:(id)arg1;	// IMP=0x00100000000b2408
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000b1e7c
- (id)dictionaryRepresentation;	// IMP=0x00100000000b1b21
- (id)description;	// IMP=0x00100000000b1a72
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x00100000000b188f
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00100000000b1823
