...
@interface CKKSUpdateCurrentItemPointerOperation
{
    ...
    MISSING_TYPE *_newerItemSHA1;	// 80 = 0x50
...
- (void).cxx_destruct;	// IMP=0x002000000019d72b
...
- (struct SecDbItem *)_onqueueFindSecDbItemWithQuery:(id)arg1 error:(id *)arg2;	// IMP=0x001000000019d12c
- (struct SecDbItem *)_onqueueFindSecDbItemWithUUID:(id)arg1 accessGroup:(id)arg2 error:(id *)arg3;	// IMP=0x001000000019cf2d
- (struct SecDbItem *)_onqueueFindSecDbItem:(id)arg1 accessGroup:(id)arg2 error:(id *)arg3;	// IMP=0x001000000019ce31
- (void)_fetchAndUpdateMirrorEntry:(id)arg1;	// IMP=0x001000000019c9a4
- (void)groupStart;	// IMP=0x001000000019c89f
- (void)dealloc;	// IMP=0x001000000019c82f
- (id)initWithCKKSOperationDependencies:(id)arg1 viewState:(id)arg2 newItem:(id)arg3 hash:(id)arg4 accessGroup:(id)arg5 identifier:(id)arg6 replacing:(id)arg7 hash:(id)arg8 ckoperationGroup:(id)arg9;	// IMP=0x001000000019c62f
