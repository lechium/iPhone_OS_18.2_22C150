...
- (void).cxx_destruct;	// IMP=0x00200000001d9e0e
...
- (void)setStorage:(id)arg1;	// IMP=0x00100000001d9c7a
- (id)storage;	// IMP=0x00100000001d9c17
- (id)initWithStoragePath:(id)arg1 storageClass:(Class)arg2;	// IMP=0x00100000001d9a93
