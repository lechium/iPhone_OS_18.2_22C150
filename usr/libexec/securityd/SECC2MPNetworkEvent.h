...
- (void).cxx_destruct;	// IMP=0x0020000000203be1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000203335
- (unsigned long long)hash;	// IMP=0x0010000000202d34
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002024fd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000201f2f
- (void)copyTo:(id)arg1;	// IMP=0x0010000000201a22
- (void)writeTo:(id)arg1;	// IMP=0x00100000002014c1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002014b4
- (id)dictionaryRepresentation;	// IMP=0x0010000000200842
- (id)description;	// IMP=0x0010000000200793
