...
- (void).cxx_destruct;	// IMP=0x002000000011e09a
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x001000000011dd8b
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x001000000011dc1e
- (void)groupStart;	// IMP=0x001000000011d6d7
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 custodianRecoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x001000000011d5c7
