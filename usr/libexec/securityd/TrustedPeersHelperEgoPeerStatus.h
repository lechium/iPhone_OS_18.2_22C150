...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000021afd6
- (void).cxx_destruct;	// IMP=0x002000000021af98
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000021ad39
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000021a952
- (id)description;	// IMP=0x001000000021a8bf
- (id)initWithEgoPeerID:(id)arg1 egoPeerMachineID:(id)arg2 status:(unsigned long long)arg3 viablePeerCountsByModelID:(id)arg4 peerCountsByMachineID:(id)arg5 isExcluded:(_Bool)arg6 isLocked:(_Bool)arg7;	// IMP=0x001000000021a659
