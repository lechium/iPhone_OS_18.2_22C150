...
- (void).cxx_destruct;	// IMP=0x00200000002279ad
...
- (long long)wait:(unsigned long long)arg1;	// IMP=0x00100000002278e1
- (void)fulfill;	// IMP=0x001000000022785e
- (id)initToChain:(id)arg1;	// IMP=0x00100000002277de
- (id)init;	// IMP=0x00100000002277ca
