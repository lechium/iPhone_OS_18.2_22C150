...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x002000000003ff92
+ (id)getCircleStatus;	// IMP=0x001000000003fe70
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x001000000003fdd1
- (void).cxx_destruct;	// IMP=0x002000000003ddd7
...
- (void)setCDPCapableiCloudAccountStatus:(long long)arg1;	// IMP=0x001000000003da72
- (void)triggerOctagonStatusFetch;	// IMP=0x001000000003d876
- (id)checkForAllDeliveries;	// IMP=0x001000000003d754
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x001000000003d716
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x001000000003d6fd
- (_Bool)notifyCKAccountStatusChangeAndWait:(unsigned long long)arg1;	// IMP=0x001000000003d6ae
- (void)recheckCKAccountStatus;	// IMP=0x001000000003d671
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x001000000003d529
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x001000000003d379
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x001000000003cf50
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x001000000003cdc4
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x001000000003cbda
- (id)notifyCircleChange:(id)arg1;	// IMP=0x001000000003cadf
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x001000000003c95a
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x001000000003c81f
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x001000000003c736
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x001000000003c59a
- (void)dealloc;	// IMP=0x001000000003c51f
- (void)performInitialDispatches;	// IMP=0x001000000003c495
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x001000000003bfca
