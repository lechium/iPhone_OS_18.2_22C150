...
- (void).cxx_destruct;	// IMP=0x0020000000044510
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x0010000000044413
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x00100000000441af
