...
- (void).cxx_destruct;	// IMP=0x002000000008e7f4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000008e6cc
- (unsigned long long)hash;	// IMP=0x001000000008e560
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008e451
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000008e36b
- (void)copyTo:(id)arg1;	// IMP=0x001000000008e2c6
- (void)writeTo:(id)arg1;	// IMP=0x001000000008e217
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000008e20a
- (id)dictionaryRepresentation;	// IMP=0x001000000008e09c
- (id)description;	// IMP=0x001000000008dfed
