...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000218c95
- (void).cxx_destruct;	// IMP=0x0020000000218c57
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000002189d8
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000021882f
- (id)description;	// IMP=0x00100000002186b1
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6 walrus:(id)arg7 webAccess:(id)arg8;	// IMP=0x00100000002185ae
