...
- (void).cxx_destruct;	// IMP=0x0020000000186ca2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000186b68
- (unsigned long long)hash;	// IMP=0x0010000000186ad0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001869bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001868d3
- (void)copyTo:(id)arg1;	// IMP=0x001000000018682f
- (void)writeTo:(id)arg1;	// IMP=0x001000000018678f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000186782
- (id)dictionaryRepresentation;	// IMP=0x001000000018664f
- (id)description;	// IMP=0x00100000001865a0
