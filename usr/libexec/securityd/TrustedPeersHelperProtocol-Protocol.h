...
- (void)fetchPCSIdentityByPublicKeyWithSpecificUser:(TPSpecificUser *)arg1 pcsservices:(NSArray *)arg2 reply:(void (^)(NSArray *, NSArray *, NSError *))arg3;
- (void)fetchCurrentItemWithSpecificUser:(TPSpecificUser *)arg1 items:(NSArray *)arg2 reply:(void (^)(NSArray *, NSArray *, NSError *))arg3;
- (void)octagonContainsDistrustedRecoveryKeysWithSpecificUser:(TPSpecificUser *)arg1 reply:(void (^)(_Bool, NSError *))arg2;
...
- (void)resetAccountCDPContentsWithSpecificUser:(TPSpecificUser *)arg1 idmsTargetContext:(NSString *)arg2 idmsCuttlefishPassword:(NSString *)arg3 notifyIdMS:(_Bool)arg4 internalAccount:(_Bool)arg5 demoAccount:(_Bool)arg6 reply:(void (^)(NSError *))arg7;
- (void)getSupportAppInfoWithSpecificUser:(TPSpecificUser *)arg1 reply:(void (^)(NSData *, NSError *))arg2;
- (void)requestHealthCheckWithSpecificUser:(TPSpecificUser *)arg1 requiresEscrowCheck:(_Bool)arg2 repair:(_Bool)arg3 knownFederations:(NSArray *)arg4 flowID:(NSString *)arg5 deviceSessionID:(NSString *)arg6 reply:(void (^)(TrustedPeersHelperHealthCheckResult *, NSError *))arg7;
...
- (void)fetchViableBottlesWithSpecificUser:(TPSpecificUser *)arg1 source:(long long)arg2 flowID:(NSString *)arg3 deviceSessionID:(NSString *)arg4 reply:(void (^)(NSArray *, NSArray *, NSError *))arg5;
...
- (void)joinWithSpecificUser:(TPSpecificUser *)arg1 voucherData:(NSData *)arg2 voucherSig:(NSData *)arg3 ckksKeys:(NSArray *)arg4 tlkShares:(NSArray *)arg5 preapprovedKeys:(NSArray *)arg6 flowID:(NSString *)arg7 deviceSessionID:(NSString *)arg8 canSendMetrics:(_Bool)arg9 reply:(void (^)(NSString *, NSArray *, TPSyncingPolicy *, NSError *))arg10;
- (void)vouchWithRerollWithSpecificUser:(TPSpecificUser *)arg1 oldPeerID:(NSString *)arg2 tlkShares:(NSArray *)arg3 reply:(void (^)(NSData *, NSData *, NSArray *, TrustedPeersHelperTLKRecoveryResult *, NSError *))arg4;
...
- (void)vouchWithSpecificUser:(TPSpecificUser *)arg1 peerID:(NSString *)arg2 permanentInfo:(NSData *)arg3 permanentInfoSig:(NSData *)arg4 stableInfo:(NSData *)arg5 stableInfoSig:(NSData *)arg6 ckksKeys:(NSArray *)arg7 flowID:(NSString *)arg8 deviceSessionID:(NSString *)arg9 canSendMetrics:(_Bool)arg10 reply:(void (^)(NSData *, NSData *, NSError *))arg11;
...
- (void)markTrustedDeviceListFetchFailed:(TPSpecificUser *)arg1 reply:(void (^)(NSError *))arg2;
- (void)setAllowedMachineIDsWithSpecificUser:(TPSpecificUser *)arg1 allowedMachineIDs:(NSSet *)arg2 userInitiatedRemovals:(NSSet *)arg3 evictedRemovals:(NSSet *)arg4 unknownReasonRemovals:(NSSet *)arg5 honorIDMSListChanges:(_Bool)arg6 version:(NSString *)arg7 flowID:(NSString *)arg8 deviceSessionID:(NSString *)arg9 canSendMetrics:(_Bool)arg10 altDSID:(NSString *)arg11 trustedDeviceHash:(NSString *)arg12 deletedDeviceHash:(NSString *)arg13 trustedDevicesUpdateTimestamp:(NSNumber *)arg14 reply:(void (^)(_Bool, NSError *))arg15;
- (void)localResetWithSpecificUser:(TPSpecificUser *)arg1 reply:(void (^)(NSError *))arg2;
- (void)performCKServerUnreadableDataRemovalWithSpecificUser:(TPSpecificUser *)arg1 isGuitarfish:(_Bool)arg2 internalAccount:(_Bool)arg3 demoAccount:(_Bool)arg4 reply:(void (^)(NSError *))arg5;
- (void)resetWithSpecificUser:(TPSpecificUser *)arg1 resetReason:(long long)arg2 idmsTargetContext:(NSString *)arg3 idmsCuttlefishPassword:(NSString *)arg4 notifyIdMS:(_Bool)arg5 internalAccount:(_Bool)arg6 demoAccount:(_Bool)arg7 isGuitarfish:(_Bool)arg8 accountType:(long long)arg9 reply:(void (^)(NSError *))arg10;
...
- (void)trustedDeviceNamesByPeerIDWithSpecificUser:(TPSpecificUser *)arg1 reply:(void (^)(NSDictionary *, NSError *))arg2;
- (void)octagonPeerIDGivenBottleIDWithSpecificUser:(TPSpecificUser *)arg1 bottleID:(NSString *)arg2 reply:(void (^)(NSString *, NSError *))arg3;
- (void)honorIDMSListChangesForSpecificUser:(TPSpecificUser *)arg1 reply:(void (^)(NSString *, NSError *))arg2;
