...
- (void).cxx_destruct;	// IMP=0x00200000000b97bf
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x00100000000b9527
- (void)groupStart;	// IMP=0x00100000000b9131
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x00100000000b908f
