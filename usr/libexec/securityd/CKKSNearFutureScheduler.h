...
- (void).cxx_destruct;	// IMP=0x00200000000b6736
...
- (void)cancel;	// IMP=0x00100000000b64fc
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00100000000b5f47
- (void)trigger;	// IMP=0x00100000000b5e82
- (void)_onqueueTimerTick;	// IMP=0x00100000000b5b3b
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x00100000000b5a6b
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x00100000000b59ef
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00100000000b581e
- (id)makeOperationDependency;	// IMP=0x00100000000b574f
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x00100000000b56c8
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 exponentialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 qosClass:(unsigned int)arg7 block:(CDUnknownBlockType)arg8;	// IMP=0x00100000000b54de
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 exponentialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x00100000000b54bb
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00100000000b5467
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x00100000000b5443
