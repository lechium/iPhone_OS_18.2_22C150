...
- (void).cxx_destruct;	// IMP=0x002000000009ade0
...
- (_Bool)ensureKeyPresent:(id)arg1 viewState:(id)arg2;	// IMP=0x001000000009a7af
- (void)attemptToHealView:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x001000000009a1bf
- (void)groupStart;	// IMP=0x0010000000099d3b
- (id)initWithDependencies:(id)arg1 allowFullRefetchResult:(_Bool)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x0010000000099c22
- (id)init;	// IMP=0x0010000000099c14
