...
- (void).cxx_destruct;	// IMP=0x00200000001a8d76
...
- (id)sfaStatus;	// IMP=0x00100000001a8cd5
- (id)sysdiagnoseStatus;	// IMP=0x00100000001a8ccd
- (_Bool)clearFollowUp:(unsigned char)arg1 activeAccount:(id)arg2 error:(id *)arg3;	// IMP=0x00100000001a89df
- (_Bool)postFollowUp:(unsigned char)arg1 activeAccount:(id)arg2 error:(id *)arg3;	// IMP=0x00100000001a86c8
- (id)createCDPFollowupContext:(unsigned char)arg1;	// IMP=0x00100000001a8687
- (id)initWithFollowupController:(id)arg1;	// IMP=0x00100000001a85f0
- (void)clearAllPostedFlags;	// IMP=0x00100000001a8e05
- (_Bool)hasPosted:(unsigned char)arg1;	// IMP=0x00100000001a8d9e
