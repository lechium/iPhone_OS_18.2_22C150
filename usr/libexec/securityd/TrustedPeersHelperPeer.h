...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000021993f
- (void).cxx_destruct;	// IMP=0x00200000002198f6
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000002196fb
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000002194f4
- (id)description;	// IMP=0x001000000021938b
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 secureElementIdentity:(id)arg4 viewList:(id)arg5;	// IMP=0x0010000000219284
