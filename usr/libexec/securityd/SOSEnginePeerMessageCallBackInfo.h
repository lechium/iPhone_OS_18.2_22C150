...
- (void).cxx_destruct;	// IMP=0x0020000000120f31
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000120d2e
- (void)dealloc;	// IMP=0x0010000000120c38
- (void)setCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000120b8c
- (void)callCallback:(_Bool)arg1;	// IMP=0x0010000000120b42
- (id)initWithEngine:(struct __OpaqueSOSEngine *)arg1 peer:(struct __OpaqueSOSPeer *)arg2 localManifest:(struct __OpaqueSOSManifest *)arg3 proposedManifest:(struct __OpaqueSOSManifest *)arg4 confirmedManifest:(struct __OpaqueSOSManifest *)arg5 andMessage:(struct __OpaqueSOSMessage *)arg6;	// IMP=0x0010000000120a17
