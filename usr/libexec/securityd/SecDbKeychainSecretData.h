...
- (void).cxx_destruct;	// IMP=0x002000000013f22a
...
- (id)initWithData:(id)arg1;	// IMP=0x001000000013ef3e
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x001000000013ed4f
