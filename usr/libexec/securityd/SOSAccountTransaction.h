...
- (void).cxx_destruct;	// IMP=0x002000000024da17
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x001000000024d824
- (void)requestSyncWith:(id)arg1;	// IMP=0x001000000024d751
- (void)finish;	// IMP=0x001000000024bdae
- (void)restart;	// IMP=0x001000000024bd80
- (void)start;	// IMP=0x001000000024b954
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x001000000024b8cc
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x001000000024b65a
- (unsigned long long)currentTrustBitmask;	// IMP=0x001000000024b548
