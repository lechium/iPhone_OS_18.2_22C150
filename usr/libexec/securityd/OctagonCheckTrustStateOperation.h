...
- (void).cxx_destruct;	// IMP=0x00200000001a6133
...
- (void)afterTPHTrustState:(id)arg1 trustedPeers:(id)arg2;	// IMP=0x00100000001a4fb1
- (void)groupStart;	// IMP=0x00100000001a4e06
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x00100000001a4d3c
