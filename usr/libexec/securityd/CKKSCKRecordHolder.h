...
- (void).cxx_destruct;	// IMP=0x00200000000c5f5c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c5e2a
- (_Bool)matchesCKRecord:(id)arg1;	// IMP=0x00100000000c5d4a
- (void)setFromCKRecord:(id)arg1;	// IMP=0x00100000000c5c6a
- (id)updateCKRecord:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000000c5b7d
- (id)CKRecordName;	// IMP=0x00100000000c5aac
- (id)CKRecordWithZoneID:(id)arg1;	// IMP=0x00100000000c5924
...
- (id)initWithCKRecordType:(id)arg1 encodedCKRecord:(id)arg2 contextID:(id)arg3 zoneID:(id)arg4;	// IMP=0x00100000000c5324
- (id)initWithCKRecord:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000c5223
