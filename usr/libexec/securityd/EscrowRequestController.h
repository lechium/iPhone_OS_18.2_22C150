...
- (void).cxx_destruct;	// IMP=0x002000000003b65b
...
- (void)storePrerecordsInEscrowRPC:(CDUnknownBlockType)arg1;	// IMP=0x001000000003b433
- (void)triggerEscrowUpdateRPC:(id)arg1 options:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x001000000003aa10
- (id)_onqueueNextStateMachineTransition:(id)arg1 flags:(id)arg2 pendingFlags:(id)arg3;	// IMP=0x0010000000039faf
- (id)initWithLockStateTracker:(id)arg1;	// IMP=0x0010000000039d6d
