...
- (void).cxx_destruct;	// IMP=0x002000000015d9ba
...
- (_Bool)checkRampStateWithError:(id *)arg1;	// IMP=0x001000000015cad5
- (void)fetchRampRecordWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000015c81e
- (id)initWithRecordName:(id)arg1 localSettingName:(id)arg2 container:(id)arg3 database:(id)arg4 zoneID:(id)arg5 accountTracker:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8 fetchRecordRecordsOperationClass:(Class)arg9;	// IMP=0x001000000015c63d
