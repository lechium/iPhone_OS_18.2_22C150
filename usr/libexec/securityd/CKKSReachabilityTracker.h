...
+ (_Bool)isNetworkFailureError:(id)arg1;	// IMP=0x00000000001429cf
+ (_Bool)isNetworkError:(id)arg1;	// IMP=0x001000000014287a
- (void).cxx_destruct;	// IMP=0x0020000000142485
...
- (_Bool)isNetworkError:(id)arg1;	// IMP=0x00100000001423a9
- (void)setNetworkReachability:(_Bool)arg1;	// IMP=0x001000000014232f
- (void)_onqueueSetNetworkReachability:(_Bool)arg1;	// IMP=0x0010000000142275
- (void)_onQueueResetReachabilityDependency;	// IMP=0x0010000000141f4b
- (void)_onQueueRunReachabilityDependency;	// IMP=0x0010000000141e0d
@property(readonly) _Bool currentReachability;
- (id)description;	// IMP=0x0010000000141cf2
- (id)init;	// IMP=0x0010000000141ac9
