...
@interface OTPreloadOctagonKeysOperation
{
    ...
    MISSING_TYPE *_finishOp;	// 40 = 0x28
}

- (void).cxx_destruct;	// IMP=0x002000000022952d
...
- (void)groupStart;	// IMP=0x0010000000228ed4
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0010000000228e0a
