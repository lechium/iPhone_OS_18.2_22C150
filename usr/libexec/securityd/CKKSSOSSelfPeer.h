...
- (void).cxx_destruct;	// IMP=0x00200000000c124b
...
- (_Bool)shouldHaveView:(id)arg1;	// IMP=0x00100000000c1160
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x00100000000c106d
@property(readonly) NSString *peerID;
@property(readonly) _SFECPublicKey *publicSigningKey;
@property(readonly) _SFECPublicKey *publicEncryptionKey;
- (id)initWithSOSPeerID:(id)arg1 encryptionKey:(id)arg2 signingKey:(id)arg3 viewList:(id)arg4;	// IMP=0x00100000000c0e1b
