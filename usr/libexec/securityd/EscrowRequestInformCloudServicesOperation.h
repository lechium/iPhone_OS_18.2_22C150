...
+ (id)triggerCloudServicesPasscodeRequest:(id)arg1 serializedReason:(id)arg2 error:(id *)arg3;	// IMP=0x002000000022edfc
- (void).cxx_destruct;	// IMP=0x002000000022edba
...
- (void)main;	// IMP=0x001000000022e47c
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 lockStateTracker:(id)arg3;	// IMP=0x001000000022e3b2
