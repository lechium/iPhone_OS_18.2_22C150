...
+ (_Bool)isFullPeer:(id)arg1;	// IMP=0x0040000000205360
- (void).cxx_destruct;	// IMP=0x0020000000205301
...
- (id)initForContainerName:(id)arg1 contextID:(id)arg2 epoch:(unsigned long long)arg3 machineID:(id)arg4 modelID:(id)arg5 deviceName:(id)arg6 serialNumber:(id)arg7 osVersion:(id)arg8;	// IMP=0x001000000020508c
