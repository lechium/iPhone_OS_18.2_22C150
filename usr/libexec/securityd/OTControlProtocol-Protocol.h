...
@class NSArray, NSData, NSError, NSString, NSUUID, OTAccountSettings, OTControlArguments, OTCustodianRecoveryKey, OTInheritanceKey, OTJoiningConfiguration, OTOperationConfiguration;
