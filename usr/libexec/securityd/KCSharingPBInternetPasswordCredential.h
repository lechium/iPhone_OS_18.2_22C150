...
- (void).cxx_destruct;	// IMP=0x00200000001a7f59
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001a79ab
- (unsigned long long)hash;	// IMP=0x00100000001a7588
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a716d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a6db1
- (void)writeTo:(id)arg1;	// IMP=0x00100000001a6af6
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001a6ae9
