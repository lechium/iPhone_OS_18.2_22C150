...
- (void).cxx_destruct;	// IMP=0x0020000000086a5d
...
- (void)proceedAfterFetch;	// IMP=0x0010000000086507
- (void)groupStart;	// IMP=0x001000000008620c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0010000000086142
