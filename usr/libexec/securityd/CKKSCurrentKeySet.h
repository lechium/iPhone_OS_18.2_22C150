...
+ (id)loadForZone:(id)arg1 contextID:(id)arg2;	// IMP=0x00400000000b0ecc
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x00100000000b0ab0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b07c1
- (id)description;	// IMP=0x00100000000b0538
- (id)initWithZoneID:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000b049f
