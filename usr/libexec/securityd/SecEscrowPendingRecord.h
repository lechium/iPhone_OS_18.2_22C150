...
+ (id)loadAllFromKeychain:(id *)arg1;	// IMP=0x0020000000188a68
+ (id)loadFromKeychain:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000188753
- (void).cxx_destruct;	// IMP=0x002000000022aa9c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000022a84d
- (unsigned long long)hash;	// IMP=0x001000000022a6ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000022a4ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000022a30e
- (void)copyTo:(id)arg1;	// IMP=0x001000000022a1b7
- (void)writeTo:(id)arg1;	// IMP=0x001000000022a050
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000229b2e
- (id)dictionaryRepresentation;	// IMP=0x0010000000229841
- (id)description;	// IMP=0x0010000000229792
...
- (_Bool)deleteFromKeychain:(id *)arg1;	// IMP=0x0010000000188495
- (_Bool)saveToKeychain:(id *)arg1;	// IMP=0x0010000000187e96
- (_Bool)escrowAttemptedWithinLastSeconds:(double)arg1;	// IMP=0x0010000000188697
