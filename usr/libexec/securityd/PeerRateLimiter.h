...
- (void).cxx_destruct;	// IMP=0x0020000000289ae1
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x0010000000289941
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x0010000000289840
- (id)setUpConfigForPeer;	// IMP=0x00100000002897c5
