...
+ (void)cdpUploadPrerecord:(id)arg1 secretType:(unsigned long long)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00200000000c71f8
- (void).cxx_destruct;	// IMP=0x00200000000c6ca4
...
- (void)groupStart;	// IMP=0x00100000000c631c
- (_Bool)checkFatalError:(id)arg1;	// IMP=0x00100000000c6189
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 enforceRateLimiting:(_Bool)arg3 lockStateTracker:(id)arg4;	// IMP=0x00100000000c60ae
