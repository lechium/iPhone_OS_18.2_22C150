...
+ (id)globalTracker;	// IMP=0x00400000001ab315
- (void).cxx_destruct;	// IMP=0x00200000001aafb6
...
- (void)addLockStateObserver:(id)arg1;	// IMP=0x00100000001aae06
- (_Bool)isLockedError:(id)arg1;	// IMP=0x00100000001aad79
- (_Bool)checkErrorChainForLockState:(id)arg1;	// IMP=0x00100000001aaca3
- (_Bool)lockedError:(id)arg1;	// IMP=0x00100000001aabd4
- (void)recheck;	// IMP=0x00100000001aab63
- (void)_onqueueRecheck;	// IMP=0x00100000001aa829
- (void)resetUnlockDependency;	// IMP=0x00100000001aa73c
- (id)description;	// IMP=0x00100000001aa697
@property(readonly) NSDate *lastUnlockTime;
@property(readonly) _Bool isLocked;
- (void)dealloc;	// IMP=0x00100000001aa4d0
- (id)initWithProvider:(id)arg1;	// IMP=0x00100000001aa2bf
