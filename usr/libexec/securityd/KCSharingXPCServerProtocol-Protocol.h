...
@class KCSharingGroupCreateRequest, KCSharingGroupDeleteRequest, KCSharingGroupFetchRequest, KCSharingGroupLeaveRequest, KCSharingGroupUpdateRequest, MISSING_TYPE, NSArray, NSString;
...
- (MISSING_TYPE *)fetchCurrentUserIdentifierWithReply: /* Error: Ran out of types for this method. */;
