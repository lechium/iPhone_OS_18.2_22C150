...
+ (Class)clientOperationType;	// IMP=0x002000000019c61e
+ (Class)operationGroupType;	// IMP=0x001000000019c60d
- (void).cxx_destruct;	// IMP=0x002000000019bfb8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000019bb20
- (unsigned long long)hash;	// IMP=0x001000000019b9b3
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000019b75b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019b30f
- (void)copyTo:(id)arg1;	// IMP=0x001000000019b09d
- (void)writeTo:(id)arg1;	// IMP=0x001000000019ad58
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000019ad4b
- (id)dictionaryRepresentation;	// IMP=0x001000000019a6e8
- (id)description;	// IMP=0x001000000019a639
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x001000000019a58c
- (unsigned long long)clientOperationsCount;	// IMP=0x001000000019a56f
- (void)addClientOperation:(id)arg1;	// IMP=0x001000000019a505
- (void)clearClientOperations;	// IMP=0x001000000019a4e8
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x001000000019a433
- (unsigned long long)operationGroupsCount;	// IMP=0x001000000019a416
- (void)addOperationGroup:(id)arg1;	// IMP=0x001000000019a3ac
- (void)clearOperationGroups;	// IMP=0x001000000019a38f
