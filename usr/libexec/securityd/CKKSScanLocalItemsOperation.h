...
@interface CKKSScanLocalItemsOperation
{
    ...
    CKKSOperationDependencies *;	// 32 = 0x20
...
- (void).cxx_destruct;	// IMP=0x00200000000cab10
...
- (_Bool)areEquivalent:(struct SecDbItem *)arg1 ckksItem:(id)arg2 keyCache:(id)arg3;	// IMP=0x00100000000ca454
- (void)main;	// IMP=0x00100000000c8dc5
- (void)retriggerMissingMirrorEntries:(id)arg1 databaseProvider:(id)arg2;	// IMP=0x00100000000c8caf
- (void)fixUUIDlessItemsInZone:(id)arg1 primaryKeys:(id)arg2 databaseProvider:(id)arg3;	// IMP=0x00100000000c8adb
- (void)onboardItemsInView:(id)arg1 uuids:(id)arg2 itemClass:(id)arg3 databaseProvider:(id)arg4;	// IMP=0x00100000000c87c0
- (_Bool)onboardItemToCKKS:(struct SecDbItem *)arg1 viewState:(id)arg2 keyCache:(id)arg3 error:(id *)arg4;	// IMP=0x00100000000c83d7
- (_Bool)executeQuery:(id)arg1 readWrite:(_Bool)arg2 error:(id *)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00100000000c80c4
- (id)queryPredicatesForViewMapping:(id)arg1;	// IMP=0x00100000000c7480
- (id)initWithDependencies:(id)arg1 intending:(id)arg2 errorState:(id)arg3 ckoperationGroup:(id)arg4;	// IMP=0x00100000000c733f
- (id)init;	// IMP=0x00100000000c7331
