...
- (void).cxx_destruct;	// IMP=0x0020000000267524
...
- (id)initWithDefaults:(id)arg1 dateDescription:(id)arg2 earliest:(double)arg3 latest:(double)arg4;	// IMP=0x00100000002673d3
- (void)schedule;	// IMP=0x001000000026738f
- (void)followup;	// IMP=0x0010000000267346
- (_Bool)checkDate;	// IMP=0x00100000002672f1
- (id)getDate;	// IMP=0x00100000002672d4
