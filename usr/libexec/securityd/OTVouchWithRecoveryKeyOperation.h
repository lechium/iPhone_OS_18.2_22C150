...
- (void).cxx_destruct;	// IMP=0x00200000000e892f
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000e861e
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00100000000e84b1
- (void)groupStart;	// IMP=0x00100000000e8084
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00100000000e7f74
