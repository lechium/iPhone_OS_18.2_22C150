...
+ (Class)internalTestConfigType;	// IMP=0x002000000021fc5c
- (void).cxx_destruct;	// IMP=0x002000000021f804
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000021f431
- (unsigned long long)hash;	// IMP=0x001000000021f2fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000021f0d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000021eda8
- (void)copyTo:(id)arg1;	// IMP=0x001000000021ebc4
- (void)writeTo:(id)arg1;	// IMP=0x001000000021e980
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000021e973
- (id)dictionaryRepresentation;	// IMP=0x001000000021e5b3
- (id)description;	// IMP=0x001000000021e504
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x001000000021e4e7
- (unsigned long long)internalTestConfigsCount;	// IMP=0x001000000021e4ca
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x001000000021e460
- (void)clearInternalTestConfigs;	// IMP=0x001000000021e443
