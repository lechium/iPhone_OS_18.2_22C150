...
- (void).cxx_destruct;	// IMP=0x0020000000006c0d
...
- (_Bool)sendFile:(id)arg1 onService:(id)arg2;	// IMP=0x0010000000006a55
- (_Bool)sendProtobufData:(id)arg1 type:(unsigned long long)arg2 service:(id)arg3 fireAndForget:(_Bool)arg4 includeInactiveDevices:(_Bool)arg5;	// IMP=0x001000000000654e
- (id)init;	// IMP=0x00100000000063cf
