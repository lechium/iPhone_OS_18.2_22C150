...
+ (_Bool)askUserIfTTR:(id)arg1;	// IMP=0x004000000000686a
+ (void)triggerTapToRadar:(id)arg1;	// IMP=0x00100000000062a1
+ (void)disableTTRsEntirely;	// IMP=0x001000000000612f
+ (_Bool)isRateLimited:(id)arg1;	// IMP=0x0010000000005ff9
+ (id)keyname:(id)arg1;	// IMP=0x0010000000005f83
- (void).cxx_destruct;	// IMP=0x0020000000006cb4
...
- (void)trigger;	// IMP=0x00100000000069f7
- (void)clearRetryTimestamp;	// IMP=0x0010000000006218
- (void)updateRetryTimestamp;	// IMP=0x001000000000613c
- (_Bool)isRateLimited;	// IMP=0x001000000000601b
- (id)initTapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3;	// IMP=0x0010000000005e35
