...
- (void).cxx_destruct;	// IMP=0x0040000000018f03
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x0010000000018ea0
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x0010000000018e75
- (id)initToMemory;	// IMP=0x0010000000018e4a
- (void)close;	// IMP=0x0010000000018e03
- (void)open;	// IMP=0x0010000000018adc
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x001000000001898a
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x0010000000018496
- (id)init;	// IMP=0x0010000000018232
