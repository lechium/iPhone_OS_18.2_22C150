...
+ (_Bool)isConnectionEntitled:(id)arg1;	// IMP=0x002000000001d74b
+ (id)sharedService;	// IMP=0x001000000001cec2
- (void).cxx_destruct;	// IMP=0x002000000001d7f2
...
- (void)notifyDismissDialogWithIdentifier:(id)arg1;	// IMP=0x001000000001d46d
- (void)removeQRDialogDismissalObserverForIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000001d1c8
- (void)observeQRDialogDismissalNotificationForIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000001cf17
- (id)init;	// IMP=0x001000000001ce22
