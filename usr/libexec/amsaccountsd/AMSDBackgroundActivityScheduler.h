...
- (void).cxx_destruct;	// IMP=0x0020000000005db8
...
- (void)schedule;	// IMP=0x0010000000005354
- (void)invalidate;	// IMP=0x00100000000052db
- (void)checkIn;	// IMP=0x00100000000050d7
- (id)initWithIdentifier:(id)arg1;	// IMP=0x001000000000501d
