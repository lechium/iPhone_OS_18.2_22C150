...
- (void).cxx_destruct;	// IMP=0x0020000000048c4d
...
- (id)_stringForRefreshType:(unsigned long long)arg1;	// IMP=0x0010000000048bb1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000048a87
@property(readonly, nonatomic) NSString *hashedDescription;
- (id)initWithReason:(id)arg1;	// IMP=0x001000000004882c
