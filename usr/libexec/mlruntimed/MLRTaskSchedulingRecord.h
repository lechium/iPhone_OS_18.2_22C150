...
- (void).cxx_destruct;	// IMP=0x0020000000008a79
...
- (id);	// IMP=0x0010000000008a40
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x0010000000008a04
- (id)description;	// IMP=0x0010000000008986
- (id)initWithTaskID:(id)arg1;	// IMP=0x0010000000008884
