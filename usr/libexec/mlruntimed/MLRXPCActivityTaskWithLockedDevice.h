...
- (void).cxx_destruct;	// IMP=0x0020000000002b89
...
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002984
- (id)createTaskScheduler;	// IMP=0x0010000000002954
- (id)criteria;	// IMP=0x00100000000027ff
