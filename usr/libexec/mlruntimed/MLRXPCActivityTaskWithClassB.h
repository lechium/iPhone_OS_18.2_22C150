...
- (void).cxx_destruct;	// IMP=0x0020000000002f54
...
- (void)stop;	// IMP=0x0010000000002eea
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002da8
- (id)createTaskScheduler;	// IMP=0x0010000000002d78
- (id)criteria;	// IMP=0x0010000000002c83
