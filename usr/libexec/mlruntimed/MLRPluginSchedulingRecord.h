...
- (void).cxx_destruct;	// IMP=0x0020000000006be2
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x0010000000006a75
- (id)description;	// IMP=0x00100000000069f7
- (id)initWithPluginID:(id)arg1;	// IMP=0x0010000000006890
