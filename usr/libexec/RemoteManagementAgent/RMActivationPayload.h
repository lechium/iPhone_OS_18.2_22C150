...
- (id)reportDetails;	// IMP=0x002000000000a906
@property(retain, nonatomic) RMPredicateDescription *predicateDescription;
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000b8ef
- (_Bool)_updatePropertiesForActivation:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000b248
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000b0aa
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x001000000000aeda
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000abdb
