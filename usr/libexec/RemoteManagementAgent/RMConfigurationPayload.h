...
+ (_Bool)isSignificantChange:(id)arg1;	// IMP=0x0040000000025c37
- (id)reportDetails;	// IMP=0x0020000000025cb4
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x0010000000026830
- (_Bool)_updatePropertiesForConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000264e7
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000026349
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x0010000000026179
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000025e8b
