...
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x0020000000058d65
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000058bc7
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x0010000000058a19
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000058730
