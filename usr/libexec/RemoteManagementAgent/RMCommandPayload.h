...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x00200000000242dd
- (id)reportDetails;	// IMP=0x0020000000024b34
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x00100000000245b9
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x001000000002434d
