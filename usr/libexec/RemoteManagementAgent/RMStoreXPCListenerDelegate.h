...
- (void).cxx_destruct;	// IMP=0x002000000009ea47
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000009e82b
- (id)initWithPersistentContainer:(id)arg1 allowedToRun:(_Bool)arg2;	// IMP=0x001000000009e7b5
