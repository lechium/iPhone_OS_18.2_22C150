...
- (id)reportDetails;	// IMP=0x002000000000c02b
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000c739
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000c59b
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x001000000000c3ed
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000c104
