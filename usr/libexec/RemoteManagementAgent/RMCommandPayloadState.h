...
- (void)markPending;	// IMP=0x002000000002537f
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x0010000000025036
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x0010000000024cc8
- (void)markQueued;	// IMP=0x0010000000024c65
