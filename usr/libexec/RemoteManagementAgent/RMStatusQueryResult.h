...
- (void).cxx_destruct;	// IMP=0x0020000000080a7f
...
- (id)initWithStatusKeyPaths:(id)arg1 statusByKeyPath:(id)arg2 errorByKeyPath:(id)arg3;	// IMP=0x001000000007fe01
- (id)init;	// IMP=0x001000000007fd9d
- (id)protocolStatusReportWithFullReport:(_Bool)arg1;	// IMP=0x0010000000080e57
