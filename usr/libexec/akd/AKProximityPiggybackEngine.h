...
- (void).cxx_destruct;	// IMP=0x002000000007d4b7
...
- (void)invalidate;	// IMP=0x001000000007d439
- (void)activate;	// IMP=0x001000000007d3ed
- (void)prepareWithController:(id)arg1 queue:(id)arg2;	// IMP=0x001000000007d3ad
- (void)dealloc;	// IMP=0x001000000007d334
- (id)initWithPresenceSID:(id)arg1;	// IMP=0x001000000007d2c9
