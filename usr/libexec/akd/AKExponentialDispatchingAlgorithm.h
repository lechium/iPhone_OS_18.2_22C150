...
- (void)_decrementQueueSize;	// IMP=0x0010000000024718
- (_Bool)_incrementQueueSize;	// IMP=0x00100000000246f7
- (void)_incrementCounter;	// IMP=0x00100000000246e0
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

@property(readonly, copy) NSString *description;
- (id)nextCalculation;	// IMP=0x00100000000244aa
- (id)initWithBase:(double)arg1 maxQueueSize:(unsigned long long)arg2;	// IMP=0x001000000002445e
