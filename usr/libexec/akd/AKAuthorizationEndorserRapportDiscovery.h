...
- (void).cxx_destruct;	// IMP=0x0020000000068b69
...
- (void)_handleFoundDevice:(id)arg1;	// IMP=0x00100000000689c1
- (void)authorizationEndorserRapportClientDidFinish:(id)arg1;	// IMP=0x00100000000689af
- (void)deactivate;	// IMP=0x0010000000068921
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x00100000000688a9
- (id)initWithClient:(id)arg1;	// IMP=0x001000000006883e
