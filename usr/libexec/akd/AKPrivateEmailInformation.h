...
- (void).cxx_destruct;	// IMP=0x002000000007eb2c
...
- (id)description;	// IMP=0x001000000007eaa8
- (void)_processDictionary:(id)arg1 addedPrivateEmails:(id *)arg2 removedPrivateEmails:(id *)arg3;	// IMP=0x001000000007e89c
- (id)initWithResponseBody:(id)arg1;	// IMP=0x001000000007e41e
