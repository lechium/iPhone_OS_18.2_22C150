...
- (void).cxx_destruct;	// IMP=0x00200000000df788
...
- (_Bool)eligibleForContinuationKeyAuthentication;	// IMP=0x00100000000df587
@property(readonly, nonatomic) NSString *passwordResetToken;
- (id)continuationToken:(id *)arg1;	// IMP=0x00100000000dec52
- (id)authKitAccount:(id *)arg1;	// IMP=0x00100000000deab7
- (void)_clearDeviceListCacheForAltDSID:(id)arg1;	// IMP=0x00100000000de882
- (void)clearContinuationTokenIfSupportedWithError:(id)arg1;	// IMP=0x00100000000de5be
- (void)_addExperimentalFeaturesInfoToClientProvidedData:(id)arg1;	// IMP=0x00100000000de42e
- (id)_anisetteHeadersFromAttestationData:(id)arg1;	// IMP=0x00100000000de1b5
- (void)authenticationParametersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000dc472
- (_Bool)isContextSecretValidForSRP:(id *)arg1;	// IMP=0x00100000000dc2e4
- (id)initWithContext:(id)arg1;	// IMP=0x00100000000dc279
