...
- (void).cxx_destruct;	// IMP=0x00200000000304b3
...
- (id)description;	// IMP=0x001000000003042c
- (id)compile;	// IMP=0x00100000000302e4
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000030109
- (id)initWithApprove:(id)arg1 body:(id)arg2 decline:(id)arg3 title:(id)arg4;	// IMP=0x001000000002ff7e
