...
- (void).cxx_destruct;	// IMP=0x0020000000009476
...
- (id)description;	// IMP=0x00100000000091bf
- (id)compile;	// IMP=0x0010000000008b47
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000076d1
- (id)initWithItemIdentifier:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 date:(id)arg4;	// IMP=0x00100000000075e9
- (id)initWithRequest:(id)arg1 date:(id)arg2;	// IMP=0x001000000000723f
