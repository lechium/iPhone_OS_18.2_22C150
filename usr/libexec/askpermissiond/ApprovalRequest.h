...
+ (long long)lobForProductType:(id)arg1;	// IMP=0x002000000002bff3
+ (long long)lobForSubscription:(id)arg1;	// IMP=0x001000000002bef5
+ (id)createUniqueIDFromRequestID:(id)arg1 andCreatedDate:(id)arg2;	// IMP=0x001000000002bac9
...
- (id)productType;	// IMP=0x001000000002c992
...
- (id)compile;	// IMP=0x001000000002c15e
- (long long)lineOfBusiness;	// IMP=0x001000000002be70
- (id)metricsTopic;	// IMP=0x001000000002bd84
- (id)metricsApp;	// IMP=0x001000000002bca6
- (_Bool)isSubscription;	// IMP=0x001000000002bc5b
- (void)updateStatus:(long long)arg1 withApproverDSID:(id)arg2;	// IMP=0x001000000002bc46
- (id)initWithCloudPushDictionary:(id)arg1 bag:(id)arg2;	// IMP=0x0010000000029888
- (id)initWithCloudPushDictionary:(id)arg1;	// IMP=0x0010000000029807
- (id)initWithRequestStorageItem:(id)arg1;	// IMP=0x0010000000029485
- (id)initWithApproverStorageItem:(id)arg1;	// IMP=0x001000000002914f
- (id)initWithApproverDSID:(id)arg1 createdDate:(id)arg2 modifiedDate:(id)arg3 requestIdentifier:(id)arg4 uniqueIdentifier:(id)arg5 canSendViaMessages:(_Bool)arg6 itemBundleID:(id)arg7 itemDescription:(id)arg8 itemIdentifier:(id)arg9 itemTitle:(id)arg10 localizations:(id)arg11 offerName:(id)arg12 mocked:(_Bool)arg13 previewURL:(id)arg14 productType:(id)arg15 productTypeName:(id)arg16 productURL:(id)arg17 requesterName:(id)arg18 requesterDSID:(id)arg19 requestInfo:(id)arg20 requestString:(id)arg21 requestSummary:(id)arg22 priceSummary:(id)arg23 status:(long long)arg24;	// IMP=0x0010000000028da1
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000027967
