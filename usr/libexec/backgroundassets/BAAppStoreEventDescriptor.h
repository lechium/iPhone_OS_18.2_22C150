...
+ (id)descriptorWithAppBundleIdentifier:(id)arg1 appBundleURL:(id)arg2 event:(unsigned long long)arg3 client:(unsigned long long)arg4;	// IMP=0x0020000000012d22
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000012c58
+ (id)new;	// IMP=0x0010000000012c50
- (void).cxx_destruct;	// IMP=0x0020000000013067
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000012edd
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000012da1
- (id)init;	// IMP=0x0010000000012c42
