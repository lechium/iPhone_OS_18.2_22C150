...
- (void).cxx_destruct;	// IMP=0x00200000000328be
...
- (id)_newOperationQuery;	// IMP=0x0010000000032488
- (void)_downloadActualAsset;	// IMP=0x0010000000031b22
- (_Bool)_consumeAvailableDownloadSize;	// IMP=0x00100000000318a5
- (void)_downloadSucceededWithURL:(id)arg1;	// IMP=0x0010000000031719
- (void)_downloadFailedWithError:(id)arg1;	// IMP=0x001000000003158e
- (void)cancelDownload;	// IMP=0x0010000000031551
- (void)pauseDownload;	// IMP=0x0010000000031429
- (_Bool)startDownloadWithError:(id *)arg1;	// IMP=0x0010000000030808
- (id)initWithDownload:(id)arg1 withDelegate:(id)arg2;	// IMP=0x00100000000306db
