...
- (void).cxx_destruct;	// IMP=0x00200000000220a0
- (void)drawInContext:(struct CGContext *)arg1 atPoint:(struct CGPoint)arg2;	// IMP=0x0010000000022001
@property(readonly, nonatomic) struct CGSize drawingSize;
- (void)dealloc;	// IMP=0x0010000000021f9a
- (id)initWithStyle:(id)arg1 tag:(id)arg2;	// IMP=0x00100000000218a2
