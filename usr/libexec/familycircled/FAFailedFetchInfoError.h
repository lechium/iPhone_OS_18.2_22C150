...
+ (id)errorWithCachedFamilyCircle:(id)arg1 underlyingError:(id)arg2;	// IMP=0x004000000000bee6
- (void).cxx_destruct;	// IMP=0x002000000000c175
...
- (id)initWithCachedFamilyCircle:(id)arg1 underlyingError:(id)arg2;	// IMP=0x001000000000c04e
