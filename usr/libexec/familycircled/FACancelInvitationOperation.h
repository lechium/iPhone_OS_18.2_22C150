...
- (void).cxx_destruct;	// IMP=0x0020000000012edb
...
- (id)cancelInvitation;	// IMP=0x0010000000012c8b
- (id)initWithNetworkService:(id)arg1 email:(id)arg2 familyID:(id)arg3;	// IMP=0x0010000000012be3
