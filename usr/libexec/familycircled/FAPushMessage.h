...
- (void).cxx_destruct;	// IMP=0x002000000000e033
...
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000000dd70
- (id)initWithMessage:(id)arg1 accountStore:(id)arg2;	// IMP=0x001000000000dbb1
