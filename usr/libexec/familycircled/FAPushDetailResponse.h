...
- (void).cxx_destruct;	// IMP=0x002000000001f9b2
@property(copy, nonatomic) NSString *pushTopic; // @synthesize pushTopic=_pushTopic;
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001f922
- (_Bool)_booleanValueOfObject:(id)arg1;	// IMP=0x001000000001f8b0
- (id)description;	// IMP=0x001000000001f81b
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x001000000001f315
