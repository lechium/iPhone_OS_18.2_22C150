...
- (void).cxx_destruct;	// IMP=0x002000000001cf7c
...
- (void)_deliverNotificationWithResponse:(id)arg1 payload:(id)arg2;	// IMP=0x001000000001ce31
- (void)process:(id)arg1;	// IMP=0x001000000001c615
- (_Bool)shouldProcess:(id)arg1;	// IMP=0x001000000001c5c0
- (id)init;	// IMP=0x001000000001c4d9
