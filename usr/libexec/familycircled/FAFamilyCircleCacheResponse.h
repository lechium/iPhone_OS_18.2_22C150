...
- (void).cxx_destruct;	// IMP=0x0020000000019d1f
...
- (_Bool)_isFamilyCircleFresh:(id)arg1;	// IMP=0x0010000000019c44
@property(readonly, nonatomic) NSDate *expiration;
- (_Bool)isFamilyCircleFresh;	// IMP=0x0010000000019b83
- (id)familyCircleValidatingAgeWithDate:(id)arg1;	// IMP=0x0010000000019b3f
- (id)familyCircleIfFresh;	// IMP=0x0010000000019ad9
- (id)initWithFamilyCircle:(id)arg1 serverTag:(id)arg2 cacheDate:(id)arg3 maxAge:(double)arg4;	// IMP=0x0010000000019a0f
