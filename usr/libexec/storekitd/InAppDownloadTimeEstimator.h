...
- (void)_updateStatisticsFromSnapshots;	// IMP=0x00100000000053c6
- (void)setCurrentValue:(unsigned long long)arg1;	// IMP=0x00100000000051de
@property(readonly, nonatomic) double estimatedTimeRemaining;
- (id)initWithMaxValue:(unsigned long long)arg1;	// IMP=0x0010000000005073
