...
- (void).cxx_destruct;	// IMP=0x0020000000006e00
...
- (void)main;	// IMP=0x0010000000005ce3
- (id)initWithLocalRevision:(id)arg1 reason:(long long)arg2 includeFinishedConsumables:(_Bool)arg3 client:(id)arg4;	// IMP=0x0010000000005be3
