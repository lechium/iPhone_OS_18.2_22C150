...
+ (id)_titleForProtectionSpace:(id)arg1;	// IMP=0x0040000000038e66
+ (id)_messageForProtectionSpace:(id)arg1;	// IMP=0x0010000000038c26
- (void).cxx_destruct;	// IMP=0x0020000000038edb
...
- (id)initWithAuthenticationChallenge:(id)arg1;	// IMP=0x0010000000038aea
