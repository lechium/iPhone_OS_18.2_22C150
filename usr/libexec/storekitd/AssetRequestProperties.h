...
- (void).cxx_destruct;	// IMP=0x0020000000079e74
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007997a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000079968
- (id)init;	// IMP=0x00100000000798f5
