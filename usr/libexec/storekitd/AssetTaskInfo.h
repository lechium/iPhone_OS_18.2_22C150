...
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x0040000000096c70
+ (void)removeTaskInfo:(id)arg1;	// IMP=0x0010000000096bec
+ (void)removeAllTaskInfo;	// IMP=0x0010000000096bb1
+ (void)recordTaskInfo:(id)arg1 forTask:(id)arg2;	// IMP=0x0010000000096a43
+ (void)exchangeTaskForTaskInfo:(id)arg1 withTask:(id)arg2;	// IMP=0x0010000000096a31
+ (id)newTaskInfoForTask:(id)arg1;	// IMP=0x0010000000096932
- (void).cxx_destruct;	// IMP=0x0020000000096ee3
...
- (id)initWithTask:(id)arg1;	// IMP=0x001000000009699d
