...
- (void).cxx_destruct;	// IMP=0x00200000000963a0
...
- (id)_bomInstallFromPath:(id)arg1 withError:(id *)arg2;	// IMP=0x0010000000095c5b
- (void)_bomInstall;	// IMP=0x0010000000095606
- (void)_updateDownloadStatus:(id)arg1;	// IMP=0x001000000009557f
- (void)_sendDownloadStatus;	// IMP=0x00100000000954be
- (void)_install;	// IMP=0x00100000000954ac
- (void)_finalizeTaskWithError:(id)arg1;	// IMP=0x00100000000950f6
- (void)_downloadedBytes:(long long)arg1 expectedBytes:(long long)arg2;	// IMP=0x0010000000094fef
- (void)pause;	// IMP=0x0010000000094e7e
- (void)cancel;	// IMP=0x0010000000094c8b
- (void)main;	// IMP=0x0010000000093c04
- (id)initWithDownloadID:(id)arg1 info:(id)arg2 bundleID:(id)arg3 containerID:(id)arg4;	// IMP=0x0010000000093a91
