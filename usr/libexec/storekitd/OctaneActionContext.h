...
+ (id)contextWithBundleID:(id)arg1 transactionID:(unsigned long long)arg2;	// IMP=0x004000000006c6d1
+ (id)contextWithBundleID:(id)arg1;	// IMP=0x001000000006c66d
- (void).cxx_destruct;	// IMP=0x002000000006c721
...
- (id)init;	// IMP=0x001000000006c5cb
