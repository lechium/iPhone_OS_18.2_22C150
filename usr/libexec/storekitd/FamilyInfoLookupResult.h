...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x00400000000972e3
- (void).cxx_destruct;	// IMP=0x0020000000097aa4
...
- (id)description;	// IMP=0x0010000000097261
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x0010000000096f85
