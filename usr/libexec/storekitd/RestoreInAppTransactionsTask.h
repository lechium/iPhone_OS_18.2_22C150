...
- (void).cxx_destruct;	// IMP=0x0020000000057ef7
...
- (id)_authenticateAccount:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000577c8
- (id)_runRequestWithError:(id *)arg1;	// IMP=0x0010000000057486
- (void)main;	// IMP=0x0010000000056f5d
- (id)initWithClient:(id)arg1;	// IMP=0x0010000000056ebe
