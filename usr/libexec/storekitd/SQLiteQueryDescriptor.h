...
- (void).cxx_destruct;	// IMP=0x0020000000073d35
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00100000000735ef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000734fd
- (id)initWithEntityClass:(Class)arg1 memoryEntityClass:(Class)arg2;	// IMP=0x00100000000734b5
- (id)initWithEntityClass:(Class)arg1;	// IMP=0x00100000000734a1
