...
+ (id)inMemoryDatabaseSharedCacheFlag;	// IMP=0x00200000000797a4
+ (id)inMemoryDatabaseFlag;	// IMP=0x0010000000079797
- (void).cxx_destruct;	// IMP=0x00200000000798c2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000797b1
- (_Bool)isInMemoryDatabase;	// IMP=0x001000000007973e
- (void)setCacheSizeWithNumberOfKilobytes:(long long)arg1;	// IMP=0x0010000000079729
- (void)setCacheSizeWithNumberOfDatabasePages:(long long)arg1;	// IMP=0x0010000000079717
- (id)initInMemoryDatabaseWithName:(id)arg1;	// IMP=0x0010000000079639
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x00100000000795ac
