...
- (void).cxx_destruct;	// IMP=0x002000000000deec
...
- (id)description;	// IMP=0x001000000000dd49
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000db69
- (unsigned long long)hash;	// IMP=0x001000000000daa1
- (id)plistRepresentation;	// IMP=0x001000000000d840
...
- (id)initWithPlistRepresentation:(id)arg1;	// IMP=0x001000000000d5f5
- (id)initWithSyncSessionState:(unsigned long long)arg1 syncSessionType:(unsigned long long)arg2 migrationSync:(_Bool)arg3 activities:(id)arg4 completedActivities:(id)arg5;	// IMP=0x001000000000d534
