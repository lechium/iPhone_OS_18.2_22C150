...
- (void).cxx_destruct;	// IMP=0x002000000001a716
...
- (id)description;	// IMP=0x001000000001a5c9
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001a426
- (unsigned long long)hash;	// IMP=0x001000000001a3b1
- (id)plistRepresentation;	// IMP=0x001000000001a21c
- (id)initWithPlistRepresentation:(id)arg1;	// IMP=0x001000000001a0e3
- (id)initWithActivityLabel:(id)arg1 globalProgress:(long long)arg2 syncProgressState:(unsigned long long)arg3;	// IMP=0x001000000001a05a
