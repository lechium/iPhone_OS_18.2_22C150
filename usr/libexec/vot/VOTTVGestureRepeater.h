...
- (void).cxx_destruct;	// IMP=0x002000000006b798
...
- (long long)_repeatStateForEvent:(id)arg1;	// IMP=0x001000000006b68e
- (long long)_currentGestureRepeaterEvent;	// IMP=0x001000000006b669
- (double)_delayForCurrentRepeatCount;	// IMP=0x001000000006b65b
- (void)_handleRepeaterTimerDidFire:(id)arg1;	// IMP=0x001000000006b57b
- (void)updateWithEvent:(id)arg1;	// IMP=0x001000000006b336
- (void)dealloc;	// IMP=0x001000000006b233
- (id)initWithThread:(id)arg1;	// IMP=0x001000000006afe6
