...
+ (id)brailleEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x004000000001724f
+ (id)appleTVRemoteEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x00100000000171b1
+ (id)systemServerEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000017113
+ (id)internalEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000017075
+ (id)touchEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000016fd7
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2;	// IMP=0x0010000000016fbb
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2 otherInfo:(id)arg3;	// IMP=0x0010000000016eed
+ (id)externalDeviceEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000016e4f
...
- (id)description;	// IMP=0x0010000000017466
@property(nonatomic) _Bool bypassHelp; // @dynamic bypassHelp;
- (id)objectForIndex:(unsigned long long)arg1;	// IMP=0x001000000001743e
- (void)setObject:(id)arg1 forIndex:(unsigned long long)arg2;	// IMP=0x00100000000173c5
- (void)setInfo:(id)arg1;	// IMP=0x001000000001737a
@property(retain, nonatomic) VOTKeyInfo *keyInfo; // @dynamic keyInfo;
- (_Bool)isAppleTVRemoteEvent;	// IMP=0x001000000001733e
- (_Bool)isSystemServerEvent;	// IMP=0x0010000000017330
- (_Bool)isBrailleEvent;	// IMP=0x0010000000017322
- (_Bool)isExternalDeviceEvent;	// IMP=0x0010000000017314
- (_Bool)isTouchEvent;	// IMP=0x0010000000017306
- (_Bool)isKeyEvent;	// IMP=0x00100000000172f8
- (double)time;	// IMP=0x00100000000172ed
- (id)initWithType:(long long)arg1;	// IMP=0x0010000000016dfd
