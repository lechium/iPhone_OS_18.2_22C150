...
+ (id)context:(long long)arg1;	// IMP=0x004000000001344e
- (void).cxx_destruct;	// IMP=0x00200000000136d4
...
- (id)description;	// IMP=0x00100000000134c1
- (id)init;	// IMP=0x0010000000013486
