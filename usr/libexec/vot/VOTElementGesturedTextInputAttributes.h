...
- (void).cxx_destruct;	// IMP=0x002000000006afd6
...
- (void);	// IMP=0x001000000006af31
@property(nonatomic) unsigned long long preferredCharacterSet; // @synthesize preferredCharacterSet=_preferredCharacterSet;
- (id)description;	// IMP=0x001000000006ad17
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x001000000006acf9
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x001000000006ac37
- (id)initWithAttributes:(id)arg1;	// IMP=0x001000000006a8fa
