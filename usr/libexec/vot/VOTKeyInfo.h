...
- (void).cxx_destruct;	// IMP=0x00200000001270f4
...
- (id)description;	// IMP=0x0010000000126e87
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000126900
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x001000000012679d
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x0010000000127127
