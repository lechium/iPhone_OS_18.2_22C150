...
+ (id)fetchFoundData:(id)arg1 forceUpdate:(_Bool)arg2 direction:(long long)arg3 generation:(unsigned long long)arg4 range:(struct _NSRange)arg5 searchType:(long long)arg6;	// IMP=0x004000000012a7bb
- (void).cxx_destruct;	// IMP=0x002000000012aa1a
...
- (id)description;	// IMP=0x001000000012a889
