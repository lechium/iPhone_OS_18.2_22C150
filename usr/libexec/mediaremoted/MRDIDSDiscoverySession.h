...
- (void).cxx_destruct;	// IMP=0x002000000005812e
...
- (void)_onWorkerQueue_scheduleReload;	// IMP=0x001000000005801e
- (void)_onWorkerQueue_reload;	// IMP=0x0010000000057f6f
- (void)service:(id)arg1 connectedDevicesChanged:(id)arg2;	// IMP=0x0010000000057f5d
- (void)service:(id)arg1 devicesChanged:(id)arg2;	// IMP=0x0010000000057f4b
- (id)availableOutputDevices;	// IMP=0x0010000000057f39
- (unsigned int)discoveryMode;	// IMP=0x0010000000057efd
- (void)setDiscoveryMode:(unsigned int)arg1;	// IMP=0x0010000000057dc9
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

- (id)init;	// IMP=0x0010000000057b15
