...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x0040000000026628
- (void).cxx_destruct;	// IMP=0x0020000000026722
...
- (void)setIsMuted:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00100000000266f5
- (void)adjustVolume:(long long)arg1 error:(id *)arg2;	// IMP=0x00100000000266ef
- (void)adjustVolumeWithStepAmount:(float)arg1 error:(id *)arg2;	// IMP=0x00100000000266e9
- (void)setVolume:(float)arg1 error:(id *)arg2;	// IMP=0x00100000000266e3
- (id)initWithRoutingDataSource:(id)arg1;	// IMP=0x0010000000026678
