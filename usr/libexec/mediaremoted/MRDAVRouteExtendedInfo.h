...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x004000000007bca6
- (void).cxx_destruct;	// IMP=0x002000000007be6b
...
- (id)_extendedInfo;	// IMP=0x001000000007be20
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x001000000007bcf7
