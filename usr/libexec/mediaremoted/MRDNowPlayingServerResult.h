...
@class MISSING_TYPE, MRDMediaRemoteClient, MRDNowPlayingClient, MRDNowPlayingOriginClient, MRDNowPlayingPlayerClient, MRPlayerPath;
...
@interface MRDNowPlayingServerResult : NSObject
{
    ...
    MISSING_TYPE *_unresolvedPlayerPath;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x0020000000115b23
...
- (id)description;	// IMP=0x0010000000115a08
@property(readonly, nonatomic) _Bool isActivity;
@property(readonly, nonatomic) _Bool isLocalOrigin;
- (id)initWithUnresolvedPlayerPath:(id)arg1;	// IMP=0x0010000000115807
