...
- (void).cxx_destruct;	// IMP=0x00200000000824cd
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000081d30
- (id)description;	// IMP=0x0010000000081c1b
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000081a2e
