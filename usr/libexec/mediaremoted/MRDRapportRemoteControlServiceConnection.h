...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000051e8d
- (void).cxx_destruct;	// IMP=0x0020000000052251
...
- (void)dealloc;	// IMP=0x00100000000520de
- (id)description;	// IMP=0x0010000000052096
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000051f2a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000051e95
