...
- (void).cxx_destruct;	// IMP=0x0000000000074fd3
...
- (void)collectDiagnostic:(id)arg1;	// IMP=0x0010000000074e23
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000074d26
- (void)hostedDiscoverySessionDidInvalidate:(id)arg1;	// IMP=0x0010000000074c7a
- (id)endpointForDeviceUID:(id)arg1;	// IMP=0x00100000000749f5
- (id)endpointForOrigin:(id)arg1;	// IMP=0x00100000000745af
@property(readonly, nonatomic) NSXPCListenerEndpoint *xpcEndpoint;
- (id)init;	// IMP=0x001000000007448c
