...
- (void).cxx_destruct;	// IMP=0x00200000001634ac
...
- (void)notifyDelegateOfWake;	// IMP=0x00100000001633e5
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000016334a
- (id)init;	// IMP=0x0010000000163085
