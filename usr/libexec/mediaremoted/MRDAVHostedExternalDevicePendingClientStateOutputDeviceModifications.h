...
- (void).cxx_destruct;	// IMP=0x002000000004624e
...
- (void)removeOutputDevice:(id)arg1;	// IMP=0x001000000004614c
- (void)changeOutputDevice:(id)arg1;	// IMP=0x00100000000460b6
- (void)addOutputDevice:(id)arg1;	// IMP=0x001000000004602f
- (id)description;	// IMP=0x0010000000045f02
