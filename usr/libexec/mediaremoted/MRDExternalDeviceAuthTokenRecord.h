...
- (void).cxx_destruct;	// IMP=0x00200000001a0058
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x001000000019ffa9
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019ff76
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019ff4a
