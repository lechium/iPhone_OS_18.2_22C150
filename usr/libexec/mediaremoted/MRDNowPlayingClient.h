...
@class MRClient, MRDNowPlayingPlayerClient, MRPlayerPath, NSArray, NSDate, NSMutableArray;
...
- (void).cxx_destruct;	// IMP=0x002000000011aa63
...
- (void)handleCanBeNowPlayingPlayerDidChange:(id)arg1;	// IMP=0x001000000011a82c
- (void)_onQueue_popState;	// IMP=0x0010000000119d0a
- (void)_onQueue_pushState;	// IMP=0x0010000000119c5f
- (id)notificationPlayerPathFromPlayer:(id)arg1;	// IMP=0x0010000000119bd7
@property(readonly, nonatomic) _Bool hasNowPlayingData;
- (void)_onQueue_removePlayerClientForPlayer:(id)arg1;	// IMP=0x0010000000119925
- (void)removePlayerClientForPlayer:(id)arg1;	// IMP=0x001000000011987a
- (id)_onQueue_existingPlayerClientForPlayer:(id)arg1;	// IMP=0x00100000001196a5
- (id)existingPlayerClientForPlayer:(id)arg1;	// IMP=0x0010000000119551
- (id)existingPlayerClientForPlayerPath:(id)arg1;	// IMP=0x00100000001194ef
- (id)_onQueue_addPlayer:(id)arg1;	// IMP=0x00100000001192fd
- (id)_onQueue_playerClientForPlayer:(id)arg1;	// IMP=0x00100000001191b6
- (id)playerClientForPlayer:(id)arg1;	// IMP=0x0010000000119062
- (_Bool)canBeNowPlayingForPlayerClient:(id)arg1;	// IMP=0x0010000000118f5c
- (_Bool)_onQueue_anyPlayerIsPlaying;	// IMP=0x0010000000118e15
@property(readonly, nonatomic) _Bool anyPlayerIsPlaying;
@property(nonatomic) _Bool canBeNowPlaying;
- (void)_reevaluateCanBeNowPlaying;	// IMP=0x0010000000118755
- (id)_onQueue_activePlayerClient;	// IMP=0x0010000000118734
@property(retain, nonatomic) MRDNowPlayingPlayerClient *activePlayerClient;
- (void)_onQueue_setActivePlayerClient:(id)arg1;	// IMP=0x0010000000118406
@property(retain, nonatomic) MRClient *client;
- (void)updateClient:(id)arg1;	// IMP=0x001000000011811b
...
- (void)initializeDisplayName;	// IMP=0x0010000000117d21
- (void)_onQueue_initializeDisplayName;	// IMP=0x0010000000117b43
- (void)initializeBundleIdentifier;	// IMP=0x00100000001178b7
@property(readonly, nonatomic) NSArray *playerClients;
- (id)debugDescription;	// IMP=0x00100000001172d4
- (id)description;	// IMP=0x0010000000117257
- (void)dealloc;	// IMP=0x0010000000117228
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0010000000116e17
