...
- (void).cxx_destruct;	// IMP=0x002000000014bd18
...
- (void)_onCalloutQueue_notifyStatusDidChange:(unsigned long long)arg1;	// IMP=0x001000000014b7b9
- (void)_checkConnectionStatus;	// IMP=0x001000000014b2da
- (_Bool)_canSendMessage;	// IMP=0x001000000014b1f4
- (void)canSendMessage:(CDUnknownBlockType)arg1;	// IMP=0x001000000014b137
@property(readonly, nonatomic) NSString *label;
- (id)debugDescription;	// IMP=0x001000000014ae66
- (id)description;	// IMP=0x001000000014addb
- (id)_initWithLabel:(id)arg1;	// IMP=0x001000000014ad2a
- (id)initWithXPCConnection:(id)arg1 label:(id)arg2;	// IMP=0x001000000014ac6f
- (id)initWithConnection:(id)arg1 label:(id)arg2;	// IMP=0x001000000014aba3
