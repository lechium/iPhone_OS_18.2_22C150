...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x004000000018c169
- (void).cxx_destruct;	// IMP=0x002000000018c32b
...
- (unsigned long long)sampleRate;	// IMP=0x001000000018c2b9
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x001000000018c24b
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000018c1b9
