...
- (void).cxx_destruct;	// IMP=0x0020000000176771
...
- (void)cancel;	// IMP=0x0010000000176751
- (void)respondWithAuthorizationToken:(id)arg1;	// IMP=0x001000000017673f
- (id)initWithRoute:(id)arg1 inputType:(long long)arg2 responseCallback:(CDUnknownBlockType)arg3 cancelCallback:(CDUnknownBlockType)arg4;	// IMP=0x0010000000176654
