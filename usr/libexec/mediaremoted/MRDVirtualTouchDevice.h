...
- (void).cxx_destruct;	// IMP=0x002000000017337a
...
- (id)_newIOKitDeviceProperties;	// IMP=0x00100000001731c0
- (_Bool)handleTouchEvent:(struct _MRHIDTouchEvent)arg1;	// IMP=0x0010000000172e3f
- (_Bool)handleHIDReport:(id)arg1;	// IMP=0x0010000000172d2e
- (id)deviceProperties;	// IMP=0x0010000000172cef
- (void)dealloc;	// IMP=0x0010000000172cb0
- (id)initWithDeviceDescriptor:(id)arg1;	// IMP=0x0010000000172b69
