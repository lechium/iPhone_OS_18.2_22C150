...
+ (id)restrictedTo:(id)arg1 by:(id)arg2;	// IMP=0x0020000000124a45
- (void).cxx_destruct;	// IMP=0x0020000000124ece
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000124d68
- (id)description;	// IMP=0x0010000000124b05
