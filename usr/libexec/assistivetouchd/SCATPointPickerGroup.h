...
- (void).cxx_destruct;	// IMP=0x00200000000d6dc9
...
- (_Bool)scatIsValid;	// IMP=0x00100000000d6d83
- (struct CGRect)scatFrame;	// IMP=0x00100000000d6d1b
- (unsigned long long)hash;	// IMP=0x00100000000d6cd7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000d6bb0
- (id)initWithSelectionPath:(id)arg1 generatorDelegate:(id)arg2;	// IMP=0x00100000000d6b0b
