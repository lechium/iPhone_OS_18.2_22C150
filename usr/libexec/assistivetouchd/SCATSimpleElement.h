...
@interface SCATSimpleElement : NSObject
{
    ...
    _Bool isHandUI;	// 9 = 0x9
    _Bool isVisible;	// 10 = 0xa
...
@property(readonly, nonatomic) _Bool isVisible; // @synthesize isVisible;
@property(readonly, nonatomic) _Bool isHandUI; // @synthesize isHandUI;
...
- (id)keyboardContainer;	// IMP=0x00100000000dabbd
@property(readonly, nonatomic) struct CGRect frame;
- (_Bool)isGroup;	// IMP=0x00100000000dab96
- (id)highestAncestorGroup;	// IMP=0x00100000000dab46
...
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x00100000000da977
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x00100000000da96f
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x00100000000da960
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x00100000000da958
- (void)scatScrollToVisible;	// IMP=0x00100000000da952
- (id)scatSupportedGestures;	// IMP=0x00100000000da94a
...
- (id)scrollableElement;	// IMP=0x00100000000da92a
...
- (id)scatValue;	// IMP=0x00100000000da8d2
