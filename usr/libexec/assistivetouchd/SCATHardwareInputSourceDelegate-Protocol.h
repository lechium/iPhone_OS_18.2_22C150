...
@class SCATActionItem, SCATHardwareInputSource;
...
- (void)hardwareInputSource:(SCATHardwareInputSource *)arg1 didReceiveActionWithIdentifier:(SCATActionItem *)arg2 start:(_Bool)arg3 ignoreInputHold:(_Bool)arg4;
@end
