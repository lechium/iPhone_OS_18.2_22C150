...
- (void).cxx_destruct;	// IMP=0x00200000000ae340
...
- (void)_resetWithActionSource:(id)arg1;	// IMP=0x00100000000ae245
- (void)_handleFireActionAndResumeAutoscanning:(_Bool)arg1;	// IMP=0x00100000000ae122
- (_Bool)isPending;	// IMP=0x00100000000ae0de
- (void)cancelPendingAction;	// IMP=0x00100000000adf98
- (void)notifyDidReceiveAction:(id)arg1;	// IMP=0x00100000000adc7f
- (_Bool)_shouldHandleSelectActionImmediately;	// IMP=0x00100000000adbf2
@property(readonly, nonatomic) _Bool shouldShowMenuOnFirstSelectAction;
- (id)initWithAction:(long long)arg1 timeoutDuration:(double)arg2;	// IMP=0x00100000000adaef
