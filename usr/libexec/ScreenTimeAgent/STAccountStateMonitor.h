...
- (void).cxx_destruct;	// IMP=0x00200000000052da
...
- (void)reloadAccountState:(_Bool)arg1;	// IMP=0x00100000000041a7
- (void)debouncer:(id)arg1 didDebounce:(id)arg2;	// IMP=0x0010000000004193
- (id)initWithDelegate:(id)arg1;	// IMP=0x00100000000039e0
- (void)dealloc;	// IMP=0x0010000000003962
