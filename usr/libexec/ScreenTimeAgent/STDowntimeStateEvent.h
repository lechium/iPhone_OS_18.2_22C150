...
- (void).cxx_destruct;	// IMP=0x00200000000c4826
...
- (unsigned long long)hash;	// IMP=0x00100000000c4715
- (_Bool)isEqualToDowntimeStateEvent:(id)arg1;	// IMP=0x00100000000c4574
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000c4511
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c44d5
@property(readonly) _Bool enabled;
- (id)initWithIdentifier:(id)arg1 downtimeConfigurationState:(long long)arg2 downtimeDate:(id)arg3 userID:(id)arg4;	// IMP=0x00100000000c43a6
