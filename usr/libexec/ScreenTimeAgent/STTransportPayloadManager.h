...
- (void).cxx_destruct;	// IMP=0x00200000000b72c3
...
- (void)localTransport:(id)arg1 didReceivePayload:(id)arg2;	// IMP=0x00100000000b71c7
- (void)transport:(id)arg1 didReceiveUpdatedState:(unsigned long long)arg2 forPayloadUUID:(id)arg3 context:(id)arg4 error:(id)arg5;	// IMP=0x00100000000b6fc0
- (void)transport:(id)arg1 didReceiveData:(id)arg2 altURI:(id)arg3 appleID:(id)arg4 serverReceivedTime:(id)arg5;	// IMP=0x00100000000b6941
- (void)_forwardPayloadToLocalTransport:(id)arg1;	// IMP=0x00100000000b63f5
- (void)_updatePayloadUUID:(id)arg1 toState:(unsigned long long)arg2 context:(id)arg3;	// IMP=0x00100000000b62c8
- (void)_sendPayload:(id)arg1;	// IMP=0x00100000000b5d9a
- (void)_operation:(id)arg1 finishedDidChange:(_Bool)arg2;	// IMP=0x00100000000b5c1d
- (void)_operation:(id)arg1 executingDidChange:(_Bool)arg2;	// IMP=0x00100000000b5b02
- (void)_operation:(id)arg1 cancelledDidChange:(_Bool)arg2;	// IMP=0x00100000000b59e7
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000000b5747
- (void)_processEnqueuedPayloads;	// IMP=0x00100000000b5198
- (void)enqueuePayload:(id)arg1;	// IMP=0x00100000000b4f4f
- (void)invalidate;	// IMP=0x00100000000b4d7d
- (void)resume;	// IMP=0x00100000000b4bdb
- (id)initWithTransport:(id)arg1 localTransport:(id)arg2 persistenceController:(id)arg3;	// IMP=0x00100000000b479a
