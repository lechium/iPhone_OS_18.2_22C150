...
- (void).cxx_destruct;	// IMP=0x002000000001e49e
- (id)persistentContainer;	// IMP=0x001000000001e48a
...
- (id)_handleConfigurationAsSettings:(id)arg1;	// IMP=0x001000000001dee3
- (id)_handleConfigurationAsBlueprint:(id)arg1 timeout:(unsigned long long)arg2;	// IMP=0x001000000001d719
- (id)handleConfigurationChange:(id)arg1;	// IMP=0x001000000001d17d
- (id)initWithFamilySettingsManager:(id)arg1 requestManager:(id)arg2 persistentContainer:(id)arg3;	// IMP=0x001000000001d0b7
