...
- (NSNumber *)getIsWebContentRestrictedAndReturnError:(id *)arg1;
...
- (_Bool)authenticateRestrictionsPasscode:(NSString *)arg1 error:(id *)arg2;
- (void)restrictionsPasscodeEntryAttemptCountAndTimeoutDateWithCompletionHandler:(void (^)(NSNumber *, NSDate *, NSError *))arg1;
- (void)setRestrictionsPasscode:(NSString *)arg1 error:(id *)arg2;
- (NSNumber *)getNeedsToSetRestrictionsPasscodeAndReturnError:(id *)arg1;
- (NSNumber *)getIsRestrictionsPasscodeSetAndReturnError:(id *)arg1;
