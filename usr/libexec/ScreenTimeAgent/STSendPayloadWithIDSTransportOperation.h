...
- (void).cxx_destruct;	// IMP=0x00200000000aecba
...
- (id)_sendData:(id)arg1 toDestinations:(id)arg2 queueIdentifier:(id)arg3 payloadUUID:(id)arg4 expectResponse:(_Bool)arg5 withError:(id *)arg6;	// IMP=0x00100000000ae098
- (void)main;	// IMP=0x00100000000ad7c3
- (id)initWithPayload:(id)arg1 destinations:(id)arg2 service:(id)arg3;	// IMP=0x00100000000ad6eb
