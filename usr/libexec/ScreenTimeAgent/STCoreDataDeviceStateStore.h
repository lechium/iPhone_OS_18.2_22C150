...
- (void).cxx_destruct;	// IMP=0x002000000002e2f8
...
- (void)observer:(id)arg1 didObserveCoreDataChanges:(id)arg2;	// IMP=0x001000000002e174
- (id)writeDeviceStateChange:(id)arg1;	// IMP=0x001000000002e0fa
- (id)readDeviceStateChangeForLocalDevice;	// IMP=0x001000000002e0aa
- (id)initWithObserver:(id)arg1 transformer:(id)arg2 reverseTransformer:(id)arg3;	// IMP=0x001000000002df92
