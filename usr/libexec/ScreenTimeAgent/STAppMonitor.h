...
- (void).cxx_destruct;	// IMP=0x0020000000008bf7
...
- (void)_updateLocalAppsWithBackgroundActivity:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000088b3
- (void)_scheduleAppDiscoveryBackgroundActivity;	// IMP=0x0010000000008700
- (void)_didDetectNewAppUsage:(id)arg1;	// IMP=0x00100000000085ed
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x00100000000085d7
- (void)applicationsDidInstall:(id)arg1;	// IMP=0x00100000000085c1
- (void)resume;	// IMP=0x0010000000008549
- (void)dealloc;	// IMP=0x00100000000084d4
- (id)initWithPersistenceController:(id)arg1;	// IMP=0x00100000000083cb
