...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x00200000001588be
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000f578a
- (void).cxx_destruct;	// IMP=0x002000000015875b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000157ebe
- (unsigned long long)hash;	// IMP=0x0010000000157b36
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001575b7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000156fe5
- (void)copyTo:(id)arg1;	// IMP=0x0010000000156bf3
- (void)writeTo:(id)arg1;	// IMP=0x0010000000156798
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000155f2d
- (id)dictionaryRepresentation;	// IMP=0x0010000000155907
- (id)description;	// IMP=0x0010000000155858
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x001000000015571e
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x0010000000155701
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x0010000000155697
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x001000000015567a
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000118279
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001a768b
