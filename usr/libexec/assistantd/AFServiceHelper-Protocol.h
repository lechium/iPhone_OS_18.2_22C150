...
@class AFEndpointInfo, AFInstanceInfo, AFPeerInfo, AFSpeechInfo, MISSING_TYPE, NSBundle, NSSet, NSString, NSURL, SABaseCommand;
...
@optional
- (MISSING_TYPE *)dismissAssistantWithReason: /* Error: Ran out of types for this method. */;
