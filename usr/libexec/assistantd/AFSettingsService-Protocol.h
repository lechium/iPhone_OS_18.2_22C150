...
@class AFAudioPlaybackRequest, AFBluetoothDeviceInfo, AFCompanionDeviceInfo, AFDeleteSiriHistoryContext, AFMyriadAdvertisementContext, AFRequestInfo, AFSpeechRecognition, AFVoiceInfo, MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSString, NSURL, NSUUID, SCDAAdvertisementContext, SCDAFParticipation;
...
- (MISSING_TYPE *)getHeadGesturesForCurrentlyRoutedDevice: /* Error: Ran out of types for this method. */;
