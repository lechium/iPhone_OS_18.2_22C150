...
+ (id)_readDictationSampledPlist;	// IMP=0x004000000025ff1d
+ (id)sharedManager;	// IMP=0x001000000025feed
- (void).cxx_destruct;	// IMP=0x002000000025fea4
...
- (void)_writeDictationSamplingVariablesToFile:(id)arg1;	// IMP=0x001000000025fd62
- (void)_createDictationSampledPlistIfItDoesNotExist;	// IMP=0x001000000025fb1e
- (void)createDictationSampledPlistIfItDoesNotExist;	// IMP=0x001000000025fad3
- (_Bool)isRequestSelectedForSampling;	// IMP=0x001000000025f77e
- (_Bool)isSamplingDateCurrent;	// IMP=0x001000000025f6cc
- (void)updateDateToCurrent;	// IMP=0x001000000025f630
- (void)setRequestCount:(long long)arg1;	// IMP=0x001000000025f5c2
- (void)decrementRequestCount;	// IMP=0x001000000025f51a
- (void)updateRequestCountWithFlag:(_Bool)arg1;	// IMP=0x001000000025f4ff
- (void)incrementRequestCount;	// IMP=0x001000000025f4e2
- (void)resetRequestCount;	// IMP=0x001000000025f4ce
- (id)init;	// IMP=0x001000000025f35f
