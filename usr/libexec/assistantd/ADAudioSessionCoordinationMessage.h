...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000036da12
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x001000000036d9c5
- (void).cxx_destruct;	// IMP=0x002000000036d561
...
- (id)buildDictionaryRepresentation;	// IMP=0x001000000036d2d3
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x001000000036ce1b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000036cce0
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000036caaa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000036ca9f
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000036c7f1
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x001000000036c5fa
@property(readonly, copy) NSString *description;
- (id)initWithHostTime:(unsigned long long)arg1 type:(long long)arg2 payloadBeginAudioSessionRequest:(id)arg3 payloadBeginAudioSessionResponse:(id)arg4 payloadKeepAudioSessionAliveRequest:(id)arg5 payloadKeepAudioSessionAliveResponse:(id)arg6 payloadEndAudioSessionRequest:(id)arg7 payloadEndAudioSessionResponse:(id)arg8;	// IMP=0x001000000036c45c
- (id)init;	// IMP=0x001000000036c448
- (id)initWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x001000000036c1db
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x001000000036da1a
