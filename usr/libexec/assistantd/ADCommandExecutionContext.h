...
- (void).cxx_destruct;	// IMP=0x0020000000377ae7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000377a54
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000003779f5
@property(readonly, copy, nonatomic) AFCommandExecutionInfo *info;
- (id)description;	// IMP=0x001000000037782b
@property(readonly, nonatomic) ADPeerInfo *originPeerInfo;
@property(readonly, nonatomic) _Bool isFromRemote;
- (void)updateInfoUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000377672
- (id)initWithInfo:(id)arg1;	// IMP=0x00100000003775b3
