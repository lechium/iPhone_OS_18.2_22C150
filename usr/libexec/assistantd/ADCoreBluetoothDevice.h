...
- (void).cxx_destruct;	// IMP=0x00200000002bc8ef
...
- (id)dictionaryRepresentation;	// IMP=0x00100000002bc82b
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 RSSI:(id)arg3 state:(id)arg4;	// IMP=0x00100000002bc743
