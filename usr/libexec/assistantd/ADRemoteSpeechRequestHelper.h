...
- (void).cxx_destruct;	// IMP=0x002000000018e63f
...
- (void)reset;	// IMP=0x001000000018e5dd
- (id)setSpeechRequestOptions:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000018e520
