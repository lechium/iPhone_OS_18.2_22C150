...
- (void).cxx_destruct;	// IMP=0x0020000000245fc6
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00100000002464a1
- (id)metricValue;	// IMP=0x00100000002460b8
