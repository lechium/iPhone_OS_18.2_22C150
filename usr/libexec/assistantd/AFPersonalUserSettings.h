...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001cdc65
- (void).cxx_destruct;	// IMP=0x00200000001cdc27
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001cda57
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001cd9a9
