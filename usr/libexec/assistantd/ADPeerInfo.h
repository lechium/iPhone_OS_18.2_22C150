...
+ (void)updateSharedInfoWithIdentifier:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3;	// IMP=0x002000000036bff9
+ (id)locallyPairedPeerInfo;	// IMP=0x001000000036bf09
+ (id)_queue;	// IMP=0x001000000036bed9
- (void).cxx_destruct;	// IMP=0x002000000036bc77
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000036b9b3
- (unsigned long long)hash;	// IMP=0x001000000036b99d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000036b992
- (id)afPeerInfo;	// IMP=0x001000000036b935
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)description;	// IMP=0x001000000036b81e
- (id)initWithAFPeerInfo:(id)arg1;	// IMP=0x001000000036b467
- (id)initWithUniqueIdentifer:(id)arg1;	// IMP=0x001000000036b3fa
- (id)initWithIDSIdentifer:(id)arg1;	// IMP=0x001000000036b3e0
- (id)initWithIDSIdentifer:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3 name:(id)arg4;	// IMP=0x001000000036b2c9
