...
- (void).cxx_destruct;	// IMP=0x002000000023e45b
- (void)setExpirationDuration:(double)arg1;	// IMP=0x001000000023e44c
- (double)getExpirationDuration;	// IMP=0x001000000023e429
- (_Bool)isDirty;	// IMP=0x001000000023e41e
- (id)initWithBase:(id)arg1;	// IMP=0x001000000023e3b3
