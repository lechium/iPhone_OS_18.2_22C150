...
- (void).cxx_destruct;	// IMP=0x0020000000102c10
...
- (void)dealloc;	// IMP=0x0010000000102a5a
- (void)completeRequestWithSuccess:(_Bool)arg1 forReason:(long long)arg2 shouldEmitInstrumentationEvent:(_Bool)arg3;	// IMP=0x0010000000102a02
- (id)initWithRemoteAnnouncement:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000010288b
- (id)initWithAnnouncementRequestType:(unsigned long long)arg1 platform:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001027cd
- (id)_initWithAnnouncementRequestType:(unsigned long long)arg1 platform:(long long)arg2 announcementIdentifier:(id)arg3 timeOfRequestArrival:(id)arg4 startLocalRequest:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x001000000010262d
