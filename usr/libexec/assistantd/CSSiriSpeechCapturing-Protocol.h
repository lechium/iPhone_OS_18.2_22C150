...
@class AFExperimentContext, AFSpeechRequestOptions, CSASRFeatures, CSAudioSessionController, CSSiriAudioPlaybackService, CSSpeechController, MISSING_TYPE, NSObject, SASResultCandidate;
...
- (MISSING_TYPE *)cancelSpeechCaptureSuppressingAlert: /* Error: Ran out of types for this method. */;
