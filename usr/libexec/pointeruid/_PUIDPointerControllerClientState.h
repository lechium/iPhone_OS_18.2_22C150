...
- (void).cxx_destruct;	// IMP=0x0020000000012238
...
- (void)startAutomaticRegionExitTimerWithDelayInterval:(double)arg1 fireHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000011fb2
- (void)invalidateAutomaticRegionExitTimer;	// IMP=0x0010000000011f80
- (id)init;	// IMP=0x0010000000011efd
