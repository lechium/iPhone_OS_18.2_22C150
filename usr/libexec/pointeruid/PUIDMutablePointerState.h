...
- (id)description;	// IMP=0x001000000002f460
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002f430
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002f3f9
