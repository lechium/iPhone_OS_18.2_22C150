...
+ (id)monitor;	// IMP=0x00200000000013bd
- (void).cxx_destruct;	// IMP=0x00200000000012e6
...
- (void)_onqueueRecheck;	// IMP=0x0010000000001166
- (void)recheck;	// IMP=0x001000000000111b
- (void)connectTo:(id)arg1;	// IMP=0x00100000000010f0
- (void)notifyListener;	// IMP=0x0010000000001089
- (void)handleNotification:(const char *)arg1;	// IMP=0x001000000000103d
- (id)init;	// IMP=0x0010000000000ed0
