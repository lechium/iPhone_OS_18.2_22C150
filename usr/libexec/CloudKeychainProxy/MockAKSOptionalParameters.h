...
- (void).cxx_destruct;	// IMP=0x002000000000df24
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000de32
- (unsigned long long)hash;	// IMP=0x001000000000ddc5
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000dce5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000dc21
- (void)copyTo:(id)arg1;	// IMP=0x001000000000db9e
- (void)writeTo:(id)arg1;	// IMP=0x001000000000db24
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000d998
- (id)dictionaryRepresentation;	// IMP=0x001000000000d8ee
- (id)description;	// IMP=0x001000000000d83f
