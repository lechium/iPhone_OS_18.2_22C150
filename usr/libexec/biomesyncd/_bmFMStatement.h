...
- (void).cxx_destruct;	// IMP=0x002000000004d24a
...
- (id)description;	// IMP=0x001000000004d161
- (void)reset;	// IMP=0x001000000004d13f
- (void)close;	// IMP=0x001000000004d115
- (void)dealloc;	// IMP=0x001000000004d0d7
