...
- (void).cxx_destruct;	// IMP=0x0020000000058bb0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000058aa7
- (unsigned long long)hash;	// IMP=0x0010000000058a30
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000005893e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000058880
- (void)copyTo:(id)arg1;	// IMP=0x00100000000587fd
- (void)writeTo:(id)arg1;	// IMP=0x0010000000058779
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000584e3
- (id)dictionaryRepresentation;	// IMP=0x00100000000583b1
- (id)description;	// IMP=0x0010000000058302
