...
- (void).cxx_destruct;	// IMP=0x002000000007041e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000702cb
- (unsigned long long)hash;	// IMP=0x0010000000070217
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000700e1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006ffd4
- (void)copyTo:(id)arg1;	// IMP=0x001000000006ff12
- (void)writeTo:(id)arg1;	// IMP=0x001000000006fe48
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000006fe3b
- (id)dictionaryRepresentation;	// IMP=0x001000000006fccd
- (id)description;	// IMP=0x001000000006fc1e
