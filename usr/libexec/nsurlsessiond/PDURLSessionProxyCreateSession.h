...
- (void).cxx_destruct;	// IMP=0x00200000000046f3
...
- (unsigned long long)hash;	// IMP=0x0010000000004413
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000004222
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000040db
- (void)copyTo:(id)arg1;	// IMP=0x0010000000003fcf
- (void)writeTo:(id)arg1;	// IMP=0x0010000000003e9c
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000393b
- (id)dictionaryRepresentation;	// IMP=0x0010000000003671
- (id)description;	// IMP=0x00100000000035c2
