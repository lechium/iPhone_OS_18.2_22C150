...
- (void).cxx_destruct;	// IMP=0x0020000000002833
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000026fb
- (unsigned long long)hash;	// IMP=0x0010000000002665
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000002557
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000002473
- (void)copyTo:(id)arg1;	// IMP=0x00100000000023d0
- (void)writeTo:(id)arg1;	// IMP=0x0010000000002330
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000209e
- (id)dictionaryRepresentation;	// IMP=0x0010000000001f6b
- (id)description;	// IMP=0x0010000000001ebc
