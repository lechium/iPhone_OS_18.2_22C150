...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000072fc0
- (void).cxx_destruct;	// IMP=0x0020000000072fb0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000072e58
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000072d77
- (id)initWithCallbackType:(int)arg1 taskIdentifier:(unsigned long long)arg2 args:(id)arg3;	// IMP=0x0010000000072cad
