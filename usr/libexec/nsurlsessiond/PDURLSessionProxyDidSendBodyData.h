...
- (void).cxx_destruct;	// IMP=0x0020000000063277
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000006316b
- (unsigned long long)hash;	// IMP=0x00100000000630e2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000062fe1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000062f0e
- (void)copyTo:(id)arg1;	// IMP=0x0010000000062e70
- (void)writeTo:(id)arg1;	// IMP=0x0010000000062dc0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000062a55
- (id)dictionaryRepresentation;	// IMP=0x00100000000628ba
- (id)description;	// IMP=0x001000000006280b
