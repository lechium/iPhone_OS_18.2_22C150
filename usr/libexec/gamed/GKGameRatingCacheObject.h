...
+ (id)entityName;	// IMP=0x00400000001044a7
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0010000000103f7d
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0020000000104234
