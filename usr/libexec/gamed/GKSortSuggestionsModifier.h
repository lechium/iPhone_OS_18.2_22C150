...
- (void).cxx_destruct;	// IMP=0x002000000019084f
...
- (id)sortSuggestions:(id)arg1 usingSortedContactsAssociationIDs:(id)arg2 suggestionMap:(id)arg3;	// IMP=0x00100000001902f0
- (id)modifySuggestions:(id)arg1;	// IMP=0x001000000018fabc
- (id)initWithSettings:(id)arg1 networkRequester:(id)arg2 cachedSortedAssociationIDs:(id)arg3 transactionGroupProvider:(CDUnknownBlockType)arg4 featureEnabledBlock:(CDUnknownBlockType)arg5;	// IMP=0x001000000018f99d
