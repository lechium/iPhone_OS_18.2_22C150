...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00200000000e89b5
- (void).cxx_destruct;	// IMP=0x00200000000e8e5a
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e8ac5
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00100000000e8a27
