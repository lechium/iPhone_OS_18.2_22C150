...
+ (id)bagKey;	// IMP=0x00200000000d7c6f
- (void).cxx_destruct;	// IMP=0x00200000000d848f
...
- (id)requestIdentifier;	// IMP=0x00100000000d82fa
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000d818a
- (id)taskInfo;	// IMP=0x00100000000d800f
- (id)postBody;	// IMP=0x00100000000d7f81
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000d7ed5
- (void)mergeRequestData:(id)arg1;	// IMP=0x00100000000d7e49
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000d7db8
- (id)initWithChallenges:(id)arg1 bundleID:(id)arg2;	// IMP=0x00100000000d7c8f
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000d7c7c
