...
- (oneway void)revokePseudonym:(NSString *)arg1 withCompletionHandler:(void (^)(NSError *))arg2;
- (oneway void)fetchTransportOverrideWithHandler:(void (^)(NSArray *, NSArray *, _Bool))arg1;
