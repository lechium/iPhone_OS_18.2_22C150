...
- (void).cxx_destruct;	// IMP=0x0020000000196d23
...
- (id)modifySuggestions:(id)arg1;	// IMP=0x00100000001969b1
- (id)initWithSettings:(id)arg1 suggestionsProvider:(CDUnknownBlockType)arg2;	// IMP=0x001000000019690c
