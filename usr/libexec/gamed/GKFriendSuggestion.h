...
- (void).cxx_destruct;	// IMP=0x00200000000cb99f
...
- (id)description;	// IMP=0x00100000000cb7f0
- (id)initWithContactID:(id)arg1 handle:(id)arg2 prefixedHandle:(id)arg3 contactAssociationID:(id)arg4;	// IMP=0x00100000000cb708
- (id)initWithSuggestion:(id)arg1;	// IMP=0x00100000000cb593
