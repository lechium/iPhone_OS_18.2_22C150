...
+ (long long)coalescingDelay;	// IMP=0x00200000000d6af5
+ (id)bagKey;	// IMP=0x00100000000d6ae8
- (void).cxx_destruct;	// IMP=0x00200000000d7c1b
...
- (id)requestIdentifier;	// IMP=0x00100000000d7a73
- (id)taskInfo;	// IMP=0x00100000000d78f8
- (void)removeFromStore:(id)arg1;	// IMP=0x00100000000d76ce
- (id)postBody;	// IMP=0x00100000000d7640
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000d762b
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00100000000d7618
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00100000000d7260
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000d6f8d
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithAchievements:(id)arg1 bundleID:(id)arg2;	// IMP=0x00100000000d6bac
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000d6b00
