...
+ (id)bagKey;	// IMP=0x00200000000d91ae
- (void).cxx_destruct;	// IMP=0x00200000000d9b0a
...
- (id)requestIdentifier;	// IMP=0x00100000000d9941
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000d992e
- (id)taskInfo;	// IMP=0x00100000000d974e
- (id)postBody;	// IMP=0x00100000000d973c
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000d96ab
- (id)initWithInstanceScore:(id)arg1 bundleID:(id)arg2 challenges:(id)arg3;	// IMP=0x00100000000d93f1
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000d9267
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000d91bb
