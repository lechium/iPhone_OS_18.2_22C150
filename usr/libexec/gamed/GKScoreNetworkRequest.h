...
+ (long long)coalescingDelay;	// IMP=0x00200000000d6884
+ (id)bagKey;	// IMP=0x00100000000d5d13
- (void).cxx_destruct;	// IMP=0x00200000000d6a89
...
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000d66a3
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00100000000d6690
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00100000000d6567
- (id)requestIdentifier;	// IMP=0x00100000000d655d
- (id)taskInfo;	// IMP=0x00100000000d6382
- (void)removeFromStore:(id)arg1;	// IMP=0x00100000000d629f
- (id)postBody;	// IMP=0x00100000000d61a6
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithScores:(id)arg1 bundleID:(id)arg2 eligibleChallenges:(id)arg3;	// IMP=0x00100000000d5de1
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000d5d35
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000d5d20
