...
+ (id)sharedManager;	// IMP=0x00400000000c35e7
- (void).cxx_destruct;	// IMP=0x00200000000c3a1c
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x00100000000c3757
- (id)init;	// IMP=0x00100000000c36a3
