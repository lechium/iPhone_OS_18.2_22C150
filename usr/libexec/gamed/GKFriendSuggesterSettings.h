...
+ (id)allBagKeys;	// IMP=0x004000000018c57e
...
- (id)description;	// IMP=0x001000000018c5fb
- (id)initWithBagValues:(id)arg1;	// IMP=0x001000000018c4c5
- (id)init;	// IMP=0x001000000018c4ac
