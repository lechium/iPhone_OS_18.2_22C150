...
+ (id)entityName;	// IMP=0x00400000001107dd
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00200000001107ea
- (id)internalRepresentation;	// IMP=0x0010000000110635
