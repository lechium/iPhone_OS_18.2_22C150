...
+ (id)entityName;	// IMP=0x0040000000114ffd
- (id)internalRepresentation;	// IMP=0x002000000011535d
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000011500a
