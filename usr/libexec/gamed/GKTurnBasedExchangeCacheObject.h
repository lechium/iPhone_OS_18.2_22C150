...
+ (id)entityName;	// IMP=0x004000000011464a
- (id)internalRepresentation;	// IMP=0x0020000000114ff5
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x0010000000114657
