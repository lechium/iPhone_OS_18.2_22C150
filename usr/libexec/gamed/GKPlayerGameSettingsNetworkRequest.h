...
+ (id)bagKey;	// IMP=0x00200000000da35a
- (void).cxx_destruct;	// IMP=0x00200000000dabea
...
- (id)requestIdentifier;	// IMP=0x00100000000daaff
- (id)taskInfo;	// IMP=0x00100000000da9a5
- (void)removeFromStore:(id)arg1;	// IMP=0x00100000000da8a1
- (id)postBody;	// IMP=0x00100000000da7bf
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000da713
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000da636
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000da521
- (id)initWithBundleID:(id)arg1 value:(id)arg2;	// IMP=0x00100000000da3f8
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000da367
