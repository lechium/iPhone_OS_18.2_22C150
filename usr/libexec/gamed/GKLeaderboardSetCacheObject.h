...
+ (id)entityName;	// IMP=0x0020000000104fc1
- (id)internalRepresentation;	// IMP=0x0020000000104cb5
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000104661
