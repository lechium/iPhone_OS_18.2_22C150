...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000017ca88
- (void).cxx_destruct;	// IMP=0x002000000017e9ce
...
- (id)description;	// IMP=0x001000000017e5da
- (id)customInviteSoundPathForBundleID:(id)arg1;	// IMP=0x001000000017e4c2
- (void)declineInviteWithReason:(int)arg1;	// IMP=0x001000000017e2b3
- (void)updateDeclineInviteTrackingForReason:(long long)arg1;	// IMP=0x001000000017e183
- (id)clientNotification;	// IMP=0x001000000017db21
- (id)clientNotificationWithiCloudID:(id)arg1;	// IMP=0x001000000017da7c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000017d6ad
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000017d244
- (id)initWithPushNotification:(id)arg1;	// IMP=0x001000000017cc6a
- (void)parseClientData:(id)arg1;	// IMP=0x001000000017cb94
- (long long)inviteVersionFromMessage:(id)arg1;	// IMP=0x001000000017cabf
- (id)init;	// IMP=0x001000000017ca90
