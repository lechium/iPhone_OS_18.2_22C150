...
+ (id)sharedManager;	// IMP=0x00200000000dd714
- (void).cxx_destruct;	// IMP=0x00200000000ddd8a
...
- (void)accountController:(id)arg1 accountAdded:(id)arg2;	// IMP=0x00100000000ddbd9
- (void)fetchIDSDataForHandles:(id)arg1 service:(id)arg2 infoTypes:(unsigned long long)arg3 performingBlockPerBatch:(CDUnknownBlockType)arg4;	// IMP=0x00100000000dd8d0
- (_Bool)isReady;	// IMP=0x00100000000dd885
- (void)dealloc;	// IMP=0x00100000000dd840
- (id)init;	// IMP=0x00100000000dd769
