...
- (void).cxx_destruct;	// IMP=0x0020000000141d8a
...
- (void)applicationsWillUninstall:(id)arg1;	// IMP=0x0010000000141bdb
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x0010000000141a93
- (void)startObservingApplicationWorkspaceChanges;	// IMP=0x00100000001419ad
- (void)updateStateObservation;	// IMP=0x0010000000141789
- (void)stopObservingStateChangesForBundleID:(id)arg1;	// IMP=0x001000000014170a
- (_Bool)startObservingStateChangesForBundleID:(id)arg1;	// IMP=0x001000000014164a
- (void)dealloc;	// IMP=0x0010000000140f86
- (id)init;	// IMP=0x0010000000140ecc
