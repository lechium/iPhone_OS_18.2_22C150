...
+ (id)entityName;	// IMP=0x00200000000fd301
+ (id)playerProfilesWithPlayerIDs:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x00100000000fb9db
+ (id)playerProfilesWithPlayers:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x00100000000fb936
+ (id)profileForPlayer:(id)arg1 context:(id)arg2;	// IMP=0x00100000000fb84b
+ (id)playerProfileWithPlayerID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x00100000000fb572
+ (id)localPlayerInManagedObjectContext:(id)arg1;	// IMP=0x00100000000fb2c4
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x00100000000fa8a1
+ (id)uniqueAttributeName;	// IMP=0x00100000000fa894
+ (id)filterPlayerIDs:(id)arg1 familiarity:(int)arg2 includeSelf:(_Bool)arg3;	// IMP=0x00100000000fe8fa
+ (unsigned char)piecesToLoadForFamiliarity:(int)arg1;	// IMP=0x00100000000fe8d2
+ (id)playersByFamiliarity:(id)arg1;	// IMP=0x00100000000fe346
+ (void)setFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x00100000000fe10b
+ (void)removeFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x00100000000fddc1
+ (void)addFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x00100000000fdbb5
+ (int)familiarityForPlayerID:(id)arg1;	// IMP=0x00100000000fd9ba
+ (id)selfPlayerID;	// IMP=0x00100000000fd963
+ (void)buildFamiliarilyLookupForProfile:(id)arg1;	// IMP=0x00100000000fd688
+ (id)_familiarityLookup;	// IMP=0x00100000000fd491
- (void)expireRecentMatchesWithGame:(id)arg1;	// IMP=0x00200000000fd30e
- (id)internalRepresentation;	// IMP=0x00100000000fd142
- (id)internalRepresentationWithPieces:(unsigned char)arg1;	// IMP=0x00100000000fcf5a
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2 pieces:(unsigned char)arg3;	// IMP=0x00100000000fc103
- (id)updateImagesWithImageURLs:(id)arg1;	// IMP=0x00100000000fbd14
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000000fbcff
- (void)deleteCachedImage:(id)arg1;	// IMP=0x00100000000fafa3
- (void)deleteCachedAvatars;	// IMP=0x00100000000fad74
- (void)clearImages;	// IMP=0x00100000000faa30
- (_Bool);	// IMP=0x00100000000fa9ca
@property(nonatomic, getter=isUnderage) _Bool underage; // @dynamic underage;
- (void)invalidate;	// IMP=0x00100000000fa924
