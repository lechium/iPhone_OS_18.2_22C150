...
+ (id)entityName;	// IMP=0x004000000010aff7
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x002000000010b004
- (id)internalRepresentation;	// IMP=0x001000000010acea
