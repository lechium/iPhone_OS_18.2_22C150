...
+ (id)writerWithCacheWriter:(id)arg1 cacheReader:(id)arg2 networkWriter:(id)arg3 batchSubmissionInterval:(double)arg4;	// IMP=0x00200000000e8e82
- (void).cxx_destruct;	// IMP=0x00200000000eb7be
...
- (void)writeResourcesToCacheOnly:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000eb5ab
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000ea8d0
- (void)readAndSubmitDelayedRequestsOfResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e9945
- (void)deleteSubmittedRequestsWithIDs:(id)arg1 onConnection:(id)arg2;	// IMP=0x00100000000e956f
- (void)submitDelayedRequestsForPlayer:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e9445
- (void)batchAndPerformInGroup:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e91f2
- (id)initWithCacheWriter:(id)arg1 cacheReader:(id)arg2 networkWriter:(id)arg3 batchSubmissionInterval:(double)arg4;	// IMP=0x00100000000e909b
