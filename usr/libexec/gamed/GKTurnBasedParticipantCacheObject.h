...
+ (id)entityName;	// IMP=0x0040000000114217
- (id)internalRepresentation;	// IMP=0x0020000000114642
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000114224
