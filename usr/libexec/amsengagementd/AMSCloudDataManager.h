...
+ (void)handleRecordZoneFetchFailed:(id)arg1 inDatabase:(id)arg2 withError:(id)arg3;	// IMP=0x0040000000196bcf
- (void).cxx_destruct;	// IMP=0x0020000000197130
...
- (void)handlePushNotification:(id)arg1;	// IMP=0x0010000000196b66
- (id)containerWithContainerIdentifier:(id)arg1 options:(id)arg2;	// IMP=0x0010000000196a52
- (id)containerWithContainerIdentifier:(id)arg1;	// IMP=0x0010000000196a3e
@property(readonly, nonatomic) NSString *pushNotificationTopic;
- (id)initWithDataSource:(id)arg1;	// IMP=0x0010000000196969
