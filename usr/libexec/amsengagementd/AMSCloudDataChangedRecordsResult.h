...
- (void).cxx_destruct;	// IMP=0x0020000000195fd0
...
- (id)initWithChangedRecords:(id)arg1 deletedRecords:(id)arg2 errors:(id)arg3 changeTokens:(id)arg4;	// IMP=0x0010000000195cf2
