...
- (void).cxx_destruct;	// IMP=0x0020000000010cd0
@property(readonly, getter=isManaging) _Bool managing; // @synthesize managing=_managing;
@property(readonly) NSData *state;
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000108f1
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001070b
- (id)init;	// IMP=0x001000000001064a
- (void)_loadEnterpriseData;	// IMP=0x0010000000010d03
