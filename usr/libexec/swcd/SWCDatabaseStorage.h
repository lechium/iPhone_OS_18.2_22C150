...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000147d7
- (void).cxx_destruct;	// IMP=0x00200000000152ef
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000014885
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000147df
