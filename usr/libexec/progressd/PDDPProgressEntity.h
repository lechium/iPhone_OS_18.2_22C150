...
- (void).cxx_destruct;	// IMP=0x002000000007f1b4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007ef78
- (unsigned long long)hash;	// IMP=0x001000000007ee73
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007ecad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007eb20
- (void)copyTo:(id)arg1;	// IMP=0x001000000007e9fd
- (void)writeTo:(id)arg1;	// IMP=0x001000000007e8e9
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000007e8dc
- (id)dictionaryRepresentation;	// IMP=0x001000000007e3cd
- (id)description;	// IMP=0x001000000007e31e
...
- (int)StringAsType:(id)arg1;	// IMP=0x001000000007e171
- (id)typeAsString:(int)arg1;	// IMP=0x001000000007e128
