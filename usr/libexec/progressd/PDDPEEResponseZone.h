...
- (void).cxx_destruct;	// IMP=0x00200000000ef0e1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000eef4e
- (unsigned long long)hash;	// IMP=0x00100000000eee9e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000eed63
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000eec51
- (void)copyTo:(id)arg1;	// IMP=0x00100000000eeb8e
- (void)writeTo:(id)arg1;	// IMP=0x00100000000eead1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000eeac4
- (id)dictionaryRepresentation;	// IMP=0x00100000000ee654
- (id)description;	// IMP=0x00100000000ee5a5
