...
- (void).cxx_destruct;	// IMP=0x002000000011e8fe
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000011e671
- (unsigned long long)hash;	// IMP=0x001000000011e57f
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000011e3c3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011e22f
- (void)copyTo:(id)arg1;	// IMP=0x001000000011e10c
- (void)writeTo:(id)arg1;	// IMP=0x001000000011e001
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000011dff4
- (id)dictionaryRepresentation;	// IMP=0x001000000011db33
- (id)description;	// IMP=0x001000000011da84
