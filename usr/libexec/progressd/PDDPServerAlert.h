...
+ (Class)otherButtonInfosType;	// IMP=0x00200000000d7716
- (void).cxx_destruct;	// IMP=0x00200000000d8f3d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000d8b28
- (unsigned long long)hash;	// IMP=0x00100000000d89ec
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000d87ce
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d849f
- (void)copyTo:(id)arg1;	// IMP=0x00100000000d82bc
- (void)writeTo:(id)arg1;	// IMP=0x00100000000d8075
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000d8068
- (id)dictionaryRepresentation;	// IMP=0x00100000000d77d6
- (id)description;	// IMP=0x00100000000d7727
- (id)otherButtonInfosAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000d76f9
- (unsigned long long)otherButtonInfosCount;	// IMP=0x00100000000d76dc
- (void)addOtherButtonInfos:(id)arg1;	// IMP=0x00100000000d7672
- (void)clearOtherButtonInfos;	// IMP=0x00100000000d7655
