...
+ (Class)classIdsType;	// IMP=0x0020000000143433
- (void).cxx_destruct;	// IMP=0x0020000000146353
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000145b20
- (unsigned long long)hash;	// IMP=0x00100000001456d3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001451cb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000144bc3
- (void)copyTo:(id)arg1;	// IMP=0x00100000001447f0
- (void)writeTo:(id)arg1;	// IMP=0x00100000001443c1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001443b4
- (id)dictionaryRepresentation;	// IMP=0x0010000000143623
- (id)description;	// IMP=0x0010000000143574
...
- (id)classIdsAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000143416
- (unsigned long long)classIdsCount;	// IMP=0x00100000001433f9
- (void)addClassIds:(id)arg1;	// IMP=0x001000000014338f
- (void)clearClassIds;	// IMP=0x0010000000143372
...
- (int)StringAsParentEntityType:(id)arg1;	// IMP=0x001000000014318f
- (id)parentEntityTypeAsString:(int)arg1;	// IMP=0x0010000000143146
...
- (int)StringAsType:(id)arg1;	// IMP=0x0010000000142f6b
- (id)typeAsString:(int)arg1;	// IMP=0x0010000000142f22
