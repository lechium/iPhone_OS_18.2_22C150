...
+ (Class)adminRequestAccountIdsType;	// IMP=0x002000000003d2ef
- (void).cxx_destruct;	// IMP=0x002000000003f018
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000003eb3a
- (unsigned long long)hash;	// IMP=0x001000000003e971
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000003e69e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003e2f0
- (void)copyTo:(id)arg1;	// IMP=0x001000000003e096
- (void)writeTo:(id)arg1;	// IMP=0x001000000003ddc9
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000003ddbc
- (id)dictionaryRepresentation;	// IMP=0x001000000003d3c4
- (id)description;	// IMP=0x001000000003d315
@property(readonly, nonatomic) _Bool hasAdminNote;
- (id)adminRequestAccountIdsAtIndex:(unsigned long long)arg1;	// IMP=0x001000000003d2d2
- (unsigned long long)adminRequestAccountIdsCount;	// IMP=0x001000000003d2b5
- (void)addAdminRequestAccountIds:(id)arg1;	// IMP=0x001000000003d24b
- (void)clearAdminRequestAccountIds;	// IMP=0x001000000003d22e
...
- (int)StringAsApprovalStatus:(id)arg1;	// IMP=0x001000000003d0c9
- (id)approvalStatusAsString:(int)arg1;	// IMP=0x001000000003d080
...
- (int)StringAsRequestStatus:(id)arg1;	// IMP=0x001000000003cf4a
- (id)requestStatusAsString:(int)arg1;	// IMP=0x001000000003cf01
@property(nonatomic) _Bool hasRequestStatus;
@property(nonatomic) int requestStatus; // @synthesize requestStatus=_requestStatus;
- (int)StringAsType:(id)arg1;	// IMP=0x001000000003cda5
- (id)typeAsString:(int)arg1;	// IMP=0x001000000003cd5c
