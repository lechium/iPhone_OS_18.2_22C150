...
#import <ClassKit/CLSGroupMember.h>

@class NSArray, NSObject, NSString;
@protocol PDDatabaseValue;

@interface CLSGroupMember (PDDatabaseEntity)
+ (long long)migrationOrder;	// IMP=0x002000000012a329
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x001000000012a26c
+ (id)entityName;	// IMP=0x0010000000129ffd
- (void)bindTo:(id)arg1;	// IMP=0x002000000012a13f
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x001000000012a071
