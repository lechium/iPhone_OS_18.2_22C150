...
+ (long long)migrationOrder;	// IMP=0x0020000000074c45
+ (_Bool)migrateFromVersion:(unsigned long long)arg1 finalVersion:(out unsigned long long *)arg2 inDatabase:(id)arg3;	// IMP=0x00100000000748e5
+ (id)searchColumnName;	// IMP=0x00100000000742d2
+ (id)entityName;	// IMP=0x00100000000742c5
- (void)setExpiration:(double)arg1;	// IMP=0x0020000000074c50
- (void)bindTo:(id)arg1;	// IMP=0x0010000000074619
- (id)initWithDatabaseRow:(id)arg1;	// IMP=0x00100000000743ca
