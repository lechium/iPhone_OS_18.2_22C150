...
@class CLSAdminRequestor, CLSObject, CLSQuerySpecification, CLSSearchSpecification, CLSSurvey, FPSandboxingURLWrapper, NSArray, NSData, NSDate, NSFileHandle, NSObject, NSString, NSURL;
