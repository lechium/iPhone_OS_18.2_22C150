...
+ (Class)additionalReportsType;	// IMP=0x0020000000195815
- (void).cxx_destruct;	// IMP=0x00200000001973e5
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000196f54
- (unsigned long long)hash;	// IMP=0x0010000000196dc7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000196b3e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001967a8
- (void)copyTo:(id)arg1;	// IMP=0x001000000019658a
- (void)writeTo:(id)arg1;	// IMP=0x00100000001962f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001962ec
- (id)dictionaryRepresentation;	// IMP=0x00100000001958ea
- (id)description;	// IMP=0x001000000019583b
@property(readonly, nonatomic) _Bool hasReportItemId;
- (id)additionalReportsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000001957f8
- (unsigned long long)additionalReportsCount;	// IMP=0x00100000001957db
- (void)addAdditionalReports:(id)arg1;	// IMP=0x0010000000195771
- (void)clearAdditionalReports;	// IMP=0x0010000000195754
...
- (int)StringAsGranularity:(id)arg1;	// IMP=0x00100000001955a4
- (id)granularityAsString:(int)arg1;	// IMP=0x001000000019555b
@property(nonatomic) _Bool hasGranularity;
@property(nonatomic) int granularity; // @synthesize granularity=_granularity;
- (int)StringAsType:(id)arg1;	// IMP=0x0010000000195425
- (id)typeAsString:(int)arg1;	// IMP=0x00100000001953dc
