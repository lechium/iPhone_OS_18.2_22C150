...
- (void).cxx_destruct;	// IMP=0x00200000000b7b5a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000b78fc
- (unsigned long long)hash;	// IMP=0x00100000000b7825
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b7695
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b752a
- (void)copyTo:(id)arg1;	// IMP=0x00100000000b7427
- (void)writeTo:(id)arg1;	// IMP=0x00100000000b7339
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000b732c
- (id)dictionaryRepresentation;	// IMP=0x00100000000b6ea2
- (id)description;	// IMP=0x00100000000b6df3
