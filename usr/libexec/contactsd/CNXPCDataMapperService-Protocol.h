...
@class CNChangeHistoryClearRequest, CNChangeHistoryFetchRequest, CNContact, CNContactFetchRequest, CNContainer, CNGeminiHandle, CNImageUtilsBitmapFormat, CNSaveRequest, NSArray, NSData, NSDictionary, NSNumber, NSPredicate, NSString;
