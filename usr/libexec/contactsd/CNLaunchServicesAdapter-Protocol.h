...
@class CNApplicationProxy, NSData, NSDictionary, NSNumber, NSString, NSURL;
...
- (void)defaultApplicationForDefaultAppCategory:(NSNumber *)arg1 withReply:(void (^)(CNApplicationProxy *, NSError *))arg2;
- (void)applicationsAvailableForDefaultAppCategory:(NSNumber *)arg1 withReply:(void (^)(NSArray *, NSError *))arg2;
