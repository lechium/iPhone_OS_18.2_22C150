...
+ (id)sharedInstance;	// IMP=0x002000000000e8dc
- (void).cxx_destruct;	// IMP=0x002000000000f405
...
- (void)willBecomeIdle:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000f18a
- (void)_updateAssetForAssetType:(id)arg1;	// IMP=0x001000000000f119
- (void)_refreshAssetCatalogForAssetType:(id)arg1 withOverrideTimeout:(id)arg2 forceCatalogRefresh:(_Bool)arg3;	// IMP=0x001000000000f07c
- (id)_managedAssetForAssetType:(id)arg1;	// IMP=0x001000000000ee68
- (void)run;	// IMP=0x001000000000ecfd
- (void)registerManagedAssets:(id)arg1;	// IMP=0x001000000000ec94
- (void)registerManagedAsset:(id)arg1;	// IMP=0x001000000000ec2b
- (id)_init;	// IMP=0x001000000000e964
