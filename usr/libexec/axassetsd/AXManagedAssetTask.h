...
+ (id)taskWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0020000000001b30
- (void).cxx_destruct;	// IMP=0x0020000000002417
...
- (_Bool)_deferIfNeeded;	// IMP=0x00100000000021e1
- (id)_restorationExitStatusForResult:(unsigned long long)arg1;	// IMP=0x00100000000021b6
- (void)_completeWithResult:(unsigned long long)arg1;	// IMP=0x0010000000001edd
@property(readonly, copy) NSString *description;
- (id)initWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000001bd5
