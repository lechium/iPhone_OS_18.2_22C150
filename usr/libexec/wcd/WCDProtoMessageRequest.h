...
- (void).cxx_destruct;	// IMP=0x0020000000029b70
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000029a08
- (unsigned long long)hash;	// IMP=0x001000000002992b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000297ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000029692
- (void)copyTo:(id)arg1;	// IMP=0x00100000000295b4
- (void)writeTo:(id)arg1;	// IMP=0x00100000000294c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000294b8
- (id)dictionaryRepresentation;	// IMP=0x0010000000028eed
- (id)description;	// IMP=0x0010000000028e3e
