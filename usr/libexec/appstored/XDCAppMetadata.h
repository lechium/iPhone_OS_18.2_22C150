...
- (void).cxx_destruct;	// IMP=0x00200000001df1be
- (unsigned long long)hash;	// IMP=0x00100000001ded72
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001de72c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001de0f1
- (void)writeTo:(id)arg1;	// IMP=0x00100000001ddc09
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001ddbfc
- (id)dictionaryRepresentation;	// IMP=0x00100000001dca2f
- (id)description;	// IMP=0x00100000001dc980
