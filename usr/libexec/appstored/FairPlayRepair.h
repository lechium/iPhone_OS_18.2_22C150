...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logKey:(id)arg3;	// IMP=0x00200000000c1be2
- (void).cxx_destruct;	// IMP=0x00200000000c1d01
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000c1bea
...
- (id)init;	// IMP=0x00100000000c1546
