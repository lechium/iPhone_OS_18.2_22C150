...
- (void)setShouldPostNotificationOnDefaultBrowserInstallation:(_Bool)arg1;
- (void)shouldPostNotificationOnDefaultBrowserInstallationWithReplyHandler:(void (^)(_Bool))arg1;
