...
- (void).cxx_destruct;	// IMP=0x00400000000855a0
@property(nonatomic, readonly) NSString *humanReadableReason;
@property(nonatomic, readonly) CDUnknownBlockType callbackHandler;
- (id)initWithReason:(long long)arg1 requestToken:(id)arg2 logKey:(id)arg3 callbackHandler:(CDUnknownBlockType)arg4 includeMetrics:(_Bool)arg5 isVPPLookup:(_Bool)arg6 userInitiated:(_Bool)arg7 targetedItemID:(id)arg8;	// IMP=0x00100000000851b0
- (id)initWithReason:(long long)arg1;	// IMP=0x00100000000850e0
- (id)init;	// IMP=0x0010000000085070
