...
@class ASDRepairOptions, ApplicationProxy, LogKey, NSArray, NSString;
@protocol ApplicationRepairDelegate;

@protocol ApplicationRepair <NSObject>
+ (_Bool)shouldAttemptToRepairApplication:(ApplicationProxy *)arg1 options:(ASDRepairOptions *)arg2 logKey:(LogKey *)arg3;
@property(readonly, nonatomic) NSString *repairType;
@property(retain, nonatomic) LogKey *logKey;
