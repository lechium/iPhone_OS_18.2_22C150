...
- (void).cxx_destruct;	// IMP=0x00200000001b14f8
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00100000001b0e64
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001b0d72
- (id)initWithEntityClass:(Class)arg1;	// IMP=0x00100000001b0ccd
