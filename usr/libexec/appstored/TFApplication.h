...
- (void).cxx_destruct;	// IMP=0x00200000002db273
- (unsigned long long)hash;	// IMP=0x00100000002db119
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002daf12
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002dad82
- (void)writeTo:(id)arg1;	// IMP=0x00100000002dabe5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002dabd8
- (id)dictionaryRepresentation;	// IMP=0x00100000002da51e
- (id)description;	// IMP=0x00100000002da46f
