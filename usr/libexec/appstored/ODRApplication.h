...
- (void).cxx_destruct;	// IMP=0x002000000026b6da
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000026af91
- (unsigned long long)hash;	// IMP=0x001000000026ae71
- (id)description;	// IMP=0x001000000026ad0b
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000026ac29
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000026aa17
