...
- (void).cxx_destruct;	// IMP=0x0020000000103d46
...
- (void)main;	// IMP=0x00100000000ff77a
- (void)completeWithError:(id)arg1;	// IMP=0x00100000000ff725
- (void)completeWithSuccess;	// IMP=0x00100000000ff5e0
@property(readonly, nonatomic) NSArray *jobResults;
- (id)initWithContext:(id)arg1;	// IMP=0x00100000000fe690
