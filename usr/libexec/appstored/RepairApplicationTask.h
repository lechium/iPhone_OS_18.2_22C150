...
- (void).cxx_destruct;	// IMP=0x0020000000157bb5
- (void)repair:(id)arg1 needsToReleaseBlockingCallerWithReason:(id)arg2;	// IMP=0x0010000000157b1e
- (void)repair:(id)arg1 wantsToRelaunchApplication:(id)arg2;	// IMP=0x00100000001578f9
- (void)main;	// IMP=0x0010000000156fe3
