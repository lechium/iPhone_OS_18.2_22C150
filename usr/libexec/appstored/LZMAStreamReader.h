...
- (void).cxx_destruct;	// IMP=0x002000000013cf08
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x001000000013cb43
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000013c860
- (void)open;	// IMP=0x001000000013c814
- (void)close;	// IMP=0x001000000013c7b2
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x001000000013c4f4
