...
- (void).cxx_destruct;	// IMP=0x00200000001e918f
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000001e8bc1
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000001e888c
- (void)close;	// IMP=0x00100000001e882a
- (void)open;	// IMP=0x00100000001e87de
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x00100000001e8622
