...
- (void).cxx_destruct;	// IMP=0x00200000002372e9
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0010000000237220
- (void)close;	// IMP=0x00100000002371d6
