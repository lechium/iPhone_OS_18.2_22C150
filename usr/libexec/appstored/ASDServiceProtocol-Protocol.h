...
@class ASDSupportedDialogHandlers;

@protocol ASDServiceProtocol <NSObject>
- (void)setSupportedNotificationDelivery:(ASDSupportedDialogHandlers *)arg1;
...
- (void)getSKANInteropServiceWithReplyHandler:(void (^)(id <SKANInteropServiceProtocol><NSXPCProxyCreating>, NSError *))arg1;
...
- (void)getAppCapabilitiesServiceWithReplyHandler:(void (^)(id <ASDAppCapabilitiesServiceProtocol><NSXPCProxyCreating>, NSError *))arg1;
