...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logKey:(id)arg3;	// IMP=0x00200000001071f9
- (void).cxx_destruct;	// IMP=0x0020000000107904
@property(retain, nonatomic) _TtC9appstored6LogKey *logKey; // @synthesize logKey=_logKey;
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001073a9
...
- (id)init;	// IMP=0x0010000000106f70
