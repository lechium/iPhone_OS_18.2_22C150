...
- (void)getSubscriptionEntitlementsForSegment:(unsigned long long)arg1 ignoreCaches:(_Bool)arg2 isBackground:(_Bool)arg3 requestingBundleId:(NSString *)arg4 withReplyHandler:(void (^)(NSArray *, _Bool, _Bool, NSError *))arg5;
