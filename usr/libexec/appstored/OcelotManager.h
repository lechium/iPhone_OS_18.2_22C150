...
- (void).cxx_destruct;	// IMP=0x002000000023576f
- (void)_handleRepairBundleIDNotification:(id)arg1;	// IMP=0x0010000000233c48
- (void)_handleNetworkStateDidChangeNotification:(id)arg1;	// IMP=0x0010000000233393
- (void)decorateMetricsEvent:(id)arg1 context:(id)arg2;	// IMP=0x0010000000231ea3
- (id)createMetricsEventsForEventType:(unsigned char)arg1 context:(id)arg2;	// IMP=0x0010000000231b3d
- (id)init;	// IMP=0x001000000022b5dc
