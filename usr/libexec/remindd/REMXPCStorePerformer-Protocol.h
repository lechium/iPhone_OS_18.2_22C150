...
- (void)batchDeleteExpiredRemindersWith:(NSNumber *)arg1 completion:(void (^)(NSError *))arg2;
- (void)permanentlyHideRemindersWith:(NSDictionary *)arg1 accountID:(REMObjectID *)arg2 completion:(void (^)(NSError *))arg3;
...
- (void)setOverridingGroceryCategorizationSecondaryGroceryLocales:(NSArray *)arg1 completion:(void (^)(NSArray *, NSError *))arg2;
...
- (void)fetchSuggestedSectionsForRemindersWithReminderTitles:(NSSet *)arg1 fromGroceryClassifierWithGroceryLocaleIDs:(NSArray *)arg2 maxSuggestionsCountPerReminderTitle:(NSNumber *)arg3 confidenceScoreThreshold:(NSNumber *)arg4 shouldUseGlobalCorrections:(_Bool)arg5 completion:(void (^)(REMGrocerySuggestions *, NSError *))arg6;
