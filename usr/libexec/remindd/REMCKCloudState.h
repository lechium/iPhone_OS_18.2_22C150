...
@class NSDate, REMCDBaseList, REMCDBaseSection, REMCDReminder, REMCDRootEntityObject, REMCDSavedAttachment, REMCDSavedReminder, REMCDTemplate;
...
+ (id)defaultRelationshipKeyPathsForPrefetching;	// IMP=0x0020000000076556
+ (id)fetchRequest;	// IMP=0x0010000000079bcb
- (_Bool)isInCloud;	// IMP=0x0040000000076544
...
@property(retain, nonatomic) REMCDBaseList *list; // @dynamic list;
