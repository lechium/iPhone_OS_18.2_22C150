...
- (void).cxx_destruct;	// IMP=0x0020000000077fd0
...
- (id)identifier;	// IMP=0x0010000000077f76
- (void)markAsExpanded;	// IMP=0x0010000000077f5f
- (id)childrenNodes;	// IMP=0x0010000000077b60
