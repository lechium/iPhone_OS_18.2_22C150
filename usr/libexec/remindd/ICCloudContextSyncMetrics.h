...
- (void).cxx_destruct;	// IMP=0x002000000004b315
...
- (void)finishWithSuccess:(_Bool)arg1;	// IMP=0x001000000004b169
- (id)dictionaryRepresentation;	// IMP=0x001000000004aa73
- (id)initWithSyncReason:(id)arg1;	// IMP=0x001000000004a9de
