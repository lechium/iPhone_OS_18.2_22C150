...
- (void).cxx_destruct;	// IMP=0x00200000000598ab
...
- (id)description;	// IMP=0x0010000000059749
- (void)_computeShouldPerformCloudSchemaCatchUpSyncFrom:(id)arg1 storeController:(id)arg2;	// IMP=0x00100000000594df
- (id)initWithAccountIdentifier:(id)arg1 syncReason:(id)arg2 schedulingStateStorage:(id)arg3 managedObjectContext:(id)arg4;	// IMP=0x00100000000592a4
