...
- (id)reminderIDsMergeableOrderingReplicaIDSourceWithAccountID:(id)arg1 listID:(id)arg2;	// IMP=0x0010000000070de8
- (void)migrateCRDTsInList:(id)arg1;	// IMP=0x00100000000706d0
- (void)migrateCRDTsInAccount:(id)arg1;	// IMP=0x00100000000700c7
- (void)migrateCRDTsInObject:(id)arg1;	// IMP=0x001000000007002f
- (void)migrateTokenResolutionMapInObject:(id)arg1;	// IMP=0x001000000006fea8
- (void)migrateStore:(id)arg1;	// IMP=0x001000000006f472
- (void)migrateStoreIfNeeded:(id)arg1 metadata:(id)arg2;	// IMP=0x001000000006f3b0
