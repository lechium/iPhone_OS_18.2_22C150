...
@interface _ICCloudConfigurationStorage : NSObject
{
    ...
    double _savedImageDeduplicationDefaultThrottleInterval;	// 416 = 0x1a0
    double _savedImageDeduplicationBackoffThrottleInterval;	// 424 = 0x1a8
    NSNumber *_savedImageDeduplicationRateReduceFactor;	// 432 = 0x1b0
    unsigned long long _savedImageDeduplicationApproximatePerRunDeleteLimit;	// 440 = 0x1b8
    double _suggestConversionToGroceryListDefaultThrottleInterval;	// 448 = 0x1c0
    NSNumber *_suggestConversionToGroceryListRateReduceFactor;	// 456 = 0x1c8
    NSNumber *_languageHypothesisThresholdForPrimaryLanguage;	// 464 = 0x1d0
    NSNumber *_languageHypothesisThresholdForAdditionalLanguages;	// 472 = 0x1d8
    NSNumber *_miniumumAutomaticLanguageConfidenceScoreAllowed;	// 480 = 0x1e0
    double _postAnalyticsDefaultThrottleInterval;	// 488 = 0x1e8
    NSNumber *_postAnalyticsRateReduceFactor;	// 496 = 0x1f0
    double _batchDeleteExpiredRemindersDefaultThrottleInterval;	// 504 = 0x1f8
    NSNumber *_batchDeleteExpiredRemindersRateReduceFactor;	// 512 = 0x200
    double _batchDeleteExpiredRemindersMinimumDeletionTimeInterval;	// 520 = 0x208
    NSDictionary *_minimumSearchTermLengthByBaseLanguage;	// 528 = 0x210
    unsigned long long _appStoreReviewCreatedOrCompletedRemindersCountThreshold;	// 536 = 0x218
    unsigned long long _appStoreReviewNumberOfForegroundsThreshold;	// 544 = 0x220
    double _appStoreReviewTimeIntervalOfInterest;	// 552 = 0x228
    double _appStoreReviewTimeIntervalSinceInitialForeground;	// 560 = 0x230
    double _appStoreReviewTimeIntervalSinceLastPrompt;	// 568 = 0x238
    double _appStoreReviewTimeIntervalSinceLastFetch;	// 576 = 0x240
    double _iCloudIsOffTimeIntervalSinceLastPrompt;	// 584 = 0x248
}

- (void).cxx_destruct;	// IMP=0x002000000004f315
...
@property double batchDeleteExpiredRemindersMinimumDeletionTimeInterval; // @synthesize batchDeleteExpiredRemindersMinimumDeletionTimeInterval=_batchDeleteExpiredRemindersMinimumDeletionTimeInterval;
@property(retain) NSNumber *batchDeleteExpiredRemindersRateReduceFactor; // @synthesize batchDeleteExpiredRemindersRateReduceFactor=_batchDeleteExpiredRemindersRateReduceFactor;
@property double batchDeleteExpiredRemindersDefaultThrottleInterval; // @synthesize batchDeleteExpiredRemindersDefaultThrottleInterval=_batchDeleteExpiredRemindersDefaultThrottleInterval;
@property(retain) NSNumber *postAnalyticsRateReduceFactor; // @synthesize postAnalyticsRateReduceFactor=_postAnalyticsRateReduceFactor;
@property double postAnalyticsDefaultThrottleInterval; // @synthesize postAnalyticsDefaultThrottleInterval=_postAnalyticsDefaultThrottleInterval;
@property(retain) NSNumber *miniumumAutomaticLanguageConfidenceScoreAllowed; // @synthesize miniumumAutomaticLanguageConfidenceScoreAllowed=_miniumumAutomaticLanguageConfidenceScoreAllowed;
@property(retain) NSNumber *languageHypothesisThresholdForAdditionalLanguages; // @synthesize languageHypothesisThresholdForAdditionalLanguages=_languageHypothesisThresholdForAdditionalLanguages;
@property(retain) NSNumber *languageHypothesisThresholdForPrimaryLanguage; // @synthesize languageHypothesisThresholdForPrimaryLanguage=_languageHypothesisThresholdForPrimaryLanguage;
@property(retain) NSNumber *suggestConversionToGroceryListRateReduceFactor; // @synthesize suggestConversionToGroceryListRateReduceFactor=_suggestConversionToGroceryListRateReduceFactor;
...
@property unsigned long long savedImageDeduplicationApproximatePerRunDeleteLimit; // @synthesize savedImageDeduplicationApproximatePerRunDeleteLimit=_savedImageDeduplicationApproximatePerRunDeleteLimit;
@property(retain) NSNumber *savedImageDeduplicationRateReduceFactor; // @synthesize savedImageDeduplicationRateReduceFactor=_savedImageDeduplicationRateReduceFactor;
@property double savedImageDeduplicationBackoffThrottleInterval; // @synthesize savedImageDeduplicationBackoffThrottleInterval=_savedImageDeduplicationBackoffThrottleInterval;
@property double savedImageDeduplicationDefaultThrottleInterval; // @synthesize savedImageDeduplicationDefaultThrottleInterval=_savedImageDeduplicationDefaultThrottleInterval;
...
// Error: Property attributes should begin with the type ('T') attribute, property name: extraneousAlarmsCollectorThrottleInterval
...
- (void)downloadRemoteConfiguration;	// IMP=0x001000000004eb08
