...
- (void).cxx_destruct;	// IMP=0x0020000000005980
...
- (void)_cancelFireRequests;	// IMP=0x001000000000584f
- (void)cancelPreviousFireRequests;	// IMP=0x00100000000057c8
@property(readonly, nonatomic) _Bool isScheduledToFire;
- (void)callTargetSelector;	// IMP=0x001000000000550e
- (void)fireImmediately;	// IMP=0x00100000000053f7
- (void)requestFire;	// IMP=0x00100000000050bc
- (void)dealloc;	// IMP=0x0010000000005017
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 delay:(double)arg3 waitToFireUntilRequestsStop:(_Bool)arg4 callOnMainThread:(_Bool)arg5;	// IMP=0x0010000000004f02
