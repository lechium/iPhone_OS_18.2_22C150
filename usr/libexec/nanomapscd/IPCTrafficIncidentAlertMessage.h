...
- (void).cxx_destruct;	// IMP=0x0020000000018671
...
- (id)description;	// IMP=0x001000000001845e
- (id)dictionaryValue;	// IMP=0x001000000001822e
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001809f
