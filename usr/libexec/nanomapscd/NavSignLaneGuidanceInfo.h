...
+ (struct _NSRange)highlightedLaneRangeForLanes:(id)arg1;	// IMP=0x0040000000013950
+ (id)_createFakeLanes;	// IMP=0x0010000000012fcb
+ (id)fakeInfoForManeuver:(_Bool)arg1;	// IMP=0x0010000000012e99
- (void).cxx_destruct;	// IMP=0x0020000000013c98
...
- (id)highlightedLanes;	// IMP=0x0010000000013c32
@property(readonly, nonatomic) struct _NSRange highlightedLaneRange;
@property(readonly, nonatomic) _Bool isForMidStep;
- (id)description;	// IMP=0x00100000000137a1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000136d3
- (id)initWithLaneInfoId:(id)arg1 lanes:(id)arg2 forManeuver:(_Bool)arg3 midStepTitles:(id)arg4 details:(id)arg5;	// IMP=0x00100000000135bd
- (id)initWithLaneInfoId:(id)arg1 lanes:(id)arg2;	// IMP=0x0010000000013591
- (id)initWithGuidanceLaneInfo:(id)arg1;	// IMP=0x00100000000130e2
