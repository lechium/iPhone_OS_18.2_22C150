...
+ (id)updatedGuidanceWithPreviousGuidance:(id)arg1 currentGuidance:(id)arg2;	// IMP=0x0040000000030ffc
- (void).cxx_destruct;	// IMP=0x0020000000032237
...
- (void)_setNeedsChangeNotification;	// IMP=0x0010000000031f67
- (void)_notifyObserversWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000031e30
- (id)description;	// IMP=0x00100000000317d1
- (void)removeGuidanceObserver:(id)arg1;	// IMP=0x00100000000317bb
- (void)addGuidanceObserver:(id)arg1;	// IMP=0x00100000000317a5
- (_Bool);	// IMP=0x00100000000316a3
- (_Bool)matchesManeuver:(int)arg1 minorTextAlternatives:(id)arg2 shieldInfo:(id)arg3;	// IMP=0x0010000000031510
@property(retain, nonatomic) MKServerFormattedString *minorText;
@property(retain, nonatomic) MKServerFormattedString *majorText;
- (id)initWithSignID:(id)arg1 maneuverArtwork:(id)arg2 majorTextAlternatives:(id)arg3 minorTextAlternatives:(id)arg4 shieldInfo:(id)arg5;	// IMP=0x001000000003117c
