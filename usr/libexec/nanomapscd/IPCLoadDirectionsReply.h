...
- (void).cxx_destruct;	// IMP=0x0020000000037c22
@property(copy, nonatomic) NSError *error; // @synthesize error=_error;
- (id);	// IMP=0x0010000000037c00
...
- (id)description;	// IMP=0x0010000000037b0d
- (id)dictionaryValue;	// IMP=0x001000000003796d
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000377e8
