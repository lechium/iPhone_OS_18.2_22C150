...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x004000000003dcdd
- (void).cxx_destruct;	// IMP=0x002000000003e319
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x001000000003e191
- (id)description;	// IMP=0x001000000003e0e2
- (id)dictionaryValue;	// IMP=0x001000000003df12
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000003dd2f
