...
+ (id)ipcMessageForShieldInfo:(id)arg1;	// IMP=0x002000000003ef32
- (void).cxx_destruct;	// IMP=0x002000000003804d
...
- (id)dictionaryValue;	// IMP=0x0010000000037d58
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000037c35
- (id)shieldInfo;	// IMP=0x001000000003f000
