...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000030465
+ (id)requestWithTraceAtPath:(id)arg1;	// IMP=0x0010000000030063
+ (id)requestForPlaceholderDirections;	// IMP=0x001000000002fd79
+ (id)requestForDirectionsWithCompanionRouteDetails:(id)arg1 companionRouteContext:(id)arg2;	// IMP=0x001000000002fbfe
+ (id)requestForDirectionsToCustomRoute:(id)arg1 currentLocation:(id)arg2 companionRouteContext:(id)arg3;	// IMP=0x001000000002fa44
+ (id)requestWithWaypoints:(id)arg1 viaTransportType:(int)arg2 traits:(id)arg3 companionRouteContext:(id)arg4;	// IMP=0x001000000002f946
- (void).cxx_destruct;	// IMP=0x0020000000030f55
...
- (id)debugDescription;	// IMP=0x0010000000030bbd
- (id)description;	// IMP=0x0010000000030a8d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000030881
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003046d
- (void)_populateCopy:(id)arg1;	// IMP=0x0010000000030392
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003035e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003032a
- (id)snapshot;	// IMP=0x001000000002ffe1
...
- (id)requestedCompanionRouteDetails;	// IMP=0x001000000002fdca
- (id)init;	// IMP=0x001000000002f814
- (void)_addTimepointIfNeededToRouteAttributes:(id)arg1;	// IMP=0x001000000001fefc
- (void)_populateRouteAttributes:(id)arg1 forTransportType:(int)arg2;	// IMP=0x001000000001fdc3
- (id)routeAttributes;	// IMP=0x001000000001fd60
