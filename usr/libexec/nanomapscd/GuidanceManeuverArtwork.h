...
+ (id)artworkWithManeuver:(int)arg1;	// IMP=0x0040000000016c31
- (void).cxx_destruct;	// IMP=0x0020000000016f79
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000016e06
- (unsigned long long)hash;	// IMP=0x0010000000016d9e
...
- (id)initWithManeuver:(int)arg1 junction:(id)arg2 drivingSide:(int)arg3 artworkDataSource:(id)arg4;	// IMP=0x0010000000016c66
- (_Bool)isValue:(id)arg1 equalTo:(id)arg2;	// IMP=0x0010000000016b97
