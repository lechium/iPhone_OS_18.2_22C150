...
+ (Class)localizationHeadersType;	// IMP=0x0020000000052c8c
+ (Class)baseHeadersType;	// IMP=0x0010000000052b90
- (void).cxx_destruct;	// IMP=0x0020000000054913
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000005447d
- (unsigned long long)hash;	// IMP=0x0010000000054342
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000054133
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000053cd6
- (void)copyTo:(id)arg1;	// IMP=0x0010000000053a7e
- (void)writeTo:(id)arg1;	// IMP=0x001000000005376d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000053760
- (id)dictionaryRepresentation;	// IMP=0x0010000000052def
- (id)description;	// IMP=0x0010000000052d40
- (_Bool);	// IMP=0x0010000000052d2c
...
- (id)localizationHeadersAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000052c6f
- (unsigned long long)localizationHeadersCount;	// IMP=0x0010000000052c52
- (void)addLocalizationHeaders:(id)arg1;	// IMP=0x0010000000052be8
- (void)clearLocalizationHeaders;	// IMP=0x0010000000052bcb
@property(readonly, nonatomic) _Bool hasLocalizationURL;
@property(readonly, nonatomic) _Bool hasCachedBaseETag;
- (id)baseHeadersAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000052b73
- (unsigned long long)baseHeadersCount;	// IMP=0x0010000000052b56
- (void)addBaseHeaders:(id)arg1;	// IMP=0x0010000000052aec
- (void)clearBaseHeaders;	// IMP=0x0010000000052acf
