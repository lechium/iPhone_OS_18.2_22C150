...
+ (id)fromProto:(id)arg1;	// IMP=0x004000000000742a
+ (id)toProto:(id)arg1;	// IMP=0x00100000000072ef
- (void).cxx_destruct;	// IMP=0x00200000000075b6
...
- (id)init;	// IMP=0x00100000000072c0
