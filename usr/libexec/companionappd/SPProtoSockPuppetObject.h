...
- (void).cxx_destruct;	// IMP=0x0020000000005fc7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000005cd5
- (unsigned long long)hash;	// IMP=0x0010000000005976
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000056eb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000054f2
- (void)copyTo:(id)arg1;	// IMP=0x0010000000005350
- (void)writeTo:(id)arg1;	// IMP=0x001000000000518d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000005180
- (id)dictionaryRepresentation;	// IMP=0x00100000000046bb
- (id)description;	// IMP=0x001000000000460c
