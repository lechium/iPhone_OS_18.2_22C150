...
+ (id)fromProto:(id)arg1;	// IMP=0x0040000000003036
+ (id)toProto:(id)arg1;	// IMP=0x0010000000002e22
- (void).cxx_destruct;	// IMP=0x00200000000032f1
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000002b1a
- (id)init;	// IMP=0x0010000000002aeb
