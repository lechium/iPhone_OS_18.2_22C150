...
+ (id)sharedInstance;	// IMP=0x0040000000002768
...
- (void)updatePowerLogs;	// IMP=0x0010000000002a59
- (id)newEventFromEvent:(id)arg1 usingLogEvent:(id)arg2;	// IMP=0x0010000000002883
- (void)logEvent:(id)arg1 withName:(id)arg2;	// IMP=0x001000000000287d
- (void)startLogUpdateTimer;	// IMP=0x0010000000002877
- (void)cancelLogUpdateTimer;	// IMP=0x0010000000002841
