...
- (long long)compareByCount:(id)arg1;	// IMP=0x001000000008f79b
- (id)initWithErrorCode:(unsigned long long)arg1 count:(unsigned long long)arg2 errorLine:(unsigned long long)arg3;	// IMP=0x001000000008f748
