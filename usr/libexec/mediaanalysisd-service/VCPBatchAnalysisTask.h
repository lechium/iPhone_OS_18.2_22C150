...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x00400000000cc3ee
- (void).cxx_destruct;	// IMP=0x00200000000cd686
...
- (int)mainInternal;	// IMP=0x00100000000ccb45
- (_Bool)containsAsset:(id)arg1;	// IMP=0x00100000000cc8d1
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x00100000000cc833
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x00100000000cc453
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000cc31e
