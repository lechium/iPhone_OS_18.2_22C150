...
+ (id)taskWithPhotoLibrary:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x004000000015410d
- (void).cxx_destruct;	// IMP=0x0020000000155e92
- (_Bool)run:(id *)arg1;	// IMP=0x0010000000154883
- (void)publishResults:(id)arg1;	// IMP=0x00100000001541c5
- (id)initWithPhotoLibrary:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000153dfe
