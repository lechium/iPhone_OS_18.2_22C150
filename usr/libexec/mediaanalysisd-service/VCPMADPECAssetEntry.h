...
@class NSDate, NSDictionary, PHAsset;

@interface VCPMADPECAssetEntry : NSObject
{
    int _status;	// 8 = 0x8
    int _version;	// 12 = 0xc
    ...
    NSDictionary *_result;	// 56 = 0x38
}

+ (id)entryWithAsset:(id)arg1 previousStatus:(unsigned long long)arg2 previousAttempts:(unsigned long long)arg3 andLastAttemptDate:(id)arg4;	// IMP=0x004000000009c558
- (void).cxx_destruct;	// IMP=0x002000000009c654
...
- (id)initWithAsset:(id)arg1 previousStatus:(unsigned long long)arg2 previousAttempts:(unsigned long long)arg3 andLastAttemptDate:(id)arg4;	// IMP=0x001000000009c474
