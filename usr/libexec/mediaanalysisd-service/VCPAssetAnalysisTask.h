...
+ (id)taskWithAnalysisTypes:(unsigned long long)arg1 forAsset:(id)arg2 withExistingAnalysis:(id)arg3;	// IMP=0x00400000000bd281
...
- (int)mainInternal;	// IMP=0x00100000000bde7e
- (void)_reportCoreAnalyticsWithAsset:(id)arg1 analysis:(id)arg2 analysisStatus:(long long)arg3 processingInterval:(double)arg4 extendedAnalysisStatus:(id)arg5;	// IMP=0x00100000000bd819
- (void)publishLivePhotoEffectsAnalysis:(id)arg1 toAsset:(id)arg2;	// IMP=0x00100000000bd3b9
@property(readonly, nonatomic) double cost;
- (id)initWithAnalysisTypes:(unsigned long long)arg1 forAsset:(id)arg2 withExistingAnalysis:(id)arg3;	// IMP=0x00100000000bd144
