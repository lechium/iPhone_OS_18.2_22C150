...
+ (id)entryWithLocalIdentifier:(id)arg1 requestDate:(id)arg2;	// IMP=0x004000000005f1b4
- (void).cxx_destruct;	// IMP=0x002000000005f260
...
- (id)initWithLocalIdentifier:(id)arg1 requestDate:(id)arg2;	// IMP=0x001000000005f11b
