...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x00400000000b378a
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x00100000000b36cc
- (void).cxx_destruct;	// IMP=0x00200000000b3683
...
- (id)description;	// IMP=0x00100000000b3594
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x00100000000b3475
