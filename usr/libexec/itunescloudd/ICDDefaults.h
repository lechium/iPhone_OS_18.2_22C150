...
+ (id)daemonDefaults;	// IMP=0x002000000002720d
- (void).cxx_destruct;	// IMP=0x00200000000271e5
...
- (void)_setOrRemoveObject:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000002710b
- (id)_init;	// IMP=0x001000000002701b
