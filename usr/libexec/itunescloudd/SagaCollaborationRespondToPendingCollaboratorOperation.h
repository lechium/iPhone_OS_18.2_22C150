...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000045439
- (void).cxx_destruct;	// IMP=0x0020000000045207
...
- (void)start;	// IMP=0x0010000000044ec7
- (_Bool)isPersistent;	// IMP=0x0010000000044ebf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000044dff
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000044d2d
- (id)description;	// IMP=0x0010000000044cba
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 persistentID:(long long)arg3 socialProfileID:(id)arg4 approval:(_Bool)arg5;	// IMP=0x0010000000044c16
