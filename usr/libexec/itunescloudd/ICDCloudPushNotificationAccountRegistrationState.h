...
- (void).cxx_destruct;	// IMP=0x0020000000117fda
...
- (id)dictionaryRepresentation;	// IMP=0x0010000000117f2a
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000117e87
