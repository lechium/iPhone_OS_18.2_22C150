...
+ (id)eTagValueFromContentTasteResponse:(id)arg1;	// IMP=0x0040000000054652
- (void).cxx_destruct;	// IMP=0x002000000005462a
...
- (id)initWithContentTasteResponse:(id)arg1;	// IMP=0x0010000000054535
