...
- (void).cxx_destruct;	// IMP=0x00200000000802ae
...
- (id)debugDescription;	// IMP=0x00100000000800c3
- (_Bool)isValid;	// IMP=0x00100000000800ba
- (id)initWithSong:(id)arg1;	// IMP=0x001000000007fd18
