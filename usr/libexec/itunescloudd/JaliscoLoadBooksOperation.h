...
- (void).cxx_destruct;	// IMP=0x00200000000e2e1d
...
- (id)metadataFilter;	// IMP=0x00100000000e2d93
- (id)queryFilter;	// IMP=0x00100000000e2d26
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x00100000000e2d03
- (void)main;	// IMP=0x00100000000e2613
