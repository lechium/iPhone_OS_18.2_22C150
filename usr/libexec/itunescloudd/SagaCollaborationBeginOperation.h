...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000022e19
...
- (void)start;	// IMP=0x00100000000225cb
- (_Bool)isPersistent;	// IMP=0x00100000000225c3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000022523
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000022480
- (id)description;	// IMP=0x0010000000022438
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 playlistPersistentID:(long long)arg3 sharingMode:(unsigned long long)arg4;	// IMP=0x00100000000223e2
