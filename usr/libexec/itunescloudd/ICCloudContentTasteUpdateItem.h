...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000b8b9e
- (void).cxx_destruct;	// IMP=0x00200000000b8b60
...
- (unsigned long long)hash;	// IMP=0x00100000000b5682
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b549d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000b53c7
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000b523b
- (id)description;	// IMP=0x00100000000b5159
- (id)initWithGlobalPlaylistID:(id)arg1 contentTaste:(long long)arg2 configuration:(id)arg3;	// IMP=0x00100000000b5010
- (id)initWithStoreItemID:(long long)arg1 mediaContentTasteItem:(long long)arg2 contentTaste:(long long)arg3 configuration:(id)arg4 timeStamp:(id)arg5;	// IMP=0x00100000000b4ee1
