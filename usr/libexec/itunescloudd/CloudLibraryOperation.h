...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000969b4
- (void).cxx_destruct;	// IMP=0x002000000009691d
...
- (id)description;	// IMP=0x00100000000967f1
- (void);	// IMP=0x0010000000096759
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000009667d
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x0010000000096523
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000964c1
- (id)init;	// IMP=0x0010000000096481
