...
- (void).cxx_destruct;	// IMP=0x00200000000a6292
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000a60fe
- (unsigned long long)hash;	// IMP=0x00100000000a602c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000a5eb2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a5d85
- (void)writeTo:(id)arg1;	// IMP=0x00100000000a5c9c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000a59bd
- (id)dictionaryRepresentation;	// IMP=0x00100000000a5826
- (id)description;	// IMP=0x00100000000a5777
