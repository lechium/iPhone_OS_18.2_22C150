...
- (void).cxx_destruct;	// IMP=0x002000000005651e
...
- (void)main;	// IMP=0x0010000000055f8b
- (id)initWithConfiguration:(id)arg1 cloudIDs:(id)arg2;	// IMP=0x0010000000055e69
- (id)initWithCloudIDs:(id)arg1;	// IMP=0x0010000000055e05
