...
- (void).cxx_destruct;	// IMP=0x0020000000083dd2
...
- (id)debugDescription;	// IMP=0x0010000000083b85
- (float)legacyScore;	// IMP=0x0010000000083a6f
...
- (id)initWithContentItemSnapshot:(id)arg1;	// IMP=0x0010000000083770
