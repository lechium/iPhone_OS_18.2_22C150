...
- (void).cxx_destruct;	// IMP=0x00200000000ff3a2
...
- (void)disconnect;	// IMP=0x00100000000ff2e8
- (void)connectWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000ff1df
- (void)_onQueue_sendRequest:(id)arg1 withInternalResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fe540
- (void)sendRequest:(id)arg1 withResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fe462
@property(readonly, nonatomic) ICUserIdentityStore *userIdentityStore;
@property(readonly, nonatomic) ICUserIdentity *userIdentity;
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000fe33b
