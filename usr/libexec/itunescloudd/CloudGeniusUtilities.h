...
- (void).cxx_destruct;	// IMP=0x00200000000a82df
...
- (void)_initializeMappings;	// IMP=0x00100000000a6ffc
- (id)geniusValueForML3ContainerProperty:(id)arg1 value:(id)arg2;	// IMP=0x00100000000a6f77
- (id)geniusPlaylistPropertyForML3ContainerProperty:(id)arg1;	// IMP=0x00100000000a6f61
- (id)geniusValueForML3TrackProperty:(id)arg1 value:(id)arg2;	// IMP=0x00100000000a6edc
- (id)geniusTrackPropertyForML3TrackProperty:(id)arg1;	// IMP=0x00100000000a6ec6
- (id)init;	// IMP=0x00100000000a6e7a
