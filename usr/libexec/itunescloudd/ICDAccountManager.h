...
- (void).cxx_destruct;	// IMP=0x00200000001331cd
...
- (void)_updateStateWithChange:(id)arg1;	// IMP=0x00100000001330d8
- (id)_buildStateChange;	// IMP=0x0010000000132ecd
...
- (void)changeLibraryManagementPolicy:(long long)arg1;	// IMP=0x00100000001328f7
- (void)updateState;	// IMP=0x00100000001326eb
- (id)initWithLibraryManagementPolicy:(long long)arg1;	// IMP=0x00100000001324a1
