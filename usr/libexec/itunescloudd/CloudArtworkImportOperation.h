...
- (void).cxx_destruct;	// IMP=0x00200000000d8ff7
...
- (id)_resizedImageDataFromLocation:(id)arg1;	// IMP=0x00100000000d8bc8
- (void)cancel;	// IMP=0x00100000000d8b6f
- (void)start;	// IMP=0x00100000000d812e
- (id)description;	// IMP=0x00100000000d80a0
- (void)callCompletionHandlers;	// IMP=0x00100000000d7f11
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000d7e73
- (id)initWithURLSession:(id)arg1 configuration:(id)arg2 cloudID:(unsigned long long)arg3 artworkToken:(id)arg4 artworkType:(long long)arg5 sourceType:(long long)arg6 clientIdentity:(id)arg7;	// IMP=0x00100000000d7d4a
