...
- (unsigned long long)estimatedSpeechEndHostTimeWithLastAudioChunkHostTime:(unsigned long long)arg1;	// IMP=0x0010000000005f09
- (unsigned long long)estimatedSpeechEndHostTime;	// IMP=0x0010000000005ef3
- (void)notifyTrailingSilenceDurationAtEndpoint:(double)arg1;	// IMP=0x0010000000005dca
- (void)addNumSamples:(unsigned long long)arg1 hostTime:(unsigned long long)arg2;	// IMP=0x0010000000005dbc
- (void)reset;	// IMP=0x0010000000005da3
- (id)init;	// IMP=0x0010000000005d57
