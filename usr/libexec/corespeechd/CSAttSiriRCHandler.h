...
- (void).cxx_destruct;	// IMP=0x00200000000ac98f
...
- (void)getMitigationDecisionForRCIdWithCompletion:(unsigned long long)arg1 requestId:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000ac7fb
- (void)processRCWithId:(unsigned long long)arg1 requestId:(id)arg2 speechPackage:(id)arg3 taskId:(id)arg4 forceAccept:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00100000000ac3e7
- (void)addResultCandidateReceiver:(id)arg1;	// IMP=0x00100000000ac35a
- (id)initWithEndpointerNode:(id)arg1 uresNode:(id)arg2;	// IMP=0x00100000000ac1e4
