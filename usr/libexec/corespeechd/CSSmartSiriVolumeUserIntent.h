...
- (double)applyLowerAndUpperBoundsToVolumeOffset:(float)arg1;	// IMP=0x00100000000db7fb
- (void)storeASVStateInformation;	// IMP=0x00100000000db7a8
- (float)decreaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000db787
- (float)increaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000db766
- (void)initWithStoredInformationAndAsset:(id)arg1;	// IMP=0x00100000000db623
- (double)applyLowerAndUpperBoundsToVolume:(float)arg1;	// IMP=0x00100000000db51b
