...
- (void).cxx_destruct;	// IMP=0x00200000000d914a
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000d8fe6
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5 isFileLoadedBuffer:(_Bool)arg6;	// IMP=0x00100000000d8f2e
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000d8f28
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000d8f22
- (void)stopAudioStream;	// IMP=0x00100000000d8ed0
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000d8e7e
- (_Bool)isRecording;	// IMP=0x00100000000d8de9
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000d8dba
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000d8d8b
- (void)stop;	// IMP=0x00100000000d8d39
- (void)start;	// IMP=0x00100000000d8ce7
- (void)dealloc;	// IMP=0x00100000000d8c2d
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000d8b3b
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000d8aa6
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000d8a51
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000d8a49
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000d88df
