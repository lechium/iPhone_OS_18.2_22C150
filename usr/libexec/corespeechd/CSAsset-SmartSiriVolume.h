...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x00100000000443af
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x001000000004434b
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x00100000000442f9
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0010000000044295
+ (_Bool)supportsMultiPhraseVoiceTriggerForEngineVersion:(id)arg1 engineMinorVersion:(id)arg2 accessoryRTModelType:(id)arg3;	// IMP=0x001000000004e103
@property(readonly, nonatomic) NSDictionary *SSVParameterDirectionary;
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x00100000000437a8
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x0010000000040366
- (id)_userSelectedPhraseTypeToRTModelPhraseType:(id)arg1;	// IMP=0x001000000004ddda
- (_Bool)_allowMultiPhrase:(id)arg1 forceSkipEngineVersionCheck:(_Bool)arg2;	// IMP=0x001000000004dc1d
- (id)_rtModelWithRequestOptions:(id)arg1 accessoryBlobs:(id)arg2;	// IMP=0x001000000004d931
- (id)_getFilteredAccessoryRTBlobListForRequestOptions:(id)arg1 accessoryBlobs:(id)arg2 forceSkipEngineVersionCheck:(_Bool)arg3;	// IMP=0x001000000004d734
- (id)_splitBlobsByPhraseType:(id)arg1;	// IMP=0x001000000004d335
- (id)_buildRTModelWithBlobConfig:(id)arg1 requestOptions:(id)arg2;	// IMP=0x001000000004cd0d
- (id)_sha256:(id)arg1;	// IMP=0x001000000004cc55
- (id)_sha1:(id)arg1;	// IMP=0x001000000004cb6a
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000004c969
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000004c935
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000004c91c
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000004c903
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000004c8ea
- (id)hearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x001000000004c8d8
- (id)rtModelWithRequestOptions:(id)arg1;	// IMP=0x001000000004c6e3
- (id)latestHearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x001000000004c20c
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000004c1a6
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x001000000004c11d
...
- (long long)multiUserDeltaScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000086e39
@property(readonly, nonatomic) long long multiUserConfidentScoreThreshold;
- (long long)multiUserConfidentScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000086cfd
@property(readonly, nonatomic) long long multiUserHighScoreThreshold;
- (long long)multiUserHighScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000086bc1
@property(readonly, nonatomic) long long multiUserLowScoreThreshold;
- (long long)multiUserLowScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000086a85
@property(readonly, nonatomic) float satScoreThreshold;
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x001000000008694f
- (id)getPhraseConfig:(unsigned long long)arg1;	// IMP=0x001000000008683f
