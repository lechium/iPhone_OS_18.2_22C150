...
+ (id)sharedMonitor;	// IMP=0x0040000000026aae
- (void).cxx_destruct;	// IMP=0x0020000000026a0e
@property(nonatomic) __weak id <CSVoiceTriggerAssetChangeDelegate> delegate; // @synthesize delegate=_delegate;
- (void)notifyVoiceTriggerAssetChanged;	// IMP=0x00100000000269d6
- (void)startMonitoring;	// IMP=0x0010000000026924
- (id)init;	// IMP=0x00100000000268c5
