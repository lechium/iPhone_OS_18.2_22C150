...
+ (id)localDeviceProtocolInfo;	// IMP=0x004000000005edb6
+ (id)defaultProtocolInfo;	// IMP=0x001000000005ed6b
- (void).cxx_destruct;	// IMP=0x002000000005ed38
...
- (id)description;	// IMP=0x001000000005ecc4
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x001000000005e9eb
- (id)initWithProtocolVersion:(unsigned long long)arg1 buildVersion:(id)arg2 deviceProductVersion:(id)arg3 deviceProductType:(id)arg4 deviceCategory:(unsigned long long)arg5;	// IMP=0x001000000005e91f
