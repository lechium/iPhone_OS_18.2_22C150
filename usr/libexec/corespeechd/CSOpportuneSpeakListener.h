...
- (void).cxx_destruct;	// IMP=0x00200000000503f7
...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2 clientProcessedAudioTimeMS:(float)arg3;	// IMP=0x001000000004fede
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x001000000004fed8
- (_Bool)_shouldReportBoron;	// IMP=0x001000000004fea0
- (_Bool)_popRemoteVADSignal;	// IMP=0x001000000004fe21
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x001000000004fd9b
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x001000000004f9e8
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectedly:(long long)arg2;	// IMP=0x001000000004f939
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000004f922
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000004f71f
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000004f28d
- (void)_resetAlignBuffer;	// IMP=0x001000000004f264
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000004ed7b
- (id)init;	// IMP=0x001000000004ec57
