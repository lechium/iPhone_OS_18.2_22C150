...
- (void).cxx_destruct;	// IMP=0x00200000000184db
...
- (id)description;	// IMP=0x001000000001843e
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x001000000001839d
