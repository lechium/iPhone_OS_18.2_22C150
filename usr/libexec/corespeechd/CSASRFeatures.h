...
+ (id)initialResultCandidateFeatures;	// IMP=0x00400000000091c6
+ (id)initialASRFeatures;	// IMP=0x001000000000916f
- (void).cxx_destruct;	// IMP=0x0020000000009147
...
- (id)dictionary;	// IMP=0x0010000000008e80
- (id)description;	// IMP=0x0010000000008dca
- (id)initWithWordCount:(long long)arg1 trailingSilenceDuration:(long long)arg2 eosLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6 processedAudioDurationInMilliseconds:(long long)arg7 acousticEndpointerScore:(double)arg8;	// IMP=0x0010000000008ce6
