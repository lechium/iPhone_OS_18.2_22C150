...
+ (_Bool)supportAttentionLostAndGain;	// IMP=0x00200000000efdc5
- (void).cxx_destruct;	// IMP=0x00200000000efe57
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000efdf3
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000efded
- (void)stop;	// IMP=0x00100000000efde7
- (void)pause;	// IMP=0x00100000000efde1
- (void)start;	// IMP=0x00100000000efddb
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000efdcd
