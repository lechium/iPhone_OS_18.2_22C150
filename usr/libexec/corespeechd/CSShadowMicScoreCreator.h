...
- (void).cxx_destruct;	// IMP=0x00200000000d5bfd
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x00100000000d58ed
- (void)_calculateSpeechVoicingLevel;	// IMP=0x00100000000d565a
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x00100000000d5615
- (void)calculateShadowMicScore;	// IMP=0x00100000000d51f2
- (void)addDataToBuffer:(id)arg1;	// IMP=0x00100000000d51dc
- (id)init;	// IMP=0x00100000000d5155
