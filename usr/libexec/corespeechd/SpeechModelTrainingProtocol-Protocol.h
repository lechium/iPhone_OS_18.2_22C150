...
- (void)xpcExitClean;
- (void)generateConfusionPairsWithUUID:(NSString *)arg1 parameters:(NSDictionary *)arg2 language:(NSString *)arg3 task:(NSString *)arg4 samplingRate:(unsigned long long)arg5 recognizedNbest:(NSArray *)arg6 recognizedText:(NSString *)arg7 correctedText:(NSString *)arg8 selectedAlternatives:(NSArray *)arg9 completion:(void (^)(NSArray *, NSError *))arg10;
