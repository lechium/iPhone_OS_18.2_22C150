...
- (void).cxx_destruct;	// IMP=0x00200000000e0812
...
- (void)dispatchStateChangedFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x00100000000e02d9
- (void)notifyObserver:(id)arg1 didChangeStateFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x00100000000e01f9
- (void)notifyObserver:(id)arg1 didReceiveNotificationWithToken:(int)arg2;	// IMP=0x00100000000e00f7
- (id)initWithDelegate:(id)arg1;	// IMP=0x00100000000dff83
