...
@class AFSpeechInfoPackage, AFSpeechPackage, AFVoiceIdScoreCard, NSArray, NSDictionary, NSError, NSString, SMTContinuityEnd, SMTMultiUserTRPCandidate, SMTTRPCandidate, SMTTRPDetected;
