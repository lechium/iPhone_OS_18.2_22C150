...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000acfd7
- (void).cxx_destruct;	// IMP=0x00200000000acfc7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000acf0b
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000ace1b
- (id)initWithVolumeEstimate:(float)arg1 debugLogFile:(id)arg2;	// IMP=0x00100000000acda0
