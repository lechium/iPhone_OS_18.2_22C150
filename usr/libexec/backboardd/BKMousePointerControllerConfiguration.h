...
@interface BKMousePointerControllerConfiguration : NSObject
{
    ...
    double _mainDisplayCornerRadius;	// 136 = 0x88
}

- (void).cxx_destruct;	// IMP=0x002000000005712d
@property(nonatomic) double mainDisplayCornerRadius; // @synthesize mainDisplayCornerRadius=_mainDisplayCornerRadius;
