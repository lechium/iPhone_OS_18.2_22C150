...
- (void).cxx_destruct;	// IMP=0x00200000000a9a8a
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x00100000000a9839
- (void)activate;	// IMP=0x00100000000a9823
- (id)initWithSentinel:(id)arg1;	// IMP=0x00100000000a96c2
