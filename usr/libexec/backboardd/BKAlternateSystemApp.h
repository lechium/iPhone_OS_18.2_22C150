...
+ (id)_bundleInfoOverrides;	// IMP=0x002000000002eb9b
- (void).cxx_destruct;	// IMP=0x002000000002e92d
...
- (void)_noteExitedWithContext:(id)arg1;	// IMP=0x001000000002e783
- (_Bool)terminate;	// IMP=0x001000000002e558
- (_Bool)launchWithResultBlock:(CDUnknownBlockType)arg1 exitBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000002d1c7
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000002d130
@property(readonly, copy) NSString *description;
- (id)initWithBundleId:(id)arg1 options:(id)arg2 queue:(id)arg3;	// IMP=0x001000000002d050
