...
- (void).cxx_destruct;	// IMP=0x00200000000384e2
- (struct CGPoint)currentTranslation;	// IMP=0x00100000000384ca
- (_Bool)isComplete;	// IMP=0x00100000000384a8
- (void)applyForTime:(double)arg1;	// IMP=0x0010000000038413
- (id)initWithRelativeTranslation:(struct CGPoint)arg1 animationSettings:(id)arg2;	// IMP=0x00100000000381aa
