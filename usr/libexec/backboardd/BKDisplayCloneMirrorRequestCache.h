...
- (void).cxx_destruct;	// IMP=0x0020000000035c59
- (void)_lock_rebuildModeCache;	// IMP=0x00100000000359d1
- (void)_lock_addDeathWatcherForPid:(int)arg1;	// IMP=0x00100000000358e6
