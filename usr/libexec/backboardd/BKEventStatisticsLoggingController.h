...
+ (id)workQueue;	// IMP=0x002000000007533c
- (void).cxx_destruct;	// IMP=0x0020000000074c79
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (void)invalidate;	// IMP=0x0010000000074c15
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x0010000000074b88
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x0010000000074b72
- (void)dealloc;	// IMP=0x00100000000749e9
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x0010000000074823
