...
+ (id)sharedInstance;	// IMP=0x0020000000098085
- (void).cxx_destruct;	// IMP=0x00200000000976ed
- (void)orientationManager:(id)arg1 userInterfaceOrientationMayHaveChanged:(long long)arg2 isDeviceOrientationLocked:(_Bool)arg3;	// IMP=0x0010000000097685
- (void)systemShellDidFinishLaunching:(id)arg1;	// IMP=0x001000000009766a
- (void)clientDied:(id)arg1;	// IMP=0x00100000000975da
- (void)setBacklightFeatures:(id)arg1 forPID:(int)arg2;	// IMP=0x00100000000974af
- (void)setBacklightLocked:(_Bool)arg1 forReason:(id)arg2;	// IMP=0x00100000000972e7
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000009726f
- (id)propertyForKey:(id)arg1;	// IMP=0x0010000000097208
@property(nonatomic) int displayBrightnessCurve;
- (void)setAutoBrightnessEnabled:(_Bool)arg1;	// IMP=0x0010000000097159
...
- (void)setBrightnessLevel:(float)arg1 reason:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0010000000096bd4
@property(readonly, nonatomic) float brightnessLevel;
@property(readonly, nonatomic) float unentitledBrightnessLevel;
- (void)setMinimumBrightnessLevel:(float)arg1 fadeDuration:(float)arg2;	// IMP=0x00100000000969d3
- (unsigned char)backlightArchitectureVersion;	// IMP=0x0010000000096931
- (id)suppressBrightnessNotificationsForReason:(id)arg1;	// IMP=0x00100000000968c2
- (void)dealloc;	// IMP=0x001000000009685a
- (id)_initWithBrightnessSystem:(id)arg1 systemShellSentinel:(id)arg2 orientationManager:(id)arg3;	// IMP=0x00100000000965ef
