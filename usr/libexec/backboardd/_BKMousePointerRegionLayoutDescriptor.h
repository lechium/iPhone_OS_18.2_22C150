...
- (void).cxx_destruct;	// IMP=0x00200000000a691b
...
- (id)initWithRegion:(id)arg1 relativeRegion:(id)arg2 edge:(unsigned int)arg3 edgePosition:(double)arg4;	// IMP=0x00100000000a683f
