...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000350d8
+ (id)classesRequiredToDecode;	// IMP=0x0010000000035052
- (void).cxx_destruct;	// IMP=0x002000000003502a
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000034e88
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000034d20
- (void)dealloc;	// IMP=0x0010000000034c96
- (id)_initWithDescriptor:(id)arg1 overlayType:(long long)arg2 imageData:(id)arg3 level:(float)arg4 frozen:(_Bool)arg5;	// IMP=0x0010000000034ba3
