...
- (void).cxx_destruct;	// IMP=0x002000000002fd2b
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x001000000002fbe9
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x001000000002fb99
- (id)succinctDescriptionBuilder;	// IMP=0x001000000002fb31
- (id)succinctDescription;	// IMP=0x001000000002fae1
@property(readonly, copy) NSString *description;
- (void)_wrapInCATransaction:(CDUnknownBlockType)arg1;	// IMP=0x001000000002fa67
- (id)_persistenceData;	// IMP=0x001000000002f9f1
- (void)_cleanup;	// IMP=0x001000000002f9eb
- (void)_freeze;	// IMP=0x001000000002f9e5
- (void)_dismissWithAnimationSettings:(id)arg1;	// IMP=0x001000000002f9df
- (void)_stopAnimating;	// IMP=0x001000000002f9d9
- (void)_startAnimating;	// IMP=0x001000000002f9d3
- (_Bool)_presentWithAnimationSettings:(id)arg1;	// IMP=0x001000000002f9cb
- (void)dismissWithAnimationSettings:(id)arg1;	// IMP=0x001000000002f885
- (void)freeze;	// IMP=0x001000000002f64b
- (_Bool)presentWithAnimationSettings:(id)arg1;	// IMP=0x001000000002f472
...
- (void)dealloc;	// IMP=0x001000000002f214
- (id)_initWithPersistenceData:(id)arg1;	// IMP=0x001000000002f164
- (id)initWithOverlayDescriptor:(id)arg1 level:(float)arg2;	// IMP=0x001000000002ec7e
