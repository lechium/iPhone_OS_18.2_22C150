...
- (void).cxx_destruct;	// IMP=0x00200000000366e7
...
- (void)_loadAllImages;	// IMP=0x0010000000036624
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x0010000000036379
- (id)_idiomSuffix;	// IMP=0x001000000003636c
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x0010000000036038
- (id)allImages;	// IMP=0x0010000000036009
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x0010000000035ff7
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x0010000000035ebe
