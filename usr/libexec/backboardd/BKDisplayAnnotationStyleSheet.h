...
- (void).cxx_destruct;	// IMP=0x0020000000028da5
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x0010000000028bc6
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x0010000000028b16
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x0010000000028a97
