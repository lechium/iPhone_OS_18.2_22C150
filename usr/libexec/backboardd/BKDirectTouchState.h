...
- (void).cxx_destruct;	// IMP=0x00200000000850fd
- (void)invalidate;	// IMP=0x0010000000084fee
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x0010000000084f8d
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0010000000084d7e
