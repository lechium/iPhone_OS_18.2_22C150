...
- (void).cxx_destruct;	// IMP=0x002000000009aead
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000009ae54
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x001000000009acac
- (id)init;	// IMP=0x001000000009ac5c
