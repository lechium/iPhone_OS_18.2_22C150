...
- (void).cxx_destruct;	// IMP=0x002000000000fa22
...
- (void)resetForCancel;	// IMP=0x001000000000f920
- (id)description;	// IMP=0x001000000000f7a6
- (id)initWithService:(id)arg1;	// IMP=0x001000000000f590
