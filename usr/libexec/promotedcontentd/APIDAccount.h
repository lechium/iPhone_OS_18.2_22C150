...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000044492
- (void).cxx_destruct;	// IMP=0x00200000000455f1
...
- (void)_performForceReconcile;	// IMP=0x00100000000453ff
- (id)_fakeID;	// IMP=0x00100000000452f7
- (id)initWithIDAccountsRecord:(id)arg1 storefront:(id)arg2 monthlyIDResetCount:(id)arg3;	// IMP=0x0010000000044b15
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000004480c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000004449a
