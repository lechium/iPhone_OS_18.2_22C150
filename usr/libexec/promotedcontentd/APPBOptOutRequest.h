...
+ (id)options;	// IMP=0x0020000000081508
- (void).cxx_destruct;	// IMP=0x00200000000825d9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000082467
- (unsigned long long)hash;	// IMP=0x0010000000082126
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000081fab
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000081e83
- (void)copyTo:(id)arg1;	// IMP=0x0010000000081da1
- (void)writeTo:(id)arg1;	// IMP=0x0010000000081cad
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000081ca0
- (id)dictionaryRepresentation;	// IMP=0x001000000008175b
- (id)description;	// IMP=0x00100000000816ac
