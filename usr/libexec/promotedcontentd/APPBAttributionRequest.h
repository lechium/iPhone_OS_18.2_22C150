...
+ (id)options;	// IMP=0x002000000007624c
- (void).cxx_destruct;	// IMP=0x0020000000078580
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000078215
- (unsigned long long)hash;	// IMP=0x0010000000077bd0
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007789e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007762f
- (void)copyTo:(id)arg1;	// IMP=0x0010000000077431
- (void)writeTo:(id)arg1;	// IMP=0x0010000000077229
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000007721c
- (id)dictionaryRepresentation;	// IMP=0x0010000000076834
- (id)description;	// IMP=0x0010000000076785
- (int)StringAsDownloadType:(id)arg1;	// IMP=0x00100000000766ee
- (id)downloadTypeAsString:(int)arg1;	// IMP=0x00100000000766a5
...
- (_Bool);	// IMP=0x001000000007657d
@property(readonly, nonatomic) _Bool hasToroID;
- (int)StringAsRunState:(id)arg1;	// IMP=0x00100000000764d1
- (id)runStateAsString:(int)arg1;	// IMP=0x0010000000076488
