...
- (void).cxx_destruct;	// IMP=0x00200000000b3cc7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000b3b51
- (unsigned long long)hash;	// IMP=0x00100000000b38b5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b370f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b35e3
- (void)copyTo:(id)arg1;	// IMP=0x00100000000b34e6
- (void)writeTo:(id)arg1;	// IMP=0x00100000000b33d1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000b33c4
- (id)dictionaryRepresentation;	// IMP=0x00100000000b2cbc
- (id)description;	// IMP=0x00100000000b2c0d
...
- (int)StringAsContentType:(id)arg1;	// IMP=0x00100000000b29e5
- (id)contentTypeAsString:(int)arg1;	// IMP=0x00100000000b2997
