...
+ (id)options;	// IMP=0x00200000000593ec
- (void).cxx_destruct;	// IMP=0x002000000005a274
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000005a09b
- (unsigned long long)hash;	// IMP=0x0010000000059fac
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000059e06
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000059caf
- (void)copyTo:(id)arg1;	// IMP=0x0000000000059baf
- (void)writeTo:(id)arg1;	// IMP=0x0010000000059aa9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000059a9c
- (id)dictionaryRepresentation;	// IMP=0x00100000000595e2
- (id)description;	// IMP=0x0010000000059533
