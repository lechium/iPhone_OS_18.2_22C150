...
- (void).cxx_destruct;	// IMP=0x00200000000876d1
...
- (id)transformedContext;	// IMP=0x001000000008701f
- (void)_addAdjacentContext;	// IMP=0x0010000000086e90
- (void)_addContext:(id)arg1;	// IMP=0x0010000000086aa7
- (void)_addCurrentArticleContext;	// IMP=0x00100000000868ee
- (id)initWithContext:(id)arg1 contentIdentifier:(id)arg2 placementType:(long long)arg3;	// IMP=0x00100000000867ef
