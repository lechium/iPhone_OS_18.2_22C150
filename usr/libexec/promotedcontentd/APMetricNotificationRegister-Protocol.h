...
- (long long)registerHandlerForExternalPurposesAndAllMetricsWithClosure:(void (^)(id <APMetricProtocol>))arg1;
- (long long)registerHandlerForInternalPurposesAndAllMetricsWithClosure:(void (^)(id <APMetricProtocol>))arg1;
- (long long)registerHandlerForAllPurposesAndAllMetricsWithClosure:(void (^)(id <APMetricProtocol>))arg1;
