...
- (void).cxx_destruct;	// IMP=0x002000000013dece
...
- (void)_reportStatisticsForDuration:(double)arg1 storageInfo:(id)arg2 cancelled:(_Bool)arg3;	// IMP=0x001000000013da5f
- (void)_removeItemInBlockForKey:(id)arg1;	// IMP=0x001000000013d7ad
- (void)_removeItem:(id)arg1;	// IMP=0x001000000013d67a
- (void)_handleAncientItem:(id)arg1;	// IMP=0x001000000013d5a7
- (void)stop;	// IMP=0x001000000013d56a
- (void)collect;	// IMP=0x001000000013cf50
- (id)initWithCacheStore:(id)arg1 expirationDate:(id)arg2 timeSincePrevLaunch:(double)arg3;	// IMP=0x001000000013ce40
