...
- (void).cxx_destruct;	// IMP=0x0020000000046e8a
...
- (id)protoBuffer;	// IMP=0x0010000000046bdb
- (Class)responseClass;	// IMP=0x0010000000046bca
- (id)initWithBundleID:(id)arg1 identifier:(id)arg2 segmentIdentifiers:(id)arg3 replaceExisting:(_Bool)arg4 privateSegment:(_Bool)arg5;	// IMP=0x0010000000046ac4
