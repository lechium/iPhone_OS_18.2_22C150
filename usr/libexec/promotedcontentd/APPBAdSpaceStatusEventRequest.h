...
+ (id)options;	// IMP=0x0020000000093ae4
- (void).cxx_destruct;	// IMP=0x0020000000096301
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000095f3a
- (unsigned long long)hash;	// IMP=0x0010000000095b74
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000095823
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009559f
- (void)copyTo:(id)arg1;	// IMP=0x0010000000095389
- (void)writeTo:(id)arg1;	// IMP=0x001000000009516d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000095160
- (id)dictionaryRepresentation;	// IMP=0x001000000009453b
- (id)description;	// IMP=0x001000000009448c
...
- (int)StringAsStatusCode:(id)arg1;	// IMP=0x0010000000093f70
- (id)statusCodeAsString:(int)arg1;	// IMP=0x0010000000093d2f
