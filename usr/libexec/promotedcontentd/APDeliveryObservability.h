...
- (void).cxx_destruct;	// IMP=0x00200000000f1509
...
- (void)recordFailure:(long long)arg1;	// IMP=0x00100000000f141d
- (void)recordSuccess;	// IMP=0x00100000000f13dc
- (id)initWithTransmitter:(id)arg1;	// IMP=0x00100000000f1369
