...
- (double)_yIncrement;	// IMP=0x0010000000007a4e
- (double)_xIncrement;	// IMP=0x0000000000007a0d
- (void)layoutSubviews;	// IMP=0x001000000000760e
- (void)decreaseYPrecision;	// IMP=0x00100000000075b4
- (void)increaseYPrecision;	// IMP=0x0010000000007582
- (void)decreaseXPrecision;	// IMP=0x0010000000007528
- (void)increaseXPrecision;	// IMP=0x00100000000074f6
- (void)moveDown;	// IMP=0x0010000000007493
- (void)moveUp;	// IMP=0x0010000000007430
- (void)moveRight;	// IMP=0x00100000000073c9
- (void)moveLeft;	// IMP=0x0010000000007362
@property(readonly, nonatomic) struct CGPoint selectedScreenPoint;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000006fc0
