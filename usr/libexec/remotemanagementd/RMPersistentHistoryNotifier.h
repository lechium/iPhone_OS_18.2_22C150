...
+ (id)sharedQueryQueue;	// IMP=0x004000000006bb32
- (void).cxx_destruct;	// IMP=0x002000000006d4b8
...
- (void)_queryForTransactionsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006c36b
- (void)_delayedQuery;	// IMP=0x001000000006c080
- (void)_scheduleQueryForTransactions;	// IMP=0x001000000006bf5b
- (void)_managedObjectContextDidSave:(id)arg1;	// IMP=0x001000000006be77
- (void)start;	// IMP=0x001000000006bbd9
- (void)dealloc;	// IMP=0x001000000006ba8a
- (id)initWithContext:(id)arg1;	// IMP=0x001000000006b9e8
- (id)initWithPersistentHistoryToken:(id)arg1 context:(id)arg2;	// IMP=0x001000000006b945
