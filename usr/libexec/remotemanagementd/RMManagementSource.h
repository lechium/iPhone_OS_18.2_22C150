...
+ (id)fetchRequestWithAccountIdentifier:(id)arg1;	// IMP=0x002000000005a698
+ (id)fetchRequestWithIdentifier:(id)arg1;	// IMP=0x001000000005a5f1
+ (id)fetchRequestWithEnrollmentTypes:(id)arg1;	// IMP=0x001000000005a54a
+ (id)fetchRequestWithEnrollmentType:(long long)arg1;	// IMP=0x001000000005a4c7
+ (id)fetchRequestWithDeviceChannel;	// IMP=0x001000000005a439
+ (id)fetchRequestWithBootstrapURI:(id)arg1 enrollmentType:(long long)arg2;	// IMP=0x001000000005a384
+ (id)fetchRequestWithBootstrapURI:(id)arg1;	// IMP=0x001000000005a2dd
- (id)reportDetails;	// IMP=0x002000000005a73f
- (void)awakeFromInsert;	// IMP=0x001000000005a24a
