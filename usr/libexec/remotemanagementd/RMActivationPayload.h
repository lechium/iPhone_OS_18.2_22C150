...
- (id)reportDetails;	// IMP=0x002000000000aa0a
@property(retain, nonatomic) RMPredicateDescription *predicateDescription;
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000b9f3
- (_Bool)_updatePropertiesForActivation:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000b34c
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000b1ae
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x001000000000afde
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000acdf
