...
+ (id)fetchRequestWithKeyPaths:(id)arg1;	// IMP=0x00200000000a714e
- (id)reportDetails;	// IMP=0x00200000000a71f5
- (void)_validateSetOncePropertiesWithErrors:(id)arg1;	// IMP=0x00100000000a6df0
- (void)_validateManagementSourceWithErrors:(id)arg1;	// IMP=0x00100000000a6d53
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x00100000000a6b3a
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x00100000000a6921
- (void)awakeFromInsert;	// IMP=0x00100000000a68ba
