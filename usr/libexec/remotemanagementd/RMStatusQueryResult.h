...
- (void).cxx_destruct;	// IMP=0x0020000000080b83
...
- (id)initWithStatusKeyPaths:(id)arg1 statusByKeyPath:(id)arg2 errorByKeyPath:(id)arg3;	// IMP=0x001000000007ff05
- (id)init;	// IMP=0x001000000007fea1
- (id)protocolStatusReportWithFullReport:(_Bool)arg1;	// IMP=0x0010000000080f5b
