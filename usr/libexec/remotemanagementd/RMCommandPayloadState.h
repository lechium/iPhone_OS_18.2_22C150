...
- (void)markPending;	// IMP=0x0020000000025483
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x001000000002513a
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x0010000000024dcc
- (void)markQueued;	// IMP=0x0010000000024d69
