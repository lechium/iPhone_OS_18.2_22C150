...
- (void).cxx_destruct;	// IMP=0x0020000000231e78
...
- (id)description;	// IMP=0x0010000000231ca5
- (_Bool)hasContainerDatabase;	// IMP=0x0010000000231c97
- (_Bool)hasCloudStoreZones;	// IMP=0x0010000000231b24
