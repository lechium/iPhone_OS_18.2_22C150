...
- (void)acceptStatefulSharingMessage:(PKSharingMessage *)arg1 transportIdentifier:(NSString *)arg2 activationCode:(NSString *)arg3 completion:(void (^)(PDStatefulShareAcceptanceResponse *, NSError *))arg4;
- (void)handleIncomingMessage:(PKSharingGenericMessage *)arg1 transportIdentifier:(NSString *)arg2 share:(PKPassShare *)arg3 completion:(void (^)(_Bool))arg4;
@end
