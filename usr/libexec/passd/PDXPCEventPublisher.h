...
- (void).cxx_destruct;	// IMP=0x0020000000315ed0
...
- (void)sendEvent:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000003159db
- (void)sendEvent:(id)arg1;	// IMP=0x00100000003159c7
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x001000000031554b
- (id)initWithStreamName:(id)arg1;	// IMP=0x0010000000315230
