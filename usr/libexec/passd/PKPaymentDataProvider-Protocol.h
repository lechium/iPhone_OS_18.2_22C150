...
@class MISSING_TYPE, NSArray, NSCalendar, NSData, NSDate, NSSet, NSString, PKExpressPassConfiguration, PKExpressPassInformation, PKMerchant, PKOSVersionRequirement, PKPass, PKPassUpgradeRequest, PKPaymentApplication, PKPaymentBalance, PKPaymentBalanceReminder, PKPaymentCommutePlanReminder, PKPaymentPass, PKPaymentRewardsBalance, PKPaymentTransactionRequest, PKPaymentWebService, PKTransitCommutePlan;
...
@optional
- (MISSING_TYPE *)removeDelegate: /* Error: Ran out of types for this method. */;
- (void)addDelegate:(id <PKPaymentDataProviderDelegate>)arg1;
- (void)setHideCardBenefitRewards:(_Bool)arg1;
- (_Bool)hideCardBenefitRewards;
- (void)setHideCardBenefitPayLater:(_Bool)arg1;
...
- (void)tilesForPassWithUniqueIdentifier:(NSString *)arg1 context:(long long)arg2 completion:(void (^)(NSArray *))arg3;
...
- (void)setExpressWithPassConfiguration:(PKExpressPassConfiguration *)arg1 visibleViewController:(id)arg2 requiresAuth:(_Bool)arg3 completion:(void (^)(_Bool, NSSet *))arg4;
...
- (void)setExpressWithPassConfiguration:(PKExpressPassConfiguration *)arg1 visibleViewController:(id)arg2 completion:(void (^)(_Bool, PKExpressPassConfiguration *))arg3;
