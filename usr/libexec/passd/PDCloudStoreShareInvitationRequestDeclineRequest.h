...
- (void).cxx_destruct;	// IMP=0x00200000001f31e5
...
- (id)description;	// IMP=0x00100000001f3060
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x00100000001f2d62
- (id)initWithHandle:(id)arg1 zoneName:(id)arg2 containerName:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000001f2c84
