...
- (void).cxx_destruct;	// IMP=0x00200000000fb38c
...
- (unsigned long long)hash;	// IMP=0x00100000000fb291
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000fb1e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000fb10d
