...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000002e8d0c
- (void).cxx_destruct;	// IMP=0x00200000002e8ff2
...
- (void)generateNewDeviceIdentifier;	// IMP=0x00100000002e8f31
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000002e8e88
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000002e8d14
- (id)description;	// IMP=0x00100000002e8c24
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002e8a31
