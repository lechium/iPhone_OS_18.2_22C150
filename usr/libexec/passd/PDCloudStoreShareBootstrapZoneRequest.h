...
- (void).cxx_destruct;	// IMP=0x00200000001f3dfa
...
- (id)description;	// IMP=0x00100000001f3cf3
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x00100000001f3b3b
- (id)initWithZoneName:(id)arg1 containerName:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001f3a8e
