...
- (MISSING_TYPE *)updateScheduledPaymentsWithAccount:completion: /* Error: Ran out of types for this method. */;
...
- (void)setNeedsSyncToFinanceForAllTransactionsWithCompletion:(void (^)(_Bool))arg1;
