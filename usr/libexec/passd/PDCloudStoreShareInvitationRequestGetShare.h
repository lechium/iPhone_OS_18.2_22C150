...
- (void).cxx_destruct;	// IMP=0x00200000001f35af
...
- (id)description;	// IMP=0x00100000001f34a8
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x00100000001f32d4
- (id)initWithZoneName:(id)arg1 containerName:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001f3227
