...
- (void).cxx_destruct;	// IMP=0x002000000056995a
...
- (unsigned long long)hash;	// IMP=0x00100000005698e7
- (_Bool)isEqualToConfiguration:(id)arg1;	// IMP=0x001000000056983d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000005697d5
- (id)initWithTransactionIdentifier:(id)arg1 updateReasons:(unsigned long long)arg2;	// IMP=0x001000000056975e
