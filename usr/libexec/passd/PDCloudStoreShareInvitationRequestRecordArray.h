...
- (void).cxx_destruct;	// IMP=0x00200000003e6888
@property(readonly, nonatomic) PKCloudRecordArray *cloudStoreRecords; // @synthesize cloudStoreRecords=_cloudStoreRecords;
- (unsigned long long)type;	// IMP=0x00100000003e686c
- (id)initWithCloudStoreRecords:(id)arg1 success:(_Bool)arg2 error:(id)arg3;	// IMP=0x00100000003e67ea
