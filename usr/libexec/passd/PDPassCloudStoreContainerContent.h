...
- (void).cxx_destruct;	// IMP=0x00200000002ff695
- (id)description;	// IMP=0x00100000002ff5ad
...
- (void)noteTypeOfSyncPerformed:(long long)arg1;	// IMP=0x00100000002ff531
- (void)noteEnounteredError:(id)arg1;	// IMP=0x00100000002ff520
- (void)appendCatalog:(id)arg1;	// IMP=0x00100000002ff50a
- (void)appendPassID:(id)arg1;	// IMP=0x00100000002ff4ba
- (void)appendPass:(id)arg1;	// IMP=0x00100000002ff4a4
- (id)init;	// IMP=0x00100000002ff418
