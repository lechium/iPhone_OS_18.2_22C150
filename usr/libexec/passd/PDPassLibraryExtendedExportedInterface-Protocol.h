...
@class MISSING_TYPE, NSArray, NSData, NSDate, NSMapTable, NSNumber, NSSet, NSString, NSUUID, PKACAccountChange, PKAddShareablePassConfiguration, PKAliroHomeAuxiliaryCapabilityDescriptor, PKAppleAccountChange, PKContact, PKDisplayProfile, PKDisplayTraitCollection, PKFieldProperties, PKFileDescriptorXPCContainer, PKGroupsControllerSnapshotFetchOptions, PKPaymentSetupRequest, PKUnifiedAccessHomeAuxiliaryCapabilityDescriptor;
...
- (void)badgeCountItemsWithCompletion:(void (^)(NSArray *))arg1;
- (void)presentIssuerBindingFlowForIssuerData:(NSData *)arg1 signature:(NSData *)arg2 orientation:(NSNumber *)arg3;
- (void)usingSynchronousProxy:(_Bool)arg1 requestIssuerBoundPassesWithBindingWithData:(NSData *)arg2 automaticallyProvision:(_Bool)arg3 withCompletion:(void (^)(NSArray *, NSError *))arg4;
...
- (void)iPadSupportsPasses:(void (^)(_Bool))arg1;
...
- (void)updateDate:(NSDate *)arg1 forPendingNotificationWithIdentifier:(NSString *)arg2;
- (void)pendingUserNotificationsWithIdentifier:(NSString *)arg1 completion:(void (^)(NSArray *))arg2;
...
- (void)updateIngestedDate:(NSDate *)arg1 forPassWithUniqueID:(NSString *)arg2;
...
- (void)usingSynchronousProxy:(_Bool)arg1 configurePushProvisioningConfigurationV2:(id <PKPushablePassConfigurationProvider>)arg2 completion:(void (^)(id <PKPushablePassConfigurationProvider>, NSError *))arg3;
...
- (void)usingSynchronousProxy:(_Bool)arg1 generateAuxiliaryCapabilitiesForRequirements:(NSArray *)arg2 completion:(void (^)(NSMapTable *, NSError *))arg3;
...
- (void)usingSynchronousProxy:(_Bool)arg1 configureHomeAuxiliaryCapabilitiesForSerialNumber:(NSString *)arg2 homeIdentifier:(NSUUID *)arg3 fromUnifiedAccessDescriptor:(PKUnifiedAccessHomeAuxiliaryCapabilityDescriptor *)arg4 andAliroDescriptor:(PKAliroHomeAuxiliaryCapabilityDescriptor *)arg5 completion:(void (^)(NSArray *, NSArray *, NSArray *, NSError *))arg6;
...
- (MISSING_TYPE *)usingSynchronousProxy:addPassesContainer:withCompletionHandler: /* Error: Ran out of types for this method. */;
