...
@class MISSING_TYPE, NSArray, NSData, NSDate, NSDictionary, NSSet, NSString, PKApplicationMessageKey, PKExpressTransactionState, PKPaymentApplication, PKPaymentBalanceReminder, PKPaymentCommutePlanReminder, PKPaymentPass, PKPaymentTransaction, PKTransitAppletHistory, PKValueAddedServiceTransaction, PKVerificationChannel;
...
- (void)userNotificationActionPerformed:(unsigned long long)arg1 notificationIdentifier:(NSString *)arg2 completion:(void (^)(void))arg3;
...
- (void)recordPaymentApplicationUsageForPassUniqueIdentifier:(NSString *)arg1 paymentApplicationIdentifier:(NSString *)arg2;
...
- (MISSING_TYPE *)balanceReminderThresholdForBalanceIdentifier:withPassUniqueIdentifier:handler: /* Error: Ran out of types for this method. */;
- (void)plansForPaymentPassWithUniqueIdentifier:(NSString *)arg1 handler:(void (^)(NSArray *))arg2;
...
- (void)usingSynchronousProxy:(_Bool)arg1 tilesForPassWithUniqueIdentifer:(NSString *)arg2 context:(long long)arg3 completion:(void (^)(NSArray *))arg4;
...
- (void)setDoubleClickAllowed:(_Bool)arg1 completion:(void (^)(void))arg2;
@end
