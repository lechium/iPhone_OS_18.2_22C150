...
- (void).cxx_destruct;	// IMP=0x00200000001f2769
...
- (id)description;	// IMP=0x00100000001f25e1
- (_Bool)canCoalesceRequest:(id)arg1;	// IMP=0x00100000001f22e2
- (id)initWithHandle:(id)arg1 permission:(long long)arg2 zoneName:(id)arg3 containerName:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00100000001f21ff
