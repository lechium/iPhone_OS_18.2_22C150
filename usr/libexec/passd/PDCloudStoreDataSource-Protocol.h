...
@class Account, CKDatabaseSubscription, CKRecord, CKRecordID, NSArray, NSData, NSDate, NSDictionary, NSSet, NSString, PDCloudStoreContainerDatabase, PKAccount, PKAccountEvent, PKAccountUser, PKCloudStoreContainerChangeEvent, PKCloudStoreRecordFetchTask, PKCloudStoreZone, PKPass, PKPaymentTransaction, PKPaymentTransactionArchive, PKPeerPaymentAccount, PKPeerPaymentCounterpartImageData, PKPeerPaymentRecurringPayment, PKSharedAccountCloudStore;

@protocol PDCloudStoreDataSource <NSObject>
- (void)removeRecordFetchTasks:(NSArray *)arg1;
- (void)updateRecordFetchTask:(PKCloudStoreRecordFetchTask *)arg1;
- (NSArray *)allRecordFetchTasks;
...
- (CKRecord *)cloudStoreRecordWithRecordName:(NSString *)arg1 recordType:(NSString *)arg2 inCloudStoreZone:(PKCloudStoreZone *)arg3;
...
- (void)insertOrUpdatePeerPaymentCounterpartImageData:(PKPeerPaymentCounterpartImageData *)arg1;
- (PKPeerPaymentCounterpartImageData *)peerPaymentCounterpartImageDataWithIdentifier:(NSString *)arg1;
...
- (void)updateTransactionArchive:(PKPaymentTransactionArchive *)arg1 forCounterpartImageData:(PKPeerPaymentCounterpartImageData *)arg2;
- (PKPaymentTransactionArchive *)transactionArchiveForCounterpartImageData:(PKPeerPaymentCounterpartImageData *)arg1;
