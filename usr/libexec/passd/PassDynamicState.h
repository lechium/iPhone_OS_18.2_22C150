...
@class PKPassBalanceModel, PKPassLiveRender, PKPassRelevancyModel;

@interface PassDynamicState : NSObject
{
    PKPassLiveRender *_liveRender;	// 8 = 0x8
    PKPassBalanceModel *_balanceModel;	// 16 = 0x10
    PKPassRelevancyModel *_relevancyModel;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x002000000016480e
