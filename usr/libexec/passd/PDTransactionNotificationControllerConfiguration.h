...
@class NSString, PKAccountUser, PKFamilyMember, PKPaymentApplication, PKPaymentOfferInstallmentCriteria, PKPaymentPass, PKPeerPaymentAccount, PKPeerPaymentPreferences;
...
@interface PDTransactionNotificationControllerConfiguration : NSObject
{
    ...
    PKPaymentOfferInstallmentCriteria *_installmentCriteria;	// 88 = 0x58
}

- (void).cxx_destruct;	// IMP=0x002000000032d2f0
@property(retain, nonatomic) PKPaymentOfferInstallmentCriteria *installmentCriteria; // @synthesize installmentCriteria=_installmentCriteria;
...
- (id)description;	// IMP=0x001000000032cf96
- (_Bool)shouldReceiveNotificationsForPeerPaymentNotificationType:(unsigned long long)arg1;	// IMP=0x001000000032cf00
- (id)passUniqueIdentifier;	// IMP=0x001000000032ceea
