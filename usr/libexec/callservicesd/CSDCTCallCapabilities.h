...
+ (id)callCapabilitiesForCallManagementStateInfo:(id)arg1;	// IMP=0x0040000000094378
+ (id)callCapabilitiesForCTCallCapabilities:(id)arg1;	// IMP=0x001000000009429a
...
- (id)debugDescription;	// IMP=0x00100000000945e7
- (id)description;	// IMP=0x00100000000945d5
