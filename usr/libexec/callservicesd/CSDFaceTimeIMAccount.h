...
+ (id)sharedInstance;	// IMP=0x0020000000200d3e
- (void).cxx_destruct;	// IMP=0x00200000002020ea
...
- (void)account:(id)arg1 aliasesChanged:(id)arg2;	// IMP=0x0010000000201f6b
- (void)updateState;	// IMP=0x0010000000201cbe
- (id)faceTimeIMAccount;	// IMP=0x0010000000201c64
- (void)_saveLastKnownFaceTimeCallerID;	// IMP=0x0010000000201b08
- (void)removeCallerIDFromPreferences;	// IMP=0x0010000000201a61
- (void)_initializeLastKnownCallerID;	// IMP=0x0010000000201752
- (void)displayNameChanged:(id)arg1;	// IMP=0x0010000000201696
- (void)preferredAccountChanged:(id)arg1;	// IMP=0x00100000002015da
- (void)imDaemonDidConnect:(id)arg1;	// IMP=0x0010000000201464
- (void)updateCallerID:(id)arg1;	// IMP=0x0010000000201223
- (id)init;	// IMP=0x0010000000200dc3
