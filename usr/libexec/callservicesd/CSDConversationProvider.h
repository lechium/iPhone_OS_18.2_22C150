...
- (void).cxx_destruct;	// IMP=0x00200000002183ca
...
- (void)isPseudonymHandleForProvider:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000002182b2
- (void)revokePseudonymHandle:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000218209
- (void)renewPseudonymHandle:(id)arg1 expirationDate:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000002180f6
- (void)generatePseudonymHandleForConversationWithExpiryDuration:(double)arg1 URI:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000217e40
- (id)callerIDAccount;	// IMP=0x0010000000217df0
- (void)registerWithIDSWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000217d5c
- (id)tuConversationProvider;	// IMP=0x0010000000217c2e
- (id)initWithProvider:(id)arg1;	// IMP=0x0010000000217ace
