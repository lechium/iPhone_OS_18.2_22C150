...
- (void).cxx_destruct;	// IMP=0x00200000001b5810
...
- (id)valueForEntitlement:(id)arg1;	// IMP=0x00100000001b5636
- (_Bool)isEntitledForCapability:(id)arg1;	// IMP=0x00100000001b562e
...
- (void)performBlockAfterCoalescing:(CDUnknownBlockType)arg1;	// IMP=0x00100000001b5522
@property(readonly, nonatomic) id objectForBlock;
- (void)performBlock:(CDUnknownBlockType)arg1 coalescedByIdentifier:(id)arg2;	// IMP=0x00100000001b527b
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001b5218
@property(readonly, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x00100000001b507e
- (id)initWithObject:(id)arg1 queue:(id)arg2;	// IMP=0x00100000001b4f8f
