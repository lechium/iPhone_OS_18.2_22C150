...
- (void).cxx_destruct;	// IMP=0x002000000010022a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000100037
- (unsigned long long)hash;	// IMP=0x00100000000fff34
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ffd93
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ffc3f
- (void)copyTo:(id)arg1;	// IMP=0x00100000000ffb3d
- (void)writeTo:(id)arg1;	// IMP=0x00100000000ffa39
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000ffa2c
- (id)dictionaryRepresentation;	// IMP=0x00100000000ff425
- (id)description;	// IMP=0x00100000000ff376
...
- (id)tuAssociationForHandle:(id)arg1;	// IMP=0x001000000020b7a6
