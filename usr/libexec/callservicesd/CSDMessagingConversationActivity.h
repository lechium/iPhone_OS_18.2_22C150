...
+ (id)activityWithCSDConversationActivity:(id)arg1 handle:(id)arg2;	// IMP=0x00200000000c1a67
+ (id)activityWithCSDConversationActivity:(id)arg1 fromConversation:(id)arg2 forStorage:(_Bool)arg3;	// IMP=0x00100000000c1321
- (void).cxx_destruct;	// IMP=0x0020000000175cd6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000017590d
- (unsigned long long)hash;	// IMP=0x00100000001755c7
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000017530f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001750c5
- (void)copyTo:(id)arg1;	// IMP=0x0010000000174efa
- (void)writeTo:(id)arg1;	// IMP=0x0010000000174d41
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000174d34
- (id)dictionaryRepresentation;	// IMP=0x0010000000174516
- (id)description;	// IMP=0x0010000000174467
@property(readonly, nonatomic) _Bool hasFromHandle;
@property(nonatomic) _Bool hasTimestampAsTimeIntervalSinceReferenceDate;
- (void);	// IMP=0x001000000017440b
...
- (long long)mappedLifetimePolicy:(long long)arg1;	// IMP=0x00100000000c291b
- (id)description;	// IMP=0x00100000000c284f
