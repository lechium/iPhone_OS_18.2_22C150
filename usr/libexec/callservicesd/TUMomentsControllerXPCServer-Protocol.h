...
@class MISSING_TYPE, NSDictionary, NSString, NSUUID, TUMomentsMediaRecordRequest, TUMomentsMessageSendRequest;
...
- (MISSING_TYPE *)unregisterStreamToken:reply: /* Error: Ran out of types for this method. */;
