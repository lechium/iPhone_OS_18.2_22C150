...
- (void).cxx_destruct;	// IMP=0x004000000025bc86
- (id)init;	// IMP=0x001000000025bc51
- (_Bool)validateUserIntentForCallSource:(id)arg1;	// IMP=0x001000000025bbdd
- (void)donateUserIntentForCallProviderIdentifier:(id)arg1;	// IMP=0x001000000025b617
- (id)initWithQueue:(id)arg1;	// IMP=0x001000000025b3d1
