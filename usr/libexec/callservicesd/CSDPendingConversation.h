...
- (void).cxx_destruct;	// IMP=0x002000000007797b
...
- (id)groupUUID;	// IMP=0x00100000000773a9
- (id)UUID;	// IMP=0x0010000000077397
@property(readonly, nonatomic) long long state;
- (id)description;	// IMP=0x0010000000077128
- (id)initWithConversationLink:(id)arg1 localMember:(id)arg2 queue:(id)arg3;	// IMP=0x0010000000076ff4
