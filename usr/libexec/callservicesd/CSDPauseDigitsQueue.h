...
- (void).cxx_destruct;	// IMP=0x00200000000d2072
...
- (void)_parsePauseDigitsFromDestinationID:(id)arg1;	// IMP=0x00100000000d1c61
- (id)dequeueAllPauseDigits;	// IMP=0x00100000000d1b63
- (id)dequeueNextPauseDigits;	// IMP=0x00100000000d1ab6
@property(readonly, nonatomic) _Bool hasQueuedHardPauseDigits;
@property(readonly, nonatomic) CSDPauseDigits *nextPauseDigits;
- (id)description;	// IMP=0x00100000000d17c5
- (id)initWithDestinationID:(id)arg1;	// IMP=0x00100000000d172e
- (id)init;	// IMP=0x00100000000d16a4
