...
+ (Class)invitedHandlesType;	// IMP=0x0020000000007db4
+ (id)linkWithTUConversationLink:(id)arg1 includeGroupUUID:(_Bool)arg2;	// IMP=0x0010000000007805
- (void).cxx_destruct;	// IMP=0x0020000000009d34
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000098f7
- (unsigned long long)hash;	// IMP=0x00100000000095b1
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000931c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000008f82
- (void)copyTo:(id)arg1;	// IMP=0x0010000000008d68
- (void)writeTo:(id)arg1;	// IMP=0x0010000000008ad1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000008ac4
- (id)dictionaryRepresentation;	// IMP=0x00100000000080c9
- (id)description;	// IMP=0x001000000000801a
- (int)StringAsLinkLifetimeScope:(id)arg1;	// IMP=0x0010000000007fb5
- (id)linkLifetimeScopeAsString:(int)arg1;	// IMP=0x0010000000007f60
...
- (id)invitedHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000007d97
- (unsigned long long)invitedHandlesCount;	// IMP=0x0010000000007d7a
- (void)addInvitedHandles:(id)arg1;	// IMP=0x0010000000007d10
- (void)clearInvitedHandles;	// IMP=0x0010000000007cf3
...
- (id)description;	// IMP=0x0010000000007be8
