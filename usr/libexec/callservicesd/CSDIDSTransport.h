...
- (void).cxx_destruct;	// IMP=0x002000000024b029
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000024ae5d
- (unsigned long long)hash;	// IMP=0x001000000024ad43
- (_Bool)isEqualToTransport:(id)arg1;	// IMP=0x001000000024ab2a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000024aacd
- (id)description;	// IMP=0x001000000024a89b
- (id)initWithDestination:(id)arg1;	// IMP=0x001000000024a820
- (id)initWithSocket:(int)arg1;	// IMP=0x001000000024a7de
