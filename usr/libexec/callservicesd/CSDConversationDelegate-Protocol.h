...
@class CSDConversation, CSDConversationParticipant, CXCallFailureContext, MISSING_TYPE, NSData, NSSet, NSString, NSUUID, TUCallScreenShareAttributes, TUConversationActivityEvent, TUConversationActivitySession, TUConversationParticipant, TUSandboxExtendedURL;
...
- (MISSING_TYPE *)conversation:updatedActiveParticipant: /* Error: Ran out of types for this method. */;
