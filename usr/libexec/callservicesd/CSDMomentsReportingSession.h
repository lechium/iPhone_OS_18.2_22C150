...
+ (unsigned long long)bucketedInteger:(unsigned long long)arg1;	// IMP=0x00400000001e06c7
+ (double)meanFromDoubleNumbers:(id)arg1;	// IMP=0x00100000001e0526
+ (id)medianFromNumbers:(id)arg1;	// IMP=0x00100000001e03e6
- (void).cxx_destruct;	// IMP=0x00200000001e07ce
...
- (double)meanRequestDuration;	// IMP=0x00100000001e0384
- (id)medianRequestDuration;	// IMP=0x00100000001e031a
- (unsigned long long)fuzzyPhotoRequestSuccessCount;	// IMP=0x00100000001e02d5
- (unsigned long long)fuzzyPhotoRequestFailureCount;	// IMP=0x00000000001e0290
- (void)reportDataCollectionCompleteIfNecessary;	// IMP=0x00100000001e00ad
- (void)didCleanUp;	// IMP=0x00100000001e0004
- (void)didReceiveResultsWithTransactionID:(id)arg1;	// IMP=0x00100000001dfc55
- (void)didStartRequestWithTransactionID:(id)arg1;	// IMP=0x00100000001df8ee
- (void)registeredStreamWithAvailability:(int)arg1;	// IMP=0x00100000001df864
- (id)init;	// IMP=0x00100000001df7da
- (id)initWithStreamToken:(long long)arg1;	// IMP=0x00100000001df6f1
