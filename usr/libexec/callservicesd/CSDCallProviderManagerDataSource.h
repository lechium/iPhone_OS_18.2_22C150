...
+ (id)dataForProviders:(id)arg1;	// IMP=0x00200000001de32c
- (void).cxx_destruct;	// IMP=0x00200000001df689
...
- (void)didChangeRelayCallingAvailability;	// IMP=0x00100000001df591
- (void)callsChangedForCallCenterObserver:(id)arg1;	// IMP=0x00100000001df27a
- (void)handleApplicationUnregisteredNotification:(id)arg1;	// IMP=0x00100000001df1b8
- (id)_providersForPreferenceKey:(id)arg1;	// IMP=0x00100000001ded6d
- (id)_providersForKeychainItem:(id)arg1;	// IMP=0x00100000001de864
- (_Bool)_saveProviders:(id)arg1 forKeychainItem:(id)arg2 error:(id *)arg3;	// IMP=0x00100000001de5f3
- (void)moveExistingPreferencesToKeychain;	// IMP=0x00100000001ddfc3
- (_Bool)isProviderInstalled:(id)arg1;	// IMP=0x00100000001dded9
- (void)removeLinksForFilenamesNotInArray:(id)arg1;	// IMP=0x00100000001ddde3
- (id)createLinkIfNecessaryWithFilename:(id)arg1 toURL:(id)arg2;	// IMP=0x00100000001ddc52
- (_Bool)isSymbolicLinkAtURL:(id)arg1;	// IMP=0x00100000001ddad4
- (void)openUserActivity:(id)arg1 usingApplicationWithBundleIdentifier:(id)arg2 frontBoardOptions:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000001dd86e
@property(readonly, nonatomic, getter=isDevicePasscodeLocked) _Bool devicePasscodeLocked;
- (id)dialAssistedDialRequestForDialRequest:(id)arg1;	// IMP=0x00100000001dd7e9
...
- (void)dealloc;	// IMP=0x00100000001dcb5c
- (id)initWithSerialQueue:(id)arg1 localKeychainItem:(id)arg2 pairedHostKeychainItem:(id)arg3;	// IMP=0x00100000001dc811
- (id)initWithSerialQueue:(id)arg1;	// IMP=0x00100000001dc6bb
