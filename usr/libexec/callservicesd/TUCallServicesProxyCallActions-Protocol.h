...
@class IDSDestination, NSSet, NSString, NSUUID, TUAnswerRequest, TUCallScreenShareAttributes, TUDialRequest, TUProxyCall;
...
- (oneway void)setHasEmergencyVideoStream:(_Bool)arg1 forCallWithUniqueProxyIdentifier:(NSString *)arg2;
