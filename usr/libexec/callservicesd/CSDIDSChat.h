...
+ (id)faceTimeAppUUID;	// IMP=0x002000000008dc24
- (void).cxx_destruct;	// IMP=0x0020000000092683
...
- (void)conference:(id)arg1 didReceiveData:(id)arg2 forCallID:(long long)arg3;	// IMP=0x00100000000923d4
- (void)conference:(id)arg1 changedBytesOfDataUsed:(long long)arg2;	// IMP=0x0010000000092372
- (void)conference:(id)arg1 outputLevelChangedTo:(float)arg2;	// IMP=0x001000000009230b
- (void)conference:(id)arg1 inputLevelChangedTo:(float)arg2;	// IMP=0x00100000000922a4
- (void)conference:(id)arg1 outputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x001000000009222a
- (void)conference:(id)arg1 inputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x00100000000921b0
- (void)conference:(id)arg1 remoteMediaStalled:(_Bool)arg2;	// IMP=0x00100000000920e0
- (void)remoteVideoPausedForConference:(id)arg1;	// IMP=0x0010000000092084
- (void)receivedFirstRemoteFrameForConference:(id)arg1;	// IMP=0x0010000000091f6d
- (void)sendingAudioChangedForConference:(id)arg1;	// IMP=0x0010000000091f11
- (void)mutedChangedForConference:(id)arg1;	// IMP=0x0010000000091eb5
- (void)conference:(id)arg1 endedWithReason:(long long)arg2 error:(id)arg3;	// IMP=0x0010000000091d99
- (void)conferenceStarted:(id)arg1;	// IMP=0x0010000000091b15
- (void)conferenceFinishedPreparing:(id)arg1;	// IMP=0x00100000000916ed
- (void)session:(id)arg1 receivedData:(id)arg2;	// IMP=0x0010000000091625
- (void)session:(id)arg1 receivedInvitationCancelWithData:(id)arg2;	// IMP=0x001000000009155b
- (void)session:(id)arg1 receivedInvitationDeclineWithData:(id)arg2;	// IMP=0x0010000000091491
- (void)session:(id)arg1 receivedInvitationAcceptWithData:(id)arg2;	// IMP=0x0010000000090b73
- (void)session:(id)arg1 endedWithReason:(int)arg2;	// IMP=0x0010000000090a5a
- (void)session:(id)arg1 invitationSentToPushTokens:(id)arg2 shouldBreakBeforeMake:(_Bool)arg3;	// IMP=0x001000000009093a
- (void)sessionStarted:(id)arg1;	// IMP=0x00100000000906df
- (void)_handlePushTokensInvited:(id)arg1 didSendInvitation:(_Bool)arg2 didCancelInvitation:(_Bool)arg3;	// IMP=0x00100000000905b6
- (void)setRemoteVideoPresentationState:(int)arg1;	// IMP=0x001000000009055e
- (void)setRemoteVideoPresentationSize:(struct CGSize)arg1;	// IMP=0x0010000000090505
- (void)prepareConference;	// IMP=0x001000000009026c
- (void)startConnectionWithTransport:(id)arg1;	// IMP=0x00100000000900cb
...
- (void)sendDataUnreliably:(id)arg1;	// IMP=0x001000000008fa4e
- (void)cancelInvitationWithLocalHangup;	// IMP=0x001000000008f955
- (void)cancelInvitationWithDeclinedElsewhere;	// IMP=0x001000000008f859
- (void)cancelInvitationWithAnsweredElsewhere;	// IMP=0x001000000008f75d
- (void)end;	// IMP=0x001000000008f462
- (void)cancelOrDeclineInvitation;	// IMP=0x001000000008f32f
- (void)answerWithVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x001000000008f229
- (void)startWithVideoAspectRatioDescriptor:(id)arg1 inviteCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000008f15a
- (int)deviceRole;	// IMP=0x001000000008f141
- (id)capabilities;	// IMP=0x001000000008ef40
- (void)_setLocalAspectRatiosForVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x001000000008eddc
- (void)_setDateEndedIfNecessary;	// IMP=0x001000000008eb66
...
- (id)initOutgoingWithSession:(id)arg1 UUID:(id)arg2 remoteHandle:(id)arg3 wantsVideo:(_Bool)arg4 isRelaying:(_Bool)arg5;	// IMP=0x001000000008e030
- (id)initIncomingWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3 remoteInviteDictionary:(id)arg4;	// IMP=0x001000000008ded1
- (id)initWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3;	// IMP=0x001000000008dd39
