...
+ (Class)contactIdentifiersType;	// IMP=0x0020000000180d26
- (void).cxx_destruct;	// IMP=0x002000000018290e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000182370
- (unsigned long long)hash;	// IMP=0x00100000001821a1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000181e85
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000181a46
- (void)copyTo:(id)arg1;	// IMP=0x00100000001817a2
- (void)writeTo:(id)arg1;	// IMP=0x00100000001814ad
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001814a0
- (id)dictionaryRepresentation;	// IMP=0x0010000000180e10
- (id)description;	// IMP=0x0010000000180d61
@property(readonly, nonatomic) _Bool hasCompanyImageURL;
@property(readonly, nonatomic) _Bool hasCompanyDepartment;
- (id)contactIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000180d09
- (unsigned long long)contactIdentifiersCount;	// IMP=0x0010000000180cec
- (void)addContactIdentifiers:(id)arg1;	// IMP=0x0010000000180c82
- (void)clearContactIdentifiers;	// IMP=0x0010000000180c65
...
- (id)initWithCallDisplayContext:(id)arg1;	// IMP=0x00100000001aaf36
