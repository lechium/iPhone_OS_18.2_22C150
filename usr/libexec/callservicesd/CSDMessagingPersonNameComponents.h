...
- (void).cxx_destruct;	// IMP=0x00200000000ef420
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ef204
- (unsigned long long)hash;	// IMP=0x00100000000ef12d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000eef9d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000eee32
- (void)copyTo:(id)arg1;	// IMP=0x00100000000eed2f
- (void)writeTo:(id)arg1;	// IMP=0x00100000000eec41
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000eec34
- (id)dictionaryRepresentation;	// IMP=0x00100000000ee84a
- (id)description;	// IMP=0x00100000000ee79b
...
- (id)initWithPersonNameComponents:(id)arg1;	// IMP=0x00100000000d6752
