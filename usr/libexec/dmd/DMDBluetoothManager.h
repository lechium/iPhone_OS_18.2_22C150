...
+ (id)sharedManager;	// IMP=0x002000000002bf87
- (void).cxx_destruct;	// IMP=0x002000000002c2ea
...
- (void)availabilityChanged:(id)arg1;	// IMP=0x001000000002c16a
- (id)init;	// IMP=0x001000000002bfdc
