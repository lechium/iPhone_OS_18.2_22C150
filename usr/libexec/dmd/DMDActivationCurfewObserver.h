...
- (void).cxx_destruct;	// IMP=0x002000000000df6c
...
- (id)_nextDateAfter:(id)arg1 matchingWeekday:(long long)arg2 hour:(long long)arg3 minute:(long long)arg4 second:(long long)arg5 inCalendar:(id)arg6;	// IMP=0x001000000000dcdb
- (id)_datesForNextCurfewBoundary;	// IMP=0x001000000000d7e8
- (void)_registerPredicateObserver;	// IMP=0x001000000000d31f
- (_Bool)_extractComponentsFromPredicate:(id)arg1;	// IMP=0x001000000000c9d3
- (id)metadata;	// IMP=0x001000000000c8a2
- (void)updateObserverRegistration;	// IMP=0x001000000000c890
- (void)invalidate;	// IMP=0x001000000000c6d3
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000c13f
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 curfewPredicate:(id)arg3;	// IMP=0x001000000000c04e
