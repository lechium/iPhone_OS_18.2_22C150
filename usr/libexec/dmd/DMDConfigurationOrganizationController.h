...
- (void).cxx_destruct;	// IMP=0x00200000000393d5
...
- (void)resolveAssetWithContext:(id)arg1;	// IMP=0x0010000000039232
- (void)configurationSourceController:(id)arg1 fetchEventsWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000003907a
- (void)configurationSourceController:(id)arg1 fetchStatusUpdatesWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000038ec2
- (void)unregisterConfigurationSource:(id)arg1;	// IMP=0x0010000000038e32
- (id)registerConfigurationSource:(id)arg1;	// IMP=0x0010000000038c43
- (id)configurationSourceWithIdentifier:(id)arg1;	// IMP=0x0010000000038b6c
...
- (void)updateWithOrganization:(id)arg1;	// IMP=0x0010000000038099
- (id)initWithOrganization:(id)arg1 delegate:(id)arg2;	// IMP=0x0010000000037fa3
