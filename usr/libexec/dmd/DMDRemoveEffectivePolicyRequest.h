...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000008080f
- (void).cxx_destruct;	// IMP=0x0020000000080a7a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000080962
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000080817
