...
- (void)networkDidChange;	// IMP=0x00100000000438de
- (void)keybagLockStateDidChange;	// IMP=0x00100000000438a6
- (void)stopObservingChanges;	// IMP=0x001000000004386e
- (void)startObservingChanges;	// IMP=0x00100000000436de
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x00100000000435fe
