...
- (void).cxx_destruct;	// IMP=0x002000000000bfd9
...
- (_Bool)_registerPredicateObserver;	// IMP=0x001000000000bbf0
- (_Bool)_budgetDays:(id)arg1 duration:(id)arg2 calendar:(id)arg3 schedule:(id)arg4;	// IMP=0x001000000000b822
- (_Bool)_extractComponentsFromCompositeBudgetPredicate:(id)arg1;	// IMP=0x001000000000b026
- (_Bool)_extractComponentsFromBudgetPredicate:(id)arg1;	// IMP=0x001000000000a803
- (id)metadata;	// IMP=0x001000000000a6e7
- (void)invalidate;	// IMP=0x001000000000a423
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x0010000000009d08
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 compositeBudgetPredicate:(id)arg3;	// IMP=0x0010000000009c13
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 budgetPredicate:(id)arg3;	// IMP=0x0010000000009b1e
