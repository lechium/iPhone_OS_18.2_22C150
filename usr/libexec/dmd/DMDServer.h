...
+ (id)sharedServer;	// IMP=0x0020000000082f74
- (void).cxx_destruct;	// IMP=0x0020000000083205
...
- (void)invalidate;	// IMP=0x00100000000830dc
- (void)run;	// IMP=0x0010000000082fc9
- (id)init;	// IMP=0x0010000000082c6e
