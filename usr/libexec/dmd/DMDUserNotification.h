...
- (void).cxx_destruct;	// IMP=0x002000000008dace
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x001000000008d9e5
- (struct __CFUserNotification *)notificationRef;	// IMP=0x001000000008d9db
- (void)dealloc;	// IMP=0x001000000008d99c
- (id)init;	// IMP=0x001000000008d93a
