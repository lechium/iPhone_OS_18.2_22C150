...
- (void).cxx_destruct;	// IMP=0x002000000004dcee
...
- (id)processDeclarationPayloadsInContext:(id)arg1 forOrganization:(id)arg2 enqueuedOperations:(id)arg3 assetResolver:(id)arg4 error:(id *)arg5;	// IMP=0x001000000004a735
- (id)processCommandPayloadsInContext:(id)arg1 forOrganization:(id)arg2 enqueuedOperations:(id)arg3 assetResolver:(id)arg4 error:(id *)arg5;	// IMP=0x0010000000049041
- (_Bool)updateActiveRestrictionsInContext:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000487b3
- (_Bool)preprocessDatabaseInContext:(id)arg1 forOrganization:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000047ed1
- (void)performDatabaseModificationOperationWithManagedObjectContext:(id)arg1;	// IMP=0x00100000000475fb
