...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000084aea
- (void).cxx_destruct;	// IMP=0x0020000000085076
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000084dce
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000084af2
