...
- (void).cxx_destruct;	// IMP=0x002000000004f9f2
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x001000000004f84d
- (void)main;	// IMP=0x001000000004efcd
