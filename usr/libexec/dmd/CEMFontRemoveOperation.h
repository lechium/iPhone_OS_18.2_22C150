...
- (void).cxx_destruct;	// IMP=0x00200000000066e0
...
- (void)main;	// IMP=0x0010000000006570
- (id)initWithFontDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x00100000000064ce
