...
- (void).cxx_destruct;	// IMP=0x00200000000071e1
...
- (void)main;	// IMP=0x0010000000007071
- (id)initWithImageDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0010000000006fcf
