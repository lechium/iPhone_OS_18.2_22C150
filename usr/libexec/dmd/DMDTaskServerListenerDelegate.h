...
- (void).cxx_destruct;	// IMP=0x002000000008b955
@property(readonly, nonatomic) CATTaskServer *taskServer; // @synthesize taskServer=_taskServer;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000008b84f
- (id)initWithTaskServer:(id)arg1;	// IMP=0x001000000008b7e4
