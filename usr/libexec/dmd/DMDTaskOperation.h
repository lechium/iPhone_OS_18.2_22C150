...
+ (id)whitelistedClassesForRequest;	// IMP=0x0020000000089878
+ (id)requiredEntitlements;	// IMP=0x000000000008986b
+ (_Bool)validateRequest:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000089667
- (void).cxx_destruct;	// IMP=0x002000000008995d
...
- (void)endOperationWithDMFErrorCode:(long long)arg1;	// IMP=0x00100000000898af
- (void)runWithRequest:(id)arg1;	// IMP=0x0010000000089898
...
- (void)main;	// IMP=0x00100000000897b8
- (_Bool)isAsynchronous;	// IMP=0x00100000000897b0
- (void)operationDidFinish;	// IMP=0x0010000000089617
- (void)operationWillFinish;	// IMP=0x001000000008956e
- (void)operationWillStart;	// IMP=0x00100000000894d7
- (id)initWithRequest:(id)arg1;	// IMP=0x0010000000089428
- (void)dealloc;	// IMP=0x001000000008934f
