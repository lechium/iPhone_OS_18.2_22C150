...
- (void).cxx_destruct;	// IMP=0x0020000000051f2b
...
- (void)startWithScheduleElapsedHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000051d12
- (unsigned long long)hash;	// IMP=0x0010000000051bde
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000051992
- (id)description;	// IMP=0x00100000000518df
- (void)dealloc;	// IMP=0x001000000005189d
- (id)initWithScheduleRegistration:(id)arg1;	// IMP=0x00100000000515dc
