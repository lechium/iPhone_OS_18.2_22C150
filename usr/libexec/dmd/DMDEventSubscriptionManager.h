...
- (void).cxx_destruct;	// IMP=0x0020000000053e78
...
- (id)eventStatusesByPayloadIdentifierSinceStartDate:(id)arg1 organizationIdentifier:(id)arg2;	// IMP=0x0010000000053c03
- (_Bool)setEventSubscriptionRegistrations:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000535db
- (id)init;	// IMP=0x0010000000053585
