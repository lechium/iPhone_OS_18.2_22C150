...
- (void).cxx_destruct;	// IMP=0x0020000000053552
...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x001000000005340a
- (id)description;	// IMP=0x001000000005336d
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x001000000005329d
