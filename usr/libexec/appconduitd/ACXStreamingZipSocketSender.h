...
+ (id)senderForURL:(id)arg1 queue:(id)arg2 writingUsingBlock:(CDUnknownBlockType)arg3;	// IMP=0x004000000006be8e
- (void).cxx_destruct;	// IMP=0x002000000006c7e0
...
- (void)cancelSending;	// IMP=0x001000000006c727
- (void)beginSendingWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000006bf22
- (id)initWithURL:(id)arg1 queue:(id)arg2 writerBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000006bdcc
