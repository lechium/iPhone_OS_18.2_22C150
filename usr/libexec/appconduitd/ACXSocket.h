...
- (void).cxx_destruct;	// IMP=0x0020000000039719
...
- (id)readDataOrDictionaryWithError:(id *)arg1;	// IMP=0x0010000000038df8
- (id)readDictionaryWithError:(id *)arg1;	// IMP=0x0010000000038cb4
- (id)readDataWithError:(id *)arg1;	// IMP=0x0010000000038b70
- (_Bool)writeShutdownMessageWithError:(id *)arg1;	// IMP=0x0010000000038aff
- (_Bool)writePingWithError:(id *)arg1;	// IMP=0x0010000000038a8e
- (_Bool)writeDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003888f
- (_Bool)writeData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003880e
- (_Bool)writeBytes:(const void *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000000385d7
- (void)_setUpSocketReadSource;	// IMP=0x001000000003833d
- (void)invalidate;	// IMP=0x0010000000038212
- (void)noteWifiAsserted:(_Bool)arg1;	// IMP=0x0010000000038209
- (void)suspendReadSource;	// IMP=0x00100000000381a1
- (void)resumeReadSource;	// IMP=0x0010000000038136
- (id)initWithIDSDeviceConnection:(id)arg1 boostingMessageContext:(id)arg2 streamName:(id)arg3 creationTime:(id)arg4 readEventHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000038005
- (id)initWithSocket:(int)arg1 streamName:(id)arg2 creationTime:(id)arg3 readEventHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000037f27
