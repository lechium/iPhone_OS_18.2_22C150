...
- (void).cxx_destruct;	// IMP=0x0020000000049b18
...
- (unsigned long long)hash;	// IMP=0x0010000000049adc
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000499cd
- (id)initWithObserver:(id)arg1 queue:(id)arg2;	// IMP=0x00100000000498e6
