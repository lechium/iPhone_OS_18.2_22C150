...
+ (id)installOperationForURL:(id)arg1 watchAppBundleIdentifier:(id)arg2 companionAppBundleID:(id)arg3 isPlaceholder:(_Bool)arg4 size:(long long)arg5 targetUsesLegacySocketService:(_Bool)arg6;	// IMP=0x0020000000044e36
+ (id)installOperationForCompanionAppBundleIdentifier:(id)arg1 watchAppBundleIdentifier:(id)arg2 targetUsesLegacySocketService:(_Bool)arg3;	// IMP=0x0010000000044db1
- (void).cxx_destruct;	// IMP=0x0020000000048703
...
- (void)socketDidCloseWithError:(id)arg1;	// IMP=0x0010000000048444
- (void)receivedDictionaryOrData:(id)arg1;	// IMP=0x0010000000046bd6
- (void)_onQueue_startInstall;	// IMP=0x0010000000046945
- (void)_onQueue_doTransferAndInstall;	// IMP=0x00100000000464f2
- (void)_onQueue_prepForTransferAndInstall;	// IMP=0x0010000000045b44
- (id)_onQueue_sendCancelMessage;	// IMP=0x0010000000045a30
- (id)_makeTempDirectoryWithError:(id *)arg1;	// IMP=0x001000000004593e
- (void)_onQueue_callCompletion:(id)arg1;	// IMP=0x001000000004569f
- (void)_onQueue_callProgressBlockWithPhase:(unsigned long long)arg1 percent:(double)arg2;	// IMP=0x0010000000045585
- (void)_onQueue_disarmWatchdog;	// IMP=0x00100000000454fd
- (void)_onQueue_armWatchdog;	// IMP=0x0010000000045307
- (void)cancel;	// IMP=0x001000000004527b
- (void)beginWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000044eee
- (void)dealloc;	// IMP=0x0010000000044cc2
- (id)initWithWatchAppBundleID:(id)arg1 companionAppBundleID:(id)arg2 isPlaceholder:(_Bool)arg3 appURL:(id)arg4 size:(long long)arg5 targetUsesLegacySocketService:(_Bool)arg6;	// IMP=0x0010000000044ba8
- (id)initWithCompanionBundleID:(id)arg1 watchAppBundleID:(id)arg2 targetUsesLegacySocketService:(_Bool)arg3;	// IMP=0x0010000000044ad2
- (void)_commonInit:(_Bool)arg1;	// IMP=0x00100000000449c0
