...
- (void).cxx_destruct;	// IMP=0x00200000000162bd
...
- (id)dictionaryRepresentation;	// IMP=0x001000000001605c
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000015d72
- (id)initWithLSSequenceNumber:(unsigned long long)arg1 acxSequenceNumber:(unsigned long long)arg2 counterpartIdentifiers:(id)arg3;	// IMP=0x0010000000015ce9
