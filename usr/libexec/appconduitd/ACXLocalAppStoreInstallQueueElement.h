...
- (void).cxx_destruct;	// IMP=0x0020000000037ef4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000037d97
- (unsigned long long)hash;	// IMP=0x0010000000037d29
- (id)initWithApp:(id)arg1 isUserInitiated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000037c76
