...
- (void)performConditionalRegistrationForExternalProviderWithLoginChoice:(ASCPlatformPublicKeyCredentialLoginChoice *)arg1 delegate:(id <ASPublicKeyCredentialManagerDelegate>)arg2;
...
- (void)completeAssertionWithExternalPasskeyForUUID:(NSUUID *)arg1 usingCredential:(ASCPlatformPublicKeyCredentialAssertion *)arg2;
...
- (_Bool)renamePasskeywithIdentifier:(WBSPublicKeyCredentialIdentifier *)arg1 newName:(NSString *)arg2 error:(id *)arg3;
...
- (NSUUID *)createNewPlatformCredentialWithOptions:(ASCPublicKeyCredentialCreationOptions *)arg1 authenticatedContext:(LAContext *)arg2 delegate:(id <ASPublicKeyCredentialManagerDelegate>)arg3 webFrameIdentifier:(ASGlobalFrameIdentifier *)arg4 parentActivity:(NSObject<OS_os_activity> *)arg5 isConditionalRegistration:(_Bool)arg6;
...
@optional
- (void)test_runBlockToRunAfterReceivingRequest;
- (_Bool)passkeyExistsForRelyingParty:(NSString *)arg1 username:(NSString *)arg2;
@end
