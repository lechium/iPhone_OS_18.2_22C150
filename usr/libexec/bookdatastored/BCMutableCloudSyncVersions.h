...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000044aeb
- (void).cxx_destruct;	// IMP=0x0020000000044e22
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000044c2b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000044af3
- (id)description;	// IMP=0x00100000000449f2
- (id)initWithCloudSyncVersions:(id)arg1;	// IMP=0x00100000000448cf
