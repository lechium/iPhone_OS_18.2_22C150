...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000489af
- (void).cxx_destruct;	// IMP=0x0020000000048c88
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000048ad2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000489b7
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000048885
- (id)configuredRecordFromAttributes;	// IMP=0x00100000000487f1
- (void)incrementEditGeneration;	// IMP=0x00100000000487bf
- (id)zoneName;	// IMP=0x0010000000048512
- (id)identifier;	// IMP=0x00100000000484cf
- (id)recordType;	// IMP=0x0010000000048487
@property(readonly, copy, nonatomic) NSData *ckSystemFields; // @dynamic ckSystemFields;
- (id)initWithRecord:(id)arg1;	// IMP=0x0010000000048339
- (id)initWithCloudData:(id)arg1;	// IMP=0x00100000000481d4
- (id)init;	// IMP=0x0010000000048154
