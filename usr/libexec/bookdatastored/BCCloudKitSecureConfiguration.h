...
+ (id)configuration;	// IMP=0x0020000000041a89
- (void).cxx_destruct;	// IMP=0x0020000000041d28
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x0010000000041c19
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x0010000000041c11
