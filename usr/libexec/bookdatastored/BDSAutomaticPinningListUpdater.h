...
- (void).cxx_destruct;	// IMP=0x00200000000464fd
...
- (void)_l_finishWithError:(id)arg1;	// IMP=0x00100000000461bb
- (void)_l_finishedFetchingCollectionsWithManager:(_Bool)arg1;	// IMP=0x0010000000045f16
- (void)_updateAttachmentCompletedFromObserver:(unsigned long long)arg1 attached:(_Bool)arg2;	// IMP=0x0010000000045c73
- (_Bool)_updateCloudDataWithManager:(id)arg1;	// IMP=0x00100000000455af
- (void)_l_cancelWithManagers:(id)arg1;	// IMP=0x0010000000045112
- (void)cancelWithManager:(id)arg1;	// IMP=0x0010000000044fdb
- (_Bool)startUpdateWithManager:(id)arg1 jaliscoUpdateSuccessful:(_Bool)arg2;	// IMP=0x0010000000044eb7
- (id)init;	// IMP=0x0010000000044e4a
