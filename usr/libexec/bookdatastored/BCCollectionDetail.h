...
+ (id)propertyIDKey;	// IMP=0x002000000008cadb
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

- (id)zoneName;	// IMP=0x001000000008cae8
- (id)identifier;	// IMP=0x001000000008cac9
- (id)recordType;	// IMP=0x001000000008cabc
- (void)resolveConflictsFromRecord:(id)arg1 withResolvers:(id)arg2;	// IMP=0x001000000008c287
- (void)_configureFromCollectionDetail:(id)arg1 withMergers:(id)arg2;	// IMP=0x001000000008bef8
- (_Bool)isEqualExceptForDate:(id)arg1 ignoringEmptySalt:(_Bool)arg2;	// IMP=0x001000000008bc61
- (void)configureFromCloudData:(id)arg1 withMergers:(id)arg2;	// IMP=0x001000000008bbbc
- (id)mutableCopy;	// IMP=0x001000000008bb8e
