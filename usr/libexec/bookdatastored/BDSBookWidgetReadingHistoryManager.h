...
- (void).cxx_destruct;	// IMP=0x0020000000003b09
...
- (void)_processViewStateChange:(id)arg1;	// IMP=0x00100000000035a2
- (void)handleReadingHistoryViewStateChange:(id)arg1;	// IMP=0x0010000000003559
@property(readonly, nonatomic) BDSReadingHistoryStateInfo *currentViewStateInfo;
- (id)initWithBookWidgetDataUpdater:(id)arg1 transactionProvider:(id)arg2;	// IMP=0x001000000000331e
