...
@interface BCMutableAssetDetail
{
    ...
    short _finishedDateKind;	// 14 = 0xe
...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000040ef4
- (void).cxx_destruct;	// IMP=0x00200000000419d0
...
@property(nonatomic) short finishedDateKind; // @synthesize finishedDateKind=_finishedDateKind;
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000412d8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000040efc
- (id)configuredRecordFromAttributes;	// IMP=0x0010000000040942
- (id)zoneName;	// IMP=0x0010000000040818
- (id)identifier;	// IMP=0x0010000000040806
- (id)recordType;	// IMP=0x00100000000407f9
@property(readonly, copy) NSString *description;
- (id)initWithRecord:(id)arg1;	// IMP=0x001000000003ffe8
- (id)initWithCloudData:(id)arg1;	// IMP=0x001000000003fb99
- (id)initWithAssetID:(id)arg1;	// IMP=0x001000000003fad5
