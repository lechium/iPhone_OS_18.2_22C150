...
- (void).cxx_destruct;	// IMP=0x00200000000148f5
...
- (void)acknowledgeiCloudIdentity;	// IMP=0x00100000000144c9
- (_Bool)didUnacknowledgediCloudLogoutOccur;	// IMP=0x0010000000014178
- (void)forceUpdateTokenWithString:(id)arg1;	// IMP=0x00100000000140f5
- (void)fetchCurrentToken;	// IMP=0x0010000000014084
- (id)initWithContainerURL:(id)arg1 trackingLiverpool:(_Bool)arg2;	// IMP=0x0010000000013f23
