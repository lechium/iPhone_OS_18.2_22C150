...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000037f8
- (void).cxx_destruct;	// IMP=0x0020000000004a7b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000004125
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0010000000003d70
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000003d65
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000003b25
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000003800
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x0010000000003610
