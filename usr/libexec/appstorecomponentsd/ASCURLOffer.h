...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000028ab7
- (void).cxx_destruct;	// IMP=0x0020000000029965
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002927f
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0010000000028f87
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000028f7c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000028db4
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000028abf
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x0010000000028949
