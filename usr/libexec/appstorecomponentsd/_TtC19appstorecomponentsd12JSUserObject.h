...
- (void).cxx_destruct;	// IMP=0x00400000000dbee0
- (id)init;	// IMP=0x00100000000dbe80
- (id)cookieForUrlWithName:(id)arg1:(id)arg2;	// IMP=0x00100000000dbe00
- (id)cookiesForUrl:(id)arg1;	// IMP=0x00100000000dbb40
