...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000099a8
- (void).cxx_destruct;	// IMP=0x002000000000a911
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000a1c1
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0010000000009e9f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000009e94
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000009cbc
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000099b0
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x0010000000009810
