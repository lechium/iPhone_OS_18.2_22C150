...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000017d3a
- (void).cxx_destruct;	// IMP=0x0020000000017cdb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000017ad2
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000178fa
- (id)initWithGroupID:(id)arg1 shareURL:(id)arg2 senderHandle:(id)arg3 inviteeHandle:(id)arg4 inviteToken:(id)arg5 sentTime:(id)arg6 displayName:(id)arg7;	// IMP=0x00100000000177b0
