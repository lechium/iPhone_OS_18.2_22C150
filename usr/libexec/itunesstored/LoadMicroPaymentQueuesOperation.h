...
- (void).cxx_destruct;	// IMP=0x0020000000090d31
...
- (id)_URLBagContext;	// IMP=0x0010000000090c53
- (_Bool)_shouldCheckAutoRenewQueue;	// IMP=0x0010000000090b67
- (_Bool)_appendToResponse:(id)arg1 usingOperation:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000090683
- (_Bool)_appendNormalQueueToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x001000000009051e
- (_Bool)_appendAutoRenewQueueToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000903b9
- (void)run;	// IMP=0x001000000008fc92
