...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000286b1
- (unsigned long long)hash;	// IMP=0x00100000000286a7
- (id)description;	// IMP=0x0010000000028641
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000028581
- (void)dealloc;	// IMP=0x0010000000028529
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x00100000000284c7
