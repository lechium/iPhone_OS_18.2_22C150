...
- (void).cxx_destruct;	// IMP=0x002000000006e06a
- (_Bool)_updateTouchIDSettingsForAccount:(id)arg1;	// IMP=0x001000000006d9ed
- (id)_authenticateWithAccount:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006cb7a
- (void)run;	// IMP=0x001000000006cadc
@property(copy) CDUnknownBlockType resultBlock;
@property _Bool requiresStoreAuthentication;
- (id)init;	// IMP=0x001000000006c935
