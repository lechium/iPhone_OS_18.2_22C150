...
- (void).cxx_destruct;	// IMP=0x00200000001e1b66
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00100000001e1a3a
- (id)description;	// IMP=0x00100000001e1922
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x00100000001e1816
