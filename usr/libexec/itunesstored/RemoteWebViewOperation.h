...
- (void).cxx_destruct;	// IMP=0x0020000000185149
...
- (void)_sendActivationWithError:(id)arg1;	// IMP=0x0010000000184f94
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x0010000000184d93
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0010000000184bbf
- (void)remoteAlertHandleDidActivate:(id)arg1;	// IMP=0x00100000001849fb
- (void)run;	// IMP=0x001000000018454a
- (id)initWithWebViewRequest:(id)arg1;	// IMP=0x00100000001844b9
