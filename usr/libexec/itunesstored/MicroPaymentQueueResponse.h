...
- (_Bool)_ntsLoadFromPropertyList:(id)arg1;	// IMP=0x00200000000478cf
- (id)_dsidFromDictionary:(id)arg1;	// IMP=0x001000000004782a
- (id)_copyPaymentsFromDictionary:(id)arg1;	// IMP=0x00100000000475ba
- (id)_copyAppReceiptFromDictionary:(id)arg1;	// IMP=0x0010000000047568
@property(copy) NSNumber *userIdentifier;
@property _Bool shouldTriggerQueueCheck;
- (void)setRangesToLoad:(id)arg1;	// IMP=0x00100000000473e5
...
- (_Bool)loadFromPropertyList:(id)arg1;	// IMP=0x001000000004717c
- (void)appendResponse:(id)arg1;	// IMP=0x0010000000046e66
- (void)dealloc;	// IMP=0x0010000000046e07
- (id)initWithRequestType:(long long)arg1;	// IMP=0x0010000000046dca
