...
- (void).cxx_destruct;	// IMP=0x00200000000333f3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000033259
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000032cdc
- (id)initWithApplication:(id)arg1;	// IMP=0x0010000000032b4b
