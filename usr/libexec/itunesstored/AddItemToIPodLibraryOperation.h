...
- (void)_setInsertedItemPersistentIdentifier:(long long)arg1;	// IMP=0x00200000000aaf35
- (id)_libraryItem;	// IMP=0x00100000000aaee0
- (void)run;	// IMP=0x00100000000aace2
@property(readonly) NSNumber *insertedItemPersistentIdentifier;
@property(readonly) IPodLibraryItem *IPodLibraryItem;
- (void)dealloc;	// IMP=0x00100000000aabdc
- (id)initWithIPodLibraryItem:(id)arg1;	// IMP=0x00100000000aab7e
