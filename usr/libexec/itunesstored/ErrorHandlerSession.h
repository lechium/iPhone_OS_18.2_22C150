...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001b36e6
- (unsigned long long)hash;	// IMP=0x00100000001b36dc
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x00100000001b36b5
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x00100000001b364a
- (void)dealloc;	// IMP=0x00100000001b360f
- (id)init;	// IMP=0x00100000001b35b1
