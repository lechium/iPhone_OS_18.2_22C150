...
- (id)_userAgentForPurchases:(id)arg1;	// IMP=0x00200000001c669c
- (id)_clientIdentifierForPurchases:(id)arg1;	// IMP=0x00100000001c6529
- (void)run;	// IMP=0x00100000001c6348
@property(copy) NSString *clientIdentifierHeader;
@property(copy) CDUnknownBlockType authenticationBlock;
- (void)dealloc;	// IMP=0x00100000001c6197
- (id)initWithPurchases:(id)arg1;	// IMP=0x00100000001c5fd4
