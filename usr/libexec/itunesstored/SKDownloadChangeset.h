...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0020000000012ec6
- (void).cxx_destruct;	// IMP=0x00200000000133fa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001322e
- (id)copyXPCEncoding;	// IMP=0x0010000000013171
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0010000000012f64
