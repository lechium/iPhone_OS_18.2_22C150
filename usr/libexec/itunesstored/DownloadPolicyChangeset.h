...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000188d93
- (void)dealloc;	// IMP=0x0010000000188d49
- (id)initWithPolicyIdentifiers:(id)arg1;	// IMP=0x0010000000188cf2
