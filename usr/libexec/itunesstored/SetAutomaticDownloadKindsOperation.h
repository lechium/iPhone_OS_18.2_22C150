...
- (void)_run;	// IMP=0x00200000000aa6ee
- (_Bool)_postDownloadKinds:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000aa0ec
- (_Bool)_isFatalError:(id)arg1;	// IMP=0x00100000000aa0dc
- (id)_copyFilteredDownloadKinds;	// IMP=0x00100000000a9e5b
- (id)uniqueKey;	// IMP=0x00100000000a9e4e
- (_Bool)shouldFailAfterUniquePredecessorError:(id)arg1;	// IMP=0x00100000000a9e3c
- (void)run;	// IMP=0x00100000000a9c68
...
- (void)dealloc;	// IMP=0x00100000000a98a3
- (id)initWithDownloadKinds:(id)arg1;	// IMP=0x00100000000a9845
