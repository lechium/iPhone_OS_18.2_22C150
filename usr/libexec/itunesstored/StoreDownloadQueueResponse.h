...
- (void).cxx_destruct;	// IMP=0x0020000000012429
...
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2;	// IMP=0x0010000000012324
...
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x001000000001202d
@property(readonly) NSOrderedSet *downloads;
- (id)initWithError:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0010000000011e79
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2 preferredAssetFlavor:(id)arg3;	// IMP=0x0010000000010f36
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0010000000010f21
- (id)init;	// IMP=0x0010000000010f0f
- (id)_initStoreDownloadQueueResponse;	// IMP=0x0010000000010eb7
- (id)_newManifestWithStoreDownloadQueueResponse:(id)arg1 accountID:(id)arg2 accountName:(id)arg3;	// IMP=0x00100000001722cb
- (void)enumerateActivitiesWithAccountID:(id)arg1 accountName:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00100000001719c3
- (id)copyJobManifestWithAccountID:(id)arg1 accountName:(id)arg2;	// IMP=0x001000000017195a
