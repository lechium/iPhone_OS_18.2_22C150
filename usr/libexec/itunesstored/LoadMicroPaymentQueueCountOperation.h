...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008eb9f
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x001000000008e8bd
- (void)run;	// IMP=0x001000000008e602
- (void)dealloc;	// IMP=0x001000000008e59c
