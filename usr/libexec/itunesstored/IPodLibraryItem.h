...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x00200000001080db
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x00200000001096f7
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x0010000000109590
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x0010000000108c97
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000107f24
- (void)dealloc;	// IMP=0x0010000000107eb5
- (id)init;	// IMP=0x0010000000107e67
