...
- (void)_setURLCredential:(id)arg1;	// IMP=0x0020000000190b3a
- (void)_setState:(long long)arg1;	// IMP=0x0010000000190aeb
- (id)_openSession;	// IMP=0x0010000000190877
- (void)downloadHandlerManager:(id)arg1 sessionsDidChange:(id)arg2;	// IMP=0x00100000001906a4
- (void)run;	// IMP=0x0010000000190189
- (void)cancel;	// IMP=0x0010000000190101
...
- (void)dealloc;	// IMP=0x001000000018ff20
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x001000000018feb0
