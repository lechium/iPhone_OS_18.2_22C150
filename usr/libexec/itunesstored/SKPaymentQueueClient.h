...
- (void).cxx_destruct;	// IMP=0x00200000000a97f1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a95fa
- (id)copyXPCEncoding;	// IMP=0x00100000000a9509
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00100000000a932d
