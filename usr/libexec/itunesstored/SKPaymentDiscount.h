...
- (void).cxx_destruct;	// IMP=0x002000000008763c
...
- (id)initWithIdentifier:(id)arg1 keyIdentifier:(id)arg2 nonce:(id)arg3 signature:(id)arg4 timestamp:(id)arg5;	// IMP=0x0010000000087330
