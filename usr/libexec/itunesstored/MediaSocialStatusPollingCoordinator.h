...
- (void).cxx_destruct;	// IMP=0x00200000001de1a2
@property(nonatomic) __weak id <MediaSocialStatusPollingDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_finishRequests:(id)arg1 withResponses:(id)arg2;	// IMP=0x00100000001ddac0
- (void)_addBackgroundTaskJob;	// IMP=0x00100000001ddaba
- (void)_handleBackgroundTaskEvent:(id)arg1;	// IMP=0x00100000001ddab4
@property(readonly, nonatomic) long long numberOfPollRequests;
- (void)addPollRequest:(id)arg1;	// IMP=0x00100000001dda98
- (void)dealloc;	// IMP=0x00100000001dda69
- (id)initWithDispatchQueue:(id)arg1;	// IMP=0x00100000001dd99a
