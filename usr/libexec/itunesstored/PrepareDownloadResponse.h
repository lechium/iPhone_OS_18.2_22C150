...
- (void).cxx_destruct;	// IMP=0x002000000017eb5b
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x001000000017df3d
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x001000000017d8b1
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1 error:(id *)arg2;	// IMP=0x001000000017d554
- (id)sessionConfiguration;	// IMP=0x001000000017d37f
