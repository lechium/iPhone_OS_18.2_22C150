...
- (void)_setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000000fad2
...
- (void)dealloc;	// IMP=0x001000000000f989
- (id)initWithManifestItemDictionary:(id)arg1;	// IMP=0x001000000000f932
- (id)init;	// IMP=0x001000000000f8e6
