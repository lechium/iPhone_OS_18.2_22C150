...
- (void).cxx_destruct;	// IMP=0x0020000000028494
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000028342
- (unsigned long long)hash;	// IMP=0x001000000002832c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000028268
