...
+ (id)defaultProperties;	// IMP=0x0040000000086fa1
+ (Class)databaseEntityClass;	// IMP=0x0010000000086f90
- (void).cxx_destruct;	// IMP=0x00200000000872ee
...
- (id)secondaryAssetForType:(id)arg1;	// IMP=0x0010000000086c5e
@property(readonly, nonatomic) long long restoreState;
- (id)newITunesMetadataDictionary;	// IMP=0x00100000000864b0
- (void)loadAssetsUsingSession:(id)arg1;	// IMP=0x0010000000085f1d
...
- (id)destinationDirectoryPathForAsset:(id)arg1;	// IMP=0x0010000000085991
