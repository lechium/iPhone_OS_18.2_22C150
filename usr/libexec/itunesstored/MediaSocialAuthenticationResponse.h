...
- (void).cxx_destruct;	// IMP=0x00200000000e2dff
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e2d0b
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00100000000e2cb1
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00100000000e2c57
- (id)init;	// IMP=0x00100000000e2be2
