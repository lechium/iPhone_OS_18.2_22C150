...
- (void).cxx_destruct;	// IMP=0x00200000001e31fc
...
- (id)_newProgressForMediaSelection:(id)arg1;	// IMP=0x00100000001e3092
- (void)setMediaSelectionDidComplete:(id)arg1;	// IMP=0x00100000001e3088
- (void)setProgress:(double)arg1 forMediaSelection:(id)arg2;	// IMP=0x00100000001e2efb
@property(readonly, nonatomic) double progress;
- (id)init;	// IMP=0x00100000001e2e7f
