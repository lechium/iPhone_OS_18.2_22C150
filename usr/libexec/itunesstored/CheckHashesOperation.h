...
- (void)run;	// IMP=0x002000000011deda
@property(readonly) long long numberOfBytesToHash;
@property(readonly) NSArray *hashes;
@property(readonly) NSString *filePath;
- (void)dealloc;	// IMP=0x001000000011de35
- (id)initWithFilePath:(id)arg1 hashes:(id)arg2 bytesToHash:(long long)arg3;	// IMP=0x001000000011dd9f
