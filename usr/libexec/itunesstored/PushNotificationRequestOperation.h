...
- (_Bool)_loadResponseWithAccountIdentifier:(id)arg1 URL:(id)arg2 error:(id *)arg3;	// IMP=0x002000000008cc58
- (void)run;	// IMP=0x001000000008c3c0
@property(copy) NSString *userAgent;
@property(readonly) SSURLConnectionResponse *URLResponse;
- (void)dealloc;	// IMP=0x001000000008c257
- (id)initWithPushNotificationParameters:(id)arg1;	// IMP=0x001000000008c1f9
