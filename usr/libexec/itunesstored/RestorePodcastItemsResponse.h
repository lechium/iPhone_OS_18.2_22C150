...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x00100000001a256f
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x00100000001a2548
- (void)dealloc;	// IMP=0x00100000001a24f0
