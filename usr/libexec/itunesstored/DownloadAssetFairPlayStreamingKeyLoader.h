...
- (void).cxx_destruct;	// IMP=0x00200000000a4a09
...
- (id)_track;	// IMP=0x00100000000a4681
- (void)_persistURI:(id)arg1 persistentContentKey:(id)arg2;	// IMP=0x00100000000a467b
- (void)_persistKeys;	// IMP=0x00100000000a4675
- (id)_pastisKeyServerURL;	// IMP=0x00100000000a45aa
- (id)_pastisCertificateURL;	// IMP=0x00100000000a44df
- (_Bool)resourceLoader:(id)arg1 shouldWaitForLoadingOfRequestedResource:(id)arg2;	// IMP=0x00100000000a44d7
- (void)persistKeys;	// IMP=0x00100000000a44d1
- (void)applyResourceLoaderDelegate:(id)arg1;	// IMP=0x00100000000a44b2
- (id)initWithDownloadEntity:(id)arg1;	// IMP=0x00100000000a4337
