...
- (void).cxx_destruct;	// IMP=0x00200000000d479c
...
- (_Bool)_shouldSkipInitialDialog:(id)arg1;	// IMP=0x00100000000d3fc2
- (_Bool)_shouldAuthenticateForButton:(id)arg1;	// IMP=0x00100000000d3f00
- (_Bool)_isLocalizationAlreadyConfiguredForAuthContext:(id)arg1;	// IMP=0x00100000000d3e56
- (void)_handleSelectedButton:(id)arg1;	// IMP=0x00100000000d3b77
- (_Bool)_copySelectedButton:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000d3851
- (id)_copyButtonToSkipDialog:(id)arg1;	// IMP=0x00100000000d36a6
- (id)_copyAuthenticationContext;	// IMP=0x00100000000d2c33
- (_Bool)_copyAccountIdentifier:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000d27e0
- (void)run;	// IMP=0x00100000000d2267
...
- (id)initWithDialog:(id)arg1;	// IMP=0x00100000000d1f25
- (id)init;	// IMP=0x00100000000d1ced
