...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001b4832
- (void)_presentDialog:(id)arg1;	// IMP=0x00100000001b479e
- (void)dealloc;	// IMP=0x00100000001b475c
