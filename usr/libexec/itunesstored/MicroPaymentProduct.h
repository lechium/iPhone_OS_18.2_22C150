...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x0040000000064566
...
- (id)copyProduct;	// IMP=0x001000000006416e
- (void)dealloc;	// IMP=0x00100000000640ec
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000063a04
