...
- (void).cxx_destruct;	// IMP=0x00200000000b1335
@property(readonly) NSData *auditTokenData; // @synthesize auditTokenData=_auditTokenData;
- (_Bool)_isAdHocCodeSigned;	// IMP=0x00100000000b1309
- (_Bool)_isBetaApp;	// IMP=0x00100000000b12f1
- (_Bool)_isNewsstandApp;	// IMP=0x00100000000b1252
- (void)_invalidateBackgroundTaskAssertion:(id)arg1;	// IMP=0x00100000000b0ea2
- (void)_handleOutputConnectionDisconnect;	// IMP=0x00100000000b0d76
@property(readonly, nonatomic) long long _clientType;
@property(readonly, nonatomic) unsigned int _applicationState;
- (id)_applicationBackgroundModes;	// IMP=0x00100000000b0b21
- (void)_applicationStateChanged:(id)arg1;	// IMP=0x00100000000b0700
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b0675
- (unsigned long long)hash;	// IMP=0x00100000000b065f
- (id)description;	// IMP=0x00100000000b05d9
- (id)valueForEntitlement:(id)arg1;	// IMP=0x00100000000b05c3
@property(readonly) NSString *userAgent;
- (void)setOutputConnectionWithConnection:(id)arg1;	// IMP=0x00100000000b03df
- (void)sendCoalescedMessageWithIdentifier:(unsigned long long)arg1;	// IMP=0x00100000000b021f
@property(readonly) int processIdentifier;
@property(readonly) SSXPCConnection *outputConnection;
- (void)loadSpringBoardStateWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000b001d
...
- (void)endBackgroundTaskWithIdentifier:(id)arg1;	// IMP=0x00100000000afa44
- (id)copyInputConnection;	// IMP=0x00100000000af971
- (id)copyApplicationBackgroundModes;	// IMP=0x00100000000af859
...
- (id)beginBackgroundTaskWithReason:(unsigned int)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000000af165
@property(readonly) unsigned int applicationState;
- (void)dealloc;	// IMP=0x00100000000aedfd
- (id)initWithApplicationIdentifier:(id)arg1 isAppleSigned:(_Bool)arg2;	// IMP=0x00100000000aed77
- (id)initWithInputConnection:(id)arg1;	// IMP=0x00100000000ae816
- (id)init;	// IMP=0x00100000000ae802
- (id)_initCommon;	// IMP=0x00100000000ae795
