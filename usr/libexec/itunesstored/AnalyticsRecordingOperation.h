...
@class MISSING_TYPE, NSArray, NSString, SSMetricsController;
...
- (void).cxx_destruct;	// IMP=0x00200000001b08a2
@property(copy, nonatomic) NSString *appBundleId; // @synthesize appBundleId=_appBundleId;
@property(copy, nonatomic) NSString *eventTopicOverride; // @synthesize eventTopicOverride=_eventTopicOverride;
- (void)run;	// IMP=0x00100000001af4ba
- (MISSING_TYPE *)initWithMetricsEvents: /* Error: Ran out of types for this method. */;	// IMP=0x00100000001af44c
