...
- (void).cxx_destruct;	// IMP=0x00200000001a2f4b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a2b0e
- (id)description;	// IMP=0x00100000001a2ac0
- (id)initWithAppAdamId:(id)arg1 transactionId:(id)arg2 campaignId:(id)arg3 adNetworkId:(id)arg4 attributionSignature:(id)arg5 pingbackUrl:(id)arg6 retryCount:(long long)arg7 localTimestamp:(id)arg8;	// IMP=0x00100000001a26de
