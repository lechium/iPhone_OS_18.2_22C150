...
- (void).cxx_destruct;	// IMP=0x0020000000120153
- (long long)_keyboardType;	// IMP=0x00100000001200f0
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x00100000001200db
- (void)run;	// IMP=0x0010000000120038
@property(copy) CDUnknownBlockType tokenBlock;
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x001000000011fc34
