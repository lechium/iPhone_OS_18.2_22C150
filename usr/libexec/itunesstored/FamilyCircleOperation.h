...
- (void)_writeCacheWithFamilyCircle:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x0010000000010cfd
- (id)_familyCircleForDictionary:(id)arg1;	// IMP=0x0010000000010397
- (id)_cachePath;	// IMP=0x001000000001030b
- (id)_cachedFamilyCircleWithAccountIdentifier:(id)arg1;	// IMP=0x0010000000010117
- (void)run;	// IMP=0x001000000000fb6e
- (void)dealloc;	// IMP=0x001000000000fb08
