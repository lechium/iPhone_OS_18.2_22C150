...
- (void)runWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000004f220
@property(readonly, nonatomic) _Bool blocksAppInstallation;
- (_Bool)applicationIsInstalled:(id)arg1;	// IMP=0x001000000004f19f
- (void)dealloc;	// IMP=0x001000000004f164
- (id)initWithApplicationHandle:(id)arg1;	// IMP=0x001000000004f10d
