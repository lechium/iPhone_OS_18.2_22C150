...
+ (id)propertiesForDownloadEntities;	// IMP=0x0040000000198b44
+ (id)downloadEntityFromContext:(id)arg1;	// IMP=0x0010000000198af7
- (void)awakeFromInsert;	// IMP=0x002000000019902a
- (void)setValuesWithAssetDictionary:(id)arg1;	// IMP=0x0010000000198cfe
- (id)copySKDownload;	// IMP=0x0010000000198baf
