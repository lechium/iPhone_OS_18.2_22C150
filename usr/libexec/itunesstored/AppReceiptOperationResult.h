...
- (void)addRefreshed:(id)arg1;	// IMP=0x001000000011fb6f
- (void)addRevoked:(id)arg1;	// IMP=0x001000000011fb13
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000011fa35
- (void)dealloc;	// IMP=0x001000000011f9cf
