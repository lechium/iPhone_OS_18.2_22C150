...
- (void).cxx_destruct;	// IMP=0x00200000001ac6d1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001ac5a5
@property(readonly, nonatomic) NSString *URLBagKey;
- (id)initWithReceiptFlags:(unsigned long long)arg1;	// IMP=0x00100000001ac53d
