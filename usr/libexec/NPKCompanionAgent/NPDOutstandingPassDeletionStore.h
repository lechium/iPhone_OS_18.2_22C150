...
- (void).cxx_destruct;	// IMP=0x0020000000007106
...
- (void)_performCleanup;	// IMP=0x0010000000006e09
- (void)_saveOutstandingRecords;	// IMP=0x0010000000006d55
- (void)clearStore;	// IMP=0x0010000000006cf3
- (_Bool)isDeletionPendingForUniqueID:(id)arg1;	// IMP=0x0010000000006909
- (void)notePassDatabaseReconciled;	// IMP=0x0010000000006835
- (void)noteDeliveryForMessageID:(id)arg1;	// IMP=0x0010000000006715
- (void)noteDeletionSentForUniqueID:(id)arg1 messageID:(id)arg2;	// IMP=0x0010000000006512
- (void)noteDeletionPendingForUniqueID:(id)arg1;	// IMP=0x00100000000063f2
- (void)dealloc;	// IMP=0x00100000000063b8
- (id)initWithDomainAccessor:(id)arg1;	// IMP=0x0010000000006174
