...
- (void)xpcGetMigrationCountForPairingID:(NSUUID *)arg1 completion:(void (^)(long long, NSError *))arg2;
- (void)xpcGetLastSwitchIndex:(void (^)(long long, NSError *))arg1;
...
- (void)xpcPingActiveGizmoWithPriority:(int)arg1 withMessageSize:(long long)arg2 withBlock:(void (^)(_Bool, double, double))arg3;
