...
+ (id)defaultManager;	// IMP=0x004000000005413d
- (void).cxx_destruct;	// IMP=0x0020000000054746
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x00100000000544f9
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x0010000000053fff
