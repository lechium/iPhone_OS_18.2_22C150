...
- (void).cxx_destruct;	// IMP=0x0020000000048859
...
- (_Bool)applyPatchWithError:(id *)arg1;	// IMP=0x00100000000484dc
- (_Bool)_applyDeltaPatchWithError:(id *)arg1;	// IMP=0x0010000000047e3b
@property(readonly, nonatomic) NSString *patchTypeName; // @dynamic patchTypeName;
- (id)initWithBundle:(id)arg1 inStagingRoot:(id)arg2 packageFormat:(unsigned char)arg3 identity:(id)arg4 domain:(unsigned long long)arg5 installOptions:(id)arg6 manifestURL:(id)arg7 existingBundleContainer:(id)arg8 patchType:(unsigned char)arg9 operationType:(unsigned long long)arg10 error:(id *)arg11;	// IMP=0x00100000000479c5
