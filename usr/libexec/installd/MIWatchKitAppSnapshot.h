...
- (void).cxx_destruct;	// IMP=0x002000000000c967
...
- (_Bool)createSnapshotWithError:(id *)arg1;	// IMP=0x001000000000c6ee
- (void)dealloc;	// IMP=0x001000000000c67c
- (id)initWithBundleID:(id)arg1 snapshotTo:(id)arg2 onlyV1AppIfPresent:(_Bool)arg3 placeholderOnly:(_Bool)arg4;	// IMP=0x001000000000c5c4
