...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000004f9bc
+ (void)_attemptLSUpdateWithDiscoveredStateForIdentity:(id)arg1 domain:(unsigned long long)arg2;	// IMP=0x001000000004e002
+ (id)_registerUsingDiscoveredInfoForAppIdentity:(id)arg1 inDomain:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x001000000004dfd0
- (void).cxx_destruct;	// IMP=0x0020000000052d4a
...
- (_Bool)cleanUpJournaledDataOnDiskWithError:(id *)arg1;	// IMP=0x001000000005285c
- (_Bool)makeStagedBackgroundUpdateLive:(id *)arg1;	// IMP=0x00100000000527a7
- (_Bool)stageUpdateForLater:(id *)arg1;	// IMP=0x00100000000526c9
- (_Bool)finalizeWithError:(id *)arg1;	// IMP=0x0010000000052654
- (_Bool)performLaunchServicesRegistrationWithError:(id *)arg1;	// IMP=0x001000000005255c
- (_Bool)finalizeContainersWithError:(id *)arg1;	// IMP=0x0010000000052464
- (_Bool)_performJournaledInstallAsReplay:(_Bool)arg1 withError:(id *)arg2;	// IMP=0x0010000000051cb0
- (_Bool)_beginLaunchServicesRegistrationWithError:(id *)arg1;	// IMP=0x0010000000051c0d
- (_Bool)_gatherLaunchServicesRegistrationInfoWithError:(id *)arg1;	// IMP=0x0010000000051794
- (void)_updateContainerStatePostCommit;	// IMP=0x0010000000050e54
- (_Bool)_commitContainersWithError:(id *)arg1;	// IMP=0x0010000000050588
- (_Bool)_updateReferencesWithError:(id *)arg1;	// IMP=0x0010000000050171
- (_Bool)_linkToParentApplication:(id *)arg1;	// IMP=0x0010000000050046
- (_Bool)_refreshUUIDForContainer:(id)arg1 withError:(id *)arg2;	// IMP=0x001000000004fec6
- (_Bool)_updateJournalPhaseTo:(unsigned long long)arg1 withError:(id *)arg2;	// IMP=0x001000000004fdb9
- (void)_purgeJournalEntry;	// IMP=0x001000000004fd6b
- (_Bool)_writeJournalEntryWithError:(id *)arg1;	// IMP=0x001000000004fd15
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000004f2c8
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000004e52f
- (_Bool)_findBundleContainerForToken:(id)arg1 error:(id *)arg2;	// IMP=0x001000000004e409
- (_Bool)_populateSigningInfoWithError:(id *)arg1;	// IMP=0x001000000004e2ec
- (id)initWithIdentity:(id)arg1 bundleContainer:(id)arg2 existingBundleContainer:(id)arg3 installationDomain:(unsigned long long)arg4 operationType:(unsigned long long)arg5 installOptions:(id)arg6 bundleSigningInfo:(id)arg7;	// IMP=0x001000000004e13e
- (id)_registerInstalledInfo:(id)arg1 forIdentity:(id)arg2 inDomain:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x001000000004dfe9
- (id)_journalInstance;	// IMP=0x001000000004dfb7
- (id)_uninstalledAppList;	// IMP=0x001000000004df9e
- (id)_helperServiceClient;	// IMP=0x001000000004df85
- (id)_containerProtectionManager;	// IMP=0x001000000004df6c
- (id)_systemAppState;	// IMP=0x001000000004df53
- (id)_freeProfileValidatedAppTracker;	// IMP=0x001000000004df3a
- (id)_keychainAccessGroupTracker;	// IMP=0x001000000004df21
- (id)_containerLinkManager;	// IMP=0x001000000004deec
- (int)_promoteKeychainItemsForAppClipWithAppIdentifier:(id)arg1 toParentAppWithAppIdentifier:(id)arg2;	// IMP=0x001000000004dedc
