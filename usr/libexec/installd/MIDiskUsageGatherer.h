...
- (void).cxx_destruct;	// IMP=0x0020000000033054
...
- (id)gatherUsageInfoWithError:(id *)arg1;	// IMP=0x0010000000032d78
- (id)_gatherForIdentifier:(id)arg1;	// IMP=0x0010000000032751
- (id)initWithIdentifiers:(id)arg1 options:(id)arg2;	// IMP=0x001000000003260a
