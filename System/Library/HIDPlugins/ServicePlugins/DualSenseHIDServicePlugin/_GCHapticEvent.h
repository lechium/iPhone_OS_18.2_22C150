...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001ffd
...
- (id)description;	// IMP=0x0000000000001ec0
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001cd0
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001c3b
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001a4c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000213b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002005
