...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001dfd
...
- (id)description;	// IMP=0x0000000000001cc0
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001ad0
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001a3b
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x000000000000184c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001f3b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001e05
