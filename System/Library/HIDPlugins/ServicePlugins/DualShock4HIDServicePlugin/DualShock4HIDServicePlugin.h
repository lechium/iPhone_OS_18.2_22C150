...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x001000000000292f
...
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00000000000066cc
- (void)updateSensorsActive:(_Bool)arg1;	// IMP=0x0000000000006580
- (void)readSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000006567
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006483
- (void)updateLightWithRed:(float)arg1 green:(float)arg2 blue:(float)arg3;	// IMP=0x0000000000006288
- (void)readLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000061a5
- (id)defaultHapticMotors;	// IMP=0x00000000000060c6
- (float)defaultHapticDispatchFrequency;	// IMP=0x00000000000060b8
- (void)dispatchHapticEvent;	// IMP=0x0000000000006077
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x0000000000006065
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x0000000000005f77
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x0000000000005c2c
@property(readonly, copy) NSString *description;
- (void)updateBatteryLevel:(unsigned char)arg1 isPowerSupplyConnected:(_Bool)arg2;	// IMP=0x0000000000005a66
- (void)dispatchOutputReport;	// IMP=0x0000000000005572
- (void)setupRawReportHandling;	// IMP=0x0000000000004940
- (void)requestPairingInfo;	// IMP=0x00000000000045da
- (void)requestSensorCalibrationInfo;	// IMP=0x0000000000003655
- (void)requestFirmwareInfo;	// IMP=0x0000000000002f65
- (void)determineSupportMode;	// IMP=0x0000000000002c62
- (id)initWithService:(unsigned int)arg1;	// IMP=0x00000000000029ec
