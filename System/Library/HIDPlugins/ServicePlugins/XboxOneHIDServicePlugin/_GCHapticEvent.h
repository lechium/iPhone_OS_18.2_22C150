...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001809
...
- (id)description;	// IMP=0x00000000000016cc
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x00000000000014dc
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001447
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001258
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001947
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001811
