...
- (void).cxx_destruct;	// IMP=0x00000000000077eb
...
- (void)_handleConnectionInterrupted;	// IMP=0x00000000000076fb
- (void)_handleConnectionActivated;	// IMP=0x0000000000007605
- (oneway void)handleOtherAction;	// IMP=0x000000000000757b
- (oneway void)handleDefaultAction;	// IMP=0x00000000000074f1
- (oneway void)handleCancelAction;	// IMP=0x0000000000007467
@property(readonly, copy) NSString *description;
- (void)invalidate;	// IMP=0x00000000000072b1
- (void)dismiss;	// IMP=0x000000000000710b
- (void)present;	// IMP=0x0000000000006f28
- (id)initWithAlert:(id)arg1 forDestination:(long long)arg2 preferredPresentationStyle:(long long)arg3;	// IMP=0x000000000000683f
