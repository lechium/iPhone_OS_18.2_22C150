...
- (id).cxx_construct;	// IMP=0x0000000000012334
- (void).cxx_destruct;	// IMP=0x00000000000122b6
...
- (id)snapshotImage;	// IMP=0x000000000001212b
- (void)updateVertexControllerWithData:(vector_f3c59865)arg1 range:(struct _NSRange)arg2 allowWet:(_Bool)arg3;	// IMP=0x0000000000011fad
- (void)updateVertexControllerWithDataRange:(struct _NSRange)arg1 allowWet:(_Bool)arg2;	// IMP=0x0000000000011e47
- (void)didBeginNewStroke;	// IMP=0x0000000000011e07
- (void)didCompleteStroke;	// IMP=0x0000000000011df5
- (void)clearComposite;	// IMP=0x0000000000011d31
- (void)clearDryPaintBuffer;	// IMP=0x0000000000011c70
- (void)clearWetPaintBuffer;	// IMP=0x0000000000011c09
- (void)clear;	// IMP=0x0000000000011bce
- (void)resetRendererState;	// IMP=0x0000000000011b25
- (_Bool)canvasIsEmpty;	// IMP=0x0000000000011b14
- (void)drawContiguousVertexStorageImmediatelyWithLayeredBlending:(_Bool)arg1;	// IMP=0x00000000000116f1
- (void)redrawEntireDrawingImmediatelyWithLayeredBlending:(_Bool)arg1;	// IMP=0x00000000000116df
- (void)undo;	// IMP=0x0000000000011691
- (void)drawComposite;	// IMP=0x00000000000113d5
- (void)draw;	// IMP=0x0000000000011341
- (void)updateDryForcefully;	// IMP=0x0000000000011204
- (void)renderToComposite:(_Bool)arg1;	// IMP=0x0000000000010f9d
- (void)renderToDryPaintBuffer;	// IMP=0x0000000000010d7f
- (void)renderToWetPaintBufferWithRange:(struct _NSRange)arg1;	// IMP=0x0000000000010c50
- (void)updateDryCycleIncludingComposite:(_Bool)arg1;	// IMP=0x0000000000010c13
- (void)updateWet;	// IMP=0x0000000000010bf9
- (struct CGRect)getVertexBounds;	// IMP=0x0000000000010b51
- (struct CGRect)regionWithVertices:(vector_f3c59865)arg1 withInflationAmount:(float)arg2;	// IMP=0x00000000000108c7
- (void)update;	// IMP=0x0000000000010679
- (_Bool)detectCollision:: /* Error: Ran out of types for this method. */;	// IMP=0x0000000000010471
- (void)addPoints:(id)arg1 withSegmentLength:(unsigned long long)arg2;	// IMP=0x000000000000fbd3
- (void)removeVertexHistoryElement;	// IMP=0x000000000000fb60
- (void)appendVertexHistoryElement;	// IMP=0x000000000000f93d
- (void)initializeFrameBuffers;	// IMP=0x000000000000f65d
- (void)destroyFrameBuffers;	// IMP=0x000000000000f5cc
- (void)didResize;	// IMP=0x000000000000f4ce
- (_Bool)initGL;	// IMP=0x000000000000ea52
- (void)teardown;	// IMP=0x000000000000e9e3
- (void)dealloc;	// IMP=0x000000000000e937
- (id)init;	// IMP=0x000000000000e88f
- (id)initWithBounds:(struct CGRect)arg1 scale:(double)arg2;	// IMP=0x000000000000e876
- (id)initWithBounds:(struct CGRect)arg1 scale:(double)arg2 bufferSize:(int)arg3 sharedContext:(_Bool)arg4;	// IMP=0x000000000000e79a
