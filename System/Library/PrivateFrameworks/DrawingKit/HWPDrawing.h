...
- (void).cxx_destruct;	// IMP=0x0000000000016989
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000167cc
- (unsigned long long)hash;	// IMP=0x00000000000166b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000016502
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001638a
- (void)copyTo:(id)arg1;	// IMP=0x0000000000016271
- (void)writeTo:(id)arg1;	// IMP=0x000000000001612d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000016120
- (id)dictionaryRepresentation;	// IMP=0x000000000001595a
- (id)description;	// IMP=0x00000000000158ab
...
- (int)StringAsCompressionAlgorithm:(id)arg1;	// IMP=0x00000000000156c6
- (id)compressionAlgorithmAsString:(int)arg1;	// IMP=0x000000000001567d
