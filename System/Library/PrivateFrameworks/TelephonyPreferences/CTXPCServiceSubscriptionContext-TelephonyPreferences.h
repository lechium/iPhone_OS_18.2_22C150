...
+ (id)telephonyClient;	// IMP=0x001000000001922d
- (_Bool)tps_isEquivalentToSubscriptionContext:(id)arg1;	// IMP=0x0010000000019669
@property(readonly, copy, nonatomic) NSString *tps_localizedShortLabel;
