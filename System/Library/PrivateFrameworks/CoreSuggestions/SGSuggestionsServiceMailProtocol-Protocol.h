...
- (void)suggestionsFromSearchableItem:(CSSearchableItem *)arg1 options:(unsigned long long)arg2 processingType:(unsigned long long)arg3 withCompletion:(void (^)(NSArray *, NSError *))arg4;
