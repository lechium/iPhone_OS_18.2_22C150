...
@class NSData, NSDictionary, NSString, _SFPBAppIconImage, _SFPBCalendarImage, _SFPBClockImage, _SFPBContactImage, _SFPBDefaultPunchoutAppIconImage, _SFPBGraphicalFloat, _SFPBImage, _SFPBLocalImage, _SFPBMediaArtworkImage, _SFPBMonogramImage, _SFPBPhotosLibraryImage, _SFPBPointSize, _SFPBQuickLookThumbnailImage, _SFPBShortcutsImage, _SFPBSymbolImage, _SFPBURLImage;
