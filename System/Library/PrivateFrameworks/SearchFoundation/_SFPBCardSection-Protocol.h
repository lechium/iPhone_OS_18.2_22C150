...
@class NSArray, NSData, NSDictionary, NSString, _SFPBAbstractCommand, _SFPBAppEntityAnnotation, _SFPBButtonItem, _SFPBCard, _SFPBCardSectionValue, _SFPBColor, _SFPBCommand, _SFPBPunchout, _SFPBUserReportRequest;
