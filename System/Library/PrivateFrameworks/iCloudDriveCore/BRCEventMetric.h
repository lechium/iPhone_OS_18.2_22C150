...
- (void).cxx_destruct;	// IMP=0x000000000004f110
...
- (void)associateWithCompletedOperation:(id)arg1;	// IMP=0x000000000004ef5f
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000004ef57
- (id)additionalPayload;	// IMP=0x000000000004ef4a
- (id)subDescription;	// IMP=0x000000000004ef3d
- (double)duration;	// IMP=0x000000000004eeba
- (id)description;	// IMP=0x000000000004ee26
- (id)initWithEventName:(id)arg1;	// IMP=0x000000000004edb6
