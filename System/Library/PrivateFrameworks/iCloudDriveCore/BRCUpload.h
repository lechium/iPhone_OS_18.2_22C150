...
- (void).cxx_destruct;	// IMP=0x00000000000e831c
...
- (void)dealloc;	// IMP=0x00000000000e8256
- (id)initWithDocument:(id)arg1 stageID:(id)arg2 transferSize:(unsigned long long)arg3;	// IMP=0x00000000000e80c7
- (id)description;	// IMP=0x00000000000e809a
