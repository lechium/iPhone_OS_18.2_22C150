...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001b17b3
+ (id)loadFromClientStateInSession:(id)arg1 options:(id)arg2;	// IMP=0x00600000001b142b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b16c3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b15ca
- (id)init;	// IMP=0x00000000001b1570
- (id)description;	// IMP=0x00000000001b1526
...
- (unsigned long long)allocatePackageItemRank;	// IMP=0x00000000001b12b2
@property(nonatomic) unsigned long long nextNotifRank;
- (unsigned long long)allocateNotifRank;	// IMP=0x00000000001b11b5
- (unsigned long long)allocateItemRowID;	// IMP=0x00000000001b115d
