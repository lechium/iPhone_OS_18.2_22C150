...
- (void).cxx_destruct;	// IMP=0x000000000004f46f
...
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000004f34a
- (id)subDescription;	// IMP=0x000000000004f291
- (id)additionalPayload;	// IMP=0x000000000004f14e
