...
- (void).cxx_destruct;	// IMP=0x0000000000055797
...
- (void)syncErrors:(CDUnknownBlockType)arg1;	// IMP=0x0000000000052fcd
- (void)dumpAggregatedEvents:(CDUnknownBlockType)arg1;	// IMP=0x0000000000052e03
- (void)generateReportWithSession:(id)arg1;	// IMP=0x0000000000050c8d
- (void)_collectAggregatedTelemetryForSession:(id)arg1;	// IMP=0x0000000000050bae
- (id)_injectionForAnalyticsServiceCode:(int)arg1;	// IMP=0x0000000000050ac6
- (void)_fillTransferFailure:(id)arg1 withRowID:(unsigned long long)arg2 atDate:(id)arg3 session:(id)arg4;	// IMP=0x0000000000050744
- (id)getRampNumberForSession:(id)arg1;	// IMP=0x0000000000050702
- (id)init;	// IMP=0x000000000005062d
