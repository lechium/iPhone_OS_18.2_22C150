...
- (void).cxx_destruct;	// IMP=0x00000000001ddd57
...
- (id)stringRepresentation;	// IMP=0x00000000001ddcf1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ddc3e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ddb82
- (id)initWithIdentifier:(id)arg1 artworkProperties:(id)arg2 artworkIdentifier:(id)arg3;	// IMP=0x00000000001dda96
