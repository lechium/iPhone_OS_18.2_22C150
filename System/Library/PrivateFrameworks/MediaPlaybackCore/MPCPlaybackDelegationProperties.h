...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001d6d7d
+ (id)payloadValueFromJSONValue:(id)arg1;	// IMP=0x00100000002e7b4b
- (void).cxx_destruct;	// IMP=0x00000000001d6be4
...
- (id)_copyWithClass:(Class)arg1 zone:(struct _NSZone *)arg2;	// IMP=0x00000000001d6aeb
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d6ab8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d69f0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d687e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d6873
- (id)initWithStoreAccountID:(unsigned long long)arg1 deviceGUID:(id)arg2;	// IMP=0x00000000001d67f5
- (id)mpc_jsonValue;	// IMP=0x00000000002e4ee6
