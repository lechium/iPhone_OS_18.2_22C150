...
+ (id)_filePathsForModelAtURL:(id)arg1;	// IMP=0x0060000000211f7b
+ (id)_plistForModelAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0060000000211c66
- (void).cxx_destruct;	// IMP=0x0000000000211c28
...
- (id)description;	// IMP=0x0000000000211789
