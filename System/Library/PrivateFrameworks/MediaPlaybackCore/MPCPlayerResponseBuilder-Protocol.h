...
@class ICMusicSubscriptionStatus, MPCPlayerAudioFormat, MPCPlayerAudioRoute, MPMiddlewareChain, MPModelGenericObject, MPNowPlayingParticipant, MPPropertySet, NSArray, NSDictionary, NSIndexPath, NSString, UIView;
...
- (_Bool)playerItemIsFavoritable:(_Bool)arg1 atIndexPath:(NSIndexPath *)arg2 chain:(MPMiddlewareChain *)arg3;
...
- (CDStruct_ef20cf08)playerItemDuration:(CDStruct_ef20cf08)arg1 atIndexPath:(NSIndexPath *)arg2 chain:(MPMiddlewareChain *)arg3;
