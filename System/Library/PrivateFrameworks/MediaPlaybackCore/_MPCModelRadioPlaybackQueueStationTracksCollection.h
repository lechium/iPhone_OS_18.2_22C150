...
- (void).cxx_destruct;	// IMP=0x0000000000308013
...
- (id)trackForItemAtIndex:(long long)arg1;	// IMP=0x0000000000307f7b
- (long long)removeExplicitItems;	// IMP=0x0000000000307e3f
- (void)removeAllItems;	// IMP=0x0000000000307dfa
@property(readonly, nonatomic) long long numberOfItems;
- (_Bool)isExplicitItemAtIndex:(long long)arg1;	// IMP=0x0000000000307c4e
- (id)AVItemAtIndex:(long long)arg1;	// IMP=0x0000000000307973
- (void)updateWithPersonalizedResponse:(id)arg1;	// IMP=0x0000000000307573
- (id)initWithPlaybackContext:(id)arg1;	// IMP=0x0000000000307470
