...
- (void).cxx_destruct;	// IMP=0x00000000001047e5
...
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x00000000001046ef
- (id)operationsForRequest:(id)arg1;	// IMP=0x0000000000104682
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x000000000010480d
