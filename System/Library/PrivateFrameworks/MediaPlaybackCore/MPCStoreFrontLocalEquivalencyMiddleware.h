...
- (void).cxx_destruct;	// IMP=0x00000000002f522c
...
- (id)_stateDumpObject;	// IMP=0x00000000002f5086
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x00000000002f4fc6
- (id)operationsForRequest:(id)arg1;	// IMP=0x00000000002f4f59
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x00000000002f525f
