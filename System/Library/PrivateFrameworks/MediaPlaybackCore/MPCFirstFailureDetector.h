...
- (void).cxx_destruct;	// IMP=0x000000000017be5b
...
- (_Bool)processSample:(id)arg1;	// IMP=0x000000000017bb75
- (id)initWithSamplingTime:(double)arg1 renderingLimit:(double)arg2;	// IMP=0x000000000017bb1b
