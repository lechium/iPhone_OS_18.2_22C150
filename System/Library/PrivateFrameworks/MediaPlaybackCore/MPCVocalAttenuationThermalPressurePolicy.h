...
- (void).cxx_destruct;	// IMP=0x0000000000202279
...
- (void)updateEvaluationWithReason:(id)arg1;	// IMP=0x00000000002020a4
- (void)thermalStateDidChange:(long long)arg1;	// IMP=0x0000000000201e4b
- (void)environmentMonitorDidChangeThermalLevel:(id)arg1;	// IMP=0x0000000000201df2
- (id)evaluation;	// IMP=0x0000000000201cf9
- (void)reset;	// IMP=0x0000000000201cf3
@property(readonly, nonatomic) _Bool canBeReset;
- (id)initWithThermalMonitor:(id)arg1 calloutQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000000201bc9
- (id)initWithCalloutQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000201b32
