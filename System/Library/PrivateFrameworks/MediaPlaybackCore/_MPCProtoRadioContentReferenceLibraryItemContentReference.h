...
- (void).cxx_destruct;	// IMP=0x000000000029577d
- (unsigned long long)hash;	// IMP=0x0000000000295365
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000294fb9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000294cfa
- (void)writeTo:(id)arg1;	// IMP=0x0000000000294a89
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000294a7c
- (id)dictionaryRepresentation;	// IMP=0x0000000000294559
- (id)description;	// IMP=0x00000000002944aa
