...
@interface _TtC17MediaPlaybackCore29OverlappingTransitionTimeImpl : _TtCs12_SwiftObject
{
    MISSING_TYPE *startItemSourceTime;	// 16 = 0x10
    MISSING_TYPE *startItemTargetTime;	// 24 = 0x18
    MISSING_TYPE *endItemSourceTime;	// 32 = 0x20
    MISSING_TYPE *endItemTargetTime;	// 40 = 0x28
}
