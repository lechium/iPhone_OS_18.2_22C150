...
- (void).cxx_destruct;	// IMP=0x00000000002917b2
...
- (id)changeValue:(_Bool)arg1;	// IMP=0x000000000029140f
- (id)initWithResponse:(id)arg1 mediaRemoteCommand:(unsigned int)arg2;	// IMP=0x00000000002913cd
