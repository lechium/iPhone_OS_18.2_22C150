...
- (void).cxx_destruct;	// IMP=0x000000000017c3d3
...
- (id)flushSamplesToCSVDataWithHeader:(_Bool)arg1;	// IMP=0x000000000017c270
- (id)dictionaryRepresentation;	// IMP=0x000000000017c16f
- (id)description;	// IMP=0x000000000017c0b6
@property(readonly, nonatomic) int numberOfSamples;
- (void)recordSample:(id)arg1;	// IMP=0x000000000017c020
- (id)initWithRecordID:(id)arg1 modelID:(id)arg2 firstFailureDetector:(id)arg3 shouldStoreSamples:(_Bool)arg4 delegate:(id)arg5;	// IMP=0x000000000017be83
