...
@class AVPlayerItemAccessLog, NSDictionary, NSError, NSString;
@protocol MFOverlappingTransitionTime, MFQueuePlayerItem, MFRouteChangeMetadata, MFTimeStamp, MFUserAction;
