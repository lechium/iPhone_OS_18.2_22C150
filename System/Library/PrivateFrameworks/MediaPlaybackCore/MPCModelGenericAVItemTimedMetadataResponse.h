...
- (void).cxx_destruct;	// IMP=0x00000000001795d8
...
- (void)_personalizationResponseDidInvalidateNotification:(id)arg1;	// IMP=0x000000000017951d
- (void)dealloc;	// IMP=0x0000000000179488
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2 firstResponse:(_Bool)arg3 finalResponse:(_Bool)arg4;	// IMP=0x0000000000179334
