...
- (void).cxx_destruct;	// IMP=0x0000000000202924
...
- (void)updateEvaluationWithReason:(id)arg1;	// IMP=0x0000000000202779
- (void)powerModeDidChange:(_Bool)arg1;	// IMP=0x0000000000202616
- (void)processInfoPowerStateDidChange:(id)arg1;	// IMP=0x00000000002025e1
- (id)evaluation;	// IMP=0x00000000002024e9
- (void)reset;	// IMP=0x00000000002024e3
@property(readonly, nonatomic) _Bool canBeReset;
- (id)initWithPowerModeMonitor:(id)arg1 calloutQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000000202396
- (id)initWithCalloutQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000002022ff
