...
+ (id)metadataIdentifiers;	// IMP=0x004000000032ccfb
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000032ccf3
- (void).cxx_destruct;	// IMP=0x000000000032ac58
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000032ab17
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000032aa88
- (id)initWithGenericObject:(id)arg1 timedMetadataGroups:(id)arg2 storeRequestContext:(id)arg3;	// IMP=0x000000000032a9a0
