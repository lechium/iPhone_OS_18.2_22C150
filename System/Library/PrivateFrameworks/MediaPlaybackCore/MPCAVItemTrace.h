...
+ (id)traceIntervalWithName:(id)arg1 item:(id)arg2 beginEvent:(unsigned int)arg3 endEvent:(unsigned int)arg4;	// IMP=0x0060000000301c47
+ (void)traceWithName:(id)arg1 item:(id)arg2 event:(unsigned int)arg3;	// IMP=0x0060000000301b63
- (void).cxx_destruct;	// IMP=0x0000000000301b3d
...
- (void)cancel;	// IMP=0x000000000030192b
- (void)endInterval;	// IMP=0x0000000000301799
- (void)dealloc;	// IMP=0x000000000030175b
