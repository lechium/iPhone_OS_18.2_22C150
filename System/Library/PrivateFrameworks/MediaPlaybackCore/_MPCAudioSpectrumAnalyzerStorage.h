...
- (void)analyzeAudioData:(void *)arg1 numberFrames:(unsigned int)arg2 observers:(id)arg3;	// IMP=0x0000000000100911
- (void)analyzeFrequencies:(struct AudioBufferList *)arg1 numberFrames:(unsigned long long)arg2 observers:(id)arg3;	// IMP=0x000000000010083a
- (void)_freeBuffers;	// IMP=0x00000000001007fe
- (void)_destroyFFTSetup;	// IMP=0x00000000001007d8
- (void)_prepareBuffers;	// IMP=0x0000000000100771
- (void)dealloc;	// IMP=0x000000000010071e
- (id)initWithMaximumNumberOfFrames:(long long)arg1 sampleRate:(float)arg2;	// IMP=0x000000000010067f
