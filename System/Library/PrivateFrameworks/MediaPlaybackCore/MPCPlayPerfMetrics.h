...
+ (id)playMetricsWithErrorSignature:(id)arg1 event:(id)arg2 cursor:(id)arg3;	// IMP=0x0060000000325963
+ (id)playMetricsWithItemReadyForMetricsEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x0060000000322602
- (void).cxx_destruct;	// IMP=0x0000000000321b8a
@property(retain, nonatomic) NSMutableDictionary *data; // @synthesize data=_data;
- (void)addEnvironmentInfoWithCursor:(id)arg1;	// IMP=0x0000000000321ac3
- (void)addAssetSelectionWithCursor:(id)arg1 itemIDPayload:(id)arg2;	// IMP=0x0000000000321123
- (void)addSessionActivationTimesWithScopedCursor:(id)arg1;	// IMP=0x0000000000320e2e
- (void)addNetworkTimesWithScopedCursor:(id)arg1;	// IMP=0x0000000000320ba3
- (void)addSharePlayWithCursor:(id)arg1;	// IMP=0x0000000000320abb
- (void)addPlaybackBehaviorWithCursor:(id)arg1;	// IMP=0x00000000003208ca
- (void)addQueueMetadata:(id)arg1;	// IMP=0x0000000000320816
- (id)jsonObject;	// IMP=0x000000000031f4e4
- (id)description;	// IMP=0x000000000031f2d4
- (id)dictionaryRepresentation;	// IMP=0x000000000031f28c
...
- (id)init;	// IMP=0x000000000031e78a
