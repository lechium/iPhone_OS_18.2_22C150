...
- (void).cxx_destruct;	// IMP=0x00000000002b3986
...
- (void)_onQueue_flush;	// IMP=0x00000000002b315f
- (void)subscribeToEventType:(id)arg1 options:(unsigned long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000002b2e01
- (void)subscribeToEventType:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b2dea
- (void)flushEventsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002b2bf5
- (void)cancelSubscription;	// IMP=0x00000000002b2a7c
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

- (id)initWithConsumer:(id)arg1 eventStream:(id)arg2;	// IMP=0x00000000002b279e
