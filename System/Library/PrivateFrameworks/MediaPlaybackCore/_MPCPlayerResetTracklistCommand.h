...
- (void).cxx_destruct;	// IMP=0x0000000000273894
...
- (id)replaceWithPlaybackIntent:(id)arg1 replaceIntent:(long long)arg2;	// IMP=0x00000000002732e4
- (id)replaceWithPlaybackIntent:(id)arg1;	// IMP=0x00000000002732cd
- (id)clearUpNextItems;	// IMP=0x0000000000273176
- (id)clear;	// IMP=0x0000000000272f9c
