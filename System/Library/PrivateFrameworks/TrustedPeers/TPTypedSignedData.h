...
- (void).cxx_destruct;	// IMP=0x000000000001d621
...
- (_Bool)checkSignatureWithKey:(id)arg1;	// IMP=0x000000000001d353
- (id)initWithData:(id)arg1 sig:(id)arg2 signatureTypeName:(id)arg3;	// IMP=0x000000000001d33b
- (id)initWithData:(id)arg1 key:(id)arg2 signatureTypeName:(id)arg3 error:(id *)arg4;	// IMP=0x000000000001d242
- (id)initWithData:(id)arg1 sig:(id)arg2 pubkey:(id)arg3 sigTypeName:(id)arg4;	// IMP=0x000000000001d0b5
