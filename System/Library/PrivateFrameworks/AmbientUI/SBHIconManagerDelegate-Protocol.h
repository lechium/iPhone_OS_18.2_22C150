...
@class BSAction, CHSBaseDescriptor, CHSWidget, CHSWidgetMetrics, CHUISWidgetHostViewController, INIntent, NSArray, NSData, NSDictionary, NSMutableDictionary, NSSet, NSString, NSURL, NSUUID, PUIStylePickerHomeScreenConfiguration, SBFloatingDockViewController, SBFolder, SBFolderController, SBHAddWidgetSheetViewController, SBHApplicationIcon, SBHCustomIconElement, SBHIconAnimationSettings, SBHIconImageCache, SBHIconManager, SBHWidget, SBHWidgetDisplayConfiguration, SBHomeScreenIconTransitionAnimator, SBIcon, SBIconListModel, SBIconListView, SBIconView, SBLeafIcon, SBModalWidgetIntroductionHomeScreenPreview, SBNestingViewController, SBRootFolderController, SBRootFolderControllerConfiguration, SBRootFolderViewPageManagementLayoutManager, SBSApplicationShortcutItem, SBViewControllerTransitionContext, SBWidgetIcon, UIColor, UIDragItem, UIDragPreviewParameters, UIStatusBar, UIStatusBarStyleRequest, UITargetedDragPreview, UIView, UIViewController, UIViewPropertyAnimator, UIWindow, UIWindowScene, _UIContextMenuStyle;
@protocol BSInvalidatable, SBHFeatureIntroductionProviding, SBHIconRootViewProviding, SBHIconViewConfigurationInteraction, SBHMainAddSheetViewControlling, SBHModalInteraction, SBHRecycledViewsContainerProviding, SBHStackConfigurationInteractionDelegate, SBHStackConfigurationViewControllerAppearanceDelegate, SBIconDragPreview, SBIconDragPreviewContaining, SBIconViewSnapshotProviding, SBLeafIconDataSource, SBViewControllerTransitionCoordinator, UIDragSession, UIDropSession, UIViewImplicitlyAnimating;
...
- (_Bool)shouldUseHomeScreenLargeIconSizeForIconManager:(SBHIconManager *)arg1;
- (void)iconManagerWantsIconSizeToggled:(SBHIconManager *)arg1;
- (_Bool)isHomeScreenWallpaperDimmedForIconManager:(SBHIconManager *)arg1;
...
- (id <SBLeafIconDataSource>)iconManager:(SBHIconManager *)arg1 widgetDataSourceForReplacingIconWithWidget:(SBIcon *)arg2 proposedWidgetDataSource:(id <SBLeafIconDataSource>)arg3;
...
- (id <SBHRecycledViewsContainerProviding>)recycledViewsContainerProviderForIconManager:(SBHIconManager *)arg1;
...
- (_Bool)iconManager:(SBHIconManager *)arg1 supportsParallaxForIconView:(SBIconView *)arg2;
...
- (_Bool)iconManager:(SBHIconManager *)arg1 isEditingAllowedForIconView:(SBIconView *)arg2;
...
- (void)iconManagerPreferredProminentPosterColor:(SBHIconManager *)arg1 handler:(void (^)(UIColor *))arg2;
