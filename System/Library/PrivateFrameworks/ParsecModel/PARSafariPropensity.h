...
- (void).cxx_destruct;	// IMP=0x00000000000027af
- (void).cxx_construct;	// IMP=0x00000000000027a6
- (id)initWithEntity:(id)arg1 insertIntoManagedObjectContext:(id)arg2;	// IMP=0x000000000000275a
