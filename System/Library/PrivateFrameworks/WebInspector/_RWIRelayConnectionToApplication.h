...
- (void).cxx_destruct;	// IMP=0x00000000000033a8
...
- (void)sendMessage:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000000003230
- (void)_handleEvent:(id)arg1;	// IMP=0x0000000000002f6c
- (id)_deserializeMessage:(id)arg1;	// IMP=0x0000000000002e34
- (void)dealloc;	// IMP=0x0000000000002df6
- (void)close;	// IMP=0x0000000000002dc0
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000002c8c
