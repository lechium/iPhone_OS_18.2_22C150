...
@interface AAUIOBInheritanceShareAccessKeyOptionsViewModel : AAOBInheritanceShareAccessKeyOptionsModel
{
...
- (void).cxx_destruct;	// IMP=0x0000000000058d2a
...
- (id)initWithBeneficiaryName:(id)arg1 handle:(id)arg2;	// IMP=0x0000000000058c06
