...
@interface AAUIWalrusRecoveryContactRemovedScreenModel : AAWalrusRecoveryContactRemovedScreenModel
{
...
- (void).cxx_destruct;	// IMP=0x000000000009281c
...
- (id)initWithHasRecoveryContact:(_Bool)arg1 hasRecoveryKey:(_Bool)arg2;	// IMP=0x0000000000092751
