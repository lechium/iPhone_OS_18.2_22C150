...
@interface AAUIOBInheritanceShareDataViewModel : AAOBInheritanceShareDataModel
{
...
- (void).cxx_destruct;	// IMP=0x000000000002f4e5
...
- (id)initWithBeneficiaryName:(id)arg1;	// IMP=0x000000000002f38c
