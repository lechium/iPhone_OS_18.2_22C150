...
@interface AAUIOBInheritanceInviteMessageViewModel : AAOBInheritanceInviteMessageModel
{
...
- (void).cxx_destruct;	// IMP=0x000000000002f34a
...
- (id)initWithType:(unsigned long long)arg1 recipientHandle:(id)arg2;	// IMP=0x000000000002f20e
- (id)initWithBeneficiaryName:(id)arg1;	// IMP=0x000000000002f15a
