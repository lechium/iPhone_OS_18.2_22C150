...
@interface AAUIOBCustodiansListViewModel : AAOBCustodiansListViewModel
{
...
- (void).cxx_destruct;	// IMP=0x0000000000030a55
...
- (id)initWithContacts:(id)arg1;	// IMP=0x0000000000030953
