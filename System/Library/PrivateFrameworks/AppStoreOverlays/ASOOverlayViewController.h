...
- (void).cxx_destruct;	// IMP=0x0000000000005ae3
...
- (void)shutdownViewServiceIfOverlayOffScreen;	// IMP=0x00000000000058de
- (void)didEnterBackground;	// IMP=0x000000000000587a
- (void)didReceiveMemoryWarning;	// IMP=0x00000000000057f5
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x0000000000005613
- (void)didFinishDismissingOverlay:(id)arg1;	// IMP=0x0000000000005532
- (void)willStartPresentingOverlay:(id)arg1 transitionContext:(id)arg2;	// IMP=0x0000000000005450
- (id)remoteViewControllerForOverlayViewService;	// IMP=0x000000000000543e
- (id)hostContextForOverlayViewService;	// IMP=0x000000000000542c
- (void)_loadRemoteViewController:(CDUnknownBlockType)arg1;	// IMP=0x0000000000004da3
- (void)_loadViewServiceIfNeeded:(CDUnknownBlockType)arg1;	// IMP=0x0000000000004659
- (void)loadViewServiceIfNeeded;	// IMP=0x0000000000004526
- (void)failAllQueuedOverlaysWithError:(id)arg1;	// IMP=0x000000000000420e
- (void)dismissOverlay;	// IMP=0x00000000000040f3
- (void)presentOverlay:(id)arg1;	// IMP=0x0000000000003f3e
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000003da3
- (void)viewDidLoad;	// IMP=0x0000000000003c10
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000003b29
