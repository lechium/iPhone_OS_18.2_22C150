...
- (void).cxx_destruct;	// IMP=0x000000000002ca41
...
- (void)consumeStream:(struct __FSEventStream *)arg1 forVolume:(id)arg2;	// IMP=0x000000000002c49c
- (void)callback:(id)arg1;	// IMP=0x000000000002b7b0
- (void)dealloc;	// IMP=0x000000000002b739
- (id)initWithConsumer:(CDUnknownBlockType)arg1 identifier:(id)arg2;	// IMP=0x000000000002b64c
