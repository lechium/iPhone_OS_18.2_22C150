...
+ (id)descriptionStringForTracksOfPlayerItem:(id)arg1;	// IMP=0x00600000000629d3
+ (id)descriptionStringForVideoRangeOfFormatDescription:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x00600000000629a8
+ (id)descriptionStringForBitRate:(double)arg1;	// IMP=0x006000000006293d
+ (id)descriptionStringForFormatOfTrack:(id)arg1;	// IMP=0x006000000006263c
- (void).cxx_destruct;	// IMP=0x0000000000064747
...
- (void)update;	// IMP=0x0000000000063ee7
- (void)updateFromPlayerItem;	// IMP=0x00000000000631f3
- (void)updateFromPlayer;	// IMP=0x0000000000062cda
- (void)dealloc;	// IMP=0x0000000000062508
