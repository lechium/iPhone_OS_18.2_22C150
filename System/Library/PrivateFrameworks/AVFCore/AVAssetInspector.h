...
- (id)makePropertyListForProxyWithOptions:(id)arg1;	// IMP=0x0000000000118102
...
- (_Bool)isCompatibleWithPhotosTranscodingServiceWithOptions:(id)arg1;	// IMP=0x000000000011805b
@property(readonly, nonatomic, getter=isPlayable) _Bool playable;
- (_Bool)hasProtectedContent;	// IMP=0x000000000011804b
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x000000000011801a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000117e80
