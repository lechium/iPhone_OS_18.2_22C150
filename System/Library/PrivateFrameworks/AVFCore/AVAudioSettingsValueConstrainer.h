...
- (float)_getAvailableOutputSampleRateFor:(float)arg1 rounding:(long long)arg2;	// IMP=0x0000000000150c21
- (unsigned int)availableOutputChannelCountForDesiredChannelCount:(unsigned int)arg1 rounding:(long long)arg2;	// IMP=0x0000000000150acf
- (float)applicableOutputSampleRateForDesiredSampleRate:(float)arg1 rounding:(long long)arg2;	// IMP=0x000000000015078e
...
- (void)setInputPropertiesFromASBD:(struct AudioStreamBasicDescription)arg1;	// IMP=0x00000000001506c3
- (void)_bringUpToDate;	// IMP=0x000000000015060b
- (id)_fetchApplicableOutputDataRates;	// IMP=0x0000000000150566
- (void)_buildApplicableDataRatesForSampleRates;	// IMP=0x000000000014ffc1
- (void)_buildAvailableSampleRates;	// IMP=0x000000000014fe82
- (void)_buildAudioConverter;	// IMP=0x000000000014fdba
- (void)dealloc;	// IMP=0x000000000014fd51
- (id)init;	// IMP=0x000000000014fcf6
