...
- (void)dealloc;	// IMP=0x000000000017d1e5
- (id)init;	// IMP=0x000000000017d1cc
- (id)initWithExternalDevice:(id)arg1 client:(id)arg2 reason:(id)arg3;	// IMP=0x000000000017d0ec
