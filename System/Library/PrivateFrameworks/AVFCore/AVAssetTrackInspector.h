...
+ (id)assetTrackInspectorWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00100000001276a6
@property(readonly, nonatomic, getter=_isDefunct) _Bool defunct;
- (struct OpaqueFigSampleCursorService *)_getFigSampleCursorServiceReportingTimeAccuracy:(_Bool *)arg1;	// IMP=0x00000000001285df
- (id)makeSampleCursorAtLastSampleInDecodeOrder;	// IMP=0x000000000012854f
- (id)makeSampleCursorAtFirstSampleInDecodeOrder;	// IMP=0x00000000001284bf
- (id)makeSampleCursorWithPresentationTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000001283ae
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x00000000001282bf
...
- (CDStruct_1b6d18a9)samplePresentationTimeForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000128051
- (id)segmentForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000127d32
...
- (id)_segmentsForSegmentData:(id)arg1;	// IMP=0x0000000000127b5f
...
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000012785f
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000127848
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012783d
- (void)dealloc;	// IMP=0x00000000001277d7
- (id)_weakReference;	// IMP=0x00000000001277c6
- (id)init;	// IMP=0x00000000001277a9
- (id)_initWithAsset:(id)arg1 trackIndex:(long long)arg2;	// IMP=0x0000000000127792
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2;	// IMP=0x0000000000127779
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00000000001276fc
