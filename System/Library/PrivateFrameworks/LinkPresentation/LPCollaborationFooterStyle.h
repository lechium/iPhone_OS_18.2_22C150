...
- (void).cxx_destruct;	// IMP=0x0000000000093a63
...
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x0000000000093571
