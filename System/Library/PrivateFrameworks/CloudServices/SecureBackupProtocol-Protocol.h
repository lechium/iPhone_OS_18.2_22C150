...
- (void)removeRecoveryKeyFromBackupInDaemon:(void (^)(_Bool, NSError *))arg1;
...
- (void)fetchStingrayAccountStatusInDaemon:(SecureBackup *)arg1 reply:(void (^)(CSStingrayAccountStatus *, NSError *))arg2;
