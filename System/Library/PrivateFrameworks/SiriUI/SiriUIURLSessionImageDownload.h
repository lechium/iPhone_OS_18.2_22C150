...
- (void).cxx_destruct;	// IMP=0x000000000000c9d5
- (void)finishedFromURL:(id)arg1 error:(id)arg2;	// IMP=0x000000000000c880
- (void)appendDownloadedData:(id)arg1 fromURL:(id)arg2;	// IMP=0x000000000000c53a
- (void)_updateImageFromURL:(id)arg1 error:(id)arg2;	// IMP=0x000000000000bbdc
- (void)dealloc;	// IMP=0x000000000000bb95
- (id)initWithFitToSize:(struct CGSize)arg1 progressHandler:(CDUnknownBlockType)arg2 incremental:(_Bool)arg3 client:(id)arg4 fillColor:(id)arg5;	// IMP=0x000000000000ba2b
