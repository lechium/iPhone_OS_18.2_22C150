...
@class NSArray, NSMutableArray, _FEFocusGroupMap, _FEFocusSearchInfo;
...
@interface _FEFocusMapSearchInfo : NSObject
{
    ...
    _FEFocusGroupMap *_focusGroupMap;	// 24 = 0x18
    NSMutableArray *_mutableSnapshots;	// 32 = 0x20
    NSMutableArray *_mutableDestinationRegions;	// 40 = 0x28
    _FEFocusSearchInfo *_searchInfo;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x000000000002ebef
...
@property(retain, nonatomic) _FEFocusGroupMap *focusGroupMap; // @synthesize focusGroupMap=_focusGroupMap;
...
- (void)addDestinationRegion:(id)arg1;	// IMP=0x000000000002eade
- (void)addSnapshot:(id)arg1;	// IMP=0x000000000002ea54
@property(readonly, copy, nonatomic) NSArray *destinationRegions;
@property(readonly, copy, nonatomic) NSArray *snapshots;
- (id)init;	// IMP=0x000000000002e94b
