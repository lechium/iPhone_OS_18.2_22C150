...
- (oneway void)submitInstanceScore:(long long)arg1 context:(unsigned long long)arg2 leaderboard:(GKLeaderboardInternal *)arg3 forPlayer:(GKPlayerInternal *)arg4 whileScreeningChallenges:(_Bool)arg5 withEligibleChallenges:(NSArray *)arg6 handler:(void (^)(NSError *))arg7;
...
- (oneway void)getLeaderboardForRequest:(GKLeaderboardScoreRequest *)arg1 handler:(void (^)(GKLeaderboardInternal *, NSError *))arg2;
...
- (oneway void)getRecentMatchesForGameDescriptor:(GKGameDescriptor *)arg1 leaderboardIdentifier:(NSString *)arg2 handler:(void (^)(NSArray *, NSError *))arg3;
- (oneway void)getRecentMatchesForGameDescriptor:(GKGameDescriptor *)arg1 includeCompatibleMultiplayerGames:(_Bool)arg2 handler:(void (^)(NSArray *, NSError *))arg3;
- (oneway void)getRecentMatchesForGameDescriptor:(GKGameDescriptor *)arg1 achievementIdentifier:(NSString *)arg2 handler:(void (^)(NSArray *, NSError *))arg3;
