...
@class NSString, NSUndoManager, UIImage, UIView, UIViewController, WBSCloudTab, WBSCloudTabDevice;
...
- (_Bool)tabCollectionView:(id <TabThumbnailCollectionView>)arg1 includesHeaderInSnapshotForItems:(id <TabCollectionItem>)arg2;
