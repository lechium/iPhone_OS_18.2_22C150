...
@optional
- (void)_webView:(WKWebView *)arg1 startXRSessionWithFeatures:(unsigned long long)arg2 completionHandler:(void (^)(id, UIViewController *))arg3;
...
- (_Bool)_focusWebViewFromServiceWorker:(WKWebView *)arg1;
...
- (void)_webView:(WKWebView *)arg1 requestWebAuthenticationConditionalMediationRegistrationForUser:(NSString *)arg2 completionHandler:(void (^)(_Bool))arg3;
...
- (void)_webView:(WKWebView *)arg1 requestStorageAccessPanelForDomain:(NSString *)arg2 underCurrentDomain:(NSString *)arg3 forQuirkDomains:(NSDictionary *)arg4 completionHandler:(void (^)(_Bool))arg5;
