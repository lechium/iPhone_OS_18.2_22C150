...
@class NSArray, NSItemProvider, NSURL, SFStartPageCustomizationViewController, WBSBackgroundImageAssetController;
@protocol SFStartPageCustomizationProfileProviding;
...
- (id <SFStartPageCustomizationProfileProviding>)profileProviderForCustomizationViewController:(SFStartPageCustomizationViewController *)arg1;
...
- (_Bool)isSuggestionsCustomizationAvailableForStartPageCustomizationViewController:(SFStartPageCustomizationViewController *)arg1;
