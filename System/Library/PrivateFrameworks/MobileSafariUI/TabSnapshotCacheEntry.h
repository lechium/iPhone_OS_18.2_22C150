...
- (void).cxx_destruct;	// IMP=0x0000000000236266
...
- (id)debugDescription;	// IMP=0x0000000000235ffc
- (id)initWithIdentifier:(id)arg1 isGroup:(_Bool)arg2;	// IMP=0x0000000000235f3c
