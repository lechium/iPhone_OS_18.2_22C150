...
- (_Bool)performActionForPage:(id)arg1;	// IMP=0x0000000000110c82
- (_Bool)startPageAction:(id)arg1;	// IMP=0x0000000000110c18
- (id)initWithTestName:(id)arg1 browserController:(id)arg2;	// IMP=0x0000000000110bca
