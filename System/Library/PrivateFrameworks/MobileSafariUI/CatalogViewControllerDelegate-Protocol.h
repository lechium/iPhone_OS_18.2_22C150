...
- (_Bool)catalogViewControllerUnifiedFieldCanBecomeFirstResponder:(CatalogViewController *)arg1;
...
- (void)catalogViewController:(CatalogViewController *)arg1 loadURL:(NSURL *)arg2 inExternalApplication:(_Bool)arg3 forImageAttribution:(_Bool)arg4;
