...
@interface PageLoadTestRunner : NSObject
{
    ...
    _Bool _useInjectedBundle;	// 36 = 0x24
...
+ (CDStruct_81cc75c8)heapStatistics;	// IMP=0x00600000000dac4a
+ (id)worldLeaksString;	// IMP=0x00600000000da9d0
+ (_Bool)closingBrowserWindowsForWorldLeakTest;	// IMP=0x00600000000da9c2
+ (void)addLeakToArray:(id)arg1 count:(int)arg2 name:(id)arg3;	// IMP=0x00600000000da916
- (void).cxx_destruct;	// IMP=0x00000000000daea2
...
- (_Bool)checkForWorldLeaksNow;	// IMP=0x00000000000dac0f
- (void)checkForWorldLeaksSoon;	// IMP=0x00000000000dabe9
- (void)closeBrowserWindowsAndFinishCheckingForWorldLeaks;	// IMP=0x00000000000dab9f
- (_Bool)finishCheckingForWorldLeaks;	// IMP=0x00000000000dab64
- (void)closeBrowserWindows;	// IMP=0x00000000000da9ca
- (void)clearCacheWithURL:(id)arg1;	// IMP=0x00000000000da8bf
- (void)log:(id)arg1;	// IMP=0x00000000000da739
- (void)finishedTestPage:(id)arg1;	// IMP=0x00000000000da6a0
- (void)startingTestPage:(id)arg1;	// IMP=0x00000000000da65f
- (void)finishedTestRunner;	// IMP=0x00000000000da601
- (void)finishedTestRunnerIteration;	// IMP=0x00000000000da5dd
- (void)startingTestRunner;	// IMP=0x00000000000da5c2
- (void)_handleActionTimer:(id)arg1;	// IMP=0x00000000000da4f6
- (_Bool)performActionForPage:(id)arg1;	// IMP=0x00000000000da4ee
- (_Bool)startPageAction:(id)arg1;	// IMP=0x00000000000da3a3
- (void)finishPage:(id)arg1 stats:(id)arg2 error:(id)arg3;	// IMP=0x00000000000da0fe
- (void)_updatePageLoad:(id)arg1 stats:(id)arg2;	// IMP=0x00000000000d9b98
- (void)_checkRedirect:(id)arg1;	// IMP=0x00000000000d9aa4
- (void)_pageRestExpired:(id)arg1;	// IMP=0x00000000000d9a2f
- (void)_pageTimeoutExpired:(id)arg1;	// IMP=0x00000000000d98e0
- (id)_pageLoadForTabDocument:(id)arg1;	// IMP=0x00000000000d9758
- (void)finish;	// IMP=0x00000000000d94d9
- (void)_startNextPageNow;	// IMP=0x00000000000d8c1d
- (void)startNextPage;	// IMP=0x00000000000d8bbc
- (void)start;	// IMP=0x00000000000d827c
- (_Bool)loadTestSuiteFile:(id)arg1;	// IMP=0x00000000000d74e0
- (void)removeURLsInRange:(struct _NSRange)arg1;	// IMP=0x00000000000d73ff
- (void)addPageURL:(id)arg1 withProcessSwap:(_Bool)arg2;	// IMP=0x00000000000d7315
- (void)setTestOptions:(id)arg1;	// IMP=0x00000000000d6f5e
- (void)setExistingProperty:(id)arg1 to:(id)arg2;	// IMP=0x00000000000d6e4d
- (void)_closeLogStream;	// IMP=0x00000000000d6e0f
- (void)dealloc;	// IMP=0x00000000000d6dd1
- (id)initWithTestName:(id)arg1 browserController:(id)arg2;	// IMP=0x00000000000d6c6a
