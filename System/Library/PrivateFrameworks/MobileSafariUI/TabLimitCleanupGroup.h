...
- (void).cxx_destruct;	// IMP=0x00000000001bada6
@property(readonly, copy, nonatomic) NSString *message; // @synthesize message=_message;
@property(readonly, nonatomic) UIAlertAction *action; // @synthesize action=_action;
- (id)initWithAlertMesssage:(id)arg1 actionTitle:(id)arg2 tabs:(id)arg3 browserController:(id)arg4 resultHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000001ba9f8
