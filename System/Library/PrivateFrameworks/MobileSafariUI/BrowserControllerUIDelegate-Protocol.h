...
@class BannerController, BrowserController, CatalogViewController, NSArray, SFStartPageCustomizationViewController, TabBarManager, TabDocument, TabDocumentView, TabHoverPreview, TabOverview, UIResponder, UISceneConnectionOptions, UISceneSession, UIScrollView, UIView, UIViewController, UIWindowScene, WBSWebExtensionData, _SFDownload;
@protocol BannerControllerDelegate, SFStartPageVisualStyleProviding, SidebarUIProxy, TabDocumentViewGeometryProviding, TabSnapshotContentProvider, TabSnapshotGeneratorDelegate, UIDragSession, UIDropSession, UIFocusEnvironment, UIFocusItemContainer, _SFNavigationBarCommon;

@protocol BrowserControllerUIDelegate <NSObject>
- (NSArray *)browserControllerPreferredFocusEnvironments:(BrowserController *)arg1;
- (id <UIFocusItemContainer>)browserControllerFocusItemContainer:(BrowserController *)arg1;
- (id <UIFocusEnvironment>)browserControllerParentFocusEnvironment:(BrowserController *)arg1;
...
- (id <TabSnapshotGeneratorDelegate>)tabSnapshotGeneratorDelegateForBrowserController:(BrowserController *)arg1;
...
@optional
- (void)browserController:(BrowserController *)arg1 overrideDownloadQuickLookPreview:(_SFDownload *)arg2 isContentManaged:(_Bool)arg3;
