...
- (void).cxx_destruct;	// IMP=0x00000000000dd0bf
...
- (double)framesPerSecond;	// IMP=0x00000000000dce2f
- (double)renderDuration;	// IMP=0x00000000000dce0b
- (void)finishRenderTime:(id)arg1;	// IMP=0x00000000000dcdfa
- (void)startRenderTime:(id)arg1;	// IMP=0x00000000000dcdb3
- (void)finishRenderFps:(id)arg1;	// IMP=0x00000000000dcd8a
- (void)startRenderFps:(id)arg1;	// IMP=0x00000000000dcd36
- (void)setTimer:(id)arg1;	// IMP=0x00000000000dccf8
- (id)timer;	// IMP=0x00000000000dccea
- (id)statusString;	// IMP=0x00000000000dcccb
- (int)status;	// IMP=0x00000000000dccc2
- (void)setStatus:(int)arg1;	// IMP=0x00000000000dccb9
- (id)description;	// IMP=0x00000000000dc9e3
- (void)dealloc;	// IMP=0x00000000000dc9a1
- (id)initWithURL:(id)arg1 withProcessSwap:(_Bool)arg2;	// IMP=0x00000000000dc91e
