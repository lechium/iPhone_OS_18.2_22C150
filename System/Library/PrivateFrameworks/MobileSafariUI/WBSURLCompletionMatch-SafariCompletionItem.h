...
+ (id)_relativeDateTimeFormatter;	// IMP=0x00100000001beee1
- (_Bool)isEquivalentTo:(id)arg1;	// IMP=0x00100000001bf9cf
...
- (id)reflectedStringForUserTypedString:(id)arg1;	// IMP=0x00100000001bf91e
- (void)auditAcceptedCompletionWithRank:(unsigned long long)arg1;	// IMP=0x00100000001bf8a4
- (double)completionTableViewCellCustomHeightForCompletionList:(id)arg1;	// IMP=0x00100000001bf88b
- (id)completionTableViewCellForCompletionList:(id)arg1;	// IMP=0x00100000001bf809
- (id)completionTableViewCellReuseIdentifier;	// IMP=0x00100000001bf7fc
- (void)acceptCompletionWithActionHandler:(id)arg1;	// IMP=0x00100000001bf774
- (long long)_completionIcon;	// IMP=0x00100000001bf6fc
- (id)_promptString;	// IMP=0x00100000001bf3b8
- (id)_addressString;	// IMP=0x00100000001bf2f1
- (void)configureCompletionTableViewCell:(id)arg1 forCompletionList:(id)arg2;	// IMP=0x00100000001bef36
