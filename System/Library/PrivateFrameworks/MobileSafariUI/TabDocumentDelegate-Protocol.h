...
@class NSDictionary, NSString, TabDocument, UIViewController, _SFDownload, _SFPageZoomPreferenceManager;
...
- (void)tabDocumentDidChangeMediaState:(TabDocument *)arg1 needsUpdateGlobalAudioState:(_Bool)arg2;
