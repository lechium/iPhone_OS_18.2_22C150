...
@class AFRequestInfo, NSData, NSSet, NSString, SKRExecutionOutput, _TtC14SiriKitRuntime14FlowPluginInfo;

@protocol SKRServiceBridge
- (void)postToMessageBusWithMessage:(NSData *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (void)submitExternalActivationRequestWithRequestInfo:(AFRequestInfo *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
