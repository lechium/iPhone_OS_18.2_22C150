...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000005468
- (void)mediaPause;	// IMP=0x00000000000052db
- (void)imageViewTapped:(id)arg1;	// IMP=0x000000000000529e
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000004a60
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000004970
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x00000000000045b5
- (void)loadView;	// IMP=0x00000000000041d2
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000000335c
