...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000012711
- (unsigned long long)hash;	// IMP=0x0000000000012664
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000012524
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000012412
- (void)copyTo:(id)arg1;	// IMP=0x000000000001234e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000012291
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000012284
- (id)dictionaryRepresentation;	// IMP=0x0000000000011ef9
- (id)description;	// IMP=0x0000000000011e4a
