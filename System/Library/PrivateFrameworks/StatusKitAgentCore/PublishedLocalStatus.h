...
+ (id)identifierKeyPath;	// IMP=0x0040000000011217
+ (id)predicateForPublishedLocalStatusIdentifiers:(id)arg1;	// IMP=0x0040000000011224
+ (id)fetchRequest;	// IMP=0x004000000008b1ba
