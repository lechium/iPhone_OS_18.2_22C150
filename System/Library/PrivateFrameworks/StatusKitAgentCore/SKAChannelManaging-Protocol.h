...
- (void)publishProvisionPayloads:(NSArray *)arg1 onChannel:(NSString *)arg2 withChannelToken:(NSData *)arg3 publishInitiateTime:(NSDate *)arg4 retryCount:(unsigned long long)arg5 completion:(void (^)(NSError *))arg6;
