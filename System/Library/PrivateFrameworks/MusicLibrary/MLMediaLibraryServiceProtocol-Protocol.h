...
- (void)securityScopedURLWrapperForItemPid:(unsigned long long)arg1 withDatabasePath:(NSString *)arg2 completionHandler:(void (^)(NSSecurityScopedURLWrapper *, NSError *))arg3;
