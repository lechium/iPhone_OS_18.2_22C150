...
- (id).cxx_construct;	// IMP=0x0000000000193e04
- (void).cxx_destruct;	// IMP=0x0000000000193db4
...
- (_Bool)unregister;	// IMP=0x0000000000193b45
- (_Bool)registerWithConnection:(id)arg1;	// IMP=0x0000000000193869
@property(readonly, nonatomic) NSString *name;
- (void)dealloc;	// IMP=0x00000000001937e8
- (id)initWithDatabaseTable:(id)arg1;	// IMP=0x0000000000193664
