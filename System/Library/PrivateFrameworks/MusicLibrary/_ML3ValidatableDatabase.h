...
- (void).cxx_destruct;	// IMP=0x00000000002037dd
...
- (_Bool)currentQueueIsValidationQueue;	// IMP=0x0000000000203772
- (id)init;	// IMP=0x0000000000203730
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x00000000002035de
