...
@class NSArray, NSData, NSString, SYDStoreConfiguration, SYDTestConfiguration;
...
- (void)synchronizeStoresWithIdentifiers:(NSArray *)arg1 type:(long long)arg2 testConfiguration:(SYDTestConfiguration *)arg3 completionHandler:(void (^)(NSError *))arg4;
