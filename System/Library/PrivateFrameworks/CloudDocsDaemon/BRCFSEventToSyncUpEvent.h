...
- (void).cxx_destruct;	// IMP=0x000000000005e9a4
...
- (id)associatedAppTelemetryEvent;	// IMP=0x000000000005e87f
- (id)subDescription;	// IMP=0x000000000005e7c6
- (id)additionalPayload;	// IMP=0x000000000005e683
