...
@class BRFileObjectID, BRMangledID, CKShareMetadata, FPSandboxingURLWrapper, NSArray, NSData, NSDictionary, NSFileHandle, NSNumber, NSObject, NSSet, NSString, NSURL;
...
- (void)verifyAccountLoaded:(void (^)(NSError *))arg1;
...
- (void)userVerifiedTermsWithReply:(void (^)(NSError *))arg1;
...
- (void)validateCloudDocsSupported:(_Bool)arg1 withReply:(void (^)(NSError *))arg2;
...
- (void)backupDatabaseWithURLWrapper:(FPSandboxingURLWrapper *)arg1 reply:(void (^)(NSURL *, NSError *))arg2;
- (void)dumpDatabaseTo:(NSFileHandle *)arg1 containerID:(NSString *)arg2 personaID:(NSString *)arg3 includeAllItems:(_Bool)arg4 verbose:(_Bool)arg5 reply:(void (^)(_Bool, NSError *))arg6;
