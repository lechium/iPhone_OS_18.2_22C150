...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001a43f1
+ (id)loadFromClientStateInSession:(id)arg1 options:(id)arg2;	// IMP=0x00600000001a4069
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a4301
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a4208
- (id)init;	// IMP=0x00000000001a41ae
- (id)description;	// IMP=0x00000000001a4164
...
- (unsigned long long)allocatePackageItemRank;	// IMP=0x00000000001a3ef0
@property(nonatomic) unsigned long long nextNotifRank;
- (unsigned long long)allocateNotifRank;	// IMP=0x00000000001a3df3
- (unsigned long long)allocateItemRowID;	// IMP=0x00000000001a3d9b
