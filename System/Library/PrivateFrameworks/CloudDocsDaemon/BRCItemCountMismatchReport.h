...
+ (void)generateReportForSharedFolder:(id)arg1 qualityOfService:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000066099
+ (void)_finishReport:(id)arg1 session:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000065bae
- (void).cxx_destruct;	// IMP=0x0000000000066d1a
...
- (id)telemetryEvent;	// IMP=0x0000000000066c01
- (void)incrementErrorRetryCountWithSession:(id)arg1;	// IMP=0x0000000000065919
- (void)shareChangedDuringCheckWithSession:(id)arg1;	// IMP=0x0000000000065813
- (id)initWithURL:(id)arg1;	// IMP=0x00000000000657a8
