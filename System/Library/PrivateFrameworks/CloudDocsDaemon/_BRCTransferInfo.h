...
- (void).cxx_destruct;	// IMP=0x0000000000190704
...
- (void)verifyFutureProgressIsNotFinished;	// IMP=0x00000000001905ec
- (void)copyProgressInfoToProgress:(id)arg1 options:(BOOL)arg2;	// IMP=0x000000000019050c
- (void)updateLocalizedDescriptionWithOptions:(BOOL)arg1;	// IMP=0x00000000003b4696
- (void)updateUnitCount;	// IMP=0x000000000018ff1b
- (id)description;	// IMP=0x000000000018fbc4
- (id)init;	// IMP=0x000000000018faa9
