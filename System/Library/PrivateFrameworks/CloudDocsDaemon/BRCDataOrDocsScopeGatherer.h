...
- (void).cxx_destruct;	// IMP=0x000000000008e279
...
- (void)dealloc;	// IMP=0x000000000008e220
- (void)invalidate;	// IMP=0x000000000008e00f
- (void)done;	// IMP=0x000000000008dde3
- (CDUnknownBlockType)_popGatherReply;	// IMP=0x000000000008dd76
- (void)gatherWithBatchSize:(long long)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000008c4d2
- (id)initWithNotificationPipe:(id)arg1 appLibraries:(id)arg2 startingRank:(unsigned long long)arg3 maxRank:(unsigned long long)arg4 withDeadItems:(_Bool)arg5 gatherReply:(CDUnknownBlockType)arg6;	// IMP=0x000000000008c113
