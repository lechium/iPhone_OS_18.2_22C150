...
- (void).cxx_destruct;	// IMP=0x000000000010fe14
...
- (void)dealloc;	// IMP=0x000000000010fd4e
- (id)initWithDocument:(id)arg1 stageID:(id)arg2 transferSize:(unsigned long long)arg3;	// IMP=0x000000000010fbbf
- (id)description;	// IMP=0x000000000010fb92
