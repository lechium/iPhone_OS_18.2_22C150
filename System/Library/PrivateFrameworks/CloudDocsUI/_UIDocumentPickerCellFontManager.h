...
+ (id)sharedFontManager;	// IMP=0x0060000000001e44
- (void).cxx_destruct;	// IMP=0x0000000000002042
...
- (void)cacheFonts;	// IMP=0x0000000000001ecd
- (id)init;	// IMP=0x0000000000001e81
