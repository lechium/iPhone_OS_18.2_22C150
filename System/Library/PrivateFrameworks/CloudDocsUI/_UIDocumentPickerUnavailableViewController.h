...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000010a92
- (void)_fontSizeDidChange:(id)arg1;	// IMP=0x0000000000010a7e
- (id)_buttonBackgroundImageForState:(unsigned long long)arg1 traits:(id)arg2;	// IMP=0x000000000001088f
- (void)_buttonPressed:(id)arg1;	// IMP=0x0000000000010816
- (void)dealloc;	// IMP=0x0000000000010794
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000000ef3f
