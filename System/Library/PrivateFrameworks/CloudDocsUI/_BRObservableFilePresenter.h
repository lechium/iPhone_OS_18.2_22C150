...
- (void).cxx_destruct;	// IMP=0x000000000002058e
...
- (void)accommodatePresentedItemDeletionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000204a4
- (void)presentedItemDidMoveToURL:(id)arg1;	// IMP=0x0000000000020457
- (void)presentedItemUbiquityDidChange;	// IMP=0x000000000002041a
- (void)presentedItemDidChange;	// IMP=0x00000000000203dd
