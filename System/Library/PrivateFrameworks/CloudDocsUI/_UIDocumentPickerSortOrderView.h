...
- (void)_toggleListMode:(id)arg1;	// IMP=0x000000000000ae17
- (void)valueChanged:(id)arg1;	// IMP=0x000000000000ad86
@property(nonatomic) int value;
- (void)updateForListMode;	// IMP=0x000000000000ac9e
- (void)layoutSubviews;	// IMP=0x000000000000a216
- (void)setNeedsLayout;	// IMP=0x000000000000a1e7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000009d01
