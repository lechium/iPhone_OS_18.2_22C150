...
- (void).cxx_destruct;	// IMP=0x0000000000037b73
...
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 async:(_Bool)arg3;	// IMP=0x0000000000037aac
- (id)initWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000037a26
