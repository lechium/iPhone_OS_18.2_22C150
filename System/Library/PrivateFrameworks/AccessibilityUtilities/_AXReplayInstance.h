...
+ (id)replayBlock:(CDUnknownBlockType)arg1 name:(id)arg2 attempts:(long long)arg3 interval:(double)arg4 async:(_Bool)arg5 queue:(id)arg6 completion:(CDUnknownBlockType)arg7;	// IMP=0x00600000000b356e
- (void).cxx_destruct;	// IMP=0x00000000000b3de3
...
- (id)_genericFailError;	// IMP=0x00000000000b3c64
- (void)_dispatchAsynchronously;	// IMP=0x00000000000b39a6
- (void)_dispatchSynchronously;	// IMP=0x00000000000b378c
- (void)dispatch;	// IMP=0x00000000000b36d9
