...
- (void).cxx_destruct;	// IMP=0x00000000000379f5
...
- (unsigned long long)hash;	// IMP=0x000000000003799c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000037923
- (void)dealloc;	// IMP=0x00000000000378d2
- (id)initWithPort:(unsigned int)arg1 identifier:(id)arg2;	// IMP=0x000000000003768f
