...
@interface UnitInfo : NSObject
{
    ...
    _Bool _isPreferredUnit;	// 17 = 0x11
    int _unitID;	// 20 = 0x14
...
- (void).cxx_destruct;	// IMP=0x0000000000084f7b
...
- (unsigned long long)hash;	// IMP=0x0000000000084d29
- (long long)compare:(id)arg1;	// IMP=0x0000000000084c9a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000084c12
- (id)init;	// IMP=0x0000000000084b5c
