...
- (void).cxx_destruct;	// IMP=0x0000000000087afb
...
- (void)writeNode:(CDStruct_ef06dbdc)arg1;	// IMP=0x00000000000879b6
- (void)writeCharacter:(unsigned char)arg1;	// IMP=0x000000000008794e
- (void)dealloc;	// IMP=0x00000000000878f3
- (id)init;	// IMP=0x00000000000877c8
