...
@optional
- (void)cdpContext:(CDPContext *)arg1 promptForEDPRecoveryTokenWithValidator:(CDPRemoteDeviceSecretValidator *)arg2 successfulCDPRecoveryContinuationHandler:(void (^)(void))arg3;
