...
+ (id)logCategory;	// IMP=0x001000000007a7ec
- (void).cxx_destruct;	// IMP=0x000000000007a584
...
- (id)logIdentifier;	// IMP=0x000000000007a4c3
- (id)abort;	// IMP=0x0000000000079f28
- (id)commit:(id)arg1;	// IMP=0x0000000000079923
- (id)updateModelID:(id)arg1 modelEncoding:(unsigned long long)arg2 modelData:(id)arg3;	// IMP=0x0000000000079555
- (id)initWithOwner:(id)arg1 identifier:(id)arg2 zoneRow:(unsigned long long)arg3 blockRow:(unsigned long long)arg4;	// IMP=0x0000000000079290
