...
- (void).cxx_destruct;	// IMP=0x000000000005b796
...
- (id)nextObject;	// IMP=0x000000000005b4b9
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x000000000005b3f3
- (id)initWithLocalZone:(id)arg1 modelID:(id)arg2;	// IMP=0x000000000005b04f
