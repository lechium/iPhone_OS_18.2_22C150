...
- (void).cxx_destruct;	// IMP=0x000000000005afdb
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x000000000005ae87
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2 modelClassName:(id)arg3;	// IMP=0x000000000005ab7e
