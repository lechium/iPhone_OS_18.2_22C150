...
+ (id)logCategory;	// IMP=0x0010000000041925
- (void).cxx_destruct;	// IMP=0x000000000003a885
...
- (id)logIdentifier;	// IMP=0x000000000003a723
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000003a478
- (void)handleZoneChanged;	// IMP=0x000000000003a1c8
@property(readonly, nonatomic, getter=isZoneRebuildInProgress) _Bool zoneRebuildInProgress;
- (void)rebuild;	// IMP=0x0000000000039fcd
- (void)handleIdentityLost;	// IMP=0x0000000000039e1a
- (id)zoneStartUp;	// IMP=0x0000000000039cc0
- (id)initWithCloudZone:(id)arg1;	// IMP=0x0000000000039bf9
