...
@class DOCUIPBrowserState, FPItem, FPSandboxingURLWrapper, NSArray, NSString, UIKeyCommand;

@protocol DOCServiceDocumentBrowserViewControllerInterface
- (void)applyBrowserStateChange:(DOCUIPBrowserState *)arg1;
...
- (void)_initiateDocumentCreationWithIntent:(NSString *)arg1;
...
- (void)_getAnimationInfoForDocumentAtURL:(FPSandboxingURLWrapper *)arg1 completion:(void (^)(DOCAnimatableInfo *))arg2;
