...
- (void).cxx_destruct;	// IMP=0x00000000000e1c78
...
- (id)valueForPropertyPath:(id)arg1;	// IMP=0x00000000000e1baf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e1ba4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e1922
- (unsigned long long)hash;	// IMP=0x00000000000e18de
- (id)initWithType:(id)arg1 identifier:(id)arg2 prototypeIdentifier:(id)arg3 dataDictionary:(id)arg4;	// IMP=0x00000000000e17dd
