...
+ (id)_prototypeGroupsByTypeForDOMElement:(id)arg1;	// IMP=0x0010000000093b58
+ (id)_parsedMutationRulesForDOMElement:(id)arg1;	// IMP=0x00100000000936a1
+ (id)instantiateDOMElementForItem:(id)arg1 withPrototype:(id)arg2 parentDOMElement:(id)arg3 existingDOMElement:(id)arg4;	// IMP=0x001000000009253e
+ (id)domBindingControllerForDOMElement:(id)arg1;	// IMP=0x0010000000090d07
+ (void)prepareForDOMElement:(id)arg1;	// IMP=0x0010000000090c4c
+ (id)parsedBindingForDOMElement:(id)arg1;	// IMP=0x0010000000090418
- (void).cxx_destruct;	// IMP=0x0000000000095b8e
...
- (void)_evaluateMutationRules;	// IMP=0x00000000000958a7
- (void)_resolveBinding;	// IMP=0x0000000000094589
- (_Bool)_canBeReused;	// IMP=0x0000000000094307
- (void)dataObservable:(id)arg1 didChangePropertyPathWithString:(id)arg2 extraInfo:(id)arg3;	// IMP=0x0000000000092d4d
- (id)findPrototypeForDataItem:(id)arg1;	// IMP=0x000000000009294e
- (void)scheduleUpdateUsingPreUpdate:(CDUnknownBlockType)arg1 update:(CDUnknownBlockType)arg2;	// IMP=0x0000000000091e29
- (void)dealloc;	// IMP=0x0000000000091d78
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000090d1c
