...
+ (id)hashForObserver:(id)arg1;	// IMP=0x00600000000248cf
- (void).cxx_destruct;	// IMP=0x0000000000024b6c
...
- (_Bool)isAffectedByPropertyPathWithString:(id)arg1 subpathString:(id *)arg2;	// IMP=0x00000000000249fe
- (id)initWithObserver:(id)arg1 pathString:(id)arg2;	// IMP=0x00000000000248f4
