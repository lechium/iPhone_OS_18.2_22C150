...
- (void).cxx_destruct;	// IMP=0x00000000000113ea
@property(readonly, copy, nonatomic) NSString *identifier; // @synthesize identifier=_identifier;
@property(readonly, nonatomic) __weak IKDOMElement *domElement; // @synthesize domElement=_domElement;
- (void)mutateWithDOMElement:(id)arg1;	// IMP=0x00000000000112e3
- (_Bool)passesForDataItem:(id)arg1 default:(_Bool)arg2;	// IMP=0x0000000000010fd1
...
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000010a81
