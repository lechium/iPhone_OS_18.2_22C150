...
+ (id)prototypeMappingFromAppPrototype:(id)arg1 dataSourceElement:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00600000000020e9
- (void).cxx_destruct;	// IMP=0x00000000000024ad
...
- (id)initWithIdentifier:(id)arg1 viewElement:(id)arg2 usageIndexes:(id)arg3;	// IMP=0x00000000000023c5
