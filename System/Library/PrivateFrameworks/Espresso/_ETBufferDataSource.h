...
- (id).cxx_construct;	// IMP=0x00000000009bc296
- (void).cxx_destruct;	// IMP=0x00000000009bc264
...
- (float *)dataAtIndex:(unsigned long long)arg1 key:(const void *)arg2;	// IMP=0x00000000009bc090
- (id)initWithBlobShapes:(const void *)arg1 numberOfDataPoints:(unsigned long long)arg2 batchSize:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x00000000009bbe74
- (id)dataPointAtIndex:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x00000000009bb667
- (unsigned long long)numberOfDataPoints;	// IMP=0x00000000009bb65d
