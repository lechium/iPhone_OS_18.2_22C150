...
- (id).cxx_construct;	// IMP=0x000000000000850e
...
- (id)newIntersectionFunctionTableWithDescriptor:(id)arg1;	// IMP=0x0000000000008413
- (id)newVisibleFunctionTableWithDescriptor:(id)arg1;	// IMP=0x000000000000840b
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3 sparsePageSize:(long long)arg4;	// IMP=0x00000000000083f4
...
- (id)newSharedEventWithMachPort:(unsigned int)arg1;	// IMP=0x0000000000008124
- (id)newSharedEventWithHandle:(id)arg1;	// IMP=0x0000000000007e0b
- (id)newSharedEventWithOptions:(long long)arg1;	// IMP=0x0000000000007bed
- (id)newEventWithOptions:(long long)arg1;	// IMP=0x0000000000007bdb
- (id)newSharedEvent;	// IMP=0x00000000000079c4
- (id)newEvent;	// IMP=0x00000000000079b2
...
- (id)newRasterizationRateMapWithDescriptor:(id)arg1;	// IMP=0x000000000000798e
- (_Bool)supportsRasterizationRateMapWithLayerCount:(unsigned long long)arg1;	// IMP=0x0000000000007986
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000007965
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007944
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000007920
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000078fc
- (id)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000078d8
- (void)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000078b7
- (unsigned long long)minimumTextureBufferAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000007735
- (unsigned long long)minimumLinearTextureAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000007558
- (id)newBufferWithIOSurface:(struct __IOSurface *)arg1;	// IMP=0x0000000000007533
- (_Bool)setResourcesPurgeableState:(id *)arg1 newState:(unsigned long long)arg2 oldState:(unsigned long long *)arg3 count:(int)arg4;	// IMP=0x000000000000752b
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x00000000000073a5
- (id)vendorName;	// IMP=0x0000000000007398
- (_Bool)supportsSampleCount:(unsigned long long)arg1;	// IMP=0x0000000000007382
- (int)llvmVersion;	// IMP=0x0000000000007377
- (id)productName;	// IMP=0x000000000000736a
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 descriptor:(id)arg3 offset:(unsigned long long)arg4 bytesPerRow:(unsigned long long)arg5;	// IMP=0x0000000000007346
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 deallocator:(CDUnknownBlockType)arg3 descriptor:(id)arg4 offset:(unsigned long long)arg5 bytesPerRow:(unsigned long long)arg6;	// IMP=0x0000000000007322
- (id)newIndirectRenderCommandEncoderWithBuffer:(id)arg1;	// IMP=0x00000000000072fe
- (id)newIndirectComputeCommandEncoderWithBuffer:(id)arg1;	// IMP=0x00000000000072da
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x00000000000072b6
- (id)newArgumentEncoderWithLayout:(id)arg1;	// IMP=0x0000000000007038
- (id)newIndirectArgumentBufferLayoutWithStructType:(id)arg1;	// IMP=0x0000000000006de5
- (id)familyName;	// IMP=0x0000000000006dd8
- (id)newComputePipelineWithDescriptor:(id)arg1 variant:(id)arg2 errorMessage:(id *)arg3;	// IMP=0x0000000000006afd
- (id)newComputeVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000006ae6
- (id)wrapComputeState:(id)arg1 descriptor:(id)arg2;	// IMP=0x0000000000006ac2
- (id)pipelinePerformanceStatisticsWithComputeVariant:(id)arg1 compileTimeOutput:(id)arg2;	// IMP=0x0000000000006a53
- (id)pipelinePerformanceStatisticsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2 vertexCompileTimeOutput:(id)arg3 fragmentCompileTimeOutput:(id)arg4;	// IMP=0x000000000000693a
- (CDStruct_9028b892)pipelineFlagsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2;	// IMP=0x0000000000006932
- (id)newRenderPipelineWithDescriptor:(id)arg1 vertexVariant:(id)arg2 fragmentVariant:(id)arg3 errorMessage:(id *)arg4;	// IMP=0x00000000000066b2
- (id)newVertexVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x000000000000669b
- (id)newFragmentVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000006684
- (id)newFunctionVariantWithCompilerOutput:(id)arg1 functionType:(unsigned long long)arg2;	// IMP=0x00000000000063a9
- (id)reportLeaks;	// IMP=0x00000000000062c9
- (void)freeVertexFunctionKey:(void *)arg1 vertexKeySize:(unsigned long long)arg2;	// IMP=0x00000000000062c3
- (void)freeFragmentFunctionKey:(void *)arg1 fragmentKeySize:(unsigned long long)arg2;	// IMP=0x00000000000062bd
- (void *)vertexFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 nextStageVariant:(id)arg3 vertexKeySize:(unsigned long long *)arg4;	// IMP=0x00000000000062ae
- (void *)fragmentFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 previousStateVariant:(id)arg3 fragmentKeySize:(unsigned long long *)arg4;	// IMP=0x000000000000629f
- (id)wrapRenderState:(id)arg1 descriptor:(id)arg2;	// IMP=0x000000000000627b
- (void)registerViewTexture:(id)arg1 baseTextureView:(id)arg2;	// IMP=0x0000000000006275
@property(readonly) _Bool deserializerSupportsSharedTextures;
- (id)newTextureWithDescriptor:(id)arg1 iosurface:(struct __IOSurface *)arg2 plane:(unsigned long long)arg3;	// IMP=0x0000000000005e3c
- (id)newTextureWithDescriptor:(id)arg1;	// IMP=0x0000000000005b0c
- (id)_fixUpSwizzleForTexture:(id)arg1 key:(unsigned int)arg2;	// IMP=0x00000000000059ce
- (id)newSamplerStateWithDescriptor:(id)arg1;	// IMP=0x0000000000005880
- (void)dispatchNotificationWithReference:(unsigned int)arg1;	// IMP=0x000000000000575f
- (void)registerEventNotification:(unsigned int)arg1 listener:(id)arg2 event:(id)arg3 value:(unsigned long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x000000000000563c
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCommandCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000005618
- (id)newHeapWithDescriptor:(id)arg1;	// IMP=0x00000000000052ff
- (id)newFence;	// IMP=0x0000000000005065
- (id)newDepthStencilStateWithDescriptor:(id)arg1;	// IMP=0x0000000000004f17
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000004eee
- (id)newBufferWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 deallocator:(CDUnknownBlockType)arg4;	// IMP=0x0000000000004ec0
- (id)newBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000004e8b
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 pointer:(void *)arg3 copyBytes:(_Bool)arg4 deallocator:(CDUnknownBlockType)arg5;	// IMP=0x0000000000004bcd
- (void)releaseCommandBufferRef:(unsigned int)arg1;	// IMP=0x0000000000004b19
- (unsigned int)registerCommandBuffer:(id)arg1;	// IMP=0x0000000000004986
- (id)commandBufferForReference:(unsigned int)arg1;	// IMP=0x0000000000004819
- (CDStruct_4bcfbbae)heapTextureSizeAndAlignWithDescriptor:(id)arg1;	// IMP=0x000000000000458b
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3;	// IMP=0x000000000000454e
- (CDStruct_4bcfbbae)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000000043b9
- (unsigned int)getNewResourceID;	// IMP=0x00000000000043a6
- (id)compiler;	// IMP=0x000000000000427d
- (id)_deviceWrapper;	// IMP=0x0000000000004253
- (void)_setDeviceWrapper:(id)arg1;	// IMP=0x0000000000004242
- (void)dealloc;	// IMP=0x0000000000004140
- (id)init;	// IMP=0x000000000000379a
...
- (_Bool)supportsVertexAmplificationCount:(unsigned long long)arg1;	// IMP=0x000000000000341a
