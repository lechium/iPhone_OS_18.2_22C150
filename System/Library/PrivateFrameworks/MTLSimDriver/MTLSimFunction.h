...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000097fb
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1 reflection:(id *)arg2;	// IMP=0x00000000000097f3
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1;	// IMP=0x00000000000097eb
@property(readonly) unsigned int functionRef;
- (void)dealloc;	// IMP=0x000000000000970d
- (id)initWithDevice:(id)arg1 functionType:(unsigned long long)arg2 functionRef:(unsigned int)arg3;	// IMP=0x00000000000096a4
