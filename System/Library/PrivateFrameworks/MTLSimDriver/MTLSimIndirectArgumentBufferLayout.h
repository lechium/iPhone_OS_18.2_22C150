...
- (unsigned long long)constantOffsetAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000001b5e
- (unsigned long long)alignment;	// IMP=0x0000000000001b4d
- (unsigned long long)encodedLength;	// IMP=0x0000000000001b3c
- (_Bool)bufferLayoutMatchesFrontEndLayout;	// IMP=0x0000000000001b2c
- (void)dealloc;	// IMP=0x0000000000001a57
- (id)initWithDevice:(id)arg1 reference:(unsigned int)arg2 data:(CDStruct_146dae35 *)arg3;	// IMP=0x00000000000019b8
