...
- (int)setOwnerWithIdentity:(unsigned int)arg1;	// IMP=0x0000000000014246
@property(readonly) unsigned long long heapOffset;
- (void)setHeapOffset:(unsigned long long)arg1;	// IMP=0x0000000000014208
- (void)waitUntilComplete;	// IMP=0x0000000000014202
- (_Bool)isPurgeable;	// IMP=0x00000000000141fa
- (_Bool)isComplete;	// IMP=0x00000000000141f2
- (_Bool)doesAliasResource:(id)arg1;	// IMP=0x00000000000141c2
- (_Bool)doesAliasAnyResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x00000000000141ad
- (_Bool)doesAliasAllResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000014195
- (_Bool)doesAliasResources:(const id *)arg1 count:(unsigned long long)arg2 all:(_Bool)arg3;	// IMP=0x0000000000014044
...
- (unsigned long long)setPurgeableState:(unsigned long long)arg1;	// IMP=0x0000000000013fab
- (void)makeAliasable;	// IMP=0x0000000000013f0d
- (_Bool)isAliasable;	// IMP=0x0000000000013f04
@property(readonly) id <MTLHeap> heap; // @dynamic heap;
@property(copy) NSString *label; // @dynamic label;
- (id)retainedLabel;	// IMP=0x0000000000013ead
@property(readonly) id <MTLDevice> device; // @dynamic device;
- (void)dealloc;	// IMP=0x0000000000013de2
- (id)initWithResourceRef:(unsigned int)arg1 options:(unsigned long long)arg2 device:(id)arg3 heap:(id)arg4;	// IMP=0x0000000000013d46
