...
- (id)pipelineBinaries;	// IMP=0x000000000000f36b
- (unsigned int)pipelineRef;	// IMP=0x000000000000f35b
- (void)dealloc;	// IMP=0x000000000000f281
@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x000000000000f089
