...
+ (id)zero;	// IMP=0x0040000000037020
+ (id)add:(id)arg1 to:(id)arg2;	// IMP=0x0040000000036f40
- (void).cxx_destruct;	// IMP=0x00000000000376d0
- (id)init;	// IMP=0x0000000000037670
@property(nonatomic, readonly) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000036e30
- (id)initWithNatural:(unsigned long long)arg1 leftToRight:(unsigned long long)arg2 rightToLeft:(unsigned long long)arg3;	// IMP=0x0000000000036b60
