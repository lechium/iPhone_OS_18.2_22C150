...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000d632
...
- (id)messageContent;	// IMP=0x000000000000d7fd
@property(readonly, copy, nonatomic) NSDictionary *dictionaryValue;
- (id)initWithMetadata:(id)arg1 message:(id)arg2;	// IMP=0x000000000000d495
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000000d40d
