...
+ (id)missingContentTimerIdentifier;	// IMP=0x001000000000c42c
- (void).cxx_destruct;	// IMP=0x000000000000c4fb
@property(nonatomic) __weak id <CATIDSServiceConnectionDataAggregatorDelegate> delegate; // @synthesize delegate=_delegate;
- (id)description;	// IMP=0x000000000000c486
- (void)dataAggregationCompleted:(id)arg1;	// IMP=0x000000000000c29a
- (void)missingContentTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x000000000000c1da
- (void)updateMissingContentTrackingForDataContent:(id)arg1;	// IMP=0x000000000000be75
- (void)updateExistingDataWindowWithContent:(id)arg1;	// IMP=0x000000000000bd46
- (void)processNewDataWindowWithContent:(id)arg1;	// IMP=0x000000000000bc57
- (void)receiveExpectedSequenceNumber:(unsigned long long)arg1;	// IMP=0x000000000000bb6b
- (void)receiveDataContent:(id)arg1;	// IMP=0x000000000000ba45
@property(readonly, nonatomic) unsigned long long receivedSequenceNumber;
- (id)missingSequenceNumbers;	// IMP=0x000000000000b99c
- (id)initWithWorkQueue:(id)arg1 timerSource:(id)arg2 missingItemInterval:(double)arg3 supportsSequenceCorrection:(_Bool)arg4;	// IMP=0x000000000000b8b9
