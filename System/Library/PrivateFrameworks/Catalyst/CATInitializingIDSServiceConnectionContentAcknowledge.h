...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000042682
- (void).cxx_destruct;	// IMP=0x00000000000426f8
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x0000000000042545
