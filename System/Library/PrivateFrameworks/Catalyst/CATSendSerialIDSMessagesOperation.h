...
- (void).cxx_destruct;	// IMP=0x000000000002302a
- (void)didSendMessagesWithError:(id)arg1;	// IMP=0x0000000000023003
- (void)sendMessages;	// IMP=0x0000000000022b21
- (void)main;	// IMP=0x0000000000022b0f
- (_Bool)isAsynchronous;	// IMP=0x0000000000022b07
- (id)initWithIDSPrimitives:(id)arg1 workQueue:(id)arg2 messages:(id)arg3 destinationAddress:(id)arg4 sourceAppleID:(id)arg5 options:(id)arg6;	// IMP=0x0000000000022977
