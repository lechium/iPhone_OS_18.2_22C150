...
- (void).cxx_destruct;	// IMP=0x0000000000022939
...
- (id)initWithInvitationIdentifier:(id)arg1 appleID:(id)arg2 assertion:(id)arg3 userInfo:(id)arg4;	// IMP=0x000000000002280b
