...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000002627
- (void).cxx_destruct;	// IMP=0x00000000000027db
...
- (id)initWithMessageType:(long long)arg1;	// IMP=0x0000000000002443
- (id)initWithMessageIdentifier:(id)arg1 messageType:(long long)arg2 messagingVersion:(long long)arg3;	// IMP=0x00000000000023c2
