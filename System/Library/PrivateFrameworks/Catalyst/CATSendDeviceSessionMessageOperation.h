...
- (void)sendMessage;	// IMP=0x000000000000c6bd
- (void)main;	// IMP=0x000000000000c5f7
- (_Bool)isAsynchronous;	// IMP=0x000000000000c5ef
- (id)initWithDeviceSession:(id)arg1 message:(id)arg2;	// IMP=0x000000000000c54d
