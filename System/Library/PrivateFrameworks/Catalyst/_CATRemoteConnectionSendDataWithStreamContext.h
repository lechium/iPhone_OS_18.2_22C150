...
- (void).cxx_destruct;	// IMP=0x000000000001cb02
...
- (id)bufferedDataWithError:(id *)arg1;	// IMP=0x000000000001c7fe
...
- (id)initWithStream:(id)arg1 length:(unsigned long long)arg2 bufferSize:(unsigned long long)arg3 userInfo:(id)arg4;	// IMP=0x000000000001c58f
