...
- (void).cxx_destruct;	// IMP=0x000000000012975d
...
- (_Bool)shouldIngestDomainUserInfoUpdateWithOldVersion:(id)arg1 newVersion:(id)arg2;	// IMP=0x0000000000129664
- (id)currentResponseWithRequest:(id)arg1;	// IMP=0x00000000001294ff
- (void)retrieveUserInfoFromExtension;	// IMP=0x00000000001293bc
@property(readonly, nonatomic) NSDictionary *userInfo;
@property(readonly, nonatomic) NSFileProviderDomainVersion *domainVersion;
- (id)instanceWithPrivateSelector:(SEL)arg1;	// IMP=0x0000000000128fe1
@property(readonly, nonatomic) NSFileProviderExtension *v2Instance;
- (void)invalidate;	// IMP=0x0000000000128f17
- (id)itemIDsFromVendorItemIDs:(id)arg1;	// IMP=0x0000000000128e9d
- (id)itemsFromVendorItems:(id)arg1;	// IMP=0x0000000000128e23
- (id)itemIDFromVendorItemID:(id)arg1;	// IMP=0x0000000000128d15
- (id)itemFromVendorItem:(id)arg1;	// IMP=0x00000000001289b6
- (id)internalErrorFromVendorError:(id)arg1 callerDescription:(id)arg2;	// IMP=0x0000000000128939
- (void)prepareForDomainRemovalWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000128893
- (void)updateCapabilities;	// IMP=0x0000000000128534
- (id)initWithVendorInstance:(id)arg1 domain:(id)arg2 extensionContext:(id)arg3 providerDomain:(id)arg4 domainVersion:(id)arg5;	// IMP=0x0000000000128309
