...
- (void).cxx_destruct;	// IMP=0x000000000063db60
...
- (void)pu_cancel;	// IMP=0x000000000063dad5
- (void)main;	// IMP=0x000000000063da64
- (id)initWithDelegate:(id)arg1 activityType:(id)arg2;	// IMP=0x000000000063d999
