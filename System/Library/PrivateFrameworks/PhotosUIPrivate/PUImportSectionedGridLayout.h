...
+ (Class)layoutAttributesClass;	// IMP=0x0060000000324390
- (void).cxx_destruct;	// IMP=0x000000000032432c
...
- (id)indexPathsToDeleteForDecorationViewOfKind:(id)arg1;	// IMP=0x0000000000323f52
- (id)layoutAttributesForDecorationViewOfKind:(id)arg1 atIndexPath:(id)arg2;	// IMP=0x0000000000323e7e
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000323c31
- (void)finalizeCollectionViewUpdates;	// IMP=0x0000000000323bd7
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x000000000032390e
- (id)createLayoutAttributesForSectionBackgroundAtSection:(unsigned long long)arg1;	// IMP=0x00000000003234ab
- (void)recreateSectionDecorationAttributes;	// IMP=0x000000000032322d
- (void)prepareLayout;	// IMP=0x000000000032318d
@property(nonatomic) __weak id <PUImportSectionedGridLayoutDelegate> delegate; // @dynamic delegate;
- (id)init;	// IMP=0x0000000000322f6e
