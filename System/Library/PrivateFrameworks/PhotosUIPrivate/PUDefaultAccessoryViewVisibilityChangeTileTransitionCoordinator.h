...
- (void).cxx_destruct;	// IMP=0x0000000000280b2f
...
- (id)_layoutInfoWithDefaultDisappearance:(id)arg1;	// IMP=0x00000000002803eb
- (id)optionsForAnimatingTileController:(id)arg1 toLayoutInfo:(id)arg2 withAnimationType:(long long)arg3;	// IMP=0x00000000002802b8
