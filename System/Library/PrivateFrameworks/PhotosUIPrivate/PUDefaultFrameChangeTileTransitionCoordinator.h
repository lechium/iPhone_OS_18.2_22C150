...
- (void).cxx_destruct;	// IMP=0x000000000027feab
...
- (_Bool)_isLayoutInfoVisible:(id)arg1;	// IMP=0x000000000027fcc9
- (void)prepare;	// IMP=0x000000000027fbea
- (id)_layoutInfoForDisappearedInvisibleTile:(id)arg1;	// IMP=0x000000000027f85f
- (id)finalLayoutInfoForDisappearingTileController:(id)arg1 fromLayoutInfo:(id)arg2;	// IMP=0x000000000027f791
- (id)initialLayoutInfoForAppearingTileController:(id)arg1 toLayoutInfo:(id)arg2;	// IMP=0x000000000027f6fe
- (_Bool)useDoubleSidedTransitionForUpdatedTileController:(id)arg1 toLayoutInfo:(id)arg2;	// IMP=0x000000000027f69d
