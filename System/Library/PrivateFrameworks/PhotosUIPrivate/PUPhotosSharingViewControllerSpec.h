...
- (_Bool)embedsActivityViewForBounds:(struct CGRect)arg1 horizontalSizeClass:(long long)arg2 verticalSizeClass:(long long)arg3;	// IMP=0x000000000051e1af
...
- (double)interItemSpacingForWidth:(double)arg1;	// IMP=0x000000000051e0fb
@property(readonly, nonatomic) double interItemSpacing;
- (_Bool)maximizeImageHeightForBounds:(struct CGRect)arg1;	// IMP=0x000000000051e0a2
