...
- (void).cxx_destruct;	// IMP=0x000000000020697a
...
- (id)assetsDataSourceManagerInterestingAssetReferences:(id)arg1;	// IMP=0x0000000000206849
- (void)assetsDataSourceManager:(id)arg1 didChangeAssetsDataSource:(id)arg2;	// IMP=0x0000000000206837
- (void)_updateDataSource;	// IMP=0x0000000000206727
- (void)performChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000206655
- (void)detachFromOriginalDataSourceManager;	// IMP=0x00000000002065f9
- (id)initWithOriginalDataSourceManager:(id)arg1;	// IMP=0x0000000000206528
