...
- (void).cxx_destruct;	// IMP=0x0000000000534c2a
...
- (id)_stringFromTimeInterval:(double)arg1;	// IMP=0x0000000000534b17
- (id)_labelTextWithFormat:(long long)arg1 elapsedInterval:(double)arg2 remainingInterval:(double)arg3;	// IMP=0x00000000005349c9
- (struct CGSize)_maximumLabelSizeWithDuration:(double)arg1;	// IMP=0x00000000005346a5
- (void)_updateLabelIfNeeded;	// IMP=0x000000000053453c
- (void)_invalidateLabel;	// IMP=0x0000000000534509
- (void)_updateBackgroundIfNeeded;	// IMP=0x0000000000534353
- (void)_invalidateBackground;	// IMP=0x0000000000534320
- (void)_updateIfNeeded;	// IMP=0x00000000005342d9
- (void)_setNeedsUpdate;	// IMP=0x00000000005342c7
- (_Bool)_needsUpdate;	// IMP=0x000000000053428e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000005341f0
- (void)layoutSubviews;	// IMP=0x00000000005341af
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000533d4f
