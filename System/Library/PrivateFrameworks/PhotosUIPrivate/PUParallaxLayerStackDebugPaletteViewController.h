...
- (void).cxx_destruct;	// IMP=0x000000000040c7c8
...
- (void)modeChanged:(id)arg1;	// IMP=0x000000000040c4cc
- (void)viewDidLoad;	// IMP=0x000000000040bda4
- (void)addSwitchableView:(id)arg1;	// IMP=0x000000000040b9ed
- (id)init;	// IMP=0x000000000040b9ba
