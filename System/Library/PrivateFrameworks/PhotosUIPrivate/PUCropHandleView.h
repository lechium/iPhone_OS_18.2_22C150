...
+ (id)allHandles;	// IMP=0x0060000000264645
- (void).cxx_destruct;	// IMP=0x0000000000264603
...
- (id)_createCornerOverlayView;	// IMP=0x0000000000264396
- (id)_createLineView;	// IMP=0x00000000002642e4
- (id)initForHandle:(unsigned long long)arg1;	// IMP=0x00000000002633a5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000026338e
