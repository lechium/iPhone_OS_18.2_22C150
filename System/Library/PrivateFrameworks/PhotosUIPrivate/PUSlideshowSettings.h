...
+ (id)settingsControllerModule;	// IMP=0x00600000005ae2d8
+ (id)sharedInstance;	// IMP=0x00600000005ae2a8
- (void).cxx_destruct;	// IMP=0x00000000005ae08c
...
- (void)setDefaultValues;	// IMP=0x00000000005ade0d
- (void)setDefaultPresetTransitionValues;	// IMP=0x00000000005ad6f1
- (void)saveInteractiveSlideshowSettingsInUserDefaults;	// IMP=0x00000000005ad3e4
- (_Bool)transitionSettingsAreDefaults;	// IMP=0x00000000005acfe4
- (void)restoreCurrentInteractiveTransitionValuesFromUserDefaults;	// IMP=0x00000000005acdc4
- (void)removeTransitionTimingCustomizationsFromUserDefaults;	// IMP=0x00000000005acd04
@property(retain, nonatomic) OKProducerPreset *currentPreset; // @synthesize currentPreset=_currentPreset;
- (id)archiveValueForKey:(id)arg1;	// IMP=0x00000000005ac92d
- (void)applyArchiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000005ac8a0
- (void)performPostSaveActions;	// IMP=0x00000000005ac85f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005ac7fe
- (id)parentSettings;	// IMP=0x00000000005ac7e5
