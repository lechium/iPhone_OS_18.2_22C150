...
- (void).cxx_destruct;	// IMP=0x00000000002d38cc
...
- (_Bool)_disableRasterizeInAnimations;	// IMP=0x00000000002d377f
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x00000000002d36b5
- (void)_updateExtendedContents;	// IMP=0x00000000002d35cb
- (void)_render;	// IMP=0x00000000002d2d7b
@property(readonly, nonatomic) long long numberOfColumns;
- (void)setVisualSectionIndex:(long long)arg1 andVisualItemRange:(struct _NSRange)arg2;	// IMP=0x00000000002d2b56
- (void)setNeedsRendering;	// IMP=0x00000000002d2971
- (void)layoutSubviews;	// IMP=0x00000000002d24c0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002d2434
