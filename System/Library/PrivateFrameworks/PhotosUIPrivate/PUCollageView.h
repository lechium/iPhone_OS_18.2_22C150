...
+ (long long)maximumNumberOfItems;	// IMP=0x00600000002549d5
- (void).cxx_destruct;	// IMP=0x00000000002548bd
...
- (void)_updateRoundedCornerOverlayView;	// IMP=0x000000000025465b
- (void)_updateImageViews;	// IMP=0x00000000002542f2
- (void)setHasRoundedCorners:(_Bool)arg1 withCornersBackgroundColor:(id)arg2;	// IMP=0x0000000000254277
- (void)setImage:(id)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x0000000000254160
- (void)setImageSize:(struct CGSize)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x00000000002540b3
- (struct CGSize)imageSizeForItemAtIndex:(long long)arg1;	// IMP=0x0000000000253fff
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000253f5b
- (void)layoutSubviews;	// IMP=0x0000000000253943
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000253753
