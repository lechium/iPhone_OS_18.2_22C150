...
- (void).cxx_destruct;	// IMP=0x00000000004b7e24
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000004b7bad
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000004b7b09
- (void)_handleResultAVAsset:(id)arg1 audioMix:(id)arg2 info:(id)arg3;	// IMP=0x00000000004b7a27
- (id)init;	// IMP=0x00000000004b7948
