...
+ (struct CGSize)bufferingIndicatorTileSize;	// IMP=0x0010000000247c54
+ (_Bool)canShowBufferingIndicatorTileForAsset:(id)arg1;	// IMP=0x0010000000247be1
- (void).cxx_destruct;	// IMP=0x0000000000247a73
...
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x00000000002478a3
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000002476a5
- (void)_updateIndicator;	// IMP=0x000000000024742e
- (void)_handleErrorButton:(id)arg1;	// IMP=0x0000000000247281
- (void)_setIndicatorStyle:(long long)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000246c5b
- (void)becomeReusable;	// IMP=0x000000000024697d
