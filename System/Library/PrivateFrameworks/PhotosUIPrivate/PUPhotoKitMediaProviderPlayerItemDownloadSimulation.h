...
- (void).cxx_destruct;	// IMP=0x00000000004b786e
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000004b765d
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000004b75b9
- (void)_handleResultPlayerItem:(id)arg1 info:(id)arg2;	// IMP=0x00000000004b7506
- (id)init;	// IMP=0x00000000004b7427
