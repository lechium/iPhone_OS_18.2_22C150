...
- (void).cxx_destruct;	// IMP=0x0000000000210dbb
...
- (void)unregisterChangeObserver:(id)arg1;	// IMP=0x00000000002109b4
- (void)registerChangeObserver:(id)arg1;	// IMP=0x0000000000210985
@property(readonly, nonatomic) PUAssetSharedViewModelChange *currentChange;
- (id)newViewModelChange;	// IMP=0x0000000000210936
- (id)initWithAsset:(id)arg1;	// IMP=0x00000000002107e6
- (id)init;	// IMP=0x000000000021076c
