...
+ (id)sortDescriptorForMode:(long long)arg1;	// IMP=0x00600000005fbbc6
+ (id)sharedInstance;	// IMP=0x00600000005fbb96
- (void).cxx_destruct;	// IMP=0x00000000005fbb83
...
- (void)createChildren;	// IMP=0x00000000005fb559
- (void)performPostSaveActions;	// IMP=0x00000000005fb445
- (void)setDefaultValues;	// IMP=0x00000000005fb34d
- (id)parentSettings;	// IMP=0x00000000005fb334
