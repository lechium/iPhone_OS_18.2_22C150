...
+ (_Bool)shouldEnableOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x00600000002084bf
+ (_Bool)canPerformOnAsset:(id)arg1 inAssetCollection:(id)arg2;	// IMP=0x00600000002084a6
- (void).cxx_destruct;	// IMP=0x000000000020879d
...
- (void)_presentFunEffectsViewControllerForAsset:(id)arg1;	// IMP=0x0000000000208622
- (void)performUserInteractionTask;	// IMP=0x00000000002084d8
