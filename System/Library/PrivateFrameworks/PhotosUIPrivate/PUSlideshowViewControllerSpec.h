...
- (void)updateIfNeeded;	// IMP=0x00000000005b6eff
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x00000000005b6ebb
- (id)init;	// IMP=0x00000000005b6ea7
@property(readonly, nonatomic) PUSlideshowViewControllerSpecChange *currentChange;
- (id)newSpecChange;	// IMP=0x00000000005b6e58
