...
- (void).cxx_destruct;	// IMP=0x00000000005ab1a2
...
- (void)_endDisablingIdleTimerIfNecessary;	// IMP=0x00000000005ab09f
- (void)_beginDisablingIdleTimer;	// IMP=0x00000000005aafe4
- (void)_slideshowSettingsViewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000005aad98
- (void)_slideshowViewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000005aacbe
- (void)_updateCurrentState;	// IMP=0x00000000005aac65
- (void)_invalidateCurrentState;	// IMP=0x00000000005aac53
- (void)_addCurrentSettingsToPayload:(id)arg1;	// IMP=0x00000000005aa9b6
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x00000000005aa51b
- (void)_configurePresentationViewController:(id)arg1;	// IMP=0x00000000005aa277
- (id)_resolutionSizes;	// IMP=0x00000000005aa0ee
- (void)unregisterSlideshowDisplayContext:(id)arg1;	// IMP=0x00000000005aa07e
- (void)registerSlideshowDisplayContext:(id)arg1;	// IMP=0x00000000005aa03f
- (void)_distributeSlideshowDisplayContextWithPresentationController:(id)arg1;	// IMP=0x00000000005a9dde
- (void)updatePresentationViewController;	// IMP=0x00000000005a9ad0
- (void)settings:(id)arg1 changedValueForKey:(id)arg2;	// IMP=0x00000000005a9867
- (void)dealloc;	// IMP=0x00000000005a97eb
- (id)initWithFetchResult:(id)arg1 assetCollection:(id)arg2;	// IMP=0x00000000005a97d6
- (id)initWithFetchResult:(id)arg1 assetCollection:(id)arg2 startIndex:(unsigned long long)arg3;	// IMP=0x00000000005a9406
- (id)init;	// IMP=0x00000000005a936f
