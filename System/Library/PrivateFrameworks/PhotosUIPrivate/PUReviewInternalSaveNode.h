...
- (void).cxx_destruct;	// IMP=0x0000000000553d74
...
- (void)run;	// IMP=0x0000000000552cc9
- (id)_exportProperties;	// IMP=0x0000000000552c04
- (long long)_adjustmentBaseVersion;	// IMP=0x0000000000552b69
- (double)_baseDuration;	// IMP=0x0000000000552a86
- (long long)_baseExifOrientation;	// IMP=0x00000000005529f6
- (id)initWithDirectory:(id)arg1 imageDataNode:(id)arg2 imageRenderNode:(id)arg3 videoURLNode:(id)arg4 videoRenderNode:(id)arg5;	// IMP=0x0000000000552851
