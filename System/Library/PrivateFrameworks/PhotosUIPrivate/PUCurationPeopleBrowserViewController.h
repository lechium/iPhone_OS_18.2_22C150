...
- (void).cxx_destruct;	// IMP=0x0000000000591e0e
...
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000000591bef
- (id)initWithScoreConfiguration:(id)arg1;	// IMP=0x0000000000591a33
