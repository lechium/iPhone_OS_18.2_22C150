...
- (void).cxx_destruct;	// IMP=0x00000000005c2d06
...
- (void)updateSelectionWithCurrentIndexPath:(id)arg1 leftClosestIndexPath:(id)arg2 aboveClosestIndexPath:(id)arg3;	// IMP=0x00000000005c27da
- (void)endSelection;	// IMP=0x00000000005c26ff
- (void)beginSelectionFromIndexPath:(id)arg1;	// IMP=0x00000000005c2671
- (long long)_selectionModeForRestoringStateOfIndexPath:(id)arg1;	// IMP=0x00000000005c2588
- (id)_indexesPathsRangeForIndexPath:(id)arg1;	// IMP=0x00000000005c205f
- (void)dealloc;	// IMP=0x00000000005c1f73
- (id)initWithSelectionMode:(long long)arg1 photoSelectionManager:(id)arg2;	// IMP=0x00000000005c1ef5
- (id)init;	// IMP=0x00000000005c1eb1
