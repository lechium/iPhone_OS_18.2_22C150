...
- (void).cxx_destruct;	// IMP=0x000000000063ca41
...
- (void)photoLibraryDidChangeOnMainQueue:(id)arg1;	// IMP=0x000000000063c955
- (id)tipQueue_fetchCountsDictionary;	// IMP=0x000000000063c693
- (id)tipQueue_fetchSizesDictionary;	// IMP=0x000000000063c398
- (void)tipQueue_createPendingDataSection;	// IMP=0x000000000063c2a9
- (void)tipQueue_populateInitialFetches;	// IMP=0x000000000063c142
- (id)createDataSection;	// IMP=0x000000000063c0f8
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x000000000063bf57
