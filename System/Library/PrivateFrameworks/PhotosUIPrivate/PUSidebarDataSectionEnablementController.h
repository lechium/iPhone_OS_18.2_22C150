...
- (void).cxx_destruct;	// IMP=0x00000000002a0a59
...
- (void)preferencesDidChange;	// IMP=0x00000000002a0967
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x00000000002a08c3
- (void)_observeDefaultsForManager:(id)arg1 enablementItem:(long long)arg2;	// IMP=0x00000000002a07e8
- (void)_observeAccountsStoreForManager:(id)arg1 enablementItem:(long long)arg2;	// IMP=0x00000000002a06b0
- (void)_configureEnablementOfSectionManager:(id)arg1 enablementItem:(long long)arg2 setupObservation:(_Bool)arg3;	// IMP=0x00000000002a03b4
- (void)configureEnablementOfSectionManager:(id)arg1 enablementItem:(long long)arg2;	// IMP=0x00000000002a039c
- (void)dealloc;	// IMP=0x00000000002a0352
- (id)initWithPhotoLibrary:(id)arg1 isPhotosPicker:(_Bool)arg2 excludesHiddenAlbum:(_Bool)arg3;	// IMP=0x00000000002a027f
