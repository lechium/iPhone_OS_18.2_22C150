...
- (void).cxx_destruct;	// IMP=0x00000000002b460d
...
- (void)px_finishIfPossible;	// IMP=0x00000000002b43dc
- (_Bool)px_shouldWaitForCancel;	// IMP=0x00000000002b43d4
- (void)cancel;	// IMP=0x00000000002b4344
- (void)_handleLayerStackResponse:(id)arg1;	// IMP=0x00000000002b409a
- (_Bool)_loadLayerStackFromDirectory;	// IMP=0x00000000002b3eb3
- (_Bool)_canLoadLayerStackFromDirectory;	// IMP=0x00000000002b3c6e
- (_Bool)tryLoadLayerStackFromDirectory;	// IMP=0x00000000002b3c35
- (void)px_start;	// IMP=0x00000000002b3595
- (id)initWithPosterMedia:(id)arg1 editConfiguration:(id)arg2 assetDirectory:(id)arg3 style:(id)arg4 persistedStyle:(id)arg5 isPreloading:(_Bool)arg6;	// IMP=0x00000000002b3418
