...
@optional
- (_Bool)oneUpGestureRecognizerCoordinator:(PUOneUpGestureRecognizerCoordinator *)arg1 shouldAllowIrisGestureAtLocationFromProvider:(id <PUDisplayLocationProvider>)arg2;
