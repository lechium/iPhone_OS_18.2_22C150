...
- (void).cxx_destruct;	// IMP=0x00000000002ee6d6
...
- (void)finishSessionWithEnd:(long long)arg1;	// IMP=0x00000000002ee5f5
- (id)finishSessionWithEnd:(long long)arg1 newCompositionController:(id)arg2 oldCompositionController:(id)arg3;	// IMP=0x00000000002ee202
- (void)_recordKeys:(id)arg1;	// IMP=0x00000000002ee0d1
- (id)_sessionKeysWithEnd:(long long)arg1;	// IMP=0x00000000002edf6c
@property(readonly, nonatomic) __weak NSArray *_autoCropKeys;
- (void)notifyDidAdjustCrop;	// IMP=0x00000000002ede31
- (void)notifyDidResetCrop;	// IMP=0x00000000002edde3
- (void)notifyDidApplyPerspectiveAutoCrop;	// IMP=0x00000000002eddcc
- (void)notifyDidApplyAutoCrop;	// IMP=0x00000000002edd88
- (struct __CFString *)_keyForSessionEnd:(long long)arg1;	// IMP=0x00000000002edd07
