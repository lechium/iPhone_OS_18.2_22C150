...
- (_Bool)oneUpAccessoryViewControllersManager:(PUOneUpAccessoryViewControllersManager *)arg1 preventAlbumAttributionWidgetForAssetReference:(PUAssetReference *)arg2;
