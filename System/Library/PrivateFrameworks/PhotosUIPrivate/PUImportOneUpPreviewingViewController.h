...
- (void).cxx_destruct;	// IMP=0x00000000002fcedf
...
- (struct CGSize)sizeForImportItemViewModel:(id)arg1;	// IMP=0x00000000002fcd52
- (void)updatePreferredContentSize;	// IMP=0x00000000002fcc53
- (void)viewDidLoad;	// IMP=0x00000000002fcaf3
- (id)initWithImportItemViewModel:(id)arg1 startingImage:(id)arg2 mediaProvider:(id)arg3;	// IMP=0x00000000002fc9f9
