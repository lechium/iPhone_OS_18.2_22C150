...
+ (void)runSizeTest;	// IMP=0x0060000000394bb2
+ (id)settingsControllerModule;	// IMP=0x006000000039443f
+ (id)sharedInstance;	// IMP=0x006000000039440f
...
- (id)parentSettings;	// IMP=0x0000000000395509
