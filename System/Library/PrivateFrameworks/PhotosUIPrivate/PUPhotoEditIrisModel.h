...
- (void).cxx_destruct;	// IMP=0x0000000000449460
...
- (void)_setHidden:(_Bool)arg1 explicit:(_Bool)arg2 supportable:(_Bool)arg3;	// IMP=0x0000000000449340
- (id)newViewModelChange;	// IMP=0x000000000044932f
@property(readonly, nonatomic) PUPhotoEditIrisModelChange *currentChange;
- (_Bool)_hasLegacyIrisConflicts;	// IMP=0x000000000044916b
- (void)_updateAutoDisableStateIfNeeded;	// IMP=0x00000000004490de
- (void)compositionDidChange;	// IMP=0x00000000004490a5
@property(readonly, nonatomic) _Bool hasUnsavedChanges;
- (_Bool)reenablingLivePhotoShouldRemoveEdits;	// IMP=0x0000000000448fd6
- (void)notifyCannotSupportVideoEdits;	// IMP=0x0000000000448f8a
- (void)dealloc;	// IMP=0x0000000000448ec3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000448df0
- (id)initWithIrisVisibilityState:(unsigned short)arg1 hasAdjustments:(_Bool)arg2 compositionController:(id)arg3;	// IMP=0x0000000000448cf9
- (id)initWithAsset:(id)arg1 compositionController:(id)arg2;	// IMP=0x0000000000448c2f
- (id)init;	// IMP=0x0000000000448c19
