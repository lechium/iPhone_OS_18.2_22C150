...
- (void).cxx_destruct;	// IMP=0x00000000002df6e4
...
- (void)_handleRenderCompletedWithJpegData:(id)arg1 baseSize:(struct CGSize)arg2 editedSize:(struct CGSize)arg3;	// IMP=0x00000000002df5e1
- (void)run;	// IMP=0x00000000002df3c6
- (id)_editSource;	// IMP=0x00000000002df137
- (_Bool)_isInputValid;	// IMP=0x00000000002deffb
- (id)initWithImageInfoNode:(id)arg1 videoURLNode:(id)arg2 compositionController:(id)arg3 livePhotoPairingIdentifier:(id)arg4 jpegCompression:(double)arg5;	// IMP=0x00000000002deced
