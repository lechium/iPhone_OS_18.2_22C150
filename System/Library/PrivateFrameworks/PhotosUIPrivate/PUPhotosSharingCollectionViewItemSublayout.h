...
- (void).cxx_destruct;	// IMP=0x0000000000509485
...
- (void)setFloatingOffset:(struct UIOffset)arg1;	// IMP=0x00000000005092ff
- (void)prepareSublayout;	// IMP=0x0000000000508cf9
@property(nonatomic) struct CGSize optionBadgeSize;
@property(nonatomic) struct CGSize selectionBadgeSize;
- (id)initWithIndexPath:(id)arg1 itemFrame:(struct CGRect)arg2;	// IMP=0x0000000000508b85
