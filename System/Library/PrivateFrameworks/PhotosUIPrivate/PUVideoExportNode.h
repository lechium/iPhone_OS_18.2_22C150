...
- (void).cxx_destruct;	// IMP=0x000000000062d93e
...
- (void)_handleExportCompletedWithSuccess:(_Bool)arg1 editedSize:(struct CGSize)arg2 error:(id)arg3;	// IMP=0x000000000062d860
- (void)didCancel;	// IMP=0x000000000062d823
@property(readonly, nonatomic) double progress;
- (void)run;	// IMP=0x000000000062d579
- (id)_editSource;	// IMP=0x000000000062d415
- (id)_newOutputURL;	// IMP=0x000000000062d32c
- (id)_exportPresetName;	// IMP=0x000000000062d2f4
- (id)initWithVideoURLNode:(id)arg1 imageURLNode:(id)arg2 quality:(unsigned long long)arg3 livePhotoPairingIdentifier:(id)arg4 compositionController:(id)arg5;	// IMP=0x000000000062d0db
