...
- (void).cxx_destruct;	// IMP=0x00000000002a7dc3
...
- (void)_handleLoadedImageData:(id)arg1 imageUTI:(id)arg2 imageOrientation:(long long)arg3 info:(id)arg4;	// IMP=0x00000000002a7b49
- (void)run;	// IMP=0x00000000002a799d
- (void)didCancel;	// IMP=0x00000000002a794a
- (id)initWithAsset:(id)arg1 mediaProvider:(id)arg2 version:(long long)arg3;	// IMP=0x00000000002a7893
