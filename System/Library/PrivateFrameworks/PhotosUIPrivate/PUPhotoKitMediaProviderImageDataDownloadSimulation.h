...
- (void).cxx_destruct;	// IMP=0x00000000004b737f
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000004b70e8
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000004b7044
- (void)_handleResultImageData:(id)arg1 dataUTI:(id)arg2 orientation:(long long)arg3 info:(id)arg4;	// IMP=0x00000000004b6f98
- (id)init;	// IMP=0x00000000004b6ee7
