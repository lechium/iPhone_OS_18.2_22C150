...
- (void).cxx_destruct;	// IMP=0x0000000000602c9d
...
- (void)_endWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4 finish:(_Bool)arg5 animated:(_Bool)arg6;	// IMP=0x000000000060204e
- (void)_autoUpdate:(id)arg1;	// IMP=0x000000000060203c
- (void)_updateAutoUpdateDisplayLink;	// IMP=0x0000000000601f1b
- (void)_update;	// IMP=0x0000000000601977
- (void)cancelWithoutAnimation;	// IMP=0x0000000000601945
- (void)cancelWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4;	// IMP=0x0000000000601928
- (void)finishWithTranslationVelocity:(struct CGPoint)arg1 rotationVelocity:(double)arg2 scaleVelocity:(double)arg3 shouldBounce:(_Bool)arg4;	// IMP=0x0000000000601908
- (void)updateWithTranslation:(struct CGPoint)arg1 rotation:(double)arg2 scale:(double)arg3;	// IMP=0x0000000000601861
- (id)initWithView:(id)arg1 sourceFrame:(struct CGRect)arg2 targetFrame:(struct CGRect)arg3 anchorPoint:(struct CGPoint)arg4 shouldUseTargetAspectRatio:(_Bool)arg5 rampUpDuration:(double)arg6 direction:(unsigned long long)arg7;	// IMP=0x000000000060119d
