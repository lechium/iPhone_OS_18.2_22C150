...
- (void).cxx_destruct;	// IMP=0x0000000000456897
@property(readonly, nonatomic) struct UIEdgeInsets insets; // @synthesize insets=_insets;
@property(readonly, nonatomic) UILabel *label; // @synthesize label=_label;
@property(copy, nonatomic) NSString *text; // @synthesize text=_text;
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000456807
- (void)_updateLabel;	// IMP=0x00000000004567b3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000456330
