...
+ (id)srlCompensationLoadingQueue;	// IMP=0x00100000003110a6
- (void).cxx_destruct;	// IMP=0x00000000003108b2
...
- (void)_handleLoadedSRLCompensationAmount:(id)arg1 forAsset:(id)arg2;	// IMP=0x000000000031065a
- (void)_updateSRLCompensation;	// IMP=0x0000000000310426
- (void)_updatePlaybackEnabled;	// IMP=0x0000000000310190
- (void)_videoCurrentTimeDidChange:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000030ff1b
- (void)_updateMergedVideo;	// IMP=0x000000000030fe51
- (void)_updateLivePhotoViewModulatorInput;	// IMP=0x000000000030fdd3
- (void)_updateLivePhotoViewModulator;	// IMP=0x000000000030fc2c
- (void)_updateLivePhotoViewPhoto;	// IMP=0x000000000030f8bc
- (void)viewModel:(id)arg1 didChange:(id)arg2;	// IMP=0x000000000030f21c
- (void)observable:(id)arg1 didChange:(unsigned long long)arg2 context:(void *)arg3;	// IMP=0x000000000030efaa
- (double)livePhotoView:(id)arg1 extraMinimumTouchDurationForTouch:(id)arg2 withStyle:(long long)arg3;	// IMP=0x000000000030ef2f
- (void)livePhotoView:(id)arg1 didEndPlaybackWithStyle:(long long)arg2;	// IMP=0x000000000030ee92
- (void)livePhotoView:(id)arg1 willBeginPlaybackWithStyle:(long long)arg2;	// IMP=0x000000000030ec8b
- (_Bool)livePhotoView:(id)arg1 canBeginPlaybackWithStyle:(long long)arg2;	// IMP=0x000000000030ebef
- (_Bool)disappearanceAssertionsEnabled;	// IMP=0x000000000030ebe7
- (void)becomeReusable;	// IMP=0x000000000030eb7e
- (id)gestureRecognizers;	// IMP=0x000000000030eb6c
- (id)loadView;	// IMP=0x000000000030e85c
- (void)dealloc;	// IMP=0x000000000030e808
- (void)setMergedVideo:(id)arg1;	// IMP=0x000000000030e540
