...
- (void).cxx_destruct;	// IMP=0x00000000004b83fc
...
- (void)endSimulationWithError:(id)arg1;	// IMP=0x00000000004b81eb
- (void)updateSimulationWithProgress:(double)arg1;	// IMP=0x00000000004b8147
- (void)_handleResultLivePhoto:(id)arg1 info:(id)arg2;	// IMP=0x00000000004b7fd5
- (id)init;	// IMP=0x00000000004b7f24
