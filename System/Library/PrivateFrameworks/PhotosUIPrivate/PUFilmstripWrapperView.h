...
- (void).cxx_destruct;	// IMP=0x00000000002c44d6
...
- (void)setFilmstripView:(id)arg1 leavingPreviousViewInPlace:(_Bool)arg2;	// IMP=0x00000000002c4215
- (void)layoutSubviews;	// IMP=0x00000000002c3bd2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002c399f
