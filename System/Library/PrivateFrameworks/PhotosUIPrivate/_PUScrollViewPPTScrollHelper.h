...
- (void).cxx_destruct;	// IMP=0x00000000006531f9
...
- (void)_endScroll;	// IMP=0x000000000065305c
- (void)_incrementScroll;	// IMP=0x0000000000652f5d
- (void)scrollWithStartHandler:(CDUnknownBlockType)arg1 incrementHandler:(CDUnknownBlockType)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000652da4
- (id)initWithScrollView:(id)arg1;	// IMP=0x0000000000652d40
- (id)init;	// IMP=0x0000000000652cc6
