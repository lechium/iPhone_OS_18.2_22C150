...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000063bbd
- (void).cxx_destruct;	// IMP=0x0000000000064297
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000640eb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000063f0c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000063bc5
