...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004ade4
- (void).cxx_destruct;	// IMP=0x000000000004af73
...
- (Class)clientPromiseClass;	// IMP=0x000000000004aed7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004adec
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004ac75
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004aafc
