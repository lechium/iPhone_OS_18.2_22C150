...
- (void).cxx_destruct;	// IMP=0x0000000000050046
...
- (_Bool)_hasFocalPoint;	// IMP=0x000000000004fb48
...
- (id)initWithSearchResultItem:(id)arg1;	// IMP=0x000000000004f98c
- (id)initWithGatingResultItem:(id)arg1 domain:(id)arg2;	// IMP=0x000000000004f8f3
