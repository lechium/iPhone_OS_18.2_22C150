...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005fb83
- (void).cxx_destruct;	// IMP=0x000000000005fdb6
...
- (id)boundingQuads;	// IMP=0x000000000005fcfb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005fc39
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005fb8b
- (id)initWithScannerResult:(id)arg1 quad:(id)arg2;	// IMP=0x000000000005fa52
- (id)initWithMADMRCResultItem:(id)arg1 scannerResult:(id)arg2;	// IMP=0x000000000005f900
