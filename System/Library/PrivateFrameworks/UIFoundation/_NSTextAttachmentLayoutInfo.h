...
- (void)invalidateAttachmentMeasurements;	// IMP=0x0000000000133693
- (void)_invalidateLocations;	// IMP=0x0000000000133671
...
- (id)textLayoutFragment;	// IMP=0x000000000013344f
@property(readonly) id <NSTextLocation> location; // @dynamic location;
- (void)_queryLayoutWithHorizontalOffset:(double)arg1;	// IMP=0x000000000013328e
- (void)_queryLayout;	// IMP=0x0000000000132fdd
- (void)dealloc;	// IMP=0x0000000000132f7e
- (id)initWithContext:(id)arg1 location:(id)arg2 attributes:(id)arg3;	// IMP=0x0000000000132e33
