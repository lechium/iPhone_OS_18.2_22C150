...
- (id)_accessibilityAXAttributedName;	// IMP=0x003000000000c3a0
- (_Bool)_accessibilityMatchesCustomActionIdentifier:(id)arg1;	// IMP=0x003000000000c332
- (id)_accessibilityCustomActionIdentifier;	// IMP=0x003000000000c220
