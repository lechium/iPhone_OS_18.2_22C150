...
- (void).cxx_destruct;	// IMP=0x000000000054c270
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x000000000054b940
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x000000000054b290
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x000000000054ab00
- (void)startWithHandler:(id)arg1;	// IMP=0x0000000000549810
- (void)dealloc;	// IMP=0x00000000005497e0
- (id)init;	// IMP=0x0000000000549510
