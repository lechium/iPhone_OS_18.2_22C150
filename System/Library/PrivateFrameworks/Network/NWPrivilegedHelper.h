...
- (void).cxx_destruct;	// IMP=0x000000000074d330
...
- (void)handleRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x000000000074cd20
- (id)initWithQueue:(id)arg1;	// IMP=0x000000000074c6a0
- (void)startThrottlePolicyEventListener;	// IMP=0x000000000074c650
- (_Bool)startXPCListener;	// IMP=0x000000000074be90
- (void)registerHelperFunctions;	// IMP=0x000000000074b230
- (void)registerHandlerFunction:(CDUnknownFunctionPointerType)arg1 type:(int)arg2 allowedEntitlementGroup:(id)arg3;	// IMP=0x0000000000749e20
