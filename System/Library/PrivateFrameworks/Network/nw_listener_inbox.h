...
- (void).cxx_destruct;	// IMP=0x00000000009e3320
...
- (_Bool)cancel;	// IMP=0x00000000009e3000
- (_Bool)resume;	// IMP=0x00000000009e2f20
- (_Bool)isSuspended;	// IMP=0x00000000009e2f10
- (_Bool)suspend;	// IMP=0x00000000009e2e30
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000009e2b10
- (id)start;	// IMP=0x00000000009e2b00
