...
- (void).cxx_destruct;	// IMP=0x00000000001650d0
...
- (id)snapshot;	// IMP=0x0000000000164d00
- (void)reset;	// IMP=0x0000000000164ca0
- (void)updateWithState:(id)arg1 atTime:(double)arg2;	// IMP=0x0000000000164900
- (id)description;	// IMP=0x0000000000164860
- (void)dealloc;	// IMP=0x00000000001647d0
- (id)initWithName:(id)arg1;	// IMP=0x0000000000164650
