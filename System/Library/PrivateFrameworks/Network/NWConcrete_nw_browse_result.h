...
- (id).cxx_construct;	// IMP=0x000000000011fae0
- (void).cxx_destruct;	// IMP=0x000000000011faa0
- (id)redactedDescription;	// IMP=0x000000000011fa60
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000011f990
