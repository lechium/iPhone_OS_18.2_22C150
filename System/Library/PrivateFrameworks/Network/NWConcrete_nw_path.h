...
- (void).cxx_destruct;	// IMP=0x00000000009e9140
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009e9050
- (id)redactedDescription;	// IMP=0x00000000009e9030
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000009e7a50
- (id)init;	// IMP=0x00000000009e7780
