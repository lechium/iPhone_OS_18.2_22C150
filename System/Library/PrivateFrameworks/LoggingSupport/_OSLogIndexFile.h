...
- (void).cxx_destruct;	// IMP=0x00000000000188f5
...
- (id)copyMappedChunkStore:(id *)arg1;	// IMP=0x00000000000188a9
- (_Bool)_determineTimespan;	// IMP=0x00000000000186ee
- (_Bool)_loadCatalogMetadataForTimespan;	// IMP=0x00000000000184c9
- (_Bool)_loadHeaderMetadata:(id)arg1;	// IMP=0x0000000000018405
- (void)dealloc;	// IMP=0x00000000000183cb
- (id)initWithChunkStore:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001830b
- (id)initWithTraceFile:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000181d9
