...
- (void).cxx_destruct;	// IMP=0x00000000000466b4
...
- (id)stringForIndex:(id)arg1;	// IMP=0x0000000000046574
- (id)indexForString:(id)arg1;	// IMP=0x0000000000046468
- (id)dataRepresentation;	// IMP=0x0000000000046050
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x0000000000045bc6
- (id)init;	// IMP=0x0000000000045b60
