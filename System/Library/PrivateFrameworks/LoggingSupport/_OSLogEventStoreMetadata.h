...
- (void).cxx_destruct;	// IMP=0x0000000000057753
...
- (id)timeRefForTTLClass:(unsigned char)arg1;	// IMP=0x000000000005771f
- (id)initWithCollection:(id)arg1 localStorePlist:(id)arg2 liveDataDescriptor:(int)arg3;	// IMP=0x000000000005745c
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000056ee0
