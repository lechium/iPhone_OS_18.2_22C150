...
- (void)appendBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000000002e779
- (void)setTruncated;	// IMP=0x000000000002e771
- (void)setPublic;	// IMP=0x000000000002e750
- (void)_initBlob;	// IMP=0x000000000002e6a2
