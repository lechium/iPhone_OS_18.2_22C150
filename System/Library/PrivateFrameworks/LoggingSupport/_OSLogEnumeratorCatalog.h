...
- (void).cxx_destruct;	// IMP=0x00000000000199eb
...
- (void)enumerateSubchunksUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001970a
- (void)unionWithRange:(struct _NSRange)arg1;	// IMP=0x00000000000196e5
...
- (void)dealloc;	// IMP=0x0000000000019674
- (id)initWithStore:(id)arg1 index:(id)arg2 fileHeader:(struct tracev3_chunk_s *)arg3 range:(struct _NSRange)arg4 chunk:(struct tracev3_chunk_s *)arg5;	// IMP=0x0000000000019575
