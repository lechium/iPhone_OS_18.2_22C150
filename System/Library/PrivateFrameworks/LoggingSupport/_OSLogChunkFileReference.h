...
- (id)copyMappedChunkFile:(id *)arg1;	// IMP=0x0000000000018002
- (_Bool)readXattrForTimespan:(id *)arg1;	// IMP=0x0000000000017da0
- (void)dealloc;	// IMP=0x0000000000017d66
- (id)initWithCollection:(id)arg1 subpath:(const char *)arg2;	// IMP=0x0000000000017ce7
