...
- (void).cxx_destruct;	// IMP=0x000000000011ccf5
- (id)flatbuffData;	// IMP=0x000000000011cb64
- (Offset_acd6b661)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000011bfba
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000011b670
- (unsigned long long)context_info_count;	// IMP=0x000000000011b5d4
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000011b4da
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011b050
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000011aea5
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2;	// IMP=0x000000000011ae90
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000011ae76
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000011ae5f
