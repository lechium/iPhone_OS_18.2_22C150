...
- (void)onDeviceModeSupported:(void (^)(_Bool, NSError *))arg1;
...
- (void)_getAssetSize:(void (^)(NSNumber *, NSError *))arg1;
- (void)_updateAllAssets:(void (^)(NSError *))arg1;
- (void)_purgeAllAssetsExcludingConfig:(_Bool)arg1 completion:(void (^)(NSError *))arg2;
...
- (void)addLanguages:(NSArray *)arg1 useCellular:(_Bool)arg2;
...
- (void)modalitiesPerLocaleWithCompletion:(void (^)(_LTLocaleModalities *))arg1;
