...
+ (long long)container_message_typeForObject:(id)arg1;	// IMP=0x00600000000b9c41
+ (long long)container_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b982d
+ (Class)container_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b97f3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b7cb4
- (id)init;	// IMP=0x00000000000b7c26
