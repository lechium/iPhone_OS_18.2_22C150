...
+ (long long)container_message_typeForImmutableObject:(id)arg1;	// IMP=0x00100000000943b2
+ (Class)container_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000094378
- (void).cxx_destruct;	// IMP=0x0000000000095529
- (id)flatbuffData;	// IMP=0x0000000000095398
- (Offset_eabeea59)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000947c6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000092b3f
- (id)initWithFlatbuffData:(id)arg1 root:(const struct QssMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000009295c
- (id)initWithFlatbuffData:(id)arg1 root:(const struct QssMessage *)arg2;	// IMP=0x0000000000092947
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000009292d
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000092916
