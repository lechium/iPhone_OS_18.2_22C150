...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000192639
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000192463
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000192429
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000191804
- (id)init;	// IMP=0x0000000000191776
