...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000191312
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000191098
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000019105e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019003d
- (id)init;	// IMP=0x000000000018ffaf
