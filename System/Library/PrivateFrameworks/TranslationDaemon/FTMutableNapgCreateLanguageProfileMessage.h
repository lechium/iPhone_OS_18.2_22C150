...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000b4dfb
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b4d6c
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b4d2c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b48ff
- (id)init;	// IMP=0x00000000000b4871
