...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000008030f
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x00100000000802d5
- (void).cxx_destruct;	// IMP=0x0000000000081492
- (id)flatbuffData;	// IMP=0x0000000000081301
- (Offset_b5e03a40)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000008074c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007eb57
- (id)initWithFlatbuffData:(id)arg1 root:(const struct AsrRecognitionMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000007e974
- (id)initWithFlatbuffData:(id)arg1 root:(const struct AsrRecognitionMessage *)arg2;	// IMP=0x000000000007e95f
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000007e945
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000007e92e
