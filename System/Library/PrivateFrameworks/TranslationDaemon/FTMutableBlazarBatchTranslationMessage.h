...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000b29d1
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b2876
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b283c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b1f14
- (id)init;	// IMP=0x00000000000b1e86
