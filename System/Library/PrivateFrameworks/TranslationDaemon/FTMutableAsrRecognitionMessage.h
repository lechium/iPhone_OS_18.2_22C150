...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a9302
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a8ec5
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a8e8b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a7375
- (id)init;	// IMP=0x00000000000a72e7
