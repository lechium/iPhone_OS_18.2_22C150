...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000b647c
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b637a
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b6340
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b5c16
- (id)init;	// IMP=0x00000000000b5b88
