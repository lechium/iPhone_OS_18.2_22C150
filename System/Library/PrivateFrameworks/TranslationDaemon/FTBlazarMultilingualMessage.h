...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000008825d
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000088223
- (void).cxx_destruct;	// IMP=0x0000000000088d1b
- (id)flatbuffData;	// IMP=0x0000000000088b8a
- (Offset_a99fc554)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000884d7
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000874be
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000872db
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2;	// IMP=0x00000000000872c6
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000872ac
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000087295
