...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017e431
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x001000000017e3f7
- (void).cxx_destruct;	// IMP=0x000000000017ec87
- (id)flatbuffData;	// IMP=0x000000000017eaf6
- (Offset_2c19e347)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017e607
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017da3e
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultiUserStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000017d85b
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultiUserStreamingRequest *)arg2;	// IMP=0x000000000017d846
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000017d82c
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000017d815
