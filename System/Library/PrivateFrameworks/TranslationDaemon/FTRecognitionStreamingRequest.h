...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017b44f
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x001000000017b415
- (void).cxx_destruct;	// IMP=0x000000000017bd3f
- (id)flatbuffData;	// IMP=0x000000000017bbae
- (Offset_3f5da55c)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017b64e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017a971
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000017a78e
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingRequest *)arg2;	// IMP=0x000000000017a779
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000017a75f
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000017a748
