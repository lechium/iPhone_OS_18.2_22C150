...
- (void).cxx_destruct;	// IMP=0x00000000000ce4eb
- (id)flatbuffData;	// IMP=0x00000000000ce35a
- (Offset_b7f57b05)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000cd311
@property(readonly, nonatomic) NSString *self_session_id;
@property(readonly, nonatomic) unsigned int initial_result_candidate_id;
- (void)multi_user_parameters_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000cd0c7
- (unsigned long long)multi_user_parameters_count;	// IMP=0x00000000000cd02b
- (id)multi_user_parameters_objectAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000ccf31
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000cc3a6
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000cc1fb
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartSpeechRequest *)arg2;	// IMP=0x00000000000cc1e6
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000cc1cc
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000cc1b5
