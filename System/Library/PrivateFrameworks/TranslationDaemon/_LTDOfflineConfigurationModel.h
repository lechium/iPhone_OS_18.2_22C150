...
+ (_Bool)isPassthroughLocalePairIdentifier:(id)arg1;	// IMP=0x00600000000277fb
+ (id)passthroughConfiguration;	// IMP=0x006000000002771d
...
- (id)debugDescription;	// IMP=0x0000000000028153
- (id)description;	// IMP=0x0000000000028141
- (id)_offlinePairConfigurationWithIdentifier:(id)arg1 capability:(long long)arg2;	// IMP=0x0000000000027cb5
- (id)offlinePairConfigurationWithIdentifier:(id)arg1;	// IMP=0x0000000000027c3d
@property(readonly, nonatomic) NSArray *languageIdentifiers;
@property(readonly, nonatomic) NSArray *languagePairs;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000273e6
