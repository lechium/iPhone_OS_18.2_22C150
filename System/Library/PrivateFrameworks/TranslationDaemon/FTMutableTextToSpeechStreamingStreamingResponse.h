...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000019a336
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000019a25c
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000019a222
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000199bf7
- (id)init;	// IMP=0x0000000000199b69
