...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a7130
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a702e
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a6ff4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a68ca
- (id)init;	// IMP=0x00000000000a683c
