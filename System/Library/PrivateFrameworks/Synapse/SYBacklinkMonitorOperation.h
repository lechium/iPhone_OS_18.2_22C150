...
- (void).cxx_destruct;	// IMP=0x00000000000169c4
...
- (void)_finishProcessingAndNotify;	// IMP=0x00000000000166bd
- (void)_showOrHideBacklinkIndicatorForDomainIdentifiers:(id)arg1 linkedIdentifiers:(id)arg2;	// IMP=0x0000000000016407
- (void)_searchBacklinksForInputUserActivity;	// IMP=0x0000000000015fae
- (void)beginProcessing;	// IMP=0x0000000000015ee1
@property(readonly, nonatomic) long long type;
- (id)description;	// IMP=0x0000000000015dbf
- (id)initWithDelegate:(id)arg1 processingQueue:(id)arg2 inputUserActivityInfo:(id)arg3 processIdentifier:(int)arg4;	// IMP=0x0000000000015cdf
