...
+ (Class)incomingMessageClass;	// IMP=0x00100000000a620b
+ (unsigned long long)command;	// IMP=0x00100000000a61df
- (void).cxx_destruct;	// IMP=0x00000000000a6147
...
- (void)execute;	// IMP=0x00000000000a59d5
- (_Bool)preflightClientAllowed;	// IMP=0x00000000000a58d5
- (void)dealloc;	// IMP=0x00000000000a5851
- (void)_commonInit:(id)arg1;	// IMP=0x00000000000a5309
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x00000000000a5166
