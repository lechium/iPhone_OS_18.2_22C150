...
- (void).cxx_destruct;	// IMP=0x000000000001415e
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0000000000013db9
- (id)initWithURL:(id)arg1 error:(unsigned long long *)arg2;	// IMP=0x0000000000013d4b
