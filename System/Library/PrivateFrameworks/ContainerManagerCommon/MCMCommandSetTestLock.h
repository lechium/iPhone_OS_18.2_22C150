...
+ (Class)incomingMessageClass;	// IMP=0x0010000000086714
+ (unsigned long long)command;	// IMP=0x00100000000866e8
- (void).cxx_destruct;	// IMP=0x00000000000866b4
...
- (void)execute;	// IMP=0x0000000000086122
- (_Bool)preflightClientAllowed;	// IMP=0x000000000008608e
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000085f9d
