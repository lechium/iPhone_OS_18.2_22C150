...
+ (Class)incomingMessageClass;	// IMP=0x0010000000070272
+ (unsigned long long)command;	// IMP=0x0010000000070246
...
- (void)execute;	// IMP=0x000000000006fad3
- (_Bool)preflightClientAllowed;	// IMP=0x000000000006fa3f
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000006f920
