...
+ (Class)incomingMessageClass;	// IMP=0x0010000000052cbd
+ (unsigned long long)command;	// IMP=0x0010000000052c91
- (void).cxx_destruct;	// IMP=0x0000000000052c2c
...
- (void)execute;	// IMP=0x00000000000518ce
- (_Bool)preflightClientAllowed;	// IMP=0x000000000005183a
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000051724
