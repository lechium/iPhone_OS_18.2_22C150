...
+ (Class)incomingMessageClass;	// IMP=0x001000000009570d
+ (unsigned long long)command;	// IMP=0x00100000000956e1
- (void).cxx_destruct;	// IMP=0x000000000009568d
...
- (void)execute;	// IMP=0x00000000000949e5
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000094951
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000009481d
