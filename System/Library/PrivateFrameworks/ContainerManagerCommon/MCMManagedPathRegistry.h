...
- (void).cxx_destruct;	// IMP=0x000000000003db8b
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x000000000003d4e8
- (void)_addPaths:(id)arg1;	// IMP=0x000000000003d48f
- (id)managedPathForURL:(id)arg1;	// IMP=0x000000000003d2b9
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x000000000003cf1f
- (id)initWithDaemonUser:(id)arg1 privileged:(_Bool)arg2;	// IMP=0x000000000003cdbe
