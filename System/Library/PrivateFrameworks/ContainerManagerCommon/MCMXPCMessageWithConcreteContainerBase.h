...
- (void).cxx_destruct;	// IMP=0x0000000000084cfb
...
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000084a2c
- (id)initWithConcreteContainer:(id)arg1 context:(id)arg2;	// IMP=0x0000000000084991
