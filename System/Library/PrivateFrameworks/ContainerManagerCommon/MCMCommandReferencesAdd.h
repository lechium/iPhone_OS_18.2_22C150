...
+ (Class)incomingMessageClass;	// IMP=0x001000000000d92f
+ (unsigned long long)command;	// IMP=0x001000000000d903
- (void).cxx_destruct;	// IMP=0x000000000000d6bb
...
- (id)_resolveUserIdentity;	// IMP=0x000000000000d349
- (void)execute;	// IMP=0x000000000000c846
- (_Bool)preflightClientAllowed;	// IMP=0x000000000000c7b2
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000000c66c
