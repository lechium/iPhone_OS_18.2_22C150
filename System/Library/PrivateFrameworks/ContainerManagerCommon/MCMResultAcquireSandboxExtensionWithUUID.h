...
- (void).cxx_destruct;	// IMP=0x000000000007cdf0
...
- (void)dealloc;	// IMP=0x000000000007ccb8
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000007cb68
- (id)initWithSandboxToken:(const char *)arg1 personaUniqueString:(id)arg2 url:(id)arg3;	// IMP=0x000000000007ca6b
