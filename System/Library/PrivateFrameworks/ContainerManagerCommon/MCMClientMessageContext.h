...
- (void).cxx_destruct;	// IMP=0x000000000009ef2a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009ed63
- (id)initForCurrentThreadContextWithXPCMessage:(id)arg1 userIdentityCache:(id)arg2;	// IMP=0x000000000009ec75
