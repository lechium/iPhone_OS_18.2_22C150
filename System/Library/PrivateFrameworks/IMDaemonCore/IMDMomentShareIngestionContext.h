...
- (void)completeTransferForAssetUUID:(id)arg1;	// IMP=0x0000000000004af5
- (void)clearAllTransfers;	// IMP=0x0000000000004adf
- (void)addTransfers:(id)arg1;	// IMP=0x0000000000004ac9
@property(readonly, nonatomic) NSDictionary *assetUUIDsToFileTransfers;
- (id)initWithURL:(id)arg1 message:(id)arg2 inChat:(id)arg3;	// IMP=0x00000000000049e9
