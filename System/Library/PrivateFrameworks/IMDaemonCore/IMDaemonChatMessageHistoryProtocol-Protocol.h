...
@class NSArray, NSData, NSDate, NSDateInterval, NSDictionary, NSString;
...
- (void)fetchIncomingPendingMessagesOverSatelliteForChatsWithIDs:(NSArray *)arg1 services:(NSArray *)arg2;
...
- (void)markChatAsSpamWithGUID:(NSString *)arg1 chatIdentifiers:(NSArray *)arg2 style:(unsigned char)arg3 services:(NSArray *)arg4 isAutoReport:(_Bool)arg5 isJunkReportedToCarrier:(_Bool)arg6 reportReason:(unsigned long long)arg7 reply:(void (^)(unsigned long long))arg8;
...
- (void)fetchOldestMessageDateForChatIdentifiers:(NSArray *)arg1 chatStyle:(unsigned char)arg2 services:(NSArray *)arg3 reply:(void (^)(NSDate *))arg4;
- (void)fetchMessageHistorySummaryForDateInterval:(NSDateInterval *)arg1 chatIdentifiers:(NSArray *)arg2 chatStyle:(unsigned char)arg3 services:(NSArray *)arg4 reply:(void (^)(IMMessageHistoryDateRangeSummary *))arg5;
...
- (void)loadItemWithGUID:(NSString *)arg1 queryID:(NSString *)arg2;
