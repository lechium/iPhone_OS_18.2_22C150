...
@class BSMachPortSendRight, NSDate, NSError, NSNumber, NSString, NSURL, SBSDebugActiveWidgetInfo, SBSHomeScreenIconStyleConfiguration, SBSHomeScreenServiceArrayOfNumbers, SBSHomeScreenServiceArrayOfStrings, SBSHomeScreenServiceNumberOrString, SBSHomeScreenSilhouetteLayout;
...
- (_Bool)canSwapApplicationIconsInProminentPositionsWithBundleIdentifier:(NSString *)arg1 withApplicationIconsWithWithBundleIdentifier:(NSString *)arg2;
- (void)swapApplicationIconsInProminentPositionsWithBundleIdentifier:(NSString *)arg1 withApplicationIconsWithWithBundleIdentifier:(NSString *)arg2;
- (oneway void)setObservingIconTintColor:(NSNumber *)arg1;
