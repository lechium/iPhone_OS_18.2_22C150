...
+ (void)setTypologyRecordsLimit:(unsigned long long)arg1;	// IMP=0x006000000001c038
+ (void)resetTypologyRecords;	// IMP=0x006000000001bf9e
+ (void)writeTypologyRecords;	// IMP=0x006000000001bd2b
+ (id)currentTypologyRecord;	// IMP=0x006000000001b63b
+ (id)openTypologyRecordWithString:(id)arg1 range:(struct _NSRange)arg2 languageObject:(id)arg3 languages:(id)arg4 topLanguages:(id)arg5 autocorrect:(_Bool)arg6 initialCapitalize:(_Bool)arg7 autocapitalize:(_Bool)arg8 keyEventArray:(id)arg9 appIdentifier:(id)arg10 selectedRangeValue:(id)arg11;	// IMP=0x006000000001b3a9
- (void)closeTypologyRecordWithResults:(id)arg1;	// IMP=0x000000000001c0d9
- (id)dictionaryRepresentation;	// IMP=0x000000000001b7e1
- (void)addCandidate:(id)arg1;	// IMP=0x000000000001b7c0
- (void)addCorrection:(id)arg1;	// IMP=0x000000000001b79f
- (void)dealloc;	// IMP=0x000000000001b327
- (id)initWithString:(id)arg1 offset:(unsigned long long)arg2 range:(struct _NSRange)arg3 languageObject:(id)arg4 languages:(id)arg5 topLanguages:(id)arg6 autocorrect:(_Bool)arg7 initialCapitalize:(_Bool)arg8 autocapitalize:(_Bool)arg9 keyEventArray:(id)arg10 appIdentifier:(id)arg11 selectedRangeValue:(id)arg12;	// IMP=0x000000000001b1fc
