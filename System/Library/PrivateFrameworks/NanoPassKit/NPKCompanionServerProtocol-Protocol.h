...
- (void)updateCredentials:(NSSet *)arg1 forUniqueID:(NSString *)arg2 completion:(void (^)(NSError *))arg3;
...
- (void)presentStandaloneTransaction:(long long)arg1 forPassUniqueIdentifier:(NSString *)arg2 terminalReaderIdentifier:(NSString *)arg3 completion:(void (^)(_Bool))arg4;
