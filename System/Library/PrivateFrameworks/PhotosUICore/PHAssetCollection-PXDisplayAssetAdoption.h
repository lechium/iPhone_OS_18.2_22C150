...
+ (id)px_fetchAssetCollectionsWithAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x001000000135dd63
+ (id)px_fetchSmartAlbumCollectionsBySubtypeForAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x001000000135d983
+ (id)px_fetchContainingCollectionsForAsset:(id)arg1 excludedAssetCollection:(id)arg2;	// IMP=0x001000000135d87a
+ (id)px_fetchSmartAlbumWithSubtype:(long long)arg1;	// IMP=0x001000000135d742
+ (id)px_smartAlbumWithSubtype:(long long)arg1;	// IMP=0x001000000135d6f2
+ (id)px_regularAlbumWithTitle:(id)arg1;	// IMP=0x001000000135d5ef
+ (id)px_otherAlbumsSubtypes;	// IMP=0x001000000135d58c
+ (id)px_mediaTypeSmartAlbumSubtypes;	// IMP=0x001000000135d529
+ (void)px_getType:(long long *)arg1 subtype:(long long *)arg2 forBuiltInAlbumName:(id)arg3;	// IMP=0x001000000135d178
+ (id)px_builtInAlbumNameForSubtype:(long long)arg1;	// IMP=0x001000000135cf91
+ (id)px_albumNameForTransientIdentifier:(id)arg1;	// IMP=0x001000000135cf25
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x001000000111bf80
...
- (id)px_fetchAncestorThatSupportsExplictlyRemovingAssets;	// IMP=0x001000000135b4a4
- (id)px_fetchAncestorThatSupportsCustomKeyAssets;	// IMP=0x001000000135b39f
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x001000000135b31c
...
- (id)px_debugDictionary;	// IMP=0x001000000135a9aa
- (id)px_navigationURLComponents;	// IMP=0x001000000135a87d
- (id)px_navigationWellKnownName;	// IMP=0x001000000135a848
- (id)px_navigationURLHost;	// IMP=0x001000000135a83b
- (unsigned long long)px_assetsDropMode;	// IMP=0x001000000135a751
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x001000000135a60c
