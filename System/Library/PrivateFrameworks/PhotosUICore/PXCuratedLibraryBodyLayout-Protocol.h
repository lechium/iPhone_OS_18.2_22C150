...
- (void (^)(void (^)(id <PXDisplayAsset>)))assetsIteratorForContentInRect:(struct CGRect)arg1;
- (void (^)(void (^)(id <PXDisplayAssetCollection>)))assetCollectionsIteratorForContentInRect:(struct CGRect)arg1;
