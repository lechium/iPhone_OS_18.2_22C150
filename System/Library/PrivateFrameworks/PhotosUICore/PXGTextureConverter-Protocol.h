...
- (PXGImageTexture *)createTextureFromCGImage:(struct CGImage *)arg1 transform:(float)arg2 alpha:(CDStruct_0dd72924)arg3 options:(id *)arg4 error: /* Error: Ran out of types for this method. */;
@end
