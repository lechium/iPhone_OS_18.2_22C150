...
- (void).cxx_destruct;	// IMP=0x0000000000410980
- (id)init;	// IMP=0x0000000000410920
- (void)updateCurrentPlacement;	// IMP=0x00000000004108f0
- (void)updateSwipeDownTracker;	// IMP=0x000000000040fd70
- (void)updateInitialPlacement;	// IMP=0x000000000040e9c0
- (void)setNeedsUpdate;	// IMP=0x000000000040e990
