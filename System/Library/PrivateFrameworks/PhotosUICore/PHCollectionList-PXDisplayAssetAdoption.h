...
+ (id)px_otherAlbumsCollectionListIncludeDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3;	// IMP=0x001000000135cc83
+ (id)_otherAlbumAssetCollectionsIncludingRecentlyDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3 includingSharedLibrary:(_Bool)arg4 includingDebugAlbums:(_Bool)arg5;	// IMP=0x001000000135bab7
+ (id)_isValidGazeRectPredicate;	// IMP=0x001000000135b9ae
+ (id)_otherAlbumsCollectionListWithDeletedCollection:(_Bool)arg1 withHiddenCollection:(_Bool)arg2 withDuplicatesCollection:(_Bool)arg3;	// IMP=0x001000000135b8e6
+ (id)px_transientIdentifierForWellKnownFolderName:(id)arg1;	// IMP=0x001000000135b87a
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x001000000135a2e3
- (_Bool)px_isContainedInCollectionList:(id)arg1;	// IMP=0x001000000135a1ba
...
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x0010000001359df1
- (id)px_navigationWellKnownName;	// IMP=0x0010000001359d7b
- (id)px_navigationURLHost;	// IMP=0x0010000001359d6e
