...
- (void).cxx_destruct;	// IMP=0x00000000000305c5
...
- (id)shortDescription;	// IMP=0x00000000000302af
- (_Bool)isExpiredAtTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000030239
- (float)similarityToPersonBlob:(id)arg1;	// IMP=0x000000000002fa39
- (void)trackPersonBlob:(id)arg1;	// IMP=0x000000000002f9ea
- (id)initWithNewPersonEvent:(id)arg1 timeStamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x000000000002f7b5
