...
- (void).cxx_destruct;	// IMP=0x0000000000062435
...
- (id)specifiers;	// IMP=0x0000000000061f5f
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000061f09
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x0000000000061e77
