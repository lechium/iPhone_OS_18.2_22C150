...
- (void).cxx_destruct;	// IMP=0x0000000000027146
...
- (id)specifiers;	// IMP=0x0000000000026d27
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000026cd1
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x0000000000026c3f
