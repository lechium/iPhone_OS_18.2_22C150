...
- (void).cxx_destruct;	// IMP=0x00000000000776ac
...
- (id)getLogger;	// IMP=0x00000000000775cb
- (void)launchMyAccountInSafari:(id)arg1;	// IMP=0x0000000000077497
- (void)launchMyAccountInWebView:(id)arg1;	// IMP=0x000000000007730d
- (id)initWithContext:(id)arg1 cbCache:(id)arg2;	// IMP=0x0000000000077114
