...
- (void).cxx_destruct;	// IMP=0x000000000002767c
...
- (id)specifiers;	// IMP=0x000000000002725d
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2;	// IMP=0x0000000000027207
- (id)initWithListController:(id)arg1 groupSpecifier:(id)arg2 parentSpecifier:(id)arg3;	// IMP=0x0000000000027175
