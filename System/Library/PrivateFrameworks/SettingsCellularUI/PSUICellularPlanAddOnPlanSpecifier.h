...
- (void).cxx_destruct;	// IMP=0x000000000008773e
@property(readonly, nonatomic) UIButton *addButton; // @synthesize addButton=_addButton;
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000086c68
- (id)initWithTarget:(id)arg1 action:(SEL)arg2 displayPlan:(id)arg3;	// IMP=0x0000000000086ab4
