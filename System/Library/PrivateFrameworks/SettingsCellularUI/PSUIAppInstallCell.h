...
+ (id)specifierForAppWithDescription:(id)arg1 target:(id)arg2 action:(SEL)arg3;	// IMP=0x00600000000454dd
- (void).cxx_destruct;	// IMP=0x0000000000047172
...
- (id)getLogger;	// IMP=0x0000000000046f61
- (void)_updateCellWithInstallState;	// IMP=0x0000000000046d7b
- (void)layoutSubviews;	// IMP=0x0000000000046bba
- (void)updateConstraints;	// IMP=0x0000000000046a0b
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x0000000000045820
