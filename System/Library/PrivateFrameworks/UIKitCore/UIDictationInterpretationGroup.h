...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000f8917a
- (void).cxx_destruct;	// IMP=0x0000000000f894f1
...
- (id)description;	// IMP=0x0000000000f8941e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000f89343
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f89230
- (id)initWithInterpretations:(id)arg1 isLowConfidence:(_Bool)arg2;	// IMP=0x0000000000f8920c
- (id)initWithInterpretations:(id)arg1;	// IMP=0x0000000000f89182
