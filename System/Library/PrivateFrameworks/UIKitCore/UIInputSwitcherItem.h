...
+ (id)switcherItemWithIdentifier:(id)arg1;	// IMP=0x0060000000e013ac
- (void).cxx_destruct;	// IMP=0x0000000000e01697
...
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000e0145b
- (void)dealloc;	// IMP=0x0000000000e013f5
