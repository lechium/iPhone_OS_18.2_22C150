...
- (void).cxx_destruct;	// IMP=0x0000000000c897c9
...
- (unsigned long long)_targetEdges;	// IMP=0x0000000000c89650
- (void)_idleTimerElapsed:(id)arg1;	// IMP=0x0000000000c89507
- (void)_longPressTimerElapsed:(id)arg1;	// IMP=0x0000000000c8940d
- (void)_incorporateIncrementalSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000c88692
- (void)_incorporateInitialTouchAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000c87ea9
- (void)incorporateTouchSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000c87e19
- (unsigned long long)touchedEdgesForInterfaceOrientation:(long long)arg1;	// IMP=0x0000000000c87d89
- (long long)_type;	// IMP=0x0000000000c87d7c
- (void)_setState:(long long)arg1;	// IMP=0x0000000000c87b88
@property(readonly, nonatomic) _Bool useGrapeFlags;
- (void)reset;	// IMP=0x0000000000c87af3
- (void)dealloc;	// IMP=0x0000000000c87ab7
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000c87a58
- (id)initWithType:(long long)arg1 settings:(id)arg2;	// IMP=0x0000000000c87869
