...
- (void).cxx_destruct;	// IMP=0x00000000017dc72c
...
- (void)setupToInsertResultForNewHypothesis:(id)arg1;	// IMP=0x00000000017dc5dc
- (void)_displayLinkFired:(id)arg1;	// IMP=0x00000000017dbd11
- (void)_startStreamingAnimations;	// IMP=0x00000000017dbbf9
- (void)_stopStreamingAnimation;	// IMP=0x00000000017dbb83
- (void)setWords:(id)arg1;	// IMP=0x00000000017dbaa9
- (void)commitFinalResults;	// IMP=0x00000000017dba59
- (id)initWithTextView:(id)arg1;	// IMP=0x00000000017db9e8
