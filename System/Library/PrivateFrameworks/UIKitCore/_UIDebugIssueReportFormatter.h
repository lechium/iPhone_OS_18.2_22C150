...
- (void).cxx_destruct;	// IMP=0x0000000000acf650
...
- (id)stringFromReport:(id)arg1;	// IMP=0x0000000000acf57a
- (id)_componentsFromReport:(id)arg1;	// IMP=0x0000000000acf04d
- (id)init;	// IMP=0x0000000000acef8b
