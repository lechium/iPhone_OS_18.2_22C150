...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000018daef0
- (void).cxx_destruct;	// IMP=0x00000000018daf6d
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000018dac87
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000018daadb
