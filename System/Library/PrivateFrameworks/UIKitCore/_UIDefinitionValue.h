...
- (void).cxx_destruct;	// IMP=0x0000000000837adc
...
- (id)description;	// IMP=0x00000000008379f1
- (id)initWithLocalizedDictionaryName:(id)arg1 term:(id)arg2 definition:(id)arg3 longDefinition:(id)arg4;	// IMP=0x00000000008378e0
