...
- (void).cxx_destruct;	// IMP=0x00000000010310d7
@property(nonatomic) struct CGRect sectionFrame; // @synthesize sectionFrame=_sectionFrame;
@property(nonatomic) long long section; // @synthesize section=_section;
@property(nonatomic) __weak UICollectionView *collectionView; // @synthesize collectionView=_collectionView;
- (id)_fallbackFocusItemForMovementRequest:(id)arg1 inFocusMap:(id)arg2 withSnapshot:(id)arg3;	// IMP=0x000000000103073f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000010305b1
- (id)_focusRegionWithAdjustedFrame:(struct CGRect)arg1 coordinateSpace:(id)arg2;	// IMP=0x00000000010304c7
