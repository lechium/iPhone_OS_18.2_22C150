...
- (void).cxx_destruct;	// IMP=0x00000000011447cd
...
- (id)meshTransformForKeyplane:(id)arg1 forward:(_Bool)arg2 initial:(_Bool)arg3;	// IMP=0x00000000011418b8
- (struct CGRect)keyRectForFrame:(struct CGRect)arg1 normalizedSubRect:(struct CGRect)arg2;	// IMP=0x000000000114188e
- (void)gatherTransitionKeys;	// IMP=0x0000000001141321
- (void)updateWithProgress:(double)arg1;	// IMP=0x00000000011412a6
- (void)removeAllAnimations;	// IMP=0x000000000114113a
- (void)_runOpacityAnimation;	// IMP=0x0000000001141008
- (void)_runTransformAnimation;	// IMP=0x0000000001140dab
- (void)runNonInteractivelyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000001140d70
- (double)nonInteractiveDuration;	// IMP=0x0000000001140d62
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000001140c91
- (void)commitTransitionRebuild;	// IMP=0x0000000001140c39
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000001140830
