...
- (void).cxx_destruct;	// IMP=0x0000000001778b2b
...
- (void)animationCompleted;	// IMP=0x00000000017789ef
- (void)animationStarted;	// IMP=0x00000000017789b6
- (id)positionedPasteResult;	// IMP=0x00000000017788c4
