...
+ (id)sliceSetWithDictionaryRepresenation:(id)arg1;	// IMP=0x0060000001147860
- (void).cxx_destruct;	// IMP=0x0000000001147f94
...
- (id)description;	// IMP=0x0000000001147cc4
- (void)addSlice:(id)arg1;	// IMP=0x0000000001147cae
- (id)initWithSliceID:(id)arg1;	// IMP=0x00000000011476b9
