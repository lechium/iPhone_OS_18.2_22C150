...
- (void).cxx_destruct;	// IMP=0x000000000076c850
...
- (_Bool)currentSateCanTransitionWithEvents:(id)arg1;	// IMP=0x000000000076c712
@property(readonly, nonatomic) unsigned long long *currentStateRef;
- (void)_updateFromState:(unsigned long long)arg1;	// IMP=0x000000000076c6e2
- (id)initWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000076c5f2
