...
+ (void)setAnimationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0060000001a4bf8e
+ (id)animationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0060000001a4beae
- (void).cxx_destruct;	// IMP=0x0000000001a4c504
...
- (_Bool)_allowsHitTesting;	// IMP=0x0000000001a4c4b9
- (_Bool)_allowsUserInteractionToCutOffEndOfAnimation;	// IMP=0x0000000001a4c4b0
- (void)_sendDeferredCompletion:(id)arg1;	// IMP=0x0000000001a4c43b
- (void)_didEndBlockAnimation:(id)arg1 finished:(id)arg2 context:(void *)arg3;	// IMP=0x0000000001a4c0de
- (void)_willBeginBlockAnimation:(id)arg1 context:(id)arg2;	// IMP=0x0000000001a4c0b6
