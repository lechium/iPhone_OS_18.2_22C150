...
- (void).cxx_destruct;	// IMP=0x00000000018f3d4b
...
- (void)setPrimaryInternalIdentifier:(id)arg1 secondaryIdentifiers:(id)arg2;	// IMP=0x00000000018f3b2c
- (_Bool)isPresentable;	// IMP=0x00000000018f3aa8
