...
+ (id)styleOverride;	// IMP=0x00600000002d5f10
- (void).cxx_destruct;	// IMP=0x00000000002d64cc
...
- (id)actionTitleLabelFontForViewState:(id)arg1;	// IMP=0x00000000002d6390
- (id)newActionSeparatorViewForGroupViewState:(id)arg1;	// IMP=0x00000000002d62bd
- (id)newActionBackgroundViewForViewState:(id)arg1;	// IMP=0x00000000002d615d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002d600b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002d5f59
