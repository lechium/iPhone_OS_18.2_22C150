...
- (void).cxx_destruct;	// IMP=0x000000000124171f
...
- (void)dealloc;	// IMP=0x00000000012415fc
- (void)finalizeEffect;	// IMP=0x00000000012415e3
- (void)applyBackgroundEffectWithMagnitude:(double)arg1 interactive:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000001241566
