...
- (void).cxx_destruct;	// IMP=0x0000000001997d32
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000001997d15
- (void)update;	// IMP=0x0000000001997cf8
...
- (id)initWithContents:(id)arg1 delegatingToView:(id)arg2;	// IMP=0x0000000001997b4d
