...
- (void).cxx_destruct;	// IMP=0x00000000019e261d
...
- (void)setPoint:(struct CGPoint)arg1 forContentOffset:(struct CGPoint)arg2;	// IMP=0x00000000019e24f2
- (void)_adjustPointToCurrentContentOffset;	// IMP=0x00000000019e2465
- (void)_handleAutoScrollerWithContentOffset:(struct CGPoint)arg1 direction:(unsigned long long)arg2;	// IMP=0x00000000019e23ef
- (void)displayLinkFired:(id)arg1;	// IMP=0x00000000019e21ee
- (_Bool)_scrollContinuous;	// IMP=0x00000000019e2180
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (void)stop;	// IMP=0x00000000019e20d7
- (void)autoScrollFromPoint:(struct CGPoint)arg1;	// IMP=0x00000000019e1e5b
- (id)initWithScrollView:(id)arg1;	// IMP=0x00000000019e1d13
