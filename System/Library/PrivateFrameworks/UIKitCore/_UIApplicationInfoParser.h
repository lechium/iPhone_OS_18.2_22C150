...
@interface _UIApplicationInfoParser : NSObject
{
    ...
    _Bool _observationTrackingEnabled;	// 27 = 0x1b
    _Bool _supportsPrintCommand;	// 28 = 0x1c
    _Bool _supportsAlwaysOnDisplay;	// 29 = 0x1d
    _Bool _supportsBacklightEnvironment;	// 30 = 0x1e
...
+ (id)mainBundleInfoParser;	// IMP=0x0060000000ba0e79
- (void).cxx_destruct;	// IMP=0x0000000000ba27cb
...
- (_Bool)_isLinkedOnOrAfterYukon;	// IMP=0x0000000000ba2636
- (void)_computeSupportedUserInterfaceStyleFromInfo:(id)arg1;	// IMP=0x0000000000ba256b
- (void)_computeSupportedInterfaceOrientationsWithInfo:(id)arg1;	// IMP=0x0000000000ba2199
- (id)_initWithApplicationPlistData:(id)arg1;	// IMP=0x0000000000ba121e
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x0000000000ba0f74
- (id)_initWithBundle:(id)arg1;	// IMP=0x0000000000ba0f1e
