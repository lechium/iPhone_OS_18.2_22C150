...
+ (id)settingsControllerModule;	// IMP=0x0060000000c875a6
+ (id)keyPathsForValuesAffectingCornerAngleWindowDegreees;	// IMP=0x0060000000c87586
...
- (void)setDefaultValues;	// IMP=0x0000000000c874e3
