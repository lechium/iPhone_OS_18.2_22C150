...
+ (id)stateWithRegionContainer:(id)arg1 focusSystem:(id)arg2 clippingRect:(struct CGRect)arg3;	// IMP=0x0060000000b0a693
- (void).cxx_destruct;	// IMP=0x0000000000b0a746
...
- (id)initWithRegionContainer:(id)arg1 focusSystem:(id)arg2 clippingRect:(struct CGRect)arg3;	// IMP=0x0000000000b0a5e5
