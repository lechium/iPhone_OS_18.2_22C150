...
- (void).cxx_destruct;	// IMP=0x000000000043f5cb
...
- (void)_handlePopSwipe:(id)arg1;	// IMP=0x000000000043f478
- (_Bool)_gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000043f3ca
- (id)initWithNavigationBar:(id)arg1;	// IMP=0x000000000043f308
