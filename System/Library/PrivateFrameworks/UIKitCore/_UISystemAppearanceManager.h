...
- (void).cxx_destruct;	// IMP=0x000000000057ea65
...
- (void)_logOrientationPreferencesChangeWithOldSupportedOrientations:(unsigned long long)arg1 newSupportedOrientations:(unsigned long long)arg2 oldPreferredOrientation:(long long)arg3 newPreferredOrientation:(long long)arg4 animationSettings:(id)arg5 fenced:(_Bool)arg6;	// IMP=0x000000000057e548
- (void)window:(id)arg1 didUpdateSupportedOrientations:(unsigned long long)arg2 preferredOrientation:(long long)arg3 prefersAnimation:(_Bool)arg4;	// IMP=0x000000000057dd20
- (void)updateContainerBackgroundStyle;	// IMP=0x000000000057dd1a
- (void)updateMultitaskingDragExclusionRects;	// IMP=0x000000000057d8b2
- (void)updateWhitePointAdaptivityStyle;	// IMP=0x000000000057d78e
- (void)updateUserInterfaceStyle;	// IMP=0x000000000057d788
- (void)updateScreenEdgesDeferringSystemGestures;	// IMP=0x000000000057d5e9
- (void)updateHomeIndicatorAutoHidden;	// IMP=0x000000000057d4a6
- (void)_windowDrivingSystemAppearanceDidChange:(id)arg1;	// IMP=0x000000000057d48f
- (void)_handleWindowVisibilityNotification:(id)arg1;	// IMP=0x000000000057d1e2
- (id)_findWindowDrivingSystemAppearance;	// IMP=0x000000000057ce88
@property(nonatomic, getter=_scene, setter=_setScene:) __weak UIScene *_scene;
- (void)dealloc;	// IMP=0x000000000057cb8d
- (id)initWithScene:(id)arg1;	// IMP=0x000000000057c9eb
