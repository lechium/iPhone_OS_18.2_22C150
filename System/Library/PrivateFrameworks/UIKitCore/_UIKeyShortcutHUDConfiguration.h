...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000001555866
- (void).cxx_destruct;	// IMP=0x0000000001555aca
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000001555923
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000155586e
