...
- (void)finishFullRotateUsingOnePartAnimation:(_Bool)arg1;	// IMP=0x00000000007c2bcf
- (void)finishFirstHalfRotation;	// IMP=0x00000000007c273b
- (void)rotateSnapshots;	// IMP=0x00000000007c20ab
- (void)setupRotationOrderingKeyboardInAfterRotation:(_Bool)arg1;	// IMP=0x00000000007c143e
- (_Bool)_isFooterTranslucent;	// IMP=0x00000000007c13f9
- (_Bool)_isHeaderTranslucent;	// IMP=0x00000000007c137c
- (void)_positionHeaderView:(id)arg1 andFooterView:(id)arg2 outsideContentViewForInterfaceOrientation:(long long)arg3;	// IMP=0x00000000007c10c8
- (void)slideHeaderViewAndFooterViewOffScreen:(_Bool)arg1 forInterfaceOrientation:(long long)arg2;	// IMP=0x00000000007c10a8
- (void)_slideHeaderView:(id)arg1 andFooterView:(id)arg2 offScreen:(_Bool)arg3 forInterfaceOrientation:(long long)arg4;	// IMP=0x00000000007c0dc2
- (void)dealloc;	// IMP=0x00000000007c0d59
- (id)initWithClient:(id)arg1 toOrientation:(long long)arg2 duration:(double)arg3 andWindow:(id)arg4;	// IMP=0x00000000007c0b0c
