...
- (void).cxx_destruct;	// IMP=0x00000000003382fe
...
- (id)description;	// IMP=0x0000000000337e51
- (void)reloadFocusItemInfo;	// IMP=0x0000000000337d9c
@property(readonly, nonatomic) struct CGRect focusItemFrame; // @synthesize focusItemFrame=_focusItemFrame;
- (struct CGPoint)resolveTargetContentOffsetUsingScrollOffsetResolverClamped:(_Bool)arg1;	// IMP=0x0000000000337ab5
- (id)initWithEnvironmentScrollableContainer:(id)arg1 focusItemFrame:(struct CGRect)arg2 targetContentOffsetValue:(id)arg3;	// IMP=0x0000000000337a9b
- (id)initWithEnvironmentScrollableContainer:(id)arg1 focusItemInfo:(id)arg2 targetContentOffsetValue:(id)arg3;	// IMP=0x0000000000337a63
- (id)initWithEnvironmentScrollableContainer:(id)arg1 focusItemInfo:(id)arg2 focusUpdateContext:(id)arg3;	// IMP=0x00000000003379b3
- (id)initWithBaseRequest:(id)arg1 environmentScrollableContainer:(id)arg2;	// IMP=0x0000000000337792
- (id)initWithEnvironmentScrollableContainer:(id)arg1 focusItemInfo:(id)arg2 focusMovement:(id)arg3 focusItemFrame:(struct CGRect)arg4 targetContentOffsetValue:(id)arg5;	// IMP=0x00000000003370ca
