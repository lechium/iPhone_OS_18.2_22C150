...
- (void).cxx_destruct;	// IMP=0x000000000195fe17
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000000195fb5a
- (void)animationDidStart:(id)arg1;	// IMP=0x000000000195f831
- (id)initWithLabel:(id)arg1;	// IMP=0x000000000195f7cd
