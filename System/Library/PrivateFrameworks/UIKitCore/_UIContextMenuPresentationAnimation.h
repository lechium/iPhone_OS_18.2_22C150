...
- (void).cxx_destruct;	// IMP=0x00000000011f949c
...
- (_Bool)_hasVisibleBackground;	// IMP=0x00000000011f9227
- (void)_setBackgroundVisible:(_Bool)arg1;	// IMP=0x00000000011f8fd6
- (id)_secondarySourcePreviews;	// IMP=0x00000000011f8f5c
- (id)_accessoryViews;	// IMP=0x00000000011f8ee2
- (id)_menuView;	// IMP=0x00000000011f8e92
- (id)_platterView;	// IMP=0x00000000011f8e42
- (id)_backgroundView;	// IMP=0x00000000011f8df2
- (id)_platterTransitionView;	// IMP=0x00000000011f8da2
- (id)_containerView;	// IMP=0x00000000011f8d52
- (_Bool)_isDismissingToDrag;	// IMP=0x00000000011f8d38
- (_Bool)_shouldAnimateBackgroundEffects;	// IMP=0x00000000011f8cd4
- (void)_updateAccessoryAttachment:(id)arg1;	// IMP=0x00000000011f8648
- (void)_installAccessories;	// IMP=0x00000000011f82c2
- (void)_prepareReparentingAnimationWithDismissalTarget:(id)arg1;	// IMP=0x00000000011f7800
- (void)_presentation_applyBackgroundEffectWithProgress:(double)arg1;	// IMP=0x00000000011f746a
- (void)_prepareAnimatablePropertyBasedAnimations;	// IMP=0x00000000011f6f75
- (void)_prepareOverallAnimationCompletion;	// IMP=0x00000000011f6d8c
- (void)transitionDidEnd:(_Bool)arg1;	// IMP=0x00000000011f6cc3
- (id)_dismissalPreviewForSecondaryItemPreview:(id)arg1;	// IMP=0x00000000011f6c09
- (id)_targetedPreviewForDismissalAnimation;	// IMP=0x00000000011f6381
- (void)_performReduceMotionDisappearanceTransition;	// IMP=0x00000000011f615c
- (void)_performReduceMotionAppearanceTransition;	// IMP=0x00000000011f608a
- (void)performTransition;	// IMP=0x00000000011f5f14
- (void)_actuallyPerformTransition;	// IMP=0x00000000011f4cba
- (void)_anchorTransitionViewToTargetedPreview:(id)arg1;	// IMP=0x00000000011f49ad
- (CDStruct_d52ce5d2)_dismissedMenuLayoutForPresentedLayout:(CDStruct_d52ce5d2)arg1 previewLayout:(CDStruct_d52ce5d2)arg2 anchor:(CDStruct_17a0fc55)arg3;	// IMP=0x00000000011f467a
- (void)prepareTransitionToView:(id)arg1;	// IMP=0x00000000011f3541
- (id)initWithUIController:(id)arg1 asDismissal:(_Bool)arg2;	// IMP=0x00000000011f31d0
