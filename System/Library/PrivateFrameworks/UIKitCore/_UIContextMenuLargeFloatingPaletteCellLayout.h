...
- (void).cxx_destruct;	// IMP=0x00000000010b26fe
...
- (void)_configureSharedFloatingContentViewStyleForImageStyle:(_Bool)arg1;	// IMP=0x00000000010b21d5
- (void)setControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000010b20e3
- (void)removeConstraints;	// IMP=0x00000000010b2048
- (void)updateConstraints;	// IMP=0x00000000010b2042
- (void)installConstraints;	// IMP=0x00000000010b076e
...
- (id)preferredIconFontUsingBoldFont:(_Bool)arg1;	// IMP=0x00000000010b053a
- (_Bool)allowsHighlightingOnHover;	// IMP=0x00000000010b0532
...
- (id)initWithContentView:(id)arg1;	// IMP=0x00000000010b0407
