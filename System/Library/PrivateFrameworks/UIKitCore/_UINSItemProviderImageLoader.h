...
- (void).cxx_destruct;	// IMP=0x0000000000a06bf0
@property(retain, setter=_setProgress:) NSProgress *_progress; // @synthesize _progress=__progress;
- (_Bool)_really_cancel;	// IMP=0x0000000000a06b89
- (void)_really_loadImage:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a06a05
- (id)initWithItemProvider:(id)arg1 typeIdentifier:(id)arg2;	// IMP=0x0000000000a06921
