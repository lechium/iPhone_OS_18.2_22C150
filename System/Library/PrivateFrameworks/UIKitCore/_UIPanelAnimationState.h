...
+ (double)defaultDuration;	// IMP=0x006000000084f330
+ (id)timingCurveProviderWithVelocity:(double)arg1;	// IMP=0x006000000084f2f2
+ (id)timingCurveProvider;	// IMP=0x006000000084f2d9
- (void).cxx_destruct;	// IMP=0x000000000084f42d
...
- (id)description;	// IMP=0x000000000084f23f
