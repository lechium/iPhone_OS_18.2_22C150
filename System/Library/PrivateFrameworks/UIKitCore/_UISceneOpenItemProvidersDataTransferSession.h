...
- (void).cxx_destruct;	// IMP=0x00000000011082f4
...
- (void)dataTransferMonitorFinishedTransfers:(id)arg1;	// IMP=0x0000000001108215
- (void)dataTransferMonitorBeganTransfers:(id)arg1;	// IMP=0x00000000011081c9
- (void)didFinishSendingRequests;	// IMP=0x00000000011080f5
- (id)initWithItemProviders:(id)arg1 itemCollection:(id)arg2 continuation:(id)arg3;	// IMP=0x0000000001107ecc
