...
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3;	// IMP=0x0010000000bbc1ef
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2;	// IMP=0x0010000000bbc1da
- (void).cxx_destruct;	// IMP=0x0000000000bbe8e5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bbe5de
- (id)withTimeZone:(id)arg1;	// IMP=0x0000000000bbe532
- (id)withDisplaysTimeZone:(_Bool)arg1;	// IMP=0x0000000000bbe4eb
- (id)withForceDoubleDigitHours:(_Bool)arg1;	// IMP=0x0000000000bbe3e0
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3;	// IMP=0x0000000000bbe3cb
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3 ranges:(CDStruct_a33ff3ce *)arg4;	// IMP=0x0000000000bbd77e
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 followsSystemHourCycle:(_Bool)arg3 forceDoubleDigitHours:(_Bool)arg4 displaysTimeZone:(_Bool)arg5;	// IMP=0x0000000000bbc2a6
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 forceDoubleDigitHours:(_Bool)arg3 displaysTimeZone:(_Bool)arg4;	// IMP=0x0000000000bbc27e
