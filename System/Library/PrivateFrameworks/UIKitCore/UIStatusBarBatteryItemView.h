...
- (void).cxx_destruct;	// IMP=0x000000000140f7d6
...
- (id)accessibilityHUDRepresentation;	// IMP=0x000000000140f438
- (double)legibilityStrength;	// IMP=0x000000000140f42a
- (void)_updateAccessoryImage;	// IMP=0x000000000140f021
- (double)extraRightPadding;	// IMP=0x000000000140efa4
- (id)contentsImage;	// IMP=0x000000000140ef2c
- (id)_contentsImage;	// IMP=0x000000000140ea2e
- (id)_accessoryImage;	// IMP=0x000000000140e9d7
- (_Bool)_needsAccessoryImage;	// IMP=0x000000000140e9c3
- (struct CGSize)_batteryOffsetWithBackground:(id)arg1;	// IMP=0x000000000140e8d4
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x000000000140e837
