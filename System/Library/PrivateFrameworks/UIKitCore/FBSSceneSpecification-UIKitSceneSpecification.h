...
- (id)disconnectionHandlers;	// IMP=0x0030000000bdd84a
- (id)connectionHandlers;	// IMP=0x0030000000bdd83d
...
- (id)coreSceneComponentClassDictionary;	// IMP=0x0030000000bdd80f
- (id)_transitionContextHandlers;	// IMP=0x0030000000bdd802
