...
- (void)sendImageTo:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x0000000001456e43
- (void)sendImage;	// IMP=0x0000000001456d07
- (void)renderImage;	// IMP=0x0000000001456695
@property(readonly, retain) UIImage *image; // @dynamic image;
- (void)releaseOperation;	// IMP=0x0000000001456637
@property UIPDFPageRenderOperation *operation; // @dynamic operation;
- (void)setTarget:(id)arg1 callback:(SEL)arg2 userData:(id)arg3;	// IMP=0x000000000145647d
- (void)cancelOperationForTarget:(id)arg1;	// IMP=0x00000000014562f5
- (void)cancelOperation;	// IMP=0x000000000145618d
- (void)cancel;	// IMP=0x000000000145600b
- (void)dealloc;	// IMP=0x0000000001455fb3
- (id)initWithPage:(id)arg1 maxSize:(struct CGSize)arg2 queuePriority:(long long)arg3;	// IMP=0x0000000001455ed1
- (_Bool)hasPage;	// IMP=0x0000000001455ea4
