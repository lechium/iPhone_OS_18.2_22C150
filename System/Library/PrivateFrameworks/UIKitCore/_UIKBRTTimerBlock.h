...
- (void).cxx_destruct;	// IMP=0x0000000001109eeb
...
- (void)timerFired:(id)arg1;	// IMP=0x0000000001109bae
- (void)invalidate;	// IMP=0x0000000001109b0d
- (void)fireNow;	// IMP=0x0000000001109a1e
- (void)dealloc;	// IMP=0x00000000011099e0
- (id)initWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3 owner:(id)arg4;	// IMP=0x000000000110986d
