...
+ (id)sampleFromHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x00600000013d773b
- (void).cxx_destruct;	// IMP=0x00000000013d8176
...
- (id)description;	// IMP=0x00000000013d808d
- (id)hitTestWithEvent:(id)arg1;	// IMP=0x00000000013d7f8c
- (CDStruct_59622bbb)sampleFlags;	// IMP=0x00000000013d7eba
- (id)copyWithSampleFlags:(CDStruct_59622bbb)arg1;	// IMP=0x00000000013d7e1d
