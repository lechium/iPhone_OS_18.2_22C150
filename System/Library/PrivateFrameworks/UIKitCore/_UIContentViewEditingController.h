...
- (void).cxx_destruct;	// IMP=0x0000000000d5f9f7
...
- (_Bool)passthroughScrollInteractionDidRecognize:(id)arg1;	// IMP=0x0000000000d5f992
- (_Bool)passthroughScrollInteraction:(id)arg1 shouldInteractAtLocation:(struct CGPoint)arg2 withEvent:(id)arg3;	// IMP=0x0000000000d5f976
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x0000000000d5f800
- (_Bool)textFieldShouldEndEditing:(id)arg1;	// IMP=0x0000000000d5f6b6
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000d5f69e
- (void)textFieldDidBeginEditing:(id)arg1;	// IMP=0x0000000000d5f5c4
- (_Bool)textFieldShouldBeginEditing:(id)arg1;	// IMP=0x0000000000d5f57d
- (_Bool)textField:(id)arg1 shouldChangeCharactersInRange:(struct _NSRange)arg2 replacementString:(id)arg3;	// IMP=0x0000000000d5f3dc
@property(readonly, nonatomic, getter=isDisplayingEditedText) _Bool displayingEditedText;
- (_Bool)makeTextInputFirstResponderWithInitialLayoutBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d5f289
- (void)longPressRecognizerChanged:(id)arg1;	// IMP=0x0000000000d5f1d8
- (void)dealloc;	// IMP=0x0000000000d5f1a2
- (void)updateLabelConfiguration:(id)arg1 editingConfiguration:(id)arg2;	// IMP=0x0000000000d5ec52
@property(readonly, copy) NSString *description;
- (id)initWithContentView:(id)arg1 editableLabel:(id)arg2;	// IMP=0x0000000000d5ea43
