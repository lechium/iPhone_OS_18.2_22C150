...
- (void).cxx_destruct;	// IMP=0x0000000000e0a416
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000e0966b
- (void)layoutSubviews;	// IMP=0x0000000000e094de
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000e093e5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000e09117
