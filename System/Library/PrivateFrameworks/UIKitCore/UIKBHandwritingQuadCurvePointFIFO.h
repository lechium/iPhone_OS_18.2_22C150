...
- (void).cxx_destruct;	// IMP=0x0000000000e6f7b8
...
- (void)clear;	// IMP=0x0000000000e6f69f
- (void)flush;	// IMP=0x0000000000e6f3a5
- (void)addPoint:(struct)arg1;	// IMP=0x0000000000e6edd3
- (id)initWithFIFO:(id)arg1 scale:(double)arg2;	// IMP=0x0000000000e6ed3d
