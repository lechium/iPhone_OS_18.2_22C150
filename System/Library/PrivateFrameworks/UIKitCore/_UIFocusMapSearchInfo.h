...
- (void).cxx_destruct;	// IMP=0x0000000000b04441
...
- (void)addDestinationRegion:(id)arg1;	// IMP=0x0000000000b04330
- (void)addSnapshot:(id)arg1;	// IMP=0x0000000000b042a6
@property(readonly, copy, nonatomic) NSArray *destinationRegions;
@property(readonly, copy, nonatomic) NSArray *snapshots;
- (id)init;	// IMP=0x0000000000b0419d
