...
- (void).cxx_destruct;	// IMP=0x000000000109a61c
...
- (void)_updateBackgroundAndTitleColor;	// IMP=0x000000000109a3fe
- (id)_titleColorForState:(unsigned long long)arg1;	// IMP=0x000000000109a3ec
- (id)_currentTitleColor;	// IMP=0x000000000109a3a0
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000109a35f
