...
- (void).cxx_destruct;	// IMP=0x0000000000728f9f
...
- (void)addStartupHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000728f01
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000728ea9
- (void)startWithAnimator:(id)arg1;	// IMP=0x0000000000727e29
- (void)start;	// IMP=0x0000000000727e15
...
- (id)description;	// IMP=0x0000000000727d31
- (id)initWithView:(id)arg1 viewType:(long long)arg2 finalLayoutAttributes:(id)arg3 startFraction:(double)arg4 endFraction:(double)arg5 animateFromCurrentPostion:(_Bool)arg6 deleteAfterAnimation:(_Bool)arg7 customAnimations:(CDUnknownBlockType)arg8;	// IMP=0x0000000000727aab
