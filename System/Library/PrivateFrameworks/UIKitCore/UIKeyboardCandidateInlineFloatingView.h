...
- (void).cxx_destruct;	// IMP=0x0000000000dc54ac
...
- (id)traitCollection;	// IMP=0x0000000000dc51f8
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000dc4fcd
- (void)layoutSubviews;	// IMP=0x0000000000dc4e1f
- (void)setInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3 layout:(_Bool)arg4;	// IMP=0x0000000000dc461a
- (_Bool)shouldExtendUpwards;	// IMP=0x0000000000dc43d1
- (void)adjustFrameForInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3;	// IMP=0x0000000000dc38d3
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textWidth:(double)arg2;	// IMP=0x0000000000dc35f0
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textHeight:(double)arg2;	// IMP=0x0000000000dc316c
- (_Bool)isAcceptableFrame:(struct CGRect)arg1 afterScrollBy:(double)arg2;	// IMP=0x0000000000dc28a0
- (struct CGRect)adjustedInlineRectFromInlineText:(id)arg1 inlineRect:(struct CGRect)arg2;	// IMP=0x0000000000dc281f
- (void)dealloc;	// IMP=0x0000000000dc2766
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000dc269b
