...
- (void).cxx_destruct;	// IMP=0x00000000002ba662
...
- (void)_updateForShadowPath;	// IMP=0x00000000002ba3f1
- (id)initWithFrame:(struct CGRect)arg1 shadowPath:(id)arg2;	// IMP=0x00000000002ba280
