...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x0010000000dae2de
- (void).cxx_destruct;	// IMP=0x0000000000dae502
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000dae131
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000dae052
