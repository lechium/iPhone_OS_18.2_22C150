...
@class NSArray, NSCollectionLayoutSection, NSIndexSet, NSString, NSUUID, UITraitCollection, _UICollectionLayoutContainer, _UICollectionLayoutFramesQueryResult, _UICollectionLayoutSolveParameters, _UICollectionLayoutSolveResult, _UICollectionPreferredSizes;
...
- (void)solveForContainer:(_UICollectionLayoutContainer *)arg1 supplementaryContainer:(id <NSCollectionLayoutContainer>)arg2 traitCollection:(UITraitCollection *)arg3 layoutAxis:(unsigned long long)arg4 frameCount:(long long)arg5 preferredSizes:(_UICollectionPreferredSizes *)arg6 layoutRTL:(_Bool)arg7;
