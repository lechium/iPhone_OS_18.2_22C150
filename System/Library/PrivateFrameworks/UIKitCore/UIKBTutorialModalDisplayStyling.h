...
- (void).cxx_destruct;	// IMP=0x0000000000c0c9d1
...
- (id)backgroundBlurEffects:(long long)arg1;	// IMP=0x0000000000c0c8d0
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000c0c7d6
