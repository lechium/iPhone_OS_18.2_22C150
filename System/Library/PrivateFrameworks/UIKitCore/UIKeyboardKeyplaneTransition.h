...
- (void).cxx_destruct;	// IMP=0x000000000114571d
...
- (_Bool)canDisplayTransitionFromKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000001145671
- (void)finishWithProgress:(double)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000001145506
- (void)transitionToFinalState:(id)arg1;	// IMP=0x0000000001145474
- (void)finalizeTransition;	// IMP=0x0000000001145389
- (void)removeAllAnimations;	// IMP=0x0000000001145122
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000001144dd8
- (void)cancelNonInteractiveAnimation;	// IMP=0x0000000001144d82
- (void)runNonInteractivelyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000001144d70
@property(readonly, nonatomic) double nonInteractiveDuration;
- (void)commitTransitionRebuild;	// IMP=0x0000000001144d61
- (void)addTransitionView:(id)arg1 startFrame:(struct CGRect)arg2 endFrame:(struct CGRect)arg3;	// IMP=0x0000000001144a0d
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000001144908
@property(readonly, nonatomic) double endHeight;
@property(readonly, nonatomic) double startHeight;
- (void)dealloc;	// IMP=0x0000000001144831
