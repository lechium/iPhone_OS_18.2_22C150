...
+ (id)detailWithTitle:(id)arg1 detail:(id)arg2;	// IMP=0x0060000001855165
- (void).cxx_destruct;	// IMP=0x0000000001855251
...
- (void)_updateForInspectedView:(id)arg1;	// IMP=0x0000000001855201
