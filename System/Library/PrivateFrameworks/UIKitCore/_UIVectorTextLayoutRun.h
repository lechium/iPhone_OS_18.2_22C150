...
- (void).cxx_destruct;	// IMP=0x000000000198764e
...
- (void)_enumerateGlyphsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001987208
- (void)enumerateGlyphsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001986e68
- (void)renderInContext:(struct CGContext *)arg1;	// IMP=0x0000000001986c05
- (_Bool)shouldRender;	// IMP=0x0000000001986be1
- (id)font;	// IMP=0x0000000001986bd3
- (id)string;	// IMP=0x0000000001986aca
- (struct _NSRange)stringRange;	// IMP=0x0000000001986aa9
- (long long)glyphCount;	// IMP=0x0000000001986a9f
- (void)dealloc;	// IMP=0x0000000001986a60
- (id)initWithCTRun:(struct __CTRun *)arg1 lineIndex:(unsigned long long)arg2 layoutInfo:(id)arg3;	// IMP=0x00000000019869d0
