...
- (void)cancel;	// IMP=0x0000000001afecaf
- (void)main;	// IMP=0x0000000001afeb81
- (void)_search;	// IMP=0x0000000001afe457
- (id)sanitizedAttributedStringForAttributedString:(id)arg1;	// IMP=0x0000000001afe11e
- (struct __CTFont *)_fontWithPDFFont:(struct CGPDFFont *)arg1 size:(double)arg2;	// IMP=0x0000000001afddd8
- (void)_notifyDelegateOfStatus;	// IMP=0x0000000001afdc61
- (_Bool)_hitSearchLimit;	// IMP=0x0000000001afdc36
- (void)dealloc;	// IMP=0x0000000001afdbce
- (id)init;	// IMP=0x0000000001afdb49
