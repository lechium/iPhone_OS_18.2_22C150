...
- (void).cxx_destruct;	// IMP=0x00000000011a4f48
...
- (void)createDynamicColors;	// IMP=0x00000000011a4510
- (id)vibrancyEffectForBlur:(id)arg1;	// IMP=0x00000000011a44f2
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x00000000011a441e
