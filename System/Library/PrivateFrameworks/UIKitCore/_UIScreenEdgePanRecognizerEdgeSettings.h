...
+ (id)settingsControllerModule;	// IMP=0x0060000000c86947
+ (id)keyPathsForValuesAffectingEdgeAngleWindowDegreees;	// IMP=0x0060000000c86927
...
- (void)setDefaultValues;	// IMP=0x0000000000c86772
