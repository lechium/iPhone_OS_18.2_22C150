...
- (void).cxx_destruct;	// IMP=0x00000000019e4f18
...
- (void)_performAllCompletionBlocks;	// IMP=0x00000000019e4d98
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000019e4d0b
- (id)previewForContinuingToEffectWithPreview:(id)arg1;	// IMP=0x00000000019e4b21
- (void)setDescriptor:(id)arg1 andKey:(id)arg2;	// IMP=0x00000000019e4b10
- (id)_shadowBehavior;	// IMP=0x00000000019e4a8f
- (id)_settlingBehavior;	// IMP=0x00000000019e4a0e
- (id)_interactiveScaleBehavior;	// IMP=0x00000000019e498d
- (void)endExpanded:(_Bool)arg1 withVelocity:(double)arg2;	// IMP=0x00000000019e408d
- (void)advanceToScale:(double)arg1;	// IMP=0x00000000019e3d56
- (void)begin;	// IMP=0x00000000019e3a36
@property(readonly, nonatomic) UITargetedPreview *handOffPreview;
- (id)initWithDescriptor:(id)arg1;	// IMP=0x00000000019e3743
