...
- (void).cxx_destruct;	// IMP=0x0000000001986572
...
- (void)_layoutIfNeeded;	// IMP=0x000000000198573e
- (id)layoutDescription;	// IMP=0x0000000001984d17
- (id)description;	// IMP=0x0000000001984c03
- (void)enumerateRunsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001984b46
...
- (void)resetLayout;	// IMP=0x00000000019849e0
- (_Bool)hasLayout;	// IMP=0x00000000019849d2
@property(readonly, copy, nonatomic) _UIVectorTextLayoutParameters *parameters;
- (id)initWithTextParameters:(id)arg1;	// IMP=0x0000000001984900
