...
- (void).cxx_destruct;	// IMP=0x0000000000727a9b
...
- (double)speed;	// IMP=0x000000000072795d
- (void)addValue:(double)arg1;	// IMP=0x0000000000727898
- (id)init;	// IMP=0x0000000000727736
