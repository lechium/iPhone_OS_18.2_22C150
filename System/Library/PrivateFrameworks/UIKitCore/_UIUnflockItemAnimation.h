...
+ (id)animationWithPlatterView:(id)arg1 destination:(id)arg2 positionReferenceView:(id)arg3 type:(long long)arg4;	// IMP=0x00600000016e0ca9
- (void).cxx_destruct;	// IMP=0x00000000016e2066
...
- (void)complete;	// IMP=0x00000000016e1f2f
- (void)play;	// IMP=0x00000000016e0e4f
