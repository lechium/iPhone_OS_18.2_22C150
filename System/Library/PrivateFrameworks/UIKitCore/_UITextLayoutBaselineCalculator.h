...
- (void).cxx_destruct;	// IMP=0x0000000000acbe16
- (double)_convertOffset:(double)arg1;	// IMP=0x0000000000acbd34
...
- (double)_baselineOffsetAtPosition:(id)arg1;	// IMP=0x0000000000acb654
- (id)initWithTextLayoutController:(id)arg1 typingAttributes:(id)arg2 usesLineFragmentOrigin:(_Bool)arg3 coordinateSpace:(id)arg4 scale:(double)arg5 fallbackTextContainerOrigin:(struct CGPoint)arg6;	// IMP=0x0000000000acb562
