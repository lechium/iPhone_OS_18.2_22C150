...
- (void).cxx_destruct;	// IMP=0x0000000000ac5a68
...
- (void)_reportInferredPreferredFocusEnvironment:(id)arg1;	// IMP=0x0000000000ac588f
- (void)_stopLogging;	// IMP=0x0000000000ac5875
- (id)_startLogging;	// IMP=0x0000000000ac5583
- (void)popEnvironment;	// IMP=0x0000000000ac5468
- (void)pushEnvironment:(id)arg1;	// IMP=0x0000000000ac521b
- (_Bool)_isAllowedToPreferEnvironment:(id)arg1;	// IMP=0x0000000000ac4fc5
- (id)_inferPreferencesForEnvironment:(id)arg1;	// IMP=0x0000000000ac4e16
- (void)_resolvePreferredFocusEnvironments;	// IMP=0x0000000000ac49ca
- (void)_invalidatePreferredEnvironments;	// IMP=0x0000000000ac49a0
...
- (id)initWithFocusEnvironment:(id)arg1 enumerationMode:(long long)arg2;	// IMP=0x0000000000ac4329
- (id)init;	// IMP=0x0000000000ac42a2
