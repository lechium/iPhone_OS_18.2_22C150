...
+ (id)descriptorWithPreview:(id)arg1;	// IMP=0x00100000019e4f56
- (void).cxx_destruct;	// IMP=0x00000000019e510e
@property(readonly, nonatomic) UITargetedPreview *targetedPreview; // @synthesize targetedPreview=_targetedPreview;
- (_Bool)canTransitionInPlaceToEffectWithDescriptor:(id)arg1;	// IMP=0x00000000019e503a
