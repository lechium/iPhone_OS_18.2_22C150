...
- (void).cxx_destruct;	// IMP=0x00000000015e18e4
...
- (_Bool)deletePlaceholder;	// IMP=0x00000000015e174a
- (_Bool)commitInsertionWithDataSourceUpdates:(CDUnknownBlockType)arg1;	// IMP=0x00000000015e15e8
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000015e1434
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000015e1280
- (id)initWithDelegate:(id)arg1 dragItem:(id)arg2 reuseIdentifier:(id)arg3 rowHeight:(double)arg4 cellUpdateHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000015e118d
