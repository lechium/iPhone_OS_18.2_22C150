...
@interface _UIPointerSettings : PTSettings
{
    ...
    _Bool _showMenuPressDuration;	// 10 = 0xa
...
+ (id)settingsControllerModule;	// IMP=0x0060000001116634
- (void).cxx_destruct;	// IMP=0x0000000001116e77
...
- (void)setDefaultValues;	// IMP=0x00000000011165cb
