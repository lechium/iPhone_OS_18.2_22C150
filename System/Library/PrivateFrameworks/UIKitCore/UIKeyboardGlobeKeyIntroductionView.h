...
- (void).cxx_destruct;	// IMP=0x00000000004c2d26
...
- (void)continueButtonTapped;	// IMP=0x00000000004c2b52
- (long long)backdropStyleForRenderConfig:(id)arg1;	// IMP=0x00000000004c2b3d
- (void)layoutSubviews;	// IMP=0x00000000004c1c23
- (id)initWithFrame:(struct CGRect)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000004c1600
