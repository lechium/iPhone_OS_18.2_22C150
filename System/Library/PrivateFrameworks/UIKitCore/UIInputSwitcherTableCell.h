...
+ (id)reuseIdentifier;	// IMP=0x0060000000dfefe9
...
- (void)_updateRoundedCorners;	// IMP=0x0000000000dff344
- (void)updateSelectionWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000dff33e
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000dff294
- (void)layoutSubviews;	// IMP=0x0000000000dff07a
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000dfeff3
