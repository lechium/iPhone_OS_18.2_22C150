...
+ (id)transitionForExistingPlacement:(id)arg1 animationStyle:(id)arg2;	// IMP=0x0060000000fe3701
+ (id)transitionFromPlacement:(id)arg1 toPlacement:(id)arg2 withAnimationStyle:(id)arg3;	// IMP=0x0060000000fe364d
- (void).cxx_destruct;	// IMP=0x0000000000fe39b2
...
- (void)dealloc;	// IMP=0x0000000000fe388b
- (_Bool)didAdvanceAnimationToState:(int)arg1;	// IMP=0x0000000000fe37a1
