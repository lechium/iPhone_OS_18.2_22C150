...
@interface UIDragInteractionContextImpl : NSObject
{
    ...
    struct CAPoint3D _initialLocation;	// 88 = 0x58
}

- (void).cxx_destruct;	// IMP=0x00000000009c3c00
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000009c3a16
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x00000000009c3925
