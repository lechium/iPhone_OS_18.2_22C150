...
- (void).cxx_destruct;	// IMP=0x0000000000fe0c5f
...
- (void)dragWillBegin:(id)arg1;	// IMP=0x0000000000fe0b13
- (void)layoutSubviews;	// IMP=0x0000000000fe0651
- (id)fontUsingSilhouette:(unsigned long long)arg1 size:(double)arg2;	// IMP=0x0000000000fdfab8
- (void)setStringRepresentation:(id)arg1 silhouette:(unsigned long long)arg2;	// IMP=0x0000000000fdf967
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000fdf471
