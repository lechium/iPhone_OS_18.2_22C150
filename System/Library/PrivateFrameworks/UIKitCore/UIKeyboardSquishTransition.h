...
- (void).cxx_destruct;	// IMP=0x0000000001155050
...
- (id)meshTransformForKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000001153152
- (id)symmetricMeshTransformForKeyplane:(id)arg1;	// IMP=0x0000000001151613
- (_Bool)_allowFacesToAdjoinToAdjacentFaces;	// IMP=0x00000000011515ab
- (id)geometriesForKeyplane:(id)arg1;	// IMP=0x0000000001151577
- (id)sortedCommonVisibleKeys;	// IMP=0x0000000001151401
- (void)updateOpacityAnimation:(id)arg1;	// IMP=0x0000000001151221
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000001151012
- (void)removeAllAnimations;	// IMP=0x0000000001150ee7
- (void)_updateTransition;	// IMP=0x0000000001150d20
- (id)_animationsForEnd;	// IMP=0x000000000115075d
- (id)_animationsForStart;	// IMP=0x000000000115018b
- (void)commitTransitionRebuild;	// IMP=0x00000000011500cb
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x000000000114fc68
- (void)dealloc;	// IMP=0x000000000114fc1f
