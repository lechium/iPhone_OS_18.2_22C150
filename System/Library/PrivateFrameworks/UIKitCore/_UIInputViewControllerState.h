...
+ (id)stateForKeyboardState:(id)arg1;	// IMP=0x0010000000e1ef5a
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000e1ef52
- (void).cxx_destruct;	// IMP=0x0000000000e1f92d
...
- (id)description;	// IMP=0x0000000000e1f71e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e1f4de
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000e1f418
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000e1f2be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e1f217
- (void)createDocumentStateIfNecessary;	// IMP=0x0000000000e1f14c
