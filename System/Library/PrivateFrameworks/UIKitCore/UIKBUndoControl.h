...
+ (id)controlLableTextByType:(long long)arg1 style:(id)arg2 available:(_Bool)arg3;	// IMP=0x00600000011a5ca0
- (void).cxx_destruct;	// IMP=0x00000000011a6f35
...
- (id)viewForLastBaselineLayout;	// IMP=0x00000000011a6da9
- (id)viewForFirstBaselineLayout;	// IMP=0x00000000011a6d94
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000011a6d21
- (unsigned int)_secureName;	// IMP=0x00000000011a6d07
- (void)configureSecurePasteButtonInRootView:(id)arg1;	// IMP=0x00000000011a68a0
- (void)layoutControlForType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x00000000011a5de0
- (id)controlImageByType:(long long)arg1;	// IMP=0x00000000011a5c2c
- (id)controlLabelImageNameByType:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x00000000011a5ba1
- (void)updateCoverWithTavelProcess:(double)arg1 isRTL:(_Bool)arg2;	// IMP=0x00000000011a5807
- (void)updateUndoControlStyle;	// IMP=0x00000000011a545f
- (void)layoutSubviews;	// IMP=0x00000000011a535b
- (id)initWithType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x00000000011a4fbd
