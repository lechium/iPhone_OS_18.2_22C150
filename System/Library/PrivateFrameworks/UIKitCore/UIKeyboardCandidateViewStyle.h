...
+ (id)tvGridStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000db0e1b
+ (id)tvLinearStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000db0a32
+ (id)disambiguationStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000db0a00
+ (id)styleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000db09ce
+ (id)darkKeyboardStyleForDisambiguation;	// IMP=0x0010000000db0731
+ (id)lightKeyboardStyleForDisambiguation;	// IMP=0x0010000000db04e2
+ (id)visionInlineStyle;	// IMP=0x0010000000db0047
+ (id)darkKeyboardStyle;	// IMP=0x0010000000dafbdf
+ (id)lightKeyboardStyle;	// IMP=0x0010000000daf777
- (void).cxx_destruct;	// IMP=0x0000000000db1d07
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000daec99
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000dae755
