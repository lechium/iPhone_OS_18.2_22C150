...
- (void).cxx_destruct;	// IMP=0x0000000000b9f522
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000b9f398
- (id)_gestureRecognizerForExclusionRelationship;	// IMP=0x0000000000b9f386
- (void)_endInteractionEffectIfNeeded;	// IMP=0x0000000000b9f2b7
- (void)_prepareInteractionEffect;	// IMP=0x0000000000b9efee
- (void)clickInteractionDidClickUp:(id)arg1;	// IMP=0x0000000000b9dede
- (void)clickInteractionDidClickDown:(id)arg1;	// IMP=0x0000000000b9de5d
- (id)highlightEffectForClickInteraction:(id)arg1;	// IMP=0x0000000000b9da7f
- (void)clickInteractionDidEnd:(id)arg1;	// IMP=0x0000000000b9da02
- (_Bool)clickInteractionShouldBegin:(id)arg1;	// IMP=0x0000000000b9d97a
...
- (_Bool)_performPresentationIfPossible;	// IMP=0x0000000000b9d3ce
- (_Bool)_canPerformPresentation;	// IMP=0x0000000000b9d391
- (void)_startPreviewAtLocation:(struct CGPoint)arg1 inCoordinateSpace:(id)arg2;	// IMP=0x0000000000b9d34a
- (void)didMoveToView:(id)arg1;	// IMP=0x0000000000b9d143
- (void)willMoveToView:(id)arg1;	// IMP=0x0000000000b9cfb9
- (void)cancelInteraction;	// IMP=0x0000000000b9ce17
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x0000000000b9cd30
- (void)dealloc;	// IMP=0x0000000000b9ccc2
- (id)initWithView:(id)arg1 previewInteraction:(id)arg2;	// IMP=0x0000000000b9cc3f
