...
- (void).cxx_destruct;	// IMP=0x0000000000c40f95
...
- (id)description;	// IMP=0x0000000000c40e46
@property(readonly, nonatomic, getter=isLoop) _Bool loop;
- (id)commonNode:(id)arg1;	// IMP=0x0000000000c40caf
- (id)oppositeNode:(id)arg1;	// IMP=0x0000000000c40c72
- (id)initWithLabel:(id)arg1 sourceNode:(id)arg2 targetNode:(id)arg3 directed:(_Bool)arg4;	// IMP=0x0000000000c40af2
