...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000e1fc92
- (void).cxx_destruct;	// IMP=0x0000000000e21051
...
- (id)description;	// IMP=0x0000000000e20b6c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e20682
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000e20421
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000e20159
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e20052
- (void)setInputModeList:(long long)arg1 touchBegan:(double)arg2 fromLocation:(struct CGPoint)arg3 updatePoint:(struct CGPoint)arg4;	// IMP=0x0000000000e2002f
- (void)adjustTextPositionByCharacterOffset:(long long)arg1;	// IMP=0x0000000000e1ff31
- (void)deleteBackward;	// IMP=0x0000000000e1fe76
- (void)insertText:(id)arg1;	// IMP=0x0000000000e1fe0d
- (id)_currentKeyboardOutput;	// IMP=0x0000000000e1fd64
- (void)_pushNewKeyboardOutput;	// IMP=0x0000000000e1fc9a
