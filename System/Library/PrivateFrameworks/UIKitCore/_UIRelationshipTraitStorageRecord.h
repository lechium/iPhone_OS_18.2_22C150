...
- (void).cxx_destruct;	// IMP=0x0000000000d875c5
...
- (id)description;	// IMP=0x0000000000d87527
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000d874a6
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000d873c7
- (id)initWithTraitCollection:(id)arg1 addedObjects:(id)arg2 removedObjects:(id)arg3;	// IMP=0x0000000000d872ec
