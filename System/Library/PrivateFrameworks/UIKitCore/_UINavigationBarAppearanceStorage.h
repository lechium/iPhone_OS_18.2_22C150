...
+ (long long)typicalBarPosition;	// IMP=0x00600000004200ec
- (void).cxx_destruct;	// IMP=0x0000000000420596
...
- (id)representativeImageForIdiom:(long long)arg1;	// IMP=0x00000000004203a2
...
- (double)titleVerticalAdjustmentForBarMetrics:(long long)arg1;	// IMP=0x0000000000420267
- (void)setTitleVerticalAdjustment:(double)arg1 forBarMetrics:(long long)arg2;	// IMP=0x0000000000420158
