...
- (void)recalculateForDecelerationTarget:(struct CGPoint)arg1;	// IMP=0x00000000019ddc04
- (void)calculateToReachDecelerationTarget;	// IMP=0x00000000019ddbfe
- (void)calculateDecelerationTarget;	// IMP=0x00000000019ddbf8
- (_Bool)isRubberBandingAfterDuration:(double)arg1;	// IMP=0x00000000019ddbf0
- (struct CGPoint)positionAfterDuration:(double)arg1;	// IMP=0x00000000019ddbda
- (struct CGVector)velocityAfterDuration:(double)arg1;	// IMP=0x00000000019ddbce
- (double)speedAfterDuration:(double)arg1;	// IMP=0x00000000019ddbc5
@property(readonly, nonatomic) double durationUntilStop;
- (id)initWithInitialContentOffset:(struct CGPoint)arg1 velocity:(struct CGVector)arg2 contentFrame:(struct CGRect)arg3 viewSize:(struct CGSize)arg4 screenScale:(double)arg5;	// IMP=0x00000000019ddab0
- (id)init;	// IMP=0x00000000019dda45
