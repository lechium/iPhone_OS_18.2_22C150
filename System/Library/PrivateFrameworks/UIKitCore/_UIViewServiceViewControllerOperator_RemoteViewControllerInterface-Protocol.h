...
@class BKSAnimationFenceHandle, BSMachPortSendRight, FBSDisplayConfiguration, FBSDisplayIdentity, NSDate, NSDateInterval, NSObject, NSString, UIColor, UITraitCollection, _UIBoundingPath, _UIPhysicalButtonBSAction, _UIRemoteViewControllerSceneContext, _UISheetPresentationControllerConfiguration, _UIViewControllerTransitionCoordinatorContextDescription, _UIViewServiceViewControllerOperatorCreateOptions;
...
- (void)__hostReceivedHomeAffordanceDoubleTapGestureDidSucceed:(_Bool)arg1;
- (void)__hostHomeAffordanceFrameIntersectionDidChange:(struct CGRect)arg1;
