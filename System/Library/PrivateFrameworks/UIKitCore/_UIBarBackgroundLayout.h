...
- (void).cxx_destruct;	// IMP=0x0000000000c3ea21
...
- (id)description;	// IMP=0x0000000000c3e8e3
- (void)describeInto:(id)arg1;	// IMP=0x0000000000c3e80d
...
- (_Bool)bg2HasHeight;	// IMP=0x0000000000c3e7a4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c3e690
- (id)initWithLayout:(id)arg1;	// IMP=0x0000000000c3e5cc
- (id)init;	// IMP=0x0000000000c3e5b8
