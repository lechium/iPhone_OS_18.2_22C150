...
- (void).cxx_destruct;	// IMP=0x0000000000368e5b
...
- (_Bool)_animateForInterval:(double)arg1;	// IMP=0x0000000000368b4d
- (void)runWithValueApplier:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000368add
- (id)initWithValue:(double)arg1 targetValue:(double)arg2 convergenceRate:(double)arg3 minimumDifference:(double)arg4;	// IMP=0x0000000000368a51
