...
+ (id)sliceWithStart:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0060000001148066
- (void).cxx_destruct;	// IMP=0x0000000001148331
...
- (id)description;	// IMP=0x0000000001148185
@property(readonly) _Bool hasGeometry;
- (void)addStartRect:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x00000000011480cc
- (id)init;	// IMP=0x0000000001147fc7
