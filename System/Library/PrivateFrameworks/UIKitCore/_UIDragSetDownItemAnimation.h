...
@interface _UIDragSetDownItemAnimation : NSObject
{
    ...
    UIView *_dropContainerView;	// 56 = 0x38
    ...
    CDUnion_5898235e _initialVelocity;	// 272 = 0x110
    CDUnion_5898235e _initialTargetVelocity;	// 304 = 0x130
}

- (void).cxx_destruct;	// IMP=0x0000000001a86ca9
...
- (void)_setCenterAndVelocityFromDroppedItem:(id)arg1;	// IMP=0x0000000001a8677b
- (void)updateDroppedItem:(id)arg1;	// IMP=0x0000000001a865d3
- (void)updateTargetedDropPreview:(id)arg1;	// IMP=0x0000000001a85f4f
- (void)dirtyTargetedDropPreview;	// IMP=0x0000000001a85e91
- (void)updateAnimationTargeting;	// IMP=0x0000000001a85771
@property(readonly, nonatomic) long long previewMode;
- (_Bool)needsReparenting;	// IMP=0x0000000001a856d6
- (CDUnknownBlockType)animationCompletionHandler;	// IMP=0x0000000001a85554
- (void)performSpringAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000001a85330
- (void)previewContainerAnimationDidComplete;	// IMP=0x0000000001a852f6
- (void)performTrackingAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000001a850da
- (double)estimatedFractionCompleteOfAnimation;	// IMP=0x0000000001a84fe4
- (void)updateCurrentTargetFrame;	// IMP=0x0000000001a84e17
- (void)reparentRetargetingContainerViewInTargetContainer;	// IMP=0x0000000001a844f8
- (void)configureCrossfadingAnimationToTargetedPreview;	// IMP=0x0000000001a82c06
- (void)configureSystemDefaultAnimation;	// IMP=0x0000000001a8270a
- (void)configureAnimation;	// IMP=0x0000000001a826b2
@property(readonly, nonatomic) UIWindow *targetContainerWindow;
- (void)animationCompleted;	// IMP=0x0000000001a8258f
- (void)animationReachedTarget;	// IMP=0x0000000001a8253f
- (void)beginAnimation;	// IMP=0x0000000001a824ff
- (void)prepareToBeginAnimation;	// IMP=0x0000000001a823a1
- (void)prepareAnimationInWindow;	// IMP=0x0000000001a8205e
- (id)initWithDragItem:(id)arg1 droppedItem:(id)arg2 dropContainerView:(id)arg3 defaultAnimation:(_Bool)arg4 sourceAnimation:(_Bool)arg5 delegate:(id)arg6;	// IMP=0x0000000001a81f04
