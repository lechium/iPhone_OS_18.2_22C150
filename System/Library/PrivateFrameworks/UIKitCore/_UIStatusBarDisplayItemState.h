...
+ (void)setupRelationsBetweenDisplayItemStates:(id)arg1 visualProvider:(id)arg2;	// IMP=0x0010000001504a73
+ (id)stateForDisplayItemWithIdentifier:(id)arg1 statusBar:(id)arg2;	// IMP=0x00100000015042b7
- (void).cxx_destruct;	// IMP=0x000000000150818e
...
- (id)description;	// IMP=0x0000000001507cfa
@property(readonly, nonatomic) long long priority;
@property(readonly, copy, nonatomic) NSArray *potentialPlacementRegionIdentifiers;
- (_Bool)isCurrentPlacement:(id)arg1;	// IMP=0x0000000001507960
- (_Bool)prepareAnimation:(id)arg1;	// IMP=0x000000000150741d
- (id)_animationWithUpdateAnimation:(id)arg1;	// IMP=0x00000000015071a6
- (void)_cancelObsoleteAnimations;	// IMP=0x0000000001506faf
@property(readonly, nonatomic, getter=_animationType) long long animationType;
- (id)_effectiveStyleAttributesFromStyleAttributes:(id)arg1 data:(id)arg2 styleAttributesChanged:(_Bool *)arg3;	// IMP=0x0000000001506a8e
- (id)_updateForUpdatedData:(id)arg1 updatedStyleAttributes:(id)arg2 updatedEnability:(id)arg3;	// IMP=0x000000000150686e
- (id)_updateForItem:(id)arg1 data:(id)arg2 styleAttributes:(id)arg3;	// IMP=0x00000000015065b0
- (id)updateWithData:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x0000000001505e84
- (_Bool)updatePlacement;	// IMP=0x0000000001505da7
- (void)resetToPreferredPlacement;	// IMP=0x0000000001505d91
- (_Bool)_updatePlacementWithRecursionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001505c06
- (_Bool)_resolveDependentItemStatesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001505964
- (void)_updateStatuses;	// IMP=0x0000000001505882
- (void)prepareForDataUpdate;	// IMP=0x000000000150586b
- (void)prepareForOverflowDataUpdate;	// IMP=0x0000000001505855
- (id)placementStateForPlacement:(id)arg1;	// IMP=0x00000000015048ae
- (void)addPlacement:(id)arg1 inRegion:(id)arg2;	// IMP=0x00000000015046ca
- (_Bool)_updateToNextPlacementStateIfNeeded;	// IMP=0x000000000150463d
- (void)updateToNextEnabledPlacement;	// IMP=0x0000000001504606
@property(readonly, nonatomic) _UIStatusBarDisplayItemPlacementState *currentPlacementState;
- (_Bool)hasRunningAnimations;	// IMP=0x0000000001504582
