...
- (void).cxx_destruct;	// IMP=0x000000000031f45d
...
- (_Bool)_shouldInstallContentGuideConstraints;	// IMP=0x000000000031f408
- (_Bool)_shouldShowSeparatorAboveActionsSequenceView;	// IMP=0x000000000031f3bf
- (id)defaultVisualStyleForTraitCollection:(id)arg1 presentationStyle:(long long)arg2;	// IMP=0x000000000031f2e5
- (id)_alertController;	// IMP=0x000000000031f2cc
- (id)initWithAlertController:(id)arg1 actionGroup:(id)arg2 actionHandlerInvocationDelegate:(id)arg3;	// IMP=0x000000000031f250
