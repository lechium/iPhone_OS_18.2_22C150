...
+ (id)inlineTextCompletion:(id)arg1 source:(id)arg2;	// IMP=0x006000000183cf30
- (void).cxx_destruct;	// IMP=0x000000000183d113
...
- (id)initWithCompletion:(id)arg1 source:(id)arg2;	// IMP=0x000000000183cfa6
