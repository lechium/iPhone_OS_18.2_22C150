...
- (double)_currentTouchForceMultiplier;	// IMP=0x000000000124b476
- (double)_normalizedTouchForceValue:(double)arg1;	// IMP=0x000000000124b449
- (double)_denormalizedTouchForceValue:(double)arg1;	// IMP=0x000000000124b418
- (double)_thresholdForForceLevel:(long long)arg1;	// IMP=0x000000000124b3af
- (void)_accessibilityForceSensitivityChanged:(id)arg1;	// IMP=0x000000000124b39d
- (void)reset;	// IMP=0x000000000124b1a2
- (void)evaluateWithTouchForce:(double)arg1 atTimestamp:(double)arg2 withCentroidAtLocation:(struct CGPoint)arg3;	// IMP=0x000000000124addf
@property(readonly, nonatomic) double velocity; // @dynamic velocity;
- (double)currentProgressToState:(long long)arg1;	// IMP=0x000000000124acb0
- (id)description;	// IMP=0x000000000124abdd
- (void)dealloc;	// IMP=0x000000000124ab5b
- (id)init;	// IMP=0x000000000124aa49
