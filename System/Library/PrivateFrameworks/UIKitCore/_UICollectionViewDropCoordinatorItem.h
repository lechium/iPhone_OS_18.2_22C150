...
- (void).cxx_destruct;	// IMP=0x00000000007402eb
...
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000007401cf
- (void)addAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000000740166
@property(readonly, copy) NSString *description;
- (id)initWithDestinationIndexPath:(id)arg1 dragItem:(id)arg2 placeholderConfiguration:(id)arg3;	// IMP=0x000000000073fe82
- (id)initWithDragItem:(id)arg1 target:(id)arg2;	// IMP=0x000000000073fd3f
- (id)initWithDestinationIndexPath:(id)arg1 dragItem:(id)arg2;	// IMP=0x000000000073fc0d
