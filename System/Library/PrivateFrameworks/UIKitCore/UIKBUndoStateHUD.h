...
- (void).cxx_destruct;	// IMP=0x00000000011ace16
...
- (void)layoutSubviews;	// IMP=0x00000000011acc12
- (void)updateUndoStateHUDControlType:(long long)arg1 available:(_Bool)arg2;	// IMP=0x00000000011aca6d
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x00000000011ab5bb
