...
+ (id)defaultConfiguration;	// IMP=0x0060000000a51551
- (void).cxx_destruct;	// IMP=0x0000000000a51b2b
...
- (void)setclickDownFeedback:(id)arg1;	// IMP=0x0000000000a5196b
- (id)feedbackKeyPaths;	// IMP=0x0000000000a51854
...
- (long long)requiredSupportLevel;	// IMP=0x0000000000a51320
