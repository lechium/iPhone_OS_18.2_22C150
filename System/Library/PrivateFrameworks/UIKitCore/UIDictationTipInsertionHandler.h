...
- (void).cxx_destruct;	// IMP=0x0000000001a63857
...
- (void)startRecodingText:(id)arg1;	// IMP=0x0000000001a63769
- (void)resetHandler;	// IMP=0x0000000001a63727
- (void)recordDictationTipText:(id)arg1;	// IMP=0x0000000001a63680
- (void)finalizeRecordedText;	// IMP=0x0000000001a634f0
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000001a63437
