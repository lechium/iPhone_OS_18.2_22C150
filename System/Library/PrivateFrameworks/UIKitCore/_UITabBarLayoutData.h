...
+ (id)decodeFromCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x00600000015434b7
+ (id)standardLayoutData;	// IMP=0x006000000154345f
- (void).cxx_destruct;	// IMP=0x00000000015443e2
...
- (long long)positioningForTraitCollection:(id)arg1;	// IMP=0x0000000001544354
- (id)replicate;	// IMP=0x00000000015440ac
- (_Bool)checkEqualTo:(id)arg1;	// IMP=0x0000000001543f0d
- (long long)hashInto:(long long)arg1;	// IMP=0x0000000001543e5b
- (void)describeInto:(id)arg1;	// IMP=0x0000000001543ce2
- (void)encodeToCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x0000000001543984
