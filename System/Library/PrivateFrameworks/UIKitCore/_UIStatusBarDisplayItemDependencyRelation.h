...
- (void).cxx_destruct;	// IMP=0x0000000001508c78
...
- (id)_ui_descriptionBuilder;	// IMP=0x0000000001508aef
- (id)type;	// IMP=0x0000000001508ac8
- (id)itemStates;	// IMP=0x0000000001508a3f
- (_Bool)isFulfilled;	// IMP=0x00000000015089dd
