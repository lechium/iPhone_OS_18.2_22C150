...
- (id)description;	// IMP=0x000000000123e21b
@property(readonly, nonatomic, getter=isSteady) _Bool steady;
- (void)updateFromDisplayLink:(id)arg1;	// IMP=0x000000000123e15d
- (void)update:(double)arg1;	// IMP=0x000000000123e118
- (id)initWithValue:(double)arg1;	// IMP=0x000000000123e0bb
- (id)init;	// IMP=0x000000000123e05b
