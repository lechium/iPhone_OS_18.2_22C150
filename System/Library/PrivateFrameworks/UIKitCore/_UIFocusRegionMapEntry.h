...
- (void).cxx_destruct;	// IMP=0x0000000000afaaa9
...
- (id)description;	// IMP=0x0000000000afa947
...
- (id)_uniqueElementFromArray:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000afa618
- (void)_wasOccludedByFrame:(struct CGRect)arg1;	// IMP=0x0000000000afa4f0
- (id)sliceWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000afa47d
- (id)_mapEntriesByOccludingWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000af9dae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000af9d1d
- (id)initWithFrame:(struct CGRect)arg1 originalRegionFrame:(struct CGRect)arg2;	// IMP=0x0000000000af9cae
