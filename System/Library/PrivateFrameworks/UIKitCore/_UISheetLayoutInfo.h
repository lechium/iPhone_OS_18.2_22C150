...
- (void).cxx_destruct;	// IMP=0x00000000007a36f5
...
- (double)_maximumDepthLevelInChain;	// IMP=0x00000000007a318e
...
- (id)_descendantDescription;	// IMP=0x00000000007a2eb4
@property(readonly, copy) NSString *description;
- (void)_layout;	// IMP=0x00000000007a1797
...
- (_Bool)_supportsAttachedEdge;	// IMP=0x000000000079bbc1
...
- (void)_invalidateCurrentOffset;	// IMP=0x000000000079a53d
- (void)_invalidateDetents;	// IMP=0x0000000000799a84
- (void)_boundingPathMayHaveChangedForView:(id)arg1 relativeToBoundsOriginOnly:(_Bool)arg2;	// IMP=0x0000000000799087
- (void)_invalidatePreferredSize;	// IMP=0x0000000000799034
- (id)initWithMetrics:(id)arg1;	// IMP=0x0000000000798ced
