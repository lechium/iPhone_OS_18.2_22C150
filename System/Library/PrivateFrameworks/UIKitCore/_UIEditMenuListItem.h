...
+ (id)itemWithTitle:(id)arg1;	// IMP=0x006000000120157f
+ (id)itemWithMenuElement:(id)arg1 preferredDisplayMode:(unsigned long long)arg2;	// IMP=0x0060000001201070
- (void).cxx_destruct;	// IMP=0x0000000001201b4c
...
- (id)description;	// IMP=0x00000000012016bf
- (_Bool)hidesImageForTraitCollection:(id)arg1;	// IMP=0x000000000120163d
- (_Bool)hidesTitleForTraitCollection:(id)arg1;	// IMP=0x00000000012015c3
