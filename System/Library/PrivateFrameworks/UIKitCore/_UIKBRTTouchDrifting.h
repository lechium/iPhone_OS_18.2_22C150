...
+ (_Bool)isEnabled;	// IMP=0x00600000010fb1f7
- (void).cxx_destruct;	// IMP=0x00000000011006ad
...
- (void)_updateDriftViewTimer:(id)arg1;	// IMP=0x00000000010fffad
- (void)_updateDriftView;	// IMP=0x00000000010fe74b
- (struct CGPoint)_pinOffset:(struct CGPoint)arg1;	// IMP=0x00000000010fe668
- (struct CGPoint)_pointFromPoint:(struct CGPoint)arg1 plusOffset:(struct CGPoint)arg2;	// IMP=0x00000000010fe65a
- (struct CGPoint)_offsetForPoint:(struct CGPoint)arg1 fromPoint:(struct CGPoint)arg2;	// IMP=0x00000000010fe64c
- (void)_updateDriftForFingers:(id)arg1 leftHand:(_Bool)arg2 newestTouch:(id)arg3;	// IMP=0x00000000010fdbe2
- (void)_updateDriftWithTouchInfo:(id)arg1;	// IMP=0x00000000010fd1ea
- (id)_touchDictWithFingerIds:(id)arg1;	// IMP=0x00000000010fcdad
- (void)_updateHistory;	// IMP=0x00000000010fcd64
- (void)removeTouchWithIdentifier:(id)arg1 touchCancelled:(_Bool)arg2;	// IMP=0x00000000010fc9bd
- (void)moveTouchWithIdentifier:(id)arg1 toLocation:(struct CGPoint)arg2 withRadius:(double)arg3 atTouchTime:(double)arg4;	// IMP=0x00000000010fc6d2
- (void)ignoreTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2;	// IMP=0x00000000010fc2da
- (void)updateTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 resultingError:(struct CGPoint)arg3 rowOffsetFromHomeRow:(long long)arg4;	// IMP=0x00000000010fc032
- (void)addTouchLocation:(struct CGPoint)arg1 withRadius:(double)arg2 withTouchTime:(double)arg3 withIdentifier:(id)arg4;	// IMP=0x00000000010fbdcf
...
- (void)updateWithFCenter:(struct CGPoint)arg1 jCenter:(struct CGPoint)arg2 keySize:(struct CGSize)arg3 rowOffsets:(id)arg4 homeRowOffsetIndex:(int)arg5;	// IMP=0x00000000010fbaaa
- (void)reset;	// IMP=0x00000000010fb857
- (void)_resetFeedback;	// IMP=0x00000000010fb78e
- (void)dealloc;	// IMP=0x00000000010fb750
- (id)initWithParentView:(id)arg1;	// IMP=0x00000000010fb6ff
- (id)init;	// IMP=0x00000000010fb223
