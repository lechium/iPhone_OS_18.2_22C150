...
+ (id)requestWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x0010000000af30c4
- (void).cxx_destruct;	// IMP=0x0000000000af3ef6
...
- (id)takeSnapshot;	// IMP=0x0000000000af3334
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000af3211
- (id)initWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x0000000000af3132
