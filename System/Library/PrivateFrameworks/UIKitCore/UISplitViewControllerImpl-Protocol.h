...
@class NSArray, NSCoder, NSString, UIBarButtonItem, UIDimmingView, UIFocusUpdateContext, UIPopoverController, UIPresentationController, UIResponder, UISplitViewController, UISplitViewControllerDisplayModeBarButtonItem, UITraitCollection, UIView, UIViewController;
