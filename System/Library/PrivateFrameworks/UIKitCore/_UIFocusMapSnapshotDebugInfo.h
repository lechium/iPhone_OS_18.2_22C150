...
+ (id)_summaryImageForDebugInfoArray:(id)arg1 forFocusMovementWithInfo:(id)arg2 scaleFactor:(double)arg3;	// IMP=0x0060000000ad3337
- (void).cxx_destruct;	// IMP=0x0000000000ad4099
...
- (id)_drawImage;	// IMP=0x0000000000ad2788
- (struct CGRect)_rectContainingAllFocusRegions;	// IMP=0x0000000000ad2590
@property(readonly, nonatomic) struct CGPoint imageAnchorPoint; // @synthesize imageAnchorPoint=_imageAnchorPoint;
@property(readonly, nonatomic) UIImage *image; // @synthesize image=_image;
- (id)initWithSnapshot:(id)arg1 focusMapSearchInfo:(id)arg2;	// IMP=0x0000000000ad240b
