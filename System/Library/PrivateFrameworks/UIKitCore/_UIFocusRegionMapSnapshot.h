...
+ (id)combinedVisualRepresentationForSnapshots:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x0010000000af8d4d
- (void).cxx_destruct;	// IMP=0x0000000000af9c2c
...
- (id)debugQuickLookObject;	// IMP=0x0000000000af9a46
- (id)visualRepresentationWithMinimumArea:(struct CGRect)arg1;	// IMP=0x0000000000af7a0f
...
- (void)_didChooseFocusCandidateRegion:(id)arg1;	// IMP=0x0000000000af7181
- (id)_snapshotByFulfillingPromiseFocusRegionEntry:(id)arg1;	// IMP=0x0000000000af6563
- (id)focusableRegionMapEntriesLimitedByFocusContainerGuide:(id)arg1;	// IMP=0x0000000000af61d5
@property(readonly, copy, nonatomic) NSArray *allFocusableRegionMapEntries;
- (void)_commit;	// IMP=0x0000000000af6183
- (void)_updateSortedFocusContainerGuideMapEntries;	// IMP=0x0000000000af6112
- (void)_updateFinalFocusableRegionMapEntries;	// IMP=0x0000000000af6076
- (id)_sortedEligibleFocusContainerGuidesInArray:(id)arg1;	// IMP=0x0000000000af5707
- (id)_finalFocusableRegionMapEntriesFromViewMapEntries:(id)arg1 guideMapEntries:(id)arg2;	// IMP=0x0000000000af5418
- (id)_finalFocusableRegionMapEntriesFromMapEntries:(id)arg1;	// IMP=0x0000000000af4df5
- (void)_punchHoleInMap:(id)arg1 atFrame:(struct CGRect)arg2;	// IMP=0x0000000000af4b65
- (void)_occludeFocusInFrame:(struct CGRect)arg1;	// IMP=0x0000000000af4a7e
- (void)_addFocusContainerGuide:(id)arg1 withFrame:(struct CGRect)arg2;	// IMP=0x0000000000af4912
- (void)_addFocusableRegion:(id)arg1 isFocusGuide:(_Bool)arg2 withFrame:(struct CGRect)arg3;	// IMP=0x0000000000af465f
- (struct CGRect)_clippedRegionFrame:(struct CGRect)arg1 isFocusGuide:(_Bool)arg2;	// IMP=0x0000000000af4442
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000af420d
- (id)_initWithRequest:(id)arg1;	// IMP=0x0000000000af3f25
