...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000001904340
+ (id)descriptionForTransitionCoordinatorContext:(id)arg1;	// IMP=0x00100000019041c7
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000001904520
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001904348
