...
+ (id)accessoryWithIdentifier:(id)arg1;	// IMP=0x00600000015b0e1e
- (void).cxx_destruct;	// IMP=0x00000000015b105c
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000015b1004
- (id)description;	// IMP=0x00000000015b0f39
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000015b0e67
- (id)init;	// IMP=0x00000000015b0de2
