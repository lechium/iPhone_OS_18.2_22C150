...
- (void).cxx_destruct;	// IMP=0x000000000186279e
...
- (void)_sliderDidChangeValue:(id)arg1;	// IMP=0x00000000018625f2
- (void)_prototypingSettingDidChange;	// IMP=0x000000000186227b
- (void)_tapRecognizerDidRecognizer:(id)arg1;	// IMP=0x0000000001862194
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000001861e16
