...
+ (id)instanceForScene:(id)arg1;	// IMP=0x00600000009120ed
+ (id)sharedInstance;	// IMP=0x0060000000912068
- (void).cxx_destruct;	// IMP=0x00000000009149a4
...
- (void)displayForDownloadingURL:(id)arg1 copyToURL:(id)arg2 sourceViewController:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000913659
- (void)displayForCopyingFileAtURL:(id)arg1 toURL:(id)arg2 sourceViewController:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000913647
- (void)displayForDownloadingURL:(id)arg1 sourceViewController:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000091362d
- (id)_sourceScene;	// IMP=0x0000000000913534
- (id)_createSourceWindow;	// IMP=0x00000000009133f8
- (id)_defaultSourceViewControllerCreatingWindowIfNeeded;	// IMP=0x000000000091338c
- (void)displayWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 sourceViewController:(id)arg5 preDisplayTestBlock:(CDUnknownBlockType)arg6 dismissalHandler:(CDUnknownBlockType)arg7;	// IMP=0x000000000091312f
@property(copy, nonatomic) NSString *message;
@property(copy, nonatomic) NSString *title;
- (void)reconfigureWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 dismissalHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000912ae2
- (void)hideAfterDelay:(double)arg1 forceCompletion:(_Bool)arg2 replacementDismissalHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000912966
- (void)hideAfterMinimumUptimeWithDismissalHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000912814
- (void)_dismissButtonAction:(id)arg1;	// IMP=0x00000000009127f5
- (void)_hideTimerAction:(id)arg1;	// IMP=0x00000000009127b8
- (void)_showTimerAction:(id)arg1;	// IMP=0x00000000009126c0
- (_Bool)_shouldAnimatePresentationForIdiom:(long long)arg1;	// IMP=0x00000000009126b3
- (void)_hideImmediatelyWasDismissedByUser:(_Bool)arg1;	// IMP=0x0000000000912663
- (void)_reset;	// IMP=0x0000000000912518
- (void)_callAndClearDismissalHandlerWasDismissedByUser:(_Bool)arg1;	// IMP=0x00000000009124c8
- (id)init;	// IMP=0x00000000009123b6
