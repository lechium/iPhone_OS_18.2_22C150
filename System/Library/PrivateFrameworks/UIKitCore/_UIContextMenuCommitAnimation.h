...
- (void).cxx_destruct;	// IMP=0x0000000000693e1d
...
- (void)_prepareAnimationViews;	// IMP=0x0000000000693419
- (void)_prepareSnapshots;	// IMP=0x00000000006930b2
- (void)animateWithAlongsideActions:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000069235a
- (id)initWithSource:(id)arg1 container:(id)arg2;	// IMP=0x0000000000692247
