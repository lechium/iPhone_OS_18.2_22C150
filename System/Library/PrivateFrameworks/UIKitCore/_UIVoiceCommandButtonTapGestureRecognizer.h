...
- (id)voiceCommandButtonTapDuration;	// IMP=0x0000000000f48d2e
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000f48ca3
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000f48c18
- (void)reset;	// IMP=0x0000000000f48bcf
