...
- (void).cxx_destruct;	// IMP=0x000000000119f2e9
...
- (struct CGRect)boundingRectForGlyphsInRange:(struct _NSRange)arg1;	// IMP=0x000000000119f1c9
- (void)placeGlyphs;	// IMP=0x000000000119effd
- (void)removeGlyphs;	// IMP=0x000000000119ee93
- (void)buildGlyphViews;	// IMP=0x000000000119dc4e
- (void)dealloc;	// IMP=0x000000000119dbe5
- (id)initWithLabel:(id)arg1 attributedString:(id)arg2;	// IMP=0x000000000119d9e5
