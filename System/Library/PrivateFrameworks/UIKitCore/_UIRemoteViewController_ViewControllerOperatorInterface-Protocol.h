...
@class BKSAnimationFenceHandle, BSAction, BSAnimationSettings, NSArray, NSData, NSSet, NSString, NSValue, UIFocusMovementAction, _UIDismissInteractionUpdate, _UIPhysicalButtonConfigurationSet, _UISheetPresentationControllerClientConfiguration, _UITextServiceSessionContext, _UIViewAnimationAttributes;
