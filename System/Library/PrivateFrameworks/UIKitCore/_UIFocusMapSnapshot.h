...
- (void).cxx_destruct;	// IMP=0x0000000000b0a517
...
- (void)addRegionsInContainers:(id)arg1;	// IMP=0x0000000000b0a2a2
- (void)addRegionsInContainer:(id)arg1;	// IMP=0x0000000000b08b36
- (void)addRegions:(id)arg1;	// IMP=0x0000000000b0896f
- (void)addRegion:(id)arg1;	// IMP=0x0000000000b08479
- (id)searchArea;	// IMP=0x0000000000b08467
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace;
- (void)_capture;	// IMP=0x0000000000b081cd
@property(readonly, nonatomic) _Bool hasOnlyStaticContent;
- (void)markContainerAsProvidingDynamicContent;	// IMP=0x0000000000b08054
- (struct CGRect)snapshotFrameForRegion:(id)arg1;	// IMP=0x0000000000b07f03
- (id)_cachedNextFocusedItemForRegion:(id)arg1 withFocusMovementRequest:(id)arg2 inMap:(id)arg3;	// IMP=0x0000000000b07cf3
- (void)consumeRegionInformationForRegions:(id)arg1 fromSnapshot:(id)arg2;	// IMP=0x0000000000b07ae4
- (id)occludingRegionsForRegion:(id)arg1;	// IMP=0x0000000000b079cd
- (void)_trackOccludingRegion:(id)arg1 forRegion:(id)arg2;	// IMP=0x0000000000b07909
- (id)originalRegionForRegion:(id)arg1;	// IMP=0x0000000000b077e1
- (void)_trackSubregion:(id)arg1 forRegion:(id)arg2;	// IMP=0x0000000000b07627
- (id)regionsForOriginalRegion:(id)arg1;	// IMP=0x0000000000b073a9
@property(readonly, copy, nonatomic) NSArray *originalRegions;
@property(readonly, copy, nonatomic) NSArray *regions;
- (void)dealloc;	// IMP=0x0000000000b06e0c
- (id)_initWithSnapshotter:(id)arg1 mapArea:(id)arg2 searchArea:(id)arg3;	// IMP=0x0000000000b069ab
- (id)init;	// IMP=0x0000000000b06924
- (id)_debugInfoWithFocusMapSearchInfo:(id)arg1;	// IMP=0x0000000000ad418f
@property(readonly, nonatomic, getter=_debugInfo) _UIFocusMapSnapshotDebugInfo *debugInfo;
- (id)debugQuickLookObject;	// IMP=0x0000000000ad40ca
