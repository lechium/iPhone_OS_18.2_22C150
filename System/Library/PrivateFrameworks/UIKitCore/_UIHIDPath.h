...
- (void).cxx_destruct;	// IMP=0x00000000013d0c6c
...
- (void)applyTransform:(struct CGAffineTransform)arg1;	// IMP=0x00000000013d0b82
- (void)updateWithHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x00000000013d073d
- (id)init;	// IMP=0x00000000013d0701
