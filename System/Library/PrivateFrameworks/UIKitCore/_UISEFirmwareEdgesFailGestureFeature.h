...
- (void).cxx_destruct;	// IMP=0x0000000000c26581
@property(readonly, nonatomic) unsigned long long touchedEdges; // @synthesize touchedEdges=_touchedEdges;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x0000000000c264ce
- (id)debugDictionary;	// IMP=0x0000000000c2641f
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000c263af
