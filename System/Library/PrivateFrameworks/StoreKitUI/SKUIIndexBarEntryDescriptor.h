...
+ (id)placeholderEntryDescriptorWithSize:(struct CGSize)arg1;	// IMP=0x00600000000753c0
+ (id)entryDescriptorWithImage:(id)arg1;	// IMP=0x0060000000075314
+ (id)entryDescriptorWithAttributedString:(id)arg1;	// IMP=0x0060000000075268
+ (id)entryDescriptorWithArtwork:(id)arg1;	// IMP=0x00600000000751bc
- (void).cxx_destruct;	// IMP=0x000000000007572d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007508b
- (unsigned long long)hash;	// IMP=0x0000000000074f84
