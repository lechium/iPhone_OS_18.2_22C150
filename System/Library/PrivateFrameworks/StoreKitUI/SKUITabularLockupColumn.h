...
- (void).cxx_destruct;	// IMP=0x00000000002fb055
...
- (id)description;	// IMP=0x00000000002faf55
- (void)_addChildViewElement:(id)arg1;	// IMP=0x00000000002faf3f
- (id)initWithColumnIdentifier:(long long)arg1;	// IMP=0x00000000002fae9b
