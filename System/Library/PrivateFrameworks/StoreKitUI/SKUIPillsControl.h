...
- (void).cxx_destruct;	// IMP=0x000000000022b565
...
- (void)_segmentedControlAction:(id)arg1;	// IMP=0x000000000022b499
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000022b47c
- (void)layoutSubviews;	// IMP=0x000000000022b366
@property(nonatomic) long long selectedIndex;
@property(readonly, nonatomic) struct CGRect selectedPillFrame;
- (void)reloadPills;	// IMP=0x000000000022b056
- (void)dealloc;	// IMP=0x000000000022b002
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000022ae68
