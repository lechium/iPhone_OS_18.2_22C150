...
- (void).cxx_destruct;	// IMP=0x00000000001eb2f0
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000001eb1ed
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000001eb070
