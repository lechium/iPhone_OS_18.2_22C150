...
- (void).cxx_destruct;	// IMP=0x00000000002dad48
...
- (id)_httpBody;	// IMP=0x00000000002daaa2
- (void)run;	// IMP=0x00000000002da831
- (id)initWithMetadata:(id)arg1;	// IMP=0x00000000002da7c3
