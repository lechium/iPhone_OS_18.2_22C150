...
- (void).cxx_destruct;	// IMP=0x00000000002d69f8
...
- (void)_addSelectedViewController;	// IMP=0x00000000002d6809
- (void)layoutSubviews;	// IMP=0x00000000002d6747
- (void)setSelectedViewControllerIndex:(long long)arg1;	// IMP=0x00000000002d668a
