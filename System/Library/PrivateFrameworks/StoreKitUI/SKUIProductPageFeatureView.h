...
- (void).cxx_destruct;	// IMP=0x00000000001ca9b8
@property(retain, nonatomic) SKUIColorScheme *colorScheme; // @synthesize colorScheme=_colorScheme;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001ca8a6
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001ca804
- (void)layoutSubviews;	// IMP=0x00000000001ca5db
