...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001e148
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001e0e2
- (unsigned long long)hash;	// IMP=0x000000000001e0ca
- (id)initWithNavigationControllerOperation:(long long)arg1 operationDidComplete:(_Bool)arg2;	// IMP=0x000000000001e03d
