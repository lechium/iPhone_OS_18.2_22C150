...
- (void).cxx_destruct;	// IMP=0x00000000002486d6
...
- (_Bool)isLoaded;	// IMP=0x000000000024854d
- (void)updateWithDictionary:(id)arg1;	// IMP=0x000000000024831d
- (id)initWithCountdownDictionary:(id)arg1;	// IMP=0x00000000002479ac
