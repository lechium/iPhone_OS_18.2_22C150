...
+ (double)maximumHeightWithVisibleFields:(unsigned long long)arg1;	// IMP=0x006000000005217c
...
- (void)_reloadUserRatingViews;	// IMP=0x00000000000541fd
- (id)_newDefaultLabel;	// IMP=0x00000000000540f3
- (id)_decimalNumberFormatter;	// IMP=0x0000000000054085
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000053d9e
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000053c53
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000052f7d
...
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x00000000000526fb
@property(copy, nonatomic) NSString *categoryString;
@property(copy, nonatomic) NSString *editorialBadgeString;
@property(copy, nonatomic) NSString *artistName;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000520ce
