...
- (void).cxx_destruct;	// IMP=0x00000000000a6e65
...
- (void)_setSenderName:(id)arg1;	// IMP=0x00000000000a6927
- (void)_setPrice:(id)arg1;	// IMP=0x00000000000a66f9
- (void)_setMessage:(id)arg1;	// IMP=0x00000000000a64cc
- (void)_setHeaderImage:(id)arg1;	// IMP=0x00000000000a6394
- (void)_reloadItemView;	// IMP=0x00000000000a61a5
- (id)_itemView;	// IMP=0x00000000000a60bc
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000000a601e
- (void)layoutSubviews;	// IMP=0x00000000000a584e
@property(retain, nonatomic) UIImage *itemImage;
- (void)reloadThemeHeaderImage;	// IMP=0x00000000000a5175
