...
- (void).cxx_destruct;	// IMP=0x000000000005ff10
...
- (void)_reloadItemState;	// IMP=0x000000000005fa00
- (id)_newDefaultLabel;	// IMP=0x000000000005f92f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000005f8c0
- (void)layoutSubviews;	// IMP=0x000000000005e45c
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000005e33a
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000005d3c1
