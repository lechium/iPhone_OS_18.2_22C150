...
- (void).cxx_destruct;	// IMP=0x00000000002d2b91
...
- (void)handleLabelTap:(id)arg1;	// IMP=0x00000000002d28a8
- (void)endAllAnimations;	// IMP=0x00000000002d2860
- (void)updateLabelFrame;	// IMP=0x00000000002d26ba
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000002d25db
- (void)viewDidLoad;	// IMP=0x00000000002d2388
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000002d2324
