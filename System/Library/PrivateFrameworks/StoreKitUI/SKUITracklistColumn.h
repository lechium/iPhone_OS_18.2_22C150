...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b7c2e
- (id)description;	// IMP=0x00000000000b7b5d
- (void)setPreferredWidthForAttributedStrings:(id)arg1;	// IMP=0x00000000000b78f6
