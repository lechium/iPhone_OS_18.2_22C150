...
- (void).cxx_destruct;	// IMP=0x00000000002b6026
...
- (id)description;	// IMP=0x00000000002b5f63
- (void)_setLinkItem:(id)arg1;	// IMP=0x00000000002b5f4d
- (id)artworkForSize:(struct CGSize)arg1;	// IMP=0x00000000002b5ea7
- (id)initWithComponentContext:(id)arg1;	// IMP=0x00000000002b5b83
