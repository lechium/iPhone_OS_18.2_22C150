...
- (void).cxx_destruct;	// IMP=0x00000000003aed7f
...
- (void)_setLogoImage:(id)arg1 forCharity:(id)arg2;	// IMP=0x00000000003aeb25
- (void)_finishLoadWithResponse:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000003ae752
- (void)removeObserver:(id)arg1;	// IMP=0x00000000003ae71b
- (id)logoImageForCharity:(id)arg1;	// IMP=0x00000000003ae6b8
- (void)loadLogoForCharity:(id)arg1;	// IMP=0x00000000003ae3a4
- (void)loadConfigurationWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000003adf6f
- (id)charityForIdentifier:(id)arg1;	// IMP=0x00000000003addaa
- (void)addObserver:(id)arg1;	// IMP=0x00000000003add04
- (id)initWithOperationQueue:(id)arg1 clientContext:(id)arg2;	// IMP=0x00000000003adc28
