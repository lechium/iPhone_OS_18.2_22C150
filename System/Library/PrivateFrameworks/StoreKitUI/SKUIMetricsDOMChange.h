...
- (id)description;	// IMP=0x00000000001b6c7d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b6b10
- (unsigned long long)hash;	// IMP=0x00000000001b6a07
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b67a0
- (id)initWithReportDomBuildTimesMessagePayload:(id)arg1;	// IMP=0x00000000001b6605
