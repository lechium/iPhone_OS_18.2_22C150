...
- (void).cxx_destruct;	// IMP=0x0000000000314ea6
...
- (void)_setLogoImage:(id)arg1 forCharity:(id)arg2;	// IMP=0x0000000000314be5
- (void)_setHeaderImage:(id)arg1 forTheme:(id)arg2;	// IMP=0x00000000003149df
- (void)_loadThemeImages;	// IMP=0x0000000000314593
- (void)_finishLoadAccountInfoWithResponse:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000003143db
- (void)_finishLoadWithResponse:(id)arg1 error:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000003132b9
- (void)removeObserver:(id)arg1;	// IMP=0x0000000000313282
- (id)logoImageForCharity:(id)arg1;	// IMP=0x000000000031321f
- (void)loadLogoForCharity:(id)arg1;	// IMP=0x0000000000312f0b
- (void)loadConfigurationWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000312ad6
- (_Bool)loadCachedConfiguration;	// IMP=0x0000000000312ace
- (id)charityForIdentifier:(id)arg1;	// IMP=0x0000000000312909
- (void)addObserver:(id)arg1;	// IMP=0x0000000000312863
- (id)initWithOperationQueue:(id)arg1 clientContext:(id)arg2;	// IMP=0x0000000000312787
