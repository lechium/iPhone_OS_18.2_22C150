...
- (void).cxx_destruct;	// IMP=0x0000000000158059
...
- (id)_urlByAppendingItemId:(id)arg1;	// IMP=0x0000000000157ee1
- (void)fetchURLsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000157ba1
- (id)initWithClientContext:(id)arg1 itemID:(id)arg2;	// IMP=0x0000000000157af5
- (id)init;	// IMP=0x0000000000157aae
