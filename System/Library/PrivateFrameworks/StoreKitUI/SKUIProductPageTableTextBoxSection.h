...
- (void).cxx_destruct;	// IMP=0x00000000002046d8
...
- (id)tableViewCellForTableView:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000002043e7
- (id)selectionActionForTableView:(id)arg1 indexPath:(id)arg2;	// IMP=0x0000000000204344
- (long long)numberOfRowsInSection;	// IMP=0x0000000000204339
- (double)heightForCellInTableView:(id)arg1 indexPath:(id)arg2;	// IMP=0x00000000002042c1
- (id)initWithClientContext:(id)arg1;	// IMP=0x0000000000204210
