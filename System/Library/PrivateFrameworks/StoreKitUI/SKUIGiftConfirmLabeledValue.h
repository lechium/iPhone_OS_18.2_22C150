...
- (void).cxx_destruct;	// IMP=0x00000000000b9280
@property(readonly, nonatomic) long long giftConfirmLabelStyle; // @synthesize giftConfirmLabelStyle=_style;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000b9180
- (void)layoutSubviews;	// IMP=0x00000000000b8a7d
@property(copy, nonatomic) NSString *value;
@property(copy, nonatomic) NSString *subtitleLabel;
@property(copy, nonatomic) NSString *label;
- (id)initWithGiftConfirmLabelStyle:(long long)arg1;	// IMP=0x00000000000b8177
