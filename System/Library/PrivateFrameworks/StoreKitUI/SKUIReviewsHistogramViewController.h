...
- (void).cxx_destruct;	// IMP=0x000000000021fb2e
@property(retain, nonatomic) SKUIReviewList *reviewList; // @synthesize reviewList=_reviewList;
@property(retain, nonatomic) SKUIClientContext *clientContext; // @synthesize clientContext=_clientContext;
- (void)_reloadHistogram;	// IMP=0x000000000021f857
- (id)_histogramView;	// IMP=0x000000000021f746
- (void)loadView;	// IMP=0x000000000021f6fa
