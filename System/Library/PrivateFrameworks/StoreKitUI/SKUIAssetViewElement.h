...
- (void).cxx_destruct;	// IMP=0x000000000037e71a
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000037e4e8
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x000000000037e0f5
