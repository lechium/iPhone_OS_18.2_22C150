...
- (void).cxx_destruct;	// IMP=0x0000000000203338
...
- (void)_setTitles:(id)arg1 forSegmentedControl:(id)arg2;	// IMP=0x00000000002031dd
- (void)_configureSegmentedControl:(id)arg1 withTitles:(id)arg2 boundingSize:(struct CGSize)arg3;	// IMP=0x0000000000202db7
- (void)_valueChangeAction:(id)arg1;	// IMP=0x0000000000202c38
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000202b82
- (void)layoutSubviews;	// IMP=0x0000000000202998
...
- (struct CGRect)frameForSegmentWithIndex:(long long)arg1;	// IMP=0x000000000020263b
- (void)cancelMoreList;	// IMP=0x0000000000202600
- (void)dealloc;	// IMP=0x00000000002025ac
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020246c
