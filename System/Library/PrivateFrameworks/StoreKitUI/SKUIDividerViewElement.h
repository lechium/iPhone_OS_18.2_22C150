...
- (void).cxx_destruct;	// IMP=0x000000000024509a
...
- (long long)pageComponentType;	// IMP=0x0000000000244f77
- (_Bool)isEnabled;	// IMP=0x0000000000244f62
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000244df8
