...
- (void).cxx_destruct;	// IMP=0x00000000001499f9
...
- (long long)pageComponentType;	// IMP=0x00000000001499cc
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000149902
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000149718
