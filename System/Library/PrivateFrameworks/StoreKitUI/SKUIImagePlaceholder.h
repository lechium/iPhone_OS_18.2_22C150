...
- (void).cxx_destruct;	// IMP=0x0000000000321c6a
...
- (id)initWithBackgroundColor:(id)arg1 borderColor:(id)arg2 borderWidth:(double)arg3 cornerPathBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000321b1b
- (id)initWithBackgroundColor:(id)arg1 borderColor:(id)arg2 borderWidth:(double)arg3 cornerRadius:(double)arg4;	// IMP=0x00000000003219e1
