...
- (void).cxx_destruct;	// IMP=0x00000000000ef033
...
- (void)_setTextLayoutCache:(id)arg1;	// IMP=0x00000000000eef68
- (void)_setResourceLoader:(id)arg1;	// IMP=0x00000000000eef24
- (void)_setPortraitPageWidth:(double)arg1;	// IMP=0x00000000000eef19
- (void)_setParentViewController:(id)arg1;	// IMP=0x00000000000eeee7
- (void)_setMetricsController:(id)arg1;	// IMP=0x00000000000eeea3
- (void)_setLayoutStyle:(long long)arg1;	// IMP=0x00000000000eee99
- (void)_setLandscapePageWidth:(double)arg1;	// IMP=0x00000000000eee8e
- (void)_setDefaultPinningTransitionStyle:(long long)arg1;	// IMP=0x00000000000eee84
- (void)_setColorScheme:(id)arg1;	// IMP=0x00000000000eee31
- (void)_setCollectionView:(id)arg1;	// IMP=0x00000000000eedde
- (void)_setActivePageWidth:(double)arg1;	// IMP=0x00000000000eedc1
- (void)_setActiveMetricsImpressionSession:(id)arg1;	// IMP=0x00000000000eedb0
...
- (id)init;	// IMP=0x00000000000eea0c
