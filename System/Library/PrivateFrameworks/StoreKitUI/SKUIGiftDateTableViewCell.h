...
- (void).cxx_destruct;	// IMP=0x000000000009a21a
...
- (id)_newLabel;	// IMP=0x000000000009a0be
- (id)_labelForDate:(id)arg1;	// IMP=0x0000000000099f69
- (id)_labelColor;	// IMP=0x0000000000099f2a
- (void)_datePickerEditingDidBegin;	// IMP=0x0000000000099e8e
- (void)_datePickerDateDidChange;	// IMP=0x0000000000099ddd
- (void)layoutSubviews;	// IMP=0x0000000000099768
@property(copy, nonatomic) NSString *placeholder;
@property(copy, nonatomic) NSString *label;
@property(retain, nonatomic) NSDate *date;
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000098d2b
