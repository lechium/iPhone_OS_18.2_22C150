...
- (void).cxx_destruct;	// IMP=0x00000000001fc463
@property(retain, nonatomic) SKUIColorScheme *colorScheme; // @synthesize colorScheme=_colorScheme;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001fc3ef
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001fc325
- (void)layoutSubviews;	// IMP=0x00000000001fbfb3
