...
- (void).cxx_destruct;	// IMP=0x0000000000361d3b
...
- (void)updateBackgroundImage;	// IMP=0x0000000000361c53
- (void)_setIsContainedInPopover:(_Bool)arg1;	// IMP=0x0000000000361c4d
- (void)_setFrame:(struct CGRect)arg1 forceUpdateBackgroundImage:(_Bool)arg2;	// IMP=0x0000000000361c3b
- (id)_currentCustomBackgroundRespectOversize_legacy:(_Bool *)arg1;	// IMP=0x0000000000361c33
- (id)_currentCustomBackground;	// IMP=0x0000000000361c2b
- (void)layoutSubviews;	// IMP=0x0000000000361b12
@property(copy, nonatomic) NSString *backdropGroupName;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000361848
