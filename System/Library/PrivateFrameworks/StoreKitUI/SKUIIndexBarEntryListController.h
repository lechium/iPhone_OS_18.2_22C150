...
+ (id)entryListControllerForEntryListViewElement:(id)arg1;	// IMP=0x006000000033b17c
+ (id)entryListControllerForEntryViewElement:(id)arg1;	// IMP=0x006000000033b0ef
- (void).cxx_destruct;	// IMP=0x000000000033b3e4
...
- (void)_didInvalidate;	// IMP=0x000000000033b31f
- (id)targetIndexBarEntryIDForEntryDescriptorAtIndex:(long long)arg1 returningRelativeSectionIndex:(out long long *)arg2;	// IMP=0x000000000033b2d4
- (void)reloadViewElementData;	// IMP=0x000000000033b28b
- (id)entryDescriptorAtIndex:(long long)arg1;	// IMP=0x000000000033b240
