...
- (void)invalidatePinningTransitionStyle;	// IMP=0x00000000002d09a6
- (void)invalidatePinningGroup;	// IMP=0x00000000002d0947
- (void)invalidatePinningStyle;	// IMP=0x00000000002d08e8
- (void)invalidatePinningContentInset;	// IMP=0x00000000002d087b
