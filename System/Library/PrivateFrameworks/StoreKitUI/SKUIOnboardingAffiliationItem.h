...
- (void).cxx_destruct;	// IMP=0x0000000000165e83
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000165cde
- (unsigned long long)hash;	// IMP=0x0000000000165c7a
- (id)description;	// IMP=0x0000000000165baa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000165a9c
