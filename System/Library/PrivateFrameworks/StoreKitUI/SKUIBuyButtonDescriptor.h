...
- (void).cxx_destruct;	// IMP=0x000000000033830f
...
- (_Bool)canPerformLocalActionWithItemState:(id)arg1;	// IMP=0x00000000003381f0
- (_Bool)canPersonalizeUsingItemState:(id)arg1;	// IMP=0x00000000003380b5
