...
- (void).cxx_destruct;	// IMP=0x00000000003a0401
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000003a02e8
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000003a025a
- (void)layoutSubviews;	// IMP=0x00000000003a0008
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000039fe85
