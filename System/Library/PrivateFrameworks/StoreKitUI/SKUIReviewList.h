...
- (void).cxx_destruct;	// IMP=0x000000000020f5a4
...
- (id)initWithCacheRepresentation:(id)arg1;	// IMP=0x000000000020f0f5
...
- (void)addReviews:(id)arg1;	// IMP=0x000000000020ecf4
- (id)initWithReviewListDictionary:(id)arg1;	// IMP=0x000000000020e9f6
