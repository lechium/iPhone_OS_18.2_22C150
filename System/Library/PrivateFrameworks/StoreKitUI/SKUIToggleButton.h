...
- (void).cxx_destruct;	// IMP=0x0000000000215ca1
...
- (void)itemStateCenter:(id)arg1 itemStateChanged:(id)arg2;	// IMP=0x00000000002158b3
- (id)_toggledLayout;	// IMP=0x0000000000215835
- (id)_titleAttributes;	// IMP=0x00000000002155bb
- (void)_showToggleState:(_Bool)arg1;	// IMP=0x000000000021534f
- (void)_sendWillAnimate;	// IMP=0x00000000002152c5
- (void)_sendDidAnimate;	// IMP=0x000000000021523b
- (id)_nonToggledLayout;	// IMP=0x00000000002151bd
- (id)_layoutForString:(id)arg1;	// IMP=0x00000000002150a5
- (void)setButtonTitleText:(id)arg1;	// IMP=0x0000000000214ffb
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000214d45
- (void)setToggled:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000214d27
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000214b8a
- (void)dealloc;	// IMP=0x0000000000214b15
- (id)init;	// IMP=0x0000000000214a44
