...
+ (id)supportedFeatures;	// IMP=0x00600000001250cc
...
- (id)_splitElementForIndex:(long long)arg1;	// IMP=0x00000000001251c6
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000012513e
...
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000124d92
