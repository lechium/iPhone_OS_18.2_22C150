...
- (void).cxx_destruct;	// IMP=0x0000000000238630
@property __weak SSVPlatformRequestOperation *underlyingOperation; // @synthesize underlyingOperation=_underlyingOperation;
- (void)cancel;	// IMP=0x0000000000238596
- (void)main;	// IMP=0x0000000000237fcc
- (id)initWithResourceRequest:(id)arg1;	// IMP=0x0000000000237f36
