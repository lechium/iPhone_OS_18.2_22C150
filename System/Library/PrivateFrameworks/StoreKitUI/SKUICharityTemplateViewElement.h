...
- (void).cxx_destruct;	// IMP=0x0000000000383585
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x0000000000383482
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000383333
