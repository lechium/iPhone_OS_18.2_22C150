...
+ (id)configurationWithTemplateElement:(id)arg1;	// IMP=0x00100000002e8689
- (void).cxx_destruct;	// IMP=0x00000000002e8e04
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002e8b9b
