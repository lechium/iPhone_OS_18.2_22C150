...
- (void).cxx_destruct;	// IMP=0x000000000035d75d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000035d665
- (id)HTTPBodyDictionary;	// IMP=0x000000000035d546
- (id)initWithAmountDictionary:(id)arg1;	// IMP=0x000000000035d357
