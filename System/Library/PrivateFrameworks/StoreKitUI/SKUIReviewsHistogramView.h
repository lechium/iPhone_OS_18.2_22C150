...
- (void).cxx_destruct;	// IMP=0x0000000000218dab
...
- (id)_countLabelString;	// IMP=0x0000000000218a65
- (id)_histogramImageForValues:(id)arg1;	// IMP=0x000000000021808e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000217f2d
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000217e77
- (void)layoutSubviews;	// IMP=0x0000000000217495
...
- (id)initWithClientContext:(id)arg1;	// IMP=0x0000000000215d67
