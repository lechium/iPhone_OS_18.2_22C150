...
+ (struct CGSize)sizeWithLayout:(id)arg1 treatment:(long long)arg2;	// IMP=0x001000000031b4cb
- (void).cxx_destruct;	// IMP=0x000000000031e07a
...
- (void)_setTouchInside:(_Bool)arg1;	// IMP=0x000000000031df83
- (void)_setTrackingTouch:(_Bool)arg1;	// IMP=0x000000000031df60
- (void)_reloadTopInset;	// IMP=0x000000000031ddce
- (void)tintColorDidChange;	// IMP=0x000000000031dd80
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000031d968
- (_Bool)_touchInsideLinkText:(struct CGPoint)arg1 linkTextRange:(struct _NSRange *)arg2;	// IMP=0x000000000031d7ac
- (void)_setupTapLocatorContainer;	// IMP=0x000000000031d61c
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000031be91
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000031be20
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000031bcce
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000031bc1f
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000031bb33
...
- (void)viewWasRecycled;	// IMP=0x000000000031b42a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000031b37c
