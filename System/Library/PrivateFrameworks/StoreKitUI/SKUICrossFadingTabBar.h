...
- (void).cxx_destruct;	// IMP=0x000000000022bde8
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000022b9d5
- (void)layoutSubviews;	// IMP=0x000000000022b6ff
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000022b5b8
