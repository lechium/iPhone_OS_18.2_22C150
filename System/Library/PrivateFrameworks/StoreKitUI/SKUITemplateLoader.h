...
- (void).cxx_destruct;	// IMP=0x00000000002236a0
...
- (void)load;	// IMP=0x00000000002233e8
- (void)_operationDidFinish:(id)arg1;	// IMP=0x00000000002231c2
- (void)_operation:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x0000000000223127
- (void)_operation:(id)arg1 didCompleteWithOutput:(id)arg2;	// IMP=0x0000000000222f02
- (id)_operationWithURL:(id)arg1;	// IMP=0x0000000000222bc7
- (id)initWithURLs:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000222a31
