...
- (void).cxx_destruct;	// IMP=0x00000000001838ac
...
- (void)_enumerateItemElementsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001836f1
- (long long)pageComponentType;	// IMP=0x00000000001836e6
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000018361c
@property(readonly, nonatomic) NSArray *segmentItemTitles;
@property(readonly, nonatomic) long long initialSelectedItemIndex;
- (void)dispatchEventOfType:(unsigned long long)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x000000000018337e
@property(readonly, nonatomic) SKUIDividerViewElement *bottomDivider;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000001831d2
