...
- (void).cxx_destruct;	// IMP=0x00000000002075b1
...
- (void)layoutSubviews;	// IMP=0x00000000002072e3
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000002071e2
- (id)description;	// IMP=0x000000000020712b
@property(readonly, nonatomic) UILabel *titleLabel;
- (void)setBackgroundImageAlpha:(double)arg1;	// IMP=0x0000000000206ecb
- (void)setBackgroundImage:(id)arg1;	// IMP=0x0000000000206e2a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000206cf7
