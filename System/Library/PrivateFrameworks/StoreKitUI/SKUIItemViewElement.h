...
- (void).cxx_destruct;	// IMP=0x00000000002d8db8
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000002d8cce
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000002d89f9
