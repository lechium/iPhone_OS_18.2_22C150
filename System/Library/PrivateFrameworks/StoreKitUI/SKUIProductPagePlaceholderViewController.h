...
- (void).cxx_destruct;	// IMP=0x00000000001f5d92
...
- (void)_addHeaderView;	// IMP=0x00000000001f5b10
@property(readonly, nonatomic) UIScrollView *scrollView;
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000001f5598
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000000001f554f
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000001f5506
- (void)loadView;	// IMP=0x00000000001f54ab
- (id)initWithStyle:(long long)arg1;	// IMP=0x00000000001f5420
