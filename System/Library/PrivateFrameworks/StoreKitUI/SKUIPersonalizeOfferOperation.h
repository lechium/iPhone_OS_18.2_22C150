...
- (void).cxx_destruct;	// IMP=0x00000000002769b2
- (void)main;	// IMP=0x00000000002763c2
@property(copy) CDUnknownBlockType outputBlock;
- (id)initWithItemIdentifier:(long long)arg1 clientContext:(id)arg2;	// IMP=0x00000000002760ab
