...
- (void).cxx_destruct;	// IMP=0x00000000001d04e9
...
- (void)_setDocument:(id)arg1;	// IMP=0x00000000001d0228
- (id)initWithDocument:(id)arg1 presentationOptions:(id)arg2;	// IMP=0x00000000001d0147
- (id)init;	// IMP=0x00000000001d0131
