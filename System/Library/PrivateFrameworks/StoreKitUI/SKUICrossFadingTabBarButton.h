...
- (void).cxx_destruct;	// IMP=0x000000000032b6c0
...
- (void)_positionBadge;	// IMP=0x000000000032b470
- (void)_setBadgeValue:(id)arg1;	// IMP=0x000000000032b2b3
- (void)tintColorDidChange;	// IMP=0x000000000032aec3
- (void)layoutSubviews;	// IMP=0x000000000032ab1b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000032a79d
