...
- (void).cxx_destruct;	// IMP=0x000000000039e0e3
...
- (void)presentViewController:(id)arg1 permittedArrowDirections:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x000000000039dc87
- (id)initWithViewController:(id)arg1;	// IMP=0x000000000039dbd9
