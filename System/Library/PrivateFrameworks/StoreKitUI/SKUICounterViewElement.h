...
- (void).cxx_destruct;	// IMP=0x00000000001665bb
...
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000001663b9
- (long long)currentNumberValue;	// IMP=0x00000000001662a0
@property(readonly, nonatomic) SKUIImageViewElement *backgroundImageElement;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0000000000165ed7
