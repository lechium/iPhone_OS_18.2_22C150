...
- (void).cxx_destruct;	// IMP=0x00000000002d6493
...
- (void)_reloadColumnViews;	// IMP=0x00000000002d5968
- (id)_headerViewWithViewControllers:(id)arg1;	// IMP=0x00000000002d571a
- (void)segmentedControl:(id)arg1 didSelectSegmentIndex:(long long)arg2;	// IMP=0x00000000002d56c3
- (void)_headerViewAction:(id)arg1;	// IMP=0x00000000002d561d
- (void)layoutSubviews;	// IMP=0x00000000002d4ed8
- (void)endColumnChangeAnimation;	// IMP=0x00000000002d4d7c
- (void)beginColumnChangeAnimationToNumberOfVisibleColumns:(long long)arg1;	// IMP=0x00000000002d4d06
- (void)dealloc;	// IMP=0x00000000002d4cbb
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002d49d2
