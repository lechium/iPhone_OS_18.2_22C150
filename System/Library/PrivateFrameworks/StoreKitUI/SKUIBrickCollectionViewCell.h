...
- (void).cxx_destruct;	// IMP=0x0000000000149692
...
- (void)_removeOverlay;	// IMP=0x00000000001495c1
- (void)_reloadHighlight;	// IMP=0x0000000000149335
- (void)layoutSubviews;	// IMP=0x0000000000149188
- (void)setBackgroundColor:(id)arg1;	// IMP=0x00000000001490be
@property(copy, nonatomic) NSString *title;
@property(retain, nonatomic) UIImage *itemImage;
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000148a35
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000001489a6
@property(retain, nonatomic) SKUICountdown *countdown;
- (void)setColoringWithColorScheme:(id)arg1;	// IMP=0x000000000014872f
