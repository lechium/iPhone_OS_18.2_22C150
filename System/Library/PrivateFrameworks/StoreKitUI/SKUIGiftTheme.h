...
- (void).cxx_destruct;	// IMP=0x00000000000b1546
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b13af
- (id)description;	// IMP=0x00000000000b131d
- (id)initWithThemeDictionary:(id)arg1;	// IMP=0x00000000000b0ff5
