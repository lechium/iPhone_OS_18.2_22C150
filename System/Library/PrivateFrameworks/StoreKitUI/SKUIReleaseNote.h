...
+ (id)dateFormatter;	// IMP=0x006000000020dcd4
- (void).cxx_destruct;	// IMP=0x000000000020dd2c
...
- (id)initWithReleaseNoteDictionary:(id)arg1 dateFormatter:(id)arg2;	// IMP=0x000000000020dad1
