...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000010a45e
- (void).cxx_destruct;	// IMP=0x000000000010aaef
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000010a7db
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000010a466
- (id)init;	// IMP=0x000000000010a3c7
