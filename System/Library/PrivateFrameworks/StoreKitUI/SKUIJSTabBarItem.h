...
- (void).cxx_destruct;	// IMP=0x00000000003080ed
...
- (void)dealloc;	// IMP=0x0000000000307c36
- (id)initWithAppContext:(id)arg1 navigationController:(id)arg2 tabBarItem:(id)arg3 owner:(id)arg4;	// IMP=0x00000000003079cf
