...
- (void).cxx_destruct;	// IMP=0x0000000000366228
...
- (void)viewDidLoad;	// IMP=0x0000000000365c6b
- (id)initWithTitle:(id)arg1 style:(unsigned long long)arg2;	// IMP=0x0000000000365bdb
