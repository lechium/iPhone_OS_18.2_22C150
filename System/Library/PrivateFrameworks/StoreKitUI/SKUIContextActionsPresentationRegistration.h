...
- (void).cxx_destruct;	// IMP=0x00000000000e86a3
...
- (void)_presentFromGestureRecognizer:(id)arg1;	// IMP=0x00000000000e83db
- (void)longPressGestureRecognizerTriggered:(id)arg1;	// IMP=0x00000000000e82a0
- (void)cleanupPreviewInteraction:(id)arg1;	// IMP=0x00000000000e8174
- (void)previewInteractionDidCancel:(id)arg1;	// IMP=0x00000000000e80d2
- (void)previewInteraction:(id)arg1 didUpdatePreviewTransition:(double)arg2 ended:(_Bool)arg3;	// IMP=0x00000000000e7e53
- (_Bool)previewInteractionShouldBegin:(id)arg1;	// IMP=0x00000000000e688f
- (void)dealloc;	// IMP=0x00000000000e6806
- (id)initWithViewController:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e6718
