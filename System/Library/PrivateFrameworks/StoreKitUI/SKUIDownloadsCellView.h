...
- (void).cxx_destruct;	// IMP=0x000000000032516d
...
- (void)layoutSubviews;	// IMP=0x0000000000324b5f
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000324aab
@property(nonatomic) double progress;
@property(retain, nonatomic) UIImage *image;
- (id)init;	// IMP=0x0000000000324212
