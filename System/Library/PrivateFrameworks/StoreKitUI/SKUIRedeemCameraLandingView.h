...
- (void).cxx_destruct;	// IMP=0x000000000030797c
@property(nonatomic) long long spacingStyle; // @synthesize spacingStyle=_spacingStyle;
@property(readonly, nonatomic) UIButton *button; // @synthesize button=_button;
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000307678
- (void)layoutSubviews;	// IMP=0x000000000030703d
@property(retain, nonatomic) UIImage *image;
- (id)initWithClientContext:(id)arg1;	// IMP=0x0000000000306903
