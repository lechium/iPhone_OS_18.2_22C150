...
- (void).cxx_destruct;	// IMP=0x00000000001769d0
@property(readonly, nonatomic) SKUILockupSwooshCellLayout *layout; // @synthesize layout=_layout;
- (void)configureForItem:(id)arg1 clientContext:(id)arg2;	// IMP=0x000000000017672b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000017663f
