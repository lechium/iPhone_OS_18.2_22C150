...
- (void)registerResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000071b8
- (void)_fulfillWithResult:(id)arg1;	// IMP=0x000000000000708d
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000006ff0
