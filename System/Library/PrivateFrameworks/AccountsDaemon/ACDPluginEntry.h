...
- (void).cxx_destruct;	// IMP=0x0000000000075803
@property(readonly, nonatomic) NSBundle *bundle; // @synthesize bundle=_bundle;
- (id)debugDescription;	// IMP=0x00000000000756d8
- (id)description;	// IMP=0x0000000000075635
- (_Bool)principalObjectRespondsToSelector:(SEL)arg1;	// IMP=0x0000000000075600
...
- (id)initWithBundle:(id)arg1;	// IMP=0x00000000000751e8
- (id)init;	// IMP=0x00000000000751bd
