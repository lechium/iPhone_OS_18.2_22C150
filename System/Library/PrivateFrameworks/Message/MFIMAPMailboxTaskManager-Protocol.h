...
@class ECLocalMessageAction, ECLocalMessageActionResults, EFFuture, MFLibraryMessage, MFMailMessage, MFMailMessageLibrary, MFMessageCriterion, MFMimePart, MFProgressFilterDataConsumer, MFUIDSet, NSArray, NSData, NSDictionary, NSSet, NSString;
