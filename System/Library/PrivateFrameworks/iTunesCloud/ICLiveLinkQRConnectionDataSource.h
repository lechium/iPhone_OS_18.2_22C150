...
+ (id)dataSourceForExistingSharedListeningSession:(id)arg1 identity:(id)arg2;	// IMP=0x00100000001a38e3
+ (id)dataSourceForNewSharedListeningSessionWithIdentity:(id)arg1;	// IMP=0x00100000001a3894
- (void).cxx_destruct;	// IMP=0x00000000001a08ea
...
- (id)sessionURLForBag:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001a00b9
- (void)_joinSharedListeningSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019fd27
- (void)_revokeUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019fbdc
- (void)_renewUserPseudonym;	// IMP=0x000000000019fa29
- (void)_beginPseudonymAutoRenewal;	// IMP=0x000000000019f895
- (void)_provisionUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019f084
- (void)populateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019efcc
- (void)dealloc;	// IMP=0x000000000019ef1a
- (id)initWithSharedListeningSessionIdentifier:(id)arg1 identity:(id)arg2;	// IMP=0x000000000019ee22
