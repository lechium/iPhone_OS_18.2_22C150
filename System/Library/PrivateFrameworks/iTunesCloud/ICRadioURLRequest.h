...
- (void).cxx_destruct;	// IMP=0x00000000001c5063
...
- (void)_decorateHeaderPropertiesForURLRequest:(id)arg1 withBuilderProperties:(id)arg2;	// IMP=0x00000000001c4d5a
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001c4b50
- (id)initWithURLRequest:(id)arg1 requestContext:(id)arg2;	// IMP=0x00000000001c4b0d
