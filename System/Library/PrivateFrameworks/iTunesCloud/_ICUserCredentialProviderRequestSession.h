...
- (void).cxx_destruct;	// IMP=0x00000000001ea829
...
- (id)description;	// IMP=0x00000000001ea6b9
- (id)initWithCredentialRequests:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001ea49e
