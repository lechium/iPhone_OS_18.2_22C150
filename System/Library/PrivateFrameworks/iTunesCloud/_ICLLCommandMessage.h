...
- (void).cxx_destruct;	// IMP=0x00000000000902a4
- (unsigned long long)hash;	// IMP=0x0000000000090134
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008febe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008fc85
- (void)writeTo:(id)arg1;	// IMP=0x000000000008fb23
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000008fb16
- (id)dictionaryRepresentation;	// IMP=0x000000000008f739
- (id)description;	// IMP=0x000000000008f68a
