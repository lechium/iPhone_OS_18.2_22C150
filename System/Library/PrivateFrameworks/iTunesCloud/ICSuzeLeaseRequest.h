...
- (void).cxx_destruct;	// IMP=0x0000000000134d88
...
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000134c1e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000134b54
- (id)initWithRequestContext:(id)arg1 requestType:(long long)arg2 leaseID:(id)arg3 mediaType:(long long)arg4 clientData:(id)arg5;	// IMP=0x0000000000134a47
