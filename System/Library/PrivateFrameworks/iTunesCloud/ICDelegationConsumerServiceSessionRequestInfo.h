...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000aa69e
- (unsigned long long)hash;	// IMP=0x00000000000aa690
- (id)initWithAccountID:(unsigned long long)arg1 fairPlaySessionID:(unsigned long long)arg2;	// IMP=0x00000000000aa648
