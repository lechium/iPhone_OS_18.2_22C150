...
- (void).cxx_destruct;	// IMP=0x0000000000019357
...
- (id)_xpcConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x0000000000019085
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (void)dealloc;	// IMP=0x0000000000018f43
- (id)initWithListenerEndpointProvider:(id)arg1;	// IMP=0x0000000000018ec3
