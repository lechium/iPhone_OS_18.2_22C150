...
- (void).cxx_destruct;	// IMP=0x00000000001c9b64
...
- (void)_addEvents:(id)arg1 toReportString:(id)arg2 eventLevel:(long long)arg3;	// IMP=0x00000000001c9756
@property(readonly, nonatomic) NSString *formattedReport;
- (void)endEvent:(id)arg1 withError:(id)arg2;	// IMP=0x00000000001c92fa
- (void)endEvent:(id)arg1;	// IMP=0x00000000001c92e6
- (void)startEvent:(id)arg1 withParentEvent:(id)arg2;	// IMP=0x00000000001c918a
- (void)startEvent:(id)arg1;	// IMP=0x00000000001c9176
- (id)init;	// IMP=0x00000000001c90f1
