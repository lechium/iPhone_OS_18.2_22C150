...
- (void).cxx_destruct;	// IMP=0x00000000001ed331
...
- (id)_xpcConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x00000000001ed0de
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (void)reportAppIconBadgeActionMetrics;	// IMP=0x00000000001ecf72
- (id)initWithListenerEndpointProvider:(id)arg1;	// IMP=0x00000000001ecef2
