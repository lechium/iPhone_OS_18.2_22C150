...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000cf4d1
- (void).cxx_destruct;	// IMP=0x00000000000cf493
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000cf356
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000cf1a7
- (void)lock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000cf13d
- (id)initWithIdentityStoreStyle:(long long)arg1;	// IMP=0x00000000000cf0ec
- (id)_initCommon;	// IMP=0x00000000000cf0b1
