...
- (void).cxx_destruct;	// IMP=0x000000000013e060
- (unsigned long long)hash;	// IMP=0x000000000013d000
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000013c1f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013b5f4
- (void)writeTo:(id)arg1;	// IMP=0x000000000013abfc
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000138f15
- (id)dictionaryRepresentation;	// IMP=0x0000000000137b6b
- (id)description;	// IMP=0x0000000000137abc
