...
- (void).cxx_destruct;	// IMP=0x000000000003e33b
- (unsigned long long)hash;	// IMP=0x000000000003e113
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003dd8f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003da6f
- (void)writeTo:(id)arg1;	// IMP=0x000000000003d84a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003d83d
- (id)dictionaryRepresentation;	// IMP=0x000000000003d2a1
- (id)description;	// IMP=0x000000000003d1f2
