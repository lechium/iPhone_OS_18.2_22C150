...
- (void)dispose;	// IMP=0x0000000000004927
- (_Bool)didProcessBarrierEventUUID:(id)arg1;	// IMP=0x000000000000480a
- (void)didProcessEventID:(unsigned long long)arg1;	// IMP=0x00000000000047fb
- (id)waitableBarrier;	// IMP=0x0000000000004475
@property(readonly, nonatomic) NSString *rootParent;
- (id)description;	// IMP=0x0000000000004419
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x0000000000004253
- (id)initWithPath:(id)arg1 fd:(int)arg2 reader:(id)arg3 sinceEventID:(unsigned long long)arg4 streamUUID:(id)arg5 ignoreOwnEvents:(_Bool)arg6 delegate:(id)arg7 purpose:(id)arg8;	// IMP=0x0000000000004122
