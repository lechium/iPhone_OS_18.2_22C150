...
@class AFSpeechInfoPackage, AFSpeechPackage, AFVoiceIdScoreCard, LBLocalSpeechRecognizerClient, NSArray, NSDictionary, NSError, NSString, SMTContinuityEnd, SMTMultiUserTRPCandidate, SMTTRPCandidate, SMTTRPDetected;
