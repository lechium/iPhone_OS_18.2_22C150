...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001031c
- (void)endObservingTerminal;	// IMP=0x00000000000102c2
- (void)beginObservingTerminal;	// IMP=0x0000000000010262
- (void)invalidateWithError:(id)arg1;	// IMP=0x00000000000100ee
- (void)broadcastTerminalNeedsToDismissPin:(id)arg1;	// IMP=0x0000000000010002
- (void)broadcastTerminal:(id)arg1 needsToDisplayPin:(id)arg2;	// IMP=0x000000000000fe89
- (void)broadcastTerminal:(id)arg1 hasPairedDeviceConnection:(id)arg2;	// IMP=0x000000000000fcb4
- (void)broadcastTerminal:(id)arg1 stoppedWithError:(id)arg2;	// IMP=0x000000000000fbeb
- (void)broadcastTerminal:(id)arg1 hasError:(id)arg2;	// IMP=0x000000000000fa89
- (void)broadcastTerminal:(id)arg1 didActivateWithError:(id)arg2;	// IMP=0x000000000000f9c4
- (void)invalidate;	// IMP=0x000000000000f957
- (void)startBroadcasting;	// IMP=0x000000000000f8bd
- (id)initWithPrimitives:(id)arg1;	// IMP=0x000000000000f815
- (void)dealloc;	// IMP=0x000000000000f7d7
