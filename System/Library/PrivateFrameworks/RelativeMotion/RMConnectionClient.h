...
- (void).cxx_destruct;	// IMP=0x0000000000008c58
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000008c37
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x0000000000008c1a
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x0000000000008a32
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x00000000000089c3
