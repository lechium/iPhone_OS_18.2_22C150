...
- (id <CRKClassKitQuery>)makeQueryForLocationsAllowingEasyStudentSignInForPersonID:(NSString *)arg1;
...
- (void)syncServerConfigWithCompletion:(void (^)(_Bool, NSError *))arg1;
