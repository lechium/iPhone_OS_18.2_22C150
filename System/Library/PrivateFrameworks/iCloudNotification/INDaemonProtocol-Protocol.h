...
@class ACAccount, CERuleConfiguration, ICQInlineTip, ICQLink, ICQRemoteContext, NSArray, NSDictionary, NSError, NSNumber, NSString, NSURLRequest;

@protocol INDaemonProtocol <NSObject>
- (void)sendStatusForRecommendationsWithAltDSID:(NSString *)arg1 configuration:(CERuleConfiguration *)arg2 params:(NSDictionary *)arg3 completion:(void (^)(NSError *))arg4;
...
- (void)getCacheDataForLink:(ICQLink *)arg1 completion:(void (^)(NSData *))arg2;
- (void)appLaunchLinkDidPresentForBundleIdentifier:(NSString *)arg1;
...
- (void)unregisterDeviceFromLoggedOutiCloudNotificationsWithReason:(unsigned long long)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (void)unregisterAccountWithID:(NSString *)arg1 fromiCloudNotificationsWithCompletion:(void (^)(_Bool, NSError *))arg2;
- (void)registerDeviceForLoggedOutiCloudNotificationsWithReason:(unsigned long long)arg1 completion:(void (^)(_Bool, NSError *))arg2;
