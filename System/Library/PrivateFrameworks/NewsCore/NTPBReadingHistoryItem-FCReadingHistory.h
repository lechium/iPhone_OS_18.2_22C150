...
+ (id)readValueFromKeyValuePair:(id)arg1;	// IMP=0x0010000000041ef4
+ (int)keyValuePairType;	// IMP=0x0010000000041ee9
- (void)writeToKeyValuePair:(id)arg1;	// IMP=0x0010000000041f09
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000040f90
