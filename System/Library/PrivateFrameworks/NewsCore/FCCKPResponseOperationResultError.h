...
- (void).cxx_destruct;	// IMP=0x00000000002f51cb
- (unsigned long long)hash;	// IMP=0x00000000002f50f5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002f4f87
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002f4e4b
- (void)writeTo:(id)arg1;	// IMP=0x00000000002f4d71
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002f4d64
- (id)dictionaryRepresentation;	// IMP=0x00000000002f484e
- (id)description;	// IMP=0x00000000002f479f
