...
@protocol NCContainerViewProviding, NCNotificationListComponent, PLExpandedPlatterInteractionAnimating, PLKeyboardHomeAffordanceAssertion, UIViewSpringAnimationBehaviorDescribing;

@protocol NCNotificationListComponentDelegate <NCNotificationListBaseComponentDelegate>

@optional
- (void)notificationListComponent:(id <NCNotificationListComponent>)arg1 didRemoveView:(UIView *)arg2;
- (void)notificationListComponent:(id <NCNotificationListComponent>)arg1 willRemoveView:(UIView *)arg2 bottomSpacing:(double)arg3;
- (void)notificationListComponent:(id <NCNotificationListComponent>)arg1 dismissPresentLongLookForRequst:(NCNotificationRequest *)arg2 animator:(id <PLExpandedPlatterInteractionAnimating>)arg3;
- (void)notificationListComponent:(id <NCNotificationListComponent>)arg1 willPresentLongLookForRequst:(NCNotificationRequest *)arg2 animator:(id <PLExpandedPlatterInteractionAnimating>)arg3;
- (void)notificationListComponent:(id <NCNotificationListComponent>)arg1 willRemoveNotificationRequest:(NCNotificationRequest *)arg2;
