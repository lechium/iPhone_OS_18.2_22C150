...
@class NSArray, NSDictionary, NSError, NSSet, NSString, TUConversation, TUConversationActivityEvent, TUConversationActivitySession, TUConversationLink, TUConversationMember, TUConversationNotice, TUConversationParticipant;
...
- (oneway void)activeParticipant:(TUConversationParticipant *)arg1 addedHighlightToConversation:(TUConversation *)arg2 highlightIdentifier:(NSString *)arg3 oldHighlightIdentifier:(NSString *)arg4 isFirstAdd:(_Bool)arg5;
