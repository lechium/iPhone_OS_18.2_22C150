...
- (void)removeLinkDescriptorsFromDataSourceWithPredicate:(NSPredicate *)arg1 reply:(void (^)(unsigned long long, NSError *))arg2;
- (void)removeConversationLinkDescriptorsWithPredicate:(NSPredicate *)arg1 deleteReason:(long long)arg2 reply:(void (^)(unsigned long long, NSError *))arg3;
