...
@class NSArray, NSDictionary, NSError, NSSet, NSString, NSUUID, TUConversation, TUConversationActivityEvent, TUConversationActivitySession, TUConversationLink, TUConversationMember, TUConversationNotice, TUConversationParticipant;
...
- (void)activeParticipant:(TUConversationParticipant *)arg1 addedHighlightToConversation:(TUConversation *)arg2 highlightIdentifier:(NSString *)arg3 oldHighlightIdentifier:(NSString *)arg4 isFirstAdd:(_Bool)arg5;
