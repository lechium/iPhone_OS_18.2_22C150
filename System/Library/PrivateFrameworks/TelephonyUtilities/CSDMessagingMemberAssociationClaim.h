...
- (void).cxx_destruct;	// IMP=0x000000000009e756
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000009e563
- (unsigned long long)hash;	// IMP=0x000000000009e460
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009e2bf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009e16b
- (void)copyTo:(id)arg1;	// IMP=0x000000000009e069
- (void)writeTo:(id)arg1;	// IMP=0x000000000009df65
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000009df58
- (id)dictionaryRepresentation;	// IMP=0x000000000009d951
- (id)description;	// IMP=0x000000000009d8a2
...
- (id)tuAssociationForHandle:(id)arg1;	// IMP=0x000000000002dd34
