...
- (struct CGPath *)bottomStrokePath;	// IMP=0x00000000000052f2
- (struct CGPath *)topStrokePath;	// IMP=0x00000000000051da
- (struct CGPath *)bottomStrokeLongPath;	// IMP=0x0000000000004fda
- (struct CGPath *)topStrokeLongPath;	// IMP=0x0000000000004dda
- (id)strokeLayerWithPath:(struct CGPath *)arg1 color:(struct CGColor *)arg2;	// IMP=0x0000000000004d0d
- (void)drawSolidShapeWithDuration:(double)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000045ab
- (void)drawSolidShape;	// IMP=0x00000000000043f9
- (void)removeTransparentShapeWithDuration:(double)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000000401d
- (void)drawTransparentShape;	// IMP=0x0000000000003c57
- (void)removeTransparentShape;	// IMP=0x0000000000003bb8
- (void)performFadeInIntroAnimation:(double)arg1 delay:(double)arg2;	// IMP=0x0000000000003888
- (void)performSDrawingAnimationWithDuration:(double)arg1 delay:(double)arg2;	// IMP=0x0000000000003720
- (void)performSDrawingIntroAnimation;	// IMP=0x00000000000036c9
- (void)skipIntroAnimation;	// IMP=0x0000000000003696
- (void)layoutSublayers;	// IMP=0x00000000000032d3
- (void)setup;	// IMP=0x0000000000002f2e
