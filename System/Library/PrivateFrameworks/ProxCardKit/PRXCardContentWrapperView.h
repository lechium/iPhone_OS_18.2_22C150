...
- (void).cxx_destruct;	// IMP=0x000000000000a198
...
- (void)didChangeContentsOfBottomTray:(id)arg1;	// IMP=0x0000000000009f87
@property(copy, nonatomic) NSArray *actionButtons;
@property(readonly, copy, nonatomic) NSArray *auxiliaryViews;
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000000009ac7
- (void)removeBottomTray;	// IMP=0x0000000000009a8a
- (void)setAuxiliaryButtonWithSymbolName:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000009616
- (void)scrollToBottom;	// IMP=0x00000000000091c0
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x000000000000915f
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000008f25
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000008e83
- (struct CGSize)systemLayoutSizeFittingSize:(struct CGSize)arg1 withHorizontalFittingPriority:(float)arg2 verticalFittingPriority:(float)arg3;	// IMP=0x0000000000008e00
- (void)layoutSubviews;	// IMP=0x0000000000008951
- (id)initWithContentView:(id)arg1;	// IMP=0x0000000000006e30
