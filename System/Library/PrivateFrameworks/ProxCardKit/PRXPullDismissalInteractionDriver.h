...
- (void)_finishPullToDismiss;	// IMP=0x0000000000013ad5
- (void)scrollViewDidEndDecelerating:(id)arg1;	// IMP=0x0000000000013ac3
- (void)scrollViewDidEndDragging:(id)arg1 willDecelerate:(_Bool)arg2;	// IMP=0x0000000000013aab
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000000013a4d
- (void)scrollViewWillBeginDragging:(id)arg1;	// IMP=0x0000000000013988
...
- (id)initWithPresentedViewController:(id)arg1 scrollView:(id)arg2;	// IMP=0x00000000000138a7
