...
+ (double)strokeWidth;	// IMP=0x0010000000011c50
+ (double)innerHoleRatio;	// IMP=0x0010000000011c42
- (void).cxx_destruct;	// IMP=0x0000000000013175
...
- (void)complete;	// IMP=0x00000000000130ff
- (void)reset;	// IMP=0x00000000000130ed
- (void)animateInitialIfNeeded;	// IMP=0x0000000000012ba6
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000012a3b
- (void)animateBorderFrom:(id)arg1 to:(id)arg2 duration:(double)arg3;	// IMP=0x00000000000128a3
- (void)animateToColors:(id)arg1 duration:(double)arg2;	// IMP=0x0000000000012568
- (id)innerHolePathForRatio:(double)arg1 stroke:(double)arg2;	// IMP=0x0000000000012441
- (void)completed;	// IMP=0x00000000000121f3
- (void)initial;	// IMP=0x0000000000011fc3
- (void)configure;	// IMP=0x0000000000011c5e
- (void)layoutSubviews;	// IMP=0x0000000000011a85
- (id)init;	// IMP=0x000000000001199b
