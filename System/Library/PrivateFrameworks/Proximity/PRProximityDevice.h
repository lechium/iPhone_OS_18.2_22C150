...
- (id).cxx_construct;	// IMP=0x0000000000025d65
- (void).cxx_destruct;	// IMP=0x0000000000025d1e
@property(readonly) NSUUID *peer; // @synthesize peer=_peer;
- (void)estimateProximity;	// IMP=0x00000000000258d6
- (long long)deviceProximity;	// IMP=0x00000000000258cc
- (_Bool)proxReady;	// IMP=0x00000000000258a1
- (void)addSample:(struct BtProxData)arg1;	// IMP=0x000000000002575f
- (id)initWithPeer:(id)arg1 andPeerModel:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000000025607
- (id)init;	// IMP=0x00000000000255c9
