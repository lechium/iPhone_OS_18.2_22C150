...
- (id).cxx_construct;	// IMP=0x00000000000293e4
- (void).cxx_destruct;	// IMP=0x0000000000029369
...
- (void)updateScoresWithNewMeasurement:(const void *)arg1;	// IMP=0x00000000000291f7
- (void)updateScoresForTime:(double)arg1;	// IMP=0x0000000000028e82
- (void)reportScoresToClientAlways:(_Bool)arg1 useUpdatedScoreList:(_Bool)arg2 currentMachContTime:(double)arg3;	// IMP=0x00000000000280bc
- (void)heartbeatTimeout:(double)arg1 currentMachContTime:(double)arg2 useUpdatedScores:(_Bool)arg3;	// IMP=0x0000000000027ff6
- (void)addBluetoothProximityEstimate:(struct NeighborMeasurements)arg1 currentMachContTime:(double)arg2;	// IMP=0x0000000000027f3a
- (void)addRoseSolutions:(id)arg1 currentMachContTime:(double)arg2;	// IMP=0x000000000002727a
- (void)createEstimators;	// IMP=0x00000000000271d4
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000000270c4
- (id)init;	// IMP=0x0000000000027086
