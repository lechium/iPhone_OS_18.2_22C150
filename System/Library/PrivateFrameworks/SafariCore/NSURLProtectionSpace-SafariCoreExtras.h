...
+ (id)safari_passkeySidecarProtectionSpaceForRelyingPartyIdentifier:(id)arg1;	// IMP=0x002000000005cb7b
+ (id)safari_HTMLFormProtectionSpaceForURL:(id)arg1;	// IMP=0x002000000005ca47
...
- (_Bool)isEqualToProtectionSpaceForPasswordManager:(id)arg1;	// IMP=0x001000000005d5fc
- (id)safari_creationDateOfCredentialWithUser:(id)arg1;	// IMP=0x001000000005d413
...
- (long long)safari_compareToHighLevelDomainFromProtectionSpace:(id)arg1;	// IMP=0x001000000005d022
- (long long)safari_compareToHighLevelDomainFromProtectionSpaceOrderingDecimalCharactersLast:(id)arg1;	// IMP=0x001000000005ce66
