...
- (void).cxx_destruct;	// IMP=0x00000000000aab6c
...
- (id)initWithProtectionSpace:(id)arg1 modificationDate:(id)arg2 creationDate:(id)arg3 persistentIdentifier:(id)arg4 isDefaultCredentialForProtectionSpace:(_Bool)arg5;	// IMP=0x00000000000aaa38
