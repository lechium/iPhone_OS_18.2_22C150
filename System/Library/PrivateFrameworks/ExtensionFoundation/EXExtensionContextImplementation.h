...
+ (id)_derivedExtensionAuxiliaryHostProtocolWithContextClass:(Class)arg1;	// IMP=0x00100000000106c3
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000106bb
+ (id)_extensionContextForIdentifier:(id)arg1;	// IMP=0x001000000001063d
+ (id)_extensionContextVendorProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x00100000000104ed
+ (id)_defaultExtensionContextVendorProtocol;	// IMP=0x0010000000010444
+ (id)_extensionContextHostProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x001000000001012e
+ (id)_extensionContextHostProtocolAllowedClassesForItems;	// IMP=0x00100000000100d7
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000013251
- (void)___nsx_pingHost:(CDUnknownBlockType)arg1;	// IMP=0x0000000000013246
- (void)_willPerformHostCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000000013018
@property(readonly, copy) NSString *description;
- (void)_openURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012d9c
- (void)_loadPreviewImageForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012bc7
- (void)_loadItemForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001280a
- (void)openURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012590
- (void)cancelRequestWithError:(id)arg1;	// IMP=0x00000000000122b6
- (void)completeRequestReturningItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000118f1
- (void)_completeRequestReturningItemsSecondHalf:(CDUnknownBlockType)arg1;	// IMP=0x00000000000118e6
- (_Bool)_isHost;	// IMP=0x00000000000118b3
- (void)dealloc;	// IMP=0x000000000001185e
- (void)invalidate;	// IMP=0x000000000001174a
- (void)_initializeAuxillaryConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x0000000000011235
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000111bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000111b1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001105d
- (id)initWithInputItems:(id)arg1 listenerEndpoint:(id)arg2 contextUUID:(id)arg3 extensionContext:(id)arg4;	// IMP=0x000000000001098b
