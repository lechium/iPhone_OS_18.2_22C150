...
- (void).cxx_destruct;	// IMP=0x00000000000030d4
...
- (void)layoutSubviews;	// IMP=0x0000000000002f58
- (void)creatScene;	// IMP=0x00000000000026c3
- (id)initWithExtensionProcess:(id)arg1 sessionUUID:(id)arg2 role:(id)arg3;	// IMP=0x00000000000025c0
