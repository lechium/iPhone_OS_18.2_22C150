...
- (void).cxx_destruct;	// IMP=0x000000000000f7f6
@property(retain) UIViewController *viewController; // @synthesize viewController=_viewController;
- (void)connectToSession:(id)arg1;	// IMP=0x000000000000f624
- (_Bool)shouldAcceptConnection:(id)arg1;	// IMP=0x000000000000f506
