...
- (void).cxx_destruct;	// IMP=0x0000000000003347
...
- (void)loadView;	// IMP=0x0000000000003202
- (id)initWithExtensionProcess:(id)arg1 sessionUUID:(id)arg2 role:(id)arg3;	// IMP=0x0000000000003138
