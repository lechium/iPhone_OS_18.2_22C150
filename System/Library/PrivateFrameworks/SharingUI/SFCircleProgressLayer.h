...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x006000000000b257
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000000b318
- (id)initWithLayer:(id)arg1;	// IMP=0x000000000000b06a
- (id)init;	// IMP=0x000000000000aef8
