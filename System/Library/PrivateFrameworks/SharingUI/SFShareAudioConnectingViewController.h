...
- (void).cxx_destruct;	// IMP=0x0000000000039d5c
...
- (void)_updateDeviceVisual:(id)arg1;	// IMP=0x0000000000039920
- (void)_updateForDeviceInfo;	// IMP=0x00000000000396a1
- (void)sessionProgressEvent:(int)arg1 info:(id)arg2;	// IMP=0x000000000003958d
- (void)eventCancel:(id)arg1;	// IMP=0x000000000003950a
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000000000394c1
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0000000000039423
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000392e4
