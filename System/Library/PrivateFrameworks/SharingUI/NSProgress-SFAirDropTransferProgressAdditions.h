...
+ (id)sf_transferStateAsString:(long long)arg1;	// IMP=0x002000000003278c
+ (id)sf_publishingKeyForApp:(id)arg1 sessionID:(id)arg2;	// IMP=0x0020000000032272
@property(readonly, nonatomic) NSString *sf_error;
- (void)sf_failedWithError:(id)arg1;	// IMP=0x001000000003290e
@property(nonatomic) long long sf_transferState;
@property(nonatomic) unsigned int sf_initiator;
- (id)sf_initWithFileURL:(id)arg1;	// IMP=0x0010000000032636
...
- (id)sf_initWithAppBundle:(id)arg1 sessionID:(id)arg2 andPersonRealName:(id)arg3;	// IMP=0x001000000003229a
@end
