...
- (void).cxx_destruct;	// IMP=0x000000000000a3b1
...
- (id)initWithRequestID:(int)arg1 identifier:(id)arg2 synchronous:(_Bool)arg3 resultHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000000a2ba
