...
- (id)description;	// IMP=0x000000000000c560
- (unsigned long long)hash;	// IMP=0x000000000000c510
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c440
- (id)initWithPlugIns:(id)arg1 extensionPointName:(id)arg2 forClient:(id)arg3;	// IMP=0x000000000000c2c0
