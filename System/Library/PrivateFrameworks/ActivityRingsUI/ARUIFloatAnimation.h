...
+ (id)animationWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x001000000001534a
...
- (void)completeAnimation;	// IMP=0x00000000000155de
- (_Bool)isAnimating;	// IMP=0x00000000000155c7
- (void)update:(double)arg1;	// IMP=0x000000000001552e
- (void)dealloc;	// IMP=0x00000000000154d0
- (id)initWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x00000000000153e2
