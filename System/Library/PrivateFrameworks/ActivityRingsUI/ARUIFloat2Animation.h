...
+ (id)animationWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x00100000000100db
- (void).cxx_destruct;	// IMP=0x000000000001046b
...
- (void)completeAnimation;	// IMP=0x0000000000010398
- (_Bool)isAnimating;	// IMP=0x0000000000010381
- (void)update:(double)arg1;	// IMP=0x00000000000102bf
- (void)dealloc;	// IMP=0x0000000000010261
- (id)initWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x0000000000010173
