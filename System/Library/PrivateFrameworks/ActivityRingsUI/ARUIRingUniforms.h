...
- (void)_updateUniformsWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x0000000000021137
- (void)_updateVertexAttributesWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x0000000000020c6a
- (void *)uniformsBytes;	// IMP=0x0000000000020c5d
- (void *)vertexAttributesBytes;	// IMP=0x0000000000020c53
- (id)initWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x0000000000020baf
