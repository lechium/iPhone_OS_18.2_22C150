...
- (void).cxx_destruct;	// IMP=0x0000000000357930
- (void)doneButtonTapped;	// IMP=0x00000000003578e0
- (void)startButtonTapped;	// IMP=0x00000000003578c0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003574b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000357480
