...
- (void).cxx_destruct;	// IMP=0x0000000000982c40
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000981a10
- (void)tintColorDidChange;	// IMP=0x0000000000981670
- (void)layoutSubviews;	// IMP=0x00000000009814c0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000981200
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009811d0
@property(nonatomic) _Bool highlighted;
- (_Bool)isHighlighted;	// IMP=0x0000000000980890
