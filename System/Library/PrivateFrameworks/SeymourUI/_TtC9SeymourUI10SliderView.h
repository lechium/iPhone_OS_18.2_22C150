...
- (void).cxx_destruct;	// IMP=0x000000000097fa50
- (void)panGestureRecognized:(id)arg1;	// IMP=0x000000000097f8b0
- (void)layoutSubviews;	// IMP=0x000000000097f050
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000097ee80
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000097ee50
