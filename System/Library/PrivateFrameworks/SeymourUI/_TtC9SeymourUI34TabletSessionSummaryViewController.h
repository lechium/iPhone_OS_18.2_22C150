...
- (void).cxx_destruct;	// IMP=0x00000000001b6a70
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000001b6a10
- (void)updateViewConstraints;	// IMP=0x00000000001b5970
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000001b58c0
- (void)ttrButtonTapped;	// IMP=0x00000000001b3360
- (void)shareButtonTapped;	// IMP=0x00000000001b3330
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000001b3300
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000001b31d0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b2fc0
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000001b8460
