...
+ (long long)activityCategory;	// IMP=0x0040000000993840
- (void).cxx_destruct;	// IMP=0x0000000000994de0
- (id)init;	// IMP=0x0000000000994d80
- (void)performActivity;	// IMP=0x0000000000993c70
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0000000000993990
