...
- (void).cxx_destruct;	// IMP=0x00000000005e8620
- (void)doneButtonTapped;	// IMP=0x00000000005e85d0
- (void)startButtonTapped;	// IMP=0x00000000005e85b0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005e8480
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005e8450
