...
- (void).cxx_destruct;	// IMP=0x000000000004ca27
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x000000000004c9c3
- (void)reset;	// IMP=0x000000000004c987
- (void)setOverlayImageOpacity:(double)arg1;	// IMP=0x000000000004c94e
@property(nonatomic, getter=isRotationEnabled) _Bool rotationEnabled;
- (void)handlePinchGesture:(id)arg1;	// IMP=0x000000000004c78d
- (void)handlePanGesture:(id)arg1;	// IMP=0x000000000004c540
- (void)handleRotateGesture:(id)arg1;	// IMP=0x000000000004c4ab
- (void)layoutSubviews;	// IMP=0x000000000004bfd8
- (id)initWithBackgroundImage:(id)arg1 overlayImage:(id)arg2 transform:(id)arg3;	// IMP=0x000000000004bd0b
