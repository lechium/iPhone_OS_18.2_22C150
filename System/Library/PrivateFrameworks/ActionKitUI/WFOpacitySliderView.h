...
- (void).cxx_destruct;	// IMP=0x000000000002ae63
...
- (void)reset;	// IMP=0x000000000002ada5
@property(readonly, nonatomic) double opacity;
- (void)didChangeOpacityValue:(id)arg1;	// IMP=0x000000000002ac89
- (void)layoutSubviews;	// IMP=0x000000000002a7e7
