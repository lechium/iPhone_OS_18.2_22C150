...
- (void).cxx_destruct;	// IMP=0x00000000000372c3
...
- (void)updateButtons;	// IMP=0x0000000000036fb9
- (void)updateFlipButton;	// IMP=0x0000000000036f12
- (void)flashValueChanged;	// IMP=0x0000000000036e62
- (void)cancelPressed;	// IMP=0x0000000000036d5c
- (void)flipPressed;	// IMP=0x0000000000036cbc
- (void)updatePhotosLabel;	// IMP=0x0000000000036a18
- (void)shutterPressed;	// IMP=0x0000000000036926
- (void)layoutSubviews;	// IMP=0x000000000003678a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000350e3
