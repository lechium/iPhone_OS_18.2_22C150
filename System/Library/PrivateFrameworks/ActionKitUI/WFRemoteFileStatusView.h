...
- (void).cxx_destruct;	// IMP=0x0000000000050b71
...
- (void)setError:(id)arg1;	// IMP=0x0000000000050915
- (void)setLoading;	// IMP=0x00000000000507a0
- (void)setEmptyWithLabel:(_Bool)arg1;	// IMP=0x00000000000505df
- (void)recoveryButtonTapped;	// IMP=0x0000000000050593
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004fe5e
