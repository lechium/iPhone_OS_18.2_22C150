...
- (void).cxx_destruct;	// IMP=0x000000000003f58b
...
- (void)cancelEditingImage;	// IMP=0x000000000003f3b4
- (void)finishEditingImage;	// IMP=0x000000000003ee8b
- (void)resetOverlayImageViewTransformations;	// IMP=0x000000000003ee4e
@property(nonatomic) _Bool rotationEnabled;
@property(nonatomic) _Bool opacitySliderVisible;
- (void)didChangeOpacity:(id)arg1;	// IMP=0x000000000003ebc4
- (_Bool)prefersStatusBarHidden;	// IMP=0x000000000003df99
- (id)editorBackgroundColor;	// IMP=0x000000000003df60
- (void)viewDidLoad;	// IMP=0x000000000003de5c
- (void)loadView;	// IMP=0x000000000003d9af
- (id)initWithFileRepresentations:(id)arg1 overlayImage:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000003d875
