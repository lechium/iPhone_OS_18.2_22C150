...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000f9cbc
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithL:(id)arg1 D:(id)arg2 I:(id)arg3 N:(id)arg4 W:(id)arg5 bi_lstm_0_h_in:(id)arg6 bi_lstm_0_c_in:(id)arg7 bi_lstm_0_h_in_rev:(id)arg8 bi_lstm_0_c_in_rev:(id)arg9;	// IMP=0x00000000000f9b39
- (id)initWithL:(id)arg1 D:(id)arg2 I:(id)arg3 N:(id)arg4 W:(id)arg5;	// IMP=0x00000000000f9a54
