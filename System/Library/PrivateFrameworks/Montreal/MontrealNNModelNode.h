...
- (void).cxx_destruct;	// IMP=0x000000000014d200
...
- (id)createDataContainer;	// IMP=0x000000000014cde0
- (void)generateJSONAtPath:(id)arg1;	// IMP=0x000000000014cc70
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014cb50
- (id)jsonDescription;	// IMP=0x000000000014c900
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000014c560
- (CDStruct_96916c69)parameters:(void *)arg1;	// IMP=0x000000000014c4c0
- (void)keepTensors:(id)arg1;	// IMP=0x000000000014c1d0
- (id)auditAndUpdateTensors:(id)arg1 dimensionTensors:(id)arg2;	// IMP=0x000000000014bdc0
- (id)initWithDictionary:(id)arg1 tensors:(id)arg2 quantization:(id)arg3 jsonDir:(id)arg4;	// IMP=0x000000000014b3e0
- (id)initWithName:(id)arg1 nodeStr:(id)arg2 activations:(id)arg3 properties:(id)arg4 weights:(id)arg5;	// IMP=0x000000000014b210
- (id)checkForValidity;	// IMP=0x000000000014afd0
