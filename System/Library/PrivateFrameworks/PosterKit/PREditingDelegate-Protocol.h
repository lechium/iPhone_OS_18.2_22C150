...
@class NSArray, NSString, PREditingLook, PREditingPosterContentStyleCoordinator, PREditor, PREditorColorPickerConfiguration, PREditorContentStylePickerConfiguration, PRPosterTransition, PRTimeFontConfiguration;
...
- (PREditorContentStylePickerConfiguration *)titleContentStylePickerConfigurationForEditor:(PREditor *)arg1;
- (_Bool)editorShouldAllowUserToAdjustTimeColor:(PREditor *)arg1;
- (_Bool)editorShouldAllowUserToAdjustTitleContentStyle:(PREditor *)arg1;
