...
- (void).cxx_destruct;	// IMP=0x000000000014bef7
...
- (id)accountForAlias:(id)arg1;	// IMP=0x000000000014be56
- (id)initWithAccountIdentity:(id)arg1 aliasToAccountsMap:(id)arg2 serviceName:(id)arg3;	// IMP=0x000000000014bd9e
