...
- (void).cxx_destruct;	// IMP=0x000000000000aae1
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000000a0b7
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000000a09a
- (id)initWithProtocol:(id)arg1 ivarQueue:(id)arg2 remoteMessageQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000009fa9
- (id)initWithProtocol:(id)arg1 ivarQueue:(id)arg2 remoteMessageQueue:(id)arg3;	// IMP=0x0000000000009f94
