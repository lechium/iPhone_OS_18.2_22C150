...
+ (_Bool)isDirectMessagingRequested:(id)arg1;	// IMP=0x006000000000e5ef
...
- (void)logConnectionStatisticsInPowerDictionary;	// IMP=0x00000000000145a4
- (void)startPowerLogReportTimer;	// IMP=0x0000000000014477
- (void)clearPowerAssertion;	// IMP=0x000000000001441c
- (void)getPowerAssertion;	// IMP=0x0000000000014295
- (void)dequeueMessages;	// IMP=0x0000000000013e16
- (void)sendMessageWithParameters:(id)arg1 options:(id)arg2;	// IMP=0x0000000000012fde
- (void)failedToSendMessage:(id)arg1 responseCode:(long long)arg2;	// IMP=0x0000000000012d85
- (void)suspendPendingAckTimer;	// IMP=0x0000000000012d5d
- (void)resumePendingAckTimer;	// IMP=0x0000000000012d35
- (void)cancelPendingAckTimer;	// IMP=0x0000000000012cf4
- (id)createDispatchDataForMessageSend:(id)arg1 isAck:(_Bool)arg2 ackMessageId:(unsigned int)arg3;	// IMP=0x00000000000122c8
- (unsigned char)getMessageTypeForFirstMessage;	// IMP=0x000000000001211a
- (void)sendAppAckWithGUID:(id)arg1;	// IMP=0x000000000001180b
- (void)sendAckForMessageID:(unsigned int)arg1 guidToAck:(id)arg2;	// IMP=0x000000000001152f
- (void)processIncomingMessage:(id)arg1 messageType:(unsigned char)arg2 messageIdentifier:(unsigned int)arg3;	// IMP=0x0000000000010564
- (void)receiveMessages;	// IMP=0x0000000000010040
- (void)setupConnectionIfApplicable;	// IMP=0x000000000000ffed
- (void)receivedDirectMessagingSocketWithContext:(id)arg1;	// IMP=0x000000000000fc24
- (void)setupIDSDeviceConnection;	// IMP=0x000000000000f755
- (void)updateTrafficClass:(unsigned short)arg1;	// IMP=0x000000000000f73d
- (void)updateConnection:(id)arg1;	// IMP=0x000000000000f47b
- (void)resetConnection;	// IMP=0x000000000000f373
- (void)updateMetadata:(id)arg1;	// IMP=0x000000000000eeca
- (void)updateConnectedDevices:(id)arg1;	// IMP=0x000000000000ea7b
- (_Bool)isMessageEligible:(id)arg1 options:(id)arg2 destinationDevice:(id)arg3;	// IMP=0x000000000000e6d2
- (_Bool)canUseDirectMessaging;	// IMP=0x000000000000e5d8
- (void)setDestinationDevice:(id)arg1;	// IMP=0x000000000000e451
- (void)invalidate;	// IMP=0x000000000000e355
- (void)cancel;	// IMP=0x000000000000e294
- (id)description;	// IMP=0x000000000000e201
- (void)dealloc;	// IMP=0x000000000000e0ff
- (void)parseDirectMessagingState;	// IMP=0x000000000000df7c
- (id)initWithServiceName:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000000000dc60
