...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000d03d
- (void).cxx_destruct;	// IMP=0x000000000000d0b5
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000cf1b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000ce6b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000cda3
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
@property(readonly, copy) NSString *description;
- (id)initWithBase64EncodedString:(id)arg1 shardType:(long long)arg2 startIndex:(long long)arg3 shardCount:(long long)arg4 expirationDate:(id)arg5;	// IMP=0x000000000000cb0f
