...
#import <HealthDaemonFoundation/HDSQLiteEntitySchema-Protocol.h>
...
- (_Bool)getValuesForProperties:(NSArray *)arg1 database:(HDSQLiteDatabase *)arg2 error:(id *)arg3 handler:(void (^)(NSArray *, void *))arg4;
- (_Bool)getValuesForProperties:(NSArray *)arg1 database:(HDSQLiteDatabase *)arg2 handler:(void (^)(NSArray *, void *))arg3;
