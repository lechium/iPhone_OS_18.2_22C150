...
- (void)configureSleepFocusWithState:(unsigned long long)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (void)deleteSleepFocusModeWithCompletion:(void (^)(_Bool, NSError *))arg1;
- (void)createSleepFocusInState:(unsigned long long)arg1 completion:(void (^)(_Bool, NSError *))arg2;
...
- (void)getSleepScheduleModelWithCompletion:(void (^)(HKSPSleepScheduleModel *, NSError *))arg1;
