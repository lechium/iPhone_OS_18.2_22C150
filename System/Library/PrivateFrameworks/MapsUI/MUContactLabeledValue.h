...
- (void).cxx_destruct;	// IMP=0x000000000012c968
...
- (id)initWithContactLabeledValue:(id)arg1 type:(long long)arg2;	// IMP=0x000000000012c7f3
- (id)glyphName;	// IMP=0x000000000012c7ca
