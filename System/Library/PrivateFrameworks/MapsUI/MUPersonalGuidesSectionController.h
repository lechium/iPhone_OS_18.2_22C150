...
- (void).cxx_destruct;	// IMP=0x00000000000b0199
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
- (_Bool)isImpressionable;	// IMP=0x00000000000b0181
- (int)analyticsModuleType;	// IMP=0x00000000000b0176
- (_Bool)verticalCardContainerView:(id)arg1 shouldHighlightRowAtIndex:(unsigned long long)arg2;	// IMP=0x00000000000b016e
- (void)verticalCardContainerView:(id)arg1 didSelectRow:(id)arg2 atIndex:(unsigned long long)arg3;	// IMP=0x00000000000aff3a
...
- (void)reloadCollectionsAnimated:(_Bool)arg1;	// IMP=0x00000000000af4af
- (void)_setupSectionView;	// IMP=0x00000000000af28e
- (id)initWithMapItem:(id)arg1 collectionViewProvider:(id)arg2;	// IMP=0x00000000000af143
