...
- (void).cxx_destruct;	// IMP=0x00000000000e8873
...
- (id)initWithTrailHead:(id)arg1;	// IMP=0x00000000000e87f0
- (id)initWithRelatedPlaceList:(id)arg1;	// IMP=0x00000000000e87d6
- (id)initWithDataSource:(long long)arg1 relatedPlaceList:(id)arg2 trailHead:(id)arg3;	// IMP=0x00000000000e8734
