...
- (void).cxx_destruct;	// IMP=0x0000000000161826
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016164a
- (unsigned long long)hash;	// IMP=0x0000000000161594
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000161543
- (id)initWithNativeControllerName:(id)arg1 webControllerName:(id)arg2 bridgeVersion:(id)arg3;	// IMP=0x000000000016145a
