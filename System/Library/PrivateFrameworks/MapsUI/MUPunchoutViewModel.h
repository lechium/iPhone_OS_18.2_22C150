...
+ (id)viewModelForFullScreenGallery;	// IMP=0x00600000000b3690
+ (id)viewModelForAddPhotos;	// IMP=0x00600000000b361a
+ (id)viewModelForVendorName:(id)arg1;	// IMP=0x00600000000b3550
- (void).cxx_destruct;	// IMP=0x00000000000b3757
