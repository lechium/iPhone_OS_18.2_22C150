...
- (void).cxx_destruct;	// IMP=0x0000000000146b80
...
- (void)addExternalActionsAsSupportedActions:(id)arg1;	// IMP=0x00000000001459f9
- (void)contextMenuAction:(id)arg1;	// IMP=0x0000000000145981
- (void)getAppAction:(id)arg1;	// IMP=0x00000000001458d4
- (void)addPhotoAction:(id)arg1;	// IMP=0x000000000014581d
- (void)ratePlaceAction:(id)arg1;	// IMP=0x0000000000145769
- (void)directionsAction:(id)arg1;	// IMP=0x00000000001456bc
- (void)layoutActionsUsingArguments:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000144ef1
- (void)performActionUsingArguments:(id)arg1 contextMenu:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001431c2
- (id)adamIDForAppCategory:(id)arg1;	// IMP=0x0000000000143055
- (void)configureWithEnrichmentDataProvider:(id)arg1 presentationOptions:(id)arg2;	// IMP=0x0000000000142ed5
- (id)dictionaryForAction:(id)arg1;	// IMP=0x0000000000142ec0
- (id)supportedPlaceEnrichmentActions;	// IMP=0x0000000000142967
- (id)initWithPlaceActionManager:(id)arg1 mapItem:(id)arg2 dataAvailability:(id)arg3 amsResultProvider:(id)arg4 callToActionDelegate:(id)arg5 contextMenuDelegate:(id)arg6 externalActionHandler:(id)arg7 analyticsDelegate:(id)arg8 onActionUpdate:(CDUnknownBlockType)arg9;	// IMP=0x00000000001427ac
