...
- (void).cxx_destruct;	// IMP=0x00000000000be179
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bdea1
- (id)description;	// IMP=0x00000000000bee70
@property(readonly, copy, nonatomic) NSDictionary *JSONObject;
- (id)initWithJSONObject:(id)arg1;	// IMP=0x00000000000be1ee
