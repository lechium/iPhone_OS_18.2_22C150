...
+ (id)managedHandlesForHandles:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0080000000011c66
+ (id)managedHandleForHandle:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x00800000000119fc
+ (id)fetchRequest;	// IMP=0x0080000000013c53
- (id)copyWithContext:(id)arg1;	// IMP=0x0000000000011f35
