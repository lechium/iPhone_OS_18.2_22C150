...
- (void).cxx_destruct;	// IMP=0x000000000004043c
...
- (void)dealloc;	// IMP=0x00000000000403cc
- (id)initWithName:(id)arg1 queue:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x00000000000401e0
