...
- (void).cxx_destruct;	// IMP=0x00000000003c2cc6
...
- (id)description;	// IMP=0x00000000003c2b93
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x00000000003c2ab8
