...
+ (id)logCategory;	// IMP=0x0010000000c442c7
- (void).cxx_destruct;	// IMP=0x0000000000c44057
...
- (void)handleServicesUpdated:(id)arg1;	// IMP=0x0000000000c43f21
- (void)handleCharacteristicsUpdated:(id)arg1;	// IMP=0x0000000000c43eb0
- (void)_notifyDelegate;	// IMP=0x0000000000c43cc2
- (id)_accessoryCharacteristicsToObserve;	// IMP=0x0000000000c438fd
- (void)_registerForNotifications;	// IMP=0x0000000000c43815
- (void)start;	// IMP=0x0000000000c437b5
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 interestedCharacteristicTypesByServiceType:(id)arg3;	// IMP=0x0000000000c435d3
