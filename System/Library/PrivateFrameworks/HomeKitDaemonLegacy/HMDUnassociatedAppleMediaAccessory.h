...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000034f862
+ (id)logCategory;	// IMP=0x001000000034f832
+ (id)namespace;	// IMP=0x001000000034f802
- (void).cxx_destruct;	// IMP=0x000000000034f75a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000034f324
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000034f00a
- (id)logIdentifier;	// IMP=0x000000000034eff8
- (id)dumpDescription;	// IMP=0x000000000034edde
- (_Bool)canPairGivenCapabilities:(unsigned long long)arg1;	// IMP=0x000000000034ec55
- (id)addTransactionForHome:(id)arg1;	// IMP=0x000000000034e85b
...
- (id)descriptionWithPointer:(_Bool)arg1 additionalDescription:(id)arg2;	// IMP=0x000000000034e362
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 requiredPairingCapabilities:(unsigned long long)arg4 minimumPairingSoftware:(id)arg5 productColor:(long long)arg6 idsIdentifierString:(id)arg7 rawAccessoryCapabilities:(id)arg8 rawResidentCapabilities:(id)arg9 messageDispatcher:(id)arg10;	// IMP=0x000000000034e177
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 productColor:(long long)arg4 idsIdentifierString:(id)arg5 rawAccessoryCapabilities:(id)arg6 rawResidentCapabilities:(id)arg7 messageDispatcher:(id)arg8;	// IMP=0x000000000034e137
- (id)modelForChangeType:(unsigned long long)arg1 uuid:(id)arg2 parentUUID:(id)arg3;	// IMP=0x000000000034e11e
