...
+ (void)configureKeyedArchiverClassMappings;	// IMP=0x0010000000501a5a
- (void).cxx_destruct;	// IMP=0x000000000050193b
...
- (id)homeWithUUID:(id)arg1;	// IMP=0x000000000050149d
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000501449
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000050143e
