...
- (void).cxx_destruct;	// IMP=0x0000000000b5c7bb
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b5c36f
- (void)stop;	// IMP=0x0000000000b5c2c5
- (void)start;	// IMP=0x0000000000b5c14c
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b5c07e
- (id)initWithHome:(id)arg1 accessory:(id)arg2 linkType:(long long)arg3;	// IMP=0x0000000000b5bf5d
