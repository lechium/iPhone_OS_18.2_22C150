...
+ (id)tupleForMessage:(id)arg1 originalRequestIdentifier:(id)arg2 requestCount:(unsigned long long)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00600000000e284b
- (void).cxx_destruct;	// IMP=0x00000000000e27e7
...
- (id)retrieveAndClearLatestResponses;	// IMP=0x00000000000e263e
- (id)retrieveAndClearAllResponses;	// IMP=0x00000000000e2588
- (void)addResponsesToPendingResponse:(id)arg1;	// IMP=0x00000000000e24b8
- (void)addToPendingResponses:(id)arg1;	// IMP=0x00000000000e23f0
- (id)description;	// IMP=0x00000000000e232f
