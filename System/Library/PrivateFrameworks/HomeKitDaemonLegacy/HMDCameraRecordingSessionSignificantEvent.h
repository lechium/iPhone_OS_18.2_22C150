...
- (void).cxx_destruct;	// IMP=0x000000000006897c
...
- (id)attributeDescriptions;	// IMP=0x000000000006831b
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006816b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000068160
- (unsigned long long)hash;	// IMP=0x000000000006811c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000067d95
- (id)initWithUUID:(id)arg1;	// IMP=0x0000000000067c6f
