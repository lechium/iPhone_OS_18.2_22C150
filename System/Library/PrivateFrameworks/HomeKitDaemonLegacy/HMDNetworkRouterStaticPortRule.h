...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000528d8c
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x00100000004ac1bc
- (void).cxx_destruct;	// IMP=0x0000000000528d38
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005285a9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000528477
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000527e10
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000005277f9
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 protocol:(id)arg3 destinationIPAddress:(id)arg4 destinationPortStart:(id)arg5 destinationPortEnd:(id)arg6;	// IMP=0x00000000005276d2
- (id)init;	// IMP=0x00000000005276a3
- (void)addTo:(id)arg1;	// IMP=0x00000000004aabd8
