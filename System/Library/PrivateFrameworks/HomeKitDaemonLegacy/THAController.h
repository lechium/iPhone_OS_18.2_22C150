...
+ (id)selectButtonConfiguration:(id)arg1 supportsSiri:(_Bool)arg2;	// IMP=0x00600000007975c8
- (void).cxx_destruct;	// IMP=0x00000000007975a0
...
- (_Bool)dispatchButtonEvent:(id)arg1;	// IMP=0x00000000007974dc
- (void)updateSelectedButtons:(id)arg1;	// IMP=0x00000000007974ca
- (id)initWithName:(id)arg1 identifier:(unsigned int)arg2 ticksPerSecond:(unsigned long long)arg3 supportedButtons:(id)arg4 supportsSiri:(_Bool)arg5;	// IMP=0x00000000007973df
