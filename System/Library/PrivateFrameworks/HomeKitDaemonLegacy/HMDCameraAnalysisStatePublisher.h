...
@interface HMDCameraAnalysisStatePublisher : HMFObject <HMFMessageReceiver>
{
...
+ (id)logCategory;	// IMP=0x001000000032028c
- (void).cxx_destruct;	// IMP=0x000000000031ff67
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000031fe27
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)stateManager:(id)arg1 didReceiveLocalUpdate:(id)arg2;	// IMP=0x000000000031fc32
- (void)_handleRemoteAnalysisStateUpdate:(id)arg1;	// IMP=0x000000000031f973
- (void)_publishAnalysisStateUpdate;	// IMP=0x000000000031f60b
- (void)_processStateUpdate:(id)arg1;	// IMP=0x000000000031f4a5
- (void)configureWithHome:(id)arg1;	// IMP=0x000000000031f27e
- (id)initWithHomeMessagingContext:(id)arg1 analysisStateManager:(id)arg2 workQueue:(id)arg3 cameraAnalysisStatePublisherDebounceTimer:(id)arg4;	// IMP=0x000000000031f194
- (id)initWithHome:(id)arg1;	// IMP=0x000000000031f09e
