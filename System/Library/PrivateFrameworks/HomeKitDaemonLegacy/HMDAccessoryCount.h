...
- (void).cxx_destruct;	// IMP=0x00000000004fff49
@property __weak HMDHome *home; // @synthesize home=_home;
- (unsigned long long)numHAPAccessoriesWithAnyServiceWithTypes:(id)arg1;	// IMP=0x00000000004ffd90
...
- (id)initWithHome:(id)arg1;	// IMP=0x00000000004ff984
