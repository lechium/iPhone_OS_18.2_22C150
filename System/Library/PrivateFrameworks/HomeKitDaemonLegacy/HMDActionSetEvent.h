...
- (void).cxx_destruct;	// IMP=0x000000000060a2db
...
- (id)initWithActionSet:(id)arg1 source:(unsigned long long)arg2 numAccessories:(unsigned int)arg3 bundleId:(id)arg4 transactionId:(id)arg5;	// IMP=0x0000000000609d4a
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x000000000004bcde
