...
- (void).cxx_destruct;	// IMP=0x00000000002ed8c9
...
- (id)attributeDescriptions;	// IMP=0x00000000002ed69f
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4;	// IMP=0x00000000002ed5a2
