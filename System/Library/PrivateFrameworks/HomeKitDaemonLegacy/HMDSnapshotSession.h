...
+ (id)logCategory;	// IMP=0x00100000007b13d8
- (void).cxx_destruct;	// IMP=0x00000000007b1374
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x00000000007b0e8a
- (void)dealloc;	// IMP=0x00000000007b0e0e
- (id)logIdentifier;	// IMP=0x00000000007b0dbe
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x00000000007b0be7
