...
+ (id)supportedEventClasses;	// IMP=0x0010000000c34b2b
- (void).cxx_destruct;	// IMP=0x0000000000c3473d
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000c3456a
- (void)checkNetworkChange;	// IMP=0x0000000000c34085
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000c33fca
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000c33f0f
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x0000000000c339c3
- (void)runDailyTask;	// IMP=0x0000000000c334b3
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000c333ea
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x0000000000c331eb
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x0000000000c32f6f
- (void)_clearNonPersistentCounters;	// IMP=0x0000000000c32eac
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x0000000000c32d76
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x0000000000c32c96
- (void)_handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x0000000000c32ae1
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x0000000000c329fa
- (void)stop;	// IMP=0x0000000000c32868
- (void)start;	// IMP=0x0000000000c3262a
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 wifiManager:(id)arg6 notificationCenter:(id)arg7 changeDebounceTimer:(id)arg8 tickBlock:(CDUnknownBlockType)arg9;	// IMP=0x0000000000c32432
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000c322ca
