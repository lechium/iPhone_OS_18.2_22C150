...
+ (id)logCategory;	// IMP=0x00100000007827f8
- (void).cxx_destruct;	// IMP=0x0000000000782794
...
- (void)dealloc;	// IMP=0x00000000007825f2
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000782461
