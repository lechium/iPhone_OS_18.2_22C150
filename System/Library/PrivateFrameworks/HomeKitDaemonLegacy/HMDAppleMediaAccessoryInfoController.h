...
+ (id)logCategory;	// IMP=0x006000000047aa2e
- (void).cxx_destruct;	// IMP=0x0000000000479b3b
...
- (void)_notifyDelegateWifiInfoUpdated:(id)arg1;	// IMP=0x000000000047987e
- (void)_postUpdateSoftwareVersionIfDifferent:(id)arg1;	// IMP=0x00000000004796f7
- (void)_postUpdateWifiNetworkInfoIfDifferent:(id)arg1;	// IMP=0x0000000000479538
- (id)currentWifiNetworkInfo;	// IMP=0x0000000000479367
- (void)handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x00000000004790fc
- (void)configure;	// IMP=0x0000000000478f74
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2 delegate:(id)arg3 notificationCenter:(id)arg4 wifiManager:(id)arg5;	// IMP=0x0000000000478e71
