...
+ (id)logCategory;	// IMP=0x0010000000789dbb
+ (double)timeout;	// IMP=0x0010000000789cdd
- (void).cxx_destruct;	// IMP=0x0000000000789848
...
- (id)logIdentifier;	// IMP=0x0000000000789719
- (void)main;	// IMP=0x000000000078929d
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x0000000000789123
