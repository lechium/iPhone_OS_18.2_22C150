...
- (void).cxx_destruct;	// IMP=0x000000000023ff5f
...
- (id)mainReturningError;	// IMP=0x000000000023f8e1
- (id)initWithGroup:(id)arg1 records:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000023f801
- (id)initWithGroup:(id)arg1 parentUuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000023f721
- (id)initWithGroup:(id)arg1 uuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000023f641
