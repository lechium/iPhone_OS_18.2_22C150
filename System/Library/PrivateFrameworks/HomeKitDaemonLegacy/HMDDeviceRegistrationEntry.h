...
- (void).cxx_destruct;	// IMP=0x00000000000e2eab
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e2db1
- (id)initWithDevice:(id)arg1 accessoryList:(id)arg2;	// IMP=0x00000000000e2d0f
