...
- (void).cxx_destruct;	// IMP=0x00000000004b7f48
...
- (id)initWithAction:(id)arg1 characteristicWriteRequests:(id)arg2;	// IMP=0x00000000004b7e7a
- (id)init;	// IMP=0x00000000004b7dd2
