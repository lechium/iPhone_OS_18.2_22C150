...
+ (id)hmdErrorWithCode:(long long)arg1;	// IMP=0x00200000000cae27
+ (id)errorWithSQLite3Statement:(struct sqlite3_stmt *)arg1;	// IMP=0x00200000007be225
+ (id)errorWithSQLite3Context:(struct sqlite3 *)arg1 statement:(const char *)arg2;	// IMP=0x00200000007be098
+ (id)errorWithSQLite3Context:(struct sqlite3 *)arg1;	// IMP=0x00200000007bdf4a
+ (id)hmd_HTTPMessageTransportErrorWithCode:(long long)arg1;	// IMP=0x0020000000a463a8
...
- (id)hmd_actualCKErrorFromCKErrorPartialFailure:(id)arg1;	// IMP=0x001000000047e60e
@end
