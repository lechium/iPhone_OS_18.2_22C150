...
- (void).cxx_destruct;	// IMP=0x000000000024bd41
...
- (_Bool)addFragmentChunk:(id)arg1 error:(id *)arg2;	// IMP=0x000000000024b6b4
- (id)attributeDescriptions;	// IMP=0x000000000024b43f
- (id)initWithSequenceNumber:(id)arg1 type:(id)arg2;	// IMP=0x000000000024b22f
