...
+ (id)logCategory;	// IMP=0x001000000084f212
+ (id)sharedHandler;	// IMP=0x001000000084f1af
- (void).cxx_destruct;	// IMP=0x000000000084ebd2
...
- (void)_setJetsamPriorityElevated:(_Bool)arg1;	// IMP=0x000000000084e95d
- (void)_updateOrRemoveRelaunchPlist;	// IMP=0x000000000084e3da
- (void)deregisterRelaunchClientWithUUID:(id)arg1;	// IMP=0x000000000084e322
- (void)registerRelaunchClientWithUUID:(id)arg1;	// IMP=0x000000000084e269
- (void)removePersistentRelaunchRegistrationsIfNecessary;	// IMP=0x000000000084e1f8
- (id)initWithRelaunchPlistFileURL:(id)arg1 fileManager:(id)arg2 jetsamPriorityHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000084e0a1
- (id)init;	// IMP=0x000000000084e000
