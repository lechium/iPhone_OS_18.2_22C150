...
+ (id)qualityPredicate;	// IMP=0x0040000000c21af3
+ (id)countOfClipsWithQualityBetweenDatesQuery;	// IMP=0x0040000000c21a90
+ (id)clipsWithQualityBetweenDatesDescendingQuery;	// IMP=0x0040000000c21a2d
+ (id)clipsWithQualityBetweenDatesAscendingQuery;	// IMP=0x0040000000c219ca
+ (id)clipsBeforeDateQuery;	// IMP=0x0040000000c2199a
+ (id)clipsWithNeedsUploadFeedbackStatusQuery;	// IMP=0x0040000000c2196a
+ (id)incompleteClipsQuery;	// IMP=0x0040000000c2193a
+ (id)sentinelParentUUID;	// IMP=0x0040000000c2190a
+ (id)hmbQueries;	// IMP=0x0040000000c217b3
+ (id)hmbExternalRecordType;	// IMP=0x0040000000c217a6
+ (id)hmbProperties;	// IMP=0x0040000000c21776
@property long long quality;
@property unsigned long long feedbackStatus;
- (id)createClipWithSignificantEvents:(id)arg1;	// IMP=0x0000000000c22bac
