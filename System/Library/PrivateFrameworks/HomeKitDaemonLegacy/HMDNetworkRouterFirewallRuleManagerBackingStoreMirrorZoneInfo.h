...
- (void).cxx_destruct;	// IMP=0x00000000008766e1
...
- (void)forceRefresh;	// IMP=0x000000000087661d
- (void)markDeleted;	// IMP=0x000000000087660c
- (void)markChanged;	// IMP=0x00000000008765fb
- (id)initWithZoneID:(id)arg1;	// IMP=0x0000000000876544
