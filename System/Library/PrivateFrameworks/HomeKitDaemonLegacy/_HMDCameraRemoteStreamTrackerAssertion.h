...
- (void).cxx_destruct;	// IMP=0x00000000006ebf6a
...
- (void)dealloc;	// IMP=0x00000000006ebebc
- (id)initWithStreamTracker:(id)arg1 streamIdentifier:(id)arg2;	// IMP=0x00000000006ebe21
