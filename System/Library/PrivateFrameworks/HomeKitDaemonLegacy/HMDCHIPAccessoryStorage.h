...
+ (id)logCategory;	// IMP=0x0010000000276e67
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000276e5f
- (void).cxx_destruct;	// IMP=0x0000000000276dc8
...
- (id)logIdentifier;	// IMP=0x0000000000276c02
- (id)attributeDescriptions;	// IMP=0x00000000002766b1
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000276333
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002760a1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000275ec2
- (unsigned long long)hash;	// IMP=0x0000000000275ca4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000275911
- (void)updateAccessoryModel:(id)arg1;	// IMP=0x000000000027569a
- (_Bool)updateUsingAccessoryModel:(id)arg1;	// IMP=0x0000000000274344
