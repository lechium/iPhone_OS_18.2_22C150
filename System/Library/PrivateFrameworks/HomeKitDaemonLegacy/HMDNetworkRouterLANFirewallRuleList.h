...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000529f93
- (void).cxx_destruct;	// IMP=0x0000000000521ac8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005215a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005214c3
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000520bec
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000520625
- (id)initWithMulticastBridgingRules:(id)arg1 staticPortRules:(id)arg2 dynamicPortRules:(id)arg3 staticICMPRules:(id)arg4;	// IMP=0x000000000052053d
- (id)init;	// IMP=0x000000000052050e
