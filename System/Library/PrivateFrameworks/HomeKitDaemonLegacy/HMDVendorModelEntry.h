...
- (void).cxx_destruct;	// IMP=0x0000000000b6aec1
...
- (unsigned long long)hash;	// IMP=0x0000000000b6abe1
- (long long)compare:(id)arg1;	// IMP=0x0000000000b6aaeb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b6a716
- (id)attributeDescriptions;	// IMP=0x0000000000b6a417
- (id)initWithManufacturer:(id)arg1 model:(id)arg2 appBundleID:(id)arg3 appStoreID:(id)arg4 firmwareVersion:(id)arg5 productData:(id)arg6 productDataAlternates:(id)arg7;	// IMP=0x0000000000b6a217
