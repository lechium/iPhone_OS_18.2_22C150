...
- (void).cxx_destruct;	// IMP=0x0000000000679c8e
...
- (void)configure;	// IMP=0x0000000000679a05
- (void)dealloc;	// IMP=0x00000000006799ad
- (id)initWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2 darwinNotificationProvider:(id)arg3;	// IMP=0x00000000006798d5
- (id)initWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x000000000067984f
