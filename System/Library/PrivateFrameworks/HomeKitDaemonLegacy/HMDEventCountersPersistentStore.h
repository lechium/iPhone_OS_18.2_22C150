...
- (void).cxx_destruct;	// IMP=0x0000000000a6bc42
@property(readonly, nonatomic) __weak id <HMDPersistentStore> persistentStore; // @synthesize persistentStore=_persistentStore;
- (id)unarchive;	// IMP=0x0000000000a6b826
- (void)archiveDictionary:(id)arg1;	// IMP=0x0000000000a6b6f6
- (id)initWithPersistentStore:(id)arg1;	// IMP=0x0000000000a6b692
