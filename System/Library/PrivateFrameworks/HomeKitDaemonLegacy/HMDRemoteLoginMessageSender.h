...
+ (id)logCategory;	// IMP=0x00100000006e769b
- (void).cxx_destruct;	// IMP=0x00000000006e750a
...
- (void)sendRemoteMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006e70a4
- (id)logIdentifier;	// IMP=0x00000000006e7054
- (id)initWithTarget:(id)arg1 accessory:(id)arg2 device:(id)arg3 workQueue:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x00000000006e6f34
