...
- (void).cxx_destruct;	// IMP=0x00000000002b64da
...
- (_Bool)isSubmitted;	// IMP=0x00000000002b61cc
...
- (id)initWithHomeConfigurations:(id)arg1 widgetDataSource:(id)arg2 isFMFDevice:(_Bool)arg3;	// IMP=0x00000000002b564d
- (id)initWithHomeManager:(id)arg1 widgetDataSource:(id)arg2 metadataVersion:(unsigned int)arg3;	// IMP=0x00000000002b5369
