...
+ (id)supportedEventClasses;	// IMP=0x0010000000b6d70f
- (void).cxx_destruct;	// IMP=0x0000000000b6d366
...
- (void)_injectThreadNetworkStateForTestingWithNumAdvertisedBRs:(unsigned long long)arg1 numAppleBRs:(unsigned long long)arg2 numThirdPartyBRs:(unsigned long long)arg3 numThreadNetworks:(unsigned long long)arg4 maxSimuIPPrefixesDetected:(unsigned long long)arg5 txTotal:(unsigned long long)arg6 txSuccess:(unsigned long long)arg7 txDelayAvg:(unsigned long long)arg8 rxTotal:(unsigned long long)arg9 rxSuccess:(unsigned long long)arg10 reportDuration:(unsigned long long)arg11 reportDate:(id)arg12 reportDailySummary:(_Bool)arg13;	// IMP=0x0000000000b6cfaf
- (void)requestThreadNetworkStateCaptureForAccessory:(id)arg1 failingScenario:(int)arg2;	// IMP=0x0000000000b6cfa9
- (void)generateLogForPeriodicReport:(id)arg1;	// IMP=0x0000000000b6cfa3
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000b6cee8
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000b6ce2d
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x0000000000b6ccf7
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x0000000000b6cc17
- (void)_updateDailyCountersAndResetCurrentReportStatsForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x0000000000b6c3c2
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2 isDailySummary:(_Bool)arg3;	// IMP=0x0000000000b6bc01
- (void)_runLoggingForDate:(id)arg1 isDailySummary:(_Bool)arg2;	// IMP=0x0000000000b6ba09
- (void)runDailyTask;	// IMP=0x0000000000b6b985
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000b6b8bc
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x0000000000b6b736
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x0000000000b6b593
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x0000000000b6b4ac
- (void)stop;	// IMP=0x0000000000b6b3b9
- (void)start;	// IMP=0x0000000000b6b238
- (void)_setDailyScheduler:(id)arg1;	// IMP=0x0000000000b6b211
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 notificationCenter:(id)arg6;	// IMP=0x0000000000b6b06c
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000b6af76
