...
+ (id)logCategory;	// IMP=0x00600000009b332f
+ (id)shortDescription;	// IMP=0x00600000009b331d
- (void).cxx_destruct;	// IMP=0x00000000009b32aa
...
- (void)clearData;	// IMP=0x00000000009b30ec
...
- (_Bool)encodeObjectChange:(id)arg1;	// IMP=0x00000000009b25ca
- (id)extractObjectChange;	// IMP=0x00000000009b1a05
- (id)description;	// IMP=0x00000000009b1999
- (id)shortDescription;	// IMP=0x00000000009b18ad
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2 cloudZone:(id)arg3;	// IMP=0x00000000009b1755
- (id)init;	// IMP=0x00000000009b16ad
