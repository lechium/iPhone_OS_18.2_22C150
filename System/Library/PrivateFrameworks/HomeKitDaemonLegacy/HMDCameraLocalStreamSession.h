...
+ (id)logCategory;	// IMP=0x0010000000a504cf
- (void).cxx_destruct;	// IMP=0x0000000000a50436
...
- (id)logIdentifier;	// IMP=0x0000000000a50371
@property(readonly, copy) NSString *stateDescription;
- (_Bool)containsState:(long long)arg1;	// IMP=0x0000000000a5026b
- (void)updateState:(long long)arg1;	// IMP=0x0000000000a50104
- (id)initWithSessionID:(id)arg1 reachabilityPath:(unsigned long long)arg2 streamSender:(id)arg3 remoteCapabilities:(id)arg4 localNetworkConfig:(id)arg5 streamPreference:(id)arg6;	// IMP=0x0000000000a4ffa0
