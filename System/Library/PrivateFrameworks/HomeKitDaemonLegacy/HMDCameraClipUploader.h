...
+ (id)logCategory;	// IMP=0x0010000000a3718c
- (void).cxx_destruct;	// IMP=0x0000000000a36d8a
...
- (id)attributeDescriptions;	// IMP=0x0000000000a36a7c
- (_Bool)_isCancelledError:(id)arg1;	// IMP=0x0000000000a369f2
- (void)_handleFatalOperationFailureDueToError:(id)arg1;	// IMP=0x0000000000a36799
- (void)_startNextOperation;	// IMP=0x0000000000a3664c
- (void)_operationCompleted:(id)arg1 finalizeOnError:(_Bool)arg2 future:(id)arg3;	// IMP=0x0000000000a3639b
- (id)_addOperation:(id)arg1 finalizeClipOnError:(_Bool)arg2;	// IMP=0x0000000000a360e6
- (id)_createClipWithSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000a35f19
- (id)_createClip;	// IMP=0x0000000000a35d92
- (_Bool)hasAddedCreateClipOperation;	// IMP=0x0000000000a35d5f
- (id)finish;	// IMP=0x0000000000a35c63
- (id)addVideoSegmentData:(id)arg1 duration:(double)arg2 timeOffsetWithinClip:(double)arg3 clipFinalizedBecauseMaxDurationExceeded:(_Bool)arg4;	// IMP=0x0000000000a35952
- (id)addVideoInitData:(id)arg1;	// IMP=0x0000000000a356a0
- (id)addNotificationForSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x0000000000a35356
- (id)createClip;	// IMP=0x0000000000a35167
@property(readonly, copy) NSDictionary *stateDump;
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7 encryptionManager:(id)arg8 factory:(id)arg9;	// IMP=0x0000000000a34d32
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x0000000000a34c1b
