...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x00600000002ee2ed
- (void).cxx_destruct;	// IMP=0x00000000002ee29a
...
- (id)attributeDescriptions;	// IMP=0x00000000002ee070
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x00000000002edf82
