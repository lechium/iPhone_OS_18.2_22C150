...
- (void).cxx_destruct;	// IMP=0x000000000080961a
...
- (void)dealloc;	// IMP=0x000000000080955c
- (id)initWithPowerAssertionHandler:(id)arg1 remoteRequestHandlerSessionID:(id)arg2;	// IMP=0x00000000008094c1
