...
+ (id)managedEventCounterRequestGroups;	// IMP=0x00100000002fd2bf
- (void).cxx_destruct;	// IMP=0x00000000002fcf0b
...
- (void)runDailyTask;	// IMP=0x00000000002fce27
- (void)resetAggregationAnalysisContext;	// IMP=0x00000000002fcdea
- (void)populateAggregationAnalysisLogEvent:(id)arg1 forDate:(id)arg2;	// IMP=0x00000000002fcd45
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x00000000002fcc44
- (long long)cameraReachabilityThresholdFromConfiguration:(id)arg1;	// IMP=0x00000000002fcc0a
- (void)configurationChanged:(id)arg1;	// IMP=0x00000000002fcbae
- (id)initWithDataSource:(id)arg1 notificationSettingsProvider:(id)arg2;	// IMP=0x00000000002fc982
