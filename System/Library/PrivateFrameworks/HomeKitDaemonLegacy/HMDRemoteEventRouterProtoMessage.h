...
- (void).cxx_destruct;	// IMP=0x0000000000bba25c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000bba071
- (unsigned long long)hash;	// IMP=0x0000000000bb9f87
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bb9ded
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bb9c94
- (void)copyTo:(id)arg1;	// IMP=0x0000000000bb9b91
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bb9ac0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bb9654
- (id)dictionaryRepresentation;	// IMP=0x0000000000bb93fd
- (id)description;	// IMP=0x0000000000bb934e
- (void)clearOneofValuesForRequest;	// IMP=0x0000000000bb92b8
- (int)StringAsRequest:(id)arg1;	// IMP=0x0000000000bb91c6
- (id)requestAsString:(int)arg1;	// IMP=0x0000000000bb917e
