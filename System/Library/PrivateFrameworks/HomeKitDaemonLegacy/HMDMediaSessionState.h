...
- (void).cxx_destruct;	// IMP=0x00000000006d83fb
@property(readonly, copy, nonatomic) NSString *sessionIdentifier; // @synthesize sessionIdentifier=_sessionIdentifier;
- (id)dumpState;	// IMP=0x00000000006d8251
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006d7e9f
...
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x00000000006d7990
