...
- (void).cxx_destruct;	// IMP=0x000000000077dfcf
...
- (id)attributeDescriptions;	// IMP=0x000000000077ddbe
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2;	// IMP=0x000000000077dd32
