...
- (void).cxx_destruct;	// IMP=0x000000000037fc6e
...
- (double)getTimeDurationForLongestProgressState;	// IMP=0x000000000037fb4b
- (void)updateWithProgressState:(id)arg1 date:(id)arg2;	// IMP=0x000000000037f4bf
- (id)initWithDate:(id)arg1;	// IMP=0x000000000037f43a
