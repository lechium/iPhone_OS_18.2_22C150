...
+ (id)logCategory;	// IMP=0x00100000002a1bad
+ (void)_clearAllPendingRequests:(id)arg1 error:(id)arg2;	// IMP=0x00100000002a1a79
+ (void)_clearAllGeneratedRequests:(id)arg1 error:(id)arg2;	// IMP=0x00100000002a1805
+ (id)createResponseSubset:(id)arg1 overallError:(id)arg2 readRequest:(id)arg3 error:(id *)arg4;	// IMP=0x00100000002a0d90
+ (void)_processResponseForMultireadRequest:(id)arg1 overallError:(id)arg2 response:(id)arg3;	// IMP=0x00100000002a0805
- (void).cxx_destruct;	// IMP=0x000000000029fc1b
...
- (id)logIdentifier;	// IMP=0x000000000029faf4
- (void)_processResponse:(id)arg1 overallError:(id)arg2 messageIdentifier:(id)arg3;	// IMP=0x000000000029f59a
- (void)_sendMultipleCharacteristicRead;	// IMP=0x000000000029e5bc
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000029e504
- (void)redispatchMessage:(id)arg1 target:(id)arg2 responseQueue:(id)arg3;	// IMP=0x000000000029e3f4
- (long long)preferredDeviceType;	// IMP=0x000000000029e2fa
@property(readonly, nonatomic) HMDDevice *preferredDevice;
- (id)deviceForType:(long long)arg1;	// IMP=0x000000000029e242
- (_Bool)containsDevice:(id)arg1;	// IMP=0x000000000029e051
- (void)removeDeviceForType:(long long)arg1;	// IMP=0x000000000029de74
- (void)setDevice:(id)arg1 forType:(long long)arg2;	// IMP=0x000000000029dd81
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000029db21
- (id)initWithHome:(id)arg1 remoteDispatcher:(id)arg2;	// IMP=0x000000000029d98c
