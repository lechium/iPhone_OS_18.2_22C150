...
- (void).cxx_destruct;	// IMP=0x0000000000787f4d
...
- (id)initWithSessionID:(id)arg1 cameraAccessory:(id)arg2 isLocal:(_Bool)arg3 snapshotForNotification:(_Bool)arg4;	// IMP=0x0000000000787ed5
