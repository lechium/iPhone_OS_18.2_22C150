...
+ (id)logCategory;	// IMP=0x0010000000b47392
- (void).cxx_destruct;	// IMP=0x0000000000b4705e
...
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000b46dca
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000b46c3f
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withContext:(id)arg5;	// IMP=0x0000000000b461f7
- (void)_didReceiveData:(id)arg1 error:(id)arg2;	// IMP=0x0000000000b460ae
- (void)dealloc;	// IMP=0x0000000000b45f2f
- (void)_handleDataFromSocket:(id)arg1;	// IMP=0x0000000000b4576e
- (void)_startDataReceive;	// IMP=0x0000000000b455cf
- (id)logIdentifier;	// IMP=0x0000000000b4557f
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 machOUUID:(id)arg3 workQueue:(id)arg4 sessionInviterDeviceVerifier:(id)arg5 delegate:(id)arg6;	// IMP=0x0000000000b45371
