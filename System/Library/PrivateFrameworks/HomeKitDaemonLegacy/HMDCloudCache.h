...
- (void).cxx_destruct;	// IMP=0x0000000000a69d41
...
- (void)persistDatabaseServerChangeToken;	// IMP=0x0000000000a69c8d
@property(retain, nonatomic) CKServerChangeToken *databaseServerChangeToken;
- (void)deleteHomeZoneWithName:(id)arg1;	// IMP=0x0000000000a69a05
- (void)deleteAllZones;	// IMP=0x0000000000a69664
- (void)homeZoneWithName:(id)arg1 owner:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a694c7
- (id)homeZoneWithName:(id)arg1;	// IMP=0x0000000000a69419
- (_Bool)homeZoneExists:(id)arg1;	// IMP=0x0000000000a69362
- (id)allHomeZones;	// IMP=0x0000000000a692d5
- (void)createAndFetchZonesFromBackingStore:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a690ba
- (void)_createZones:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000a68aff
- (id)_findStoreCacheZone:(id)arg1 byName:(id)arg2;	// IMP=0x0000000000a68906
...
- (id)initWithBackingStore:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000a685d2
- (id)init;	// IMP=0x0000000000a6852a
