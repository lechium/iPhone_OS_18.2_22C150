...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000079a678
- (void).cxx_destruct;	// IMP=0x000000000079a62f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000799ffb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000799ef3
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000799880
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000007992fa
- (id)initWithWakePacketType:(id)arg1 wakeDestinationPort:(id)arg2 wakeDestinationAddress:(id)arg3 wakeType:(id)arg4 wakePattern:(id)arg5;	// IMP=0x00000000007991f3
- (id)init;	// IMP=0x00000000007991c4
