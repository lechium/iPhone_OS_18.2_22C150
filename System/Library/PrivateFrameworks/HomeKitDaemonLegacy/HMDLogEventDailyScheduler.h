...
+ (id)logCategory;	// IMP=0x001000000026e294
+ (id)createSchedulerWithLogEventSubmitter:(id)arg1;	// IMP=0x001000000026e1e8
- (void).cxx_destruct;	// IMP=0x000000000026dec5
...
- (id)statusSummary;	// IMP=0x000000000026dce8
- (void)runHomeutilTasks;	// IMP=0x000000000026d9f5
- (void)runDailyTasks;	// IMP=0x000000000026d7b8
- (id)taskRunners;	// IMP=0x000000000026d750
- (void)registerDailyTaskRunner:(id)arg1;	// IMP=0x000000000026d6da
- (void)_runActivity:(id)arg1;	// IMP=0x000000000026d29b
- (void)_handleCheckInForActivity:(id)arg1;	// IMP=0x000000000026cff7
- (void)_registerActivity;	// IMP=0x000000000026cdfe
- (id)_criteriaForActivity;	// IMP=0x000000000026cd5f
- (id)initWithIdentifier:(id)arg1 preferencesKey:(id)arg2 logEventSubmitter:(id)arg3 xpcActivityInterface:(id)arg4 dateFactory:(CDUnknownBlockType)arg5;	// IMP=0x000000000026cb73
