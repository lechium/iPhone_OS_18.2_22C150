...
+ (id)logCategory;	// IMP=0x0010000000732831
- (void).cxx_destruct;	// IMP=0x00000000007320b9
...
- (void)setTrafficClass:(unsigned long long)arg1;	// IMP=0x0000000000731ede
- (void)sendRawFrame:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000731daf
- (void)close;	// IMP=0x0000000000731d9b
- (void)_closeWithError:(id)arg1;	// IMP=0x0000000000731b61
- (void)_doReceive;	// IMP=0x000000000073190a
- (void)_consumeReceivedData:(id)arg1;	// IMP=0x0000000000731779
- (void)_stopWithError:(id)arg1;	// IMP=0x0000000000731763
- (void)_start;	// IMP=0x00000000007316eb
- (void)_registerForConnectionEvents;	// IMP=0x00000000007315ed
- (void)_handleReadClose;	// IMP=0x000000000073150c
- (void)connect;	// IMP=0x0000000000731088
- (id)_createTcpConnection;	// IMP=0x0000000000730dda
- (void)dealloc;	// IMP=0x0000000000730d92
- (id)initWithAddress:(id)arg1 port:(long long)arg2 targetQueue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000730c8f
- (id)initWithAddress:(id)arg1 port:(long long)arg2 workQueue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000730b94
