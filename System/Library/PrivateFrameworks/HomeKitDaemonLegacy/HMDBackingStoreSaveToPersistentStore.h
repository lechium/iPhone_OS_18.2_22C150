...
- (void).cxx_destruct;	// IMP=0x0000000000a3a7c3
...
- (id)mainReturningError;	// IMP=0x0000000000a3a60e
- (id)initWithHomeManager:(id)arg1 reason:(id)arg2 incrementGeneration:(_Bool)arg3;	// IMP=0x0000000000a3a54a
