...
- (void).cxx_destruct;	// IMP=0x00000000009cdaa4
...
- (id)attributeDescriptions;	// IMP=0x00000000009cd8c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009cd8b6
- (id)operationByMergingWithOperation:(id)arg1;	// IMP=0x00000000009cd77f
- (id)initWithDeviceCredentialKey:(id)arg1 accessories:(id)arg2 user:(id)arg3;	// IMP=0x00000000009cd554
- (id)initWithDeviceCredentialKey:(id)arg1 accessoriesUUIDs:(id)arg2 user:(id)arg3;	// IMP=0x00000000009cd46a
