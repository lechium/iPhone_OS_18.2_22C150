...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000052c9f2
- (void).cxx_destruct;	// IMP=0x000000000052c9b4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000052c48e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000052c3af
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000052bf10
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000052ba5e
- (id)initWithHostDNSName:(id)arg1 hostIPStart:(id)arg2 hostIPEnd:(id)arg3 icmpTypes:(id)arg4;	// IMP=0x000000000052b976
- (id)init;	// IMP=0x000000000052b947
- (void)addTo:(id)arg1;	// IMP=0x00000000004aab2d
