...
+ (id)extractNetworkConfig:(int)arg1 peerNameExtractor:(CDUnknownFunctionPointerType)arg2;	// IMP=0x00100000004b05f3
+ (int)openSocketWithNetworkConfig:(id)arg1;	// IMP=0x00100000004b00b7
+ (id)logCategory;	// IMP=0x00100000004b0087
- (void).cxx_destruct;	// IMP=0x00000000004b0028
...
- (_Bool)loadMiscFields:(id)arg1;	// IMP=0x00000000004afb90
- (void)setStreamInterfaceState:(unsigned long long)arg1;	// IMP=0x00000000004afb4f
- (void)dealloc;	// IMP=0x00000000004afac8
- (id)logIdentifier;	// IMP=0x00000000004afa78
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 sessionHandler:(id)arg3 localRTPSocket:(int)arg4;	// IMP=0x00000000004af965
