...
+ (id)shortDescription;	// IMP=0x00100000007eba78
- (void).cxx_destruct;	// IMP=0x00000000007eba25
...
- (void)replayChange:(id)arg1 stagedChange:(id)arg2;	// IMP=0x00000000007eb1be
- (void)resetRecord;	// IMP=0x00000000007eb17f
- (void)updateChangeWithRecord:(id)arg1;	// IMP=0x00000000007eb116
@property(readonly, nonatomic) CKRecordID *recordID;
@property(readonly, nonatomic) NSString *type;
@property(readonly, nonatomic) NSString *recordName;
@property(readonly, nonatomic) CKRecord *record;
- (void)updateWithObjectChange:(id)arg1;	// IMP=0x00000000007ea6e8
- (void)updateDeletedCloudRecord:(id)arg1;	// IMP=0x00000000007ea5cf
- (void)updateCloudRecord:(id)arg1;	// IMP=0x00000000007ea060
- (void)forceChangeToInvalid;	// IMP=0x00000000007ea04c
- (void)forceChangeToDelete;	// IMP=0x00000000007e9f5c
...
- (id)shortDescription;	// IMP=0x00000000007e9b62
- (id)initWithCloudObjectRecord:(id)arg1;	// IMP=0x00000000007e9b4b
- (id)initWithObjectChange:(id)arg1;	// IMP=0x00000000007e9b37
- (id)_initWithObjectChange:(id)arg1 cloudObjectRecord:(id)arg2;	// IMP=0x00000000007e97da
- (id)init;	// IMP=0x00000000007e9732
