...
+ (id)properties;	// IMP=0x0060000000b5bb4f
+ (id)schemaHashRoot;	// IMP=0x0060000000b5bb42
- (id)dependentUUIDs;	// IMP=0x0000000000b56a6a
- (id)validate;	// IMP=0x0000000000b5697f
- (_Bool)validForStorage;	// IMP=0x0000000000b56854
- (void)loadModelWithActionInformation:(id)arg1;	// IMP=0x0000000000b56682
