...
+ (id)shortDescription;	// IMP=0x0060000000b48ad3
- (void).cxx_destruct;	// IMP=0x0000000000b48a3e
...
- (id)replayTransaction:(id)arg1 stagedTransaction:(id)arg2;	// IMP=0x0000000000b484cb
- (void)loadObjectChanges;	// IMP=0x0000000000b484a8
- (id)changeWithRecordName:(id)arg1;	// IMP=0x0000000000b4842e
- (id)changeWithObjectID:(id)arg1;	// IMP=0x0000000000b483b4
...
- (void)updateCloudCache;	// IMP=0x0000000000b48184
- (void)setDeleteAsProcessedWithRecordID:(id)arg1;	// IMP=0x0000000000b4811b
- (void)resetRecordWithRecordID:(id)arg1;	// IMP=0x0000000000b480b2
- (void)setSaveAsProcessedWithRecord:(id)arg1;	// IMP=0x0000000000b48049
- (void)fetchBatchToUpload:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b47fe0
- (_Bool)moreChangesToProcess;	// IMP=0x0000000000b47f9c
- (void)setAllChangedAsProcessed;	// IMP=0x0000000000b47f5f
- (void)loadCloudRecordsAndDetermineDeletesFromCache:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b47dbb
- (void)cachedCloudRecordWithObjectID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b47d30
- (id)cachedCloudRecordWithObjectID:(id)arg1;	// IMP=0x0000000000b47cb6
@property(readonly) _Bool doRecordsExistInCache;
- (_Bool)doesRecordExistInCacheWithObjectID:(id)arg1;	// IMP=0x0000000000b47c04
- (_Bool)doesRecordExistWithObjectID:(id)arg1;	// IMP=0x0000000000b47b96
@property(readonly, nonatomic) _Bool hasValidChanges;
- (void)removeChangeWithObjectID:(id)arg1;	// IMP=0x0000000000b47ae9
- (void)addChangeWithDeletedRecordID:(id)arg1;	// IMP=0x0000000000b47a80
- (void)addChangeWithRecord:(id)arg1;	// IMP=0x0000000000b47a17
- (void)addChangeWithObjectChange:(id)arg1;	// IMP=0x0000000000b479ae
...
- (id)description;	// IMP=0x0000000000b476d1
- (id)shortDescription;	// IMP=0x0000000000b475e0
- (void)updateCloudZone:(id)arg1;	// IMP=0x0000000000b47559
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2 noLocalData:(_Bool)arg3;	// IMP=0x0000000000b474b6
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2;	// IMP=0x0000000000b474a1
- (id)init;	// IMP=0x0000000000b473f9
