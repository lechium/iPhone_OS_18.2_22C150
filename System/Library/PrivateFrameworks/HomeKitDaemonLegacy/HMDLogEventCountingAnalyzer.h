...
- (void).cxx_destruct;	// IMP=0x0000000000376190
...
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000376012
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000375f57
- (void)runDailyTask;	// IMP=0x0000000000375ee6
- (void)incrementDailyCountersForEventName:(id)arg1;	// IMP=0x0000000000375d9a
- (void)incrementPeriodicCountersForEventName:(id)arg1;	// IMP=0x0000000000375c4d
- (id)periodicSnapshotAtCurrentTickSeconds:(unsigned long long)arg1;	// IMP=0x0000000000375b9f
- (void)didReceiveEventFromDispatcher:(id)arg1 withCurrentTickSeconds:(unsigned long long)arg2;	// IMP=0x0000000000375a71
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x00000000003759dd
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5 loggingPeriodicitySeconds:(unsigned long long)arg6 tickSecondsProviderBlock:(CDUnknownBlockType)arg7 periodicCountersLoggingBlock:(CDUnknownBlockType)arg8;	// IMP=0x00000000003757c6
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5;	// IMP=0x000000000037571f
