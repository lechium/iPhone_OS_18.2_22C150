...
- (void).cxx_destruct;	// IMP=0x00000000008600db
...
- (id)initWithKeyPaths:(id)arg1 startTime:(unsigned long long)arg2 requestingClientName:(id)arg3 error:(id)arg4;	// IMP=0x000000000085faf8
