...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000554593
+ (id)characteristicMetadataWithDictionary:(id)arg1;	// IMP=0x001000000055438c
- (void).cxx_destruct;	// IMP=0x00000000005542f5
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000554085
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000553e6e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000553e63
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000553bb7
@property(readonly) unsigned long long hash;
- (id)dictionaryRepresentation;	// IMP=0x00000000005538b5
- (id)_descriptionDetails;	// IMP=0x0000000000553244
- (id)dumpState;	// IMP=0x00000000005531d7
@property(readonly, copy) NSString *description;
- (id)initWithMinimumValue:(id)arg1 maximumValue:(id)arg2 stepValue:(id)arg3 maxLength:(id)arg4 validValues:(id)arg5 format:(id)arg6 units:(id)arg7 manufacturerDescription:(id)arg8;	// IMP=0x0000000000552f4a
- (id)init;	// IMP=0x0000000000552ea2
