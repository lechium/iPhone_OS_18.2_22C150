...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000079849a
- (void).cxx_destruct;	// IMP=0x0000000000798467
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000798087
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000797fcf
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000797c01
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000007978a4
- (id)initWithOperationType:(id)arg1 operationStatus:(id)arg2 backoffTime:(id)arg3;	// IMP=0x00000000007977ec
- (id)init;	// IMP=0x00000000007977bd
