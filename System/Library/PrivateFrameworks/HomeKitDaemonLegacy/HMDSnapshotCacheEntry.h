...
- (void).cxx_destruct;	// IMP=0x0000000000a06cfb
...
- (id)description;	// IMP=0x0000000000a06c13
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x0000000000a06b49
