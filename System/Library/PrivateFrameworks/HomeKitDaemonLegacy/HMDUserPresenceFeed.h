...
- (void).cxx_destruct;	// IMP=0x000000000004f63a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004f31e
- (id)description;	// IMP=0x000000000004f206
- (id)initWithUser:(id)arg1 presenceAuthStatus:(id)arg2 presenceComputeStatus:(id)arg3 presenceRegion:(id)arg4 reason:(id)arg5;	// IMP=0x000000000004f0f0
