...
- (void).cxx_destruct;	// IMP=0x0000000000242278
...
- (id)mainReturningError;	// IMP=0x0000000000241c2f
- (id)initWithGroup:(id)arg1 update:(_Bool)arg2 migration:(_Bool)arg3 fetchResult:(CDUnknownBlockType)arg4;	// IMP=0x0000000000241b54
