...
+ (id)createEventWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x00100000006145b4
- (void).cxx_destruct;	// IMP=0x0000000000614583
...
- (id)initWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x0000000000614364
