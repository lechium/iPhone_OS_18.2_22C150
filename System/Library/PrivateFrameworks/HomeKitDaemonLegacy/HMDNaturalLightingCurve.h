...
+ (id)logCategory;	// IMP=0x0010000000557961
+ (long long)colorTemperatureMiredsFromKelvins:(long long)arg1;	// IMP=0x001000000055793e
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000557936
- (void).cxx_destruct;	// IMP=0x00000000005577f4
...
- (id)transitionPointsWithmillisecondsElapsedSinceStartOfDay:(unsigned long long)arg1;	// IMP=0x0000000000556be6
- (id)colorTemperatureForBrightness:(long long)arg1 millisecondsElapsedSinceStartOfDay:(unsigned long long)arg2;	// IMP=0x0000000000556a0c
@property(readonly) unsigned long long checksum;
- (id)attributeDescriptions;	// IMP=0x000000000055610d
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000555fde
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000555fd3
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000555c90
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000055584a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000554d24
- (id)initWithCurve:(id)arg1 minimumColorTemperature:(long long)arg2 maximumColorTemperature:(long long)arg3;	// IMP=0x00000000005547b3
- (id)initWithVersion:(unsigned long long)arg1 transitionPoints:(id)arg2 minimumBrightness:(long long)arg3 maximumBrightness:(long long)arg4 minimumColorTemperature:(long long)arg5 maximumColorTemperature:(long long)arg6;	// IMP=0x00000000005546e5
