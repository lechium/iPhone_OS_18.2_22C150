...
+ (id)logCategory;	// IMP=0x0010000000ba8190
- (void).cxx_destruct;	// IMP=0x0000000000ba6774
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000ba6520
- (id)didOccurEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000ba6466
- (void)_callExecutionCompleteIfNoMoreOutstandingRequests;	// IMP=0x0000000000ba61c8
- (void)handleSessionPlaybackStateUpdatedNotification:(id)arg1;	// IMP=0x0000000000ba60c8
- (void)_handleMonitoringEvent:(id)arg1;	// IMP=0x0000000000ba5d37
- (void)_restoreState;	// IMP=0x0000000000ba567e
- (void)_removeUserDialog;	// IMP=0x0000000000ba55db
- (void)_callExecutionComplete:(id)arg1;	// IMP=0x0000000000ba55c4
- (void)_submitAnalyticsData:(id)arg1;	// IMP=0x0000000000ba5008
- (void)_callExecutionComplete:(id)arg1 callDelegate:(_Bool)arg2;	// IMP=0x0000000000ba4985
- (id)valueInActionSetWriteResponse:(id)arg1 actionSetUUID:(id)arg2 accUUID:(id)arg3 serviceID:(id)arg4 characteristicID:(id)arg5;	// IMP=0x0000000000ba4862
- (id)_monitoringEventsFromActionSetResponse:(id)arg1;	// IMP=0x0000000000ba36cb
- (void)_activateEvents:(id)arg1;	// IMP=0x0000000000ba3432
- (void)_activateMonitoringEvents;	// IMP=0x0000000000ba33e6
- (void)_activateDurationEvents;	// IMP=0x0000000000ba339a
- (void)_handleActionSetExecutionResponse:(id)arg1 actionSetError:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ba2bd4
- (void)_directlyExecuteActionSetsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ba2a6d
- (void)_addEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000ba25b6
- (void)addEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000ba24d8
- (void)_userResponse:(unsigned long long)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ba1e22
- (void)userResponse:(unsigned long long)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ba1d38
- (id)durationEndEvents;	// IMP=0x0000000000ba1b4d
- (void)postponeRestoreIfWaitingForEndEvent;	// IMP=0x0000000000ba1adc
- (void)cancelSessionIfWaitingForUserResponse;	// IMP=0x0000000000ba1a6b
- (_Bool)containsSecureActionSet;	// IMP=0x0000000000ba192d
- (void)_executeTriggerAfterEvaluatingCondition:(id)arg1;	// IMP=0x0000000000ba1197
- (void)_evaluateFiringTrigger;	// IMP=0x0000000000ba050c
- (void)evaluateFiringTrigger;	// IMP=0x0000000000ba049b
- (id)dumpState;	// IMP=0x0000000000ba00b9
@property(readonly, nonatomic) _Bool needsUserConfirmation;
- (id)logIdentifier;	// IMP=0x0000000000ba005f
@property(readonly, copy) NSString *description;
- (id)initWithEventTrigger:(id)arg1 predicateUtilities:(id)arg2 triggerEvent:(id)arg3 causingDevice:(id)arg4 workQueue:(id)arg5 actionSets:(id)arg6 evaluationCondition:(id)arg7 recurrences:(id)arg8 endEvents:(id)arg9 msgDispatcher:(id)arg10;	// IMP=0x0000000000b9fbb7
