...
+ (unsigned long long)maximumDifferentiationNumber;	// IMP=0x00400000005375ce
- (void).cxx_destruct;	// IMP=0x000000000053744c
...
- (id)attributeDescriptions;	// IMP=0x00000000005371b6
- (id)initWithProductData:(id)arg1 manufacturer:(id)arg2 model:(id)arg3 firmwareVersion:(id)arg4 category:(id)arg5 differentiationNumber:(id)arg6;	// IMP=0x0000000000537070
- (id)initWithAccessory:(id)arg1;	// IMP=0x00000000005368da
