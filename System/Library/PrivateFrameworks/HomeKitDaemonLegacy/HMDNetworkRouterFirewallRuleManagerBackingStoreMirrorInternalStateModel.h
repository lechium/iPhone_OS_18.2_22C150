...
+ (id)hmbProperties;	// IMP=0x0010000000a40710
+ (id)parentModelID;	// IMP=0x0010000000a406e0
+ (id)modelID;	// IMP=0x0010000000a406b0
+ (id)logCategory;	// IMP=0x0010000000a40680
- (void).cxx_destruct;	// IMP=0x0000000000a40ed2
...
- (id)init;	// IMP=0x0000000000a408b2
