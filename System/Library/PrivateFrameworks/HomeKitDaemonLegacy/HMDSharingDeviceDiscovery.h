...
- (void).cxx_destruct;	// IMP=0x00000000005a9a60
@property(retain, nonatomic) SFDeviceDiscovery *deviceDiscovery; // @synthesize deviceDiscovery=_deviceDiscovery;
- (void)repairDevice:(id)arg1 flags:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000005a9980
- (void)stop;	// IMP=0x00000000005a9926
- (void)start;	// IMP=0x00000000005a98e2
...
- (void)dealloc;	// IMP=0x00000000005a9427
