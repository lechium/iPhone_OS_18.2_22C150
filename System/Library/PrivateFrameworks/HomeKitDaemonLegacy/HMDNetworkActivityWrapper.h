...
- (void).cxx_destruct;	// IMP=0x0000000000c0195a
...
- (id)childActivityWithLabel:(unsigned long long)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x0000000000c0175a
- (void)submitMetrics:(id)arg1 withName:(id)arg2;	// IMP=0x0000000000c01571
- (void)completeWithSuccess:(_Bool)arg1;	// IMP=0x0000000000c01526
- (void)setParent:(id)arg1;	// IMP=0x0000000000c0145b
- (void)activate;	// IMP=0x0000000000c01426
...
- (id)initWithLabel:(unsigned long long)arg1;	// IMP=0x0000000000c012eb
