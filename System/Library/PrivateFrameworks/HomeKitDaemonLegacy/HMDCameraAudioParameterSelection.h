...
+ (id)logCategory;	// IMP=0x00600000000cadc0
- (void).cxx_destruct;	// IMP=0x00000000000cacc3
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x00000000000ca5fa
- (id)createSelectedAudioParameters;	// IMP=0x00000000000ca218
- (id)createSRTPParamters;	// IMP=0x00000000000ca18d
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x00000000000c9ba8
- (_Bool)selectAudioParameters;	// IMP=0x00000000000c9341
- (id)logIdentifier;	// IMP=0x00000000000c92f1
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x00000000000c9164
