...
+ (id)logCategory;	// IMP=0x00600000007e2e6e
- (void).cxx_destruct;	// IMP=0x00000000007e2e2c
...
- (id)attributeDescriptions;	// IMP=0x00000000007e2a22
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x00000000007e2929
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x00000000007e24e5
