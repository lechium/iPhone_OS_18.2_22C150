...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0060000000a60539
- (void).cxx_destruct;	// IMP=0x0000000000a60506
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x0000000000a6036b
