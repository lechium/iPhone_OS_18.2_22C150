...
- (void).cxx_destruct;	// IMP=0x000000000023f548
...
- (id)mainReturningError;	// IMP=0x000000000023f2ea
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000023f22e
