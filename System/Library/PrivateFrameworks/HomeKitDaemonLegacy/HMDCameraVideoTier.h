...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000009cd3fc
- (void).cxx_destruct;	// IMP=0x00000000009cd398
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009cd1e3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009cd04c
- (unsigned long long)hash;	// IMP=0x00000000009cd008
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009ccf2c
@property(readonly, nonatomic) long long quality;
- (id)description;	// IMP=0x00000000009ccda7
- (id)initWithVideoResolution:(id)arg1 framerate:(id)arg2 minBitRate:(id)arg3 maxBitRate:(id)arg4 rtcpInterval:(id)arg5;	// IMP=0x00000000009ccc8a
