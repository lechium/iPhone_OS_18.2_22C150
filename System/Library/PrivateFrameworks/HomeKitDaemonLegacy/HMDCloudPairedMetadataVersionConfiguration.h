...
+ (id)logCategory;	// IMP=0x0010000000896399
- (void).cxx_destruct;	// IMP=0x0000000000896368
...
- (id)attributeDescriptions;	// IMP=0x0000000000896161
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000895c9e
- (id)initWithAccessoryIdentifier:(id)arg1 diagnostics:(id)arg2;	// IMP=0x0000000000895bed
