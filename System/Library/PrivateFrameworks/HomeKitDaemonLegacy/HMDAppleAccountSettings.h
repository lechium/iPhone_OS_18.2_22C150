...
+ (_Bool)supportsCloudSettings;	// IMP=0x001000000073eccb
+ (id)sharedSettings;	// IMP=0x001000000073ec9b
+ (id)logCategory;	// IMP=0x00100000001e73e0
- (void)updateHomeEnabled:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000073ec2c
- (void)synchronize;	// IMP=0x000000000073ec26
...
- (id)attributeDescriptions;	// IMP=0x00000000001e71ea
