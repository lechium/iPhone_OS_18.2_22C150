...
+ (id)properties;	// IMP=0x00600000005e7c3d
@property(copy, nonatomic) HMDNaturalLightingContext *naturalLightingContext;
- (id)audioAnalysisClassifierOptions;	// IMP=0x00000000005e8870
- (void)setAudioAnalysisClassifierOptions:(id)arg1;	// IMP=0x00000000005e885e
