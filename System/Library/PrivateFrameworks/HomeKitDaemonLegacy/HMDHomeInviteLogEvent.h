...
+ (id)updateWithInvitationState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x001000000060c808
+ (id)updateWithState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x001000000060c7cf
...
- (id)initWithHomeInviteLogEventState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x000000000060c012
