...
+ (id)allowedClasses;	// IMP=0x00600000002c33b7
+ (_Bool)isSupported;	// IMP=0x00600000002c330f
+ (long long)role;	// IMP=0x00600000002c3267
- (void).cxx_destruct;	// IMP=0x00000000002c3676
...
- (_Bool)processSessionData:(id)arg1 outAccessoryUUID:(id *)arg2 outAccessoryCategory:(id *)arg3 outAccessoryIDSIdentifier:(id *)arg4 error:(id *)arg5;	// IMP=0x00000000002c352c
- (id)initWithHomeManager:(id)arg1 userDefaults:(id)arg2;	// IMP=0x00000000002c3482
