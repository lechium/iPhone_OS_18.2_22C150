...
+ (id)logCategory;	// IMP=0x0010000000c4b500
...
- (id)serializedMetric;	// IMP=0x0000000000c4b26e
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000c4b06f
- (id)initWithHomeUUID:(id)arg1 numCapableSiriEndpoints:(unsigned long long)arg2 numEnabledSiriEndpoints:(unsigned long long)arg3;	// IMP=0x0000000000c4b019
- (id)initWithConfigurationDataSource:(id)arg1;	// IMP=0x0000000000c4acc7
