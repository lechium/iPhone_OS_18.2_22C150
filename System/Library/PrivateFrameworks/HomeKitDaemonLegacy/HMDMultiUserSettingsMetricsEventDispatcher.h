...
+ (id)logCategory;	// IMP=0x00100000002b49e1
- (void).cxx_destruct;	// IMP=0x00000000002b4990
...
- (id)logIdentifier;	// IMP=0x00000000002b48d1
- (void)runDailyTask;	// IMP=0x00000000002b48bf
- (void)submitMultiUserSettingsDailyEvent;	// IMP=0x00000000002b4543
- (void)registerForDailyMultiUserSettingsEvents;	// IMP=0x00000000002b44f7
- (id)initWithIdentifier:(id)arg1 logEventSubmitter:(id)arg2 dailyScheduler:(id)arg3;	// IMP=0x00000000002b442d
