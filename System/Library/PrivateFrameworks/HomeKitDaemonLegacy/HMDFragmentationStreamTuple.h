...
+ (id)tupleWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0060000000a1339a
- (void).cxx_destruct;	// IMP=0x0000000000a13347
...
- (void)close;	// IMP=0x0000000000a132c6
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000a130f4
