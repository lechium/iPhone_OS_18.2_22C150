...
- (void).cxx_destruct;	// IMP=0x00000000007f5f24
...
- (id)initWithSessionStartCallback:(CDUnknownBlockType)arg1 handleOpenRequestResponseTimer:(id)arg2 sendCloseEventTimer:(id)arg3;	// IMP=0x00000000007f5da5
