...
- (void).cxx_destruct;	// IMP=0x00000000002ecdb3
...
- (id)attributeDescriptions;	// IMP=0x00000000002ecb26
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002eca6b
- (_Bool)isEqualValue:(id)arg1;	// IMP=0x00000000002ec7a6
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4 readVersion:(id)arg5 writeVersion:(id)arg6;	// IMP=0x00000000002ec6a6
