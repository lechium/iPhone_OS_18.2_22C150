...
- (void).cxx_destruct;	// IMP=0x00000000006f6248
...
- (id)popNextFrameUpToMaxLength:(unsigned long long)arg1;	// IMP=0x00000000006f612a
- (_Bool)isComplete;	// IMP=0x00000000006f60c9
- (id)initWithData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000006f601d
