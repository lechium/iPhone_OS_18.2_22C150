...
- (void).cxx_destruct;	// IMP=0x000000000027d51b
...
- (void)routeAccessorySettingsUpdateRequestMessage:(id)arg1;	// IMP=0x000000000027d29d
- (void)routeAccessorySettingsFetchRequestMessage:(id)arg1;	// IMP=0x000000000027d073
- (void)registerForMessagesWithHome:(id)arg1;	// IMP=0x000000000027ce35
- (id)initWithMessageTargetUUID:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x000000000027cd71
