...
+ (id)localIPAddress;	// IMP=0x001000000062a98a
- (void).cxx_destruct;	// IMP=0x000000000062a959
...
- (id)description;	// IMP=0x000000000062a803
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000062a720
- (id)initWithAddress:(id)arg1 ipv6:(_Bool)arg2 rtpPort:(id)arg3;	// IMP=0x000000000062a67d
- (id)init;	// IMP=0x000000000062a63e
