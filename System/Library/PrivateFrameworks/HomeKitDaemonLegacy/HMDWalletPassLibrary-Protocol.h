...
@class HMDHomeWalletKey, HMFFlow, NSData, NSSet, NSString, NSURL;
...
- (void)fetchIsExpressEnabledForPassWithTypeIdentifier:(NSString *)arg1 serialNumber:(NSString *)arg2 flow:(HMFFlow *)arg3 completion:(void (^)(_Bool, NSError *))arg4;
