...
- (void).cxx_destruct;	// IMP=0x0000000000bd1913
...
- (void)setReselectedConfigParameters:(id)arg1 videoTier:(id)arg2;	// IMP=0x0000000000bd1748
- (void)setSelectedConfigParameters:(id)arg1;	// IMP=0x0000000000bd15a0
- (void)setSelectedEndPointSetupParameters:(id)arg1 videoNetworkConfig:(id)arg2 audioNetworkConfig:(id)arg3;	// IMP=0x0000000000bd11bc
- (_Bool)findBestMatchWithProtocolParameters:(id)arg1 streamingCapabilities:(id)arg2 videoTierParameters:(id)arg3;	// IMP=0x0000000000bd0e08
