...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a3fdf
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a3e30
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a3b4e
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000a3936
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000a3678
@property(readonly, copy) NSData *tlvData;
- (id)initWithCodecGroup:(id)arg1 codecParameter:(id)arg2 rtpParameter:(id)arg3 comfortNoiseEnabled:(id)arg4;	// IMP=0x00000000000a33ba
