...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000004fcb71
- (void).cxx_destruct;	// IMP=0x00000000004fcaeb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004fc8d0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004fc772
