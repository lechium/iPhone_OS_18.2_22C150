...
+ (id)tupleWithAccessoryUUID:(id)arg1 reachable:(_Bool)arg2;	// IMP=0x00600000000e2c91
- (void).cxx_destruct;	// IMP=0x00000000000e2c7e
...
- (id)description;	// IMP=0x00000000000e2a7e
- (unsigned long long)hash;	// IMP=0x00000000000e2a3a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e29a9
