...
+ (id)logCategory;	// IMP=0x00600000005bfa90
- (void).cxx_destruct;	// IMP=0x00000000005bee18
...
- (void)runHouseholdMetricsDataCollectionAssociatedToDate:(id)arg1 forceSubmit:(_Bool)arg2;	// IMP=0x00000000005be68c
- (void)sendHouseholdMetricsCollectionRequestToDevices:(id)arg1 forHomeWithUUID:(id)arg2 associatedToDate:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000005be03f
- (_Bool)evaluateMetricResponsesForSubmission:(id)arg1;	// IMP=0x00000000005bde0f
- (_Bool)evaluateHouseholdActivityLogEventForSubmission:(id)arg1;	// IMP=0x00000000005bddf2
- (id)initWithDataSource:(id)arg1 logEventSubmitter:(id)arg2 householdMetricsProvider:(id)arg3 remoteMessageDispatcher:(id)arg4 logEventFactories:(id)arg5 workQueue:(id)arg6;	// IMP=0x00000000005bdcde
