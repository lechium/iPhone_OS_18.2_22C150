...
+ (id)logCategory;	// IMP=0x00100000007870e7
- (void).cxx_destruct;	// IMP=0x0000000000786b0f
...
- (void)_drainVariantFragmentQueue;	// IMP=0x0000000000786543
- (void)handleVariantFragment:(id)arg1;	// IMP=0x00000000007861e4
- (void)handleFullFragment:(id)arg1;	// IMP=0x00000000007860f0
@property(readonly) _Bool expectsVariantFragment;
- (id)initWithLogIdentifier:(id)arg1;	// IMP=0x0000000000785fcf
