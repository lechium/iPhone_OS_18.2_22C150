...
+ (void)__unregisterActivity:(id)arg1;	// IMP=0x0010000000797140
+ (id)logCategory;	// IMP=0x0010000000797110
- (void).cxx_destruct;	// IMP=0x0000000000796b24
...
- (void)stop;	// IMP=0x00000000007969ab
- (void)start;	// IMP=0x00000000007968fd
- (void)__transitionActivity:(id)arg1 state:(long long)arg2;	// IMP=0x0000000000796734
- (void)__unregisterActivity;	// IMP=0x00000000007965f0
- (void)__runActivity:(id)arg1;	// IMP=0x0000000000796202
- (void)__checkInActivity:(id)arg1;	// IMP=0x0000000000795d97
- (void)__registerActivity;	// IMP=0x0000000000795bb9
- (id)__initialCriteria;	// IMP=0x0000000000795aaf
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000795865
- (id)initWithIdentifier:(id)arg1 interval:(double)arg2 retryInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x000000000079577a
