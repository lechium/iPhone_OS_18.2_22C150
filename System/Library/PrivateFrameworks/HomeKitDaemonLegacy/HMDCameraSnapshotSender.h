...
+ (id)logCategory;	// IMP=0x00100000004ae4da
- (void).cxx_destruct;	// IMP=0x00000000004ae35b
...
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x00000000004adeed
- (id)logIdentifier;	// IMP=0x00000000004ade9d
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 device:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6;	// IMP=0x00000000004add14
