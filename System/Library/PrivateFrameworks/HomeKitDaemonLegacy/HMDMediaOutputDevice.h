...
- (void).cxx_destruct;	// IMP=0x00000000005ff4d6
...
- (id)description;	// IMP=0x00000000005ff3d1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005ff2ba
- (unsigned long long)hash;	// IMP=0x00000000005ff29d
- (void)dealloc;	// IMP=0x00000000005ff257
...
- (id)initWithOutputDevice:(void *)arg1;	// IMP=0x00000000005fefd3
