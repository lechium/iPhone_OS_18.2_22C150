...
+ (_Bool)isRecordingSessionAlreadyInProgressError:(id)arg1;	// IMP=0x0010000000092020
- (void).cxx_destruct;	// IMP=0x000000000009200d
...
- (id)initWithAccessoryIdentifier:(id)arg1;	// IMP=0x0000000000091cf9
