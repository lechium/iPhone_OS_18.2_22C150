...
+ (id)denominatorSpecifyingEvent;	// IMP=0x00100000000c90f5
- (void).cxx_destruct;	// IMP=0x00000000000c90e2
...
- (id)initWithAccessoryDetailsType:(unsigned long long)arg1 accessoryCategoryIdentifier:(id)arg2 homeUUID:(id)arg3;	// IMP=0x00000000000c8def
