...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000354be4
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000354b6d
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000354a42
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000005cddf2
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00200000005cdda3
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000005cdd54
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000007e08ae
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000007e0844
- (unsigned long long)homeManagerOptions;	// IMP=0x00100000003549f1
...
- (id)userForHome:(id)arg1;	// IMP=0x0010000000a343e8
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x0010000000a33ff0
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0010000000c10b03
