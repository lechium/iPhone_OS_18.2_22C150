...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000489c49
- (void).cxx_destruct;	// IMP=0x0000000000489be5
...
- (id)attributeDescriptions;	// IMP=0x00000000004899d2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000489900
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004896dc
- (id)report;	// IMP=0x00000000004894ed
...
- (id)initWithServerIdentifier:(id)arg1 instanceID:(id)arg2 linkType:(long long)arg3;	// IMP=0x0000000000489055
