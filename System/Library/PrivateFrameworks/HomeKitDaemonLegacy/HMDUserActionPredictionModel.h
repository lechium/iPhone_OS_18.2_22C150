...
+ (_Bool)hmbExcludeFromCloudStorage;	// IMP=0x00600000003b0c30
+ (id)hmbProperties;	// IMP=0x00600000003b0c00
- (id)userActionPrediction;	// IMP=0x00000000003b17ca
- (id)initWithUserActionPrediction:(id)arg1;	// IMP=0x00000000003b11ae
