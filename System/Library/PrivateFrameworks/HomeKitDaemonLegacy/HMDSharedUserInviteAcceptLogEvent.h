...
- (unsigned long long)coreAnalyticsEventOptions;	// IMP=0x000000000079e5d0
- (id)coreAnalyticsEventDictionary;	// IMP=0x000000000079e236
- (id)coreAnalyticsEventName;	// IMP=0x000000000079e229
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x000000000079e1fa
