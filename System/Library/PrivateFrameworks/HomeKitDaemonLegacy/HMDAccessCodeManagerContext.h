...
+ (id)logCategory;	// IMP=0x001000000006e9c8
- (void).cxx_destruct;	// IMP=0x000000000006e7fd
...
- (id)generateAccessCodeValueFromConstraints:(id)arg1 accessoryAccessCodes:(id)arg2 homeAccessCodes:(id)arg3;	// IMP=0x000000000006e76a
- (id)hapAccessoryWithUUID:(id)arg1;	// IMP=0x000000000006e67f
...
- (id)userWithUUID:(id)arg1;	// IMP=0x000000000006e40e
- (id)userForMessage:(id)arg1;	// IMP=0x000000000006e394
- (void)redispatchToResidentMessage:(id)arg1;	// IMP=0x000000000006e2e0
- (id)_performMockedReadRequests:(id)arg1;	// IMP=0x000000000006e106
- (id)performReadRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x000000000006df5b
- (id)performWriteRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x000000000006ddb0
- (id)_performMockedWriteRequests:(id)arg1;	// IMP=0x000000000006dbd6
...
- (void)configureWithMessageDispatcher:(id)arg1;	// IMP=0x000000000006d294
- (id)initWithHome:(id)arg1 workQueue:(id)arg2 UUID:(id)arg3;	// IMP=0x000000000006d123
- (id)initWithHome:(id)arg1 workQueue:(id)arg2;	// IMP=0x000000000006d062
