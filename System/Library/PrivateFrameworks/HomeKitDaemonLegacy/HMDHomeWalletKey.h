...
- (void).cxx_destruct;	// IMP=0x00000000002fe951
...
- (id)attributeDescriptions;	// IMP=0x00000000002fe412
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002fe24d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002fe242
- (unsigned long long)hash;	// IMP=0x00000000002fe032
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002fdc0c
@property(readonly) _Bool isMissingNFCInfo;
- (id)xpcWalletKeyWithExpressEnabled:(_Bool)arg1;	// IMP=0x00000000002fda94
@property(readonly, copy) NSUUID *uuid;
@property(readonly, copy) NSString *labelColorValue;
@property(readonly, copy) NSString *passColorValue;
- (id)initWithPKPass:(id)arg1 flow:(id)arg2;	// IMP=0x00000000002fd4bb
- (id)initWithTypeIdentifier:(id)arg1 serialNumber:(id)arg2 state:(long long)arg3 walletKeyDescription:(id)arg4 homeName:(id)arg5 color:(long long)arg6 nfcInfos:(id)arg7;	// IMP=0x00000000002fd331
