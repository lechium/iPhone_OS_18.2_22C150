...
+ (id)logCategory;	// IMP=0x0010000000408187
- (void).cxx_destruct;	// IMP=0x0000000000407cf2
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000407a50
- (id)logIdentifier;	// IMP=0x0000000000407a3e
- (void)_callDelegate;	// IMP=0x000000000040797d
- (void)_handleStatusUpdateMessageError:(id)arg1 responseTime:(double)arg2;	// IMP=0x0000000000407865
- (void)_send;	// IMP=0x00000000004069d0
- (void)send;	// IMP=0x000000000040695f
- (id)attributeDescriptions;	// IMP=0x000000000040672f
- (void)dealloc;	// IMP=0x00000000004065cd
- (id)initWithDelegate:(id)arg1 workQueue:(id)arg2 targetUUID:(id)arg3 messageDispatcher:(id)arg4 user:(id)arg5 presenceAuthStatus:(id)arg6 presenceComputeStatus:(id)arg7 presenceRegionStatus:(id)arg8 reason:(id)arg9;	// IMP=0x000000000040629f
