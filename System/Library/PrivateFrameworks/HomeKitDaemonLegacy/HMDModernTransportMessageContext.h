...
+ (id)logCategory;	// IMP=0x0010000000639cae
- (void).cxx_destruct;	// IMP=0x0000000000639818
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006392a0
- (void)done;	// IMP=0x0000000000638e39
- (void)startTransportFallbackTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000638cb2
- (void)startResponseTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000638b2b
- (double)timeoutRemaining;	// IMP=0x0000000000638a47
- (id)preparedMessageWithTimeout:(double)arg1;	// IMP=0x000000000063868b
- (void)receivedResponseOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x00000000006385ce
- (void)completeSendingOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x0000000000637f04
- (void)startSendingOverTransport:(id)arg1;	// IMP=0x0000000000637a82
@property(readonly, copy, nonatomic) NSSet *inProgressTransports;
@property(readonly, nonatomic) _Bool expectsResponse;
@property(readonly, nonatomic) double timeout;
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5;	// IMP=0x00000000006377bf
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5 activityFactory:(id)arg6 logEventSubmitter:(id)arg7;	// IMP=0x0000000000637319
