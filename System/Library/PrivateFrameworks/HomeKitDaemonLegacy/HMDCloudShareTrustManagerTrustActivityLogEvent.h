...
- (void).cxx_destruct;	// IMP=0x00000000008b6e5d
...
- (id)initWithTrustActivityType:(long long)arg1 privilege:(unsigned long long)arg2 isPrimaryResident:(_Bool)arg3;	// IMP=0x00000000008b6c09
