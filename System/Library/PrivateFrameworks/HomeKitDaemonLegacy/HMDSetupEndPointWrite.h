...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a064f
- (void).cxx_destruct;	// IMP=0x00000000000a05fc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a04d5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a0247
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000a005a
- (_Bool)_parseFromTLVDataOnFailure;	// IMP=0x000000000009ff67
- (_Bool)_parseFromTLVDataOnSuccess;	// IMP=0x000000000009ff55
- (_Bool)_parseFromTLVDataImpl;	// IMP=0x000000000009fc8b
- (_Bool)_parseFromTLVData;	// IMP=0x000000000009fc79
@property(readonly, copy) NSData *tlvData;
- (id)initWithSessionIdentifier:(id)arg1 address:(id)arg2 videoSrtpParameters:(id)arg3 audioSrtpParameters:(id)arg4;	// IMP=0x000000000009f9d2
