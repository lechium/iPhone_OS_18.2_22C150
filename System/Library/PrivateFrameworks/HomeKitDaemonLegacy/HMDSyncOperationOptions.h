...
- (void).cxx_destruct;	// IMP=0x00000000006c5b87
...
- (id)description;	// IMP=0x00000000006c597d
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 delayRespected:(_Bool)arg3;	// IMP=0x00000000006c5965
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 cloudConflict:(_Bool)arg3 delayRespected:(_Bool)arg4;	// IMP=0x00000000006c58b0
