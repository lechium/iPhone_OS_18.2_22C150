...
@interface HMDNaturalLightingCurveWriter : HMFObject <HMFMessageReceiver>
{
...
+ (id)logCategory;	// IMP=0x0010000000c21222
- (void).cxx_destruct;	// IMP=0x0000000000c20c3e
...
- (_Bool)supportsDeviceWithCapabilities:(id)arg1;	// IMP=0x0000000000c20b0b
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000c207b1
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)writeForNaturalLightingEnabledWithReason:(id)arg1;	// IMP=0x0000000000c206ac
- (void)synchronizeCurveWithActiveTransitionContext:(id)arg1;	// IMP=0x0000000000c20211
- (void)writeWithNaturalLightingEnabled:(_Bool)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000c1fff2
- (void)handleCurrentDevicePrimaryResidentChangedWithReason:(id)arg1;	// IMP=0x0000000000c1fe0b
- (void)handlePrimaryResidentUpdateNotification:(id)arg1;	// IMP=0x0000000000c1fd53
- (void)handleActiveTransitionContextUpdated:(id)arg1;	// IMP=0x0000000000c1f4c6
- (void)configureWithLightProfile:(id)arg1;	// IMP=0x0000000000c1f1ed
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3 dataSource:(id)arg4 notificationCenter:(id)arg5 timerFactory:(CDUnknownBlockType)arg6;	// IMP=0x0000000000c1f0a2
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3;	// IMP=0x0000000000c1efc0
