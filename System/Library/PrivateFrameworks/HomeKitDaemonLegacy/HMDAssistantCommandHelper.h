...
@interface HMDAssistantCommandHelper : HMFObject <HMFMessageReceiver>
{
...
+ (id)logCategory;	// IMP=0x001000000035a4b5
- (void).cxx_destruct;	// IMP=0x0000000000359707
...
- (void)removeResponses:(id)arg1;	// IMP=0x00000000003594c3
- (void)addActionSetRequest:(id)arg1 actionSet:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000358f70
- (void)addWriteRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000358b3f
- (void)addReadRequests:(id)arg1 home:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000358717
- (void)addMediaWriteRequests:(id)arg1 withRequestProperty:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000357fa0
- (void)handleAccessoryCharacteristicsChangedNotification:(id)arg1;	// IMP=0x0000000000357ee8
- (void)__handleAccessoryCharacteristicsChanged:(id)arg1;	// IMP=0x0000000000356f7d
- (void)_reportOperationStartedForAccessory:(id)arg1;	// IMP=0x0000000000356719
- (void)reportOperationStartedForAccessory:(id)arg1;	// IMP=0x0000000000356661
- (void)_reportResponses;	// IMP=0x00000000003559b6
- (void)_reportResponsesForMediaRequests;	// IMP=0x0000000000355273
- (void)timeoutAndReportResults;	// IMP=0x0000000000355202
- (void)_register;	// IMP=0x000000000035519e
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)dealloc;	// IMP=0x00000000003550d2
- (id)initWithQueue:(id)arg1 msgDispatcher:(id)arg2;	// IMP=0x0000000000354f7b
