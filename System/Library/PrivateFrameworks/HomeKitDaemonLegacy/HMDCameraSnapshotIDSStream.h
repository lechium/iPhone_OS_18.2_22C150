...
+ (id)logCategory;	// IMP=0x001000000063a929
- (void).cxx_destruct;	// IMP=0x000000000063a8d6
...
- (id)logIdentifier;	// IMP=0x000000000063a82e
- (void)dealloc;	// IMP=0x000000000063a6fa
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 proxyService:(id)arg3;	// IMP=0x000000000063a52e
