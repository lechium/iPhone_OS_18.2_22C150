...
+ (id)logCategory;	// IMP=0x0010000000be1a9b
- (void).cxx_destruct;	// IMP=0x0000000000bdda55
...
- (id)logIdentifier;	// IMP=0x0000000000bdd943
- (void)__handleDeviceRemovedFromAccount:(id)arg1;	// IMP=0x0000000000bdd8af
- (void)__handleAccountRemovedFromRegistry:(id)arg1;	// IMP=0x0000000000bdd81b
- (void)__handleRemovedIdentity:(id)arg1;	// IMP=0x0000000000bdd787
- (void)handleSecureMessage:(id)arg1 fromDevice:(id)arg2 fromTransport:(id)arg3;	// IMP=0x0000000000bdd694
- (void)handleCompletedMessage:(id)arg1 options:(id)arg2 responsePayload:(id)arg3 error:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000bdd54b
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000bdd481
- (void)stop;	// IMP=0x0000000000bdd42f
- (void)_closeWithError:(id)arg1;	// IMP=0x0000000000bdd358
- (void)closedWithError:(id)arg1;	// IMP=0x0000000000bdd2c4
- (void)_configureWithCompletionQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000bdcb5e
- (void)startAndInvokeOnQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000bdcaa0
@property(readonly, copy) NSDate *lastActivity; // @synthesize lastActivity=_lastActivity;
- (void)setIdle:(_Bool)arg1;	// IMP=0x0000000000bdc937
@property(readonly, getter=isIdle) _Bool idle; // @synthesize idle=_idle;
- (void)setAuthenticated:(_Bool)arg1;	// IMP=0x0000000000bdc8c0
@property(readonly, getter=isAuthenticated) _Bool authenticated; // @synthesize authenticated=_authenticated;
- (void)setOpen:(_Bool)arg1;	// IMP=0x0000000000bdc849
@property(readonly, getter=isOpen) _Bool open; // @synthesize open=_open;
- (void)setMaximumRemoteStreams:(id)arg1;	// IMP=0x0000000000bdc7be
...
- (void)dealloc;	// IMP=0x0000000000bdc2ee
- (id)initWithCurrentDevice:(id)arg1 peerDevice:(id)arg2 clientMode:(_Bool)arg3 sessionID:(id)arg4 accountRegistry:(id)arg5;	// IMP=0x0000000000bdc068
