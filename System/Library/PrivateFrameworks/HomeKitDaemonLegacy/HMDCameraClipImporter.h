...
+ (id)logCategory;	// IMP=0x00100000009af960
- (void).cxx_destruct;	// IMP=0x00000000009add48
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x00000000009ace3e
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x00000000009accc5
