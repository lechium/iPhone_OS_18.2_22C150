...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000089b4d6
- (void).cxx_destruct;	// IMP=0x000000000089b447
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000089b331
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000089b175
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000089af79
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000089ab97
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 videoAttributes:(id)arg3;	// IMP=0x000000000089aacd
