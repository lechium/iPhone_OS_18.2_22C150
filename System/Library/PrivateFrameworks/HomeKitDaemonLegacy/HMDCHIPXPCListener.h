...
+ (id)logCategory;	// IMP=0x00100000000667be
- (void).cxx_destruct;	// IMP=0x0000000000066410
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000065cb0
- (id)createClientConnectionWithRemoteObjectProxy:(id)arg1 homeManager:(id)arg2 connection:(id)arg3 backgroundModeEntitled:(_Bool)arg4;	// IMP=0x0000000000065b47
- (void)stop;	// IMP=0x0000000000065b0a
- (void)start;	// IMP=0x00000000000659f7
- (id)initWithHomeManager:(id)arg1;	// IMP=0x000000000006577b
