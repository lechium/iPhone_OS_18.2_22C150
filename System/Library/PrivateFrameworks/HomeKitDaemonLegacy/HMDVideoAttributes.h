...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000098aab
+ (_Bool)translateImageResolution:(id)arg1 imageWidth:(id *)arg2 imageHeight:(id *)arg3;	// IMP=0x0010000000098a5a
- (void).cxx_destruct;	// IMP=0x0000000000098a07
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000988e0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000098631
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000098475
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000009816e
- (id)translateImageWidth:(id)arg1 imageHeight:(id)arg2;	// IMP=0x0000000000097aaa
- (id)initWithResolution:(id)arg1 framerate:(id)arg2;	// IMP=0x000000000009793d
