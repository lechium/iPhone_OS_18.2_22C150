...
+ (id)logCategory;	// IMP=0x0010000000a6fb8f
- (void).cxx_destruct;	// IMP=0x0000000000a6fa2d
...
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x0000000000a6f732
- (void)handleCharacteristicsValueUpdated:(id)arg1;	// IMP=0x0000000000a6f67a
- (void)handleAccessoryConfigured:(id)arg1;	// IMP=0x0000000000a6f609
- (void)_handleObservedCharacteristicsValueUpdate:(id)arg1;	// IMP=0x0000000000a6e9bd
- (void)start;	// IMP=0x0000000000a6e86c
- (void)dealloc;	// IMP=0x0000000000a6e6e0
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2 availabilityListener:(id)arg3 notificationCenter:(id)arg4;	// IMP=0x0000000000a6e4c3
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000a6e2df
