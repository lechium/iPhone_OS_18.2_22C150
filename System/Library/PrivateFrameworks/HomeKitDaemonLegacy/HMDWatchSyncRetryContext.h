...
+ (id)createWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3;	// IMP=0x001000000023b599
- (void).cxx_destruct;	// IMP=0x000000000023b568
...
- (id)attributeDescriptions;	// IMP=0x000000000023b375
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000023b36a
@property(readonly) double retryInterval;
- (id)initWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3 initialRetryInterval:(double)arg4 maximumRetryAttempts:(long long)arg5;	// IMP=0x000000000023b22c
