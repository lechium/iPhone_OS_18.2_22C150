...
+ (id)logCategory;	// IMP=0x00100000002f508c
- (void).cxx_destruct;	// IMP=0x00000000002f455f
...
- (id)logIdentifier;	// IMP=0x00000000002f43bd
- (void)accessory:(id)arg1 didCloseDataStreamWithError:(id)arg2;	// IMP=0x00000000002f4305
- (void)accessoryDidStartListening:(id)arg1;	// IMP=0x00000000002f424d
- (void)accessory:(id)arg1 didReceiveBulkSessionCandidate:(id)arg2;	// IMP=0x00000000002f4233
- (void)_bulkSendDidComplete;	// IMP=0x00000000002f4198
- (void)_bulkSendDidFail;	// IMP=0x00000000002f40fd
- (_Bool)_handleFrame:(id)arg1;	// IMP=0x00000000002f405f
@property(readonly, getter=isSessionOpenInProgress) _Bool sessionOpenInProgress;
- (void)_handleAccessoryDidClose;	// IMP=0x00000000002f3eac
- (void)_callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000002f3c80
- (void)callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000002f3ba2
- (void)_openSession;	// IMP=0x00000000002f3a09
- (void)_setUpTransport;	// IMP=0x00000000002f38a5
- (void)readData;	// IMP=0x00000000002f36cf
- (void)setUpWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000002f3526
@property(readonly, getter=isBulkSendActive) _Bool bulkSendActive;
- (void)dealloc;	// IMP=0x00000000002f338d
- (void)shutDown;	// IMP=0x00000000002f31e5
- (id)attributeDescriptions;	// IMP=0x00000000002f2ffa
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 fileType:(id)arg3 metadata:(id)arg4 reason:(id)arg5;	// IMP=0x00000000002f2ee4
