...
- (void).cxx_destruct;	// IMP=0x0000000000362cf6
...
- (unsigned long long)hash;	// IMP=0x0000000000362c80
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000362bab
- (id)initWithIdentifier:(id)arg1 protocol:(id)arg2 topic:(id)arg3 payload:(id)arg4 callback:(CDUnknownBlockType)arg5;	// IMP=0x0000000000362aa6
