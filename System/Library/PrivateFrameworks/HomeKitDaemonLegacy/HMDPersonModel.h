...
+ (id)sentinelParentUUID;	// IMP=0x0040000000701581
+ (id)hmbProperties;	// IMP=0x0040000000701551
- (id)createPerson;	// IMP=0x0000000000701c23
- (id)initWithPerson:(id)arg1;	// IMP=0x0000000000701b0e
