...
- (void).cxx_destruct;	// IMP=0x0000000000241507
...
- (id)initWithGroup:(id)arg1 recordName:(id)arg2 uuid:(id)arg3 parentUuid:(id)arg4 type:(id)arg5;	// IMP=0x00000000002411b3
