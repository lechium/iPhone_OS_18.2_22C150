...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000530fcb
- (void).cxx_destruct;	// IMP=0x0000000000530fa3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000530cb1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000530c23
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000530948
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000005305c1
- (id)initWithStatus:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000000530528
- (id)init;	// IMP=0x00000000005304f9
