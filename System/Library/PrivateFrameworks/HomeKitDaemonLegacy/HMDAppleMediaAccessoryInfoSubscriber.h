...
+ (id)logCategory;	// IMP=0x0010000000bfccea
- (void).cxx_destruct;	// IMP=0x0000000000bfc8b1
...
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0000000000bfc224
- (void)didReceiveCachedEvent:(id)arg1 topic:(id)arg2 source:(id)arg3;	// IMP=0x0000000000bfc212
- (void)subscribeToWiFiInfoUpdate;	// IMP=0x0000000000bfc002
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2;	// IMP=0x0000000000bfbf68
