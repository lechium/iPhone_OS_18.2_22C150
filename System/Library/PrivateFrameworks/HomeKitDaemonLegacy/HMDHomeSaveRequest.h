...
- (void).cxx_destruct;	// IMP=0x00000000009675b6
...
- (void)_updateSaveOptions:(_Bool)arg1 reason:(id)arg2;	// IMP=0x000000000096750d
- (id)initWithReason:(id)arg1 information:(id)arg2 saveOptions:(unsigned long long)arg3;	// IMP=0x00000000009674e5
- (id)initWithReason:(id)arg1 information:(id)arg2 postSyncNotification:(_Bool)arg3;	// IMP=0x00000000009674b8
- (id)initWithHome:(id)arg1 reason:(id)arg2 information:(id)arg3 postSyncNotification:(_Bool)arg4 objectChange:(_Bool)arg5;	// IMP=0x0000000000967431
- (id)_initWithHome:(id)arg1 reason:(id)arg2 information:(id)arg3 postSyncNotification:(_Bool)arg4 objectChange:(_Bool)arg5 saveOptions:(unsigned long long)arg6;	// IMP=0x0000000000967327
