...
- (void).cxx_destruct;	// IMP=0x000000000023e231
...
- (id)mainReturningError;	// IMP=0x000000000023de98
- (id)initWithGroup:(id)arg1 subscription:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000023dde2
