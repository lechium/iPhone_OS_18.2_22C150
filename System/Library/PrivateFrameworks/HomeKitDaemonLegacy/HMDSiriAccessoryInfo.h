...
+ (id)infoWithTargetableAccessory:(id)arg1;	// IMP=0x00600000001e74de
- (void).cxx_destruct;	// IMP=0x00000000001e74d0
...
- (_Bool)isActiveAndSupportsDragonSiri;	// IMP=0x00000000001e7447
