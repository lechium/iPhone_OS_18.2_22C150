...
+ (id)createWithJSONDictionary:(id)arg1 name:(id)arg2 critical:(_Bool)arg3 purpose:(unsigned long long)arg4 allowInterAccessoryConnections:(_Bool)arg5 direction:(unsigned char)arg6 requiredForHAPFunctionality:(_Bool)arg7 ruleDictionary:(id)arg8 error:(id *)arg9;	// IMP=0x0060000000c38a51
- (void).cxx_destruct;	// IMP=0x0000000000c38a0b
...
- (id)prettyJSONDictionary;	// IMP=0x0000000000c386e3
- (id)attributeDescriptions;	// IMP=0x0000000000c3847d
- (unsigned long long)hash;	// IMP=0x0000000000c383ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c381d5
- (id)initWithJSONDictionary:(id)arg1 name:(id)arg2 critical:(_Bool)arg3 purpose:(unsigned long long)arg4 allowInterAccessoryConnections:(_Bool)arg5 direction:(unsigned char)arg6 requiredForHAPFunctionality:(_Bool)arg7 transportProtocol:(unsigned char)arg8 ipAddress:(id)arg9 portStart:(unsigned short)arg10 portEnd:(unsigned short)arg11 icmpTypes:(id)arg12;	// IMP=0x0000000000c380b1
