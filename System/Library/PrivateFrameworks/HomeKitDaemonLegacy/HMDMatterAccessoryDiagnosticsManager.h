...
- (void).cxx_destruct;	// IMP=0x000000000008ef58
...
- (void)handleDiagnosticsTransferWithOptions:(id)arg1 message:(id)arg2;	// IMP=0x000000000008ede3
- (id)_diagnosticsMetadataFromFile:(id)arg1 outError:(id *)arg2;	// IMP=0x000000000008e8eb
- (void)shutDown;	// IMP=0x000000000008e87a
- (void)start;	// IMP=0x000000000008e809
- (id)initWithAccessory:(id)arg1;	// IMP=0x000000000008e766
