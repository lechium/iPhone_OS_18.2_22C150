...
- (void).cxx_destruct;	// IMP=0x00000000009b0114
...
- (id)attributeDescriptions;	// IMP=0x00000000009afcdd
- (id)initWithClipModelID:(id)arg1 operation:(id)arg2;	// IMP=0x00000000009afc2a
