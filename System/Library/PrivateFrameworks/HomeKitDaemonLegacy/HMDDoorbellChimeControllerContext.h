...
- (void).cxx_destruct;	// IMP=0x00000000006d34b6
...
- (_Bool)accessorySupportsCoordinationFreeDoorbellChime:(id)arg1;	// IMP=0x00000000006d343e
@property(readonly, copy) NSUUID *currentAccessoryUUID;
- (id)fetchDoorbellDelay;	// IMP=0x00000000006d335a
...
- (id)initWithWorkQueue:(id)arg1 accessory:(id)arg2;	// IMP=0x00000000006d305e
