...
+ (id)logCategory;	// IMP=0x001000000056be9d
+ (id)sharedTracker;	// IMP=0x001000000056be6d
- (void).cxx_destruct;	// IMP=0x000000000056bda5
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000056bcad
@property(readonly, copy) NSDictionary *stateDump;
- (void)submitCounters;	// IMP=0x000000000056b4ee
- (id)sampleCountersAndReset:(_Bool)arg1;	// IMP=0x000000000056b331
- (void)incrementCounterOfType:(long long)arg1 clientIdentifier:(id)arg2 messageName:(id)arg3;	// IMP=0x000000000056b1b8
- (id)countersOfType:(long long)arg1;	// IMP=0x000000000056b133
- (id)mutableCountersOfType:(long long)arg1;	// IMP=0x000000000056b0db
- (void)_resetCounters;	// IMP=0x000000000056aff5
- (void)configure;	// IMP=0x000000000056af71
- (id)initWithLogEventSubmitter:(id)arg1 submissionTimer:(id)arg2;	// IMP=0x000000000056ae41
- (id)init;	// IMP=0x000000000056ad32
