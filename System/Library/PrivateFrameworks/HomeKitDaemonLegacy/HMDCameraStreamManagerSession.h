...
+ (id)logCategory;	// IMP=0x00100000000ad99c
- (void).cxx_destruct;	// IMP=0x00000000000ad927
...
- (id)logIdentifier;	// IMP=0x00000000000ad831
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x00000000000ad652
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x00000000000ad4cf
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x00000000000ad39c
