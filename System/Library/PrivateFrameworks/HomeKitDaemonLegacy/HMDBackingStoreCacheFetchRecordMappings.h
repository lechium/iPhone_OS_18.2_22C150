...
- (void).cxx_destruct;	// IMP=0x00000000002418f4
...
- (id)mainReturningError;	// IMP=0x0000000000241627
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000024156b
