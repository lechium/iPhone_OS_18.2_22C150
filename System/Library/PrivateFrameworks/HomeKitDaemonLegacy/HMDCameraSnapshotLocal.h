...
+ (id)logCategory;	// IMP=0x00100000002607e2
- (void).cxx_destruct;	// IMP=0x0000000000260657
...
- (void)_handleSnapshotFile:(id)arg1 error:(id)arg2;	// IMP=0x0000000000260347
- (void)_getSnapshot:(unsigned long long)arg1;	// IMP=0x0000000000260225
- (void)getSnapshot:(unsigned long long)arg1;	// IMP=0x00000000002601a9
- (id)logIdentifier;	// IMP=0x0000000000260159
- (void)dealloc;	// IMP=0x000000000026005a
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 accessory:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 snapshotRequestHandler:(id)arg6;	// IMP=0x000000000025ff24
