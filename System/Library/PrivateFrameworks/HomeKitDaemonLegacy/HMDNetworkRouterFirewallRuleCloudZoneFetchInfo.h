...
+ (id)logCategory;	// IMP=0x00100000008c9028
- (void).cxx_destruct;	// IMP=0x00000000008c8fd5
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000008c8edb
- (id)initWithOptions:(id)arg1 changeToken:(id)arg2 promise:(id)arg3 database:(id)arg4 useAnonymousRequests:(_Bool)arg5 interestedRecordIDs:(id)arg6 mirrorInput:(id)arg7;	// IMP=0x00000000008c8d0f
