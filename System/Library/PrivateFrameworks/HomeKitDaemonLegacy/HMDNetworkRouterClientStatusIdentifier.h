...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000535d14
- (void).cxx_destruct;	// IMP=0x0000000000535ce1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000535901
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000535849
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000053547b
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000053505b
- (id)initWithClientIdentifier:(id)arg1 macAddress:(id)arg2 ipAddress:(id)arg3;	// IMP=0x0000000000534fa3
- (id)init;	// IMP=0x0000000000534f74
