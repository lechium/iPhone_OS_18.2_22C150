...
- (void).cxx_destruct;	// IMP=0x000000000036c6df
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000036c518
- (id)description;	// IMP=0x000000000036c3b9
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3 maximumBitrate:(id)arg4 minimumBitrate:(id)arg5 rtcpInterval:(id)arg6 rtpPtime:(id)arg7;	// IMP=0x000000000036c2c2
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3;	// IMP=0x000000000036c1f8
