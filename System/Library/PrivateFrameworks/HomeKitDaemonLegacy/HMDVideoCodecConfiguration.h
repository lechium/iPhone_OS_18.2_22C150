...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000099e3d
- (void).cxx_destruct;	// IMP=0x0000000000099cc4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000099bae
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009994a
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000009977e
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000099395
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 attributes:(id)arg3;	// IMP=0x00000000000992cb
