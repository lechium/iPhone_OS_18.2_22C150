...
- (void).cxx_destruct;	// IMP=0x00000000009faff2
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000009faf29
- (id)initWithTimeoutTimer:(id)arg1 workQueue:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000009fae0d
