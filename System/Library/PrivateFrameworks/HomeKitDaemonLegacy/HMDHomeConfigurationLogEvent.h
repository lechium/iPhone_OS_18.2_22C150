...
- (void).cxx_destruct;	// IMP=0x0000000000549e63
...
- (void)updateConfigWithAccessory:(id)arg1 reportNetworkProtectionMetrics:(_Bool)arg2 networkProtectionEnabled:(_Bool)arg3 hapServiceTypes:(id)arg4 primaryHAPServiceTypes:(id)arg5;	// IMP=0x0000000000545708
- (id)initWithDataSource:(id)arg1 home:(id)arg2 configuredWidgetsCount:(long long)arg3;	// IMP=0x0000000000543316
- (id)initWithHome:(id)arg1 configuredWidgetsCount:(long long)arg2;	// IMP=0x00000000005432fe
- (long long)weeksSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x0000000000543298
- (long long)daysSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x00000000005431d1
- (void)setHomeConfigurationBitMasks;	// IMP=0x00000000005430b5
