...
- (void).cxx_destruct;	// IMP=0x000000000034fe7a
...
- (id)attributeDescriptions;	// IMP=0x000000000034fbf8
- (id)initWithLocation:(id)arg1 reachableIPAccessoryCount:(unsigned long long)arg2 reachableBTLEAccessoryCount:(unsigned long long)arg3 reachableMediaAccessoryCount:(unsigned long long)arg4;	// IMP=0x000000000034fb42
