...
+ (id)logCategory;	// IMP=0x00100000002f2e7d
- (void).cxx_destruct;	// IMP=0x00000000002f2c94
...
- (id)deleteSiriHistoryOperationWithConnection:(id)arg1;	// IMP=0x00000000002f2c04
- (id)connectionForEndpointUUID:(id)arg1;	// IMP=0x00000000002f2b0a
- (void)deleteSiriHistoryWithEndpointUUID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002f267e
- (id)initWithScheduler:(id)arg1;	// IMP=0x00000000002f2610
