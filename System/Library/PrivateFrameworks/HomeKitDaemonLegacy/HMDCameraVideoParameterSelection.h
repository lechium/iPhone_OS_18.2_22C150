...
+ (id)logCategory;	// IMP=0x00600000006e2d62
- (void).cxx_destruct;	// IMP=0x00000000006e2c21
...
- (void)_generateAllCombinations;	// IMP=0x00000000006e0fae
- (id)createReselectedVideoParameters:(id)arg1;	// IMP=0x00000000006e0e43
- (id)createSelectedVideoParameters;	// IMP=0x00000000006e0a59
- (id)createSRTPParamters;	// IMP=0x00000000006e09ce
- (_Bool)_selectParametersFromCodec:(id)arg1 profiles:(id)arg2 levels:(id)arg3 packetizationModes:(id)arg4 videoAttributes:(id)arg5;	// IMP=0x00000000006e00ae
- (_Bool)selectVideoParameters;	// IMP=0x00000000006df13f
- (id)logIdentifier;	// IMP=0x00000000006df0ef
- (void)_setVideoResolutionPreference;	// IMP=0x00000000006ded0b
- (id)initWithSessionID:(id)arg1 videoTierParameters:(id)arg2 supportedVideoConfiguration:(id)arg3 supportedRTPConfiguration:(id)arg4 streamingCapabilities:(id)arg5;	// IMP=0x00000000006deb1d
