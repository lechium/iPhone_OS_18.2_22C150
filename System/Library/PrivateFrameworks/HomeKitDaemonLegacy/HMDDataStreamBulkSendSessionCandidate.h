...
- (void).cxx_destruct;	// IMP=0x0000000000be1d1f
...
- (void)rejectBulkSendSessionWithStatus:(unsigned short)arg1;	// IMP=0x0000000000be1c70
- (void)acceptBulkSendSessionOnQueue:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0000000000be1be2
- (id)initWithProtocol:(id)arg1 requestHeader:(id)arg2 metadata:(id)arg3;	// IMP=0x0000000000be1b02
