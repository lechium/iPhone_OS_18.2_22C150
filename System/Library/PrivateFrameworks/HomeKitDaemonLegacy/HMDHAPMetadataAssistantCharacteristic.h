...
- (void).cxx_destruct;	// IMP=0x00000000002510d7
...
- (id)description;	// IMP=0x0000000000250edd
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x0000000000250d3f
- (id)init;	// IMP=0x0000000000250c97
