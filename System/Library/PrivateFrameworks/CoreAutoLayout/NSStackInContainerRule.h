...
+ (id)verticalStackWithRects:(id)arg1 inContainer:(id)arg2 spacing:(double)arg3;	// IMP=0x0010000000004a53
+ (id)horizontalStackWithRects:(id)arg1 inContainer:(id)arg2 spacing:(double)arg3;	// IMP=0x0010000000004a39
+ (id)stackWithOrientation:(long long)arg1 stackedRects:(id)arg2 inContainer:(id)arg3 spacing:(double)arg4;	// IMP=0x00100000000049ed
...
- (id)makeChildRules;	// IMP=0x0000000000004a70
@property(readonly, copy) NSString *identifier;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000493f
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000048b1
- (void)dealloc;	// IMP=0x0000000000004867
