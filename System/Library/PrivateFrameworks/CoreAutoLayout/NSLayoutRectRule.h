...
- (id)makeChildRules;	// IMP=0x0000000000003a42
@property(readonly, copy) NSString *identifier;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000039b2
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003961
- (void)dealloc;	// IMP=0x0000000000003917
