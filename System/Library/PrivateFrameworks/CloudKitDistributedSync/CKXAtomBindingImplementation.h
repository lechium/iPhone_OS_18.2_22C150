...
- (void).cxx_destruct;	// IMP=0x00000000000ca359
@property(retain, nonatomic) CKXSchema *schema; // @synthesize schema=_schema;
- (id)orcHelpers;	// IMP=0x00000000000ca2a7
- (Class)mutableProxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000ca199
- (Class)proxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000ca08b
- (unsigned long long)structTokenForClass:(Class)arg1;	// IMP=0x00000000000c9ea2
- (unsigned long long)topLevelStructToken;	// IMP=0x00000000000c9e98
- (id)init;	// IMP=0x00000000000c9e1e
