...
- (id).cxx_construct;	// IMP=0x00000000000e3b1c
- (void).cxx_destruct;	// IMP=0x00000000000e3ae2
@property(readonly, nonatomic) __weak CKXStructProxyBase *proxy; // @synthesize proxy=_proxy;
- (id)structListProxyForListReference:(unsigned long long)arg1 mutable:(_Bool)arg2;	// IMP=0x00000000000e3976
- (id)structProxyForStructReference:(unsigned long long)arg1 mutable:(_Bool)arg2;	// IMP=0x00000000000e3820
- (void)reset;	// IMP=0x00000000000e37d1
- (id)initWithProxy:(id)arg1;	// IMP=0x00000000000e3759
