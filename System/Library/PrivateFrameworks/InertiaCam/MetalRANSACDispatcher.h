...
- (void).cxx_destruct;	// IMP=0x0000000000056184
...
- (void)assureSizeAndCopyToMetalBuffer:(id *)arg1 fromData:(const void *)arg2 dataSize:(unsigned long long)arg3 metalResourceOptions:(unsigned long long)arg4;	// IMP=0x0000000000055f18
- (void)performRansacOnData:(unsigned int)arg1 firstPointSet:(const float *)arg2 secondPointSet:(const float *)arg3 pointWeights:(const float *)arg4 homographies:(const struct ransac_homography_record *)arg5 numHomographies:(unsigned int)arg6 homScores:(float *)arg7;	// IMP=0x0000000000055c8f
- (id)initWithMaxCorrespondences:(unsigned long long)arg1;	// IMP=0x0000000000055a95
