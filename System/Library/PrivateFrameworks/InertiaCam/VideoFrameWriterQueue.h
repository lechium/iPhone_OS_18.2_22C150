...
- (void).cxx_destruct;	// IMP=0x00000000000266c4
...
- (void)DrainIfAbove:(unsigned int)arg1 downTo:(unsigned int)arg2;	// IMP=0x0000000000026371
- (void)StartWatchingForFrames;	// IMP=0x00000000000262ae
- (void)FrameRequestCallback;	// IMP=0x0000000000025e22
- (id)FindFrameWithIndex:(long long)arg1;	// IMP=0x0000000000025d4d
- (_Bool)WaitForFinish;	// IMP=0x0000000000025afc
- (unsigned long long)FramesInQueue;	// IMP=0x0000000000025aad
- (void)AddAFrame:(id)arg1;	// IMP=0x0000000000025a24
- (void)dealloc;	// IMP=0x00000000000259f5
- (id)initWithOutputURL:(id)arg1 forMovieDimensions:(struct CGSize)arg2 outputTransform:(struct CGAffineTransform)arg3 startTime:(CDStruct_1b6d18a9)arg4 endTime:(CDStruct_1b6d18a9)arg5;	// IMP=0x00000000000255dc
