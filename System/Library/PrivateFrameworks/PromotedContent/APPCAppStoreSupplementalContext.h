...
@interface APPCAppStoreSupplementalContext : NSObject
{
    ...
    MISSING_TYPE *additionalImpressionCaps;	// 56 = 0x38
    MISSING_TYPE *additionalClickCaps;	// 64 = 0x40
    MISSING_TYPE *adamId;	// 72 = 0x48
    MISSING_TYPE *appMetadataFields;	// 88 = 0x58
    MISSING_TYPE *requestTime;	// 2004049759 = 0x77735f5f
}

- (void).cxx_destruct;	// IMP=0x0000000000060cb0
- (id)init;	// IMP=0x0000000000060aa0
- (id)copyWithZone:(void *)arg1;	// IMP=0x00000000000609f0
