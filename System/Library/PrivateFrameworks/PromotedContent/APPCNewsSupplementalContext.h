...
@interface APPCNewsSupplementalContext : NSObject
{
    ...
    MISSING_TYPE *superFeedMetadata;	// 712 = 0x2c8
    MISSING_TYPE *anfComponentMetadataInternal;	// 720 = 0x2d0
    MISSING_TYPE *currentIssueIsDraftInternal;	// 728 = 0x2d8
    MISSING_TYPE *currentIssueIsCurrentInternal;	// 736 = 0x2e0
    MISSING_TYPE *requestedAdTypeInternal;	// 744 = 0x2e8
}

- (void).cxx_destruct;	// IMP=0x0000000000087e30
- (id)copyWithZone:(void *)arg1;	// IMP=0x00000000000833b0
