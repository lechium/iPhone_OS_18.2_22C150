...
- (void).cxx_destruct;	// IMP=0x000000000007a780
...
- (id)initWithVisionIdentifier:(id)arg1 minConfidence:(double)arg2 commonBlockingTokens:(id)arg3 categoryBlockingTokens:(id)arg4 categoryBlockingTokensAnnex:(id)arg5;	// IMP=0x000000000007a5c0
