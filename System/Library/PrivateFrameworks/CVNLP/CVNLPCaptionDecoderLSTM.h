...
- (void).cxx_destruct;	// IMP=0x00000000000dad20
- (id)computeCaptionForImageWithInputs:(id)arg1 genderOption:(int)arg2;	// IMP=0x00000000000d9f00
- (void)extractBeamID:(id *)arg1 tokenID:(id *)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 fromFollowup:(id)arg5;	// IMP=0x00000000000d9cc0
- (id)packBeamID:(id)arg1 tokenID:(id)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 softmax:(CDStruct_0a65202a *)arg5;	// IMP=0x00000000000d99f0
- (void)dealloc;	// IMP=0x00000000000d9950
- (id)initWithOptions:(id)arg1 runTimeParams:(id)arg2;	// IMP=0x00000000000d8d20
