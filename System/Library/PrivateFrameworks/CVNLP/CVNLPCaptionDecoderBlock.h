...
- (id).cxx_construct;	// IMP=0x00000000000b6eb0
- (void).cxx_destruct;	// IMP=0x00000000000b6dc0
...
- (void)_runBlockWithCopyOutputBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b5c20
- (void)runBlockWithCopyInput:(float *)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b5a70
- (void)runBlockWithCopyInputBlock:(CDUnknownBlockType)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000b5850
- (void)copyOutputState:(id)arg1;	// IMP=0x00000000000b4ad0
- (void)copyInputState:(id)arg1;	// IMP=0x00000000000b3440
- (void)buildNetworkForSequenceLength:(unsigned long long)arg1 imageFeatures:(id)arg2;	// IMP=0x00000000000af620
- (_Bool)_loadNetwork:(id)arg1 modelIndex:(unsigned long long)arg2;	// IMP=0x00000000000ae3d0
- (void)dealloc;	// IMP=0x00000000000ae2c0
- (id)initWithOptions:(id)arg1 modelIndex:(unsigned long long)arg2 runTimeParams:(id)arg3;	// IMP=0x00000000000ae0a0
