...
@class CCUIContentModuleContainerViewController, UIView, UIViewController;
...
- (struct CGSize)controlCenterGridSizeForContentModuleContainerViewController:(CCUIContentModuleContainerViewController *)arg1;
- (struct CGRect)compactModeFrameForContentModuleContainerViewController:(CCUIContentModuleContainerViewController *)arg1;
- (UIView *)compactModeSourceViewForContentModuleContainerViewController:(CCUIContentModuleContainerViewController *)arg1;
@end
