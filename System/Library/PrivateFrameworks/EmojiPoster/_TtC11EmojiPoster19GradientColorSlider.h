...
- (void)rightColorWasTappedWithGr:(id)arg1;	// IMP=0x0000000000023f80
- (void)leftColorWasTappedWithGr:(id)arg1;	// IMP=0x0000000000023f30
- (void)rightColorDidPanWithGr:(id)arg1;	// IMP=0x0000000000023ee0
- (void)leftColorDidPanWithGr:(id)arg1;	// IMP=0x0000000000023b90
- (void)layoutSubviews;	// IMP=0x0000000000023860
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000023360
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000230e0
