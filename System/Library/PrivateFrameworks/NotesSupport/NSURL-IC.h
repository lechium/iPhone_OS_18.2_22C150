...
@interface NSURL (IC)
+ (id)ic_urlFromWeblocFileAtURL:(id)arg1;	// IMP=0x002000000003ddbb
...
- (_Bool)ic_isSafeFileURLForAttachment;	// IMP=0x001000000003d7d7
...
- (void)ic_updateFlagToExcludeFromBackup:(_Bool)arg1;	// IMP=0x001000000003cfcc
- (id)ic_dedupedURLWithProhibitedNames:(id)arg1;	// IMP=0x001000000003cd27
- (void)ic_updateFlagToExcludeFromBackupNow:(_Bool)arg1;	// IMP=0x001000000003ddc3
@end
