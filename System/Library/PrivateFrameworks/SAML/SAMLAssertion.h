...
+ (id)createElement:(id *)arg1;	// IMP=0x006000000000b7a6
- (id)authorizationForResource:(id)arg1;	// IMP=0x000000000000c0ed
- (_Bool)isValidForRequestor:(id)arg1;	// IMP=0x000000000000bf47
- (_Bool)meetsConditions:(id *)arg1;	// IMP=0x000000000000bef6
- (_Bool)isValid:(id *)arg1;	// IMP=0x000000000000bde2
