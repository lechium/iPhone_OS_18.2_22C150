...
- (void).cxx_destruct;	// IMP=0x000000000031715a
...
- (id)perform;	// IMP=0x0000000000316658
- (id)initWithAccount:(id)arg1 session:(id)arg2 task:(id)arg3;	// IMP=0x000000000031658e
