...
- (void).cxx_destruct;	// IMP=0x00000000004e339a
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00000000004e2c54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004e2b62
