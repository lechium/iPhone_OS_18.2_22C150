...
- (void).cxx_destruct;	// IMP=0x0000000000499f32
...
- (id)description;	// IMP=0x0000000000499d85
- (id)initWithPhoneNumber:(id)arg1 simLabel:(id)arg2 uuid:(id)arg3 isVoicePreferred:(_Bool)arg4;	// IMP=0x0000000000499cc2
