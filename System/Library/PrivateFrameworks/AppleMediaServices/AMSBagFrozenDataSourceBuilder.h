...
- (void).cxx_destruct;	// IMP=0x00000000003017e2
...
- (id)createFrozenDataSource;	// IMP=0x000000000030149a
- (id)createFrozenBag;	// IMP=0x0000000000301324
- (id)initWithFrozenDataSource:(id)arg1;	// IMP=0x0000000000301113
