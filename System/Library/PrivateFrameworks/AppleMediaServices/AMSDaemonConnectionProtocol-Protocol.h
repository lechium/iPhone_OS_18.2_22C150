...
- (void)getPaymentValidationServiceProxyWithReplyHandler:(void (^)(id <AMSPaymentValidationServiceInterface>, NSError *))arg1;
- (void)getPaymentConfirmationServiceProxyWithReplyHandler:(void (^)(id <AMSDPaymentConfirmationInterface>, NSError *))arg1;
