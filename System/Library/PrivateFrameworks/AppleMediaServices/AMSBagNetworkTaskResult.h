...
- (void).cxx_destruct;	// IMP=0x0000000000305ced
...
- (id)initWithData:(id)arg1 expirationDate:(id)arg2 loadedBagIdentifier:(id)arg3 loadedBagPartialIdentifier:(id)arg4 storefront:(id)arg5 accountIdentifier:(id)arg6;	// IMP=0x0000000000305957
