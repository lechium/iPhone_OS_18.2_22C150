...
+ (id)localeSpecificStorageForLocale:(id)arg1;	// IMP=0x00600000002b7667
- (void).cxx_destruct;	// IMP=0x00000000002b7970
...
- (id)initWithLocale:(id)arg1;	// IMP=0x00000000002b7138
