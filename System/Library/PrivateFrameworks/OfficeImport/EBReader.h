...
- (void).cxx_destruct;	// IMP=0x000000000039a3a7
...
- (struct OCCBinaryStreamer *)allocBinaryStreamerWithCryptoKey:(struct OCCCryptoKey *)arg1 baseOutputFilenameInUTF8:(const char *)arg2;	// IMP=0x000000000039a2e9
- (struct OCCEncryptionInfoReader *)encryptionInfoReader;	// IMP=0x000000000010f51a
- (id)read;	// IMP=0x000000000010f6ce
- (_Bool)start;	// IMP=0x000000000010ed52
- (void)dealloc;	// IMP=0x0000000000135a32
- (id)initWithCancelDelegate:(id)arg1;	// IMP=0x000000000039a1ad
