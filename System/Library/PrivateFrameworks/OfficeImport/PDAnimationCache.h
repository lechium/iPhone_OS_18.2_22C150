...
+ (id)createAnimationInfoDataForCacheItem:(id)arg1 order:(unsigned int)arg2;	// IMP=0x0060000000448bdb
+ (void)loadAnimationCache:(id)arg1 pdAnimation:(id)arg2 state:(id)arg3;	// IMP=0x006000000044889b
+ (void)mapAnimationInfo:(id)arg1 cacheData:(id)arg2 state:(id)arg3;	// IMP=0x006000000044943d
+ (void)mapCommonData:(id)arg1 cacheData:(id)arg2 state:(id)arg3;	// IMP=0x0060000000448fbb
- (void).cxx_destruct;	// IMP=0x0000000000448f7a
...
- (id)initWithAnimationInfo:(id)arg1;	// IMP=0x0000000000448520
