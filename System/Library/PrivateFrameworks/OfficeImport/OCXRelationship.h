...
- (void).cxx_destruct;	// IMP=0x000000000037a3ca
...
- (void)writeToStreamWriter:(id)arg1;	// IMP=0x000000000037a2d8
- (id)initWithId:(unsigned long long)arg1 type:(id)arg2 target:(id)arg3 external:(_Bool)arg4;	// IMP=0x000000000037a143
