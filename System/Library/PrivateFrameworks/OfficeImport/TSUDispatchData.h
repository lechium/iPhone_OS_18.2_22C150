...
- (void).cxx_destruct;	// IMP=0x00000000002aae21
...
- (void)defragmentData;	// IMP=0x00000000002aace4
- (void)append:(id)arg1;	// IMP=0x00000000002aac3e
- (id)initWithData:(id)arg1;	// IMP=0x00000000002aab7e
- (id)init;	// IMP=0x00000000002aab65
