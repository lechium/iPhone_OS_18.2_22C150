...
- (void).cxx_destruct;	// IMP=0x000000000045f68b
...
- (long long)textLevel;	// IMP=0x000000000045f654
- (void)popTextLevel;	// IMP=0x00000000000fcedd
- (void)pushTextLevel;	// IMP=0x00000000000f8e1e
@property _Bool isOnPhone; // @synthesize isOnPhone=mIsOnPhone;
@property _Bool isThumbnail; // @synthesize isThumbnail=mIsThumbnail;
- (_Bool)isOffice12;	// IMP=0x0000000000184cf0
- (void)copyFromCMStateWithoutComponents:(id)arg1;	// IMP=0x00000000001e8d88
- (id)getHtmlResource;	// IMP=0x00000000001e8e96
- (void)setHtmlResource:(id)arg1;	// IMP=0x00000000001e8ea4
- (id)resourceUrlPrefix;	// IMP=0x00000000001e8eb5
- (void)setResourceUrlPrefix:(id)arg1;	// IMP=0x000000000045f63a
- (void)setComponentWithName:(id)arg1 value:(id)arg2;	// IMP=0x000000000045f61b
- (id)componentByName:(id)arg1;	// IMP=0x000000000045f5f5
- (id)init;	// IMP=0x000000000003930d
