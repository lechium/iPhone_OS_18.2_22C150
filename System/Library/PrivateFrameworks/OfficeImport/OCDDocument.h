...
- (void).cxx_destruct;	// IMP=0x000000000034ffaa
...
- (id)bulletBlips;	// IMP=0x000000000034ff5f
- (void)setTheme:(id)arg1;	// IMP=0x000000000034ff4e
- (id)theme;	// IMP=0x000000000034ff40
- (void)removeUnnecessaryOverrides;	// IMP=0x000000000034ff3a
- (void)setUpPropertyHierarchyPreservingEffectiveValues;	// IMP=0x000000000034ff34
- (void)setEncryptionInfo:(id)arg1;	// IMP=0x000000000034ff23
- (id)encryptionInfo;	// IMP=0x000000000034ff15
- (_Bool)isFromBinaryFile;	// IMP=0x000000000034feff
- (id)init;	// IMP=0x000000000000a434
