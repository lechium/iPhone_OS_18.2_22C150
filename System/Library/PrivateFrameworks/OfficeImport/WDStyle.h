...
- (void).cxx_destruct;	// IMP=0x00000000003fd644
...
- (id)description;	// IMP=0x00000000003fd5ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003fd425
@property __weak WDStyle *baseStyle; // @synthesize baseStyle=mBaseStyle;
- (id)id;	// IMP=0x000000000019d50e
- (int)type;	// IMP=0x00000000000d1506
- (void)setName:(id)arg1;	// IMP=0x00000000000cedd1
- (id)name;	// IMP=0x00000000000d1512
- (id)tableStyleOverrideForPart:(int)arg1;	// IMP=0x0000000000162b3f
- (id)tableCellProperties;	// IMP=0x00000000001627a0
- (id)tableRowProperties;	// IMP=0x00000000001626ab
- (id)tableProperties;	// IMP=0x000000000019d6b6
- (_Bool)isAnythingOverridden;	// IMP=0x00000000003fd3e2
- (void)setHidden:(_Bool)arg1;	// IMP=0x00000000000cf3d5
- (_Bool)hidden;	// IMP=0x00000000003fd3d6
- (id)characterProperties;	// IMP=0x00000000000d01f4
- (id)paragraphProperties;	// IMP=0x00000000000cf4d9
- (id)initWithStyleSheet:(id)arg1 id:(id)arg2 type:(int)arg3;	// IMP=0x00000000000ceb55
