...
- (void).cxx_destruct;	// IMP=0x000000000024dc4a
...
- (id)stringForObjectValue:(id)arg1;	// IMP=0x000000000024d96e
- (_Bool)getObjectValue:(out id *)arg1 forString:(id)arg2 errorDescription:(out id *)arg3;	// IMP=0x000000000024d821
- (id)init;	// IMP=0x000000000024d6ec
