...
+ (id)csvHeader;	// IMP=0x00600000002637ac
...
- (id)csvString;	// IMP=0x00000000002637b9
- (void)report;	// IMP=0x000000000026355a
- (void)run;	// IMP=0x00000000002630fc
- (void)dealloc;	// IMP=0x00000000002630b2
- (id)initWithName:(id)arg1 selector:(SEL)arg2 target:(id)arg3 goalTime:(double)arg4;	// IMP=0x0000000000262ffd
