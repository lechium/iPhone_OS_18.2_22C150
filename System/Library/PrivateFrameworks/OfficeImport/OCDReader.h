...
- (void).cxx_destruct;	// IMP=0x000000000037942b
...
- (void)setStartErrorMessageFromException:(id)arg1;	// IMP=0x0000000000379391
- (id)initWithCancelDelegate:(id)arg1;	// IMP=0x00000000003792fd
- (_Bool)verifyFileFormat;	// IMP=0x000000000037948a
- (id)read;	// IMP=0x0000000000379482
- (_Bool)start;	// IMP=0x000000000037947a
- (_Bool)isBinaryReader;	// IMP=0x0000000000379472
