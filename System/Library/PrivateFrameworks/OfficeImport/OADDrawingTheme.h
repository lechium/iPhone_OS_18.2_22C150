...
- (void).cxx_destruct;	// IMP=0x0000000000346942
...
- (id)description;	// IMP=0x00000000003467cc
...
- (unsigned long long)hash;	// IMP=0x000000000034671b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000346660
- (void)applyThemeOverrides:(id)arg1 colorMapOverride:(id)arg2;	// IMP=0x000000000034653b
- (id)initWithTheme:(id)arg1 colorMap:(id)arg2 colorPalette:(id)arg3;	// IMP=0x0000000000346330
- (id)initWithStyleMatrix:(id)arg1 fontScheme:(id)arg2 colorScheme:(id)arg3 colorMap:(id)arg4 colorPalette:(id)arg5;	// IMP=0x00000000003461dc
