...
- (void)handleCompletion:(id)arg1;	// IMP=0x000000000001c890
- (void)loadRequest:(id)arg1;	// IMP=0x000000000001c670
- (void)cancel;	// IMP=0x000000000001c5f0
- (void)sendText:(id)arg1;	// IMP=0x000000000001c560
- (void)sendData:(id)arg1;	// IMP=0x000000000001c3d0
- (void)send;	// IMP=0x000000000001c3a0
- (id)init;	// IMP=0x000000000001c310
