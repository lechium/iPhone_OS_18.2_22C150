...
+ (id)urlRequestRewriteRuleWithMatchPattern:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x006000000001ce60
- (void).cxx_destruct;	// IMP=0x000000000001d0b0
...
- (void)rewriteURLRequest:(id)arg1;	// IMP=0x000000000001cf90
- (id)initWithMatchExpression:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x000000000001cd60
