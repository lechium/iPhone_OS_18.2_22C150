...
- (void).cxx_destruct;	// IMP=0x0000000000019e30
...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x00000000000199a0
- (void)layoutSubviews;	// IMP=0x0000000000019860
@property(nonatomic) double spacing;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000018580
