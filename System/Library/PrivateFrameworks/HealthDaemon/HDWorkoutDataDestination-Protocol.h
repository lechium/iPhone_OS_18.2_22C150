...
@class HKDataFlowLink, HKWorkoutActivity, HKWorkoutConfiguration, NSArray, NSDate, NSDictionary, NSError, NSUUID;
...
- (void)didReceiveDataFromRemoteWorkoutSession:(NSArray *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
