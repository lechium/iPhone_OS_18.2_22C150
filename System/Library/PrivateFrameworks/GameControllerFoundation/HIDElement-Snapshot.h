...
- (id)gc_snapshot;	// IMP=0x002000000001fe4e
- (id)debugDescription;	// IMP=0x002000000002f968
- (id)valueForKey:(id)arg1;	// IMP=0x002000000002f845
- (id)valueForElementKey:(id)arg1;	// IMP=0x002000000002f71b
