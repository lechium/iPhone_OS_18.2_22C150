...
- (void).cxx_destruct;	// IMP=0x000000000002f45b
@property(readonly) NSString *configurationType; // @synthesize configurationType=_configurationType;
- (void)_assetDidChange:(id)arg1;	// IMP=0x000000000002f434
- (void)_filesystemDidChange:(id)arg1;	// IMP=0x000000000002f17d
- (id)fetchBundles;	// IMP=0x000000000002ec2f
- (void)dealloc;	// IMP=0x000000000002eb74
- (id)init;	// IMP=0x000000000002eb49
- (id)initWithConfigurationType:(id)arg1 provider:(id)arg2;	// IMP=0x000000000002de6e
