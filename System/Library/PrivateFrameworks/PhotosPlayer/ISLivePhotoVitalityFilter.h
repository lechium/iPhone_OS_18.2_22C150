...
- (void).cxx_destruct;	// IMP=0x0000000000014b97
...
- (void)updateOutput;	// IMP=0x0000000000014b32
- (void)invalidateOutput;	// IMP=0x0000000000014b1b
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000014a88
- (void)setState:(long long)arg1;	// IMP=0x0000000000014a0a
- (id)initWithSettings:(id)arg1;	// IMP=0x000000000001499f
- (id)init;	// IMP=0x000000000001498b
