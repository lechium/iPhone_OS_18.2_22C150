...
- (void).cxx_destruct;	// IMP=0x0000000000026b2b
...
- (void)inputDidChange;	// IMP=0x0000000000026955
- (void)_invalidateOutput;	// IMP=0x000000000002693e
- (void)performOutputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000026868
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000267d5
- (id)initWithSettings:(id)arg1;	// IMP=0x000000000002676a
- (id)init;	// IMP=0x0000000000026756
