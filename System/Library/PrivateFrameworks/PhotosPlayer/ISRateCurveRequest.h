...
- (void)_stopObservingPlayer;	// IMP=0x000000000000376f
- (void)dealloc;	// IMP=0x0000000000003731
- (void)cancel;	// IMP=0x000000000000371b
- (void)_didReachTargetTime;	// IMP=0x0000000000003586
- (void)_stepDownRate;	// IMP=0x00000000000032c2
- (void)start;	// IMP=0x0000000000002fd1
- (id)initWithTargetTime:(CDStruct_1b6d18a9)arg1 duration:(double)arg2 initialRate:(float)arg3 avPlayer:(id)arg4 progressHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000002ef9
