...
- (void)_showVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000e339
- (void)_transitionToVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000e2b4
- (void)_startPlaybackWithPlaybackID:(long long)arg1;	// IMP=0x000000000000e255
- (void)_didFinishPreparing;	// IMP=0x000000000000e203
- (void)_handleDidFinishPreroll;	// IMP=0x000000000000e1f1
- (void)_prerollWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000e110
- (void)_handleDidSeekToBeginning;	// IMP=0x000000000000e06c
- (void)_prepareVideoForPlaybackIfNeeded;	// IMP=0x000000000000de25
- (void)startPlayback;	// IMP=0x000000000000dd9a
- (void)activeDidChange;	// IMP=0x000000000000dd1a
- (void)videoDidPlayToEnd;	// IMP=0x000000000000dcd6
- (void)_handleDidFinish;	// IMP=0x000000000000dc67
- (void)videoWillPlayToEnd;	// IMP=0x000000000000dae6
- (long long)behaviorType;	// IMP=0x000000000000dadb
@property(nonatomic) __weak id <ISLivePhotoPlaybackBehaviorDelegate> delegate; // @dynamic delegate;
- (id)initWithInitialLayoutInfo:(id)arg1 keyTime:(CDStruct_1b6d18a9)arg2 playbackTimeRange:(CDStruct_e83c9415)arg3 photoTransitionDuration:(double)arg4 immediatelyShowsPhotoWhenPlaybackEnds:(_Bool)arg5 hasBlurryTransition:(_Bool)arg6;	// IMP=0x000000000000d99f
