...
- (void).cxx_destruct;	// IMP=0x000000000001eda4
...
- (void)_preparePlayerItem;	// IMP=0x000000000001e164
- (void)_handleValuesDidLoad;	// IMP=0x000000000001e0ff
- (void)main;	// IMP=0x000000000001e02e
- (id)initWithAsset:(id)arg1 trimmedTimeRange:(CDStruct_e83c9415)arg2 photoTime:(CDStruct_1b6d18a9)arg3 includeAudio:(_Bool)arg4 includeVideo:(_Bool)arg5 resultHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000001dee5
