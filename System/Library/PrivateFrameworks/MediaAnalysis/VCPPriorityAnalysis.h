...
+ (id)priorityAnalysis;	// IMP=0x0060000000336c08
- (id).cxx_construct;	// IMP=0x0000000000338434
- (void).cxx_destruct;	// IMP=0x0000000000338361
- (int)calculatePriorityScore:(float *)arg1 ofPixelBuffer:(struct __CVBuffer *)arg2 withMetadata:(id)arg3;	// IMP=0x0000000000337f92
- (int)fastSignLanguageDetection:(float *)arg1 ofPixelBuffer:(struct __CVBuffer *)arg2 withMetadata:(id)arg3;	// IMP=0x0000000000337040
- (int)addKeypointsToNSArray:(struct CGPoint *)arg1 keypointConfidence:(float [21])arg2 handBox:(id)arg3 keypointsArray:(id)arg4;	// IMP=0x0000000000336c22
- (void)dealloc;	// IMP=0x0000000000336b6e
- (id)init;	// IMP=0x000000000033677a
