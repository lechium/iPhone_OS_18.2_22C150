...
+ (id)requestWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x0060000000033c7c
- (void).cxx_destruct;	// IMP=0x0000000000033dbd
...
- (id)initWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000033942
