...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x0010000000290bae
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000014f56
- (unsigned long long)hash;	// IMP=0x0000000000014b88
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000014a62
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000014974
- (void)copyTo:(id)arg1;	// IMP=0x00000000000148c0
- (void)writeTo:(id)arg1;	// IMP=0x00000000000147f5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000147e8
- (id)dictionaryRepresentation;	// IMP=0x00000000000142c6
- (id)description;	// IMP=0x0000000000014217
...
- (id)exportToLegacyDictionary;	// IMP=0x0000000000290e90
