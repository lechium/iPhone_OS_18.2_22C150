...
- (void).cxx_destruct;	// IMP=0x000000000008db82
@property(nonatomic) _Bool enablePowerLog; // @synthesize enablePowerLog=_enablePowerLog;
- (_Bool)run:(id *)arg1;	// IMP=0x000000000008b8d8
- (id)finalizeSafetyResultsWithError:(id *)arg1;	// IMP=0x000000000008b55f
- (_Bool)configureVideoProcessorWithError:(id *)arg1;	// IMP=0x000000000008a8dd
- (void)_processFrameBuffer:(struct opaqueCMSampleBuffer *)arg1 stop:(_Bool *)arg2;	// IMP=0x000000000008a558
- (id)initWithRequest:(id)arg1 forAsset:(id)arg2 cancelBlock:(CDUnknownBlockType)arg3 progressHandler:(CDUnknownBlockType)arg4 andCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000008a353
