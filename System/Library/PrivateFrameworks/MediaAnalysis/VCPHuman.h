...
+ (unsigned long long)flagsFromKeypoints:(id)arg1 withMinConfidence:(float)arg2;	// IMP=0x006000000018f8c4
- (void).cxx_destruct;	// IMP=0x000000000018fbcf
...
- (id)init;	// IMP=0x000000000018f83c
