...
+ (id)pairWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x0060000000352501
- (void).cxx_destruct;	// IMP=0x00000000003525a8
...
- (id)initWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x0000000000352458
