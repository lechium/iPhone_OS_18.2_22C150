...
- (void).cxx_destruct;	// IMP=0x00000000000fcf00
...
- (void)checkAutoPlayable;	// IMP=0x00000000000fcc1e
- (void)copyScoresFrom:(id)arg1;	// IMP=0x00000000000fcab7
- (_Bool)isShort;	// IMP=0x00000000000fca6c
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000fc577
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1;	// IMP=0x00000000000fc4ef
