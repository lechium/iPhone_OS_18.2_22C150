...
+ (_Bool)_isColocatingAnimalObservation:(id)arg1 withFaceObservations:(id)arg2 orTorsoObservations:(id)arg3;	// IMP=0x0010000000080471
+ (double)_calculateIoUBetweenObservation:(id)arg1 andObservation:(id)arg2;	// IMP=0x0010000000080308
+ (double)_calculateOverlappingBetweenFaceObservation:(id)arg1 andBodyObservation:(id)arg2;	// IMP=0x00100000000801f4
+ (id)facesFromPHFetchResult:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000007f778
+ (id)faceFromPHFace:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000007eae3
+ (id)facesFromFaceObservations:(id)arg1 humanObservations:(id)arg2 animalHeadObservations:(id)arg3 animalBodyObservations:(id)arg4 sourceWidth:(unsigned long long)arg5 sourceHeight:(unsigned long long)arg6 visionRequests:(id)arg7 blurScorePerFace:(id)arg8 exposureScorePerFace:(id)arg9 tooSmallFaceObservations:(id)arg10 processingVersion:(int)arg11 animalResults:(id *)arg12;	// IMP=0x001000000007e065
+ (id)_animalHeadsOnlyFromAnimalHeadObservations:(id)arg1 matchedHead:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6;	// IMP=0x001000000007db0b
+ (id)_animalBodiesOnlyFromAnimalBodyObservations:(id)arg1 matchedBody:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6;	// IMP=0x001000000007d6eb
+ (id)_animalHeadsBodiesFromAnimalHeadObservations:(id)arg1 animalBodyObservations:(id)arg2 matchedHead:(void *)arg3 matchedBody:(void *)arg4 sourceWidth:(unsigned long long)arg5 sourceHeight:(unsigned long long)arg6 visionRequests:(id)arg7 processingVersion:(int)arg8;	// IMP=0x001000000007cdb8
+ (id)faceFromAnimalHeadObservation:(id)arg1 animalBodyObservation:(id)arg2 animalLabel:(id)arg3 sourceWidth:(unsigned long long)arg4 sourceHeight:(unsigned long long)arg5 visionRequests:(id)arg6 processingVersion:(int)arg7;	// IMP=0x001000000007c887
+ (id)_animalImageprintWrapperFromObservation:(id)arg1 visionRequests:(id)arg2 processingVersion:(int)arg3;	// IMP=0x001000000007bfab
+ (id)_filterAnimalObservations:(id)arg1 colocatingWithFaceObservations:(id)arg2 orHumanObservations:(id)arg3;	// IMP=0x001000000007bda4
+ (id)_peopleTorsosOnlyFromHumanObservations:(id)arg1 matchedTorso:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6;	// IMP=0x001000000007b1a5
+ (id)_peopleFacesOnlyFromFaceObservations:(id)arg1 matchedFace:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 blurScorePerFace:(id)arg6 exposureScorePerFace:(id)arg7 tooSmallFaceObservations:(id)arg8 processingVersion:(int)arg9;	// IMP=0x001000000007a9e0
+ (id)_peopleFacesTorsosFromFaceObservations:(id)arg1 humanObservations:(id)arg2 matchedFace:(void *)arg3 matchedTorso:(void *)arg4 sourceWidth:(unsigned long long)arg5 sourceHeight:(unsigned long long)arg6 visionRequests:(id)arg7 blurScorePerFace:(id)arg8 exposureScorePerFace:(id)arg9 tooSmallFaceObservations:(id)arg10 processingVersion:(int)arg11;	// IMP=0x0010000000079e9e
+ (id)facesFromFaceObservations:(id)arg1 humanObservations:(id)arg2 animalObservations:(id)arg3 sourceWidth:(unsigned long long)arg4 sourceHeight:(unsigned long long)arg5 visionRequests:(id)arg6 blurScorePerFace:(id)arg7 exposureScorePerFace:(id)arg8 tooSmallFaceObservations:(id)arg9 processingVersion:(int)arg10;	// IMP=0x00100000000762f7
+ (id)faceFromFaceObservation:(id)arg1 humanObservation:(id)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6 force:(_Bool)arg7 andError:(id *)arg8;	// IMP=0x001000000007368e
+ (id)faceWithLocalIdentifier:(id)arg1;	// IMP=0x0010000000073629
- (void).cxx_destruct;	// IMP=0x0000000000081129
...
- (double)photosFaceRepresentationBodyHeight;	// IMP=0x0000000000080c4d
- (double)photosFaceRepresentationBodyWidth;	// IMP=0x0000000000080c3b
- (double)photosFaceRepresentationBodyCenterY;	// IMP=0x0000000000080c29
- (double)photosFaceRepresentationBodyCenterX;	// IMP=0x0000000000080c17
- (double)photosFaceRepresentationQuality;	// IMP=0x0000000000080c05
- (double)photosFaceRepresentationRoll;	// IMP=0x0000000000080bf3
- (id)photosFaceRepresentationLocalIdentifier;	// IMP=0x0000000000080be1
- (long long)photosFaceRepresentationClusterSequenceNumber;	// IMP=0x0000000000080bcf
- (long long)photosFaceRepresentationQualityMeasure;	// IMP=0x0000000000080bbd
- (_Bool)photosFaceRepresentationIsRightEyeClosed;	// IMP=0x0000000000080bab
- (_Bool)photosFaceRepresentationIsLeftEyeClosed;	// IMP=0x0000000000080b99
- (_Bool)photosFaceRepresentationHasSmile;	// IMP=0x0000000000080b87
- (double)photosFaceRepresentationBlurScore;	// IMP=0x0000000000080b75
- (double)photosFaceRepresentationSize;	// IMP=0x0000000000080b63
- (double)photosFaceRepresentationCenterY;	// IMP=0x0000000000080b51
- (double)photosFaceRepresentationCenterX;	// IMP=0x0000000000080b3f
- (long long)photosFaceRepresentationSourceHeight;	// IMP=0x0000000000080b2d
- (long long)photosFaceRepresentationSourceWidth;	// IMP=0x0000000000080b1b
- (long long)qualityMeasureWithCountOfFacesOnAsset:(unsigned long long)arg1;	// IMP=0x00000000000809bf
- (id)gist;	// IMP=0x000000000007ff82
- (struct CGRect)normalizedBodyRect;	// IMP=0x000000000007fee0
- (struct CGRect)normalizedFaceRect;	// IMP=0x000000000007fe63
- (_Bool)setCenterAndSizeFromNormalizedFaceRect:(struct CGRect)arg1;	// IMP=0x000000000007fdc4
- (void)replaceCoordinatesAndFeaturesFromDetectedFace:(id)arg1;	// IMP=0x000000000007f9a6
- (id)initWithLocalIdentifier:(id)arg1;	// IMP=0x00000000000734d0
