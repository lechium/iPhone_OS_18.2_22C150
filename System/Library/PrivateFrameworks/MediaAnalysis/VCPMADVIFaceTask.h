...
+ (id)dependencies;	// IMP=0x0010000000271c25
+ (id)taskWithRequest:(id)arg1 imageAsset:(id)arg2 andSignpostPayload:(id)arg3;	// IMP=0x0010000000271a0d
- (void).cxx_destruct;	// IMP=0x000000000027427c
- (int)run;	// IMP=0x0000000000271dc4
- (void)cancel;	// IMP=0x0000000000271c59
- (_Bool)autoCancellable;	// IMP=0x0000000000271c51
- (float)resourceRequirement;	// IMP=0x0000000000271c43
- (void)setPreferredMetalDevice:(id)arg1;	// IMP=0x0000000000271c32
- (id)initWithRequest:(id)arg1 imageAsset:(id)arg2 andSignpostPayload:(id)arg3;	// IMP=0x0000000000271913
