...
- (void).cxx_destruct;	// IMP=0x000000000011f6ef
...
- (struct CGRect)faceBoundsWithTransform:(unsigned long long)arg1 height:(unsigned long long)arg2 transform:(struct CGAffineTransform)arg3;	// IMP=0x000000000011f53e
- (struct CGRect)faceBounds:(unsigned long long)arg1 height:(unsigned long long)arg2;	// IMP=0x000000000011f4df
- (unsigned long long)flagsForOrientation:(_Bool)arg1 width:(unsigned long long)arg2 height:(unsigned long long)arg3;	// IMP=0x000000000011f475
- (id)init;	// IMP=0x000000000011f412
