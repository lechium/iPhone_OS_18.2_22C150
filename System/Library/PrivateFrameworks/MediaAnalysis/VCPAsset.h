...
+ (void)unimplementedExceptionForMethodName:(id)arg1;	// IMP=0x00800000003a0dd0
- (id)typeDescription;	// IMP=0x00000000003a0f53
...
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1 orientation:(unsigned int *)arg2;	// IMP=0x00000000003a1137
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1;	// IMP=0x00000000003a1113
...
- (struct CGSize)originalMovieSize;	// IMP=0x00000000003a1391
- (id)originalMovie;	// IMP=0x00000000003a136d
- (id)streamedMovie:(_Bool)arg1;	// IMP=0x00000000003a1365
- (_Bool)isMovieResourceLocalAvailable;	// IMP=0x00000000003a1341
- (id)movie;	// IMP=0x00000000003a131d
