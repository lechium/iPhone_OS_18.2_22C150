...
+ (_Bool)supportVectorForward;	// IMP=0x0060000000372421
+ (_Bool)supportGPU;	// IMP=0x0060000000372419
- (void).cxx_destruct;	// IMP=0x00000000003724ab
...
- (int)execute;	// IMP=0x0000000000372437
- (id)initNewContext:(_Bool)arg1;	// IMP=0x0000000000372429
