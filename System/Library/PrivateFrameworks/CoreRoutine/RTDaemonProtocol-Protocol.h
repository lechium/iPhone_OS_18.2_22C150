...
@class CLCircularRegion, CLLocation, GEOMapItemStorage, NSArray, NSData, NSDate, NSNumber, NSSet, NSString, NSUUID, RTBackgroundInertialOdometrySampleEnumerationOptions, RTDiagnosticOptions, RTEnumerationOptions, RTEstimatedLocationOptions, RTFamiliarityIndexOptions, RTLocationsForTripSegmentFetchOptions, RTPlaceInferenceOptions, RTPredictedLocationOfInterest, RTStoredElevationEnumerationOptions, RTStoredLocationEnumerationContext, RTStoredTripSegmentFetchOptions, RTStoredVehicleFetchOptions, RTStoredVisitFetchOptions, RTTripSegmentMetadataFetchOptions;

@protocol RTDaemonProtocol <NSObject>
- (void)addBackgroundInertialOdometrySamples:(NSArray *)arg1 reply:(void (^)(NSError *))arg2;
- (void)fetchBackgroundInertialOdometrySamplesWithOptions:(RTBackgroundInertialOdometrySampleEnumerationOptions *)arg1 reply:(void (^)(NSArray *, NSError *))arg2;
...
- (void)fetchAuthorizedLocationStatus:(void (^)(RTAuthorizedLocationStatus *, NSError *))arg1;
...
- (void)fetchLookbackWindowStartDateWithLocation:(CLLocation *)arg1 reply:(void (^)(NSDate *, NSError *))arg2;
- (void)fetchRemoteStatusWithReply:(void (^)(long long, NSError *))arg1;
...
- (void)stopMonitoringPlaceInferencesWithReply:(void (^)(NSError *))arg1;
- (void)startMonitoringPlaceInferencesWithOptions:(RTPlaceInferenceOptions *)arg1 reply:(void (^)(NSError *))arg2;
