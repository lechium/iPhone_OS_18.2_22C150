...
- (void).cxx_destruct;	// IMP=0x000000000013a627
...
- (id)_serializeHeader;	// IMP=0x000000000013a295
- (id)serialize;	// IMP=0x000000000013a185
- (void)cancelWithError:(id)arg1;	// IMP=0x000000000013a0d6
- (id)description;	// IMP=0x000000000013a0c2
- (id)debugDescription;	// IMP=0x000000000013a0ab
- (id)descriptionWithPointer:(_Bool)arg1;	// IMP=0x0000000000139ec3
- (id)shortDescription;	// IMP=0x0000000000139eb1
- (id)initWithRequestType:(unsigned char)arg1 bodyData:(id)arg2 shouldEncrypt:(_Bool)arg3 timeoutInterval:(double)arg4;	// IMP=0x0000000000139e92
- (id)initWithCharacteristic:(id)arg1 requestType:(unsigned char)arg2 bodyData:(id)arg3 shouldEncrypt:(_Bool)arg4 timeoutInterval:(double)arg5;	// IMP=0x0000000000139d3e
- (id)_initWithCharacteristic:(id)arg1 requestType:(unsigned char)arg2 bodyData:(id)arg3 shouldEncrypt:(_Bool)arg4 timeoutInterval:(double)arg5;	// IMP=0x00000000001399be
- (id)init;	// IMP=0x0000000000139916
