...
- (void).cxx_destruct;	// IMP=0x0000000000121cd1
...
- (id)initWithPreviousResult:(id)arg1 currentResult:(id)arg2 changes:(unsigned long long)arg3;	// IMP=0x0000000000121c0e
