...
- (void).cxx_destruct;	// IMP=0x0000000000094abb
...
- (id)description;	// IMP=0x0000000000094803
- (void)updatePairedPeripheralConfiguration:(_Bool)arg1 connectionPriority:(unsigned long long)arg2;	// IMP=0x0000000000094648
- (void)updateWithPeripheral:(id)arg1;	// IMP=0x00000000000944e9
- (id)initRecentlySeenPairedHAPBLEPeripheral:(id)arg1;	// IMP=0x000000000009441c
