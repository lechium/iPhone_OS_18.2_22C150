...
- (void).cxx_destruct;	// IMP=0x00000000000aef5d
...
- (void)reset;	// IMP=0x00000000000aeb11
- (id)initWithDiscoveryType:(long long)arg1;	// IMP=0x00000000000ae93c
- (id)init;	// IMP=0x00000000000ae894
