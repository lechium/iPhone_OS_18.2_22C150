...
- (void).cxx_destruct;	// IMP=0x0000000000044840
...
- (unsigned long long)_deserializeHeaderBodyLengthWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000445b3
- (unsigned long long)_deserializeHeaderWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000044489
- (unsigned long long)appendData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000043fea
- (unsigned long long)_remainingBodyLength;	// IMP=0x0000000000043f5d
...
- (id)description;	// IMP=0x0000000000043da1
- (id)debugDescription;	// IMP=0x0000000000043d8a
- (id)descriptionWithPointer:(_Bool)arg1;	// IMP=0x0000000000043c0d
- (id)shortDescription;	// IMP=0x0000000000043bfb
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000000043b8d
