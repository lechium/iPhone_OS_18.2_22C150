...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006914c
- (void).cxx_destruct;	// IMP=0x00000000000690d7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000685a9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006841d
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000000678d8
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000066f6a
- (id)initWithInstanceID:(id)arg1 characteristicType:(id)arg2 characteristicProperties:(id)arg3 userDescription:(id)arg4 bluetoothFormat:(id)arg5 validRange:(id)arg6 stepValue:(id)arg7 validValues:(id)arg8 validValuesRange:(id)arg9;	// IMP=0x0000000000066de5
- (id)init;	// IMP=0x0000000000066db6
