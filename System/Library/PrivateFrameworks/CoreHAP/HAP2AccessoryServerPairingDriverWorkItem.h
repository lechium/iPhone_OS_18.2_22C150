...
- (void).cxx_destruct;	// IMP=0x0000000000074afc
...
- (void)cancelWithError:(id)arg1;	// IMP=0x0000000000074a1e
- (void)runForPairingDriver:(id)arg1;	// IMP=0x000000000007496a
@property(readonly, copy) NSString *description;
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000746cc
- (void)startWithPairingDriver:(id)arg1;	// IMP=0x0000000000074553
...
- (id)maybePairingDriver;	// IMP=0x0000000000074521
