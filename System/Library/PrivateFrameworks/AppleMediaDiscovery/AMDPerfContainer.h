...
+ (float)getMemoryUsage:(id)arg1 logType:(id)arg2 timeDelta:(double)arg3;	// IMP=0x00600000000f9cc0
- (void).cxx_destruct;	// IMP=0x00000000000fa270
...
- (double)getTime;	// IMP=0x00000000000f9c50
- (id)initWithSwitch:(_Bool)arg1 atLevel:(BOOL)arg2;	// IMP=0x00000000000f9ac0
