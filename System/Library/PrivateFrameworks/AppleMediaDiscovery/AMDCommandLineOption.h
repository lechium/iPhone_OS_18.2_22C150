...
- (void).cxx_destruct;	// IMP=0x000000000008af30
...
- (id)initWithName:(id)arg1 withDefaultValue:(id)arg2 withHelpText:(id)arg3 withShortName:(id)arg4 andIsBoolFlag:(_Bool)arg5;	// IMP=0x000000000008ac10
