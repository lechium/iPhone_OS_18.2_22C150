...
- (oneway void)getCodepathIdsWithCompletion:(void (^)(NSSet *, NSError *))arg1;
- (oneway void)addCodepathId:(NSString *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (oneway void)removeCodepathId:(NSString *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
