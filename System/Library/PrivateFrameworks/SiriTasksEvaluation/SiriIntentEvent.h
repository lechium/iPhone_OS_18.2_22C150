...
- (void).cxx_destruct;	// IMP=0x000000000000278e
...
- (id)initWithIntentId:(id)arg1 eventType:(long long)arg2 eventData:(id)arg3 createdAt:(id)arg4;	// IMP=0x0000000000002692
