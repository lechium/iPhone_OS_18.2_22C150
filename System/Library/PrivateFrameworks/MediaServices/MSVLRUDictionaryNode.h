...
- (void).cxx_destruct;	// IMP=0x0000000000059947
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000598a1
- (id)initWithKey:(id)arg1 object:(id)arg2;	// IMP=0x0000000000059808
