...
+ (id)sharedNotifier;	// IMP=0x00400000000642fb
...
- (void)postLocalNotification;	// IMP=0x00000000000646fe
- (void)postLocalNotificationIfNeeded;	// IMP=0x000000000006466e
- (void)dealloc;	// IMP=0x0000000000064612
- (id)_initSingleton;	// IMP=0x0000000000064360
