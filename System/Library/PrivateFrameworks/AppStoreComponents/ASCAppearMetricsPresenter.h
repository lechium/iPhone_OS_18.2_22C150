...
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x000000000000dd23
- (void)disappearIfNeeded;	// IMP=0x000000000000db59
@property(readonly, nonatomic) _Bool canDisappear;
- (void)appearIfNeeded;	// IMP=0x000000000000d4ab
@property(readonly, nonatomic) _Bool canAppear;
- (void)viewDidRetryFailedRequest;	// IMP=0x000000000000ccb4
- (void)viewDidFailRequest:(id)arg1 withError:(id)arg2;	// IMP=0x000000000000c92d
- (void)viewDidEndRenderWithPredicate:(id)arg1;	// IMP=0x000000000000c6d1
- (void)viewDidAction;	// IMP=0x000000000000c4ea
- (void)viewDidSetHidden;	// IMP=0x000000000000c394
- (void)viewDidMoveToWindow;	// IMP=0x000000000000c0ac
- (void)hostWillEnterForeground;	// IMP=0x000000000000bfd1
- (void)hostDidEnterBackground;	// IMP=0x000000000000bef6
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000000b7bb
- (id)initWithView:(id)arg1;	// IMP=0x000000000000b715
- (id)initWithView:(id)arg1 metrics:(id)arg2 notificationCenter:(id)arg3;	// IMP=0x000000000000b5a2
