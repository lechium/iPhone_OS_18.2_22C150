...
+ (id)sharedContext;	// IMP=0x0040000000063cd4
...
- (id)description;	// IMP=0x0000000000064199
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000063f63
- (unsigned long long)hash;	// IMP=0x0000000000063e83
- (id)initWithArtworkFetcher:(id)arg1 lockupFetcher:(id)arg2 appOfferStateCenter:(id)arg3;	// IMP=0x0000000000063dcb
