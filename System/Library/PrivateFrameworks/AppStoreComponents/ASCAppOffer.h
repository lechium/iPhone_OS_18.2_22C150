...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001079d
- (void).cxx_destruct;	// IMP=0x00000000000122c7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000115d7
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00000000000110bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000110b1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000010da1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000107a5
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13 capabilities:(id)arg14;	// IMP=0x000000000001051e
