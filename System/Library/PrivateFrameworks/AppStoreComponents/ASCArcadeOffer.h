...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001684f
- (void).cxx_destruct;	// IMP=0x00000000000177b8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000017068
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000016d46
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000016d3b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000016b63
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000016857
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x00000000000166b7
