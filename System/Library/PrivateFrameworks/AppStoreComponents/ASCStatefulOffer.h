...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000069797
- (void).cxx_destruct;	// IMP=0x000000000006a8c1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006a033
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000069cb9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000069cae
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000069aa2
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006979f
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x00000000000695e5
