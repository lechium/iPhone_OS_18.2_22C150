...
- (void).cxx_destruct;	// IMP=0x00000000000234c6
...
- (void)reset;	// IMP=0x0000000000023402
- (double)nextSleepTimeInterval;	// IMP=0x0000000000023320
- (id)initWithBaseSleepTimeInterval:(double)arg1 maxSleepTimeInterval:(double)arg2;	// IMP=0x00000000000232a4
