...
- (void).cxx_destruct;	// IMP=0x000000000002060f
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000020563
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000000020513
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000204de
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x0000000000020486
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x0000000000020453
- (id)newCommandQueue;	// IMP=0x0000000000020425
@property(retain, nonatomic) FigMetalExecutionStatus *executionStatus;
- (id)initWithLevel:(int)arg1;	// IMP=0x00000000000201b7
