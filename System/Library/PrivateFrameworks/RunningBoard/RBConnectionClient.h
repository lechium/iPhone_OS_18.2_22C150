...
- (void).cxx_destruct;	// IMP=0x000000000003fb85
- (id)captureState;	// IMP=0x000000000003fb49
@property(readonly, copy, nonatomic) NSString *stateCaptureTitle;
- (void)inheritanceManager:(id)arg1 didChangeInheritances:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000003e861
@property(readonly, copy) NSString *description;
- (_Bool)hasEntitlementDomain:(unsigned long long)arg1;	// IMP=0x000000000003b2a9
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x000000000003b290
- (id)init;	// IMP=0x0000000000031c1d
