...
@class NSSet, RBProcess, RBProcessStateChangeSet, RBSAuditToken, RBSLaunchRequest, RBSProcessIdentity, RBSProcessInstance, RBSProcessPredicate, RBSTerminateRequest, RBSystemState;
...
- (void)executeLaunchRequest:(RBSLaunchRequest *)arg1 withCompletion:(void (^)(RBSProcessHandle *, NSDictionary *, NSError *))arg2;
