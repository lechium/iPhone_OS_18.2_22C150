...
@class BSDescriptionStyle, NSObject, NSString;
...
- (void)appendCustomFormatWithNameFromObjectDescription:(id)arg1 block:(void (^)(id <BSDescriptionStringAppendTarget>))arg2;
