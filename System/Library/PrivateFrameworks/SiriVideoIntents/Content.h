...
@class NSArray, NSDate, NSNumber, NSString, NSURL, ResultEntity;

@interface Content : INObject
{
}

+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000196be0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000196e90
- (id)initWithIdentifier:(id)arg1 displayString:(id)arg2 pronunciationHint:(id)arg3;	// IMP=0x0000000000196d94
...
@property(nonatomic, copy) NSString *entityExperienceUrl; // @dynamic entityExperienceUrl;
...
@property(nonatomic, retain) NSNumber *inTheaters; // @dynamic inTheaters;
@property(nonatomic, retain) NSNumber *isInWatchList; // @dynamic isInWatchList;
@property(nonatomic, copy) NSString *machineGeneratedUtterance; // @dynamic machineGeneratedUtterance;
@property(nonatomic, copy) NSString *name; // @dynamic name;
@property(nonatomic, copy) NSURL *punchoutUrl; // @dynamic punchoutUrl;
@property(nonatomic, copy) NSString *ratingSystem; // @dynamic ratingSystem;
@property(nonatomic, copy) NSString *ratingValue; // @dynamic ratingValue;
@property(nonatomic, copy) NSDate *releaseDate; // @dynamic releaseDate;
@property(nonatomic, retain) ResultEntity *resultEntity; // @dynamic resultEntity;
@property(nonatomic, retain) NSNumber *runtimeInMinutes; // @dynamic runtimeInMinutes;
