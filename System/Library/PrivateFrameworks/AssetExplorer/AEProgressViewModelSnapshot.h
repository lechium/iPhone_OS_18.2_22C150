...
- (id)progressForIndexPath:(struct PXSimpleIndexPath)arg1;	// IMP=0x000000000002666a
- (_Bool)hasProgressForIndexPath:(struct PXSimpleIndexPath)arg1;	// IMP=0x000000000002660d
- (id)initWithProgressByIndexPath:(id)arg1 dataSourceIdenfitier:(long long)arg2;	// IMP=0x00000000000263ea
