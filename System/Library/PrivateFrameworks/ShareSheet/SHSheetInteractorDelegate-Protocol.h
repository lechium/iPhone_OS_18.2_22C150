...
@class LPLinkMetadata, NSError, SFAirDropTransferChange, SFCollaborationCloudSharingRequest, SFShareSheetRecipient, SHSheetActivityPerformerResult, SHSheetUserDefaultsContext, UIActivity, UIActivityCollaborationModeRestriction;
@protocol SHSheetActivityPerformerPresentationInterface, SHSheetInteractor;

@protocol SHSheetInteractorDelegate <NSObject>
- (void)interactor:(id <SHSheetInteractor>)arg1 showingModeRestriction:(UIActivityCollaborationModeRestriction *)arg2 continueHandler:(void (^)(_Bool))arg3;
