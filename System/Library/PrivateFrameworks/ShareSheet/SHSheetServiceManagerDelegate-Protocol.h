...
- (void)serviceManager:(SHSheetServiceManager *)arg1 willPerformActivityInServiceForRequest:(UISUIActivityExtensionItemDataRequest *)arg2 completion:(void (^)(NSArray *, UISDActivityItemData *, NSError *))arg3;
