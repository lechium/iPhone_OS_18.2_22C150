...
- (void)activityViewControllerWithSessionID:(NSString *)arg1 findSupportedActivitiesWithCompletionHandler:(void (^)(NSArray *, NSError *))arg2;
- (void)activityViewControllerWithSessionID:(NSString *)arg1 performActivityWithType:(NSString *)arg2 completionHandler:(void (^)(_Bool, NSError *))arg3;
...
- (void)activityViewControllerDidDisappearWithSessionID:(NSString *)arg1;
- (void)activityViewControllerDidAppearWithSessionID:(NSString *)arg1;
