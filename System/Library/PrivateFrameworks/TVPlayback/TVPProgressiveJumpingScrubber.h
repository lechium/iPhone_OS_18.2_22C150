...
- (void).cxx_destruct;	// IMP=0x0000000000003bc6
...
- (void)_skipTimerFired:(id)arg1;	// IMP=0x00000000000039bc
- (double)_nextTimeToAdvanceFromTime:(double)arg1;	// IMP=0x00000000000038ea
- (void)cancelScrub;	// IMP=0x00000000000038b8
- (void)startScrubWithRate:(double)arg1;	// IMP=0x00000000000037d9
