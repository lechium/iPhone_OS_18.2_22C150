...
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x00000000000164a7
- (void)_updateImageIntervalWithRate:(double)arg1;	// IMP=0x00000000000163d3
- (void)_cancelStaleImageLoadsForTime:(double)arg1;	// IMP=0x000000000001619e
- (void)_cancelAllImageLoads;	// IMP=0x000000000001610a
- (void)_loadImagesIfNecessary;	// IMP=0x0000000000015664
- (void)_displayLinkTimerFired:(id)arg1;	// IMP=0x000000000001522b
- (void)invalidate;	// IMP=0x0000000000015216
- (id)initWithMediaItem:(id)arg1 referenceTime:(CDStruct_1b6d18a9)arg2 forDate:(id)arg3;	// IMP=0x0000000000014e24
