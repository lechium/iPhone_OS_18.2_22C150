...
- (void)callCompletionHandlerWithImage:(id)arg1 actualCMTime:(CDStruct_1b6d18a9)arg2 actualDate:(id)arg3;	// IMP=0x0000000000003f32
- (id)description;	// IMP=0x0000000000003e7b
