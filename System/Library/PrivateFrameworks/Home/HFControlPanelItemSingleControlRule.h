...
- (void).cxx_destruct;	// IMP=0x00000000002adfdb
...
- (id)controlPanelItemForControlItems:(id)arg1;	// IMP=0x00000000002ade95
- (id)initWithFilter:(CDUnknownBlockType)arg1 displayResultsGenerator:(CDUnknownBlockType)arg2;	// IMP=0x00000000002adddc
