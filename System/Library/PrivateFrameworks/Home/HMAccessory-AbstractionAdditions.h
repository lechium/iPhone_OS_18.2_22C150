...
+ (id)hf_minimumDescriptionsOfAccessories:(id)arg1;	// IMP=0x001000000020d20e
+ (_Bool)hf_isSuspendedStateSupported:(unsigned long long)arg1;	// IMP=0x001000000020c8db
+ (_Bool)hf_isSuspendedStateSuspended:(unsigned long long)arg1;	// IMP=0x001000000020c82b
+ (id)hf_userFriendlyLocalizedLowercaseDescription:(id)arg1;	// IMP=0x001000000020c342
+ (id)hf_userFriendlyLocalizedCapitalizedDescription:(id)arg1;	// IMP=0x001000000020c1ea
+ (id)hf_userFriendlyLocalizedCapitalizedPluralDescription:(id)arg1;	// IMP=0x001000000020c092
+ (id)hf_getUserFriendlyDescriptionKey:(id)arg1;	// IMP=0x001000000020bb4e
+ (CDUnknownBlockType)hf_softwareUpdateComparator;	// IMP=0x00100000002baf4d
- (id)hf_setTileSize:(id)arg1;	// IMP=0x00100000000ded85
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x00100000000ded52
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x00100000000decf6
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x00100000000dec08
...
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x00100000000dea75
...
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x00100000000de96d
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x001000000012b6fc
@property(readonly, nonatomic) NSSet *hf_fakeDebugSymptoms;
- (void)_pushSymptomUpdate;	// IMP=0x001000000015305e
...
- (_Bool)hf_shouldDisplayManualFixOptionForSymptom:(long long)arg1;	// IMP=0x0010000000152319
- (_Bool)hf_shouldShowSoftwareUpdateInfo;	// IMP=0x00100000001522e0
- (id)hf_identifyHomePod;	// IMP=0x0010000000152271
...
- (_Bool)hf_supportsMultiUserLanguage:(id)arg1;	// IMP=0x0010000000151f79
...
- (_Bool)hf_isCategorizedAsMediaAccessory;	// IMP=0x0010000000151c12
@property(readonly, nonatomic) _Bool hf_isMediaAccessory;
- (id)hf_minimumDescription;	// IMP=0x001000000020d17b
@property(readonly, nonatomic) NAFuture *hf_allConnectedHomeToCHIPAccessoryPairingFuture;
- (_Bool)hf_shouldHideNearbyAccessoryService:(id)arg1;	// IMP=0x001000000020cca9
- (_Bool)hf_supportsUserLevelUpdateListeningHistorySetting;	// IMP=0x001000000020cc97
- (id)hf_errorForCurrentSessionState;	// IMP=0x001000000020cab8
- (_Bool)hf_needsOnboarding;	// IMP=0x001000000020ca74
- (id)hf_siriEndpointProfile;	// IMP=0x001000000020c98b
...
- (id)_hf_categoryType;	// IMP=0x001000000020c566
...
- (id)hf_serviceOfType:(id)arg1;	// IMP=0x001000000020b108
...
- (id)hf_primaryService;	// IMP=0x001000000020a81b
...
- (id)hf_setShowAsIndividualServices:(_Bool)arg1;	// IMP=0x001000000020a0f5
...
- (_Bool)hf_isRestrictedGuestAllowedAccessory;	// IMP=0x0010000000209a00
...
- (id)hf_servicesWithBulletinBoardNotificationTurnedOff;	// IMP=0x0010000000208f66
...
- (_Bool)_areAllSensorServices;	// IMP=0x0010000000254150
- (_Bool)hf_anyNonSensorServiceIsOnForContextType:(unsigned long long)arg1;	// IMP=0x0010000000254077
- (id)hf_updateValueForCurrentObjectOnly:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x0010000000253b6d
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x001000000025376c
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x0010000000253414
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000002531e8
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x0010000000252f54
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x0010000000252e00
- (_Bool)hf_isValidObject;	// IMP=0x0010000000297c44
@property(readonly, nonatomic) __weak HMRoom *hf_parentRoom;
- (id)hf_softwareUpdateDependentClasses;	// IMP=0x00100000002bbb8e
- (id)hf_softwareUpdateDependentObjects;	// IMP=0x00100000002bbab2
- (id)hf_softwareUpdateHash;	// IMP=0x00100000002bb9d9
- (id)hf_startSoftwareUpdate;	// IMP=0x00100000002bb952
- (id)hf_fetchAvailableSoftwareUpdateWithOptions:(unsigned long long)arg1;	// IMP=0x00100000002bb8bc
- (id)hf_softwareUpdatePortionComplete;	// IMP=0x00100000002bb835
- (unsigned long long)hf_softwareUpdateDownloadSize;	// IMP=0x00100000002bb7ba
- (id)hf_softwareUpdateReleaseDate;	// IMP=0x00100000002bb733
- (id)hf_softwareUpdateDisplayableVersion;	// IMP=0x00100000002bb6ac
- (id)hf_softwareUpdateVersion;	// IMP=0x00100000002bb625
- (id)hf_softwareUpdateDocumentation;	// IMP=0x00100000002bb59e
- (_Bool)hf_softwareUpdatePossessesNecessaryDocumentation;	// IMP=0x00100000002bb525
- (_Bool)hf_isSoftwareUpdateInstalled;	// IMP=0x00100000002bb4ac
- (_Bool)hf_isSoftwareUpdateInProgress;	// IMP=0x00100000002bb433
- (_Bool)hf_isInstallingSoftwareUpdate;	// IMP=0x00100000002bb3ba
- (_Bool)hf_isDownloadingSoftwareUpdate;	// IMP=0x00100000002bb341
- (_Bool)hf_isReadyToInstallSoftwareUpdate;	// IMP=0x00100000002bb2c8
- (_Bool)hf_hasRequestedSoftwareUpdate;	// IMP=0x00100000002bb24f
- (_Bool)hf_hasNewValidSoftwareUpdate;	// IMP=0x00100000002bb1d6
- (_Bool)hf_hasValidSoftwareUpdate;	// IMP=0x00100000002bb15d
- (_Bool)hf_hasSoftwareUpdate;	// IMP=0x00100000002bb0e4
- (_Bool)hf_hasNewValidSoftwareOrFirmwareUpdate;	// IMP=0x00100000002bb0ab
- (_Bool)hf_hasValidSoftwareOrFirmwareUpdate;	// IMP=0x00100000002bb072
- (_Bool)hf_supportsSoftwareUpdate;	// IMP=0x00100000002bb024
- (id)_hf_audioAnalysisEventBulletinBoardNotification;	// IMP=0x00100000002cb45d
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x00100000002cb2e3
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)_audioAnalysisEventBulletinNotifications;	// IMP=0x00100000002cb182
- (void)hf_updateApplicationData:(id)arg1 handleError:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000002e6408
- (void)_hf_didUpdateApplicationData:(id)arg1;	// IMP=0x00100000002e62e9
...
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x00100000003bedd6
