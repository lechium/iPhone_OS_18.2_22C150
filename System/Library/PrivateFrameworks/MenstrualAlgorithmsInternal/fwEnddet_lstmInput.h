...
- (void).cxx_destruct;	// IMP=0x000000000005737d
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000571d7
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithIn:(id)arg1 lstm_1_h_in:(id)arg2 lstm_1_c_in:(id)arg3;	// IMP=0x00000000000570ff
- (id)initWithIn:(id)arg1;	// IMP=0x00000000000570e8
