...
- (void).cxx_destruct;	// IMP=0x00000000000f1b10
- (id)init;	// IMP=0x00000000000f1ab0
- (void)service:(id)arg1 devicesChanged:(id)arg2;	// IMP=0x00000000000f1d60
- (void)service:(id)arg1 activeAccountsChanged:(id)arg2;	// IMP=0x00000000000f1d10
