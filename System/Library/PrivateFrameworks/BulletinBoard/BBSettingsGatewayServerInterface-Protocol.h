...
- (void)setEffectiveGlobalHighlightsSetting:(long long)arg1 withHandler:(void (^)(void))arg2;
- (void)getEffectiveGlobalHighlightsSettingWithHandler:(void (^)(long long, NSError *))arg1;
- (void)setEffectiveGlobalSummarizationSetting:(long long)arg1 withHandler:(void (^)(void))arg2;
- (void)getEffectiveGlobalSummarizationSettingWithHandler:(void (^)(long long, NSError *))arg1;
