...
- (void).cxx_destruct;	// IMP=0x0000000000026693
@property unsigned long long dispatcherId; // @synthesize dispatcherId;
- (void)dispatchMessage:(id)arg1 replyConnection:(id)arg2;	// IMP=0x00000000000263bc
- (id)initWithCallback:(CDUnknownBlockType)arg1 bulkDataProxy:(id)arg2 andToken:(id)arg3;	// IMP=0x00000000000262d7
