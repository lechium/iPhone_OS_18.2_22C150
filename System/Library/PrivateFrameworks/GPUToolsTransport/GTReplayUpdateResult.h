...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000005b1b
- (void).cxx_destruct;	// IMP=0x0000000000005e1c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000005cb6
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005b23
