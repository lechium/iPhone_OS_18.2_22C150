...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002f21d
- (void).cxx_destruct;	// IMP=0x000000000002f541
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002f408
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002f225
