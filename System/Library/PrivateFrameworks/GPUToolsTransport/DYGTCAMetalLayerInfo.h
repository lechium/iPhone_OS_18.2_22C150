...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000f3ab
- (void).cxx_destruct;	// IMP=0x000000000000f674
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000f4f6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000f3b3
