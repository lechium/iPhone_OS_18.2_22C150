...
+ (id)uniqueDeviceID;	// IMP=0x001000000002e0b9
+ (id)hardwareUUID;	// IMP=0x001000000002e043
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002e03b
- (void).cxx_destruct;	// IMP=0x000000000002f0c9
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002ed4d
- (id)initForEmbeddedSystem;	// IMP=0x000000000002e89b
- (id)description;	// IMP=0x000000000002e86e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002e51f
- (id)initWithXPCObject:(id)arg1;	// IMP=0x000000000002e0ff
