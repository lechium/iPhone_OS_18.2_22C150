...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000021539
- (void).cxx_destruct;	// IMP=0x0000000000021cab
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000021bb2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000021615
- (id)init;	// IMP=0x0000000000021541
