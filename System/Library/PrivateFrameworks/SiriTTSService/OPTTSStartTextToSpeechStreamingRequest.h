...
- (void).cxx_destruct;	// IMP=0x000000000011b689
- (id)flatbuffData;	// IMP=0x000000000011b55e
- (Offset_acd6b661)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000011a9ab
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000011a06f
- (unsigned long long)context_info_count;	// IMP=0x0000000000119fd3
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000119eb3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000119a42
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000011985f
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2;	// IMP=0x000000000011984a
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000119830
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000119819
