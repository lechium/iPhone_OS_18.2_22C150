...
- (void).cxx_destruct;	// IMP=0x00000000001186df
- (id)flatbuffData;	// IMP=0x00000000001185b4
- (Offset_91732649)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000117ab7
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000011717b
- (unsigned long long)context_info_count;	// IMP=0x00000000001170df
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000116fbf
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000116bbc
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000116388
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2;	// IMP=0x0000000000116373
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000116359
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000116342
