...
- (void).cxx_destruct;	// IMP=0x0000000000070fce
- (id)init;	// IMP=0x0000000000070fb4
- (void)purge;	// IMP=0x0000000000070f51
- (void)cancelDownloadingThen:(CDUnknownBlockType)arg1;	// IMP=0x0000000000070e9a
- (void)downloadWithReservation:(id)arg1 useBattery:(_Bool)arg2 progress:(CDUnknownBlockType)arg3 then:(CDUnknownBlockType)arg4;	// IMP=0x0000000000070c6c
