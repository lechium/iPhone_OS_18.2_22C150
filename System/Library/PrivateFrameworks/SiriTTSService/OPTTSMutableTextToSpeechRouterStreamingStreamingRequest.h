...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000105d0a
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000105caf
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000105c81
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010598e
- (id)init;	// IMP=0x000000000010590a
