...
- (void).cxx_destruct;	// IMP=0x000000000001fe6b
...
- (id)resourceNamed:(id)arg1;	// IMP=0x000000000001fdba
- (void)clearResources;	// IMP=0x000000000001fd81
- (void)addResourcesFromDictionary:(id)arg1;	// IMP=0x000000000001fd18
- (void)setResource:(id)arg1 forName:(id)arg2;	// IMP=0x000000000001fc74
@property(readonly) id <ISCompositorResourceProvider> resourceProvider;
- (id)initWithRecipe:(id)arg1 resources:(id)arg2;	// IMP=0x000000000001fbaf
- (id)init;	// IMP=0x000000000001fb3a
