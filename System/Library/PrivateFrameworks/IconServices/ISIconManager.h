...
+ (id)serviceName;	// IMP=0x00600000000404cb
+ (id)sharedInstance;	// IMP=0x0060000000040466
- (void).cxx_destruct;	// IMP=0x0000000000040d34
...
- (void)removeObserver:(id)arg1;	// IMP=0x0000000000040c31
- (void)addObserver:(id)arg1;	// IMP=0x0000000000040bdd
- (id)findOrRegisterIcon:(id)arg1;	// IMP=0x0000000000040a04
- (void)dealloc;	// IMP=0x00000000000409d5
- (id)_init;	// IMP=0x0000000000040522
