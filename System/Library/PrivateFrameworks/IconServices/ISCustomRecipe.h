...
+ (id)customRecipeWithInfo:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000033a12
- (void).cxx_destruct;	// IMP=0x0000000000033ed8
...
- (id)resourceNamed:(id)arg1;	// IMP=0x0000000000033d34
- (id)initWithRecipe:(id)arg1 bitmapResources:(id)arg2 symbolResources:(id)arg3 bundle:(id)arg4;	// IMP=0x0000000000033c37
