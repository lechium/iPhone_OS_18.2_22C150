...
- (void).cxx_destruct;	// IMP=0x0000000000084d73
...
- (void)_reloadColumnViews;	// IMP=0x0000000000084248
- (id)_headerViewWithViewControllers:(id)arg1;	// IMP=0x0000000000083ffa
- (void)segmentedControl:(id)arg1 didSelectSegmentIndex:(long long)arg2;	// IMP=0x0000000000083fa3
- (void)_headerViewAction:(id)arg1;	// IMP=0x0000000000083efd
- (void)layoutSubviews;	// IMP=0x00000000000837b8
- (void)endColumnChangeAnimation;	// IMP=0x000000000008365c
- (void)beginColumnChangeAnimationToNumberOfVisibleColumns:(long long)arg1;	// IMP=0x00000000000835e6
- (void)dealloc;	// IMP=0x000000000008359b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000083301
