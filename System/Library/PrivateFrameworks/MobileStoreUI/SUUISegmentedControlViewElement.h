...
- (void).cxx_destruct;	// IMP=0x00000000001b6e3b
...
- (void)_enumerateItemElementsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b6c80
- (long long)pageComponentType;	// IMP=0x00000000001b6c75
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x00000000001b6bab
@property(readonly, nonatomic) NSArray *segmentItemTitles;
@property(readonly, nonatomic) long long initialSelectedItemIndex;
- (void)dispatchEventOfType:(unsigned long long)arg1 forItemAtIndex:(long long)arg2;	// IMP=0x00000000001b690d
@property(readonly, nonatomic) SUUIDividerViewElement *bottomDivider;
- (id)initWithDOMElement:(id)arg1 parent:(id)arg2 elementFactory:(id)arg3;	// IMP=0x00000000001b67d8
