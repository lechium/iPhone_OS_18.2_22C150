...
- (void).cxx_destruct;	// IMP=0x000000000033a10c
...
- (id)learnMoreAlertView;	// IMP=0x000000000033a06f
- (id)initWithITunesPassDictionary:(id)arg1 clientContext:(id)arg2;	// IMP=0x0000000000339551
