...
+ (id)configurationWithTemplateElement:(id)arg1;	// IMP=0x0010000000018f7d
- (void).cxx_destruct;	// IMP=0x000000000001963e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000019422
