...
- (void).cxx_destruct;	// IMP=0x00000000001ec458
...
- (void)_reloadHistogram;	// IMP=0x00000000001ec181
- (id)_histogramView;	// IMP=0x00000000001ec070
- (void)loadView;	// IMP=0x00000000001ec024
