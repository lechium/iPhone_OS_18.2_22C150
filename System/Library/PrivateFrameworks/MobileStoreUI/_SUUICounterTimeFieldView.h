...
- (void).cxx_destruct;	// IMP=0x0000000000277732
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000277619
- (void)setBackgroundColor:(id)arg1;	// IMP=0x000000000027758b
- (void)layoutSubviews;	// IMP=0x0000000000277339
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002771b6
