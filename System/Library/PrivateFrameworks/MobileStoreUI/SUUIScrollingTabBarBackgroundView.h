...
- (void).cxx_destruct;	// IMP=0x000000000004bc26
...
- (void)_updateTopHairlineColor;	// IMP=0x000000000004bb50
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000004b689
- (void)layoutSubviews;	// IMP=0x000000000004b413
