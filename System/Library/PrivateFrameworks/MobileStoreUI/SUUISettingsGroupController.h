...
- (void).cxx_destruct;	// IMP=0x0000000000038ce6
...
- (id)_viewForSettingDescription:(id)arg1;	// IMP=0x0000000000038be3
- (void)_reloadSettingDescription:(id)arg1;	// IMP=0x0000000000038b55
- (void)attachSettingDescription:(id)arg1;	// IMP=0x0000000000038ac3
