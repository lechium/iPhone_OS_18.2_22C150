...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f8ebc
- (id)description;	// IMP=0x00000000000f8e31
- (void)setPreferredWidthForAttributedStrings:(id)arg1;	// IMP=0x00000000000f8c34
