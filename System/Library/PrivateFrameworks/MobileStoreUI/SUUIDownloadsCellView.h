...
- (void).cxx_destruct;	// IMP=0x00000000002572d8
...
- (void)layoutSubviews;	// IMP=0x0000000000256cca
- (void)setBackgroundColor:(id)arg1;	// IMP=0x0000000000256c16
@property(nonatomic) double progress;
@property(retain, nonatomic) UIImage *image;
- (id)init;	// IMP=0x00000000002563c7
