...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001b5cd2
- (void).cxx_destruct;	// IMP=0x00000000001b6319
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b6005
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b5cda
- (id)init;	// IMP=0x00000000001b5c7e
