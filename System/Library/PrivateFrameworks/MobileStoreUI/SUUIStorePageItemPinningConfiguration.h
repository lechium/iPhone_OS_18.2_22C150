...
- (void)invalidatePinningTransitionStyle;	// IMP=0x0000000000088565
- (void)invalidatePinningGroup;	// IMP=0x0000000000088553
- (void)invalidatePinningStyle;	// IMP=0x0000000000088541
- (void)invalidatePinningContentInset;	// IMP=0x0000000000088521
