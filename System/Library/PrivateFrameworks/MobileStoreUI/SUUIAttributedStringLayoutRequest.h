...
- (void).cxx_destruct;	// IMP=0x00000000000e5d01
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e5c48
- (id)initWithAttributedString:(id)arg1;	// IMP=0x00000000000e5bd5
