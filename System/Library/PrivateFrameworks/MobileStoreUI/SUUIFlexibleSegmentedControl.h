...
- (void).cxx_destruct;	// IMP=0x0000000000388c6e
...
- (void)_setTitles:(id)arg1 forSegmentedControl:(id)arg2;	// IMP=0x0000000000388b13
- (void)_configureSegmentedControl:(id)arg1 withTitles:(id)arg2 boundingSize:(struct CGSize)arg3;	// IMP=0x00000000003886ed
- (void)_valueChangeAction:(id)arg1;	// IMP=0x000000000038856e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000003884b8
- (void)layoutSubviews;	// IMP=0x00000000003882ce
...
- (struct CGRect)frameForSegmentWithIndex:(long long)arg1;	// IMP=0x0000000000387f71
- (void)cancelMoreList;	// IMP=0x0000000000387f36
- (void)dealloc;	// IMP=0x0000000000387ee2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000387df1
