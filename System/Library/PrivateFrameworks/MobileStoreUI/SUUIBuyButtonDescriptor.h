...
- (void).cxx_destruct;	// IMP=0x000000000019b567
...
- (_Bool)canPerformLocalActionWithItemState:(id)arg1;	// IMP=0x000000000019b448
- (_Bool)canPersonalizeUsingItemState:(id)arg1;	// IMP=0x000000000019b30d
