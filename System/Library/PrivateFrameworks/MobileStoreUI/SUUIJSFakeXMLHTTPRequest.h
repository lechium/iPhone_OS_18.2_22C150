...
- (void).cxx_destruct;	// IMP=0x0000000000232d6c
...
- (id)getResponseHeader:(id)arg1;	// IMP=0x0000000000232aea
- (id)getAllResponseHeaders;	// IMP=0x00000000002329fb
- (id)initWithAppContext:(id)arg1 data:(id)arg2 URLResponse:(id)arg3 performanceMetrics:(id)arg4;	// IMP=0x0000000000232924
