...
- (void).cxx_destruct;	// IMP=0x00000000000cf151
...
- (_Bool)isLoaded;	// IMP=0x00000000000cefc8
- (void)updateWithDictionary:(id)arg1;	// IMP=0x00000000000ced98
- (id)initWithCountdownDictionary:(id)arg1;	// IMP=0x00000000000ce46f
