...
- (void).cxx_destruct;	// IMP=0x00000000003798d9
...
- (id)_saturationBackgroundImageWithSize:(struct CGSize)arg1;	// IMP=0x0000000000379775
- (id)imageForImage:(id)arg1;	// IMP=0x0000000000379328
