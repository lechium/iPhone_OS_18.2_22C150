...
- (void)itemStateCenter:(id)arg1 itemStateChanged:(id)arg2;	// IMP=0x0000000000081f20
- (id)_toggledLayout;	// IMP=0x0000000000081ea2
- (id)_titleAttributes;	// IMP=0x0000000000081c28
- (void)_showToggleState:(_Bool)arg1;	// IMP=0x00000000000819bc
- (void)_sendWillAnimate;	// IMP=0x0000000000081932
- (void)_sendDidAnimate;	// IMP=0x00000000000818a8
- (id)_nonToggledLayout;	// IMP=0x000000000008182a
- (id)_layoutForString:(id)arg1;	// IMP=0x0000000000081712
- (void)setButtonTitleText:(id)arg1;	// IMP=0x0000000000081668
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000813b2
- (void)setToggled:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000081394
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000811f7
- (void)dealloc;	// IMP=0x0000000000081182
- (id)init;	// IMP=0x00000000000810f7
