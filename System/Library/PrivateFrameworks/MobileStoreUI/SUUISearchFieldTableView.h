...
- (void).cxx_destruct;	// IMP=0x000000000027d676
...
- (void)_reloadView;	// IMP=0x000000000027d496
- (void)_setTrendingResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000027d440
- (void)_reloadData;	// IMP=0x000000000027d269
- (void)layoutSubviews;	// IMP=0x000000000027d1d9
