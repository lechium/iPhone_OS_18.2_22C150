...
- (void).cxx_destruct;	// IMP=0x000000000009c130
- (void)main;	// IMP=0x000000000009bb40
@property(copy) CDUnknownBlockType outputBlock;
- (id)initWithItemIdentifier:(long long)arg1 clientContext:(id)arg2;	// IMP=0x000000000009b873
