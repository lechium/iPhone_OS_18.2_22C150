...
- (void).cxx_destruct;	// IMP=0x000000000013b570
- (void)setShelfItemViewElementValidator:(CDUnknownBlockType)arg1;	// IMP=0x000000000013b526
- (_Bool)isDynamicContainer;	// IMP=0x000000000013b51e
- (id)applyUpdatesWithElement:(id)arg1;	// IMP=0x000000000013b47e
