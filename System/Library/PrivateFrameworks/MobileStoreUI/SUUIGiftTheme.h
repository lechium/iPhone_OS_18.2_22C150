...
- (void).cxx_destruct;	// IMP=0x000000000009fb7c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009f9e5
- (id)description;	// IMP=0x000000000009f953
- (id)initWithThemeDictionary:(id)arg1;	// IMP=0x000000000009f685
