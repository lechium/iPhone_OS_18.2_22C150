...
- (void).cxx_destruct;	// IMP=0x000000000033ff65
...
- (void)_setDocument:(id)arg1;	// IMP=0x000000000033fca4
- (id)initWithDocument:(id)arg1 presentationOptions:(id)arg2;	// IMP=0x000000000033fc06
- (id)init;	// IMP=0x000000000033fbf0
