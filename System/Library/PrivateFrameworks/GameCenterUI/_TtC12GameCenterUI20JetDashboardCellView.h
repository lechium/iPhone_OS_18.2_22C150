...
- (void).cxx_destruct;	// IMP=0x00000000001e6124
...
- (void)layoutSubviews;	// IMP=0x00000000001e575d
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000000001e5538
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001e5382
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e535a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001e50bc
