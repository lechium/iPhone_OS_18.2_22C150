...
- (void)backlightTelemetrySource:(id <BLSHBacklightHostTelemetrySource>)arg1 didUnblankToDisplayMode:(long long)arg2 fromDisplayMode:(long long)arg3 activeEvents:(NSArray *)arg4 abortedEvents:(NSArray *)arg5;
