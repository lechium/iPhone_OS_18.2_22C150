...
- (_Bool)isPartiallyOffscreenWindowsEnabled;
...
- (unsigned long long)assistantModality;
...
- (NSString *)homeScreenIconGridSizeClassForAppLayout:(SBAppLayout *)arg1;
...
- (id <SBSwitcherLayoutElementProviding>)bezelEffectsLayoutElement;
...
- (_Bool)isShieldingApplicationWithBundleIdentifier:(NSString *)arg1;
- (_Bool)isLocationInSafeArea:(struct CGPoint)arg1;
- (double)screenScale;
