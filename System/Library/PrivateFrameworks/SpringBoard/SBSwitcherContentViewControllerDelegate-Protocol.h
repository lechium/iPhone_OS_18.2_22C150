...
@optional
- (void)switcherContentControllerDidUpdateVisibleHomeAffordances:(id <SBSwitcherContentViewControlling>)arg1;
- (void)tickleContinuousExposeStripRevealGrabberTongueIfVisibleForSwitcherContentController:(id <SBSwitcherContentViewControlling>)arg1;
- (void)presentContinuousExposeStripRevealGrabberTongueImmediatelyForSwitcherContentController:(id <SBSwitcherContentViewControlling>)arg1;
...
- (void)switcherContentController:(id <SBSwitcherContentViewControlling>)arg1 setInterfaceOrientation:(long long)arg2;
...
- (_Bool)switcherContentControllerControlsWallpaper:(id <SBSwitcherContentViewControlling>)arg1;
