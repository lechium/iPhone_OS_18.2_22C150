...
@class SBHIDUISensorModeController, SBIdleTimerDefaults, SBLockScreenManager, SBProximitySensorManager, SBScreenSleepCoordinator, SBScreenWakeAnimationController, SBWakeLogger;
@protocol BLSHBacklightHostObservable><BLSBacklightChangeRequestable;
