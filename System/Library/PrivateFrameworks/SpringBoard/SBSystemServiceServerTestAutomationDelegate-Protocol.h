...
@class BSMachPortSendRight, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, SBSystemServiceServer;
...
- (NSMutableArray *)systemServiceServer:(SBSystemServiceServer *)arg1 getSystemApertureModelStateDumpForClient:(id <FBSServiceFacilityClientHandle>)arg2;
...
- (NSMutableDictionary *)systemServiceServer:(SBSystemServiceServer *)arg1 getAnimationFrameRecordingsForClient:(id <FBSServiceFacilityClientHandle>)arg2;
- (void)systemServiceServer:(SBSystemServiceServer *)arg1 client:(id <FBSServiceFacilityClientHandle>)arg2 setSpringBoardAnimationFrameRecordingForUpdateTypes:(unsigned long long)arg3;
- (void)systemServiceServer:(SBSystemServiceServer *)arg1 client:(id <FBSServiceFacilityClientHandle>)arg2 setSystemApertureUnderAutomationTesting:(_Bool)arg3;
...
- (void)systemServiceServer:(SBSystemServiceServer *)arg1 client:(id <FBSServiceFacilityClientHandle>)arg2 setAmbientMountState:(long long)arg3;
