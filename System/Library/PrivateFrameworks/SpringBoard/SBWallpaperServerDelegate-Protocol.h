...
@class NSString, NSUUID, PBUIWallpaperGradient, SBSQuickActionConfigurationRequest, SBWallpaperServer, UIColor;

@protocol SBWallpaperServerDelegate <NSObject>
- (void)wallpaperServer:(SBWallpaperServer *)arg1 handleQuickActionConfigurationRequest:(SBSQuickActionConfigurationRequest *)arg2 completionHandler:(void (^)(NSError *))arg3;
