...
- (void)transientOverlayViewControllerDidUpdateHIDEventDeferringDisabled:(SBTransientOverlayViewController *)arg1;
...
- (void)transientOverlayDidUpdateSupportedInterfaceOrientations:(SBTransientOverlayViewController *)arg1;
