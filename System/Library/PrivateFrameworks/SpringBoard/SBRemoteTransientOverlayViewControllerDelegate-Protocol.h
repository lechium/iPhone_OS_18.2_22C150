...
@class NSError, NSString, SBRemoteTransientOverlayViewController, SBUIButtonAction;

@protocol SBRemoteTransientOverlayViewControllerDelegate <NSObject>
- (SBUIButtonAction *)remoteTransientOverlayViewController:(SBRemoteTransientOverlayViewController *)arg1 requestsActionForHandlingButtonEvents:(unsigned long long)arg2;
