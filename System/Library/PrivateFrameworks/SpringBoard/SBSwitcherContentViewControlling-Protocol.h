...
@protocol SBSwitcherContentViewControllerDataSource, SBSwitcherContentViewControllerDelegate, SBSwitcherGestureManaging, SBSwitcherLiveContentOverlay;
...
- (void)handleFluidSwitcherGestureManager:(id <SBSwitcherGestureManaging>)arg1 didEndGesture:(SBFluidSwitcherGesture *)arg2;
- (void)handleFluidSwitcherGestureManager:(id <SBSwitcherGestureManaging>)arg1 didUpdateGesture:(SBFluidSwitcherGesture *)arg2;
- (void)handleFluidSwitcherGestureManager:(id <SBSwitcherGestureManaging>)arg1 didBeginGesture:(SBFluidSwitcherGesture *)arg2;
