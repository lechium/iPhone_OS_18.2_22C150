...
- (struct SBSwitcherWallpaperGradientAttributes)wallpaperGradientAttributesForIndex:(unsigned long long)arg1;
...
- (_Bool)isDropletEffectRequiredBehindAppLayout:(SBAppLayout *)arg1;
