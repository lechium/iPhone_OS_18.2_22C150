...
- (id).cxx_construct;	// IMP=0x000000000008aa1d
- (void).cxx_destruct;	// IMP=0x000000000008a9e3
- (unsigned long long)drawNoise;	// IMP=0x000000000008a8eb
- (id)initWithUnigram:(float *)arg1 ofSize:(unsigned long long)arg2;	// IMP=0x000000000008a20b
- (id)initWithZipfOfSize:(unsigned long long)arg1;	// IMP=0x000000000008a09c
- (id)init;	// IMP=0x000000000008a08e
