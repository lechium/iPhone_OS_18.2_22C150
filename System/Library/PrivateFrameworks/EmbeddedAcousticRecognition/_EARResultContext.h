...
- (id).cxx_construct;	// IMP=0x00000000000db5c7
- (void).cxx_destruct;	// IMP=0x00000000000db539
...
- (void)updateLoggableResultWithCurrentResult:(const void *)arg1 currentCosts:(const void *)arg2 startMilliseconds:(unsigned int)arg3;	// IMP=0x00000000000db0d9
- (id)description;	// IMP=0x00000000000daff9
- (void)resetPartialResultContext;	// IMP=0x00000000000daf94
- (void)addPartialResultToContext:(const void *)arg1;	// IMP=0x00000000000dae8f
- (void)incrementCountOfIsFinalFalseAlreadyWritten;	// IMP=0x00000000000dae85
