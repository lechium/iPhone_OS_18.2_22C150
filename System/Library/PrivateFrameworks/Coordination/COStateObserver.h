...
- (void).cxx_destruct;	// IMP=0x00000000000121fe
...
- (void)notify:(id)arg1;	// IMP=0x00000000000118c5
- (id)description;	// IMP=0x0000000000011854
- (id)initWithDispatchQueue:(id)arg1 predicate:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000000011769
