...
- (void).cxx_destruct;	// IMP=0x0000000000065757
@property __weak AKTextAttributesViewController *parentController; // @synthesize parentController=_parentController;
- (void)syncTextAttributesToUI:(id)arg1;	// IMP=0x00000000000656c7
- (id)convertTextAttributes:(id)arg1;	// IMP=0x000000000006564d
- (long long)tag;	// IMP=0x0000000000065642
