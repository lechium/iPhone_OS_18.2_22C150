...
- (void).cxx_destruct;	// IMP=0x0000000000066f36
...
- (void)syncTextAttributesToUI:(id)arg1;	// IMP=0x0000000000066df2
- (id)convertTextAttributes:(id)arg1;	// IMP=0x0000000000066cb1
- (void)viewDidLayoutSubviews;	// IMP=0x0000000000066b31
- (void)setRightButtonItems:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000066a00
- (void)valueChanged:(id)arg1;	// IMP=0x0000000000066811
- (void)viewDidLoad;	// IMP=0x00000000000661ea
- (id)initWithController:(id)arg1;	// IMP=0x000000000006617e
