...
@class NSArray, NSItemProvider, NSSet, NSString, PKAttachmentView, PKProofreadingItem, PKSelectionInteraction, PKStrokeSelectionImageConfig, UIBezierPath, UIContextMenuConfiguration, UIContextMenuInteraction, UIEvent, UIGestureRecognizer, UITargetedPreview;
@protocol UIContextMenuInteractionAnimating;

@protocol PKSelectionInteractionDelegate <NSObject>

@optional
- (void)selectionInteraction:(PKSelectionInteraction *)arg1 handleGenerationToolForSelectedStrokes:(NSArray *)arg2 inBounds:(struct CGRect)arg3 inAttachment:(PKAttachmentView *)arg4;
- (void)selectionInteraction:(PKSelectionInteraction *)arg1 replaceStrokes:(NSArray *)arg2 withString:(NSString *)arg3 proofreadingItem:(PKProofreadingItem *)arg4 inBounds:(struct CGRect)arg5 inAttachment:(PKAttachmentView *)arg6;
...
- (_Bool)selectionInteraction:(PKSelectionInteraction *)arg1 handleTapOnCanvasAtLocation:(struct CGPoint)arg2 inAttachment:(PKAttachmentView *)arg3;
...
- (_Bool)selectionInteraction:(PKSelectionInteraction *)arg1 handleLassoSelection:(UIBezierPath *)arg2 strokes:(NSSet *)arg3 inAttachment:(PKAttachmentView *)arg4;
