...
- (void)layoutSubviews;	// IMP=0x0000000000033b0a
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000033a42
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x0000000000033a25
- (double)_continuousCornerRadius;	// IMP=0x0000000000033a08
- (struct CGRect)_mainBodyBounds;	// IMP=0x000000000003398b
@property(readonly, nonatomic) struct CGRect tabViewBounds;
- (void)setTabHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x00000000000333d8
- (id)initWithFrame:(struct CGRect)arg1 minimumStashTabSize:(struct CGSize)arg2;	// IMP=0x0000000000032c9f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000032c7d
