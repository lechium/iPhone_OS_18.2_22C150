...
+ (id)_comparatorForStrategy:(unsigned long long)arg1 comparisonOptions:(unsigned long long)arg2;	// IMP=0x0010000000003b31
+ (id)_referenceItemsSourceForType:(unsigned long long)arg1;	// IMP=0x0010000000003a25
- (void).cxx_destruct;	// IMP=0x000000000000404a
...
- (void)addExclusionAreaAt:(struct CGRect)arg1;	// IMP=0x0000000000003f19
- (void)addSquareGuideAt:(struct CGRect)arg1 withColor:(id)arg2;	// IMP=0x0000000000003e8b
- (void)addHorozontalGuideAt:(double)arg1 withColor:(id)arg2;	// IMP=0x0000000000003dff
- (void)addVerticalGuideAt:(double)arg1 withColor:(id)arg2;	// IMP=0x0000000000003d76
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003866
- (id)initWithReferenceItemsSource:(id)arg1 storeManager:(id)arg2 imageComparator:(id)arg3;	// IMP=0x0000000000003774
- (id)init;	// IMP=0x000000000000375b
