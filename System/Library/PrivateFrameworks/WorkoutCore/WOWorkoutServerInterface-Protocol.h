...
- (void)remote_fetchAllDeletedConfigurationsAsSerializedPersistenceWithCompletion:(void (^)(NSData *, NSError *))arg1;
- (void)remote_fetchAllConfigurationsAsSerializedPersistenceWithCompletion:(void (^)(NSData *, NSError *))arg1;
- (void)remote_fetchDeletedConfiguration:(NSUUID *)arg1 withCompletion:(void (^)(WOPersistence *, NSError *))arg2;
