...
- (void).cxx_destruct;	// IMP=0x00000000000ac306
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000ac1c7
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithBoundingBoxes:(id)arg1 classLogits:(id)arg2 anchors:(id)arg3;	// IMP=0x00000000000ac056
