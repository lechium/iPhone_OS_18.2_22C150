...
- (void).cxx_destruct;	// IMP=0x0000000000051da6
...
- (_Bool)shouldFetchProtectedKey:(id)arg1;	// IMP=0x0000000000051b82
- (_Bool)shouldFetchUserAssignedDeviceName;	// IMP=0x0000000000051ada
- (void)dealloc;	// IMP=0x0000000000051a93
- (id)init;	// IMP=0x0000000000050f9e
