...
- (void).cxx_destruct;	// IMP=0x000000000007a04b
...
- (void)useImmutableObjectsFromMap:(id)arg1 intermediateMutableObjectTransferBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000079cdb
@property(readonly, copy) NSString *description;
- (id)initWithRemovedObjects:(id)arg1 indexes:(id)arg2;	// IMP=0x0000000000079b40
