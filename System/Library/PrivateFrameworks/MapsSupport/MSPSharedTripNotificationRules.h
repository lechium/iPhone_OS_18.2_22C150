...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000172b
+ (id)unarchivingObjectsSet;	// IMP=0x001000000000166f
- (void).cxx_destruct;	// IMP=0x0000000000002bb9
...
- (_Bool)hasSentNotificationType:(unsigned long long)arg1 forState:(id)arg2 waypoint:(id)arg3;	// IMP=0x00000000000029c7
- (double)minimumETADifferenceIncrement;	// IMP=0x00000000000029b0
- (void)incrementMinimumETADifference;	// IMP=0x000000000000290f
- (void)didReceiveUpdateWithETA:(double)arg1 lastUpdated:(double)arg2;	// IMP=0x0000000000002870
- (unsigned long long)currentlyNecessaryNotificationTypeForState:(id)arg1;	// IMP=0x000000000000234c
- (void)didPostNotificationType:(unsigned long long)arg1 forState:(id)arg2;	// IMP=0x0000000000002067
- (id)description;	// IMP=0x0000000000001f3d
- (id)initWithMaximumNumberOfNotifications:(unsigned long long)arg1 minimumNotificationInterval:(double)arg2;	// IMP=0x0000000000001e32
- (id)initWithMaximumNumberOfNotifications:(unsigned long long)arg1;	// IMP=0x0000000000001dfc
- (id)init;	// IMP=0x0000000000001db4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000019d1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001733
