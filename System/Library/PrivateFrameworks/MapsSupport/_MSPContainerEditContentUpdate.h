...
- (void).cxx_destruct;	// IMP=0x000000000007abd1
...
- (void)useImmutableObjectsFromMap:(id)arg1 intermediateMutableObjectTransferBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000007aac6
@property(readonly, copy) NSString *description;
- (id)initWithUpdatedImmutableObject:(id)arg1;	// IMP=0x000000000007a9a9
- (id)initWithUpdatedObject:(id)arg1;	// IMP=0x000000000007a93b
