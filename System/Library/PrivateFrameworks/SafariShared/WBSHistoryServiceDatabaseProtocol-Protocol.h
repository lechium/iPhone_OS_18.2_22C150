...
@protocol WBSHistoryExporterProtocol, WBSHistoryPredicate;
...
- (void)visitIdentifiersMatchingExistingVisits:(NSSet *)arg1 desiredVisitTimePrecision:(unsigned long long)arg2 completionHandler:(void (^)(NSSet *, NSError *))arg3;
...
- (void)startImportHistorySessionWithVisitTimePrecision:(unsigned long long)arg1 completionHandler:(void (^)(id <WBSHistoryImporterDelegate>, NSError *))arg2;
...
- (void)clearHistoryVisitsAddedAfterDate:(NSDate *)arg1 beforeDate:(NSDate *)arg2 tombstoneMode:(unsigned long long)arg3 clearAllSpotlightHistoryForProfile:(_Bool)arg4 completionHandler:(void (^)(NSError *))arg5;
- (void)clearAllHistoryInsertingTombstoneUpToDate:(NSDate *)arg1 clearAllSpotlightHistoryForProfile:(_Bool)arg2 completionHandler:(void (^)(NSError *))arg3;
