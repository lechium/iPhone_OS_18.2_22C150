...
- (void)fetchAuxiliaryAuthenticationDataFromCacheForType:(unsigned long long)arg1 label:(NSString *)arg2 cacheKey:(NSString *)arg3 completionHandler:(void (^)(NSData *, NSError *))arg4;
- (void)addAuxiliaryAuthenticationData:(NSData *)arg1 type:(unsigned long long)arg2 label:(NSString *)arg3 cacheKey:(NSString *)arg4;
- (void)addToken:(NSData *)arg1 toCacheForFetcher:(NSPPrivateAccessTokenFetcher *)arg2;
- (_Bool)checkOriginAllowedAsThirdParty:(NSString *)arg1;
- (void)fetchKnownPrivateAccessTokenKeyWithFetcher:(NSPPrivateAccessTokenFetcher *)arg1 completionHandler:(void (^)(NSData *, NSError *))arg2;
- (void)fetchPrivateAccessTokenPairWithFetcher:(NSPPrivateAccessTokenFetcher *)arg1 completionHandler:(void (^)(NSData *, NSData *, NSData *, NSError *))arg2;
...
- (void)getPreferredObliviousProxyWithCompletionHandler:(void (^)(NSString *, NSError *))arg1;
- (void)overridePreferredObliviousProxy:(NSString *)arg1 completionHandler:(void (^)(NSError *))arg2;
