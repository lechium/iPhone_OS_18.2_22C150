...
+ (Class)subtitleLocalizedArgumentsType;	// IMP=0x00100000001fb5e7
+ (Class)titleLocalizedArgumentsType;	// IMP=0x00100000001fb4eb
+ (Class)localizedArgumentsType;	// IMP=0x00100000001fb39b
- (void).cxx_destruct;	// IMP=0x00000000001fd3a0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001fcd4b
- (unsigned long long)hash;	// IMP=0x00000000001fcbda
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001fc942
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001fc361
- (void)copyTo:(id)arg1;	// IMP=0x00000000001fc03b
- (void)writeTo:(id)arg1;	// IMP=0x00000000001fbc29
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001fbc1c
- (id)dictionaryRepresentation;	// IMP=0x00000000001fb6a7
- (id)description;	// IMP=0x00000000001fb5f8
- (id)subtitleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001fb5ca
- (unsigned long long)subtitleLocalizedArgumentsCount;	// IMP=0x00000000001fb5ad
- (void)addSubtitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001fb543
- (void)clearSubtitleLocalizedArguments;	// IMP=0x00000000001fb526
@property(readonly, nonatomic) _Bool hasSubtitleLocalizedKey;
@property(readonly, nonatomic) _Bool hasSubtitle;
- (id)titleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001fb4ce
- (unsigned long long)titleLocalizedArgumentsCount;	// IMP=0x00000000001fb4b1
- (void)addTitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001fb447
- (void)clearTitleLocalizedArguments;	// IMP=0x00000000001fb42a
...
- (id)localizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001fb37e
- (unsigned long long)localizedArgumentsCount;	// IMP=0x00000000001fb361
- (void)addLocalizedArguments:(id)arg1;	// IMP=0x00000000001fb2f7
- (void)clearLocalizedArguments;	// IMP=0x00000000001fb2da
