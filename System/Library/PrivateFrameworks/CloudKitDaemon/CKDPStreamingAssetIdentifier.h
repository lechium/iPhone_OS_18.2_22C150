...
- (void).cxx_destruct;	// IMP=0x00000000000d34ae
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000d33bc
- (unsigned long long)hash;	// IMP=0x00000000000d334f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d326f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d31ab
- (void)copyTo:(id)arg1;	// IMP=0x00000000000d3128
- (void)writeTo:(id)arg1;	// IMP=0x00000000000d30ae
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000d30a1
- (id)dictionaryRepresentation;	// IMP=0x00000000000d2e6b
- (id)description;	// IMP=0x00000000000d2dbc
