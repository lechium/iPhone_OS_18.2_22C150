...
- (void).cxx_destruct;	// IMP=0x00000000003ed669
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003ed560
- (unsigned long long)hash;	// IMP=0x00000000003ed4ea
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003ed3fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003ed339
- (void)copyTo:(id)arg1;	// IMP=0x00000000003ed2b6
- (void)writeTo:(id)arg1;	// IMP=0x00000000003ed232
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003ed225
- (id)dictionaryRepresentation;	// IMP=0x00000000003ece6c
- (id)description;	// IMP=0x00000000003ecdbd
