...
- (void).cxx_destruct;	// IMP=0x00000000003b9dd1
...
- (void)requestDidComplete;	// IMP=0x00000000003b961a
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000003b904c
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000003b81b4
- (id)returnVerificationKeyAndSignatureForRequestOperation:(id)arg1 dataToBeSigned:(id)arg2 error:(id *)arg3;	// IMP=0x00000000003b7a87
- (id)generateMergeableDeltaSaveOperationsForRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00000000003b68f1
- (id)generateRequestOperations;	// IMP=0x00000000003b3cd6
- (_Bool)requiresCKAnonymousSignature;	// IMP=0x00000000003b3cc4
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000003b3cbc
- (int)isolationLevel;	// IMP=0x00000000003b3c9f
- (id)requestOperationClasses;	// IMP=0x00000000003b3b85
- (id)zoneIDsToLock;	// IMP=0x00000000003b3849
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000003b382f
- (id)recordIDsUsedInZones:(id)arg1;	// IMP=0x00000000003b3598
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000003b3492
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000003b3323
- (id)initWithOperation:(id)arg1 recordsToSave:(id)arg2 recordIDsToDelete:(id)arg3 recordIDsToDeleteToSigningPCSIdentity:(id)arg4 oplock:(_Bool)arg5 sendAllFields:(_Bool)arg6 clientChangeTokenData:(id)arg7 requestedFieldsByRecordId:(id)arg8;	// IMP=0x00000000003b30f6
