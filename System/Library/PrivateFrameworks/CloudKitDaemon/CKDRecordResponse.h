...
- (id)description;	// IMP=0x00000000002bb217
- (id)CKPropertiesDescription;	// IMP=0x00000000002bb148
- (id)initWithRecordID:(id)arg1 record:(id)arg2 etag:(id)arg3;	// IMP=0x00000000002bb06d
