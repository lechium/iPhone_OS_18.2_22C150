...
+ (id)options;	// IMP=0x00100000001c0f2c
- (void).cxx_destruct;	// IMP=0x00000000001c20b3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001c1e4d
- (unsigned long long)hash;	// IMP=0x00000000001c1d40
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001c1b79
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c19f7
- (void)copyTo:(id)arg1;	// IMP=0x00000000001c18d7
- (Class)responseClass;	// IMP=0x00000000001c18c6
- (unsigned int)requestTypeCode;	// IMP=0x00000000001c18bb
- (void)writeTo:(id)arg1;	// IMP=0x00000000001c1799
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001c178c
- (id)dictionaryRepresentation;	// IMP=0x00000000001c1159
- (id)description;	// IMP=0x00000000001c10aa
