...
- (void).cxx_destruct;	// IMP=0x00000000001adb67
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000001ad961
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001ad81c
- (id)generateRequestOperations;	// IMP=0x00000000001acd59
- (id)requestOperationClasses;	// IMP=0x00000000001acc72
- (id)zoneIDsToLock;	// IMP=0x00000000001acbb9
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000001acbb1
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000001ac92f
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000001ac7b7
- (id)initWithOperation:(id)arg1 subscriptionsToSave:(id)arg2 subscriptionIDsToDelete:(id)arg3;	// IMP=0x00000000001ac6ee
