...
+ (id)options;	// IMP=0x00100000003533fc
- (void).cxx_destruct;	// IMP=0x0000000000354a2e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003547de
- (unsigned long long)hash;	// IMP=0x0000000000354698
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000354493
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000354315
- (void)copyTo:(id)arg1;	// IMP=0x00000000003541db
- (Class)responseClass;	// IMP=0x00000000003541ca
- (unsigned int)requestTypeCode;	// IMP=0x00000000003541bf
- (void)writeTo:(id)arg1;	// IMP=0x0000000000354075
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000354068
- (id)dictionaryRepresentation;	// IMP=0x00000000003537c9
- (id)description;	// IMP=0x000000000035371a
...
- (int)StringAsRequestedChangeTypes:(id)arg1;	// IMP=0x0000000000353586
- (id)requestedChangeTypesAsString:(int)arg1;	// IMP=0x000000000035353b
