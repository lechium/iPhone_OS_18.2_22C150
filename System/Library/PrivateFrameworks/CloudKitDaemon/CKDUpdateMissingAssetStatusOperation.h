...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000024b324
- (void).cxx_destruct;	// IMP=0x000000000024b9fd
...
- (void)main;	// IMP=0x000000000024b8cb
- (void)_updateMissingAssetStatus;	// IMP=0x000000000024b37f
- (int)operationType;	// IMP=0x000000000024b374
- (_Bool)makeStateTransition;	// IMP=0x000000000024b27f
- (id)activityCreate;	// IMP=0x000000000024b256
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000024b139
