...
- (void).cxx_destruct;	// IMP=0x0000000000093ffb
...
- (id)CKPropertiesDescription;	// IMP=0x0000000000093f53
- (id)description;	// IMP=0x0000000000093f41
- (void)invokeWaitCompletedHandler:(_Bool)arg1;	// IMP=0x0000000000093e2e
- (id)initWithWaiter:(id)arg1 zoneIDs:(id)arg2 waitCompletedHandler:(CDUnknownBlockType)arg3 activity:(id)arg4;	// IMP=0x0000000000093d38
