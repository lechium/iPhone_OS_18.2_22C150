...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000011718c
- (void).cxx_destruct;	// IMP=0x000000000011967b
...
- (void)main;	// IMP=0x0000000000119521
- (void)_verifyOONParticipant;	// IMP=0x0000000000118a63
- (void)_reconstructShareURL;	// IMP=0x0000000000118812
- (void)_forceFetchShareMetadata;	// IMP=0x00000000001180be
- (void)_performAuthKitVerification;	// IMP=0x0000000000117ab6
- (void)_reconstructShortToken;	// IMP=0x0000000000117387
- (id)shortSharingTokenFromData:(id)arg1;	// IMP=0x0000000000117372
- (id)shortSharingTokenFromFullToken:(id)arg1;	// IMP=0x0000000000117274
- (_Bool)makeStateTransition;	// IMP=0x0000000000117030
- (id)activityCreate;	// IMP=0x0000000000117007
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000116de0
