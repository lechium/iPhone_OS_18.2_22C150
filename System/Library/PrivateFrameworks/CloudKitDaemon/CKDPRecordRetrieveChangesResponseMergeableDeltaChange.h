...
+ (Class)deltasType;	// IMP=0x00100000000511a4
- (void).cxx_destruct;	// IMP=0x000000000005232d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000052044
- (unsigned long long)hash;	// IMP=0x0000000000051fa5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000051e6d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000051c02
- (void)copyTo:(id)arg1;	// IMP=0x0000000000051ab7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000051901
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000518f4
- (id)dictionaryRepresentation;	// IMP=0x0000000000051279
- (id)description;	// IMP=0x00000000000511ca
@property(readonly, nonatomic) _Bool hasRecordType;
- (id)deltasAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000051187
- (unsigned long long)deltasCount;	// IMP=0x000000000005116a
- (void)addDeltas:(id)arg1;	// IMP=0x0000000000051100
- (void)clearDeltas;	// IMP=0x00000000000510e3
