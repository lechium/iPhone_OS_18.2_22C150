...
- (void).cxx_destruct;	// IMP=0x0000000000386086
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000385e39
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000003859b2
- (id)generateRequestOperations;	// IMP=0x0000000000385401
- (id)requestOperationClasses;	// IMP=0x0000000000385395
- (id)zoneIDsToLock;	// IMP=0x00000000003851cf
- (id)recordIDsUsedInZones:(id)arg1;	// IMP=0x0000000000385152
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000003850c1
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x0000000000384f93
- (id)initWithOperation:(id)arg1 recordIDs:(id)arg2 desiredKeys:(id)arg3 minimumVersionETag:(id)arg4;	// IMP=0x0000000000384e8a
