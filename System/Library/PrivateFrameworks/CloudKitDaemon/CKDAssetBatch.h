...
- (void).cxx_destruct;	// IMP=0x00000000003c3bcd
...
- (id)description;	// IMP=0x00000000003c3b0b
- (id)CKPropertiesDescription;	// IMP=0x00000000003c399a
- (_Bool)isEmptyOfRereferencesAssets;	// IMP=0x00000000003c38af
- (_Bool)isEmptyOfAssets;	// IMP=0x00000000003c37c4
- (_Bool)isRereferenceAssetBatch;	// IMP=0x00000000003c377c
- (_Bool)isPackageSectionBatch;	// IMP=0x00000000003c366b
- (id)firstMMCSItemError;	// IMP=0x00000000003c351c
- (void)failIfNotDoneAllRegularAndSectionAndRereferenceItemsWithError:(id)arg1;	// IMP=0x00000000003c336f
@property(readonly, nonatomic) NSArray *allRegularAndSectionAndRereferenceItems;
- (id)allMMCSAndSectionItems;	// IMP=0x00000000003c3138
...
- (void)addAssetRecord:(id)arg1;	// IMP=0x00000000003c2f3d
- (id)initWithAssetZone:(id)arg1;	// IMP=0x00000000003c2e38
