...
- (void).cxx_destruct;	// IMP=0x000000000026b276
...
- (id)description;	// IMP=0x000000000026b189
- (id)CKPropertiesDescription;	// IMP=0x000000000026ae44
- (void)performCallback;	// IMP=0x000000000026aa9b
- (id)initWithAggregator:(id)arg1;	// IMP=0x000000000026a9b6
