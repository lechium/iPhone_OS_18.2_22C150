...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001b8d9c
- (unsigned long long)hash;	// IMP=0x00000000001b8cfe
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b8bdd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b8b11
- (void)copyTo:(id)arg1;	// IMP=0x00000000001b8a68
- (void)writeTo:(id)arg1;	// IMP=0x00000000001b8995
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001b8988
- (id)dictionaryRepresentation;	// IMP=0x00000000001b8390
- (id)description;	// IMP=0x00000000001b82e1
