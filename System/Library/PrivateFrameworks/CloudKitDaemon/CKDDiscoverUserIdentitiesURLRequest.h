...
- (void).cxx_destruct;	// IMP=0x00000000002bc63e
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002bc378
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002bb6db
- (id)generateRequestOperations;	// IMP=0x00000000002bb499
- (id)requestOperationClasses;	// IMP=0x00000000002bb42d
- (long long)databaseScope;	// IMP=0x00000000002bb422
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000002bb325
- (id)initWithOperation:(id)arg1 lookupInfos:(id)arg2 adopterProvidedLookupInfos:(_Bool)arg3;	// IMP=0x00000000002bb27a
