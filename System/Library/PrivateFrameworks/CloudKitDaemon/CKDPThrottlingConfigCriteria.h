...
- (void).cxx_destruct;	// IMP=0x00000000003c2885
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003c266c
- (unsigned long long)hash;	// IMP=0x00000000003c2553
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003c2363
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003c21cd
- (void)copyTo:(id)arg1;	// IMP=0x00000000003c2092
- (void)writeTo:(id)arg1;	// IMP=0x00000000003c1f51
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003c1f44
- (id)dictionaryRepresentation;	// IMP=0x00000000003c141a
- (id)description;	// IMP=0x00000000003c136b
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x00000000003c1248
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x00000000003c11fd
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsOperationType:(id)arg1;	// IMP=0x00000000003c0a48
- (id)operationTypeAsString:(int)arg1;	// IMP=0x00000000003c052b
@property(nonatomic) _Bool hasOperationType;
@property(nonatomic) int operationType; // @synthesize operationType=_operationType;
- (int)StringAsContainerEnvironment:(id)arg1;	// IMP=0x00000000003c0456
- (id)containerEnvironmentAsString:(int)arg1;	// IMP=0x00000000003c0400
