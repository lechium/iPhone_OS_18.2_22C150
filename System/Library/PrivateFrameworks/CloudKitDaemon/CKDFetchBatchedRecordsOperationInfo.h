...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002f0c5a
- (void).cxx_destruct;	// IMP=0x00000000002f1150
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002f0dbe
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002f0c62
