...
- (void).cxx_destruct;	// IMP=0x00000000002df7e0
...
- (id)ckShortDescription;	// IMP=0x00000000002df631
- (id)description;	// IMP=0x00000000002df61f
- (id)CKPropertiesDescription;	// IMP=0x00000000002df60d
- (void)finishWithError:(id)arg1;	// IMP=0x00000000002df419
- (_Bool)_tryComplete;	// IMP=0x00000000002df36e
- (id)spawnURLRequests;	// IMP=0x00000000002de818
- (void)performRequest;	// IMP=0x00000000002dda42
- (void)_receivedUserIdentity:(id)arg1 forLookupInfo:(id)arg2 error:(id)arg3;	// IMP=0x00000000002dda26
- (void)_saveUserIdentity:(id)arg1 forLookupInfo:(id)arg2;	// IMP=0x00000000002dd794
- (void)cancel;	// IMP=0x00000000002dd77d
- (id)initWithOperation:(id)arg1 lookupInfos:(id)arg2;	// IMP=0x00000000002dd6d9
