...
+ (Class)clientConfigType;	// IMP=0x00100000003bae10
- (void).cxx_destruct;	// IMP=0x00000000003bcf78
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003bca4b
- (unsigned long long)hash;	// IMP=0x00000000003bc8a1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003bc5fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003bc237
- (void)copyTo:(id)arg1;	// IMP=0x00000000003bbff6
- (Class)responseClass;	// IMP=0x00000000003bbfe5
- (unsigned int)requestTypeCode;	// IMP=0x00000000003bbfda
- (void)writeTo:(id)arg1;	// IMP=0x00000000003bbd50
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003bb783
- (id)dictionaryRepresentation;	// IMP=0x00000000003bb1b7
- (id)description;	// IMP=0x00000000003bb108
- (void)clearOneofValuesForDataProtection;	// IMP=0x00000000003bb0a8
- (int)StringAsDataProtection:(id)arg1;	// IMP=0x00000000003bb011
- (id)dataProtectionAsString:(int)arg1;	// IMP=0x00000000003bafc8
...
- (id)clientConfigAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003badf3
- (unsigned long long)clientConfigsCount;	// IMP=0x00000000003badd6
- (void)addClientConfig:(id)arg1;	// IMP=0x00000000003bad6c
- (void)clearClientConfigs;	// IMP=0x00000000003bad4f
- (int)StringAsSerializationFormat:(id)arg1;	// IMP=0x00000000003bace4
- (id)serializationFormatAsString:(int)arg1;	// IMP=0x00000000003bac8e
