...
- (id)initWithEncryptedData:(id)arg1 changeType:(int)arg2 deleteType:(int)arg3;	// IMP=0x000000000022d31c
- (id)initWithEncryptedData:(id)arg1;	// IMP=0x000000000022d2a9
