...
+ (id)options;	// IMP=0x00100000001fe860
- (void).cxx_destruct;	// IMP=0x00000000001ff588
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001ff40d
- (unsigned long long)hash;	// IMP=0x00000000001ff358
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ff215
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001ff108
- (void)copyTo:(id)arg1;	// IMP=0x00000000001ff048
- (Class)responseClass;	// IMP=0x00000000001ff037
- (unsigned int)requestTypeCode;	// IMP=0x00000000001ff02c
- (void)writeTo:(id)arg1;	// IMP=0x00000000001fef61
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001fef54
- (id)dictionaryRepresentation;	// IMP=0x00000000001fea2c
- (id)description;	// IMP=0x00000000001fe97d
