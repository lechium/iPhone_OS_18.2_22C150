...
- (void).cxx_destruct;	// IMP=0x00000000003d23b1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003d20c8
- (unsigned long long)hash;	// IMP=0x00000000003d1f52
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003d1d02
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003d1b0b
- (void)copyTo:(id)arg1;	// IMP=0x00000000003d1987
- (void)writeTo:(id)arg1;	// IMP=0x00000000003d180d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003d1800
- (id)dictionaryRepresentation;	// IMP=0x00000000003d1064
- (id)description;	// IMP=0x00000000003d0fb5
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x00000000003d0dff
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x00000000003d0db6
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsDatabaseEnvironment:(id)arg1;	// IMP=0x00000000003d0ce7
- (id)databaseEnvironmentAsString:(int)arg1;	// IMP=0x00000000003d0c92
