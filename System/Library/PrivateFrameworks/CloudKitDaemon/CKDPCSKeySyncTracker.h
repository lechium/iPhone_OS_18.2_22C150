...
- (void).cxx_destruct;	// IMP=0x00000000001dcec3
...
- (void)waitOnSyncWithQueue:(id)arg1 waiterOperationID:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001dcab1
