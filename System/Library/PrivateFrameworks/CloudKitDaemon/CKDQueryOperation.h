...
- (id)relevantZoneIDs;	// IMP=0x00000000000a74de
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000a7478
- (void)main;	// IMP=0x00000000000a6a8e
- (void)_sendQueryRequestWithCursor:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000000a56a2
- (void)_handleRecordResponses:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000000a4995
- (id)_wrapError:(id)arg1 format:(id)arg2;	// IMP=0x00000000000a477b
- (void)_handleQueryRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x00000000000a40ab
- (id)activityCreate;	// IMP=0x00000000000a4082
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x00000000000a406a
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000a3d13
