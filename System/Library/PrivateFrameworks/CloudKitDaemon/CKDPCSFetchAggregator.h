...
- (void).cxx_destruct;	// IMP=0x00000000003ccc73
...
- (void)cancelAllOperations;	// IMP=0x00000000003cc89c
- (void)requestFetchOfZoneWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000003cc3fb
- (void)requestFetchOfShareWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000003cbed9
- (void)requestFetchOfRecordWithID:(id)arg1 forOperation:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000003cb850
- (_Bool)fetchRequestForExistingOperation:(id)arg1 isDependentOnOperation:(id)arg2;	// IMP=0x00000000003cb2c5
- (id)_lockedGetQueuedFetchForOperation:(id)arg1 ofClass:(Class)arg2;	// IMP=0x00000000003cac53
- (void)_lockedRescheduleFetchTimer;	// IMP=0x00000000003ca951
- (void)_lockedTearDownFetchTimer;	// IMP=0x00000000003ca8c9
- (void)_lockedFetchesAreReady;	// IMP=0x00000000003c9b9f
- (void)dealloc;	// IMP=0x00000000003c9b60
- (id)initWithContainer:(id)arg1;	// IMP=0x00000000003c989e
- (id)init;	// IMP=0x00000000003c983e
