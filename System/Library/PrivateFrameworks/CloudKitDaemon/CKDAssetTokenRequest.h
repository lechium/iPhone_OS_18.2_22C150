...
- (void).cxx_destruct;	// IMP=0x00000000000837be
...
- (id)description;	// IMP=0x000000000008375b
- (id)CKPropertiesDescription;	// IMP=0x00000000000835bb
- (_Bool)isEmpty;	// IMP=0x000000000008359e
- (id)successfulBatches;	// IMP=0x000000000008354b
- (_Bool)hasSuccessfulBatches;	// IMP=0x0000000000083454
- (void)addFailedBatch:(id)arg1;	// IMP=0x0000000000083435
- (void)addAssetBatch:(id)arg1;	// IMP=0x0000000000083385
- (id)init;	// IMP=0x0000000000083310
