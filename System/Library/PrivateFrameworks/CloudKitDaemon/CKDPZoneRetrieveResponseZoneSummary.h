...
- (void).cxx_destruct;	// IMP=0x000000000015ace2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000015a96f
- (unsigned long long)hash;	// IMP=0x000000000015a7a9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000015a4e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015a2bf
- (void)copyTo:(id)arg1;	// IMP=0x000000000015a109
- (void)writeTo:(id)arg1;	// IMP=0x0000000000159f49
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000159f3c
- (id)dictionaryRepresentation;	// IMP=0x00000000001594ee
- (id)description;	// IMP=0x000000000015943f
