...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002ecb3e
- (unsigned long long)hash;	// IMP=0x00000000002eca7f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002ec8f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002ec809
- (void)copyTo:(id)arg1;	// IMP=0x00000000002ec741
- (void)writeTo:(id)arg1;	// IMP=0x00000000002ec649
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002ec63c
- (id)dictionaryRepresentation;	// IMP=0x00000000002ebf2c
- (id)description;	// IMP=0x00000000002ebe7d
@property(nonatomic) _Bool hasHierarchicalSharing;
@property(nonatomic) _Bool hasZoneSharing;
- (int)StringAsSharingType:(id)arg1;	// IMP=0x00000000002ebd49
- (id)sharingTypeAsString:(int)arg1;	// IMP=0x00000000002ebcfe
