...
- (void).cxx_destruct;	// IMP=0x00000000001e0eb4
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001e0de7
- (void)main;	// IMP=0x00000000001e06fa
- (int)operationType;	// IMP=0x00000000001e06ef
- (void)_handleSubscriptionFetched:(id)arg1 withID:(id)arg2 responseCode:(id)arg3;	// IMP=0x00000000001e0357
- (id)activityCreate;	// IMP=0x00000000001e032e
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001e0283
