...
- (void).cxx_destruct;	// IMP=0x00000000003862d3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003861bc
- (unsigned long long)hash;	// IMP=0x0000000000386178
- (void)dealloc;	// IMP=0x0000000000386131
