...
- (void).cxx_destruct;	// IMP=0x0000000000370048
...
- (void)cancel;	// IMP=0x000000000036ff5e
...
- (id)activityCreate;	// IMP=0x000000000036fcf2
- (id)initWithPackage:(id)arg1 trackProgress:(_Bool)arg2;	// IMP=0x000000000036fb4c
