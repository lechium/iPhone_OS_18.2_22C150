...
+ (id)dmc_createManagementAccountWithStore:(id)arg1;	// IMP=0x00200000000015e2
- (_Bool)dmc_isAccountSchemeSharediPad;	// IMP=0x0010000000002409
- (id)dmc_accountQuotaString;	// IMP=0x0010000000001e8c
- (_Bool)dmc_isPrimaryAccount;	// IMP=0x0010000000001e41
- (_Bool)dmc_isVisibleRemoteManagementAccount;	// IMP=0x0010000000001db5
