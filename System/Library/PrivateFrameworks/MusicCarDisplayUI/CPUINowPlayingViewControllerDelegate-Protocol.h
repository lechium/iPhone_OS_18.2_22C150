...
@optional
- (_Bool)nowPlayingViewControllerShouldOverrideRightBarButtons:(CPUINowPlayingViewController *)arg1;
- (void)nowPlayingViewControllerAttributionButtonTapped:(CPUINowPlayingViewController *)arg1;
- (_Bool)nowPlayingViewControllerShouldHideBackButton:(CPUINowPlayingViewController *)arg1;
