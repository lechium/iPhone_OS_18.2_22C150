...
@class NSArray, NSDictionary, NSString, TIAutocorrectionList, TICandidateRequestToken, TIKeyboardCandidate, TIKeyboardCandidateResultSet, TIKeyboardConfiguration, TIKeyboardInput, TIKeyboardLayout, TIKeyboardOutput, TIKeyboardState, TIKeyboardTouchEvent;
