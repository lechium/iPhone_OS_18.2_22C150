...
- (void)generateResponseKitSuggestionsForString:(NSString *)arg1 withLanguage:(NSString *)arg2 withClientID:(NSString *)arg3 withRecipientID:(NSString *)arg4 withAdditionalPredictions:(TIAutocorrectionList *)arg5 desiredCandidateCount:(unsigned long long)arg6 shouldDisableAutoCaps:(_Bool)arg7 stringIsBlocklisted:(_Bool)arg8 async:(_Bool)arg9 completionHandler:(void (^)(TIAutocorrectionList *))arg10;
@end
