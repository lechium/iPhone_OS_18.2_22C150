...
- (id).cxx_construct;	// IMP=0x000000000000c700
...
- (id)applyAdjustments:(id)arg1 toCIImage:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000c1f0
- (id)predictSlidersForStyleVector:(id)arg1 contentVector:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000b1d0
- (id)predictContentVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000ab70
- (id)predictStyleVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000a030
- (id)initWithModel:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000092e0
- (id)initWithModel:(id)arg1;	// IMP=0x00000000000092c0
- (unsigned long long)styleFVecSize;	// IMP=0x0000000000009250
- (unsigned long long)contentFVecSize;	// IMP=0x00000000000091e0
