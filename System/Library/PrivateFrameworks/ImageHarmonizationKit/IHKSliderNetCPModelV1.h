...
- (id).cxx_construct;	// IMP=0x0000000000019f70
- (void).cxx_destruct;	// IMP=0x0000000000019e20
...
- (id)applyAdjustments:(id)arg1 toCIImage:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000019ab0
- (id)getValueForAdjustment:(id)arg1 adjustments:(id)arg2;	// IMP=0x0000000000019990
- (id)predictSlidersForStyleVector:(id)arg1 contentVector:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000018100
- (struct EspressoTensor)newTensorWithCorrectShape:(struct EspressoTensor)arg1 shape:(id)arg2;	// IMP=0x0000000000017d30
- (id)predictContentVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000176a0
- (id)predictStyleVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000017040
- (id)initWithModel:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000015750
- (id)initWithModel:(id)arg1;	// IMP=0x0000000000015730
- (unsigned long long)styleFVecSize;	// IMP=0x00000000000156c0
- (unsigned long long)contentFVecSize;	// IMP=0x0000000000015650
