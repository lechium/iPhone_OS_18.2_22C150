...
+ (id)defaultPropertiesToFetch;	// IMP=0x0060000000001b01
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
@property(nonatomic) _Bool virtualPlayEnabled;
@property(nonatomic) int subscriberCount;
- (id)streamKeyURL;	// IMP=0x0000000000004e5c
- (id)streamCertificateURL;	// IMP=0x0000000000004dbf
...
- (void)setStreamKeyURL:(id)arg1;	// IMP=0x00000000000044b8
- (void)setStreamCertificateURL:(id)arg1;	// IMP=0x00000000000043c9
...
- (id)feedbackDictionaryRepresentation;	// IMP=0x0000000000001fe0
- (id)additionalReferencedTrackDescriptors;	// IMP=0x0000000000001bf4
