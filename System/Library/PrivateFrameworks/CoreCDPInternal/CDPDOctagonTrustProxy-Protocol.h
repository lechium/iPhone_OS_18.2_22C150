...
- (void)fetchAllEscrowRecords:(NSDictionary *)arg1 source:(long long)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
- (void)fetchAllEscrowRecords:(NSDictionary *)arg1 forceFetch:(_Bool)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
- (void)fetchEscrowRecords:(NSDictionary *)arg1 source:(long long)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
- (void)fetchEscrowRecords:(NSDictionary *)arg1 forceFetch:(_Bool)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
