...
- (void)beginInMemoryDownloadOfResource:(CPLResource *)arg1 clientBundleID:(NSString *)arg2 reply:(void (^)(NSString *))arg3;
...
- (void)openLibraryWithClientLibraryBaseURL:(NSURL *)arg1 cloudLibraryStateStorageURL:(NSURL *)arg2 cloudLibraryResourceStorageURL:(NSURL *)arg3 libraryIdentifier:(NSString *)arg4 mainScopeIdentifier:(NSString *)arg5 options:(unsigned long long)arg6 completionHandler:(void (^)(NSError *, NSDictionary *, unsigned long long, unsigned long long, unsigned long long, unsigned long long, unsigned long long, NSString *, NSString *, NSString *, NSURL *))arg7;
