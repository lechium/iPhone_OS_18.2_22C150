...
@class CPLResource, NSArray, NSData, NSDictionary, NSError, NSString, NSURL;

@protocol CPLClientLibraryManagerProtocol <NSObject>
- (void)libraryManagerHasBeenReplaced;
- (void)providePayloadForComputeStates:(NSArray *)arg1 inFolderWithURL:(NSURL *)arg2 completionHandler:(void (^)(NSArray *, NSError *))arg3;
