...
- (void).cxx_destruct;	// IMP=0x0000000000562972
...
- (void)deleteAttachmentItems:(id)arg1;	// IMP=0x0000000000562274
- (void)updateCollections;	// IMP=0x00000000005617d0
- (id)guidFromChatItem:(id)arg1;	// IMP=0x000000000056176d
- (void)chatItemsChanged:(id)arg1;	// IMP=0x0000000000560e4f
- (void)dealloc;	// IMP=0x0000000000560dda
- (id)initWithChat:(id)arg1;	// IMP=0x0000000000560dc6
- (id)initWithChat:(id)arg1 photoTransferGUIDs:(id)arg2;	// IMP=0x0000000000560c78
