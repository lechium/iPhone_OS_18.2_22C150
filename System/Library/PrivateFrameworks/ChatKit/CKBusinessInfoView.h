...
- (void).cxx_destruct;	// IMP=0x000000000049892f
...
- (void)infoButtonTapped:(id)arg1;	// IMP=0x00000000004986ef
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000498346
- (void)layoutSubviews;	// IMP=0x00000000004978df
- (void)setup;	// IMP=0x0000000000497443
- (id)initWithLayoutType:(long long)arg1;	// IMP=0x00000000004973e5
