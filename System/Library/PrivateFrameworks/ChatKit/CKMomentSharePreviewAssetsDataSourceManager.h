...
- (void).cxx_destruct;	// IMP=0x00000000005bdb8b
...
- (void)_momentShareCacheDidChange:(id)arg1;	// IMP=0x00000000005bda5a
- (void)_handleFetchedMomentShare:(id)arg1 error:(id)arg2;	// IMP=0x00000000005bd877
- (void)_fetchMomentShare;	// IMP=0x00000000005bd71d
- (id)createInitialDataSource;	// IMP=0x00000000005bd4c3
- (id)initWithMomentShareURL:(id)arg1;	// IMP=0x00000000005bd3af
- (id)init;	// IMP=0x00000000005bd39b
