...
- (void).cxx_destruct;	// IMP=0x0000000000434f1f
...
- (void)configureForEffectIsDark:(_Bool)arg1;	// IMP=0x0000000000434db7
- (void)setTitle:(id)arg1;	// IMP=0x0000000000434c4d
- (void)setImage:(id)arg1;	// IMP=0x0000000000434be4
- (void)layoutSubviews;	// IMP=0x0000000000434996
- (_Bool)canBecomeFirstResponder;	// IMP=0x000000000043498e
- (void)setSelected:(_Bool)arg1;	// IMP=0x0000000000434871
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000004337f3
