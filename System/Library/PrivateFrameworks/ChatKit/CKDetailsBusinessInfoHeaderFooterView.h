...
+ (id)reuseIdentifier;	// IMP=0x00100000003949ce
- (void).cxx_destruct;	// IMP=0x0000000000394caf
@property(retain, nonatomic) CKBusinessInfoView *businessInfoView; // @synthesize businessInfoView=_businessInfoView;
- (void)layoutSubviews;	// IMP=0x0000000000394ba2
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x00000000003949db
