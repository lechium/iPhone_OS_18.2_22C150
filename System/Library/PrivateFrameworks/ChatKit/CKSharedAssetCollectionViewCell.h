...
+ (id)reuseIdentifier;	// IMP=0x00600000003e7e92
- (void).cxx_destruct;	// IMP=0x00000000003e892a
...
- (void)layoutSubviews;	// IMP=0x00000000003e84cd
- (id)formattedTitleFromPreviewTitle:(id)arg1;	// IMP=0x00000000003e83b0
- (double)cornerRadius;	// IMP=0x00000000003e7fb2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003e7e9f
