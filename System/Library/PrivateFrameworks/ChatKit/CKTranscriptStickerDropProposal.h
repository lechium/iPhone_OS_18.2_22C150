...
- (void).cxx_destruct;	// IMP=0x000000000009ea19
...
- (id)initWithDragItem:(id)arg1 previewCenter:(struct CGPoint)arg2 targetBalloonIndex:(id)arg3;	// IMP=0x000000000009e90a
