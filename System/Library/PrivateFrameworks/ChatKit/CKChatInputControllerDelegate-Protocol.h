...
@class CKBrowserDragControllerTarget, CKBrowserDraggedSticker, CKBrowserItemPayload, CKChatInputController, CKComposition, CKConversation, CKMessagePartChatItem, CKSendMenuPresentation, CKSendMenuPresentationRequest, CKStickerReactionSession, IMSticker, NSArray, NSData, NSMutableDictionary, NSString, UIInputViewController, UIKeyboardLayoutGuide, UIPresentationController, UIView, UIViewController;
...
- (void)sendAutomaticallyPlacedSticker:(IMSticker *)arg1 stickerReactionSession:(CKStickerReactionSession *)arg2 forChatItem:(CKMessagePartChatItem *)arg3 forParentChatItem:(CKMessagePartChatItem *)arg4 stickerFrame:(struct CGRect)arg5 animationCompletionHandler:(void (^)(void))arg6;
...
@optional
- (_Bool)commitStickerAsTapback:(IMSticker *)arg1;
