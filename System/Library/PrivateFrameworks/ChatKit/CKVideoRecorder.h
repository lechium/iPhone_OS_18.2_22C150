...
- (void).cxx_destruct;	// IMP=0x0000000000214a2c
...
- (void)captureOutput:(id)arg1 didFinishRecordingToOutputFileAtURL:(id)arg2 fromConnections:(id)arg3 error:(id)arg4;	// IMP=0x00000000002147dc
- (void)captureOutput:(id)arg1 didStartRecordingToOutputFileAtURL:(id)arg2 fromConnections:(id)arg3;	// IMP=0x00000000002147d6
- (void)setupCamera:(id)arg1;	// IMP=0x0000000000214691
@property(nonatomic) long long cameraDevice;
- (id)_configureRearVideoInput;	// IMP=0x0000000000214330
- (id)_configureFrontVideoInput;	// IMP=0x00000000002142b6
- (id)rearFacingCamera;	// IMP=0x0000000000214235
- (id)frontFacingCamera;	// IMP=0x00000000002141c5
- (id)audioDevice;	// IMP=0x0000000000214148
- (id)_cameraWithPosition:(long long)arg1;	// IMP=0x0000000000213fc2
- (void)dealloc;	// IMP=0x0000000000213f01
- (void)takePicture;	// IMP=0x0000000000213d0a
- (_Bool)startVideoCapture;	// IMP=0x0000000000213b20
- (void)stopVideoCapture;	// IMP=0x0000000000213ae3
- (void)cancel;	// IMP=0x00000000002139b9
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000213823
- (void)loadView;	// IMP=0x00000000002136f5
- (id)init;	// IMP=0x0000000000213272
