...
- (void).cxx_destruct;	// IMP=0x00000000002096ab
...
- (void)showCGGlyphs:(const unsigned short *)arg1 positions:(const struct CGPoint *)arg2 count:(long long)arg3 font:(id)arg4 textMatrix:(struct CGAffineTransform)arg5 attributes:(id)arg6 inContext:(struct CGContext *)arg7;	// IMP=0x00000000002091a8
- (void)drawAttributedMentionGlyphsForGlyphRange:(struct _NSRange)arg1 atPoint:(struct CGPoint)arg2;	// IMP=0x0000000000208c91
- (void)drawGlyphsForGlyphRange:(struct _NSRange)arg1 atPoint:(struct CGPoint)arg2;	// IMP=0x0000000000208bbe
- (void)updateDisplayForMentionGlyphRangeRemovingAttribute:(_Bool)arg1;	// IMP=0x00000000002089e6
- (void)updateMentionDisplay;	// IMP=0x000000000020899a
- (void)stopTimerRemovingAttribute:(_Bool)arg1;	// IMP=0x0000000000208933
- (void)startTimerIfNeeded;	// IMP=0x0000000000208834
- (_Bool)isAnyMentionAnimationActive;	// IMP=0x00000000002085c5
- (void)updateMentionAttributes:(id)arg1;	// IMP=0x00000000002083a6
- (id)init;	// IMP=0x00000000002082d8
