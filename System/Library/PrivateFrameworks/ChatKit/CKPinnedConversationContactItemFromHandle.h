...
- (void).cxx_destruct;	// IMP=0x0000000000478470
...
- (id)contactItemView;	// IMP=0x0000000000478325
- (id)cnContactWithKeys:(id)arg1;	// IMP=0x000000000047830f
@property(readonly, nonatomic) NSString *contactItemIdentifier;
- (id)initWithEntity:(id)arg1;	// IMP=0x000000000047828e
