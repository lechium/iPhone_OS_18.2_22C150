...
@interface CKTapbackLegacyView
{
    ...
    MISSING_TYPE *glyphView;	// 56 = 0x38
    MISSING_TYPE *isSelected;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x00000000006fc8c0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000006fc830
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000006fc690
- (void)layoutSubviews;	// IMP=0x00000000006fc380
...
- (void)performViewControllerDismissingAnimation;	// IMP=0x00000000006fca30
- (void)configureForTapback:(id)arg1 isSelected:(_Bool)arg2;	// IMP=0x00000000006fc960
