...
@class CKAggregateAttachmentMessagePartChatItem, CKAttachmentMessagePartChatItem, CKBalloonView, CKBrowserItemPayload, CKChatItem, CKChatItemDiff, CKComposition, CKConversation, CKFullScreenEffect, CKInlineReplyTransitionProperties, CKMessagePartChatItem, CKMessageStatusChatItem, CKTranscriptHighlightedMessageScrollContext, CKTranscriptStatusCell, CKViewController, IMChipAction, IMChipReply, IMRichCard, IMSticker, NSArray, NSIndexPath, NSIndexSet, NSString, PXAssetReference, UIContextMenuConfiguration, UIContextMenuInteraction, UITargetedPreview, UITraitCollection, UIView, UIViewController, _UIContextMenuStyle;
...
- (_Bool)transcriptCollectionViewControllerShouldScrollToBottomForLocalSentMessage:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
...
- (struct CGRect)effectiveVisibleRectOfCollectionViewForTranscriptCollectionViewController:(CKViewController<CKCoreTranscriptControllerProtocol> *)arg1;
