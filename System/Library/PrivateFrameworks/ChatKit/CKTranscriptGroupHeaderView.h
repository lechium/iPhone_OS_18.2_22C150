...
- (void).cxx_destruct;	// IMP=0x000000000055df27
...
- (void)layoutSubviews;	// IMP=0x000000000055dcae
- (id)initWithFrame:(struct CGRect)arg1 conversation:(id)arg2;	// IMP=0x000000000055d8eb
- (void)dealloc;	// IMP=0x000000000055d876
