...
- (void).cxx_destruct;	// IMP=0x000000000000ed2a
...
- (void)layoutSubviews;	// IMP=0x000000000000e250
@property(retain, nonatomic) NSString *subheadingText;
@property(retain, nonatomic) NSString *mainText;
- (void)prepareForReuse;	// IMP=0x000000000000dfde
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000000dc33
