...
- (void)captureOutput:(AVCaptureFileOutput *)arg1 didStartRecordingToOutputFileAtURL:(NSURL *)arg2 startPTS:(CDStruct_1b6d18a9)arg3 fromConnections:(NSArray *)arg4;
