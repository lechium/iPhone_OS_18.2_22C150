...
- (id)initWithFileURL:(NSURL *)arg1 transcoderUserInfo:(NSDictionary *)arg2 attributionInfo:(NSDictionary *)arg3 adaptiveImageGlyphContentIdentifier:(NSString *)arg4 adaptiveImageGlyphContentDescription:(NSString *)arg5 hideAttachment:(_Bool)arg6 isScreenshot:(_Bool)arg7;
