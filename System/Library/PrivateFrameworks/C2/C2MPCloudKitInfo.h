...
+ (Class)clientOperationType;	// IMP=0x0010000000016d53
+ (Class)operationGroupType;	// IMP=0x0010000000016be9
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000018d76
- (unsigned long long)hash;	// IMP=0x0000000000018b73
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001883d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001833d
- (void)copyTo:(id)arg1;	// IMP=0x000000000001802b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000017c55
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000017c48
- (id)dictionaryRepresentation;	// IMP=0x0000000000016ea3
- (id)description;	// IMP=0x0000000000016df4
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000016d36
- (unsigned long long)clientOperationsCount;	// IMP=0x0000000000016d19
- (void)addClientOperation:(id)arg1;	// IMP=0x0000000000016caf
- (void)clearClientOperations;	// IMP=0x0000000000016c92
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000016bcc
- (unsigned long long)operationGroupsCount;	// IMP=0x0000000000016baf
- (void)addOperationGroup:(id)arg1;	// IMP=0x0000000000016b45
- (void)clearOperationGroups;	// IMP=0x0000000000016b28
