...
+ (Class)networkPathInfoType;	// IMP=0x00100000000087d2
- (void).cxx_destruct;	// IMP=0x000000000000e7f7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000dbb6
- (unsigned long long)hash;	// IMP=0x000000000000d44e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000cad2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c29b
- (void)copyTo:(id)arg1;	// IMP=0x000000000000bc52
- (void)writeTo:(id)arg1;	// IMP=0x000000000000b53d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000b530
- (id)dictionaryRepresentation;	// IMP=0x0000000000008f69
- (id)description;	// IMP=0x0000000000008eba
...
- (id)networkPathInfoAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000087b5
- (unsigned long long)networkPathInfosCount;	// IMP=0x0000000000008798
- (void)addNetworkPathInfo:(id)arg1;	// IMP=0x000000000000872e
- (void)clearNetworkPathInfos;	// IMP=0x0000000000008711
