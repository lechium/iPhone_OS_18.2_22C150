...
- (void).cxx_destruct;	// IMP=0x0000000000007eac
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000007d9e
- (unsigned long long)hash;	// IMP=0x0000000000007d03
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000007bfa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000007b1d
- (void)copyTo:(id)arg1;	// IMP=0x0000000000007a7b
- (void)writeTo:(id)arg1;	// IMP=0x00000000000079ce
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000079c1
- (id)dictionaryRepresentation;	// IMP=0x00000000000075d2
- (id)description;	// IMP=0x0000000000007523
