...
+ (Class)internalTestConfigType;	// IMP=0x00100000000381a6
- (void).cxx_destruct;	// IMP=0x0000000000039861
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000003948e
- (unsigned long long)hash;	// IMP=0x000000000003935b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003912f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000038e05
- (void)copyTo:(id)arg1;	// IMP=0x0000000000038c21
- (void)writeTo:(id)arg1;	// IMP=0x00000000000389dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000389d0
- (id)dictionaryRepresentation;	// IMP=0x0000000000038266
- (id)description;	// IMP=0x00000000000381b7
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000038189
- (unsigned long long)internalTestConfigsCount;	// IMP=0x000000000003816c
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x0000000000038102
- (void)clearInternalTestConfigs;	// IMP=0x00000000000380e5
