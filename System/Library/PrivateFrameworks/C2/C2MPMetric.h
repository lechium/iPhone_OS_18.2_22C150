...
- (void).cxx_destruct;	// IMP=0x0000000000033f6b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000033bf0
- (unsigned long long)hash;	// IMP=0x0000000000033a49
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000033789
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000033553
- (void)copyTo:(id)arg1;	// IMP=0x000000000003339c
- (void)writeTo:(id)arg1;	// IMP=0x00000000000331dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000331d0
- (id)dictionaryRepresentation;	// IMP=0x0000000000032698
- (id)description;	// IMP=0x00000000000325e9
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x0000000000032346
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00000000000322da
