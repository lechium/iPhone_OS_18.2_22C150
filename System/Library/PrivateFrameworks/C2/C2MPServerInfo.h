...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000026749
- (unsigned long long)hash;	// IMP=0x00000000000266c5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000265b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000264cf
- (void)copyTo:(id)arg1;	// IMP=0x000000000002642c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000026395
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000026388
- (id)dictionaryRepresentation;	// IMP=0x00000000000260f3
- (id)description;	// IMP=0x0000000000026044
