...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000732e
- (unsigned long long)hash;	// IMP=0x0000000000007290
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000717a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000709f
- (void)copyTo:(id)arg1;	// IMP=0x0000000000006fff
- (void)writeTo:(id)arg1;	// IMP=0x0000000000006f51
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000006f44
- (id)dictionaryRepresentation;	// IMP=0x0000000000006b52
- (id)description;	// IMP=0x0000000000006aa3
