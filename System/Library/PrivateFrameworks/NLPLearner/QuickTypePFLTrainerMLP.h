...
+ (id)reportingStringForModelUpdates:(float *)arg1 count:(unsigned long long)arg2;	// IMP=0x006000000000dcf1
+ (struct __CFData *)copyToFlatBuffer:(void *)arg1;	// IMP=0x006000000000dbf2
+ (void)initialize;	// IMP=0x006000000000dba4
- (id).cxx_construct;	// IMP=0x000000000000f6f6
- (void).cxx_destruct;	// IMP=0x000000000000f681
...
- (void)writeModelToURL:(id)arg1;	// IMP=0x000000000000f49e
- (id)getWeightUpdatesAddNoise:(_Bool)arg1 encryptionKey:(id)arg2 recipe:(id)arg3;	// IMP=0x000000000000eaba
- (_Bool)trainOn:(id)arg1 forNEpochs:(unsigned long long)arg2;	// IMP=0x000000000000e19b
- (id)initWithSeedModelPath:(id)arg1 andPrivacyIdentifier:(id)arg2;	// IMP=0x000000000000e01b
