...
+ (double)effectiveAspectRatioForSize:(struct CGSize)arg1;	// IMP=0x0010000000025c0e
- (void).cxx_destruct;	// IMP=0x00000000000280bf
...
- (id)finalLayoutAttributesForDisappearingItemAtIndexPath:(id)arg1;	// IMP=0x0000000000027d85
- (id)initialLayoutAttributesForAppearingItemAtIndexPath:(id)arg1;	// IMP=0x0000000000027c9f
- (void)finalizeCollectionViewUpdates;	// IMP=0x0000000000027c45
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x0000000000027969
- (_Bool)shouldInvalidateLayoutForBoundsChange:(struct CGRect)arg1;	// IMP=0x0000000000027961
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x00000000000277a3
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x00000000000276b1
- (struct CGSize)collectionViewContentSize;	// IMP=0x0000000000027683
- (void)updateLayoutCacheIfNecessary;	// IMP=0x0000000000026ead
- (void)prepareLayout;	// IMP=0x0000000000026e9b
- (struct CGPoint)targetContentOffsetForProposedContentOffset:(struct CGPoint)arg1 withScrollingVelocity:(struct CGPoint)arg2;	// IMP=0x0000000000026c52
- (void)setCurrentItem:(unsigned long long)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000026a5d
- (void)setContentOffsetForItem:(unsigned long long)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000026968
- (double)horizontalContentOffsetForItem:(unsigned long long)arg1;	// IMP=0x0000000000026847
- (double)horizontalContentOffsetAdjustmentForItem:(unsigned long long)arg1;	// IMP=0x00000000000266b6
- (void)invalidateLayoutWithContext:(id)arg1;	// IMP=0x00000000000262e4
- (void)setInterPageScrollPosition:(double)arg1;	// IMP=0x0000000000025e70
@property(readonly, nonatomic) double extraSpacingForCurrentItem;
- (struct CGSize)itemSizeForImageSize:(struct CGSize)arg1;	// IMP=0x0000000000025c40
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000025b3b
