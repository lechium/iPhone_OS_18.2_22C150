...
- (void)handleReturnedURL:(id)arg1;	// IMP=0x000000000002daf6
- (void)presentMarkupViewControllerFromView:(id)arg1;	// IMP=0x000000000002d730
- (void)dismissMarkupViewController;	// IMP=0x000000000002d662
- (void)markupDoneAction:(id)arg1;	// IMP=0x000000000002d433
- (void)markupCancelAction:(id)arg1;	// IMP=0x000000000002d421
- (void)presentMarkupFromView:(id)arg1;	// IMP=0x000000000002d40f
