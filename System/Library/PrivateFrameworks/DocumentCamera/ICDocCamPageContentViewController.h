...
+ (double)leadingTrailingOffset:(long long)arg1;	// IMP=0x0060000000028121
- (void).cxx_destruct;	// IMP=0x0000000000028362
...
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000282b9
- (void)didReceiveMemoryWarning;	// IMP=0x000000000002828a
- (void)handleSingleTap:(id)arg1;	// IMP=0x0000000000028231
- (void)viewDidLoad;	// IMP=0x000000000002812a
