...
- (void).cxx_destruct;	// IMP=0x000000000009df45
...
- (struct CGAffineTransform)transformFromCurrentVideoOrientationToOrientation:(long long)arg1;	// IMP=0x000000000009dbcb
- (double)angleOffsetFromPortraitOrientationToOrientation:(long long)arg1;	// IMP=0x000000000009dbab
- (void)removeFile:(id)arg1;	// IMP=0x000000000009da95
- (void)video:(id)arg1 didFinishSavingWithError:(id)arg2 contextInfo:(void *)arg3;	// IMP=0x000000000009d956
- (void)saveMovieToCameraRoll;	// IMP=0x000000000009d84b
- (void)resumeCaptureSessionForMovieRecording;	// IMP=0x000000000009d80e
- (void)pauseCaptureSessionForMovieRecording;	// IMP=0x000000000009d7d1
- (_Bool)inputsReadyToRecord;	// IMP=0x000000000009d798
- (void)stopRecording;	// IMP=0x000000000009d505
- (void)startRecording;	// IMP=0x000000000009d2f4
- (_Bool)setupAssetWriterMetadataInputAndMetadataAdaptor;	// IMP=0x000000000009cef9
- (_Bool)setupAssetWriterVideoInput:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x000000000009c9bb
- (_Bool)writeMetaDataAtFrame:(long long)arg1 intrinsicMatrix:(CDStruct_d80e62f2)arg2;	// IMP=0x000000000009c549
- (void)writeSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 ofType:(id)arg2 atFrame:(long long)arg3;	// IMP=0x000000000009c24b
- (void)recordingDidStop;	// IMP=0x000000000009c09a
- (void)recordingWillStop;	// IMP=0x000000000009bf83
- (void)recordingDidStart;	// IMP=0x000000000009beab
- (void)recordingWillStart;	// IMP=0x000000000009bcc5
- (void)recordFrame:(struct opaqueCMSampleBuffer *)arg1 fromConnection:(id)arg2;	// IMP=0x000000000009b975
- (id)initWithDelegate:(id)arg1 videoConnection:(id)arg2 referenceOrientation:(long long)arg3;	// IMP=0x000000000009b800
