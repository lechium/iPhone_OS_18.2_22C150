...
- (void).cxx_destruct;	// IMP=0x00000000000b0d03
...
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000000b0c2e
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000b0a55
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000b09eb
- (void)viewDidLoad;	// IMP=0x00000000000b08ea
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000b083a
