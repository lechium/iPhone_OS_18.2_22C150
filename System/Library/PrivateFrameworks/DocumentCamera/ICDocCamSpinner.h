...
- (void).cxx_destruct;	// IMP=0x000000000003ac20
...
- (void)hide;	// IMP=0x000000000003a7e9
- (void)show;	// IMP=0x000000000003a420
- (id)initWithView:(id)arg1 minimumDuration:(double)arg2;	// IMP=0x000000000003a1e3
