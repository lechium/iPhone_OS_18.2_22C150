...
- (_Bool)_canShowWhileLocked;	// IMP=0x000000000003a140
- (id)activityTypesThatInhibitPDFGeneration;	// IMP=0x000000000003a0d6
- (_Bool)writeGalleryPDFDataToPasteboardIfNecessaryForActivity:(id)arg1 documentInfoCollection:(id)arg2;	// IMP=0x0000000000039f6f
- (_Bool)inhibitPDFGenerationForActivityType:(id)arg1;	// IMP=0x0000000000039ecf
- (void)_performActivity:(id)arg1;	// IMP=0x0000000000039c72
