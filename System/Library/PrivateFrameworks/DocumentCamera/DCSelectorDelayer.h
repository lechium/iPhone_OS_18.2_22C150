...
- (void).cxx_destruct;	// IMP=0x000000000001d7c6
...
- (void)_cancelFireRequests;	// IMP=0x000000000001d695
- (void)cancelPreviousFireRequests;	// IMP=0x000000000001d60e
@property(readonly, nonatomic) _Bool isScheduledToFire;
- (void)callTargetSelector;	// IMP=0x000000000001d3c4
- (void)fireImmediately;	// IMP=0x000000000001d2c9
- (void)requestFire;	// IMP=0x000000000001cfae
- (void)dealloc;	// IMP=0x000000000001cf09
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 delay:(double)arg3 waitToFireUntilRequestsStop:(_Bool)arg4 callOnMainThread:(_Bool)arg5;	// IMP=0x000000000001cdf4
