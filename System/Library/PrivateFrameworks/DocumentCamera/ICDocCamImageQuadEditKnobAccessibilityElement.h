...
- (void).cxx_destruct;	// IMP=0x00000000000a7b09
...
- (struct CGRect)accessibilityFrame;	// IMP=0x00000000000a79e0
- (id)accessibilityHint;	// IMP=0x00000000000a79b6
- (id)accessibilityLabel;	// IMP=0x00000000000a7708
- (_Bool)accessibilityViewIsModal;	// IMP=0x00000000000a7700
- (_Bool)isAccessibilityElement;	// IMP=0x00000000000a76f8
- (id)initWithKnobLayer:(id)arg1 overlayView:(id)arg2;	// IMP=0x00000000000a765a
