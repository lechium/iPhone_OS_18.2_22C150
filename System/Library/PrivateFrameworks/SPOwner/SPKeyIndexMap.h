...
- (void).cxx_destruct;	// IMP=0x0000000000046eee
...
- (id)headerString;	// IMP=0x0000000000046e33
- (id)initWithBeaconIdentifier:(id)arg1 keySequence:(unsigned char)arg2 mapHandle:(CDStruct_e66c82b6 *)arg3;	// IMP=0x0000000000046db2
- (void)dealloc;	// IMP=0x0000000000046d78
- (id)init;	// IMP=0x0000000000046d4d
