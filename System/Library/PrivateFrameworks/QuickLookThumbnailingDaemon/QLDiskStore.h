...
+ (id)diskStores;	// IMP=0x006000000001960a
+ (id)diskStoreForURL:(id)arg1;	// IMP=0x0060000000019294
- (void).cxx_destruct;	// IMP=0x000000000001983c
...
- (void)executeBlock:(CDUnknownBlockType)arg1 onQueue:(id)arg2;	// IMP=0x000000000001947c
- (id)description;	// IMP=0x000000000001943d
- (id)initWithURL:(id)arg1;	// IMP=0x0000000000018e83
