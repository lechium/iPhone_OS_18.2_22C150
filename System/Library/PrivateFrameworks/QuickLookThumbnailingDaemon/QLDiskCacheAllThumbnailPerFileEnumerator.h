...
- (id)nextThumbnailData;	// IMP=0x0000000000018676
- (void)_createNewCacheIndexDatabaseEnumeratorWithFileIdentifier:(id)arg1;	// IMP=0x0000000000018590
- (id)initWithDiskCache:(id)arg1 fileIdentifier:(id)arg2;	// IMP=0x00000000000184eb
