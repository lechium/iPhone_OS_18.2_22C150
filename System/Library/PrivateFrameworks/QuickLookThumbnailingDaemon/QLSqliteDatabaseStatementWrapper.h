...
- (void).cxx_destruct;	// IMP=0x000000000000a851
@property(nonatomic) struct sqlite3_stmt *stmt; // @synthesize stmt=_stmt;
@property(copy, nonatomic) NSString *key; // @synthesize key=_key;
- (void)dealloc;	// IMP=0x000000000000a7f5
@property(nonatomic, getter=isInUse) _Bool inUse;
- (id)initWithStatement:(struct sqlite3_stmt *)arg1 key:(id)arg2 inUseTable:(id)arg3;	// IMP=0x000000000000a6d5
