...
- (void).cxx_destruct;	// IMP=0x0000000000010ad5
...
- (void)_invalidate;	// IMP=0x0000000000010977
- (void)invalidate;	// IMP=0x000000000001088e
- (id)remoteObjectProxy;	// IMP=0x000000000001083e
- (void)addFailureBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000105b1
- (id)initWithFMNSXPCConnection:(id)arg1;	// IMP=0x0000000000010513
