...
@class FMDFMIPAccountInfo, FMDLostModeInfo, FMDPairingCheckCommandRequestInfo, FMDPairingLockRegisterRequestInfo, FMDPairingLockUpdateRequestInfo, FMDRepairDeviceContext, FMDSecureLocationContext, NSData, NSDictionary, NSString;
...
- (void)disableLocationDisplayWithCompletion:(void (^)(NSError *))arg1;
- (void)requireDisableLocationWithCompletion:(void (^)(long long, NSError *))arg1;
...
- (oneway void)attemptUCRTHealing:(NSDictionary *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
