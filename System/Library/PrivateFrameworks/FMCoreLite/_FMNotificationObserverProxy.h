...
- (void).cxx_destruct;	// IMP=0x000000000000f237
...
- (void)invalidate;	// IMP=0x000000000000f169
- (void)performObserverBlock;	// IMP=0x000000000000f110
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000000eec5
