...
- (_Bool)isActionAllowed:(unsigned long long)arg1 forStore:(void *)arg2 inDatabase:(struct CalDatabase *)arg3;	// IMP=0x0000000000006377
- (id)initWithAllowedSourceIdentifiers:(id)arg1 databaseDataProvider:(id)arg2;	// IMP=0x00000000000062e4
