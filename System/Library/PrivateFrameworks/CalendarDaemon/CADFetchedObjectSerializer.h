...
- (void).cxx_destruct;	// IMP=0x00000000000512bc
...
- (id)_fetchedObjectDictionaryForEntity:(void *)arg1;	// IMP=0x0000000000050ff6
- (id)_properties:(id)arg1 forEntityIfNotSeen:(void *)arg2 objectExists:(_Bool *)arg3;	// IMP=0x00000000000508d1
@property(readonly, nonatomic) NSArray *fetchedObjectWrappers;
- (id)addEntity:(void *)arg1;	// IMP=0x000000000005055a
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2 relatedObjectPropertiesToLoad:(id)arg3;	// IMP=0x000000000005042a
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2;	// IMP=0x0000000000050415
