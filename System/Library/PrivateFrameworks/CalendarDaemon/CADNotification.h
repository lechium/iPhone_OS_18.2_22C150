...
- (void).cxx_destruct;	// IMP=0x000000000004aca8
...
- (void)addExpandedNotification:(id)arg1;	// IMP=0x000000000004abba
@property(readonly, nonatomic) NSArray *expandedNotifications;
@property(readonly, nonatomic) _Bool expanded;
- (id)initWithType:(int)arg1 objectID:(id)arg2 occurrenceDate:(double)arg3 expirationDate:(double)arg4;	// IMP=0x000000000004aafb
