...
- (void)deleteImportCookieDataForVolumeAtURL:(NSURL *)arg1 reply:(void (^)(_Bool))arg2;
...
- (void)setAdditionConflictResolvedInStorage:(long long)arg1 nameSpace:(NSString *)arg2 additionName:(NSString *)arg3 value:(_Bool)arg4 reply:(void (^)(_Bool, NSError *))arg5;
