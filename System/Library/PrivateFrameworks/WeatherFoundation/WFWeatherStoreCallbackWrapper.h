...
- (void).cxx_destruct;	// IMP=0x000000000002bcf7
...
- (void)executeCallbackwithResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000002bab4
- (id)initWithAQIScaleRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002ba34
- (id)initWithForecastRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002b9bc
