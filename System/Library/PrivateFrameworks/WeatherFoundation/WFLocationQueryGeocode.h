...
+ (id)queryWithSearchString:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000bc05
+ (void)invalidateCaches;	// IMP=0x001000000000bb03
+ (id)queryWithSearchCompletion:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000ba8d
+ (id)queryWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000ba01
+ (id)queryWithDictionaryRepresentation:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000b6ad
- (void).cxx_destruct;	// IMP=0x000000000000d41e
...
- (void)_handleErrorResponse:(id)arg1;	// IMP=0x000000000000d109
- (void)handleSearchResponseWithLocation:(id)arg1;	// IMP=0x000000000000cf5d
- (id)_reverseGeocoderLocation;	// IMP=0x000000000000cedb
- (id)_mkLocalSearchRequest;	// IMP=0x000000000000cde1
- (_Bool)isLocationValid:(id)arg1;	// IMP=0x000000000000cc3d
- (void)_startCLGeocoderReverseGeo;	// IMP=0x000000000000c57f
- (void)_startMKLocalSearch;	// IMP=0x000000000000c00c
- (void)cancel;	// IMP=0x000000000000bf93
- (void)start;	// IMP=0x000000000000bec9
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000bdb7
- (id)initWithSearchString:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000bc7b
- (id)initWithSearchCompletion:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000bb09
