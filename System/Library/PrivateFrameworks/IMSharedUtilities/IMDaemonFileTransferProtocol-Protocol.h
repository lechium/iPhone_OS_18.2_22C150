...
- (void)successfullyGeneratedPreviewForTransfer:(NSString *)arg1 withPreviewSize:(struct CGSize)arg2;
- (void)successfullyGeneratedPreviewForTransfer:(NSString *)arg1;
- (void)failTransferPreviewGeneration:(NSString *)arg1;
