...
- (void)leaveChatID:(NSString *)arg1 style:(unsigned char)arg2 account:(NSString *)arg3;
- (void)declineInvitationToChatID:(NSString *)arg1 identifier:(NSString *)arg2 style:(unsigned char)arg3 account:(NSString *)arg4;
- (void)closeSessionChatID:(NSString *)arg1 identifier:(NSString *)arg2 didDeleteConversation:(_Bool)arg3 style:(unsigned char)arg4 account:(NSString *)arg5;
- (void)markChatsAsReadFilteredUsingPredicate:(NSPredicate *)arg1;
...
- (void)chat:(NSString *)arg1 updateDisplayName:(NSString *)arg2 messageID:(NSString *)arg3;
...
- (void)markRepliedForMessageGUID:(NSString *)arg1;
