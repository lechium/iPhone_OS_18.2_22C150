...
- (_Bool)closeWithError:(id *)arg1;	// IMP=0x0000000000006707
- (_Bool)processData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000000647d
- (_Bool)writeDataToDelegate:(id)arg1 withError:(id *)arg2;	// IMP=0x000000000000623d
- (id)init;	// IMP=0x00000000000061d7
