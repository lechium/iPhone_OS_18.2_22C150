...
- (void).cxx_destruct;	// IMP=0x0000000000bf17f0
- (id)init;	// IMP=0x0000000000bf1790
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000bf1640
