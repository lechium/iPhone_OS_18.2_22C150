...
- (void).cxx_destruct;	// IMP=0x0000000000c0a8b0
- (id)init;	// IMP=0x0000000000c0a7f0
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000c0a760
