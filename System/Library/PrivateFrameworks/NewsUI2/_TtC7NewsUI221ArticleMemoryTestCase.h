...
- (void).cxx_destruct;	// IMP=0x000000000045ecf0
- (id)init;	// IMP=0x000000000045ec40
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000045ea80
