...
- (void).cxx_destruct;	// IMP=0x0000000000bdc880
- (id)init;	// IMP=0x0000000000bdc820
- (void)runTestWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000bdc790
