...
+ (id)readOpaqueTokenFromBuffer:(const char *)arg1;	// IMP=0x00600000000f7d5b
+ (id)readTokenFromBuffer:(const char *)arg1;	// IMP=0x00600000000f7d40
+ (id)readTokenFromBuffer:(const char *)arg1 opaque:(_Bool)arg2;	// IMP=0x00600000000f7c02
...
- (id)description;	// IMP=0x00000000000f7d79
- (id)_initWithID:(unsigned long long)arg1 class:(unsigned char)arg2 length:(unsigned long long)arg3 content:(const char *)arg4 opaque:(_Bool)arg5;	// IMP=0x00000000000f7ba4
