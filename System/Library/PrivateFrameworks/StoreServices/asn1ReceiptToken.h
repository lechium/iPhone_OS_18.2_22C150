...
+ (id)readFromBuffer:(const char *)arg1;	// IMP=0x0060000000170618
...
- (id)description;	// IMP=0x00000000001707ec
- (void)dealloc;	// IMP=0x00000000001705dd
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x0000000000170574
