...
- (id)_errorMessageForFailureReason:(id)arg1 failingURLString:(id)arg2 providerName:(id)arg3 networkName:(id)arg4 isUsingEthernetNetwork:(_Bool)arg5;	// IMP=0x00300000000be0aa
- (void)fetchLocalNetworkContentFilteringErrorMessageForFailingURLString:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00300000000bda97
- (id)computeLocalNetworkContentFilteringErrorTitle;	// IMP=0x00300000000bd8e5
