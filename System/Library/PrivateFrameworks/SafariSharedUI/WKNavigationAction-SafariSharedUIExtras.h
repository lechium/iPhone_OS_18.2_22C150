...
@property(readonly, nonatomic) _Bool safari_shouldProhibitNavigationToSafariSpecificURL;
...
- (_Bool)safari_isEligibleForContinuedTranslationWithPolicy:(long long)arg1;	// IMP=0x00300000000e3048
@end
