...
- (void)isComputeSyncEnabledForDirection:(long long)arg1 reply:(void (^)(_Bool, NSString *))arg2;
- (void)runComputeSyncBackfillMigrationSynchronously;
- (void)setPrefetchMode:(long long)arg1 reply:(void (^)(_Bool, NSError *))arg2;
- (void)getCPLSettingsWithReply:(void (^)(PLCPLSettings *))arg1;
...
- (void)isReadyForAnalysisCPLInitialDownloadCompletedWithReply:(void (^)(_Bool))arg1;
