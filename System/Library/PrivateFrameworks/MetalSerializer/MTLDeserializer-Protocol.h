...
- (void)submitCommandSegments:(void **)arg1 lengths:(unsigned long long *)arg2 count:(unsigned long long)arg3 submissionCompleted:(void (^)(id <MTLCommandBuffer>, NSException *))arg4 commandBufferCompleted:(void (^)(id <MTLCommandBuffer>, NSException *))arg5 commandQueueRef:(unsigned int)arg6;
