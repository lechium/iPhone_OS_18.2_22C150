...
- (void).cxx_destruct;	// IMP=0x000000000005b3c0
...
- (void)switchToggled:(id)arg1;	// IMP=0x000000000005b22e
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000005afbf
