...
- (void).cxx_destruct;	// IMP=0x0000000000085cb9
...
- (void)viewTapped:(id)arg1;	// IMP=0x0000000000085b51
- (void)_setupAccessibility;	// IMP=0x00000000000859e8
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000008596c
- (void)mediaPause;	// IMP=0x0000000000085893
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000084c6e
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000084b7e
- (void)viewWillLayoutSubviews;	// IMP=0x000000000008421f
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x000000000008419a
- (void)loadView;	// IMP=0x0000000000083d5d
- (void)dealloc;	// IMP=0x0000000000083c9b
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000082dc6
