...
- (void).cxx_destruct;	// IMP=0x0000000000097e6c
...
- (id)loadPage;	// IMP=0x000000000009779e
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000009772d
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000097153
