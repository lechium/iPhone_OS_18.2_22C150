...
- (id)_createLabelWithLines:(long long)arg1 title:(_Bool)arg2;	// IMP=0x0000000000096f8f
- (id)_createButtonWithTarget:(id)arg1 selector:(SEL)arg2;	// IMP=0x0000000000096dd6
- (void)_bottomLinkSelected:(id)arg1;	// IMP=0x0000000000096d91
- (void)layoutSubviews;	// IMP=0x000000000009687e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000966b3
