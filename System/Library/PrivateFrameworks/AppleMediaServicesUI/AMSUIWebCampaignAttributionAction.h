...
+ (id)_campaignAttributionTaskForURL:(id)arg1;	// IMP=0x006000000009a7af
...
- (id)runAction;	// IMP=0x0000000000099da5
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000998e4
