...
- (void).cxx_destruct;	// IMP=0x00000000000b0dde
...
- (void)_runWithType:(long long)arg1 options:(id)arg2;	// IMP=0x00000000000b095e
- (id)runAction;	// IMP=0x00000000000b0533
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000aff2f
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000afeec
