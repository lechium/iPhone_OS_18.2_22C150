...
+ (id)_authenticationTypeFromStringedType:(id)arg1;	// IMP=0x00100000000de26f
+ (long long)_serviceTypeFromType:(long long)arg1;	// IMP=0x00100000000de114
...
- (id)runAction;	// IMP=0x00000000000ddc12
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000dd3e9
