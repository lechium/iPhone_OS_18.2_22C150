...
+ (id)timeoutWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00600000000b564d
- (void).cxx_destruct;	// IMP=0x00000000000b5eae
...
- (void)reset;	// IMP=0x00000000000b5cec
- (void)pause;	// IMP=0x00000000000b5abd
- (void)start;	// IMP=0x00000000000b56d5
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b5590
