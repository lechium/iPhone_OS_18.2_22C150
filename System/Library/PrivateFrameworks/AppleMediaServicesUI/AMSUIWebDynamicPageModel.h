...
- (void).cxx_destruct;	// IMP=0x00000000000a54f1
...
- (id)loadPage;	// IMP=0x00000000000a5050
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000a4ebb
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000a4b15
