...
- (void).cxx_destruct;	// IMP=0x0000000000012091
...
- (id)_serviceContextWithResults:(id)arg1 parentViewController:(id)arg2;	// IMP=0x0000000000011c89
- (id)performAuthenticate;	// IMP=0x0000000000011499
- (id)initWithAuthRequest:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x00000000000113f7
