...
@class NSError, NSString, NSURL, PKAccountServicePaymentMethod, PKApplePayTrustSignature, PKAuthorizedPeerPaymentQuote, PKPaymentAuthorizationController, PKServiceProviderPurchase;
...
- (void)paymentAuthorizationController:(PKPaymentAuthorizationController *)arg1 didRequestMerchantSessionWithURL:(NSURL *)arg2 merchantSessionUpdate:(void (^)(PKPaymentRequestMerchantSessionUpdate *))arg3;
@end
