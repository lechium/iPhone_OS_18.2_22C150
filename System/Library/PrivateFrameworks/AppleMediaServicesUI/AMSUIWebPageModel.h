...
- (void).cxx_destruct;	// IMP=0x00000000000ccba5
...
- (id)loadPage;	// IMP=0x00000000000cc802
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000cc7aa
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000cc493
