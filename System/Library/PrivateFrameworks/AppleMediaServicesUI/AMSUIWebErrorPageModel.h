...
+ (id)_messageFromError:(id)arg1;	// IMP=0x00100000000a72dd
- (void).cxx_destruct;	// IMP=0x00000000000a75dc
...
- (id)loadPage;	// IMP=0x00000000000a72c4
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000a7253
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *errorMessage; // @synthesize errorMessage=_errorMessage;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000a6a29
- (id)initWithError:(id)arg1 context:(id)arg2 actionBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000a66c6
