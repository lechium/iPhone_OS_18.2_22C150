...
- (void).cxx_destruct;	// IMP=0x000000000006de90
...
- (void)dismissViewControllerAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000006dcd1
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000006dc30
- (void)loadView;	// IMP=0x000000000006db9b
- (void)_setup;	// IMP=0x000000000006db16
- (id)initWithPaymentSetupRequest:(id)arg1;	// IMP=0x000000000006da98
