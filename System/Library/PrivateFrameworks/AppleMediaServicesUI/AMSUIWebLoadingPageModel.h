...
- (void).cxx_destruct;	// IMP=0x00000000000c070f
...
- (id)loadPage;	// IMP=0x00000000000c066e
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000c05db
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000bfff7
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000bff8c
