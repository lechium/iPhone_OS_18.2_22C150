...
- (void).cxx_destruct;	// IMP=0x000000000009162e
...
- (id)_imageForButtonWithNavStyle:(long long)arg1;	// IMP=0x00000000000913f3
@property(readonly, copy) NSString *description;
- (id)createDialogAction;	// IMP=0x0000000000091247
- (id)_makeProxCardButtonWithActionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000091152
- (id)_makeActivityIndicatorView;	// IMP=0x00000000000910bd
- (long long)_barButtonItemStyle;	// IMP=0x00000000000910a4
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000090b9d
