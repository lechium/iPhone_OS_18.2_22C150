...
- (void).cxx_destruct;	// IMP=0x00000000000d497d
...
- (id)loadPage;	// IMP=0x00000000000d4834
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000d4676
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000d3d31
