...
- (void).cxx_destruct;	// IMP=0x000000000008d8a2
...
- (id)_responseForAccount:(id)arg1;	// IMP=0x000000000008d6af
- (void)_updateContextWithAccountIfNeeded:(id)arg1;	// IMP=0x000000000008d582
- (id)runAction;	// IMP=0x000000000008ceaa
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000008c302
