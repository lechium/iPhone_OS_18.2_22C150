...
- (id)initWithPropertiesByName:(id)arg1;	// IMP=0x000000000013c590
- (id)initWithBackingStore:(id)arg1;	// IMP=0x000000000013c340
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000013c1c0
- (id)init;	// IMP=0x000000000013c050
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x000000000013bf30
