...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001243c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000123b4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001227e
@property(readonly, copy, nonatomic) NSString *extraPreviewText;
@property(readonly, nonatomic) long long type;
- (id)initWithInvalidDataType:(long long)arg1 invalidContents:(id)arg2;	// IMP=0x00000000000121dd
