...
- (void).cxx_destruct;	// IMP=0x0000000000df19c8
- (unsigned long long)hash;	// IMP=0x0000000000df1557
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000df12c4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000df0e5e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000df09d8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000df09c9
- (id)jsonRepresentation;	// IMP=0x0000000000defaf3
- (id)dictionaryRepresentation;	// IMP=0x0000000000def256
- (id)description;	// IMP=0x0000000000def1a7
- (id)initWithData:(id)arg1;	// IMP=0x0000000000dedba0
- (id)init;	// IMP=0x0000000000dedb44
