...
- (void).cxx_destruct;	// IMP=0x000000000065488d
...
- (id)initWithCoordinate:(CDStruct_071ac149)arg1 angle:(double)arg2 road:(id)arg3 startCoordinate:(CDStruct_071ac149)arg4 endCoordinate:(CDStruct_071ac149)arg5 penalties:(id)arg6;	// IMP=0x00000000006542c0
- (id)init;	// IMP=0x000000000065427c
