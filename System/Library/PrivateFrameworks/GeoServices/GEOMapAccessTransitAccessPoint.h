...
- (id).cxx_construct;	// IMP=0x0000000000277451
- (void).cxx_destruct;	// IMP=0x0000000000277420
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000027739e
- (id)findStation:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002771b2
- (id)findStops:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002771aa
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000277166
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x00000000002770e3
...
- (id)initWithMap:(id)arg1 accessPoint:(shared_ptr_4792c490)arg2;	// IMP=0x0000000000276f60
