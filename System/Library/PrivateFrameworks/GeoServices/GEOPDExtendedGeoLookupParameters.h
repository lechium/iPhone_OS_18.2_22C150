...
- (void).cxx_destruct;	// IMP=0x000000000047f070
- (unsigned long long)hash;	// IMP=0x000000000047ef27
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000047ed17
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000047ea7e
- (void)writeTo:(id)arg1;	// IMP=0x000000000047e742
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000047e733
- (id)jsonRepresentation;	// IMP=0x000000000047e31c
- (id)dictionaryRepresentation;	// IMP=0x000000000047dc48
- (id)description;	// IMP=0x000000000047db99
- (void)dealloc;	// IMP=0x000000000047cafa
- (id)initWithData:(id)arg1;	// IMP=0x000000000047ca9e
- (id)init;	// IMP=0x000000000047ca42
