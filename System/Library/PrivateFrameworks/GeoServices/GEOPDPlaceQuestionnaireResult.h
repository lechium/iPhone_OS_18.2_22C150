...
- (void).cxx_destruct;	// IMP=0x00000000014aa15d
- (unsigned long long)hash;	// IMP=0x00000000014a9a7c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000014a984c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000014a945d
- (void)writeTo:(id)arg1;	// IMP=0x00000000014a8e77
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000014a8e68
- (id)jsonRepresentation;	// IMP=0x00000000014a6f98
- (id)dictionaryRepresentation;	// IMP=0x00000000014a688c
- (id)description;	// IMP=0x00000000014a67dd
- (id)initWithData:(id)arg1;	// IMP=0x00000000014a581a
- (id)init;	// IMP=0x00000000014a57be
