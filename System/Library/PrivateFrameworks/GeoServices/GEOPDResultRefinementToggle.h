...
- (void).cxx_destruct;	// IMP=0x0000000000e2a515
- (unsigned long long)hash;	// IMP=0x0000000000e2a3e7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e2a1fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e29f8a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e29c87
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e29c78
- (id)jsonRepresentation;	// IMP=0x0000000000e291cd
- (id)dictionaryRepresentation;	// IMP=0x0000000000e28cd9
- (id)description;	// IMP=0x0000000000e28c2a
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e27e88
- (id)init;	// IMP=0x0000000000e27e2c
