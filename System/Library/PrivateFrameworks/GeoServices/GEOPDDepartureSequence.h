...
- (void).cxx_destruct;	// IMP=0x0000000000bee720
- (unsigned long long)hash;	// IMP=0x0000000000bee2be
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bee028
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000beda48
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bed333
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bed324
- (id)jsonRepresentation;	// IMP=0x0000000000bebaf4
- (id)dictionaryRepresentation;	// IMP=0x0000000000beb016
- (id)description;	// IMP=0x0000000000beaf67
- (void)dealloc;	// IMP=0x0000000000be9496
- (id)initWithData:(id)arg1;	// IMP=0x0000000000be943a
- (id)init;	// IMP=0x0000000000be93de
