...
- (void).cxx_destruct;	// IMP=0x0000000000ac71ba
- (unsigned long long)hash;	// IMP=0x0000000000ac6ed2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ac6b77
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ac6509
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ac5eec
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ac5edd
- (id)jsonRepresentation;	// IMP=0x0000000000ac5995
- (id)dictionaryRepresentation;	// IMP=0x0000000000ac4cc2
- (id)description;	// IMP=0x0000000000ac4c13
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ac39a0
- (id)init;	// IMP=0x0000000000ac3944
