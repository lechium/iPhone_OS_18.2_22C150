...
- (void).cxx_destruct;	// IMP=0x00000000007082e4
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000707ecd
@property(readonly, nonatomic) NSData *metadata;
@property(readonly, nonatomic) NSData *entryMetadata;
- (void)sendFeedback;	// IMP=0x0000000000707eb7
- (_Bool)getCoordinate:(CDStruct_c3b9c2ee *)arg1;	// IMP=0x0000000000707d4b
...
- (id)calloutTitle;	// IMP=0x00000000007079b4
- (id)queryLine;	// IMP=0x0000000000707896
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x0000000000707847
- (id)initWithEntry:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 entryIndex:(int)arg4 mapItems:(id)arg5 collections:(id)arg6 publishers:(id)arg7;	// IMP=0x0000000000705dc0
