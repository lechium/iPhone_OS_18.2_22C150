...
- (void).cxx_destruct;	// IMP=0x000000000142b4d2
- (unsigned long long)hash;	// IMP=0x000000000142b3fb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000142b298
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000142b073
- (void)writeTo:(id)arg1;	// IMP=0x000000000142ad68
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000142ad59
- (id)jsonRepresentation;	// IMP=0x000000000142a9ec
- (id)dictionaryRepresentation;	// IMP=0x000000000142a46e
- (id)description;	// IMP=0x000000000142a3bf
- (void)dealloc;	// IMP=0x000000000142974f
- (id)initWithData:(id)arg1;	// IMP=0x00000000014296f3
- (id)init;	// IMP=0x0000000001429697
