...
- (void).cxx_destruct;	// IMP=0x0000000000d9edcf
- (unsigned long long)hash;	// IMP=0x0000000000d9eb9c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d9e84c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d9e4fa
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d9df49
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d9df3c
- (id)jsonRepresentation;	// IMP=0x0000000000d9dc8d
- (id)dictionaryRepresentation;	// IMP=0x0000000000d9d566
- (id)description;	// IMP=0x0000000000d9d4b7
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d9c300
- (id)init;	// IMP=0x0000000000d9c2a4
