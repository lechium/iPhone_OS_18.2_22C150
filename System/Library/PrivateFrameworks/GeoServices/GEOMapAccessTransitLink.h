...
- (id).cxx_construct;	// IMP=0x0000000000277c0c
- (void).cxx_destruct;	// IMP=0x0000000000277bb2
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1 outClosestCoordinateOnLine:(CDStruct_c3b9c2ee *)arg2;	// IMP=0x000000000027792d
...
- (id)initWithMap:(id)arg1 transitEdge:(shared_ptr_24ebf3c0)arg2;	// IMP=0x0000000000277461
