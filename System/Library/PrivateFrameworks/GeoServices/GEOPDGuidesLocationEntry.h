...
- (void).cxx_destruct;	// IMP=0x0000000000c36db8
- (unsigned long long)hash;	// IMP=0x0000000000c36cca
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c36b23
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c368b4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c365b8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c365a9
- (id)jsonRepresentation;	// IMP=0x0000000000c35868
- (id)dictionaryRepresentation;	// IMP=0x0000000000c353b7
- (id)description;	// IMP=0x0000000000c35308
- (void)dealloc;	// IMP=0x0000000000c34151
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c340f5
- (id)init;	// IMP=0x0000000000c34099
