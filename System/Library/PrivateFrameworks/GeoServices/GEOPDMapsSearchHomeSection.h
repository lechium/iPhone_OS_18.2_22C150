...
- (void).cxx_destruct;	// IMP=0x00000000004b6f7c
- (unsigned long long)hash;	// IMP=0x00000000004b6d46
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004b6b91
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004b6904
- (void)writeTo:(id)arg1;	// IMP=0x00000000004b6637
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004b6628
- (id)jsonRepresentation;	// IMP=0x00000000004b60c4
- (id)dictionaryRepresentation;	// IMP=0x00000000004b5c04
- (id)description;	// IMP=0x00000000004b5b55
- (id)initWithData:(id)arg1;	// IMP=0x00000000004b4c0c
- (id)init;	// IMP=0x00000000004b4bb0
