...
+ (id)businessHoursForPlaceData:(id)arg1;	// IMP=0x0010000000a04863
- (void).cxx_destruct;	// IMP=0x0000000000b4cb2a
- (unsigned long long)hash;	// IMP=0x0000000000b4c808
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b4c651
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b4c277
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b4bd6e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b4bd5f
- (id)jsonRepresentation;	// IMP=0x0000000000b4ab42
- (id)dictionaryRepresentation;	// IMP=0x0000000000b4a3fd
- (id)description;	// IMP=0x0000000000b4a34e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b494ec
- (id)init;	// IMP=0x0000000000b49490
