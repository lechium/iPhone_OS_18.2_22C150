...
- (void).cxx_destruct;	// IMP=0x000000000033c520
- (unsigned long long)hash;	// IMP=0x000000000033bb84
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000033b7b7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000033b41e
- (void)writeTo:(id)arg1;	// IMP=0x000000000033b08f
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000033b082
- (id)jsonRepresentation;	// IMP=0x000000000033ade9
- (id)dictionaryRepresentation;	// IMP=0x000000000033a403
- (id)description;	// IMP=0x000000000033a354
- (id)initWithData:(id)arg1;	// IMP=0x0000000000339530
- (id)init;	// IMP=0x00000000003394d4
