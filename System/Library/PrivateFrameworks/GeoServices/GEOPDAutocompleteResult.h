...
- (void).cxx_destruct;	// IMP=0x0000000000447ce5
- (unsigned long long)hash;	// IMP=0x0000000000447a6d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000447692
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000446f89
- (void)writeTo:(id)arg1;	// IMP=0x0000000000446161
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000446152
- (id)jsonRepresentation;	// IMP=0x00000000004429d5
- (id)dictionaryRepresentation;	// IMP=0x0000000000441aa0
- (id)description;	// IMP=0x00000000004419f1
- (id)initWithData:(id)arg1;	// IMP=0x0000000000440012
- (id)init;	// IMP=0x000000000043ffb6
