...
- (void).cxx_destruct;	// IMP=0x0000000000e4d2b1
- (unsigned long long)hash;	// IMP=0x0000000000e4ce99
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e4cb4e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e4c5ed
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e4c08f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e4c080
- (id)jsonRepresentation;	// IMP=0x0000000000e4a2ea
- (id)dictionaryRepresentation;	// IMP=0x0000000000e49954
- (id)description;	// IMP=0x0000000000e498a5
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e47f11
- (id)init;	// IMP=0x0000000000e47eb5
