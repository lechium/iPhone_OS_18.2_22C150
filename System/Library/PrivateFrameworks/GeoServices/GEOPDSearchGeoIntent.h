...
- (void).cxx_destruct;	// IMP=0x0000000000a7b9d5
- (unsigned long long)hash;	// IMP=0x0000000000a7b86c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a7b605
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a7b2f5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a7aff3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a7afe4
- (id)jsonRepresentation;	// IMP=0x0000000000a7ace0
- (id)dictionaryRepresentation;	// IMP=0x0000000000a7a504
- (id)description;	// IMP=0x0000000000a7a455
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a79756
- (id)init;	// IMP=0x0000000000a796fa
