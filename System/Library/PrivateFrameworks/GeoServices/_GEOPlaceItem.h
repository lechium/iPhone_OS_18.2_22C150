...
- (void).cxx_destruct;	// IMP=0x00000000007fee54
...
- (id)_placecardLayoutConfiguration;	// IMP=0x00000000007fee2c
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x00000000007fee24
...
- (id)_businessClaim;	// IMP=0x00000000007fedd4
- (_Bool)_hasBusinessClaim;	// IMP=0x00000000007fedcc
- (id)_mapItemByStrippingOptionalData;	// IMP=0x00000000007fedc3
@property(readonly, nonatomic, getter=_photos) NSArray *photos;
@property(readonly, nonatomic, getter=_reviews) NSArray *reviews;
- (id)_asPlaceInfo;	// IMP=0x00000000007fed6b
...
- (id)_yelpID;	// IMP=0x00000000007feb0a
...
- (id)_urlForWritingAReview;	// IMP=0x00000000007feaf2
- (id)_urlForReview:(id)arg1;	// IMP=0x00000000007feaea
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x00000000007feae2
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x00000000007fea5f
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x00000000007fea57
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x00000000007fe6ba
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x00000000007fe678
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x00000000007fe636
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x00000000007fe619
- (int)_recommendedTransportType;	// IMP=0x00000000007fe60e
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x00000000007fe5f1
...
- (id)weatherDisplayName;	// IMP=0x00000000007fe549
- (id)addressObject;	// IMP=0x00000000007fe496
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x00000000007fded9
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x00000000007fde1e
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x00000000007fdc3c
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x00000000007fdb63
