...
+ (id)_etaFilterWithTransportTypes:(int *)arg1 transportTypesCount:(unsigned long long)arg2 automobileOptions:(id)arg3 transitOptions:(id)arg4 walkingOptions:(id)arg5 cyclingOptions:(id)arg6;	// IMP=0x0010000000a05ca5
+ (id)etaFilterForRouteAttributes:(id)arg1;	// IMP=0x0010000000a05a7a
+ (id)etaFilterForTraits:(id)arg1;	// IMP=0x0010000000a05854
- (void).cxx_destruct;	// IMP=0x0000000000bf9d2c
- (unsigned long long)hash;	// IMP=0x0000000000bf9be2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bf99b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bf96fe
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bf9342
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bf9333
- (id)jsonRepresentation;	// IMP=0x0000000000bf871c
- (id)dictionaryRepresentation;	// IMP=0x0000000000bf7ef0
- (id)description;	// IMP=0x0000000000bf7e41
- (void)dealloc;	// IMP=0x0000000000bf6c56
- (id)initWithData:(id)arg1;	// IMP=0x0000000000bf6bfa
- (id)init;	// IMP=0x0000000000bf6b9e
