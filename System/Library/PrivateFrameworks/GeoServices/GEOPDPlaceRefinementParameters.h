...
- (void).cxx_destruct;	// IMP=0x00000000005053b8
- (unsigned long long)hash;	// IMP=0x0000000000504f26
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000504cbe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000504841
- (void)writeTo:(id)arg1;	// IMP=0x000000000050434b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000050433c
- (id)jsonRepresentation;	// IMP=0x0000000000502f70
- (id)dictionaryRepresentation;	// IMP=0x00000000005026e6
- (id)description;	// IMP=0x0000000000502637
- (id)initWithData:(id)arg1;	// IMP=0x00000000005011ee
- (id)init;	// IMP=0x0000000000501192
- (_Bool)_routeHypothesisPlaceRefinementParametersIsEqual:(id)arg1;	// IMP=0x000000000118b287
- (unsigned long long)_routeHypothesisPlaceRefinementParametersHash;	// IMP=0x000000000118b21b
- (_Bool)_hasRequiredFields;	// IMP=0x000000000118b1ef
- (id)initWithSearchURLQuery:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000001401562
- (id)initWithMapItemToRefine:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2;	// IMP=0x00000000014012c5
- (id)initWithIdentifier:(id)arg1 placeNameHint:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x000000000140109f
