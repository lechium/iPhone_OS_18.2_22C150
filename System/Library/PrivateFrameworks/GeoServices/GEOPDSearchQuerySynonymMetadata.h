...
- (void).cxx_destruct;	// IMP=0x0000000000acb622
- (unsigned long long)hash;	// IMP=0x0000000000acb332
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000acafb6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aca89e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aca210
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aca201
- (id)jsonRepresentation;	// IMP=0x0000000000ac8fb5
- (id)dictionaryRepresentation;	// IMP=0x0000000000ac84c6
- (id)description;	// IMP=0x0000000000ac8417
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ac727a
- (id)init;	// IMP=0x0000000000ac721e
