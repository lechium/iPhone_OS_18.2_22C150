...
- (void).cxx_destruct;	// IMP=0x0000000000be24e9
- (unsigned long long)hash;	// IMP=0x0000000000be1f62
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000be1dda
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000be1b78
- (void)writeTo:(id)arg1;	// IMP=0x0000000000be1807
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000be17f8
- (id)jsonRepresentation;	// IMP=0x0000000000bdfbf9
- (id)dictionaryRepresentation;	// IMP=0x0000000000bdf78c
- (id)description;	// IMP=0x0000000000bdf6dd
- (id)initWithData:(id)arg1;	// IMP=0x0000000000bde8ef
- (id)init;	// IMP=0x0000000000bde893
- (id)locationName;	// IMP=0x0000000000a042c9
- (id)categoryName;	// IMP=0x0000000000a0424e
