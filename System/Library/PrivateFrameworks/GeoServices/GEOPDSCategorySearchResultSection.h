...
- (void).cxx_destruct;	// IMP=0x00000000005f09e9
- (unsigned long long)hash;	// IMP=0x00000000005f07ab
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005f0656
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005f0415
- (void)writeTo:(id)arg1;	// IMP=0x00000000005f01b3
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005f01a4
- (id)jsonRepresentation;	// IMP=0x00000000005ef814
- (id)dictionaryRepresentation;	// IMP=0x00000000005ef416
- (id)description;	// IMP=0x00000000005ef367
- (id)initWithData:(id)arg1;	// IMP=0x00000000005ee766
- (id)init;	// IMP=0x00000000005ee70a
