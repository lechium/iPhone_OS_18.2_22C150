...
- (void).cxx_destruct;	// IMP=0x00000000004c174b
- (unsigned long long)hash;	// IMP=0x00000000004c15f9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004c144f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004c11e0
- (void)writeTo:(id)arg1;	// IMP=0x00000000004c0f7d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004c0f6e
- (id)jsonRepresentation;	// IMP=0x00000000004c0a42
- (id)dictionaryRepresentation;	// IMP=0x00000000004c02a7
- (id)description;	// IMP=0x00000000004c01f8
- (id)initWithData:(id)arg1;	// IMP=0x00000000004bf8d4
- (id)init;	// IMP=0x00000000004bf878
