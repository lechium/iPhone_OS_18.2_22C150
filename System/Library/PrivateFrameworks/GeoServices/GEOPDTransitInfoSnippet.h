...
+ (id)transitInfoSnippetForPlaceData:(id)arg1;	// IMP=0x00100000009fbf2a
- (void).cxx_destruct;	// IMP=0x0000000000d14f8b
- (unsigned long long)hash;	// IMP=0x0000000000d14e2f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d14be8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d14592
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d13f3e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d13f2f
- (id)jsonRepresentation;	// IMP=0x0000000000d12e85
- (id)dictionaryRepresentation;	// IMP=0x0000000000d125bb
- (id)description;	// IMP=0x0000000000d1250c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d10f0a
- (id)init;	// IMP=0x0000000000d10eae
