...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000011baadb
- (void).cxx_destruct;	// IMP=0x00000000011baca7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000011bac07
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011baae3
...
- (id)initWithLine:(id)arg1 system:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x00000000011ba5f9
