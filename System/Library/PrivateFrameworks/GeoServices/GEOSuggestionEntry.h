...
- (void).cxx_destruct;	// IMP=0x0000000001013f5c
- (unsigned long long)hash;	// IMP=0x0000000001013e50
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001013c76
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001013742
- (void)writeTo:(id)arg1;	// IMP=0x0000000001013252
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000001013243
- (id)jsonRepresentation;	// IMP=0x0000000001012d81
- (id)dictionaryRepresentation;	// IMP=0x00000000010123b7
- (id)description;	// IMP=0x0000000001012308
- (void)dealloc;	// IMP=0x000000000101149a
- (id)initWithData:(id)arg1;	// IMP=0x000000000101143e
- (id)init;	// IMP=0x00000000010113e2
