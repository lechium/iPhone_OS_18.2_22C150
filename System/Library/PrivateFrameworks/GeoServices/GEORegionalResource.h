...
- (void).cxx_destruct;	// IMP=0x000000000068f8ff
- (unsigned long long)hash;	// IMP=0x000000000068f7fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000068f63d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000068f087
- (void)writeTo:(id)arg1;	// IMP=0x000000000068eb5a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000068eb4b
- (id)jsonRepresentation;	// IMP=0x000000000068e68c
- (id)dictionaryRepresentation;	// IMP=0x000000000068e061
- (id)description;	// IMP=0x000000000068dfb2
- (void)dealloc;	// IMP=0x000000000068d117
- (id)initWithData:(id)arg1;	// IMP=0x000000000068d0bb
- (id)init;	// IMP=0x000000000068d05f
