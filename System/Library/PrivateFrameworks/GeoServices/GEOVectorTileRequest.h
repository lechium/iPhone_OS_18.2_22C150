...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000eb057f
- (void).cxx_destruct;	// IMP=0x0000000000eb1df4
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000eb1bd8
- (unsigned long long)hash;	// IMP=0x0000000000eb17d4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000eb143a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000eb10e5
- (void)copyTo:(id)arg1;	// IMP=0x0000000000eb0e7b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000eb0b0d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000eb0b00
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000eb034b
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000eb0339
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000eafbc5
- (id)jsonRepresentation;	// IMP=0x0000000000eafbb6
- (id)dictionaryRepresentation;	// IMP=0x0000000000eaf5a7
- (id)description;	// IMP=0x0000000000eaf4f8
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000eadf20
- (id)init;	// IMP=0x0000000000eadec4
