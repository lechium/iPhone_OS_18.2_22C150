...
- (void).cxx_destruct;	// IMP=0x0000000000a606c0
- (unsigned long long)hash;	// IMP=0x0000000000a605dd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a6044b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a5ffb4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a5fa4b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a5fa3c
- (id)jsonRepresentation;	// IMP=0x0000000000a5e3c0
- (id)dictionaryRepresentation;	// IMP=0x0000000000a5dc98
- (id)description;	// IMP=0x0000000000a5dbe9
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a5d10f
- (id)init;	// IMP=0x0000000000a5d0b3
