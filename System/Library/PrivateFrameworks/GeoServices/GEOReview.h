...
- (void).cxx_destruct;	// IMP=0x000000000100993f
- (unsigned long long)hash;	// IMP=0x0000000001009693
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000010094bc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001009239
- (void)writeTo:(id)arg1;	// IMP=0x0000000001008f90
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000001008f81
- (id)jsonRepresentation;	// IMP=0x0000000001008be0
- (id)dictionaryRepresentation;	// IMP=0x000000000100861f
- (id)description;	// IMP=0x0000000001008570
- (id)initWithData:(id)arg1;	// IMP=0x0000000001007c8b
- (id)init;	// IMP=0x0000000001007c2f
