...
- (id).cxx_construct;	// IMP=0x0000000001046935
- (void).cxx_destruct;	// IMP=0x000000000104689f
...
- (void)cancel;	// IMP=0x00000000010467a6
- (void)decodeWithPathHandler:(CDUnknownBlockType)arg1 errorHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000010458b1
- (void)_finishedDecodingWithPath:(Path_3f73a495)arg1;	// IMP=0x000000000104571d
- (id)initWithDecoder:(id)arg1 message:(shared_ptr_27244a92)arg2;	// IMP=0x000000000104551c
