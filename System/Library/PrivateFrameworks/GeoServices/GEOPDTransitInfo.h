...
+ (id)transitInfoForPlaceData:(id)arg1;	// IMP=0x00100000009fbded
- (void).cxx_destruct;	// IMP=0x0000000000d10829
- (unsigned long long)hash;	// IMP=0x0000000000d106ec
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d104b5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d0fc84
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d0f25b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d0f24c
- (id)jsonRepresentation;	// IMP=0x0000000000d0e9fa
- (id)dictionaryRepresentation;	// IMP=0x0000000000d0dcf5
- (id)description;	// IMP=0x0000000000d0dc46
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d0c394
- (id)init;	// IMP=0x0000000000d0c338
