...
- (void).cxx_destruct;	// IMP=0x00000000011df8d9
...
- (void)removeOldData:(id)arg1;	// IMP=0x00000000011df89d
- (void)populateTileGroup:(id)arg1;	// IMP=0x00000000011df82d
- (void)cancel;	// IMP=0x00000000011df827
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x00000000011df745
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 oldTileGroup:(id)arg5 dataSet:(id)arg6;	// IMP=0x00000000011df5cc
- (id)init;	// IMP=0x00000000011df5a2
