...
- (void).cxx_destruct;	// IMP=0x0000000000b1768e
...
- (id)initWithProcess:(id)arg1 reason:(id)arg2 creationTimestamp:(double)arg3;	// IMP=0x0000000000b174ff
- (id)init;	// IMP=0x0000000000b174d5
