...
- (void).cxx_destruct;	// IMP=0x0000000000d239f9
- (unsigned long long)hash;	// IMP=0x0000000000d238a6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d236a3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d23414
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d2312d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d2311e
- (id)jsonRepresentation;	// IMP=0x0000000000d22db1
- (id)dictionaryRepresentation;	// IMP=0x0000000000d2287d
- (id)description;	// IMP=0x0000000000d227ce
- (void)dealloc;	// IMP=0x0000000000d212db
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d2127f
- (id)init;	// IMP=0x0000000000d21223
