...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000001111b11
...
- (id)description;	// IMP=0x0000000001111e28
- (double)currentReferenceTime;	// IMP=0x0000000001111d29
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001111c6d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000001111b8c
- (id)initWithRefTime:(double)arg1 refError:(double)arg2 kernTime:(double)arg3 bootTime:(struct timeval)arg4;	// IMP=0x0000000001111b19
