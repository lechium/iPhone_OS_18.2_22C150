...
- (void).cxx_destruct;	// IMP=0x00000000012d2545
...
- (void)removeOldData:(id)arg1;	// IMP=0x00000000012d1cca
- (void)_completeWithError:(id)arg1;	// IMP=0x00000000012d1b8d
- (void)populateTileGroup:(id)arg1;	// IMP=0x00000000012d1b87
- (void)cancel;	// IMP=0x00000000012d1af9
- (void)_handleResponse:(id)arg1 withData:(id)arg2 error:(id)arg3;	// IMP=0x00000000012d15d7
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x00000000012d0da9
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (void)dealloc;	// IMP=0x00000000012d0d46
- (id)initWithMigrator:(id)arg1 newSearchAttributionManifestURL:(id)arg2 oldTileGroup:(id)arg3;	// IMP=0x00000000012d0b3d
- (id)init;	// IMP=0x00000000012d0b13
