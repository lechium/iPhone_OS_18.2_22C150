...
+ (_Bool)decodingSupported;	// IMP=0x0060000000d4a678
- (id).cxx_construct;	// IMP=0x0000000000d4aa18
- (void).cxx_destruct;	// IMP=0x0000000000d4a9c9
...
- (void)requestComplete:(id)arg1;	// IMP=0x0000000000d4a8ff
- (void)trackRequest:(id)arg1;	// IMP=0x0000000000d4a873
- (id)decodeZilchMessage:(shared_ptr_27244a92)arg1 pathHandler:(CDUnknownBlockType)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000d4a758
- (void)setRequestQueue:(id)arg1;	// IMP=0x0000000000d4a744
- (id)requestQueue;	// IMP=0x0000000000d4a72f
- (id)init;	// IMP=0x0000000000d4a691
