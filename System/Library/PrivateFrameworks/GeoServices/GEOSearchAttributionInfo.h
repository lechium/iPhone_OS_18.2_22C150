...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000011f52d2
- (void).cxx_destruct;	// IMP=0x00000000011f5e86
...
- (void)addLogoPath:(id)arg1;	// IMP=0x00000000011f5dce
- (id)snippetLogoPathForScale:(double)arg1;	// IMP=0x00000000011f5af8
- (id)logoPathForScale:(double)arg1;	// IMP=0x00000000011f5822
- (_Bool)hasAttributionRequirement:(int)arg1;	// IMP=0x00000000011f5813
- (id)description;	// IMP=0x00000000011f5764
- (id)dictionaryRepresentation;	// IMP=0x00000000011f55a8
- (_Bool)supportsActionURLs;	// IMP=0x00000000011f52da
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000011f51cf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011f4f93
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000011f4d73
...
- (id)initWithSource:(id)arg1 localizedAttribution:(id)arg2 logoPaths:(id)arg3 snippetLogoPaths:(id)arg4;	// IMP=0x00000000011f4aef
