...
- (void).cxx_destruct;	// IMP=0x000000000019f2ff
- (_Bool)performOperation;	// IMP=0x000000000019f259
- (id)init:(id)arg1 rowId:(long long)arg2 type:(id)arg3 key:(id)arg4 value:(id)arg5 parentId:(long long)arg6;	// IMP=0x000000000019f13e
