...
- (void).cxx_destruct;	// IMP=0x00000000011e8504
...
- (void)dataURLSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x00000000011e6863
- (void)dataURLSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000011e66d7
...
- (double)startTime;	// IMP=0x00000000011e6576
- (double)elapsed;	// IMP=0x00000000011e6526
- (void)clearAllRelatedOperations;	// IMP=0x00000000011e64f4
- (void)cancel;	// IMP=0x00000000011e6351
- (void)start;	// IMP=0x00000000011e5d14
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long contentLength;
@property(readonly, nonatomic) NSURL *URL;
@property unsigned int priority;
- (id)initWithRequest:(id)arg1 delegateQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000011e52de
- (id)init;	// IMP=0x00000000011e52d0
