...
- (void).cxx_destruct;	// IMP=0x0000000000a9fe32
- (unsigned long long)hash;	// IMP=0x0000000000a9fda8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a9fca2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a9f9ac
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a9f465
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a9f456
- (id)jsonRepresentation;	// IMP=0x0000000000a9f09b
- (id)dictionaryRepresentation;	// IMP=0x0000000000a9ea97
- (id)description;	// IMP=0x0000000000a9e9e8
- (void)dealloc;	// IMP=0x0000000000a9e04f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a9dff3
- (id)init;	// IMP=0x0000000000a9df97
