...
- (void).cxx_destruct;	// IMP=0x0000000000c4a965
- (unsigned long long)hash;	// IMP=0x0000000000c4a891
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c4a701
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c4a4a3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c4a280
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c4a271
- (id)jsonRepresentation;	// IMP=0x0000000000c49f04
- (id)dictionaryRepresentation;	// IMP=0x0000000000c499c9
- (id)description;	// IMP=0x0000000000c4991a
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c48e89
- (id)init;	// IMP=0x0000000000c48e2d
