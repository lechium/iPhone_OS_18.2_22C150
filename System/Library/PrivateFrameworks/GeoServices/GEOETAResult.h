...
- (void).cxx_destruct;	// IMP=0x00000000014e11c9
- (unsigned long long)hash;	// IMP=0x00000000014e10c4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000014e0f0e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000014e0a71
- (void)writeTo:(id)arg1;	// IMP=0x00000000014e04af
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000014e04a0
- (id)jsonRepresentation;	// IMP=0x00000000014df02c
- (id)dictionaryRepresentation;	// IMP=0x00000000014de7f4
- (id)description;	// IMP=0x00000000014de745
- (id)initWithData:(id)arg1;	// IMP=0x00000000014dd8b9
- (id)init;	// IMP=0x00000000014dd85d
