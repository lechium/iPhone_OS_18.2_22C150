...
- (unsigned long long)hash;	// IMP=0x0000000000c6dff5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c6ddc7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c6dadd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c6d7da
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c6d7cb
- (id)jsonRepresentation;	// IMP=0x0000000000c6ad76
- (id)dictionaryRepresentation;	// IMP=0x0000000000c6a5fa
- (id)description;	// IMP=0x0000000000c6a54b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c69151
- (id)init;	// IMP=0x0000000000c690f5
