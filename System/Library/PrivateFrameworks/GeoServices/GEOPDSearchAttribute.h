...
- (void).cxx_destruct;	// IMP=0x0000000000a62178
- (unsigned long long)hash;	// IMP=0x0000000000a62063
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a61e7c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a61c0a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a6195c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a6194d
- (id)jsonRepresentation;	// IMP=0x0000000000a616ad
- (id)dictionaryRepresentation;	// IMP=0x0000000000a6111b
- (id)description;	// IMP=0x0000000000a6106c
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a607a2
- (id)init;	// IMP=0x0000000000a60746
