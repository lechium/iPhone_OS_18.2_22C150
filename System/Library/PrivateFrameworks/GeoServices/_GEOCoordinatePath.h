...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000ea70d8
- (id).cxx_construct;	// IMP=0x0000000000ea7464
- (void).cxx_destruct;	// IMP=0x0000000000ea740d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000ea7319
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000ea70e0
