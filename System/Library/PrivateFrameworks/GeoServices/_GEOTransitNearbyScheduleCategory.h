...
- (void).cxx_destruct;	// IMP=0x00000000011be009
...
- (id)initWithTransitScheduleCategory:(id)arg1 nearbyScheduleGroups:(id)arg2 categoryArtwork:(id)arg3;	// IMP=0x00000000011bdef7
