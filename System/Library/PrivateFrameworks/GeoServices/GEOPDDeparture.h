...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000be591b
- (void).cxx_destruct;	// IMP=0x0000000000be6ae4
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000be6a43
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000be6852
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000be6357
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000be60ce
- (void)copyTo:(id)arg1;	// IMP=0x0000000000be5f4a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000be5c7b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000be5c6c
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000be5691
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000be567f
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000be512d
- (id)jsonRepresentation;	// IMP=0x0000000000be501d
- (id)dictionaryRepresentation;	// IMP=0x0000000000be4b5a
@property(readonly, copy) NSString *description;
@property(retain, nonatomic) NSString *displayNameOverride;
@property(readonly, nonatomic) _Bool hasDisplayNameOverride;
- (int)StringAsRealTimeStatusInfo:(id)arg1;	// IMP=0x0000000000be48ec
- (id)realTimeStatusInfoAsString:(int)arg1;	// IMP=0x0000000000be48a3
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000be3a91
- (id)init;	// IMP=0x0000000000be3a35
- (_Bool)isPastDepartureRelativeToDate:(id)arg1 usingGracePeriod:(_Bool)arg2;	// IMP=0x00000000011bc297
