...
+ (_Bool)isValid:(id)arg1;	// IMP=0x00100000011c7243
+ (Class)tokenCandidatesType;	// IMP=0x00100000011c55a8
+ (Class)spellSuggestionType;	// IMP=0x00100000011c5009
- (void).cxx_destruct;	// IMP=0x00000000011c9285
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000011c8ebb
- (unsigned long long)hash;	// IMP=0x00000000011c8b5e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000011c889d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000011c830a
- (void)copyTo:(id)arg1;	// IMP=0x00000000011c801d
- (void)writeTo:(id)arg1;	// IMP=0x00000000011c7b19
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000011c7b0c
- (void)readAll:(_Bool)arg1;	// IMP=0x00000000011c6e33
- (id)initWithJSON:(id)arg1;	// IMP=0x00000000011c6e20
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000011c63c2
- (id)jsonRepresentation;	// IMP=0x00000000011c63b3
- (id)dictionaryRepresentation;	// IMP=0x00000000011c5af7
- (id)description;	// IMP=0x00000000011c5a48
...
- (int)StringAsRankerModelType:(id)arg1;	// IMP=0x00000000011c5820
- (id)rankerModelTypeAsString:(int)arg1;	// IMP=0x00000000011c57d7
...
- (id)tokenCandidatesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000011c5577
- (unsigned long long)tokenCandidatesCount;	// IMP=0x00000000011c554b
- (void)addTokenCandidates:(id)arg1;	// IMP=0x00000000011c5465
- (void)clearTokenCandidates;	// IMP=0x00000000011c5404
...
- (int)StringAsResultStatus:(id)arg1;	// IMP=0x00000000011c5113
- (id)resultStatusAsString:(int)arg1;	// IMP=0x00000000011c50c8
@property(nonatomic) _Bool hasResultStatus;
@property(nonatomic) int resultStatus;
- (id)spellSuggestionAtIndex:(unsigned long long)arg1;	// IMP=0x00000000011c4fd8
- (unsigned long long)spellSuggestionsCount;	// IMP=0x00000000011c4fac
- (void)addSpellSuggestion:(id)arg1;	// IMP=0x00000000011c4ec6
- (void)clearSpellSuggestions;	// IMP=0x00000000011c4e65
@property(retain, nonatomic) NSMutableArray *spellSuggestions;
- (id)initWithData:(id)arg1;	// IMP=0x00000000011c41e1
- (id)init;	// IMP=0x00000000011c4185
