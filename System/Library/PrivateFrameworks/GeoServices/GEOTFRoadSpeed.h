...
- (void).cxx_destruct;	// IMP=0x000000000024264d
- (unsigned long long)hash;	// IMP=0x00000000002421db
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000241f0c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000241a8a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000241554
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000241545
- (id)jsonRepresentation;	// IMP=0x00000000002411ba
- (id)dictionaryRepresentation;	// IMP=0x000000000024081c
- (id)description;	// IMP=0x000000000024076d
- (void)dealloc;	// IMP=0x000000000023f6f1
- (id)initWithData:(id)arg1;	// IMP=0x000000000023f695
- (id)init;	// IMP=0x000000000023f639
