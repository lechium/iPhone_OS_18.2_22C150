...
- (void).cxx_destruct;	// IMP=0x0000000001340de0
...
- (id)_chooseMostImportantTransitLegInRoute:(id)arg1;	// IMP=0x0000000001340c56
- (id)description;	// IMP=0x0000000001340b9c
- (id)initWithComposedRoute:(id)arg1;	// IMP=0x0000000001340af6
