...
- (void).cxx_destruct;	// IMP=0x0000000000c9bd98
- (unsigned long long)hash;	// IMP=0x0000000000c9bbc7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c9b973
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c9b171
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c9a5a3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c9a594
- (id)jsonRepresentation;	// IMP=0x0000000000c98e33
- (id)dictionaryRepresentation;	// IMP=0x0000000000c980ae
- (id)description;	// IMP=0x0000000000c97fff
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c968f9
- (id)init;	// IMP=0x0000000000c9689d
- (id)punchOutText;	// IMP=0x0000000000a03e72
- (id)itemHTMLDescription;	// IMP=0x0000000000a03e1c
- (id)itemDescription;	// IMP=0x0000000000a03dc6
