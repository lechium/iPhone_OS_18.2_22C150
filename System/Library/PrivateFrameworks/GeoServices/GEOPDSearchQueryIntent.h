...
- (void).cxx_destruct;	// IMP=0x0000000000aa9ae1
- (unsigned long long)hash;	// IMP=0x0000000000aa9a1e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aa98a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aa925d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aa813b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aa812c
- (id)jsonRepresentation;	// IMP=0x0000000000aa1840
- (id)dictionaryRepresentation;	// IMP=0x0000000000aa0e25
- (id)description;	// IMP=0x0000000000aa0d76
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a9fed0
