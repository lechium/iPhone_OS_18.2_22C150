...
- (void).cxx_destruct;	// IMP=0x0000000000cb7d75
- (unsigned long long)hash;	// IMP=0x0000000000cb7c72
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cb7abc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000cb7619
- (void)writeTo:(id)arg1;	// IMP=0x0000000000cb707b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000cb706c
- (id)jsonRepresentation;	// IMP=0x0000000000cb633f
- (id)dictionaryRepresentation;	// IMP=0x0000000000cb59f9
- (id)description;	// IMP=0x0000000000cb594a
- (id)initWithData:(id)arg1;	// IMP=0x0000000000cb49d1
- (id)init;	// IMP=0x0000000000cb4975
- (id)publisherDescription;	// IMP=0x0000000000a03d70
