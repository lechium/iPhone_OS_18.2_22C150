...
+ (id)dbValue:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x0060000000199b30
- (void).cxx_destruct;	// IMP=0x0000000000199c20
...
- (id)initWithParent:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x0000000000199a7a
