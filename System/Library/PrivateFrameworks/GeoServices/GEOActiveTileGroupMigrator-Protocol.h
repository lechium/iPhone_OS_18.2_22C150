...
- (id <GEOActiveTileGroupMigrationTask>)opportunisticTaskForNewTileGroup:(GEOTileGroup *)arg1 inResourceManifest:(GEOResources *)arg2 oldTileGroup:(GEOActiveTileGroup *)arg3 activeScales:(NSSet *)arg4 activeScenarios:(NSSet *)arg5 activeNames:(NSSet *)arg6 dataSet:(GEODataSetDescription *)arg7;
@end
