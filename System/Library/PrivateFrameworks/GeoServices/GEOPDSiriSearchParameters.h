...
- (void).cxx_destruct;	// IMP=0x0000000000598a94
- (unsigned long long)hash;	// IMP=0x0000000000598914
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000059868b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000059811f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000597be4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000597bd5
- (id)jsonRepresentation;	// IMP=0x00000000005976e2
- (id)dictionaryRepresentation;	// IMP=0x0000000000596c1d
- (id)description;	// IMP=0x0000000000596b6e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000595948
- (id)init;	// IMP=0x00000000005958ec
