...
+ (id)factoidsForPlaceData:(id)arg1;	// IMP=0x0010000000a02e1f
+ (_Bool)factoidPairAvailableForPlaceData:(id)arg1;	// IMP=0x0010000000a02d23
- (void).cxx_destruct;	// IMP=0x0000000000c241ef
- (unsigned long long)hash;	// IMP=0x0000000000c23f80
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c23cfb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c23857
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c2345c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c2344d
- (id)jsonRepresentation;	// IMP=0x0000000000c222a8
- (id)dictionaryRepresentation;	// IMP=0x0000000000c21a35
- (id)description;	// IMP=0x0000000000c21986
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c20677
- (id)init;	// IMP=0x0000000000c2061b
- (id)bestLocalizedPlaceName;	// IMP=0x0000000000a02f75
