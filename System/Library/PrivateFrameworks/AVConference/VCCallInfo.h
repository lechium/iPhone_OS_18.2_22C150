...
+ (unsigned char)getVCCurrentVersion;	// IMP=0x006000000045aad8
...
- (_Bool)supportSDPCompression;	// IMP=0x000000000045aacb
- (void)setUserAgent:(id)arg1;	// IMP=0x000000000045a989
- (struct VoiceIOFarEndVersionInfo)audioVersionInfo:(_Bool)arg1;	// IMP=0x000000000045a928
@property(readonly) _Bool supportsDynamicContentsRectWithAspectPreservation;
- (_Bool)updateWithLastDecodedFrameTime:(double)arg1 time:(double)arg2;	// IMP=0x000000000045a68b
@property(readonly, nonatomic) _Bool requiresImplicitFeatureString;
- (void)dealloc;	// IMP=0x000000000045a5cc
- (id)init;	// IMP=0x000000000045a402
