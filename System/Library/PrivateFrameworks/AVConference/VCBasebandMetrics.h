...
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x00000000001ea8be
- (void)addBDCDListWithNotificationArrivalTime:(double)arg1 bdcd:(double)arg2 queuingDelay:(double)arg3;	// IMP=0x00000000001ea7b1
- (void)resetBBNoteHistoryList;	// IMP=0x00000000001ea796
- (void)resetBDCDList;	// IMP=0x00000000001ea77b
- (void)normalizeBDCD:(double)arg1;	// IMP=0x00000000001ea53f
- (double)updateTotalQueueDepth:(unsigned int)arg1;	// IMP=0x00000000001ea4d0
- (void)calculateBitratesAndDelaysWithTotalQueueDepth:(unsigned int)arg1;	// IMP=0x00000000001ea227
- (void)addInfoListWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x00000000001ea164
- (struct tagVCStatisticsMessage)getBasebandMetricsWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x00000000001e9ee7
- (void)dealloc;	// IMP=0x00000000001e9e89
- (id)init;	// IMP=0x00000000001e9de2
