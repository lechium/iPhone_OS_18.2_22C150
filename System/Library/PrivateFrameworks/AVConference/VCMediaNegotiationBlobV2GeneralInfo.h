...
- (unsigned long long)hash;	// IMP=0x00000000001ba05d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b9f77
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b9ea4
- (void)copyTo:(id)arg1;	// IMP=0x00000000001b9e11
- (void)writeTo:(id)arg1;	// IMP=0x00000000001b9d69
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001b9d5c
- (id)dictionaryRepresentation;	// IMP=0x00000000001b9913
- (id)description;	// IMP=0x00000000001b9879
...
- (void)dealloc;	// IMP=0x00000000001b9708
- (void)printWithLogFile:(void *)arg1 prefix:(id)arg2;	// IMP=0x00000000003b5e96
@property(readonly, nonatomic) struct CGSize screenResolution;
@property(readonly, nonatomic) union tagNTP creationTime;
- (id)initWithCreationTime:(union tagNTP)arg1 screenResolution:(struct CGSize)arg2 abSwitches:(unsigned int)arg3;	// IMP=0x00000000003b5ca4
