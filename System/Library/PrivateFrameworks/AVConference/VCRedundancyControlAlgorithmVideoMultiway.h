...
- (void)updateRedundancyPercentage;	// IMP=0x000000000026cc89
- (void)reset;	// IMP=0x000000000026cc83
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000026cc02
- (id)init;	// IMP=0x000000000026cb96
