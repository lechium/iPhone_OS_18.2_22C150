...
- (int)jitterBufferModeFromAVCJitterBufferMode:(unsigned int)arg1;	// IMP=0x00000000004449a4
- (void)applyMediaStreamClientDictionary:(id)arg1;	// IMP=0x000000000044447a
- (void)setupMediaStreamConfig;	// IMP=0x00000000004443f1
@property(readonly, nonatomic) long long primaryTxCodecType;
- (void)addTxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x0000000000444233
- (void)addTxPayloadType:(int)arg1;	// IMP=0x000000000044421c
- (void)addRxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x00000000004441b3
- (void)addRxPayloadType:(int)arg1;	// IMP=0x000000000044419c
- (id)description;	// IMP=0x000000000044415b
- (void)dealloc;	// IMP=0x000000000044407d
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x0000000000443fb4
- (id)init;	// IMP=0x0000000000443f45
