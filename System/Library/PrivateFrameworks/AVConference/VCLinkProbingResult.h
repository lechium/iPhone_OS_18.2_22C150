...
- (id)description;	// IMP=0x0000000000445f80
- (unsigned char)getPLRTierFromPLREnvelope:(double)arg1;	// IMP=0x0000000000445ed7
- (void)updateLinkStatsWithArrivingNewValueMeanRTT:(double)arg1 arrivingNewValuePLR:(double)arg2;	// IMP=0x0000000000445d2d
- (void)updateProbingResult:(id)arg1 initialResult:(_Bool)arg2;	// IMP=0x00000000004458a6
- (void)mergeProbingResults:(id)arg1;	// IMP=0x0000000000445892
- (void)dealloc;	// IMP=0x0000000000445817
- (id)initWithProbingResults:(id)arg1 linkProbingResultConfig:(CDStruct_7421bd8e)arg2;	// IMP=0x0000000000445709
