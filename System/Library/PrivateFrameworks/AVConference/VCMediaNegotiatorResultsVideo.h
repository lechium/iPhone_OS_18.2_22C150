...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000378447
- (void)addNegotiatedHDRMode:(id)arg1;	// IMP=0x0000000000378431
- (void)addPixelFormatSet:(id)arg1;	// IMP=0x000000000037841b
- (void)addParameterSet:(id)arg1 payload:(int)arg2;	// IMP=0x00000000003783d1
- (void)addFeatureString:(id)arg1 payload:(int)arg2;	// IMP=0x0000000000378387
- (void)addVideoRules:(id)arg1 transportType:(unsigned char)arg2 payload:(int)arg3 encodingType:(unsigned char)arg4;	// IMP=0x0000000000378371
- (void)dealloc;	// IMP=0x00000000003782ef
- (id)init;	// IMP=0x0000000000378238
