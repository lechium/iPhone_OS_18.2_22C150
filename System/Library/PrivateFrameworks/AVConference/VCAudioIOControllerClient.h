...
- (void)setClientFormat:(const struct tagVCAudioFrameFormat *)arg1;	// IMP=0x00000000002db425
- (void)setRemoteCodecType:(unsigned int)arg1 sampleRate:(double)arg2;	// IMP=0x00000000002db40d
- (void)setFarEndVersionInfo:(struct VoiceIOFarEndVersionInfo)arg1;	// IMP=0x00000000002db3e1
