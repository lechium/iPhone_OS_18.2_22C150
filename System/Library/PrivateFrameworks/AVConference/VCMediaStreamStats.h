...
- (unsigned int)getBitrateKbpsSinceTime:(double)arg1;	// IMP=0x00000000001b73da
- (double)getFramerateSinceTime:(double)arg1;	// IMP=0x00000000001b7365
- (void)updateMinMaxSinceTime:(double)arg1;	// IMP=0x00000000001b7302
@property(readonly, nonatomic) unsigned int bitrateKbps;
@property(readonly, nonatomic) double framerate;
- (void)recordDataWithSize:(double)arg1 atTime:(double)arg2;	// IMP=0x00000000001b724b
- (void)dealloc;	// IMP=0x00000000001b71e4
- (id)init;	// IMP=0x00000000001b710d
