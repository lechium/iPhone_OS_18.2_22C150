...
- (void)dealloc;	// IMP=0x00000000003d0752
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x00000000003d0394
- (void)readyToRead;	// IMP=0x00000000003d035c
- (int)stop;	// IMP=0x00000000003d023d
- (int)start;	// IMP=0x00000000003cfa83
- (id)initWithIDSDestination:(id)arg1;	// IMP=0x00000000003cf87a
- (id)initWithIDSSocketDescriptor:(unsigned short)arg1;	// IMP=0x00000000003cf670
