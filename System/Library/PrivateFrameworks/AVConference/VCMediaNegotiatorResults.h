...
- (unsigned int)maxBandwidthWithArbiterMode:(unsigned char)arg1 connectionType:(int)arg2;	// IMP=0x00000000003742f5
- (void)addBandwidthConfigurations:(id)arg1;	// IMP=0x00000000003742c0
- (void)dealloc;	// IMP=0x000000000037424c
- (id)init;	// IMP=0x00000000003741cc
