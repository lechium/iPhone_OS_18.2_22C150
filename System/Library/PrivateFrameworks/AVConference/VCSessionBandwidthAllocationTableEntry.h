...
+ (long long)compareAudioEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x00600000001ece1e
+ (long long)compareVideoEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x00600000001ec992
+ (long long)compareAudioEntry:(id)arg1 audioEntry:(id)arg2;	// IMP=0x00600000001ec763
+ (unsigned char)entryTypeForMediaType:(unsigned int)arg1;	// IMP=0x00600000001ec51c
...
- (long long)compare:(id)arg1;	// IMP=0x00000000001ec5a8
- (id)description;	// IMP=0x00000000001ec417
- (void)dealloc;	// IMP=0x00000000001ec3b9
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 streamID:(unsigned int)arg4 streamGroupID:(unsigned int)arg5;	// IMP=0x00000000001ec308
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 minNetworkBitrate:(unsigned int)arg4 maxNetworkBitrate:(unsigned int)arg5 mediaBitrate:(unsigned int)arg6 qualityIndex:(unsigned int)arg7 streamID:(unsigned int)arg8 hasRepairStreamID:(_Bool)arg9 repairStreamID:(unsigned int)arg10 repairMaxNetworkBitrate:(unsigned int)arg11 subscribedTo:(_Bool)arg12 startOnDemand:(_Bool)arg13 streamGroupID:(unsigned int)arg14 encoderGroupID:(unsigned int)arg15 v2StreamID:(unsigned int)arg16;	// IMP=0x00000000001ec20f
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 networkBitrate:(unsigned int)arg4 mediaBitrate:(unsigned int)arg5 qualityIndex:(unsigned int)arg6 streamID:(unsigned int)arg7 streamGroupID:(unsigned int)arg8 v2StreamID:(unsigned int)arg9;	// IMP=0x00000000001ec1c2
