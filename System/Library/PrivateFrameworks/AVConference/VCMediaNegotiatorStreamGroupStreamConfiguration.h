...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010d8e4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010d329
- (_Bool)isEqualPayloads:(id)arg1;	// IMP=0x000000000010d1e8
- (_Bool)applyCipherSuiteOnMediaStreamConfig:(id)arg1 codecConfigs:(id)arg2;	// IMP=0x000000000010cf97
- (_Bool)areCodecsEqualTo:(id)arg1;	// IMP=0x000000000010cf3a
- (void)resetCodecs;	// IMP=0x000000000010cf24
- (void)removeCodec:(unsigned int)arg1;	// IMP=0x000000000010ceeb
- (void)addCodec:(unsigned int)arg1;	// IMP=0x000000000010ceb2
- (void)resetPayloads;	// IMP=0x000000000010ce9c
- (void)addPayload:(int)arg1;	// IMP=0x000000000010ce63
- (void)dealloc;	// IMP=0x000000000010cdf6
- (id)init;	// IMP=0x000000000010cd70
