...
- (id)streamIds;	// IMP=0x0000000000363f69
- (void)addSubStreamConfig:(id)arg1;	// IMP=0x0000000000363f4c
- (void)addPayload:(int)arg1;	// IMP=0x0000000000363f0c
- (void)dealloc;	// IMP=0x0000000000363e91
- (id)init;	// IMP=0x0000000000363e04
