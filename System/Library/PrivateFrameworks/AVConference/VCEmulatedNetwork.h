...
- (void)runUntilTime:(double)arg1;	// IMP=0x00000000000928e3
- (id)copyPacketFromPop;	// IMP=0x0000000000092894
- (void)push:(id)arg1;	// IMP=0x000000000009285b
- (void)dealloc;	// IMP=0x00000000000927d7
- (id)initWithPolicies:(id)arg1;	// IMP=0x00000000000926e8
