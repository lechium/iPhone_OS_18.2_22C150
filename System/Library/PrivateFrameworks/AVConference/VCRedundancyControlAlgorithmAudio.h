...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(double *)arg1;	// IMP=0x0000000000460313
- (void)computeRedundancyInfo;	// IMP=0x0000000000460291
- (void)reset;	// IMP=0x000000000046028b
- (void)processRCNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000046009d
- (void)processNWConnectionStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000460003
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x000000000045ffd6
- (id)initWithMode:(unsigned int)arg1;	// IMP=0x000000000045fd06
