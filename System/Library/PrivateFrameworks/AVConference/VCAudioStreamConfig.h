...
+ (int)bundlingSchemeForAudioStreamMode:(long long)arg1 payloadType:(int)arg2;	// IMP=0x006000000046abea
...
- (void)addSupportedNumRedundantPayload:(unsigned int)arg1;	// IMP=0x000000000046b7e5
- (void)addCodecConfiguration:(id)arg1;	// IMP=0x000000000046b70a
@property(nonatomic) const struct tagVCAudioFrameFormat *externalIOFormat;
- (_Bool)setupDTMFCodecWithClientDictionary:(id)arg1;	// IMP=0x000000000046b46a
- (_Bool)setupCNCodecWithClientDictionary:(id)arg1;	// IMP=0x000000000046b218
- (void)setupRedWithRxPayload:(unsigned int)arg1 txPayload:(unsigned int)arg2;	// IMP=0x000000000046b1c6
- (_Bool)setupCodecWithClientDictionary:(id)arg1;	// IMP=0x000000000046acd8
- (void)dealloc;	// IMP=0x000000000046ab61
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000046a62c
- (id)init;	// IMP=0x000000000046a59f
