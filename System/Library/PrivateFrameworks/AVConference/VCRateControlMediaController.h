...
- (void)updateLargeFrameSizeWithBandwidth:(unsigned int)arg1;	// IMP=0x000000000014b5d9
- (void)updateProbingLargeFrameSizeCap;	// IMP=0x000000000014b51e
- (_Bool)isProbingLargeFrameRequiredAtTime:(double)arg1;	// IMP=0x000000000014b129
- (void)printLargeFrameStatsAtTime:(double)arg1 timestamp:(unsigned int)arg2 timeSinceLastProbingSequence:(double)arg3 frameSize:(unsigned int)arg4 wastedBytes:(unsigned int)arg5 fecRatio:(double)arg6 isFrameRequested:(_Bool)arg7;	// IMP=0x000000000014af6a
- (void)scheduleProbingSequenceAtTime:(double)arg1;	// IMP=0x000000000014ae70
- (_Bool)increaseFlushCountForVideoRefresh:(int)arg1 transactionID:(unsigned short)arg2;	// IMP=0x000000000014adff
- (void)recordVideoRefreshFrameWithTimestamp:(unsigned int)arg1 payloadType:(unsigned char)arg2 packetCount:(unsigned int)arg3 isKeyFrame:(_Bool)arg4;	// IMP=0x000000000014ad6a
- (void)scheduleProbingSequenceWithFrameSize:(unsigned int)arg1 paddingBytes:(unsigned int)arg2 timestamp:(unsigned int)arg3 fecRatio:(double)arg4 isProbingSequenceScheduled:(_Bool *)arg5;	// IMP=0x000000000014abb4
...
- (_Bool)rampUpAudioFraction;	// IMP=0x000000000014a90f
- (void)setTargetBitrate:(unsigned int)arg1;	// IMP=0x000000000014a449
- (_Bool)didMediaGetFlushedWithPayloadType:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x000000000014a356
- (void)decreaseFlushCount:(int)arg1;	// IMP=0x000000000014a224
- (void)pauseVideoByUser:(_Bool)arg1;	// IMP=0x0000000000149a50
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x0000000000147e8a
- (void)dealloc;	// IMP=0x0000000000147e08
- (id)initWithMediaQueue:(struct tagHANDLE *)arg1 delegate:(id)arg2;	// IMP=0x0000000000147cca
