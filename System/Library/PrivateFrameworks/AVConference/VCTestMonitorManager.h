...
+ (id)sharedManager;	// IMP=0x0060000000476c62
...
- (void)registerBlocksForService;	// IMP=0x0000000000476fdb
- (void)reportSessionMediaDaemonStats:(id)arg1;	// IMP=0x0000000000476cb1
- (void)dealloc;	// IMP=0x0000000000476bf2
- (id)init;	// IMP=0x0000000000476b50
