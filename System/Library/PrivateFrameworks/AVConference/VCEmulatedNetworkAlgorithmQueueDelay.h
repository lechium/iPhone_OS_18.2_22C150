...
- (void)process:(id)arg1;	// IMP=0x000000000014bbc0
- (double)computeNetworkDelay;	// IMP=0x000000000014badf
- (void)updateSettingsAtTime:(double)arg1 impairments:(id)arg2;	// IMP=0x000000000014b878
- (id)init;	// IMP=0x000000000014b81a
