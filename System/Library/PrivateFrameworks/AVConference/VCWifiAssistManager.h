...
+ (id)sharedInstance;	// IMP=0x006000000013470b
@property(readonly) unsigned char wifiAssistState; // @synthesize wifiAssistState=_wifiAssistState;
- (void)removeDelegate:(id)arg1;	// IMP=0x0000000000134719
- (void)addDelegate:(id)arg1;	// IMP=0x0000000000134713
@property(readonly) _Bool isAvailable;
- (id)init;	// IMP=0x00000000001346f5
