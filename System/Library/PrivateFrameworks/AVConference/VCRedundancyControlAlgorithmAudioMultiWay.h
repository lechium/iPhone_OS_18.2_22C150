...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(unsigned int *)arg1;	// IMP=0x00000000002df0d2
- (void)computeRedundancyInfo;	// IMP=0x00000000002df050
- (void)reset;	// IMP=0x00000000002df04a
- (void)processRCNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000002dee56
- (void)processNWConnectionStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000002dedbc
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000002ded8f
- (id)init;	// IMP=0x00000000002ded1f
