...
- (void)addCustomFeatureListString:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002f3cb0
- (void)dealloc;	// IMP=0x00000000002f3c09
- (id)description;	// IMP=0x00000000002f3acc
- (id)init;	// IMP=0x00000000002f39e9
