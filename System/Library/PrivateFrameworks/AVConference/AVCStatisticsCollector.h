...
- (struct tagVCStatisticsMessage)getVCStatisticsWithType:(int)arg1 time:(double)arg2;	// IMP=0x00000000000438a9
- (_Bool)shouldProcessAtTime:(double)arg1;	// IMP=0x000000000004386a
- (void)unregisterAllStatisticsChangeHandlers;	// IMP=0x00000000000435e5
- (_Bool)unregisterStatisticsChangeHandlerWithType:(int)arg1 handlerIndex:(int)arg2;	// IMP=0x0000000000043562
- (int)registerStatisticsChangeHandlerWithType:(int)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000431a8
- (void)setMaxBitrate:(unsigned int)arg1;	// IMP=0x0000000000043110
- (id)getStatistics:(id)arg1;	// IMP=0x0000000000042f2e
- (void)setStatistics:(id)arg1;	// IMP=0x0000000000042d4e
- (void)stop;	// IMP=0x0000000000042a46
- (void)start;	// IMP=0x0000000000041e15
- (void)dealloc;	// IMP=0x0000000000041b7b
- (id)initForSimulation:(_Bool)arg1 useExternalThread:(_Bool)arg2;	// IMP=0x00000000000417be
