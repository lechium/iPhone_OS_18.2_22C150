...
- (id)className;	// IMP=0x000000000037c80b
- (void)releaseLogDumpFile;	// IMP=0x000000000037c742
- (void)createLogDumpFile:(unsigned int)arg1;	// IMP=0x000000000037c69a
- (void)updateAverageTargetBitrate:(unsigned int)arg1 interval:(double)arg2;	// IMP=0x000000000037c5f6
- (void)setOperatingTierIndexWithBitrate:(unsigned int)arg1;	// IMP=0x000000000037c3ec
- (unsigned short)maxTierIndex:(unsigned int)arg1;	// IMP=0x000000000037c36a
- (unsigned short)minTierIndex:(unsigned int)arg1;	// IMP=0x000000000037c2de
...
- (void)updateVideoStall:(_Bool)arg1 withStallDuration:(unsigned int)arg2;	// IMP=0x000000000037c1e3
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x000000000037c0fc
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingBitrate:(unsigned int)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x000000000037be5f
- (void)setRateControlInterval:(double)arg1;	// IMP=0x000000000037bdcd
- (void)setMaxTargetBitrate:(unsigned int)arg1 minTargetBitrate:(unsigned int)arg2;	// IMP=0x000000000037bcd2
- (void)dealloc;	// IMP=0x000000000037bc5e
- (id)initWithDumpID:(unsigned int)arg1;	// IMP=0x000000000037babd
