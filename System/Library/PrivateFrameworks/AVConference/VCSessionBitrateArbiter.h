...
- (void)readStoreBagValues;	// IMP=0x00000000002c1caf
- (unsigned int)bitrateForStoreBagKey:(id)arg1 connectionType:(int)arg2 currentBitrate:(unsigned int)arg3 isExpensive:(_Bool)arg4;	// IMP=0x00000000002c1a9a
- (void)readHardwareValues;	// IMP=0x00000000002c1a70
- (_Bool)rangeCheck:(unsigned int)arg1;	// IMP=0x00000000002c19f8
- (void)dealloc;	// IMP=0x00000000002c199a
- (id)init;	// IMP=0x00000000002c1916
