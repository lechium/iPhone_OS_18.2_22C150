...
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x00000000003e56ed
- (void)setMaxBitrateForBandwidthEstimator:(unsigned int)arg1;	// IMP=0x00000000003e42b7
- (void)dealloc;	// IMP=0x00000000003e4244
- (id)init;	// IMP=0x00000000003e4192
