...
+ (unsigned int)capabilitiesBitmapWithCapabilities:(unsigned char)arg1;	// IMP=0x00100000003fd956
+ (unsigned int)avcMomentsCapabilitiesForMultiwayMomentsCapabilities:(int)arg1;	// IMP=0x00100000003fd513
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000738b9
- (unsigned long long)hash;	// IMP=0x0000000000073842
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007378c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000736e9
- (void)copyTo:(id)arg1;	// IMP=0x0000000000073684
- (void)writeTo:(id)arg1;	// IMP=0x00000000000735e1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000735d4
- (id)dictionaryRepresentation;	// IMP=0x000000000007314b
- (id)description;	// IMP=0x00000000000730b1
...
- (id)newImageTypeSet;	// IMP=0x00000000003fd8c4
- (id)newVideoCodecSet;	// IMP=0x00000000003fd832
- (id)initWithVideoCodecs:(id)arg1 imageTypes:(id)arg2 capabilities:(unsigned char)arg3 multiwayCapabilities:(unsigned char)arg4;	// IMP=0x00000000003fd52b
