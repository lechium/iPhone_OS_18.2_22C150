...
- (void)setupEVSModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x00000000000562ca
- (void)setupAMRWBModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x00000000000560b8
- (void)setupAMRModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x0000000000055edc
- (void)setPreferredModeWithClientMode:(int)arg1;	// IMP=0x0000000000055ed3
- (void)setupCodecBandwidthsWithClientBandwidthMask:(unsigned int)arg1;	// IMP=0x0000000000055d6c
- (void)setupModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x0000000000055d1d
@property(readonly, nonatomic) _Bool isComfortNoise;
- (void)dealloc;	// IMP=0x0000000000055c76
- (id)initWithCodecType:(long long)arg1;	// IMP=0x0000000000055bdd
