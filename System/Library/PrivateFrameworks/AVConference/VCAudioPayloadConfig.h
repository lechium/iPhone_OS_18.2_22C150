...
- (id)description;	// IMP=0x00000000004ac3cb
- (id)className;	// IMP=0x00000000004ac3b9
- (void)updateDescription;	// IMP=0x00000000004ac2f4
@property(readonly, nonatomic) unsigned int flags;
- (float)qualityForBitRate:(unsigned int)arg1;	// IMP=0x00000000004ac1fe
- (void)dealloc;	// IMP=0x00000000004ac18a
- (id)initWithConfigDict:(id)arg1;	// IMP=0x00000000004ac0f0
- (void)setupEncodeProperties:(id)arg1;	// IMP=0x00000000004abcdb
- (void)createSupportedBitratesForEVS;	// IMP=0x00000000004abcba
- (void)createSupportedBitratesForAMR16k;	// IMP=0x00000000004abc99
- (void)createSupportedBitratesForAMR8k;	// IMP=0x00000000004abc78
- (void)createSupportedBitratesForOpus;	// IMP=0x00000000004abc57
- (void)createSupportedBitratesForAACELD48;	// IMP=0x00000000004abc36
- (void)createSupportedBitratesForAACELD;	// IMP=0x00000000004abc15
- (void)createSupportedBitrates;	// IMP=0x00000000004abb96
- (unsigned int)aacBitrate;	// IMP=0x00000000004aba69
- (void)setUseSBR:(_Bool)arg1;	// IMP=0x00000000004ab9ee
- (_Bool)configure:(id)arg1;	// IMP=0x00000000004ab2e0
