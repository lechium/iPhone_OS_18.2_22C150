...
- (unsigned int)computeRedundancyWithBurstyLoss;	// IMP=0x0000000000069dfa
- (unsigned int)computeRedundancyWithLossPercentage;	// IMP=0x0000000000069dd0
- (void)updateBurstyLoss:(unsigned int)arg1;	// IMP=0x0000000000069d84
- (void)reset;	// IMP=0x0000000000069d7e
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000069cd0
