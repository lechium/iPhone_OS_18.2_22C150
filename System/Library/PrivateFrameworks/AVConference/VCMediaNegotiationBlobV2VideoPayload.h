...
+ (int)rtpPayloadWithPayload:(int)arg1;	// IMP=0x0010000000269920
+ (int)payloadWithRTPPayload:(int)arg1;	// IMP=0x0010000000269820
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000003a283
- (unsigned long long)hash;	// IMP=0x000000000003a19c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003a065
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000039f5d
- (void)copyTo:(id)arg1;	// IMP=0x0000000000039e95
- (void)writeTo:(id)arg1;	// IMP=0x0000000000039dad
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000039da0
- (id)dictionaryRepresentation;	// IMP=0x00000000000397bb
- (id)description;	// IMP=0x0000000000039721
...
- (void)dealloc;	// IMP=0x0000000000039518
- (void)setupVideoParameterSupport:(unsigned int)arg1;	// IMP=0x000000000026aa43
- (_Bool)setupEncode:(_Bool)arg1 videoRules:(id)arg2;	// IMP=0x0000000000269a16
- (void)printWithLogFile:(void *)arg1 prefix:(id)arg2;	// IMP=0x0000000000269122
@property(readonly, nonatomic) unsigned int videoParameterSupport;
- (id)videoRulesWithBitmap:(unsigned int)arg1 preferredBitmap:(unsigned int)arg2;	// IMP=0x0000000000267741
...
- (id)initWithPayload:(int)arg1 encodeVideoRules:(id)arg2 decodeVideoRules:(id)arg3 videoParameterSupport:(unsigned int)arg4 featureListStrings:(id)arg5;	// IMP=0x000000000026749c
