...
- (id)description;	// IMP=0x00000000004e391f
- (unsigned long long)hash;	// IMP=0x00000000004e38ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004e385e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004e380b
- (id)initWithPayload:(int)arg1 transportType:(unsigned char)arg2 encodingType:(unsigned char)arg3;	// IMP=0x00000000004e3796
