...
- (_Bool)filterPendingTemporalStreams;	// IMP=0x00000000000a388d
- (void)restart;	// IMP=0x00000000000a3622
- (void)unlock;	// IMP=0x00000000000a3614
- (void)lock;	// IMP=0x00000000000a3606
- (id)schedulerStreamWithVideoStream:(id)arg1;	// IMP=0x00000000000a3571
- (id)newVideoStreamKeyFrameScheduleWithStreamIDs:(id)arg1;	// IMP=0x00000000000a33e5
- (id)getMultiwayConfigForStreamID:(id)arg1;	// IMP=0x00000000000a31fa
- (void)handleStreamsResetIDR;	// IMP=0x00000000000a2c47
- (id)videoStreamPendingKeyFrameGenerationWithStreamID:(id)arg1 shouldRemoveFromPendingArray:(_Bool *)arg2;	// IMP=0x00000000000a24f1
- (void)handleStreamsPendingKeyFrameGeneration;	// IMP=0x00000000000a2235
- (_Bool)pauseStreams;	// IMP=0x00000000000a1e4a
- (_Bool)shouldGenerateIDRWithStreamSchedule:(id)arg1;	// IMP=0x00000000000a183b
- (_Bool)resumeStreams;	// IMP=0x00000000000a1219
- (id)delegate;	// IMP=0x00000000000a120b
- (void)initilizeStreamInfoMapWithStreamInfos:(id)arg1;	// IMP=0x00000000000a0da7
- (id)anchorStreamIDWithCappedVideoStreamIDs:(id)arg1;	// IMP=0x00000000000a09c3
- (_Bool)setStreamsUseRTCPWithStreamInfos:(id)arg1;	// IMP=0x00000000000a03c4
- (void)generateKeyFrameWithStreamID:(id)arg1 firType:(int)arg2;	// IMP=0x00000000000a0185
- (void)setIsLocalOnCellular:(_Bool)arg1 cappedVideoStreamIDs:(id)arg2;	// IMP=0x000000000009fa04
- (void)printPendingKeyFrameWarningOnThresholdTimeElapsedWithCurrentFrameTime:(float)arg1;	// IMP=0x000000000009f2a7
- (void)selectVideoStreamForVideoPriority;	// IMP=0x000000000009efda
- (void)setPendingVideoStreamsInternal:(id)arg1;	// IMP=0x000000000009ed17
- (void)setCachedActiveVideoStreams:(id)arg1;	// IMP=0x000000000009d47b
@property(readonly) NSDictionary *activeVideoStreams;
- (void)dealloc;	// IMP=0x000000000009d32e
- (id)initWithVideoStreams:(id)arg1 streamInfos:(id)arg2 reportingAgent:(struct opaqueRTCReporting *)arg3 delegate:(id)arg4;	// IMP=0x000000000009cfd0
