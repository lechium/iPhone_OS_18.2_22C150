...
- (void)addTxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x0000000000443b4b
- (void)addRxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x0000000000443ae2
...
- (void)dealloc;	// IMP=0x00000000004438bf
- (id)init;	// IMP=0x0000000000443840
