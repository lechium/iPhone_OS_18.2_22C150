...
- (id)valueForUndefinedKey:(id)arg1;	// IMP=0x000000000000ed14
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x000000000000ecf9
- (void)setAXAttribute:(id)arg1 value:(id)arg2;	// IMP=0x000000000000ecda
- (void)setAttribute:(id)arg1 value:(id)arg2;	// IMP=0x000000000000ec29
- (void)tmlObjectCompleted;	// IMP=0x000000000000ebd0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000eb87
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000000eaec
- (id)init;	// IMP=0x000000000000ead8
