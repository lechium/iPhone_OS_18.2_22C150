...
+ (id)decode:(const struct ProtobufCMessage *)arg1;	// IMP=0x006000000003884d
...
- (void)encode:(struct ProtobufCMessage *)arg1;	// IMP=0x000000000003860a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003844e
@property(readonly, nonatomic) Protocol *objcProtocol; // @synthesize objcProtocol=_objcProtocol;
- (void)addSignal:(id)arg1;	// IMP=0x0000000000038383
- (id)initWithName:(id)arg1 implementsProtocols:(id)arg2;	// IMP=0x00000000000382b3
