...
- (void).cxx_destruct;	// IMP=0x000000000002ebb1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002ea68
- (unsigned long long)hash;	// IMP=0x000000000002ea5e
- (void)notify:(id)arg1;	// IMP=0x000000000002ea04
- (id)initWithObserver:(id)arg1 keyPath:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x000000000002e927
