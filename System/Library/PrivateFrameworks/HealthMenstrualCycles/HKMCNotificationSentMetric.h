...
+ (id)eventName;	// IMP=0x0040000000008d19
...
- (id)description;	// IMP=0x0000000000008f5a
- (id)initWithCategory:(id)arg1 areHealthNotificationsAuthorized:(id)arg2;	// IMP=0x0000000000008d26
