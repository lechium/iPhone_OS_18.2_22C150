...
+ (id)eventName;	// IMP=0x004000000001f14b
- (void).cxx_destruct;	// IMP=0x000000000001f371
...
- (id)description;	// IMP=0x000000000001f287
- (id)initWithMethod:(id)arg1;	// IMP=0x000000000001f158
