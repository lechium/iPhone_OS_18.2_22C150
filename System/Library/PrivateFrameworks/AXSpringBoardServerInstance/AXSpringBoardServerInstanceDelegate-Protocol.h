...
- (void)setSecurePayAccessibilityFeaturesDisabled:(_Bool)arg1 withServerInstance:(_AXSpringBoardServerInstance *)arg2;
...
- (_Bool)isTypeToSiriVisibleWithServerInstance:(_AXSpringBoardServerInstance *)arg1;
...
- (_Bool)isContinuitySessionActiveWithServerInstance:(_AXSpringBoardServerInstance *)arg1;
...
- (_Bool)isRemoteTransientOverlayVisibleWithServerInstance:(_AXSpringBoardServerInstance *)arg1;
...
- (void)openTypeToSiriWithServerInstance:(_AXSpringBoardServerInstance *)arg1;
...
- (void)serverInstance:(_AXSpringBoardServerInstance *)arg1 showRemoteViewType:(long long)arg2 withData:(NSDictionary *)arg3 withPreviousViewDismissal:(_Bool)arg4;
