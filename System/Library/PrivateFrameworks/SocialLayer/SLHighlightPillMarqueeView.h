...
- (void).cxx_destruct;	// IMP=0x000000000001a51c
...
- (void)_deactivateMarqueeAnimationIfNecessary;	// IMP=0x000000000001a309
- (void)_activateMarqueeAnimationIfNecessary;	// IMP=0x000000000001a03b
- (void)updateConstraints;	// IMP=0x00000000000195ea
- (void)layoutSubviews;	// IMP=0x0000000000019300
- (id)initWithFrame:(struct CGRect)arg1 pillView:(id)arg2;	// IMP=0x0000000000018f54
