...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000242b
- (id)debugDescription;	// IMP=0x0000000000002357
- (Class)classForCoder;	// IMP=0x0000000000002346
@property int title_maxlines;
- (_Bool)hasDetail;	// IMP=0x0000000000002138
