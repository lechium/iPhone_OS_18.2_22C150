...
- (void)pui_setInvalidated:(id)arg1;	// IMP=0x0020000000044b73
...
- (void)pui_setInvalidated;	// IMP=0x00200000000447c0
...
- (void)pui_applyOtherSettings:(id)arg1;	// IMP=0x00200000000443e9
- (void)pui_applyToMutableSceneSettings:(id)arg1;	// IMP=0x002000000004410c
