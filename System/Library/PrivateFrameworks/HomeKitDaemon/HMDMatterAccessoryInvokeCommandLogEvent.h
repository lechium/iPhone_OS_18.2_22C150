...
- (void).cxx_destruct;	// IMP=0x0000000000061fd0
- (id)initWithStartTime:(double)arg1 homeUUID:(id)arg2;	// IMP=0x0000000000061f40
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x0000000000061e40
...
- (id)initWithHome:(id)arg1 nodeId:(unsigned long long)arg2 endpointId:(id)arg3 clusterId:(id)arg4 commandId:(id)arg5 fields:(id)arg6 source:(unsigned long long)arg7;	// IMP=0x0000000000061a60
...
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x00000000000400f0
