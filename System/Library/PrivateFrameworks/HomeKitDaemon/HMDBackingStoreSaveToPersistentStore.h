...
- (void).cxx_destruct;	// IMP=0x0000000000d56d9c
...
- (id)mainReturningError;	// IMP=0x0000000000d56be7
- (id)initWithHomeManager:(id)arg1 reason:(id)arg2 incrementGeneration:(_Bool)arg3;	// IMP=0x0000000000d56b23
