...
+ (id)messageName;	// IMP=0x00100000005b98fe
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000005b98f6
+ (id)objWithMessage:(id)arg1;	// IMP=0x00100000005b9735
+ (id)objWithDict:(id)arg1;	// IMP=0x00100000005b958e
- (void).cxx_destruct;	// IMP=0x00000000005b953b
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005b9346
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005b920b
