...
- (void).cxx_destruct;	// IMP=0x0000000000f164a8
...
- (void)rejectBulkSendSessionWithStatus:(unsigned short)arg1;	// IMP=0x0000000000f163f9
- (void)acceptBulkSendSessionOnQueue:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x0000000000f1636b
- (id)initWithProtocol:(id)arg1 requestHeader:(id)arg2 metadata:(id)arg3;	// IMP=0x0000000000f1628b
