...
+ (id)logCategory;	// IMP=0x00100000006a9b24
- (void).cxx_destruct;	// IMP=0x00000000006a9187
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006a8f47
- (void)monitorDidObserveExportComplete:(id)arg1;	// IMP=0x00000000006a8ea3
- (id)_retrieveExpectedObjectIDsTokenMap;	// IMP=0x00000000006a8768
- (void)_stopWithError:(id)arg1;	// IMP=0x00000000006a86c3
- (void)startWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000006a85ff
- (void)configure;	// IMP=0x00000000006a838c
- (id)initWithCurrentAccessoryUUID:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000006a82c9
