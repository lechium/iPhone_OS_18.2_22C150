...
- (void).cxx_destruct;	// IMP=0x00000000005b5627
@property(readonly) NSArray *parentRelationships; // @synthesize parentRelationships=_parentRelationships;
- (id)descriptionForRelationship:(id)arg1;	// IMP=0x00000000005b549a
- (id)descriptionForAttribute:(id)arg1;	// IMP=0x00000000005b5321
