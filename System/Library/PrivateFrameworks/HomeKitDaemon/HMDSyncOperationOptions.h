...
- (void).cxx_destruct;	// IMP=0x000000000094136f
...
- (id)description;	// IMP=0x0000000000941165
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 delayRespected:(_Bool)arg3;	// IMP=0x000000000094114d
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 cloudConflict:(_Bool)arg3 delayRespected:(_Bool)arg4;	// IMP=0x0000000000941098
