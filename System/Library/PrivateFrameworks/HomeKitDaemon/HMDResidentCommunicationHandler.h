...
+ (id)logCategory;	// IMP=0x00100000004332c9
+ (void)_clearAllPendingRequests:(id)arg1 error:(id)arg2;	// IMP=0x0010000000433195
+ (void)_clearAllGeneratedRequests:(id)arg1 error:(id)arg2;	// IMP=0x0010000000432f21
+ (id)createResponseSubset:(id)arg1 overallError:(id)arg2 readRequest:(id)arg3 error:(id *)arg4;	// IMP=0x00100000004324ac
+ (void)_processResponseForMultireadRequest:(id)arg1 overallError:(id)arg2 response:(id)arg3;	// IMP=0x0010000000431f21
- (void).cxx_destruct;	// IMP=0x00000000004313a3
...
- (id)logIdentifier;	// IMP=0x000000000043127c
- (void)_processResponse:(id)arg1 overallError:(id)arg2 messageIdentifier:(id)arg3;	// IMP=0x0000000000430d22
- (void)_sendMultipleCharacteristicRead;	// IMP=0x000000000042fe30
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000042fd78
- (void)redispatchMessage:(id)arg1 target:(id)arg2 responseQueue:(id)arg3;	// IMP=0x000000000042fc68
- (long long)preferredDeviceType;	// IMP=0x000000000042fb6e
@property(readonly, nonatomic) HMDDevice *preferredDevice;
- (id)deviceForType:(long long)arg1;	// IMP=0x000000000042fab6
- (_Bool)containsDevice:(id)arg1;	// IMP=0x000000000042f8c5
- (void)removeDeviceForType:(long long)arg1;	// IMP=0x000000000042f6e8
- (void)setDevice:(id)arg1 forType:(long long)arg2;	// IMP=0x000000000042f5f5
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000042f395
- (id)initWithHome:(id)arg1 remoteDispatcher:(id)arg2;	// IMP=0x000000000042f200
