...
+ (id)logCategory;	// IMP=0x0010000000acb55e
+ (id)sharedHandler;	// IMP=0x0010000000acb52e
- (void).cxx_destruct;	// IMP=0x0000000000acad79
...
- (void)deregisterRemoteRequestHandler:(id)arg1;	// IMP=0x0000000000acac7f
- (void)registerRemoteRequestHandler:(id)arg1 forSessionID:(id)arg2;	// IMP=0x0000000000acaba1
- (id)init;	// IMP=0x0000000000acaaab
