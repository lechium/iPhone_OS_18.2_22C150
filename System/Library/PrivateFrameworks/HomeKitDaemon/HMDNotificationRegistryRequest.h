...
- (void).cxx_destruct;	// IMP=0x0000000000a0e91c
...
- (id)attributeDescriptions;	// IMP=0x0000000000a0e657
- (id)initWithEnable:(_Bool)arg1 user:(id)arg2 deviceIdsDestination:(id)arg3;	// IMP=0x0000000000a0e596
