...
- (void).cxx_destruct;	// IMP=0x0000000000ee4921
...
- (void)dumpForLoggingWithPrefix:(id)arg1 logType:(unsigned char)arg2;	// IMP=0x0000000000ee46be
- (id)descriptionLines;	// IMP=0x0000000000ee43f1
- (id)description;	// IMP=0x0000000000ee42f4
