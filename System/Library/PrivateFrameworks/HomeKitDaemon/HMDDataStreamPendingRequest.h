...
- (void).cxx_destruct;	// IMP=0x000000000053ea1d
...
- (unsigned long long)hash;	// IMP=0x000000000053e9a7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000053e8d2
- (id)initWithIdentifier:(id)arg1 protocol:(id)arg2 topic:(id)arg3 payload:(id)arg4 callback:(CDUnknownBlockType)arg5;	// IMP=0x000000000053e7cd
