...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000720e43
- (void).cxx_destruct;	// IMP=0x0000000000720dbd
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000720ba2
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000720a44
