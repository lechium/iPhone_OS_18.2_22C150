...
@class CLRegion, CLVisit, NSArray, NSError;
@protocol HMDCLLocationManager;

@protocol HMDCLLocationManagerDelegate <NSObject>
- (void)locationManager:(id <HMDCLLocationManager>)arg1 didReportVisit:(CLVisit *)arg2;
- (void)locationManager:(id <HMDCLLocationManager>)arg1 didVisit:(CLVisit *)arg2;
