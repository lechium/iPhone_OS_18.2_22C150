...
+ (id)supportedEventClasses;	// IMP=0x0010000000c08603
- (void).cxx_destruct;	// IMP=0x0000000000c0825a
...
- (void)_injectThreadNetworkStateForTestingWithNumAdvertisedBRs:(unsigned long long)arg1 numAppleBRs:(unsigned long long)arg2 numThirdPartyBRs:(unsigned long long)arg3 numThreadNetworks:(unsigned long long)arg4 maxSimuIPPrefixesDetected:(unsigned long long)arg5 txTotal:(unsigned long long)arg6 txSuccess:(unsigned long long)arg7 txDelayAvg:(unsigned long long)arg8 rxTotal:(unsigned long long)arg9 rxSuccess:(unsigned long long)arg10 reportDuration:(unsigned long long)arg11 reportDate:(id)arg12 reportDailySummary:(_Bool)arg13;	// IMP=0x0000000000c07ea3
- (void)requestThreadNetworkStateCaptureForAccessory:(id)arg1 failingScenario:(int)arg2;	// IMP=0x0000000000c07e9d
- (void)generateLogForPeriodicReport:(id)arg1;	// IMP=0x0000000000c07e97
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000c07ddc
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000c07d21
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x0000000000c07beb
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x0000000000c07b0b
- (void)_updateDailyCountersAndResetCurrentReportStatsForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x0000000000c072b6
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2 isDailySummary:(_Bool)arg3;	// IMP=0x0000000000c06af5
- (void)_runLoggingForDate:(id)arg1 isDailySummary:(_Bool)arg2;	// IMP=0x0000000000c068fd
- (void)runDailyTask;	// IMP=0x0000000000c06879
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000c067b0
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x0000000000c0662a
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x0000000000c06487
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x0000000000c063a0
- (void)stop;	// IMP=0x0000000000c062ad
- (void)start;	// IMP=0x0000000000c0612c
- (void)_setDailyScheduler:(id)arg1;	// IMP=0x0000000000c06105
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 notificationCenter:(id)arg6;	// IMP=0x0000000000c05f60
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000c05e6a
