...
- (void).cxx_destruct;	// IMP=0x0000000000f3a5a3
...
- (id)attributeDescriptions;	// IMP=0x0000000000f3a439
@property(readonly) BGRepeatingSystemTaskRequest *taskRequest;
- (id)initWithTaskRequest:(id)arg1;	// IMP=0x0000000000f3a262
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000f3a1f4
