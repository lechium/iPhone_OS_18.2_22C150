...
- (void).cxx_destruct;	// IMP=0x0000000000435527
...
- (void)logRateTrigger:(id)arg1 triggerValue:(unsigned long long)arg2;	// IMP=0x000000000043517a
- (void)updatedCounter:(id)arg1 fromOldValue:(long long)arg2 toNewValue:(long long)arg3;	// IMP=0x0000000000434ddf
- (void)dealloc;	// IMP=0x0000000000434da5
- (id)initWithThreshold:(long long)arg1 windowSize:(long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4 ewsLogger:(id)arg5 timeSourceBlock:(CDUnknownBlockType)arg6;	// IMP=0x0000000000434c7f
- (id)initWithThreshold:(long long)arg1 windowSize:(long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4 ewsLogger:(id)arg5;	// IMP=0x0000000000434c5d
- (id)initWithThreshold:(long long)arg1 windowSize:(long long)arg2 counterName:(id)arg3 ewsLogger:(id)arg4;	// IMP=0x0000000000434c3b
