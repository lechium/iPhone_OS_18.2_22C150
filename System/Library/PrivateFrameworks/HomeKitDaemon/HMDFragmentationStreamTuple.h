...
+ (id)tupleWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0060000000d26ced
- (void).cxx_destruct;	// IMP=0x0000000000d26c9a
...
- (void)close;	// IMP=0x0000000000d26c19
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000d26a47
