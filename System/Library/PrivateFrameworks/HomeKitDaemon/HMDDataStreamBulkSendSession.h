...
+ (id)logCategory;	// IMP=0x0010000000f170c1
- (void).cxx_destruct;	// IMP=0x0000000000f16dc2
...
- (void)_pumpReadDataIfPossible;	// IMP=0x0000000000f16b8e
- (void)_closeSession;	// IMP=0x0000000000f16ab4
- (void)asyncHandleRemoteCloseWithError:(id)arg1;	// IMP=0x0000000000f169fc
- (void)asyncHandleIncomingPackets:(id)arg1 isEof:(_Bool)arg2;	// IMP=0x0000000000f16945
- (void)read:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f16805
- (void)cancelWithReason:(unsigned short)arg1;	// IMP=0x0000000000f16774
@property(readonly, getter=isActive) _Bool active;
- (void)dealloc;	// IMP=0x0000000000f1662e
- (id)initWithProtocol:(id)arg1 sessionIdentifier:(id)arg2 queue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000f164ef
