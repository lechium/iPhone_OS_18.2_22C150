...
- (void).cxx_destruct;	// IMP=0x00000000001aa03f
...
- (id)attributeDescriptions;	// IMP=0x00000000001a99de
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a982e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001a9823
- (unsigned long long)hash;	// IMP=0x00000000001a97df
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a9458
- (id)initWithUUID:(id)arg1;	// IMP=0x00000000001a9332
