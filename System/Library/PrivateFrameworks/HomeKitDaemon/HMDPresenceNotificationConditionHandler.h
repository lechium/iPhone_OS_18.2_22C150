...
+ (id)logCategory;	// IMP=0x0010000000e8718b
- (void).cxx_destruct;	// IMP=0x0000000000e87136
...
- (_Bool)conditionPasses:(id)arg1 registrationUser:(id)arg2;	// IMP=0x0000000000e869ff
- (_Bool)canHandleCondition:(id)arg1;	// IMP=0x0000000000e869b8
- (id)initWithHome:(id)arg1 presenceProvider:(id)arg2 featuresDataSource:(id)arg3;	// IMP=0x0000000000e868dc
- (id)initWithHome:(id)arg1;	// IMP=0x0000000000e8684a
