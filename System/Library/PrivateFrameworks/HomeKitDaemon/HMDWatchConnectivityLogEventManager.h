...
+ (id)sharedInstance;	// IMP=0x00100000006d022b
- (void).cxx_destruct;	// IMP=0x00000000006d0218
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006d00da
- (struct HMDWatchConnectivityLogEventManagerSnapshot)currentWatchConnectivitySnapshot;	// IMP=0x00000000006d0050
- (void)completeCurrentReport;	// IMP=0x00000000006cfeb4
- (void)incrementWatchRemovedNotificationCount;	// IMP=0x00000000006cfe7f
- (void)incrementWatchAddedNotificationCount;	// IMP=0x00000000006cfe4a
- (id)init;	// IMP=0x00000000006cfda5
