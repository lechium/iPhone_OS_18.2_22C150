...
+ (id)logCategory;	// IMP=0x0060000000221751
- (void).cxx_destruct;	// IMP=0x0000000000221654
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x0000000000220f8b
- (id)createSelectedAudioParameters;	// IMP=0x0000000000220ba9
- (id)createSRTPParamters;	// IMP=0x0000000000220b1e
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x0000000000220539
- (_Bool)selectAudioParameters;	// IMP=0x000000000021fcd2
- (id)logIdentifier;	// IMP=0x000000000021fc82
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x000000000021faf5
