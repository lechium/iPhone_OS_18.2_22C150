...
- (void).cxx_destruct;	// IMP=0x00000000003c67bf
...
- (id)mainReturningError;	// IMP=0x00000000003c6176
- (id)initWithGroup:(id)arg1 update:(_Bool)arg2 migration:(_Bool)arg3 fetchResult:(CDUnknownBlockType)arg4;	// IMP=0x00000000003c609b
