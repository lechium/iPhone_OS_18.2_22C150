...
- (void).cxx_destruct;	// IMP=0x00000000006dc176
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006dbf52
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006dbf47
- (unsigned long long)hash;	// IMP=0x00000000006dbe24
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006dbba3
- (id)attributeDescriptions;	// IMP=0x00000000006db881
- (id)init;	// IMP=0x00000000006db777
