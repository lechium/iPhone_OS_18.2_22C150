...
- (void).cxx_destruct;	// IMP=0x0000000000e8b09e
...
- (unsigned long long)hash;	// IMP=0x0000000000e8adbe
- (long long)compare:(id)arg1;	// IMP=0x0000000000e8acc8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e8a8f3
- (id)attributeDescriptions;	// IMP=0x0000000000e8a5f4
- (id)initWithManufacturer:(id)arg1 model:(id)arg2 appBundleID:(id)arg3 appStoreID:(id)arg4 firmwareVersion:(id)arg5 productData:(id)arg6 productDataAlternates:(id)arg7;	// IMP=0x0000000000e8a3f4
