...
- (void).cxx_destruct;	// IMP=0x0000000000cdc154
...
- (id)coreAnalyticsEventDictionary;	// IMP=0x0000000000cdc04b
- (id)coreAnalyticsEventName;	// IMP=0x0000000000cdc03e
- (id)initWithAccessory:(id)arg1 hmdAddRemoveEvent:(unsigned long long)arg2 forLinkType:(id)arg3;	// IMP=0x0000000000cdbfb4
