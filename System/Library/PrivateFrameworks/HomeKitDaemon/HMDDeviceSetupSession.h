...
+ (id)logCategory;	// IMP=0x001000000045e086
+ (_Bool)isRoleSupported:(long long)arg1;	// IMP=0x001000000045e052
- (void).cxx_destruct;	// IMP=0x000000000045d258
...
- (id)setupTrackingInfo;	// IMP=0x000000000045ceaa
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x000000000045ce36
- (void)_sendRequestData:(id)arg1;	// IMP=0x000000000045cc0f
- (void)_handleReceiveData:(id)arg1;	// IMP=0x000000000045cb72
- (void)close:(id)arg1;	// IMP=0x000000000045c9ff
- (void)_handleClose:(id)arg1;	// IMP=0x000000000045c836
- (void)_closeWithError:(id)arg1;	// IMP=0x000000000045c191
- (void)updateAccessoryUUIDAndNotifyDelegate:(id)arg1 accessoryIDSIdentifier:(id)arg2 accessoryCategory:(id)arg3;	// IMP=0x000000000045bfd6
- (void)open;	// IMP=0x000000000045bf05
- (void)__registerForMessages;	// IMP=0x000000000045bdb6
- (id)messageDispatcher;	// IMP=0x000000000045bd66
- (id)messageDestination;	// IMP=0x000000000045bcfd
@property(readonly) long long role;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000045bbd6
@property(readonly) unsigned long long hash;
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3 upSecondsFactory:(CDUnknownBlockType)arg4 userDefaults:(id)arg5;	// IMP=0x000000000045b72a
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3;	// IMP=0x000000000045b684
- (id)init;	// IMP=0x000000000045b5dc
