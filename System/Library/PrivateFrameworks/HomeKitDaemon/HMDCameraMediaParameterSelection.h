...
- (void).cxx_destruct;	// IMP=0x0000000000cd396a
...
- (void)setReselectedConfigParameters:(id)arg1 videoTier:(id)arg2;	// IMP=0x0000000000cd379f
- (void)setSelectedConfigParameters:(id)arg1;	// IMP=0x0000000000cd35f7
- (void)setSelectedEndPointSetupParameters:(id)arg1 videoNetworkConfig:(id)arg2 audioNetworkConfig:(id)arg3;	// IMP=0x0000000000cd3213
- (_Bool)findBestMatchWithProtocolParameters:(id)arg1 streamingCapabilities:(id)arg2 videoTierParameters:(id)arg3;	// IMP=0x0000000000cd2e5f
