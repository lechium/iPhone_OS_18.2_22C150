...
- (_Bool)isValidValue:(id)arg1 error:(id *)arg2;	// IMP=0x000000000073db8e
- (id)initWithMaxValue:(long long)arg1 minValue:(long long)arg2 stepValue:(long long)arg3;	// IMP=0x000000000073db3b
