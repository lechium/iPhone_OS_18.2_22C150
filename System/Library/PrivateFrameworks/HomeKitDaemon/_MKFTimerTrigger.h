...
+ (id)backingModelProtocol;	// IMP=0x00100000008929b4
+ (id)homeRelation;	// IMP=0x0010000000892984
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000008928d0
+ (id)fetchRequest;	// IMP=0x00100000009738cd
+ (Class)cd_modelClass;	// IMP=0x0010000000a51a52
- (id)castIfTimerTrigger;	// IMP=0x00000000008928c7
@property(readonly, copy, nonatomic) MKFTimerTriggerDatabaseID *databaseID;
- (void)awakeFromFetch;	// IMP=0x000000000089267f
