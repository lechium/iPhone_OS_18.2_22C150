...
- (void).cxx_destruct;	// IMP=0x0000000000c4b9fa
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000c4b856
- (unsigned long long)hash;	// IMP=0x0000000000c4b789
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c4b61b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c4b4e7
- (void)copyTo:(id)arg1;	// IMP=0x0000000000c4b404
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c4b350
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c4af5e
- (id)dictionaryRepresentation;	// IMP=0x0000000000c4ad53
- (id)description;	// IMP=0x0000000000c4aca4
- (void)clearOneofValuesForMessage;	// IMP=0x0000000000c4ac20
- (int)StringAsMessage:(id)arg1;	// IMP=0x0000000000c4ab4e
- (id)messageAsString:(int)arg1;	// IMP=0x0000000000c4ab06
