...
- (void).cxx_destruct;	// IMP=0x0000000000d16085
...
- (id)description;	// IMP=0x0000000000d15f9d
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x0000000000d15ed3
