...
- (void).cxx_destruct;	// IMP=0x0000000000c0b4a2
...
- (id)description;	// IMP=0x0000000000c0b3c7
- (unsigned long long)hash;	// IMP=0x0000000000c0b383
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c0b2a7
- (id)initWithIdentifier:(id)arg1 transports:(unsigned long long)arg2 setupHash:(id)arg3 delegate:(id)arg4;	// IMP=0x0000000000c0b1bd
- (id)init;	// IMP=0x0000000000c0b115
