...
- (void).cxx_destruct;	// IMP=0x0000000000008cf0
- (id)initWithStartTime:(double)arg1 homeUUID:(id)arg2;	// IMP=0x0000000000008c60
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x0000000000008b60
...
- (id)initWithHome:(id)arg1 nodeId:(unsigned long long)arg2 endpointId:(id)arg3 clusterId:(id)arg4 attributeId:(id)arg5 value:(id)arg6 timedWriteTimeout:(id)arg7;	// IMP=0x00000000000087d0
