...
- (void).cxx_destruct;	// IMP=0x00000000006a2cef
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006a2b01
- (id)description;	// IMP=0x00000000006a2a44
- (id)initWithProfile:(id)arg1 level:(id)arg2 videoTier:(id)arg3;	// IMP=0x00000000006a297a
