...
- (void).cxx_destruct;	// IMP=0x000000000040da5c
...
- (id)description;	// IMP=0x000000000040d9bd
- (void)dealloc;	// IMP=0x000000000040d8b3
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000040d7df
