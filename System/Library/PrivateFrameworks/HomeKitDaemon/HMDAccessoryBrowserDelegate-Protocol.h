...
@class HAP2AccessorySessionInfo, HAPAccessoryServer, HAPAccessoryServerBookkeeping, HMDAccessoryAdvertisement, HMDAccessoryBrowser, HMDMediaEndpoint, HMFOSTransaction, NSArray, NSError, NSNumber, NSString;
...
- (void)accessoryBrowser:(HMDAccessoryBrowser *)arg1 accessoryServer:(HAPAccessoryServer *)arg2 didUpdateConnectionState:(_Bool)arg3 linkLayerType:(long long)arg4 bookkeeping:(HAPAccessoryServerBookkeeping *)arg5 withError:(NSError *)arg6;
