...
- (void).cxx_destruct;	// IMP=0x0000000000ef0210
...
- (double)getTimeDurationForLongestProgressState;	// IMP=0x0000000000ef00ed
- (void)updateWithProgressState:(id)arg1 date:(id)arg2;	// IMP=0x0000000000eefa61
- (id)initWithDate:(id)arg1;	// IMP=0x0000000000eef9dc
