...
+ (id)eventWithReachable:(_Bool)arg1 changed:(_Bool)arg2 duration:(double)arg3 accessory:(id)arg4 transportReport:(id)arg5;	// IMP=0x00100000005998d4
- (void).cxx_destruct;	// IMP=0x000000000059985f
...
- (double)duration;	// IMP=0x0000000000599797
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (id)__initWithReachable:(_Bool)arg1 changed:(_Bool)arg2 duration:(double)arg3 accessory:(id)arg4 transportReport:(id)arg5;	// IMP=0x0000000000599043
- (id)init;	// IMP=0x0000000000598f9b
