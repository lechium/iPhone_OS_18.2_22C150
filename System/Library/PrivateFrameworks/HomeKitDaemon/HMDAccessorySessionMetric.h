...
+ (id)logCategory;	// IMP=0x0010000000cb1463
- (void).cxx_destruct;	// IMP=0x0000000000cb0d5f
...
- (id)logIdentifier;	// IMP=0x0000000000cb0a6d
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000cb0a67
- (void)updateReachableState:(_Bool)arg1;	// IMP=0x0000000000cb09ed
- (void)_resetSessionMetric;	// IMP=0x0000000000cb073f
- (void)resetSessionMetric;	// IMP=0x0000000000cb06ce
- (void)_submitMetric;	// IMP=0x0000000000cb0196
- (void)submitMetric;	// IMP=0x0000000000cb0125
- (void)_updateSessionState:(_Bool)arg1 linkLayerType:(long long)arg2 sessionInfo:(id)arg3 bookkeeping:(id)arg4 withError:(id)arg5;	// IMP=0x0000000000caf7fd
- (void)updateSessionState:(_Bool)arg1 linkLayerType:(long long)arg2 sessionInfo:(id)arg3 bookkeeping:(id)arg4 withError:(id)arg5;	// IMP=0x0000000000caf6d9
...
- (_Bool)isCurrentPrimaryResident;	// IMP=0x0000000000caf447
@property(readonly, nonatomic) double sessionCheckIntervalSec;
- (id)attributeDescriptions;	// IMP=0x0000000000caebb1
@property(readonly, copy, nonatomic) NSDictionary *state;
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 hapSessionTTRTimer:(id)arg3 hapSessionTTRAllowList:(id)arg4 radarInitiator:(id)arg5;	// IMP=0x0000000000cae3d3
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000cae300
