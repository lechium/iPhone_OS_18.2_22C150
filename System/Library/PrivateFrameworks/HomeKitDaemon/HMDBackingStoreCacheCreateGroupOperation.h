...
- (void).cxx_destruct;	// IMP=0x00000000003c1eac
...
- (id)mainReturningError;	// IMP=0x00000000003c1b7b
- (id)initWithZone:(id)arg1 owner:(id)arg2 rootRecord:(id)arg3 subscriptionName:(id)arg4 subscription:(id)arg5 creationBlock:(CDUnknownBlockType)arg6;	// IMP=0x00000000003c1a39
