...
+ (id)logCategory;	// IMP=0x0060000000968476
- (void).cxx_destruct;	// IMP=0x0000000000968335
...
- (void)_generateAllCombinations;	// IMP=0x00000000009666c2
- (id)createReselectedVideoParameters:(id)arg1;	// IMP=0x0000000000966557
- (id)createSelectedVideoParameters;	// IMP=0x000000000096616d
- (id)createSRTPParamters;	// IMP=0x00000000009660e2
- (_Bool)_selectParametersFromCodec:(id)arg1 profiles:(id)arg2 levels:(id)arg3 packetizationModes:(id)arg4 videoAttributes:(id)arg5;	// IMP=0x00000000009657c2
- (_Bool)selectVideoParameters;	// IMP=0x0000000000964853
- (id)logIdentifier;	// IMP=0x0000000000964803
- (void)_setVideoResolutionPreference;	// IMP=0x000000000096441f
- (id)initWithSessionID:(id)arg1 videoTierParameters:(id)arg2 supportedVideoConfiguration:(id)arg3 supportedRTPConfiguration:(id)arg4 streamingCapabilities:(id)arg5;	// IMP=0x0000000000964231
