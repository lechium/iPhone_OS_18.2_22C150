...
+ (id)logCategory;	// IMP=0x0060000000889374
- (void).cxx_destruct;	// IMP=0x0000000000889321
...
- (id)logIdentifier;	// IMP=0x0000000000889232
- (_Bool)acceptMessage:(id)arg1 target:(id)arg2 errorReason:(id *)arg3;	// IMP=0x000000000088866f
- (id)initWithTarget:(id)arg1 allowedMessages:(id)arg2 appleAccountManager:(id)arg3 systemKeychainStore:(id)arg4;	// IMP=0x0000000000888534
- (id)initWithTarget:(id)arg1 allowedMessages:(id)arg2;	// IMP=0x0000000000888474
- (id)initWithTarget:(id)arg1;	// IMP=0x0000000000888460
- (id)initWithName:(id)arg1;	// IMP=0x00000000008883ac
