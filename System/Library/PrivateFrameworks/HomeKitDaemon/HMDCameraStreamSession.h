...
+ (id)logCategory;	// IMP=0x0010000000e73b0d
- (void).cxx_destruct;	// IMP=0x0000000000e73aa9
...
- (id)logIdentifier;	// IMP=0x0000000000e739c8
- (id)negotiatedParameters;	// IMP=0x0000000000e73873
- (id)initWithSessionID:(id)arg1 streamingTierType:(unsigned long long)arg2 remoteCapabilities:(id)arg3 streamPreference:(id)arg4;	// IMP=0x0000000000e73445
