...
+ (id)logCategory;	// IMP=0x00100000004e568d
+ (id)shortDescription;	// IMP=0x00100000004e567b
+ (unsigned long long)cameraClipOperationType;	// IMP=0x00100000004e55d3
- (void).cxx_destruct;	// IMP=0x00000000004e553c
...
- (void)_markEndDateAndSubmitUploadOperationEvent;	// IMP=0x00000000004e4ffd
@property(readonly) double executionDuration;
- (id)updateClipModel:(id)arg1;	// IMP=0x00000000004e4c90
- (id)fetchClipModel;	// IMP=0x00000000004e4a27
- (void)cancelWithError:(id)arg1;	// IMP=0x00000000004e48e1
- (void)finish;	// IMP=0x00000000004e47b5
- (void)main;	// IMP=0x00000000004e4731
@property(readonly) double queuedDuration;
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2 dataSource:(id)arg3;	// IMP=0x00000000004e43ae
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2;	// IMP=0x00000000004e4328
