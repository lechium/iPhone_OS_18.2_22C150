...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000757756
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x00100000006c98f8
+ (id)ruleForHAP;	// IMP=0x00100000006c973d
- (void).cxx_destruct;	// IMP=0x0000000000756ed0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000756741
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000075660f
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000755fa8
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000755991
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 protocol:(id)arg3 advertisementProtocol:(id)arg4 flags:(id)arg5 serviceType:(id)arg6;	// IMP=0x000000000075586a
- (id)init;	// IMP=0x000000000075583b
- (void)addTo:(id)arg1;	// IMP=0x00000000006c72ee
