...
@class HAP2AccessorySessionInfo, HAPAccessoryInfo, HAPAccessoryServer, HAPAccessoryServerBookkeeping, HMFOSTransaction, NSArray, NSData, NSError, NSNumber, NSString, NSUUID;
...
- (void)accessoryServer:(HAPAccessoryServer *)arg1 didUpdateConnectionState:(_Bool)arg2 linkLayerType:(long long)arg3 bookkeeping:(HAPAccessoryServerBookkeeping *)arg4 withError:(NSError *)arg5;
