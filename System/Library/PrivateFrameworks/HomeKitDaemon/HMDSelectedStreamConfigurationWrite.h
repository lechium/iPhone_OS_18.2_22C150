...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001e7886
- (void).cxx_destruct;	// IMP=0x00000000001e7844
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e772e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e74dd
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000001e7341
- (_Bool)_parseFromTLVData;	// IMP=0x00000000001e705d
@property(readonly, copy) NSData *tlvData;
- (id)initWithSessionControl:(id)arg1;	// IMP=0x00000000001e6e74
- (id)initWithSessionControl:(id)arg1 videoParameters:(id)arg2 audioParameters:(id)arg3;	// IMP=0x00000000001e6daa
