...
+ (id)logCategory;	// IMP=0x00100000006921cd
+ (id)sharedPSKForNetworkWithSSID:(id)arg1;	// IMP=0x0010000000691f32
- (void).cxx_destruct;	// IMP=0x000000000068fec3
...
- (id)logIdentifier;	// IMP=0x000000000068fd5c
- (void)_performWiFiConfigurationControlRequest:(id)arg1 withDescription:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000068f665
- (void)_reconfigurationCompletedWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x000000000068f438
- (void)_commitConfigurationUpdate;	// IMP=0x000000000068f2ff
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000068f149
- (void)_accessoryDidBecomeReachable:(id)arg1;	// IMP=0x000000000068f0d8
- (void)safelyReconfigureWithSSID:(id)arg1 PSK:(id)arg2 verificationCallback:(CDUnknownBlockType)arg3 logEvent:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x000000000068ef6c
- (void)reconfigureWithSSID:(id)arg1 PSK:(id)arg2 logEvent:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000068ee2e
@property(readonly) NSNotificationCenter *notificationCenter;
@property(readonly) _Bool supportsStationConfiguration;
@property(readonly) long long capabilities;
- (id)initWithAccessory:(id)arg1 wiFiTransportService:(id)arg2 workQueue:(id)arg3;	// IMP=0x000000000068ecc9
