...
+ (id)tupleWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x006000000017f27f
- (void).cxx_destruct;	// IMP=0x000000000017f21b
...
- (void)updatePostingTime;	// IMP=0x000000000017f14f
- (id)initWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x000000000017f00c
