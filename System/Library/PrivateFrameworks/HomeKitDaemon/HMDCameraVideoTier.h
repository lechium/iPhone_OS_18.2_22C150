...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000cdca9a
- (void).cxx_destruct;	// IMP=0x0000000000cdca36
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000cdc881
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000cdc6ea
- (unsigned long long)hash;	// IMP=0x0000000000cdc6a6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cdc5ca
@property(readonly, nonatomic) long long quality;
- (id)description;	// IMP=0x0000000000cdc445
- (id)initWithVideoResolution:(id)arg1 framerate:(id)arg2 minBitRate:(id)arg3 maxBitRate:(id)arg4 rtcpInterval:(id)arg5;	// IMP=0x0000000000cdc328
