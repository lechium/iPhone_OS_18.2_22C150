...
- (void).cxx_destruct;	// IMP=0x000000000097aff0
...
- (id)attributeDescriptions;	// IMP=0x000000000097ac94
@property(readonly, getter=isExpired) _Bool expired;
@property(readonly, copy) NSUUID *deviceUUID;
- (id)initWithCameraUUID:(id)arg1 numberOfAvailableDevices:(long long)arg2 totalNumberOfJobSlots:(long long)arg3 remainingNumberOfJobSlots:(long long)arg4 analysisNode:(id)arg5 decisionDate:(id)arg6;	// IMP=0x000000000097aa73
