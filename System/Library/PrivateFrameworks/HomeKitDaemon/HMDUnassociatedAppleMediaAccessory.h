...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000522aa6
+ (id)logCategory;	// IMP=0x0010000000522a76
- (void).cxx_destruct;	// IMP=0x00000000005229ce
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000522598
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000052227e
- (id)logIdentifier;	// IMP=0x000000000052226c
- (id)dumpDescription;	// IMP=0x0000000000522052
- (_Bool)canPairGivenCapabilities:(unsigned long long)arg1;	// IMP=0x0000000000521ec9
- (id)addTransactionForHome:(id)arg1;	// IMP=0x0000000000521a38
...
- (id)descriptionWithPointer:(_Bool)arg1 additionalDescription:(id)arg2;	// IMP=0x000000000052153f
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 requiredPairingCapabilities:(unsigned long long)arg4 minimumPairingSoftware:(id)arg5 productColor:(long long)arg6 idsIdentifierString:(id)arg7 rawAccessoryCapabilities:(id)arg8 rawResidentCapabilities:(id)arg9 messageDispatcher:(id)arg10;	// IMP=0x00000000005213eb
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 category:(id)arg3 productColor:(long long)arg4 idsIdentifierString:(id)arg5 rawAccessoryCapabilities:(id)arg6 rawResidentCapabilities:(id)arg7 messageDispatcher:(id)arg8;	// IMP=0x00000000005213ab
- (id)modelForChangeType:(unsigned long long)arg1 uuid:(id)arg2 parentUUID:(id)arg3;	// IMP=0x000000000052132a
