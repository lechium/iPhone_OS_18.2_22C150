...
+ (id)supportedEventClasses;	// IMP=0x001000000068c169
- (void).cxx_destruct;	// IMP=0x000000000068bd7b
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000068bba8
- (void)checkNetworkChange;	// IMP=0x000000000068b6c3
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x000000000068b608
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x000000000068b54d
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x000000000068b001
- (void)runDailyTask;	// IMP=0x000000000068aaf1
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x000000000068aa28
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x000000000068a829
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x000000000068a5ad
- (void)_clearNonPersistentCounters;	// IMP=0x000000000068a4ea
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x000000000068a3b4
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x000000000068a2d4
- (void)_handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x000000000068a11f
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x000000000068a038
- (void)stop;	// IMP=0x0000000000689ea6
- (void)start;	// IMP=0x0000000000689c68
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 wifiManager:(id)arg6 notificationCenter:(id)arg7 changeDebounceTimer:(id)arg8 tickBlock:(CDUnknownBlockType)arg9;	// IMP=0x0000000000689a70
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000689908
