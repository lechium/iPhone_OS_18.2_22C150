...
+ (id)logCategory;	// IMP=0x0010000000369d1e
+ (id)coalescedEventFromHouseholdActivityLogEvents:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x001000000036972f
- (void).cxx_destruct;	// IMP=0x000000000036971c
...
- (id)serializedMetric;	// IMP=0x000000000036909d
- (id)initWithDictionary:(id)arg1 contributors:(id)arg2;	// IMP=0x0000000000368d90
- (id)initPopulatedFromDate:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x0000000000368bcc
- (id)initWithHomeUUID:(id)arg1 contributors:(id)arg2;	// IMP=0x0000000000368b48
