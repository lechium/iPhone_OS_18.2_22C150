...
- (void).cxx_destruct;	// IMP=0x00000000006a72fa
...
- (void)main;	// IMP=0x00000000006a70eb
- (id)initWithItemToPost:(id)arg1 followUpController:(id)arg2;	// IMP=0x00000000006a7020
