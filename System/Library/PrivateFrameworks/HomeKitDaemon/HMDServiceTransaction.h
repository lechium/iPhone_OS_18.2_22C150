...
+ (id)properties;	// IMP=0x00100000007d54ac
+ (id)cd_createMKFCharacteristicFromDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0010000000e59d85
+ (id)cd_modelTypeForCharacteristicFormat:(id)arg1;	// IMP=0x0010000000e59d29
+ (Class)cd_entityClass;	// IMP=0x0010000000e59d18
+ (id)cd_parentReferenceName;	// IMP=0x0010000000e59d0b
- (void).cxx_destruct;	// IMP=0x00000000007d547b
...
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000e595a8
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000e59275
- (_Bool)cd_updateManagedObjectInContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000e591a2
