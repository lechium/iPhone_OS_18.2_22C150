...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000f432ec
- (void).cxx_destruct;	// IMP=0x0000000000f432bb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000f431eb
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000f430ff
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000f42f95
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000f42c93
- (id)initWithAudioCodec:(id)arg1 codecParameters:(id)arg2;	// IMP=0x0000000000f42bf1
