...
+ (id)logCategory;	// IMP=0x0060000000a9fe0d
- (void).cxx_destruct;	// IMP=0x0000000000a9fdcb
...
- (id)attributeDescriptions;	// IMP=0x0000000000a9f9c1
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x0000000000a9f8c8
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000a9f484
