...
- (void).cxx_destruct;	// IMP=0x0000000000d0aa1c
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000d0a953
- (id)initWithTimeoutTimer:(id)arg1 workQueue:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000d0a837
