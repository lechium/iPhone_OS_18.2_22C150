...
- (void).cxx_destruct;	// IMP=0x0000000000d9cc4d
@property(readonly, nonatomic) __weak id <HMDPersistentStore> persistentStore; // @synthesize persistentStore=_persistentStore;
- (id)unarchive;	// IMP=0x0000000000d9c831
- (void)archiveDictionary:(id)arg1;	// IMP=0x0000000000d9c701
- (id)initWithPersistentStore:(id)arg1;	// IMP=0x0000000000d9c69d
