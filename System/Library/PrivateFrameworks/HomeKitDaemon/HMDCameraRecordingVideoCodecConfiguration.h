...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000b94672
- (void).cxx_destruct;	// IMP=0x0000000000b945e3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000b944cd
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000b94311
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000b94115
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000b93d33
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 videoAttributes:(id)arg3;	// IMP=0x0000000000b93c69
