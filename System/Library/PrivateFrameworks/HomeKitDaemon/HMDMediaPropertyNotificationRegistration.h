...
- (void).cxx_destruct;	// IMP=0x0000000000d7db94
...
- (id)attributeDescriptions;	// IMP=0x0000000000d7d873
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d7d868
- (unsigned long long)hash;	// IMP=0x0000000000d7d7b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d7d47b
- (id)initWithMediaProfileUniqueIdentifier:(id)arg1 mediaProperty:(id)arg2 deviceIdsDestination:(id)arg3 userUUID:(id)arg4 lastModified:(id)arg5 enabled:(_Bool)arg6;	// IMP=0x0000000000d7d34e
