...
@class CLLocation, HMDHomeNFCReaderKey, HMDNaturalLightingContext, HMFSoftwareVersion, MKFHomeDatabaseID, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSString, NSTimeZone, NSUUID, Protocol;
@protocol MKFAccessory, MKFAccessoryNetworkProtectionGroup, MKFActionSet, MKFAirPlayAccessory, MKFAppleMediaAccessory, MKFApplicationData, MKFDevice, MKFEventTrigger, MKFGuest, MKFGuestAccessCode, MKFHAPAccessory, MKFHomeMediaSetting, MKFHomeNetworkRouterManagingDeviceSetting, MKFHomeNetworkRouterSetting, MKFHomePerson, MKFHomePersonManagerSetting, MKFHomeSoftwareUpdateSetting, MKFHomeThreadNetwork, MKFMatterLocalKeyValuePair, MKFOutgoingInvitation, MKFRemovedUserAccessCode, MKFResident, MKFResidentSelection, MKFRoom, MKFServiceGroup, MKFTimerTrigger, MKFTrigger, MKFUser, MKFZone;
...
- (id <MKFResidentSelection>)findResidentSelectionsRelationWithModelID:(NSUUID *)arg1;
- (id <MKFResidentSelection>)materializeOrCreateResidentSelectionsRelationWithModelID:(NSUUID *)arg1 createdNew:(_Bool *)arg2;
...
- (id <MKFMatterLocalKeyValuePair>)findMatterControllerLocalKeyValuePairsRelationWithKey:(NSString *)arg1;
- (id <MKFMatterLocalKeyValuePair>)materializeOrCreateMatterControllerLocalKeyValuePairsRelationWithKey:(NSString *)arg1 createdNew:(_Bool *)arg2;
