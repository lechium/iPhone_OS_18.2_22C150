...
- (void)submitSuccess;	// IMP=0x00000000002178c6
- (void)submitFailureWithReason:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x0000000000217835
- (id)init;	// IMP=0x0000000000217806
