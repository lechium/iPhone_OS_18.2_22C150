...
+ (void)configureKeyedArchiverClassMappings;	// IMP=0x0010000000726cf7
- (void).cxx_destruct;	// IMP=0x0000000000726bd8
...
- (id)homeWithUUID:(id)arg1;	// IMP=0x000000000072673a
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007266e6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007266db
