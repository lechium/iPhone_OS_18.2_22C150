...
+ (id)logCategory;	// IMP=0x00600000003d4872
- (void).cxx_destruct;	// IMP=0x00000000003d1bd1
...
- (void)_finishStreamTransport;	// IMP=0x00000000003d18c8
- (id)_createTCPTransport;	// IMP=0x00000000003d165f
- (void)_generateStreamKeys;	// IMP=0x00000000003d1430
- (void)processTransportSetupResponse:(id)arg1;	// IMP=0x00000000003d0fe1
- (void)startSetup;	// IMP=0x00000000003d0a36
- (id)_fullKeySalt;	// IMP=0x00000000003d0992
- (_Bool)_isComplete;	// IMP=0x00000000003d0918
- (id)initWithAccessory:(id)arg1 queue:(id)arg2 logIdentifier:(id)arg3 transferManagementService:(id)arg4;	// IMP=0x00000000003d08b5
