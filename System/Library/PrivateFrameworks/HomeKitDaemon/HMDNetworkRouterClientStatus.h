...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000763c43
- (void).cxx_destruct;	// IMP=0x0000000000763230
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000762aa1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000076296f
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000762308
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000761ced
- (id)initWithClientIdentifier:(id)arg1 macAddress:(id)arg2 ipAddressList:(id)arg3 lanIdentifier:(id)arg4 name:(id)arg5 rssi:(id)arg6;	// IMP=0x0000000000761bc6
- (id)init;	// IMP=0x0000000000761b97
