...
+ (id)logCategory;	// IMP=0x0010000000e746b5
- (void).cxx_destruct;	// IMP=0x0000000000e74686
...
- (void)addObserver:(SEL)arg1 name:(id)arg2 object:(id)arg3;	// IMP=0x0000000000e743b1
- (id)logIdentifier;	// IMP=0x0000000000e742dc
- (id)initWithRegisterer:(id)arg1;	// IMP=0x0000000000e74244
