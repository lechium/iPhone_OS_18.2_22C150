...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000007604ff
- (void).cxx_destruct;	// IMP=0x00000000007604d7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007601e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000760157
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000075fe7c
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000075faf5
- (id)initWithOperation:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000075fa5c
- (id)init;	// IMP=0x000000000075fa2d
