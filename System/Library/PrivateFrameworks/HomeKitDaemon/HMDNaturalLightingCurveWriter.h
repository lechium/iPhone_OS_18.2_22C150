...
+ (id)logCategory;	// IMP=0x0010000000f727b2
- (void).cxx_destruct;	// IMP=0x0000000000f721ce
...
- (_Bool)supportsDeviceWithCapabilities:(id)arg1;	// IMP=0x0000000000f7209b
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000f71d41
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)writeForNaturalLightingEnabledWithReason:(id)arg1;	// IMP=0x0000000000f71c3c
- (void)synchronizeCurveWithActiveTransitionContext:(id)arg1;	// IMP=0x0000000000f717a1
- (void)writeWithNaturalLightingEnabled:(_Bool)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000f71582
- (void)handleCurrentDevicePrimaryResidentChangedWithReason:(id)arg1;	// IMP=0x0000000000f7139b
- (void)handlePrimaryResidentUpdateNotification:(id)arg1;	// IMP=0x0000000000f712e3
- (void)handleActiveTransitionContextUpdated:(id)arg1;	// IMP=0x0000000000f70a56
- (void)configureWithLightProfile:(id)arg1;	// IMP=0x0000000000f7077d
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3 dataSource:(id)arg4 notificationCenter:(id)arg5 timerFactory:(CDUnknownBlockType)arg6;	// IMP=0x0000000000f70632
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3;	// IMP=0x0000000000f70550
