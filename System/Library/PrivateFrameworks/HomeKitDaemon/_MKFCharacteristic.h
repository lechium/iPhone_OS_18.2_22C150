...
+ (id)backingModelProtocol;	// IMP=0x0010000000836deb
+ (id)homeRelation;	// IMP=0x0010000000836dbb
+ (id)fetchRequest;	// IMP=0x0010000000de04fc
...
- (id)castIfCharacteristic;	// IMP=0x00000000008373ff
@property(readonly, copy, nonatomic) MKFCharacteristicDatabaseID *databaseID;
- (void)pr_updateWithHAPMetadata:(id)arg1;	// IMP=0x00000000008372fb
- (void)pr_updateWithDictionary:(id)arg1;	// IMP=0x00000000008370de
