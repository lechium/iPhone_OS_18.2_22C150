...
+ (id)logCategory;	// IMP=0x0010000000bb5f9b
- (void).cxx_destruct;	// IMP=0x0000000000bb5925
...
- (void)_backgroundTimerDidExpire:(id)arg1;	// IMP=0x0000000000bb53ba
- (void)_removeBackgroundTimer:(id)arg1;	// IMP=0x0000000000bb5273
- (id)_enableBackgroundTimerWithBundleIdentifier:(id)arg1;	// IMP=0x0000000000bb4fee
- (void)handleProcessWithBundleIdentifier:(id)arg1 updatedIsActive:(_Bool)arg2;	// IMP=0x0000000000bb4dff
- (id)initWithQueue:(id)arg1 timerProvider:(id)arg2 applicationsAndIntervals:(id)arg3 dataSource:(id)arg4;	// IMP=0x0000000000bb4c8e
