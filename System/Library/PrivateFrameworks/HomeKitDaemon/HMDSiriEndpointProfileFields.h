...
- (void).cxx_destruct;	// IMP=0x0000000000a0c0a8
...
- (id)attributeDescriptions;	// IMP=0x0000000000a0bd0f
- (id)serializeFields;	// IMP=0x0000000000a0bb16
- (id)initWithNeedsOnboardingField:(id)arg1 supportsOnboardingField:(id)arg2 siriEnableField:(id)arg3 siriListeningField:(id)arg4 siriTouchToUseField:(id)arg5 siriLightOnUseField:(id)arg6 siriSoundOnUseField:(id)arg7;	// IMP=0x0000000000a0b903
