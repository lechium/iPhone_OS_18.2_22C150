...
+ (id)localIPAddress;	// IMP=0x00100000008981e3
- (void).cxx_destruct;	// IMP=0x00000000008981b2
...
- (id)description;	// IMP=0x000000000089805c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000897f79
- (id)initWithAddress:(id)arg1 ipv6:(_Bool)arg2 rtpPort:(id)arg3;	// IMP=0x0000000000897ed6
- (id)init;	// IMP=0x0000000000897e97
