...
- (void).cxx_destruct;	// IMP=0x0000000000b59beb
...
- (void)forceRefresh;	// IMP=0x0000000000b59b27
- (void)markDeleted;	// IMP=0x0000000000b59b16
- (void)markChanged;	// IMP=0x0000000000b59b05
- (id)initWithZoneID:(id)arg1;	// IMP=0x0000000000b59a4e
