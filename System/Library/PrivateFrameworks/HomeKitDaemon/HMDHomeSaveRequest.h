...
- (void).cxx_destruct;	// IMP=0x0000000000c6aedc
...
- (void)_updateSaveOptions:(_Bool)arg1 reason:(id)arg2;	// IMP=0x0000000000c6ae33
- (id)initWithReason:(id)arg1 information:(id)arg2 saveOptions:(unsigned long long)arg3;	// IMP=0x0000000000c6ae0b
- (id)initWithReason:(id)arg1 information:(id)arg2 postSyncNotification:(_Bool)arg3;	// IMP=0x0000000000c6adde
- (id)initWithHome:(id)arg1 reason:(id)arg2 information:(id)arg3 postSyncNotification:(_Bool)arg4 objectChange:(_Bool)arg5;	// IMP=0x0000000000c6ad57
- (id)_initWithHome:(id)arg1 reason:(id)arg2 information:(id)arg3 postSyncNotification:(_Bool)arg4 objectChange:(_Bool)arg5 saveOptions:(unsigned long long)arg6;	// IMP=0x0000000000c6ac4d
