...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000075f06e
+ (id)configurationForFirewallConfiguration:(id)arg1 hapAccessory:(_Bool)arg2 airplayAccessory:(_Bool)arg3 withClientIdentifier:(id)arg4;	// IMP=0x00100000006c9cf2
+ (id)configurationForOpenProtectionWithClientIdentifier:(id)arg1;	// IMP=0x00100000006c9c3c
+ (id)configurationWithClientIdentifier:(id)arg1 lanIdentifier:(long long)arg2;	// IMP=0x00100000006c9b3c
- (void).cxx_destruct;	// IMP=0x000000000074fb53
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000074f51f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000074f417
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000074ee90
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000074e908
- (id)initWithClientIdentifier:(id)arg1 lanIdentifier:(id)arg2 credential:(id)arg3 wanFirewallConfiguration:(id)arg4 lanFirewallConfiguration:(id)arg5;	// IMP=0x000000000074e801
- (id)init;	// IMP=0x000000000074e7d2
