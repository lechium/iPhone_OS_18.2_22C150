...
- (void).cxx_destruct;	// IMP=0x0000000000a9d8d2
...
- (void)netServiceBrowser:(id)arg1 didStopBrowsingWithError:(id)arg2;	// IMP=0x0000000000a9d5ae
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2;	// IMP=0x0000000000a9d3ac
- (void)netServiceBrowser:(id)arg1 didAddService:(id)arg2;	// IMP=0x0000000000a9d1aa
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000a9d0db
- (void)_updateTimerWithTimeout:(double)arg1;	// IMP=0x0000000000a9cf78
- (void)_removeBrowser:(id)arg1;	// IMP=0x0000000000a9cf02
- (void)_addBrowser:(id)arg1;	// IMP=0x0000000000a9ce8c
@property(nonatomic) unsigned long long state; // @synthesize state=_state;
@property(readonly, nonatomic, getter=isStarted) _Bool started;
- (unsigned long long)discoveredServicesCountForServiceType:(id)arg1;	// IMP=0x0000000000a9ccd7
- (void)_stopBrowsers;	// IMP=0x0000000000a9c82f
- (void)stop;	// IMP=0x0000000000a9c7be
- (_Bool)_startBrowsers;	// IMP=0x0000000000a9c429
- (void)startWithBrowsingCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a9c371
- (id)initWithServicesOfTypes:(id)arg1 browsingTimeInterval:(double)arg2 browsingPeriodicity:(double)arg3 workQueue:(id)arg4;	// IMP=0x0000000000a9c0ea
