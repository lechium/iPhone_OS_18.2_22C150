...
- (void).cxx_destruct;	// IMP=0x0000000000b486c2
...
- (id)mainReturningError;	// IMP=0x0000000000b48159
- (id)initWithAtomicSaveEnabled:(_Bool)arg1 transaction:(id)arg2;	// IMP=0x0000000000b480c6
- (id)initWithTransaction:(id)arg1;	// IMP=0x0000000000b4807f
