...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0060000000e5ddd6
- (void).cxx_destruct;	// IMP=0x0000000000e5dda3
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x0000000000e5dc08
