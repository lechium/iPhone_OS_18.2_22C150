...
- (void).cxx_destruct;	// IMP=0x0000000000e584cd
...
- (id)attributeDescriptions;	// IMP=0x0000000000e581ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e58145
- (unsigned long long)hash;	// IMP=0x0000000000e58101
- (long long)compare:(id)arg1 outCriteria:(unsigned long long *)arg2;	// IMP=0x0000000000e57a94
- (long long)compare:(id)arg1;	// IMP=0x0000000000e57a80
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithResident:(id)arg1 enabled:(id)arg2 location:(long long)arg3 accessories:(id)arg4;	// IMP=0x0000000000e575da
- (id)initWithResident:(id)arg1 dictionaryRepresentation:(id)arg2;	// IMP=0x0000000000e573e4
