...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001e6175
- (void).cxx_destruct;	// IMP=0x00000000001e6122
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e5fc6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e5ce4
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000001e5abf
- (_Bool)_parseFromTLVData;	// IMP=0x00000000001e57d4
@property(readonly, copy) NSData *tlvData;
- (id)initWithCodec:(id)arg1 codecParameter:(id)arg2 attribute:(id)arg3 rtpParameter:(id)arg4;	// IMP=0x00000000001e54f4
