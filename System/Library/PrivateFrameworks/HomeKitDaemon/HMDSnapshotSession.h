...
+ (id)logCategory;	// IMP=0x0010000000a513c5
- (void).cxx_destruct;	// IMP=0x0000000000a51361
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x0000000000a50e77
- (void)dealloc;	// IMP=0x0000000000a50dfb
- (id)logIdentifier;	// IMP=0x0000000000a50dab
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x0000000000a50bd4
