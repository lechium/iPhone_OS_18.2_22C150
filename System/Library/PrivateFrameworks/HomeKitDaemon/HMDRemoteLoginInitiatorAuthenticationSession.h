...
- (void).cxx_destruct;	// IMP=0x00000000006d9fca
...
- (id)description;	// IMP=0x00000000006d9f3c
- (void)dealloc;	// IMP=0x00000000006d9e32
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000006d9d81
