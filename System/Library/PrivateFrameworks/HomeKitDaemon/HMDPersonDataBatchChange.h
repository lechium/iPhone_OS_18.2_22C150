...
+ (id)logCategory;	// IMP=0x0010000000455eff
- (void).cxx_destruct;	// IMP=0x0000000000455e9d
...
- (id)attributeDescriptions;	// IMP=0x0000000000455d4c
- (id)logIdentifier;	// IMP=0x0000000000455cfc
- (void)commit;	// IMP=0x0000000000455959
- (void)removeFaceCropWithUUID:(id)arg1;	// IMP=0x000000000045581f
- (void)removePersonWithUUID:(id)arg1;	// IMP=0x00000000004556e7
- (void)addOrUpdateFaceCrop:(id)arg1;	// IMP=0x000000000045551e
- (void)addOrUpdatePerson:(id)arg1;	// IMP=0x00000000004553e6
- (id)initWithLocalInput:(id)arg1;	// IMP=0x00000000004552c9
