...
+ (id)allOtherHomesSingleAccessorySecurityFetchSpecifications;	// IMP=0x00400000003b3623
+ (id)mainHomeSecurityFetchSpecifications;	// IMP=0x00400000003b2f5a
+ (id)lightsFetchSpecifications;	// IMP=0x00400000003b2c4c
+ (id)allHomeLockScreenWidgetKinds;	// IMP=0x00400000003b2b88
- (void).cxx_destruct;	// IMP=0x00000000003b2b24
...
- (id)attributeDescriptions;	// IMP=0x00000000003b28e4
- (id)initWithName:(id)arg1 serviceTypes:(id)arg2 associatedServiceTypes:(id)arg3 characteristicTypes:(id)arg4 affectedWidgetKinds:(id)arg5;	// IMP=0x00000000003b2768
