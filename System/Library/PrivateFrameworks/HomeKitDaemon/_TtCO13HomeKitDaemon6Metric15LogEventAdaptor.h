...
- (void).cxx_destruct;	// IMP=0x0000000000138c20
- (id)initWithStartTime:(double)arg1 homeUUID:(id)arg2;	// IMP=0x0000000000138b90
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x0000000000138b30
