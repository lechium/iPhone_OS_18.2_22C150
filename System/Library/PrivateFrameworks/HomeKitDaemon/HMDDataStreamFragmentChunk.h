...
- (void).cxx_destruct;	// IMP=0x0000000000735951
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007358dc
- (unsigned long long)hash;	// IMP=0x00000000007357c9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000735551
- (id)attributeDescriptions;	// IMP=0x00000000007352da
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000734a40
- (id)initWithData:(id)arg1 sequenceNumber:(id)arg2 fragmentSequenceNumber:(id)arg3 type:(id)arg4 isLast:(_Bool)arg5;	// IMP=0x00000000007348a7
