...
+ (id)__decodeRulesFromNetworkDeclarations:(id)arg1 key:(id)arg2 class:(Class)arg3 required:(_Bool)arg4;	// IMP=0x0010000000ee94ff
+ (_Bool)__decodeFullAccessFromNetworkDeclarations:(id)arg1 key:(id)arg2 fullAccess:(_Bool *)arg3;	// IMP=0x0010000000ee9354
+ (_Bool)__decodeNetworkDeclarationsFromJSONDictionary:(id)arg1 networkDeclarations:(id *)arg2;	// IMP=0x0010000000ee90fd
+ (id)logCategory;	// IMP=0x0010000000ee90cd
- (void).cxx_destruct;	// IMP=0x0000000000ee9050
...
- (id)attributeDescriptions;	// IMP=0x0000000000ee8714
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ee833d
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000ee7fc5
- (id)initWithAccessoryIdentifier:(id)arg1 lastModifiedTime:(id)arg2 fullAccessLAN:(_Bool)arg3 lanRules:(id)arg4 fullAccessWAN:(_Bool)arg5 wanRules:(id)arg6;	// IMP=0x0000000000ee7ea0
