...
- (void).cxx_destruct;	// IMP=0x000000000049c7fa
...
- (id)attributeDescriptions;	// IMP=0x000000000049c5d0
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4;	// IMP=0x000000000049c4d3
