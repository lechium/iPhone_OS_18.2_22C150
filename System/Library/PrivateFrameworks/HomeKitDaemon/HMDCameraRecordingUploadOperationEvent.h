...
- (void).cxx_destruct;	// IMP=0x0000000000cca904
...
- (id)attributeDescriptions;	// IMP=0x0000000000cca4cd
- (id)initWithClipModelID:(id)arg1 operation:(id)arg2;	// IMP=0x0000000000cca41a
