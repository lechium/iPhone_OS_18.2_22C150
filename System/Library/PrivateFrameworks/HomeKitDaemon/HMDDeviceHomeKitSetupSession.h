...
- (void).cxx_destruct;	// IMP=0x0000000000b6bce3
...
- (void)markHasFailedRelayAttempt;	// IMP=0x0000000000b6bc6f
@property(readonly) _Bool shouldRelayRequest;
- (id)initWithFirstResidentForHome:(_Bool)arg1 clientConnection:(id)arg2;	// IMP=0x0000000000b6bbbf
