...
- (void).cxx_destruct;	// IMP=0x00000000003c3403
...
- (id)mainReturningError;	// IMP=0x00000000003c2f87
- (id)initWithGroup:(id)arg1 recordNames:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000003c2ed1
