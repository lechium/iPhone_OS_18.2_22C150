...
- (void).cxx_destruct;	// IMP=0x00000000003d5659
...
- (id)initWithIdentifier:(id)arg1 uuid:(id)arg2 name:(id)arg3 description:(id)arg4;	// IMP=0x00000000003d5391
- (id)init;	// IMP=0x00000000003d52e9
