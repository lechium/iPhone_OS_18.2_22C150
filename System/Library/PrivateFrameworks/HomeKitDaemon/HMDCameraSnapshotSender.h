...
+ (id)logCategory;	// IMP=0x00100000006ca752
- (void).cxx_destruct;	// IMP=0x00000000006ca5d3
...
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x00000000006ca165
- (id)logIdentifier;	// IMP=0x00000000006ca115
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 device:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6;	// IMP=0x00000000006c9f8c
