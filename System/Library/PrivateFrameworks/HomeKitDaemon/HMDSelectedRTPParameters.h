...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001e54ec
- (void).cxx_destruct;	// IMP=0x00000000001e5466
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e5216
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e4d81
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000001e4b3f
- (_Bool)_parseFromTLVData;	// IMP=0x00000000001e47c1
@property(readonly, copy) NSData *tlvData;
- (id)initWithPayloadType:(id)arg1 maximumBitrate:(id)arg2 minimumBitrate:(id)arg3 rtcpInterval:(id)arg4 comfortNoisePayloadType:(id)arg5;	// IMP=0x00000000001e4489
