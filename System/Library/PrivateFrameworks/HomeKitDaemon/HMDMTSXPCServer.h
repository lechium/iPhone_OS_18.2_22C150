...
- (void).cxx_destruct;	// IMP=0x000000000020aebd
...
- (void)start;	// IMP=0x000000000020accf
- (id)initWithPairingServer:(id)arg1 deviceSetupServer:(id)arg2 authorizationServer:(id)arg3 xpcServer:(id)arg4;	// IMP=0x000000000020ab7a
- (id)initWithPairingServer:(id)arg1 deviceSetupServer:(id)arg2 authorizationServer:(id)arg3;	// IMP=0x000000000020aaad
