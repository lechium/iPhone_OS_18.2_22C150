...
- (id)initWithReason:(long long)arg1 currentMemoryUsage:(unsigned long long)arg2 intervalMaxMemoryUsage:(unsigned long long)arg3;	// IMP=0x0000000000ddd97b
- (id)init;	// IMP=0x0000000000ddd8d3
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000f85d72
