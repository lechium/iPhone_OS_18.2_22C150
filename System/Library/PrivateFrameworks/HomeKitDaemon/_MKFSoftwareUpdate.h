...
+ (id)backingModelProtocol;	// IMP=0x001000000095320b
+ (id)homeRelation;	// IMP=0x00100000009531db
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000009531c2
+ (id)fetchRequest;	// IMP=0x00100000008008d9
+ (Class)cd_modelClass;	// IMP=0x0010000000ae6880
@property(readonly) id <MKFHome> home;
- (id)castIfSoftwareUpdate;	// IMP=0x0000000000953290
