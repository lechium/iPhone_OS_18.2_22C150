...
- (void).cxx_destruct;	// IMP=0x0000000000a6b6e1
...
- (void)main;	// IMP=0x0000000000a6b08b
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a6afbe
