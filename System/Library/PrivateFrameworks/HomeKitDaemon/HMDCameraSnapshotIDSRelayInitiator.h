...
+ (id)logCategory;	// IMP=0x0010000000ddbe9a
- (void).cxx_destruct;	// IMP=0x0000000000ddb963
...
- (void)_callFileTransferFailed:(id)arg1;	// IMP=0x0000000000ddb778
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000ddb5b6
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000ddb41a
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2;	// IMP=0x0000000000ddb288
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2;	// IMP=0x0000000000ddb0f6
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2;	// IMP=0x0000000000ddafab
- (void)dealloc;	// IMP=0x0000000000ddae2c
- (void)_startDataTransfer;	// IMP=0x0000000000ddab3f
- (void)sendIDSInvitation;	// IMP=0x0000000000dda64e
- (void)_sendData;	// IMP=0x0000000000dda5b5
- (void)sendData:(id)arg1;	// IMP=0x0000000000dda3ab
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3 device:(id)arg4 delegate:(id)arg5;	// IMP=0x0000000000dda211
