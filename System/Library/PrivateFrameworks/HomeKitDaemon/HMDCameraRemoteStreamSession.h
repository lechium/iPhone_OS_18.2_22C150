...
+ (id)logCategory;	// IMP=0x001000000091a115
- (void).cxx_destruct;	// IMP=0x000000000091a08d
...
- (id)logIdentifier;	// IMP=0x0000000000919fef
@property(readonly, copy) NSString *stateDescription;
- (_Bool)containsState:(long long)arg1;	// IMP=0x0000000000919ee9
- (void)updateState:(long long)arg1;	// IMP=0x0000000000919d82
- (id)initWithSessionID:(id)arg1 reachabilityPath:(unsigned long long)arg2 streamSender:(id)arg3 streamReceiver:(id)arg4 remoteCapabilities:(id)arg5 streamPreference:(id)arg6;	// IMP=0x0000000000919c55
