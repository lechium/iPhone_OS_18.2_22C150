...
+ (id)sharedManager;	// IMP=0x0060000000cdbcee
- (void).cxx_destruct;	// IMP=0x0000000000cdb8aa
...
- (void)dealloc;	// IMP=0x0000000000cdb678
- (id)initWithNotificationCenter:(id)arg1 followUpManager:(id)arg2 darwinNotificationProvider:(id)arg3;	// IMP=0x0000000000cdb34e
