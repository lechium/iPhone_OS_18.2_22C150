...
+ (id)properties;	// IMP=0x00100000008f3887
+ (Class)cd_entityClass;	// IMP=0x001000000060a05b
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000609cea
