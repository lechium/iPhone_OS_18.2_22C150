...
+ (id)updateMultipleCharacteristicReadWriteResponsePayload:(id)arg1 withUnhandledRequests:(id)arg2;	// IMP=0x0060000000eeeece
+ (id)notificationUpdateMessagePayloadForHome:(id)arg1 notificationEnabled:(_Bool)arg2 characteristics:(id)arg3 characteristicsErrorsMap:(id)arg4;	// IMP=0x0060000000eee6c7
+ (id)responsePayloadForHome:(id)arg1 changedAccessories:(id)arg2 moreMessagesInMultipart:(id)arg3;	// IMP=0x0060000000eee579
- (void).cxx_destruct;	// IMP=0x0000000000eee515
...
- (id)attributeDescriptions;	// IMP=0x0000000000eee25d
- (id)notificationWithHome:(id)arg1;	// IMP=0x0000000000eee0ed
- (id)initWithRequestIdentifier:(id)arg1 responses:(id)arg2 pendingMultiPartResponses:(_Bool)arg3;	// IMP=0x0000000000eed082
