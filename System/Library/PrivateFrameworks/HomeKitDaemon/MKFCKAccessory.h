...
+ (id)fetchRequest;	// IMP=0x0080000000fadfbc
- (_Bool)exportFromLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x0000000000a9e793
- (_Bool)importIntoLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x0000000000a9dd7b
- (_Bool)isReadyToImportIntoLocalModelWithContext:(id)arg1;	// IMP=0x0000000000a9dc33
