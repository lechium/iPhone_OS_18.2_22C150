...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000179b7d
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000179a1c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000017984f
@property(readonly, copy) NSString *name;
@property(readonly, copy) id value;
- (id)initWithIdentifier:(id)arg1 parentIdentifier:(id)arg2 type:(id)arg3 numberValue:(id)arg4 dataValue:(id)arg5;	// IMP=0x000000000017957b
