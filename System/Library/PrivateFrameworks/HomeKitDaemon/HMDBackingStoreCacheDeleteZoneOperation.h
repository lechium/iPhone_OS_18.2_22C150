...
- (void).cxx_destruct;	// IMP=0x00000000003c146b
...
- (id)mainReturningError;	// IMP=0x00000000003c0953
- (id)initWithZone:(id)arg1 resultBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000003c08c8
