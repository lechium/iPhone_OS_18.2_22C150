...
+ (id)meshInformationFromMessagePayload:(id)arg1 home:(id)arg2;	// IMP=0x0060000000a14fd0
+ (id)meshInformationWithMeshController:(id)arg1 home:(id)arg2;	// IMP=0x0060000000a14c5f
- (void).cxx_destruct;	// IMP=0x0000000000a14c2c
...
- (id)redactedDescription;	// IMP=0x0000000000a14be8
- (id)description;	// IMP=0x0000000000a14a7d
- (id)toMessagePayload;	// IMP=0x0000000000a14794
- (id)initWithResponder:(id)arg1 leader:(id)arg2 primary:(id)arg3 reachableIPAccessories:(unsigned long long)arg4 residentsInMesh:(unsigned long long)arg5;	// IMP=0x0000000000a146ba
