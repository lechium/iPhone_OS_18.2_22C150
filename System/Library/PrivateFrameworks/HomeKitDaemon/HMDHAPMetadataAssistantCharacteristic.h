...
- (void).cxx_destruct;	// IMP=0x00000000003d5aec
...
- (id)description;	// IMP=0x00000000003d58f2
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x00000000003d5754
- (id)init;	// IMP=0x00000000003d56ac
