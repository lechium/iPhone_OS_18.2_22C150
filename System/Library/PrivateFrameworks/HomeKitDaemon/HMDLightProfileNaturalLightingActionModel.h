...
+ (id)properties;	// IMP=0x00100000007bf1c5
+ (Class)cd_entityClass;	// IMP=0x0010000000a0e585
- (id)dependentUUIDs;	// IMP=0x00000000007bf53c
@property(getter=isNaturalLightingEnabled) _Bool naturalLightingEnabled;
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000a0e431
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000a0e2fe
