...
+ (id)exitLogEvent:(double)arg1 isFalse:(_Bool)arg2 isInitial:(_Bool)arg3;	// IMP=0x0010000000f03ea2
+ (id)entryLogEvent:(double)arg1 isFalse:(_Bool)arg2 isInitial:(_Bool)arg3;	// IMP=0x0010000000f03e54
...
- (id)initWithReason:(unsigned long long)arg1 isFalse:(_Bool)arg2 lastFired:(double)arg3 isInitial:(_Bool)arg4;	// IMP=0x0000000000f0392a
