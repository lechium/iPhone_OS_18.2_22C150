...
- (void).cxx_destruct;	// IMP=0x0000000000c55f51
...
- (void)handleUpdatedDestination:(id)arg1;	// IMP=0x0000000000c55e60
- (void)handleMediaDestinationUpdatedNotification:(id)arg1;	// IMP=0x0000000000c559e5
- (id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 notificationCenter:(id)arg3 dataSource:(id)arg4 delegate:(id)arg5;	// IMP=0x0000000000c55871
