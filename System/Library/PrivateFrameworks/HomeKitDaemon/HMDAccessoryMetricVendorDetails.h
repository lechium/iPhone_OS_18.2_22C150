...
+ (unsigned long long)maximumDifferentiationNumber;	// IMP=0x004000000076772e
- (void).cxx_destruct;	// IMP=0x00000000007675ac
...
- (id)attributeDescriptions;	// IMP=0x0000000000767316
- (id)initWithProductData:(id)arg1 manufacturer:(id)arg2 model:(id)arg3 firmwareVersion:(id)arg4 category:(id)arg5 differentiationNumber:(id)arg6;	// IMP=0x00000000007671d0
- (id)initWithAccessory:(id)arg1;	// IMP=0x0000000000766a3a
