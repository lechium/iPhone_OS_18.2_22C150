...
+ (id)diagnosticInfoDescriptionWithData:(id)arg1;	// IMP=0x0060000000446888
- (void).cxx_destruct;	// IMP=0x000000000044687a
...
- (id)diagnosticInfoDataWithAdditionalKeys:(id)arg1;	// IMP=0x0000000000446809
- (id)_diagnosticInfoWithAdditionalKeys:(id)arg1;	// IMP=0x00000000004457ad
- (id)initWithDataSource:(id)arg1 isHH2Mode:(_Bool)arg2;	// IMP=0x000000000044573e
