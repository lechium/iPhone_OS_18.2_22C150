...
+ (id)backingModelProtocol;	// IMP=0x00100000006c3cfa
+ (id)homeRelation;	// IMP=0x00100000006c3cca
+ (id)modelIDForKeyAttribute:(id)arg1 parent:(id)arg2;	// IMP=0x00100000006c3c3d
+ (id)fetchRequest;	// IMP=0x0010000000a70902
+ (Class)cd_modelClass;	// IMP=0x0010000000e59cfa
@property(readonly, retain, nonatomic) NSArray *serviceGroups;
@property(readonly, retain, nonatomic) NSArray *eventCharacteristics;
- (void)synchronizeCharacteristicsRelationWith:(id)arg1;	// IMP=0x00000000006c4312
- (id)findCharacteristicsRelationOfTypeStringCharacteristicWithInstanceID:(id)arg1;	// IMP=0x00000000006c42ef
- (id)createCharacteristicsRelationOfTypeStringCharacteristicWithInstanceID:(id)arg1;	// IMP=0x00000000006c42cc
- (id)materializeOrCreateCharacteristicsRelationOfTypeStringCharacteristicWithInstanceID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x00000000006c42a6
- (id)findCharacteristicsRelationOfTypeIntegerCharacteristicWithInstanceID:(id)arg1;	// IMP=0x00000000006c4283
- (id)createCharacteristicsRelationOfTypeIntegerCharacteristicWithInstanceID:(id)arg1;	// IMP=0x00000000006c4260
- (id)materializeOrCreateCharacteristicsRelationOfTypeIntegerCharacteristicWithInstanceID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x00000000006c423a
- (id)findCharacteristicsRelationOfTypeFloatCharacteristicWithInstanceID:(id)arg1;	// IMP=0x00000000006c4217
- (id)createCharacteristicsRelationOfTypeFloatCharacteristicWithInstanceID:(id)arg1;	// IMP=0x00000000006c41f4
- (id)materializeOrCreateCharacteristicsRelationOfTypeFloatCharacteristicWithInstanceID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x00000000006c41ce
- (id)findCharacteristicsRelationOfTypeCharacteristicWithInstanceID:(id)arg1;	// IMP=0x00000000006c41ab
- (id)createCharacteristicsRelationOfTypeCharacteristicWithInstanceID:(id)arg1;	// IMP=0x00000000006c4188
- (id)materializeOrCreateCharacteristicsRelationOfTypeCharacteristicWithInstanceID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x00000000006c4162
- (id)createCharacteristicsRelationOfType:(id)arg1 instanceID:(id)arg2;	// IMP=0x00000000006c40e7
- (id)materializeOrCreateCharacteristicsRelationOfType:(id)arg1 instanceID:(id)arg2 createdNew:(_Bool *)arg3;	// IMP=0x00000000006c4066
@property(retain, nonatomic) NSArray *characteristics;
- (id)materializeOrCreateApplicationDataRelation:(_Bool *)arg1;	// IMP=0x00000000006c3f67
@property(readonly, retain, nonatomic) NSArray *actionCharacteristicWrites;
@property(readonly) id <MKFHome> home;
- (id)castIfService;	// IMP=0x00000000006c3eb7
@property(readonly, copy, nonatomic) MKFServiceDatabaseID *databaseID;
- (id)pr_findCharacteristicWithInstanceID:(id)arg1;	// IMP=0x00000000006c3d49
- (_Bool)shouldIncludeForRestrictedGuestWithContext:(id)arg1;	// IMP=0x0000000000a1930d
