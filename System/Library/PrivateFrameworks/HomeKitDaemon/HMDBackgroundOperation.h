...
+ (id)logCategory;	// IMP=0x0010000000927308
+ (id)predicate;	// IMP=0x0010000000927260
- (void).cxx_destruct;	// IMP=0x00000000009271a9
...
- (id)dumpState;	// IMP=0x0000000000926ea0
- (id)attributeDescriptions;	// IMP=0x0000000000926b79
- (id)logIdentifier;	// IMP=0x0000000000926b29
- (id)AllDependencies;	// IMP=0x0000000000926ac9
- (_Bool)hasDependency:(id)arg1;	// IMP=0x0000000000926a27
- (void)removeDependency:(id)arg1;	// IMP=0x0000000000926993
- (void)addDependency:(id)arg1;	// IMP=0x00000000009268fc
- (_Bool)isDeferred;	// IMP=0x0000000000926855
@property(retain) NSDate *deferralDate; // @synthesize deferralDate=_deferralDate;
- (void)deferWithFailureCount:(long long)arg1;	// IMP=0x00000000009266d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009263ad
- (void)markOperationFinished;	// IMP=0x0000000000926396
- (_Bool)runOperation:(id)arg1;	// IMP=0x0000000000925ed3
@property(readonly) long long qualityOfService;
- (id)initWithUserData:(id)arg1 dataSource:(id)arg2 backGroundOpsManager:(id)arg3;	// IMP=0x0000000000925db7
- (id)initWithUserData:(id)arg1;	// IMP=0x0000000000925ce2
- (id)initWithUUID:(id)arg1 userData:(id)arg2 backGroundOpsManager:(id)arg3 scheduledDate:(id)arg4 expirationDate:(id)arg5 dataSource:(id)arg6 dependentOperations:(id)arg7;	// IMP=0x0000000000925b08
- (_Bool)mainWithError:(id *)arg1;	// IMP=0x0000000000925a60
