...
@interface HMDHomeConfigurationLogEvent : HMMHomeLogEvent
{
    ...
    _Bool _isResidentSelectionEnabled;	// 24 = 0x18
...
- (void).cxx_destruct;	// IMP=0x000000000077442e
...
- (void)updateConfigWithAccessory:(id)arg1 reportNetworkProtectionMetrics:(_Bool)arg2 networkProtectionEnabled:(_Bool)arg3 hapServiceTypes:(id)arg4 primaryHAPServiceTypes:(id)arg5;	// IMP=0x000000000076fb74
- (id)initWithDataSource:(id)arg1 home:(id)arg2 configuredWidgetsCount:(long long)arg3;	// IMP=0x000000000076d591
- (id)initWithHome:(id)arg1 configuredWidgetsCount:(long long)arg2;	// IMP=0x000000000076d579
- (long long)weeksSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x000000000076d513
- (long long)daysSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x000000000076d44c
- (void)setHomeConfigurationBitMasks;	// IMP=0x000000000076d330
