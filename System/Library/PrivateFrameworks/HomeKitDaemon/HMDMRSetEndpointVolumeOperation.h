...
+ (id)logCategory;	// IMP=0x001000000043e344
+ (id)shortDescription;	// IMP=0x001000000043e337
- (void).cxx_destruct;	// IMP=0x000000000043bedf
...
- (id)setVolumeOnEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000043b86c
- (id)getVolumeCapabilitiesForEndpoint:(id)arg1 outputDeviceUID:(id)arg2;	// IMP=0x000000000043b578
- (id)connectToEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000043b28e
- (id)discoverRemoteControlEndpointsForUIDs:(id)arg1;	// IMP=0x000000000043b09a
- (_Bool)cancelOnSetup;	// IMP=0x000000000043aa86
- (void)generateOverallResultAndFinishWithDeviceStatuses:(id)arg1 overallError:(id)arg2;	// IMP=0x0000000000439d58
- (void)main;	// IMP=0x0000000000439af3
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2;	// IMP=0x0000000000439a6d
- (id)initWithRouteIDs:(id)arg1 volume:(id)arg2 externalObjectInterface:(id)arg3;	// IMP=0x000000000043991b
