...
- (void).cxx_destruct;	// IMP=0x0000000000c0aab4
...
- (_Bool)matchesAccessoryServer:(id)arg1;	// IMP=0x0000000000c0a71d
- (_Bool)matchesUnpairedAccessory:(id)arg1;	// IMP=0x0000000000c0a64a
- (id)description;	// IMP=0x0000000000c0a469
- (id)initWithAccessoryDescription:(id)arg1 linkType:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3 progressHandler:(CDUnknownBlockType)arg4 pairingRequest:(id)arg5;	// IMP=0x0000000000c0a1e1
- (id)initWithAccessoryUUID:(id)arg1 accessoryName:(id)arg2 linkType:(long long)arg3 setupCode:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 setupCodeProvider:(CDUnknownBlockType)arg6 pairingRequest:(id)arg7;	// IMP=0x0000000000c0a047
