...
- (void).cxx_destruct;	// IMP=0x0000000000fa2703
...
- (void)executeSessionWithSessionData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000fa15be
- (id)initWithLogEventSubmitter:(id)arg1;	// IMP=0x0000000000fa14c6
