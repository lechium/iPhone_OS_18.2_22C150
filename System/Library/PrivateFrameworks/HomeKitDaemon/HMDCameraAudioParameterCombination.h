...
- (void).cxx_destruct;	// IMP=0x0000000000549709
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000549542
- (id)description;	// IMP=0x00000000005493e3
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3 maximumBitrate:(id)arg4 minimumBitrate:(id)arg5 rtcpInterval:(id)arg6 rtpPtime:(id)arg7;	// IMP=0x00000000005492ec
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3;	// IMP=0x0000000000549222
