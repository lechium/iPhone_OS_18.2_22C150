...
+ (id)localizedBodyForEcosystemName:(id)arg1 accessoryName:(id)arg2;	// IMP=0x0060000000cfec36
+ (id)localizedBodyForAppleEcosystemWithAccessoryName:(id)arg1;	// IMP=0x0060000000cfea7e
+ (id)localizedBodyForAccessoryName:(id)arg1;	// IMP=0x0060000000cfe8c6
+ (id)localizedTitle;	// IMP=0x0060000000cfe8b5
- (void).cxx_destruct;	// IMP=0x0000000000cfe851
...
- (id)attributeDescriptions;	// IMP=0x0000000000cfe530
- (id)initWithAddedPairing:(id)arg1 accessory:(id)arg2;	// IMP=0x0000000000cfde95
- (id)initWithTitle:(id)arg1 body:(id)arg2 threadIdentifier:(id)arg3 dateOfOccurrence:(id)arg4 userInfo:(id)arg5 isTimeSensitive:(_Bool)arg6;	// IMP=0x0000000000cfdca3
