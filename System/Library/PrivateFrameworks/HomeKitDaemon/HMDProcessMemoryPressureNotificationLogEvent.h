...
+ (id)createEventWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x00100000008827fc
- (void).cxx_destruct;	// IMP=0x00000000008827cb
...
- (id)initWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x00000000008825ac
