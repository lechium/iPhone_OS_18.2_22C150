...
- (void).cxx_destruct;	// IMP=0x0000000000eec38c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000eec1a1
- (unsigned long long)hash;	// IMP=0x0000000000eec0b7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000eebf1d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000eebdc4
- (void)copyTo:(id)arg1;	// IMP=0x0000000000eebcc1
- (void)writeTo:(id)arg1;	// IMP=0x0000000000eebbf0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000eeb783
- (id)dictionaryRepresentation;	// IMP=0x0000000000eeb52c
- (id)description;	// IMP=0x0000000000eeb47d
- (void)clearOneofValuesForRequest;	// IMP=0x0000000000eeb3e7
- (int)StringAsRequest:(id)arg1;	// IMP=0x0000000000eeb2f5
- (id)requestAsString:(int)arg1;	// IMP=0x0000000000eeb2ad
