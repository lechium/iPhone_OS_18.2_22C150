...
+ (id)backingModelProtocol;	// IMP=0x0010000000566f93
+ (id)fetchRequest;	// IMP=0x00100000005d292a
@property(readonly) id <MKFHome> home;
- (id)castIfIntegerCharacteristic;	// IMP=0x0000000000566f3a
@property(readonly, copy, nonatomic) MKFIntegerCharacteristicDatabaseID *databaseID;
- (void)pr_updateWithHAPMetadata:(id)arg1;	// IMP=0x0000000000566de2
