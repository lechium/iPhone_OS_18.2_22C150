...
- (void).cxx_destruct;	// IMP=0x0000000000a0e2cd
...
- (id)attributeDescriptions;	// IMP=0x0000000000a0e183
- (id)initWithAudioAnalysisEventBulletinNotificationRegistration:(id)arg1 source:(id)arg2;	// IMP=0x0000000000a0e0e1
