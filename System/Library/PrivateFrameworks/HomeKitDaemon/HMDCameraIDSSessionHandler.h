...
+ (id)logCategory;	// IMP=0x001000000099fee2
- (void).cxx_destruct;	// IMP=0x000000000099fe8f
...
- (id)logIdentifier;	// IMP=0x000000000099fde7
- (void)startKeepAlive;	// IMP=0x000000000099fde1
- (void)dealloc;	// IMP=0x000000000099fcae
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2;	// IMP=0x000000000099fb68
