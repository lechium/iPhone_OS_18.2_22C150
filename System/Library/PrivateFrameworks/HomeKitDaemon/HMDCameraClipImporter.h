...
+ (id)logCategory;	// IMP=0x0010000000cae259
- (void).cxx_destruct;	// IMP=0x0000000000cac64f
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x0000000000cab745
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x0000000000cab5cc
