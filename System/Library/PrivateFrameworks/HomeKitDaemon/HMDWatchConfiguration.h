...
- (void).cxx_destruct;	// IMP=0x0000000000de2ede
...
- (void)setConfigVersion:(id)arg1 forHome:(id)arg2;	// IMP=0x0000000000de2d82
- (void)setHomeConfiguration:(id)arg1;	// IMP=0x0000000000de2af3
- (id)description;	// IMP=0x0000000000de2a33
- (id)initWithUniqueID:(id)arg1;	// IMP=0x0000000000de297e
