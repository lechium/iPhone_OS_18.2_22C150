...
@class CKDeviceToDeviceShareInvitationToken, CKRecordID, HAPPairingIdentity, HMDAccountHandle, HMDAccountIdentifier, MKFUserDatabaseID, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSString, NSUUID, Protocol;
@protocol MKFAccessory, MKFAirPlayAccessory, MKFAnalysisEventBulletinRegistration, MKFBulletinRegistration, MKFCameraAccessModeBulletinRegistration, MKFCameraReachabilityBulletinRegistration, MKFCameraSignificantEventBulletinRegistration, MKFCharacteristicBulletinRegistration, MKFHAPAccessory, MKFHome, MKFMatterBulletinRegistration, MKFNotificationRegistration, MKFNotificationRegistrationActionSet, MKFNotificationRegistrationCharacteristic, MKFNotificationRegistrationMediaProperty, MKFOutgoingInvitation, MKFPhotosPerson, MKFPresenceBulletinCondition, MKFUserAccessCode, MKFUserActivityStatus;
