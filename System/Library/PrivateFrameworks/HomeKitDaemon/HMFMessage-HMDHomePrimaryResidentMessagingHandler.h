...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000053526e
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000005351f7
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000005350cc
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000815d0a
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x0020000000815cbb
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000815c6c
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000a9b482
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000a9b418
- (_Bool)isRequestType;	// IMP=0x00100000001c1ed4
- (unsigned long long)homeManagerOptions;	// IMP=0x001000000053507b
...
- (_Bool)shouldWeProcessRemoteMessageDespiteNoRemoteAccessAllowedForUser:(id)arg1;	// IMP=0x0010000000d51446
- (id)userForHome:(id)arg1;	// IMP=0x0010000000d513af
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x0010000000d50ffc
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0010000000f57b2c
