...
+ (id)logCategory;	// IMP=0x0010000000e6e868
- (void).cxx_destruct;	// IMP=0x0000000000e6e534
...
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000e6e2a0
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000e6e115
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withContext:(id)arg5;	// IMP=0x0000000000e6d6cd
- (void)_didReceiveData:(id)arg1 error:(id)arg2;	// IMP=0x0000000000e6d584
- (void)dealloc;	// IMP=0x0000000000e6d405
- (void)_handleDataFromSocket:(id)arg1;	// IMP=0x0000000000e6cc44
- (void)_startDataReceive;	// IMP=0x0000000000e6caa5
- (id)logIdentifier;	// IMP=0x0000000000e6ca55
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 machOUUID:(id)arg3 workQueue:(id)arg4 sessionInviterDeviceVerifier:(id)arg5 delegate:(id)arg6;	// IMP=0x0000000000e6c847
