...
+ (id)logCategory;	// IMP=0x00100000007b25b3
+ (id)removingAccessory:(id)arg1 hapAccessory:(id)arg2;	// IMP=0x00100000007b24d9
+ (id)pairingAccessory:(id)arg1 home:(id)arg2 appIdentifier:(id)arg3 retry:(_Bool)arg4;	// IMP=0x00100000007b2403
+ (id)pairingAccessoryWithDescription:(id)arg1 home:(id)arg2;	// IMP=0x00100000007b2391
- (void).cxx_destruct;	// IMP=0x00000000007b2172
...
- (id)residentConfirmationToString:(long long)arg1;	// IMP=0x00000000007b19c0
- (void)updateResidentConfirmationDurationWithConfirmation:(long long)arg1;	// IMP=0x00000000007b1936
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)prepareForObservation;	// IMP=0x00000000007af8ee
@property(readonly) NSDate *endDate; // @synthesize endDate=_endDate;
- (void)markEndTime;	// IMP=0x00000000007af808
- (_Bool)_isMatterAccessory;	// IMP=0x00000000007af7f3
@property(readonly, nonatomic, getter=isMatterAccessory) _Bool matterAccessory;
- (void)_updateThreadPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000007af733
- (void)updateEventPropertiesWithHAPAccessory:(id)arg1;	// IMP=0x00000000007af2e3
- (void)updateEventPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000007af14f
- (void)pairedToServer:(id)arg1 certificationStatus:(long long)arg2 addedViaWAC:(_Bool)arg3 legacyWAC:(_Bool)arg4;	// IMP=0x00000000007aeedc
- (void)setAuthenticationMethod:(unsigned long long)arg1;	// IMP=0x00000000007aeeca
- (void)setAddedViaWAC:(_Bool)arg1;	// IMP=0x00000000007aeeb8
- (id)initWithAccessoryDescription:(id)arg1 home:(id)arg2;	// IMP=0x00000000007ae515
- (id)initWithUnpairedAccessory:(id)arg1 pairedAccessory:(id)arg2 hapAccessory:(id)arg3 appIdentifier:(id)arg4 retry:(_Bool)arg5 home:(id)arg6 isAddOperation:(_Bool)arg7 logEventStateManager:(id)arg8;	// IMP=0x00000000007ad4e9
