...
+ (id)logCategory;	// IMP=0x0010000000337b34
- (void).cxx_destruct;	// IMP=0x0000000000336ba7
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000003367a2
- (void)downlinkQualityChanged:(id)arg1;	// IMP=0x0000000000336623
- (void)updateReconfigurationMode:(_Bool)arg1;	// IMP=0x00000000003363d3
- (id)logIdentifier;	// IMP=0x00000000003363ad
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000003362b0
