...
- (void).cxx_destruct;	// IMP=0x00000000005fe2bd
@property(readonly, nonatomic) __weak HMDHomeManager *homeManager; // @synthesize homeManager=_homeManager;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005fe299
- (id)initWithHomeManager:(id)arg1;	// IMP=0x00000000005fe232
- (id)init;	// IMP=0x00000000005fe18a
