...
- (void).cxx_destruct;	// IMP=0x00000000007214cb
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000007213b8
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)timeout;	// IMP=0x0000000000721175
- (void)submitSuccess;	// IMP=0x00000000007210f9
- (_Bool)incrementCompleted;	// IMP=0x0000000000721085
- (id)initWithAccessoryUUID:(id)arg1 withKeyType:(unsigned long long)arg2 expectedCount:(long long)arg3 queue:(id)arg4;	// IMP=0x0000000000720f54
