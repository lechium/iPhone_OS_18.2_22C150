...
- (void).cxx_destruct;	// IMP=0x000000000040d548
...
- (void)dealloc;	// IMP=0x000000000040d41b
- (id)initWithSessionID:(id)arg1 cameraAccessory:(id)arg2 isLocal:(_Bool)arg3;	// IMP=0x000000000040d362
