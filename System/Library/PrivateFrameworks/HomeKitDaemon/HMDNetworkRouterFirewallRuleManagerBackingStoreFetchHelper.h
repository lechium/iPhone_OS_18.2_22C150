...
+ (unsigned long long)maxOperationDurationSeconds;	// IMP=0x001000000017deb3
+ (unsigned long long)maxRetryCount;	// IMP=0x001000000017de95
+ (unsigned long long)__integerForPreferenceKey:(id)arg1 defaultValue:(unsigned long long)arg2;	// IMP=0x001000000017ddb1
+ (id)logCategory;	// IMP=0x001000000017dd81
- (void).cxx_destruct;	// IMP=0x000000000017dd1d
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000017d8f9
- (void)finishWithError:(id)arg1;	// IMP=0x000000000017d8e2
- (void)finishWithResult:(id)arg1;	// IMP=0x000000000017d8ce
@property(nonatomic) _Bool shouldRetry;
- (void)dealloc;	// IMP=0x000000000017d3cf
- (id)initWithActivity:(id)arg1 options:(id)arg2 container:(id)arg3 useAnonymousRequests:(_Bool)arg4 promise:(id)arg5;	// IMP=0x000000000017d1e8
