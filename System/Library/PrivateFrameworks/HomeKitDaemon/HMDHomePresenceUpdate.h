...
- (void).cxx_destruct;	// IMP=0x00000000005ae62e
...
- (id)description;	// IMP=0x00000000005ae4fb
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x00000000005ae420
