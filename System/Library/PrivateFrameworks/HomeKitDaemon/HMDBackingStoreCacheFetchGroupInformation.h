...
- (void).cxx_destruct;	// IMP=0x00000000003c3ac3
...
- (id)mainReturningError;	// IMP=0x00000000003c3865
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x00000000003c37a9
