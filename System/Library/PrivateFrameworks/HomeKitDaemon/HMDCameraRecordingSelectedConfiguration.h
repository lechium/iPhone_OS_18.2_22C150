...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000008b7c30
- (void).cxx_destruct;	// IMP=0x00000000008b7bee
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000008b7ad8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000008b79b3
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000008b77c6
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x00000000008b7413
- (id)initWithGeneralConfiguration:(id)arg1 videoCodecConfiguration:(id)arg2 audioCodecConfiguration:(id)arg3;	// IMP=0x00000000008b7349
