...
+ (id)logCategory;	// IMP=0x0010000000bc7b5e
- (void).cxx_destruct;	// IMP=0x0000000000bc7b0b
...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000bc7a11
- (id)initWithOptions:(id)arg1 changeToken:(id)arg2 promise:(id)arg3 database:(id)arg4 useAnonymousRequests:(_Bool)arg5 interestedRecordIDs:(id)arg6 mirrorInput:(id)arg7;	// IMP=0x0000000000bc7845
