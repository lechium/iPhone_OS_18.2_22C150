...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001e6da2
- (void).cxx_destruct;	// IMP=0x00000000001e6d4f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001e6bf3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e6911
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000001e66f9
- (_Bool)_parseFromTLVData;	// IMP=0x00000000001e643b
@property(readonly, copy) NSData *tlvData;
- (id)initWithCodecGroup:(id)arg1 codecParameter:(id)arg2 rtpParameter:(id)arg3 comfortNoiseEnabled:(id)arg4;	// IMP=0x00000000001e617d
