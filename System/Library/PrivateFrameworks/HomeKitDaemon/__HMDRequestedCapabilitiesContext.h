...
- (void).cxx_destruct;	// IMP=0x00000000008d64b3
...
- (id)initWithTransactionID:(id)arg1 requestedCapabilities:(id)arg2 destinationAddress:(id)arg3 responseQueue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000008d6331
