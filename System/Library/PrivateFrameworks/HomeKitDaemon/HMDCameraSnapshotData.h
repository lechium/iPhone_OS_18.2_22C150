...
- (void).cxx_destruct;	// IMP=0x00000000009a3b2c
...
- (void)dealloc;	// IMP=0x00000000009a3aa0
- (id)initWithSnapshotFile:(id)arg1 videoResolution:(id)arg2;	// IMP=0x00000000009a39bc
- (id)initWithSnapshotData:(id)arg1 videoResolution:(id)arg2 snapshotDataTrasaction:(id)arg3;	// IMP=0x00000000009a38f2
