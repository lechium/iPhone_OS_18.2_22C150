...
+ (id)logCategory;	// IMP=0x0010000000972eb9
+ (id)messageTargetUUIDFromHomeUUID:(id)arg1;	// IMP=0x0010000000972def
- (void).cxx_destruct;	// IMP=0x00000000009732d6
...
- (id)logIdentifier;	// IMP=0x00000000009731ce
- (void)residentChanged;	// IMP=0x00000000009731c8
- (void)handleHomeDataLoadedNotification:(id)arg1;	// IMP=0x00000000009731c2
- (void)_registerForMessages;	// IMP=0x0000000000973174
- (void)configure:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x0000000000973104
- (void)_initialize:(id)arg1;	// IMP=0x0000000000972f20
