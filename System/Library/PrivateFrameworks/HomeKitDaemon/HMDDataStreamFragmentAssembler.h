...
- (void).cxx_destruct;	// IMP=0x00000000003cfd86
...
- (_Bool)addFragmentChunk:(id)arg1 error:(id *)arg2;	// IMP=0x00000000003cf6f9
- (id)attributeDescriptions;	// IMP=0x00000000003cf484
- (id)initWithSequenceNumber:(id)arg1 type:(id)arg2;	// IMP=0x00000000003cf274
