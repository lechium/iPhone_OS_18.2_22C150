...
+ (id)backingModelProtocol;	// IMP=0x001000000096caa2
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000096ca89
+ (Class)cd_modelClass;	// IMP=0x00100000009ff658
+ (id)fetchRequest;	// IMP=0x0010000000c582d1
- (id)castIfMediaAccessory;	// IMP=0x000000000096cae9
