...
- (void).cxx_destruct;	// IMP=0x00000000006a67eb
...
- (void)_ensureNetworkInterfaceMonitorStopped;	// IMP=0x00000000006a6733
- (int)_ensureNetworkInterfaceMonitorStarted;	// IMP=0x00000000006a64b4
- (void)_update;	// IMP=0x00000000006a630f
- (void)stop;	// IMP=0x00000000006a62bd
- (void)start;	// IMP=0x00000000006a626b
- (void)dealloc;	// IMP=0x00000000006a61e7
- (id)init;	// IMP=0x00000000006a615e
