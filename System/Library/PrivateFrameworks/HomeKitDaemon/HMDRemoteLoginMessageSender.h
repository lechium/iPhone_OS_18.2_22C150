...
+ (id)logCategory;	// IMP=0x0010000000972a32
- (void).cxx_destruct;	// IMP=0x00000000009728a1
...
- (void)sendRemoteMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000097243b
- (id)logIdentifier;	// IMP=0x00000000009723eb
- (id)initWithTarget:(id)arg1 accessory:(id)arg2 device:(id)arg3 workQueue:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x00000000009722cb
