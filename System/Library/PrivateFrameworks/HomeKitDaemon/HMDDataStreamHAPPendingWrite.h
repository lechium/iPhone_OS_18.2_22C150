...
- (void).cxx_destruct;	// IMP=0x0000000000987da6
...
- (id)popNextFrameUpToMaxLength:(unsigned long long)arg1;	// IMP=0x0000000000987c88
- (_Bool)isComplete;	// IMP=0x0000000000987c27
- (id)initWithData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000987b7b
