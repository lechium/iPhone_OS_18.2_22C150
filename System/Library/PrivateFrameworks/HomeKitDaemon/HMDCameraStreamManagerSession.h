...
+ (id)logCategory;	// IMP=0x00100000001f1acc
- (void).cxx_destruct;	// IMP=0x00000000001f1a57
...
- (id)logIdentifier;	// IMP=0x00000000001f1961
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x00000000001f1782
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x00000000001f15ff
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x00000000001f14cc
