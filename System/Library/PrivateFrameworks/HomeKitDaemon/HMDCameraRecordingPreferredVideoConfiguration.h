...
- (void).cxx_destruct;	// IMP=0x0000000000b07c4c
...
- (id)description;	// IMP=0x0000000000b07ae0
- (id)initWithResolution:(long long)arg1 bitRateByFrameRate:(id)arg2 keyFrameInterval:(id)arg3 h264Level:(long long)arg4;	// IMP=0x0000000000b07a32
