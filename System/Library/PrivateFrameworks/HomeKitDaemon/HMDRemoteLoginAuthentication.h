...
+ (id)logCategory;	// IMP=0x001000000084d565
- (void).cxx_destruct;	// IMP=0x000000000084d512
...
- (void)authenticate;	// IMP=0x000000000084d426
- (id)logIdentifier;	// IMP=0x000000000084d414
- (id)initWithSessionID:(id)arg1 remoteDevice:(id)arg2 workQueue:(id)arg3 remoteMessageSender:(id)arg4;	// IMP=0x000000000084d317
