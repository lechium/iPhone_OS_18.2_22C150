...
+ (unsigned long long)aspectRatioOfResolution:(id)arg1;	// IMP=0x0010000000747278
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000747270
+ (void)translateCapabilities:(id)arg1;	// IMP=0x0010000000746b57
- (void).cxx_destruct;	// IMP=0x00000000007468cb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000007466d6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007463cc
- (void)updateWithRemoteSettings:(id)arg1;	// IMP=0x00000000007460b8
- (void)_updateWithStreamPreference:(id)arg1;	// IMP=0x000000000074593a
- (id)_supportedResolutionsWithOverrides;	// IMP=0x000000000074546d
- (id)initWithStreamPreference:(id)arg1;	// IMP=0x00000000007451a1
- (id)description;	// IMP=0x0000000000745073
