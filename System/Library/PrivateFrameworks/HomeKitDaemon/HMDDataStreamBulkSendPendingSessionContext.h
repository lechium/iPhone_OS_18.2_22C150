...
- (void).cxx_destruct;	// IMP=0x0000000000ab7aef
...
- (id)initWithSessionStartCallback:(CDUnknownBlockType)arg1 handleOpenRequestResponseTimer:(id)arg2 sendCloseEventTimer:(id)arg3;	// IMP=0x0000000000ab7970
