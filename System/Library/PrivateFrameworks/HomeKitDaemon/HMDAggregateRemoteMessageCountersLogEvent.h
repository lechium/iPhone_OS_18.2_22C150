...
+ (id)aggregateRemoteCountersLogEventWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 primaryResidentDuration:(double)arg5 count:(id)arg6;	// IMP=0x00100000007d88a7
- (void).cxx_destruct;	// IMP=0x00000000007d8843
...
- (id)initWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 primaryResidentDuration:(double)arg5 count:(id)arg6;	// IMP=0x00000000007d84af
