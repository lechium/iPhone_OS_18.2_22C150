...
+ (id)tupleForMessage:(id)arg1 originalRequestIdentifier:(id)arg2 requestCount:(unsigned long long)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0060000000236919
- (void).cxx_destruct;	// IMP=0x00000000002368b5
...
- (id)retrieveAndClearLatestResponses;	// IMP=0x000000000023670c
- (id)retrieveAndClearAllResponses;	// IMP=0x0000000000236656
- (void)addResponsesToPendingResponse:(id)arg1;	// IMP=0x0000000000236586
- (void)addToPendingResponses:(id)arg1;	// IMP=0x00000000002364be
- (id)description;	// IMP=0x00000000002363fd
