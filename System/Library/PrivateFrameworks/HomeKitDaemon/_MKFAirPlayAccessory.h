...
+ (id)backingModelProtocol;	// IMP=0x00100000005f5eb0
+ (id)homeRelation;	// IMP=0x00100000005f5e80
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000005f5dcc
+ (Class)cd_modelClass;	// IMP=0x0010000000877709
+ (id)fetchRequest;	// IMP=0x0010000000cd1acf
- (void)removePairedUsersObject:(id)arg1;	// IMP=0x00000000005f5fb1
- (void)addPairedUsersObject:(id)arg1;	// IMP=0x00000000005f5f95
@property(readonly, retain, nonatomic) NSArray *pairedUsers;
- (id)castIfAirPlayAccessory;	// IMP=0x00000000005f5f35
