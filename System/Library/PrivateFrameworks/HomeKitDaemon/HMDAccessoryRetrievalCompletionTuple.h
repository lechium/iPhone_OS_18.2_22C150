...
- (void).cxx_destruct;	// IMP=0x0000000000c6922a
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000c68dde
- (void)stop;	// IMP=0x0000000000c68d34
- (void)start;	// IMP=0x0000000000c68bbb
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c68aed
- (id)initWithHome:(id)arg1 accessory:(id)arg2 linkType:(long long)arg3;	// IMP=0x0000000000c689cc
