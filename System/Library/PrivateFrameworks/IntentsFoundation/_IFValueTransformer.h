...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000001e89
- (void).cxx_destruct;	// IMP=0x0000000000001e58
...
- (id)reverseTransformedValue:(id)arg1;	// IMP=0x0000000000001dc4
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000001d52
- (id)initWithForwardTransformation:(CDUnknownBlockType)arg1 reverseTransformation:(CDUnknownBlockType)arg2;	// IMP=0x0000000000001c8b
