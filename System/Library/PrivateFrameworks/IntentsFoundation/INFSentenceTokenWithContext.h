...
+ (id)sentenceResolvedTokenWithOriginalToken:(id)arg1 placeholderName:(id)arg2;	// IMP=0x0060000000002afc
...
- (id)initWithToken:(id)arg1 variableName:(id)arg2;	// IMP=0x00000000000029cf
