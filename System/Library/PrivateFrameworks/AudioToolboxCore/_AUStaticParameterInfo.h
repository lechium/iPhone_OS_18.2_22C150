...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000019f8dd
- (void).cxx_destruct;	// IMP=0x000000000019f8b5
...
- (void)dealloc;	// IMP=0x000000000019f7c6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019f4db
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019f3a5
