...
@class AUAudioUnitPreset, AUAudioUnitProperty, AUAudioUnitViewConfiguration, AVAudioFormat, AVSpeechSynthesisProviderRequest, MIDICIProfile, NSArray, NSData, NSDictionary, NSObject, NSString, NSUUID;
@protocol OS_xpc_object;

@protocol AUAudioUnitXPCProtocol <_AURemoteParameterSynchronization>
- (void)localCachingDisabled:(_Bool)arg1 newValue:(_Bool)arg2 reply:(void (^)(NSError *, _Bool))arg3;
- (void)retrieveInstanceUUID:(void (^)(NSError *, NSString *))arg1;
...
- (void)open:(struct AudioComponentDescription)arg1 instanceUUID:(NSUUID *)arg2 reply:(void (^)(NSError *, _Bool, _Bool, NSArray *, NSArray *, _Bool, _Bool, int, unsigned long long, unsigned long long))arg3;
@end
