...
- (_Bool)canRemoveAccount;	// IMP=0x003000000005ce96
- (id)_registeredBundles;	// IMP=0x003000000005ce7d
- (id)normalizedDSID;	// IMP=0x003000000005cc8d
- (id)dsid;	// IMP=0x003000000005cc71
- (void)setDSID:(id)arg1;	// IMP=0x003000000005cc55
- (id)appleID;	// IMP=0x003000000005cc43
- (void)storeOriginalUsername;	// IMP=0x003000000005cede
- (void)_aa_clearRawPassword;	// IMP=0x003000000009cff0
@property(copy, nonatomic, setter=_aa_setRawPassword:) NSString *_aa_rawPassword;
- (void)_aa_setPrimaryEmail:(id)arg1;	// IMP=0x003000000009ce39
- (void)_aa_setAltDSID:(id)arg1;	// IMP=0x003000000009cde7
- (void)_aa_setAppleID:(id)arg1;	// IMP=0x003000000009cd95
- (_Bool)aa_isDuplicateAccount:(id)arg1;	// IMP=0x003000000009c84e
- (_Bool)_aa_isExistingAccount:(id)arg1;	// IMP=0x003000000009c729
- (_Bool)aa_hasDuplicateAccount;	// IMP=0x003000000009c50c
- (void)_aa_setDataclassProperties:(id)arg1;	// IMP=0x003000000009c4fa
- (_Bool)aa_updateTokensWithProvisioningResponse:(id)arg1;	// IMP=0x003000000009bc29
- (void)aa_updateWithProvisioningResponse:(id)arg1;	// IMP=0x003000000009ae18
- (void)aa_setUseCellular:(_Bool)arg1 forDataclass:(id)arg2;	// IMP=0x003000000009ad49
- (_Bool)aa_useCellularForDataclass:(id)arg1;	// IMP=0x003000000009acd0
- (id)aa_hsaTokenWithError:(id *)arg1;	// IMP=0x003000000009ac8d
- (id)aa_authTokenWithError:(id *)arg1;	// IMP=0x003000000009abed
- (void)aa_setMDMServerToken:(id)arg1;	// IMP=0x003000000009aaad
@property(readonly, nonatomic) NSString *aa_mdmServerToken;
- (void)aa_setMapsToken:(id)arg1;	// IMP=0x003000000009a91d
...
- (void)_aa_setTermsServerInfo:(id)arg1;	// IMP=0x003000000009a2dc
- (id)_aa_termsServerInfo;	// IMP=0x003000000009a2cb
...
- (_Bool)_hasMailDataclassProperties;	// IMP=0x003000000009a193
- (_Bool)_dataclassIsDisabledForProperties:(id)arg1;	// IMP=0x003000000009a13e
- (_Bool)aa_serverDisabledDataclass:(id)arg1;	// IMP=0x003000000009a061
...
- (_Bool)aa_updateAccountClassIfNecessary;	// IMP=0x00300000000994a6
@property(copy, nonatomic, setter=aa_setAccountClass:) NSString *aa_accountClass;
- (_Bool)aa_isAccountClass:(id)arg1;	// IMP=0x003000000009927e
...
- (void)_aa_setAppProvidedContext:(id)arg1;	// IMP=0x003000000009d57a
- (id)_aa_appProvidedContext;	// IMP=0x003000000009d561
- (void)_aa_setPrimaryAccountUpdaterVersion:(id)arg1;	// IMP=0x003000000009d548
- (id)_aa_primaryAccountUpdaterVersion;	// IMP=0x003000000009d52f
- (void)_aa_setLastAgreedTermsInfo:(id)arg1;	// IMP=0x003000000009d4dd
- (void)_aa_setPersonID:(id)arg1;	// IMP=0x003000000009d48b
