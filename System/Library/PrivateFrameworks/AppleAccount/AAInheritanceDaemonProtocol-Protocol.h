...
- (void)setupBeneficiaryManifest:(AKBeneficiaryManifest *)arg1 contactInfo:(id <AAInheritanceContactInfo>)arg2 setupAuthToken:(NSString *)arg3 completion:(void (^)(AABeneficiary *, NSError *))arg4;
