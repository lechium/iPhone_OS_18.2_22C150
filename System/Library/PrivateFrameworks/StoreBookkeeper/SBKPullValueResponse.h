...
+ (id)responseWithResponse:(id)arg1 transaction:(id)arg2;	// IMP=0x0060000000022faa
- (void).cxx_destruct;	// IMP=0x000000000002315b
...
- (void)deserializeResponseBodyWithTransaction:(id)arg1;	// IMP=0x000000000002301e
