...
- (id)descriptionForSpatialMode:(int)arg1;	// IMP=0x000000000011d1c0
- (id)description;	// IMP=0x000000000011d122
- (id)initWithMode:(int)arg1 headTrackingEnabled:(_Bool)arg2;	// IMP=0x000000000011d0dc
