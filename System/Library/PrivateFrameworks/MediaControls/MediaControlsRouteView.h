...
- (void).cxx_destruct;	// IMP=0x00000000000c9153
...
- (void)_contentSizeCategoryDidChange;	// IMP=0x00000000000c8fa5
- (void)_updateLabelVisualStyling;	// IMP=0x00000000000c8e83
- (void)providedStylesDidChangeForProvider:(id)arg1;	// IMP=0x00000000000c8e71
- (void)showMessage:(id)arg1;	// IMP=0x00000000000c8cbe
- (void)setGlyphState:(id)arg1;	// IMP=0x00000000000c8be2
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000c8a46
- (void)layoutSubviews;	// IMP=0x00000000000c8407
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000c8182
