...
- (void).cxx_destruct;	// IMP=0x0000000000031fd9
...
- (id)pointerInteraction:(id)arg1 styleForRegion:(id)arg2;	// IMP=0x0000000000031bcd
- (id)pointerInteraction:(id)arg1 regionForRequest:(id)arg2 defaultRegion:(id)arg3;	// IMP=0x0000000000031a3a
- (void)launchNowPlayingAppButtonPressed;	// IMP=0x0000000000031a1d
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000031a0b
- (void)_handleContentSizeCategoryDidChangeNotification:(id)arg1;	// IMP=0x00000000000319f9
- (void)_updateRTL;	// IMP=0x0000000000031854
- (void)clearOverrideSize;	// IMP=0x0000000000031526
- (void)tintColorDidChange;	// IMP=0x0000000000030f2f
- (void)didMoveToWindow;	// IMP=0x0000000000030eac
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000030e55
- (void)updateArtworkStyle;	// IMP=0x0000000000030754
- (void)_updateStyle;	// IMP=0x0000000000030265
- (struct CGSize)layoutTextInAvailableBounds:(struct CGRect)arg1 setFrames:(_Bool)arg2;	// IMP=0x000000000002ef8d
- (void)layoutSubviews;	// IMP=0x000000000002e2dc
- (void)dealloc;	// IMP=0x000000000002e25a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002d3d8
