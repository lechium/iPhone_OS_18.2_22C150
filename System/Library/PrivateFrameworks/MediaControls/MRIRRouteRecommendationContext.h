...
+ (id)fromObject:(id)arg1;	// IMP=0x006000000012e360
- (void).cxx_destruct;	// IMP=0x000000000012e990
- (id)init;	// IMP=0x000000000012e940
@property(nonatomic, readonly) NSString *description;
- (id)initWithCandidateResults:(id)arg1 contextIdentifier:(id)arg2;	// IMP=0x000000000012e400
