...
- (void).cxx_destruct;	// IMP=0x000000000006af6b
...
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000006acc6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000006a9ea
