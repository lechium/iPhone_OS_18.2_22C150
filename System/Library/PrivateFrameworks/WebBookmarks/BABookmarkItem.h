...
- (void).cxx_destruct;	// IMP=0x000000000000947d
...
- (id)description;	// IMP=0x0000000000009370
- (id)initWithBookmarkCollection:(id)arg1 bookmark:(id)arg2;	// IMP=0x00000000000092c7
