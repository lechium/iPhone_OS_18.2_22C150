...
- (struct CGRect)alphaCroppedRect;	// IMP=0x000000000008f9b3
- (struct CGSize)originalUncroppedSize;	// IMP=0x000000000008f99d
- (struct CGImage *)createImageFromPDFRenditionWithScale:(double)arg1;	// IMP=0x000000000008f924
- (id)baseKey;	// IMP=0x000000000008f8f4
- (id)description;	// IMP=0x000000000008f5ff
...
- (long long)resizingModeWithSubtype:(long long)arg1;	// IMP=0x000000000008f4d8
...
- (double)positionOfSliceBoundary:(unsigned int)arg1;	// IMP=0x000000000008f23a
@property(readonly, nonatomic) long long imageType;
@property(readonly, nonatomic) struct CGSize size;
@property(readonly, nonatomic) struct CGImage *croppedImage;
@property(readonly, nonatomic) struct CGImage *image;
- (_Bool)_cacheRenditionProperties;	// IMP=0x000000000008ee67
- (id)initWithName:(id)arg1 usingRenditionKey:(id)arg2 fromTheme:(unsigned long long)arg3;	// IMP=0x000000000008edd7
