...
- (id)description;	// IMP=0x00000000000938a2
- (_Bool)shouldRespectOutputBlending;	// IMP=0x000000000009389a
- (_Bool)shouldIgnoreForegroundColor;	// IMP=0x0000000000093892
- (void)dealloc;	// IMP=0x0000000000093857
- (id)init;	// IMP=0x0000000000093828
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000093780
