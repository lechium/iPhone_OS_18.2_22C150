...
- (void)dealloc;	// IMP=0x00000000000af2f0
- (id)description;	// IMP=0x00000000000af1e6
- (unsigned int)effectType;	// IMP=0x00000000000af1db
- (id)init;	// IMP=0x00000000000af188
- (id)initWithEffectFromPreset:(id)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000004fc3f
- (_Bool)updateLayerEffectPreset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004f8d2
