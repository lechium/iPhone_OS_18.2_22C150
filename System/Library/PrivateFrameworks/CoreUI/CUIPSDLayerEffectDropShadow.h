...
- (void)dealloc;	// IMP=0x00000000000ae81e
- (unsigned int)effectType;	// IMP=0x00000000000ae813
- (id)init;	// IMP=0x00000000000ae7c0
- (id)initWithEffectFromPreset:(id)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000004e7b8
- (_Bool)updateLayerEffectPreset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004e5d5
