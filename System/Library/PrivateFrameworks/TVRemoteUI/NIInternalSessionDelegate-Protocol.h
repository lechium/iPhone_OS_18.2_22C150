...
#import <TVRemoteUI/NISessionDelegate-Protocol.h>

@class NIAlgorithmConvergenceState, NIBluetoothHostTimeSyncResponse, NINearbyObject, NIRegionPredicate, NISession, NSError;
