...
+ (id)modelElementWithMDLSubmesh:(MDLSubmesh *)arg1;
+ (id)meshElementWithData:(NSData *)arg1 primitiveType:(long long)arg2 primitiveCount:(long long)arg3 bytesPerIndex:(long long)arg4;
+ (id)meshElementWithData:(NSData *)arg1 primitiveType:(long long)arg2 primitiveCount:(long long)arg3 indicesChannelCount:(long long)arg4 interleavedIndicesChannels:(_Bool)arg5 bytesPerIndex:(long long)arg6;
