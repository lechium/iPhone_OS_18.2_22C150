...
- (id)ciImage;	// IMP=0x000000000009fa8e
- (id)textureForSliceIndex:(unsigned long long)arg1;	// IMP=0x000000000009f91e
- (_Bool)matchesDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000009f81d
@property(readonly, nonatomic) unsigned char renderBufferFormat;
@property(readonly, nonatomic) _Bool viewportDependant;
- (id)description;	// IMP=0x000000000009f76a
- (void)dealloc;	// IMP=0x000000000009f712
- (id)initWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000009f6b8
