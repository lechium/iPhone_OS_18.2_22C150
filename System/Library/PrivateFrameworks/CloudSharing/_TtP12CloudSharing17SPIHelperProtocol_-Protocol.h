...
@class CKContainerSetupInfo, CKShare, FPSandboxingURLWrapper, NSArray, NSData, NSString, NSURL;
...
- (void)addParticipantsToShareWithURLWrapper:(FPSandboxingURLWrapper *)arg1 share:(CKShare *)arg2 emailAddresses:(NSArray *)arg3 phoneNumbers:(NSArray *)arg4 permissionType:(long long)arg5 allowOthersToInvite:(_Bool)arg6 withReply:(void (^)(NSURL *, CKShare *, NSError *))arg7;
...
- (void)removeFromShareForFileURL:(NSURL *)arg1 withReply:(void (^)(_Bool, NSError *))arg2;
