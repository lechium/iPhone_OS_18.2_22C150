...
- (void)performRealtimeConnectivityCheckWithConfiguration:(AWDLTrafficRegistrationConfiguration *)arg1 completionHandler:(void (^)(NSNumber *))arg2;
- (void)queryAWDLState:(void (^)(WiFiP2PAWDLState *))arg1;
- (void)queryActiveServicesAndActivePortsWithCompletionHandler:(void (^)(NSArray *, NSArray *))arg1;
...
- (void)updateAWDLLTERestrictedChannels:(NSArray *)arg1 completionHandler:(void (^)(long long))arg2;
