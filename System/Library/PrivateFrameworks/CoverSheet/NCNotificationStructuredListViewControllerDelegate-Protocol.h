...
- (double)clippingOffsetForNotificationStructuredListViewController:(NCNotificationStructuredListViewController *)arg1;
...
- (void)notificationStructuredListViewControllerDidUpdateVisibleContentExtent:(NCNotificationStructuredListViewController *)arg1;
