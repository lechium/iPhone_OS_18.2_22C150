...
@class NSArray, PUAssetReference, PUOneUpPresentationHelper, PUOneUpViewController, PXSearchQueryMatchInfo, UIScrollView, UIView, UIViewController;
...
- (_Bool)oneUpPresentationHelperPreventAlbumAttributionWidget:(PUOneUpPresentationHelper *)arg1;
- (_Bool)oneUpPresentationHelperPreventPeopleOrnament:(PUOneUpPresentationHelper *)arg1;
- (_Bool)oneUpPresentationHelperPreventHideAssetAction:(PUOneUpPresentationHelper *)arg1;
