...
- (void)captureOutput:(AVCaptureFileOutput *)arg1 didStartRecordingToOutputFileAtURL:(NSURL *)arg2 startPTS:(CDStruct_198678f7)arg3 fromConnections:(NSArray *)arg4;
