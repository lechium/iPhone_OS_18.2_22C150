...
- (_Bool)cameraRollControllerShouldRequestUnlock:(CAMCameraRollController *)arg1;
- (void)cameraRollController:(CAMCameraRollController *)arg1 didRequestPasscodeUnlockForAction:(unsigned long long)arg2 completionBlock:(void (^)(_Bool))arg3;
