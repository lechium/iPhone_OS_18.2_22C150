...
+ (id)pkMediaNameWithString:(id)arg1;	// IMP=0x0060000000025b4a
...
- (void)parseMediaName:(id)arg1;	// IMP=0x0000000000025cfd
- (void)dealloc;	// IMP=0x0000000000025c52
- (id)initWithString:(id)arg1;	// IMP=0x0000000000025ba8
