...
- (void)af_saveItemSelection:(id)arg1 forType:(long long)arg2;	// IMP=0x00200000000d7402
- (id)af_assistedSelectionItem;	// IMP=0x00200000000d738a
@property(retain, nonatomic, setter=af_setDisambiguationInfo:) AFDisambiguationInfo *af_disambiguationInfo;
- (id)af_itemForIndexIdentifier:(id)arg1;	// IMP=0x00200000000d711e
- (id)af_indexIdentifierForItem:(id)arg1;	// IMP=0x00200000000d6f1e
