...
- (void)saveFeedbackInCoreDuetd:(NSString *)arg1 forSessionId:(NSString *)arg2 feedbackActionType:(long long)arg3 isFallbackFetch:(_Bool)arg4 reply:(void (^)(_Bool))arg5;
