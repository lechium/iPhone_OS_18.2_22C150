...
@class CSSearchableItemAttributeSet, IMDSpotlightIndexerTimingProfiler, NSArray, NSDictionary, NSMutableArray, NSString;
...
+ (NSArray *)auxiliaryItemsForPrimaryAttributes:(CSSearchableItemAttributeSet *)arg1 withItem:(NSDictionary *)arg2 chat:(NSDictionary *)arg3 isReindexing:(_Bool)arg4 timingProfiler:(IMDSpotlightIndexerTimingProfiler *)arg5 rejectedItems:(NSMutableArray *)arg6;
