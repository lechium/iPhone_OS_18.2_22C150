...
+ (_Bool)_navigation_isLocation:(id)arg1 equalTo:(id)arg2;	// IMP=0x00200000000ac427
+ (id)_navigation_stringWithType:(int)arg1;	// IMP=0x00200000000abdc6
- (CDStruct_071ac149)_navigation_geoCoordinate3D;	// IMP=0x00100000000ac6dc
- (CDStruct_c3b9c2ee)_navigation_geoCoordinate;	// IMP=0x00100000000ac69d
- (id)_navigation_geoLocation;	// IMP=0x00100000000ac631
...
- (double)_navigation_speedAccuracy;	// IMP=0x00100000000ac53e
- (_Bool)_navigation_isEqualToLocationCoordinate:(struct CLLocationCoordinate2D)arg1;	// IMP=0x00100000000ac4b1
...
- (id)initWithGeoLocation:(id)arg1;	// IMP=0x00100000000abf5e
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 rawCoordinate:(struct CLLocationCoordinate2D)arg2 course:(double)arg3 rawCourse:(double)arg4 courseAccuracy:(double)arg5 speed:(double)arg6 speedAccuracy:(double)arg7 altitude:(double)arg8 timestamp:(double)arg9 horizontalAccuracy:(double)arg10 verticalAccuracy:(double)arg11 type:(int)arg12 referenceFrame:(int)arg13 serializedCoarseMetaData:(id)arg14;	// IMP=0x00100000000abe01
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 rawCoordinate:(struct CLLocationCoordinate2D)arg2 course:(double)arg3 rawCourse:(double)arg4 courseAccuracy:(double)arg5 speed:(double)arg6 speedAccuracy:(double)arg7 altitude:(double)arg8 timestamp:(double)arg9 horizontalAccuracy:(double)arg10 verticalAccuracy:(double)arg11 type:(int)arg12 referenceFrame:(int)arg13;	// IMP=0x00100000000abde9
@end
