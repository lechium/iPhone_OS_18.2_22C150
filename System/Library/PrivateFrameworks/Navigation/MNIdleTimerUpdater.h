...
- (void).cxx_destruct;	// IMP=0x00000000000aa30c
...
- (_Bool)_shouldEnableIdleTimerForArrivalState:(long long)arg1;	// IMP=0x00000000000aa2ce
- (void)_updateForLocation:(id)arg1;	// IMP=0x00000000000a9fe5
- (void)_updateShouldEnableIdleTimer:(_Bool)arg1;	// IMP=0x00000000000a9edf
- (void)updateForStartNavigation;	// IMP=0x00000000000a9e4f
- (void)dealloc;	// IMP=0x00000000000a9bfd
