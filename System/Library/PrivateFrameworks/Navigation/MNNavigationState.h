...
- (void).cxx_destruct;	// IMP=0x000000000012bde9
...
- (_Bool)_isSelectorValidForForwarding:(SEL)arg1;	// IMP=0x000000000012bda9
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000012bd59
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000012bce0
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000012bbb5
- (void)changeUserOptions:(id)arg1;	// IMP=0x000000000012bbaf
- (void)postEnterState;	// IMP=0x000000000012bba9
- (void)preEnterState;	// IMP=0x000000000012bba3
- (void)leaveState;	// IMP=0x000000000012bb9d
- (void)enterState;	// IMP=0x000000000012bb97
- (void)dealloc;	// IMP=0x000000000012bb09
- (id)initWithStateManager:(id)arg1;	// IMP=0x000000000012ba2e
- (id)init;	// IMP=0x000000000012ba1a
