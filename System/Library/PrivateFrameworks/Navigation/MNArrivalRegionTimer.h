...
- (void)updateForLocation:(id)arg1;	// IMP=0x0000000000033c7b
- (void)dealloc;	// IMP=0x0000000000033c39
- (id)initWithArrivalRegion:(id)arg1;	// IMP=0x0000000000033b80
- (id)init;	// IMP=0x0000000000033b56
