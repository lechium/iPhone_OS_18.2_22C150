...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000103cab
- (void).cxx_destruct;	// IMP=0x0000000000103e3e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000103d92
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000103cb3
- (id)initWithAction:(unsigned long long)arg1 withTitle:(id)arg2 buttonDisplay:(int)arg3;	// IMP=0x0000000000103bac
