...
@class GEOComposedGuidanceEvent, MNGuidanceEventFeedback, MNGuidanceJunctionViewInfo, MNGuidanceLaneInfo, MNGuidanceManager, MNGuidanceSignInfo, MNNavTrayGuidanceEvent, NSArray, NSString, NSUUID;
...
- (void)guidanceManager:(MNGuidanceManager *)arg1 announce:(NSString *)arg2 isImportant:(_Bool)arg3 shortPromptType:(unsigned long long)arg4 stage:(unsigned long long)arg5 completionBlock:(void (^)(unsigned long long))arg6;
