...
- (void).cxx_destruct;	// IMP=0x0000000000039529
...
- (id)description;	// IMP=0x000000000003910b
- (id)initWithEvent:(id)arg1 distance:(double)arg2 speed:(double)arg3 durations:(id)arg4;	// IMP=0x0000000000038f11
