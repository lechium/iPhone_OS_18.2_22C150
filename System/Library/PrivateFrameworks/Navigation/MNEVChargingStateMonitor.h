...
- (void)_updateForVehicle:(id)arg1 forceDelegateCallback:(_Bool)arg2;	// IMP=0x000000000001aa48
- (void)virtualGarageManager:(id)arg1 didUpdateSelectedVehicle:(id)arg2;	// IMP=0x000000000001aa31
- (void)_notifyShouldShowChargingInfo;	// IMP=0x000000000001a9bf
- (void)_startTimer;	// IMP=0x000000000001a7aa
- (void)updateForArrival;	// IMP=0x000000000001a798
- (void)updateForLocation:(id)arg1;	// IMP=0x000000000001a655
- (void)dealloc;	// IMP=0x000000000001a5d2
- (id)initWithTargetBatteryCharge:(id)arg1;	// IMP=0x000000000001a344
