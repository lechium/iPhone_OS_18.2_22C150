...
+ (_Bool)shouldAdjustTimeoutIntervalForBeginDate;	// IMP=0x00600000000856cf
- (void).cxx_destruct;	// IMP=0x0000000000085bf0
...
- (void)invalidate;	// IMP=0x0000000000085af1
- (void)triggerTimeout;	// IMP=0x00000000000859cc
- (void)timerCallback;	// IMP=0x00000000000858a9
- (id)initWithHandle:(id)arg1 beginDate:(id)arg2 timeoutInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x00000000000856d7
