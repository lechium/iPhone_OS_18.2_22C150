...
@class NSArray, NSDateInterval, NSDictionary, NSNumber, NSSecurityScopedURLWrapper, NSString, NSURL, STIntroductionModel, STUserNotificationContext;

@protocol STManagementStateServerInterface <NSObject>
- (void)triggerDowngradeMigrationWithCompletionHandler:(void (^)(NSError *))arg1;
- (void)postNotificationForContext:(STUserNotificationContext *)arg1;
...
- (void)enableWebContentFilterWithCompletionHandler:(void (^)(NSError *))arg1;
- (void)isWebContentRestrictedWithCompletionHandler:(void (^)(_Bool, NSError *))arg1;
