...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001fe1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002a35
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000028b7
- (void)setState:(long long)arg1;	// IMP=0x00000000000026af
- (void)setError:(id)arg1;	// IMP=0x0000000000002096
- (id)initWithRole:(long long)arg1;	// IMP=0x0000000000001fe9
