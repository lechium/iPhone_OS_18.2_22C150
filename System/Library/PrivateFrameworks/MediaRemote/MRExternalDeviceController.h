...
+ (Class)externalDeviceClass;	// IMP=0x0010000000186c58
- (void).cxx_destruct;	// IMP=0x0000000000187c44
...
- (_Bool)_isManagedConfigIDAllowed:(id)arg1;	// IMP=0x00000000001878ea
- (void)netService:(id)arg1 didUpdateTXTRecordData:(id)arg2;	// IMP=0x0000000000187840
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x0000000000187536
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x00000000001871cb
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x00000000001870b9
- (void)endDiscovery;	// IMP=0x0000000000187007
- (void)beginDiscovery;	// IMP=0x0000000000186f46
- (void)dealloc;	// IMP=0x0000000000186ef0
- (id)initWithBonjourServiceType:(id)arg1;	// IMP=0x0000000000186c69
