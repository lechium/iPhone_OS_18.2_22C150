...
@class NSArray, NSData, NSError, NSSet, NSString, SWCollaborationHighlight, TUCollaborationNotice, TUConversation, TUConversationActivityEvent, TUConversationActivitySession, TUConversationLink, TUConversationManager, TUConversationMember, TUConversationNotice, TUConversationParticipant;
