...
- (void).cxx_destruct;	// IMP=0x0000000000027819
...
- (void)_mirrorStateChanged:(_Bool)arg1 screenType:(unsigned int)arg2;	// IMP=0x000000000002763d
- (void)dealloc;	// IMP=0x000000000002758c
- (id)init;	// IMP=0x0000000000027317
