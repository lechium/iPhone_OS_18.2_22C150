...
- (void).cxx_destruct;	// IMP=0x000000000025ac7c
...
- (void)restoreNowPlayingClientState;	// IMP=0x000000000025ab71
- (void)handlePlayerPropertiesRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000025a7b6
- (void)handlePlaybackStateRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000025a412
- (void)handleSupportedCommandsRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000025a078
- (void)enqueuePlaybackQueueRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000259901
- (void)updateSupportedCommandsIfUninitialized:(id)arg1;	// IMP=0x000000000025981c
- (void)updatePlaybackStateIfUninitialized:(unsigned int)arg1;	// IMP=0x00000000002597a5
- (void)updatePlaybackQueueIfUninitialized:(id)arg1;	// IMP=0x00000000002596c0
- (void)updateContentItemArtwork:(id)arg1;	// IMP=0x0000000000258f51
- (void)updateContentItems:(id)arg1;	// IMP=0x0000000000258c4c
...
- (id)debugDescription;	// IMP=0x000000000025835e
- (void)dealloc;	// IMP=0x00000000002582e9
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x0000000000258145
