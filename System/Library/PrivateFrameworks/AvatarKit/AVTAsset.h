...
- (void).cxx_destruct;	// IMP=0x0000000000018e82
...
- (id)assetImageForAsset:(id)arg1;	// IMP=0x0000000000018d8c
- (id)resourceByCachingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000018c9d
- (id)instantiateResource;	// IMP=0x000000000001878f
@property(readonly) _Bool is3DAsset;
@property(readonly) _Bool is2DAsset;
- (void)decrUseCount;	// IMP=0x00000000000186fa
- (void)freeCache;	// IMP=0x00000000000186e0
- (void)incrUseCount;	// IMP=0x00000000000186ba
- (id)description;	// IMP=0x0000000000018645
- (void)enumerateVariantDependenciesOfKind:(unsigned long long)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000018473
- (id)initWithType:(long long)arg1 identifier:(id)arg2 path:(id)arg3;	// IMP=0x0000000000017bd6
