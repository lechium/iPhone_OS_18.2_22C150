...
- (void).cxx_destruct;	// IMP=0x000000000001b944
...
- (unsigned long long)hash;	// IMP=0x000000000001b906
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b8fb
- (id)initWithPlaceholderToken:(id)arg1;	// IMP=0x000000000001b428
