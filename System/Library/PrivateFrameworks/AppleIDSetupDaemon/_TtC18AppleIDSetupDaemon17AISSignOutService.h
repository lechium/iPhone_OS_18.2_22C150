...
@interface _TtC18AppleIDSetupDaemon17AISSignOutService : _TtCs12_SwiftObject
{
    ...
    MISSING_TYPE *enrollInterface;	// 96 = 0x60
}

- (void)signOutAllAccountsWith:(AISSignOutContext *)arg1 completionHandler:(void (^)(_Bool, NSError *))arg2;	// IMP=0x0000000000097420
