...
- (void).cxx_destruct;	// IMP=0x0000000000019394
...
- (void)reflectNextFireDelay:(double)arg1 fireInterval:(double)arg2;	// IMP=0x0000000000019284
- (void)dealloc;	// IMP=0x0000000000019233
- (id)initWithDispatchSilo:(id)arg1;	// IMP=0x0000000000018fb0
