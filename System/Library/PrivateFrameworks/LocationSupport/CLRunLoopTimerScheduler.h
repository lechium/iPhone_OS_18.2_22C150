...
- (void).cxx_destruct;	// IMP=0x000000000000907f
...
- (void)reflectNextFireDelay:(double)arg1 fireInterval:(double)arg2;	// IMP=0x0000000000008f2b
- (void)dealloc;	// IMP=0x0000000000008ee9
- (id)initWithRunLoopSilo:(id)arg1;	// IMP=0x0000000000008cc4
