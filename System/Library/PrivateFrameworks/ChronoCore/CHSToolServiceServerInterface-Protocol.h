...
- (oneway void)fetchWidgetSceneInfoWithCompletion:(void (^)(NSData *, NSError *))arg1;
...
- (oneway void)reloadControlsOfKind:(NSString *)arg1 containedIn:(NSString *)arg2 reason:(NSString *)arg3 completion:(void (^)(NSError *))arg4;
...
- (oneway void)allCachedSnapshotURLsWithCompletion:(void (^)(NSArray<__NSString__> *, NSError *))arg1;
- (oneway void)resetCaches:(NSNumber *)arg1 completion:(void (^)(NSError *))arg2;
- (oneway void)refreshDescriptorsForExtensionBundleIdentifier:(NSString *)arg1 completion:(void (^)(CHSWidgetExtensionsBox *, NSError *))arg2;
@end
