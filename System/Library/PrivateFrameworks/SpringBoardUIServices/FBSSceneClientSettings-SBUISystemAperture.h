...
- (id)SBUI_systemApertureDescriptionOfDiffFromSettings:(id)arg1;	// IMP=0x003000000005de83
- (id)SBUI_systemApertureDescription;	// IMP=0x003000000005de33
...
@property(readonly, nonatomic) _Bool SBUISA_prefersFixedPortraitOrientation;
