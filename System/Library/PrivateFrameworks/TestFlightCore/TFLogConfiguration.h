...
+ (id)defaultConfiguration;	// IMP=0x006000000001cb1c
- (void).cxx_destruct;	// IMP=0x000000000001cecf
...
- (id)initWithSubsystem:(id)arg1 category:(id)arg2;	// IMP=0x000000000001ca4f
