...
- (void).cxx_destruct;	// IMP=0x0000000000018227
...
- (void)setImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000001804f
@property(readonly, nonatomic) struct CGSize displayedIconSize;
- (void)_prepareForDisplayWithTraitCollection:(id)arg1;	// IMP=0x0000000000017e0e
- (void)_layoutLabelsInLayoutBounds:(struct CGRect)arg1;	// IMP=0x00000000000178a8
- (void)layoutSubviews;	// IMP=0x0000000000017473
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000173f5
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000001728a
- (void)_styleSubviews;	// IMP=0x0000000000016dab
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000016b6d
