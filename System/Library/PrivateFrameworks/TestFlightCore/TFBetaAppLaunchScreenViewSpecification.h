...
- (void).cxx_destruct;	// IMP=0x00000000000208c6
...
- (id)_primaryButtonTextFontStyle;	// IMP=0x0000000000020731
- (id)_createPrimaryButtonTextFontForTraitCollection:(id)arg1;	// IMP=0x0000000000020699
- (id)_bodyTextFontStyle;	// IMP=0x0000000000020685
- (id)_createBodyTextFontForTraitCollection:(id)arg1;	// IMP=0x00000000000205ed
- (id)_bodyTitleFontStyle;	// IMP=0x00000000000205d9
- (id)_createBodyTitleFontForTraitCollection:(id)arg1;	// IMP=0x0000000000020541
- (id)_subtitleFontStyle;	// IMP=0x000000000002052d
- (id)_createSubtitleFontForTraitCollection:(id)arg1;	// IMP=0x0000000000020495
- (id)_titleFontStyle;	// IMP=0x0000000000020481
- (id)_createTitleFontForTraitCollection:(id)arg1;	// IMP=0x00000000000203e9
@property(readonly, nonatomic) struct CGSize headerIconViewSize;
@property(readonly, nonatomic) double primaryButtonCornerRadius;
- (id)initWithTraitCollection:(id)arg1;	// IMP=0x000000000001ff66
