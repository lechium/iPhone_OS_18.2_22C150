...
- (id).cxx_construct;	// IMP=0x0000000000d69340
- (void).cxx_destruct;	// IMP=0x0000000000d692e0
...
- (id)description;	// IMP=0x0000000000d69150
- (id)displayGroup;	// IMP=0x0000000000d68f90
- (void)layoutForStagingWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000d68f70
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000d68ee0
...
- (id)initWithNavFeature:(id)arg1 label:(const void *)arg2 navLabelType:(int)arg3;	// IMP=0x0000000000d68d30
