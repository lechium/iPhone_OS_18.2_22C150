...
- (id).cxx_construct;	// IMP=0x00000000000bddb0
...
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x00000000000bdbf0
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x00000000000bdb00
- (Box_3d7e3c2c)_expandedBoundingRect;	// IMP=0x00000000000bda60
- (_Bool)containsGroundPoint:(const void *)arg1;	// IMP=0x00000000000bd950
- (_Bool)rejectsRect:(const void *)arg1;	// IMP=0x00000000000bd6e0
- (void)computeFromCamera:(id)arg1;	// IMP=0x00000000000bd1d0
