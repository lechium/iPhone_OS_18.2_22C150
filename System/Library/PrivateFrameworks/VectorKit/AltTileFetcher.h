...
- (id).cxx_construct;	// IMP=0x0000000000c4fa50
- (void).cxx_destruct;	// IMP=0x0000000000c4f960
- (void)purgeExpired:(double)arg1;	// IMP=0x0000000000c4f900
- (void)reportCorruptTile:(const struct _GEOTileKey *)arg1;	// IMP=0x0000000000c4f8e0
- (void)cancelRequests;	// IMP=0x0000000000c4f760
- (void)updateJobPriority:(void *)arg1;	// IMP=0x0000000000c4f6b0
- (void)cancelJob:(void *)arg1;	// IMP=0x0000000000c4f5e0
- (void)fetchDataForJob:(void *)arg1;	// IMP=0x0000000000c4f300
- (shared_ptr_97fa0047)getJobForKey:(const struct _GEOTileKey *)arg1;	// IMP=0x0000000000c4f280
- (id)initWithToken:(id)arg1;	// IMP=0x0000000000c4f130
