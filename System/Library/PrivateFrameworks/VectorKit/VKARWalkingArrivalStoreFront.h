...
- (id).cxx_construct;	// IMP=0x0000000000a0e140
- (void).cxx_destruct;	// IMP=0x0000000000a0e130
...
- (id)description;	// IMP=0x0000000000a0e000
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a0de80
...
- (id)initWithOrientedRect:(const void *)arg1 undulationProvider:(CDUnknownBlockType)arg2;	// IMP=0x0000000000a0d590
- (id)initWithYaw:(float)arg1 pitch:(float)arg2 roll:(float)arg3 x:(double)arg4 y:(double)arg5 z:(double)arg6 w:(float)arg7 h:(float)arg8 undulationProvider:(CDUnknownBlockType)arg9;	// IMP=0x0000000000a0d360
- (id)initWithGEOOrientedBox:(id)arg1 undulationProvider:(CDUnknownBlockType)arg2;	// IMP=0x0000000000a0d0c0
- (id)initWithOrientedRect:(const void *)arg1;	// IMP=0x0000000000a0d0a0
