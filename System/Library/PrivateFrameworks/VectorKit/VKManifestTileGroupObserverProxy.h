...
- (id).cxx_construct;	// IMP=0x0000000000ee9350
- (void).cxx_destruct;	// IMP=0x0000000000ee92c0
...
- (void)experimentConfigurationDidChange:(id)arg1;	// IMP=0x0000000000ee9090
- (void)resourceManifestManager:(id)arg1 didChangeActiveTileGroup:(id)arg2 fromOldTileGroup:(id)arg3;	// IMP=0x0000000000ee8ec0
- (void)resourceManifestManagerWillChangeActiveTileGroup:(id)arg1;	// IMP=0x0000000000ee8d80
- (void)dealloc;	// IMP=0x0000000000ee8c30
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000ee8b10
