...
- (id).cxx_construct;	// IMP=0x0000000000b93190
- (void).cxx_destruct;	// IMP=0x0000000000b92e20
...
- (unsigned char)computeRoutePositionForPOIAtPixel:(const void *)arg1 currentPosition:(unsigned char)arg2 context:(struct NavContext *)arg3;	// IMP=0x0000000000b92cc0
- (_Bool)_updateActiveRouteRange;	// IMP=0x0000000000b92620
- (_Bool)_findRouteOverlappingJunctionFrom:(long long)arg1 routeJunctions:(void *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(long long *)arg4 secondOverlap:(long long *)arg5;	// IMP=0x0000000000b92090
- (void)_updateCurrentRoadInfo;	// IMP=0x0000000000b91d40
- (void)_initalizeCurrentRoadInfo;	// IMP=0x0000000000b91d20
- (void)_dedupOffRouteRoads;	// IMP=0x0000000000b90e50
- (void)_updatePreferredLabelPlacements;	// IMP=0x0000000000b90b10
- (void)_updateRoadsInGuidance;	// IMP=0x0000000000b90590
- (void)_updateRoadStarts;	// IMP=0x0000000000b900d0
- (void)_updateUniqueOffRouteRoads;	// IMP=0x0000000000b8faf0
- (_Bool)_addJunctionsForTile:(const void *)arg1;	// IMP=0x0000000000b8eaa0
- (void)_addLabelsForJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3 useAllJunctions:(_Bool)arg4 placeShieldsFrontToBack:(_Bool)arg5;	// IMP=0x0000000000b8d7c0
- (void)_addLabelsAtJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3;	// IMP=0x0000000000b8cd90
- (void)_addVisibleSigns;	// IMP=0x0000000000b8ccc0
- (void)layoutWithNavContext:(struct NavContext *)arg1 avoidanceRects:(const void *)arg2;	// IMP=0x0000000000b89b40
- (unsigned char)orientationForRoadSign:(id)arg1 roadLabel:(id)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x0000000000b899a0
- (unsigned char)resolveOrientation:(struct NavContext *)arg1 road:(id)arg2 currentOrientation:(unsigned char)arg3;	// IMP=0x0000000000b896e0
- (struct RoadSignOrientationResolver)createRoadSignOrientationResolver:(id)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x0000000000b89640
- (void)_generateCurrentRoadSignWithContext:(struct NavContext *)arg1;	// IMP=0x0000000000b887e0
- (void)styleManagerDidFinishAnimating;	// IMP=0x0000000000b887d0
- (void)styleManagerDidStartAnimating;	// IMP=0x0000000000b887c0
- (void)styleManagerDidChange:(_Bool)arg1;	// IMP=0x0000000000b887a0
- (_Bool)_collideLabel:(id)arg1 activeLabel:(id)arg2 labelsToRemove:(id)arg3;	// IMP=0x0000000000b87f40
- (void)_tryAddLabel:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x0000000000b86b40
- (void)_tryAddRoadSignForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 labelCollisionEnabled:(_Bool)arg4;	// IMP=0x0000000000b86000
- (void)_createOrUpdateLabelForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 hopOffsetDistance:(float)arg4;	// IMP=0x0000000000b85e80
- (void)_tryAddRoadSignForJunction:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x0000000000b85d00
- (void)grabTilesFromScene:(const void *)arg1;	// IMP=0x0000000000b856f0
- (void)_refreshGuidanceRoadNames;	// IMP=0x0000000000b85440
- (void)_reloadRouteJunctions;	// IMP=0x0000000000b850a0
- (void)clearSceneIsMemoryWarning:(_Bool)arg1;	// IMP=0x0000000000b84d50
- (_Bool)isNavMode;	// IMP=0x0000000000b84d30
- (void)setMaxVisibleRoadsigns:(unsigned int)arg1;	// IMP=0x0000000000b84b90
- (void)setStyleManager:(shared_ptr_3e3c7f86)arg1;	// IMP=0x0000000000b84990
- (id)init;	// IMP=0x0000000000b84330
@property(readonly, nonatomic) float currentRoadSignPixelHeight;
@property(readonly, nonatomic) void *currentRoadSign;
- (void)drawNavOverlayDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x0000000000957950
- (void)drawRoadSignOrientationDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x0000000000956060
- (void)debugDraw:(id)arg1 overlayConsole:(void *)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x0000000000955ef0
- (_Bool)needsDebugDraw;	// IMP=0x0000000000955de0
