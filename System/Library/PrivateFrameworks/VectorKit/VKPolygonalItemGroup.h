...
- (id).cxx_construct;	// IMP=0x00000000007bd2a0
- (void).cxx_destruct;	// IMP=0x00000000007bcd40
...
- (void)clearRouteAttributes;	// IMP=0x00000000007bccf0
- (void)setRouteAttributes:(const struct PolygonRouteAttributes *)arg1;	// IMP=0x00000000007bccc0
- (void)updateCachedStyles;	// IMP=0x00000000007bc1a0
@property(readonly, nonatomic) const void *featureIds;
- (_Bool)hasFeatureId:(unsigned long long)arg1;	// IMP=0x00000000007bc030
- (_Bool)canAcceptPolygon:(void *)arg1;	// IMP=0x00000000007bbf80
- (void)didFinishAddingData;	// IMP=0x00000000007bbcf0
- (void)willAddDataWithAccessor:(struct ResourceAccessor *)arg1;	// IMP=0x00000000007bbcc0
- (unsigned char)indexForGeoFeatureAttributes:(const void *)arg1;	// IMP=0x00000000007bb8a0
- (const void *)commitRangesToVerticalVenueWallStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000007bb6f0
- (const void *)commitRangesToHorizontalVenueWallStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000007bb540
- (const void *)commitRangesToVenueWallEndCapRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000007bb390
- (const void *)commitRangesToVenueWallRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000007bb1e0
- (const void *)commitRangesToStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_ce5c9822)arg4;	// IMP=0x00000000007bb000
- (const void *)commitRangesToFillRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_ce5c9822)arg4;	// IMP=0x00000000007bae20
@property(readonly, nonatomic) void *fillMeshes;
@property(readonly, nonatomic) float tileZoom;
- (void *)styleQueries:(const struct StyleQueryOverride *)arg1;	// IMP=0x00000000007bade0
...
- (const void *)attributeSets;	// IMP=0x00000000007bad70
- (unsigned char)maxAttributeSetsPerGroup;	// IMP=0x00000000007bad60
- (id)initWithStyleQuery:(void *)arg1 tileZoom:(float)arg2 fixedAroundCentroid:(const void *)arg3 contentScale:(float)arg4 storage:(shared_ptr_fb8448a7)arg5;	// IMP=0x00000000007baa60
- (id)initWithStyleQuery:(void *)arg1 tileZoom:(float)arg2 fixedAroundCentroid:(const void *)arg3 contentScale:(float)arg4;	// IMP=0x00000000007ba9d0
