...
- (id).cxx_construct;	// IMP=0x0000000000938500
- (void).cxx_destruct;	// IMP=0x00000000009384e0
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x0000000000938420
- (void)dealloc;	// IMP=0x00000000009383a0
- (id)initWithRouteContext:(id)arg1 transitSupport:(void *)arg2;	// IMP=0x00000000009382d0
