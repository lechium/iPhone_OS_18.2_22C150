...
- (id).cxx_construct;	// IMP=0x000000000064b8e0
- (void).cxx_destruct;	// IMP=0x000000000064b880
...
- (id)description;	// IMP=0x000000000064b780
- (Matrix_811b2232)convertCoordinateToTile:(const CDStruct_071ac149 *)arg1;	// IMP=0x000000000064b670
@property(readonly) _Bool isMapMatched;
@property(readonly) _Bool hasCompletedMapMatching;
- (float)laneHalfWidthAtIndex:(unsigned int)arg1;	// IMP=0x000000000064b640
...
- (const struct GradientTraffic *)gradientTrafficAtIndex:(unsigned int)arg1;	// IMP=0x000000000064b5f0
- (id)initWithOverlay:(id)arg1 section:(id)arg2 routeStartIndex:(unsigned int)arg3 routeEndIndex:(unsigned int)arg4 matchedPathSegments:(id)arg5 elevationSource:(void *)arg6 elevationSourceContext:(void *)arg7;	// IMP=0x000000000064a0a0
- (id)initWithOverlay:(id)arg1 section:(id)arg2 matchedPathSegments:(id)arg3;	// IMP=0x0000000000649fa0
