...
- (id).cxx_construct;	// IMP=0x00000000006beb00
- (void).cxx_destruct;	// IMP=0x00000000006bea80
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x00000000006bea30
- (void)stopObserving:(id)arg1;	// IMP=0x00000000006be910
- (void)startObserving:(id)arg1;	// IMP=0x00000000006be660
- (void)dealloc;	// IMP=0x00000000006be590
- (id)initWithRouteContextChangeObserver:(struct RouteContextChangeObserver *)arg1;	// IMP=0x00000000006be550
