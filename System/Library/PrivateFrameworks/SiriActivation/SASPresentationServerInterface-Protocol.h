...
@class NSNumber, NSString, SASActivationRequest, SASButtonIdentifierTransport, SASLockStateTransport, SASPreheatOptions, SASPresentationState, SASRequestOptions, SASTimeIntervalTransport, SiriDismissalOptions, SiriLongPressButtonContext, SiriPresentationActivationCancelReasonTransport, SiriPresentationIdentifierTransport, SiriPresentationOptions;
...
- (oneway void)preheatWithOptions:(SASPreheatOptions *)arg1;
- (oneway void)cancelActivatedHintGlow;
- (oneway void)activateHintGlow;
- (oneway void)presentationActivationPriorityDidChange:(SiriPresentationIdentifierTransport *)arg1;
- (_Bool)presentationisIdleAndQuiet;
- (oneway void)handleRequestWithPresentationOptionsUpdate:(SiriPresentationOptions *)arg1 requestOptions:(SASRequestOptions *)arg2;
