...
- (void).cxx_destruct;	// IMP=0x0000000000044c9b
- (id)generate;	// IMP=0x0000000000044bee
- (void)setPresentationIdentifier:(id)arg1;	// IMP=0x0000000000044bce
- (id)initWithBaseModel:(id)arg1;	// IMP=0x0000000000044b63
- (id)init;	// IMP=0x0000000000044b4f
