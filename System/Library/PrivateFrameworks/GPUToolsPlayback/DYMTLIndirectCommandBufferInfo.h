...
- (id)initWithMaxCommandCount:(unsigned long long)arg1 options:(unsigned long long)arg2 maxKernelThreadgroupMemoryBindCount:(unsigned long long)arg3;	// IMP=0x0000000000018023
