...
- (_Bool)_isStereoPeerActive;	// IMP=0x000000000000e33c
- (_Bool)_isStereoPeer:(id)arg1;	// IMP=0x000000000000e243
- (_Bool)_isStereoPairMember;	// IMP=0x000000000000e1c3
- (void)_notifyDelegate:(id)arg1;	// IMP=0x000000000000e08e
- (void)_withLock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000e050
...
- (id)_messageDecodeCapabilities:(id)arg1;	// IMP=0x000000000000d77c
- (id)_messageEncodeCapabilities;	// IMP=0x000000000000d660
- (_Bool)_messageValidateResponse:(id)arg1;	// IMP=0x000000000000d58b
- (_Bool)_messageValidateRequest:(id)arg1;	// IMP=0x000000000000d4b6
- (id)_messageCreateResponse;	// IMP=0x000000000000d3f8
- (id)_messageCreateRequest;	// IMP=0x000000000000d382
- (void)_rapportProcessResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000000ccde
- (void)_rapportProcessRequest:(id)arg1 emittingResponse:(CDUnknownBlockType)arg2;	// IMP=0x000000000000cae1
- (_Bool)_rapportEventShouldUpdateState:(id)arg1;	// IMP=0x000000000000ca29
- (void)_rapportDeregister;	// IMP=0x000000000000c9e5
- (void)_rapportRegister;	// IMP=0x000000000000c7dd
- (void)_rapportStop;	// IMP=0x000000000000c749
- (void)_rapportStart;	// IMP=0x000000000000c083
- (void)_stateQuery;	// IMP=0x000000000000bd48
- (void)_stateUpdate;	// IMP=0x000000000000bbed
- (void)dealloc;	// IMP=0x000000000000bbaf
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000000b91d
