...
- (void).cxx_destruct;	// IMP=0x0000000000085e4c
...
- (id)serviceAddOn;	// IMP=0x0000000000085d77
- (id)init;	// IMP=0x0000000000085cd5
- (id)initWithAlarmManager:(id)arg1 homekitAdapter:(id)arg2 hubAdapter:(id)arg3;	// IMP=0x0000000000085c1d
