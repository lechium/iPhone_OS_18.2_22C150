...
- (void).cxx_destruct;	// IMP=0x00000000000e599d
@property __weak id <COEndpointMonitorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_activateLink;	// IMP=0x00000000000e582b
- (void)startMonitoring;	// IMP=0x00000000000e57e5
- (id)init;	// IMP=0x00000000000e5763
