...
+ (id)requestWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x006000000006e1af
...
- (void)dealloc;	// IMP=0x000000000006e2b3
- (id)_initWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x000000000006e1fa
