...
+ (id)deviceControlRequestWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00600000000bda21
...
- (void)dealloc;	// IMP=0x00000000000bdac1
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bda58
