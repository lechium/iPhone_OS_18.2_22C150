...
+ (id)requestWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0060000000054a96
+ (void)initialize;	// IMP=0x0060000000054a85
...
- (void)_resolveExpectedPhotoManifest;	// IMP=0x0000000000054d14
...
- (void)dealloc;	// IMP=0x0000000000054bf6
- (id)initWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0000000000054ae1
