...
- (void).cxx_destruct;	// IMP=0x000000000000406b
...
- (id)allObjects;	// IMP=0x0000000000003fa2
- (id)nextObject;	// IMP=0x0000000000003ecf
- (id)initWithEnumerator:(id)arg1 filter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003e1a
