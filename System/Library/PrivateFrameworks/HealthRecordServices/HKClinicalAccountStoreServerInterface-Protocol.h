...
- (void)remote_beginReloginSessionForAccountWithIdentifier:(NSUUID *)arg1 completion:(void (^)(HKOAuth2LoginSession *, NSError *))arg2;
- (void)remote_beginInitialLoginSessionForGatewayWithExternalID:(NSString *)arg1 completion:(void (^)(HKOAuth2LoginSession *, NSError *))arg2;
@end
