...
- (id)_targetForBrowseResult:(id)arg1;	// IMP=0x00000000000031b9
- (void)_applyUpdates;	// IMP=0x0000000000002d77
- (void)_handleBrowseChangeFromTarget:(id)arg1 toTarget:(id)arg2 applyBatch:(_Bool)arg3;	// IMP=0x0000000000002b3d
- (void)_prepareBrowserHandlers;	// IMP=0x0000000000002570
- (id)_prepareBrowseParameters;	// IMP=0x0000000000002507
- (id)_prepareBrowseDescriptor;	// IMP=0x000000000000247f
- (void)_invalidated;	// IMP=0x000000000000230b
- (void)_invalidate;	// IMP=0x0000000000002182
- (void)_startBrowsing;	// IMP=0x0000000000001f0a
- (id)description;	// IMP=0x0000000000001e1f
- (void)dealloc;	// IMP=0x0000000000001de1
- (id)initWithDelegate:(id)arg1 dispatchQueue:(id)arg2;	// IMP=0x0000000000001c24
