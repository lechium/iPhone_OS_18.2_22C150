...
- (int)_estimateRSSIForSFBLEDevice:(id)arg1;	// IMP=0x00000000001191ae
- (id)description;	// IMP=0x00000000001190c3
- (void)dealloc;	// IMP=0x0000000000119054
- (id)initWithProximityInfo:(id)arg1;	// IMP=0x0000000000118f2c
