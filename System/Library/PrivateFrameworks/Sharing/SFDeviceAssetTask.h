...
- (void).cxx_destruct;	// IMP=0x0000000000076f62
...
- (id)bundleAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000076a3a
- (id)bundleURLFromAssetURL:(id)arg1;	// IMP=0x000000000007676e
- (void)completeWithBundle:(id)arg1 isFallback:(_Bool)arg2 isCached:(_Bool)arg3;	// IMP=0x0000000000075f6b
- (_Bool)completeIfPossible;	// IMP=0x00000000000759e4
- (void)cancelTimeout;	// IMP=0x000000000007599a
- (_Bool)updateTaskWithBundle:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x0000000000075796
- (_Bool)updateTaskWithAssetBundleURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x00000000000756e0
- (_Bool)updateTaskWithAssetURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x000000000007564f
- (void)createQueryParameters;	// IMP=0x0000000000075326
- (id)initWithDeviceQuery:(id)arg1 requestConfiguration:(id)arg2 dispatchQueue:(id)arg3 useProcessLocalCache:(_Bool)arg4;	// IMP=0x0000000000074fc2
