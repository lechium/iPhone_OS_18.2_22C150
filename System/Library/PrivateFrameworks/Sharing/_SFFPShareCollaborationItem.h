...
- (void).cxx_destruct;	// IMP=0x000000000005ecd6
...
- (void)loadCopyRepresentationURLWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000005e8ab
- (id)_defaultLoadingOptionsSummary;	// IMP=0x000000000005e84f
@property(readonly, nonatomic) _Bool hasSeparateSendCopyRepresentation;
@property(readonly, nonatomic) _Bool isCollaborativeURL;
- (void)_loadSendCopyRepresentationIfNeeded;	// IMP=0x000000000005e785
- (void)_loadMetadataIfNeeded;	// IMP=0x000000000005e52b
@property(readonly, copy, nonatomic) NSString *additionalContentIdentifier;
- (id)initWithFileURL:(id)arg1 itemProvider:(id)arg2 activityItem:(id)arg3 defaultCollaboration:(_Bool)arg4 managedFileURL:(id)arg5;	// IMP=0x000000000005e1b9
