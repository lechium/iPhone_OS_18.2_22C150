...
- (void).cxx_destruct;	// IMP=0x000000000005effd
...
- (void)_loadOptionsIfNeeded;	// IMP=0x000000000005ef70
- (id)initWithItemProvider:(id)arg1 activityItem:(id)arg2 isURLProviderSupported:(_Bool)arg3;	// IMP=0x000000000005ed18
