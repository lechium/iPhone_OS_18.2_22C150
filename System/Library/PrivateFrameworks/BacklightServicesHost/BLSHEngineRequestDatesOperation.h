...
- (void).cxx_destruct;	// IMP=0x0000000000051d62
@property(readonly, nonatomic) NSDateInterval *requestInterval; // @synthesize requestInterval=_requestInterval;
- (id)telemetryDataWithEndTime:(double)arg1;	// IMP=0x0000000000051a65
- (void)beginOperationWithIntervals:(id)arg1 shouldReset:(_Bool)arg2;	// IMP=0x0000000000050cfa
...
- (void)invalidate;	// IMP=0x0000000000050ad5
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000005046c
- (id)initWithRequestInterval:(id)arg1 delegate:(id)arg2 osTimerProvider:(id)arg3;	// IMP=0x00000000000503ae
