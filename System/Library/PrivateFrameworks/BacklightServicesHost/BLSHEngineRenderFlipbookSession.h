...
- (void).cxx_destruct;	// IMP=0x0000000000023ab7
@property(readonly, nonatomic) BLSHBacklightEnvironmentPresentation *presentation; // @synthesize presentation=_presentation;
- (id)telemetryDataWithEndTime:(double)arg1 reasonEnded:(id)arg2 preventedSleepDuration:(double)arg3;	// IMP=0x0000000000022647
- (void)prepareAndRenderFrameSpecifier:(id)arg1;	// IMP=0x0000000000021c13
- (void)invalidate;	// IMP=0x0000000000021a08
...
- (void)dealloc;	// IMP=0x000000000002145c
- (id)initWithDelegate:(id)arg1 flipbook:(id)arg2 presentation:(id)arg3 osInterfaceProvider:(id)arg4;	// IMP=0x0000000000021097
