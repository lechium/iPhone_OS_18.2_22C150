...
- (void).cxx_destruct;	// IMP=0x0000000000004dfa
...
- (id)bls_shortLoggingString;	// IMP=0x0000000000004c80
- (id)bls_loggingString;	// IMP=0x0000000000004b68
...
- (id)initWithPresentationTime:(unsigned long long)arg1 frameId:(unsigned long long)arg2 specifier:(id)arg3 memoryUsage:(unsigned long long)arg4;	// IMP=0x0000000000004a86
