...
- (void)requestDatesOperation:(id)arg1 didTimeoutPendingEnvironments:(id)arg2;	// IMP=0x000000000006e85c
- (void)requestDatesOperation:(id)arg1 environment:(id)arg2 didProvideSpecifiers:(id)arg3 forPresentationInterval:(id)arg4 isComplete:(_Bool)arg5;	// IMP=0x000000000006e5cf
- (void)lock_completeAllTimelineEntries;	// IMP=0x000000000006e3f2
- (void)callCompletionIfDone;	// IMP=0x000000000006e324
- (void)calculateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000006deb9
