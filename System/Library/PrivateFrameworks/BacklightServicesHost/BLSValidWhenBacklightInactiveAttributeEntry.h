...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0010000000079986
- (void).cxx_destruct;	// IMP=0x0000000000079b43
...
- (void)invalidate;	// IMP=0x0000000000079afb
- (_Bool)reactivateIfPossible;	// IMP=0x0000000000079af3
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x0000000000079a3d
