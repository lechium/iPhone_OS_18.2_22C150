...
- (void).cxx_destruct;	// IMP=0x000000000008820c
...
- (void)invalidate:(unsigned long long)arg1;	// IMP=0x00000000000881cb
- (id)initWithExplanation:(id)arg1;	// IMP=0x0000000000088158
