...
- (id <BLSHSystemActivityAsserting>)createSystemActivityAssertionWithIdentifier:(NSString *)arg1 configurator:(void (^)(id <SWSystemActivityAssertionConfiguring>))arg2;
