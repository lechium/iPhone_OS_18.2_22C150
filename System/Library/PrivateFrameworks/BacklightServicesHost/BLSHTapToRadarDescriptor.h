...
- (void).cxx_destruct;	// IMP=0x0000000000073e0d
...
- (id)toURL;	// IMP=0x00000000000738ee
- (id)initWithDesignation:(unsigned long long)arg1 radarTitle:(id)arg2 radarDescription:(id)arg3;	// IMP=0x0000000000073757
