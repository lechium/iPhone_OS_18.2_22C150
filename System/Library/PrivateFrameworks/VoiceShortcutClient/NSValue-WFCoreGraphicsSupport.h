...
+ (id)wf_valueWithCGAffineTransform:(struct CGAffineTransform)arg1;	// IMP=0x00200000000c7eb2
+ (id)wf_valueWithCGRect:(struct CGRect)arg1;	// IMP=0x00200000000c7ea0
+ (id)wf_valueWithCGSize:(struct CGSize)arg1;	// IMP=0x00200000000c7e8e
+ (id)wf_valueWithCGVector:(struct CGVector)arg1;	// IMP=0x00200000000c7e7c
+ (id)wf_valueWithCGPoint:(struct CGPoint)arg1;	// IMP=0x00200000000c7e6a
