...
- (id)init;	// IMP=0x000000000000e3f0
...
- (void)invalidate;	// IMP=0x000000000000e100
- (id)initWithExplanation:(id)arg1 activityIdentifier:(id)arg2 duration:(double)arg3 invalidationHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000000e010
