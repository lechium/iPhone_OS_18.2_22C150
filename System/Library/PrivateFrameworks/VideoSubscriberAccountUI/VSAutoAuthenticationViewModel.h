...
- (void).cxx_destruct;	// IMP=0x0000000000041d9c
...
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000041c19
- (void)didSelectManualSignInButton;	// IMP=0x0000000000041bcd
- (id)init;	// IMP=0x0000000000041b09
