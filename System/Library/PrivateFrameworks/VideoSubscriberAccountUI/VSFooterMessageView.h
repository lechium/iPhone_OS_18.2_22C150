...
- (void).cxx_destruct;	// IMP=0x00000000000480f4
...
- (double)preferredHeightForWidth:(double)arg1;	// IMP=0x000000000004803b
- (void)dealloc;	// IMP=0x0000000000048005
- (id)initWithSpecifier:(id)arg1;	// IMP=0x00000000000474bb
