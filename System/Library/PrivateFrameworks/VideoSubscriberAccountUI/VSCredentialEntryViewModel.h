...
- (void).cxx_destruct;	// IMP=0x000000000004903a
...
- (void)clearFieldsAfterUsername;	// IMP=0x0000000000048d68
- (void)pickerDidSelectRow:(unsigned long long)arg1;	// IMP=0x0000000000048d17
- (void)buttonTappedAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000048cc6
- (void)validateCredentialEntryFields;	// IMP=0x0000000000048ad4
- (void)configureWithRequest:(id)arg1;	// IMP=0x00000000000486c4
- (void)_bindField:(id)arg1;	// IMP=0x00000000000484c3
- (void)_unbindField:(id)arg1;	// IMP=0x000000000004846c
