...
+ (id)toVSSubscriptions:(id)arg1;	// IMP=0x001000000004129a
- (void).cxx_destruct;	// IMP=0x00000000000415f4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000041465
- (id)toVSSubscription;	// IMP=0x0000000000041131
- (id)init;	// IMP=0x0000000000041053
