...
- (void).cxx_destruct;	// IMP=0x0000000000035170
...
- (void)buttonAtIndexWasPressed:(unsigned long long)arg1;	// IMP=0x0000000000035056
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000034e8b
- (id)init;	// IMP=0x0000000000034b10
