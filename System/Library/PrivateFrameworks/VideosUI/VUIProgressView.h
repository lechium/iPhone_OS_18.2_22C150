...
- (void).cxx_destruct;	// IMP=0x00000000002dc1c7
...
- (void)_updateForStyleChange;	// IMP=0x00000000002dbf3a
- (id)_maskImageForProgressBar;	// IMP=0x00000000002dbd6a
- (void)_layoutMaterialView;	// IMP=0x00000000002dbc59
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000002db7ae
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002db462
- (void)layoutSubviews;	// IMP=0x00000000002db12f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002dae5a
