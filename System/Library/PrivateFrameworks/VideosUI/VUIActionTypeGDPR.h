...
- (void).cxx_destruct;	// IMP=0x00000000000c4b82
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c44d9
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000000c4437
