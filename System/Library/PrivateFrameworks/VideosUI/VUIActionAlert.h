...
- (void).cxx_destruct;	// IMP=0x00000000001a4541
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001a39e5
- (id)initWithContextData:(id)arg1 appContext:(id)arg2 controllerClass:(Class)arg3;	// IMP=0x00000000001a32d2
