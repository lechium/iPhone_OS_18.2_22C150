...
- (void).cxx_destruct;	// IMP=0x000000000004ee25
...
- (id)initWithZoomingImageView:(id)arg1 itemIndex:(unsigned long long)arg2 appearState:(unsigned long long)arg3 isInteractive:(_Bool)arg4;	// IMP=0x000000000004ed1a
