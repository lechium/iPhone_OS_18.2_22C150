...
- (void).cxx_destruct;	// IMP=0x000000000003c0de
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003c007
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x000000000003bea4
- (id)init;	// IMP=0x000000000003be8b
