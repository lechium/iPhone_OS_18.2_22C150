...
+ (_Bool)_viewBackgroundImageNeedsUpdatingWithFrame:(struct CGRect)arg1 currentBackgroundImage:(id)arg2;	// IMP=0x006000000023cd31
+ (id)badgeWithLayout:(id)arg1 existing:(id)arg2;	// IMP=0x006000000023af98
- (void).cxx_destruct;	// IMP=0x000000000023d0f3
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000023cdd9
- (_Bool)_textBadgeBackgroundImageNeedsUpdating;	// IMP=0x000000000023cc71
- (void)_cancelPendingOperation;	// IMP=0x000000000023cb17
- (void)_redrawView:(id)arg1 withDuration:(double)arg2;	// IMP=0x000000000023ca1e
- (void)_redrawTextBadgeWithDuration:(double)arg1;	// IMP=0x000000000023ca09
- (void)_updateBackgroundImagesWithCompletedOperation:(id)arg1;	// IMP=0x000000000023c8f1
- (void)_updateBackgroundMaterialImagesWithBackgroundImageSize:(struct CGSize)arg1 performSynchronously:(_Bool)arg2 overlayViewFrame:(struct CGRect)arg3;	// IMP=0x000000000023c472
- (void)setBackgroundImageForMaterialRendering:(id)arg1 imageSize:(struct CGSize)arg2 overlayViewFrame:(struct CGRect)arg3;	// IMP=0x000000000023c3da
- (void)setBackgroundImageForMaterialRendering:(id)arg1 imageSize:(struct CGSize)arg2 overlayViewFrame:(struct CGRect)arg3 operationQueue:(id)arg4;	// IMP=0x000000000023c311
- (void)_setBackgroundImageForMaterialRendering:(id)arg1;	// IMP=0x000000000023c2cf
- (void)_imageLoaded;	// IMP=0x000000000023c2a1
- (struct CGSize)_textSize;	// IMP=0x000000000023c0e5
- (void)_invalidateTimer;	// IMP=0x000000000023c0ad
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000023b95e
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000023b83a
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000023b811
- (void)dealloc;	// IMP=0x000000000023b730
- (void)reset;	// IMP=0x000000000023b63e
- (void)rentalExpirationLabelNeedsRelayout:(id)arg1;	// IMP=0x000000000023b5bc
- (_Bool)isAccessibilityElement;	// IMP=0x000000000023b371
- (id)accessibilityTitle;	// IMP=0x000000000023b35f
- (id)accessibilityLabel;	// IMP=0x000000000023b329
- (void)_configureWithLayout:(id)arg1;	// IMP=0x000000000023b06d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000023aedd
