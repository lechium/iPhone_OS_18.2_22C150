...
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000000008b9b0
- (struct CGSize)computeSizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000008b8f8
- (void)layoutOfferSubviewsWithSize:(struct CGSize)arg1;	// IMP=0x000000000008abdb
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000008aba5
- (double)_chinHeightForSize:(struct CGSize)arg1;	// IMP=0x000000000008a5c9
- (_Bool)_shouldDisplaySeparator;	// IMP=0x000000000008a585
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x000000000008a4d7
- (void)prepareForCellReuse;	// IMP=0x0000000000089ff6
