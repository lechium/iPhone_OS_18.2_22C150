...
- (void).cxx_destruct;	// IMP=0x00000000000919dd
...
- (struct CGSize)_calculateMetricsOfScorecard;	// IMP=0x00000000000911c4
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000909ab
- (void)_calculateColumnSpacing;	// IMP=0x00000000000906ff
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000906c0
- (void)invalidateData;	// IMP=0x0000000000090658
