...
- (void).cxx_destruct;	// IMP=0x0000000000180dee
...
- (void)_installAppWithChannel:(id)arg1 punchoutURL:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000018050b
- (void)installAppWithPunchoutURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000018042e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000180367
- (unsigned long long)hash;	// IMP=0x00000000001802f9
- (id)initWithChannelDetails:(id)arg1 contentTitle:(id)arg2;	// IMP=0x000000000018023c
