...
- (void).cxx_destruct;	// IMP=0x00000000001bcbeb
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001bc79f
- (void)layoutSubviews;	// IMP=0x00000000001bc401
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001bc303
