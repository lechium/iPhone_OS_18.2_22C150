...
- (void).cxx_destruct;	// IMP=0x0000000000096f7d
...
- (void)_freeBuffers;	// IMP=0x0000000000096ec9
- (void)_compute;	// IMP=0x00000000000962cb
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x000000000009622f
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x00000000000961f4
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x00000000000961b9
- (void)dealloc;	// IMP=0x000000000009617b
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x0000000000096107
