...
+ (void)initialize;	// IMP=0x00600000001bee8f
- (void).cxx_destruct;	// IMP=0x00000000001bf6b0
...
- (void)parse;	// IMP=0x00000000001bf137
- (void)reportParseError:(struct _xmlError *)arg1;	// IMP=0x00000000001beff9
- (void)reportErrorWithCode:(unsigned long long)arg1 userInfo:(id)arg2;	// IMP=0x00000000001bef74
- (id)init;	// IMP=0x00000000001bef49
- (id)initWithString:(id)arg1;	// IMP=0x00000000001beed6
