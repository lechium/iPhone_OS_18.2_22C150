...
- (void).cxx_destruct;	// IMP=0x000000000021312d
...
- (void)_openPunchoutURL:(id)arg1;	// IMP=0x0000000000212a3d
- (id)_addMusicAppMetricsToUrl:(id)arg1;	// IMP=0x0000000000212884
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000212705
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000002125a8
