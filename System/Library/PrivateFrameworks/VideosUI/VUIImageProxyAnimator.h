...
- (void).cxx_destruct;	// IMP=0x00000000000a2a6b
...
- (void)_displayIntervalTimerFired:(id)arg1;	// IMP=0x00000000000a28b2
- (void)_fetchNext;	// IMP=0x00000000000a24f9
- (void)_updateImageWithIndex:(unsigned long long)arg1;	// IMP=0x00000000000a203d
- (void)loadImageProxy:(id)arg1 withWeakObject:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000a1df7
- (void)_setImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000a1c3f
- (void)stopAnimation;	// IMP=0x00000000000a1bd6
- (void)startAnimation;	// IMP=0x00000000000a1b15
- (id)initWithImageView:(id)arg1 andProxies:(id)arg2;	// IMP=0x00000000000a1a31
- (id)init;	// IMP=0x00000000000a19ef
