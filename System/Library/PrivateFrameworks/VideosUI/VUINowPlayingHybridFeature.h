...
- (void).cxx_destruct;	// IMP=0x000000000003c87a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003c6c4
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x000000000003c4f3
- (id)init;	// IMP=0x000000000003c4cf
