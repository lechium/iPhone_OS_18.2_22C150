...
- (void).cxx_destruct;	// IMP=0x0000000000c1a45d
@property(nonatomic, readonly) double accessibilityProgress;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000c196db
- (void)vui_setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000c1951c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000c19464
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000c19379
