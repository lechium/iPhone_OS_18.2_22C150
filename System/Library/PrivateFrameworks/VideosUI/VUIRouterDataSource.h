...
- (void).cxx_destruct;	// IMP=0x00000000000aad13
...
- (id)initWithRouterData:(id)arg1 prefetchedData:(id)arg2;	// IMP=0x00000000000aaba0
- (id)initWithRouterData:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000000aa9db
- (id)initWithLibraryMediaEntity:(id)arg1;	// IMP=0x00000000000aad46
