...
- (void).cxx_destruct;	// IMP=0x0000000000138368
...
- (void)layoutSubviews;	// IMP=0x0000000000137919
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000137896
- (struct CGSize)legendDescriptionSizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000137754
- (struct CGSize)legendNameSizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001375d2
- (id)initWithLayout:(id)arg1;	// IMP=0x000000000013754d
