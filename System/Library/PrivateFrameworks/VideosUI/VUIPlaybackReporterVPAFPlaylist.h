...
- (void).cxx_destruct;	// IMP=0x0000000000272a21
...
- (id)itemsBetweenStartOverallPosition:(unsigned long long)arg1 endOverallPosition:(unsigned long long)arg2;	// IMP=0x00000000002727b7
- (id)itemAtOverallPosition:(unsigned long long)arg1 rangeOptions:(long long)arg2;	// IMP=0x0000000000272364
- (id)initWithPlayer:(id)arg1;	// IMP=0x0000000000271398
