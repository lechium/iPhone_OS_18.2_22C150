...
- (void).cxx_destruct;	// IMP=0x00000000002779e2
...
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000000027779d
...
- (id)_sortKeys:(id)arg1;	// IMP=0x00000000002774ea
- (id)initWithEventDictionary:(id)arg1 termCollater:(id)arg2;	// IMP=0x0000000000276866
