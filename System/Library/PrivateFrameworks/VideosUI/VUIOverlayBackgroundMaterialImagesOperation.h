...
- (void).cxx_destruct;	// IMP=0x00000000002217a5
...
- (id)_blurredMaterialImageWithSourceBackgroundImage:(id)arg1 forRect:(struct CGRect)arg2 croppedRect:(struct CGRect)arg3;	// IMP=0x0000000000221490
- (void)main;	// IMP=0x0000000000220ff3
- (id)init;	// IMP=0x0000000000220f84
- (id)initWithSourceBackgroundImage:(id)arg1;	// IMP=0x0000000000220f16
