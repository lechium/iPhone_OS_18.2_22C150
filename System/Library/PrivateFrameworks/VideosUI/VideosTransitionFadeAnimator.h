...
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000001a3104
- (void)animateTransition:(id)arg1;	// IMP=0x00000000001a2c58
- (id)initWithTransitionType:(long long)arg1 andDuration:(double)arg2;	// IMP=0x00000000001a2c0c
