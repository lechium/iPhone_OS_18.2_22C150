...
+ (id)configureCollectionHeaderViewWithTitle:(id)arg1 subtitle:(id)arg2 buttonString:(id)arg3 existingView:(id)arg4;	// IMP=0x0060000000237cc5
- (void).cxx_destruct;	// IMP=0x0000000000239521
...
- (void)_selectButtonAction:(id)arg1;	// IMP=0x0000000000239427
- (id)_buttonWithString:(id)arg1 existingButton:(id)arg2;	// IMP=0x0000000000239256
- (void)tintColorDidChange;	// IMP=0x00000000002391ad
- (struct CGSize)_layoutWithSize:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x000000000023835f
- (void)layoutSubviews;	// IMP=0x0000000000238314
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002382fd
