...
- (void).cxx_destruct;	// IMP=0x00000000002b208f
...
- (unsigned long long)hash;	// IMP=0x00000000002b1fef
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002b1e96
- (id)initWithRentalID:(id)arg1 dsid:(id)arg2;	// IMP=0x00000000002b1dfd
