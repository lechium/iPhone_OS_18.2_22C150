...
- (void).cxx_destruct;	// IMP=0x000000000020f565
...
- (void)layoutSubviews;	// IMP=0x000000000020edfd
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000020ec93
- (_Bool)hasImage;	// IMP=0x000000000020ebed
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000020e619
