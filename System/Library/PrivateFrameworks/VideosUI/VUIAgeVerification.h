...
+ (id)sharedInstance;	// IMP=0x00600000000e68b0
- (void).cxx_destruct;	// IMP=0x00000000000e7821
...
- (void)performAgeGateVerificationWithRatingValue:(id)arg1 ratingDomain:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e6a9d
- (void)configureAgeVerification:(id)arg1;	// IMP=0x00000000000e6905
