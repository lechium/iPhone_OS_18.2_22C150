...
- (void).cxx_destruct;	// IMP=0x00000000000e44e6
...
- (id)accountsForAccountManager:(id)arg1;	// IMP=0x00000000000e4405
- (void)presentFamilySetupScreenWithBuyParams:(id)arg1;	// IMP=0x00000000000e4284
- (void)presentFamilySetupScreenIfEligible:(id)arg1 checkEligibility:(_Bool)arg2;	// IMP=0x00000000000e3c51
- (id)init;	// IMP=0x00000000000e3b87
