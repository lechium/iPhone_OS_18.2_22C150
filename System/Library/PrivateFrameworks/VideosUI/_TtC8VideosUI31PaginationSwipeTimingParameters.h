...
- (id)init;	// IMP=0x0000000000afbc4f
- (id)copyWithZone:(void *)arg1;	// IMP=0x0000000000afbbcf
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000afbb84
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000afbafd
