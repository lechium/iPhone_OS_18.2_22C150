...
- (void).cxx_destruct;	// IMP=0x0000000000231d17
...
- (id)_textColorForDarkMode;	// IMP=0x0000000000231be5
- (void)_configureLabels;	// IMP=0x0000000000231850
- (void)_configureAgeRatingBadge;	// IMP=0x0000000000231620
- (_Bool)canBecomeFocused;	// IMP=0x00000000002315d9
@property(readonly, nonatomic) VUIAppInstallView *installView;
- (void)_layoutForIos;	// IMP=0x0000000000230dac
- (void)_layoutForTvos;	// IMP=0x0000000000230849
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002304e2
