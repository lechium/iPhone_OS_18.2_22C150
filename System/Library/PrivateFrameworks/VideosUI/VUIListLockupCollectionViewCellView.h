...
- (void).cxx_destruct;	// IMP=0x0000000000081122
...
- (void)vui_prepareForReuse;	// IMP=0x0000000000080faf
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000007fc24
- (void)vui_setHighlighted:(_Bool)arg1;	// IMP=0x000000000007fbc5
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000007fb7c
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x000000000007faf6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000007f76f
