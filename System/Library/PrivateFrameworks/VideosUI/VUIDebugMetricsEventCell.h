...
- (void).cxx_destruct;	// IMP=0x000000000002680e
...
- (void)prepareForReuse;	// IMP=0x0000000000026553
- (void)layoutSubviews;	// IMP=0x0000000000025e03
@property(copy, nonatomic) UIImage *tabImage;
- (void)setSubhead3LabelColor:(id)arg1;	// IMP=0x0000000000025d44
- (void)setSubhead2LabelColor:(id)arg1;	// IMP=0x0000000000025d27
- (void)setSubhead1LabelColor:(id)arg1;	// IMP=0x0000000000025d0a
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000002541c
