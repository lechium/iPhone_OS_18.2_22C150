...
- (void).cxx_destruct;	// IMP=0x00000000001f13ae
...
- (void)_updateVignetteImage;	// IMP=0x00000000001f126d
- (void)installBannerOnView:(id)arg1 anchoredToScrollView:(id)arg2;	// IMP=0x00000000001f11f6
- (void)_doAllSetup;	// IMP=0x00000000001f0c18
- (void)_configureBanner;	// IMP=0x00000000001f0997
- (id)initWithBannerElement:(id)arg1;	// IMP=0x00000000001f08bd
