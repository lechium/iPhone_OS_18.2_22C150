...
- (void).cxx_destruct;	// IMP=0x000000000023527c
...
- (void)_layoutLabels:(id)arg1 withOrigin:(struct CGPoint)arg2 maxWidth:(double)arg3;	// IMP=0x0000000000234dd7
- (double)_subscribeButtonHeight;	// IMP=0x0000000000234c64
- (_Bool)_isSubscribed;	// IMP=0x0000000000234c03
- (struct CGSize)_layoutSubviewsWithSize:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000232af8
@property(readonly, nonatomic) double topThreshold;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000232a95
- (void)setVuiBackgroundColor:(id)arg1;	// IMP=0x00000000002323ed
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002322ac
