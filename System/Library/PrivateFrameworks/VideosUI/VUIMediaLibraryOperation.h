...
- (void).cxx_destruct;	// IMP=0x000000000015873b
...
- (void)cancel;	// IMP=0x0000000000158651
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000001585b0
- (id)init;	// IMP=0x0000000000158541
