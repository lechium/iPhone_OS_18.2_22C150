...
- (void).cxx_destruct;	// IMP=0x00000000000d158b
...
- (id)_resultWithResponses:(id)arg1;	// IMP=0x00000000000d1425
- (void)_startChangesOperationWithMediaEntityFetchResponses:(id)arg1 currentFetchResponses:(id)arg2;	// IMP=0x00000000000d11a3
- (void)_handleCompletdFetchWithResponses:(id)arg1 error:(id)arg2;	// IMP=0x00000000000d0feb
- (void)_startMediaLibraryFetchOperation;	// IMP=0x00000000000d0c04
- (void)cancel;	// IMP=0x00000000000d0b86
- (void)executionDidBegin;	// IMP=0x00000000000d0b74
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2 requests:(id)arg3;	// IMP=0x00000000000d0aab
