...
- (void).cxx_destruct;	// IMP=0x0000000000185079
...
- (id)_prefixForString:(id)arg1;	// IMP=0x0000000000184eed
- (void)recordLog:(id)arg1;	// IMP=0x0000000000184d60
- (id)cacheDownloadedFileFromLocation:(id)arg1;	// IMP=0x0000000000184b7e
- (id)cachePath;	// IMP=0x0000000000184b0d
- (void)cancelDownload;	// IMP=0x0000000000184abe
- (void)startDownloadWithSession:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000184a16
- (id)initWithRemoteURL:(id)arg1 shareURL:(id)arg2 fileName:(id)arg3;	// IMP=0x00000000001848a7
