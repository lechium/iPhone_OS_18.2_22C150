...
- (void).cxx_destruct;	// IMP=0x00000000002df44a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002df38a
- (void)removeUnicodeFromScoreValuesIfNeeded;	// IMP=0x00000000002df132
- (id)dictionaryRepresentation;	// IMP=0x00000000002df114
- (id)jsContextDictionary;	// IMP=0x00000000002df06c
@property(readonly, nonatomic) _Bool showScoreboard;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000002dedb0
