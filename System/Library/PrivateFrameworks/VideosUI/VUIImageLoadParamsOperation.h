...
- (void).cxx_destruct;	// IMP=0x000000000026d1cb
...
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x000000000026cff9
- (id)init;	// IMP=0x000000000026cf8a
