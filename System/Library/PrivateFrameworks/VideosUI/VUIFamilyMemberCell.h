...
+ (id)_monogramViewForFamilyMemberCell:(id)arg1;	// IMP=0x00100000002c2ff5
+ (double)maxMonogramHeight;	// IMP=0x00100000002c2fca
+ (void)configureVUIFamilyMemberCell:(id)arg1 withFamilyMember:(id)arg2 metricsOnly:(_Bool)arg3;	// IMP=0x00100000002c2359
- (void).cxx_destruct;	// IMP=0x00000000002c3d42
...
- (struct CGSize)_iOS_layoutSubviewsWithSize:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000002c3449
- (void)configureMonogramImageLayoutForWindowWidth:(double)arg1;	// IMP=0x00000000002c33ca
@property(readonly, nonatomic) struct CGSize monogramSize;
- (void)familyMember:(id)arg1 photoRequestDidCompleteWithImage:(id)arg2;	// IMP=0x00000000002c2df5
- (void)layoutSubviews;	// IMP=0x00000000002c2d8c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002c2d75
- (void)prepareForReuse;	// IMP=0x00000000002c29c8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002c26b3
