...
- (void).cxx_destruct;	// IMP=0x00000000001f7564
...
- (struct CGSize)_horizontalFittingSizeForFontDescriptor:(id)arg1 gutterSize:(double)arg2 itemCount:(long long)arg3 itemSizes:(out struct CGSize *)arg4;	// IMP=0x00000000001f73b6
- (void)_updateAllMetrics;	// IMP=0x00000000001f727a
- (void)updateSizes;	// IMP=0x00000000001f724c
- (struct CGSize)sizeForCellAtIndex:(long long)arg1;	// IMP=0x00000000001f71fa
- (void)setFittingWidth:(double)arg1;	// IMP=0x00000000001f71c2
- (void)_setNeedsUpdate;	// IMP=0x00000000001f7043
- (void)_recalculateSizes;	// IMP=0x00000000001f6fb8
- (void)dealloc;	// IMP=0x00000000001f6f79
