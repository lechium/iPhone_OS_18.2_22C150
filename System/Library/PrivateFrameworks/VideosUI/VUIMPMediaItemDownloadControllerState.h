...
- (void).cxx_destruct;	// IMP=0x00000000002daaab
...
- (id)description;	// IMP=0x00000000002da5ff
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002da425
- (unsigned long long)hash;	// IMP=0x00000000002da33a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002da2e2
- (id)init;	// IMP=0x00000000002da27e
