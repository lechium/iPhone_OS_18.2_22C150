...
- (void).cxx_destruct;	// IMP=0x0000000000033d87
...
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000033c47
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x0000000000033bcf
- (void)_defaultsSwitchPressed:(id)arg1;	// IMP=0x0000000000033bb2
- (void)layoutSubviews;	// IMP=0x00000000000335cf
- (void)configureCellWithDefaults:(id)arg1;	// IMP=0x0000000000033322
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000032df6
