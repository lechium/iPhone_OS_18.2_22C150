...
- (void).cxx_destruct;	// IMP=0x000000000028b7ae
...
- (void)executionDidBegin;	// IMP=0x000000000028b3d8
- (id)initWithDatabase:(id)arg1;	// IMP=0x000000000028b337
- (id)init;	// IMP=0x000000000028b2c8
