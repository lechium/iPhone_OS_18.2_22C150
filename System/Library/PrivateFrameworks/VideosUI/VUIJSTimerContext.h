...
- (void).cxx_destruct;	// IMP=0x00000000000e9f65
...
- (void)dealloc;	// IMP=0x00000000000e9ef4
- (void)removeManagedReferences;	// IMP=0x00000000000e9dbe
- (id)description;	// IMP=0x00000000000e9d3c
- (id)initWithCallback:(id)arg1 callbackArgs:(id)arg2 repeating:(_Bool)arg3 ownerObject:(id)arg4 timer:(id)arg5;	// IMP=0x00000000000e9b93
