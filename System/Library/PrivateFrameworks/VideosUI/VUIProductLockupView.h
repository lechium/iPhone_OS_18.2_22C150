...
+ (id)productLockupViewWithMedia:(id)arg1;	// IMP=0x001000000024e009
- (void).cxx_destruct;	// IMP=0x0000000000252ac8
...
- (id)_contentDescriptionFont;	// IMP=0x0000000000252769
- (struct CGSize)_layoutForStacked:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x00000000002519d4
- (struct CGSize)_layoutForCompact:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x0000000000250d6c
- (struct CGSize)_layoutForCategoryAccessibility:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x0000000000250755
- (struct CGSize)_layoutWithSize:(struct CGSize)arg1 metricsOnly:(_Bool)arg2;	// IMP=0x0000000000250540
- (double)_descriptionBottomMarginWithBaselineMargin:(double)arg1;	// IMP=0x00000000002504bd
- (double)_descriptionTopMarginWithBaselineMargin:(double)arg1 otherFont:(id)arg2;	// IMP=0x00000000002503f9
- (struct CGSize)_sizeOfDescriptionLabel:(double)arg1;	// IMP=0x000000000025025f
- (id)_contentDescriptionAttributedString;	// IMP=0x000000000024ff89
- (void)_updateSubtitleLabelForWindowWidth:(double)arg1;	// IMP=0x000000000024fedc
- (void)rentalExpirationLabelNeedsRelayout:(id)arg1;	// IMP=0x000000000024feab
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000024fe94
- (void)layoutSubviews;	// IMP=0x000000000024fe01
- (void)setCoverArtImageProxy:(id)arg1 placeholderImage:(id)arg2;	// IMP=0x000000000024f54f
- (void)updateWithMediaEntity:(id)arg1;	// IMP=0x000000000024e48d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000024e08a
