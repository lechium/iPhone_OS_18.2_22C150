...
- (void).cxx_destruct;	// IMP=0x0000000000af5153
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000af5120
- (id)actionForLayer:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000af5081
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000af4b22
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000af482a
- (id)init;	// IMP=0x0000000000af4728
