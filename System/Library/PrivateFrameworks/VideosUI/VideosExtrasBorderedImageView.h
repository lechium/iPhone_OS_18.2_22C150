...
- (void)replicateStateFromImageView:(id)arg1;	// IMP=0x000000000000df22
@property(nonatomic) double borderWidth;
@property(copy, nonatomic) UIColor *borderColor;
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x000000000000dcf7
- (void)setTransform:(struct CGAffineTransform)arg1;	// IMP=0x000000000000dc82
