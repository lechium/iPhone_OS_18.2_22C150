...
- (void).cxx_destruct;	// IMP=0x000000000009832e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009805e
- (unsigned long long)hash;	// IMP=0x0000000000097fb4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000097fa9
- (void)_assetControllerStateDidChange:(id)arg1;	// IMP=0x0000000000097e84
- (void)_removeDeletedMediaItemInShowPageIfNeeded;	// IMP=0x0000000000097b94
- (void)_configureWithMediaEntities:(id)arg1;	// IMP=0x00000000000975f9
- (id)initWithMediaEntities:(id)arg1 withDownloadType:(long long)arg2;	// IMP=0x0000000000097042
- (id)initWithMediaEntity:(id)arg1 withDownloadType:(long long)arg2;	// IMP=0x0000000000096f8c
