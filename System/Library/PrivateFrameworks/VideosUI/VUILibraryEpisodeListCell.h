...
+ (id)_metadataLabelWithString:(id)arg1 existingLabel:(id)arg2;	// IMP=0x0060000000072ef3
+ (void)configureVUILibraryEpisodeListCell:(id)arg1 withMedia:(id)arg2 andAssetController:(id)arg3;	// IMP=0x0060000000070687
- (void).cxx_destruct;	// IMP=0x0000000000073163
...
- (_Bool)_contentSizeCategoryIsAccessibility;	// IMP=0x0000000000072eaf
- (double)_metadataHeightToBaselineNonAXContentSizeCategory;	// IMP=0x0000000000072e75
- (double)_metadataScaledTopMarginForNonAXContentSizeCategory;	// IMP=0x0000000000072df3
- (void)_configureDotSeparator;	// IMP=0x0000000000072c8e
- (void)_addDownloadButtonIfRequired:(id)arg1;	// IMP=0x0000000000072b53
- (void)layoutSubviews;	// IMP=0x00000000000716c4
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000070caf
- (void)prepareForReuse;	// IMP=0x0000000000070c6c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000070a1f
