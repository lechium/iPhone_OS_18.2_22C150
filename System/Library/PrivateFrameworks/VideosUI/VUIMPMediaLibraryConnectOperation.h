...
- (void).cxx_destruct;	// IMP=0x00000000002dd765
...
- (void)_notifyClientOfProgress:(float)arg1;	// IMP=0x00000000002dd562
- (void)_stopProgressTimer;	// IMP=0x00000000002dd50f
- (void)_startProgressTimer;	// IMP=0x00000000002dd3bf
- (void)executionDidBegin;	// IMP=0x00000000002dd083
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000002dcfe2
- (id)init;	// IMP=0x00000000002dcf73
