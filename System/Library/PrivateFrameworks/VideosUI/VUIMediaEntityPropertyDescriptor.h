...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x001000000025cff6
- (void).cxx_destruct;	// IMP=0x000000000025d1f8
...
- (void)_updateSourceSupportsFiltering;	// IMP=0x000000000025d0b8
- (id)description;	// IMP=0x000000000025ca3e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000025c94f
- (id)init;	// IMP=0x000000000025c60c
