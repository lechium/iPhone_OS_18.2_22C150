...
- (void).cxx_destruct;	// IMP=0x0000000000081e62
...
- (id)description;	// IMP=0x00000000000816f7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008140a
- (unsigned long long)hash;	// IMP=0x00000000000812aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000081229
@property(readonly, nonatomic, getter=isDownloadInProgress) _Bool downloadInProgress;
- (id)init;	// IMP=0x00000000000811c2
