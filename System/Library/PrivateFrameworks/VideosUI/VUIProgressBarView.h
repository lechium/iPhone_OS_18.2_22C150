...
- (void).cxx_destruct;	// IMP=0x00000000002dca49
...
- (void)setgradientEndColor:(id)arg1;	// IMP=0x00000000002dc827
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000002dc2af
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002dc24d
