...
- (void)removeWatchers;	// IMP=0x000000000000cce0
- (void)installWatchers;	// IMP=0x000000000000ca00
- (void)cancel;	// IMP=0x000000000000c760
- (void)_performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2 uninstalledProxies:(id)arg3;	// IMP=0x000000000000c1c0
- (void)performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2;	// IMP=0x000000000000ba70
- (void)dealloc;	// IMP=0x000000000000b920
- (id)initWithAttributes:(id)arg1 flags:(unsigned long long)arg2 host:(id)arg3 report:(CDUnknownBlockType)arg4;	// IMP=0x000000000000b480
