...
- (void).cxx_destruct;	// IMP=0x00000000000d2813
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000d25b2
- (void)start;	// IMP=0x00000000000d22c1
- (id)initWithConnectionInterface:(id)arg1 action:(id)arg2 actionMetadata:(id)arg3 parameterMetadata:(id)arg4 optionsProviderReference:(id)arg5 searchTerm:(id)arg6 localeIdentifier:(id)arg7 queue:(id)arg8 completionHandler:(CDUnknownBlockType)arg9;	// IMP=0x00000000000d1e36
