...
- (void).cxx_destruct;	// IMP=0x0000000000097926
...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000097792
- (void)start;	// IMP=0x00000000000976c1
- (id)initWithConnectionInterface:(id)arg1 query:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000009741c
