...
- (void).cxx_destruct;	// IMP=0x00000000000a18d5
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000a1741
- (void)start;	// IMP=0x00000000000a152d
- (id)initWithConnectionInterface:(id)arg1 action:(id)arg2 actionMetadata:(id)arg3 parameterIdentifier:(id)arg4 queue:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000000000a11b8
