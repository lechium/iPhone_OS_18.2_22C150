...
- (void).cxx_destruct;	// IMP=0x00000000000b9658
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000b94b3
- (void)start;	// IMP=0x00000000000b9395
- (id)initWithConnectionInterface:(id)arg1 appIntentIdentifiers:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000b90ed
