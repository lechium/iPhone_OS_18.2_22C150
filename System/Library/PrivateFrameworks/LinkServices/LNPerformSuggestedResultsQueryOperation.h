...
- (void).cxx_destruct;	// IMP=0x00000000000c9015
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000c8e4e
- (void)start;	// IMP=0x00000000000c8d0a
- (id)initWithConnectionInterface:(id)arg1 entityType:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000c8a42
- (id)initWithConnectionInterface:(id)arg1 entityMangledTypeName:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000c877c
