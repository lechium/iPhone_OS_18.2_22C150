...
- (void).cxx_destruct;	// IMP=0x00000000000960ea
...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000095f3f
- (void)start;	// IMP=0x0000000000095d50
- (id)initWithConnectionInterface:(id)arg1 actionOutput:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000095aab
