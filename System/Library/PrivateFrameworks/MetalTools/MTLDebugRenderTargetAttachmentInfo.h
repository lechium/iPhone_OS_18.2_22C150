...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b6363
- (unsigned long long)hash;	// IMP=0x00000000000b6355
- (unsigned long long)intersectsTexture:(id)arg1;	// IMP=0x00000000000b61d3
- (id)initWithDesc:(const struct MTLRenderPassAttachmentDescriptorPrivate *)arg1 renderTargetArrayLength:(unsigned long long)arg2;	// IMP=0x00000000000b604c
