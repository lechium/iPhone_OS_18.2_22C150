...
- (void).cxx_destruct;	// IMP=0x00000000000b768c
...
- (unsigned int)_updateWithDeviceIE:(const char *)arg1 end:(const char *)arg2;	// IMP=0x00000000000b6b61
- (id)description;	// IMP=0x00000000000b69cf
