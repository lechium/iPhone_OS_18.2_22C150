...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000020aed1
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000020b179
- (id)initWithIdentifier:(id)arg1 displayString:(id)arg2 pronunciationHint:(id)arg3;	// IMP=0x000000000020b07d
