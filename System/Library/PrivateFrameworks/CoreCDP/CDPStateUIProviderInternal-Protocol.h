...
- (void)cdpContext:(CDPContext *)arg1 createLocalSecretWithCompletion:(void (^)(CDPLocalSecret *, NSError *))arg2;
...
@optional
- (void)cdpContext:(CDPContext *)arg1 promptForEDPRecoveryTokenWithValidator:(id <CDPRemoteDeviceSecretValidatorProtocolInternal>)arg2 successfulCDPRecoveryContinuationHandler:(void (^)(void))arg3;
- (void)cdpContext:(CDPContext *)arg1 showResetFailedAlertWithUnderlyingError:(NSError *)arg2 completion:(void (^)(unsigned long long, NSError *))arg3;
- (void)presentQuotaScreenWithCompletion:(void (^)(_Bool, CDPLocalSecret *))arg1;
