...
- (id)_statItemForTimeScope:(long long)arg1;	// IMP=0x00000000001efe0a
- (id)formatterForTimescope:(long long)arg1;	// IMP=0x00000000001efd04
@property(readonly, nonatomic) HKLineSeries *alternateLineSeries;
- (id)initWithCustomDataSource:(id)arg1 primaryDisplayType:(id)arg2;	// IMP=0x00000000001efc63
