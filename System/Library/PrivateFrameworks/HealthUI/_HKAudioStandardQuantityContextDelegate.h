...
- (void).cxx_destruct;	// IMP=0x00000000000ead69
...
- (id)_statItemForTimeScope:(long long)arg1;	// IMP=0x00000000000ead0d
- (id)formatterForTimescope:(long long)arg1;	// IMP=0x00000000000eabea
@property(readonly, nonatomic) HKLineSeries *alternateLineSeries;
- (id)initWithCustomDataSource:(id)arg1 primaryDisplayType:(id)arg2;	// IMP=0x00000000000eab49
