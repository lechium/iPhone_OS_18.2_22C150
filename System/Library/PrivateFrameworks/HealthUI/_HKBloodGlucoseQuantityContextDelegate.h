...
- (id)_statItemForTimeScope:(long long)arg1;	// IMP=0x000000000006750c
- (id)formatterForTimescope:(long long)arg1;	// IMP=0x0000000000067406
@property(readonly, nonatomic) HKLineSeries *alternateLineSeries;
- (id)initWithCustomDataSource:(id)arg1 primaryDisplayType:(id)arg2;	// IMP=0x0000000000067365
