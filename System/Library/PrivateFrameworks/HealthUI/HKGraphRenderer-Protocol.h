...
- (void)setNeedsRender;
- (struct CGSize)drawAttributedText:(NSAttributedString *)arg1 atPoint:(struct CGPoint)arg2 axisRect:(struct CGRect)arg3 horizontalAlignment:(long long)arg4 verticalAlignment:(long long)arg5 exclusion:(id <HKGraphRendererExclusion>)arg6;
- (struct CGSize)drawText:(NSString *)arg1 atPoint:(struct CGPoint)arg2 spaceAvailable:(NSNumber *)arg3 horizontalAlignment:(long long)arg4 verticalAlignment:(long long)arg5 hyphenationFactor:(NSNumber *)arg6 textColor:(UIColor *)arg7 font:(UIFont *)arg8 clipToAxis:(_Bool)arg9 exclusion:(id <HKGraphRendererExclusion>)arg10 isSystemSymbol:(_Bool)arg11 isTallText:(_Bool)arg12;
