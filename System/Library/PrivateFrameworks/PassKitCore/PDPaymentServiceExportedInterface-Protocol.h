...
@class NSArray, NSCalendar, NSData, NSDate, NSDictionary, NSError, NSPredicate, NSSet, NSString, NSURL, NSUUID, PKAppletSubcredential, PKAppletSubcredentialSharingInvitation, PKAppletSubcredentialSharingInvitationRequest, PKApplyWebServiceApplicationDeleteRequest, PKApplyWebServiceApplyRequest, PKApplyWebServiceDocumentSubmissionRequest, PKApplyWebServiceTermsRequest, PKApplyWebServiceVerificationSubmissionRequest, PKBarcodePaymentEvent, PKEncryptedDataObject, PKEncryptedPushProvisioningTarget, PKExpressPassConfiguration, PKExpressPassInformation, PKIdentityProvisioningAttestations, PKMerchant, PKPartialShareInvitation, PKPassAuxiliaryPassInformationItem, PKPassShare, PKPaymentApplication, PKPaymentAvailableProductsRequest, PKPaymentInstallmentConfiguration, PKPaymentProductsActionRequest, PKPaymentRewardsRedemption, PKPaymentShareableCredential, PKPaymentTransaction, PKPaymentTransactionRequest, PKPaymentWebServiceContext, PKPendingProvisioning, PKPlaceholderPassConfiguration, PKPushProvisioningTarget, PKShareablePassMetadata, PKSharingMessage, PKTapToRadarRequest;

@protocol PDPaymentServiceExportedInterface <PDXPCServiceExportedInterface>
- (void)regionsWithIdentifiers:(NSArray *)arg1 completion:(void (^)(NSArray *))arg2;
- (void)regionsMatchingName:(NSString *)arg1 types:(NSArray *)arg2 completion:(void (^)(NSArray *))arg3;
- (void)simulateSecureEvent:(NSDictionary *)arg1;
- (void)deletePaymentRewardsRedemptionsForPassUniqueIdentifier:(NSString *)arg1 completion:(void (^)(void))arg2;
- (void)updatePaymentRewardsRedemptionsWithPassUniqueIdentifier:(NSString *)arg1 limit:(long long)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
- (void)insertOrUpdatePaymentRewardsRedemption:(PKPaymentRewardsRedemption *)arg1 withPassUniqueIdentifier:(NSString *)arg2 completion:(void (^)(void))arg3;
- (void)paymentRewardsRedemptionsForPassUniqueIdentifier:(NSString *)arg1 paymentHashes:(NSSet *)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
- (void)paymentRewardsRedemptionsForPassUniqueIdentifier:(NSString *)arg1 limit:(long long)arg2 completion:(void (^)(NSArray *))arg3;
- (void)paymentRewardsRedemptionForPaymentHash:(NSString *)arg1 completion:(void (^)(PKPaymentRewardsRedemption *))arg2;
- (void)updatePaymentRewardsBalancesWithPassUniqueIdentifier:(NSString *)arg1 completion:(void (^)(NSArray *, NSError *))arg2;
- (void)paymentRewardsBalancesWithPassUniqueIdentifier:(NSString *)arg1 completion:(void (^)(NSArray *))arg2;
- (void)paymentRewardsBalanceWithIdentifier:(NSString *)arg1 completion:(void (^)(PKPaymentRewardsBalance *))arg2;
- (void)deleteIssuerInstallmentTransactionsForPassUniqueID:(NSString *)arg1 completion:(void (^)(NSError *))arg2;
- (void)issuerInstallmentTransactionsForTransactionSourceIdentifiers:(NSSet *)arg1 paymentHashes:(NSSet *)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
- (void)issuerInstallmentTransactionsForPassUniqueID:(NSString *)arg1 completion:(void (^)(NSArray *, NSError *))arg2;
- (void)removePaymentOffersCatalog;
- (void)updatePaymentOffersCatalogWithCompletion:(void (^)(PKPaymentOfferCatalog *, NSError *))arg1;
- (void)paymentOffersCatalogWithCompletion:(void (^)(PKPaymentOfferCatalog *))arg1;
...
- (void)generateUnderlyingKeyReportWithCompletion:(void (^)(NSDictionary *))arg1;
...
- (void)createShareInvitationForPartialShareInvitation:(PKPartialShareInvitation *)arg1 existingTransportIdentifier:(NSString *)arg2 authorization:(NSData *)arg3 completion:(void (^)(PKSharingMessage *, PKPassShare *, NSError *))arg4;
...
- (void)queueIdentityPassProvisioningWithPassMetadata:(PKShareablePassMetadata *)arg1 targetDeviceIdentifier:(NSString *)arg2 credentialIdentifier:(NSString *)arg3 supplementalData:(NSData *)arg4 completion:(void (^)(NSError *))arg5;
- (void)provisionIdentityPassWithPassMetadata:(PKShareablePassMetadata *)arg1 targetDeviceIdentifier:(NSString *)arg2 credentialIdentifier:(NSString *)arg3 attestations:(PKIdentityProvisioningAttestations *)arg4 supplementalData:(NSData *)arg5 completion:(void (^)(PKSecureElementPass *, NSError *))arg6;
...
- (void)clearProvisioningSupportDataOfType:(unsigned long long)arg1 completion:(void (^)(void))arg2;
- (void)saveProvisioningSupportData:(NSArray *)arg1 completion:(void (^)(NSError *))arg2;
...
- (void)revokeCredentialsWithReaderIdentifiers:(NSSet *)arg1 completion:(void (^)(_Bool))arg2;
...
- (void)changePasscodeFrom:(NSString *)arg1 toPasscode:(NSString *)arg2 completion:(void (^)(_Bool, NSError *))arg3;
...
- (void)conflictingExpressPassIdentifiersForPassConfiguration:(PKExpressPassConfiguration *)arg1 withReferenceExpressState:(NSSet *)arg2 completion:(void (^)(NSSet *))arg3;
- (void)conflictingExpressPassIdentifiersForPassInformation:(PKExpressPassInformation *)arg1 withCompletion:(void (^)(NSSet *))arg2;
- (void)conflictingExpressPassIdentifiersForPassConfiguration:(PKExpressPassConfiguration *)arg1 withCompletion:(void (^)(NSSet *))arg2;
- (void)setExpressWithPassInformation:(PKExpressPassInformation *)arg1 credential:(NSData *)arg2 completion:(void (^)(_Bool, NSSet *))arg3;
- (void)setExpressWithPassConfiguration:(PKExpressPassConfiguration *)arg1 credential:(NSData *)arg2 completion:(void (^)(_Bool, NSSet *))arg3;
- (void)usingSynchronousProxy:(_Bool)arg1 expressPassConfigurationsWithHandler:(void (^)(NSSet *))arg2;
- (void)expressPassesInformationWithAutomaticSelectionTechnologyType:(long long)arg1 handler:(void (^)(NSSet *))arg2;
- (void)expressPassConfigurationsWithCardType:(long long)arg1 handler:(void (^)(NSSet *))arg2;
- (void)expressPassConfigurationWithPassUniqueIdentifier:(NSString *)arg1 handler:(void (^)(PKExpressPassConfiguration *))arg2;
...
- (void)transactionsTotalAmountForRequest:(PKPaymentTransactionRequest *)arg1 completion:(void (^)(PKCurrencyAmount *))arg2;
...
- (void)transactionsWithFullPaymentHashes:(NSSet *)arg1 transactionSourceIdentifiers:(NSSet *)arg2 completion:(void (^)(NSArray *))arg3;
- (void)transactionsWithTransactionIdentifiers:(NSArray *)arg1 completion:(void (^)(NSArray *))arg2;
