...
- (void)unexpiredPassesOrderedByGroup:(void (^)(NSArray *))arg1;
...
- (void)isWatchIssuerAppProvisioningSupportedWithHandler:(void (^)(_Bool))arg1;
...
- (void)getPassesWithSearchableTransactions:(void (^)(NSSet *))arg1;
...
- (void)migrateDataWithHandler:(void (^)(_Bool))arg1 didRestoreFromBackup:(_Bool)arg2;
...
- (void)hasPassesInExpiredSectionWithHandler:(void (^)(_Bool))arg1;
...
- (void)usingSynchronousProxy:(_Bool)arg1 dynamicStateForPassUniqueID:(NSString *)arg2 handler:(void (^)(PKPassDynamicState *))arg3;
- (void)usingSynchronousProxy:(_Bool)arg1 setLiveRenderingEnabled:(_Bool)arg2 forPassUniqueID:(NSString *)arg3 handler:(void (^)(unsigned long long))arg4;
- (void)hasRemoteLibraryWithHandler:(void (^)(_Bool))arg1;
- (void)getPassesWithReaderIdentifier:(NSString *)arg1 handler:(void (^)(NSSet *))arg2;
