...
@class NSArray, NSData, NSDate, NSMapTable, NSNumber, NSSet, NSString, NSUUID, PKACAccountChange, PKAddShareablePassConfiguration, PKAliroHomeAuxiliaryCapabilityDescriptor, PKAppleAccountChange, PKContact, PKDisplayProfile, PKDisplayTraitCollection, PKFieldProperties, PKFileDescriptorXPCContainer, PKGroupsControllerSnapshotFetchOptions, PKPassesXPCContainer, PKPaymentSetupRequest, PKUnifiedAccessHomeAuxiliaryCapabilityDescriptor;
