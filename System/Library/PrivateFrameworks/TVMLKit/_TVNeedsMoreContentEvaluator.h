...
- (void).cxx_destruct;	// IMP=0x0000000000113f4b
...
- (void)reset;	// IMP=0x0000000000113eef
- (void)evaluateForState:(long long)arg1;	// IMP=0x0000000000113c18
- (id)initWithScrollView:(id)arg1 axis:(long long)arg2;	// IMP=0x0000000000113ac2
- (id)init;	// IMP=0x0000000000113ab4
