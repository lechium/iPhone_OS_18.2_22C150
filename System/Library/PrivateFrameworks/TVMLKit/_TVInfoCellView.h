...
+ (id)infoCellViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000b0c09
- (void).cxx_destruct;	// IMP=0x00000000000b2c59
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000b283c
- (void)layoutSubviews;	// IMP=0x00000000000b20f0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 withHeaderWidth:(double)arg2;	// IMP=0x00000000000b1b39
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000b1aec
- (double)minimumHeaderWidth;	// IMP=0x00000000000b17a5
