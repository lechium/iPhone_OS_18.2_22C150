...
+ (id)_histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000003d16c
+ (id)histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000003ce5a
- (void).cxx_destruct;	// IMP=0x000000000003e519
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000003dad3
- (_Bool)canBecomeFocused;	// IMP=0x000000000003dacb
