...
- (void).cxx_destruct;	// IMP=0x00000000000c5603
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000c52b5
- (long long)_positionFromView:(id)arg1;	// IMP=0x00000000000c5297
- (struct CGSize)_contentSizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000c4d9b
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000c4caf
- (id)preferredFocusEnvironments;	// IMP=0x00000000000c4a53
- (_Bool)canBecomeFocused;	// IMP=0x00000000000c4a4b
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000c48c8
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000c48b3
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x00000000000c43ee
- (void)layoutSubviews;	// IMP=0x00000000000c2eea
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000c2d20
- (struct UIEdgeInsets)tv_alignmentInsetsForExpectedWidth:(double)arg1;	// IMP=0x00000000000c1759
@property(nonatomic) double cornerRadius;
- (void)setComponentsNeedUpdate;	// IMP=0x00000000000c02c7
@property(nonatomic) __weak UIView *preferredFocusedComponent;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000c01b6
