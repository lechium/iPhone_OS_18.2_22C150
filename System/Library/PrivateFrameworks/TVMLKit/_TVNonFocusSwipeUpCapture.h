...
- (void).cxx_destruct;	// IMP=0x0000000000103fa1
...
- (void)_onPan:(id)arg1;	// IMP=0x0000000000103be2
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x0000000000103b51
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000103a84
