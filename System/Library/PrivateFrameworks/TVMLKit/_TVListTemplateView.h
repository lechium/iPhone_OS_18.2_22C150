...
- (void).cxx_destruct;	// IMP=0x0000000000119bca
...
- (void)layoutSubviews;	// IMP=0x0000000000118ae0
@property(readonly, nonatomic) long long listAlignment;
- (void)adjustScrollForListView:(id)arg1;	// IMP=0x0000000000118956
- (id)preferredFocusEnvironments;	// IMP=0x00000000001188dd
- (void)setOverlayBlurOffset:(double)arg1;	// IMP=0x0000000000118764
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x00000000001181ce
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001180fb
