...
- (void).cxx_destruct;	// IMP=0x0000000000063070
...
- (void)_freeBuffers;	// IMP=0x0000000000062fbc
- (void)_compute;	// IMP=0x00000000000622d3
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000062237
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x00000000000621fc
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x00000000000621c1
- (void)dealloc;	// IMP=0x0000000000062183
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x000000000006210f
