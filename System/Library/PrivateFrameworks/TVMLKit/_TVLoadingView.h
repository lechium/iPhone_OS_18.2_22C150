...
- (void).cxx_destruct;	// IMP=0x000000000001ac22
...
- (void)_showSpinner;	// IMP=0x000000000001a9d7
- (_Bool)canBecomeFocused;	// IMP=0x000000000001a9cf
- (void)layoutSubviews;	// IMP=0x000000000001a599
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001a454
