...
- (void).cxx_destruct;	// IMP=0x0000000000055d50
@property(nonatomic) __weak id <SFStartPageCustomizationCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void)valueDidChange:(id)arg1;	// IMP=0x0000000000055ccc
- (void)setAccessories:(id)arg1;	// IMP=0x0000000000055bde
@property(nonatomic, getter=isOn) _Bool on;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000055ab7
