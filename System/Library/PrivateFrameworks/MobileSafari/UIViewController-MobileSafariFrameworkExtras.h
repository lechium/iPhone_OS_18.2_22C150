...
- (_Bool)_sf_isPresentationControllerDismissalTransitionDidEndNotification:(id)arg1;	// IMP=0x00300000000a6eba
...
- (void)_sf_animateAlongsideTransitionOrPerform:(CDUnknownBlockType)arg1;	// IMP=0x00300000000a6c60
- (void)_sf_presentViewControllerOnTopOfPresentedViewController:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00300000000a6b37
...
- (void)safari_dismissPresentedAlert;	// IMP=0x00300000000a6969
- (_Bool)safari_isEventuallyPresentedByViewControllerClass:(Class)arg1;	// IMP=0x00300000000a68ab
...
- (void)safari_updateApplicationBackgroundStyle;	// IMP=0x00300000000a66a5
