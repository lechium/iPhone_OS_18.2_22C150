...
+ (id)rangeErrorIntentResponseWithRangeErrorGroupNumber:(id)arg1 rangeErrorGroupCount:(id)arg2;	// IMP=0x0060000000392814
+ (id)noMatchIntentResponseWithNoMatchIndex:(id)arg1;	// IMP=0x00600000003927a6
@property(nonatomic) long long code; // @synthesize code=_code;
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x000000000039270a
