...
- (_Bool)matchesPerson:(id)arg1 withUnifiedContactIdentifiers:(id)arg2;	// IMP=0x0000000000030e12
- (id)initWithHandle:(id)arg1 contactIdentifiers:(id)arg2 isMe:(_Bool)arg3;	// IMP=0x0000000000030c19
