...
- (void).cxx_destruct;	// IMP=0x000000000043b6d0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000043b670
@property(nonatomic) _Bool enabled;
- (_Bool)isEnabled;	// IMP=0x000000000043b5d0
@property(nonatomic) _Bool highlighted;
- (_Bool)isHighlighted;	// IMP=0x000000000043b590
@property(nonatomic) _Bool selected;
- (_Bool)isSelected;	// IMP=0x000000000043b550
- (void)layoutSubviews;	// IMP=0x000000000043b440
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000043b3a0
