...
@class GPInProcessMagicPaperViewController, UIImage;
...
@optional
- (id <GPMagicPaperImageGenerationEvent>)magicPaperViewControllerImageGenerationEvent:(GPInProcessMagicPaperViewController *)arg1;
