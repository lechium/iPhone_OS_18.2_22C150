...
- (void)fetchCorrespondingSignedClinicalDataRecordWithHealthRecordsStore:(HKHealthRecordsStore *)arg1 completion:(void (^)(HKSignedClinicalDataRecord *, NSError *))arg2;
