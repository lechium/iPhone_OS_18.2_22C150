...
+ (id)sortDateComponentsOfDateComponents:(id)arg1 withDayOffset:(long long)arg2;	// IMP=0x006000000003c68e
+ (id)sortDateComponentsOfDate:(id)arg1;	// IMP=0x006000000003c60b
- (void).cxx_destruct;	// IMP=0x000000000003c825
...
- (void)resetPagingContext;	// IMP=0x000000000003c591
- (_Bool)shouldQueryForNextBatch;	// IMP=0x000000000003c544
- (id)init;	// IMP=0x000000000003c4f8
