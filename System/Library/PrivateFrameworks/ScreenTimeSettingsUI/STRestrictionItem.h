...
- (void).cxx_destruct;	// IMP=0x000000000004d112
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004d084
- (id)description;	// IMP=0x000000000004cfce
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004ce8c
- (unsigned long long)hash;	// IMP=0x000000000004ce00
- (id)initWithConfiguration:(id)arg1 restrictionKey:(id)arg2 labelName:(id)arg3 type:(unsigned long long)arg4 restrictionValue:(id)arg5;	// IMP=0x000000000004cb78
