...
- (void).cxx_destruct;	// IMP=0x00000000000c06bb
...
- (void)_didFetchAppInfoOrIcon:(id)arg1;	// IMP=0x00000000000c061a
- (void)refreshCellContentsWithSpecifier:(id)arg1;	// IMP=0x00000000000c04e3
- (void)setValue:(id)arg1;	// IMP=0x00000000000c00ec
- (id)value;	// IMP=0x00000000000c00ae
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2 specifier:(id)arg3;	// IMP=0x00000000000bf277
