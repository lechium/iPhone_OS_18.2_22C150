...
- (void).cxx_destruct;	// IMP=0x000000000002b599
...
- (void)setUpSectionHeightConstraints;	// IMP=0x000000000002b035
- (void)setUpSections;	// IMP=0x000000000002a703
@property(getter=isDarkened) _Bool darkened;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000002a0b6
- (id)initWithDataPoint:(id)arg1 useVibrancy:(_Bool)arg2;	// IMP=0x0000000000029e30
