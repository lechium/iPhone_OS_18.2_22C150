...
@interface STContentPrivacyViewModel : NSObject
{
    ...
    _Bool _restrictionsEnabled;	// 11 = 0xb
    _Bool _shouldAllowEditing;	// 12 = 0xc
    _Bool _isSiriImageGenerationAllowed;	// 13 = 0xd
    _Bool _userIsManaged;	// 14 = 0xe
    _Bool _userIsRemote;	// 15 = 0xf
...
- (void).cxx_destruct;	// IMP=0x000000000004dc2c
...
@property(nonatomic) _Bool isSiriImageGenerationAllowed; // @synthesize isSiriImageGenerationAllowed=_isSiriImageGenerationAllowed;
...
- (_Bool)shouldEnableRestriction:(id)arg1;	// IMP=0x000000000004d8d0
- (id)defaultValueForRestriction:(id)arg1;	// IMP=0x000000000004d7b8
- (id)visibleRestrictionWithConfiguration:(id)arg1 key:(id)arg2;	// IMP=0x000000000004d60a
- (id)init;	// IMP=0x000000000004d589
