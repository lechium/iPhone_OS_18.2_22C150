...
- (void).cxx_destruct;	// IMP=0x00000000000aa5c1
...
- (void)showMoreItems:(id)arg1;	// IMP=0x00000000000aa4fc
- (void)updateSpecifier:(id)arg1 usageItem:(id)arg2;	// IMP=0x00000000000aa482
- (id)newSpecifierWithUsageItem:(id)arg1;	// IMP=0x00000000000aa3fc
- (void)refreshUsageSpecifiersWithUpdates:(_Bool)arg1;	// IMP=0x00000000000a9ff9
- (id)init;	// IMP=0x00000000000a9d0a
