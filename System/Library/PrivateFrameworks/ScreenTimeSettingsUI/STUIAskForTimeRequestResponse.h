...
- (void).cxx_destruct;	// IMP=0x00000000000b5fa1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b5eb0
- (id)initWithRequestResponse:(id)arg1;	// IMP=0x00000000000b5d2a
- (id)init;	// IMP=0x00000000000b5d16
