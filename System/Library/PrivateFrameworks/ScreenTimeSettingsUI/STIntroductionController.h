...
- (void).cxx_destruct;	// IMP=0x000000000007d5cf
...
- (id)_viewControllerFollowingViewController:(id)arg1;	// IMP=0x000000000007c7ed
- (void)_endIntroductionFlowWithEnablingScreenTime;	// IMP=0x000000000007c747
- (void)_endIntroductionFlowWithoutEnablingScreenTime;	// IMP=0x000000000007c67b
- (void)_viewControllerCompleted:(id)arg1;	// IMP=0x000000000007c4f3
@property(readonly) UIViewController *initialViewController;
- (void)presentOverViewController:(id)arg1;	// IMP=0x000000000007c35a
- (id)initWithNewUserRootViewModelCoordinator:(id)arg1;	// IMP=0x000000000007c1f8
- (id)initWithDSID:(id)arg1 childAge:(id)arg2 childName:(id)arg3 updateExistingSettings:(_Bool)arg4 restrictionsDataSource:(id)arg5;	// IMP=0x000000000007bffd
