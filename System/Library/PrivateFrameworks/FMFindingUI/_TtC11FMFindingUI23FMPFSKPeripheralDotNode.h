...
@interface _TtC11FMFindingUI23FMPFSKPeripheralDotNode
{
    ...
    MISSING_TYPE *findingTechnology;	// 9 = 0x9
...
- (void).cxx_destruct;	// IMP=0x000000000000e820
- (id)init;	// IMP=0x000000000000e6a0
@property(nonatomic, readonly) NSString *description;
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000ccb0
