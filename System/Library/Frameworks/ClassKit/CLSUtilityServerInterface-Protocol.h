...
- (oneway void)remote_setBootstrapMode:(int)arg1 url:(NSURL *)arg2 completion:(void (^)(NSError *))arg3;
- (oneway void)remote_getBootstrapMode:(void (^)(int, NSURL *, NSError *))arg1;
