...
- (id).cxx_construct;	// IMP=0x0000000000256bcd
- (void).cxx_destruct;	// IMP=0x0000000000256b45
- (void)flush;	// IMP=0x0000000000256a53
- (void)setPins:(id)arg1 forMapType:(unsigned long long)arg2 pinColor:(id)arg3 traits:(id)arg4;	// IMP=0x0000000000256623
- (id)pinsWithMapType:(unsigned long long)arg1 pinColor:(id)arg2 traits:(id)arg3;	// IMP=0x00000000002563ee
- (id)init;	// IMP=0x0000000000256238
