...
- (void)placeActionManager:(id <MKPlaceActionManagerProtocol>)arg1 didSelectAddOrEditNoteWithEnvironment:(MKPlaceActionEnvironment *)arg2 selectedAdd:(_Bool)arg3;
- (void)placeActionManager:(id <MKPlaceActionManagerProtocol>)arg1 didSelectAddOrRemoveFromLibraryWithEnvironment:(MKPlaceActionEnvironment *)arg2 selectedAdd:(_Bool)arg3;
