...
- (void).cxx_destruct;	// IMP=0x000000000024cb43
...
- (_Bool)_shouldCollapseTopMessageLabel;	// IMP=0x000000000024ca5d
- (void)_collapseAllLabelsFromOptions;	// IMP=0x000000000024c865
- (void)_updateHoursView;	// IMP=0x000000000024b061
- (void)_updateOptionsForCollapsingToSingleLineAndColor;	// IMP=0x000000000024afdd
- (id)_standardLabel;	// IMP=0x000000000024aec8
- (void)infoCardThemeChanged;	// IMP=0x000000000024adf8
- (_Bool)wantsDefaultClipping;	// IMP=0x000000000024adf0
- (void)applyRulesForTopAndBottomLabel;	// IMP=0x000000000024a87a
- (void)setTopLabel:(id)arg1;	// IMP=0x000000000024a720
@property(readonly, nonatomic) _MKUILabel *topLabel;
- (void)_contentSizeDidChange;	// IMP=0x000000000024a380
- (id)hoursGrayColor;	// IMP=0x000000000024a342
- (void)_commonInit;	// IMP=0x0000000000249cf7
- (id)initWithBusinessHours:(id)arg1;	// IMP=0x0000000000249c2c
