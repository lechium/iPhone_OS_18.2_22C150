...
- (void).cxx_destruct;	// IMP=0x00000000001d963d
...
- (id)_legendStringForDistanceString:(id)arg1 appendUnits:(_Bool)arg2 index:(int)arg3;	// IMP=0x00000000001d940c
@property(readonly, nonatomic) NSString *zeroUnitsString; // @synthesize zeroUnitsString=_zeroUnitsString;
- (id)_uncachedLegendStringsForDistanceString:(id)arg1;	// IMP=0x00000000001d9146
...
- (_Bool)canDisplaySegment:(unsigned long long)arg1;	// IMP=0x00000000001d8b55
- (void)_calculateLegend:(_Bool)arg1;	// IMP=0x00000000001d83ee
- (void)setUnits:(id)arg1;	// IMP=0x00000000001d8196
- (double)_widthForString:(id)arg1 attributes:(id)arg2;	// IMP=0x00000000001d808b
- (void)clearCaches:(id)arg1;	// IMP=0x00000000001d806e
- (id)init;	// IMP=0x00000000001d7e6b
