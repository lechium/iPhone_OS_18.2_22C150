...
- (void).cxx_destruct;	// IMP=0x0000000000087a07
...
- (void)hoursViewDidUpdate:(id)arg1;	// IMP=0x00000000000877bb
- (void)_setUpConstraints;	// IMP=0x00000000000874c3
- (void)_setUpViewsForPlaceHoursDayRow;	// IMP=0x0000000000087450
- (id)initWithBusinessHours:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x000000000008738c
