...
- (void).cxx_destruct;	// IMP=0x0000000000281dad
...
- (_Bool)canDisplayCompleteTitleWhenExpanded;	// IMP=0x0000000000281d74
- (void)setDetailView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000281399
@property(retain, nonatomic) UIView *detailView;
- (void)setRightView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000280686
- (void)setLeftView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000027f82f
@property(retain, nonatomic) UIView *rightView;
@property(retain, nonatomic) UIView *leftView;
@property(copy, nonatomic) NSString *calloutSubtitle;
- (void)setCalloutSubtitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000027f4f4
@property(copy, nonatomic) NSString *calloutTitle;
- (id)_maskedContainerView;	// IMP=0x000000000027f2f1
@property(readonly, nonatomic) struct CGSize preferredContentSize; // @synthesize preferredContentSize=_preferredContentSize;
- (void)_updatePreferredContentSize;	// IMP=0x000000000027f252
- (void)_updatePreferredContentSizeIfNeeded;	// IMP=0x000000000027f231
- (void)_setNeedsUpdatePreferredContentSize;	// IMP=0x000000000027f220
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000027f1f1
- (void)beginMapsTransitionMovingSideways;	// IMP=0x000000000027f15c
- (void)reset;	// IMP=0x000000000027f0f8
- (void)dealloc;	// IMP=0x000000000027f083
@property(nonatomic) double maximumWidth;
@property(nonatomic) double minimumWidth;
- (void)_contentSizeCategoryDidChange:(id)arg1;	// IMP=0x000000000027eddc
- (id)initWithFrame:(struct CGRect)arg1 metrics:(CDStruct_f381021a)arg2;	// IMP=0x000000000027da95
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000027d9f3
