...
- (void).cxx_destruct;	// IMP=0x00000000001f2d74
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001f2cf7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001f2bdf
- (unsigned long long)hash;	// IMP=0x00000000001f2b8f
- (id)initWithSize:(struct CGSize)arg1 headingString:(id)arg2 compassViewStyle:(long long)arg3;	// IMP=0x00000000001f2ae5
