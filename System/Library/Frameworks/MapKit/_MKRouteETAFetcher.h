...
- (void).cxx_destruct;	// IMP=0x0000000000175748
...
- (void)_didUpdateETAResult;	// IMP=0x00000000001756c9
- (void)invalidateETAForTransportType:(unsigned long long)arg1;	// IMP=0x0000000000175675
- (_Bool)isValidETA:(id)arg1;	// IMP=0x00000000001755c8
- (void)expireETAsIfNoLongerValid;	// IMP=0x000000000017533d
- (_Bool)shouldUpdateEstimatedTravelTimeForNewOrigin:(struct CLLocationCoordinate2D)arg1;	// IMP=0x0000000000175245
...
- (_Bool)isUsingCurrentLocationForOrigin;	// IMP=0x0000000000174fff
- (void)requestNewETAForTransportType:(unsigned long long)arg1 additionalTransportTypes:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000017493e
- (id)routeETAForTransportType:(unsigned long long)arg1;	// IMP=0x00000000001748d7
- (void)_resetState;	// IMP=0x000000000017486a
- (void)dealloc;	// IMP=0x0000000000174567
- (id)init;	// IMP=0x00000000001744a2
