...
+ (unsigned long long)_kMaxLinesInSectionBeforePage;	// IMP=0x006000000006ee6c
+ (unsigned long long)_kNumLinesFallbackValue;	// IMP=0x006000000006ee5f
+ (id)defaultFilterForInactiveLines;	// IMP=0x006000000006edde
+ (id)defaultFilterForDepartures;	// IMP=0x006000000006ed5d
