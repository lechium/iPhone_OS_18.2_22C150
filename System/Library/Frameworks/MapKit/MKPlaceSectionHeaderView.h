...
- (void).cxx_destruct;	// IMP=0x0000000000007a4e
...
- (void)setTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000076cb
@property(retain, nonatomic) UIImage *icon;
@property(retain, nonatomic) NSString *seeMoreButtonText; // @synthesize seeMoreButtonText=_seeMoreButtonText;
- (void)updateConstraints;	// IMP=0x000000000000719b
- (void)updateContent;	// IMP=0x00000000000070fb
- (void)createConstraints;	// IMP=0x000000000000620e
- (_Bool)shouldStack;	// IMP=0x0000000000005e8a
- (void)_updateConstraints;	// IMP=0x0000000000005ad4
- (void)contentSizeDidChange;	// IMP=0x0000000000005ac3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000057f8
