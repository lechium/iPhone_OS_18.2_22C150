...
- (void).cxx_destruct;	// IMP=0x00000000000d18a2
...
- (void)keyUp:(id)arg1;	// IMP=0x00000000000d17a4
- (void)keyDown:(id)arg1;	// IMP=0x00000000000d16a7
- (void)handleArrowMask:(long long)arg1;	// IMP=0x00000000000d15e2
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000d14fa
