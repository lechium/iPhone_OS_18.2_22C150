...
- (void).cxx_destruct;	// IMP=0x00000000000d103f
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000000d0cc3
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000000d0b5a
- (_Bool)tiltGestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000000d09da
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000000d0923
- (void)handleArrowZoom:(id)arg1;	// IMP=0x00000000000cfa56
- (void)handleArrowRotate:(id)arg1;	// IMP=0x00000000000ceb65
- (void)handleArrowPan:(id)arg1;	// IMP=0x00000000000cdef9
- (void)cancelZoomInOrOut;	// IMP=0x00000000000cdeac
- (void)zoomOut;	// IMP=0x00000000000cddd9
- (void)zoomIn;	// IMP=0x00000000000cdd06
- (_Bool)keyUp:(id)arg1;	// IMP=0x00000000000cdc3c
- (_Bool)keyDown:(id)arg1;	// IMP=0x00000000000cd9a1
- (void)_handleInterrupt:(id)arg1;	// IMP=0x00000000000cd8f8
- (void)_handleZoomPan:(id)arg1;	// IMP=0x00000000000cd421
- (void)_handleRotationPan:(id)arg1;	// IMP=0x00000000000cd230
- (void)handleZoomArrowMask:(long long)arg1 speed:(double)arg2;	// IMP=0x00000000000cd0c6
- (double)variableDelayTapRecognizer:(id)arg1 shouldWaitForNextTapForDuration:(double)arg2 afterTouch:(id)arg3;	// IMP=0x00000000000ccfc1
- (void)gestureRecognizerTouchesCanceled:(id)arg1;	// IMP=0x00000000000ccfaf
- (void)gestureRecognizerTouchesEnded:(id)arg1;	// IMP=0x00000000000ccf9d
- (void)gestureRecognizerTouchesBegan:(id)arg1;	// IMP=0x00000000000ccf8b
- (void)handleTouch:(id)arg1;	// IMP=0x00000000000ccf85
- (void)handlePan:(id)arg1;	// IMP=0x00000000000cc38f
- (struct CGPoint)_snapPointToDevicePixels:(struct CGPoint)arg1;	// IMP=0x00000000000cc244
- (void)_updateZoomGestureForState:(long long)arg1 focusPoint:(struct CGPoint)arg2 scale:(double)arg3 velocity:(double)arg4 gestureType:(long long)arg5 configuration:(id)arg6;	// IMP=0x00000000000cb975
- (void)handlePanZoom:(id)arg1;	// IMP=0x00000000000cb743
- (void)handlePinch:(id)arg1;	// IMP=0x00000000000cb537
- (void)handleTwoFingerLongPress:(id)arg1;	// IMP=0x00000000000cb43e
- (void)handleTwoFingerTap:(id)arg1;	// IMP=0x00000000000cb225
- (void)handleDoubleTap:(id)arg1;	// IMP=0x00000000000cafd6
- (void)_updateRotationGestureForState:(long long)arg1 focusPoint:(struct CGPoint)arg2 rotation:(double)arg3 velocity:(double)arg4;	// IMP=0x00000000000ca7e0
- (void)handleRotation:(id)arg1;	// IMP=0x00000000000ca5c6
- (void)handleTilt:(id)arg1;	// IMP=0x00000000000ca5b4
- (void)_handleStandardTilt:(id)arg1;	// IMP=0x00000000000c9bf2
- (void)_setTraitCollection:(id)arg1;	// IMP=0x00000000000c9aee
- (void)clearGestureRecognizersInFlight;	// IMP=0x00000000000c9a7c
- (void)_clearGesture:(id)arg1;	// IMP=0x00000000000c9a07
- (void)stopUserInteractionFromExternalGesture;	// IMP=0x00000000000c99f5
- (void)startUserInteractionFromExternalGesture;	// IMP=0x00000000000c99e3
- (void)endGesturing;	// IMP=0x00000000000c9917
- (void)beginGesturing;	// IMP=0x00000000000c9808
- (void)stopDynamicAnimations;	// IMP=0x00000000000c968d
@property(nonatomic, getter=isScrollEnabled) _Bool scrollEnabled;
@property(nonatomic, getter=isZoomEnabled) _Bool zoomEnabled;
- (void)dealloc;	// IMP=0x00000000000c94eb
...
- (void)_setOneHandedZoomGestureConfiguration:(id)arg1;	// IMP=0x00000000000c941b
@property(readonly, nonatomic) UIGestureRecognizer *oneHandedZoomGestureRecognizer;
- (id)initWithMapView:(id)arg1 gestureTargetView:(id)arg2;	// IMP=0x00000000000c93f8
- (void)setupOneHandedZoomGestureRecognizerForView:(id)arg1;	// IMP=0x00000000000c924a
- (id)initWithMapView:(id)arg1 gestureTargetView:(id)arg2 doubleTapTargetView:(id)arg3;	// IMP=0x00000000000c8904
