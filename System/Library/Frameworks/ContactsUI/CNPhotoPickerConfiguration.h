...
+ (id)gameCenterConfiguration;	// IMP=0x00400000003d0106
+ (id)contactsConfiguration;	// IMP=0x00400000003d00b2
+ (id)defaultConfiguration;	// IMP=0x00400000003d00a0
