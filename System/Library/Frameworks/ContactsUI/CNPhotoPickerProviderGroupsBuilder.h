...
+ (id)builderWithVisualIdentity:(id)arg1 avatarStore:(id)arg2 environment:(id)arg3 contactViewCache:(id)arg4 photoPickerConfiguration:(id)arg5;	// IMP=0x00600000002d95d5
- (void).cxx_destruct;	// IMP=0x00000000002d9597
...
- (id)build;	// IMP=0x00000000002d9285
- (id)emojiContentGroup;	// IMP=0x00000000002d9154
- (id)animojiContentGroup;	// IMP=0x00000000002d8fff
- (id)photoContentGroup;	// IMP=0x00000000002d8d92
- (id)injectedItemsGroup;	// IMP=0x00000000002d8d2f
- (id)addItemsContentGroup;	// IMP=0x00000000002d8bc4
@property(readonly, nonatomic) _Bool includesAnyPhotoContent;
- (id)initWithVisualIdentity:(id)arg1 avatarStore:(id)arg2 environment:(id)arg3 contactViewCache:(id)arg4;	// IMP=0x00000000002d8a40
