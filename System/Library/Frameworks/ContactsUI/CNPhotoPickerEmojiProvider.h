...
- (void).cxx_destruct;	// IMP=0x00000000002af055
...
- (id)loadItemsForSize:(struct CGSize)arg1 scale:(double)arg2 RTL:(_Bool)arg3 renderingQueue:(id)arg4 callbackQueue:(id)arg5 itemDelegate:(id)arg6;	// IMP=0x00000000002aed9d
- (id)initWithVisualIdentity:(id)arg1;	// IMP=0x00000000002aecb4
