...
- (void).cxx_destruct;	// IMP=0x00000000002aa198
...
- (id)contacts;	// IMP=0x00000000002aa0c8
- (void)didUpdateContentForAvatarView:(id)arg1;	// IMP=0x00000000002aa02b
- (id)presentingViewControllerForAvatarView:(id)arg1;	// IMP=0x00000000002a9fbb
- (void)setContacts:(id)arg1;	// IMP=0x00000000002a9f19
- (void)loadView;	// IMP=0x00000000002a9d4c
- (void)setAllowStaleRendering:(_Bool)arg1;	// IMP=0x00000000002a9d02
- (void)updateViewWithGroupIdentity:(id)arg1;	// IMP=0x00000000002a9c93
- (_Bool)_canShowWhileLocked;	// IMP=0x00000000002a9c26
- (id)initWithSettings:(id)arg1;	// IMP=0x00000000002a9b0f
- (id)descriptorForRequiredKeys;	// IMP=0x00000000002a9ada
