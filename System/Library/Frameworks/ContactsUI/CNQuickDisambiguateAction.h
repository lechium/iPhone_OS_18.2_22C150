...
- (void).cxx_destruct;	// IMP=0x00000000001365d7
...
- (id)description;	// IMP=0x00000000001364b6
- (void)performWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000135e75
- (id)subtitleForContext:(long long)arg1;	// IMP=0x0000000000135e18
- (id)titleForContext:(long long)arg1;	// IMP=0x0000000000135d1d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000135bae
- (id)initWithActions:(id)arg1;	// IMP=0x0000000000135b42
