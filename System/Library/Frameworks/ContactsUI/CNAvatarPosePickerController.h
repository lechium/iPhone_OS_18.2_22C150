...
- (void).cxx_destruct;	// IMP=0x000000000033849e
...
- (void)photoPickerVariantListControllerDidCancel:(id)arg1;	// IMP=0x00000000003383be
- (void)photoPickerVariantListController:(id)arg1 didSelectProviderItem:(id)arg2;	// IMP=0x0000000000338301
- (id)posePickerViewController;	// IMP=0x000000000033812f
- (id)initWithAnimojiProviderItem:(id)arg1 variantsManager:(id)arg2;	// IMP=0x0000000000337fed
- (id)initWithAvatarRecord:(id)arg1 variantsManager:(id)arg2;	// IMP=0x0000000000337f69
