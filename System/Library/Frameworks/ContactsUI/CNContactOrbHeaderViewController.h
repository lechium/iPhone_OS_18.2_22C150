...
- (void).cxx_destruct;	// IMP=0x00000000002add89
@property(retain, nonatomic) NSArray *contacts; // @synthesize contacts=_contacts;
@property(retain, nonatomic) CNContactOrbHeaderView *headerView; // @synthesize headerView=_headerView;
- (double)suggestedHeaderWidth;	// IMP=0x00000000002adab2
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000002ad8dc
- (void)viewDidLoad;	// IMP=0x00000000002ad292
- (id)initWithContacts:(id)arg1;	// IMP=0x00000000002ad1bb
