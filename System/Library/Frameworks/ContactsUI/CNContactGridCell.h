...
+ (double)actionsLeftMargin;	// IMP=0x00600000002e82e6
- (void).cxx_destruct;	// IMP=0x00000000002e81d0
...
- (void)_updateActionsMask;	// IMP=0x00000000002e7ec6
- (CDUnknownBlockType)completionBlockForHidingActions;	// IMP=0x00000000002e7e01
- (CDUnknownBlockType)animationBlockForPreparingToShowActions;	// IMP=0x00000000002e7840
@property(retain, nonatomic) CNContact *contact;
- (void)updateConstraints;	// IMP=0x00000000002e6d7b
- (void)_createViewsIfNeeded;	// IMP=0x00000000002e6a4f
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x00000000002e6a39
