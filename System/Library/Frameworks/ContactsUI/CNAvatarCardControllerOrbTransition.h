...
- (void).cxx_destruct;	// IMP=0x00000000001c9726
...
- (struct CGRect)_sourceRectInContainerView:(id)arg1;	// IMP=0x00000000001c9046
- (void)transitionDidEnd:(_Bool)arg1;	// IMP=0x00000000001c8f9e
- (void)performTransitionFromView:(id)arg1 toView:(id)arg2 containerView:(id)arg3;	// IMP=0x00000000001c8c4e
- (void)setupTransitionFromView:(id)arg1 toView:(id)arg2 withContainerView:(id)arg3;	// IMP=0x00000000001c87ea
- (void)prepareTransitionFromView:(id)arg1 toView:(id)arg2 containerView:(id)arg3;	// IMP=0x00000000001c828f
- (id)initWithCardViewController:(id)arg1 headerView:(id)arg2 sourceView:(id)arg3 highlightedView:(id)arg4 sourceRect:(struct CGRect)arg5 backgroundVisualEffectView:(id)arg6 isDismissing:(_Bool)arg7;	// IMP=0x00000000001c816b
