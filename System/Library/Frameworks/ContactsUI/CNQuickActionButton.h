...
- (void).cxx_destruct;	// IMP=0x00000000002d3022
...
- (void)onLongPress:(id)arg1;	// IMP=0x00000000002d2c99
- (void)performAction;	// IMP=0x00000000002d2bba
- (void)updateConstraints;	// IMP=0x00000000002d2794
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002d21ea
