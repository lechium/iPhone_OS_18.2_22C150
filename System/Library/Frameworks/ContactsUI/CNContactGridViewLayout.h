...
- (void).cxx_destruct;	// IMP=0x00000000002d5ecb
...
- (CDUnknownBlockType)_animationForReusableView:(id)arg1 toLayoutAttributes:(id)arg2 type:(unsigned long long)arg3;	// IMP=0x00000000002d5d46
- (void)_updateLayoutMetrics;	// IMP=0x00000000002d5384
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x00000000002d50e1
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x00000000002d4dc2
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x00000000002d4d93
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002d4cbe
