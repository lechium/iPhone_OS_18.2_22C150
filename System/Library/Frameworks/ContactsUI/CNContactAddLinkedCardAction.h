...
- (void).cxx_destruct;	// IMP=0x0000000000126d49
...
- (_Bool)contactViewController:(id)arg1 shouldPerformDefaultActionForContact:(id)arg2 propertyKey:(id)arg3 labeledValue:(id)arg4;	// IMP=0x0000000000126cad
- (void)contactPicker:(id)arg1 didSelectContact:(id)arg2;	// IMP=0x0000000000126ad0
- (void)contactPickerDidCancel:(id)arg1;	// IMP=0x0000000000126a25
- (void)peoplePickerLinkButtonTapped;	// IMP=0x000000000012694c
- (void)performActionWithSender:(id)arg1;	// IMP=0x000000000012657b
