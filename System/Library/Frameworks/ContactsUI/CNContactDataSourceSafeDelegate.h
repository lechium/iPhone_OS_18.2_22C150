...
- (void).cxx_destruct;	// IMP=0x000000000037b3ef
@property(nonatomic) __weak id <CNContactDataSourceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)contactDataSourceDidChange:(id)arg1;	// IMP=0x000000000037b321
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000037b2a6
