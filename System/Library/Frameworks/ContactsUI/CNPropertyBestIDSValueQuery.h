...
- (void).cxx_destruct;	// IMP=0x00000000002dedd5
...
- (void)cancel;	// IMP=0x00000000002de630
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 idsAvailabilityProvider:(id)arg3 schedulerProvider:(id)arg4;	// IMP=0x00000000002de2b6
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2;	// IMP=0x00000000002de1c6
