...
- (void).cxx_destruct;	// IMP=0x00000000002c1793
...
- (id)initWithLabel:(id)arg1 accessoryView:(id)arg2 confirmationHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000002c168b
- (id)initWithLabel:(id)arg1 accessoryView:(id)arg2;	// IMP=0x00000000002c1676
