...
- (void).cxx_destruct;	// IMP=0x0000000000342486
@property(retain, nonatomic) TKTonePickerViewController *tonePicker; // @synthesize tonePicker=_tonePicker;
- (void)cancelButton:(id)arg1;	// IMP=0x00000000003423ff
- (void)doneButton:(id)arg1;	// IMP=0x00000000003422a1
- (id)initWithAlertType:(long long)arg1 activityAlert:(id)arg2;	// IMP=0x0000000000341dc2
