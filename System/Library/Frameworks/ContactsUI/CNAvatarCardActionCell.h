...
+ (id)cellNibForContacts;	// IMP=0x00600000001b63f7
+ (id)cellNibForActions;	// IMP=0x00600000001b6394
- (void).cxx_destruct;	// IMP=0x00000000001b6120
...
- (void)trackHighlight:(id)arg1;	// IMP=0x00000000001b5c91
- (void)stopTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000001b5c6f
- (void)startTrackingWithGestureRecognizer:(id)arg1;	// IMP=0x00000000001b5bfc
- (void)reloadData;	// IMP=0x00000000001b520d
- (void)_updateHighlightAnimated:(_Bool)arg1;	// IMP=0x00000000001b5096
- (void)prepareForReuse;	// IMP=0x00000000001b5020
- (void)setHighlighted:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001b4fd7
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000001b4fc0
- (void)awakeFromNib;	// IMP=0x00000000001b4e0f
- (void)_updateFonts;	// IMP=0x00000000001b4cbf
