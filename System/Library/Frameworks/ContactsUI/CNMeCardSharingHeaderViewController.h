...
- (void).cxx_destruct;	// IMP=0x00000000000e5231
...
- (double)desiredHeight;	// IMP=0x00000000000e516d
- (void)viewWillLayoutSubviews;	// IMP=0x00000000000e4ef3
- (void)viewDidLoad;	// IMP=0x00000000000e4d3e
- (id)initWithAvatarViewController:(id)arg1 name:(id)arg2 layoutAttributes:(id)arg3;	// IMP=0x00000000000e4c61
