...
- (void).cxx_destruct;	// IMP=0x000000000011e7a4
...
- (struct __SecIdentity *)identityWithError:(id *)arg1;	// IMP=0x000000000011e032
- (id)executeRequest;	// IMP=0x000000000011dc27
- (_Bool)valueForBooleanDefault:(id)arg1;	// IMP=0x000000000011dbb0
- (id)processReply:(id)arg1;	// IMP=0x000000000011cc10
- (id)acmeRequest;	// IMP=0x000000000011c51b
- (id)pollForStatus:(id)arg1 until:(id)arg2;	// IMP=0x000000000011c4dd
- (id)sendRequestToXPCService:(id)arg1 response:(id *)arg2;	// IMP=0x000000000011be48
- (int)errorStatusWithHTTPErrorCode:(int)arg1;	// IMP=0x000000000011bde0
- (id)attestationChainPEMRepresentation;	// IMP=0x000000000011bd11
- (id)createCertificate;	// IMP=0x000000000011bbeb
- (id)hardwareAttestationWithError:(id *)arg1;	// IMP=0x000000000011b968
- (id)attestationObjectWithCertificates:(id)arg1;	// IMP=0x000000000011b5a7
- (id)requestAttestationChainWithError:(id *)arg1;	// IMP=0x000000000011b53d
- (_Bool)deviceAttestationSupported;	// IMP=0x000000000011b535
- (id)createCSR;	// IMP=0x000000000011b43a
- (id)createKeyPair;	// IMP=0x000000000011b36d
- (id)sanitizeParameters;	// IMP=0x000000000011b23c
- (id)sanitizeSubject;	// IMP=0x000000000011b141
- (id)serialNumber;	// IMP=0x000000000011b06c
- (void)dealloc;	// IMP=0x000000000011afcb
- (id)initWithSubject:(id)arg1 parameters:(id)arg2;	// IMP=0x000000000011aeff
