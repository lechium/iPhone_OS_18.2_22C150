...
- (void).cxx_destruct;	// IMP=0x0000000000076a3e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000007694c
- (unsigned long long)hash;	// IMP=0x00000000000768df
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000767ff
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007673b
- (void)copyTo:(id)arg1;	// IMP=0x00000000000766b8
- (void)writeTo:(id)arg1;	// IMP=0x000000000007663e
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000764b2
- (id)dictionaryRepresentation;	// IMP=0x0000000000076408
- (id)description;	// IMP=0x0000000000076359
