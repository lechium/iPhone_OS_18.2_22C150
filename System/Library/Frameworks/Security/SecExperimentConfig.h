...
- (_Bool)shouldRunWithSamplingRate:(id)arg1;	// IMP=0x00000000000166a1
- (unsigned int)hostHash;	// IMP=0x0000000000016676
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00000000000164ce
