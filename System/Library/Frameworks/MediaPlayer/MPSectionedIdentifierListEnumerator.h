...
- (void).cxx_destruct;	// IMP=0x0000000000070d1a
...
- (id)nextObject;	// IMP=0x0000000000070b93
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x000000000007059e
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x000000000006fafc
