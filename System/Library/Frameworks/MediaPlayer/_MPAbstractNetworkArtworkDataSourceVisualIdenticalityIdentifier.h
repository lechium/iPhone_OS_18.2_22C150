...
- (void).cxx_destruct;	// IMP=0x000000000012af02
...
- (id)stringRepresentation;	// IMP=0x000000000012ae0b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012adb8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012ac96
