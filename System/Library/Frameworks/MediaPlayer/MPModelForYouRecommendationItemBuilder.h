...
+ (id)allSupportedProperties;	// IMP=0x006000000027ee6d
- (void).cxx_destruct;	// IMP=0x000000000027e9d5
...
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x000000000027dccc
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3;	// IMP=0x000000000027dbec
