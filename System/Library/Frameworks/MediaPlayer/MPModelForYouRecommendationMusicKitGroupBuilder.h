...
+ (id)allSupportedItemProperties;	// IMP=0x0060000000211320
+ (id)allSupportedGroupProperties;	// IMP=0x0060000000211225
- (void).cxx_destruct;	// IMP=0x000000000020f84b
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x000000000020f4a2
- (id)modelObjectForItemsArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x000000000020f375
- (id)modelObjectForRecentlyPlayedArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x000000000020f248
- (void)initializeRequestedGroupProperties;	// IMP=0x000000000020ef66
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4 storeURLBag:(id)arg5 isListenNow:(_Bool)arg6;	// IMP=0x000000000020ee2e
