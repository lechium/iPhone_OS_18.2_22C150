...
+ (id)allSupportedProperties;	// IMP=0x006000000025902d
- (void).cxx_destruct;	// IMP=0x0000000000258d7d
...
- (id)convertToStoreItemMetadataDictionary:(id)arg1;	// IMP=0x0000000000258b64
- (id)storeItemMetadataWithMusicAPIMetadataDictionary:(id)arg1;	// IMP=0x0000000000258ad7
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x0000000000257f56
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3 storeURLBag:(id)arg4 isListenNow:(_Bool)arg5;	// IMP=0x0000000000257e51
