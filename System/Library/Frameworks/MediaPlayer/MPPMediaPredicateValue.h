...
- (void).cxx_destruct;	// IMP=0x000000000030c782
...
- (unsigned long long)hash;	// IMP=0x000000000030c435
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000030c2c9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000030c191
- (void)copyTo:(id)arg1;	// IMP=0x000000000030bffe
- (void)writeTo:(id)arg1;	// IMP=0x000000000030bebc
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000030beaf
- (id)dictionaryRepresentation;	// IMP=0x000000000030bc88
- (id)description;	// IMP=0x000000000030bbd9
...
- (void)dealloc;	// IMP=0x000000000030ba2f
