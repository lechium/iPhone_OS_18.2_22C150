...
- (void).cxx_destruct;	// IMP=0x0000000000307aa3
...
- (void)_initializeWithType:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x0000000000307a30
- (id)initWithStoreAdamID:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x00000000003079ca
- (id)initWithPlaylistGlobalID:(id)arg1 tasteType:(long long)arg2;	// IMP=0x0000000000307936
