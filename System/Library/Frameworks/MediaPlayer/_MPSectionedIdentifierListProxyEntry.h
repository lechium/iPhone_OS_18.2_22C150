...
+ (id)endEntry;	// IMP=0x0010000000071019
+ (id)startEntry;	// IMP=0x0010000000070ff8
...
- (id)trackingEntryResult;	// IMP=0x0000000000070fde
- (id)itemResult;	// IMP=0x0000000000070fd6
