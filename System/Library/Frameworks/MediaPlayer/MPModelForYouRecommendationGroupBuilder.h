...
+ (id)allSupportedItemProperties;	// IMP=0x0060000000267069
+ (id)allSupportedGroupProperties;	// IMP=0x0060000000266f8f
- (void).cxx_destruct;	// IMP=0x000000000026655e
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x000000000026608a
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4;	// IMP=0x0000000000265f7c
