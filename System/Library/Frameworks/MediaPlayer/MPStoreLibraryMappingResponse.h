...
- (void).cxx_destruct;	// IMP=0x000000000018192b
@property(nonatomic) long long libraryAddedStatus; // @synthesize libraryAddedStatus=_libraryAddedStatus;
- (void)setLibraryIdentifierSet:(id)arg1 forIdentifierSet:(id)arg2;	// IMP=0x000000000018187a
- (id)libraryIdentifierSetForIdentifierSet:(id)arg1;	// IMP=0x0000000000181864
