...
- (id).cxx_construct;	// IMP=0x00000000002a1407
- (void).cxx_destruct;	// IMP=0x00000000002a13d6
...
- (id)initWithEntityQueryResult:(shared_ptr_274c5e8b)arg1 forScope:(id)arg2 entityTranslationContext:(id)arg3;	// IMP=0x00000000002a12d5
