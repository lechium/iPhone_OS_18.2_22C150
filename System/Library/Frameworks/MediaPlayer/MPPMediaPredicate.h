...
- (void).cxx_destruct;	// IMP=0x00000000003595aa
...
- (unsigned long long)hash;	// IMP=0x0000000000359414
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003592c1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000035918d
- (void)copyTo:(id)arg1;	// IMP=0x0000000000358faf
- (void)writeTo:(id)arg1;	// IMP=0x0000000000358d04
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000358cf7
- (id)dictionaryRepresentation;	// IMP=0x0000000000358ae2
- (id)description;	// IMP=0x0000000000358a33
...
- (void)dealloc;	// IMP=0x0000000000358901
