...
- (void).cxx_destruct;	// IMP=0x00000000000d06c4
...
- (id)stringRepresentation;	// IMP=0x00000000000d05cd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d057a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d0458
