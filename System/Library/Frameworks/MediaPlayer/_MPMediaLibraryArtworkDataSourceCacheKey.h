...
- (void).cxx_destruct;	// IMP=0x00000000002e7bd1
...
- (unsigned long long)hash;	// IMP=0x00000000002e7ae2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002e79ba
- (id)initWithArtworkCatalog:(id)arg1 representativeSize:(struct CGSize)arg2;	// IMP=0x00000000002e791f
