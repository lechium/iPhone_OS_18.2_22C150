...
- (void).cxx_destruct;	// IMP=0x00000000001cc178
- (id)_parsedContentNode:(id)arg1 additionalAttributesFromParent:(id)arg2;	// IMP=0x00000000001cbeb8
- (id)_parsedElements:(id)arg1;	// IMP=0x00000000001cbc8f
- (id)_parsedSectionedCollection;	// IMP=0x00000000001cb4ed
@property(readonly, nonatomic) MPSectionedCollection *results;
- (id)initWithRawResponseOutput:(id)arg1 sectionBuilder:(id)arg2 contentItemBuilder:(id)arg3 filteredFCKinds:(id)arg4 userIdentity:(id)arg5;	// IMP=0x00000000001cb387
