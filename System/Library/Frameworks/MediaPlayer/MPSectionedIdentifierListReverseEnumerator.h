...
- (void).cxx_destruct;	// IMP=0x0000000000072172
...
- (id)_startEntryProxy;	// IMP=0x000000000007205a
- (id)nextObject;	// IMP=0x0000000000071f75
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x000000000007150a
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x0000000000071142
