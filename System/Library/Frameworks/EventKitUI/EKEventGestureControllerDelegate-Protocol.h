...
@class EKCalendarDate, EKDayOccurrenceView, EKEvent, EKEventGestureController, UIView, UIViewController;
@protocol CUIKEditor;
...
- (EKDayOccurrenceView *)eventGestureController:(EKEventGestureController *)arg1 occurrenceViewAtPoint:(struct CGPoint)arg2 ignoreSelectedCopyView:(_Bool)arg3;
...
@optional
- (_Bool)eventGestureControllerShouldSplitMultiDayAllDayEvents:(EKEventGestureController *)arg1;
