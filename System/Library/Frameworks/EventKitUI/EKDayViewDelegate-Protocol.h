...
- (_Bool)dayViewShouldAnnotateAppEntities:(EKDayView *)arg1 onDayStarting:(EKCalendarDate *)arg2;
...
- (void)dayView:(EKDayView *)arg1 didSelectEvents:(NSArray *)arg2 userInitiated:(_Bool)arg3;
