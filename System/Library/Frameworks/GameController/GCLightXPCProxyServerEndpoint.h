...
- (void).cxx_destruct;	// IMP=0x0000000000078315
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000078255
- (void)invalidateConnection;	// IMP=0x00000000000781a2
- (void)fetchLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000780f8
- (void)newLight:(id)arg1;	// IMP=0x000000000007800a
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000077c02
- (void)invalidateClient;	// IMP=0x0000000000077b41
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x0000000000077a85
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x00000000000779dd
