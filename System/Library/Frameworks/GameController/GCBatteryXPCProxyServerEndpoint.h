...
- (void).cxx_destruct;	// IMP=0x000000000000b8fe
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b83e
- (void)invalidateConnection;	// IMP=0x000000000000b78b
- (void)fetchBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b6e1
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000b2d9
- (void)invalidateClient;	// IMP=0x000000000000b218
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x000000000000b15c
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x000000000000b0b4
