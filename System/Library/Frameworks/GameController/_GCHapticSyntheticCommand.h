...
- (void).cxx_destruct;	// IMP=0x00000000000fc6b5
...
- (id)description;	// IMP=0x00000000000fc642
...
- (void)cancel;	// IMP=0x00000000000fc5ef
- (void)preprocessCommand:(const void *)arg1;	// IMP=0x00000000000fc562
- (id)initWithHapticCommand:(const void *)arg1;	// IMP=0x00000000000fc4b4
