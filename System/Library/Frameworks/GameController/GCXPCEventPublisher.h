...
- (void).cxx_destruct;	// IMP=0x000000000005def4
...
- (void)sendEvent:(id)arg1 toSubscriber:(id)arg2;	// IMP=0x000000000005dbd2
- (void)sendEvent:(id)arg1;	// IMP=0x000000000005d7a6
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x000000000005d33d
- (id)initWithStreamName:(id)arg1 isStatefulEventPublisher:(_Bool)arg2;	// IMP=0x000000000005d006
- (id)initWithStreamName:(id)arg1;	// IMP=0x000000000005cff2
