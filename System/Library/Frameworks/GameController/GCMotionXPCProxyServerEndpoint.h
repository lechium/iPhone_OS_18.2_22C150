...
- (void).cxx_destruct;	// IMP=0x000000000002d19c
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000002d0dd
- (void)invalidateConnection;	// IMP=0x000000000002d02a
- (void)fetchSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000002cf80
- (void)newSensorsActive:(_Bool)arg1;	// IMP=0x000000000002ced6
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002caf3
- (void)invalidateClient;	// IMP=0x000000000002ca32
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(_Bool)arg1;	// IMP=0x000000000002c99a
- (id)initWithIdentifier:(id)arg1 initialValue:(_Bool)arg2;	// IMP=0x000000000002c91b
