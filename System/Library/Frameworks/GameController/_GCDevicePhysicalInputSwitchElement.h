...
+ (unsigned short)updateContextSize;	// IMP=0x001000000002355b
- (_Bool)update:(void *)arg1 forGamepadEvent:(id)arg2 withTimestamp:(double)arg3;	// IMP=0x000000000002425a
...
- (_Bool)isEqualToElement:(id)arg1;	// IMP=0x0000000000023d4a
@property(readonly) id <GCSwitchPositionInput> positionInput;
- (void)postCommit:(const void *)arg1 sender:(id)arg2;	// IMP=0x0000000000023b97
- (void)preCommit:(const void *)arg1 sender:(id)arg2;	// IMP=0x0000000000023a45
- (_Bool)update:(void *)arg1 forUsages:(unsigned long long)arg2 with:(id)arg3;	// IMP=0x0000000000023590
- (id)initWithTemplate:(id)arg1 context:(id)arg2;	// IMP=0x0000000000023367
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000023031
