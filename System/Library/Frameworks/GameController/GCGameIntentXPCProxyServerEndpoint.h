...
- (void).cxx_destruct;	// IMP=0x000000000003fa31
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f97b
- (void)invalidateConnection;	// IMP=0x000000000003f8c8
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000003f65d
- (void)invalidateClient;	// IMP=0x000000000003f59c
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x000000000003f54b
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)init;	// IMP=0x000000000003f4ba
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000003f445
