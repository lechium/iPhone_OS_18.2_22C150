...
- (void).cxx_destruct;	// IMP=0x00000000000ab80b
...
- (void)processChangedElements:(id)arg1 atTimestamp:(unsigned long long)arg2;	// IMP=0x00000000000aade6
- (id)initWithPhysicalInputProfile:(id)arg1 thumbstickUserIntentHandler:(CDUnknownBlockType)arg2 slidingWindowTotalDuration:(double)arg3 slidingWindowSegmentDuration:(double)arg4 deadzone:(double)arg5 sensitivity:(int)arg6;	// IMP=0x00000000000aabf8
- (id)initWithPhysicalInputProfile:(id)arg1 thumbstickUserIntentHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000aabc5
