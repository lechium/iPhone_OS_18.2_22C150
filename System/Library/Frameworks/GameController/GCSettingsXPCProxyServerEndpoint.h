...
- (void).cxx_destruct;	// IMP=0x0000000000090216
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000090156
- (void)invalidateConnection;	// IMP=0x00000000000900a3
- (void)fetchProfileWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000008fff9
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000008fc43
- (void)invalidateClient;	// IMP=0x000000000008fb93
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValueForProfile:(id)arg1;	// IMP=0x000000000008fad7
- (id)initWithIdentifier:(id)arg1 initialValueForProfile:(id)arg2;	// IMP=0x000000000008fa2f
