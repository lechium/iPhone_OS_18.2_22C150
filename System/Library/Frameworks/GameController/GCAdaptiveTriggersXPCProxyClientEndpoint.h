...
- (void).cxx_destruct;	// IMP=0x00000000000bcd8f
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bccd1
- (void)invalidateConnection;	// IMP=0x00000000000bcc2d
- (void)refreshStatuses;	// IMP=0x00000000000bcb00
- (void)newStatuses:(id)arg1;	// IMP=0x00000000000bc9e1
- (void)_remoteEndpointHasSetStatuses:(id)arg1;	// IMP=0x00000000000bc890
- (void)setController:(id)arg1;	// IMP=0x00000000000bc7ea
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x00000000000bc5bc
- (id)init;	// IMP=0x00000000000bc591
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x00000000000bc397
