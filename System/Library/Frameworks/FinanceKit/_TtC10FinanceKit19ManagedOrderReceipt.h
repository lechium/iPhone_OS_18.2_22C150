...
@interface _TtC10FinanceKit19ManagedOrderReceipt : NSManagedObject
{
}

- (id)initWithEntity:(id)arg1 insertIntoManagedObjectContext:(id)arg2;	// IMP=0x000000000004e940
