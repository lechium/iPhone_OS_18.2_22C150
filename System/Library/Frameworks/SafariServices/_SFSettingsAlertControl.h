...
- (void).cxx_destruct;	// IMP=0x000000000010fe55
...
- (void)_updateBackgroundView;	// IMP=0x000000000010fd33
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000010fccd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000010fb8b
