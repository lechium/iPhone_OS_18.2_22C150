...
- (void).cxx_destruct;	// IMP=0x0000000000195174
...
- (_Bool)allowsSelfSizing;	// IMP=0x00000000001950ed
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000195061
- (void)_useStrongPasswordButtonAction:(id)arg1;	// IMP=0x000000000019500a
- (long long)keyboardAppearance;	// IMP=0x0000000000194fed
- (void)setKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000194fd0
- (id)initWithInputViewStyle:(long long)arg1 keyboardType:(long long)arg2;	// IMP=0x0000000000194b36
