...
- (void).cxx_destruct;	// IMP=0x0000000000043f55
...
- (void)_updateTitle;	// IMP=0x0000000000043d9f
- (void)_selectDetailType:(long long)arg1;	// IMP=0x0000000000043d30
- (void)_addSegmentForDetailType:(long long)arg1;	// IMP=0x0000000000043b6d
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000043502
