...
- (void).cxx_destruct;	// IMP=0x00000000000af37e
...
- (id)viewForLastBaselineLayout;	// IMP=0x00000000000af30d
- (void)_tappedDownloadButton:(id)arg1;	// IMP=0x00000000000af2ed
- (id)initWithTappedDownloadBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000aec5c
