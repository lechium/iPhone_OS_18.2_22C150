...
@class LSAppLink, NSError, NSURL, SFSafariViewController;
...
- (void)safariViewController:(SFSafariViewController *)arg1 didDecideCookieSharingForURL:(NSURL *)arg2 shouldCancel:(_Bool)arg3 withError:(NSError *)arg4;
@end
