...
- (void)diagnosticsFormMetadataWithCompletionHandler:(void (^)(NSArray *))arg1;
...
- (void)setStrongPasswordElementViewableIfAppropriate:(_Bool)arg1 frame:(SFFormAutoFillFrameHandle *)arg2 passwordControlUniqueIDs:(NSArray *)arg3;
