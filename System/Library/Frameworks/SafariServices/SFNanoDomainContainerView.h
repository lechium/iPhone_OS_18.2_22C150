...
+ (double)defaultHeightInsideQuickboard;	// IMP=0x0040000000119450
+ (double)defaultHeight;	// IMP=0x0040000000119447
+ (double)defaultTopOffset;	// IMP=0x004000000011943e
- (void).cxx_destruct;	// IMP=0x00000000001194d2
...
- (void)updateWithDomain:(id)arg1 isSecure:(_Bool)arg2 showsNotSecureAnnotation:(_Bool)arg3;	// IMP=0x0000000000119459
