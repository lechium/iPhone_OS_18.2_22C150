...
- (void).cxx_destruct;	// IMP=0x0000000000061004
...
- (void)completeWithResult:(long long)arg1;	// IMP=0x0000000000060fc8
- (void)dealloc;	// IMP=0x0000000000060f99
- (id)initWithFrameHandle:(id)arg1 initiatedByWebContent:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000060ee9
