...
- (void).cxx_destruct;	// IMP=0x00000000001290a8
...
- (void)_updateCountViews;	// IMP=0x0000000000128e1a
- (id)initWithDetailLabel:(_Bool)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000127ebd
