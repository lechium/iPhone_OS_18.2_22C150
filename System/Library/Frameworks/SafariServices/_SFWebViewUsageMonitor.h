...
- (void).cxx_destruct;	// IMP=0x00000000000b7465
...
- (void)checkURL:(id)arg1;	// IMP=0x00000000000b7307
- (void)auditUsageIfNeeded;	// IMP=0x00000000000b710f
@property(readonly, nonatomic) NSString *stringAsAuditKey;
@property(readonly, nonatomic) _Bool shouldAudit;
- (id)initWithHostAppIdentifier:(id)arg1;	// IMP=0x00000000000b6fa1
