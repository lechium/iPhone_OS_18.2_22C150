...
- (void)webViewController:(SFWebViewController *)arg1 requestPresentingViewControllerWithCompletionHandler:(void (^)(UIViewController *, NSError *))arg2;
...
- (_Bool)webViewControllerShouldAutofillESimInformation:(SFWebViewController *)arg1;
