...
+ (id)descriptionForPasswordWithUser:(id)arg1 creationDate:(id)arg2;	// IMP=0x00600000000f4768
- (void).cxx_destruct;	// IMP=0x00000000000f49f9
...
- (id)initWithMatch:(id)arg1 detail:(id)arg2 creationDate:(id)arg3;	// IMP=0x00000000000f4902
