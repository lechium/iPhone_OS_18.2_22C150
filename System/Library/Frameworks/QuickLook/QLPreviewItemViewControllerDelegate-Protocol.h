...
@class NSDictionary, NSError, NSString, NSURL, QLItemViewController, QLPreviewItemEditedCopy, UITapGestureRecognizer;
...
- (void)previewItemViewController:(QLItemViewController *)arg1 wantsChromelessToolbar:(_Bool)arg2;
- (void)previewItemViewController:(QLItemViewController *)arg1 wantsChromelessNavigationBar:(_Bool)arg2;
