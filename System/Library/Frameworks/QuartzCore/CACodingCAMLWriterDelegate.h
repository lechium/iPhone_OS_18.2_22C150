...
- (_Bool)CAMLWriter:(id)arg1 shouldEncodeObject:(id)arg2;	// IMP=0x0000000000027fbb
- (id)CAMLWriter:(id)arg1 URLForResource:(id)arg2;	// IMP=0x0000000000027c86
- (id)CAMLWriter:(id)arg1 typeForObject:(id)arg2;	// IMP=0x0000000000027b99
- (id)initWithResourceDir:(id)arg1;	// IMP=0x0000000000027b37
- (void)dealloc;	// IMP=0x0000000000027aca
