...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002c1db6
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002c1c80
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002c1b52
- (id)description;	// IMP=0x00000000002c1aba
- (void)dealloc;	// IMP=0x00000000002c1a4d
