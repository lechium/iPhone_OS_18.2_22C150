...
- (void)dealloc;	// IMP=0x000000000002bec8
- (void)addTransition:(id)arg1;	// IMP=0x000000000002be8b
- (void)willAddLayer:(id)arg1;	// IMP=0x000000000002be85
- (void)addElement:(id)arg1;	// IMP=0x000000000002be48
