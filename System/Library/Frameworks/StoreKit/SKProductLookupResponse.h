...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000003c761
- (void).cxx_destruct;	// IMP=0x000000000003cd9d
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003c998
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003c769
- (id)initWithResult:(id)arg1 extensionID:(id)arg2 productURL:(id)arg3 isEntitled:(_Bool)arg4 parameters:(id)arg5 deepLinkURL:(id)arg6;	// IMP=0x000000000003c65a
