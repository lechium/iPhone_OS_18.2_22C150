...
- (void)_lastKnownIndoorOutdoorStateWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001b987d
- (void)_stopIndoorOutdoorUpdates;	// IMP=0x00000000001b950d
- (void)_startIndoorOutdoorUpdates;	// IMP=0x00000000001b8f0b
- (void)_teardown;	// IMP=0x00000000001b8e78
- (void)dealloc;	// IMP=0x00000000001b8e36
- (id)init;	// IMP=0x00000000001b88e2
