...
- (void)_stopCyclingWorkoutDistanceUpdates;	// IMP=0x000000000018e364
- (void)_startCyclingWorkoutDistanceUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000018dace
- (void)_stopOdometerUpdates;	// IMP=0x000000000018d942
- (void)_stopOdometerGpsAvailability;	// IMP=0x000000000018d7ca
- (void)_startOdometerUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000018d038
- (void)_startDaemonConnection;	// IMP=0x000000000018c8f9
- (void)_teardown;	// IMP=0x000000000018c894
- (void)dealloc;	// IMP=0x000000000018c84a
- (id)initWithOdometer:(id)arg1;	// IMP=0x000000000018c750
