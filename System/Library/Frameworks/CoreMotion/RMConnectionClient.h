...
- (void).cxx_destruct;	// IMP=0x0000000000179c02
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000179be1
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x0000000000179bc4
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x0000000000179704
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x00000000001794b6
