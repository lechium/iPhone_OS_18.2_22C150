...
- (id)description;	// IMP=0x0000000000359518
- (void)dealloc;	// IMP=0x0000000000359499
- (id)initWithMetadataStoreFileLocation:(id)arg1;	// IMP=0x0000000000359421
- (id)init;	// IMP=0x00000000003593e2
