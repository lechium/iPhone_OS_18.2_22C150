...
- (id)description;	// IMP=0x00000000001506b3
- (void)updateWithChange:(id)arg1;	// IMP=0x00000000001505df
- (void)dealloc;	// IMP=0x000000000015056d
- (id)initWithOriginalChange:(id)arg1;	// IMP=0x000000000015045f
