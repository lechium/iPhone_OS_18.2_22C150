...
- (void)dealloc;	// IMP=0x00000000002f4174
- (id)initWithStack:(id)arg1 andStoreMetadata:(id)arg2;	// IMP=0x00000000002f4127
- (id)initWithStoreName:(id)arg1 andUbiquityRootLocation:(id)arg2 withLocalPeerID:(id)arg3;	// IMP=0x00000000002f4096
- (id)init;	// IMP=0x00000000002f402d
