...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000240254
- (id)copy;	// IMP=0x0000000000240210
- (void)dealloc;	// IMP=0x00000000002401a7
- (id)initWithOptions:(id)arg1 monitor:(id)arg2 assetStorageURL:(id)arg3 workQueue:(id)arg4 andDatabase:(id)arg5;	// IMP=0x0000000000240103
