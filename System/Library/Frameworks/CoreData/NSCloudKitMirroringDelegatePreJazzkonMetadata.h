...
- (void).cxx_destruct;	// IMP=0x000000000035d6b8
- (id)description;	// IMP=0x000000000035c5c2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000035c3ed
- (void)dealloc;	// IMP=0x000000000035c37e
- (id)initWithStore:(id)arg1;	// IMP=0x000000000035c32c
