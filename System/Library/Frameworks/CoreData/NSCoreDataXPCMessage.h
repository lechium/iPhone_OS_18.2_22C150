...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000003493c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000034b0b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000349be
- (void)dealloc;	// IMP=0x0000000000034944
