...
- (_Bool)validate:(id *)arg1;	// IMP=0x00000000002809ef
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x00000000002807fc
...
- (void)dealloc;	// IMP=0x0000000000280722
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x00000000002804b2
