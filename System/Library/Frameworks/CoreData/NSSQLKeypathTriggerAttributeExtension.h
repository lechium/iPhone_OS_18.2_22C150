...
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x0000000000288767
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000286270
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000286150
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x000000000028609b
