...
- (id)bindIntarrays;	// IMP=0x000000000021f310
- (id)bindVariables;	// IMP=0x000000000021f271
- (id)sqlString;	// IMP=0x000000000021f22d
- (id)entity;	// IMP=0x000000000021f223
- (void)dealloc;	// IMP=0x000000000021f1a4
- (id)initWithEntity:(id)arg1;	// IMP=0x000000000021f128
- (id)description;	// IMP=0x000000000021f0b6
- (id)initWithEntity:(id)arg1 sqlString:(id)arg2;	// IMP=0x000000000021f054
