...
+ (void)_setAnnotatesMigrationMetadata:(_Bool)arg1;	// IMP=0x0060000000240292
+ (_Bool)_annotatesMigrationMetadata;	// IMP=0x0060000000240268
...
- (void)dealloc;	// IMP=0x00000000002405f8
