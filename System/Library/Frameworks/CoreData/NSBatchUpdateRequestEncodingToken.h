...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000cf1a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000d157
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000cf22
- (void)dealloc;	// IMP=0x000000000000ceb6
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000cbd2
