...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000161dfc
- (void)dealloc;	// IMP=0x0000000000161db2
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x0000000000161d49
