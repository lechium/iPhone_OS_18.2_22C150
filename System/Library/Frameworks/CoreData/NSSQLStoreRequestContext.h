...
- (void)executeEpilogue;	// IMP=0x0000000000067a90
- (_Bool)executeRequestUsingConnection:(id)arg1;	// IMP=0x00000000000675b8
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x000000000006758a
- (void)executePrologue;	// IMP=0x0000000000067584
@property(readonly, nonatomic) _Bool isWritingRequest;
@property(readonly, nonatomic) NSSQLRowCache *rowCache;
- (void)dealloc;	// IMP=0x00000000000673db
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x000000000006726d
