...
- (void).cxx_destruct;	// IMP=0x00000000002d8770
- (void)applicationWillDeactivate:(id)arg1;	// IMP=0x00000000002d870b
- (void)applicationDidActivate:(id)arg1;	// IMP=0x00000000002d86fa
- (void)dealloc;	// IMP=0x00000000002d8679
- (id)init;	// IMP=0x00000000002d7ed3
