...
- (void)executeEpilogue;	// IMP=0x00000000003063c0
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000003062ef
- (void)executePrologue;	// IMP=0x0000000000306173
- (void)visitPredicateExpression:(id)arg1;	// IMP=0x0000000000306003
- (void)visitPredicate:(id)arg1;	// IMP=0x0000000000305ffd
- (id)_createStatement;	// IMP=0x0000000000305eaf
@property(retain, nonatomic) NSSQLiteStatement *fetchStatement;
- (id)manyToManyPrefetchRequestsForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x0000000000305036
- (id)manyToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x0000000000304ffd
- (id)inverseIsToOnePrefetchRequestForRelationshipNamed:(id)arg1 onEntity:(id)arg2;	// IMP=0x0000000000304fc4
@property(readonly, nonatomic) NSFetchRequest *request;
- (id)createChildContextForNestedFetchRequest:(id)arg1;	// IMP=0x0000000000304eca
- (void)dealloc;	// IMP=0x0000000000304d6e
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x000000000030447c
