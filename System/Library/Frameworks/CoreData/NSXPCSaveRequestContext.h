...
- (id)managedObjectContext;	// IMP=0x00000000002f2bf4
- (void)dealloc;	// IMP=0x00000000002f2b93
- (id)initForStore:(id)arg1 request:(id)arg2 metadata:(id)arg3 forceInsertsToUpdates:(_Bool)arg4 context:(id)arg5;	// IMP=0x00000000002f2aa5
