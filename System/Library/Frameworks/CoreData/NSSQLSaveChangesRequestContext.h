...
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x0000000000307f08
- (void)executeEpilogue;	// IMP=0x0000000000306ee9
- (void)executePrologue;	// IMP=0x0000000000306e81
- (_Bool)isWritingRequest;	// IMP=0x0000000000306e79
- (id)rowCache;	// IMP=0x0000000000306e67
- (void)dealloc;	// IMP=0x0000000000306d04
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x0000000000306b34
