...
- (id)vs_JSONValueTransformer;	// IMP=0x003000000002902e
...
- (id)vs_propertyListValueTransformer;	// IMP=0x003000000002898b
...
- (_Bool)vs_isSuitableForPurpose:(long long)arg1;	// IMP=0x003000000002881e
...
- (void)vs_setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0030000000028594
@end
