...
- (void).cxx_destruct;	// IMP=0x000000000005e824
...
- (void)performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000005e76b
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000005e757
- (void)_performBlock:(CDUnknownBlockType)arg1 andWait:(_Bool)arg2;	// IMP=0x000000000005e3d6
- (_Bool)_setupPersistenceIfNeeded:(id *)arg1;	// IMP=0x000000000005d902
- (void)_removePersistentStore;	// IMP=0x000000000005d7e9
- (id)init;	// IMP=0x000000000005d493
