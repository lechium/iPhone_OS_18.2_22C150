...
- (void).cxx_destruct;	// IMP=0x000000000003af7c
...
- (id)description;	// IMP=0x000000000003aaa7
@property(copy, nonatomic) NSData *data;
- (void)didAccessValueForKey:(id)arg1;	// IMP=0x000000000003a9cd
- (void)willAccessValueForKey:(id)arg1;	// IMP=0x000000000003a941
- (void)willChangeValueForKey:(id)arg1;	// IMP=0x000000000003a84e
- (id)changedValues;	// IMP=0x000000000003a512
- (id)committedValueForKey:(id)arg1;	// IMP=0x000000000003a498
- (id)committedValuesForKeys:(id)arg1;	// IMP=0x000000000003a41a
- (void)setPrimitiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000003a1f0
- (id)primitiveValueForKey:(id)arg1;	// IMP=0x000000000003a0e8
@property(readonly, nonatomic) _Bool hasPersistentChangedValues;
@property(readonly, nonatomic) _Bool hasChanges;
- (void)_setCommittedValues:(id)arg1 registeringUndo:(_Bool)arg2;	// IMP=0x0000000000039f2f
- (id)initWithItemKind:(id)arg1 insertIntoEditingContext:(id)arg2;	// IMP=0x0000000000039c14
- (id)init;	// IMP=0x0000000000039ba5
