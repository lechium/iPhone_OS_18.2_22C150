...
- (void)executionDidBegin;	// IMP=0x000000000003974f
- (void)_didSaveAccounts:(id)arg1 withResult:(_Bool)arg2 error:(id)arg3;	// IMP=0x00000000000394f0
- (id)initWithUnsavedAccounts:(id)arg1 accountStore:(id)arg2;	// IMP=0x00000000000393c4
- (id)init;	// IMP=0x0000000000039355
