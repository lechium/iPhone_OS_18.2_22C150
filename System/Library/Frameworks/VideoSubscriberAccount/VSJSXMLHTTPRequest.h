...
- (void).cxx_destruct;	// IMP=0x0000000000062998
...
- (void)_notifyWithFunctionName:(id)arg1 eventName:(id)arg2 info:(id)arg3;	// IMP=0x0000000000062362
- (void)_cancelCurrentRequestAndNotify:(_Bool)arg1;	// IMP=0x00000000000621bf
- (void)setRequestHeader:(id)arg1:(id)arg2;	// IMP=0x0000000000061faa
- (id)getResponseHeader:(id)arg1;	// IMP=0x0000000000061ec2
- (id)getAllResponseHeaders;	// IMP=0x0000000000061cbb
- (void)abort;	// IMP=0x0000000000061ca7
- (void)send:(id)arg1;	// IMP=0x000000000006159a
- (void)open:(id)arg1:(id)arg2:(id)arg3:(id)arg4:(id)arg5;	// IMP=0x00000000000613ec
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000613a8
- (id)init;	// IMP=0x00000000000612d5
