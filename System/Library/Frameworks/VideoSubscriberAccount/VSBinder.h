...
- (void).cxx_destruct;	// IMP=0x000000000003f71b
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000003f1b9
- (void)setValue:(id)arg1 forBinding:(id)arg2;	// IMP=0x000000000003f013
- (id)valueForBinding:(id)arg1;	// IMP=0x000000000003ee37
- (void)tearDownBinding:(id)arg1;	// IMP=0x000000000003e8a1
- (void)establishBinding:(id)arg1 withInfo:(id)arg2;	// IMP=0x000000000003e607
- (id)_infoForBinding:(id)arg1;	// IMP=0x000000000003e533
- (void)dealloc;	// IMP=0x000000000003e345
- (id)initWithBoundObject:(id)arg1;	// IMP=0x000000000003e27c
- (id)init;	// IMP=0x000000000003e20d
