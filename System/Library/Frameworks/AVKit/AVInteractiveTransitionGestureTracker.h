...
- (void).cxx_destruct;	// IMP=0x000000000005be93
...
- (void)_updateLastNonZeroVelocityDirection;	// IMP=0x000000000005bba6
- (void)_setHasContinuedIfNeeded;	// IMP=0x000000000005baed
- (void)_resetGesturesIfPossible;	// IMP=0x000000000005ba23
- (void)_reset;	// IMP=0x000000000005b8f3
- (_Bool)_isWaitingToContinue;	// IMP=0x000000000005b5a0
- (void)_finish;	// IMP=0x000000000005b4d8
- (void)_cancel;	// IMP=0x000000000005b410
- (void)_beginTracking:(long long)arg1;	// IMP=0x000000000005b16c
- (void)_handlePanGesture:(id)arg1;	// IMP=0x000000000005afad
- (void)_handleRotationGesture:(id)arg1;	// IMP=0x000000000005ae8c
- (void)_handlePinchGesture:(id)arg1;	// IMP=0x000000000005a93e
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x000000000005a7fb
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x000000000005a71c
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x000000000005a356
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000005a2aa
- (_Bool)transitionDriver:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x000000000005a2a2
...
- (double)angleOfVelocityInWindow;	// IMP=0x000000000005a0d8
- (struct CGPoint)velocityInWindow;	// IMP=0x0000000000059f1d
- (struct CGPoint)translationInWindow;	// IMP=0x0000000000059ec4
- (struct CGPoint)locationInWindow;	// IMP=0x0000000000059c8d
- (struct CGPoint)_filteredUntranslatedLocationInWindow;	// IMP=0x0000000000059bae
- (struct CGPoint)_untranslatedUnfilteredLocationInFixedCoordinateSpace;	// IMP=0x0000000000059a22
- (id)_locationRecognizer;	// IMP=0x00000000000599bd
- (void)willMoveToView:(id)arg1;	// IMP=0x00000000000597d3
- (void)didMoveToView:(id)arg1;	// IMP=0x000000000005977e
- (_Bool)isTracking;	// IMP=0x0000000000059765
- (void)addRecognizersToView:(id)arg1;	// IMP=0x0000000000059489
- (void)dealloc;	// IMP=0x000000000005924a
- (id)init;	// IMP=0x0000000000058fe5
