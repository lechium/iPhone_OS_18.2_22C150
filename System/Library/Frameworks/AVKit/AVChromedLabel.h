...
@interface AVChromedLabel : UIView
{
...
- (void).cxx_destruct;	// IMP=0x00000000000e380e
...
- (struct CGSize)minimumSize;	// IMP=0x00000000000e36a3
@property(readonly, nonatomic, getter=isCollapsedOrExcluded) _Bool collapsedOrExcluded;
- (void)layoutAttributesDidChange;	// IMP=0x00000000000e352e
- (id)viewForLastBaselineLayout;	// IMP=0x00000000000e34b4
- (id)viewForFirstBaselineLayout;	// IMP=0x00000000000e34a2
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000000e3490
- (void)updateConstraints;	// IMP=0x00000000000e31e3
- (void)tintColorDidChange;	// IMP=0x00000000000e3150
- (void)didMoveToSuperview;	// IMP=0x00000000000e3108
- (void)_updateLayoutItem;	// IMP=0x00000000000e3016
@property(readonly, nonatomic) UILabel *labelIfLoaded;
@property(readonly, nonatomic) UILabel *label; // @synthesize label=_label;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000e2635
