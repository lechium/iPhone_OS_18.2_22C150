...
- (void).cxx_destruct;	// IMP=0x00000000000c6fdb
...
- (struct UIEdgeInsets)playbackControlsViewLayoutMarginsForView:(id)arg1 keyboardHeight:(double)arg2 isFullScreen:(_Bool)arg3;	// IMP=0x00000000000c6581
...
- (id)initWithTraitCollection:(id)arg1;	// IMP=0x00000000000c6486
