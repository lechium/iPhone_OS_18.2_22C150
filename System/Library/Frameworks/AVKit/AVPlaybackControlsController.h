...
+ (id)keyPathsForValuesAffectingNeedsTimeResolver;	// IMP=0x0010000000111ae0
+ (id)keyPathsForValuesAffectingPlayButtonsShowPauseGlyph;	// IMP=0x0010000000111a11
+ (id)keyPathsForValuesAffectingCanShowLoadingIndicator;	// IMP=0x0010000000111942
+ (id)keyPathsForValuesAffectingShowsStartContentTransitionButtons;	// IMP=0x0010000000111894
+ (id)keyPathsForValuesAffectingShowsSkipButtons;	// IMP=0x00100000001117ba
+ (id)keyPathsForValuesAffectingSeekingEnabled;	// IMP=0x001000000011170c
+ (id)keyPathsForValuesAffectingMaximumTime;	// IMP=0x001000000011165e
+ (id)keyPathsForValuesAffectingMinimumTime;	// IMP=0x00100000001115b0
+ (id)keyPathsForValuesAffectingCurrentTime;	// IMP=0x0010000000111502
+ (id)keyPathsForValuesAffectingShowsMediaSelectionButton;	// IMP=0x00100000001114e2
+ (id)keyPathsForValuesAffectingShouldEnterFullScreenWhenPlaybackBegins;	// IMP=0x0010000000111429
+ (id)keyPathsForValuesAffectingShowsTransportControls;	// IMP=0x0010000000111370
+ (id)keyPathsForValuesAffectingProminentPlayButtonCanShowPauseGlyph;	// IMP=0x00100000001112cd
+ (id)keyPathsForValuesAffectingShowsProminentPlayButton;	// IMP=0x0010000000111198
+ (id)keyPathsForValuesAffectingShowsRoutePickerView;	// IMP=0x00100000001110df
+ (id)keyPathsForValuesAffectingFullScreen;	// IMP=0x0010000000111026
- (void).cxx_destruct;	// IMP=0x000000000010e076
...
- (void)_updateTransportBarCustomMenuItemsIfNeeded;	// IMP=0x000000000010d517
- (void)_updateRouteDetectionEnabled;	// IMP=0x000000000010d4be
- (void)_updateHasPlaybackBegunSincePlayerControllerBecameReadyToPlay:(_Bool)arg1 playing:(_Bool)arg2 userDidEndTappingProminentPlayButton:(_Bool)arg3;	// IMP=0x000000000010d49a
- (void)_updateVolumeControllerView;	// IMP=0x000000000010d494
- (void)_updateVideoGravityButtonType;	// IMP=0x000000000010cfd1
- (void)_updatePhotosensitivityRegions;	// IMP=0x000000000010ceaa
- (void)_handlePhotosensitiveRegions;	// IMP=0x000000000010cdfb
- (void)_updateScrubberAndTimeLabels;	// IMP=0x000000000010c11c
- (void)_updatePlaybackSpeedControlInclusion;	// IMP=0x000000000010c001
- (void)_updateOrCreateTimeResolverIfNeeded;	// IMP=0x000000000010ba7d
- (void)_updateContainerInclusion;	// IMP=0x000000000010b8b4
- (void)_updateControlInclusion;	// IMP=0x000000000010b822
- (void)_updateSkipButtonsEnableLongPress;	// IMP=0x000000000010b6b1
- (_Bool)_wantsRouteDetectionEnabled;	// IMP=0x000000000010b570
- (void)_startObservingPotentiallyUnimplementedPlayerControllerProperties;	// IMP=0x000000000010b129
- (void)_startObservingForPlaybackViewUpdates;	// IMP=0x00000000001099e8
- (void)_updatePlaybackControlsVisibleAndObservingUpdates;	// IMP=0x000000000010972f
- (void)endHidingItemsForTransitionAndShowImmediately:(_Bool)arg1;	// IMP=0x0000000000109691
- (void)_hideContextMenusIfPresented;	// IMP=0x000000000010960a
- (void)beginHidingItemsForTransition;	// IMP=0x00000000001095d0
@property(readonly, nonatomic, getter=isUserInteracting) _Bool userInteracting;
- (void)endUserInteraction;	// IMP=0x0000000000109514
- (void)beginUserInteraction;	// IMP=0x00000000001094b6
@property(readonly, nonatomic) _Bool prefersStatusBarHidden;
- (void)endShowingItemsDueToIndirectUserInteraction;	// IMP=0x000000000010922e
- (void)beginShowingItemsDueToIndirectUserInteraction;	// IMP=0x00000000001091db
- (void)_autoHideControlsAfterDelay:(double)arg1;	// IMP=0x0000000000109036
- (void)flashVolumeControlsWithDuration:(double)arg1;	// IMP=0x0000000000108ed1
- (void)showPlaybackControls:(_Bool)arg1 immediately:(_Bool)arg2;	// IMP=0x0000000000108d60
- (void)flashPlaybackControlsWithDuration:(double)arg1;	// IMP=0x0000000000108c12
- (void)_updatePlaybackControlsVisibilityWantsPlaybackControlsVisible:(_Bool)arg1;	// IMP=0x00000000001087d1
- (void)togglePlaybackControlsVisibility;	// IMP=0x00000000001086cd
- (void)_seekByTimeInterval:(double)arg1 toleranceBefore:(double)arg2 toleranceAfter:(double)arg3;	// IMP=0x00000000001085e3
- (void)_observeBoolForKeyPath:(id)arg1 usingKeyValueObservationController:(id)arg2 observationHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000010838a
- (void)_bindInclusionOfControlItems:(id)arg1 toKeyPath:(id)arg2;	// IMP=0x0000000000108269
- (void)_bindEnabledStateOfControls:(id)arg1 toKeyPath:(id)arg2;	// IMP=0x0000000000108197
- (void)startContentTransitionButtonTouchUpInside:(id)arg1;	// IMP=0x000000000010801a
- (void)skipButtonForcePressChanged:(id)arg1;	// IMP=0x0000000000107f26
- (void)skipButtonLongPressEnded:(id)arg1;	// IMP=0x0000000000107e09
- (void)skipButtonLongPressTriggered:(id)arg1;	// IMP=0x0000000000107cec
- (void)skipButtonTouchUpInside:(id)arg1;	// IMP=0x0000000000107b14
- (void)prominentPlayButtonTouchUpInside:(id)arg1;	// IMP=0x00000000001078b0
- (void)playbackSpeedButtonTapped:(id)arg1;	// IMP=0x0000000000107864
- (id)overflowMenuItemsForControlOverflowButton:(id)arg1;	// IMP=0x0000000000106e76
- (void)overflowButtonWillShowContextMenu:(id)arg1;	// IMP=0x0000000000106e64
- (void)overflowButtonDidHideContextMenu:(id)arg1;	// IMP=0x0000000000106e52
- (_Bool)shouldApplyLegibleMediaSelectionCriteriaAutomaticallyForMediaSelectionMenuController:(id)arg1;	// IMP=0x0000000000106e0e
- (void)mediaSelectionMenuController:(id)arg1 didSelectOption:(id)arg2;	// IMP=0x0000000000106d57
- (void)routePickerViewDidEndPresentingRoutes:(id)arg1;	// IMP=0x0000000000106d43
- (void)routePickerViewWillBeginPresentingRoutes:(id)arg1;	// IMP=0x0000000000106d2c
- (void)_updateVolumeSliderValueWithSystemVolume:(float)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000106c44
- (id)_volumeButtonMicaPackageState;	// IMP=0x0000000000106a18
- (void)_updateVolumeButtonGlyph;	// IMP=0x000000000010694d
- (void)_showOrHideDisplayModeControls;	// IMP=0x0000000000106457
- (_Bool)_prefersVolumeSliderExpandedAutomatically;	// IMP=0x000000000010617a
- (void)updateVolumeSliderValue:(id)arg1 volumeButtonControl:(id)arg2;	// IMP=0x0000000000105e35
- (void)volumeButtonPanChanged:(id)arg1;	// IMP=0x0000000000105d81
- (void)endChangingVolume;	// IMP=0x0000000000105d44
- (void)beginChangingVolume;	// IMP=0x0000000000105d07
- (void)volumeButtonLongPressTriggered:(id)arg1;	// IMP=0x0000000000105cf0
- (void)volumeButtonTapTriggered:(id)arg1;	// IMP=0x0000000000105c3e
- (void)volumeSliderValueDidChange:(id)arg1;	// IMP=0x0000000000105b9e
- (void)handleCurrentRouteSupportsVolumeControlChanged:(id)arg1;	// IMP=0x0000000000105a44
- (void)handleVolumeChange:(id)arg1;	// IMP=0x0000000000105750
- (void)endScrubbing;	// IMP=0x00000000001056d7
- (void)scrubToTime:(double)arg1 resolution:(double)arg2;	// IMP=0x0000000000105474
- (void)beginScrubbing;	// IMP=0x00000000001053ea
- (id)volumeControlsController:(id)arg1 volumeButtonControl:(id)arg2 viewContainingVolumeSlider:(id)arg3;	// IMP=0x00000000001053e2
- (void)transportControls:(id)arg1 scrubberDidEndScrubbing:(id)arg2;	// IMP=0x0000000000105345
- (void)transportControls:(id)arg1 scrubberDidScrub:(id)arg2;	// IMP=0x0000000000105248
- (void)transportControls:(id)arg1 scrubberDidBeginScrubbing:(id)arg2;	// IMP=0x00000000001051c8
- (void)transportControlsNeedsLayoutIfNeeded:(id)arg1;	// IMP=0x0000000000105147
- (void)playerViewControllerContentViewDidChangeSize:(id)arg1;	// IMP=0x0000000000105135
- (struct CGSize)playerViewControllerContentViewContentDimensions:(id)arg1;	// IMP=0x00000000001050db
- (void)playerViewControllerContentViewDidUpdateScrollingStatus:(id)arg1;	// IMP=0x000000000010509e
- (id)playerViewControllerContentViewOverrideLayoutClass:(id)arg1;	// IMP=0x0000000000104e7b
- (_Bool)playerViewControllerContentViewIsBeingTransitionedFromFullScreen:(id)arg1;	// IMP=0x0000000000104dd9
- (_Bool)playerViewControllerContentViewHasActiveTransition:(id)arg1;	// IMP=0x0000000000104d95
- (void)playerViewControllerContentViewDidChangeVideoGravity:(id)arg1;	// IMP=0x0000000000104ca8
- (_Bool)playerViewControllerContentViewShouldApplyAutomaticVideoGravity:(id)arg1;	// IMP=0x00000000001048b7
- (void)playerViewControllerContentViewDidLayoutSubviews:(id)arg1;	// IMP=0x0000000000104681
- (void)playerViewControllerContentViewDidMoveToSuperviewOrWindow:(id)arg1;	// IMP=0x000000000010440c
- (void)playerViewControllerContentViewPlaybackContentContainerViewChanged:(id)arg1;	// IMP=0x00000000001043cf
- (void)turboModePlaybackControlsPlaceholderViewDidLoad:(id)arg1;	// IMP=0x0000000000104255
- (void)playbackControlsViewDidLoad:(id)arg1;	// IMP=0x0000000000102c73
...
- (void)_updateVolumeButtonInclusionAndPrefersVolumeSliderExpandedWithPreferredExpansion:(_Bool)arg1;	// IMP=0x0000000000100c34
- (void)toggleMuted;	// IMP=0x0000000000100a1a
- (void)startUpdatesIfNeeded;	// IMP=0x0000000000100624
- (void)dealloc;	// IMP=0x0000000000100452
- (id)initWithPlayerViewController:(id)arg1;	// IMP=0x00000000001001ed
