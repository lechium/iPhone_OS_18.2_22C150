...
- (void).cxx_destruct;	// IMP=0x00000000001469d2
...
- (void)_updateStatusBarBackgroundGradientViewAlpha;	// IMP=0x00000000001461ad
- (void)didMoveToSuperview;	// IMP=0x000000000014616c
- (void)didMoveToWindow;	// IMP=0x000000000014612b
- (void)layoutSubviews;	// IMP=0x0000000000145b53
- (void)removeAllSublayerTransformAnimations;	// IMP=0x0000000000145ae9
- (void)setVideoGravity:(long long)arg1 removingAllSublayerTransformAnimations:(_Bool)arg2;	// IMP=0x0000000000145a32
@property(readonly, nonatomic) AVPlaybackContentContainerView *activeContentView;
- (void)dealloc;	// IMP=0x00000000001454f3
- (id)initWithFrame:(struct CGRect)arg1 playerLayerView:(id)arg2 contentOverlayView:(id)arg3;	// IMP=0x0000000000145317
- (id)initWithFrame:(struct CGRect)arg1 activeContentView:(id)arg2;	// IMP=0x000000000014526c
