...
- (void).cxx_destruct;	// IMP=0x00000000000fe844
...
- (id)init;	// IMP=0x00000000000fe68a
- (void)layoutSublayers;	// IMP=0x00000000000fe3d9
- (id)initWithDisplayScale:(double)arg1 placeholderImage:(struct CGImage *)arg2 opaque:(_Bool)arg3 videoRectWhenPIPBegan:(struct CGRect)arg4;	// IMP=0x00000000000fe31d
