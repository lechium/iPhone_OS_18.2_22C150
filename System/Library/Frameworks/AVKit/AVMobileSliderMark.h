...
+ (id)liveEdgeMarkAtValue:(float)arg1;	// IMP=0x006000000007cab3
+ (id)interstitialMarkAtValue:(float)arg1;	// IMP=0x006000000007ca09
- (void).cxx_destruct;	// IMP=0x000000000007c9e1
...
- (id)initWithStartValue:(float)arg1 endValue:(float)arg2 filledColor:(id)arg3 unfilledColor:(id)arg4 markWithType:(unsigned long long)arg5;	// IMP=0x000000000007c8ea
