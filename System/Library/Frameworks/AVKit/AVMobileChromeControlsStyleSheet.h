...
- (void).cxx_destruct;	// IMP=0x000000000008ca7d
...
- (double)standardPaddingInline;	// IMP=0x000000000008c84f
- (double)standardPaddingFullScreen;	// IMP=0x000000000008c83d
- (struct UIEdgeInsets)embeddedInlineInsets;	// IMP=0x000000000008c81d
- (struct UIEdgeInsets)portraitFullscreenInsets;	// IMP=0x000000000008c7fd
- (struct UIEdgeInsets)landscapeFullscreenInsets;	// IMP=0x000000000008c7dd
...
- (id)initWithTraitCollection:(id)arg1 shouldUseCompactFullScreenSize:(_Bool)arg2;	// IMP=0x000000000008c156
