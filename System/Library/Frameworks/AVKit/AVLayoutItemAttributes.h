...
- (id)debugDescription;	// IMP=0x000000000017b742
- (unsigned long long)hash;	// IMP=0x000000000017b6fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017b628
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017b3f1
@property(readonly, nonatomic, getter=isCollapsedOrExcluded) _Bool collapsedOrExcluded;
- (id)init;	// IMP=0x000000000017b2e5
