...
+ (_Bool)supportsInteractiveCounterRotationDismissals;	// IMP=0x004000000005fa9c
- (void).cxx_destruct;	// IMP=0x000000000005fa24
...
- (id)toView;	// IMP=0x000000000005f8bc
...
- (id)presentingView;	// IMP=0x000000000005f541
...
- (id)fromView;	// IMP=0x000000000005f243
...
- (id)initWithPresentationController:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000005ee77
