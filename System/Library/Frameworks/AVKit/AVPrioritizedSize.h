...
+ (id)sizesResolvingFirstPrioritizedSize:(id)arg1 secondPrioritizedSize:(id)arg2 inAvailableWidth:(double)arg3;	// IMP=0x006000000011342c
- (void).cxx_destruct;	// IMP=0x00000000001133e3
...
- (id)removeLastSizeOfPriority:(unsigned long long)arg1;	// IMP=0x00000000001131f2
- (void)addSize:(struct CGSize)arg1 withPriority:(unsigned long long)arg2;	// IMP=0x00000000001130ff
- (id)init;	// IMP=0x0000000000113033
