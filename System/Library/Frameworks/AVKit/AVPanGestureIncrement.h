...
+ (id)gestureIncrementWithTranslation:(struct CGPoint)arg1 velocity:(struct CGPoint)arg2 timestamp:(double)arg3 hasMultipleTouches:(_Bool)arg4;	// IMP=0x006000000008db2e
...
- (id)debugDescription;	// IMP=0x000000000008dab1
