...
+ (id)controlWithDisplayPriority:(long long)arg1 identifier:(id)arg2;	// IMP=0x00600000000ef2cd
+ (id)controlWithView:(id)arg1 displayPriority:(long long)arg2 identifier:(id)arg3;	// IMP=0x00600000000ef21e
- (void).cxx_destruct;	// IMP=0x00000000000ef1ed
...
- (id)description;	// IMP=0x00000000000ef119
- (_Bool)canOnlyAppearInOverflowMenu;	// IMP=0x00000000000ef10b
