...
- (void).cxx_destruct;	// IMP=0x000000000014cf09
...
- (void)setAnimationCoordinator:(id)arg1;	// IMP=0x000000000014ceb1
- (void)setDirection:(unsigned long long)arg1;	// IMP=0x000000000014cea1
