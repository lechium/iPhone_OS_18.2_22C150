...
+ (id)airMessageParser;	// IMP=0x00400000001450fe
- (void).cxx_destruct;	// IMP=0x0000000000143c34
...
- (id)partsWithData:(id)arg1;	// IMP=0x000000000014399e
- (id)init;	// IMP=0x00000000001437df
- (id)initWithLineSeparator:(id)arg1 headerBodySeparator:(id)arg2 bodyLengthKey:(id)arg3 compressionMethodKey:(id)arg4;	// IMP=0x00000000001436fe
