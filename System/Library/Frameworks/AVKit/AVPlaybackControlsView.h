...
- (void).cxx_destruct;	// IMP=0x00000000000d1e40
...
- (id)_customControlsViewIfLoaded;	// IMP=0x00000000000d19b1
- (id)_playbackControlsViewsForControlItems:(id)arg1 withType:(long long)arg2;	// IMP=0x00000000000d1607
- (id)_playbackControlsViewItems;	// IMP=0x00000000000d13b4
- (void)_animateKeyboardAvoidance:(long long)arg1 duration:(double)arg2;	// IMP=0x00000000000d1229
- (void)_updateLayoutMargins;	// IMP=0x00000000000d0f79
- (void)_setupInitialLayout;	// IMP=0x00000000000d0afb
- (void)_updateDoubleRowLayoutEnabled;	// IMP=0x00000000000d080b
- (void)_updateAreVolumeAndTransportControlsVisible;	// IMP=0x00000000000d0665
- (void)reevaluateHiddenStateForContainersAndSubviews;	// IMP=0x00000000000d04d3
- (void)_updatePlaybackControlsContainerVisibilityAnimated:(_Bool)arg1 additionalActions:(CDUnknownBlockType)arg2;	// IMP=0x00000000000cf9d4
- (void)updateDisplayControlsVisibilityIncludedButtons:(id)arg1;	// IMP=0x00000000000cf5e8
- (void)_collapse:(_Bool)arg1 view:(id)arg2;	// IMP=0x00000000000cf592
- (void)_collapse:(_Bool)arg1 views:(id)arg2;	// IMP=0x00000000000cf457
- (id)_displayModeViewsToRemoveDuringAnimation;	// IMP=0x00000000000cf3ab
- (id)_audioViewsToRemoveDuringAnimation;	// IMP=0x00000000000cf2ff
- (id)_currentArrangedDisplayModeViews;	// IMP=0x00000000000cf254
- (id)_currentArrangedAudioModeViews;	// IMP=0x00000000000cf1a9
- (id)_preferredArrangedDisplayModeViews;	// IMP=0x00000000000cf0f8
- (id)_preferredArrangedAudioModeViews;	// IMP=0x00000000000cf047
- (void)_updateVolumeControlsWithSize:(struct CGSize)arg1;	// IMP=0x00000000000ce81b
- (void)_updateTransportControlsFrame;	// IMP=0x00000000000ce2e9
- (void)_showPlaybackControlsAnimated:(_Bool)arg1;	// IMP=0x00000000000ce2d5
- (void)layoutSubviews;	// IMP=0x00000000000cc165
- (void)avkit_intrinsicContentSizeOfSubviewWasInvalidated:(id)arg1;	// IMP=0x00000000000cc153
- (void)avkit_reevaluateHiddenStateOfItem:(id)arg1;	// IMP=0x00000000000cc019
- (void)safeAreaInsetsDidChange;	// IMP=0x00000000000cbfd8
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000cbf97
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000cbebb
- (void)didMoveToWindow;	// IMP=0x00000000000cbe76
- (void)setPrefersVolumeSliderExpanded:(_Bool)arg1 prefersVolumeButtonIncluded:(_Bool)arg2 animated:(_Bool)arg3;	// IMP=0x00000000000cbbfe
- (void)showPlaybackControls:(_Bool)arg1 immediately:(_Bool)arg2;	// IMP=0x00000000000cbaca
@property(readonly, nonatomic) _Bool hasVisibleSubview;
- (void)animateAlongsideVisibilityAnimationsWithAnimationCoordinator:(id)arg1 appearingViews:(id)arg2 disappearingViews:(id)arg3;	// IMP=0x00000000000cb6a4
- (void)setCustomControlItems:(id)arg1 animations:(CDUnknownBlockType)arg2;	// IMP=0x00000000000cb43c
...
- (void)setIncludedContainers:(long long)arg1 animations:(CDUnknownBlockType)arg2;	// IMP=0x00000000000cb17c
- (void)setupInitialLayout;	// IMP=0x00000000000cb057
- (void)dealloc;	// IMP=0x00000000000caf54
- (id)initWithFrame:(struct CGRect)arg1 styleSheet:(id)arg2;	// IMP=0x00000000000ca1af
