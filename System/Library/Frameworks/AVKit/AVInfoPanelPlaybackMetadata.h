...
+ (_Bool)_closedCaptioningStatusForPlayerController:(id)arg1;	// IMP=0x0010000000182195
+ (double)_durationForPlayerController:(id)arg1;	// IMP=0x0010000000182142
+ (id)_metadataItemsForPlayerItem:(id)arg1 withAsset:(id)arg2;	// IMP=0x0010000000181ec1
+ (void)_loadAssetValues:(id)arg1 into:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000181d78
+ (id)playbackMetadataForPlayerController:(id)arg1 fulfillment:(CDUnknownBlockType)arg2;	// IMP=0x0010000000181c10
- (void).cxx_destruct;	// IMP=0x0000000000181bdd
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000181a5b
- (unsigned long long)hash;	// IMP=0x0000000000181a45
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001819fd
- (id)initWithPlaybackMetadata:(id)arg1;	// IMP=0x00000000001818e9
- (id)initWithPlayerController:(id)arg1;	// IMP=0x0000000000181773
- (id)_releaseDateStringItem;	// IMP=0x00000000001831ea
...
- (id)metadataItemForIdentifiers:(id)arg1;	// IMP=0x0000000000182d60
