...
- (void).cxx_destruct;	// IMP=0x0000000000070d63
...
- (_Bool)_isWindowSceneAvailable;	// IMP=0x0000000000070c51
- (void)_updatePreferredDisplayCriteria;	// IMP=0x0000000000070b88
@property(readonly, nonatomic) struct CGRect sceneBounds;
- (_Bool)isAvailable;	// IMP=0x0000000000070ae5
- (void)setState:(long long)arg1;	// IMP=0x00000000000708a5
- (void)connectWithSecondScreenConnection:(id)arg1;	// IMP=0x00000000000703ae
- (void)dealloc;	// IMP=0x00000000000702a7
- (id)initWithScene:(id)arg1;	// IMP=0x000000000006ff63
