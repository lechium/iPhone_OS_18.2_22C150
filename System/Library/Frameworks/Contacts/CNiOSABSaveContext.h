...
- (void).cxx_destruct;	// IMP=0x00000000000798bb
...
- (id)indexPathForContainerInstance:(id)arg1;	// IMP=0x00000000000797ec
- (id)indexPathForGroupInstance:(id)arg1;	// IMP=0x00000000000797d6
- (id)indexPathForContactInstance:(id)arg1;	// IMP=0x00000000000797c0
- (void)_populateSaveRequestIndexTables;	// IMP=0x0000000000079357
- (void)dealloc;	// IMP=0x0000000000079318
@property(readonly, nonatomic) void *addressBook;
- (id)initWithSaveRequest:(id)arg1 response:(id)arg2 addressBook:(void *)arg3;	// IMP=0x000000000007912f
