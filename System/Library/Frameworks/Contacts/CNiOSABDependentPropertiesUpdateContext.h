...
+ (_Bool)shouldSetWatchChanges;	// IMP=0x00600000000f599c
+ (id)os_log;	// IMP=0x00600000000f4a37
- (void).cxx_destruct;	// IMP=0x00000000000f5ba0
...
- (_Bool)setWatchChangesforThumbnailImageDataToPerson:(void *)arg1 error:(id *)arg2;	// IMP=0x00000000000f59a4
- (_Bool)flushPendingImageChangesToPerson:(void *)arg1 logger:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000f4cfe
- (_Bool)logIfConditionFailed:(_Bool)arg1 message:(id)arg2 error:(struct __CFError **)arg3;	// IMP=0x00000000000f4c78
- (void)resetAllData;	// IMP=0x00000000000f4bd0
