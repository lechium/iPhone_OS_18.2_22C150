...
- (void).cxx_destruct;	// IMP=0x0000000000057425
...
- (id)eventsFromResult:(id)arg1;	// IMP=0x00000000000564af
- (id)initWithContactStore:(id)arg1 additionalContactKeyDescriptors:(id)arg2;	// IMP=0x00000000000563e1
