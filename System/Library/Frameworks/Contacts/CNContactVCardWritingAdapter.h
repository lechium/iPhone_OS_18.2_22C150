...
+ (id)descriptorForAllSupportedKeysWithOptions:(id)arg1;	// IMP=0x00100000000d3d3f
+ (id)adapterWithContact:(id)arg1 options:(id)arg2;	// IMP=0x00100000000d3cd1
- (void).cxx_destruct;	// IMP=0x00000000000d5413
...
- (id)largeImageHashOfType:(id)arg1;	// IMP=0x00000000000d50e1
...
- (id)vCardPropertyItemsForProperty:(id)arg1 valueTransform:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d4db0
- (id)vCardPropertyItemsForProperty:(id)arg1;	// IMP=0x00000000000d4d9c
...
- (id)initWithContact:(id)arg1 options:(id)arg2;	// IMP=0x00000000000d41d5
