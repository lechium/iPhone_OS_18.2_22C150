...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005da3f
...
- (struct __CFArray *)cn_copyGroupsInAddressBook:(void *)arg1 error:(struct __CFError **)arg2;	// IMP=0x000000000005dc76
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005dbb6
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005da47
- (id)initWithContact:(id)arg1 includeAllParentGroups:(_Bool)arg2;	// IMP=0x000000000005d8ba
- (id)initWithGroup:(id)arg1 includeAllParentGroups:(_Bool)arg2;	// IMP=0x000000000005d780
