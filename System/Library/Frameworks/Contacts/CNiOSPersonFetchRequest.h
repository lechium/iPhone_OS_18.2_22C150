...
+ (id)effectivePredicate:(id)arg1;	// IMP=0x006000000010d6b9
+ (id)validatePredicate:(id)arg1 error:(id *)arg2;	// IMP=0x006000000010d615
+ (id)fetchRequestFromCNFetchRequest:(id)arg1 managedConfiguration:(id)arg2 error:(id *)arg3;	// IMP=0x006000000010d3fe
+ (long long)resolvedSortOrderFromContactSortOrder:(long long)arg1;	// IMP=0x006000000010d39a
- (void).cxx_destruct;	// IMP=0x000000000010d367
...
- (id)initWithPredicate:(id)arg1 keysToFetch:(id)arg2 shouldSort:(_Bool)arg3 sortOrder:(unsigned int)arg4 unifiedFetch:(_Bool)arg5 batchSize:(long long)arg6 managedConfiguration:(id)arg7 options:(unsigned long long)arg8;	// IMP=0x000000000010d1c7
