...
+ (id)os_log;	// IMP=0x00600000001422dd
- (void).cxx_destruct;	// IMP=0x0000000000142ecb
...
- (void)resetPrimaryiCloudContainer;	// IMP=0x0000000000142e38
- (void)resetAccountCache;	// IMP=0x0000000000142e24
- (id)cnAccountForContainer:(id)arg1;	// IMP=0x0000000000142cd0
- (id)accountForContainer:(id)arg1;	// IMP=0x0000000000142a41
- (id)onWorkQueue_findPrimaryiCloudContainer;	// IMP=0x00000000001427e7
- (void)dealloc;	// IMP=0x00000000001425ab
- (void)contactStoreDidChange;	// IMP=0x0000000000142524
- (void)accountStoreDidChange;	// IMP=0x000000000014249d
- (id)initWithContactStore:(id)arg1;	// IMP=0x0000000000142339
