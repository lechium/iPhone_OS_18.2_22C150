...
- (void).cxx_destruct;	// IMP=0x00000000000e2f66
...
- (void)interpretUnknownsAsEmailAddresses;	// IMP=0x00000000000e2bd7
- (void)interpretPhoneNumbers;	// IMP=0x00000000000e2942
- (void)interpretEmailAddresses;	// IMP=0x00000000000e27a8
- (void)interpretValues;	// IMP=0x00000000000e275b
- (id)description;	// IMP=0x00000000000e26d5
- (id)initWithHandleStringClassification:(id)arg1;	// IMP=0x00000000000e2606
