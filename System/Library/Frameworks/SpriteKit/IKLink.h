...
- (void).cxx_destruct;	// IMP=0x00000000000c9104
...
- (void)rotateByAngle:(float)arg1;	// IMP=0x00000000000c8df8
- (double)normalizeAngle:(double)arg1;	// IMP=0x00000000000c8d99
- (id)initWithNode:(id)arg1;	// IMP=0x00000000000c8cc0
