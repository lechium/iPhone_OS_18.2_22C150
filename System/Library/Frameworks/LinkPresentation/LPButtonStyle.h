...
+ (id)systemPillButtonStyleForPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2;	// IMP=0x0060000000090d70
- (void).cxx_destruct;	// IMP=0x0000000000091a28
...
- (id)initWithPlatform:(long long)arg1;	// IMP=0x0000000000090c85
