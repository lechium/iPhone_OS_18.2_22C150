...
- (void).cxx_destruct;	// IMP=0x00000000000da461
...
- (id)downloadProgressForTransformer:(id)arg1;	// IMP=0x00000000000da36f
- (id)initWithBytesLoaded:(unsigned long long)arg1 downloadState:(long long)arg2 metadata:(id)arg3;	// IMP=0x00000000000da2d2
