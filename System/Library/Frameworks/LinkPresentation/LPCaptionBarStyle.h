...
- (void).cxx_destruct;	// IMP=0x0000000000094ac8
...
- (id)rightAccessory;	// IMP=0x00000000000948fe
- (id)leftAccessory;	// IMP=0x00000000000948ba
- (id)rightIcon;	// IMP=0x0000000000094876
- (id)leftIcon;	// IMP=0x0000000000094832
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 sizeClassParameters:(id)arg3 fontScalingFactor:(double)arg4;	// IMP=0x0000000000093acd
