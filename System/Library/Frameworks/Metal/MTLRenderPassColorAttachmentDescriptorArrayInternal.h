...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000147d9d
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x0000000000147cda
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x0000000000147c5f
- (void)dealloc;	// IMP=0x0000000000147be2
