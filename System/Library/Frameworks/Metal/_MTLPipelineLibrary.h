...
- (id)newRenderPipelineDescriptorWithName:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e1ac9
- (id)newComputePipelineDescriptorWithName:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e1a8e
- (id)newRenderPipelineStateWithName:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000e19e2
- (id)newComputePipelineStateWithName:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000e1936
...
- (void)dealloc;	// IMP=0x00000000000e183c
- (id)initWithDevice:(id)arg1 pipelineLibraryData:(void *)arg2;	// IMP=0x00000000000e17c7
