...
- (id)description;	// IMP=0x00000000000879c4
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000087857
- (id)describe;	// IMP=0x00000000000877ca
- (void)dealloc;	// IMP=0x0000000000087779
- (id)initWithValue:(const void *)arg1 type:(unsigned long long)arg2 index:(unsigned long long)arg3;	// IMP=0x00000000000876f1
