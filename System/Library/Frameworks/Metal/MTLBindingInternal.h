...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000153b99
@property _Bool isUsed;
@property(readonly, getter=isUsed) _Bool used;
@property(readonly, getter=isActive) _Bool active;
@property(readonly, copy) NSString *description;
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000153ad8
- (id)formattedDescription:(unsigned long long)arg1 withPrintedTypes:(id)arg2;	// IMP=0x000000000015370c
- (id)dataTypeDescription;	// IMP=0x00000000001536fb
...
- (void)dealloc;	// IMP=0x00000000001533c8
@property(readonly) MTLStructType *structType; // @dynamic structType;
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 access:(unsigned long long)arg3 index:(unsigned long long)arg4 active:(_Bool)arg5 arrayLength:(unsigned long long)arg6 typeDescription:(id)arg7;	// IMP=0x0000000000153301
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 access:(unsigned long long)arg3 index:(unsigned long long)arg4 active:(_Bool)arg5 arrayLength:(unsigned long long)arg6;	// IMP=0x0000000000153246
