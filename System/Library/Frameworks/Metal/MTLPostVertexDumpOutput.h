...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001540b0
- (id)description;	// IMP=0x000000000015406e
- (id)formattedDescription:(unsigned long long)arg1 withPrintedTypes:(id)arg2;	// IMP=0x0000000000153e82
- (void)dealloc;	// IMP=0x0000000000153e38
- (id)initWithAirMDType:(id)arg1 dataType:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 aluType:(unsigned long long)arg4 name:(id)arg5 offset:(unsigned long long)arg6;	// IMP=0x0000000000153db2
