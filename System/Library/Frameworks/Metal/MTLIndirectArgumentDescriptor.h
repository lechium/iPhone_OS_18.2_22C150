...
+ (id)indirectArgumentDescriptor;	// IMP=0x00600000000c6e02
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00600000000c6d8f
+ (id)alloc;	// IMP=0x00600000000c6d85
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c6dfa
