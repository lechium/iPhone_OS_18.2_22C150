...
- (void).cxx_destruct;	// IMP=0x00000000001695b0
...
- (void)updateWithState:(id)arg1;	// IMP=0x0000000000169200
- (id)description;	// IMP=0x0000000000169110
- (id)init;	// IMP=0x00000000001690d0
