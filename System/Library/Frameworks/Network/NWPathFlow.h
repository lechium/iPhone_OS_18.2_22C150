...
- (void).cxx_destruct;	// IMP=0x00000000007ccd00
@property(readonly) NSObject<OS_nw_path_flow> *internalPathFlow; // @synthesize internalPathFlow=_internalPathFlow;
- (id)privateDescription;	// IMP=0x00000000007cccb0
- (id)description;	// IMP=0x00000000007ccc90
- (id)descriptionWithIndent:(int)arg1 showFullContent:(_Bool)arg2;	// IMP=0x00000000007cc8b0
...
- (id)initWithPathFlow:(id)arg1;	// IMP=0x00000000007cbee0
