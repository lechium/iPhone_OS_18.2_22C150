...
- (void).cxx_destruct;	// IMP=0x00000000000145d2
...
- (void)destroyBuffer:(id)arg1;	// IMP=0x0000000000014485
- (id)newBufferWithLength:(unsigned long long)arg1 type:(unsigned long long)arg2;	// IMP=0x0000000000014124
- (id)initWithCapacity:(unsigned long long)arg1 allocator:(id)arg2;	// IMP=0x0000000000013fe0
