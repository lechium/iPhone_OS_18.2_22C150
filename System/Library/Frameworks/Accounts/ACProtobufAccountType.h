...
- (void).cxx_destruct;	// IMP=0x00000000000585a8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000058317
- (unsigned long long)hash;	// IMP=0x00000000000581a3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000057f6f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000057db4
- (void)copyTo:(id)arg1;	// IMP=0x0000000000057c60
- (void)writeTo:(id)arg1;	// IMP=0x0000000000057b09
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000057afc
- (id)dictionaryRepresentation;	// IMP=0x000000000005738f
- (id)description;	// IMP=0x00000000000572e0
