...
- (void).cxx_destruct;	// IMP=0x000000000000670b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000063aa
- (unsigned long long)hash;	// IMP=0x000000000000618a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000005f36
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000005d43
- (void)copyTo:(id)arg1;	// IMP=0x0000000000005bc2
- (void)writeTo:(id)arg1;	// IMP=0x0000000000005a45
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000005a38
- (id)dictionaryRepresentation;	// IMP=0x00000000000051d8
- (id)description;	// IMP=0x0000000000005129
...
- (_Bool)_setObject:(id)arg1;	// IMP=0x00000000000539b7
- (id)initWithObjectValue:(id)arg1;	// IMP=0x000000000005393e
