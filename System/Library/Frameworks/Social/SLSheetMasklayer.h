...
- (void).cxx_destruct;	// IMP=0x000000000001f8b7
...
- (void)updateMaskWithBounds:(struct CGRect)arg1 maskRect:(struct CGRect)arg2;	// IMP=0x000000000001f538
- (void)animateSheetMaskFromOldSheetFrame:(struct CGRect)arg1 toSheetFrame:(struct CGRect)arg2 duration:(double)arg3;	// IMP=0x000000000001e76e
- (void)restoreSheetCutout;	// IMP=0x000000000001e6d6
- (void)removeSheetCutout;	// IMP=0x000000000001e63f
- (void)removeAllAnimations;	// IMP=0x000000000001e5a7
- (id)initWithBackgroundColor:(id)arg1 cornerRadius:(double)arg2;	// IMP=0x000000000001e0d0
