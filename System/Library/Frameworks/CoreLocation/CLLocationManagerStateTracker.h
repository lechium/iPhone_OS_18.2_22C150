...
+ (const char *)trackerStateTypeName;	// IMP=0x0060000000013c9b
+ (unsigned long long)trackerStateSize;	// IMP=0x0060000000013c90
- (void *)identifier;	// IMP=0x0000000000013ca8
- (_Bool)dumpState:(void *)arg1 withSize:(unsigned long long)arg2 hints:(struct os_state_hints_s *)arg3;	// IMP=0x0000000000013ae2
- (void)updateState:(CDUnknownBlockType)arg1;	// IMP=0x0000000000013732
...
- (void)dealloc;	// IMP=0x000000000001114a
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x0000000000010cd7
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2;	// IMP=0x0000000000010cc2
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x0000000000010c61
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2;	// IMP=0x0000000000010c4c
