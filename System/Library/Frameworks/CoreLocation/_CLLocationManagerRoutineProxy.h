...
- (void)createConnection;	// IMP=0x000000000000f67d
- (void)didUpdateInertialData:(id)arg1;	// IMP=0x000000000000f441
- (void)didUpdateLocations:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000f1bc
- (void)didUpdateLocations:(id)arg1;	// IMP=0x000000000000ef80
- (void)dealloc;	// IMP=0x000000000000eed7
- (id)initWithQueue:(id)arg1 locationManagerRoutine:(id)arg2;	// IMP=0x000000000000ed18
