...
@optional
- (void)presentAlertSheetWithTitle:(NSString *)arg1 message:(NSString *)arg2 buttonTitles:(NSArray *)arg3 styles:(NSArray *)arg4 completion:(void (^)(int))arg5;
- (void)presentContextMenuWithButtonTitles:(NSArray *)arg1 imageNames:(NSArray *)arg2 buttonFrame:(struct CGRect)arg3 completion:(void (^)(int))arg4;
