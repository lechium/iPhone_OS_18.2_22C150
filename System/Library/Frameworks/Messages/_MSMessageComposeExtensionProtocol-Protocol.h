...
@class MSMessage, NSArray, NSData, NSDictionary, NSNumber, NSString, NSURL, NSUUID, NSValue, _MSConversationState, _MSPresentationState, _UISticker;
...
- (void)_didSelectGPAsset:(NSURL *)arg1 sandboxExtension:(NSString *)arg2 recipeData:(NSData *)arg3 completion:(void (^)(unsigned long long))arg4;
