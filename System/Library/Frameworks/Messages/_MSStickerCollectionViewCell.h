...
- (void).cxx_destruct;	// IMP=0x00000000000159e4
@property(retain, nonatomic) CALayer *borderLayer; // @synthesize borderLayer=_borderLayer;
- (void)setAnimating:(_Bool)arg1;	// IMP=0x0000000000015986
- (void)showCellBorder:(_Bool)arg1;	// IMP=0x000000000001591b
...
- (void)layoutSubviews;	// IMP=0x0000000000015373
- (void)prepareForReuse;	// IMP=0x00000000000152e4
