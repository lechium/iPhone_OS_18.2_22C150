...
- (void).cxx_destruct;	// IMP=0x0000000000011ace
@property(nonatomic) __weak MSMessagesAppViewController *appViewController; // @synthesize appViewController=_appViewController;
- (void)sheetPresentationControllerDidChangeSelectedDetentIdentifier:(id)arg1;	// IMP=0x0000000000011985
- (id)initWithMessagesAppViewController:(id)arg1;	// IMP=0x0000000000011921
