...
+ (id)ruleWithLHS:(id)arg1 RHS:(id)arg2 nodeEvaluator:(CDUnknownBlockType)arg3;	// IMP=0x00600000000bbe36
- (void).cxx_destruct;	// IMP=0x00000000000bc484
...
- (id)description;	// IMP=0x00000000000bc467
