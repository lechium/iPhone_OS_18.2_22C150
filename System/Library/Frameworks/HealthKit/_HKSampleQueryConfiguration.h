...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000017b27
- (void).cxx_destruct;	// IMP=0x00000000000111f6
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009e7ad
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002304
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009e6ef
