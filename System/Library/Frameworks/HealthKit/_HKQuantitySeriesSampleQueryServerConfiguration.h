...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000f97d1
- (void).cxx_destruct;	// IMP=0x00000000000f9ca1
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f9a70
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f97d9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f967f
