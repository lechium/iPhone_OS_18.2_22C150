...
+ (Class)ruleClassForRawValue:(id)arg1;	// IMP=0x0060000000127a5c
- (void).cxx_destruct;	// IMP=0x00000000001282ae
@property(nonatomic) __weak id <HKRemoteFeatureAvailabilityDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (_Bool)evaluate;	// IMP=0x00000000002e8c41
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000002e8c1d
- (id)initWithRawValue:(id)arg1 dataSource:(id)arg2;	// IMP=0x00000000001281b2
