...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000022525b
- (void).cxx_destruct;	// IMP=0x0000000000225409
@property(nonatomic) unsigned long long limit; // @synthesize limit=_limit;
@property(copy, nonatomic) HKSampleIteratorQueryCursor *queryCursor; // @synthesize queryCursor=_queryCursor;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000225325
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000225263
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002251e5
