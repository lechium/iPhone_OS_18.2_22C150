...
- (void).cxx_destruct;	// IMP=0x00000000000c8faa
...
- (id)_parseCDADate:(id)arg1;	// IMP=0x00000000000c8dd1
- (id)_personNameFrom:(id)arg1 familyTagRule:(id)arg2 givenTagRule:(id)arg3 nilOnFail:(_Bool)arg4;	// IMP=0x00000000000c8bcf
- (id)_firstFrom:(id)arg1 tagRule:(id)arg2 nilOnFail:(_Bool)arg3;	// IMP=0x00000000000c8b2f
- (void)extractHeaderFieldsFromDocumentData:(id)arg1;	// IMP=0x00000000000c886d
- (id)initWithDocumentData:(id)arg1;	// IMP=0x00000000000c8805
