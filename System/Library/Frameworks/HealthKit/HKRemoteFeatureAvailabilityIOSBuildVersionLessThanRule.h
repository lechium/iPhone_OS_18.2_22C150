...
+ (id)ruleIdentifier;	// IMP=0x001000000016f60a
- (void).cxx_destruct;	// IMP=0x000000000016f7ac
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x000000000016f670
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000016f617
