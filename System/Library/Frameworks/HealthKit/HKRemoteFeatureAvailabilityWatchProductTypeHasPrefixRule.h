...
+ (id)ruleIdentifier;	// IMP=0x0010000000033b5b
- (void).cxx_destruct;	// IMP=0x0000000000033cad
@property(retain, nonatomic) NSString *productType; // @synthesize productType=_productType;
- (_Bool)evaluate;	// IMP=0x0000000000033bc1
- (void)processUserInfo:(id)arg1;	// IMP=0x0000000000033b68
