...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000007088e
- (void).cxx_destruct;	// IMP=0x0000000000070b90
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000709e4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000070896
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000707cf
