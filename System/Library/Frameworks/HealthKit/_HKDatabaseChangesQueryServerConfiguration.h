...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000251e0a
- (void).cxx_destruct;	// IMP=0x000000000025213e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000251e12
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000251d4c
