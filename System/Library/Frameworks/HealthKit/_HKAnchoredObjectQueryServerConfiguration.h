...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000008ecd
- (void).cxx_destruct;	// IMP=0x0000000000017a2a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000104a61
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003024
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000104972
