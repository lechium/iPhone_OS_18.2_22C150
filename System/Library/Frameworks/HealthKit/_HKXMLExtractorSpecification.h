...
- (void).cxx_destruct;	// IMP=0x0000000000222fe0
...
- (_Bool)matchesElementStack:(id)arg1;	// IMP=0x0000000000222eaf
- (id)initWithSpecificationString:(id)arg1;	// IMP=0x0000000000222c2b
