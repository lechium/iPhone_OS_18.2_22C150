...
+ (id)ruleIdentifier;	// IMP=0x0010000000141ef4
- (void).cxx_destruct;	// IMP=0x0000000000142096
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x0000000000141f5a
- (void)processUserInfo:(id)arg1;	// IMP=0x0000000000141f01
