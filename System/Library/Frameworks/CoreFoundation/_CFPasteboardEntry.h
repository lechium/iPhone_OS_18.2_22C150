...
- (CDUnknownBlockType)requestDataForPasteboard:(struct __CFPasteboard *)arg1 generation:(long long)arg2 immediatelyAvailableResult:(CDStruct_55991ab6 *)arg3;	// IMP=0x0000000000074e38
- (void)resolveClientPromisedDataWithQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000074b19
- (unsigned char)resolveLocalPromisedData;	// IMP=0x0000000000074a70
- (void)promiseDataWithBlock:(CDUnknownBlockType)arg1 forPasteboard:(struct __CFPasteboard *)arg2 generation:(long long)arg3;	// IMP=0x0000000000074946
- (id)createXPCObjectWithMetadataOnly:(unsigned char)arg1;	// IMP=0x000000000007480d
- (id)initFromXPCObject:(id)arg1 fromConnection:(id)arg2;	// IMP=0x0000000000074459
@property(readonly) unsigned char promisorExistsInCurrentProcess;
- (void)_setLocalPromiseState:(unsigned char)arg1;	// IMP=0x00000000000742fe
@property(readonly) unsigned char hasLocalPromise;
- (struct __CFData *)createDataAndReturnError:(int *)arg1;	// IMP=0x00000000000741a9
- (id)_createXPCData;	// IMP=0x0000000000074154
- (void)setData:(struct __CFData *)arg1;	// IMP=0x00000000000740be
@property(readonly) unsigned char hasData;
- (id)description;	// IMP=0x0000000000073f1f
- (void)dealloc;	// IMP=0x0000000000073e4f
- (id)initWithFlavorName:(struct __CFString *)arg1 itemIdentifier:(int)arg2;	// IMP=0x0000000000073db3
- (void)promiseDataWithFetchOperation:(id)arg1;	// IMP=0x0000000000111f86
