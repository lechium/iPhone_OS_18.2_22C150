...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000012ab6
- (void).cxx_destruct;	// IMP=0x0000000000014237
...
- (unsigned long long)hash;	// IMP=0x0000000000013946
- (id)populateOrderedInputFeature;	// IMP=0x00000000000134ca
- (id)description;	// IMP=0x0000000000013199
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000012abe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000012a6e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000012542
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000122d3
- (id)initWithBiasEstimatorFeatures:(id)arg1;	// IMP=0x0000000000011f4b
