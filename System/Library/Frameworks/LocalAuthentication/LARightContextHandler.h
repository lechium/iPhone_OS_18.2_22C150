...
- (void).cxx_destruct;	// IMP=0x00000000000073b7
...
- (void)contextDidBecomeInvalid:(id)arg1;	// IMP=0x0000000000007348
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000007270
- (id)init;	// IMP=0x0000000000007205
