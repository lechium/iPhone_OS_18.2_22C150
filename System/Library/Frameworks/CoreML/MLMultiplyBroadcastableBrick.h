...
- (void).cxx_destruct;	// IMP=0x000000000018832a
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000187919
- (_Bool)hasGPUSupport;	// IMP=0x0000000000187911
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000001876c8
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000001873c5
