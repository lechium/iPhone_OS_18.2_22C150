...
+ (id)sharedHandle;	// IMP=0x00600000002aebf0
...
- (id)predictVectorForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000002ae9ab
- (id)predictLabelForWordString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000002ae852
- (id)predictLabelsForSentenceString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000002ae6fc
- (id)predictTokensLabelsLocationsLengthsForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000002ae5a6
- (void *)initializeEmbeddingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000002ae55e
- (void *)initializeGazetteerModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000002ae519
- (void *)initializeSentenceClassifierModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000002ae4d4
- (void *)initializeWordTaggingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000002ae48f
- (id)init;	// IMP=0x00000000002ae1e5
