...
- (void).cxx_destruct;	// IMP=0x0000000000125f3b
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000125bcc
- (_Bool)hasGPUSupport;	// IMP=0x0000000000125bc4
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000012594f
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000001256b2
