...
- (void).cxx_destruct;	// IMP=0x00000000002308cc
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000022fb4f
- (_Bool)hasGPUSupport;	// IMP=0x000000000022fb47
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000022f810
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000022f17f
