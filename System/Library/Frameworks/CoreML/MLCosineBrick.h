...
- (void).cxx_destruct;	// IMP=0x000000000018f14a
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000018ef49
- (_Bool)hasGPUSupport;	// IMP=0x000000000018ef41
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000018ee08
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000018edf2
