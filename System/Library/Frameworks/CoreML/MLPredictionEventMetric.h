...
- (void).cxx_destruct;	// IMP=0x0000000000267c3e
...
- (id)initWithBundleIdentifier:(id)arg1 modelName:(id)arg2 firstPartyExecutable:(id)arg3 modelType:(id)arg4 featuresPredictionDuration:(double)arg5 featuresPredictionCountSoFar:(long long)arg6;	// IMP=0x0000000000267883
