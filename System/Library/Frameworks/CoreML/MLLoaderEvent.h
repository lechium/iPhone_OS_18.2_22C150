...
- (void).cxx_destruct;	// IMP=0x0000000000225cf3
...
- (id)numberFromCString:(const char *)arg1;	// IMP=0x000000000022595a
- (void)extractAndSetModelDetailsFromArchive:(void *)arg1;	// IMP=0x0000000000224e69
