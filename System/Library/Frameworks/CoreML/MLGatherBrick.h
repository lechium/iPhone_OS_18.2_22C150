...
- (void).cxx_destruct;	// IMP=0x0000000000227313
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000002269d6
- (_Bool)hasGPUSupport;	// IMP=0x00000000002269ce
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000226759
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000022644e
