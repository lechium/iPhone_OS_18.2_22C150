...
- (void).cxx_destruct;	// IMP=0x000000000012feb0
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000012f8a2
- (_Bool)hasGPUSupport;	// IMP=0x000000000012f89a
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000012f625
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000012f60f
