...
- (void).cxx_destruct;	// IMP=0x00000000003a8ced
- (id)sceneLabelOperationPointsForOriginatingRequestSpecifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000003a8b68
- (id)initWithInferenceNetworkDescriptor:(id)arg1;	// IMP=0x00000000003a8aa3
