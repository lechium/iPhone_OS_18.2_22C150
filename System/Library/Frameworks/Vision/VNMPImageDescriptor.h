...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000036d13b
+ (unsigned long long)currentVersion;	// IMP=0x001000000036d130
- (void).cxx_destruct;	// IMP=0x000000000036d108
...
- (id)initWithRawColorGaborDescriptor:(id)arg1;	// IMP=0x000000000036cdd9
@property(readonly) NSData *rawColorGaborDescriptor;
- (float)computeFinalDescriptorBasedDistanceForColorDistance:(float)arg1 andSceneClassifierDistance:(float)arg2;	// IMP=0x000000000036cd6f
- (float)distanceFromDescriptor:(id)arg1;	// IMP=0x000000000036ccec
- (_Bool)computeRegistrationFeaturesForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x000000000036cce4
- (_Bool)computeDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x000000000036c9cb
- (_Bool)computeConvnetDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x000000000036c9c3
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000036c7f4
- (unsigned long long)hash;	// IMP=0x000000000036c6dc
- (void)dealloc;	// IMP=0x000000000036c69c
- (id)initWithState:(id)arg1 byteOffset:(unsigned long long *)arg2 error:(id *)arg3;	// IMP=0x000000000036c331
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x000000000036c0bf
@property(readonly, nonatomic) unsigned long long serializedLength;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000036be00
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000036b83c
- (id)initWithImageData:(id)arg1 andCustomQualityScore:(float)arg2 context:(id)arg3 error:(id *)arg4;	// IMP=0x000000000036b80d
- (id)initWithImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x000000000036b5d5
