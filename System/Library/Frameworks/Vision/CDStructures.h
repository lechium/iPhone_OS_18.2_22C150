...
struct ConnectedComponentResult {
    ...
    vector_48b48a27 _field4;
    vector_3c4dda2d _field5;
...
struct unique_ptr<unsigned long[], std::default_delete<unsigned long[]>> {
    struct __compressed_pair<unsigned long *, std::default_delete<unsigned long[]>> {
        unsigned long long *_field1;
    } _field1;
};
...
struct vector<apple::vision::fgbg::ConnectedComponentResult::CCBoundary, std::allocator<apple::vision::fgbg::ConnectedComponentResult::CCBoundary>> {
    ...
    struct __compressed_pair<apple::vision::fgbg::ConnectedComponentResult::CCBoundary *, std::allocator<apple::vision::fgbg::ConnectedComponentResult::CCBoundary>> {
        struct CCBoundary *_field1;
    } _field3;
};
