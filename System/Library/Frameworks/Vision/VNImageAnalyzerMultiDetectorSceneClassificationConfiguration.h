...
- (void).cxx_destruct;	// IMP=0x000000000038fddc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000038fc94
- (unsigned int)labelsListType;	// IMP=0x000000000038fc89
- (unsigned int)analysisTypes;	// IMP=0x000000000038fc7e
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x000000000038fac2
