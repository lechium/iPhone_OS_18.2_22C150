...
- (void)releaseAllocations;	// IMP=0x00000000003b29a1
- (_Bool)makeAllocationsForWidth:(unsigned long long)arg1;	// IMP=0x00000000003b2893
- (void)dealloc;	// IMP=0x00000000003b2820
- (void)resetBoxBounds;	// IMP=0x00000000003b280f
- (void)copyFlagValue:(unsigned long long)arg1 toTarget:(unsigned long long)arg2 atIndex:(unsigned int)arg3;	// IMP=0x00000000003b27de
- (unsigned int)checkFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000003b27c9
- (void)clearFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000003b27b6
- (void)setFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000003b27a6
