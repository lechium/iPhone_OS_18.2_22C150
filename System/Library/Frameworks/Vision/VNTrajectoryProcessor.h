...
- (void).cxx_destruct;	// IMP=0x00000000002b6938
- (id)processVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 warningRecorder:(id)arg4 requestUUID:(id)arg5 error:(id *)arg6;	// IMP=0x00000000002b4dc3
- (id)_VNPointsFromCGPoints:(const void *)arg1;	// IMP=0x00000000002b4caf
- (struct __CVBuffer *)_createCroppedAndScaledBufferFromVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 error:(id *)arg4;	// IMP=0x00000000002b4a65
- (void)dealloc;	// IMP=0x00000000002b49f3
- (id)initWithFrameAnalysisSpacing:(CDStruct_1b6d18a9)arg1 trajectoryLength:(long long)arg2;	// IMP=0x00000000002b3ff1
