...
+ (_Bool)revision:(unsigned long long)arg1 supportsConstellation:(unsigned long long)arg2;	// IMP=0x006000000029a9af
- (void).cxx_destruct;	// IMP=0x000000000029a99c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000029a7d7
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000029a71d
