...
- (void).cxx_destruct;	// IMP=0x00000000003c96d5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003c94ec
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000003c93e4
