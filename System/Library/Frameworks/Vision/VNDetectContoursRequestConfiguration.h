...
- (void).cxx_destruct;	// IMP=0x00000000003aaf4b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003aad81
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000003aacbb
