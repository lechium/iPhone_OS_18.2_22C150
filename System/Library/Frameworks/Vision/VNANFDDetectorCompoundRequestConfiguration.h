...
- (void).cxx_destruct;	// IMP=0x0000000000444d3b
...
- (void)setDetectorConfigurationOption:(id)arg1 value:(id)arg2;	// IMP=0x0000000000444bcf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000444af0
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000444a29
