...
- (void).cxx_destruct;	// IMP=0x0000000000239ad3
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002398d3
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000023983c
