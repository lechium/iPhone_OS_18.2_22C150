...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000332886
- (void).cxx_destruct;	// IMP=0x0000000000332853
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003327a4
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000033254a
