...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000333d72
- (void).cxx_destruct;	// IMP=0x0000000000333d3f
...
- (void)dealloc;	// IMP=0x0000000000333bde
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000003338fd
- (unsigned long long)serializedLength;	// IMP=0x00000000003338dd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003338bb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000033337a
