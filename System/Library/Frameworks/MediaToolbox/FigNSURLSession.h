...
- (void)dealloc;	// IMP=0x000000000038feb3
- (void)releaseOSTransaction;	// IMP=0x000000000038fe8c
- (unsigned char)acquireOSTransaction;	// IMP=0x000000000038fe4e
- (id)initWithClientBundleIdentifier:(id)arg1 clientPersonaIdentifier:(id)arg2 dispatchQueue:(id)arg3;	// IMP=0x000000000038fcce
- (void)debug;	// IMP=0x000000000038fc72
- (struct FigOpaqueAssertion *)acquireAssertion;	// IMP=0x000000000038fb5c
