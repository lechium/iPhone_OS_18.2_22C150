...
- (id)description;	// IMP=0x0000000000095e4a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000095bad
- (unsigned long long)hash;	// IMP=0x0000000000095ba3
- (void)dealloc;	// IMP=0x0000000000095b52
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000095b47
