...
- (void).cxx_destruct;	// IMP=0x00000000001a708a
...
- (void)issueOperationalCertificateForRequest:(id)arg1 attestationInfo:(id)arg2 controller:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000001a6acf
- (id)initWithIssuer:(id)arg1;	// IMP=0x00000000001a6a4b
