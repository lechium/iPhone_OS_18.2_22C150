...
- (void).cxx_destruct;	// IMP=0x00000000001545b2
- (id)finish:(int)arg1;	// IMP=0x00000000001543e4
- (_Bool)parse:(const char *)arg1 len:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000153a0a
