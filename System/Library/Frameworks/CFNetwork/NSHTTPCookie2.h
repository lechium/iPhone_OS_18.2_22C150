...
- (void).cxx_destruct;	// IMP=0x000000000007f583
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007f25e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007f253
- (id)description;	// IMP=0x000000000007f047
@property(readonly) NSDate *expirationDate;
@property(readonly) NSDate *creationDate; // @synthesize creationDate;
- (id)initWithName:(id)arg1 value:(id)arg2 domain:(id)arg3;	// IMP=0x000000000007ee0a
