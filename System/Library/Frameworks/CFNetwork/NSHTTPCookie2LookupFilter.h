...
- (void).cxx_destruct;	// IMP=0x0000000000127705
...
- (_Bool)matchCookie:(id)arg1;	// IMP=0x0000000000126d32
- (long long)_flags;	// IMP=0x000000000012680b
- (id)initWithCookie:(id)arg1;	// IMP=0x0000000000126677
