...
+ (id)fromProto:(id)arg1;	// IMP=0x0060000000033ada
+ (id)toProto:(id)arg1;	// IMP=0x00600000000338c6
- (void).cxx_destruct;	// IMP=0x0000000000033d95
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000335be
- (id)init;	// IMP=0x000000000003358f
