...
- (void)dealloc;	// IMP=0x0000000000007cb3
- (void)destroyBuffer:(id)arg1;	// IMP=0x0000000000007b84
- (id)newBufferWithLength:(unsigned long long)arg1 type:(unsigned long long)arg2;	// IMP=0x0000000000007881
- (id)initWithCapacity:(unsigned long long)arg1 allocator:(id)arg2;	// IMP=0x00000000000077bc
