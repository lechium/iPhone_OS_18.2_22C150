...
+ (id)playerItemForMediaItem:(id)arg1;	// IMP=0x0060000000010b75
- (void).cxx_destruct;	// IMP=0x0000000000012de2
...
- (id)description;	// IMP=0x00000000000129ee
- (void)_initializeAdditionalAttributesWithMediaItem:(id)arg1;	// IMP=0x00000000000111de
- (void)_initializeArtworkCatalogWithMediaItem:(id)arg1;	// IMP=0x0000000000010df7
- (void)_initializeBasicPropertiesWithMediaItem:(id)arg1;	// IMP=0x0000000000010c57
- (id)_initWithMediaItem:(id)arg1;	// IMP=0x0000000000010bc7
