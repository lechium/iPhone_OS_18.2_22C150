...
- (void).cxx_destruct;	// IMP=0x000000000005574b
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000055548
- (oneway void)requestCalls:(CDUnknownBlockType)arg1;	// IMP=0x000000000005543b
- (oneway void)removeCall:(id)arg1;	// IMP=0x00000000000553d2
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x0000000000055369
...
- (void)dealloc;	// IMP=0x0000000000055114
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x0000000000054acf
- (id)init;	// IMP=0x0000000000054ac1
