...
- (void)stateDirectoryWithCompletionHandler:(void (^)(FPSandboxingURLWrapper *, NSError *))arg1;
...
- (void)deleteSearchableItemsWithSpotlightDomainIdentifiers:(NSArray *)arg1 indexReason:(long long)arg2 completionHandler:(void (^)(NSError *))arg3;
