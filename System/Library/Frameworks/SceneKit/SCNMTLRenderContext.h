...
- (id).cxx_construct;	// IMP=0x00000000000e8f56
- (void).cxx_destruct;	// IMP=0x00000000000e8f14
- (void)writeBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x00000000000e86ce
- (void)_drawShadowMaps;	// IMP=0x00000000000e7719
- (void)_drawPBRTextures;	// IMP=0x00000000000e6de7
- (void)resetVolatileMeshElements;	// IMP=0x00000000000e6aba
- (void)_recycleMTLBufferToPool:(id)arg1;	// IMP=0x00000000000e67dd
- (id)_newMTLBufferFromPoolWithLength:(unsigned long long)arg1;	// IMP=0x00000000000e66ff
- (void)resetVolatileMeshes;	// IMP=0x00000000000e65e1
- (void)_executeDrawCommand:(CDStruct_26eb7e6d)arg1;	// IMP=0x00000000000dee89
- (void)_prepareMaterialTextures:(struct __C3DMaterial *)arg1;	// IMP=0x00000000000dedbb
- (float)_zFarForSkyboxRenderingProjectionMatrix:(const union C3DMatrix4x4 *)arg1 defaultZFar:(float)arg2;	// IMP=0x00000000000dbb05
- (void)_updateProjectionMatrixForOrthographicSkyboxRenderingIfNeeded:(union C3DMatrix4x4 *)arg1;	// IMP=0x00000000000db845
- (void)_logLightingInformation;	// IMP=0x00000000000dad3f
- (void)_createResourceCommandBufferIfNeeded;	// IMP=0x00000000000da4f6
- (void)_clearUnusedBindingPoints;	// IMP=0x00000000000d9540
- (void)dealloc;	// IMP=0x00000000000d8c72
- (void)_reduceStatsOfConstantBuffer:(id)arg1;	// IMP=0x00000000000d8624
