...
- (id)ciImage;	// IMP=0x000000000009ba3e
- (id)textureForSliceIndex:(unsigned long long)arg1;	// IMP=0x000000000009b8c0
- (_Bool)matchesDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000009b7cd
@property(readonly, nonatomic) unsigned char renderBufferFormat;
@property(readonly, nonatomic) _Bool viewportDependant;
- (id)description;	// IMP=0x000000000009b71a
- (void)dealloc;	// IMP=0x000000000009b6c2
- (id)initWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000009b668
