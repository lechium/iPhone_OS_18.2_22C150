...
- (void)dealloc;	// IMP=0x00000000001b3ddc
- (id)prepareRendererAtIndex:(int)arg1 withScene:(id)arg2 renderSize:(struct CGSize)arg3 pointOfView:(id)arg4 parentRenderer:(id)arg5;	// IMP=0x00000000001b3c61
- (struct __C3DFXPass *)transitionPass;	// IMP=0x00000000001b3c0d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b3b6b
