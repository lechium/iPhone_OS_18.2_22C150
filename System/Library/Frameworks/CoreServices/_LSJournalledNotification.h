...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000198257
- (void).cxx_destruct;	// IMP=0x0000000000198528
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001983aa
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000198309
- (id)initWithNotification:(int)arg1 bundleIDs:(id)arg2 plugins:(_Bool)arg3 options:(id)arg4;	// IMP=0x000000000019825f
