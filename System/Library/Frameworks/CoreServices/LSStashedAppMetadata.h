...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000301d5
- (void).cxx_destruct;	// IMP=0x00000000000308b9
...
- (id)initWithContext:(struct LSContext *)arg1 unitID:(unsigned int)arg2;	// IMP=0x0000000000030444
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003039e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000301dd
