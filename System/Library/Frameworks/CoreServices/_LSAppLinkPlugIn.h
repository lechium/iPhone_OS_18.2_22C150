...
+ (_Bool)canHandleURLComponents:(id)arg1;	// IMP=0x006000000005808a
+ (id)plugInClasses;	// IMP=0x006000000005801e
- (void).cxx_destruct;	// IMP=0x000000000005832b
...
- (id)appLinksWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x0000000000058282
