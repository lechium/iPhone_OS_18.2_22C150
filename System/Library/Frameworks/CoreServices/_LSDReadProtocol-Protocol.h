...
@class FSMimic, FSNode, LSDocumentProxy, NSArray, NSSet, NSString, NSUUID, _LSDiskUsage;

@protocol _LSDReadProtocol
- (void)getCurrentApplicationDefaultInfoForCategory:(unsigned long long)arg1 completion:(void (^)(LSDefaultApplicationQueryResult *, NSError *))arg2;
- (void)getPreferredAppMarketplacesWithCompletion:(void (^)(NSArray *, NSError *))arg1;
- (void)getHasEverChangedPreferredAppForCategory:(unsigned long long)arg1 completion:(void (^)(NSNumber *, NSError *))arg2;
- (void)getEligibilityAnswerForDomain:(unsigned long long)arg1 withCompletionHandler:(void (^)(NSNumber *, NSError *))arg2;
