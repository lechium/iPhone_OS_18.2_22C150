...
@interface LSBundleRecordBuilder
{
    ...
    NSArray *_parentApplicationIdentifiers;	// 480 = 0x1e0
    NSString *_watchKitVersion;	// 488 = 0x1e8
    NSString *_complicationPrincipalClass;	// 496 = 0x1f0
    NSArray *_supportedComplicationFamilies;	// 504 = 0x1f8
    NSString *_ratingLabel;	// 512 = 0x200
    NSNumber *_ratingRank;	// 520 = 0x208
    NSString *_genre;	// 528 = 0x210
    NSNumber *_genreID;	// 536 = 0x218
    NSDictionary *_distributorInfo;	// 544 = 0x220
    NSString *_primaryIconName;	// 552 = 0x228
    NSString *_alternatePrimaryIconName;	// 560 = 0x230
    NSDictionary *_iconsDict;	// 568 = 0x238
    NSArray *_iconFileNames;	// 576 = 0x240
    NSNumber *_purchaserDSID;	// 584 = 0x248
    NSNumber *_downloaderDSID;	// 592 = 0x250
    NSNumber *_familyID;	// 600 = 0x258
    NSNumber *_staticDiskUsage;	// 608 = 0x260
    NSString *_libraryPath;	// 616 = 0x268
    NSArray *_libraryItems;	// 624 = 0x270
    NSArray *_documentClaims;	// 632 = 0x278
    NSArray *_URLClaims;	// 640 = 0x280
    NSArray *_importedTypes;	// 648 = 0x288
    NSArray *_exportedTypes;	// 656 = 0x290
    NSArray *_queriableSchemes;	// 664 = 0x298
    NSDictionary *_pluginPlists;	// 672 = 0x2a0
    NSDictionary *_pluginMIDicts;	// 680 = 0x2a8
    NSArray *_driverExtensionPaths;	// 688 = 0x2b0
    NSDictionary *_groupContainers;	// 696 = 0x2b8
    NSDictionary *_entitlements;	// 704 = 0x2c0
    NSDictionary *_sandboxEnvironmentVariables;	// 712 = 0x2c8
    NSDictionary *_extensionSDK;	// 720 = 0x2d0
    NSDictionary *_intentDefinitionURLs;	// 728 = 0x2d8
    NSArray *_bgPermittedIdentifiers;	// 736 = 0x2e0
    NSArray *_carPlayInstrumentClusterURLSchemes;	// 744 = 0x2e8
    NSDictionary *_localizedNames;	// 752 = 0x2f0
    NSDictionary *_localizedShortNames;	// 760 = 0x2f8
    NSString *_microphoneUsageDescription;	// 768 = 0x300
    NSDictionary *_localizedMicrophoneUsageDescription;	// 776 = 0x308
    NSString *_identityUsageDescription;	// 784 = 0x310
    NSDictionary *_localizedIdentityUsageDescription;	// 792 = 0x318
    NSDictionary *_localizedStrings;	// 800 = 0x320
    NSDictionary *_unlocalizedNamesWithContext;	// 808 = 0x328
    NSNumber *_directoryClass;	// 816 = 0x330
    NSDictionary *_mobileInstallIDs;	// 824 = 0x338
    NSArray *_slices;	// 832 = 0x340
    NSNumber *_signatureVersion;	// 840 = 0x348
    NSDictionary *_stashedAppInfo;	// 848 = 0x350
    NSString *_applicationManagementDomain;	// 856 = 0x358
    NSString *_linkedParentBundleID;	// 864 = 0x360
}

- (void).cxx_destruct;	// IMP=0x00000000000907e8
...
- (unsigned int)registerBundleRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000008f727
- (int)activateBindings:(id)arg1 unitID:(unsigned int)arg2 bundleData:(const struct LSBundleData *)arg3;	// IMP=0x000000000008f64e
- (struct LSBundleData)buildBundleData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000008cb69
- (void)parseNSExtensionSDKDefinitionsFromDictionary:(id)arg1;	// IMP=0x000000000008c67e
- (void)parseActivityTypesFromDictionary:(id)arg1;	// IMP=0x000000000008c41b
- (_Bool)parseInstallationInfo:(id)arg1;	// IMP=0x000000000008b0de
- (_Bool)parseInfoPlist:(id)arg1;	// IMP=0x00000000000887f8
- (void)parseURLClaimsFromDict:(id)arg1;	// IMP=0x0000000000088585
- (void)parseDocumentClaimsFromDict:(id)arg1;	// IMP=0x000000000008827d
- (void)parseDeviceFamilyFromDict:(id)arg1;	// IMP=0x0000000000088110
- (void)parseIconFilenamesFromDict:(id)arg1 forPlatform:(unsigned int)arg2;	// IMP=0x000000000008802a
- (id)iconsDictionaryFromDict:(id)arg1;	// IMP=0x0000000000087a6d
- (void)parseArchitecturesFromDict:(id)arg1;	// IMP=0x00000000000879ff
- (void)setCommonInfoPlistKeysFromDictionary:(id)arg1;	// IMP=0x00000000000878c9
- (void)setRaritiesFromDictionary:(id)arg1;	// IMP=0x000000000008763d
- (void)setFlagsFromDictionary:(id)arg1;	// IMP=0x00000000000872b9
- (id)_LSKeyTypeMap;	// IMP=0x00000000000870a8
- (id)_LSPlistRaritiesMap;	// IMP=0x0000000000086e7c
- (id)_LSBundleFlagMap;	// IMP=0x000000000008693a
- (id)truncate:(_Bool *)arg1 queriableSchemesIfNeeded:(id)arg2;	// IMP=0x00000000000866db
- (int)registerQueriableSchemes:(id)arg1 bundleData:(struct LSBundleData *)arg2;	// IMP=0x00000000000862d2
- (void)addItemInfoFlag:(unsigned int)arg1;	// IMP=0x00000000000862c2
- (void)addIconFlag:(unsigned char)arg1;	// IMP=0x00000000000862b2
- (void)addPlistFlag:(unsigned int)arg1;	// IMP=0x00000000000862a2
- (void)addBundleFlag:(unsigned long long)arg1;	// IMP=0x0000000000086291
- (void)setRegistrationInfo:(id)arg1 alias:(id)arg2;	// IMP=0x000000000008617f
