...
- (void).cxx_destruct;	// IMP=0x000000000001eaee
- (id)nextObject;	// IMP=0x000000000001e935
- (id)initWithAppEnumerationOptions:(unsigned long long)arg1;	// IMP=0x000000000001e60b
