...
- (void).cxx_destruct;	// IMP=0x000000000005cd60
- (void)layoutSublayersOfLayer:(id)arg1;	// IMP=0x000000000005cce0
- (void)tintColorDidChange;	// IMP=0x000000000005ca90
- (void)willMoveToSuperview:(id)arg1;	// IMP=0x000000000005a0d0
@property(nonatomic) unsigned long long accessibilityTraits;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000059dd0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000059da0
