...
- (void)dealloc;	// IMP=0x000000000000978d
- (void)stopIndicator;	// IMP=0x0000000000009718
- (void)startIndicator;	// IMP=0x00000000000096a6
- (void)updateConstraints;	// IMP=0x000000000000946b
- (void)createInitialConstraints;	// IMP=0x000000000000923c
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000008e8e
