...
- (id).cxx_construct;	// IMP=0x0000000000007c63
- (void).cxx_destruct;	// IMP=0x0000000000007c05
...
- (id)initWithHapticPlayer:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000005612
