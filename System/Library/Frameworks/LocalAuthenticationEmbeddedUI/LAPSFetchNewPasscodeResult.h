...
- (id)initWithRawPasscode:(id)arg1;	// IMP=0x000000000001c0ac
- (id)initWithRawPasscode:(id)arg1 isPasscodeRecoveryEnabled:(_Bool)arg2;	// IMP=0x000000000001c02a
- (id)initWithPasscode:(id)arg1 isPasscodeRecoveryEnabled:(_Bool)arg2;	// IMP=0x000000000001bfb4
