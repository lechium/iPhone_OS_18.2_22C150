...
- (void)dealloc;	// IMP=0x000000000000a673
- (void)registerAlbum:(id)arg1 assetGroupPrivate:(id)arg2;	// IMP=0x000000000000a5ab
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x0000000000009cc7
@property(readonly, retain, nonatomic) PLPhotoLibrary *photoLibrary; // @synthesize photoLibrary=_photoLibrary;
- (id)initWithAssetsLibrary:(id)arg1;	// IMP=0x0000000000009ba0
