...
- (void)_performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000000c25e
- (void)libraryDidChange;	// IMP=0x000000000000c24c
@property(nonatomic) ALAssetsLibrary *library;
- (void)setValue:(id)arg1 forProperty:(id)arg2;	// IMP=0x000000000000c1d2
- (id)valueForProperty:(id)arg1;	// IMP=0x000000000000c165
- (void)populateAssets;	// IMP=0x000000000000c147
- (void)updateAlbumFiltering;	// IMP=0x000000000000c0fb
- (void)resetAssets;	// IMP=0x000000000000c0b5
- (int)albumFilter;	// IMP=0x000000000000c031
- (void)dealloc;	// IMP=0x000000000000bf7d
- (id)initWithAlbum:(id)arg1 library:(id)arg2;	// IMP=0x000000000000bea1
