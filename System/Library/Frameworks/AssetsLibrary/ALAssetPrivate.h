...
- (void).cxx_destruct;	// IMP=0x000000000000bd84
...
- (void)_performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000000bb5e
@property(readonly, nonatomic, getter=isDeletable) _Bool deletable;
- (void)libraryDidChange;	// IMP=0x000000000000baab
@property(nonatomic) ALAssetsLibrary *library;
- (void)dealloc;	// IMP=0x000000000000ba20
- (id)initWithManagedAsset:(id)arg1 library:(id)arg2;	// IMP=0x000000000000b999
