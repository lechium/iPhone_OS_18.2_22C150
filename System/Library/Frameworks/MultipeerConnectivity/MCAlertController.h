...
- (void)dealloc;	// IMP=0x000000000000ebc3
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000000000eb2e
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000000eacf
- (void)dismiss;	// IMP=0x000000000000ea91
- (void)show;	// IMP=0x000000000000e93f
