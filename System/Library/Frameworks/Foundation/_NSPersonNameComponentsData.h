...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000784177
...
- (void)dealloc;	// IMP=0x0000000000784538
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000078443b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000078417f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007840bd
- (id)init;	// IMP=0x000000000078404f
