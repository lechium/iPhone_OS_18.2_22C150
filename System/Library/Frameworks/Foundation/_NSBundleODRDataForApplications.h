...
- (_Bool)assetPacksBecameUnavailable:(id)arg1 error:(id *)arg2;	// IMP=0x000000000083762e
- (_Bool)assetPacksBecameAvailable:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000837520
- (id)description;	// IMP=0x0000000000837496
- (void)dealloc;	// IMP=0x00000000008373ba
- (id)initWithBundle:(id)arg1;	// IMP=0x0000000000836b31
