...
+ (id)customAttributes;	// IMP=0x0060000000052e55
...
- (id)outputImage;	// IMP=0x0000000000052622
- (id)_CICMYK_black;	// IMP=0x0000000000052602
- (id)_CICMYK_yellow;	// IMP=0x00000000000525e2
- (id)_CICMYK_magenta;	// IMP=0x00000000000525c2
- (id)_CICMYK_cyan;	// IMP=0x00000000000525a2
- (id)_CICMYK_convert;	// IMP=0x0000000000052582
- (id)_CIWhite;	// IMP=0x0000000000052562
