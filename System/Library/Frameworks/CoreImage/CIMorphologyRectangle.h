...
+ (id)customAttributes;	// IMP=0x006000000017986e
...
- (id)outputImage;	// IMP=0x0000000000179b40
- (_Bool)_doMinimum;	// IMP=0x0000000000179b38
- (_Bool)_isIdentity;	// IMP=0x0000000000179aeb
