...
+ (id)customAttributes;	// IMP=0x00600000001023d2
...
- (id)outputImage;	// IMP=0x00000000001029e3
- (id)_geomKernel;	// IMP=0x00000000001029c3
- (id)_colorKernel;	// IMP=0x00000000001029a3
