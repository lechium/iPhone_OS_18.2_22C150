...
- (float *)colorHistogram;	// IMP=0x0000000000050cba
- (long long)compareImageOrder:(id)arg1;	// IMP=0x0000000000050c59
- (long long)compareImageStats:(id)arg1;	// IMP=0x0000000000050c51
- (float)computeScore:(float)arg1;	// IMP=0x0000000000050b1d
- (unsigned short *)aeMatrix;	// IMP=0x0000000000050b10
- (void)computeAEMatrix:(id)arg1;	// IMP=0x0000000000050934
- (int)setAEMatrix:(id)arg1;	// IMP=0x00000000000508c2
- (float)computeAEMatrixDifference:(id)arg1;	// IMP=0x0000000000050885
- (float)computeImageDistance:(id)arg1;	// IMP=0x0000000000050836
- (float)computeSmilePercentage;	// IMP=0x000000000005072a
- (float)computeRuleOfThreeDistance;	// IMP=0x0000000000050494
- (float)computeFacialFocusScoreSum;	// IMP=0x000000000004ff26
- (void)collapseSharpnessGrid;	// IMP=0x000000000004fc51
- (void)computeImageData:(id)arg1 faceIDCounts:(id)arg2;	// IMP=0x000000000004fa03
- (void)writeGridROI:(id)arg1;	// IMP=0x000000000004f92e
- (int)canRegister;	// IMP=0x000000000004f90d
- (void)computeImageProjections:(id)arg1;	// IMP=0x000000000004f864
- (void)performRegistration:(id)arg1 deltaCol:(float *)arg2 deltaRow:(float *)arg3;	// IMP=0x000000000004eb76
- (void)flagAsGarbage;	// IMP=0x000000000004eb55
- (void)updateROI:(struct GridROI_t)arg1;	// IMP=0x000000000004ea48
- (float)computeSmoothedGridROI:(id)arg1 nextStat:(id)arg2;	// IMP=0x000000000004e7a4
- (void)computeBlurStatsOnGrid:(id)arg1;	// IMP=0x000000000004e4bf
- (void)computeImageSharpnessOnGrid:(id)arg1;	// IMP=0x000000000004e34e
- (struct GridROI_t)getSharpnessAndBlurLimits;	// IMP=0x000000000004e33f
- (void)computeImageColorHistogram:(id)arg1;	// IMP=0x000000000004e1b7
- (void)dealloc;	// IMP=0x000000000004e12a
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000004e064
- (void)assignMeanStdBuffers:(float *)arg1;	// IMP=0x000000000004dfb9
- (void)allocateMeanStdPingPongBuffers:(float **)arg1:(float **)arg2:(float **)arg3:(float **)arg4;	// IMP=0x000000000004df04
