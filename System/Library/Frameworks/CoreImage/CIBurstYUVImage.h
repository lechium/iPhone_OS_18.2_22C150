...
- (struct __CVBuffer *)pixelBuffer;	// IMP=0x00000000000524f9
- (void)dealloc;	// IMP=0x0000000000052489
- (id)initWithIOSurface:(struct __IOSurface *)arg1 maxDimension:(int)arg2;	// IMP=0x00000000000521db
- (id)initWithCGImage:(struct CGImage *)arg1 maxDimension:(int)arg2;	// IMP=0x0000000000052009
- (void)convertRGBAToYUV420:(char *)arg1 rgbaBytesPerRow:(int)arg2;	// IMP=0x0000000000051b45
