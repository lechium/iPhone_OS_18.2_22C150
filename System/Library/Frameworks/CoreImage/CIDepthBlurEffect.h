...
+ (id)customAttributes;	// IMP=0x006000000022786d
+ (int)getDraftMode:(id)arg1;	// IMP=0x006000000022c035
+ (struct CGImageMetadata *)augmentMetadataWithRenderingPropertiesForImage:(id)arg1;	// IMP=0x006000000022bf5e
+ (struct CGImageMetadata *)metadataFromDictionary:(id)arg1 metadata:(struct CGImageMetadata *)arg2;	// IMP=0x006000000022be96
+ (id)tuningParametersFromMetadata:(struct CGImageMetadata *)arg1;	// IMP=0x006000000022be89
+ (struct CGImageMetadata *)replaceRenderingParameters:(struct CGImageMetadata *)arg1 tuningParameters:(id)arg2;	// IMP=0x006000000022be81
...
- (id)outputImage;	// IMP=0x00000000002283ad
- (id)_getFocusRect:(id)arg1 focusRect:(id)arg2;	// IMP=0x00000000002280c5
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x0000000000227edd
- (void)prewarm:(id)arg1;	// IMP=0x0000000000227298
