...
+ (id)customAttributes;	// IMP=0x0060000000196282
- (id).cxx_construct;	// IMP=0x0000000000196ea9
...
- (id)outputImage;	// IMP=0x00000000001969bf
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeCameraIntrinsics;	// IMP=0x000000000019660c
