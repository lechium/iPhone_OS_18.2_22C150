...
+ (id)customAttributes;	// IMP=0x006000000021cddf
...
- (id)outputImage;	// IMP=0x0000000000221884
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x0000000000220a62
- (id)blurMapV4:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3 hairImage:(id)arg4;	// IMP=0x000000000021f558
- (id)blurMapV3:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3;	// IMP=0x000000000021f21a
- (id)refineShiftMapV3WithMainImage:(id)arg1 shiftmap:(id)arg2 lensModel:(id)arg3;	// IMP=0x000000000021eb72
- (id)blurMapV2:(id)arg1;	// IMP=0x000000000021eadb
- (id)smoothShiftMapV2:(id)arg1;	// IMP=0x000000000021ea1b
- (id)faceMaskDelta:(id)arg1 extent:(struct CGRect)arg2 parameters:(id)arg3 distanceToAdd:(float *)arg4;	// IMP=0x000000000021e643
- (id)faceMaskApply:(id)arg1 blurMap:(id)arg2;	// IMP=0x000000000021e47a
- (id)faceMaskParams:(id)arg1 useNormalizedCoords:(_Bool)arg2;	// IMP=0x000000000021de56
- (_Bool)needToRunFaceMask;	// IMP=0x000000000021dd49
- (id)lensModelApply:(id)arg1 shiftMap:(id)arg2;	// IMP=0x000000000021dbb3
- (id)lensModelParams:(id)arg1;	// IMP=0x000000000021d982
- (id)upsampledShiftMap:(id)arg1;	// IMP=0x000000000021d746
- (float)intrinsicMatrixFocalLength;	// IMP=0x000000000021d6f9
- (struct CGSize)originalShiftMapSize;	// IMP=0x000000000021d620
- (id)calibrationData;	// IMP=0x000000000021d5e9
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x000000000021d589
