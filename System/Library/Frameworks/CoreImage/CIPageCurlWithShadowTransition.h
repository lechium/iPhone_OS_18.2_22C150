...
+ (id)customAttributes;	// IMP=0x0060000000181d6b
...
- (id)outputImage;	// IMP=0x000000000018030b
- (id)_CIPageCurlNoShadowTransition;	// IMP=0x00000000001802eb
- (id)_CIPageCurlWithShadowTransition;	// IMP=0x00000000001802cb
