...
- (id)featuresInImage:(id)arg1;	// IMP=0x0000000000026bdf
- (id)featuresInImage:(id)arg1 options:(id)arg2;	// IMP=0x0000000000025fad
- (void)dealloc;	// IMP=0x0000000000025f57
- (id)initWithContext:(id)arg1 options:(id)arg2;	// IMP=0x0000000000025e10
