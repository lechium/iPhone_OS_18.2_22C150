...
+ (id)customAttributes;	// IMP=0x006000000005a3ec
...
- (id)outputImage;	// IMP=0x000000000005a5d2
- (id)_kernelAlphaPreserving;	// IMP=0x000000000005a3cc
- (id)_kernel;	// IMP=0x000000000005a3ac
