...
+ (id)customAttributes;	// IMP=0x006000000018000b
...
- (id)outputImage;	// IMP=0x000000000017e298
- (id)_CIPageCurlTransNoEmap;	// IMP=0x000000000017e278
- (id)_CIPageCurlTransition;	// IMP=0x000000000017e258
