...
- (id)parameterNamesForChannel:(int)arg1;	// IMP=0x00000000002506ec
- (id)filterNameForChannel:(int)arg1;	// IMP=0x00000000002506c9
- (id)outputImage;	// IMP=0x0000000000250386
