...
+ (id)customAttributes;	// IMP=0x0060000000224d41
...
- (id)outputImage;	// IMP=0x0000000000225670
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x0000000000225336
- (id)alterBlurmap;	// IMP=0x0000000000225211
