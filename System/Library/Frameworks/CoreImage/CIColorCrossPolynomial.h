...
+ (id)customAttributes;	// IMP=0x00600000000636a7
...
- (id)outputImage;	// IMP=0x0000000000063a2a
- (_Bool)_isIdentity;	// IMP=0x0000000000063a22
- (id)_kernel;	// IMP=0x0000000000063687
