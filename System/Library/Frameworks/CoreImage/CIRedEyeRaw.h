...
- (id)outputImage;	// IMP=0x00000000000b1062
- (id)skinProtectionMaskWithThreshold:(float)arg1;	// IMP=0x00000000000b0f60
- (id)irisProtectionMaskWithThresholdIris:(float)arg1 thresholdSclera:(float)arg2 thresholdSkin:(float)arg3;	// IMP=0x00000000000b0df4
