...
+ (id)customAttributes;	// IMP=0x0060000000196edf
- (id).cxx_construct;	// IMP=0x000000000019777a
...
- (id)outputImage;	// IMP=0x000000000019760c
@property(readonly, nonatomic) CIFilter *outputRotationFilter;
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeRotation;	// IMP=0x00000000001972d9
- (void)computeCameraIntrinsics;	// IMP=0x0000000000197162
