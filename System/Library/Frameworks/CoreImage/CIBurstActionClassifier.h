...
- (_Bool)isBurstAction;	// IMP=0x00000000000368ff
- (float)predictResult;	// IMP=0x000000000003682b
- (double)computeKernelValueWithSupportVector:(const struct CIBurstSupportVector *)arg1;	// IMP=0x00000000000367b1
- (void)scaleVector;	// IMP=0x0000000000036671
- (id)initWithVersion:(int)arg1;	// IMP=0x0000000000036608
- (id)init;	// IMP=0x00000000000365b9
