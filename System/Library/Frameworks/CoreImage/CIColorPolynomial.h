...
+ (id)customAttributes;	// IMP=0x0060000000062380
...
- (id)outputImage;	// IMP=0x0000000000062aee
- (_Bool)_isIdentityAlpha;	// IMP=0x0000000000062a29
- (_Bool)_isIdentity;	// IMP=0x000000000006273f
- (id)_kernelRGB;	// IMP=0x0000000000062360
- (id)_kernel;	// IMP=0x0000000000062340
