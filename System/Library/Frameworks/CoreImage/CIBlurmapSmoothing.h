...
+ (id)customAttributes;	// IMP=0x00600000001a2f58
...
- (id)outputImage;	// IMP=0x00000000001a35a0
- (id)performPass:(id)arg1 reference:(id)arg2 values:(id)arg3 rect:(struct CGRect)arg4;	// IMP=0x00000000001a313e
- (id)_kernelV;	// IMP=0x00000000001a311e
- (id)_kernelH;	// IMP=0x00000000001a30fe
