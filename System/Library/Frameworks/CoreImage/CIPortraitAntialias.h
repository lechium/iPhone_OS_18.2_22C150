...
- (id)outputImage;	// IMP=0x00000000001a9f80
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2;	// IMP=0x00000000001a95bf
- (id)noiseColorKernel;	// IMP=0x00000000001a959f
- (id)_noiseGeneratorKernel;	// IMP=0x00000000001a9574
- (id)_kernel:(_Bool)arg1 withAddedNoise:(_Bool)arg2;	// IMP=0x00000000001a9523
