...
+ (id)customAttributes;	// IMP=0x00600000001ac30e
...
- (id)outputImage;	// IMP=0x00000000001ac81b
- (double)effectiveScale;	// IMP=0x00000000001ac786
- (id)sensorSize;	// IMP=0x00000000001ac660
