...
- (_Bool)compute;	// IMP=0x0000000000185616
- (void)dealloc;	// IMP=0x00000000001855db
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x0000000000185489
