...
+ (id)customAttributes;	// IMP=0x0060000000214727
...
- (id)outputImage;	// IMP=0x0000000000214ae1
- (id)_negkernel;	// IMP=0x0000000000214ac1
- (id)_poskernel;	// IMP=0x0000000000214aa1
- (_Bool)_isIdentity;	// IMP=0x0000000000214a6c
