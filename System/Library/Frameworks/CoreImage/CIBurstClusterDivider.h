...
- (long long)compareActionAmounts:(id)arg1;	// IMP=0x0000000000036c1b
- (long long)compareIndices:(id)arg1;	// IMP=0x0000000000036ba8
- (long long)compareDividers:(id)arg1;	// IMP=0x0000000000036b2f
