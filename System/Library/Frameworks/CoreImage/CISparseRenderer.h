...
+ (id)customAttributes;	// IMP=0x00600000001aaa47
...
- (id)outputImage;	// IMP=0x00000000001ab87e
- (id)_kernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x00000000001ab822
- (id)_lutKernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x00000000001ab7c6
- (id)baseVecsLUT:(unsigned int)arg1;	// IMP=0x00000000001ab6dd
- (id)stepsLUT:(unsigned int)arg1;	// IMP=0x00000000001ab5c0
- (id)baseVecsLUTGenerator;	// IMP=0x00000000001ab595
- (id)stepsLUTGenerator;	// IMP=0x00000000001ab56a
- (_Bool)_useD2XRenderer;	// IMP=0x00000000001ab44c
- (id)_packageParams:(_Bool)arg1 extent:(struct CGRect)arg2 image:(id)arg3 haveAlpha:(_Bool)arg4;	// IMP=0x00000000001aabba
