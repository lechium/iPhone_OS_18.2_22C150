...
- (void).cxx_destruct;	// IMP=0x00000000001ca7b7
...
- (_Bool)isExecuting;	// IMP=0x00000000001ca741
- (_Bool)isFinished;	// IMP=0x00000000001ca731
- (void)start;	// IMP=0x00000000001ca63d
- (id)initWithResult:(id)arg1 intent:(id)arg2 intentSlotDescription:(id)arg3 optionsProvider:(id)arg4;	// IMP=0x00000000001ca540
