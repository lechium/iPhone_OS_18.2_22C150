...
+ (id)new;	// IMP=0x0060000000196461
- (void).cxx_destruct;	// IMP=0x0000000000196709
...
- (id)initWithExternalOutputStreamUUID:(id)arg1 mixerDefinition:(id)arg2 channelLayoutTag:(unsigned int)arg3 uid:(id)arg4;	// IMP=0x0000000000196479
- (id)init;	// IMP=0x0000000000196423
