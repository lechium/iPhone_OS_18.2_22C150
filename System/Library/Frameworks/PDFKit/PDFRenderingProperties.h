...
- (void).cxx_destruct;	// IMP=0x0000000000006b75
- (void)_notifyPropertyChanged:(long long)arg1;	// IMP=0x0000000000006a83
...
- (void)dealloc;	// IMP=0x0000000000006714
- (id)init;	// IMP=0x00000000000065d3
