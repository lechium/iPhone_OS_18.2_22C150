...
+ (id)extensionInfoForCurrentProcess;	// IMP=0x00100000000154f6
+ (void)notifyExtensionMainCalled;	// IMP=0x00100000000154c5
...
- (id)initForCurrentProcess;	// IMP=0x0000000000015571
