...
- (void).cxx_destruct;	// IMP=0x000000000022bc0c
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000022ba8b
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput_1:(id)arg1 Confidence:(id)arg2 Detected:(id)arg3 detectedHistoryOut:(id)arg4;	// IMP=0x000000000022b983
