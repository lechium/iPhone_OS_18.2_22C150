...
- (void).cxx_destruct;	// IMP=0x000000000022f6bd
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000022f514
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000022f43c
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000022f425
