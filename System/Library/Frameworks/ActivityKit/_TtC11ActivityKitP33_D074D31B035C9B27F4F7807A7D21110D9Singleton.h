...
- (void)activityDidUnsubscribeForIdentifier:(id)arg1;	// IMP=0x000000000003a5e0
- (void)activityDidExceedReducedPushBudgetForIdentifier:(id)arg1;	// IMP=0x000000000003a590
