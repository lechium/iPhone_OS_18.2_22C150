...
- (void)userDidCancel;	// IMP=0x0000000000004dfe
- (void)userDidFinish;	// IMP=0x0000000000004db2
- (void)displayExtensionViewController:(id)arg1 forExtension:(id)arg2;	// IMP=0x0000000000004bd4
- (void)viewDidLoad;	// IMP=0x0000000000004a1f
