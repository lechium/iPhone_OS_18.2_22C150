...
+ (id)classesForKey;	// IMP=0x00600000000125a7
- (void).cxx_destruct;	// IMP=0x0000000000012d96
...
- (id)createAttendee:(id *)arg1;	// IMP=0x0000000000012a0b
- (id)initWithParticipant:(id)arg1;	// IMP=0x0000000000012889
